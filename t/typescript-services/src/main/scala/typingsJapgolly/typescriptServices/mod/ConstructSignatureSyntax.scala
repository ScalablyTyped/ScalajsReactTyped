...
open class ConstructSignatureSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ConstructSignatureSyntax {
  def this(
...
object ConstructSignatureSyntax {
  ...
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.ConstructSignatureSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ConstructSignatureSyntax]
}
