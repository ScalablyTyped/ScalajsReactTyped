...
@JSImport("typescript-services", "ThrowStatement")
@js.native
open class ThrowStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ThrowStatement {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.ThrowStatement, includingPosition: Boolean): Boolean = js.native
