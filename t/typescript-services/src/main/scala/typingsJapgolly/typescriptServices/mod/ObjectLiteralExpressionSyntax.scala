...
open class ObjectLiteralExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ObjectLiteralExpressionSyntax {
  def this(
...
object ObjectLiteralExpressionSyntax {
  ...
  /* static member */
  inline def create(openBraceToken: ISyntaxToken, closeBraceToken: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.ObjectLiteralExpressionSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(openBraceToken.asInstanceOf[js.Any], closeBraceToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ObjectLiteralExpressionSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.ObjectLiteralExpressionSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ObjectLiteralExpressionSyntax]
}
