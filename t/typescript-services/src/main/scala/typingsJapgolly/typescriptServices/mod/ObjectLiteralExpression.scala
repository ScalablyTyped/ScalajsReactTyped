...
@js.native
open class ObjectLiteralExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ObjectLiteralExpression {
  def this(propertyAssignments: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  ...
  /* CompleteClass */
  var propertyAssignments: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  ...
  override def structuralEquals(
    ast: typingsJapgolly.typescriptServices.TypeScript.ObjectLiteralExpression,
