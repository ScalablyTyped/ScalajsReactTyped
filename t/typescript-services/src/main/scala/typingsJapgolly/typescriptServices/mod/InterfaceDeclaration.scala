...
@js.native
open class InterfaceDeclaration protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.InterfaceDeclaration {
  def this(
    ...
    body: typingsJapgolly.typescriptServices.TypeScript.ObjectType
  ) = this()
  ...
  /* CompleteClass */
  var body: typingsJapgolly.typescriptServices.TypeScript.ObjectType = js.native
  ...
  override def structuralEquals(
    ast: typingsJapgolly.typescriptServices.TypeScript.InterfaceDeclaration,
