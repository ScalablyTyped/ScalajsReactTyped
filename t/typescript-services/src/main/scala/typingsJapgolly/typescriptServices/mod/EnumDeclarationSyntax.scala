...
open class EnumDeclarationSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.EnumDeclarationSyntax {
  def this(
...
object EnumDeclarationSyntax {
  ...
  inline def create(
    ...
    openBraceToken: ISyntaxToken,
    closeBraceToken: ISyntaxToken
  ): typingsJapgolly.typescriptServices.TypeScript.EnumDeclarationSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(enumKeyword.asInstanceOf[js.Any], identifier.asInstanceOf[js.Any], openBraceToken.asInstanceOf[js.Any], closeBraceToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.EnumDeclarationSyntax]
  
  /* static member */
  inline def create1(identifier: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.EnumDeclarationSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(identifier.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.EnumDeclarationSyntax]
}
