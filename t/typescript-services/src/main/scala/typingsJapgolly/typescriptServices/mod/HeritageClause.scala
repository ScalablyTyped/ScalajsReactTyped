...
open class HeritageClause protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.HeritageClause {
  def this(
    _nodeType: typingsJapgolly.typescriptServices.TypeScript.SyntaxKind,
    typeNames: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2
  ) = this()
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.HeritageClause, includingPosition: Boolean): Boolean = js.native
  ...
  /* CompleteClass */
  var typeNames: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
