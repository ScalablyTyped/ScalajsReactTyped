...
open class ParameterList protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ParameterList {
  def this(
    openParenTrailingComments: js.Array[typingsJapgolly.typescriptServices.TypeScript.Comment],
    parameters: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2
  ) = this()
  ...
  /* CompleteClass */
  var parameters: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
