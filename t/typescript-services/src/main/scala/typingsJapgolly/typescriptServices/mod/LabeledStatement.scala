...
open class LabeledStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.LabeledStatement {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.LabeledStatement, includingPosition: Boolean): Boolean = js.native
