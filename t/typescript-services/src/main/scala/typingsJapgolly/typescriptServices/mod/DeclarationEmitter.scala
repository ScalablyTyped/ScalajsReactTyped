...
open class DeclarationEmitter protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.DeclarationEmitter {
  def this(
  ...
  /* CompleteClass */
  var document: typingsJapgolly.typescriptServices.TypeScript.Document = js.native
  ...
  /* CompleteClass */
  override def emitDeclarations(sourceUnit: typingsJapgolly.typescriptServices.TypeScript.SourceUnit): Unit = js.native
...
object DeclarationEmitter {
  ...
  /* static member */
  inline def getEnclosingContainer(ast: typingsJapgolly.typescriptServices.TypeScript.AST): typingsJapgolly.typescriptServices.TypeScript.AST = ^.asInstanceOf[js.Dynamic].applyDynamic("getEnclosingContainer")(ast.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.AST]
}
