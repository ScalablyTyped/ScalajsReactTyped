...
class RuleOperationContext protected ()
  extends typingsJapgolly.typescriptServices.TypeScript.Services.Formatting.RuleOperationContext {
...
object RuleOperationContext extends js.Object {
  var Any: typingsJapgolly.typescriptServices.TypeScript.Services.Formatting.RuleOperationContext = js.native
}
