...
@JSImport("typescript-services", "SwitchStatement")
@js.native
open class SwitchStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.SwitchStatement {
  def this(
    ...
    switchClauses: typingsJapgolly.typescriptServices.TypeScript.ISyntaxList2
  ) = this()
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.SwitchStatement, includingPosition: Boolean): Boolean = js.native
  
  /* CompleteClass */
  var switchClauses: typingsJapgolly.typescriptServices.TypeScript.ISyntaxList2 = js.native
