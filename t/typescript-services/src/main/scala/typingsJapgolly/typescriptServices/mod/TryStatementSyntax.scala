...
open class TryStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.TryStatementSyntax {
  def this(
...
object TryStatementSyntax {
  ...
  /* static member */
  inline def create(tryKeyword: ISyntaxToken, block: typingsJapgolly.typescriptServices.TypeScript.BlockSyntax): typingsJapgolly.typescriptServices.TypeScript.TryStatementSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(tryKeyword.asInstanceOf[js.Any], block.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.TryStatementSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.TryStatementSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.TryStatementSyntax]
}
