...
open class ObjectCreationExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ObjectCreationExpressionSyntax {
  def this(
...
object ObjectCreationExpressionSyntax {
  ...
  /* static member */
  inline def create(newKeyword: ISyntaxToken, expression: IMemberExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.ObjectCreationExpressionSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(newKeyword.asInstanceOf[js.Any], expression.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ObjectCreationExpressionSyntax]
  
  /* static member */
  inline def create1(expression: IMemberExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.ObjectCreationExpressionSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(expression.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ObjectCreationExpressionSyntax]
}
