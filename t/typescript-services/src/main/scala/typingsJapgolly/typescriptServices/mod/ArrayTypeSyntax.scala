...
@js.native
open class ArrayTypeSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ArrayTypeSyntax {
  def this(
    `type`: ITypeSyntax,
...
object ArrayTypeSyntax {
  ...
  /* static member */
  inline def create1(`type`: ITypeSyntax): typingsJapgolly.typescriptServices.TypeScript.ArrayTypeSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(`type`.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ArrayTypeSyntax]
}
