...
@js.native
open class EqualsValueClauseSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.EqualsValueClauseSyntax {
...
object EqualsValueClauseSyntax {
  ...
  /* static member */
  inline def create1(value: IExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.EqualsValueClauseSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.EqualsValueClauseSyntax]
}
