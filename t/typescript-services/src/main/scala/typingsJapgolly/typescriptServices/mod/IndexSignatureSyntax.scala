...
open class IndexSignatureSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.IndexSignatureSyntax {
  def this(
...
object IndexSignatureSyntax {
  ...
  inline def create(
    ...
    parameter: typingsJapgolly.typescriptServices.TypeScript.ParameterSyntax,
    closeBracketToken: ISyntaxToken
  ): typingsJapgolly.typescriptServices.TypeScript.IndexSignatureSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(openBracketToken.asInstanceOf[js.Any], parameter.asInstanceOf[js.Any], closeBracketToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.IndexSignatureSyntax]
  
  /* static member */
  inline def create1(parameter: typingsJapgolly.typescriptServices.TypeScript.ParameterSyntax): typingsJapgolly.typescriptServices.TypeScript.IndexSignatureSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(parameter.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.IndexSignatureSyntax]
}
