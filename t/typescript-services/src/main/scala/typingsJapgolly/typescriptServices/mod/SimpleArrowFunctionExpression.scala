...
@JSImport("typescript-services", "SimpleArrowFunctionExpression")
@js.native
open class SimpleArrowFunctionExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.SimpleArrowFunctionExpression {
  def this(
