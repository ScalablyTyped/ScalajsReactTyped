...
open class Block protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.Block {
  def this(
    statements: typingsJapgolly.typescriptServices.TypeScript.ISyntaxList2,
    closeBraceLeadingComments: js.Array[typingsJapgolly.typescriptServices.TypeScript.Comment],
  ...
  /* CompleteClass */
  var closeBraceLeadingComments: js.Array[typingsJapgolly.typescriptServices.TypeScript.Comment] = js.native
  ...
  /* CompleteClass */
  var statements: typingsJapgolly.typescriptServices.TypeScript.ISyntaxList2 = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.Block, includingPosition: Boolean): Boolean = js.native
