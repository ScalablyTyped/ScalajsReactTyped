...
@js.native
open class PrefixUnaryExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.PrefixUnaryExpression {
  def this(
    _nodeType: typingsJapgolly.typescriptServices.TypeScript.SyntaxKind,
    operand: typingsJapgolly.typescriptServices.TypeScript.AST
  ) = this()
  ...
  /* CompleteClass */
  var operand: typingsJapgolly.typescriptServices.TypeScript.AST = js.native
  ...
  override def structuralEquals(
    ast: typingsJapgolly.typescriptServices.TypeScript.PrefixUnaryExpression,
