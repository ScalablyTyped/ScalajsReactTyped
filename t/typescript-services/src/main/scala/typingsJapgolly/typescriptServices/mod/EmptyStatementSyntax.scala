...
open class EmptyStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.EmptyStatementSyntax {
...
object EmptyStatementSyntax {
  ...
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.EmptyStatementSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.EmptyStatementSyntax]
}
