...
open class ConstructorTypeSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ConstructorTypeSyntax {
  def this(
...
object ConstructorTypeSyntax {
  ...
  inline def create(
    ...
    equalsGreaterThanToken: ISyntaxToken,
    `type`: ITypeSyntax
  ): typingsJapgolly.typescriptServices.TypeScript.ConstructorTypeSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(newKeyword.asInstanceOf[js.Any], parameterList.asInstanceOf[js.Any], equalsGreaterThanToken.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ConstructorTypeSyntax]
  
  /* static member */
  inline def create1(`type`: ITypeSyntax): typingsJapgolly.typescriptServices.TypeScript.ConstructorTypeSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(`type`.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ConstructorTypeSyntax]
}
