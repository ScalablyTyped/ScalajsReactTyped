...
@js.native
open class MemberAccessExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.MemberAccessExpressionSyntax {
  def this(
...
object MemberAccessExpressionSyntax {
  ...
  /* static member */
  inline def create1(expression: IExpressionSyntax, name: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.MemberAccessExpressionSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(expression.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.MemberAccessExpressionSyntax]
}
