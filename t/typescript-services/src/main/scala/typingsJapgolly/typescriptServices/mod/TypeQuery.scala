...
open class TypeQuery protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.TypeQuery {
  def this(name: typingsJapgolly.typescriptServices.TypeScript.AST) = this()
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.TypeQuery, includingPosition: Boolean): Boolean = js.native
