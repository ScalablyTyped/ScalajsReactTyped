...
open class ArrayType protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ArrayType {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.ArrayType, includingPosition: Boolean): Boolean = js.native
