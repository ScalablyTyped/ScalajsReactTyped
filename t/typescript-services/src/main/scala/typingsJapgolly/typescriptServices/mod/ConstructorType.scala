...
open class ConstructorType protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ConstructorType {
  def this(
    typeParameterList: typingsJapgolly.typescriptServices.TypeScript.TypeParameterList,
    parameterList: typingsJapgolly.typescriptServices.TypeScript.ParameterList,
    `type`: typingsJapgolly.typescriptServices.TypeScript.AST
  ) = this()
  ...
  /* CompleteClass */
  var parameterList: typingsJapgolly.typescriptServices.TypeScript.ParameterList = js.native
  ...
  /* CompleteClass */
  var `type`: typingsJapgolly.typescriptServices.TypeScript.AST = js.native
