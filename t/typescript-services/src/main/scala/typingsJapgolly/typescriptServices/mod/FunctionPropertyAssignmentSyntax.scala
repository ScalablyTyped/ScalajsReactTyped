...
open class FunctionPropertyAssignmentSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.FunctionPropertyAssignmentSyntax {
  def this(
...
object FunctionPropertyAssignmentSyntax {
  ...
  /* static member */
  inline def create1(propertyName: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.FunctionPropertyAssignmentSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(propertyName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.FunctionPropertyAssignmentSyntax]
}
