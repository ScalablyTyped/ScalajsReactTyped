...
open class ForInStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ForInStatement {
  def this(
    variableDeclaration: typingsJapgolly.typescriptServices.TypeScript.VariableDeclaration,
    left: typingsJapgolly.typescriptServices.TypeScript.AST,
  ...
  /* CompleteClass */
  var left: typingsJapgolly.typescriptServices.TypeScript.AST = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.ForInStatement, includingPosition: Boolean): Boolean = js.native
