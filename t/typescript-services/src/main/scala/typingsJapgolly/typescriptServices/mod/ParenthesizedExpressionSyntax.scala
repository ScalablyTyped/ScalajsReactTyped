...
open class ParenthesizedExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ParenthesizedExpressionSyntax {
  def this(
...
object ParenthesizedExpressionSyntax {
  ...
  /* static member */
  inline def create1(expression: IExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.ParenthesizedExpressionSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(expression.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ParenthesizedExpressionSyntax]
}
