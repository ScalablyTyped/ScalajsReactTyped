...
@JSImport("typescript-services", "TypeArgumentList")
@js.native
open class TypeArgumentList protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.TypeArgumentList {
  def this(typeArguments: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  ...
  /* CompleteClass */
  var typeArguments: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
