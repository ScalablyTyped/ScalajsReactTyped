...
open class VariableStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.VariableStatementSyntax {
  def this(
...
object VariableStatementSyntax {
  ...
  inline def create(
    variableDeclaration: typingsJapgolly.typescriptServices.TypeScript.VariableDeclarationSyntax,
    semicolonToken: ISyntaxToken
  ): typingsJapgolly.typescriptServices.TypeScript.VariableStatementSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(variableDeclaration.asInstanceOf[js.Any], semicolonToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.VariableStatementSyntax]
  
  /* static member */
  inline def create1(variableDeclaration: typingsJapgolly.typescriptServices.TypeScript.VariableDeclarationSyntax): typingsJapgolly.typescriptServices.TypeScript.VariableStatementSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(variableDeclaration.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.VariableStatementSyntax]
}
