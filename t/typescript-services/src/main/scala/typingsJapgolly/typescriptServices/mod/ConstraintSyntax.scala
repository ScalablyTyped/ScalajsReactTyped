...
@js.native
open class ConstraintSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ConstraintSyntax {
...
object ConstraintSyntax {
  ...
  /* static member */
  inline def create1(`type`: ITypeSyntax): typingsJapgolly.typescriptServices.TypeScript.ConstraintSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(`type`.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ConstraintSyntax]
}
