...
@js.native
open class SetAccessorSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.SetAccessorSyntax {
  def this(
...
object SetAccessorSyntax {
  ...
  inline def create(
    ...
    parameterList: typingsJapgolly.typescriptServices.TypeScript.ParameterListSyntax,
    block: typingsJapgolly.typescriptServices.TypeScript.BlockSyntax
  ): typingsJapgolly.typescriptServices.TypeScript.SetAccessorSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(setKeyword.asInstanceOf[js.Any], propertyName.asInstanceOf[js.Any], parameterList.asInstanceOf[js.Any], block.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.SetAccessorSyntax]
  
  /* static member */
  inline def create1(propertyName: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.SetAccessorSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(propertyName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.SetAccessorSyntax]
}
