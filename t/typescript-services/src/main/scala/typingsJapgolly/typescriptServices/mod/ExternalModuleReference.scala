...
open class ExternalModuleReference protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ExternalModuleReference {
  def this(stringLiteral: typingsJapgolly.typescriptServices.TypeScript.StringLiteral) = this()
