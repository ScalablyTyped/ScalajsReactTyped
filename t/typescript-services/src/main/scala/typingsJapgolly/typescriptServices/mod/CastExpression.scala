...
open class CastExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.CastExpression {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.CastExpression, includingPosition: Boolean): Boolean = js.native
