...
object DeclarationEmitter {
  ...
  inline def apply(
    ...
    emitDeclarations: SourceUnit => Callback,
  ...
  extension [Self <: DeclarationEmitter](x: Self) {
    ...
    inline def setEmitDeclarations(value: SourceUnit => Callback): Self = StObject.set(x, "emitDeclarations", js.Any.fromFunction1((t0: SourceUnit) => value(t0).runNow()))
    ...
    inline def setEmitIndent(value: CallbackTo[Any]): Self = StObject.set(x, "emitIndent", value.toJsFn)
