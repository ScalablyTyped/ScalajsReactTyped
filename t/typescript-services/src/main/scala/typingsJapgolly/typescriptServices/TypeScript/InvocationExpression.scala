...
- typingsJapgolly.typescriptServices.TypeScript.ICallExpression because var conflicts: _end, _start. Inlined expression, argumentList */ trait InvocationExpression
  extends StObject
     with AST {
...
object InvocationExpression {
  ...
  extension [Self <: InvocationExpression](x: Self) {
