...
import typingsJapgolly.typescriptServices.TypeScript.SyntaxWalker
...
trait IndentationTrackingWalker
  ...
  /* private */ var _indentationNodeContextPool: Any
  
  /* private */ var _lastTriviaWasNewLine: Any
  ...
  /* private */ var _textSpan: Any
  
  def forceIndentNextToken(tokenStart: Double): Unit
  
  /* private */ def forceRecomputeIndentationOfParent(tokenStart: Any, newLineAdded: Any): Any
  
  def forceSkipIndentingNextToken(tokenStart: Double): Unit
  
  /* private */ def getCommentIndentationAmount(token: Any): Any
  
  /* private */ def getNodeIndentation(node: Any, newLineInsertedByFormatting: Any): Any
  
  /* private */ def getTokenIndentationAmount(token: Any): Any
  ...
  /* private */ def shouldIndentBlockInParent(parent: Any): Any
...
object IndentationTrackingWalker {
  ...
  extension [Self <: IndentationTrackingWalker](x: Self) {
    ...
    inline def setShouldIndentBlockInParent(value: Any => Any): Self = StObject.set(x, "shouldIndentBlockInParent", js.Any.fromFunction1(value))
    
    inline def setSnapshot(value: CallbackTo[ITextSnapshot]): Self = StObject.set(x, "snapshot", value.toJsFn)
    
    inline def setTextSpan(value: CallbackTo[TextSpan]): Self = StObject.set(x, "textSpan", value.toJsFn)
    
    inline def setVisitTokenInSpan(value: ISyntaxToken => Callback): Self = StObject.set(x, "visitTokenInSpan", js.Any.fromFunction1((t0: ISyntaxToken) => value(t0).runNow()))
    
    inline def set_indentationNodeContextPool(value: Any): Self = StObject.set(x, "_indentationNodeContextPool", value.asInstanceOf[js.Any])
    
    inline def set_lastTriviaWasNewLine(value: Any): Self = StObject.set(x, "_lastTriviaWasNewLine", value.asInstanceOf[js.Any])
    ...
    inline def set_textSpan(value: Any): Self = StObject.set(x, "_textSpan", value.asInstanceOf[js.Any])
  }
}
