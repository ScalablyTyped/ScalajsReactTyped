...
object Formatter {
  ...
  inline def apply(
    ...
    _snapshot: Any,
    _textSpan: Any,
    edits: CallbackTo[js.Array[TextEditInfo]],
    ...
    recordEdit: (Double, Double, String) => Callback,
