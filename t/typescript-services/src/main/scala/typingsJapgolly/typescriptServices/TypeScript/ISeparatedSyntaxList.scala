...
object ISeparatedSyntaxList {
  ...
  def apply(
    ...
    nonSeparatorAt: Double => CallbackTo[ISyntaxNodeOrToken],
    nonSeparatorCount: CallbackTo[Double],
    separatorAt: Double => CallbackTo[ISyntaxToken],
    ...
    __obj.updateDynamic("nonSeparatorAt")(js.Any.fromFunction1((t0: scala.Double) => nonSeparatorAt(t0).runNow()))
    __obj.updateDynamic("nonSeparatorCount")(nonSeparatorCount.toJsFn)
    __obj.updateDynamic("separatorAt")(js.Any.fromFunction1((t0: scala.Double) => separatorAt(t0).runNow()))
    __obj.updateDynamic("separatorCount")(separatorCount.toJsFn)
    __obj.updateDynamic("toArray")(toArray.toJsFn)
    __obj.updateDynamic("toNonSeparatorArray")(toNonSeparatorArray.toJsFn)
