...
object DepthLimitedWalker {
  ...
  extension [Self <: DepthLimitedWalker](x: Self) {
    ...
    inline def set_maximumDepth(value: Any): Self = StObject.set(x, "_maximumDepth", value.asInstanceOf[js.Any])
  }
}
