...
object Syntax {
  ...
  object FixedWidthTokenWithLeadingAndTrailingTrivia {
    ...
    extension [Self <: FixedWidthTokenWithLeadingAndTrailingTrivia](x: Self) {
      ...
      inline def setRealize(value: CallbackTo[Any]): Self = StObject.set(x, "realize", value.toJsFn)
  ...
  object IFactory {
    ...
    extension [Self <: IFactory](x: Self) {
      ...
      inline def setOmittedExpression(value: CallbackTo[OmittedExpressionSyntax]): Self = StObject.set(x, "omittedExpression", value.toJsFn)
