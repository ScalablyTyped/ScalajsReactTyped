...
object ILanguageService {
  ...
  extension [Self <: ILanguageService](x: Self) {
    ...
    inline def setGetCompilerOptionsDiagnostics(value: CallbackTo[js.Array[Diagnostic]]): Self = StObject.set(x, "getCompilerOptionsDiagnostics", value.toJsFn)
