...
object ReferenceResolver {
  ...
  extension [Self <: ReferenceResolver](x: Self) {
    ...
    inline def setResolveInputFiles(value: CallbackTo[ReferenceResolutionResult]): Self = StObject.set(x, "resolveInputFiles", value.toJsFn)
