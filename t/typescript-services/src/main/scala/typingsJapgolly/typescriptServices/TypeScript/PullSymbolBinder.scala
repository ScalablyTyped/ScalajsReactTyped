...
object PullSymbolBinder {
  ...
  inline def apply(
    ...
    bindDeclToPullSymbol: PullDecl => Callback,
  ...
  extension [Self <: PullSymbolBinder](x: Self) {
    ...
    inline def setBindDeclToPullSymbol(value: PullDecl => Callback): Self = StObject.set(x, "bindDeclToPullSymbol", js.Any.fromFunction1((t0: PullDecl) => value(t0).runNow()))
