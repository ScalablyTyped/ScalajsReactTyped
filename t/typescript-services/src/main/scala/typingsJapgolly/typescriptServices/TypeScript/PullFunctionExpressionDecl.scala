...
object PullFunctionExpressionDecl {
  ...
  inline def apply(
    ...
    getFunctionExpressionName: CallbackTo[String],
  ...
  extension [Self <: PullFunctionExpressionDecl](x: Self) {
    ...
    inline def setGetFunctionExpressionName(value: CallbackTo[String]): Self = StObject.set(x, "getFunctionExpressionName", value.toJsFn)
  }
}
