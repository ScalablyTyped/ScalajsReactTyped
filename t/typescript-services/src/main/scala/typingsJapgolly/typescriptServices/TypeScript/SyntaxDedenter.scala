...
object SyntaxDedenter {
  ...
  extension [Self <: SyntaxDedenter](x: Self) {
    ...
    inline def setIsAborted(value: CallbackTo[Any]): Self = StObject.set(x, "isAborted", value.toJsFn)
