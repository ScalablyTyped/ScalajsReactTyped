...
object LanguageService {
  ...
  inline def apply(
    ...
    getAllSemanticDiagnostics: CallbackTo[Any],
    getAllSyntacticDiagnostics: CallbackTo[Any],
  ...
  extension [Self <: LanguageService](x: Self) {
    ...
    inline def setGetAllSemanticDiagnostics(value: CallbackTo[Any]): Self = StObject.set(x, "getAllSemanticDiagnostics", value.toJsFn)
    
    inline def setGetAllSyntacticDiagnostics(value: CallbackTo[Any]): Self = StObject.set(x, "getAllSyntacticDiagnostics", value.toJsFn)
