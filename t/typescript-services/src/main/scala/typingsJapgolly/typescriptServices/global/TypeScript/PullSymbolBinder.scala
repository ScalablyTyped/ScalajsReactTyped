...
open class PullSymbolBinder protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.PullSymbolBinder {
  def this(semanticInfoChain: typingsJapgolly.typescriptServices.TypeScript.SemanticInfoChain) = this()
  ...
  /* CompleteClass */
  override def bindDeclToPullSymbol(decl: typingsJapgolly.typescriptServices.TypeScript.PullDecl): Unit = js.native
