...
open class Identifier protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.Identifier {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.Identifier, includingPosition: Boolean): Boolean = js.native
