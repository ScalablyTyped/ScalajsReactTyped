...
@js.native
open class VariableDeclaratorSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.VariableDeclaratorSyntax {
  def this(
...
object VariableDeclaratorSyntax {
  ...
  /* static member */
  inline def create(propertyName: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.VariableDeclaratorSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(propertyName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.VariableDeclaratorSyntax]
  
  /* static member */
  inline def create1(propertyName: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.VariableDeclaratorSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(propertyName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.VariableDeclaratorSyntax]
}
