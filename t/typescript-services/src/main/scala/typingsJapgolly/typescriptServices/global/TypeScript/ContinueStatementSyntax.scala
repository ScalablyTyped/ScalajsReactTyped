...
open class ContinueStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ContinueStatementSyntax {
  def this(
...
object ContinueStatementSyntax {
  ...
  /* static member */
  inline def create(continueKeyword: ISyntaxToken, semicolonToken: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.ContinueStatementSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(continueKeyword.asInstanceOf[js.Any], semicolonToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ContinueStatementSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.ContinueStatementSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ContinueStatementSyntax]
}
