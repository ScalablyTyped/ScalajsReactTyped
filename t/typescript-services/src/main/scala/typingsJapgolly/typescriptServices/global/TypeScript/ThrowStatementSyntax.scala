...
open class ThrowStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ThrowStatementSyntax {
  def this(
...
object ThrowStatementSyntax {
  ...
  /* static member */
  inline def create1(expression: IExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.ThrowStatementSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(expression.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ThrowStatementSyntax]
}
