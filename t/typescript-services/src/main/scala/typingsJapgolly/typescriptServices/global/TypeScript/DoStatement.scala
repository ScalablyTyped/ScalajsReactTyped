...
@js.native
open class DoStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.DoStatement {
  def this(
    statement: typingsJapgolly.typescriptServices.TypeScript.AST,
    whileKeyword: typingsJapgolly.typescriptServices.TypeScript.ASTSpan,
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.DoStatement, includingPosition: Boolean): Boolean = js.native
  ...
  /* CompleteClass */
  var whileKeyword: typingsJapgolly.typescriptServices.TypeScript.ASTSpan = js.native
