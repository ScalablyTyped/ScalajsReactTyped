...
open class DefaultSwitchClause protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.DefaultSwitchClause {
  def this(statements: typingsJapgolly.typescriptServices.TypeScript.ISyntaxList2) = this()
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.DefaultSwitchClause, includingPosition: Boolean): Boolean = js.native
