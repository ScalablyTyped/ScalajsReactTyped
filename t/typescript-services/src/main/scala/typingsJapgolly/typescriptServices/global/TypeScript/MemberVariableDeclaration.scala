...
@JSGlobal("TypeScript.MemberVariableDeclaration")
@js.native
open class MemberVariableDeclaration protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.MemberVariableDeclaration {
  def this(
    modifiers: js.Array[typingsJapgolly.typescriptServices.TypeScript.PullElementFlags],
    variableDeclarator: typingsJapgolly.typescriptServices.TypeScript.VariableDeclarator
  ) = this()
  ...
  /* CompleteClass */
  var variableDeclarator: typingsJapgolly.typescriptServices.TypeScript.VariableDeclarator = js.native
