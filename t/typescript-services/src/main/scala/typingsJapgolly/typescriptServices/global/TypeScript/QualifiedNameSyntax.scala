...
@js.native
open class QualifiedNameSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.QualifiedNameSyntax {
...
object QualifiedNameSyntax {
  ...
  /* static member */
  inline def create1(left: INameSyntax, right: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.QualifiedNameSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.QualifiedNameSyntax]
}
