...
open class VoidExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.VoidExpression {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.VoidExpression, includingPosition: Boolean): Boolean = js.native
