...
@js.native
open class ConstructSignature protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ConstructSignature {
  def this(callSignature: typingsJapgolly.typescriptServices.TypeScript.CallSignature) = this()
