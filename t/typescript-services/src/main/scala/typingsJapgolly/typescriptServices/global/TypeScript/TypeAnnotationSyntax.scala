...
@js.native
open class TypeAnnotationSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.TypeAnnotationSyntax {
...
object TypeAnnotationSyntax {
  ...
  /* static member */
  inline def create1(`type`: ITypeSyntax): typingsJapgolly.typescriptServices.TypeScript.TypeAnnotationSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(`type`.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.TypeAnnotationSyntax]
}
