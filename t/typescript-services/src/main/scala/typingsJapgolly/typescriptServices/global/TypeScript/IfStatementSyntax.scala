...
open class IfStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.IfStatementSyntax {
  def this(
...
object IfStatementSyntax {
  ...
  inline def create(
    ...
    closeParenToken: ISyntaxToken,
    statement: IStatementSyntax
  ): typingsJapgolly.typescriptServices.TypeScript.IfStatementSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(ifKeyword.asInstanceOf[js.Any], openParenToken.asInstanceOf[js.Any], condition.asInstanceOf[js.Any], closeParenToken.asInstanceOf[js.Any], statement.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.IfStatementSyntax]
  
  /* static member */
  inline def create1(condition: IExpressionSyntax, statement: IStatementSyntax): typingsJapgolly.typescriptServices.TypeScript.IfStatementSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(condition.asInstanceOf[js.Any], statement.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.IfStatementSyntax]
}
