...
import typingsJapgolly.typescriptServices.TypeScript.IEnvironment
...
import typingsJapgolly.typescriptServices.anon.ActualText
import typingsJapgolly.typescriptServices.global.TypeScript.^
...
inline def getAstWalkerFactory(): typingsJapgolly.typescriptServices.TypeScript.AstWalkerFactory = ^.asInstanceOf[js.Dynamic].applyDynamic("getAstWalkerFactory")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.AstWalkerFactory]
...
inline def getIDForTypeSubstitutions(
  instantiatingSignature: typingsJapgolly.typescriptServices.TypeScript.PullSignatureSymbol,
...
inline def getIDForTypeSubstitutions(
  instantiatingType: typingsJapgolly.typescriptServices.TypeScript.PullTypeSymbol,
  typeArgumentMap: TypeArgumentMap
...
inline def getLastConstructor(classDecl: typingsJapgolly.typescriptServices.TypeScript.ClassDeclaration): typingsJapgolly.typescriptServices.TypeScript.ConstructorDeclaration = ^.asInstanceOf[js.Dynamic].applyDynamic("getLastConstructor")(classDecl.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ConstructorDeclaration]
...
inline def getParseOptions(settings: typingsJapgolly.typescriptServices.TypeScript.ImmutableCompilationSettings): typingsJapgolly.typescriptServices.TypeScript.ParseOptions = ^.asInstanceOf[js.Dynamic].applyDynamic("getParseOptions")(settings.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ParseOptions]
...
inline def getPropertyAssignmentNameTextFromIdentifier(identifier: typingsJapgolly.typescriptServices.TypeScript.AST): ActualText = ^.asInstanceOf[js.Dynamic].applyDynamic("getPropertyAssignmentNameTextFromIdentifier")(identifier.asInstanceOf[js.Any]).asInstanceOf[ActualText]
...
inline def getTrimmedTextLines(comment: typingsJapgolly.typescriptServices.TypeScript.Comment): js.Array[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getTrimmedTextLines")(comment.asInstanceOf[js.Any]).asInstanceOf[js.Array[String]]
...
inline def hasModifier(
  ...
  flag: typingsJapgolly.typescriptServices.TypeScript.PullElementFlags
...
inline def isTypesOnlyLocation(ast: typingsJapgolly.typescriptServices.TypeScript.AST): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypesOnlyLocation")(ast.asInstanceOf[js.Any]).asInstanceOf[Boolean]

inline def lastParameterIsRest(parameterList: typingsJapgolly.typescriptServices.TypeScript.ParameterList): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("lastParameterIsRest")(parameterList.asInstanceOf[js.Any]).asInstanceOf[Boolean]
...
inline def structuralEqualsIncludingPosition(
  ast1: typingsJapgolly.typescriptServices.TypeScript.AST,
  ast2: typingsJapgolly.typescriptServices.TypeScript.AST
): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("structuralEqualsIncludingPosition")(ast1.asInstanceOf[js.Any], ast2.asInstanceOf[js.Any])).asInstanceOf[Boolean]

inline def structuralEqualsNotIncludingPosition(
  ast1: typingsJapgolly.typescriptServices.TypeScript.AST,
  ast2: typingsJapgolly.typescriptServices.TypeScript.AST
): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("structuralEqualsNotIncludingPosition")(ast1.asInstanceOf[js.Any], ast2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
