...
open class BinaryExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.BinaryExpression {
  def this(
    _nodeType: typingsJapgolly.typescriptServices.TypeScript.SyntaxKind,
    left: typingsJapgolly.typescriptServices.TypeScript.AST,
    right: typingsJapgolly.typescriptServices.TypeScript.AST
  ) = this()
  ...
  /* CompleteClass */
  var right: typingsJapgolly.typescriptServices.TypeScript.AST = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.BinaryExpression, includingPosition: Boolean): Boolean = js.native
