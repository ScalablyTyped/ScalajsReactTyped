...
@js.native
open class SourceUnitSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.SourceUnitSyntax {
...
object SourceUnitSyntax {
  ...
  /* static member */
  inline def create(endOfFileToken: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.SourceUnitSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(endOfFileToken.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.SourceUnitSyntax]
  
  /* static member */
  inline def create1(endOfFileToken: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.SourceUnitSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(endOfFileToken.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.SourceUnitSyntax]
}
