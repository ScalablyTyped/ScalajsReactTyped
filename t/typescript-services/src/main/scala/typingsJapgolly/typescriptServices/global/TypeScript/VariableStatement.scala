...
open class VariableStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.VariableStatement {
  def this(
    modifiers: js.Array[typingsJapgolly.typescriptServices.TypeScript.PullElementFlags],
    declaration: typingsJapgolly.typescriptServices.TypeScript.VariableDeclaration
  ) = this()
  ...
  /* CompleteClass */
  var declaration: typingsJapgolly.typescriptServices.TypeScript.VariableDeclaration = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.VariableStatement, includingPosition: Boolean): Boolean = js.native
