...
open class ExpressionStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ExpressionStatementSyntax {
...
object ExpressionStatementSyntax {
  ...
  /* static member */
  inline def create1(expression: IExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.ExpressionStatementSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(expression.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ExpressionStatementSyntax]
}
