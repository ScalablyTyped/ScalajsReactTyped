...
@js.native
open class ConditionalExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ConditionalExpression {
  def this(
    condition: typingsJapgolly.typescriptServices.TypeScript.AST,
    whenTrue: typingsJapgolly.typescriptServices.TypeScript.AST,
    whenFalse: typingsJapgolly.typescriptServices.TypeScript.AST
  ) = this()
  ...
  override def structuralEquals(
    ast: typingsJapgolly.typescriptServices.TypeScript.ConditionalExpression,
  ...
  /* CompleteClass */
  var whenFalse: typingsJapgolly.typescriptServices.TypeScript.AST = js.native
  
  /* CompleteClass */
  var whenTrue: typingsJapgolly.typescriptServices.TypeScript.AST = js.native
