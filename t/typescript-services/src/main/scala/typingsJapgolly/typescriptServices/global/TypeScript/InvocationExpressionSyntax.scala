...
open class InvocationExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.InvocationExpressionSyntax {
  def this(
...
object InvocationExpressionSyntax {
  ...
  /* static member */
  inline def create1(expression: IMemberExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.InvocationExpressionSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(expression.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.InvocationExpressionSyntax]
}
