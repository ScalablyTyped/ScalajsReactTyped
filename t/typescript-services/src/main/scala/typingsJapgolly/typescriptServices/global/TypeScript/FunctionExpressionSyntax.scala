...
open class FunctionExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.FunctionExpressionSyntax {
  def this(
...
object FunctionExpressionSyntax {
  ...
  inline def create(
    ...
    callSignature: typingsJapgolly.typescriptServices.TypeScript.CallSignatureSyntax,
    block: typingsJapgolly.typescriptServices.TypeScript.BlockSyntax
  ): typingsJapgolly.typescriptServices.TypeScript.FunctionExpressionSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(functionKeyword.asInstanceOf[js.Any], callSignature.asInstanceOf[js.Any], block.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.FunctionExpressionSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.FunctionExpressionSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.FunctionExpressionSyntax]
}
