...
open class ModuleDeclaration protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ModuleDeclaration {
  def this(
    ...
    stringLiteral: typingsJapgolly.typescriptServices.TypeScript.StringLiteral,
    moduleElements: typingsJapgolly.typescriptServices.TypeScript.ISyntaxList2,
    endingToken: typingsJapgolly.typescriptServices.TypeScript.ASTSpan
  ) = this()
  ...
  /* CompleteClass */
  var endingToken: typingsJapgolly.typescriptServices.TypeScript.ASTSpan = js.native
  ...
  /* CompleteClass */
  var name: typingsJapgolly.typescriptServices.TypeScript.AST = js.native
  ...
  /* CompleteClass */
  var stringLiteral: typingsJapgolly.typescriptServices.TypeScript.StringLiteral = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.ModuleDeclaration, includingPosition: Boolean): Boolean = js.native
