...
open class BlockSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.BlockSyntax {
  def this(
...
object BlockSyntax {
  ...
  /* static member */
  inline def create(openBraceToken: ISyntaxToken, closeBraceToken: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.BlockSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(openBraceToken.asInstanceOf[js.Any], closeBraceToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.BlockSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.BlockSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.BlockSyntax]
}
