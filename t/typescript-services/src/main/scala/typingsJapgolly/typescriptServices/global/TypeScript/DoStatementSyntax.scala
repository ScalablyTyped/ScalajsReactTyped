...
@js.native
open class DoStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.DoStatementSyntax {
  def this(
...
object DoStatementSyntax {
  ...
  /* static member */
  inline def create1(statement: IStatementSyntax, condition: IExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.DoStatementSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(statement.asInstanceOf[js.Any], condition.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.DoStatementSyntax]
}
