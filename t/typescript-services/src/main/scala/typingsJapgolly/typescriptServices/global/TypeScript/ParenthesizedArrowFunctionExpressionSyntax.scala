...
open class ParenthesizedArrowFunctionExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ParenthesizedArrowFunctionExpressionSyntax {
  def this(
...
object ParenthesizedArrowFunctionExpressionSyntax {
  ...
  inline def create(
    callSignature: typingsJapgolly.typescriptServices.TypeScript.CallSignatureSyntax,
    equalsGreaterThanToken: ISyntaxToken
  ): typingsJapgolly.typescriptServices.TypeScript.ParenthesizedArrowFunctionExpressionSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(callSignature.asInstanceOf[js.Any], equalsGreaterThanToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ParenthesizedArrowFunctionExpressionSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.ParenthesizedArrowFunctionExpressionSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ParenthesizedArrowFunctionExpressionSyntax]
}
