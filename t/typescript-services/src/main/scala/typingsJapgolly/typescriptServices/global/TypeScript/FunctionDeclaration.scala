...
@js.native
open class FunctionDeclaration protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.FunctionDeclaration {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.FunctionDeclaration, includingPosition: Boolean): Boolean = js.native
