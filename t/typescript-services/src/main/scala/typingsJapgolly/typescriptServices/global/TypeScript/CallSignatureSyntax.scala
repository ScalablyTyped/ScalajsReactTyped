...
open class CallSignatureSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.CallSignatureSyntax {
  def this(
...
object CallSignatureSyntax {
  ...
  /* static member */
  inline def create(parameterList: typingsJapgolly.typescriptServices.TypeScript.ParameterListSyntax): typingsJapgolly.typescriptServices.TypeScript.CallSignatureSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(parameterList.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.CallSignatureSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.CallSignatureSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.CallSignatureSyntax]
}
