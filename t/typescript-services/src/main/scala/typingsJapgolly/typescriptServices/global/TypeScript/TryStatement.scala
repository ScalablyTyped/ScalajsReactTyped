...
open class TryStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.TryStatement {
  def this(
    block: typingsJapgolly.typescriptServices.TypeScript.Block,
    catchClause: typingsJapgolly.typescriptServices.TypeScript.CatchClause,
    finallyClause: typingsJapgolly.typescriptServices.TypeScript.FinallyClause
  ) = this()
  ...
  /* CompleteClass */
  var catchClause: typingsJapgolly.typescriptServices.TypeScript.CatchClause = js.native
  ...
  /* CompleteClass */
  var finallyClause: typingsJapgolly.typescriptServices.TypeScript.FinallyClause = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.TryStatement, includingPosition: Boolean): Boolean = js.native
