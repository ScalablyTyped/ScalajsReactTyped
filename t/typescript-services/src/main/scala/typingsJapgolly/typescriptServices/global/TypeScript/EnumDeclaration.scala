...
open class EnumDeclaration protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.EnumDeclaration {
  def this(
    ...
    enumElements: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2
  ) = this()
  ...
  /* CompleteClass */
  var enumElements: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
