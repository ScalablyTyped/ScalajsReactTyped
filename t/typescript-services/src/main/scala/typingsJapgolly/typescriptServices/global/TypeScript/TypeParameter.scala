...
open class TypeParameter protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.TypeParameter {
  def this(
    identifier: typingsJapgolly.typescriptServices.TypeScript.Identifier,
    constraint: typingsJapgolly.typescriptServices.TypeScript.Constraint
  ) = this()
  ...
  /* CompleteClass */
  var constraint: typingsJapgolly.typescriptServices.TypeScript.Constraint = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.TypeParameter, includingPosition: Boolean): Boolean = js.native
