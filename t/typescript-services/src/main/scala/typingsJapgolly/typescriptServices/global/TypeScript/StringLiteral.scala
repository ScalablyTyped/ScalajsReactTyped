...
open class StringLiteral protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.StringLiteral {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.StringLiteral, includingPosition: Boolean): Boolean = js.native
