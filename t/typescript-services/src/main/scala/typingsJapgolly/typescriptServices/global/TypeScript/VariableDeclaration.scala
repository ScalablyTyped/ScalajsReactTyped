...
@js.native
open class VariableDeclaration protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.VariableDeclaration {
  def this(declarators: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  ...
  /* CompleteClass */
  var declarators: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.VariableDeclaration, includingPosition: Boolean): Boolean = js.native
