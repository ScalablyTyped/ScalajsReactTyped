...
@js.native
open class ArrayLiteralExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ArrayLiteralExpression {
  def this(expressions: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  ...
  /* CompleteClass */
  var expressions: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  ...
  override def structuralEquals(
    ast: typingsJapgolly.typescriptServices.TypeScript.ArrayLiteralExpression,
