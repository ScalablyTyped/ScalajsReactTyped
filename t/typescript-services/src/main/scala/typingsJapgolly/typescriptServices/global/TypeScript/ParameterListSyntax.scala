...
open class ParameterListSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ParameterListSyntax {
  def this(
...
object ParameterListSyntax {
  ...
  /* static member */
  inline def create(openParenToken: ISyntaxToken, closeParenToken: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.ParameterListSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(openParenToken.asInstanceOf[js.Any], closeParenToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ParameterListSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.ParameterListSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ParameterListSyntax]
}
