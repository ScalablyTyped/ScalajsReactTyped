...
open class Debug ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.Debug
object Debug {
  ...
  /* static member */
  inline def shouldAssert(level: typingsJapgolly.typescriptServices.TypeScript.AssertionLevel): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("shouldAssert")(level.asInstanceOf[js.Any]).asInstanceOf[Boolean]
}
