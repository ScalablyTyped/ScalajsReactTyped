...
@JSGlobal("TypeScript.Services.ActualSignatureInfo")
@js.native
open class ActualSignatureInfo ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.Services.ActualSignatureInfo {
