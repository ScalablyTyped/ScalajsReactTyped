...
@js.native
open class ElementAccessExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ElementAccessExpressionSyntax {
  def this(
...
object ElementAccessExpressionSyntax {
  ...
  /* static member */
  inline def create1(expression: IExpressionSyntax, argumentExpression: IExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.ElementAccessExpressionSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(expression.asInstanceOf[js.Any], argumentExpression.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ElementAccessExpressionSyntax]
}
