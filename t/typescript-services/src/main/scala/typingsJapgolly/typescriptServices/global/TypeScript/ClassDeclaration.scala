...
@js.native
open class ClassDeclaration protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ClassDeclaration {
  def this(
    ...
    typeParameterList: typingsJapgolly.typescriptServices.TypeScript.TypeParameterList,
    heritageClauses: typingsJapgolly.typescriptServices.TypeScript.ISyntaxList2,
    classElements: typingsJapgolly.typescriptServices.TypeScript.ISyntaxList2,
    closeBraceToken: typingsJapgolly.typescriptServices.TypeScript.ASTSpan
  ) = this()
  ...
  /* CompleteClass */
  var classElements: typingsJapgolly.typescriptServices.TypeScript.ISyntaxList2 = js.native
  
  /* CompleteClass */
  var closeBraceToken: typingsJapgolly.typescriptServices.TypeScript.ASTSpan = js.native
  ...
  /* CompleteClass */
  var heritageClauses: typingsJapgolly.typescriptServices.TypeScript.ISyntaxList2 = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.ClassDeclaration, includingPosition: Boolean): Boolean = js.native
  ...
  /* CompleteClass */
  var typeParameterList: typingsJapgolly.typescriptServices.TypeScript.TypeParameterList = js.native
