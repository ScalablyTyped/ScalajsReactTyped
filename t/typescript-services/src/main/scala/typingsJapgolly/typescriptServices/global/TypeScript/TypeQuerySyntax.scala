...
open class TypeQuerySyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.TypeQuerySyntax {
...
object TypeQuerySyntax {
  ...
  /* static member */
  inline def create1(name: INameSyntax): typingsJapgolly.typescriptServices.TypeScript.TypeQuerySyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(name.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.TypeQuerySyntax]
}
