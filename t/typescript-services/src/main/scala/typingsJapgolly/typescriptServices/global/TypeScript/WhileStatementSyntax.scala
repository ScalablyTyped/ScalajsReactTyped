...
open class WhileStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.WhileStatementSyntax {
  def this(
...
object WhileStatementSyntax {
  ...
  /* static member */
  inline def create1(condition: IExpressionSyntax, statement: IStatementSyntax): typingsJapgolly.typescriptServices.TypeScript.WhileStatementSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(condition.asInstanceOf[js.Any], statement.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.WhileStatementSyntax]
}
