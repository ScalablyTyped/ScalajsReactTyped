...
@js.native
open class TypeArgumentListSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.TypeArgumentListSyntax {
  def this(
...
object TypeArgumentListSyntax {
  ...
  /* static member */
  inline def create(lessThanToken: ISyntaxToken, greaterThanToken: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.TypeArgumentListSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(lessThanToken.asInstanceOf[js.Any], greaterThanToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.TypeArgumentListSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.TypeArgumentListSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.TypeArgumentListSyntax]
}
