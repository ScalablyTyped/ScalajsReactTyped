...
@js.native
open class GenericTypeSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.GenericTypeSyntax {
  def this(
    name: INameSyntax,
...
object GenericTypeSyntax {
  ...
  /* static member */
  inline def create1(name: INameSyntax): typingsJapgolly.typescriptServices.TypeScript.GenericTypeSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(name.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.GenericTypeSyntax]
}
