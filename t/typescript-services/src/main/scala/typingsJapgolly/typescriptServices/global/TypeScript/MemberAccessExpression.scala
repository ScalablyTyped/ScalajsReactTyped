...
open class MemberAccessExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.MemberAccessExpression {
  def this(
    expression: typingsJapgolly.typescriptServices.TypeScript.AST,
    name: typingsJapgolly.typescriptServices.TypeScript.Identifier
  ) = this()
  ...
  /* CompleteClass */
  var name: typingsJapgolly.typescriptServices.TypeScript.Identifier = js.native
  ...
  override def structuralEquals(
    ast: typingsJapgolly.typescriptServices.TypeScript.MemberAccessExpression,
