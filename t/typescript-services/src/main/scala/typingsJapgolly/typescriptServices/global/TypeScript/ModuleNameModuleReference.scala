...
@js.native
open class ModuleNameModuleReference protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ModuleNameModuleReference {
  def this(moduleName: typingsJapgolly.typescriptServices.TypeScript.AST) = this()
  ...
  /* CompleteClass */
  var moduleName: typingsJapgolly.typescriptServices.TypeScript.AST = js.native
