...
open class IfStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.IfStatement {
  def this(
    condition: typingsJapgolly.typescriptServices.TypeScript.AST,
    statement: typingsJapgolly.typescriptServices.TypeScript.AST,
    elseClause: typingsJapgolly.typescriptServices.TypeScript.ElseClause
  ) = this()
  ...
  /* CompleteClass */
  var elseClause: typingsJapgolly.typescriptServices.TypeScript.ElseClause = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.IfStatement, includingPosition: Boolean): Boolean = js.native
