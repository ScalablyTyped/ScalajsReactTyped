...
open class VoidExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.VoidExpressionSyntax {
...
object VoidExpressionSyntax {
  ...
  /* static member */
  inline def create1(expression: IUnaryExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.VoidExpressionSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(expression.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.VoidExpressionSyntax]
}
