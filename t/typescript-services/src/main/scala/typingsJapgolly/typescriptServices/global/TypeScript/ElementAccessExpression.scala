...
open class ElementAccessExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ElementAccessExpression {
  def this(
    expression: typingsJapgolly.typescriptServices.TypeScript.AST,
    argumentExpression: typingsJapgolly.typescriptServices.TypeScript.AST
  ) = this()
  ...
  /* CompleteClass */
  var argumentExpression: typingsJapgolly.typescriptServices.TypeScript.AST = js.native
  ...
  override def structuralEquals(
    ast: typingsJapgolly.typescriptServices.TypeScript.ElementAccessExpression,
