...
open class TypeParameterList protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.TypeParameterList {
  def this(typeParameters: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  ...
  /* CompleteClass */
  var typeParameters: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
