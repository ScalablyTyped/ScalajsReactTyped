...
open class ObjectTypeSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ObjectTypeSyntax {
  def this(
...
object ObjectTypeSyntax {
  ...
  /* static member */
  inline def create(openBraceToken: ISyntaxToken, closeBraceToken: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.ObjectTypeSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(openBraceToken.asInstanceOf[js.Any], closeBraceToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ObjectTypeSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.ObjectTypeSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ObjectTypeSyntax]
}
