...
open class PullErrorTypeSymbol protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.PullErrorTypeSymbol {
  def this(_anyType: typingsJapgolly.typescriptServices.TypeScript.PullTypeSymbol, name: String) = this()
