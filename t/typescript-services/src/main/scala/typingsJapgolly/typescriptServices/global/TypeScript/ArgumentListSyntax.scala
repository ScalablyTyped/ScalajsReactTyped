...
open class ArgumentListSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ArgumentListSyntax {
  def this(
...
object ArgumentListSyntax {
  ...
  /* static member */
  inline def create(openParenToken: ISyntaxToken, closeParenToken: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.ArgumentListSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(openParenToken.asInstanceOf[js.Any], closeParenToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ArgumentListSyntax]
  
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.ArgumentListSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ArgumentListSyntax]
}
