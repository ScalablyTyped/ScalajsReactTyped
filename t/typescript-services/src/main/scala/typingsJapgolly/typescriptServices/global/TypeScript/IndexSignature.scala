...
@JSGlobal("TypeScript.IndexSignature")
@js.native
open class IndexSignature protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.IndexSignature {
  def this(
    parameter: typingsJapgolly.typescriptServices.TypeScript.Parameter,
  ...
  /* CompleteClass */
  var parameter: typingsJapgolly.typescriptServices.TypeScript.Parameter = js.native
