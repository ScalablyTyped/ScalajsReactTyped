...
open class QualifiedName protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.QualifiedName {
  def this(
    left: typingsJapgolly.typescriptServices.TypeScript.AST,
    right: typingsJapgolly.typescriptServices.TypeScript.Identifier
  ) = this()
  ...
  /* CompleteClass */
  var right: typingsJapgolly.typescriptServices.TypeScript.Identifier = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.QualifiedName, includingPosition: Boolean): Boolean = js.native
