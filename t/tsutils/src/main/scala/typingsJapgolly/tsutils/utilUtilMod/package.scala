...
import typingsJapgolly.tsutils.utilUtilMod.^
...
inline def getLateBoundPropertyNamesOfPropertyName(node: typingsJapgolly.typescript.mod.PropertyName, checker: TypeChecker): LateBoundPropertyNames = (^.asInstanceOf[js.Dynamic].applyDynamic("getLateBoundPropertyNamesOfPropertyName")(node.asInstanceOf[js.Any], checker.asInstanceOf[js.Any])).asInstanceOf[LateBoundPropertyNames]
...
inline def getPropertyName(propertyName: typingsJapgolly.typescript.mod.PropertyName): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getPropertyName")(propertyName.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
...
inline def getSingleLateBoundPropertyNameOfPropertyName(node: typingsJapgolly.typescript.mod.PropertyName, checker: TypeChecker): js.UndefOr[PropertyName] = (^.asInstanceOf[js.Dynamic].applyDynamic("getSingleLateBoundPropertyNameOfPropertyName")(node.asInstanceOf[js.Any], checker.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[PropertyName]]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.tsutils.anon.ImportEqualsDeclarationmo
  - typingsJapgolly.tsutils.anon.ExportDeclarationmoduleSp
  - typingsJapgolly.tsutils.anon.CallExpressionexpressionT
