...
/* Rewritten from type alias, can be one of: 
  - java.lang.String
  - typingsJapgolly.testcafe.mod.global.BrowserConnection
  - typingsJapgolly.testcafe.mod.global.BrowserDescriptor
*/
...
/* init */ String | (js.Function1[/* repeated */ Any, Node | js.Array[Node] | NodeList[Node] | HTMLCollection[Any]]) | Selector | NodeSnapshot | SelectorPromise, 
...
type TlsOptions = typingsJapgolly.node.tlsMod.TlsOptions
