...
import typingsJapgolly.testcafe.testcafeStrings.alert
import typingsJapgolly.testcafe.testcafeStrings.beforeunload
import typingsJapgolly.testcafe.testcafeStrings.confirm
import typingsJapgolly.testcafe.testcafeStrings.prompt
...
trait TestController extends StObject {
  ...
  def clearUpload(
    selector: js.Function1[/* repeated */ Any, Node | js.Array[Node] | NodeList[Node] | HTMLCollection[Any]]
  ...
  def dragToElement(
    selector: String,
    destinationSelector: js.Function1[/* repeated */ Any, Node | js.Array[Node] | NodeList[Node] | HTMLCollection[Any]]
  ): TestControllerPromise[Any] = js.native
  def dragToElement(
    selector: String,
    destinationSelector: js.Function1[/* repeated */ Any, Node | js.Array[Node] | NodeList[Node] | HTMLCollection[Any]],
  ...
  def selectEditableContent(
    ...
    endSelector: js.Function1[/* repeated */ Any, Node | js.Array[Node] | NodeList[Node] | HTMLCollection[Any]]
  ): TestControllerPromise[Any] = js.native
  def selectEditableContent(
    startSelector: String,
    endSelector: js.Function1[/* repeated */ Any, Node | js.Array[Node] | NodeList[Node] | HTMLCollection[Any]],
  ...
  def selectEditableContent(
    startSelector: js.Function1[/* repeated */ Any, Node | js.Array[Node] | NodeList[Node] | HTMLCollection[Any]],
    endSelector: String
  ): TestControllerPromise[Any] = js.native
  def selectEditableContent(
    startSelector: js.Function1[/* repeated */ Any, Node | js.Array[Node] | NodeList[Node] | HTMLCollection[Any]],
  ...
  def selectTextAreaContent(
    selector: String | Selector | NodeSnapshot | SelectorPromise | (js.Function1[/* repeated */ Any, Node | js.Array[Node] | NodeList[Node] | HTMLCollection[Any]]),
