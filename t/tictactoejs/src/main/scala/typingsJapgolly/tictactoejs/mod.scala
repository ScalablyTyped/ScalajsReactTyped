package typingsJapgolly.tictactoejs

import typingsJapgolly.tictactoejs.tictactoejsStrings.O
import typingsJapgolly.tictactoejs.tictactoejsStrings.X
import typingsJapgolly.tictactoejs.tictactoejsStrings.`in progress`
import typingsJapgolly.tictactoejs.tictactoejsStrings.draw
...
object mod {
  ...
  open class TicTacToe () extends StObject {
    ...
    /**
      ...
      */
    def legalMoves(): js.Array[typingsJapgolly.tictactoejs.anon.X] = js.native
    ...
    /**
      ...
      */
    def randomMove(): typingsJapgolly.tictactoejs.anon.X = js.native
