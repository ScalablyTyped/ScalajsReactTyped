...
import typingsJapgolly.tensorflowTfjsBackendWasm.anon.AttrsMeanAttrs
...
object distKernelsMeanMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-wasm/dist/kernels/Mean", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-wasm/dist/kernels/Mean", "meanConfig")
  @js.native
