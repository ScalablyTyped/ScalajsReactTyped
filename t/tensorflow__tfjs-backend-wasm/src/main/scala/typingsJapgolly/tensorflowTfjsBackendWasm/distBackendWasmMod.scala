...
import typingsJapgolly.tensorflowTfjsBackendWasm.anon.Wasm
...
import typingsJapgolly.tensorflowTfjsCore.mod.DataStorage
import typingsJapgolly.tensorflowTfjsCore.mod.KernelBackend
...
object distBackendWasmMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tensorflowTfjsBackendWasm.tensorflowTfjsBackendWasmStrings.`tfjs-backend-wasmDotwasm`
    - typingsJapgolly.tensorflowTfjsBackendWasm.tensorflowTfjsBackendWasmStrings.`tfjs-backend-wasm-simdDotwasm`
    - typingsJapgolly.tensorflowTfjsBackendWasm.tensorflowTfjsBackendWasmStrings.`tfjs-backend-wasm-threaded-simdDotwasm`
  */
