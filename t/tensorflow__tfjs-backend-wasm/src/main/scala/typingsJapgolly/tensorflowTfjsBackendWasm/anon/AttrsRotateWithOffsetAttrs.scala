...
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.RotateWithOffsetAttrs
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.RotateWithOffsetInputs
