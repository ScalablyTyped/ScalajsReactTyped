...
object DownloadPDF {
  ...
  def apply(
    ...
    documentProcessing: /* doc */ js.Any => CallbackTo[js.Any] = null,
    jsPDF: js.Any = null,
    ...
    if (documentProcessing != null) __obj.updateDynamic("documentProcessing")(js.Any.fromFunction1((t0: /* doc */ js.Any) => documentProcessing(t0).runNow()))
