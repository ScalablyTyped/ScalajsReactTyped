...
import typingsJapgolly.tabulatorTables.tabulatorTablesStrings.landscape
import typingsJapgolly.tabulatorTables.tabulatorTablesStrings.portrait
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
- typingsJapgolly.tabulatorTables.Tabulator.DownloadPDF because var conflicts: documentProcessing. Inlined orientation, title, rowGroupStyles, rowCalcStyles, jsPDF, autoTable */ trait DownloadOptions
  extends DownloadCSV
     with DownloadXLXS
     with DownloadHTML {
...
object DownloadOptions {
  ...
  def apply(
    ...
    documentProcessing: /* input */ js.Any => CallbackTo[js.Any] = null,
    jsPDF: js.Any = null,
