...
- typingsJapgolly.tabulatorTables.mod.DownloadPDF because var conflicts: documentProcessing. Inlined orientation, title, rowGroupStyles, rowCalcStyles, jsPDF, autoTable */ trait DownloadOptions
  extends StObject
     with DownloadCSV
     with DownloadXLXS
     with DownloadHTML {
