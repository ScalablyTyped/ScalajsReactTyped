...
object OptionsHTML {
  ...
  extension [Self <: OptionsHTML](x: Self) {
    ...
    inline def setPrintFooterCallbackTo(value: CallbackTo[String | HTMLElement]): Self = StObject.set(x, "printFooter", value.toJsFn)
    ...
    inline def setPrintHeaderCallbackTo(value: CallbackTo[String | HTMLElement]): Self = StObject.set(x, "printHeader", value.toJsFn)
    ...
    inline def setPrintRowRangeCallbackTo(value: CallbackTo[js.Array[RowComponent]]): Self = StObject.set(x, "printRowRange", value.toJsFn)
