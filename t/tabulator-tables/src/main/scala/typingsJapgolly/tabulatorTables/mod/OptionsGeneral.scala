...
import typingsJapgolly.tabulatorTables.tabulatorTablesStrings.blocking
import typingsJapgolly.tabulatorTables.tabulatorTablesStrings.highlight
import typingsJapgolly.tabulatorTables.tabulatorTablesStrings.manual
...
object OptionsGeneral {
  ...
  extension [Self <: OptionsGeneral](x: Self) {
    ...
    inline def setDataChanged(value: /* data */ Any => Callback): Self = StObject.set(x, "dataChanged", js.Any.fromFunction1((t0: /* data */ Any) => value(t0).runNow()))
    
    inline def setDataChangedUndefined: Self = StObject.set(x, "dataChanged", js.undefined)
    
    inline def setDataSorted(value: (/* sorters */ js.Array[SorterFromTable], /* rows */ js.Array[RowComponent]) => Callback): Self = StObject.set(x, "dataSorted", js.Any.fromFunction2((t0: /* sorters */ js.Array[SorterFromTable], t1: /* rows */ js.Array[RowComponent]) => (value(t0, t1)).runNow()))
    
    inline def setDataSortedUndefined: Self = StObject.set(x, "dataSorted", js.undefined)
    
    inline def setDataSorting(value: /* sorters */ js.Array[SorterFromTable] => Callback): Self = StObject.set(x, "dataSorting", js.Any.fromFunction1((t0: /* sorters */ js.Array[SorterFromTable]) => value(t0).runNow()))
    ...
    inline def setHtmlImported(value: /* callback */ js.Function0[Unit] => Callback): Self = StObject.set(x, "htmlImported", js.Any.fromFunction1((t0: /* callback */ js.Function0[Unit]) => value(t0).runNow()))
    
    inline def setHtmlImportedUndefined: Self = StObject.set(x, "htmlImported", js.undefined)
    
    inline def setHtmlImporting(value: /* callback */ js.Function0[Unit] => Callback): Self = StObject.set(x, "htmlImporting", js.Any.fromFunction1((t0: /* callback */ js.Function0[Unit]) => value(t0).runNow()))
    ...
    inline def setPageLoaded(value: /* pageno */ Double => Callback): Self = StObject.set(x, "pageLoaded", js.Any.fromFunction1((t0: /* pageno */ Double) => value(t0).runNow()))
    ...
    inline def setScrollHorizontal(value: /* left */ Any => Callback): Self = StObject.set(x, "scrollHorizontal", js.Any.fromFunction1((t0: /* left */ Any) => value(t0).runNow()))
    
    inline def setScrollHorizontalUndefined: Self = StObject.set(x, "scrollHorizontal", js.undefined)
    
    inline def setScrollVertical(value: /* top */ Any => Callback): Self = StObject.set(x, "scrollVertical", js.Any.fromFunction1((t0: /* top */ Any) => value(t0).runNow()))
