...
object OptionsRowGrouping {
  ...
  extension [Self <: OptionsRowGrouping](x: Self) {
    ...
    inline def setDataGrouped(value: Callback): Self = StObject.set(x, "dataGrouped", value.toJsFn)
    ...
    inline def setGroupClick(value: (/* e */ UIEvent, /* group */ GroupComponent) => Callback): Self = StObject.set(x, "groupClick", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* group */ GroupComponent) => (value(t0, t1)).runNow()))
    ...
    inline def setGroupContext(value: (/* e */ UIEvent, /* group */ GroupComponent) => Callback): Self = StObject.set(x, "groupContext", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* group */ GroupComponent) => (value(t0, t1)).runNow()))
    
    inline def setGroupContextUndefined: Self = StObject.set(x, "groupContext", js.undefined)
    
    inline def setGroupDblClick(value: (/* e */ UIEvent, /* group */ GroupComponent) => Callback): Self = StObject.set(x, "groupDblClick", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* group */ GroupComponent) => (value(t0, t1)).runNow()))
    
    inline def setGroupDblClickUndefined: Self = StObject.set(x, "groupDblClick", js.undefined)
    
    inline def setGroupDblTap(value: (/* e */ UIEvent, /* group */ GroupComponent) => Callback): Self = StObject.set(x, "groupDblTap", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* group */ GroupComponent) => (value(t0, t1)).runNow()))
    ...
    inline def setGroupTap(value: (/* e */ UIEvent, /* group */ GroupComponent) => Callback): Self = StObject.set(x, "groupTap", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* group */ GroupComponent) => (value(t0, t1)).runNow()))
    
    inline def setGroupTapHold(value: (/* e */ UIEvent, /* group */ GroupComponent) => Callback): Self = StObject.set(x, "groupTapHold", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* group */ GroupComponent) => (value(t0, t1)).runNow()))
    ...
    inline def setGroupVisibilityChanged(value: (/* group */ GroupComponent, /* visible */ Boolean) => Callback): Self = StObject.set(x, "groupVisibilityChanged", js.Any.fromFunction2((t0: /* group */ GroupComponent, t1: /* visible */ Boolean) => (value(t0, t1)).runNow()))
