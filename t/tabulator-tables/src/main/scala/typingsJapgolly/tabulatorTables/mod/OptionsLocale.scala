...
object OptionsLocale {
  ...
  extension [Self <: OptionsLocale](x: Self) {
    ...
    inline def setLocalized(value: (/* locale */ String, /* lang */ Any) => Callback): Self = StObject.set(x, "localized", js.Any.fromFunction2((t0: /* locale */ String, t1: /* lang */ Any) => (value(t0, t1)).runNow()))
