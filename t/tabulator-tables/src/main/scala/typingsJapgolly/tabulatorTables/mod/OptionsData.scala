...
object OptionsData {
  ...
  extension [Self <: OptionsData](x: Self) {
    ...
    inline def setAjaxError(value: (/* xhr */ Any, /* textStatus */ Any, /* errorThrown */ Any) => Callback): Self = StObject.set(x, "ajaxError", js.Any.fromFunction3((t0: /* xhr */ Any, t1: /* textStatus */ Any, t2: /* errorThrown */ Any) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setAjaxLoaderCallbackTo(value: CallbackTo[Boolean]): Self = StObject.set(x, "ajaxLoader", value.toJsFn)
