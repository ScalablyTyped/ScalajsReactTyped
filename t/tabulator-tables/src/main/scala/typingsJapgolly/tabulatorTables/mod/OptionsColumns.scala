...
import typingsJapgolly.tabulatorTables.anon.PartialColumnDefinition
...
import typingsJapgolly.tabulatorTables.tabulatorTablesStrings.fitDataTable
...
import typingsJapgolly.tabulatorTables.tabulatorTablesStrings.none
...
object OptionsColumns {
  ...
  extension [Self <: OptionsColumns](x: Self) {
    ...
    inline def setColumnMoved(value: (/* column */ ColumnComponent, /* columns */ js.Array[Any]) => Callback): Self = StObject.set(x, "columnMoved", js.Any.fromFunction2((t0: /* column */ ColumnComponent, t1: /* columns */ js.Array[Any]) => (value(t0, t1)).runNow()))
    
    inline def setColumnMovedUndefined: Self = StObject.set(x, "columnMoved", js.undefined)
    
    inline def setColumnResized(value: /* column */ ColumnComponent => Callback): Self = StObject.set(x, "columnResized", js.Any.fromFunction1((t0: /* column */ ColumnComponent) => value(t0).runNow()))
    
    inline def setColumnResizedUndefined: Self = StObject.set(x, "columnResized", js.undefined)
    
    inline def setColumnTitleChanged(value: /* column */ ColumnComponent => Callback): Self = StObject.set(x, "columnTitleChanged", js.Any.fromFunction1((t0: /* column */ ColumnComponent) => value(t0).runNow()))
    
    inline def setColumnTitleChangedUndefined: Self = StObject.set(x, "columnTitleChanged", js.undefined)
    
    inline def setColumnVisibilityChanged(value: (/* column */ ColumnComponent, /* visible */ Boolean) => Callback): Self = StObject.set(x, "columnVisibilityChanged", js.Any.fromFunction2((t0: /* column */ ColumnComponent, t1: /* visible */ Boolean) => (value(t0, t1)).runNow()))
