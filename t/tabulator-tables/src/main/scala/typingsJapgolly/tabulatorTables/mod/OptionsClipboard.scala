...
import typingsJapgolly.tabulatorTables.tabulatorTablesStrings.html
...
import typingsJapgolly.tabulatorTables.tabulatorTablesStrings.plain
...
object OptionsClipboard {
  ...
  extension [Self <: OptionsClipboard](x: Self) {
    ...
    inline def setClipboardCopied(value: Callback): Self = StObject.set(x, "clipboardCopied", value.toJsFn)
    ...
    inline def setClipboardPasteError(value: Callback): Self = StObject.set(x, "clipboardPasteError", value.toJsFn)
    ...
    inline def setClipboardPasted(value: Callback): Self = StObject.set(x, "clipboardPasted", value.toJsFn)
