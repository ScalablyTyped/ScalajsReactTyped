...
import typingsJapgolly.tabulatorTables.anon.PickFilterfieldvalue
...
object OptionsFiltering {
  ...
  extension [Self <: OptionsFiltering](x: Self) {
    ...
    inline def setDataFiltered(value: (/* filters */ js.Array[Filter], /* rows */ js.Array[RowComponent]) => Callback): Self = StObject.set(x, "dataFiltered", js.Any.fromFunction2((t0: /* filters */ js.Array[Filter], t1: /* rows */ js.Array[RowComponent]) => (value(t0, t1)).runNow()))
    
    inline def setDataFilteredUndefined: Self = StObject.set(x, "dataFiltered", js.undefined)
    
    inline def setDataFiltering(value: /* filters */ js.Array[Filter] => Callback): Self = StObject.set(x, "dataFiltering", js.Any.fromFunction1((t0: /* filters */ js.Array[Filter]) => value(t0).runNow()))
