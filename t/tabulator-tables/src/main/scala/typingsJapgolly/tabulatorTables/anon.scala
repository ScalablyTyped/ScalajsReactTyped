...
import typingsJapgolly.tabulatorTables.mod.CellComponent
import typingsJapgolly.tabulatorTables.mod.CellEditEventCallback
import typingsJapgolly.tabulatorTables.mod.CellEventCallback
import typingsJapgolly.tabulatorTables.mod.ColumnCalc
import typingsJapgolly.tabulatorTables.mod.ColumnCalcParams
import typingsJapgolly.tabulatorTables.mod.ColumnComponent
import typingsJapgolly.tabulatorTables.mod.ColumnDefinition
import typingsJapgolly.tabulatorTables.mod.ColumnDefinitionAlign
import typingsJapgolly.tabulatorTables.mod.ColumnDefinitionSorterParams
import typingsJapgolly.tabulatorTables.mod.ColumnEventCallback
import typingsJapgolly.tabulatorTables.mod.ColumnSorterParamLookupFunction
import typingsJapgolly.tabulatorTables.mod.CustomAccessor
import typingsJapgolly.tabulatorTables.mod.CustomAccessorParams
import typingsJapgolly.tabulatorTables.mod.CustomMutator
import typingsJapgolly.tabulatorTables.mod.CustomMutatorParams
import typingsJapgolly.tabulatorTables.mod.Editor
import typingsJapgolly.tabulatorTables.mod.EditorParams
import typingsJapgolly.tabulatorTables.mod.EmptyCallback
import typingsJapgolly.tabulatorTables.mod.FilterType
import typingsJapgolly.tabulatorTables.mod.Formatter
import typingsJapgolly.tabulatorTables.mod.FormatterParams
import typingsJapgolly.tabulatorTables.mod.GlobalTooltipOption
import typingsJapgolly.tabulatorTables.mod.MenuObject
import typingsJapgolly.tabulatorTables.mod.MenuSeparator
import typingsJapgolly.tabulatorTables.mod.RowComponent
import typingsJapgolly.tabulatorTables.mod.SortDirection
import typingsJapgolly.tabulatorTables.mod.StandardValidatorType
import typingsJapgolly.tabulatorTables.mod.Validator
import typingsJapgolly.tabulatorTables.mod.ValueBooleanCallback
import typingsJapgolly.tabulatorTables.mod.ValueVoidCallback
...
object anon {
  ...
  object PartialColumnDefinition {
    ...
    extension [Self <: PartialColumnDefinition](x: Self) {
      ...
      inline def setHeaderClick(value: (/* e */ UIEvent, /* column */ ColumnComponent) => Callback): Self = StObject.set(x, "headerClick", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* column */ ColumnComponent) => (value(t0, t1)).runNow()))
      
      inline def setHeaderClickUndefined: Self = StObject.set(x, "headerClick", js.undefined)
      
      inline def setHeaderContext(value: (/* e */ UIEvent, /* column */ ColumnComponent) => Callback): Self = StObject.set(x, "headerContext", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* column */ ColumnComponent) => (value(t0, t1)).runNow()))
      ...
      inline def setHeaderDblClick(value: (/* e */ UIEvent, /* column */ ColumnComponent) => Callback): Self = StObject.set(x, "headerDblClick", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* column */ ColumnComponent) => (value(t0, t1)).runNow()))
      ...
      inline def setHeaderDblTap(value: (/* e */ UIEvent, /* column */ ColumnComponent) => Callback): Self = StObject.set(x, "headerDblTap", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* column */ ColumnComponent) => (value(t0, t1)).runNow()))
      ...
      inline def setHeaderMouseDown(value: (/* e */ UIEvent, /* column */ ColumnComponent) => Callback): Self = StObject.set(x, "headerMouseDown", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* column */ ColumnComponent) => (value(t0, t1)).runNow()))
      
      inline def setHeaderMouseDownUndefined: Self = StObject.set(x, "headerMouseDown", js.undefined)
      
      inline def setHeaderMouseUp(value: (/* e */ UIEvent, /* column */ ColumnComponent) => Callback): Self = StObject.set(x, "headerMouseUp", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* column */ ColumnComponent) => (value(t0, t1)).runNow()))
      ...
      inline def setHeaderTap(value: (/* e */ UIEvent, /* column */ ColumnComponent) => Callback): Self = StObject.set(x, "headerTap", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* column */ ColumnComponent) => (value(t0, t1)).runNow()))
      
      inline def setHeaderTapHold(value: (/* e */ UIEvent, /* column */ ColumnComponent) => Callback): Self = StObject.set(x, "headerTapHold", js.Any.fromFunction2((t0: /* e */ UIEvent, t1: /* column */ ColumnComponent) => (value(t0, t1)).runNow()))
