...
object libRulesNewlinePerChainedCallRuleMod {
  
  @JSImport("tslint/lib/rules/newlinePerChainedCallRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/newlinePerChainedCallRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/newlinePerChainedCallRule", "Rule.metadata")
    @js.native
