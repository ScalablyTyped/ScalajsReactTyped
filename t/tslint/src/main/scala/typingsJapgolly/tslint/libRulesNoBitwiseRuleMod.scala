...
object libRulesNoBitwiseRuleMod {
  
  @JSImport("tslint/lib/rules/noBitwiseRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noBitwiseRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noBitwiseRule", "Rule.metadata")
    @js.native
