...
object libRulesNewlineBeforeReturnRuleMod {
  
  @JSImport("tslint/lib/rules/newlineBeforeReturnRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/newlineBeforeReturnRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/newlineBeforeReturnRule", "Rule.metadata")
    @js.native
