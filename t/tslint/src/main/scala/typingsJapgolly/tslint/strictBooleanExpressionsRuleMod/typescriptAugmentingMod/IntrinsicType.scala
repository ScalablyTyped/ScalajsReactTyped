package typingsJapgolly.tslint.strictBooleanExpressionsRuleMod.typescriptAugmentingMod
...
object IntrinsicType {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any], intrinsicName = intrinsicName.asInstanceOf[js.Any], symbol = symbol.asInstanceOf[js.Any])
