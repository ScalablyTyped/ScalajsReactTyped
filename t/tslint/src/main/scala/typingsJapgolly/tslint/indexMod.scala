...
import typingsJapgolly.tslint.codeFrameFormatterMod.Formatter
...
object indexMod extends js.Object {
  ...
  class FileslistFormatter ()
    extends typingsJapgolly.tslint.fileslistFormatterMod.Formatter
  
  @js.native
  class JUnitFormatter ()
    extends typingsJapgolly.tslint.junitFormatterMod.Formatter
  
  @js.native
  class JsonFormatter ()
    extends typingsJapgolly.tslint.jsonFormatterMod.Formatter
  
  @js.native
  class PmdFormatter ()
    extends typingsJapgolly.tslint.pmdFormatterMod.Formatter
  
  @js.native
  class ProseFormatter ()
    extends typingsJapgolly.tslint.proseFormatterMod.Formatter
  
  @js.native
  class StylishFormatter ()
    extends typingsJapgolly.tslint.stylishFormatterMod.Formatter
  
  @js.native
  class TapFormatter ()
    extends typingsJapgolly.tslint.tapFormatterMod.Formatter
  
  @js.native
  class VerboseFormatter ()
    extends typingsJapgolly.tslint.verboseFormatterMod.Formatter
