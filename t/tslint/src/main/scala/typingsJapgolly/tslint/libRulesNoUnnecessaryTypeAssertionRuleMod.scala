...
object libRulesNoUnnecessaryTypeAssertionRuleMod {
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noUnnecessaryTypeAssertionRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noUnnecessaryTypeAssertionRule", "Rule.metadata")
    @js.native
