...
object libRulesTypeofCompareRuleMod {
  
  @JSImport("tslint/lib/rules/typeofCompareRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/typeofCompareRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/typeofCompareRule", "Rule.metadata")
    @js.native
