...
import typingsJapgolly.tslint.anon.PartialIOptions
import typingsJapgolly.tslint.anon.PartialexcludeArraystring
import typingsJapgolly.tslint.anon.Severity
