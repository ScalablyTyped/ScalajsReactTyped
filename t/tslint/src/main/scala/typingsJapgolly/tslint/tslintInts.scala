...
import typingsJapgolly.tslint.libRulesStrictBooleanExpressionsRuleMod.TypeFailure
import typingsJapgolly.tslint.libRulesStrictComparisonsRuleMod.TypeKind
import typingsJapgolly.tslint.libRunnerMod.Status
