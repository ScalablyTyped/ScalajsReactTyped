...
object libRulesOnlyArrowFunctionsRuleMod {
  
  @JSImport("tslint/lib/rules/onlyArrowFunctionsRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/onlyArrowFunctionsRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/onlyArrowFunctionsRule", "Rule.metadata")
    @js.native
