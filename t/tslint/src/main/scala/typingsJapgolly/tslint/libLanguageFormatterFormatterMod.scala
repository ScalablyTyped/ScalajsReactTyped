...
object libLanguageFormatterFormatterMod {
  ...
  */
  ...
  object ConsumerType {
    ...
    inline def human: typingsJapgolly.tslint.tslintStrings.human = "human".asInstanceOf[typingsJapgolly.tslint.tslintStrings.human]
    
    inline def machine: typingsJapgolly.tslint.tslintStrings.machine = "machine".asInstanceOf[typingsJapgolly.tslint.tslintStrings.machine]
  }
