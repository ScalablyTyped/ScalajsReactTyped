...
import typingsJapgolly.tslint.anon.OptionsAny
import typingsJapgolly.tslint.libLanguageWalkerWalkerMod.IWalker
import typingsJapgolly.tslint.tslintBooleans.`true`
...
object libLanguageRuleRuleMod {
  ...
  object IRule {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1(apply), applyWithWalker = js.Any.fromFunction1(applyWithWalker), getOptions = getOptions.toJsFn, isEnabled = isEnabled.toJsFn)
    ...
    extension [Self <: IRule](x: Self) {
      ...
      inline def setGetOptions(value: CallbackTo[IOptions]): Self = StObject.set(x, "getOptions", value.toJsFn)
  ...
  object ITypedRule {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1(apply), applyWithProgram = js.Any.fromFunction2(applyWithProgram), applyWithWalker = js.Any.fromFunction1(applyWithWalker), getOptions = getOptions.toJsFn, isEnabled = isEnabled.toJsFn)
  ...
  */
  ...
  object RuleSeverity {
    ...
    inline def error: typingsJapgolly.tslint.tslintStrings.error = "error".asInstanceOf[typingsJapgolly.tslint.tslintStrings.error]
    
    inline def off: typingsJapgolly.tslint.tslintStrings.off = "off".asInstanceOf[typingsJapgolly.tslint.tslintStrings.off]
    
    inline def warning: typingsJapgolly.tslint.tslintStrings.warning = "warning".asInstanceOf[typingsJapgolly.tslint.tslintStrings.warning]
  }
  ...
  */
  ...
  object RuleType {
    ...
    inline def formatting: typingsJapgolly.tslint.tslintStrings.formatting = "formatting".asInstanceOf[typingsJapgolly.tslint.tslintStrings.formatting]
    
    inline def functionality: typingsJapgolly.tslint.tslintStrings.functionality = "functionality".asInstanceOf[typingsJapgolly.tslint.tslintStrings.functionality]
    
    inline def maintainability: typingsJapgolly.tslint.tslintStrings.maintainability = "maintainability".asInstanceOf[typingsJapgolly.tslint.tslintStrings.maintainability]
    
    inline def style: typingsJapgolly.tslint.tslintStrings.style = "style".asInstanceOf[typingsJapgolly.tslint.tslintStrings.style]
    
    inline def typescript: typingsJapgolly.tslint.tslintStrings.typescript = "typescript".asInstanceOf[typingsJapgolly.tslint.tslintStrings.typescript]
  }
}
