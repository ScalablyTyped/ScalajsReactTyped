...
object libRulesEncodingRuleMod {
  ...
  object Rule {
    ...
    inline def FAILURE_STRING(actual: Encoding): String = ^.asInstanceOf[js.Dynamic].applyDynamic("FAILURE_STRING")(actual.asInstanceOf[js.Any]).asInstanceOf[String]
