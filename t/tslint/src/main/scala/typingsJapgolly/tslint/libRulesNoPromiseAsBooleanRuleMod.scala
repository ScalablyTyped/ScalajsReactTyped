...
object libRulesNoPromiseAsBooleanRuleMod {
  
  @JSImport("tslint/lib/rules/noPromiseAsBooleanRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noPromiseAsBooleanRule", "Rule.metadata")
    @js.native
