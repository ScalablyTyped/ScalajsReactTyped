...
object libRulesNoEmptyRuleMod {
  
  @JSImport("tslint/lib/rules/noEmptyRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noEmptyRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noEmptyRule", "Rule.metadata")
    @js.native
