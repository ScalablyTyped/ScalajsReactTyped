...
object libRulesNoAsyncWithoutAwaitRuleMod {
  
  @JSImport("tslint/lib/rules/noAsyncWithoutAwaitRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noAsyncWithoutAwaitRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noAsyncWithoutAwaitRule", "Rule.metadata")
    @js.native
