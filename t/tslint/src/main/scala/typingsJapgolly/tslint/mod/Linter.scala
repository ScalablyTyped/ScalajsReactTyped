...
import typingsJapgolly.tslint.FnCall
import typingsJapgolly.tslint.FnCallSuppliedConfigFilePathInputFilePath
import typingsJapgolly.tslint.configurationMod.IConfigurationFile
import typingsJapgolly.tslint.configurationMod.IConfigurationLoadResult
...
class Linter protected ()
  extends typingsJapgolly.tslint.linterMod.Linter {
