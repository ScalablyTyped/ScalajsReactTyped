...
object libRulesBanCommaOperatorRuleMod {
  
  @JSImport("tslint/lib/rules/banCommaOperatorRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/banCommaOperatorRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/banCommaOperatorRule", "Rule.metadata")
    @js.native
