...
object libRulesArrowParensRuleMod {
  ...
  object Rule {
    ...
    inline def FAILURE_STRING_EXISTS_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FAILURE_STRING_EXISTS")(x.asInstanceOf[js.Any])
