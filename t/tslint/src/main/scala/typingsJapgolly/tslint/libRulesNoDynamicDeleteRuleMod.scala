...
object libRulesNoDynamicDeleteRuleMod {
  
  @JSImport("tslint/lib/rules/noDynamicDeleteRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noDynamicDeleteRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noDynamicDeleteRule", "Rule.metadata")
    @js.native
