...
object libRulesNoDefaultExportRuleMod {
  
  @JSImport("tslint/lib/rules/noDefaultExportRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noDefaultExportRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noDefaultExportRule", "Rule.metadata")
    @js.native
