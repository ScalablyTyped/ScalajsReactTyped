...
object libRulesPreferForOfRuleMod {
  
  @JSImport("tslint/lib/rules/preferForOfRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/preferForOfRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/preferForOfRule", "Rule.metadata")
    @js.native
