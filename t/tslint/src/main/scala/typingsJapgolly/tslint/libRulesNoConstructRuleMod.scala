...
object libRulesNoConstructRuleMod {
  
  @JSImport("tslint/lib/rules/noConstructRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noConstructRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noConstructRule", "Rule.metadata")
    @js.native
