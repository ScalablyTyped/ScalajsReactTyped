...
import typingsJapgolly.tslint.libLanguageFormatterFormatterMod.ConsumerType
import typingsJapgolly.tslint.libLanguageRuleRuleMod.RuleSeverity
import typingsJapgolly.tslint.libLanguageRuleRuleMod.RuleType
...
object tslintStrings {
  ...
  sealed trait formatting
    extends StObject
       with RuleType
  inline def formatting: formatting = "formatting".asInstanceOf[formatting]
  
  @js.native
  sealed trait functionality
    extends StObject
       with RuleType
  inline def functionality: functionality = "functionality".asInstanceOf[functionality]
  ...
  sealed trait maintainability
    extends StObject
       with RuleType
  inline def maintainability: maintainability = "maintainability".asInstanceOf[maintainability]
  ...
  sealed trait `utf8-bom`
    extends StObject
       with Encoding
  inline def `utf8-bom`: `utf8-bom` = "utf8-bom".asInstanceOf[`utf8-bom`]
