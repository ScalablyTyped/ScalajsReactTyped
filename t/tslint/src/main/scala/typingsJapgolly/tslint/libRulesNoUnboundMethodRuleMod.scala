...
object libRulesNoUnboundMethodRuleMod {
  
  @JSImport("tslint/lib/rules/noUnboundMethodRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noUnboundMethodRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noUnboundMethodRule", "Rule.metadata")
    @js.native
