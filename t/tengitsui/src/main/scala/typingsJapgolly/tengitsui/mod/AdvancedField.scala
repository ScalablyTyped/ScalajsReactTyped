...
import typingsJapgolly.tengitsui.tengitsuiStrings.left
import typingsJapgolly.tengitsui.tengitsuiStrings.right
...
object AdvancedField {
  ...
  extension [Self <: AdvancedField](x: Self) {
    ...
    inline def setVisibleFunction1(value: /* params */ typingsJapgolly.tengitsui.anon.Fields => Boolean): Self = StObject.set(x, "visible", js.Any.fromFunction1(value))
