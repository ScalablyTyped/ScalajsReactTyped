...
trait Field extends StObject {
  ...
  var optionCompute: js.UndefOr[typingsJapgolly.tengitsui.mod.optionCompute] = js.undefined
...
object Field {
  ...
  extension [Self <: Field](x: Self) {
    ...
    inline def setVisible(value: /* params */ typingsJapgolly.tengitsui.anon.Fields => Boolean): Self = StObject.set(x, "visible", js.Any.fromFunction1(value))
