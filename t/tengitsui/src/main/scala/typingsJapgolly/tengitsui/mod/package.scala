...
import typingsJapgolly.tengitsui.mod.^
import typingsJapgolly.tengitsui.tengitsuiStrings.multiple
...
type visibleFnc = js.Function1[/* params */ typingsJapgolly.tengitsui.anon.Fields, Boolean]
