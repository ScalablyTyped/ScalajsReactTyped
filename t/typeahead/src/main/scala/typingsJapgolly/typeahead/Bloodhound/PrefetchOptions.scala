...
object PrefetchOptions {
  ...
  def apply[T](
    ...
    prepare: /* settings */ JQueryAjaxSettings => CallbackTo[JQueryAjaxSettings] = null,
    ...
    if (prepare != null) __obj.updateDynamic("prepare")(js.Any.fromFunction1((t0: /* settings */ typingsJapgolly.jquery.JQueryAjaxSettings) => prepare(t0).runNow()))
