...
object RemoteOptions {
  ...
  def apply[T](
    url: String,
    filter: /* response */ T => CallbackTo[T] = null,
    prepare: (/* query */ String, /* settings */ JQueryAjaxSettings) => CallbackTo[JQueryAjaxSettings] = null,
    rateLimitWait: Int | Double = null,
    rateLimitby: String = null,
    transform: /* response */ T => CallbackTo[T] = null,
    wildcard: String = null
  ): RemoteOptions[T] = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction1((t0: /* response */ T) => filter(t0).runNow()))
    if (prepare != null) __obj.updateDynamic("prepare")(js.Any.fromFunction2((t0: /* query */ java.lang.String, t1: /* settings */ typingsJapgolly.jquery.JQueryAjaxSettings) => prepare(t0, t1).runNow()))
    ...
    if (transform != null) __obj.updateDynamic("transform")(js.Any.fromFunction1((t0: /* response */ T) => transform(t0).runNow()))
