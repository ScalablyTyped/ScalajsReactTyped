...
object Templates {
  ...
  def apply[T](
    ...
    suggestion: /* suggestion */ T => CallbackTo[String] = null
  ): Templates[T] = {
    ...
    if (suggestion != null) __obj.updateDynamic("suggestion")(js.Any.fromFunction1((t0: /* suggestion */ T) => suggestion(t0).runNow()))
