package typingsJapgolly.traceparent
...
object mod {
  ...
  object TraceParent {
    ...
    inline def apply(
      child: CallbackTo[TraceParent],
      ensureParentId: CallbackTo[String],
      flags: String,
      id: String,
      recorded: Boolean,
      traceId: String,
      ...
      val __obj = js.Dynamic.literal(child = child.toJsFn, ensureParentId = ensureParentId.toJsFn, flags = flags.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], recorded = recorded.asInstanceOf[js.Any], traceId = traceId.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
      __obj.asInstanceOf[TraceParent]
    }
    
    extension [Self <: TraceParent](x: Self) {
      
      inline def setChild(value: CallbackTo[TraceParent]): Self = StObject.set(x, "child", value.toJsFn)
      
      inline def setEnsureParentId(value: CallbackTo[String]): Self = StObject.set(x, "ensureParentId", value.toJsFn)
