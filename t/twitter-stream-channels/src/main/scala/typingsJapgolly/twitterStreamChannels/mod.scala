...
import typingsJapgolly.twitterStreamChannels.anon.RemoveAllListeners
import typingsJapgolly.twitterStreamChannels.mod.StreamChannels.Channels
...
object mod {
  ...
  open class ^ protected ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getApiClient(): typingsJapgolly.twit.mod.^ = js.native
  ...
  open class StreamChannels protected () extends EventEmitter {
    /**
      ...
      */
    def this(apiClient: typingsJapgolly.twit.mod.^, options: StreamChannelsOptions) = this()
  ...
  object TwitterStreamChannels {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getApiClient = getApiClient.toJsFn, streamChannels = js.Any.fromFunction1(streamChannels))
      __obj.asInstanceOf[TwitterStreamChannels]
    }
    
    extension [Self <: TwitterStreamChannels](x: Self) {
      
      inline def setGetApiClient(value: CallbackTo[typingsJapgolly.twit.mod.^]): Self = StObject.set(x, "getApiClient", value.toJsFn)
