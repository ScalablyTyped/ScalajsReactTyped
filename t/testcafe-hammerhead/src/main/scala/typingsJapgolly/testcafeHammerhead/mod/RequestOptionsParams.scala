...
import typingsJapgolly.testcafeHammerhead.Credentials
import typingsJapgolly.testcafeHammerhead.ExternalProxySettings
import typingsJapgolly.testcafeHammerhead.RequestTimeout
