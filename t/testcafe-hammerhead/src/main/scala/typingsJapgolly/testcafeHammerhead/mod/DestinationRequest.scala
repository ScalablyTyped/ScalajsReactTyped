...
import typingsJapgolly.testcafeHammerhead.testcafeHammerheadStrings.error
import typingsJapgolly.testcafeHammerhead.testcafeHammerheadStrings.fatalError
import typingsJapgolly.testcafeHammerhead.testcafeHammerheadStrings.response
