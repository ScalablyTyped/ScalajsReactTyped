...
object distSrcMultimapMod {
  ...
  object CollectionOperator {
    ...
    inline def apply[V, I](
      ...
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction2(add), create = create.toJsFn, delete = js.Any.fromFunction2(delete), has = js.Any.fromFunction2(has), size = js.Any.fromFunction1(size))
    ...
    extension [Self <: CollectionOperator[?, ?], V, I](x: Self & (CollectionOperator[V, I])) {
      ...
      inline def setCreate(value: CallbackTo[I]): Self = StObject.set(x, "create", value.toJsFn)
