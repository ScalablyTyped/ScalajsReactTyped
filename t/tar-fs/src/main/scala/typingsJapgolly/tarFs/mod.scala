...
object mod {
  ...
  inline def extract(cwd: String): typingsJapgolly.tarStream.mod.Extract_ = ^.asInstanceOf[js.Dynamic].applyDynamic("extract")(cwd.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.tarStream.mod.Extract_]
  inline def extract(cwd: String, opts: ExtractOptions): typingsJapgolly.tarStream.mod.Extract_ = (^.asInstanceOf[js.Dynamic].applyDynamic("extract")(cwd.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.tarStream.mod.Extract_]
  
  inline def pack(cwd: String): typingsJapgolly.tarStream.mod.Pack_ = ^.asInstanceOf[js.Dynamic].applyDynamic("pack")(cwd.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.tarStream.mod.Pack_]
  inline def pack(cwd: String, opts: PackOptions): typingsJapgolly.tarStream.mod.Pack_ = (^.asInstanceOf[js.Dynamic].applyDynamic("pack")(cwd.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.tarStream.mod.Pack_]
  ...
  type Extract_ = typingsJapgolly.tarStream.mod.Extract_
  ...
  trait PackOptions
    ...
    var finish: js.UndefOr[js.Function1[/* pack */ typingsJapgolly.tarStream.mod.Pack_, Unit]] = js.undefined
    
    var pack: js.UndefOr[typingsJapgolly.tarStream.mod.Pack_] = js.undefined
  }
  object PackOptions {
    ...
    extension [Self <: PackOptions](x: Self) {
      ...
      inline def setFinish(value: /* pack */ typingsJapgolly.tarStream.mod.Pack_ => Callback): Self = StObject.set(x, "finish", js.Any.fromFunction1((t0: /* pack */ typingsJapgolly.tarStream.mod.Pack_) => value(t0).runNow()))
      
      inline def setFinishUndefined: Self = StObject.set(x, "finish", js.undefined)
      
      inline def setPack(value: typingsJapgolly.tarStream.mod.Pack_): Self = StObject.set(x, "pack", value.asInstanceOf[js.Any])
      
      inline def setPackUndefined: Self = StObject.set(x, "pack", js.undefined)
    }
  }
  
  type Pack_ = typingsJapgolly.tarStream.mod.Pack_
}
