...
import typingsJapgolly.jquery.JQuery.ClickEvent
import typingsJapgolly.toastr.anon.Error
...
object ToastrOptions {
  ...
  extension [Self <: ToastrOptions](x: Self) {
    ...
    inline def setOnCloseClick(value: /* ev */ ClickEvent[Any, Any, Any, Any] => Callback): Self = StObject.set(x, "onCloseClick", js.Any.fromFunction1((t0: /* ev */ ClickEvent[Any, Any, Any, Any]) => value(t0).runNow()))
    ...
    inline def setOnShown(value: Callback): Self = StObject.set(x, "onShown", value.toJsFn)
    
    inline def setOnShownUndefined: Self = StObject.set(x, "onShown", js.undefined)
    
    inline def setOnclick(value: /* ev */ ClickEvent[Any, Any, Any, Any] => Callback): Self = StObject.set(x, "onclick", js.Any.fromFunction1((t0: /* ev */ ClickEvent[Any, Any, Any, Any]) => value(t0).runNow()))
