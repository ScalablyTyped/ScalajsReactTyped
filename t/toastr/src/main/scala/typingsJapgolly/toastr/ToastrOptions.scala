...
object ToastrOptions {
  ...
  def apply(
    ...
    onCloseClick: /* ev */ JQueryMouseEventObject => Callback = null,
    onHidden: js.UndefOr[Callback] = js.undefined,
    onShown: js.UndefOr[Callback] = js.undefined,
    onclick: /* ev */ JQueryMouseEventObject => Callback = null,
    ...
    if (onCloseClick != null) __obj.updateDynamic("onCloseClick")(js.Any.fromFunction1((t0: /* ev */ typingsJapgolly.jquery.JQueryMouseEventObject) => onCloseClick(t0).runNow()))
    onHidden.foreach(p => __obj.updateDynamic("onHidden")(p.toJsFn))
    onShown.foreach(p => __obj.updateDynamic("onShown")(p.toJsFn))
    if (onclick != null) __obj.updateDynamic("onclick")(js.Any.fromFunction1((t0: /* ev */ typingsJapgolly.jquery.JQueryMouseEventObject) => onclick(t0).runNow()))
