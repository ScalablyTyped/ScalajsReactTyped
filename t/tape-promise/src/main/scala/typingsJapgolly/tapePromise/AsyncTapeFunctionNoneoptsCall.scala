...
trait AsyncTapeFunctionNoneoptsCall extends js.Object {
  ...
  def createHarness_Any(): js.Any = js.native
  ...
  def only(cb: TestCase | typingsJapgolly.tapePromise.mod.TestCase): Unit = js.native
  /**
  	 ...
  	 */
  def only(name: String, cb: TestCase | typingsJapgolly.tapePromise.mod.TestCase): Unit = js.native
  def only(name: String, opts: TestOptions, cb: TestCase | typingsJapgolly.tapePromise.mod.TestCase): Unit = js.native
  def only(opts: TestOptions, cb: TestCase | typingsJapgolly.tapePromise.mod.TestCase): Unit = js.native
  def skip(cb: TestCase | typingsJapgolly.tapePromise.mod.TestCase): Unit = js.native
  /**
  	 * Generate a new test that will be skipped over.
  	 */
  def skip(name: String, cb: TestCase | typingsJapgolly.tapePromise.mod.TestCase): Unit = js.native
  def skip(name: String, opts: TestOptions, cb: TestCase | typingsJapgolly.tapePromise.mod.TestCase): Unit = js.native
  def skip(opts: TestOptions, cb: TestCase | typingsJapgolly.tapePromise.mod.TestCase): Unit = js.native
}
