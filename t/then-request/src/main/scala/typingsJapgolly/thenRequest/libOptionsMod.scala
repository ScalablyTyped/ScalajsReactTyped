...
import typingsJapgolly.thenRequest.thenRequestStrings.file
import typingsJapgolly.thenRequest.thenRequestStrings.memory
...
object libOptionsMod {
  ...
  trait Options extends StObject {
    ...
    var form: js.UndefOr[typingsJapgolly.formData.mod.^] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setForm(value: typingsJapgolly.formData.mod.^): Self = StObject.set(x, "form", value.asInstanceOf[js.Any])
