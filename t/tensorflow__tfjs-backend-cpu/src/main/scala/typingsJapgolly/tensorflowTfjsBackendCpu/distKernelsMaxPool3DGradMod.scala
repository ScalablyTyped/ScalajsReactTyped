...
import typingsJapgolly.tensorflowTfjsBackendCpu.anon.AttrsMaxPool3DGradAttrs
...
object distKernelsMaxPool3DGradMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/MaxPool3DGrad", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/MaxPool3DGrad", "maxPool3DGradConfig")
  @js.native
