...
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.CropAndResizeAttrs
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.CropAndResizeInputs
