...
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.TransformAttrs
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.TransformInputs
