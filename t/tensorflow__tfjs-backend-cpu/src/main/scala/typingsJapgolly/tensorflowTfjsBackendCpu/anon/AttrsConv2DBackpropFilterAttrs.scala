...
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.Conv2DBackpropFilterAttrs
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.Conv2DBackpropFilterInputs
