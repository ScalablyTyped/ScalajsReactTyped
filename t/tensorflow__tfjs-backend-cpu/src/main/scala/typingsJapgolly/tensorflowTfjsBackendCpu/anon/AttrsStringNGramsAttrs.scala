...
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.StringNGramsAttrs
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.StringNGramsInputs
