...
import typingsJapgolly.tensorflowTfjsBackendCpu.anon.AttrsRaggedTensorToTensorAttrs
...
object distKernelsRaggedTensorToTensorMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/RaggedTensorToTensor", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/RaggedTensorToTensor", "raggedTensorToTensorConfig")
  @js.native
