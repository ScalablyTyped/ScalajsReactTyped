...
import typingsJapgolly.tokeyCore.anon.End
import typingsJapgolly.tokeyCore.anon.Start
import typingsJapgolly.tokeyCore.distCoreMod.TokyOptions
import typingsJapgolly.tokeyCore.distTypesMod.Token
import typingsJapgolly.tokeyCore.tokeyCoreStrings._empty
import typingsJapgolly.tokeyCore.tokeyCoreStrings.`line-comment`
import typingsJapgolly.tokeyCore.tokeyCoreStrings.`multi-comment`
import typingsJapgolly.tokeyCore.tokeyCoreStrings.`unclosed-comment`
...
object mod {
  ...
  open class Seeker[T /* <: Token[Any] */] protected ()
    extends typingsJapgolly.tokeyCore.distSeekerMod.Seeker[T] {
