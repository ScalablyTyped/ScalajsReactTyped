package typingsJapgolly.typedJs.mod
...
object TypedOptions {
  ...
  def apply(
    ...
    onComplete: /* self */ Typed => Callback = null,
    onDestroy: /* self */ Typed => Callback = null,
    onLastStringBackspaced: /* self */ Typed => Callback = null,
    onReset: /* self */ Typed => Callback = null,
    onStart: (/* arrayPos */ Double, /* self */ Typed) => Callback = null,
    onStop: (/* arrayPos */ Double, /* self */ Typed) => Callback = null,
    onStringTyped: (/* arrayPos */ Double, /* self */ Typed) => Callback = null,
    onTypingPaused: (/* arrayPos */ Double, /* self */ Typed) => Callback = null,
    onTypingResumed: (/* arrayPos */ Double, /* self */ Typed) => Callback = null,
    preStringTyped: (/* arrayPos */ Double, /* self */ Typed) => Callback = null,
    ...
    if (onComplete != null) __obj.updateDynamic("onComplete")(js.Any.fromFunction1((t0: /* self */ typingsJapgolly.typedJs.mod.Typed) => onComplete(t0).runNow()))
    if (onDestroy != null) __obj.updateDynamic("onDestroy")(js.Any.fromFunction1((t0: /* self */ typingsJapgolly.typedJs.mod.Typed) => onDestroy(t0).runNow()))
    if (onLastStringBackspaced != null) __obj.updateDynamic("onLastStringBackspaced")(js.Any.fromFunction1((t0: /* self */ typingsJapgolly.typedJs.mod.Typed) => onLastStringBackspaced(t0).runNow()))
    if (onReset != null) __obj.updateDynamic("onReset")(js.Any.fromFunction1((t0: /* self */ typingsJapgolly.typedJs.mod.Typed) => onReset(t0).runNow()))
    if (onStart != null) __obj.updateDynamic("onStart")(js.Any.fromFunction2((t0: /* arrayPos */ scala.Double, t1: /* self */ typingsJapgolly.typedJs.mod.Typed) => onStart(t0, t1).runNow()))
    if (onStop != null) __obj.updateDynamic("onStop")(js.Any.fromFunction2((t0: /* arrayPos */ scala.Double, t1: /* self */ typingsJapgolly.typedJs.mod.Typed) => onStop(t0, t1).runNow()))
    if (onStringTyped != null) __obj.updateDynamic("onStringTyped")(js.Any.fromFunction2((t0: /* arrayPos */ scala.Double, t1: /* self */ typingsJapgolly.typedJs.mod.Typed) => onStringTyped(t0, t1).runNow()))
    if (onTypingPaused != null) __obj.updateDynamic("onTypingPaused")(js.Any.fromFunction2((t0: /* arrayPos */ scala.Double, t1: /* self */ typingsJapgolly.typedJs.mod.Typed) => onTypingPaused(t0, t1).runNow()))
    if (onTypingResumed != null) __obj.updateDynamic("onTypingResumed")(js.Any.fromFunction2((t0: /* arrayPos */ scala.Double, t1: /* self */ typingsJapgolly.typedJs.mod.Typed) => onTypingResumed(t0, t1).runNow()))
    if (preStringTyped != null) __obj.updateDynamic("preStringTyped")(js.Any.fromFunction2((t0: /* arrayPos */ scala.Double, t1: /* self */ typingsJapgolly.typedJs.mod.Typed) => preStringTyped(t0, t1).runNow()))
