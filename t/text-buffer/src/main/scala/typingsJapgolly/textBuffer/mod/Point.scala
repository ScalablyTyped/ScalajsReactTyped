...
open class Point ()
  extends StObject
     with typingsJapgolly.textBuffer.mod.global.TextBuffer.Point {
  ...
  /* CompleteClass */
  override def copy(): typingsJapgolly.textBuffer.mod.global.TextBuffer.Point = js.native
  ...
  /* CompleteClass */
  override def negate(): typingsJapgolly.textBuffer.mod.global.TextBuffer.Point = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def translate(other: PointCompatible): typingsJapgolly.textBuffer.mod.global.TextBuffer.Point = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def traverse(other: PointCompatible): typingsJapgolly.textBuffer.mod.global.TextBuffer.Point = js.native
}
