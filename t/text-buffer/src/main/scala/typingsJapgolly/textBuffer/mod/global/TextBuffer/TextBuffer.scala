...
import typingsJapgolly.textBuffer.anon.MaintainHistory
import typingsJapgolly.textBuffer.anon.NewExtent
import typingsJapgolly.textBuffer.anon.NormalizeLineEndings
import typingsJapgolly.textBuffer.mod.global.TextBuffer.Events.BufferChanged
import typingsJapgolly.textBuffer.mod.global.TextBuffer.Events.BufferChanging
import typingsJapgolly.textBuffer.mod.global.TextBuffer.Events.BufferStoppedChanging
import typingsJapgolly.textBuffer.mod.global.TextBuffer.Events.BufferWatchError
import typingsJapgolly.textBuffer.mod.global.TextBuffer.Events.FileSaved
import typingsJapgolly.textBuffer.mod.global.TextBuffer.Options.FindMarker
import typingsJapgolly.textBuffer.mod.global.TextBuffer.Options.ScanContext
import typingsJapgolly.textBuffer.mod.global.TextBuffer.Structures.BufferScanResult
import typingsJapgolly.textBuffer.mod.global.TextBuffer.Structures.ContextualBufferScanResult
...
trait TextBuffer extends StObject {
  ...
  def release(): typingsJapgolly.textBuffer.mod.global.TextBuffer.TextBuffer = js.native
  ...
  def retain(): typingsJapgolly.textBuffer.mod.global.TextBuffer.TextBuffer = js.native
