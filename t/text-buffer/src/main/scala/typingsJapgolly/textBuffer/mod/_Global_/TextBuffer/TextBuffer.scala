...
import typingsJapgolly.pathwatcher.mod.File
import typingsJapgolly.textBuffer.AnonExclusiveInvalidate
import typingsJapgolly.textBuffer.AnonInvalidate
import typingsJapgolly.textBuffer.AnonMaintainHistory
import typingsJapgolly.textBuffer.AnonNewExtent
import typingsJapgolly.textBuffer.AnonNormalizeLineEndings
import typingsJapgolly.textBuffer.mod._Global_.TextBuffer.Events.BufferChanged
import typingsJapgolly.textBuffer.mod._Global_.TextBuffer.Events.BufferChanging
import typingsJapgolly.textBuffer.mod._Global_.TextBuffer.Events.BufferStoppedChanging
import typingsJapgolly.textBuffer.mod._Global_.TextBuffer.Events.BufferWatchError
import typingsJapgolly.textBuffer.mod._Global_.TextBuffer.Events.FileSaved
import typingsJapgolly.textBuffer.mod._Global_.TextBuffer.Options.FindMarker
import typingsJapgolly.textBuffer.mod._Global_.TextBuffer.Options.ScanContext
import typingsJapgolly.textBuffer.mod._Global_.TextBuffer.Structures.BufferScanResult
import typingsJapgolly.textBuffer.mod._Global_.TextBuffer.Structures.ContextualBufferScanResult
...
trait TextBuffer extends js.Object {
  ...
  def release(): typingsJapgolly.textBuffer.mod._Global_.TextBuffer.TextBuffer = js.native
  ...
  def retain(): typingsJapgolly.textBuffer.mod._Global_.TextBuffer.TextBuffer = js.native
  /**
