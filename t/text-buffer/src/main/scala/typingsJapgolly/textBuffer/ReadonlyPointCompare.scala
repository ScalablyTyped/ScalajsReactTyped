...
object ReadonlyPointCompare {
  ...
  def apply(
    ...
    copy: CallbackTo[ReadonlyPointCompare],
    freeze: CallbackTo[ReadonlyPointColumn],
    ...
    negate: CallbackTo[ReadonlyPointCompare],
    row: Double,
    serialize: CallbackTo[js.Tuple2[Double, Double]],
    toArray: CallbackTo[js.Tuple2[Double, Double]],
    translate: PointCompatible => CallbackTo[ReadonlyPointCompare],
    traverse: PointCompatible => CallbackTo[ReadonlyPointCompare]
