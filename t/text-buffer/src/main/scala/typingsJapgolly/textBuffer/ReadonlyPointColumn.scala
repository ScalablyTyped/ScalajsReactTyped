...
object ReadonlyPointColumn {
  ...
  def apply(
    ...
    copy: CallbackTo[ReadonlyPointColumn],
    ...
    negate: CallbackTo[ReadonlyPointColumn],
    row: Double,
    serialize: CallbackTo[js.Tuple2[Double, Double]],
    toArray: CallbackTo[js.Tuple2[Double, Double]],
    translate: PointCompatible => CallbackTo[ReadonlyPointColumn],
    traverse: PointCompatible => CallbackTo[ReadonlyPointColumn]
  ): ReadonlyPointColumn = {
