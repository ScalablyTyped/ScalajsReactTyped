...
import typingsJapgolly.typedRestClient.anon.ArrayFormat
...
object interfacesMod {
  ...
  object IHttpClientResponse {
    ...
    inline def apply(message: IncomingMessage, readBody: CallbackTo[js.Promise[String]]): IHttpClientResponse = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], readBody = readBody.toJsFn)
    ...
    extension [Self <: IHttpClientResponse](x: Self) {
      ...
      inline def setReadBody(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "readBody", value.toJsFn)
    }
  }
  ...
  object IRequestHandler {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(canHandleAuthentication = js.Any.fromFunction1(canHandleAuthentication), handleAuthentication = js.Any.fromFunction3(handleAuthentication), prepareRequest = js.Any.fromFunction1((t0: RequestOptions) => prepareRequest(t0).runNow()))
    ...
    extension [Self <: IRequestHandler](x: Self) {
      ...
      inline def setPrepareRequest(value: RequestOptions => Callback): Self = StObject.set(x, "prepareRequest", js.Any.fromFunction1((t0: RequestOptions) => value(t0).runNow()))
    }
  }
