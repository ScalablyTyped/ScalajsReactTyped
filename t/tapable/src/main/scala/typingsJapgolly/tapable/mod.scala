...
import typingsJapgolly.tapable.tapableBooleans.`false`
import typingsJapgolly.tapable.tapableBooleans.`true`
import typingsJapgolly.tapable.tapableStrings.async
import typingsJapgolly.tapable.tapableStrings.call
import typingsJapgolly.tapable.tapableStrings.callAsync
import typingsJapgolly.tapable.tapableStrings.promise
import typingsJapgolly.tapable.tapableStrings.sync
...
object mod {
  ...
  object HookInterceptor {
    ...
    extension [Self <: HookInterceptor[?, ?, ?], T, R, AdditionalOptions](x: Self & (HookInterceptor[T, R, AdditionalOptions])) {
      ...
      inline def setCall(value: /* repeated */ Any => japgolly.scalajs.react.Callback): Self = StObject.set(x, "call", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      
      inline def setCallUndefined: Self = StObject.set(x, "call", js.undefined)
      
      inline def setDone(value: japgolly.scalajs.react.Callback): Self = StObject.set(x, "done", value.toJsFn)
      
      inline def setDoneUndefined: Self = StObject.set(x, "done", js.undefined)
      
      inline def setError(value: /* err */ js.Error => japgolly.scalajs.react.Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* err */ js.Error) => value(t0).runNow()))
      
      inline def setErrorUndefined: Self = StObject.set(x, "error", js.undefined)
      
      inline def setLoop(value: /* repeated */ Any => japgolly.scalajs.react.Callback): Self = StObject.set(x, "loop", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      ...
      inline def setResult(value: /* result */ R => japgolly.scalajs.react.Callback): Self = StObject.set(x, "result", js.Any.fromFunction1((t0: /* result */ R) => value(t0).runNow()))
      
      inline def setResultUndefined: Self = StObject.set(x, "result", js.undefined)
      
      inline def setTap(value: /* tap */ FullTap & IfSet[AdditionalOptions] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "tap", js.Any.fromFunction1((t0: /* tap */ FullTap & IfSet[AdditionalOptions]) => value(t0).runNow()))
