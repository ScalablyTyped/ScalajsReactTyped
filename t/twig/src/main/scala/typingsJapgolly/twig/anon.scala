...
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDot_function
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotarrayDotend
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotarrayDotstart
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotbool
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotcomma
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotcontext
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotfilter
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotkeyDotbrackets
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotkeyDotperiod
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotnull
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotnumber
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotobjectDotend
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotobjectDotstart
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotoperatorDotbinary
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotoperatorDotunary
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotparameterDotend
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotparameterDotstart
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotslice
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotstring
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotsubexpressionDotend
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotsubexpressionDotstart
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDottest
import typingsJapgolly.twig.twigStrings.TwigDotexpressionDottypeDotvariable
import typingsJapgolly.twig.twigStrings.value
...
object anon {
  ...
  object Cache {
    ...
    inline def apply(
      __express: (/* path */ String, /* options */ CompileOptions, /* fn */ js.Function2[/* err */ js.Error, /* result */ Any, Unit]) => Callback,
      cache: /* value */ Boolean => Callback,
      compile: (/* markup */ String, /* options */ CompileOptions) => js.Function1[/* context */ Any, Any],
      extend: /* extension */ js.Function1[Cache, Unit] => Callback,
      extendFilter: (/* name */ String, /* definition */ js.Function2[/* left */ Any, /* params */ js.Array[Any] | `false`, String]) => Callback,
      extendFunction: (/* name */ String, /* definition */ js.Function1[/* repeated */ Any, String]) => Callback,
      extendTag: /* definition */ ExtendTagOptions => Callback,
      extendTest: (/* name */ String, /* definition */ js.Function1[/* value */ Any, Boolean]) => Callback,
      renderFile: FnCall,
      twig: /* params */ Parameters => Template
    ): Cache = {
      val __obj = js.Dynamic.literal(__express = js.Any.fromFunction3((t0: /* path */ String, t1: /* options */ CompileOptions, t2: /* fn */ js.Function2[/* err */ js.Error, /* result */ Any, Unit]) => (__express(t0, t1, t2)).runNow()), cache = js.Any.fromFunction1((t0: /* value */ Boolean) => cache(t0).runNow()), compile = js.Any.fromFunction2(compile), extend = js.Any.fromFunction1((t0: /* extension */ js.Function1[Cache, Unit]) => extend(t0).runNow()), extendFilter = js.Any.fromFunction2((t0: /* name */ String, t1: /* definition */ js.Function2[/* left */ Any, /* params */ js.Array[Any] | `false`, String]) => (extendFilter(t0, t1)).runNow()), extendFunction = js.Any.fromFunction2((t0: /* name */ String, t1: /* definition */ js.Function1[/* repeated */ Any, String]) => (extendFunction(t0, t1)).runNow()), extendTag = js.Any.fromFunction1((t0: /* definition */ ExtendTagOptions) => extendTag(t0).runNow()), extendTest = js.Any.fromFunction2((t0: /* name */ String, t1: /* definition */ js.Function1[/* value */ Any, Boolean]) => (extendTest(t0, t1)).runNow()), renderFile = renderFile.asInstanceOf[js.Any], twig = js.Any.fromFunction1(twig))
      __obj.asInstanceOf[Cache]
    }
    
    extension [Self <: Cache](x: Self) {
      
      inline def setCache(value: /* value */ Boolean => Callback): Self = StObject.set(x, "cache", js.Any.fromFunction1((t0: /* value */ Boolean) => value(t0).runNow()))
      ...
      inline def setExtend(value: /* extension */ js.Function1[Cache, Unit] => Callback): Self = StObject.set(x, "extend", js.Any.fromFunction1((t0: /* extension */ js.Function1[Cache, Unit]) => value(t0).runNow()))
      
      inline def setExtendFilter(
        value: (/* name */ String, /* definition */ js.Function2[/* left */ Any, /* params */ js.Array[Any] | `false`, String]) => Callback
      ): Self = StObject.set(x, "extendFilter", js.Any.fromFunction2((t0: /* name */ String, t1: /* definition */ js.Function2[/* left */ Any, /* params */ js.Array[Any] | `false`, String]) => (value(t0, t1)).runNow()))
      
      inline def setExtendFunction(value: (/* name */ String, /* definition */ js.Function1[/* repeated */ Any, String]) => Callback): Self = StObject.set(x, "extendFunction", js.Any.fromFunction2((t0: /* name */ String, t1: /* definition */ js.Function1[/* repeated */ Any, String]) => (value(t0, t1)).runNow()))
      
      inline def setExtendTag(value: /* definition */ ExtendTagOptions => Callback): Self = StObject.set(x, "extendTag", js.Any.fromFunction1((t0: /* definition */ ExtendTagOptions) => value(t0).runNow()))
      
      inline def setExtendTest(value: (/* name */ String, /* definition */ js.Function1[/* value */ Any, Boolean]) => Callback): Self = StObject.set(x, "extendTest", js.Any.fromFunction2((t0: /* name */ String, t1: /* definition */ js.Function1[/* value */ Any, Boolean]) => (value(t0, t1)).runNow()))
      ...
      inline def set__express(
        value: (/* path */ String, /* options */ CompileOptions, /* fn */ js.Function2[/* err */ js.Error, /* result */ Any, Unit]) => Callback
      ): Self = StObject.set(x, "__express", js.Any.fromFunction3((t0: /* path */ String, t1: /* options */ CompileOptions, t2: /* fn */ js.Function2[/* err */ js.Error, /* result */ Any, Unit]) => (value(t0, t1, t2)).runNow()))
    }
  }
