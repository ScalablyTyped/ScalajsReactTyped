package typingsJapgolly.twitterText

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.twitterText.anon.End
import typingsJapgolly.twitterText.anon.ExtractUrlsWithoutProtocol
import typingsJapgolly.twitterText.anon.Tag
...
object mod {
  ...
  object AutoLinkOptions {
    ...
    extension [Self <: AutoLinkOptions](x: Self) {
      ...
      inline def setLinkAttributeBlock(value: (/* entity */ EntityWithIndices, /* attributes */ Attributes) => Callback): Self = StObject.set(x, "linkAttributeBlock", js.Any.fromFunction2((t0: /* entity */ EntityWithIndices, t1: /* attributes */ Attributes) => (value(t0, t1)).runNow()))
      
      inline def setLinkAttributeBlockUndefined: Self = StObject.set(x, "linkAttributeBlock", js.undefined)
      
      inline def setLinkTextBlock(value: (/* entity */ EntityWithIndices, /* text */ String) => Callback): Self = StObject.set(x, "linkTextBlock", js.Any.fromFunction2((t0: /* entity */ EntityWithIndices, t1: /* text */ String) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.twitterText.mod.HashtagWithIndices
    - typingsJapgolly.twitterText.mod.UrlWithIndices
    - typingsJapgolly.twitterText.mod.MentionWithIndices
    - typingsJapgolly.twitterText.mod.MentionOrListWithIndices
    - typingsJapgolly.twitterText.mod.CashtagWithIndices
  */
  trait EntityWithIndices extends StObject
  object EntityWithIndices {
    
    inline def CashtagWithIndices(cashtag: String, indices: js.Tuple2[Double, Double]): typingsJapgolly.twitterText.mod.CashtagWithIndices = {
      val __obj = js.Dynamic.literal(cashtag = cashtag.asInstanceOf[js.Any], indices = indices.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.twitterText.mod.CashtagWithIndices]
    }
    
    inline def HashtagWithIndices(hashtag: String, indices: js.Tuple2[Double, Double]): typingsJapgolly.twitterText.mod.HashtagWithIndices = {
      val __obj = js.Dynamic.literal(hashtag = hashtag.asInstanceOf[js.Any], indices = indices.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.twitterText.mod.HashtagWithIndices]
    }
    
    inline def MentionOrListWithIndices(indices: js.Tuple2[Double, Double], listSlug: String, screenName: String): typingsJapgolly.twitterText.mod.MentionOrListWithIndices = {
      ...
      __obj.asInstanceOf[typingsJapgolly.twitterText.mod.MentionOrListWithIndices]
    }
    
    inline def MentionWithIndices(indices: js.Tuple2[Double, Double], screenName: String): typingsJapgolly.twitterText.mod.MentionWithIndices = {
      val __obj = js.Dynamic.literal(indices = indices.asInstanceOf[js.Any], screenName = screenName.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.twitterText.mod.MentionWithIndices]
    }
    
    inline def UrlWithIndices(indices: js.Tuple2[Double, Double], url: String): typingsJapgolly.twitterText.mod.UrlWithIndices = {
      val __obj = js.Dynamic.literal(indices = indices.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.twitterText.mod.UrlWithIndices]
    }
  }
