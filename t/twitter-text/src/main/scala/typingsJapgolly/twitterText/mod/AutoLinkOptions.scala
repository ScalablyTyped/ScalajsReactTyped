...
object AutoLinkOptions {
  ...
  def apply(
    ...
    linkAttributeBlock: (/* entity */ EntityWithIndices, /* attributes */ Attributes) => Callback = null,
    linkTextBlock: (/* entity */ EntityWithIndices, /* text */ String) => Callback = null,
    ...
    if (linkAttributeBlock != null) __obj.updateDynamic("linkAttributeBlock")(js.Any.fromFunction2((t0: /* entity */ typingsJapgolly.twitterText.mod.EntityWithIndices, t1: /* attributes */ typingsJapgolly.twitterText.mod.Attributes) => linkAttributeBlock(t0, t1).runNow()))
    if (linkTextBlock != null) __obj.updateDynamic("linkTextBlock")(js.Any.fromFunction2((t0: /* entity */ typingsJapgolly.twitterText.mod.EntityWithIndices, t1: /* text */ java.lang.String) => linkTextBlock(t0, t1).runNow()))
