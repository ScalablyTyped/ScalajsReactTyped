...
import typingsJapgolly.csstype.mod.StandardPropertiesFallback
import typingsJapgolly.csstype.mod.VendorPropertiesHyphenFallback
import typingsJapgolly.std.NonNullable
import typingsJapgolly.std.Record
import typingsJapgolly.typestyle.typestyleInts.`0`
import typingsJapgolly.typestyle.typestyleStrings.all
import typingsJapgolly.typestyle.typestyleStrings.dark
import typingsJapgolly.typestyle.typestyleStrings.landscape
import typingsJapgolly.typestyle.typestyleStrings.light
import typingsJapgolly.typestyle.typestyleStrings.portrait
import typingsJapgolly.typestyle.typestyleStrings.print
import typingsJapgolly.typestyle.typestyleStrings.screen
