...
object IAxis {
  ...
  extension [Self <: IAxis](x: Self) {
    ...
    inline def setHasAnySeries(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasAnySeries", value.toJsFn)
    ...
    inline def setScroll(value: Double => Callback): Self = StObject.set(x, "scroll", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    
    inline def setSetMinMax(value: (Double, Double) => Callback): Self = StObject.set(x, "setMinMax", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
