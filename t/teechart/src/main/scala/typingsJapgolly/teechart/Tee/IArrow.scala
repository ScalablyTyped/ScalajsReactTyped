...
object IArrow {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(fill = fill.asInstanceOf[js.Any], font = font.asInstanceOf[js.Any], gradient = gradient.asInstanceOf[js.Any], image = image.asInstanceOf[js.Any], length = length.asInstanceOf[js.Any], round = round.asInstanceOf[js.Any], shadow = shadow.asInstanceOf[js.Any], stroke = stroke.asInstanceOf[js.Any], transparency = transparency.asInstanceOf[js.Any], underline = underline.asInstanceOf[js.Any])
