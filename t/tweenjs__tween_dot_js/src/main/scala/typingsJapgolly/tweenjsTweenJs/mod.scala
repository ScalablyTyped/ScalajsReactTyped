package typingsJapgolly.tweenjsTweenJs

import org.scalablytyped.runtime.Instantiable0
import org.scalablytyped.runtime.Instantiable2
import typingsJapgolly.std.Record
import typingsJapgolly.tweenjsTweenJs.anon.Back
import typingsJapgolly.tweenjsTweenJs.anon.Bernstein
import typingsJapgolly.tweenjsTweenJs.anon.Bezier
import typingsJapgolly.tweenjsTweenJs.anon.In
import typingsJapgolly.tweenjsTweenJs.anon.None
import typingsJapgolly.tweenjsTweenJs.anon.TypeofSequence
import typingsJapgolly.tweenjsTweenJs.tweenjsTweenJsBooleans.`false`
...
object mod {
  ...
  object default {
    ...
    @js.native
    def Group: Instantiable0[typingsJapgolly.tweenjsTweenJs.mod.Group] = js.native
    ...
    @js.native
    def Sequence: TypeofSequence & Instantiable0[typingsJapgolly.tweenjsTweenJs.mod.Sequence] = js.native
    ...
    def Tween: Instantiable2[
        ...
        typingsJapgolly.tweenjsTweenJs.mod.Tween[UnknownProps]
      ] = js.native
