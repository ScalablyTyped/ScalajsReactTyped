...
import typingsJapgolly.twit.anon.Idstr
import typingsJapgolly.twit.anon.Media
import typingsJapgolly.twit.twitStrings.low
import typingsJapgolly.twit.twitStrings.medium
import typingsJapgolly.twit.twitStrings.none
