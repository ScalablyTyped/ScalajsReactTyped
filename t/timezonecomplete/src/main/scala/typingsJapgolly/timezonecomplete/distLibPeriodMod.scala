...
object distLibPeriodMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.timezonecomplete.timezonecompleteStrings.regular
    - typingsJapgolly.timezonecomplete.timezonecompleteStrings.local
  */
  trait PeriodDstJson extends StObject
  object PeriodDstJson {
    
    inline def local: typingsJapgolly.timezonecomplete.timezonecompleteStrings.local = "local".asInstanceOf[typingsJapgolly.timezonecomplete.timezonecompleteStrings.local]
    
    inline def regular: typingsJapgolly.timezonecomplete.timezonecompleteStrings.regular = "regular".asInstanceOf[typingsJapgolly.timezonecomplete.timezonecompleteStrings.regular]
  }
