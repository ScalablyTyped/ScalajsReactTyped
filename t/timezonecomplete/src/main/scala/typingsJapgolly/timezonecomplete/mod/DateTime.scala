...
/**
  ...
  */
class DateTime ()
  extends typingsJapgolly.timezonecomplete.datetimeMod.DateTime {
  /**
  ...
  /**
    ...
    */
  def this(tm: typingsJapgolly.timezonecomplete.basicsMod.TimeStruct) = this()
  /**
    * Constructor
  ...
  /**
    ...
    */
  def this(date: js.Date, getFuncs: typingsJapgolly.timezonecomplete.javascriptMod.DateFunctions) = this()
  def this(isoString: String, timeZone: typingsJapgolly.timezonecomplete.timezoneMod.TimeZone) = this()
  def this(
    tm: typingsJapgolly.timezonecomplete.basicsMod.TimeStruct,
    timeZone: typingsJapgolly.timezonecomplete.timezoneMod.TimeZone
  ) = this()
  def this(unixTimestamp: Double, timeZone: typingsJapgolly.timezonecomplete.timezoneMod.TimeZone) = this()
  def this(
    dateString: String,
    formatString: String,
    timeZone: typingsJapgolly.timezonecomplete.timezoneMod.TimeZone
  ...
  def this(
    date: js.Date,
    getFuncs: typingsJapgolly.timezonecomplete.javascriptMod.DateFunctions,
    timeZone: typingsJapgolly.timezonecomplete.timezoneMod.TimeZone
  ) = this()
  /**
...
object DateTime extends js.Object {
  ...
  def exists(
    ...
    zone: js.UndefOr[Null | typingsJapgolly.timezonecomplete.timezoneMod.TimeZone],
  ...
  /**
    ...
    * @throws timezonecomplete.Argument.TimeZone if the given time zone is invalid
    */
  def fromExcel(n: Double): typingsJapgolly.timezonecomplete.datetimeMod.DateTime = js.native
  def fromExcel(n: Double, timeZone: typingsJapgolly.timezonecomplete.timezoneMod.TimeZone): typingsJapgolly.timezonecomplete.datetimeMod.DateTime = js.native
  /**
    * Current date+time in the given time zone
    * @param timeZone	The desired time zone (optional, defaults to UTC).
    * @throws timezonecomplete.NotFound.Zone if the UTC time zone doesn't exist in the time zone database
    */
  def now(): typingsJapgolly.timezonecomplete.datetimeMod.DateTime = js.native
  def now(timeZone: typingsJapgolly.timezonecomplete.timezoneMod.TimeZone): typingsJapgolly.timezonecomplete.datetimeMod.DateTime = js.native
  /**
    * Current date+time in local time
    * @throws nothing
    */
  def nowLocal(): typingsJapgolly.timezonecomplete.datetimeMod.DateTime = js.native
  /**
    * Current date+time in UTC time
    * @throws timezonecomplete.NotFound.Zone if the UTC time zone doesn't exist in the time zone database
    */
  def nowUtc(): typingsJapgolly.timezonecomplete.datetimeMod.DateTime = js.native
  /**
    ...
    * @throws timezonecomplete.Argument.FormatString if the given format string is invalid
    */
  def parse(s: String, format: String): typingsJapgolly.timezonecomplete.datetimeMod.DateTime = js.native
  def parse(s: String, format: String, zone: typingsJapgolly.timezonecomplete.timezoneMod.TimeZone): typingsJapgolly.timezonecomplete.datetimeMod.DateTime = js.native
  def parse(
    s: String,
    format: String,
    zone: typingsJapgolly.timezonecomplete.timezoneMod.TimeZone,
    locale: PartialLocale
  ): typingsJapgolly.timezonecomplete.datetimeMod.DateTime = js.native
  def parse(
    s: String,
    format: String,
    zone: typingsJapgolly.timezonecomplete.timezoneMod.TimeZone,
