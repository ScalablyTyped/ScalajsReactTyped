...
class TimeZone protected ()
  extends typingsJapgolly.timezonecomplete.timezoneMod.TimeZone
...
object TimeZone extends js.Object {
  ...
  /**
    ...
    * @throws nothing
    */
  def local(): typingsJapgolly.timezonecomplete.timezoneMod.TimeZone = js.native
  /**
  ...
  /**
    ...
    */
  def utc(): typingsJapgolly.timezonecomplete.timezoneMod.TimeZone = js.native
  /**
    ...
    */
  def zone(offset: Double): typingsJapgolly.timezonecomplete.timezoneMod.TimeZone = js.native
  /**
    ...
    */
  def zone(s: String): typingsJapgolly.timezonecomplete.timezoneMod.TimeZone = js.native
  def zone(s: String, dst: Boolean): typingsJapgolly.timezonecomplete.timezoneMod.TimeZone = js.native
}
