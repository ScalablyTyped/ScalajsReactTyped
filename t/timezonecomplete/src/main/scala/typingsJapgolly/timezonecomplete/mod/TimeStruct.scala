...
class TimeStruct protected ()
  extends typingsJapgolly.timezonecomplete.basicsMod.TimeStruct {
  /**
    * Constructor
    *
...
object TimeStruct extends js.Object {
  ...
  ): typingsJapgolly.timezonecomplete.basicsMod.TimeStruct = js.native
  /**
    ...
    * @throws nothing
    */
  def fromDate(d: js.Date, df: typingsJapgolly.timezonecomplete.javascriptMod.DateFunctions): typingsJapgolly.timezonecomplete.basicsMod.TimeStruct = js.native
  /**
    * Returns a TimeStruct from an ISO 8601 string WITHOUT time zone
    * @throws timezonecomplete.Argument.S if `s` is not a proper iso string
    */
  def fromString(s: String): typingsJapgolly.timezonecomplete.basicsMod.TimeStruct = js.native
  /**
    * Create a TimeStruct from a number of unix milliseconds
    * (backward compatibility)
    * @throws timezonecomplete.Argument.UnixMillis for non-integer milliseconds
    */
  def fromUnix(unixMillis: Double): typingsJapgolly.timezonecomplete.basicsMod.TimeStruct = js.native
}
