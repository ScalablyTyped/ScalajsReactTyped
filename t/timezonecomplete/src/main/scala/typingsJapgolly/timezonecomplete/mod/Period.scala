...
import typingsJapgolly.timezonecomplete.periodMod.PeriodJson
...
class Period protected ()
  extends typingsJapgolly.timezonecomplete.periodMod.Period {
  /**
    * Constructor
  ...
  /**
    ...
    */
  def this(
    reference: typingsJapgolly.timezonecomplete.datetimeMod.DateTime,
    interval: typingsJapgolly.timezonecomplete.durationMod.Duration
  ) = this()
  /**
    * Constructor
    * LIMITATION: if dst equals RegularLocalTime, and unit is Second, Minute or Hour,
  ...
  def this(
    reference: typingsJapgolly.timezonecomplete.datetimeMod.DateTime,
    amount: Double,
    unit: typingsJapgolly.timezonecomplete.basicsMod.TimeUnit
  ) = this()
  def this(
    reference: typingsJapgolly.timezonecomplete.datetimeMod.DateTime,
    interval: typingsJapgolly.timezonecomplete.durationMod.Duration,
    dst: typingsJapgolly.timezonecomplete.periodMod.PeriodDst
  ) = this()
  def this(
    reference: typingsJapgolly.timezonecomplete.datetimeMod.DateTime,
    amount: Double,
