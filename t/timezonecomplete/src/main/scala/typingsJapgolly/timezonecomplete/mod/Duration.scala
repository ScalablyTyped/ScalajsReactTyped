...
/**
  ...
  */
class Duration ()
  extends typingsJapgolly.timezonecomplete.durationMod.Duration {
  /**
  ...
  def this(amount: Double, unit: typingsJapgolly.timezonecomplete.basicsMod.TimeUnit) = this()
}
...
object Duration extends js.Object {
  /**
    ...
    */
  def days(amount: Double): typingsJapgolly.timezonecomplete.durationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def hours(amount: Double): typingsJapgolly.timezonecomplete.durationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def milliseconds(amount: Double): typingsJapgolly.timezonecomplete.durationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def minutes(amount: Double): typingsJapgolly.timezonecomplete.durationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def months(amount: Double): typingsJapgolly.timezonecomplete.durationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def seconds(amount: Double): typingsJapgolly.timezonecomplete.durationMod.Duration = js.native
  /**
    * Construct a time duration
    ...
    * @throws timezonecomplete.Argument.Amount if n is not a finite number
    */
  def years(amount: Double): typingsJapgolly.timezonecomplete.durationMod.Duration = js.native
}
