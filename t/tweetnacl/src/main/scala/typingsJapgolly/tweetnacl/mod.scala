package typingsJapgolly.tweetnacl

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.tweetnacl.mod.boxProps.keyPair
import typingsJapgolly.tweetnacl.mod.boxProps.open
import typingsJapgolly.tweetnacl.mod.signProps.detached
...
object mod extends Shortcut {
  ...
  object nacl {
    ...
    extension [Self <: nacl](x: Self) {
      ...
      inline def setSetPRNG(value: js.Function2[/* x */ js.typedarray.Uint8Array, /* n */ Double, Unit] => Callback): Self = StObject.set(x, "setPRNG", js.Any.fromFunction1((t0: js.Function2[/* x */ js.typedarray.Uint8Array, /* n */ Double, Unit]) => value(t0).runNow()))
  ...
  trait sign extends StObject {
    ...
    @JSName("keyPair")
    var keyPair_Original: typingsJapgolly.tweetnacl.mod.signProps.keyPair = js.native
