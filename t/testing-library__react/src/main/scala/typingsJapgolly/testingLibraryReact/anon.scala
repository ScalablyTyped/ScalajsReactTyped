...
object anon {
  ...
  object OmitRenderOptionsreadonly {
    ...
    extension [Self <: OmitRenderOptionsreadonly](x: Self) {
      ...
      inline def setWrapperFunction1(value: Children => Element | Null): Self = StObject.set(x, "wrapper", js.Any.fromFunction1(value))
  ...
  trait RenderResultreadonlygetAl extends StObject {
    ...
    def debug(baseElement: js.Array[org.scalajs.dom.Element | DocumentFragment]): Unit = js.native
    def debug(baseElement: js.Array[org.scalajs.dom.Element | DocumentFragment], maxLength: Double): Unit = js.native
    def debug(
      baseElement: js.Array[org.scalajs.dom.Element | DocumentFragment],
      maxLength: Double,
    ...
    def debug(baseElement: org.scalajs.dom.Element): Unit = js.native
    def debug(baseElement: org.scalajs.dom.Element, maxLength: Double): Unit = js.native
    def debug(baseElement: org.scalajs.dom.Element, maxLength: Double, options: OptionsReceived): Unit = js.native
    def debug(baseElement: org.scalajs.dom.Element, maxLength: Unit, options: OptionsReceived): Unit = js.native
