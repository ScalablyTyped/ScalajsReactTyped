...
import typingsJapgolly.testingLibraryDom.AnonInterval
...
object pureMod extends js.Object {
  ...
  def render(ui: japgolly.scalajs.react.raw.React.Element): RenderResultreadonlygetAl = js.native
  def render(ui: japgolly.scalajs.react.raw.React.Element, options: OmitRenderOptionsreadonly): RenderResultreadonlygetAl = js.native
  def render[Q /* <: Queries */](ui: japgolly.scalajs.react.raw.React.Element, options: RenderOptions[Q]): RenderResult[Q] = js.native
