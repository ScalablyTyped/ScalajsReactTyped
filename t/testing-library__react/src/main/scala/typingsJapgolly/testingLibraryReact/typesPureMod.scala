...
object typesPureMod {
  ...
  object prettyFormat {
    ...
    object DEFAULT_OPTIONS {
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.callToJSON")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.compareKeys")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.escapeRegex")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.escapeString")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.highlight")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.indent")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.maxDepth")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.maxWidth")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.min")
      @js.native
      def min: `false` = js.native
      inline def min_=(x: `false`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("min")(x.asInstanceOf[js.Any])
      
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.plugins")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.printBasicPrototype")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.printFunctionName")
      @js.native
      ...
      @JSImport("@testing-library/react/types/pure", "prettyFormat.DEFAULT_OPTIONS.theme")
      @js.native
  ...
  object queries {
    ...
    @JSImport("@testing-library/react/types/pure", "queries")
    @js.native
    val ^ : js.Any = js.native
