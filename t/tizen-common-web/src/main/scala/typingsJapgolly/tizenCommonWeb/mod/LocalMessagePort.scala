...
object LocalMessagePort {
  ...
  inline def apply(
    ...
    removeMessagePortListener: Double => Callback
  ): LocalMessagePort = {
    val __obj = js.Dynamic.literal(addMessagePortListener = js.Any.fromFunction1(addMessagePortListener), isTrusted = isTrusted.asInstanceOf[js.Any], messagePortName = messagePortName.asInstanceOf[js.Any], removeMessagePortListener = js.Any.fromFunction1((t0: Double) => removeMessagePortListener(t0).runNow()))
  ...
  extension [Self <: LocalMessagePort](x: Self) {
    ...
    inline def setRemoveMessagePortListener(value: Double => Callback): Self = StObject.set(x, "removeMessagePortListener", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
  }
}
