...
object TVInfoManager {
  ...
  inline def apply(
    ...
    removeCaptionValueChangeListener: Double => Callback
  ): TVInfoManager = {
    val __obj = js.Dynamic.literal(addCaptionValueChangeListener = js.Any.fromFunction2(addCaptionValueChangeListener), getCaptionValue = js.Any.fromFunction1(getCaptionValue), removeCaptionValueChangeListener = js.Any.fromFunction1((t0: Double) => removeCaptionValueChangeListener(t0).runNow()))
  ...
  extension [Self <: TVInfoManager](x: Self) {
    ...
    inline def setRemoveCaptionValueChangeListener(value: Double => Callback): Self = StObject.set(x, "removeCaptionValueChangeListener", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
  }
}
