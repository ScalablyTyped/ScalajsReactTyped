...
object MediaControllerSubtitles {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(addChangeRequestListener = js.Any.fromFunction1(addChangeRequestListener), enabled = enabled.asInstanceOf[js.Any], removeChangeRequestListener = js.Any.fromFunction1((t0: Double) => removeChangeRequestListener(t0).runNow()))
