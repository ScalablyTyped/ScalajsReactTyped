...
object SystemInfoCameraFlash {
  ...
  inline def apply(brightness: Double, camera: String, levels: Double, setBrightness: Double => Callback): SystemInfoCameraFlash = {
    val __obj = js.Dynamic.literal(brightness = brightness.asInstanceOf[js.Any], camera = camera.asInstanceOf[js.Any], levels = levels.asInstanceOf[js.Any], setBrightness = js.Any.fromFunction1((t0: Double) => setBrightness(t0).runNow()))
