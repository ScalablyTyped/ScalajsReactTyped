...
object MediaControllerAbilitiesInfo {
  ...
  extension [Self <: MediaControllerAbilitiesInfo](x: Self) {
    ...
    inline def setSubscribe(value: Callback): Self = StObject.set(x, "subscribe", value.toJsFn)
