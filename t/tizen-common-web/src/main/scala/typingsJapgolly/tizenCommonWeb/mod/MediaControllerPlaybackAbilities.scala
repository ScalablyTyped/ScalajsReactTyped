...
object MediaControllerPlaybackAbilities {
  ...
  extension [Self <: MediaControllerPlaybackAbilities](x: Self) {
    ...
    inline def setSaveAbilities(value: Callback): Self = StObject.set(x, "saveAbilities", value.toJsFn)
