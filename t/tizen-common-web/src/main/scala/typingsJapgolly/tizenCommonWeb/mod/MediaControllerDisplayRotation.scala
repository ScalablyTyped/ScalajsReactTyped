...
object MediaControllerDisplayRotation {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(addChangeRequestListener = js.Any.fromFunction1(addChangeRequestListener), displayRotation = displayRotation.asInstanceOf[js.Any], removeChangeRequestListener = js.Any.fromFunction1((t0: Double) => removeChangeRequestListener(t0).runNow()))
