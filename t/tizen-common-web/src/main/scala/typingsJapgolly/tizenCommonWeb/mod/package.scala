...
import typingsJapgolly.tizenCommonWeb.mod.^
import typingsJapgolly.tizenCommonWeb.tizenCommonWebStrings.FOREGROUND
import typingsJapgolly.tizenCommonWeb.tizenCommonWebStrings.MAIN
