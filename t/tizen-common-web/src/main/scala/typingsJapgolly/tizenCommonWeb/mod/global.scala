...
object global {
  ...
  @js.native
  val WebAPIError: typingsJapgolly.tizenCommonWeb.mod.WebAPIException = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSGlobal("WebAPIException")
  @js.native
  open class WebAPIException ()
    extends typingsJapgolly.tizenCommonWeb.mod.WebAPIException {
  ...
  object tizen extends Shortcut {
    ...
    open class AlarmAbsolute protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.AlarmAbsolute {
    ...
    open class AlarmRelative protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.AlarmRelative {
    ...
    open class ApplicationControl protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.ApplicationControl {
      def this(
        operation: String,
        uri: js.UndefOr[String | Null],
        mime: js.UndefOr[String | Null],
        category: js.UndefOr[String | Null],
        data: js.UndefOr[js.Array[typingsJapgolly.tizenCommonWeb.mod.ApplicationControlData] | Null],
    ...
    open class ApplicationControlData protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.ApplicationControlData {
    ...
    open class AttributeFilter protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.AttributeFilter {
    ...
    open class AttributeRangeFilter protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.AttributeRangeFilter {
      def this(attributeName: String) = this()
    ...
    @js.native
    open class Bundle ()
      extends typingsJapgolly.tizenCommonWeb.mod.Bundle {
    ...
    open class CompositeFilter protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.CompositeFilter {
    ...
    open class DownloadRequest protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.DownloadRequest {
      def this(
        url: String,
    ...
    open class ExifInformation ()
      extends typingsJapgolly.tizenCommonWeb.mod.ExifInformation {
    ...
    open class IotconOption protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.IotconOption {
    ...
    open class Representation protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.Representation {
    ...
    open class Response protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.Response {
    ...
    open class SimpleCoordinates protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.SimpleCoordinates {
    ...
    open class SortMode protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.SortMode {
      def this(attributeName: String) = this()
    ...
    @js.native
    open class TZDate ()
      extends typingsJapgolly.tizenCommonWeb.mod.TZDate {
    ...
    open class TimeDuration protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.TimeDuration {
    ...
    open class VoiceControlCommand protected ()
      extends typingsJapgolly.tizenCommonWeb.mod.VoiceControlCommand {
  ...
  trait Window extends StObject {
    ...
    val WebAPIError: typingsJapgolly.tizenCommonWeb.mod.WebAPIException
  ...
  object Window {
    ...
    inline def apply(
      WebAPIError: typingsJapgolly.tizenCommonWeb.mod.WebAPIException,
    ...
    extension [Self <: Window](x: Self) {
      ...
      inline def setWebAPIError(value: typingsJapgolly.tizenCommonWeb.mod.WebAPIException): Self = StObject.set(x, "WebAPIError", value.asInstanceOf[js.Any])
