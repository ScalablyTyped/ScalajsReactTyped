...
@scala.inline
open class SharedBuilder_ContentContainerProps1145292616 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def scrollRefCallback(value: Ref[HTMLDivElement]): this.type = set("scrollRefCallback", value.asInstanceOf[js.Any])
  
  inline def scrollRefCallbackFunction1(value: HTMLDivElement | Null => Callback): this.type = set("scrollRefCallback", js.Any.fromFunction1((t0: HTMLDivElement | Null) => value(t0).runNow()))
  
  inline def scrollRefCallbackNull: this.type = set("scrollRefCallback", null)
