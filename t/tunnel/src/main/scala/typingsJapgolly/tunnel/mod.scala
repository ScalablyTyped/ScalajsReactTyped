package typingsJapgolly.tunnel
...
object mod {
  ...
  inline def httpOverHttps(): typingsJapgolly.node.httpsMod.Agent = ^.asInstanceOf[js.Dynamic].applyDynamic("httpOverHttps")().asInstanceOf[typingsJapgolly.node.httpsMod.Agent]
  inline def httpOverHttps(options: HttpOverHttpsOptions): typingsJapgolly.node.httpsMod.Agent = ^.asInstanceOf[js.Dynamic].applyDynamic("httpOverHttps")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.httpsMod.Agent]
  ...
  inline def httpsOverHttps(): typingsJapgolly.node.httpsMod.Agent = ^.asInstanceOf[js.Dynamic].applyDynamic("httpsOverHttps")().asInstanceOf[typingsJapgolly.node.httpsMod.Agent]
  inline def httpsOverHttps(options: HttpsOverHttpsOptions): typingsJapgolly.node.httpsMod.Agent = ^.asInstanceOf[js.Dynamic].applyDynamic("httpsOverHttps")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.httpsMod.Agent]
