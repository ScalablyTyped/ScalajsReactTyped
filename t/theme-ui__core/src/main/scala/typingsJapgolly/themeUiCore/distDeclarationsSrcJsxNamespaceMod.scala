...
import typingsJapgolly.react.mod.global.JSX.ElementAttributesProperty
import typingsJapgolly.react.mod.global.JSX.ElementChildrenAttribute
import typingsJapgolly.react.mod.global.JSX.ElementClass
import typingsJapgolly.react.mod.global.JSX.IntrinsicAttributes
import typingsJapgolly.react.mod.global.JSX.IntrinsicClassAttributes
...
object distDeclarationsSrcJsxNamespaceMod {
  ...
  object ThemeUIJSX {
    ...
    object IntrinsicElements {
      ...
      inline def apply(
      ...
      ): typingsJapgolly.themeUiCore.distDeclarationsSrcJsxNamespaceMod.ThemeUIJSX.IntrinsicElements = {
        ...
        __obj.asInstanceOf[typingsJapgolly.themeUiCore.distDeclarationsSrcJsxNamespaceMod.ThemeUIJSX.IntrinsicElements]
      }
      
      extension [Self <: typingsJapgolly.themeUiCore.distDeclarationsSrcJsxNamespaceMod.ThemeUIJSX.IntrinsicElements](x: Self) {
