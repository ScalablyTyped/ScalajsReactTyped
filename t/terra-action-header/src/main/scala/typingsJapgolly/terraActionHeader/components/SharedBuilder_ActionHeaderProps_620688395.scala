...
@scala.inline
open class SharedBuilder_ActionHeaderProps_620688395 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def level(value: `1` | `2` | `3` | `4` | `5` | `6`): this.type = set("level", value.asInstanceOf[js.Any])
  ...
  inline def onBack(value: ReactMouseEventFrom[HTMLButtonElement & Element] => Callback): this.type = set("onBack", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement & Element]) => value(t0).runNow()))
  ...
  inline def onMaximize(value: ReactMouseEventFrom[HTMLButtonElement & Element] => Callback): this.type = set("onMaximize", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement & Element]) => value(t0).runNow()))
  
  inline def onMinimize(value: ReactMouseEventFrom[HTMLButtonElement & Element] => Callback): this.type = set("onMinimize", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement & Element]) => value(t0).runNow()))
  ...
  inline def onNext(value: ReactMouseEventFrom[HTMLButtonElement & Element] => Callback): this.type = set("onNext", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement & Element]) => value(t0).runNow()))
  ...
  inline def onPrevious(value: ReactMouseEventFrom[HTMLButtonElement & Element] => Callback): this.type = set("onPrevious", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLButtonElement & Element]) => value(t0).runNow()))
