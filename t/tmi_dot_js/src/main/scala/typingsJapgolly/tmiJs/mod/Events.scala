...
import typingsJapgolly.tmiJs.tmiJsStrings.`highlighted-message`
import typingsJapgolly.tmiJs.tmiJsStrings.`skip-subs-mode-message`
import typingsJapgolly.tmiJs.tmiJsStrings.msg_rejected
import typingsJapgolly.tmiJs.tmiJsStrings.msg_rejected_mandatory
