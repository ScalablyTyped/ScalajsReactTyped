...
import typingsJapgolly.tmiJs.anon.ClientId
import typingsJapgolly.tmiJs.anon.Error
import typingsJapgolly.tmiJs.anon.MaxReconnectAttempts
import typingsJapgolly.tmiJs.anon.Password
