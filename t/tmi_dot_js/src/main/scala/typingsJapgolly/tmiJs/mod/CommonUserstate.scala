...
import typingsJapgolly.tmiJs.tmiJsStrings._empty
import typingsJapgolly.tmiJs.tmiJsStrings.admin
import typingsJapgolly.tmiJs.tmiJsStrings.global_mod
import typingsJapgolly.tmiJs.tmiJsStrings.staff
...
trait CommonUserstate
  ...
  var `user-type`: js.UndefOr[_empty | typingsJapgolly.tmiJs.tmiJsStrings.mod | global_mod | admin | staff] = js.undefined
}
object CommonUserstate {
  ...
  extension [Self <: CommonUserstate](x: Self) {
    ...
    inline def `setUser-type`(value: _empty | typingsJapgolly.tmiJs.tmiJsStrings.mod | global_mod | admin | staff): Self = StObject.set(x, "user-type", value.asInstanceOf[js.Any])
