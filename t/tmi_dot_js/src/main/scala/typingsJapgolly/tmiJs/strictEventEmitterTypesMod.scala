...
object strictEventEmitterTypesMod {
  ...
  /* keyof tmi.js.tmi.js/strict-event-emitter-types.OverriddenMethods<any, any, any> */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tmiJs.tmiJsStrings.on
    - typingsJapgolly.tmiJs.tmiJsStrings.addListener
    - typingsJapgolly.tmiJs.tmiJsStrings.addEventListener
    - typingsJapgolly.tmiJs.tmiJsStrings.removeListener
    - typingsJapgolly.tmiJs.tmiJsStrings.removeEventListener
    - typingsJapgolly.tmiJs.tmiJsStrings.once
    - typingsJapgolly.tmiJs.tmiJsStrings.emit
  */
  ...
  trait OverriddenMethods[TEmitter, TEventRecord, TEmitRecord] extends StObject {
    ...
    ): EEMethodReturnType[TEmitter, typingsJapgolly.tmiJs.tmiJsStrings.addEventListener, T, Unit] = js.native
    ...
    ): EEMethodReturnType[TEmitter, typingsJapgolly.tmiJs.tmiJsStrings.addListener, T, Unit] = js.native
    ...
    ): EEMethodReturnType[TEmitter, typingsJapgolly.tmiJs.tmiJsStrings.emit, T, Unit] = js.native
    ...
    ): EEMethodReturnType[TEmitter, typingsJapgolly.tmiJs.tmiJsStrings.on, T, Unit] = js.native
    ...
    ): EEMethodReturnType[TEmitter, typingsJapgolly.tmiJs.tmiJsStrings.once, T, Unit] = js.native
    
    def removeEventListener(event: js.Symbol, listener: js.Function1[/* repeated */ Any, Any]): Unit = js.native
    def removeEventListener[T](event: /* keyof TEventRecord */ String, listener: js.Function1[/* repeated */ Any, Any]): EEMethodReturnType[TEmitter, typingsJapgolly.tmiJs.tmiJsStrings.removeEventListener, T, Unit] = js.native
    
    def removeListener(event: js.Symbol, listener: js.Function1[/* repeated */ Any, Any]): Unit = js.native
    def removeListener[T](event: /* keyof TEventRecord */ String, listener: js.Function1[/* repeated */ Any, Any]): EEMethodReturnType[TEmitter, typingsJapgolly.tmiJs.tmiJsStrings.removeListener, T, Unit] = js.native
  }
