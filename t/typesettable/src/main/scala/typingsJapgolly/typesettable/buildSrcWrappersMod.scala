...
object buildSrcWrappersMod {
  ...
  open class SingleLineWrapper ()
    extends typingsJapgolly.typesettable.buildSrcWrappersSingleLineWrapperMod.SingleLineWrapper
  /* static members */
  ...
  @js.native
  open class Wrapper ()
    extends typingsJapgolly.typesettable.buildSrcWrappersWrapperMod.Wrapper
}
