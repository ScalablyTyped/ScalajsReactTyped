...
object buildSrcUtilsMod {
  ...
  open class Cache[T] protected ()
    extends typingsJapgolly.typesettable.buildSrcUtilsCacheMod.Cache[T] {
    /**
      * @constructor
      *
  ...
  @js.native
  open class Methods ()
    extends typingsJapgolly.typesettable.buildSrcUtilsMethodsMod.Methods
  /* static members */
  object Methods {
  ...
  open class StringMethods ()
    extends typingsJapgolly.typesettable.buildSrcUtilsStringMethodsMod.StringMethods
  /* static members */
  ...
  open class Tokenizer ()
    extends typingsJapgolly.typesettable.buildSrcUtilsTokenizerMod.Tokenizer
}
