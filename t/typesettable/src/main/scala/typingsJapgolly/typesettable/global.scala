...
object global {
  ...
  object Typesetter {
    ...
    open class AbstractMeasurer protected ()
      extends typingsJapgolly.typesettable.mod.AbstractMeasurer {
    ...
    open class Cache[T] protected ()
      extends typingsJapgolly.typesettable.mod.Cache[T] {
      /**
        * @constructor
        *
    ...
    open class CacheCharacterMeasurer protected ()
      extends typingsJapgolly.typesettable.mod.CacheCharacterMeasurer {
      def this(ruler: IRulerFactoryContext) = this()
      def this(ruler: IRuler) = this()
    ...
    open class CacheMeasurer protected ()
      extends typingsJapgolly.typesettable.mod.CacheMeasurer {
      def this(ruler: IRulerFactoryContext) = this()
      def this(ruler: IRuler) = this()
    }
    ...
    open class CanvasContext protected ()
      extends typingsJapgolly.typesettable.mod.CanvasContext {
    ...
    open class CharacterMeasurer protected ()
      extends typingsJapgolly.typesettable.mod.CharacterMeasurer {
      def this(ruler: IRulerFactoryContext) = this()
      def this(ruler: IRuler) = this()
      def this(ruler: IRulerFactoryContext, useGuards: Boolean) = this()
      def this(ruler: IRuler, useGuards: Boolean) = this()
    ...
    open class HtmlContext protected ()
      extends typingsJapgolly.typesettable.mod.HtmlContext {
      /**
    ...
    open class HtmlUtils ()
      extends typingsJapgolly.typesettable.mod.HtmlUtils
    /* static members */
    object HtmlUtils {
    ...
    open class Measurer protected ()
      extends typingsJapgolly.typesettable.mod.Measurer {
      def this(ruler: IRulerFactoryContext) = this()
      def this(ruler: IRuler) = this()
      def this(ruler: IRulerFactoryContext, useGuards: Boolean) = this()
      def this(ruler: IRuler, useGuards: Boolean) = this()
    ...
    @js.native
    open class Methods ()
      extends typingsJapgolly.typesettable.mod.Methods
    /* static members */
    object Methods {
    ...
    open class SingleLineWrapper ()
      extends typingsJapgolly.typesettable.mod.SingleLineWrapper
    /* static members */
    ...
    open class StringMethods ()
      extends typingsJapgolly.typesettable.mod.StringMethods
    /* static members */
    ...
    open class SvgContext protected ()
      extends typingsJapgolly.typesettable.mod.SvgContext {
    ...
    @js.native
    open class SvgUtils ()
      extends typingsJapgolly.typesettable.mod.SvgUtils
    /* static members */
    object SvgUtils {
    ...
    open class Tokenizer ()
      extends typingsJapgolly.typesettable.mod.Tokenizer
    
    @JSGlobal("Typesetter.Typesetter")
    @js.native
    open class Typesetter protected ()
      extends typingsJapgolly.typesettable.mod.Typesetter {
    ...
    @js.native
    open class Wrapper ()
      extends typingsJapgolly.typesettable.mod.Wrapper
    
    @JSGlobal("Typesetter.Writer")
    @js.native
    open class Writer protected ()
      extends typingsJapgolly.typesettable.mod.Writer {
      def this(
