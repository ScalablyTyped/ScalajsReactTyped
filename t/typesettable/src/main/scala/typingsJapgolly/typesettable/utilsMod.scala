...
object utilsMod extends js.Object {
  ...
  class Cache[T] protected ()
    extends typingsJapgolly.typesettable.cacheMod.Cache[T] {
    /**
      * @constructor
      *
  ...
  @js.native
  class Methods ()
    extends typingsJapgolly.typesettable.methodsMod.Methods
  
  @js.native
  class StringMethods ()
    extends typingsJapgolly.typesettable.stringMethodsMod.StringMethods
  
  @js.native
  class Tokenizer ()
    extends typingsJapgolly.typesettable.tokenizerMod.Tokenizer
