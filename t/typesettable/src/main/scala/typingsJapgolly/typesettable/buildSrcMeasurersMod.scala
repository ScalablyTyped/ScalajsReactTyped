...
object buildSrcMeasurersMod {
  ...
  open class AbstractMeasurer protected ()
    extends typingsJapgolly.typesettable.buildSrcMeasurersAbstractMeasurerMod.AbstractMeasurer {
  ...
  open class CacheCharacterMeasurer protected ()
    extends typingsJapgolly.typesettable.buildSrcMeasurersCacheCharacterMeasurerMod.CacheCharacterMeasurer {
    def this(ruler: IRulerFactoryContext) = this()
    def this(ruler: IRuler) = this()
  ...
  open class CacheMeasurer protected ()
    extends typingsJapgolly.typesettable.buildSrcMeasurersCacheMeasurerMod.CacheMeasurer {
    def this(ruler: IRulerFactoryContext) = this()
    def this(ruler: IRuler) = this()
  }
  ...
  open class CharacterMeasurer protected ()
    extends typingsJapgolly.typesettable.buildSrcMeasurersCharacterMeasurerMod.CharacterMeasurer {
    def this(ruler: IRulerFactoryContext) = this()
    def this(ruler: IRuler) = this()
    def this(ruler: IRulerFactoryContext, useGuards: Boolean) = this()
    def this(ruler: IRuler, useGuards: Boolean) = this()
  ...
  open class Measurer protected ()
    extends typingsJapgolly.typesettable.buildSrcMeasurersMeasurerMod.Measurer {
    def this(ruler: IRulerFactoryContext) = this()
    def this(ruler: IRuler) = this()
    def this(ruler: IRulerFactoryContext, useGuards: Boolean) = this()
    def this(ruler: IRuler, useGuards: Boolean) = this()
