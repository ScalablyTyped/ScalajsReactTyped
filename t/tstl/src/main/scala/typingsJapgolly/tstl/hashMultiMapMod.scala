...
import typingsJapgolly.tstl.hashMultiMapMod.HashMultiMap.Iterator
import typingsJapgolly.tstl.hashMultiMapMod.HashMultiMap.ReverseIterator
...
object hashMultiMapMod extends js.Object {
  ...
  class HashMultiMap[Key, T] () extends MultiMap[Key, T, HashMultiMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T]] {
    ...
    /* protected */ def _Handle_erase(
      first: (Iterator[Key, T]) | (typingsJapgolly.tstl.ihashmapMod.IHashMap.Iterator[Key, T, `false`, HashMultiMap[Key, T]]),
      last: (Iterator[Key, T]) | (typingsJapgolly.tstl.ihashmapMod.IHashMap.Iterator[Key, T, `false`, HashMultiMap[Key, T]])
    ): Unit = js.native
    ...
    /**
      ...
      */
    def begin(index: Double): typingsJapgolly.tstl.ihashmapMod.IHashMap.Iterator[Key, T, `false`, HashMultiMap[Key, T]] = js.native
    /**
      * @inheritDoc
      */
    @JSName("begin")
    ...
    /**
      ...
      * @return Iterator from the specific bucket.
      */
    def end(index: Double): typingsJapgolly.tstl.ihashmapMod.IHashMap.Iterator[Key, T, `false`, HashMultiMap[Key, T]] = js.native
    /**
      * @inheritDoc
      */
    @JSName("end")
    ...
    /**
      ...
      */
    @JSName("rbegin")
    def rbegin_ReverseIterator(): typingsJapgolly.tstl.ihashmapMod.IHashMap.ReverseIterator[Key, T, `false`, HashMultiMap[Key, T]] = js.native
    /**
      * @inheritDoc
      */
    /**
    ...
    /**
      ...
      */
    @JSName("rend")
    def rend_ReverseIterator(): typingsJapgolly.tstl.ihashmapMod.IHashMap.ReverseIterator[Key, T, `false`, HashMultiMap[Key, T]] = js.native
    /**
      * @inheritDoc
      */
    /**
  ...
  object HashMultiMap extends js.Object {
    ...
    /**
      ...
      */
    type Iterator[Key, T] = typingsJapgolly.tstl.mapElementListMod.MapElementList.Iterator[Key, T, `false`, HashMultiMap[Key, T]]
    /**
      * Reverse iterator of {@link HashMultiMap}
      */
    type ReverseIterator[Key, T] = typingsJapgolly.tstl.mapElementListMod.MapElementList.ReverseIterator[Key, T, `false`, HashMultiMap[Key, T]]
  }
