...
object arrayContainerMod extends js.Object {
  ...
  - typingsJapgolly.tstl.ilinearcontainerbaseMod.ILinearContainerBase because var conflicts: iterator. Inlined resize, push_back, pop_back, insert, insert, insert */ @js.native
