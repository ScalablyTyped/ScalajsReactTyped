...
object utilityMod extends js.Object {
  ...
  class Entry[Key, T] protected ()
    extends typingsJapgolly.tstl.entryMod.Entry[Key, T] {
    /**
  ...
  class Pair[First, Second] protected ()
    extends typingsJapgolly.tstl.pairMod.Pair[First, Second] {
    /**
  ...
  @JSName("make_pair")
  def makePair[First, Second](first: First, second: Second): typingsJapgolly.tstl.pairMod.Pair[First, Second] = js.native
}
