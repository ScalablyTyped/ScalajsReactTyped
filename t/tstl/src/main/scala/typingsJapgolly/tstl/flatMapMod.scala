...
import typingsJapgolly.tstl.flatMapMod.FlatMap.Iterator
import typingsJapgolly.tstl.flatMapMod.FlatMap.ReverseIterator
...
object flatMapMod extends js.Object {
  ...
  object FlatMap extends js.Object {
    ...
    type Iterator[Key, T] = typingsJapgolly.tstl.mapElementVectorMod.MapElementVector.Iterator[Key, T, `true`, FlatMap[Key, T]]
    type ReverseIterator[Key, T] = typingsJapgolly.tstl.mapElementVectorMod.MapElementVector.ReverseIterator[Key, T, `true`, FlatMap[Key, T]]
  }
