...
import typingsJapgolly.tstl.flatMultiSetMod.FlatMultiSet.Iterator
import typingsJapgolly.tstl.flatMultiSetMod.FlatMultiSet.ReverseIterator
...
object flatMultiSetMod extends js.Object {
  ...
  object FlatMultiSet extends js.Object {
    ...
    type Iterator[Key] = typingsJapgolly.tstl.setElementVectorMod.SetElementVector.Iterator[Key, `false`, FlatMultiSet[Key]]
    type ReverseIterator[Key] = typingsJapgolly.tstl.setElementVectorMod.SetElementVector.ReverseIterator[Key, `false`, FlatMultiSet[Key]]
  }
