...
object experimentalMod extends js.Object {
  ...
  /**
    ...
    */
  class FlatMap[Key, T] ()
    extends typingsJapgolly.tstl.experimentalContainerMod.FlatMap[Key, T] {
  ...
  class FlatMultiMap[Key, T] ()
    extends typingsJapgolly.tstl.experimentalContainerMod.FlatMultiMap[Key, T] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  class FlatMultiSet[Key] ()
    extends typingsJapgolly.tstl.experimentalContainerMod.FlatMultiSet[Key] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  /**
    ...
    */
  class FlatSet[Key] ()
    extends typingsJapgolly.tstl.experimentalContainerMod.FlatSet[Key] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
