...
import typingsJapgolly.tstl.hashMultiSetMod.HashMultiSet.Iterator
import typingsJapgolly.tstl.hashMultiSetMod.HashMultiSet.ReverseIterator
import typingsJapgolly.tstl.hasherMod.Hasher
import typingsJapgolly.tstl.iforwarditeratorMod.IForwardIterator
import typingsJapgolly.tstl.multiSetMod.MultiSet
...
object hashMultiSetMod extends js.Object {
  ...
  class HashMultiSet[Key] () extends MultiSet[Key, HashMultiSet[Key], Iterator[Key], ReverseIterator[Key]] {
    ...
    /* protected */ def _Handle_erase(
      first: Iterator[Key] | (typingsJapgolly.tstl.ihashsetMod.IHashSet.Iterator[Key, `false`, HashMultiSet[Key]]),
      last: Iterator[Key] | (typingsJapgolly.tstl.ihashsetMod.IHashSet.Iterator[Key, `false`, HashMultiSet[Key]])
    ): Unit = js.native
    ...
    /**
      ...
      */
    def begin(index: Double): typingsJapgolly.tstl.ihashsetMod.IHashSet.Iterator[Key, `false`, HashMultiSet[Key]] = js.native
    /**
      * @inheritDoc
      */
    @JSName("begin")
    ...
    /**
      ...
      * @return Iterator from the specific bucket.
      */
    def end(index: Double): typingsJapgolly.tstl.ihashsetMod.IHashSet.Iterator[Key, `false`, HashMultiSet[Key]] = js.native
    /**
      * @inheritDoc
      */
    @JSName("end")
    ...
    /**
      ...
      */
    @JSName("rbegin")
    def rbegin_ReverseIterator(): typingsJapgolly.tstl.ihashsetMod.IHashSet.ReverseIterator[Key, `false`, HashMultiSet[Key]] = js.native
    /**
      * @inheritDoc
      */
    /**
    ...
    /**
      ...
      */
    @JSName("rend")
    def rend_ReverseIterator(): typingsJapgolly.tstl.ihashsetMod.IHashSet.ReverseIterator[Key, `false`, HashMultiSet[Key]] = js.native
    /**
      * @inheritDoc
      */
    /**
  ...
  object HashMultiSet extends js.Object {
    ...
    /**
      ...
      */
    type Iterator[Key] = typingsJapgolly.tstl.setElementListMod.SetElementList.Iterator[Key, `false`, HashMultiSet[Key]]
    /**
      * Reverse iterator of {@link HashMultiSet}
      */
    type ReverseIterator[Key] = typingsJapgolly.tstl.setElementListMod.SetElementList.ReverseIterator[Key, `false`, HashMultiSet[Key]]
  }
