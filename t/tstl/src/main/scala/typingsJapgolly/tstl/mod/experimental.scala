...
object experimental extends js.Object {
  ...
  /**
    ...
    */
  class FlatMap[Key, T] ()
    extends typingsJapgolly.tstl.experimentalMod.FlatMap[Key, T] {
  ...
  class FlatMultiMap[Key, T] ()
    extends typingsJapgolly.tstl.experimentalMod.FlatMultiMap[Key, T] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  class FlatMultiSet[Key] ()
    extends typingsJapgolly.tstl.experimentalMod.FlatMultiSet[Key] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  /**
    ...
    */
  class FlatSet[Key] ()
    extends typingsJapgolly.tstl.experimentalMod.FlatSet[Key] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  object FlatMap extends js.Object {
    ...
    val __MODULE: typingsJapgolly.tstl.tstlStrings.experimental = js.native
  }
