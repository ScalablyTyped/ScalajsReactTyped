...
import typingsJapgolly.tstl.ihashsetMod.IHashSet.ReverseIterator
...
object ihashsetMod extends js.Object {
  ...
  object IHashSet extends js.Object {
    /**
      ...
      */
    type Iterator[Key, Unique /* <: Boolean */, Source /* <: IHashSet[Key, Unique, Source] */] = typingsJapgolly.tstl.setElementListMod.SetElementList.Iterator[Key, Unique, Source]
    /**
      * Reverse iterator of {@link IHashSet}
      *
      * @author Jenogho Nam <http://samchon.org>
      */
    type ReverseIterator[Key, Unique /* <: Boolean */, Source /* <: IHashSet[Key, Unique, Source] */] = typingsJapgolly.tstl.setElementListMod.SetElementList.ReverseIterator[Key, Unique, Source]
  }
