...
import typingsJapgolly.tstl.flatSetMod.FlatSet.Iterator
import typingsJapgolly.tstl.flatSetMod.FlatSet.ReverseIterator
...
object flatSetMod extends js.Object {
  ...
  object FlatSet extends js.Object {
    ...
    type Iterator[Key] = typingsJapgolly.tstl.setElementVectorMod.SetElementVector.Iterator[Key, `true`, FlatSet[Key]]
    type ReverseIterator[Key] = typingsJapgolly.tstl.setElementVectorMod.SetElementVector.ReverseIterator[Key, `true`, FlatSet[Key]]
  }
