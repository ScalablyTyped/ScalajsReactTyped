...
object VizCreateOptions {
  ...
  /* filter */ StringDictionary[js.Any] = null,
    ...
    onFirstInteractive: /* e */ TableauEvent => Callback = null,
    onFirstVizSizeKnown: /* e */ VizResizeEvent => Callback = null,
    width: String = null
  ): VizCreateOptions = {
    ...
    if (onFirstInteractive != null) __obj.updateDynamic("onFirstInteractive")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.tableau.tableau.TableauEvent) => onFirstInteractive(t0).runNow()))
    if (onFirstVizSizeKnown != null) __obj.updateDynamic("onFirstVizSizeKnown")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.tableau.tableau.VizResizeEvent) => onFirstVizSizeKnown(t0).runNow()))
