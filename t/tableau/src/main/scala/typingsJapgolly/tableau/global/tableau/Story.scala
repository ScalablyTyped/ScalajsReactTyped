...
open class Story ()
  extends StObject
     with typingsJapgolly.tableau.tableau.Story {
  
  /** Activates the next story point if there is one. If the current story point is the last one, then is stays active. */
  /* CompleteClass */
  override def activateNextStoryPointAsync(): js.Promise[typingsJapgolly.tableau.tableau.StoryPoint] = js.native
  
  /** Activates the previous story point if there is one. If the current story point is the first one, then it stays active. */
  /* CompleteClass */
  override def activatePreviousStoryPointAsync(): js.Promise[typingsJapgolly.tableau.tableau.StoryPoint] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def activateStoryPointAsync(index: Double): js.Promise[typingsJapgolly.tableau.tableau.StoryPoint] = js.native
  ...
  /* CompleteClass */
  override def getActiveStoryPoint(): typingsJapgolly.tableau.tableau.StoryPoint = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getStoryPointsInfo(): js.Array[typingsJapgolly.tableau.tableau.StoryPointInfo] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def revertStoryPointAsync(index: Double): js.Promise[typingsJapgolly.tableau.tableau.StoryPoint] = js.native
}
