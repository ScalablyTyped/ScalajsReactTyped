...
import typingsJapgolly.tableau.tableau.SheetSizeOptions
...
open class Dashboard ()
  extends StObject
     with typingsJapgolly.tableau.tableau.Dashboard {
  ...
  /* CompleteClass */
  override def getObjects(): js.Array[typingsJapgolly.tableau.tableau.DashboardObject] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getParentStoryPoint(): typingsJapgolly.tableau.tableau.StoryPoint = js.native
  
  /** Gets the type of the sheet. SheetType is an enum with the following values: WORKSHEET , DASHBOARD and STORY. */
  /* CompleteClass */
  override def getSheetType(): typingsJapgolly.tableau.tableau.SheetType = js.native
  ...
  /* CompleteClass */
  override def getWorkbook(): typingsJapgolly.tableau.tableau.Workbook = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getWorksheets(): js.Array[typingsJapgolly.tableau.tableau.Worksheet] = js.native
}
