...
open class RelativeDateFilter ()
  extends StObject
     with typingsJapgolly.tableau.tableau.RelativeDateFilter {
  ...
  /* CompleteClass */
  override def getPeriod(): typingsJapgolly.tableau.tableau.PeriodType = js.native
  
  /** The range of the date filter (years, months, etc.). See DateRangeType Enum for the values in the enum. */
  /* CompleteClass */
  override def getRange(): typingsJapgolly.tableau.tableau.DateRangeType = js.native
