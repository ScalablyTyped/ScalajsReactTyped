package typingsJapgolly.testConsole
...
object mod {
  ...
  object Inspector {
    ...
    inline def apply(output: Output, restore: Callback): Inspector = {
      val __obj = js.Dynamic.literal(output = output.asInstanceOf[js.Any], restore = restore.toJsFn)
