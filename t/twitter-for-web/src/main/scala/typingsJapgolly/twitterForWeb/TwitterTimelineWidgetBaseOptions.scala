...
- typingsJapgolly.twitterForWeb.TwitterWidgetOptions because Already inherited
- typingsJapgolly.twitterForWeb.TwitterButtonWidgetOptions because var conflicts: align, dnt, hashtags, lang, related, via. Inlined count, counturl, size, text */ trait TwitterTimelineWidgetBaseOptions
  extends StObject
