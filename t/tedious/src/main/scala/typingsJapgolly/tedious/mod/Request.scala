package typingsJapgolly.tedious.mod

import typingsJapgolly.node.eventsMod.EventEmitter
import typingsJapgolly.tedious.tediousStrings.columnMetadata
import typingsJapgolly.tedious.tediousStrings.done
import typingsJapgolly.tedious.tediousStrings.doneInProc
import typingsJapgolly.tedious.tediousStrings.doneProc
import typingsJapgolly.tedious.tediousStrings.error
import typingsJapgolly.tedious.tediousStrings.prepared
import typingsJapgolly.tedious.tediousStrings.requestCompleted
import typingsJapgolly.tedious.tediousStrings.returnValue
import typingsJapgolly.tedious.tediousStrings.row
...
class Request protected () extends EventEmitter {
  ...
  def this(
    sql: String,
    callback: js.Function3[/* error */ js.Error, /* rowCount */ Double, /* rows */ js.Array[_], Unit]
  ) = this()
  /**
