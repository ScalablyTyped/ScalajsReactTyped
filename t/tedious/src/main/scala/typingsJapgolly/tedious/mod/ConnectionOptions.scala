...
object ConnectionOptions {
  ...
  def apply(
    ...
    columnNameReplacer: (/* columnName */ String, /* index */ Double, /* columnMetaData */ ColumnMetaData) => CallbackTo[String] = null,
    ...
    if (columnNameReplacer != null) __obj.updateDynamic("columnNameReplacer")(js.Any.fromFunction3((t0: /* columnName */ java.lang.String, t1: /* index */ scala.Double, t2: /* columnMetaData */ typingsJapgolly.tedious.mod.ColumnMetaData) => columnNameReplacer(t0, t1, t2).runNow()))
