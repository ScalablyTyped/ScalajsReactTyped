...
object Options {
  ...
  def apply(
    ...
    color_function: (/* x */ Double, /* y */ Double) => CallbackTo[String] = null,
    ...
    if (color_function != null) __obj.updateDynamic("color_function")(js.Any.fromFunction2((t0: /* x */ scala.Double, t1: /* y */ scala.Double) => color_function(t0, t1).runNow()))
