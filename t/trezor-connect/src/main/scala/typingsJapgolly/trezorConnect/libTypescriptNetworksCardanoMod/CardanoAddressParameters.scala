...
trait CardanoAddressParameters extends StObject {
  ...
  var addressType: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoAddressType
...
object CardanoAddressParameters {
  ...
  inline def apply(addressType: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoAddressType): CardanoAddressParameters = {
  ...
  extension [Self <: CardanoAddressParameters](x: Self) {
    ...
    inline def setAddressType(value: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoAddressType): Self = StObject.set(x, "addressType", value.asInstanceOf[js.Any])
