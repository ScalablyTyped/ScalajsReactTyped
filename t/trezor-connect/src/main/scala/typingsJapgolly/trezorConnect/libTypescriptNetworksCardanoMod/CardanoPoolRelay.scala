...
trait CardanoPoolRelay extends StObject {
  ...
  var `type`: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoPoolRelayType
}
object CardanoPoolRelay {
  
  inline def apply(`type`: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoPoolRelayType): CardanoPoolRelay = {
  ...
  extension [Self <: CardanoPoolRelay](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoPoolRelayType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
