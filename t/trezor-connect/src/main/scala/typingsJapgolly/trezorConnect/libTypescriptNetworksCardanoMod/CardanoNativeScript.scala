...
trait CardanoNativeScript extends StObject {
  ...
  var `type`: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoNativeScriptType
}
object CardanoNativeScript {
  
  inline def apply(`type`: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoNativeScriptType): CardanoNativeScript = {
  ...
  extension [Self <: CardanoNativeScript](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoNativeScriptType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
