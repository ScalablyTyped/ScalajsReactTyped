...
trait CardanoCertificate extends StObject {
  ...
  var `type`: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoCertificateType
}
object CardanoCertificate {
  
  inline def apply(`type`: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoCertificateType): CardanoCertificate = {
  ...
  extension [Self <: CardanoCertificate](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoCertificateType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
