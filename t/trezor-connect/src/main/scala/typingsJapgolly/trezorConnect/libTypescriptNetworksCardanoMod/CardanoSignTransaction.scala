...
trait CardanoSignTransaction extends StObject {
  ...
  var signingMode: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoTxSigningMode
...
object CardanoSignTransaction {
  ...
  inline def apply(
    ...
    signingMode: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoTxSigningMode
  ...
  extension [Self <: CardanoSignTransaction](x: Self) {
    ...
    inline def setSigningMode(value: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoTxSigningMode): Self = StObject.set(x, "signingMode", value.asInstanceOf[js.Any])
