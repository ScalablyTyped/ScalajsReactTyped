...
object NEMMosaicLevy extends StObject {
  ...
  sealed trait MosaicLevy_Absolute
    extends StObject
       with NEMMosaicLevy
  /* 1 */ val MosaicLevy_Absolute: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.NEMMosaicLevy.MosaicLevy_Absolute & Double = js.native
  
  @js.native
  sealed trait MosaicLevy_Percentile
    extends StObject
       with NEMMosaicLevy
  /* 2 */ val MosaicLevy_Percentile: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.NEMMosaicLevy.MosaicLevy_Percentile & Double = js.native
}
