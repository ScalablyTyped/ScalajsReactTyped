...
trait CardanoPoolRelayParameters extends StObject {
...
object CardanoPoolRelayParameters {
  
  inline def apply(`type`: CardanoPoolRelayType): CardanoPoolRelayParameters = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[CardanoPoolRelayParameters]
  }
  
  extension [Self <: CardanoPoolRelayParameters](x: Self) {
