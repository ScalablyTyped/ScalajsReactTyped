...
object CardanoTxAuxiliaryDataSupplementType extends StObject {
  ...
  /* 1 */ val CATALYST_REGISTRATION_SIGNATURE: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoTxAuxiliaryDataSupplementType.CATALYST_REGISTRATION_SIGNATURE & Double = js.native
  
  @js.native
  sealed trait NONE
    extends StObject
       with CardanoTxAuxiliaryDataSupplementType
  /* 0 */ val NONE: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.CardanoTxAuxiliaryDataSupplementType.NONE & Double = js.native
}
