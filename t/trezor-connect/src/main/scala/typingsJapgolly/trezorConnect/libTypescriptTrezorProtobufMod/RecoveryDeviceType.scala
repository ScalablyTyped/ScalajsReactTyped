...
object RecoveryDeviceType extends StObject {
  ...
  /* 1 */ val RecoveryDeviceType_Matrix: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.RecoveryDeviceType.RecoveryDeviceType_Matrix & Double = js.native
  
  @js.native
  sealed trait RecoveryDeviceType_ScrambledWords
    extends StObject
       with RecoveryDeviceType
  /* 0 */ val RecoveryDeviceType_ScrambledWords: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.RecoveryDeviceType.RecoveryDeviceType_ScrambledWords & Double = js.native
}
