...
object SdProtectOperationType extends StObject {
  ...
  /* 0 */ val DISABLE: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.SdProtectOperationType.DISABLE & Double = js.native
  
  @js.native
  sealed trait ENABLE
    extends StObject
       with SdProtectOperationType
  /* 1 */ val ENABLE: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.SdProtectOperationType.ENABLE & Double = js.native
  
  @js.native
  sealed trait REFRESH
    extends StObject
       with SdProtectOperationType
  /* 2 */ val REFRESH: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.SdProtectOperationType.REFRESH & Double = js.native
}
