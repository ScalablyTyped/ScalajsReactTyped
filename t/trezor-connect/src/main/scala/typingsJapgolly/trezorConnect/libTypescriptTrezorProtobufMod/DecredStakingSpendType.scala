...
object DecredStakingSpendType extends StObject {
  ...
  /* 0 */ val SSGen: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.DecredStakingSpendType.SSGen & Double = js.native
  
  @js.native
  sealed trait SSRTX
    extends StObject
       with DecredStakingSpendType
  /* 1 */ val SSRTX: typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.DecredStakingSpendType.SSRTX & Double = js.native
}
