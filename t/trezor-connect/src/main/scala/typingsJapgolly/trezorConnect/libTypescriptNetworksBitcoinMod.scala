...
import typingsJapgolly.trezorConnect.anon.AddressesAccountAddresses
import typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.InternalInputScriptType
import typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.MultisigRedeemScriptType
import typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.PrevInput
import typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.TxInput
import typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.TxInputType
import typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.TxOutputBinType
import typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.TxOutputType
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libTypescriptNetworksBitcoinMod {
  
  trait Address
    extends StObject
       with typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.Address {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.trezorConnect.anon.Binoutputs
    - typingsJapgolly.trezorConnect.anon.Branchid
  */
  ...
  object RefTransaction {
    ...
    inline def Binoutputs(
      ...
      __obj.asInstanceOf[typingsJapgolly.trezorConnect.anon.Binoutputs]
    }
    ...
    inline def Branchid(
      ...
      val __obj = js.Dynamic.literal(bin_outputs = bin_outputs.asInstanceOf[js.Any], hash = hash.asInstanceOf[js.Any], inputs = inputs.asInstanceOf[js.Any], lock_time = lock_time.asInstanceOf[js.Any], outputs = outputs.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.trezorConnect.anon.Branchid]
    }
  }
