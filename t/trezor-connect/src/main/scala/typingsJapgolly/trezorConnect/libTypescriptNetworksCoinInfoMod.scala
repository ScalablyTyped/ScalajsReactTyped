...
import typingsJapgolly.trezorConnect.anon.FeeLimit
import typingsJapgolly.trezorConnect.anon.Private
import typingsJapgolly.trezorConnect.trezorConnectStrings.bitcoin
import typingsJapgolly.trezorConnect.trezorConnectStrings.ethereum
import typingsJapgolly.trezorConnect.trezorConnectStrings.misc
import typingsJapgolly.trezorConnect.trezorConnectStrings.nem
...
object libTypescriptNetworksCoinInfoMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.trezorConnect.trezorConnectStrings.High
    - typingsJapgolly.trezorConnect.trezorConnectStrings.Normal
    - typingsJapgolly.trezorConnect.trezorConnectStrings.Economy
    - typingsJapgolly.trezorConnect.trezorConnectStrings.Low
  */
  trait BitcoinDefaultFeesKeys extends StObject
  object BitcoinDefaultFeesKeys {
    
    inline def Economy: typingsJapgolly.trezorConnect.trezorConnectStrings.Economy = "Economy".asInstanceOf[typingsJapgolly.trezorConnect.trezorConnectStrings.Economy]
    
    inline def High: typingsJapgolly.trezorConnect.trezorConnectStrings.High = "High".asInstanceOf[typingsJapgolly.trezorConnect.trezorConnectStrings.High]
    
    inline def Low: typingsJapgolly.trezorConnect.trezorConnectStrings.Low = "Low".asInstanceOf[typingsJapgolly.trezorConnect.trezorConnectStrings.Low]
    
    inline def Normal: typingsJapgolly.trezorConnect.trezorConnectStrings.Normal = "Normal".asInstanceOf[typingsJapgolly.trezorConnect.trezorConnectStrings.Normal]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.trezorConnect.libTypescriptNetworksCoinInfoMod.BitcoinNetworkInfo
    - typingsJapgolly.trezorConnect.libTypescriptNetworksCoinInfoMod.EthereumNetworkInfo
    - typingsJapgolly.trezorConnect.libTypescriptNetworksCoinInfoMod.MiscNetworkInfo
  */
  ...
  object CoinInfo {
    ...
    inline def BitcoinNetworkInfo(
      ...
      val __obj = js.Dynamic.literal(blocktime = blocktime.asInstanceOf[js.Any], curveName = curveName.asInstanceOf[js.Any], decimals = decimals.asInstanceOf[js.Any], defaultFees = defaultFees.asInstanceOf[js.Any], dustLimit = dustLimit.asInstanceOf[js.Any], forceBip143 = forceBip143.asInstanceOf[js.Any], hasTimestamp = hasTimestamp.asInstanceOf[js.Any], hashGenesisBlock = hashGenesisBlock.asInstanceOf[js.Any], isBitcoin = isBitcoin.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any], maxAddressLength = maxAddressLength.asInstanceOf[js.Any], maxFee = maxFee.asInstanceOf[js.Any], maxFeeSatoshiKb = maxFeeSatoshiKb.asInstanceOf[js.Any], minAddressLength = minAddressLength.asInstanceOf[js.Any], minFee = minFee.asInstanceOf[js.Any], minFeeSatoshiKb = minFeeSatoshiKb.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], network = network.asInstanceOf[js.Any], segwit = segwit.asInstanceOf[js.Any], shortcut = shortcut.asInstanceOf[js.Any], slip44 = slip44.asInstanceOf[js.Any], support = support.asInstanceOf[js.Any], xPubMagic = xPubMagic.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("bitcoin")
      __obj.asInstanceOf[typingsJapgolly.trezorConnect.libTypescriptNetworksCoinInfoMod.BitcoinNetworkInfo]
    }
    ...
    inline def EthereumNetworkInfo(
      ...
      __obj.asInstanceOf[typingsJapgolly.trezorConnect.libTypescriptNetworksCoinInfoMod.EthereumNetworkInfo]
    }
    ...
    inline def MiscNetworkInfo(
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.trezorConnect.libTypescriptNetworksCoinInfoMod.MiscNetworkInfo]
    }
  }
