...
import typingsJapgolly.trezorConnect.libTypescriptBackendTransactionsMod.RippleLibAdjustment
import typingsJapgolly.trezorConnect.libTypescriptBackendTransactionsMod.RippleLibMemo
