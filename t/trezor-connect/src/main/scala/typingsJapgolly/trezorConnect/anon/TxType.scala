...
import typingsJapgolly.trezorConnect.libTypescriptBackendTransactionsMod.RippleLibTransaction
import typingsJapgolly.trezorConnect.libTypescriptBackendTransactionsMod.TypedRawTransaction
import typingsJapgolly.trezorConnect.trezorConnectStrings.ripple
