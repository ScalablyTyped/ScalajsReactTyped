...
trait Opreturndata
  ...
  var amount: typingsJapgolly.trezorConnect.trezorConnectStrings.`0`
...
object Opreturndata {
  ...
  extension [Self <: Opreturndata](x: Self) {
    ...
    inline def setAmount(value: typingsJapgolly.trezorConnect.trezorConnectStrings.`0`): Self = StObject.set(x, "amount", value.asInstanceOf[js.Any])
