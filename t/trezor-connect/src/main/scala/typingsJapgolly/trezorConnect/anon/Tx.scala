...
import typingsJapgolly.trezorConnect.libTypescriptBackendTransactionsMod.BlockbookTransaction
import typingsJapgolly.trezorConnect.libTypescriptBackendTransactionsMod.TypedRawTransaction
import typingsJapgolly.trezorConnect.trezorConnectStrings.blockbook
