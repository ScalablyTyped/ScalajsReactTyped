...
import typingsJapgolly.trezorConnect.libTypescriptAccountMod.DiscoveryAccount
import typingsJapgolly.trezorConnect.libTypescriptAccountMod.DiscoveryAccountType
import typingsJapgolly.trezorConnect.trezorConnectStrings.end
import typingsJapgolly.trezorConnect.trezorConnectStrings.progress
import typingsJapgolly.trezorConnect.trezorConnectStrings.start
...
trait AccountTypes extends StObject {
  ...
  var coinInfo: typingsJapgolly.trezorConnect.libTypescriptNetworksCoinInfoMod.CoinInfo
...
object AccountTypes {
  ...
  inline def apply(
    coinInfo: typingsJapgolly.trezorConnect.libTypescriptNetworksCoinInfoMod.CoinInfo,
  ...
  extension [Self <: AccountTypes](x: Self) {
    ...
    inline def setCoinInfo(value: typingsJapgolly.trezorConnect.libTypescriptNetworksCoinInfoMod.CoinInfo): Self = StObject.set(x, "coinInfo", value.asInstanceOf[js.Any])
