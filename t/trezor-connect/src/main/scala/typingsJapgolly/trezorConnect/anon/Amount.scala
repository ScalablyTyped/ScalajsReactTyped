...
import typingsJapgolly.trezorConnect.libTypescriptNetworksCardanoMod.CardanoAssetGroup
import typingsJapgolly.trezorConnect.libTypescriptNetworksCardanoMod.CardanoOutput
