...
import typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.ButtonRequestType
...
trait OmitButtonRequestcodecodeCode extends StObject {
  
  var code: js.UndefOr[ButtonRequestType | ButtonRequest_FirmwareUpdate] = js.undefined
...
object OmitButtonRequestcodecodeCode {
  
  inline def apply(device: typingsJapgolly.trezorConnect.libTypescriptTrezorDeviceMod.Device): OmitButtonRequestcodecodeCode = {
