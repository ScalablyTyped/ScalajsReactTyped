...
import typingsJapgolly.trezorConnect.libTypescriptTrezorProtobufMod.DecredStakingSpendType
...
import typingsJapgolly.trezorConnect.trezorConnectStrings.EXTERNAL
