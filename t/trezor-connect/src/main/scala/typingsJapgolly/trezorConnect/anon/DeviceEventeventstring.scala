...
trait DeviceEventeventstring extends StObject {
  ...
  var payload: typingsJapgolly.trezorConnect.libTypescriptTrezorDeviceMod.Device
...
object DeviceEventeventstring {
  ...
  extension [Self <: DeviceEventeventstring](x: Self) {
    ...
    inline def setPayload(value: typingsJapgolly.trezorConnect.libTypescriptTrezorDeviceMod.Device): Self = StObject.set(x, "payload", value.asInstanceOf[js.Any])
