...
import typingsJapgolly.trezorConnect.trezorConnectStrings.manageSellOffer
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait StellarManageSellOfferOperation
  extends StObject
  ...
  var `type`: manageSellOffer
}
object StellarManageSellOfferOperation {
  
  inline def apply(amount: String, buying: StellarAsset, price: D, selling: StellarAsset): StellarManageSellOfferOperation = {
  ...
  extension [Self <: StellarManageSellOfferOperation](x: Self) {
    ...
    inline def setType(value: manageSellOffer): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
