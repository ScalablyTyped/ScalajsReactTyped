...
import typingsJapgolly.trezorConnect.anon.AllowPartialPayment
import typingsJapgolly.trezorConnect.anon.Data
import typingsJapgolly.trezorConnect.anon.Decimals
...
object libTypescriptBackendTransactionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.trezorConnect.anon.Tx
    - typingsJapgolly.trezorConnect.anon.TxType
  */
  trait TypedRawTransaction extends StObject
  object TypedRawTransaction {
    
    inline def Tx(tx: BlockbookTransaction): typingsJapgolly.trezorConnect.anon.Tx = {
      val __obj = js.Dynamic.literal(tx = tx.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("blockbook")
      __obj.asInstanceOf[typingsJapgolly.trezorConnect.anon.Tx]
    }
    
    inline def TxType(tx: RippleLibTransaction): typingsJapgolly.trezorConnect.anon.TxType = {
      val __obj = js.Dynamic.literal(tx = tx.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("ripple")
      __obj.asInstanceOf[typingsJapgolly.trezorConnect.anon.TxType]
    }
  }
