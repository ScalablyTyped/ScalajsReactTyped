...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.trezorConnect.libTypescriptNetworksNemMod.NEMRegularTransaction
  - typingsJapgolly.trezorConnect.libTypescriptNetworksNemMod.NEMMultisigTransaction
*/
...
object NEMTransaction {
  ...
  inline def NEMMultisigTransaction(
    ...
    __obj.asInstanceOf[typingsJapgolly.trezorConnect.libTypescriptNetworksNemMod.NEMMultisigTransaction]
  }
