...
import typingsJapgolly.trezorConnect.trezorConnectInts.`0x0102`
import typingsJapgolly.trezorConnect.trezorConnectInts.`0x1002`
import typingsJapgolly.trezorConnect.trezorConnectInts.`0x1004`
