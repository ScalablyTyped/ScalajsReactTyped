...
import typingsJapgolly.twilioVideo.twilioVideoNumbers.`53305`
import typingsJapgolly.twilioVideo.twilioVideoStrings.`The server has reached capacity and cannot fulfill this requestDot`
