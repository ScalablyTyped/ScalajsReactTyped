...
import typingsJapgolly.telegramWebApp.anon.Buttonid
import typingsJapgolly.telegramWebApp.anon.IsStateStable
import typingsJapgolly.telegramWebApp.telegramWebAppStrings.backButtonClicked
import typingsJapgolly.telegramWebApp.telegramWebAppStrings.bg_color
import typingsJapgolly.telegramWebApp.telegramWebAppStrings.dark
import typingsJapgolly.telegramWebApp.telegramWebAppStrings.light
import typingsJapgolly.telegramWebApp.telegramWebAppStrings.mainButtonClicked
import typingsJapgolly.telegramWebApp.telegramWebAppStrings.popupClosed
import typingsJapgolly.telegramWebApp.telegramWebAppStrings.secondary_bg_color
import typingsJapgolly.telegramWebApp.telegramWebAppStrings.settingsButtonClicked
import typingsJapgolly.telegramWebApp.telegramWebAppStrings.themeChanged
import typingsJapgolly.telegramWebApp.telegramWebAppStrings.viewportChanged
...
trait WebApp extends StObject {
  ...
  /**
    ...
    */
  var BackButton: typingsJapgolly.telegramWebApp.BackButton = js.native
  
  /**
    * An object for controlling haptic feedback.
    */
  var HapticFeedback: typingsJapgolly.telegramWebApp.HapticFeedback = js.native
  
  /**
    * An object for controlling the main button, which is displayed at the
    * bottom of the Web App in the Telegram interface.
    */
  var MainButton: typingsJapgolly.telegramWebApp.MainButton = js.native
