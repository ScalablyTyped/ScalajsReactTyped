...
import typingsJapgolly.twilioChat.channelMod.Channel
import typingsJapgolly.twilioChat.mediaMod.Media
import typingsJapgolly.twilioChat.memberMod.Member
import typingsJapgolly.twilioChat.messageMod.Message.Type
import typingsJapgolly.twilioChat.sessionerrorMod.SessionError
...
class Message_ protected () extends EventEmitter {
  ...
  def timestamp(): js.Date = js.native
