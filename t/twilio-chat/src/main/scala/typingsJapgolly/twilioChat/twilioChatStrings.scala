...
import typingsJapgolly.twilioChat.channelsMod.Channels.DataSource
import typingsJapgolly.twilioChat.memberMod.Member.Type
import typingsJapgolly.twilioChat.messageMod.Message.UpdateReason
import typingsJapgolly.twilioChat.mod.Client.ChannelSortingCriteria
import typingsJapgolly.twilioChat.mod.Client.ChannelSortingOrder
import typingsJapgolly.twilioChat.mod.Client._LogLevel
import typingsJapgolly.twilioChat.userMod.User.SubscriptionState
...
object twilioChatStrings {
  ...
  sealed trait attributes
    extends UpdateReason
       with typingsJapgolly.twilioChat.channelMod.Channel.UpdateReason
       with typingsJapgolly.twilioChat.userMod.User.UpdateReason
       with typingsJapgolly.twilioChat.memberMod.Member.UpdateReason
  ...
  sealed trait createdBy
    extends typingsJapgolly.twilioChat.channelMod.Channel.UpdateReason
  ...
  sealed trait lastConsumptionTimestamp
    extends typingsJapgolly.twilioChat.memberMod.Member.UpdateReason
  ...
  @js.native
  sealed trait media
    extends typingsJapgolly.twilioChat.messageMod.Message.Type
  ...
  sealed trait notifiable
    extends typingsJapgolly.twilioChat.userMod.User.UpdateReason
  ...
  sealed trait `private`
    extends typingsJapgolly.twilioChat.channelMod.Channel.Type
  ...
  sealed trait twilioDotchannelDotadded_to_channel
    extends typingsJapgolly.twilioChat.pushnotificationMod.PushNotification.Type
