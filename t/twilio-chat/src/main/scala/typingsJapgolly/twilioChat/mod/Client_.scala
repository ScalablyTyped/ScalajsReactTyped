...
import typingsJapgolly.twilioChat.channelsMod.Channel
import typingsJapgolly.twilioChat.mod.Client.ChannelSortingOptions
import typingsJapgolly.twilioChat.mod.Client.ConnectionState
import typingsJapgolly.twilioChat.mod.Client.CreateChannelOptions
import typingsJapgolly.twilioChat.mod.Client.NotificationsChannelType
import typingsJapgolly.twilioChat.paginatorMod.Paginator
...
class Client_ protected () extends EventEmitter {
  ...
  /**
    ...
    */
  def getSubscribedUsers(): js.Promise[js.Array[typingsJapgolly.twilioChat.userMod.User]] = js.native
  /**
    ...
    */
  def getUser(identity: String): js.Promise[typingsJapgolly.twilioChat.userMod.User] = js.native
  /**
  ...
  def user(): typingsJapgolly.twilioChat.userMod.User = js.native
}
