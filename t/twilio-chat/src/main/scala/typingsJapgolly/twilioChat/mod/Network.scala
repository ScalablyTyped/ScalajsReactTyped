...
object Network {
  ...
  extension [Self <: Network](x: Self) {
    ...
    inline def setPokeTimer(value: Callback): Self = StObject.set(x, "pokeTimer", value.toJsFn)
