...
object ChannelDescriptor0 {
  ...
  inline def apply(
    ...
    descriptor: Any,
    friendlyName: String,
    getChannel: CallbackTo[js.Promise[Channel]],
    isPrivate: Boolean,
  ...
  extension [Self <: ChannelDescriptor0](x: Self) {
    ...
    inline def setGetChannel(value: CallbackTo[js.Promise[Channel]]): Self = StObject.set(x, "getChannel", value.toJsFn)
