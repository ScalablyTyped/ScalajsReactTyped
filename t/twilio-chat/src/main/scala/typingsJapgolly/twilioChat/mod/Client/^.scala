...
import typingsJapgolly.twilioChat.pushnotificationMod.PushNotification
...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def create(token: String): js.Promise[typingsJapgolly.twilioChat.mod.Client] = js.native
  def create(token: String, options: Options): js.Promise[typingsJapgolly.twilioChat.mod.Client] = js.native
  /**
