...
import typingsJapgolly.twilioChat.mod.Client.Options
...
object default extends js.Object {
  ...
  /**
    ...
    */
  def parsePushNotification(notificationPayload: js.Any): typingsJapgolly.twilioChat.pushnotificationMod.PushNotification = js.native
}
