...
import typingsJapgolly.twilioChat.channelMod.ChannelDescriptor
import typingsJapgolly.twilioChat.channelMod.ChannelServices
...
class Channel protected ()
  extends typingsJapgolly.twilioChat.channelMod.Channel {
  /**
