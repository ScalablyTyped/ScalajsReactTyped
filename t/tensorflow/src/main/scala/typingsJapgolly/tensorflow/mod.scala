...
object mod {
  ...
  object Types extends StObject {
    ...
    sealed trait float
      extends StObject
         with Types
    /* 1 */ val float: typingsJapgolly.tensorflow.mod.Types.float & Double = js.native
    
    @js.native
    sealed trait int32
      extends StObject
         with Types
    /* 3 */ val int32: typingsJapgolly.tensorflow.mod.Types.int32 & Double = js.native
  }
  ...
  object Graph_ {
    ...
    inline def apply(createSession: CallbackTo[Session], delete: CallbackTo[Any]): Graph_ = {
      val __obj = js.Dynamic.literal(createSession = createSession.toJsFn, delete = delete.toJsFn)
      __obj.asInstanceOf[Graph_]
    }
    
    extension [Self <: Graph_](x: Self) {
      
      inline def setCreateSession(value: CallbackTo[Session]): Self = StObject.set(x, "createSession", value.toJsFn)
