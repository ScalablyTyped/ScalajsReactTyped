package typingsJapgolly.textfit
...
object mod {
  ...
  inline def apply(els: HTMLCollection[Any]): Unit = ^.asInstanceOf[js.Dynamic].apply(els.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def apply(els: HTMLCollection[Any], options: TextFitOption): Unit = (^.asInstanceOf[js.Dynamic].apply(els.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def apply(els: NodeList[Element & Node]): Unit = ^.asInstanceOf[js.Dynamic].apply(els.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def apply(els: NodeList[Element & Node], options: TextFitOption): Unit = (^.asInstanceOf[js.Dynamic].apply(els.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
