...
import typingsJapgolly.toJsonSchema.anon.AdditionalProperties
import typingsJapgolly.toJsonSchema.anon.DetectFormat
import typingsJapgolly.toJsonSchema.anon.Mode
