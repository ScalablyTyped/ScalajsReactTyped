...
object outListZipObjMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait ZipObj[LKeys /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */, LFields /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] extends StObject
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait _ZipObj[LKeys /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */, LFields /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] extends StObject
  
  /**
    * @hidden
    */
  type __ZipObj[LKeys /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */, LFields /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, O /* <: js.Object */, I /* <: Iteration */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.0ZipObj<LKeys, LFields, O, I>[ts-toolbelt.ts-toolbelt/out/Any/Extends.Extends<ts-toolbelt.ts-toolbelt/out/Iteration/Pos.Pos<I>, ts-toolbelt.ts-toolbelt/out/List/Length.Length<LKeys>>] */ js.Any
}
