...
object outObjectPMergeMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait Merge[O /* <: js.Object */, Path /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */, O1 /* <: js.Object */, depth /* <: Depth */] extends StObject
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait MergeAt[O, Path /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */, O1, depth /* <: Depth */] extends StObject
}
