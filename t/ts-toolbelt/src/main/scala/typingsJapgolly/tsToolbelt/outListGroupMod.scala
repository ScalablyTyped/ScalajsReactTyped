...
object outListGroupMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait Group[L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, N /* <: Double */] extends StObject
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait _Group[L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, N /* <: Double */] extends StObject
  
  /**
    * @hidden
    */
  type __Group[L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, N /* <: Double */, LN /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.0Group<L, N, LN>[ts-toolbelt.ts-toolbelt/out/Any/Extends.Extends<L, ts-toolbelt.ts-toolbelt/out/List/List.List<never>>] */ js.Any
}
