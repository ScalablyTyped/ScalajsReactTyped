...
object outUnionListOfMod {
  ...
  /**
    * @hidden
    */
  type _ListOf[U, LN /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, LastU] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.1LN<U, LastU, LN>[ts-toolbelt.ts-toolbelt/out/Any/Extends.Extends<[U], [never]>] */ js.Any
}
