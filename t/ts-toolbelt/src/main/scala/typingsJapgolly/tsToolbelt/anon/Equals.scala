...
import typingsJapgolly.tsToolbelt.outAnyKeysMod.Keys
import typingsJapgolly.tsToolbelt.outObjectIntersectKeysMod.IntersectMatch
import typingsJapgolly.tsToolbelt.tsToolbeltStrings.`Lessthansign-contains`
import typingsJapgolly.tsToolbelt.tsToolbeltStrings.`Lessthansign-extends`
import typingsJapgolly.tsToolbelt.tsToolbeltStrings.`contains-Greaterthansign`
import typingsJapgolly.tsToolbelt.tsToolbeltStrings.`extends-Greaterthansign`
import typingsJapgolly.tsToolbelt.tsToolbeltStrings.equals
...
trait Equals[O /* <: js.Object */, O1 /* <: js.Object */] extends StObject {
  ...
  @JSName("<-contains")
  var `Lessthansign-contains`: IntersectMatch[O, O1, typingsJapgolly.tsToolbelt.tsToolbeltStrings.`Lessthansign-contains`]
  
  @JSName("<-extends")
  var `Lessthansign-extends`: IntersectMatch[O, O1, typingsJapgolly.tsToolbelt.tsToolbeltStrings.`Lessthansign-extends`]
  
  @JSName("contains->")
  var `contains-Greaterthansign`: IntersectMatch[O, O1, typingsJapgolly.tsToolbelt.tsToolbeltStrings.`contains-Greaterthansign`]
  
  @JSName("equals")
  var equals_FEquals: IntersectMatch[O, O1, equals]
  
  @JSName("extends->")
  var `extends-Greaterthansign`: IntersectMatch[O, O1, typingsJapgolly.tsToolbelt.tsToolbeltStrings.`extends-Greaterthansign`]
}
object Equals {
