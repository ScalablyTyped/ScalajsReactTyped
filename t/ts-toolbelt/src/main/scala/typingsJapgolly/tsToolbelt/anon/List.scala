...
import typingsJapgolly.tsToolbelt.outFunctionComposeListSyncMod.ComposeListSync
import typingsJapgolly.tsToolbelt.outFunctionComposeMultiSyncMod.ComposeMultiSync
...
object List {
  ...
  inline def apply(list: ComposeListSync, multi: ComposeMultiSync): typingsJapgolly.tsToolbelt.anon.List = {
    val __obj = js.Dynamic.literal(list = list.asInstanceOf[js.Any], multi = multi.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsJapgolly.tsToolbelt.anon.List]
  }
  
  extension [Self <: typingsJapgolly.tsToolbelt.anon.List](x: Self) {
