...
trait `1PSplit`[P /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, PRest /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, PSplit /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */] extends StObject {
...
object `1PSplit` {
  ...
  inline def apply[P /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, PRest /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, PSplit /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */](
  ...
  extension [Self <: `1PSplit`[?, ?, ?], P /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, PRest /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, PSplit /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */](x: Self & (`1PSplit`[P, PRest, PSplit])) {
