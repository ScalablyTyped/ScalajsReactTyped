...
trait `3` extends StObject {
  ...
  var `0`: typingsJapgolly.tsToolbelt.tsToolbeltInts.`1`
...
object `3` {
  ...
  extension [Self <: `3`](x: Self) {
    ...
    inline def set0(value: typingsJapgolly.tsToolbelt.tsToolbeltInts.`1`): Self = StObject.set(x, "0", value.asInstanceOf[js.Any])
