...
import typingsJapgolly.tsToolbelt.outObjectExcludeKeysMod.ExcludeMatch
...
trait Default[O /* <: js.Object */, O1 /* <: js.Object */] extends StObject {
  ...
  @JSName("<-contains")
  var `Lessthansign-contains`: ExcludeMatch[O, O1, typingsJapgolly.tsToolbelt.tsToolbeltStrings.`Lessthansign-contains`]
  
  @JSName("<-extends")
  var `Lessthansign-extends`: ExcludeMatch[O, O1, typingsJapgolly.tsToolbelt.tsToolbeltStrings.`Lessthansign-extends`]
  
  @JSName("contains->")
  var `contains-Greaterthansign`: ExcludeMatch[O, O1, typingsJapgolly.tsToolbelt.tsToolbeltStrings.`contains-Greaterthansign`]
  
  @JSName("equals")
  var equals_FDefault: ExcludeMatch[O, O1, equals]
  
  @JSName("extends->")
  var `extends-Greaterthansign`: ExcludeMatch[O, O1, typingsJapgolly.tsToolbelt.tsToolbeltStrings.`extends-Greaterthansign`]
}
object Default {
