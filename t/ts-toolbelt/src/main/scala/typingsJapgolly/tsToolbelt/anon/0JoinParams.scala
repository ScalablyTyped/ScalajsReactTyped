...
import typingsJapgolly.tsToolbelt.outFunctionCurryMod._JoinParams
import typingsJapgolly.tsToolbelt.outListTailMod.Tail
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait `0JoinParams`[PSplit /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */, L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] extends StObject {
...
object `0JoinParams` {
  ...
  inline def apply[PSplit /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */, L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */](
    `0`: _JoinParams[
      Tail[PSplit], 
      /* import warning: importer.ImportType#apply c repeated non-array type: L */ js.Array[L]
    ],
  ...
  extension [Self <: `0JoinParams`[?, ?], PSplit /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */, L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */](x: Self & (`0JoinParams`[PSplit, L])) {
