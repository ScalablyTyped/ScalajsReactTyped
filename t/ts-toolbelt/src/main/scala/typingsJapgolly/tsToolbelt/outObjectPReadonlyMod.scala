...
object outObjectPReadonlyMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait Readonly[O /* <: js.Object */, Path /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */, depth /* <: Depth */] extends StObject
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait ReadonlyAt[O, Path /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */, depth /* <: Depth */] extends StObject
}
