...
object outObjectPUpdateMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait Update[O /* <: js.Object */, Path /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */, A /* <: Any */] extends StObject
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait UpdateAt[O, Path /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */, A] extends StObject
}
