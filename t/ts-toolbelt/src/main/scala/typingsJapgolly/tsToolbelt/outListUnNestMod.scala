...
object outListUnNestMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait Flatter[L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, LN /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, I /* <: Iteration */] extends StObject
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait UnNest[L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, strict /* <: Boolean */] extends StObject
  
  /**
    * @hidden
    */
  type UnNestLoose[L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] = js.Array[
  ...
  /**
    * @hidden
    */
  type UnNestStrict[L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, LN /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, I /* <: Iteration */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.0UnNestStrict<L, LN, I>[ts-toolbelt.ts-toolbelt/out/Any/Extends.Extends<ts-toolbelt.ts-toolbelt/out/Iteration/Pos.Pos<I>, ts-toolbelt.ts-toolbelt/out/List/Length.Length<L>>] */ js.Any
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait _UnNest[L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, strict /* <: Boolean */] extends StObject
  
  /**
    * @hidden
    */
  type __UnNest[L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, strict /* <: Boolean */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.0UnNestLoose<L>[ts-toolbelt.ts-toolbelt/out/Boolean/And.And<ts-toolbelt.ts-toolbelt/out/Boolean/Not.Not<ts-toolbelt.ts-toolbelt/out/Any/Extends.Extends<number, ts-toolbelt.ts-toolbelt/out/List/Length.Length<L>>>, strict>] */ js.Any
}
