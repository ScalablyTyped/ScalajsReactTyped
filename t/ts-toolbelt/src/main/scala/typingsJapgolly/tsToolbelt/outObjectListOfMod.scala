...
object outObjectListOfMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait AppendExists[O /* <: js.Object */, LN /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, I /* <: Iteration */] extends StObject
  ...
  /**
    * @hidden
    */
  type ___ListOf[O /* <: js.Object */, K, LN /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, I /* <: Iteration */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.0ListOf<O, K, I, LN>[ts-toolbelt.ts-toolbelt/out/Any/Extends.Extends<[K], [never]>] */ js.Any
}
