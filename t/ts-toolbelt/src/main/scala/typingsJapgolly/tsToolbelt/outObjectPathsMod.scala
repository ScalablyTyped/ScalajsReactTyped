...
object outObjectPathsMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait Paths[O, P /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] extends StObject
  ...
  /**
    * @hidden
    */
  type _Paths[O, P /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] = UnionOf[
