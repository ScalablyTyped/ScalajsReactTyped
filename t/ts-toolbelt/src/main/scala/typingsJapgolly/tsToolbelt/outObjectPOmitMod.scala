...
object outObjectPOmitMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait Omit[O /* <: js.Object */, Path /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */] extends StObject
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait OmitAt[O, Path /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */] extends StObject
}
