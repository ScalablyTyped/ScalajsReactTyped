...
object outObjectPathMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait Path[O /* <: Any */, P /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */] extends StObject
  
  /**
    * @ignore
    */
  type _Path[O, P /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Key] */, I /* <: Iteration */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.0Path<O, P, I>[ts-toolbelt.ts-toolbelt/out/Any/Extends.Extends<ts-toolbelt.ts-toolbelt/out/Iteration/Pos.Pos<I>, ts-toolbelt.ts-toolbelt/out/List/Length.Length<P>>] */ js.Any
}
