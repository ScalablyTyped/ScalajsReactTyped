...
import typingsJapgolly.tsToolbelt.outObjectNonNullableMod.NonNullableFlat
...
object outFunctionCurryMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait GapOf[L1 /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, L2 /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */, LN /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, I /* <: Iteration */] extends StObject
  
  /**
    * @hidden
    */
  type Gaps[L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] = Cast[
    NonNullableFlat[
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait GapsOf[L1 /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, L2 /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] extends StObject
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait JoinParams[P /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */] extends StObject
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait SplitParams[P /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] extends StObject
  
  /**
    * @hidden
    */
  type _GapsOf[L1 /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, L2 /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */, LN /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, L2D /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */, I /* <: Iteration */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.0GapsOf<L1, L2, LN, I, L2D>[ts-toolbelt.ts-toolbelt/out/Any/Extends.Extends<ts-toolbelt.ts-toolbelt/out/Iteration/Pos.Pos<I>, ts-toolbelt.ts-toolbelt/out/List/Length.Length<L1>>] */ js.Any
  
  /**
    * @hidden
    */
  type _JoinParams[PSplit /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */, L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.0JoinParams<PSplit, L>[number extends ts-toolbelt.ts-toolbelt/out/List/Length.Length<PSplit> ? 2 : PSplit extends [] ? 1 : 0] */ js.Any
  
  /**
    * @hidden
    */
  type _SplitParams[P /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */, PSplit /* <: js.Array[typingsJapgolly.tsToolbelt.outListListMod.List[Any]] */, PRest /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.1PSplit<P, PRest, PSplit>[number extends ts-toolbelt.ts-toolbelt/out/List/Length.Length<P> ? 2 : P extends [] ? 1 : 0] */ js.Any
}
