...
object outNumberRangeMod {
  ...
  /**
    * @hidden
    */
  type RangeBack[From /* <: Iteration */, To /* <: Iteration */, L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.0RangeBack<From, To, L>[ts-toolbelt.ts-toolbelt/out/Any/Extends.Extends<From, To>] */ js.Any
  
  /**
    * @hidden
    */
  type RangeForth[From /* <: Iteration */, To /* <: Iteration */, L /* <: typingsJapgolly.tsToolbelt.outListListMod.List[Any] */] = /* import warning: importer.ImportType#apply Failed type conversion: ts-toolbelt.anon.0RangeForth<From, To, L>[ts-toolbelt.ts-toolbelt/out/Any/Extends.Extends<From, To>] */ js.Any
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait _Range[From /* <: Double */, To /* <: Double */, way /* <: Way */] extends StObject
