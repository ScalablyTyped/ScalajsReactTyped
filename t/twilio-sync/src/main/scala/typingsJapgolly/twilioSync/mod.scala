...
import typingsJapgolly.twilioSync.listitemMod.ListItem
import typingsJapgolly.twilioSync.listitemMod.ListItemDescriptor
import typingsJapgolly.twilioSync.mapitemMod.MapItem
import typingsJapgolly.twilioSync.mapitemMod.MapItemDescriptor
import typingsJapgolly.twilioSync.syncdocumentMod.SyncDocumentImpl
import typingsJapgolly.twilioSync.synclistMod.SyncListImpl
import typingsJapgolly.twilioSync.syncmapMod.SyncMapImpl
...
object mod extends js.Object {
  ...
  class SyncClient protected ()
    extends typingsJapgolly.twilioSync.clientMod.SyncClient {
  ...
  class SyncDocument protected ()
    extends typingsJapgolly.twilioSync.syncdocumentMod.SyncDocument {
  ...
  class SyncList protected ()
    extends typingsJapgolly.twilioSync.synclistMod.SyncList {
  ...
  class SyncMap protected ()
    extends typingsJapgolly.twilioSync.syncmapMod.SyncMap {
