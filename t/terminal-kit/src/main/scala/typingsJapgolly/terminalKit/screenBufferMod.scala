...
import typingsJapgolly.terminalKit.anon.Attr
import typingsJapgolly.terminalKit.anon.Char
import typingsJapgolly.terminalKit.anon.Dst
import typingsJapgolly.terminalKit.anon.Shrink
import typingsJapgolly.terminalKit.anon.TransparencyChar
import typingsJapgolly.terminalKit.anon.X
...
object screenBufferMod {
  ...
  object DrawOptions {
    ...
    extension [Self <: DrawOptions](x: Self) {
      ...
      inline def setDstClipRect(value: typingsJapgolly.terminalKit.rectMod.^): Self = StObject.set(x, "dstClipRect", value.asInstanceOf[js.Any])
      ...
      inline def setSrcClipRect(value: typingsJapgolly.terminalKit.rectMod.^): Self = StObject.set(x, "srcClipRect", value.asInstanceOf[js.Any])
      ...
      inline def setWrap(value: Boolean | typingsJapgolly.terminalKit.terminalKitStrings.x | y): Self = StObject.set(x, "wrap", value.asInstanceOf[js.Any])
