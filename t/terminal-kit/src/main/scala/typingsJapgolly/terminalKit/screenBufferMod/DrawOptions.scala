...
trait DrawOptions extends js.Object {
  ...
  var dstClipRect: js.UndefOr[typingsJapgolly.terminalKit.rectMod.^] = js.undefined
  var srcClipRect: js.UndefOr[typingsJapgolly.terminalKit.rectMod.^] = js.undefined
...
object DrawOptions {
  ...
  def apply(
    ...
    dstClipRect: typingsJapgolly.terminalKit.rectMod.^ = null,
    srcClipRect: typingsJapgolly.terminalKit.rectMod.^ = null,
