...
import typingsJapgolly.terminalKit.anon.AttrChar
...
object screenBufferHDMod {
  ...
  open class ^ protected () extends ScreenBufferHD {
    def this(options: typingsJapgolly.terminalKit.anon.Blending) = this()
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.terminalKit.terminalKitBooleans.`false`
    - typingsJapgolly.terminalKit.screenBufferHDMod.Blending
  */
  ...
  trait ScreenBufferHD
    ...
    def draw(options: typingsJapgolly.terminalKit.anon.Blending): Unit = js.native
