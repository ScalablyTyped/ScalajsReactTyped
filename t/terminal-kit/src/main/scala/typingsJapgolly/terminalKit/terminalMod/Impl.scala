...
import typingsJapgolly.terminalKit.anon.Abort
import typingsJapgolly.terminalKit.anon.B
import typingsJapgolly.terminalKit.anon.BarStyle
import typingsJapgolly.terminalKit.anon.Continue
import typingsJapgolly.terminalKit.anon.Delay
import typingsJapgolly.terminalKit.anon.Mouse
import typingsJapgolly.terminalKit.anon.NoAlternate
import typingsJapgolly.terminalKit.anon.Promise
import typingsJapgolly.terminalKit.anon.PromisePromise
import typingsJapgolly.terminalKit.anon.`1`
import typingsJapgolly.terminalKit.anon.`2`
import typingsJapgolly.terminalKit.anon.`3`
...
trait Impl extends StObject {
  ...
  def apply(args: Any*): Terminal = js.native
  def apply(str: String): Terminal = js.native
  
  def alternateScreenBuffer(): Terminal = js.native
  def alternateScreenBuffer(args: Any*): Terminal = js.native
  ...
  def applicationKeypad(args: Any*): Terminal = js.native
  ...
  def backDelete(args: Any*): Terminal = js.native
  ...
  def bgBrightBlue(args: Any*): Terminal = js.native
  ...
  def bgBrightCyan(args: Any*): Terminal = js.native
  ...
  def bgBrightGreen(args: Any*): Terminal = js.native
  ...
  def bgBrightMagenta(args: Any*): Terminal = js.native
  ...
  def bgBrightRed(args: Any*): Terminal = js.native
  ...
  def bgBrightWhite(args: Any*): Terminal = js.native
  ...
  def bgBrightYellow(args: Any*): Terminal = js.native
  ...
  def bgCyan(args: Any*): Terminal = js.native
  ...
  def bgDefaultColor(args: Any*): Terminal = js.native
  ...
  def brightBlue(args: Any*): Terminal = js.native
  ...
  def brightCyan(args: Any*): Terminal = js.native
  ...
  def brightGreen(args: Any*): Terminal = js.native
  ...
  def brightMagenta(args: Any*): Terminal = js.native
  ...
  def cyan(args: Any*): Terminal = js.native
  ...
  def defaultColor(args: Any*): Terminal = js.native
  ...
  def dim(args: Any*): Terminal = js.native
  ...
  def eraseDisplay(args: Any*): Terminal = js.native
  def eraseDisplay(str: String): Terminal = js.native
  
  def eraseDisplayAbove(): Terminal = js.native
  def eraseDisplayAbove(args: Any*): Terminal = js.native
  ...
  def eraseDisplayBelow(args: Any*): Terminal = js.native
  ...
  def eraseLine(args: Any*): Terminal = js.native
  def eraseLine(str: String): Terminal = js.native
  
  def eraseLineAfter(): Terminal = js.native
  def eraseLineAfter(args: Any*): Terminal = js.native
  ...
  def eraseLineBefore(args: Any*): Terminal = js.native
  ...
  def eraseScrollback(args: Any*): Terminal = js.native
  ...
  def error(args: Any*): Terminal = js.native
  ...
  def focusEvent(args: Any*): Terminal = js.native
  ...
  def getCursorLocation(
    callback: js.Function3[/* error */ Any, /* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double], Unit]
  ): Unit = js.native
  ...
  def inputField(): Promise = js.native
  def inputField(callback: Callback[js.UndefOr[String]]): Promise = js.native
  def inputField(options: Unit, callback: Callback[js.UndefOr[String]]): Promise = js.native
  ...
  def moveTo(args: Any*): Terminal = js.native
  ...
  def noFormat(args: Any*): Terminal = js.native
  ...
  def red(args: Any*): Terminal = js.native
  ...
  def requestCursorLocation(args: Any*): Terminal = js.native
  ...
  def requestScreenSize(args: Any*): Terminal = js.native
  ...
  def reset(args: Any*): Terminal = js.native
  def reset(str: String): Terminal = js.native
  
  def resetCursorColorRgb(): Terminal = js.native
  def resetCursorColorRgb(args: Any*): Terminal = js.native
  ...
  def resetDefaultBgColorRgb(args: Any*): Terminal = js.native
  ...
  def resetDefaultColorRgb(args: Any*): Terminal = js.native
  ...
  def resetHighlightBgColorRgb(args: Any*): Terminal = js.native
  ...
  def resetScrollingRegion(args: Any*): Terminal = js.native
  ...
  def restoreCursor(args: Any*): Terminal = js.native
  ...
  def saveCursor(args: Any*): Terminal = js.native
  ...
  def tabSet(args: Any*): Terminal = js.native
  def tabSet(str: String): Terminal = js.native
  @JSName("tabSet")
  var tabSet_Original: Terminal = js.native
  
  def table(tableCells: js.Array[js.Array[String]]): Unit = js.native
  def table(tableCells: js.Array[js.Array[String]], options: TextTableOptions): Unit = js.native
  
  var termconfigFile: String = js.native
  
  def underline(): Terminal = js.native
  def underline(args: Any*): Terminal = js.native
  def underline(str: String): Terminal = js.native
  @JSName("underline")
  var underline_Original: CTerminal = js.native
  
  var up: (js.Function1[/* n */ Double, Terminal]) | (js.Function2[/* n */ Double, /* repeated */ Any, Terminal]) = js.native
  
  def white(): Terminal = js.native
  def white(args: Any*): Terminal = js.native
  ...
  def wrap(args: Any*): Terminal = js.native
  ...
  def yellow(args: Any*): Terminal = js.native
