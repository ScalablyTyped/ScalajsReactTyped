...
import typingsJapgolly.terminalKit.anon.FinalCall
import typingsJapgolly.terminalKit.anon.Height
import typingsJapgolly.terminalKit.anon.Misc
import typingsJapgolly.terminalKit.anon.`4`
import typingsJapgolly.terminalKit.rectMod.Region
import typingsJapgolly.terminalKit.screenBufferMod.Attributes
import typingsJapgolly.terminalKit.screenBufferMod.DrawOptions
...
object textBufferMod {
  ...
  trait Options extends StObject {
    ...
    var dst: typingsJapgolly.terminalKit.screenBufferMod.^
  ...
  object Options {
    ...
    inline def apply(dst: typingsJapgolly.terminalKit.screenBufferMod.^): Options = {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setDst(value: typingsJapgolly.terminalKit.screenBufferMod.^): Self = StObject.set(x, "dst", value.asInstanceOf[js.Any])
