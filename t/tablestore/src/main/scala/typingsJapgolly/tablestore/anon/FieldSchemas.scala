...
trait FieldSchemas extends StObject {
  ...
  var fieldSchemas: js.Array[typingsJapgolly.tablestore.mod.FieldSchemas]
...
object FieldSchemas {
  ...
  inline def apply(fieldSchemas: js.Array[typingsJapgolly.tablestore.mod.FieldSchemas]): FieldSchemas = {
  ...
  extension [Self <: FieldSchemas](x: Self) {
    ...
    inline def setFieldSchemas(value: js.Array[typingsJapgolly.tablestore.mod.FieldSchemas]): Self = StObject.set(x, "fieldSchemas", value.asInstanceOf[js.Any])
    
    inline def setFieldSchemasVarargs(value: typingsJapgolly.tablestore.mod.FieldSchemas*): Self = StObject.set(x, "fieldSchemas", js.Array(value*))
