...
import typingsJapgolly.tsLoader.tsLoaderStrings.dts
import typingsJapgolly.tsLoader.tsLoaderStrings.js_
import typingsJapgolly.tsLoader.tsLoaderStrings.quit
...
object anon {
  ...
  trait ConfigFile extends StObject {
    ...
    var configFile: typingsJapgolly.tsLoader.distConfigMod.ConfigFile
  ...
  object ConfigFile {
    ...
    inline def apply(configFile: typingsJapgolly.tsLoader.distConfigMod.ConfigFile): ConfigFile = {
    ...
    extension [Self <: ConfigFile](x: Self) {
      ...
      inline def setConfigFile(value: typingsJapgolly.tsLoader.distConfigMod.ConfigFile): Self = StObject.set(x, "configFile", value.asInstanceOf[js.Any])
