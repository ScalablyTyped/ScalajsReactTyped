...
import typingsJapgolly.tensorflowModelsFaceDetection.distSharedCalculatorsInterfacesConfigInterfacesMod.KeypointsSmoothingConfig
...
object distSharedFiltersKeypointsSmoothingMod {
  ...
  @JSImport("@tensorflow-models/face-detection/dist/shared/filters/keypoints_smoothing", "KeypointsSmoothingFilter")
  @js.native
