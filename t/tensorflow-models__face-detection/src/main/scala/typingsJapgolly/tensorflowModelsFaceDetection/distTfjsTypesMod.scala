...
import typingsJapgolly.tensorflowModelsFaceDetection.distMediapipeTypesMod.MediaPipeFaceDetectorEstimationConfig
import typingsJapgolly.tensorflowModelsFaceDetection.distMediapipeTypesMod.MediaPipeFaceDetectorModelConfig
