...
import typingsJapgolly.tensorflowModelsFaceDetection.distSharedCalculatorsInterfacesCommonInterfacesMod.Color
import typingsJapgolly.tensorflowModelsFaceDetection.distSharedCalculatorsInterfacesCommonInterfacesMod.PixelInput
import typingsJapgolly.tensorflowModelsFaceDetection.distSharedCalculatorsInterfacesCommonInterfacesMod.Segmentation
...
object distSharedCalculatorsRenderUtilMod {
  ...
  @JSImport("@tensorflow-models/face-detection/dist/shared/calculators/render_util", JSImport.Namespace)
  @js.native
