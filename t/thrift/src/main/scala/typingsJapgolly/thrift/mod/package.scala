...
import typingsJapgolly.thrift.mod.^
...
]]) | typingsJapgolly.node.tlsMod.Server = (^.asInstanceOf[js.Dynamic].applyDynamic("createServer")(processor.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[(Server[
Instantiable1[/* socket */ Socket, IncomingMessage], 
Instantiable1[
  /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
  ServerResponse[IncomingMessage]
]]) | typingsJapgolly.node.tlsMod.Server]
...
Instantiable1[
  /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
  ServerResponse[IncomingMessage]
]]) | typingsJapgolly.node.tlsMod.Server = (^.asInstanceOf[js.Dynamic].applyDynamic("createServer")(processor.asInstanceOf[js.Any], handler.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[(Server[
Instantiable1[/* socket */ Socket, IncomingMessage], 
Instantiable1[
  /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
  ServerResponse[IncomingMessage]
...
Instantiable1[
  /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
  ServerResponse[IncomingMessage]
]]) | typingsJapgolly.node.tlsMod.Server = ^.asInstanceOf[js.Dynamic].applyDynamic("createWebServer")(options.asInstanceOf[js.Any]).asInstanceOf[(Server[
Instantiable1[/* socket */ Socket, IncomingMessage], 
Instantiable1[
  /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
  ServerResponse[IncomingMessage]
