...
import typingsJapgolly.thrift.mod.TClientConstructor
import typingsJapgolly.thrift.mod.TProcessorConstructor
import typingsJapgolly.thrift.mod.TProtocol
import typingsJapgolly.thrift.mod.TTransport
