...
object distEngineTopologyMod {
  ...
  /* note: abstract class */ @JSImport("@tensorflow/tfjs-layers/dist/engine/topology", "Layer")
  @js.native
  open class Layer () extends Serializable {
    ...
    def built: Boolean = js.native
    def built_=(built: Boolean): Unit = js.native
    ...
    def nonTrainableWeights_=(weights: js.Array[LayerVariable]): Unit = js.native
    ...
    def trainableWeights_=(weights: js.Array[LayerVariable]): Unit = js.native
    ...
    def updates: js.Array[Tensor[Rank]] = js.native
