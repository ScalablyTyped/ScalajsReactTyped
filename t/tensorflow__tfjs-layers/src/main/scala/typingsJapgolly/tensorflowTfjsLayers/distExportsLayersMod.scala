...
object distExportsLayersMod {
  ...
  @js.native
  open class Layer ()
    extends typingsJapgolly.tensorflowTfjsLayers.distEngineTopologyMod.Layer {
  ...
  @js.native
  open class RNNCell ()
    extends typingsJapgolly.tensorflowTfjsLayers.distLayersRecurrentMod.RNNCell {
    def this(args: LayerArgs) = this()
  }
  ...
  open class RNN_ protected ()
    extends typingsJapgolly.tensorflowTfjsLayers.distLayersRecurrentMod.RNN_ {
