...
import typingsJapgolly.tensorflowTfjsCore.distModelTypesMod.ModelPredictConfig
...
import typingsJapgolly.tensorflowTfjsLayers.distEngineTrainingDatasetMod.ModelEvaluateDatasetArgs
import typingsJapgolly.tensorflowTfjsLayers.distEngineTrainingDatasetMod.ModelFitDatasetArgs
import typingsJapgolly.tensorflowTfjsLayers.distEngineTrainingTensorsMod.ModelFitArgs
...
import typingsJapgolly.tensorflowTfjsLayers.distKerasFormatTrainingConfigMod.TrainingConfig
...
object distEngineTrainingMod {
  ...
  - typingsJapgolly.tensorflowTfjsCore.distModelTypesMod.InferenceModel because var conflicts: inputs, outputs. Inlined execute, execute, execute, execute, execute, execute, predict, predict, predict */ @JSImport("@tensorflow/tfjs-layers/dist/engine/training", "LayersModel")
  @js.native
