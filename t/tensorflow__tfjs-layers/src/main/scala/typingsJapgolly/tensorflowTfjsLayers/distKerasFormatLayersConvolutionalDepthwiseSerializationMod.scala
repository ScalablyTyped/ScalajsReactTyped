...
import typingsJapgolly.tensorflowTfjsLayers.distKerasFormatLayersConvolutionalSerializationMod.BaseConvLayerConfig
...
import typingsJapgolly.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.DepthwiseConv2D
