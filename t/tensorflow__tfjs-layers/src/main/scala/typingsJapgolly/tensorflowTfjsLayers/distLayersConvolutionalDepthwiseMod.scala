...
import typingsJapgolly.tensorflowTfjsLayers.distLayersConvolutionalMod.BaseConv
import typingsJapgolly.tensorflowTfjsLayers.distLayersConvolutionalMod.BaseConvLayerArgs
...
object distLayersConvolutionalDepthwiseMod {
