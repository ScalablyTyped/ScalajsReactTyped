...
import typingsJapgolly.tensorflowTfjsLayers.distConstraintsMod.ConstraintIdentifier
...
import typingsJapgolly.tensorflowTfjsLayers.distLayersRecurrentMod.BaseRNNLayerArgs
import typingsJapgolly.tensorflowTfjsLayers.distLayersRecurrentMod.LSTMCell
import typingsJapgolly.tensorflowTfjsLayers.distLayersRecurrentMod.RNNCell
...
import typingsJapgolly.tensorflowTfjsLayers.distRegularizersMod.RegularizerIdentifier
...
object distLayersConvolutionalRecurrentMod {
  ...
  - typingsJapgolly.tensorflowTfjsCore.distSerializationMod.Serializable because Already inherited
  - typingsJapgolly.tensorflowTfjsCore.distBaseMod.serialization.Serializable because Already inherited
  - typingsJapgolly.tensorflowTfjsCore.mod.serialization.Serializable because Already inherited
  - typingsJapgolly.tensorflowTfjsLayers.distEngineTopologyMod.Layer because Already inherited
  - typingsJapgolly.tensorflowTfjsLayers.distLayersRecurrentMod.RNNCell because Already inherited
  - typingsJapgolly.tensorflowTfjsLayers.distLayersConvolutionalRecurrentMod.ConvRNN2DCell because var conflicts: _addedWeightNames, _built, _callHook, _losses, _nonTrainableWeights, _refCount, _stateful, _trainableWeights, _updates, activityRegularizer, addInboundNode, batchInputShape, dropoutMask, dtype, fastWeightInitDuringBuild, getNodeAtIndex, inboundNodes, initialWeights, inputSpec, name, outboundNodes, recurrentDropoutMask, stateSize, supportsMasking, trainable_. Inlined filters, kernelSize, strides, padding, dataFormat, dilationRate */ @JSImport("@tensorflow/tfjs-layers/dist/layers/convolutional_recurrent", "ConvLSTM2DCell")
  @js.native
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.tensorflowTfjsLayers.distLayersConvolutionalRecurrentMod.ConvRNN2DCellArgs because var conflicts: batchInputShape, batchSize, dtype, inputDType, inputShape, name, trainable, weights. Inlined filters, kernelSize, strides, padding, dataFormat, dilationRate, recurrentRegularizer, useBias, biasInitializer, dropout, dropoutFunc, kernelRegularizer, recurrentInitializer, biasRegularizer, kernelConstraint, biasConstraint, kernelInitializer, recurrentConstraint, activation, recurrentDropout */ trait ConvRNN2DLayerArgs
    extends StObject
