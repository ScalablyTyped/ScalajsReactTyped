...
import typingsJapgolly.tensorflowTfjsLayers.distLogsMod.Logs
import typingsJapgolly.tensorflowTfjsLayers.distLogsMod.UnresolvedLogs
...
object distBaseCallbacksMod {
  ...
  object ModelLoggingVerbosity extends StObject {
    ...
    /* 0 */ val SILENT: typingsJapgolly.tensorflowTfjsLayers.distBaseCallbacksMod.ModelLoggingVerbosity.SILENT & Double = js.native
    
    @js.native
    sealed trait VERBOSE
      extends StObject
         with ModelLoggingVerbosity
    /* 1 */ val VERBOSE: typingsJapgolly.tensorflowTfjsLayers.distBaseCallbacksMod.ModelLoggingVerbosity.VERBOSE & Double = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.auto
    - typingsJapgolly.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.batch
    - typingsJapgolly.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.epoch
    - typingsJapgolly.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.never
    - scala.Double
  */
