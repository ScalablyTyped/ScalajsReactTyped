...
import typingsJapgolly.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.auto
import typingsJapgolly.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.max
import typingsJapgolly.tensorflowTfjsLayers.tensorflowTfjsLayersStrings.min
