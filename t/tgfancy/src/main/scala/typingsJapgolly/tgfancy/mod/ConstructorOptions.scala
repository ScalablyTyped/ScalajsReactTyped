...
import typingsJapgolly.nodeTelegramBotApi.mod.PollingOptions
import typingsJapgolly.nodeTelegramBotApi.mod.WebHookOptions
...
trait ConstructorOptions
  extends typingsJapgolly.nodeTelegramBotApi.mod.ConstructorOptions {
