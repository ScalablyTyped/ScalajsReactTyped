...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.twemojiParser.twemojiParserStrings.png
    - typingsJapgolly.twemojiParser.twemojiParserStrings.svg
  */
  trait AssetType extends StObject
  object AssetType {
    
    inline def png: typingsJapgolly.twemojiParser.twemojiParserStrings.png = "png".asInstanceOf[typingsJapgolly.twemojiParser.twemojiParserStrings.png]
    
    inline def svg: typingsJapgolly.twemojiParser.twemojiParserStrings.svg = "svg".asInstanceOf[typingsJapgolly.twemojiParser.twemojiParserStrings.svg]
  }
