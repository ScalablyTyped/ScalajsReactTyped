package typingsJapgolly.tesseractJs

import japgolly.scalajs.react.Callback
import typingsJapgolly.tesseractJs.mod.OEM
import typingsJapgolly.tesseractJs.mod.PSM
import typingsJapgolly.tesseractJs.mod.Rectangle
...
object anon {
  ...
  object PartialWorkerOptions {
    ...
    extension [Self <: PartialWorkerOptions](x: Self) {
      ...
      inline def setErrorHandler(value: /* arg */ Any => Callback): Self = StObject.set(x, "errorHandler", js.Any.fromFunction1((t0: /* arg */ Any) => value(t0).runNow()))
      ...
      inline def setLogger(value: /* arg */ Any => Callback): Self = StObject.set(x, "logger", js.Any.fromFunction1((t0: /* arg */ Any) => value(t0).runNow()))
