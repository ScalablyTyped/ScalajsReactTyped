...
object distSharedFiltersRelativeVelocityFilterMod {
  
  @JSImport("@tensorflow-models/face-landmarks-detection/dist/shared/filters/relative_velocity_filter", "RelativeVelocityFilter")
  @js.native
