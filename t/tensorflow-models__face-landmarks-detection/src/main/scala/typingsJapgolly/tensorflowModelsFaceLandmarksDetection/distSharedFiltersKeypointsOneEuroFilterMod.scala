...
import typingsJapgolly.tensorflowModelsFaceLandmarksDetection.distSharedCalculatorsInterfacesConfigInterfacesMod.OneEuroFilterConfig
...
object distSharedFiltersKeypointsOneEuroFilterMod {
  ...
  @JSImport("@tensorflow-models/face-landmarks-detection/dist/shared/filters/keypoints_one_euro_filter", "KeypointsOneEuroFilter")
  @js.native
