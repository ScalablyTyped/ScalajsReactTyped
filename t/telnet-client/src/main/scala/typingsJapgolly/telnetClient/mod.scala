...
import typingsJapgolly.telnetClient.libUtilsMod.Callback
import typingsJapgolly.telnetClient.libUtilsMod.Stream
import typingsJapgolly.telnetClient.telnetClientBooleans.`false`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Null
    - typingsJapgolly.telnetClient.telnetClientStrings.end
    - typingsJapgolly.telnetClient.telnetClientStrings.failedlogin
    - typingsJapgolly.telnetClient.telnetClientStrings.getprompt
    - typingsJapgolly.telnetClient.telnetClientStrings.login
    - typingsJapgolly.telnetClient.telnetClientStrings.ready
    - typingsJapgolly.telnetClient.telnetClientStrings.response
    - typingsJapgolly.telnetClient.telnetClientStrings.standby
    - typingsJapgolly.telnetClient.telnetClientStrings.start
  */
