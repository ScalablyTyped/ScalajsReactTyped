  ...
  object CookieJar {
    ...
    object Serialized {
      ...
      extension [Self <: Serialized](x: Self) {
        ...
        inline def setCookies(value: js.Array[typingsJapgolly.toughCookie.mod.Cookie.Serialized]): Self = StObject.set(x, "cookies", value.asInstanceOf[js.Any])
        
        inline def setCookiesVarargs(value: typingsJapgolly.toughCookie.mod.Cookie.Serialized*): Self = StObject.set(x, "cookies", js.Array(value*))
