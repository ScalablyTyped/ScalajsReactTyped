...
import typingsJapgolly.tokenizr.anon.Column
...
object mod {
  ...
  object default {
    ...
    @js.native
    val ActionContext: Instantiable1[/* tokenizr */ Tokenizr, typingsJapgolly.tokenizr.mod.ActionContext] = js.native
    ...
    val ParsingError: Instantiable5[
        ...
        /* column */ Double, 
        /* input */ String, 
        typingsJapgolly.tokenizr.mod.ParsingError
      ] = js.native
    ...
    val Token: Instantiable6[
        ...
        typingsJapgolly.tokenizr.mod.Token
      ] = js.native
  }
  ...
  type Action = js.ThisFunction3[
    ...
    /* rule */ typingsJapgolly.tokenizr.anon.Action, 
    Unit
  ]
