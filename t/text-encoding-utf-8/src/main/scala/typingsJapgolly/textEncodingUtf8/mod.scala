...
import typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoderOptions
import typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoderStatic
...
object mod {
  ...
  open class TextDecoder ()
    extends StObject
       with typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder {
  ...
  open class TextEncoder ()
    extends StObject
       with typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder {
  ...
  object TextEncoding extends Shortcut {
    ...
    trait TextDecoderStatic
      extends StObject
         with Instantiable0[typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder]
         with Instantiable1[/* label */ String, typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder]
         with Instantiable2[
              (/* label */ String) | (/* label */ Unit), 
              /* options */ TextDecoderOptions, 
              typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder
            ] {
      
      def apply(): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder = js.native
      def apply(label: String): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder = js.native
      def apply(label: String, options: TextDecoderOptions): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder = js.native
      def apply(label: Unit, options: TextDecoderOptions): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder = js.native
    }
    ...
    trait TextEncoderStatic
      extends StObject
         with Instantiable0[typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder]
         with Instantiable1[
              /* utfLabel */ String, 
              typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder
            ]
         with Instantiable2[
      ...
      def apply(): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder = js.native
      def apply(utfLabel: String): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder = js.native
      def apply(utfLabel: String, options: TextEncoderOptions): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder = js.native
      def apply(utfLabel: Unit, options: TextEncoderOptions): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder = js.native
    }
    
    trait TextEncodingStatic extends StObject {
      
      def TextDecoder(): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder
      def TextDecoder(label: String): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder
      def TextDecoder(label: String, options: TextDecoderOptions): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder
      def TextDecoder(label: Unit, options: TextDecoderOptions): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextDecoder
      @JSName("TextDecoder")
      var TextDecoder_Original: TextDecoderStatic
      
      def TextEncoder(): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder
      def TextEncoder(utfLabel: String): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder
      def TextEncoder(utfLabel: String, options: TextEncoderOptions): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder
      def TextEncoder(utfLabel: Unit, options: TextEncoderOptions): typingsJapgolly.textEncodingUtf8.mod.TextEncoding.TextEncoder
      @JSName("TextEncoder")
