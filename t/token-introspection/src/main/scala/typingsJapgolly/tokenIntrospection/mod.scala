package typingsJapgolly.tokenIntrospection

import org.scalablytyped.runtime.Instantiable0
import org.scalajs.dom.RequestInit
import org.scalajs.dom.Response
import typingsJapgolly.jsonwebtoken.mod.JwtPayload
import typingsJapgolly.tokenIntrospection.anon.Keys
import typingsJapgolly.tokenIntrospection.tokenIntrospectionBooleans.`true`
...
object mod {
  ...
  object errors {
    ...
    open class ConfigurationError ()
      extends typingsJapgolly.tokenIntrospection.errorsMod.ConfigurationError
    @JSImport("token-introspection", "errors.ConfigurationError")
    @js.native
    def ConfigurationError: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.ConfigurationError] = js.native
    inline def ConfigurationError_=(x: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.ConfigurationError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ConfigurationError")(x.asInstanceOf[js.Any])
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("token-introspection", "errors.IntrospectionError")
    @js.native
    open class IntrospectionError ()
      extends typingsJapgolly.tokenIntrospection.errorsMod.IntrospectionError
    @JSImport("token-introspection", "errors.IntrospectionError")
    @js.native
    def IntrospectionError: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.IntrospectionError] = js.native
    inline def IntrospectionError_=(x: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.IntrospectionError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IntrospectionError")(x.asInstanceOf[js.Any])
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("token-introspection", "errors.MalformedTokenError")
    @js.native
    open class MalformedTokenError ()
      extends typingsJapgolly.tokenIntrospection.errorsMod.MalformedTokenError
    @JSImport("token-introspection", "errors.MalformedTokenError")
    @js.native
    def MalformedTokenError: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.MalformedTokenError] = js.native
    inline def MalformedTokenError_=(x: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.MalformedTokenError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MalformedTokenError")(x.asInstanceOf[js.Any])
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("token-introspection", "errors.NotBeforeError")
    @js.native
    open class NotBeforeError ()
      extends typingsJapgolly.tokenIntrospection.errorsMod.NotBeforeError
    @JSImport("token-introspection", "errors.NotBeforeError")
    @js.native
    def NotBeforeError: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.NotBeforeError] = js.native
    inline def NotBeforeError_=(x: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.NotBeforeError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NotBeforeError")(x.asInstanceOf[js.Any])
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("token-introspection", "errors.TokenExpiredError")
    @js.native
    open class TokenExpiredError ()
      extends typingsJapgolly.tokenIntrospection.errorsMod.TokenExpiredError
    @JSImport("token-introspection", "errors.TokenExpiredError")
    @js.native
    def TokenExpiredError: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.TokenExpiredError] = js.native
    inline def TokenExpiredError_=(x: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.TokenExpiredError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TokenExpiredError")(x.asInstanceOf[js.Any])
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("token-introspection", "errors.TokenNotActiveError")
    @js.native
    open class TokenNotActiveError ()
      extends typingsJapgolly.tokenIntrospection.errorsMod.TokenNotActiveError
    @JSImport("token-introspection", "errors.TokenNotActiveError")
    @js.native
    def TokenNotActiveError: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.TokenNotActiveError] = js.native
    inline def TokenNotActiveError_=(x: Any | Instantiable0[typingsJapgolly.tokenIntrospection.errorsMod.TokenNotActiveError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TokenNotActiveError")(x.asInstanceOf[js.Any])
  }
  ...
  trait IntrospectResult
    ...
    var active: `true` | typingsJapgolly.tokenIntrospection.tokenIntrospectionStrings.`true`
  }
  object IntrospectResult {
    
    inline def apply(active: `true` | typingsJapgolly.tokenIntrospection.tokenIntrospectionStrings.`true`): IntrospectResult = {
    ...
    extension [Self <: IntrospectResult](x: Self) {
      ...
      inline def setActive(value: `true` | typingsJapgolly.tokenIntrospection.tokenIntrospectionStrings.`true`): Self = StObject.set(x, "active", value.asInstanceOf[js.Any])
    }
  }
