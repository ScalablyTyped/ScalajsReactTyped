...
object libOptionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tsconfigPathsWebpackPlugin.tsconfigPathsWebpackPluginStrings.INFO
    - typingsJapgolly.tsconfigPathsWebpackPlugin.tsconfigPathsWebpackPluginStrings.WARN
    - typingsJapgolly.tsconfigPathsWebpackPlugin.tsconfigPathsWebpackPluginStrings.ERROR
  */
  trait LogLevel extends StObject
  object LogLevel {
    
    inline def ERROR: typingsJapgolly.tsconfigPathsWebpackPlugin.tsconfigPathsWebpackPluginStrings.ERROR = "ERROR".asInstanceOf[typingsJapgolly.tsconfigPathsWebpackPlugin.tsconfigPathsWebpackPluginStrings.ERROR]
    
    inline def INFO: typingsJapgolly.tsconfigPathsWebpackPlugin.tsconfigPathsWebpackPluginStrings.INFO = "INFO".asInstanceOf[typingsJapgolly.tsconfigPathsWebpackPlugin.tsconfigPathsWebpackPluginStrings.INFO]
    
    inline def WARN: typingsJapgolly.tsconfigPathsWebpackPlugin.tsconfigPathsWebpackPluginStrings.WARN = "WARN".asInstanceOf[typingsJapgolly.tsconfigPathsWebpackPlugin.tsconfigPathsWebpackPluginStrings.WARN]
  }
