...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "chalk" % "5.1.2-f0e076",
  "org.scalablytyped.japgolly" %%% "enhanced-resolve" % "5.10.0-8e55d6",
  ...
  "org.scalablytyped.japgolly" %%% "tsconfig-paths" % "4.1.0-a7bc70",
