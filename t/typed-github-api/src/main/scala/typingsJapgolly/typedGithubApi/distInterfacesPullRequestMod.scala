...
object distInterfacesPullRequestMod {
  ...
  object PullRequest {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(assignees = assignees.asInstanceOf[js.Any], base = base.asInstanceOf[js.Any], body = body.asInstanceOf[js.Any], createdAt = createdAt.asInstanceOf[js.Any], createdBy = createdBy.asInstanceOf[js.Any], head = head.asInstanceOf[js.Any], htmlUri = htmlUri.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], loadAsync = loadAsync.toJsFn, loadIssueAsync = loadIssueAsync.toJsFn, loadReviewCommentsAsync = loadReviewCommentsAsync.toJsFn, loadReviewRequestsAsync = loadReviewRequestsAsync.toJsFn, loadReviewsAsync = loadReviewsAsync.toJsFn, locked = locked.asInstanceOf[js.Any], number = number.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any], updatedAt = updatedAt.asInstanceOf[js.Any], assignee = null, milestone = null)
    ...
    extension [Self <: PullRequest](x: Self) {
      ...
      inline def setLoadIssueAsync(value: CallbackTo[js.Promise[Issue]]): Self = StObject.set(x, "loadIssueAsync", value.toJsFn)
      
      inline def setLoadReviewCommentsAsync(value: CallbackTo[js.Promise[js.Array[ReviewComment]]]): Self = StObject.set(x, "loadReviewCommentsAsync", value.toJsFn)
      
      inline def setLoadReviewRequestsAsync(value: CallbackTo[js.Promise[ReviewRequests]]): Self = StObject.set(x, "loadReviewRequestsAsync", value.toJsFn)
      
      inline def setLoadReviewsAsync(value: CallbackTo[js.Promise[js.Array[Review]]]): Self = StObject.set(x, "loadReviewsAsync", value.toJsFn)
  ...
  object PullRequestRef {
    ...
    inline def apply(loadAsync: CallbackTo[js.Promise[PullRequest | Null]], number: Double): PullRequestRef = {
      val __obj = js.Dynamic.literal(loadAsync = loadAsync.toJsFn, number = number.asInstanceOf[js.Any])
      __obj.asInstanceOf[PullRequestRef]
    }
    
    extension [Self <: PullRequestRef](x: Self) {
      
      inline def setLoadAsync(value: CallbackTo[js.Promise[PullRequest | Null]]): Self = StObject.set(x, "loadAsync", value.toJsFn)
