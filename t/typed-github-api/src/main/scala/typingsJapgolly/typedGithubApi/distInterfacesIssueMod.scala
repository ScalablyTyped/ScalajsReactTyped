...
object distInterfacesIssueMod {
  ...
  object IssueRef {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(loadAsync = loadAsync.toJsFn, loadRepositoryAsync = loadRepositoryAsync.toJsFn, number = number.asInstanceOf[js.Any])
      __obj.asInstanceOf[IssueRef]
    }
    
    extension [Self <: IssueRef](x: Self) {
      
      inline def setLoadAsync(value: CallbackTo[js.Promise[Issue | Null]]): Self = StObject.set(x, "loadAsync", value.toJsFn)
      
      inline def setLoadRepositoryAsync(value: CallbackTo[js.Promise[Repository]]): Self = StObject.set(x, "loadRepositoryAsync", value.toJsFn)
