...
import typingsJapgolly.typedGithubApi.userMod.PrivateUser
import typingsJapgolly.typedGithubApi.userMod.User
...
object distUserMod extends js.Object {
  ...
  - typingsJapgolly.typedGithubApi.interfacesUserMod.UserSummary because Already inherited
  - typingsJapgolly.typedGithubApi.interfacesUserMod.User because Already inherited
  ...
  - typingsJapgolly.typedGithubApi.ownerRefMod.OwnerRef because Already inherited
  - typingsJapgolly.typedGithubApi.interfacesUserMod.UserSummary because Already inherited
  - typingsJapgolly.typedGithubApi.interfacesUserMod.User because var conflicts: avatarUri, id, login. Inlined name, company, blog, location, email, publicRepos, publicGists, followers, following, createdAt, updatedAt */ @js.native
  ...
  /* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
  - typingsJapgolly.typedGithubApi.ownerRefMod.OwnerRef because Already inherited
  - typingsJapgolly.typedGithubApi.interfacesUserMod.UserSummary because var conflicts: login. Inlined id, avatarUri */ @js.native
