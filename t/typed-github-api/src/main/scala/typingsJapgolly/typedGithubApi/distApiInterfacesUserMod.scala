...
import typingsJapgolly.typedGithubApi.anon.Collaborators
...
object distApiInterfacesUserMod {
  ...
  - typingsJapgolly.typedGithubApi.distApiInterfacesUserMod.UserOrOrgSummary because Already inherited
  - typingsJapgolly.typedGithubApi.distApiInterfacesUserMod.UserOrOrg because var conflicts: avatar_url, events_url, id, login, repos_url, `type`, url. Inlined name, company, blog, location, email, public_repos, public_gists, followers, following, created_at, updated_at */ trait Organization
    extends StObject
  ...
  trait OrganizationSummary
    ...
    @JSName("type")
    var type_OrganizationSummary: typingsJapgolly.typedGithubApi.typedGithubApiStrings.Organization
  }
  object OrganizationSummary {
    ...
    extension [Self <: OrganizationSummary](x: Self) {
      ...
      inline def setType(value: typingsJapgolly.typedGithubApi.typedGithubApiStrings.Organization): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.typedGithubApi.distApiInterfacesUserMod.UserOrOrgSummary because Already inherited
  - typingsJapgolly.typedGithubApi.distApiInterfacesUserMod.UserOrOrg because Already inherited
  - typingsJapgolly.typedGithubApi.distApiInterfacesUserMod.PrivateUserOrOrg because var conflicts: avatar_url, blog, company, created_at, email, events_url, followers, following, id, location, login, name, public_gists, public_repos, repos_url, `type`, updated_at, url. Inlined total_private_repos, owned_private_repos, private_gists, disk_usage, collaborators, plan */ trait PrivateOrganization
    extends StObject
       with Organization {
  ...
  object PrivateUserOrOrg {
    ...
    inline def apply(
      ...
      repos_url: String,
      total_private_repos: Double,
      `type`: typingsJapgolly.typedGithubApi.typedGithubApiStrings.User | typingsJapgolly.typedGithubApi.typedGithubApiStrings.Organization,
      updated_at: js.Date,
      url: String
    ): PrivateUserOrOrg = {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.typedGithubApi.distApiInterfacesUserMod.UserOrOrgSummary because Already inherited
  - typingsJapgolly.typedGithubApi.distApiInterfacesUserMod.UserOrOrg because var conflicts: avatar_url, events_url, id, login, repos_url, `type`, url. Inlined name, company, blog, location, email, public_repos, public_gists, followers, following, created_at, updated_at */ trait User
    extends StObject
       with UserSummary {
  ...
  trait UserOrOrgSummary extends StObject {
    ...
    var `type`: typingsJapgolly.typedGithubApi.typedGithubApiStrings.User | typingsJapgolly.typedGithubApi.typedGithubApiStrings.Organization
  ...
  object UserOrOrgSummary {
    ...
    extension [Self <: UserOrOrgSummary](x: Self) {
      ...
      inline def setType(
        value: typingsJapgolly.typedGithubApi.typedGithubApiStrings.User | typingsJapgolly.typedGithubApi.typedGithubApiStrings.Organization
  ...
  trait UserSummary
    ...
    @JSName("type")
    var type_UserSummary: typingsJapgolly.typedGithubApi.typedGithubApiStrings.User
  }
  object UserSummary {
    ...
    extension [Self <: UserSummary](x: Self) {
      ...
      inline def setType(value: typingsJapgolly.typedGithubApi.typedGithubApiStrings.User): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
}
