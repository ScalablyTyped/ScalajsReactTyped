...
import typingsJapgolly.typedGithubApi.typedGithubApiStrings.modified
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distInterfacesCommitMod {
  ...
  object Commit {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(changes = changes.asInstanceOf[js.Any], files = files.asInstanceOf[js.Any], gitCommit = gitCommit.asInstanceOf[js.Any], htmlUri = htmlUri.asInstanceOf[js.Any], loadAsync = loadAsync.toJsFn, loadGitAsync = loadGitAsync.toJsFn, parents = parents.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sha = sha.asInstanceOf[js.Any])
  ...
  object CommitRef {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(loadAsync = loadAsync.toJsFn, loadGitAsync = loadGitAsync.toJsFn, repository = repository.asInstanceOf[js.Any], sha = sha.asInstanceOf[js.Any])
      __obj.asInstanceOf[CommitRef]
    }
    
    extension [Self <: CommitRef](x: Self) {
      
      inline def setLoadAsync(value: CallbackTo[js.Promise[Commit | Null]]): Self = StObject.set(x, "loadAsync", value.toJsFn)
      
      inline def setLoadGitAsync(value: CallbackTo[js.Promise[GitCommit | Null]]): Self = StObject.set(x, "loadGitAsync", value.toJsFn)
  ...
  object CommitSummary {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(gitCommit = gitCommit.asInstanceOf[js.Any], htmlUri = htmlUri.asInstanceOf[js.Any], loadAsync = loadAsync.toJsFn, loadGitAsync = loadGitAsync.toJsFn, parents = parents.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sha = sha.asInstanceOf[js.Any])
  ...
  object GitCommit {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(author = author.asInstanceOf[js.Any], committer = committer.asInstanceOf[js.Any], loadAsync = loadAsync.toJsFn, loadGitAsync = loadGitAsync.toJsFn, message = message.asInstanceOf[js.Any], parents = parents.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sha = sha.asInstanceOf[js.Any])
  ...
  object GitCommitSummary {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(author = author.asInstanceOf[js.Any], committer = committer.asInstanceOf[js.Any], loadAsync = loadAsync.toJsFn, loadGitAsync = loadGitAsync.toJsFn, message = message.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], sha = sha.asInstanceOf[js.Any])
