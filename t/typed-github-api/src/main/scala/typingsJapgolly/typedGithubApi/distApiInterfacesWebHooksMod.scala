...
import typingsJapgolly.typedGithubApi.anon.Body
import typingsJapgolly.typedGithubApi.distApiInterfacesIssueMod.Issue
import typingsJapgolly.typedGithubApi.distApiInterfacesLabelMod.Label
...
object distApiInterfacesWebHooksMod {
  ...
  - typingsJapgolly.typedGithubApi.distApiInterfacesWebHooksMod.Event because Already inherited
  - typingsJapgolly.typedGithubApi.distApiInterfacesWebHooksMod.WebHookData because var conflicts: action. Inlined sender, organization, repository */ trait IssueWebHookData
    extends StObject
       with IssueEvent {
