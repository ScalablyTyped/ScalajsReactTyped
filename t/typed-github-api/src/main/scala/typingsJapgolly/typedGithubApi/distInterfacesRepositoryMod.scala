...
import typingsJapgolly.typedGithubApi.typedGithubApiStrings.Asterisk
import typingsJapgolly.typedGithubApi.typedGithubApiStrings.`long-running`
...
import typingsJapgolly.typedGithubApi.typedGithubApiStrings.none
import typingsJapgolly.typedGithubApi.typedGithubApiStrings.open
import typingsJapgolly.typedGithubApi.typedGithubApiStrings.popularity
