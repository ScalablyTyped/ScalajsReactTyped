...
import typingsJapgolly.typedGithubApi.AnonCollaborators
...
- typingsJapgolly.typedGithubApi.userMod.UserOrOrg because Already inherited
...
object PrivateUser {
  ...
  def apply(
    ...
    `type`: typingsJapgolly.typedGithubApi.typedGithubApiStrings.User,
    updated_at: js.Date,
    url: String
  ): PrivateUser = {
