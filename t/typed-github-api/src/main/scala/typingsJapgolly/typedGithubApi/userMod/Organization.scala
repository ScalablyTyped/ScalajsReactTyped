package typingsJapgolly.typedGithubApi.userMod
...
- typingsJapgolly.typedGithubApi.userMod.UserOrOrgSummary because Already inherited
- typingsJapgolly.typedGithubApi.userMod.UserOrOrg because var conflicts: avatar_url, events_url, id, login, repos_url, `type`, url. Inlined name, company, blog, location, email, public_repos, public_gists, followers, following, created_at, updated_at */ trait Organization extends OrganizationSummary {
  var blog: String
  var company: String
...
object Organization {
  ...
  def apply(
    ...
    public_repos: Double,
    repos_url: String,
    `type`: typingsJapgolly.typedGithubApi.typedGithubApiStrings.Organization,
    updated_at: js.Date,
    url: String
  ): Organization = {
