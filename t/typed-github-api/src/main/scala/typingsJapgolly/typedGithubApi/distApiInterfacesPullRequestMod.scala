...
import typingsJapgolly.typedGithubApi.distApiInterfacesBranchMod.BranchSummary
import typingsJapgolly.typedGithubApi.distApiInterfacesIssueMod.IssueComment
import typingsJapgolly.typedGithubApi.distApiInterfacesMilestoneMod.Milestone
import typingsJapgolly.typedGithubApi.distApiInterfacesTeamMod.Team
