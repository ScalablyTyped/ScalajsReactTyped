...
import typingsJapgolly.typedGithubApi.anon.Html
import typingsJapgolly.typedGithubApi.distApiInterfacesCommitMod.CommitSummary
import typingsJapgolly.typedGithubApi.distApiInterfacesCommitMod.GitRef
