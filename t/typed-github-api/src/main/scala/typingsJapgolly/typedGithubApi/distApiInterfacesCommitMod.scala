...
import typingsJapgolly.typedGithubApi.anon.Additions
import typingsJapgolly.typedGithubApi.anon.Bloburl
import typingsJapgolly.typedGithubApi.anon.Payload
