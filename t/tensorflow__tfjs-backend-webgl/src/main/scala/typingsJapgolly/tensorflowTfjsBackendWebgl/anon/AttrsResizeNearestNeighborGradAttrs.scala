...
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.ResizeNearestNeighborGradAttrs
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.ResizeNearestNeighborGradInputs
