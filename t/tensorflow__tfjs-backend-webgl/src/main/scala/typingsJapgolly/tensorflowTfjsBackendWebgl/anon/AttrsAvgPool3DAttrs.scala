...
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.AvgPool3DAttrs
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.AvgPool3DInputs
