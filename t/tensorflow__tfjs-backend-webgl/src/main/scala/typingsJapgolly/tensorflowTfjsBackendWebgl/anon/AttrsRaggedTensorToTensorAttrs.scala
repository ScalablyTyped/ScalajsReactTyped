...
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.RaggedTensorToTensorAttrs
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.RaggedTensorToTensorInputs
