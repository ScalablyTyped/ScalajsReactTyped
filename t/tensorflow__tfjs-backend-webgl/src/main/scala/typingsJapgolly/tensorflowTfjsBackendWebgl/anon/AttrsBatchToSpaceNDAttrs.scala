...
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.BatchToSpaceNDAttrs
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.BatchToSpaceNDInputs
