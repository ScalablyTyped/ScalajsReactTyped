...
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.Conv3DBackpropInputV2Attrs
import typingsJapgolly.tensorflowTfjsCore.distKernelNamesMod.Conv3DBackpropInputV2Inputs
...
object AttrsConv3DBackpropInputV2Attrs {
  ...
  inline def apply(attrs: Conv3DBackpropInputV2Attrs, backend: MathBackendWebGL, inputs: Conv3DBackpropInputV2Inputs): AttrsConv3DBackpropInputV2Attrs = {
