...
object distWebglMod {
  ...
  open class GPGPUContext ()
    extends typingsJapgolly.tensorflowTfjsBackendWebgl.distGpgpuContextMod.GPGPUContext {
  ...
  open class MathBackendWebGL ()
    extends typingsJapgolly.tensorflowTfjsBackendWebgl.distBackendWebglMod.MathBackendWebGL {
