...
import typingsJapgolly.tensorflowTfjsBackendWebgl.anon.FlatOffset
import typingsJapgolly.tensorflowTfjsBackendWebgl.anon.Imag
...
object distTexUtilMod {
  ...
  object PackingScheme extends StObject {
    ...
    sealed trait DENSE
      extends StObject
         with PackingScheme
    /* 0 */ val DENSE: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.PackingScheme.DENSE & Double = js.native
    ...
    sealed trait SHARED_BATCH
      extends StObject
         with PackingScheme
    /* 1 */ val SHARED_BATCH: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.PackingScheme.SHARED_BATCH & Double = js.native
  }
  ...
  object PhysicalTextureType extends StObject {
    ...
    /* 4 */ val PACKED_2X2_FLOAT16: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.PhysicalTextureType.PACKED_2X2_FLOAT16 & Double = js.native
    
    @js.native
    sealed trait PACKED_2X2_FLOAT32
      extends StObject
         with PhysicalTextureType
    /* 3 */ val PACKED_2X2_FLOAT32: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.PhysicalTextureType.PACKED_2X2_FLOAT32 & Double = js.native
    
    @js.native
    sealed trait PACKED_4X1_UNSIGNED_BYTE
      extends StObject
         with PhysicalTextureType
    /* 2 */ val PACKED_4X1_UNSIGNED_BYTE: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.PhysicalTextureType.PACKED_4X1_UNSIGNED_BYTE & Double = js.native
    
    @js.native
    sealed trait UNPACKED_FLOAT16
      extends StObject
         with PhysicalTextureType
    /* 0 */ val UNPACKED_FLOAT16: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.PhysicalTextureType.UNPACKED_FLOAT16 & Double = js.native
    
    @js.native
    sealed trait UNPACKED_FLOAT32
      extends StObject
         with PhysicalTextureType
    /* 1 */ val UNPACKED_FLOAT32: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.PhysicalTextureType.UNPACKED_FLOAT32 & Double = js.native
  }
  ...
  object TextureUsage extends StObject {
    ...
    sealed trait DOWNLOAD
      extends StObject
         with TextureUsage
    /* 3 */ val DOWNLOAD: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.TextureUsage.DOWNLOAD & Double = js.native
    
    @js.native
    sealed trait PIXELS
      extends StObject
         with TextureUsage
    /* 2 */ val PIXELS: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.TextureUsage.PIXELS & Double = js.native
    
    @js.native
    sealed trait RENDER
      extends StObject
         with TextureUsage
    /* 0 */ val RENDER: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.TextureUsage.RENDER & Double = js.native
    
    @js.native
    sealed trait UPLOAD
      extends StObject
         with TextureUsage
    /* 1 */ val UPLOAD: typingsJapgolly.tensorflowTfjsBackendWebgl.distTexUtilMod.TextureUsage.UPLOAD & Double = js.native
  }
