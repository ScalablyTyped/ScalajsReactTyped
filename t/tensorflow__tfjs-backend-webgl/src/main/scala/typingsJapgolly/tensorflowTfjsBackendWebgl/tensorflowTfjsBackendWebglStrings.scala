...
import typingsJapgolly.tensorflowTfjsBackendWebgl.distKernelUtilsReduceMod.ReduceTypes
import typingsJapgolly.tensorflowTfjsBackendWebgl.distShaderCompilerMod.UniformType
