...
import typingsJapgolly.tensorflowTfjsBackendWebgl.anon.InputsSparseSegmentMeanInputs
...
object distKernelsSparseSegmentMeanMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-webgl/dist/kernels/SparseSegmentMean", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-webgl/dist/kernels/SparseSegmentMean", "sparseSegmentMeanConfig")
  @js.native
