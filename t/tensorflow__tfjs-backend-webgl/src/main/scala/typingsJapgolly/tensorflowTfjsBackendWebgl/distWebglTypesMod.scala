...
object distWebglTypesMod {
  ...
  object WebGL1DisjointQueryTimerExtension {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(GPU_DISJOINT_EXT = GPU_DISJOINT_EXT.asInstanceOf[js.Any], QUERY_RESULT_AVAILABLE_EXT = QUERY_RESULT_AVAILABLE_EXT.asInstanceOf[js.Any], QUERY_RESULT_EXT = QUERY_RESULT_EXT.asInstanceOf[js.Any], TIME_ELAPSED_EXT = TIME_ELAPSED_EXT.asInstanceOf[js.Any], beginQueryEXT = js.Any.fromFunction2((t0: Double, t1: WebGLQuery) => (beginQueryEXT(t0, t1)).runNow()), createQueryEXT = createQueryEXT.toJsFn, deleteQueryEXT = js.Any.fromFunction1((t0: WebGLQuery) => deleteQueryEXT(t0).runNow()), endQueryEXT = js.Any.fromFunction1((t0: Double) => endQueryEXT(t0).runNow()), getQueryObjectEXT = js.Any.fromFunction2(getQueryObjectEXT), isQueryEXT = js.Any.fromFunction1(isQueryEXT))
    ...
    extension [Self <: WebGL1DisjointQueryTimerExtension](x: Self) {
      ...
      inline def setCreateQueryEXT(value: CallbackTo[js.Object]): Self = StObject.set(x, "createQueryEXT", value.toJsFn)
