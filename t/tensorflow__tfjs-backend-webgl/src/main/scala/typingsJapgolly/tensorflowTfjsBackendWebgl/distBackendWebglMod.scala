...
import typingsJapgolly.tensorflowTfjsBackendWebgl.distGpgpuMathMod.GPGPUBinary
...
import typingsJapgolly.tensorflowTfjsBackendWebgl.distTextureManagerMod.TextureManager
...
import typingsJapgolly.tensorflowTfjsCore.distKernelRegistryMod.DataId
