...
object mod {
  ...
  open class GPGPUContext ()
    extends typingsJapgolly.tensorflowTfjsBackendWebgl.distBaseMod.GPGPUContext {
  ...
  open class MathBackendWebGL ()
    extends typingsJapgolly.tensorflowTfjsBackendWebgl.distBaseMod.MathBackendWebGL {
