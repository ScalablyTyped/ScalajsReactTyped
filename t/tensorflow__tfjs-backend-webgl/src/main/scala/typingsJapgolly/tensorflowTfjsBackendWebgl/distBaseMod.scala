...
import typingsJapgolly.tensorflowTfjsBackendWebgl.tensorflowTfjsBackendWebglInts.`1`
import typingsJapgolly.tensorflowTfjsBackendWebgl.tensorflowTfjsBackendWebglInts.`2`
...
object distBaseMod {
  ...
  open class GPGPUContext ()
    extends typingsJapgolly.tensorflowTfjsBackendWebgl.distWebglMod.GPGPUContext {
  ...
  open class MathBackendWebGL ()
    extends typingsJapgolly.tensorflowTfjsBackendWebgl.distWebglMod.MathBackendWebGL {
    def this(gpuResource: HTMLCanvasElement) = this()
    def this(gpuResource: OffscreenCanvas) = this()
    def this(gpuResource: typingsJapgolly.tensorflowTfjsBackendWebgl.distGpgpuContextMod.GPGPUContext) = this()
  }
  /* static members */
