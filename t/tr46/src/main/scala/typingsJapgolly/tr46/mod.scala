...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tr46.tr46Strings.nontransitional
    - typingsJapgolly.tr46.tr46Strings.transitional
  */
  trait ProcessingOption extends StObject
  object ProcessingOption {
    
    inline def nontransitional: typingsJapgolly.tr46.tr46Strings.nontransitional = "nontransitional".asInstanceOf[typingsJapgolly.tr46.tr46Strings.nontransitional]
    
    inline def transitional: typingsJapgolly.tr46.tr46Strings.transitional = "transitional".asInstanceOf[typingsJapgolly.tr46.tr46Strings.transitional]
  }
