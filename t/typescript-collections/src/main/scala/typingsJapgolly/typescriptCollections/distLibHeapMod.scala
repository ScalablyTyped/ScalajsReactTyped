...
object distLibHeapMod {
  ...
  object Heap {
    ...
    extension [Self <: Heap[?], T](x: Self & Heap[T]) {
      ...
      inline def setRemoveRoot(value: CallbackTo[js.UndefOr[T]]): Self = StObject.set(x, "removeRoot", value.toJsFn)
