...
object distLibBstreekvMod {
  ...
  object BSTreeKV {
    ...
    inline def apply[K, V /* <: K */](
      ...
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction1(add), clear = clear.toJsFn, compare = compare.asInstanceOf[js.Any], contains = js.Any.fromFunction1(contains), createNode = js.Any.fromFunction1(createNode), forEach = js.Any.fromFunction1((t0: ILoopFunction[V]) => forEach(t0).runNow()), height = height.toJsFn, heightAux = js.Any.fromFunction1(heightAux), inorderTraversal = js.Any.fromFunction1((t0: ILoopFunction[V]) => inorderTraversal(t0).runNow()), inorderTraversalAux = js.Any.fromFunction3(inorderTraversalAux), insertNode = js.Any.fromFunction1(insertNode), isEmpty = isEmpty.toJsFn, levelTraversal = js.Any.fromFunction1((t0: ILoopFunction[V]) => levelTraversal(t0).runNow()), levelTraversalAux = js.Any.fromFunction2(levelTraversalAux), maximum = maximum.toJsFn, maximumAux = js.Any.fromFunction1(maximumAux), minimum = minimum.toJsFn, minimumAux = js.Any.fromFunction1(minimumAux), nElements = nElements.asInstanceOf[js.Any], postorderTraversal = js.Any.fromFunction1((t0: ILoopFunction[V]) => postorderTraversal(t0).runNow()), postorderTraversalAux = js.Any.fromFunction3(postorderTraversalAux), preorderTraversal = js.Any.fromFunction1((t0: ILoopFunction[V]) => preorderTraversal(t0).runNow()), preorderTraversalAux = js.Any.fromFunction3(preorderTraversalAux), remove = js.Any.fromFunction1(remove), removeNode = js.Any.fromFunction1(removeNode), root = root.asInstanceOf[js.Any], search = js.Any.fromFunction1(search), searchNode = js.Any.fromFunction2(searchNode), size = size.toJsFn, toArray = toArray.toJsFn, transplant = js.Any.fromFunction2(transplant))
    ...
    extension [Self <: BSTreeKV[?, ?], K, V /* <: K */](x: Self & (BSTreeKV[K, V])) {
      ...
      inline def setForEach(value: ILoopFunction[V] => Callback): Self = StObject.set(x, "forEach", js.Any.fromFunction1((t0: ILoopFunction[V]) => value(t0).runNow()))
      ...
      inline def setInorderTraversal(value: ILoopFunction[V] => Callback): Self = StObject.set(x, "inorderTraversal", js.Any.fromFunction1((t0: ILoopFunction[V]) => value(t0).runNow()))
      ...
      inline def setLevelTraversal(value: ILoopFunction[V] => Callback): Self = StObject.set(x, "levelTraversal", js.Any.fromFunction1((t0: ILoopFunction[V]) => value(t0).runNow()))
      
      inline def setLevelTraversalAux(value: (Any, Any) => Any): Self = StObject.set(x, "levelTraversalAux", js.Any.fromFunction2(value))
      
      inline def setMaximum(value: CallbackTo[js.UndefOr[V]]): Self = StObject.set(x, "maximum", value.toJsFn)
      
      inline def setMaximumAux(value: Any => Any): Self = StObject.set(x, "maximumAux", js.Any.fromFunction1(value))
      
      inline def setMinimum(value: CallbackTo[js.UndefOr[V]]): Self = StObject.set(x, "minimum", value.toJsFn)
      ...
      inline def setPostorderTraversal(value: ILoopFunction[V] => Callback): Self = StObject.set(x, "postorderTraversal", js.Any.fromFunction1((t0: ILoopFunction[V]) => value(t0).runNow()))
      ...
      inline def setPreorderTraversal(value: ILoopFunction[V] => Callback): Self = StObject.set(x, "preorderTraversal", js.Any.fromFunction1((t0: ILoopFunction[V]) => value(t0).runNow()))
