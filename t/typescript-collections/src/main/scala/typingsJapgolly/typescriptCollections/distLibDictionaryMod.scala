...
object distLibDictionaryMod {
  ...
  object Dictionary {
    ...
    inline def apply[K, V](
      ...
      forEach: js.Function2[/* key */ K, /* value */ V, Any] => Callback,
      ...
      val __obj = js.Dynamic.literal(clear = clear.toJsFn, containsKey = js.Any.fromFunction1(containsKey), forEach = js.Any.fromFunction1((t0: js.Function2[/* key */ K, /* value */ V, Any]) => forEach(t0).runNow()), getValue = js.Any.fromFunction1(getValue), isEmpty = isEmpty.toJsFn, keys = keys.toJsFn, nElements = nElements.asInstanceOf[js.Any], remove = js.Any.fromFunction1(remove), setValue = js.Any.fromFunction2(setValue), size = size.toJsFn, table = table.asInstanceOf[js.Any], toStr = js.Any.fromFunction1(toStr), values = values.toJsFn)
    ...
    extension [Self <: Dictionary[?, ?], K, V](x: Self & (Dictionary[K, V])) {
      ...
      inline def setForEach(value: js.Function2[/* key */ K, /* value */ V, Any] => Callback): Self = StObject.set(x, "forEach", js.Any.fromFunction1((t0: js.Function2[/* key */ K, /* value */ V, Any]) => value(t0).runNow()))
      ...
      inline def setKeys(value: CallbackTo[js.Array[K]]): Self = StObject.set(x, "keys", value.toJsFn)
      ...
      inline def setValues(value: CallbackTo[js.Array[V]]): Self = StObject.set(x, "values", value.toJsFn)
    }
  }
