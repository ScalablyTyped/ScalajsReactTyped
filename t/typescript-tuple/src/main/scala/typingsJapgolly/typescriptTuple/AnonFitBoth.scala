...
import typingsJapgolly.typescriptTuple.typescriptTupleStrings.equal
import typingsJapgolly.typescriptTuple.typescriptTupleStrings.shorterLeft
import typingsJapgolly.typescriptTuple.typescriptTupleStrings.shorterRight
