...
object anon {
  ...
  trait CODENAME extends StObject {
    ...
    var CODENAME: InfiniteTupleSet & typingsJapgolly.typescriptTuple.typescriptTupleStrings.Infinite
    
    var ERROR: `TupleSet is not finite`
  }
  object CODENAME {
    
    inline def apply(CODENAME: InfiniteTupleSet & typingsJapgolly.typescriptTuple.typescriptTupleStrings.Infinite): CODENAME = {
    ...
    extension [Self <: CODENAME](x: Self) {
      ...
      inline def setCODENAME(value: InfiniteTupleSet & typingsJapgolly.typescriptTuple.typescriptTupleStrings.Infinite): Self = StObject.set(x, "CODENAME", value.asInstanceOf[js.Any])
