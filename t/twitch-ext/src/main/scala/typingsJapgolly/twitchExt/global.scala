...
import typingsJapgolly.twitchExt.Twitch.ext.Authorized
import typingsJapgolly.twitchExt.Twitch.ext.BitsProduct
import typingsJapgolly.twitchExt.Twitch.ext.BitsTransaction
import typingsJapgolly.twitchExt.Twitch.ext.Rig
import typingsJapgolly.twitchExt.Twitch.ext.Viewer
import typingsJapgolly.twitchExt.Twitch.ext.features.ChangedKey
import typingsJapgolly.twitchExt.anon.Content
import typingsJapgolly.twitchExt.anon.PartialContext
import typingsJapgolly.twitchExt.anon.X
import typingsJapgolly.twitchExt.twitchExtBooleans.`false`
import typingsJapgolly.twitchExt.twitchExtBooleans.`true`
import typingsJapgolly.twitchExt.twitchExtStrings.arePlayerControlsVisible
import typingsJapgolly.twitchExt.twitchExtStrings.bitrate
import typingsJapgolly.twitchExt.twitchExtStrings.bufferSize
import typingsJapgolly.twitchExt.twitchExtStrings.displayResolution
import typingsJapgolly.twitchExt.twitchExtStrings.game
import typingsJapgolly.twitchExt.twitchExtStrings.hlsLatencyBroadcaster
import typingsJapgolly.twitchExt.twitchExtStrings.hostingInfo
import typingsJapgolly.twitchExt.twitchExtStrings.isFullScreen
import typingsJapgolly.twitchExt.twitchExtStrings.isMuted
import typingsJapgolly.twitchExt.twitchExtStrings.isPaused
import typingsJapgolly.twitchExt.twitchExtStrings.isTheatreMode
import typingsJapgolly.twitchExt.twitchExtStrings.language
import typingsJapgolly.twitchExt.twitchExtStrings.mode
import typingsJapgolly.twitchExt.twitchExtStrings.playbackMode
import typingsJapgolly.twitchExt.twitchExtStrings.production
import typingsJapgolly.twitchExt.twitchExtStrings.theme
import typingsJapgolly.twitchExt.twitchExtStrings.videoResolution
import typingsJapgolly.twitchExt.twitchExtStrings.volume
    ...
    object ext {
      ...
      object configuration {
        ...
        /**
          ...
          */
        inline def set_broadcaster(segment: typingsJapgolly.twitchExt.twitchExtStrings.broadcaster, version: String, content: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("set")(segment.asInstanceOf[js.Any], version.asInstanceOf[js.Any], content.asInstanceOf[js.Any])).asInstanceOf[Unit]
      }
      ...
      /**
        ...
        */
      inline def onError(errorCallback: js.Function1[/* errorValue */ Any, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onError")(errorCallback.asInstanceOf[js.Any]).asInstanceOf[Unit]
