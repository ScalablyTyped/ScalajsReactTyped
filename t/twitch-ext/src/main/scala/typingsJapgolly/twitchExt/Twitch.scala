...
import typingsJapgolly.twitchExt.anon.HostedChannelId
import typingsJapgolly.twitchExt.twitchExtStrings.CURRENT_USER
import typingsJapgolly.twitchExt.twitchExtStrings.OTHER
...
import typingsJapgolly.twitchExt.twitchExtStrings.bits
...
object Twitch {
  ...
  object ext {
    ...
    object Rig {
      ...
      inline def apply(log: String => Callback): Rig = {
    ...
    object Viewer {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(helixToken = helixToken.asInstanceOf[js.Any], isLinked = isLinked.asInstanceOf[js.Any], onChanged = js.Any.fromFunction1((t0: js.Function0[Unit]) => onChanged(t0).runNow()), opaqueId = opaqueId.asInstanceOf[js.Any], role = role.asInstanceOf[js.Any], sessionToken = sessionToken.asInstanceOf[js.Any], id = null, subscriptionStatus = null)
      ...
      extension [Self <: Viewer](x: Self) {
        ...
        inline def setOnChanged(value: js.Function0[Unit] => Callback): Self = StObject.set(x, "onChanged", js.Any.fromFunction1((t0: js.Function0[Unit]) => value(t0).runNow()))
    ...
    object features {
      ...
      /* Rewritten from type alias, can be one of: 
        - typingsJapgolly.twitchExt.twitchExtStrings.isBitsEnabled
        - typingsJapgolly.twitchExt.twitchExtStrings.isChatEnabled
        - typingsJapgolly.twitchExt.twitchExtStrings.isSubscriptionStatusAvailable
      */
      trait ChangedKey extends StObject
      object ChangedKey {
        
        inline def isBitsEnabled: typingsJapgolly.twitchExt.twitchExtStrings.isBitsEnabled = "isBitsEnabled".asInstanceOf[typingsJapgolly.twitchExt.twitchExtStrings.isBitsEnabled]
        
        inline def isChatEnabled: typingsJapgolly.twitchExt.twitchExtStrings.isChatEnabled = "isChatEnabled".asInstanceOf[typingsJapgolly.twitchExt.twitchExtStrings.isChatEnabled]
        
        inline def isSubscriptionStatusAvailable: typingsJapgolly.twitchExt.twitchExtStrings.isSubscriptionStatusAvailable = "isSubscriptionStatusAvailable".asInstanceOf[typingsJapgolly.twitchExt.twitchExtStrings.isSubscriptionStatusAvailable]
      }
    }
  }
}
