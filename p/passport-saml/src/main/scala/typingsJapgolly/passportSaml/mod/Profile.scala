...
object Profile {
  ...
  def apply(
    ...
    __obj.updateDynamic("getAssertion")(getAssertion.toJsFn)
    __obj.updateDynamic("getAssertionXml")(getAssertionXml.toJsFn)
    __obj.updateDynamic("getSamlResponseXml")(getSamlResponseXml.toJsFn)
