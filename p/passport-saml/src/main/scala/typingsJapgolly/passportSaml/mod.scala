...
object mod {
  ...
  trait AuthenticateOptions
    extends StObject
       with typingsJapgolly.passport.mod.AuthenticateOptions {
  ...
  object Profile {
    ...
    inline def apply(
      getAssertion: CallbackTo[js.Object],
      getAssertionXml: CallbackTo[String],
      getSamlResponseXml: CallbackTo[String]
    ): Profile = {
      val __obj = js.Dynamic.literal(getAssertion = getAssertion.toJsFn, getAssertionXml = getAssertionXml.toJsFn, getSamlResponseXml = getSamlResponseXml.toJsFn)
    ...
    extension [Self <: Profile](x: Self) {
      ...
      inline def setGetAssertion(value: CallbackTo[js.Object]): Self = StObject.set(x, "getAssertion", value.toJsFn)
      
      inline def setGetAssertionXml(value: CallbackTo[String]): Self = StObject.set(x, "getAssertionXml", value.toJsFn)
      
      inline def setGetSamlResponseXml(value: CallbackTo[String]): Self = StObject.set(x, "getSamlResponseXml", value.toJsFn)
  ...
  object SamlConfig {
    ...
    extension [Self <: SamlConfig](x: Self) {
      ...
      inline def setCertFunction1(
        value: /* callback */ js.Function2[/* err */ js.Error | Null, /* cert */ js.UndefOr[String | js.Array[String]], Unit] => Callback
      ): Self = StObject.set(x, "cert", js.Any.fromFunction1((t0: /* callback */ js.Function2[/* err */ js.Error | Null, /* cert */ js.UndefOr[String | js.Array[String]], Unit]) => value(t0).runNow()))
