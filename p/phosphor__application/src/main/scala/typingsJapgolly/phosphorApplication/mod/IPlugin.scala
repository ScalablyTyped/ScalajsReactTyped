package typingsJapgolly.phosphorApplication.mod
...
object IPlugin {
  @scala.inline
  def apply[T, U](
    activate: (T, /* repeated */ js.Any) => CallbackTo[U | js.Promise[U]],
    id: String,
    ...
    __obj.updateDynamic("activate")(js.Any.fromFunction2((t0: T, t1: /* repeated */ js.Any) => activate(t0, t1).runNow()))
