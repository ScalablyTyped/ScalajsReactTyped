...
object resources extends js.Object {
  ...
  class BaseImageResource protected () extends Resource {
    ...
    def upload(
      ...
      glTexture: GLTexture,
      source: typingsJapgolly.std.HTMLCanvasElement
    ): Boolean = js.native
    def upload(
      renderer: Renderer,
      baseTexture: BaseTexture,
      glTexture: GLTexture,
      source: typingsJapgolly.std.HTMLImageElement
    ): Boolean = js.native
    def upload(
      renderer: Renderer,
      baseTexture: BaseTexture,
      glTexture: GLTexture,
      source: typingsJapgolly.std.HTMLVideoElement
    ): Boolean = js.native
    def upload(
      renderer: Renderer,
      baseTexture: BaseTexture,
      glTexture: GLTexture,
      source: typingsJapgolly.std.SVGElement
    ): Boolean = js.native
  }
