...
class BitmapText protected ()
  extends typingsJapgolly.pixiJs.PIXI.BitmapText {
...
object BitmapText extends js.Object {
  def registerFont(xml: XMLDocument, textures: js.Array[typingsJapgolly.pixiJs.PIXI.Texture]): js.Any = js.native
  /**
    ...
    */
  def registerFont(xml: XMLDocument, textures: StringDictionary[typingsJapgolly.pixiJs.PIXI.Texture]): js.Any = js.native
  def registerFont(xml: XMLDocument, textures: typingsJapgolly.pixiJs.PIXI.Texture): js.Any = js.native
}
