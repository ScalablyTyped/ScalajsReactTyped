...
import typingsJapgolly.pixiCore.mod.IVideoResourceOptions
import typingsJapgolly.pixiCore.mod.IVideoResourceOptionsElement
...
open class VideoResource ()
  extends typingsJapgolly.pixiCore.mod.VideoResource {
