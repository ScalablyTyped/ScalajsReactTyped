...
import typingsJapgolly.pixiCore.mod.ICubeResourceOptions
import typingsJapgolly.pixiJs.pixiJsInts.`6`
import typingsJapgolly.pixiUtils.mod.ArrayFixed
...
open class CubeResource ()
  extends typingsJapgolly.pixiCore.mod.CubeResource {
  def this(source: ArrayFixed[String | typingsJapgolly.pixiCore.mod.Resource, `6`]) = this()
  def this(source: Unit, options: ICubeResourceOptions) = this()
  def this(
    source: ArrayFixed[String | typingsJapgolly.pixiCore.mod.Resource, `6`],
