...
import typingsJapgolly.pixiJs.PIXI.IFontMetrics
...
class TextMetrics protected ()
  extends typingsJapgolly.pixiJs.PIXI.TextMetrics {
  def this(
    text: String,
    style: typingsJapgolly.pixiJs.PIXI.TextStyle,
    width: Double,
    height: Double,
...
object TextMetrics extends js.Object {
  ...
  /**
    ...
    */
  def measureText(text: String, style: typingsJapgolly.pixiJs.PIXI.TextStyle): typingsJapgolly.pixiJs.PIXI.TextMetrics = js.native
  def measureText(text: String, style: typingsJapgolly.pixiJs.PIXI.TextStyle, wordWrap: Boolean): typingsJapgolly.pixiJs.PIXI.TextMetrics = js.native
  def measureText(
    text: String,
    style: typingsJapgolly.pixiJs.PIXI.TextStyle,
    wordWrap: Boolean,
    canvas: HTMLCanvasElement
  ): typingsJapgolly.pixiJs.PIXI.TextMetrics = js.native
  /**
    * Overridable helper method used internally by TextMetrics, exposed to allow customizing the class's behavior.
    *
