...
/**
  ...
  */
open class Graphics ()
  extends typingsJapgolly.pixiGraphics.mod.Graphics {
  def this(geometry: typingsJapgolly.pixiGraphics.mod.GraphicsGeometry) = this()
}
/* static members */
object Graphics {
  ...
  @js.native
  def _TEMP_POINT: typingsJapgolly.pixiMath.mod.Point = js.native
  inline def _TEMP_POINT_=(x: typingsJapgolly.pixiMath.mod.Point): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("_TEMP_POINT")(x.asInstanceOf[js.Any])
