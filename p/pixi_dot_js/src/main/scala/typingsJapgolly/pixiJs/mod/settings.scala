...
object settings extends js.Object {
  ...
  /**
    ...
    */
  var GC_MODE: typingsJapgolly.pixiJs.PIXI.GC_MODES = js.native
  /**
    ...
    */
  var MIPMAP_TEXTURES: typingsJapgolly.pixiJs.PIXI.MIPMAP_MODES = js.native
  /**
    ...
    */
  var PRECISION_FRAGMENT: typingsJapgolly.pixiJs.PIXI.PRECISION = js.native
  /**
    ...
    */
  var PRECISION_VERTEX: typingsJapgolly.pixiJs.PIXI.PRECISION = js.native
  /**
  ...
  /**
    ...
    */
  var SCALE_MODE: typingsJapgolly.pixiJs.PIXI.SCALE_MODES = js.native
  /**
  ...
  /**
    ...
    */
  var WRAP_MODE: typingsJapgolly.pixiJs.PIXI.WRAP_MODES = js.native
  /**
