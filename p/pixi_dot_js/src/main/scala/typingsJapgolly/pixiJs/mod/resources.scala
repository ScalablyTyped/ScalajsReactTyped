...
import typingsJapgolly.pixiJs.AnonAutoLoad
import typingsJapgolly.pixiJs.AnonAutoPlay
import typingsJapgolly.pixiJs.AnonCreateBitmap
import typingsJapgolly.pixiJs.AnonHeightWidth
import typingsJapgolly.pixiJs.AnonWidth
import typingsJapgolly.pixiJs.PIXI.ISize
...
object resources extends js.Object {
  ...
  class ArrayResource protected ()
    extends typingsJapgolly.pixiJs.PIXI.resources.ArrayResource {
  ...
  class BaseImageResource protected ()
    extends typingsJapgolly.pixiJs.PIXI.resources.BaseImageResource {
  ...
  class BufferResource protected ()
    extends typingsJapgolly.pixiJs.PIXI.resources.BufferResource {
  ...
  class CanvasResource protected ()
    extends typingsJapgolly.pixiJs.PIXI.resources.CanvasResource {
    def this(source: HTMLCanvasElement) = this()
  }
  ...
  @js.native
  class CubeResource ()
    extends typingsJapgolly.pixiJs.PIXI.resources.CubeResource {
    def this(source: js.Array[String | typingsJapgolly.pixiJs.PIXI.resources.Resource]) = this()
    def this(source: js.Array[String | typingsJapgolly.pixiJs.PIXI.resources.Resource], options: AnonWidth) = this()
  }
  ...
  @js.native
  class DepthResource ()
    extends typingsJapgolly.pixiJs.PIXI.resources.DepthResource
  ...
  class ImageBitmapResource protected ()
    extends typingsJapgolly.pixiJs.PIXI.resources.ImageBitmapResource {
  ...
  class ImageResource protected ()
    extends typingsJapgolly.pixiJs.PIXI.resources.ImageResource {
  ...
  @js.native
  class Resource ()
    extends typingsJapgolly.pixiJs.PIXI.resources.Resource {
  ...
  class SVGResource protected ()
    extends typingsJapgolly.pixiJs.PIXI.resources.SVGResource {
    def this(source: String) = this()
  ...
  class VideoResource protected ()
    extends typingsJapgolly.pixiJs.PIXI.resources.VideoResource {
    def this(source: String) = this()
  ...
  /**
    ...
    */
  def autoDetectResource(source: String): typingsJapgolly.pixiJs.PIXI.resources.Resource = js.native
  def autoDetectResource(source: String, options: AnonCreateBitmap): typingsJapgolly.pixiJs.PIXI.resources.Resource = js.native
  def autoDetectResource(source: js.Any): typingsJapgolly.pixiJs.PIXI.resources.Resource = js.native
  def autoDetectResource(source: js.Any, options: AnonCreateBitmap): typingsJapgolly.pixiJs.PIXI.resources.Resource = js.native
  /* static members */
  @js.native
  ...
  object CanvasResource extends js.Object {
    /**
      ...
      */
    def test(source: typingsJapgolly.std.HTMLCanvasElement): Boolean = js.native
