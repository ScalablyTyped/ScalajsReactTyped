...
import typingsJapgolly.pixiLoaders.GlobalMixins.IApplicationOptions
...
open class AppLoaderPlugin ()
  extends typingsJapgolly.pixiLoaders.mod.AppLoaderPlugin
/* static members */
object AppLoaderPlugin {
  ...
  @js.native
  def loader: typingsJapgolly.pixiLoaders.mod.Loader = js.native
  inline def loader_=(x: typingsJapgolly.pixiLoaders.mod.Loader): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("loader")(x.asInstanceOf[js.Any])
}
