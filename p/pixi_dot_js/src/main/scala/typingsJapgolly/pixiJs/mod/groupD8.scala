...
import typingsJapgolly.pixiMath.mod.GD8Symmetry
...
object groupD8 {
  ...
  /**
    ...
    */
  inline def matrixAppendRotationInv(matrix: typingsJapgolly.pixiMath.mod.Matrix, rotation: GD8Symmetry): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("matrixAppendRotationInv")(matrix.asInstanceOf[js.Any], rotation.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def matrixAppendRotationInv(matrix: typingsJapgolly.pixiMath.mod.Matrix, rotation: GD8Symmetry, tx: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("matrixAppendRotationInv")(matrix.asInstanceOf[js.Any], rotation.asInstanceOf[js.Any], tx.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def matrixAppendRotationInv(matrix: typingsJapgolly.pixiMath.mod.Matrix, rotation: GD8Symmetry, tx: Double, ty: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("matrixAppendRotationInv")(matrix.asInstanceOf[js.Any], rotation.asInstanceOf[js.Any], tx.asInstanceOf[js.Any], ty.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def matrixAppendRotationInv(matrix: typingsJapgolly.pixiMath.mod.Matrix, rotation: GD8Symmetry, tx: Unit, ty: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("matrixAppendRotationInv")(matrix.asInstanceOf[js.Any], rotation.asInstanceOf[js.Any], tx.asInstanceOf[js.Any], ty.asInstanceOf[js.Any])).asInstanceOf[Unit]
