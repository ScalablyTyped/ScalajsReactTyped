...
import typingsJapgolly.pixiJs.PIXI.GD8Symmetry
...
object groupD8 extends js.Object {
  ...
  /**
    ...
    */
  def matrixAppendRotationInv(matrix: typingsJapgolly.pixiJs.PIXI.Matrix, rotation: GD8Symmetry, tx: Double, ty: Double): Unit = js.native
  /**
