...
class Text protected ()
  extends typingsJapgolly.pixiJs.PIXI.Text {
  def this(text: String) = this()
  def this(text: String, style: js.Any) = this()
  def this(text: String, style: typingsJapgolly.pixiJs.PIXI.TextStyle) = this()
  def this(text: String, style: js.Any, canvas: HTMLCanvasElement) = this()
  def this(text: String, style: typingsJapgolly.pixiJs.PIXI.TextStyle, canvas: HTMLCanvasElement) = this()
}
