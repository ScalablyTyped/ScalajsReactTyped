...
/**
  ...
  */
open class Text ()
  extends typingsJapgolly.pixiText.mod.Text {
  def this(text: String) = this()
  def this(text: Double) = this()
  def this(text: String, style: PartialITextStyle) = this()
  def this(text: String, style: typingsJapgolly.pixiText.mod.TextStyle) = this()
  def this(text: Double, style: PartialITextStyle) = this()
  def this(text: Double, style: typingsJapgolly.pixiText.mod.TextStyle) = this()
  def this(text: Unit, style: PartialITextStyle) = this()
  def this(text: Unit, style: typingsJapgolly.pixiText.mod.TextStyle) = this()
  ...
  def this(text: String, style: typingsJapgolly.pixiText.mod.TextStyle, canvas: HTMLCanvasElement) = this()
  ...
  def this(text: Double, style: typingsJapgolly.pixiText.mod.TextStyle, canvas: HTMLCanvasElement) = this()
  ...
  def this(text: Unit, style: typingsJapgolly.pixiText.mod.TextStyle, canvas: HTMLCanvasElement) = this()
}
object Text {
