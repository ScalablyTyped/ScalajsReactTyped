...
import typingsJapgolly.pixiApp.mod.IApplicationOptions
import typingsJapgolly.pixiApp.mod.ResizeableRenderer
...
open class ResizePlugin ()
  extends typingsJapgolly.pixiApp.mod.ResizePlugin
/* static members */
object ResizePlugin {
