...
@js.native
class SimpleMesh ()
  extends typingsJapgolly.pixiJs.PIXI.SimpleMesh {
  def this(texture: typingsJapgolly.pixiJs.PIXI.Texture) = this()
  def this(texture: typingsJapgolly.pixiJs.PIXI.Texture, vertices: scala.scalajs.js.typedarray.Float32Array) = this()
  def this(
