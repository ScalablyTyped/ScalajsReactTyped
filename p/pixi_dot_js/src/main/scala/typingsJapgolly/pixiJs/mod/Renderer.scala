...
import typingsJapgolly.pixiCore.mod.IRendererPluginConstructor
import typingsJapgolly.pixiCore.mod.IRendererPlugins
...
/**
  ...
  */
open class Renderer ()
  extends typingsJapgolly.pixiCore.mod.Renderer {
...
object Renderer {
  ...
  /**
    ...
    * @private
    */
  inline def create(): typingsJapgolly.pixiCore.mod.AbstractRenderer = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typingsJapgolly.pixiCore.mod.AbstractRenderer]
  inline def create(options: IRendererOptions): typingsJapgolly.pixiCore.mod.AbstractRenderer = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.pixiCore.mod.AbstractRenderer]
