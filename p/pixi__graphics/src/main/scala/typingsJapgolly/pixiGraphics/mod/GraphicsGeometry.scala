...
import typingsJapgolly.pixiCore.mod.BatchDrawCall
import typingsJapgolly.pixiCore.mod.BatchGeometry
import typingsJapgolly.pixiCore.mod.Resource
import typingsJapgolly.pixiCore.mod.Texture
import typingsJapgolly.pixiDisplay.mod.Bounds
...
open class GraphicsGeometry () extends BatchGeometry {
  ...
  /**
    ...
    */
  def drawHole(shape: IShape2): GraphicsGeometry = js.native
  def drawHole(shape: IShape2, matrix: Matrix): GraphicsGeometry = js.native
  ...
  /**
    ...
    * @returns - Returns geometry for chaining.
    */
  def drawShape(shape: IShape2): GraphicsGeometry = js.native
  def drawShape(shape: IShape2, fillStyle: Unit, lineStyle: Unit, matrix: Matrix): GraphicsGeometry = js.native
  def drawShape(shape: IShape2, fillStyle: Unit, lineStyle: LineStyle): GraphicsGeometry = js.native
  def drawShape(shape: IShape2, fillStyle: Unit, lineStyle: LineStyle, matrix: Matrix): GraphicsGeometry = js.native
  def drawShape(shape: IShape2, fillStyle: FillStyle): GraphicsGeometry = js.native
  def drawShape(shape: IShape2, fillStyle: FillStyle, lineStyle: Unit, matrix: Matrix): GraphicsGeometry = js.native
  def drawShape(shape: IShape2, fillStyle: FillStyle, lineStyle: LineStyle): GraphicsGeometry = js.native
  def drawShape(shape: IShape2, fillStyle: FillStyle, lineStyle: LineStyle, matrix: Matrix): GraphicsGeometry = js.native
