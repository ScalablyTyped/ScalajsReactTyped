package typingsJapgolly.petitDom.mod._Global_.JSX
...
trait IntrinsicClassAttributes[T] extends js.Object {
  ...
  var firstElementChild: js.UndefOr[org.scalajs.dom.raw.Element] = js.undefined
  ...
  var lastElementChild: js.UndefOr[org.scalajs.dom.raw.Element] = js.undefined
  ...
  var nextElementSibling: js.UndefOr[org.scalajs.dom.raw.Element] = js.undefined
  ...
  var previousElementSibling: js.UndefOr[org.scalajs.dom.raw.Element] = js.undefined
...
object IntrinsicClassAttributes {
  ...
  def apply[T](
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event_, js.Any]) => Callback = null,
    ...
    getElementsByClassName: /* classNames */ String => CallbackTo[HTMLCollectionOf[org.scalajs.dom.raw.Element]] = null,
    ...
    insertAdjacentElement: (/* position */ InsertPosition, /* insertedElement */ org.scalajs.dom.raw.Element) => CallbackTo[org.scalajs.dom.raw.Element | Null] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.mod._Global_.JSX.IntrinsicClassAttributes[T], 
