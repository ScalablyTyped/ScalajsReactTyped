...
object PetitDom {
  ...
  trait Component[P /* <: ComponentProps */] extends StObject {
  ...
  object Component {
    ...
    inline def apply[P /* <: ComponentProps */](
      mount: (P, js.Array[VNode]) => Element,
      patch: (Element, P, P, js.Array[VNode], js.Array[VNode]) => Element,
      unmount: Element => Callback
    ): Component[P] = {
      val __obj = js.Dynamic.literal(mount = js.Any.fromFunction2(mount), patch = js.Any.fromFunction5(patch), unmount = js.Any.fromFunction1((t0: Element) => unmount(t0).runNow()))
    ...
    extension [Self <: Component[?], P /* <: ComponentProps */](x: Self & Component[P]) {
      ...
      inline def setPatch(value: (Element, P, P, js.Array[VNode], js.Array[VNode]) => Element): Self = StObject.set(x, "patch", js.Any.fromFunction5(value))
      
      inline def setUnmount(value: Element => Callback): Self = StObject.set(x, "unmount", js.Any.fromFunction1((t0: Element) => value(t0).runNow()))
    }
  }
  
  @js.native
  trait ComponentClass[P /* <: ComponentProps */]
    extends StObject
       with Instantiable2[/* props */ P, /* content */ js.Array[Content], Component[P]]
  
  trait ComponentClassNode[P /* <: ComponentProps */]
    extends StObject
       with VNode {
    
    @JSName("props")
    val props_ComponentClassNode: P & IntrinsicProps
  ...
  object ComponentClassNode {
    ...
    inline def apply[P /* <: ComponentProps */](content: js.Array[VNode], isSVG: Boolean, props: P & IntrinsicProps, `type`: ComponentClass[P]): ComponentClassNode[P] = {
  ...
  trait ComponentNode[P /* <: ComponentProps */]
    extends StObject
       with VNode {
    
    @JSName("props")
    val props_ComponentNode: P & IntrinsicProps
  ...
  object ComponentNode {
    ...
    inline def apply[P /* <: ComponentProps */](content: js.Array[VNode], isSVG: Boolean, props: P & IntrinsicProps, `type`: Component[P]): ComponentNode[P] = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], isSVG = isSVG.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any], key = null)
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    ...
    extension [Self <: ComponentNode[?], P /* <: ComponentProps */](x: Self & ComponentNode[P]) {
      ...
      inline def setType(value: Component[P]): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait ElementNode[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 170, starting with typingsJapgolly.petitDom.petitDomStrings.main, typingsJapgolly.petitDom.petitDomStrings.a, typingsJapgolly.petitDom.petitDomStrings.abbr */ Any */, E /* <: /* import warning: importer.ImportType#apply Failed type conversion: petit-dom.petit-dom.PetitDom.DomElements[T] */ js.Any */]
    extends StObject
       with VNode {
  ...
  object ElementNode {
    ...
    inline def apply[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 170, starting with typingsJapgolly.petitDom.petitDomStrings.main, typingsJapgolly.petitDom.petitDomStrings.a, typingsJapgolly.petitDom.petitDomStrings.abbr */ Any */, E /* <: /* import warning: importer.ImportType#apply Failed type conversion: petit-dom.petit-dom.PetitDom.DomElements[T] */ js.Any */](content: js.Array[VNode], isSVG: Boolean, props: Props[E], `type`: T): ElementNode[T, E] = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], isSVG = isSVG.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any], key = null)
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[ElementNode[T, E]]
    }
    
    extension [Self <: ElementNode[?, ?], T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 170, starting with typingsJapgolly.petitDom.petitDomStrings.main, typingsJapgolly.petitDom.petitDomStrings.a, typingsJapgolly.petitDom.petitDomStrings.abbr */ Any */, E /* <: /* import warning: importer.ImportType#apply Failed type conversion: petit-dom.petit-dom.PetitDom.DomElements[T] */ js.Any */](x: Self & (ElementNode[T, E])) {
  ...
  @js.native
  trait FunctionComponent[P /* <: ComponentProps */] extends StObject {
  ...
  trait FunctionComponentNode[P /* <: ComponentProps */]
    extends StObject
       with VNode {
    
    @JSName("props")
    val props_FunctionComponentNode: P & IntrinsicProps
    
    @JSName("type")
    def type_MFunctionComponentNode(props: P, content: js.Array[Content]): FunctionComponentNode[P]
    @JSName("type")
    val type_Original: FunctionComponent[P]
  }
  object FunctionComponentNode {
    
    inline def apply[P /* <: ComponentProps */](content: js.Array[VNode], isSVG: Boolean, props: P & IntrinsicProps, `type`: FunctionComponent[P]): FunctionComponentNode[P] = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], isSVG = isSVG.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any], key = null)
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    ...
    extension [Self <: FunctionComponentNode[?], P /* <: ComponentProps */](x: Self & FunctionComponentNode[P]) {
      ...
      inline def setType(value: FunctionComponent[P]): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
  
  trait IntrinsicProps extends StObject {
  ...
  object IntrinsicProps {
    ...
    inline def apply(): IntrinsicProps = {
  ...
  type Props[E /* <: Element */] = IntrinsicProps & DOMElementProps[E]
