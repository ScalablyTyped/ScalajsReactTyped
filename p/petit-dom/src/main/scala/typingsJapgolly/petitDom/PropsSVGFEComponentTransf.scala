...
object PropsSVGFEComponentTransf {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEComponentTransf, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEComponentTransf, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsSVGFEComponentTransf, 
