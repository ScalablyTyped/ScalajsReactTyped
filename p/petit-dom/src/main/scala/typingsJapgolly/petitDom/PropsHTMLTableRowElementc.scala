...
object PropsHTMLTableRowElementc {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableRowElementc, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    deleteCell: /* index */ Double => Callback = null,
    dir: String = null,
    ...
    insertCell: js.UndefOr[CallbackTo[HTMLTableDataCellElement]] = js.undefined,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableRowElementc, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLTableRowElementc, 
  ...
  js.Any]) => addEventListener(t0, t1).runNow()))
    ...
    if (deleteCell != null) __obj.updateDynamic("deleteCell")(js.Any.fromFunction1((t0: /* index */ scala.Double) => deleteCell(t0).runNow()))
    ...
    insertCell.foreach(p => __obj.updateDynamic("insertCell")(p.toJsFn))
