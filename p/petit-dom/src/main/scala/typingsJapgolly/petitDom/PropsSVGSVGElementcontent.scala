...
import typingsJapgolly.petitDom.petitDomStrings.AnimationEvent
import typingsJapgolly.petitDom.petitDomStrings.SVGUnload
...
import typingsJapgolly.std.SVGZoomEvent
...
object PropsSVGSVGElementcontent {
  ...
  def apply(
    ...
    addEventListener: (SVGUnload, /* listener */ js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event_, js.Any]) => Callback = null,
    after: /* repeated */ Node | String => Callback = null,
    animate: /* keyframes */ js.Array[Keyframe] => CallbackTo[Animation] = null,
    animationsPaused: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    checkEnclosure: (/* element */ SVGElement, /* rect */ SVGRect) => CallbackTo[Boolean] = null,
    checkIntersection: (/* element */ SVGElement, /* rect */ SVGRect) => CallbackTo[Boolean] = null,
    ...
    createEvent: AnimationEvent => CallbackTo[org.scalajs.dom.raw.AnimationEvent] = null,
    createSVGAngle: js.UndefOr[CallbackTo[SVGAngle]] = js.undefined,
    createSVGLength: js.UndefOr[CallbackTo[SVGLength]] = js.undefined,
    createSVGMatrix: js.UndefOr[CallbackTo[SVGMatrix]] = js.undefined,
    createSVGNumber: js.UndefOr[CallbackTo[SVGNumber]] = js.undefined,
    createSVGPoint: js.UndefOr[CallbackTo[SVGPoint]] = js.undefined,
    createSVGRect: js.UndefOr[CallbackTo[SVGRect]] = js.undefined,
    createSVGTransform: js.UndefOr[CallbackTo[SVGTransform]] = js.undefined,
    createSVGTransformFromMatrix: /* matrix */ SVGMatrix => CallbackTo[SVGTransform] = null,
    currentScale: Int | Double = null,
    currentTranslate: SVGPoint = null,
    dataset: DOMStringMap = null,
    deselectAll: js.UndefOr[Callback] = js.undefined,
    dispatchEvent: /* event */ Event_ => CallbackTo[Boolean] = null,
    firstChild: ChildNode = null,
    firstElementChild: Element = null,
    focus: js.UndefOr[Callback] = js.undefined,
    forceRedraw: js.UndefOr[Callback] = js.undefined,
    ...
    getComputedStyle: /* elt */ Element => CallbackTo[CSSStyleDeclaration] = null,
    getCurrentTime: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getElementById: /* elementId */ String => CallbackTo[Element] = null,
    ...
    getEnclosureList: (/* rect */ SVGRect, /* referenceElement */ SVGElement) => CallbackTo[
      NodeListOf[
        (SVGCircleElement | SVGEllipseElement | SVGImageElement | SVGLineElement | SVGPathElement | SVGPolygonElement | SVGPolylineElement | SVGRectElement | SVGTextElement | SVGUseElement) with Node
      ]
    ] = null,
    getIntersectionList: (/* rect */ SVGRect, /* referenceElement */ SVGElement) => CallbackTo[
      NodeListOf[
        (SVGCircleElement | SVGEllipseElement | SVGImageElement | SVGLineElement | SVGPathElement | SVGPolygonElement | SVGPolylineElement | SVGRectElement | SVGTextElement | SVGUseElement) with Node
      ]
    ] = null,
    ...
    pauseAnimations: js.UndefOr[Callback] = js.undefined,
    ...
    removeEventListener: (SVGUnload, /* listener */ js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    if (addEventListener != null) __obj.updateDynamic("addEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.petitDom.petitDomStrings.SVGUnload, t1: /* listener */ js.ThisFunction1[
  typingsJapgolly.petitDom.PropsSVGSVGElementcontent, 
  ...
  js.Any]) => addEventListener(t0, t1).runNow()))
    ...
    animationsPaused.foreach(p => __obj.updateDynamic("animationsPaused")(p.toJsFn))
    ...
    if (checkEnclosure != null) __obj.updateDynamic("checkEnclosure")(js.Any.fromFunction2((t0: /* element */ org.scalajs.dom.raw.SVGElement, t1: /* rect */ org.scalajs.dom.raw.SVGRect) => checkEnclosure(t0, t1).runNow()))
    if (checkIntersection != null) __obj.updateDynamic("checkIntersection")(js.Any.fromFunction2((t0: /* element */ org.scalajs.dom.raw.SVGElement, t1: /* rect */ org.scalajs.dom.raw.SVGRect) => checkIntersection(t0, t1).runNow()))
    ...
    if (createEvent != null) __obj.updateDynamic("createEvent")(js.Any.fromFunction1((t0: typingsJapgolly.petitDom.petitDomStrings.AnimationEvent) => createEvent(t0).runNow()))
    createSVGAngle.foreach(p => __obj.updateDynamic("createSVGAngle")(p.toJsFn))
    createSVGLength.foreach(p => __obj.updateDynamic("createSVGLength")(p.toJsFn))
    createSVGMatrix.foreach(p => __obj.updateDynamic("createSVGMatrix")(p.toJsFn))
    createSVGNumber.foreach(p => __obj.updateDynamic("createSVGNumber")(p.toJsFn))
    createSVGPoint.foreach(p => __obj.updateDynamic("createSVGPoint")(p.toJsFn))
    createSVGRect.foreach(p => __obj.updateDynamic("createSVGRect")(p.toJsFn))
    createSVGTransform.foreach(p => __obj.updateDynamic("createSVGTransform")(p.toJsFn))
    if (createSVGTransformFromMatrix != null) __obj.updateDynamic("createSVGTransformFromMatrix")(js.Any.fromFunction1((t0: /* matrix */ org.scalajs.dom.raw.SVGMatrix) => createSVGTransformFromMatrix(t0).runNow()))
    ...
    deselectAll.foreach(p => __obj.updateDynamic("deselectAll")(p.toJsFn))
    ...
    forceRedraw.foreach(p => __obj.updateDynamic("forceRedraw")(p.toJsFn))
    ...
    if (getComputedStyle != null) __obj.updateDynamic("getComputedStyle")(js.Any.fromFunction1((t0: /* elt */ org.scalajs.dom.raw.Element) => getComputedStyle(t0).runNow()))
    getCurrentTime.foreach(p => __obj.updateDynamic("getCurrentTime")(p.toJsFn))
    if (getElementById != null) __obj.updateDynamic("getElementById")(js.Any.fromFunction1((t0: /* elementId */ java.lang.String) => getElementById(t0).runNow()))
    ...
    if (getEnclosureList != null) __obj.updateDynamic("getEnclosureList")(js.Any.fromFunction2((t0: /* rect */ org.scalajs.dom.raw.SVGRect, t1: /* referenceElement */ org.scalajs.dom.raw.SVGElement) => getEnclosureList(t0, t1).runNow()))
    if (getIntersectionList != null) __obj.updateDynamic("getIntersectionList")(js.Any.fromFunction2((t0: /* rect */ org.scalajs.dom.raw.SVGRect, t1: /* referenceElement */ org.scalajs.dom.raw.SVGElement) => getIntersectionList(t0, t1).runNow()))
    ...
    pauseAnimations.foreach(p => __obj.updateDynamic("pauseAnimations")(p.toJsFn))
    ...
    if (removeEventListener != null) __obj.updateDynamic("removeEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.petitDom.petitDomStrings.SVGUnload, t1: /* listener */ js.ThisFunction1[
  typingsJapgolly.petitDom.PropsSVGSVGElementcontent, 
  /* ev */ typingsJapgolly.std.Event_, 
