...
object PropsSVGFETurbulenceEleme {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFETurbulenceEleme, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    onprogress: js.ThisFunction1[PropsSVGFETurbulenceEleme, /* ev */ ProgressEvent, _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFETurbulenceEleme, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsSVGFETurbulenceEleme, 
