...
object PropsSVGStopElementconten {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGStopElementconten, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    onprogress: js.ThisFunction1[PropsSVGStopElementconten, /* ev */ ProgressEvent, _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGStopElementconten, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsSVGStopElementconten, 
