...
object PropsHTMLAudioElementcont {
  ...
  def apply(
    ...
    addEventListener: (encrypted, /* listener */ js.ThisFunction1[PropsHTMLAudioElementcont, /* ev */ MediaEncryptedEvent, js.Any]) => Callback = null,
    ...
    play: js.UndefOr[CallbackTo[js.Promise[Unit]]] = js.undefined,
    ...
    if (addEventListener != null) __obj.updateDynamic("addEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.petitDom.petitDomStrings.encrypted, t1: /* listener */ js.ThisFunction1[
  typingsJapgolly.petitDom.PropsHTMLAudioElementcont, 
  /* ev */ typingsJapgolly.std.MediaEncryptedEvent, 
