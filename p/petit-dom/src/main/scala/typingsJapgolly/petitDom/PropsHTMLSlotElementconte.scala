...
object PropsHTMLSlotElementconte {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLSlotElementconte, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    assignedElements: js.UndefOr[CallbackTo[js.Array[Element]]] = js.undefined,
    assignedNodes: js.UndefOr[CallbackTo[js.Array[Node]]] = js.undefined,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLSlotElementconte, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLSlotElementconte, 
  ...
  js.Any]) => addEventListener(t0, t1).runNow()))
    ...
    assignedElements.foreach(p => __obj.updateDynamic("assignedElements")(p.toJsFn))
    assignedNodes.foreach(p => __obj.updateDynamic("assignedNodes")(p.toJsFn))
