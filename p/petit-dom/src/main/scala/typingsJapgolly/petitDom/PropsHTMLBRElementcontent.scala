...
object PropsHTMLBRElementcontent {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLBRElementcontent, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    onprogress: js.ThisFunction1[PropsHTMLBRElementcontent, /* ev */ ProgressEvent, _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLBRElementcontent, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLBRElementcontent, 
