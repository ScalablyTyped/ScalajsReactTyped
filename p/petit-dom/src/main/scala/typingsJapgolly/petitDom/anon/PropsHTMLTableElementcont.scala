...
object PropsHTMLTableElementcont {
  ...
  extension [Self <: PropsHTMLTableElementcont](x: Self) {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableElementcont, /* ev */ Event, Any]) => Callback
    ): Self = StObject.set(x, "addEventListener", js.Any.fromFunction2((t0: fullscreenchange, t1: /* listener */ js.ThisFunction1[PropsHTMLTableElementcont, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setCreateCaption(value: CallbackTo[HTMLTableCaptionElement]): Self = StObject.set(x, "createCaption", value.toJsFn)
    
    inline def setCreateCaptionUndefined: Self = StObject.set(x, "createCaption", js.undefined)
    
    inline def setCreateTBody(value: CallbackTo[HTMLTableSectionElement]): Self = StObject.set(x, "createTBody", value.toJsFn)
    
    inline def setCreateTBodyUndefined: Self = StObject.set(x, "createTBody", js.undefined)
    
    inline def setCreateTFoot(value: CallbackTo[HTMLTableSectionElement]): Self = StObject.set(x, "createTFoot", value.toJsFn)
    
    inline def setCreateTFootUndefined: Self = StObject.set(x, "createTFoot", js.undefined)
    
    inline def setCreateTHead(value: CallbackTo[HTMLTableSectionElement]): Self = StObject.set(x, "createTHead", value.toJsFn)
    ...
    inline def setDeleteCaption(value: Callback): Self = StObject.set(x, "deleteCaption", value.toJsFn)
    
    inline def setDeleteCaptionUndefined: Self = StObject.set(x, "deleteCaption", js.undefined)
    
    inline def setDeleteRow(value: /* index */ Double => Callback): Self = StObject.set(x, "deleteRow", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
    
    inline def setDeleteRowUndefined: Self = StObject.set(x, "deleteRow", js.undefined)
    
    inline def setDeleteTFoot(value: Callback): Self = StObject.set(x, "deleteTFoot", value.toJsFn)
    
    inline def setDeleteTFootUndefined: Self = StObject.set(x, "deleteTFoot", js.undefined)
    
    inline def setDeleteTHead(value: Callback): Self = StObject.set(x, "deleteTHead", value.toJsFn)
    ...
    inline def setInsertRow(value: CallbackTo[HTMLTableRowElement]): Self = StObject.set(x, "insertRow", value.toJsFn)
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsHTMLTableElementcont, /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
    ...
    inline def setRemoveEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableElementcont, /* ev */ Event, Any]) => Callback
    ): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction2((t0: fullscreenchange, t1: /* listener */ js.ThisFunction1[PropsHTMLTableElementcont, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
