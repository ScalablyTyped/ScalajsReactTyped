...
object PropsHTMLSlotElementconte {
  ...
  extension [Self <: PropsHTMLSlotElementconte](x: Self) {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLSlotElementconte, /* ev */ Event, Any]) => Callback
    ): Self = StObject.set(x, "addEventListener", js.Any.fromFunction2((t0: fullscreenchange, t1: /* listener */ js.ThisFunction1[PropsHTMLSlotElementconte, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setAssign(value: /* repeated */ Element | Text => Callback): Self = StObject.set(x, "assign", js.Any.fromFunction1((t0: /* repeated */ Element | Text) => value(t0).runNow()))
    
    inline def setAssignUndefined: Self = StObject.set(x, "assign", js.undefined)
    
    inline def setAssignedElements(value: CallbackTo[js.Array[Element]]): Self = StObject.set(x, "assignedElements", value.toJsFn)
    
    inline def setAssignedElementsUndefined: Self = StObject.set(x, "assignedElements", js.undefined)
    
    inline def setAssignedNodes(value: CallbackTo[js.Array[Node]]): Self = StObject.set(x, "assignedNodes", value.toJsFn)
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsHTMLSlotElementconte, /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
    ...
    inline def setRemoveEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLSlotElementconte, /* ev */ Event, Any]) => Callback
    ): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction2((t0: fullscreenchange, t1: /* listener */ js.ThisFunction1[PropsHTMLSlotElementconte, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
