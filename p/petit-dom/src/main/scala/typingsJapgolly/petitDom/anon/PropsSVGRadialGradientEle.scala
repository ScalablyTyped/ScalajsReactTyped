...
object PropsSVGRadialGradientEle {
  ...
  extension [Self <: PropsSVGRadialGradientEle](x: Self) {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGRadialGradientEle, /* ev */ Event, Any]) => Callback
    ): Self = StObject.set(x, "addEventListener", js.Any.fromFunction2((t0: fullscreenchange, t1: /* listener */ js.ThisFunction1[PropsSVGRadialGradientEle, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsSVGRadialGradientEle, /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
    ...
    inline def setRemoveEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGRadialGradientEle, /* ev */ Event, Any]) => Callback
    ): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction2((t0: fullscreenchange, t1: /* listener */ js.ThisFunction1[PropsSVGRadialGradientEle, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
