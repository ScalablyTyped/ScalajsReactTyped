...
object PropsHTMLTableRowElementc {
  ...
  extension [Self <: PropsHTMLTableRowElementc](x: Self) {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableRowElementc, /* ev */ Event, Any]) => Callback
    ): Self = StObject.set(x, "addEventListener", js.Any.fromFunction2((t0: fullscreenchange, t1: /* listener */ js.ThisFunction1[PropsHTMLTableRowElementc, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setDeleteCell(value: /* index */ Double => Callback): Self = StObject.set(x, "deleteCell", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
    ...
    inline def setInsertCell(value: CallbackTo[HTMLTableCellElement]): Self = StObject.set(x, "insertCell", value.toJsFn)
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsHTMLTableRowElementc, /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
    ...
    inline def setRemoveEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableRowElementc, /* ev */ Event, Any]) => Callback
    ): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction2((t0: fullscreenchange, t1: /* listener */ js.ThisFunction1[PropsHTMLTableRowElementc, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
