...
object PropsHTMLTableElementcont {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableElementcont, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    createCaption: js.UndefOr[CallbackTo[HTMLTableCaptionElement]] = js.undefined,
    createTBody: js.UndefOr[CallbackTo[HTMLTableSectionElement]] = js.undefined,
    createTFoot: js.UndefOr[CallbackTo[HTMLTableSectionElement]] = js.undefined,
    createTHead: js.UndefOr[CallbackTo[HTMLTableSectionElement]] = js.undefined,
    dataset: DOMStringMap = null,
    deleteCaption: js.UndefOr[Callback] = js.undefined,
    deleteRow: /* index */ Double => Callback = null,
    deleteTFoot: js.UndefOr[Callback] = js.undefined,
    deleteTHead: js.UndefOr[Callback] = js.undefined,
    dir: String = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTableElementcont, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLTableElementcont, 
  ...
  js.Any]) => addEventListener(t0, t1).runNow()))
    ...
    createCaption.foreach(p => __obj.updateDynamic("createCaption")(p.toJsFn))
    createTBody.foreach(p => __obj.updateDynamic("createTBody")(p.toJsFn))
    createTFoot.foreach(p => __obj.updateDynamic("createTFoot")(p.toJsFn))
    createTHead.foreach(p => __obj.updateDynamic("createTHead")(p.toJsFn))
    if (dataset != null) __obj.updateDynamic("dataset")(dataset.asInstanceOf[js.Any])
    deleteCaption.foreach(p => __obj.updateDynamic("deleteCaption")(p.toJsFn))
    if (deleteRow != null) __obj.updateDynamic("deleteRow")(js.Any.fromFunction1((t0: /* index */ scala.Double) => deleteRow(t0).runNow()))
    deleteTFoot.foreach(p => __obj.updateDynamic("deleteTFoot")(p.toJsFn))
    deleteTHead.foreach(p => __obj.updateDynamic("deleteTHead")(p.toJsFn))
