...
object PropsHTMLTemplateElementc {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTemplateElementc, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTemplateElementc, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLTemplateElementc, 
