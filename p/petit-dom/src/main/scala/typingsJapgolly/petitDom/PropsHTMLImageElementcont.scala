...
import typingsJapgolly.petitDom.petitDomStrings.async
...
import typingsJapgolly.petitDom.petitDomStrings.sync
...
object PropsHTMLImageElementcont {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLImageElementcont, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    decode: js.UndefOr[CallbackTo[js.Promise[Unit]]] = js.undefined,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLImageElementcont, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLImageElementcont, 
  ...
  js.Any]) => addEventListener(t0, t1).runNow()))
    ...
    decode.foreach(p => __obj.updateDynamic("decode")(p.toJsFn))
