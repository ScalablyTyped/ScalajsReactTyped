...
object PropsSVGUseElementcontent {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGUseElementcontent, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    onprogress: js.ThisFunction1[PropsSVGUseElementcontent, /* ev */ ProgressEvent, _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGUseElementcontent, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsSVGUseElementcontent, 
