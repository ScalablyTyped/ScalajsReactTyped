...
object PropsHTMLSelectElementcon {
  ...
  def apply(
    ...
    add: /* element */ HTMLOptionElement => Callback = null,
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLSelectElementcon, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    item: /* index */ Double => CallbackTo[Element | Null] = null,
    key: Key = null,
    ...
    name: String = null,
    namedItem: /* name */ String => CallbackTo[HTMLOptionElement | Null] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLSelectElementcon, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    if (add != null) __obj.updateDynamic("add")(js.Any.fromFunction1((t0: /* element */ org.scalajs.dom.raw.HTMLOptionElement) => add(t0).runNow()))
  ...
  typingsJapgolly.petitDom.PropsHTMLSelectElementcon, 
  ...
  js.Any]) => addEventListener(t0, t1).runNow()))
    ...
    if (item != null) __obj.updateDynamic("item")(js.Any.fromFunction1((t0: /* index */ scala.Double) => item(t0).runNow()))
    ...
    if (namedItem != null) __obj.updateDynamic("namedItem")(js.Any.fromFunction1((t0: /* name */ java.lang.String) => namedItem(t0).runNow()))
