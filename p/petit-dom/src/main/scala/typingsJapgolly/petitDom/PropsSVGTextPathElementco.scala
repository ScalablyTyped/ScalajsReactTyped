...
/* Inlined petit-dom.petit-dom.PetitDom.Props<std.SVGTextPathElement> & {  content ? :petit-dom.petit-dom.PetitDom.Content | std.ReadonlyArray<petit-dom.petit-dom.PetitDom.Content>} */
trait PropsSVGTextPathElementco extends js.Object {
  ...
  var TEXTPATH_METHODTYPE_ALIGN: js.UndefOr[Double] = js.undefined
  var TEXTPATH_METHODTYPE_STRETCH: js.UndefOr[Double] = js.undefined
  var TEXTPATH_METHODTYPE_UNKNOWN: js.UndefOr[Double] = js.undefined
  var TEXTPATH_SPACINGTYPE_AUTO: js.UndefOr[Double] = js.undefined
  var TEXTPATH_SPACINGTYPE_EXACT: js.UndefOr[Double] = js.undefined
  var TEXTPATH_SPACINGTYPE_UNKNOWN: js.UndefOr[Double] = js.undefined
  ...
  var method: js.UndefOr[SVGAnimatedEnumeration] = js.undefined
  ...
  var spacing: js.UndefOr[SVGAnimatedEnumeration] = js.undefined
  var startOffset: js.UndefOr[SVGAnimatedLength] = js.undefined
...
object PropsSVGTextPathElementco {
  @scala.inline
  def apply(
    ...
    TEXTPATH_METHODTYPE_ALIGN: Int | Double = null,
    TEXTPATH_METHODTYPE_STRETCH: Int | Double = null,
    TEXTPATH_METHODTYPE_UNKNOWN: Int | Double = null,
    TEXTPATH_SPACINGTYPE_AUTO: Int | Double = null,
    TEXTPATH_SPACINGTYPE_EXACT: Int | Double = null,
    TEXTPATH_SPACINGTYPE_UNKNOWN: Int | Double = null,
    TEXT_NODE: Int | Double = null,
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    getCharNumAtPosition: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getClientRects: js.UndefOr[CallbackTo[DOMRectList]] = js.undefined,
    getComputedTextLength: js.UndefOr[CallbackTo[Double]] = js.undefined,
    ...
    getEndPositionOfChar: /* charnum */ Double => CallbackTo[DOMPoint] = null,
    getExtentOfChar: /* charnum */ Double => CallbackTo[DOMRect] = null,
    getNumberOfChars: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getRootNode: js.UndefOr[CallbackTo[Node]] = js.undefined,
    getRotationOfChar: /* charnum */ Double => CallbackTo[Double] = null,
    getScreenCTM: js.UndefOr[CallbackTo[DOMMatrix | Null]] = js.undefined,
    getStartPositionOfChar: /* charnum */ Double => CallbackTo[DOMPoint] = null,
    getSubStringLength: (/* charnum */ Double, /* nchars */ Double) => CallbackTo[Double] = null,
    ...
    method: SVGAnimatedEnumeration = null,
    ...
    onabort: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ UIEvent, _] = null,
    onanimationcancel: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ AnimationEvent, _] = null,
    onanimationend: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ AnimationEvent, _] = null,
    onanimationiteration: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ AnimationEvent, _] = null,
    onanimationstart: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ AnimationEvent, _] = null,
    onauxclick: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    onblur: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ FocusEvent, _] = null,
    oncancel: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    oncanplay: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    oncanplaythrough: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onchange: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onclick: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    onclose: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    oncontextmenu: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    oncopy: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ ClipboardEvent, _] = null,
    oncuechange: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    oncut: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ ClipboardEvent, _] = null,
    ondblclick: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    ondrag: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ DragEvent, _] = null,
    ondragend: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ DragEvent, _] = null,
    ondragenter: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ DragEvent, _] = null,
    ondragexit: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    ondragleave: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ DragEvent, _] = null,
    ondragover: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ DragEvent, _] = null,
    ondragstart: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ DragEvent, _] = null,
    ondrop: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ DragEvent, _] = null,
    ondurationchange: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onemptied: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onended: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    ...
    onfocus: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ FocusEvent, _] = null,
    onfullscreenchange: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onfullscreenerror: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    ongotpointercapture: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ PointerEvent, _] = null,
    oninput: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    oninvalid: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onkeydown: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ KeyboardEvent, _] = null,
    onkeypress: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ KeyboardEvent, _] = null,
    onkeyup: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ KeyboardEvent, _] = null,
    onload: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onloadeddata: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onloadedmetadata: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onloadstart: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onlostpointercapture: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ PointerEvent, _] = null,
    onmousedown: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    onmouseenter: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    onmouseleave: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    onmousemove: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    onmouseout: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    onmouseover: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    onmouseup: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ MouseEvent, _] = null,
    onpaste: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ ClipboardEvent, _] = null,
    onpause: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onplay: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onplaying: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onpointercancel: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ PointerEvent, _] = null,
    onpointerdown: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ PointerEvent, _] = null,
    onpointerenter: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ PointerEvent, _] = null,
    onpointerleave: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ PointerEvent, _] = null,
    onpointermove: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ PointerEvent, _] = null,
    onpointerout: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ PointerEvent, _] = null,
    onpointerover: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ PointerEvent, _] = null,
    onpointerup: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ PointerEvent, _] = null,
    onprogress: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ ProgressEvent, _] = null,
    onratechange: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onreset: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onresize: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ UIEvent, _] = null,
    onscroll: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onsecuritypolicyviolation: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ SecurityPolicyViolationEvent, _] = null,
    onseeked: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onseeking: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onselect: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onselectionchange: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onselectstart: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onstalled: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onsubmit: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onsuspend: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    ontimeupdate: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    ontoggle: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    ontouchcancel: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ TouchEvent, _] = null,
    ontouchend: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ TouchEvent, _] = null,
    ontouchmove: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ TouchEvent, _] = null,
    ontouchstart: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ TouchEvent, _] = null,
    ontransitioncancel: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ TransitionEvent, _] = null,
    ontransitionend: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ TransitionEvent, _] = null,
    ontransitionrun: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ TransitionEvent, _] = null,
    ontransitionstart: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ TransitionEvent, _] = null,
    onvolumechange: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onwaiting: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _] = null,
    onwheel: js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ WheelEvent, _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    selectSubString: (/* charnum */ Double, /* nchars */ Double) => Callback = null,
    ...
    slot: String = null,
    spacing: SVGAnimatedEnumeration = null,
    startOffset: SVGAnimatedLength = null,
    ...
    if (TEXTPATH_METHODTYPE_ALIGN != null) __obj.updateDynamic("TEXTPATH_METHODTYPE_ALIGN")(TEXTPATH_METHODTYPE_ALIGN.asInstanceOf[js.Any])
    if (TEXTPATH_METHODTYPE_STRETCH != null) __obj.updateDynamic("TEXTPATH_METHODTYPE_STRETCH")(TEXTPATH_METHODTYPE_STRETCH.asInstanceOf[js.Any])
    if (TEXTPATH_METHODTYPE_UNKNOWN != null) __obj.updateDynamic("TEXTPATH_METHODTYPE_UNKNOWN")(TEXTPATH_METHODTYPE_UNKNOWN.asInstanceOf[js.Any])
    if (TEXTPATH_SPACINGTYPE_AUTO != null) __obj.updateDynamic("TEXTPATH_SPACINGTYPE_AUTO")(TEXTPATH_SPACINGTYPE_AUTO.asInstanceOf[js.Any])
    if (TEXTPATH_SPACINGTYPE_EXACT != null) __obj.updateDynamic("TEXTPATH_SPACINGTYPE_EXACT")(TEXTPATH_SPACINGTYPE_EXACT.asInstanceOf[js.Any])
    if (TEXTPATH_SPACINGTYPE_UNKNOWN != null) __obj.updateDynamic("TEXTPATH_SPACINGTYPE_UNKNOWN")(TEXTPATH_SPACINGTYPE_UNKNOWN.asInstanceOf[js.Any])
  ...
  typingsJapgolly.petitDom.PropsSVGTextPathElementco, 
  ...
  js.Any]) => addEventListener(t0, t1).runNow()))
    ...
    getCharNumAtPosition.foreach(p => __obj.updateDynamic("getCharNumAtPosition")(p.toJsFn))
    getClientRects.foreach(p => __obj.updateDynamic("getClientRects")(p.toJsFn))
    getComputedTextLength.foreach(p => __obj.updateDynamic("getComputedTextLength")(p.toJsFn))
    ...
    if (getEndPositionOfChar != null) __obj.updateDynamic("getEndPositionOfChar")(js.Any.fromFunction1((t0: /* charnum */ scala.Double) => getEndPositionOfChar(t0).runNow()))
    if (getExtentOfChar != null) __obj.updateDynamic("getExtentOfChar")(js.Any.fromFunction1((t0: /* charnum */ scala.Double) => getExtentOfChar(t0).runNow()))
    getNumberOfChars.foreach(p => __obj.updateDynamic("getNumberOfChars")(p.toJsFn))
    getRootNode.foreach(p => __obj.updateDynamic("getRootNode")(p.toJsFn))
    if (getRotationOfChar != null) __obj.updateDynamic("getRotationOfChar")(js.Any.fromFunction1((t0: /* charnum */ scala.Double) => getRotationOfChar(t0).runNow()))
    getScreenCTM.foreach(p => __obj.updateDynamic("getScreenCTM")(p.toJsFn))
    if (getStartPositionOfChar != null) __obj.updateDynamic("getStartPositionOfChar")(js.Any.fromFunction1((t0: /* charnum */ scala.Double) => getStartPositionOfChar(t0).runNow()))
    if (getSubStringLength != null) __obj.updateDynamic("getSubStringLength")(js.Any.fromFunction2((t0: /* charnum */ scala.Double, t1: /* nchars */ scala.Double) => getSubStringLength(t0, t1).runNow()))
  ...
  js.Any]) => removeEventListener(t0, t1).runNow()))
    ...
    if (selectSubString != null) __obj.updateDynamic("selectSubString")(js.Any.fromFunction2((t0: /* charnum */ scala.Double, t1: /* nchars */ scala.Double) => selectSubString(t0, t1).runNow()))
    ...
    __obj.asInstanceOf[PropsSVGTextPathElementco]
  }
}
