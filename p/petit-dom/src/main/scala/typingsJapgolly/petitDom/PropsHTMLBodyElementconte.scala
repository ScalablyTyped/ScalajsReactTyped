...
import typingsJapgolly.petitDom.petitDomStrings.orientationchange
...
object PropsHTMLBodyElementconte {
  ...
  def apply(
    ...
    addEventListener: (orientationchange, /* listener */ js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (orientationchange, /* listener */ js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    if (addEventListener != null) __obj.updateDynamic("addEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.petitDom.petitDomStrings.orientationchange, t1: /* listener */ js.ThisFunction1[
  typingsJapgolly.petitDom.PropsHTMLBodyElementconte, 
  ...
  js.Any]) => addEventListener(t0, t1).runNow()))
    ...
    if (removeEventListener != null) __obj.updateDynamic("removeEventListener")(js.Any.fromFunction2((t0: typingsJapgolly.petitDom.petitDomStrings.orientationchange, t1: /* listener */ js.ThisFunction1[
  typingsJapgolly.petitDom.PropsHTMLBodyElementconte, 
  /* ev */ typingsJapgolly.std.Event_, 
