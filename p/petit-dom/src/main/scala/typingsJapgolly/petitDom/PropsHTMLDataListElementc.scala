...
object PropsHTMLDataListElementc {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLDataListElementc, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLDataListElementc, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLDataListElementc, 
