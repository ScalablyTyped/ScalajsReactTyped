...
object PropsSVGMarkerElementcont {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGMarkerElementcont, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGMarkerElementcont, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    setOrientToAngle: /* angle */ SVGAngle => Callback = null,
    setOrientToAuto: js.UndefOr[Callback] = js.undefined,
  ...
  typingsJapgolly.petitDom.PropsSVGMarkerElementcont, 
  ...
  js.Any]) => removeEventListener(t0, t1).runNow()))
    ...
    if (setOrientToAngle != null) __obj.updateDynamic("setOrientToAngle")(js.Any.fromFunction1((t0: /* angle */ org.scalajs.dom.raw.SVGAngle) => setOrientToAngle(t0).runNow()))
    setOrientToAuto.foreach(p => __obj.updateDynamic("setOrientToAuto")(p.toJsFn))
