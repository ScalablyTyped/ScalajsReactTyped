...
object PropsHTMLHeadElementconte {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLHeadElementconte, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    onprogress: js.ThisFunction1[PropsHTMLHeadElementconte, /* ev */ ProgressEvent, _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLHeadElementconte, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLHeadElementconte, 
