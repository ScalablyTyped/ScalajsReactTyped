...
object PropsHTMLDialogElementcon {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLDialogElementcon, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLDialogElementcon, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    showModal: js.UndefOr[Callback] = js.undefined,
    slot: String = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLDialogElementcon, 
  ...
  js.Any]) => removeEventListener(t0, t1).runNow()))
    ...
    showModal.foreach(p => __obj.updateDynamic("showModal")(p.toJsFn))
