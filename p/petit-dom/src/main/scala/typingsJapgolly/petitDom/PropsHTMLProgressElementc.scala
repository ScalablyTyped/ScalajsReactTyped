...
object PropsHTMLProgressElementc {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLProgressElementc, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLProgressElementc, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLProgressElementc, 
