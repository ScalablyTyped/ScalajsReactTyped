...
object PropsHTMLBaseElementconte {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLBaseElementconte, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLBaseElementconte, /* ev */ Event_, js.Any]) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsHTMLBaseElementconte, 
