...
object PropsSVGFEGaussianBlurEle {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEGaussianBlurEle, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEGaussianBlurEle, /* ev */ Event_, js.Any]) => Callback = null,
    ...
    setStdDeviation: (/* stdDeviationX */ Double, /* stdDeviationY */ Double) => Callback = null,
  ...
  typingsJapgolly.petitDom.PropsSVGFEGaussianBlurEle, 
  ...
  js.Any]) => removeEventListener(t0, t1).runNow()))
    ...
    if (setStdDeviation != null) __obj.updateDynamic("setStdDeviation")(js.Any.fromFunction2((t0: /* stdDeviationX */ scala.Double, t1: /* stdDeviationY */ scala.Double) => setStdDeviation(t0, t1).runNow()))
