...
import typingsJapgolly.passportGoogleIdToken.anon.Email
  ...
  object StrategyOptions {
    ...
    extension [Self <: StrategyOptions](x: Self) {
      ...
      inline def setGetGoogleCerts(
        value: (/* kid */ String, /* callback */ js.Function2[/* err */ Any, /* cert */ String, Unit]) => Callback
      ): Self = StObject.set(x, "getGoogleCerts", js.Any.fromFunction2((t0: /* kid */ String, t1: /* callback */ js.Function2[/* err */ Any, /* cert */ String, Unit]) => (value(t0, t1)).runNow()))
