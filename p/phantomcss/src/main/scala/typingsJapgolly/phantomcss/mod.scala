package typingsJapgolly.phantomcss
      ...
      object PhantomCSSOptions {
        ...
        extension [Self <: PhantomCSSOptions](x: Self) {
          ...
          inline def setOnComplete(
            value: (/* tests */ js.Array[PhantomCSSTest], /* noOfFails */ Double, /* noOfErrors */ Double) => Callback
          ): Self = StObject.set(x, "onComplete", js.Any.fromFunction3((t0: /* tests */ js.Array[PhantomCSSTest], t1: /* noOfFails */ Double, t2: /* noOfErrors */ Double) => (value(t0, t1, t2)).runNow()))
          
          inline def setOnCompleteUndefined: Self = StObject.set(x, "onComplete", js.undefined)
          
          inline def setOnFail(value: /* test */ PhantomCSSTest => Callback): Self = StObject.set(x, "onFail", js.Any.fromFunction1((t0: /* test */ PhantomCSSTest) => value(t0).runNow()))
          
          inline def setOnFailUndefined: Self = StObject.set(x, "onFail", js.undefined)
          
          inline def setOnNewImage(value: /* test */ PhantomCSSTest => Callback): Self = StObject.set(x, "onNewImage", js.Any.fromFunction1((t0: /* test */ PhantomCSSTest) => value(t0).runNow()))
          
          inline def setOnNewImageUndefined: Self = StObject.set(x, "onNewImage", js.undefined)
          
          inline def setOnPass(value: /* test */ PhantomCSSTest => Callback): Self = StObject.set(x, "onPass", js.Any.fromFunction1((t0: /* test */ PhantomCSSTest) => value(t0).runNow()))
          
          inline def setOnPassUndefined: Self = StObject.set(x, "onPass", js.undefined)
          
          inline def setOnTimeout(value: /* test */ PhantomCSSTest => Callback): Self = StObject.set(x, "onTimeout", js.Any.fromFunction1((t0: /* test */ PhantomCSSTest) => value(t0).runNow()))
