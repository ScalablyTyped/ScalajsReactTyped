...
import typingsJapgolly.polygon.anon.H
import typingsJapgolly.polygon.anon.Height
import typingsJapgolly.polygon.anon.Position
import typingsJapgolly.polygon.anon.X
import typingsJapgolly.polygon.anon.X1
...
object mod {
  ...
  open class ^ protected ()
    extends StObject
       with Polygon {
    def this(points: js.Array[js.Array[Double] | X | typingsJapgolly.vec2.mod.^]) = this()
  }
  ...
  trait Polygon extends StObject {
    ...
    /**
      ...
      */
    def center(): typingsJapgolly.vec2.mod.^ = js.native
    ...
    /**
      ...
      */
    def closestPointTo(vec2: typingsJapgolly.vec2.mod.^): typingsJapgolly.vec2.mod.^ = js.native
    ...
    /**
      ...
      */
    def contains(thing: js.Array[typingsJapgolly.vec2.mod.^]): Boolean = js.native
    ...
    /**
      ...
      */
    def containsPoint(vec2: typingsJapgolly.vec2.mod.^): Boolean = js.native
    ...
    def each(
      fn: js.Function4[
          /* prev */ typingsJapgolly.vec2.mod.^, 
          /* current */ typingsJapgolly.vec2.mod.^, 
          /* next */ typingsJapgolly.vec2.mod.^, 
          /* idx */ Double, 
          Any
        ]
    ): Polygon = js.native
    ...
    /**
      ...
      */
    def insert(vec2: typingsJapgolly.vec2.mod.^, index: Double): Unit = js.native
    ...
    /**
      ...
      */
    def line(index: Double): js.Tuple2[typingsJapgolly.vec2.mod.^, typingsJapgolly.vec2.mod.^] = js.native
    ...
    def lines(
      fn: js.Function3[
          /* start */ typingsJapgolly.vec2.mod.^, 
          /* end */ typingsJapgolly.vec2.mod.^, 
          /* index */ Double, 
          Any
        ]
    ): Polygon = js.native
    ...
    /**
      ...
      */
    def point(idx: Double): typingsJapgolly.vec2.mod.^ = js.native
    
    val points: js.Array[typingsJapgolly.vec2.mod.^] = js.native
    ...
    /**
      ...
      */
    def remove(vecOrIndex: typingsJapgolly.vec2.mod.^): Polygon = js.native
    ...
    /**
      ...
      */
    def rotate(rads: Double, vec2: typingsJapgolly.vec2.mod.^): Polygon = js.native
    def rotate(rads: Double, vec2: typingsJapgolly.vec2.mod.^, returnNew: Boolean): Polygon = js.native
    
    /**
      * Scales this polygon around `origin` (default is `this.center()`) and will return a new polygon if requested with `returnNew`
      */
    def scale(amount: Double, origin: typingsJapgolly.vec2.mod.^): Polygon = js.native
    def scale(amount: Double, origin: typingsJapgolly.vec2.mod.^, returnNew: Boolean): Polygon = js.native
    ...
    /**
      ...
      */
    def translate(vec2: typingsJapgolly.vec2.mod.^): Polygon = js.native
    def translate(vec2: typingsJapgolly.vec2.mod.^, returnNew: Boolean): Polygon = js.native
