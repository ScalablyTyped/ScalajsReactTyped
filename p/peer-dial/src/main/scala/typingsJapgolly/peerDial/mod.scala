package typingsJapgolly.peerDial
...
import typingsJapgolly.peerDial.anon.Icon
...
object mod {
  ...
  object App {
    ...
    inline def apply(allowStop: Boolean, launch: String => Callback, name: String, pid: String, state: String): App = {
      val __obj = js.Dynamic.literal(allowStop = allowStop.asInstanceOf[js.Any], launch = js.Any.fromFunction1((t0: String) => launch(t0).runNow()), name = name.asInstanceOf[js.Any], pid = pid.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any])
  ...
  object Delegate {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getApp = js.Any.fromFunction1(getApp), launchApp = js.Any.fromFunction3((t0: String, t1: String, t2: js.Function1[/* data */ String, Unit]) => (launchApp(t0, t1, t2)).runNow()), stopApp = js.Any.fromFunction3((t0: String, t1: String, t2: js.Function1[/* data */ Boolean, Unit]) => (stopApp(t0, t1, t2)).runNow()))
    ...
    extension [Self <: Delegate](x: Self) {
      ...
      inline def setLaunchApp(value: (String, String, js.Function1[/* data */ String, Unit]) => Callback): Self = StObject.set(x, "launchApp", js.Any.fromFunction3((t0: String, t1: String, t2: js.Function1[/* data */ String, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setStopApp(value: (String, String, js.Function1[/* data */ Boolean, Unit]) => Callback): Self = StObject.set(x, "stopApp", js.Any.fromFunction3((t0: String, t1: String, t2: js.Function1[/* data */ Boolean, Unit]) => (value(t0, t1, t2)).runNow()))
    }
  }
