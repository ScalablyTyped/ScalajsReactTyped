package typingsJapgolly.piscina

import japgolly.scalajs.react.Callback
import typingsJapgolly.node.workerThreadsMod.MessagePort
import typingsJapgolly.node.workerThreadsMod.Worker
import typingsJapgolly.piscina.distSrcCommonMod.TaskQueue
import typingsJapgolly.piscina.distSrcCommonMod.Transferable
import typingsJapgolly.piscina.piscinaStrings.abort
import typingsJapgolly.piscina.piscinaStrings.auto
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.piscina.mod.AbortSignalEventTarget
    - typingsJapgolly.piscina.mod.AbortSignalEventEmitter
  */
  ...
  object AbortSignalEventEmitter {
    ...
    inline def apply(off: (abort, js.Function0[Unit]) => Callback, once: (abort, js.Function0[Unit]) => Callback): AbortSignalEventEmitter = {
      val __obj = js.Dynamic.literal(off = js.Any.fromFunction2((t0: abort, t1: js.Function0[Unit]) => (off(t0, t1)).runNow()), once = js.Any.fromFunction2((t0: abort, t1: js.Function0[Unit]) => (once(t0, t1)).runNow()))
      __obj.asInstanceOf[AbortSignalEventEmitter]
    }
    
    extension [Self <: AbortSignalEventEmitter](x: Self) {
      
      inline def setOff(value: (abort, js.Function0[Unit]) => Callback): Self = StObject.set(x, "off", js.Any.fromFunction2((t0: abort, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
      
      inline def setOnce(value: (abort, js.Function0[Unit]) => Callback): Self = StObject.set(x, "once", js.Any.fromFunction2((t0: abort, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
    }
  }
  ...
  @js.native
  trait Piscina
    extends typingsJapgolly.eventemitterAsyncresource.mod.^ {
