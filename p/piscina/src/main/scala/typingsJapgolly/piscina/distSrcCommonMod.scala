...
import typingsJapgolly.piscina.piscinaBooleans.`true`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distSrcCommonMod {
  ...
  object commonState {
    ...
    @js.native
    def workerData: /* undefined */ Any = js.native
    inline def workerData_=(x: /* undefined */ Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("workerData")(x.asInstanceOf[js.Any])
  }
  ...
  object TaskQueue {
    ...
    inline def apply(push: Task => Callback, remove: Task => Callback, shift: CallbackTo[Task | Null], size: Double): TaskQueue = {
      val __obj = js.Dynamic.literal(push = js.Any.fromFunction1((t0: Task) => push(t0).runNow()), remove = js.Any.fromFunction1((t0: Task) => remove(t0).runNow()), shift = shift.toJsFn, size = size.asInstanceOf[js.Any])
      __obj.asInstanceOf[TaskQueue]
    }
    
    extension [Self <: TaskQueue](x: Self) {
      
      inline def setPush(value: Task => Callback): Self = StObject.set(x, "push", js.Any.fromFunction1((t0: Task) => value(t0).runNow()))
      
      inline def setRemove(value: Task => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction1((t0: Task) => value(t0).runNow()))
      
      inline def setShift(value: CallbackTo[Task | Null]): Self = StObject.set(x, "shift", value.toJsFn)
