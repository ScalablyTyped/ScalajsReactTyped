...
trait Group_
  ...
  var `type`: typingsJapgolly.prettier.prettierStrings.group
}
object Group_ {
  ...
  extension [Self <: Group_](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.prettier.prettierStrings.group): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
