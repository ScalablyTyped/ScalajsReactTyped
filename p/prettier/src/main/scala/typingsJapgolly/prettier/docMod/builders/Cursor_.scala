...
trait Cursor_
  ...
  var `type`: typingsJapgolly.prettier.prettierStrings.cursor
}
object Cursor_ {
  ...
  extension [Self <: Cursor_](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.prettier.prettierStrings.cursor): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
