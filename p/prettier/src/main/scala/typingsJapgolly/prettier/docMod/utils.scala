package typingsJapgolly.prettier.docMod

import typingsJapgolly.prettier.mod.Doc_
...
object utils {
  ...
  inline def canBreak(doc: Doc_): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("canBreak")(doc.asInstanceOf[js.Any]).asInstanceOf[Boolean]
