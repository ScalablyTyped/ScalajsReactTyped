package typingsJapgolly.pikadayTime.mod
...
object PikadayOptions {
  ...
  def apply(
    ...
    onSelect: /* date */ js.Date => Callback = null,
    ...
    if (onSelect != null) __obj.updateDynamic("onSelect")(js.Any.fromFunction1((t0: /* date */ js.Date) => onSelect(t0).runNow()))
