package typingsJapgolly.pikadayTime
...
object mod {
  ...
  object PikadayOptions {
    ...
    extension [Self <: PikadayOptions](x: Self) {
      ...
      inline def setOnDraw(value: Callback): Self = StObject.set(x, "onDraw", value.toJsFn)
      ...
      inline def setOnSelect(value: /* date */ js.Date => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction1((t0: /* date */ js.Date) => value(t0).runNow()))
