...
import typingsJapgolly.parcelTypes.mod.CreateBundleOpts
import typingsJapgolly.parcelTypes.mod.Target
...
trait BundleBehavior
  ...
  /**
    ...
    */
  val bundleBehavior: js.UndefOr[typingsJapgolly.parcelTypes.mod.BundleBehavior | Null] = js.undefined
  
  /** The entry asset of the bundle. If provided, many bundle properties will be inferred from it. */
  val entryAsset: typingsJapgolly.parcelTypes.mod.Asset
...
object BundleBehavior {
  ...
  inline def apply(entryAsset: typingsJapgolly.parcelTypes.mod.Asset, target: Target): BundleBehavior = {
  ...
  extension [Self <: BundleBehavior](x: Self) {
    ...
    inline def setBundleBehavior(value: typingsJapgolly.parcelTypes.mod.BundleBehavior): Self = StObject.set(x, "bundleBehavior", value.asInstanceOf[js.Any])
    ...
    inline def setEntryAsset(value: typingsJapgolly.parcelTypes.mod.Asset): Self = StObject.set(x, "entryAsset", value.asInstanceOf[js.Any])
