...
import typingsJapgolly.parcelTypes.anon.DistDir
...
trait InitialParcelOptions extends StObject {
  ...
  val additionalReporters: js.UndefOr[js.Array[typingsJapgolly.parcelTypes.anon.PackageName]] = js.undefined
...
object InitialParcelOptions {
  ...
  extension [Self <: InitialParcelOptions](x: Self) {
    ...
    inline def setAdditionalReporters(value: js.Array[typingsJapgolly.parcelTypes.anon.PackageName]): Self = StObject.set(x, "additionalReporters", value.asInstanceOf[js.Any])
    
    inline def setAdditionalReportersUndefined: Self = StObject.set(x, "additionalReporters", js.undefined)
    
    inline def setAdditionalReportersVarargs(value: typingsJapgolly.parcelTypes.anon.PackageName*): Self = StObject.set(x, "additionalReporters", js.Array(value*))
