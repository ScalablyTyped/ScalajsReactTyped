package typingsJapgolly.phosphorCommands.mod.CommandRegistry

import typingsJapgolly.phosphorCommands.phosphorCommandsStrings.`many-changed`
import typingsJapgolly.phosphorCommands.phosphorCommandsStrings.added
import typingsJapgolly.phosphorCommands.phosphorCommandsStrings.changed
import typingsJapgolly.phosphorCommands.phosphorCommandsStrings.removed
