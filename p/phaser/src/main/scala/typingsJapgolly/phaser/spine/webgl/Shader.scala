...
object Shader extends js.Object {
  ...
  def newColored(context: typingsJapgolly.std.WebGLRenderingContext): Shader = js.native
  def newColoredTextured(context: ManagedWebGLRenderingContext): Shader = js.native
  def newColoredTextured(context: typingsJapgolly.std.WebGLRenderingContext): Shader = js.native
  def newTwoColoredTextured(context: ManagedWebGLRenderingContext): Shader = js.native
  def newTwoColoredTextured(context: typingsJapgolly.std.WebGLRenderingContext): Shader = js.native
}
