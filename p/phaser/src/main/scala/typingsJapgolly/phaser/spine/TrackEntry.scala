...
object TrackEntry {
  ...
  inline def apply(
    ...
    getAnimationTime: CallbackTo[Double],
    ...
    reset: Callback,
    resetRotationDirections: Callback,
    setAnimationLast: Double => Callback,
    timeScale: Double,
    ...
    val __obj = js.Dynamic.literal(alpha = alpha.asInstanceOf[js.Any], animation = animation.asInstanceOf[js.Any], animationEnd = animationEnd.asInstanceOf[js.Any], animationLast = animationLast.asInstanceOf[js.Any], animationStart = animationStart.asInstanceOf[js.Any], attachmentThreshold = attachmentThreshold.asInstanceOf[js.Any], delay = delay.asInstanceOf[js.Any], drawOrderThreshold = drawOrderThreshold.asInstanceOf[js.Any], eventThreshold = eventThreshold.asInstanceOf[js.Any], getAnimationTime = getAnimationTime.toJsFn, holdPrevious = holdPrevious.asInstanceOf[js.Any], interruptAlpha = interruptAlpha.asInstanceOf[js.Any], isComplete = isComplete.toJsFn, listener = listener.asInstanceOf[js.Any], loop = loop.asInstanceOf[js.Any], mixBlend = mixBlend.asInstanceOf[js.Any], mixDuration = mixDuration.asInstanceOf[js.Any], mixTime = mixTime.asInstanceOf[js.Any], mixingFrom = mixingFrom.asInstanceOf[js.Any], mixingTo = mixingTo.asInstanceOf[js.Any], next = next.asInstanceOf[js.Any], nextAnimationLast = nextAnimationLast.asInstanceOf[js.Any], nextTrackLast = nextTrackLast.asInstanceOf[js.Any], reset = reset.toJsFn, resetRotationDirections = resetRotationDirections.toJsFn, setAnimationLast = js.Any.fromFunction1((t0: Double) => setAnimationLast(t0).runNow()), timeScale = timeScale.asInstanceOf[js.Any], timelineHoldMix = timelineHoldMix.asInstanceOf[js.Any], timelineMode = timelineMode.asInstanceOf[js.Any], timelinesRotation = timelinesRotation.asInstanceOf[js.Any], totalAlpha = totalAlpha.asInstanceOf[js.Any], trackEnd = trackEnd.asInstanceOf[js.Any], trackIndex = trackIndex.asInstanceOf[js.Any], trackLast = trackLast.asInstanceOf[js.Any], trackTime = trackTime.asInstanceOf[js.Any])
  ...
  extension [Self <: TrackEntry](x: Self) {
    ...
    inline def setGetAnimationTime(value: CallbackTo[Double]): Self = StObject.set(x, "getAnimationTime", value.toJsFn)
    ...
    inline def setResetRotationDirections(value: Callback): Self = StObject.set(x, "resetRotationDirections", value.toJsFn)
    
    inline def setSetAnimationLast(value: Double => Callback): Self = StObject.set(x, "setAnimationLast", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
