...
@js.native
class Composite ()
  extends typingsJapgolly.phaser.MatterJS.Composite
...
object Composite extends js.Object {
  ...
  /**
    ...
    */
  def rotate(composite: CompositeType, rotation: Double, point: typingsJapgolly.phaser.MatterJS.Vector): Unit = js.native
  def rotate(
  ...
  /**
    ...
    * @param {bool} [recursive=true]
    */
  def translate(composite: CompositeType, translation: typingsJapgolly.phaser.MatterJS.Vector): Unit = js.native
  def translate(composite: CompositeType, translation: typingsJapgolly.phaser.MatterJS.Vector, recursive: Boolean): Unit = js.native
}
