...
@js.native
class Body ()
  extends typingsJapgolly.phaser.MatterJS.Body
...
object Body extends js.Object {
  ...
  /**
    ...
    * @return {body} body
    */
  def create(options: IChamferableBodyDefinition): typingsJapgolly.phaser.MatterJS.Body = js.native
  /**
  ...
  def scale(body: BodyType, scaleX: Double, scaleY: Double, point: typingsJapgolly.phaser.MatterJS.Vector): Unit = js.native
  /**
  ...
  /**
    ...
    * @param {vector} position
    */
  def setPosition(body: BodyType, position: typingsJapgolly.phaser.MatterJS.Vector): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setVelocity(body: BodyType, velocity: typingsJapgolly.phaser.MatterJS.Vector): Unit = js.native
  /**
    ...
    */
  def setVertices(body: BodyType, vertices: js.Array[typingsJapgolly.phaser.MatterJS.Vector]): Unit = js.native
  /**
    ...
    */
  def translate(body: BodyType, translation: typingsJapgolly.phaser.MatterJS.Vector): Unit = js.native
  /**
