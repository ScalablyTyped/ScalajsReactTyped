...
open class FacebookInstantGamesLeaderboard protected ()
  extends StObject
     with typingsJapgolly.phaser.Phaser.FacebookInstantGamesLeaderboard {
  /**
    * 
    * @param plugin A reference to the Facebook Instant Games Plugin.
    * @param data An Instant Game leaderboard instance.
    */
  def this(plugin: typingsJapgolly.phaser.Phaser.FacebookInstantGamesPlugin, data: Any) = this()
}
