...
@js.native
class Bodies ()
  extends typingsJapgolly.phaser.MatterJS.Bodies
...
object Bodies extends js.Object {
  ...
  /**
    ...
    * @return {body}
    */
  def fromVertices(x: Double, y: Double, vertexSets: js.Array[js.Array[typingsJapgolly.phaser.MatterJS.Vector]]): BodyType = js.native
  def fromVertices(
    x: Double,
    y: Double,
