...
import typingsJapgolly.phaser.spine.webgl.SkeletonRenderer
...
trait Typeofwebgl extends StObject {
  ...
  var Matrix4: Instantiable0[typingsJapgolly.phaser.spine.webgl.Matrix4] & TypeofMatrix4
  ...
  var Shader: (Instantiable3[
    ...
    typingsJapgolly.phaser.spine.webgl.Shader
  ]) & TypeofShader
  ...
  var WebGLBlendModeConverter: Instantiable0[typingsJapgolly.phaser.spine.webgl.WebGLBlendModeConverter] & TypeofWebGLBlendModeConve
}
object Typeofwebgl {
