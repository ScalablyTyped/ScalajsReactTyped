...
object Animations {
  ...
  trait PlayAnimationConfig extends StObject {
    ...
    /**
      ...
      */
    var key: String | typingsJapgolly.phaser.Phaser.Animations.Animation
  ...
  object PlayAnimationConfig {
    ...
    inline def apply(key: String | typingsJapgolly.phaser.Phaser.Animations.Animation): PlayAnimationConfig = {
    ...
    extension [Self <: PlayAnimationConfig](x: Self) {
      ...
      inline def setKey(value: String | typingsJapgolly.phaser.Phaser.Animations.Animation): Self = StObject.set(x, "key", value.asInstanceOf[js.Any])
