...
import typingsJapgolly.phaser.EachListCallback
import typingsJapgolly.phaser.EachMapCallback
import typingsJapgolly.phaser.EachSetCallback
...
object Structs {
  ...
  trait List[T] extends StObject {
    ...
    /**
      ...
      * @param skipCallback Skip calling the List.removeCallback. Default false.
      */
    def removeAll(): typingsJapgolly.phaser.Phaser.Structs.List[T] = js.native
    def removeAll(skipCallback: Boolean): typingsJapgolly.phaser.Phaser.Structs.List[T] = js.native
    ...
    /**
      ...
      */
    def reverse(): typingsJapgolly.phaser.Phaser.Structs.List[T] = js.native
    ...
    /**
      ...
      */
    def shuffle(): typingsJapgolly.phaser.Phaser.Structs.List[T] = js.native
