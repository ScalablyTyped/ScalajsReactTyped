...
import typingsJapgolly.phaser.Phaser.Geom.Mesh.Face
import typingsJapgolly.phaser.Phaser.Geom.Mesh.Vertex
  ...
  object Mesh {
    ...
    trait GenerateGridConfig extends StObject {
      ...
      /**
        ...
        */
      var mesh: js.UndefOr[typingsJapgolly.phaser.Phaser.GameObjects.Mesh] = js.undefined
    ...
    object GenerateGridConfig {
      ...
      extension [Self <: GenerateGridConfig](x: Self) {
        ...
        inline def setMesh(value: typingsJapgolly.phaser.Phaser.GameObjects.Mesh): Self = StObject.set(x, "mesh", value.asInstanceOf[js.Any])
