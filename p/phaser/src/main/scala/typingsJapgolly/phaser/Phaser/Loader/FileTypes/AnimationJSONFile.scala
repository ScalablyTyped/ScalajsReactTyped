...
object AnimationJSONFile {
  ...
  extension [Self <: AnimationJSONFile](x: Self) {
    ...
    inline def setOnLoadComplete(value: Callback): Self = StObject.set(x, "onLoadComplete", value.toJsFn)
  }
}
