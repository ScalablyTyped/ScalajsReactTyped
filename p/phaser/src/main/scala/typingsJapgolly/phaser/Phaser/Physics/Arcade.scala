package typingsJapgolly.phaser.Phaser.Physics
...
import typingsJapgolly.phaser.Phaser.Physics.Arcade.Components.Pushable
...
import typingsJapgolly.phaser.Phaser.Structs.RTree
...
import typingsJapgolly.phaser.Phaser.Types.Physics.Arcade.ArcadeBodyBounds
import typingsJapgolly.phaser.Phaser.Types.Physics.Arcade.ArcadeBodyCollision
...
import typingsJapgolly.phaser.Phaser.Types.Physics.Arcade.ArcadeWorldDefaults
import typingsJapgolly.phaser.Phaser.Types.Physics.Arcade.ArcadeWorldTreeMinMax
import typingsJapgolly.phaser.Phaser.Types.Physics.Arcade.CheckCollisionObject
import typingsJapgolly.phaser.Phaser.Types.Physics.Arcade.GameObjectWithBody
import typingsJapgolly.phaser.Phaser.Types.Physics.Arcade.ImageWithDynamicBody
import typingsJapgolly.phaser.Phaser.Types.Physics.Arcade.ImageWithStaticBody
...
import typingsJapgolly.phaser.Phaser.Types.Physics.Arcade.SpriteWithDynamicBody
import typingsJapgolly.phaser.Phaser.Types.Physics.Arcade.SpriteWithStaticBody
...
object Arcade {
  ...
  object Collider {
    ...
    inline def apply(
      ...
      collideCallback: (/* object1 */ GameObjectWithBody, /* object2 */ GameObjectWithBody) => Callback,
      destroy: Callback,
      name: String,
      object1: ArcadeColliderType,
      object2: ArcadeColliderType,
      overlapOnly: Boolean,
      processCallback: (/* object1 */ GameObjectWithBody, /* object2 */ GameObjectWithBody) => Callback,
      setName: String => Collider,
      update: Callback,
      world: World
    ): Collider = {
      val __obj = js.Dynamic.literal(active = active.asInstanceOf[js.Any], callbackContext = callbackContext.asInstanceOf[js.Any], collideCallback = js.Any.fromFunction2((t0: /* object1 */ GameObjectWithBody, t1: /* object2 */ GameObjectWithBody) => (collideCallback(t0, t1)).runNow()), destroy = destroy.toJsFn, name = name.asInstanceOf[js.Any], object1 = object1.asInstanceOf[js.Any], object2 = object2.asInstanceOf[js.Any], overlapOnly = overlapOnly.asInstanceOf[js.Any], processCallback = js.Any.fromFunction2((t0: /* object1 */ GameObjectWithBody, t1: /* object2 */ GameObjectWithBody) => (processCallback(t0, t1)).runNow()), setName = js.Any.fromFunction1(setName), update = update.toJsFn, world = world.asInstanceOf[js.Any])
    ...
    extension [Self <: Collider](x: Self) {
      ...
      inline def setCollideCallback(value: (/* object1 */ GameObjectWithBody, /* object2 */ GameObjectWithBody) => Callback): Self = StObject.set(x, "collideCallback", js.Any.fromFunction2((t0: /* object1 */ GameObjectWithBody, t1: /* object2 */ GameObjectWithBody) => (value(t0, t1)).runNow()))
      ...
      inline def setProcessCallback(value: (/* object1 */ GameObjectWithBody, /* object2 */ GameObjectWithBody) => Callback): Self = StObject.set(x, "processCallback", js.Any.fromFunction2((t0: /* object1 */ GameObjectWithBody, t1: /* object2 */ GameObjectWithBody) => (value(t0, t1)).runNow()))
  ...
  trait Factory extends StObject {
    ...
    /**
      ...
      */
    def collider(
      object1: GameObject | (js.Array[GameObject | typingsJapgolly.phaser.Phaser.GameObjects.Group]) | typingsJapgolly.phaser.Phaser.GameObjects.Group,
      object2: GameObject | (js.Array[GameObject | typingsJapgolly.phaser.Phaser.GameObjects.Group]) | typingsJapgolly.phaser.Phaser.GameObjects.Group,
  ...
  trait Group
    extends StObject
       with typingsJapgolly.phaser.Phaser.GameObjects.Group {
  ...
  - typingsJapgolly.phaser.Phaser.GameObjects.Components.Texture because var conflicts: frame, texture. Inlined  */ @js.native
  trait Image
    extends StObject
  ...
  trait World
    ...
    def disable(`object`: js.Array[GameObject | typingsJapgolly.phaser.Phaser.GameObjects.Group]): Unit = js.native
    /**
    ...
    def disable(`object`: typingsJapgolly.phaser.Phaser.GameObjects.Group): Unit = js.native
    ...
    def enable(`object`: js.Array[GameObject | typingsJapgolly.phaser.Phaser.GameObjects.Group]): Unit = js.native
    def enable(`object`: js.Array[GameObject | typingsJapgolly.phaser.Phaser.GameObjects.Group], bodyType: Double): Unit = js.native
    /**
    ...
    def enable(`object`: typingsJapgolly.phaser.Phaser.GameObjects.Group): Unit = js.native
    def enable(`object`: typingsJapgolly.phaser.Phaser.GameObjects.Group, bodyType: Double): Unit = js.native
