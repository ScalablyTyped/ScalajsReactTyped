...
import typingsJapgolly.phaser.Phaser.Core.Config
...
import typingsJapgolly.phaser.Phaser.Input.Keyboard.KeyboardManager
import typingsJapgolly.phaser.Phaser.Input.Mouse.MouseManager
import typingsJapgolly.phaser.Phaser.Input.Touch.TouchManager
