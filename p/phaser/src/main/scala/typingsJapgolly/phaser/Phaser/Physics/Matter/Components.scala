...
object Components {
  ...
  object Sensor {
    ...
    inline def apply(isSensor: CallbackTo[Boolean], setSensor: Boolean => GameObject): Sensor = {
      val __obj = js.Dynamic.literal(isSensor = isSensor.toJsFn, setSensor = js.Any.fromFunction1(setSensor))
  ...
  object Static {
    ...
    inline def apply(isStatic: CallbackTo[Boolean], setStatic: Boolean => GameObject): Static = {
      val __obj = js.Dynamic.literal(isStatic = isStatic.toJsFn, setStatic = js.Any.fromFunction1(setStatic))
      __obj.asInstanceOf[Static]
    }
    
    extension [Self <: Static](x: Self) {
      
      inline def setIsStatic(value: CallbackTo[Boolean]): Self = StObject.set(x, "isStatic", value.toJsFn)
