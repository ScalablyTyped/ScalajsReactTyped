...
class Mesh protected ()
  ...
  /**
    ...
    */
  var alphas: scala.scalajs.js.typedarray.Float32Array = js.native
  /**
    * An array containing the color data for this Mesh.
    */
  var colors: scala.scalajs.js.typedarray.Uint32Array = js.native
  /**
  ...
  /**
    ...
    */
  var uv: scala.scalajs.js.typedarray.Float32Array = js.native
  /**
