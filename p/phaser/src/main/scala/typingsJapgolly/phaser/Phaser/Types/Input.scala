...
import typingsJapgolly.phaser.Phaser.GameObjects.Shape
import typingsJapgolly.phaser.Phaser.Input.Keyboard.Key
import typingsJapgolly.phaser.phaserInts.`0`
import typingsJapgolly.phaser.phaserInts.`1`
import typingsJapgolly.phaser.phaserInts.`2`
...
object Input {
  ...
  object InteractiveObject {
    ...
    inline def apply(
      ...
      hitArea: Any,
      hitAreaCallback: (/* hitArea */ Any, /* x */ Double, /* y */ Double, /* gameObject */ GameObject) => Callback,
      hitAreaDebug: Shape,
      localX: Double,
      localY: Double,
      target: GameObject
    ): InteractiveObject = {
      val __obj = js.Dynamic.literal(alwaysEnabled = alwaysEnabled.asInstanceOf[js.Any], camera = camera.asInstanceOf[js.Any], cursor = cursor.asInstanceOf[js.Any], customHitArea = customHitArea.asInstanceOf[js.Any], dragStartX = dragStartX.asInstanceOf[js.Any], dragStartXGlobal = dragStartXGlobal.asInstanceOf[js.Any], dragStartY = dragStartY.asInstanceOf[js.Any], dragStartYGlobal = dragStartYGlobal.asInstanceOf[js.Any], dragState = dragState.asInstanceOf[js.Any], dragX = dragX.asInstanceOf[js.Any], dragY = dragY.asInstanceOf[js.Any], draggable = draggable.asInstanceOf[js.Any], dropZone = dropZone.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any], gameObject = gameObject.asInstanceOf[js.Any], hitArea = hitArea.asInstanceOf[js.Any], hitAreaCallback = js.Any.fromFunction4((t0: /* hitArea */ Any, t1: /* x */ Double, t2: /* y */ Double, t3: /* gameObject */ GameObject) => (hitAreaCallback(t0, t1, t2, t3)).runNow()), hitAreaDebug = hitAreaDebug.asInstanceOf[js.Any], localX = localX.asInstanceOf[js.Any], localY = localY.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any])
