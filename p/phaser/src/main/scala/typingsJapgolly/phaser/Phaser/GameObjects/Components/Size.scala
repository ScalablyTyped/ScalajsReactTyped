...
object Size {
  ...
  def apply(
    ...
    displayWidth: Double,
    height: Double,
    setDisplaySize: (Double, Double) => CallbackTo[Size],
    setSize: (Double, Double) => CallbackTo[Size],
    setSizeToFrame: Frame => CallbackTo[Size],
    width: Double
  ): Size = {
    ...
    __obj.updateDynamic("setSizeToFrame")(js.Any.fromFunction1((t0: typingsJapgolly.phaser.Phaser.Textures.Frame) => setSizeToFrame(t0).runNow()))
