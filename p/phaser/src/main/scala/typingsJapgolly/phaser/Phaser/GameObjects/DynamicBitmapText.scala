...
import typingsJapgolly.phaser.Phaser.Types.GameObjects.BitmapText.DisplayCallback
import typingsJapgolly.phaser.Phaser.Types.GameObjects.BitmapText.DisplayCallbackConfig
