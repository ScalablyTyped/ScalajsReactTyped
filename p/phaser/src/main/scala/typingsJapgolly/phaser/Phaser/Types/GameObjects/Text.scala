  ...
  object TextWordWrap {
    ...
    extension [Self <: TextWordWrap](x: Self) {
      ...
      inline def setCallback(
        value: (/* text */ String, /* textObject */ typingsJapgolly.phaser.Phaser.GameObjects.Text) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* text */ String, t1: /* textObject */ typingsJapgolly.phaser.Phaser.GameObjects.Text) => (value(t0, t1)).runNow()))
