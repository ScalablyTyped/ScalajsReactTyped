...
import typingsJapgolly.phaser.Phaser.Tweens.Timeline
...
object TimelineBuilderConfig {
  ...
  def apply(
    ...
    onComplete: (/* timeline */ Timeline, /* repeated */ js.Any) => Callback = null,
    onCompleteParams: js.Array[_] = null,
    onCompleteScope: js.Any = null,
    onLoop: (/* timeline */ Timeline, /* repeated */ js.Any) => Callback = null,
    onLoopParams: js.Array[_] = null,
    onLoopScope: js.Any = null,
    onStart: (/* timeline */ Timeline, /* repeated */ js.Any) => Callback = null,
    onStartParams: js.Array[_] = null,
    onStartScope: js.Any = null,
    onUpdate: (/* timeline */ Timeline, /* repeated */ js.Any) => Callback = null,
    onUpdateParams: js.Array[_] = null,
    onUpdateScope: js.Any = null,
    onYoyo: (/* timeline */ Timeline, /* repeated */ js.Any) => Callback = null,
    ...
    if (onComplete != null) __obj.updateDynamic("onComplete")(js.Any.fromFunction2((t0: /* timeline */ typingsJapgolly.phaser.Phaser.Tweens.Timeline, t1: /* repeated */ js.Any) => onComplete(t0, t1).runNow()))
    ...
    if (onLoop != null) __obj.updateDynamic("onLoop")(js.Any.fromFunction2((t0: /* timeline */ typingsJapgolly.phaser.Phaser.Tweens.Timeline, t1: /* repeated */ js.Any) => onLoop(t0, t1).runNow()))
    ...
    if (onStart != null) __obj.updateDynamic("onStart")(js.Any.fromFunction2((t0: /* timeline */ typingsJapgolly.phaser.Phaser.Tweens.Timeline, t1: /* repeated */ js.Any) => onStart(t0, t1).runNow()))
    ...
    if (onUpdate != null) __obj.updateDynamic("onUpdate")(js.Any.fromFunction2((t0: /* timeline */ typingsJapgolly.phaser.Phaser.Tweens.Timeline, t1: /* repeated */ js.Any) => onUpdate(t0, t1).runNow()))
    ...
    if (onYoyo != null) __obj.updateDynamic("onYoyo")(js.Any.fromFunction2((t0: /* timeline */ typingsJapgolly.phaser.Phaser.Tweens.Timeline, t1: /* repeated */ js.Any) => onYoyo(t0, t1).runNow()))
