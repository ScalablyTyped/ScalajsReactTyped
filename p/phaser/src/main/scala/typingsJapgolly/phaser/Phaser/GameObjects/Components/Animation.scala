...
trait Animation extends js.Object {
  ...
  /**
    ...
    */
  var currentAnim: typingsJapgolly.phaser.Phaser.Animations.Animation = js.native
  /**
  ...
  def chain(key: typingsJapgolly.phaser.Phaser.Animations.Animation): GameObject = js.native
  /**
  ...
  def play(key: typingsJapgolly.phaser.Phaser.Animations.Animation): GameObject = js.native
  def play(key: typingsJapgolly.phaser.Phaser.Animations.Animation, ignoreIfPlaying: Boolean): GameObject = js.native
  def play(
    key: typingsJapgolly.phaser.Phaser.Animations.Animation,
  ...
  def playReverse(key: typingsJapgolly.phaser.Phaser.Animations.Animation): GameObject = js.native
  def playReverse(key: typingsJapgolly.phaser.Phaser.Animations.Animation, ignoreIfPlaying: Boolean): GameObject = js.native
  def playReverse(
    key: typingsJapgolly.phaser.Phaser.Animations.Animation,
    ignoreIfPlaying: Boolean,
    startFrame: integer
  ...
  def remove(key: String, animation: typingsJapgolly.phaser.Phaser.Animations.Animation): Unit = js.native
  /**
