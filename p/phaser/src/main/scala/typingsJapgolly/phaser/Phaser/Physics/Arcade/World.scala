...
import typingsJapgolly.phaser.Phaser.Tilemaps.DynamicTilemapLayer
import typingsJapgolly.phaser.Phaser.Tilemaps.StaticTilemapLayer
...
class World protected () extends EventEmitter {
  ...
  def enable(
    `object`: js.Array[GameObject | typingsJapgolly.phaser.Phaser.GameObjects.Group],
    bodyType: integer
  ): Unit = js.native
  /**
  ...
  def enable(`object`: typingsJapgolly.phaser.Phaser.GameObjects.Group, bodyType: integer): Unit = js.native
  /**
