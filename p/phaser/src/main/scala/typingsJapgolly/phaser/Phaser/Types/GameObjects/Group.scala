...
import typingsJapgolly.phaser.Phaser.Types.Actions.GridAlignConfig
...
object Group {
  ...
  object GroupConfig {
    ...
    extension [Self <: GroupConfig](x: Self) {
      ...
      inline def setCreateCallback(value: /* item */ GameObject => Callback): Self = StObject.set(x, "createCallback", js.Any.fromFunction1((t0: /* item */ GameObject) => value(t0).runNow()))
      
      inline def setCreateCallbackUndefined: Self = StObject.set(x, "createCallback", js.undefined)
      
      inline def setCreateMultipleCallback(value: /* items */ js.Array[GameObject] => Callback): Self = StObject.set(x, "createMultipleCallback", js.Any.fromFunction1((t0: /* items */ js.Array[GameObject]) => value(t0).runNow()))
      ...
      inline def setRemoveCallback(value: /* item */ GameObject => Callback): Self = StObject.set(x, "removeCallback", js.Any.fromFunction1((t0: /* item */ GameObject) => value(t0).runNow()))
  ...
  object GroupCreateConfig {
    ...
    extension [Self <: GroupCreateConfig](x: Self) {
      ...
      inline def setHitAreaCallback(
        value: (/* hitArea */ Any, /* x */ Double, /* y */ Double, /* gameObject */ GameObject) => Callback
      ): Self = StObject.set(x, "hitAreaCallback", js.Any.fromFunction4((t0: /* hitArea */ Any, t1: /* x */ Double, t2: /* y */ Double, t3: /* gameObject */ GameObject) => (value(t0, t1, t2, t3)).runNow()))
