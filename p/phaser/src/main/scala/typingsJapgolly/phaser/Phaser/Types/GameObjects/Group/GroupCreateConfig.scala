...
object GroupCreateConfig {
  ...
  def apply(
    ...
    hitArea: js.Any = null,
    hitAreaCallback: (/* hitArea */ js.Any, /* x */ Double, /* y */ Double, /* gameObject */ GameObject) => Callback = null,
    ...
    if (hitAreaCallback != null) __obj.updateDynamic("hitAreaCallback")(js.Any.fromFunction4((t0: /* hitArea */ js.Any, t1: /* x */ scala.Double, t2: /* y */ scala.Double, t3: /* gameObject */ typingsJapgolly.phaser.Phaser.GameObjects.GameObject) => hitAreaCallback(t0, t1, t2, t3).runNow()))
