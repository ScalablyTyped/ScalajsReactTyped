...
import typingsJapgolly.phaser.Phaser.Input.Gamepad.GamepadPlugin
import typingsJapgolly.phaser.Phaser.Input.Keyboard.KeyboardPlugin
import typingsJapgolly.phaser.Phaser.Input.Mouse.MouseManager
