...
object Sound {
  ...
  trait HTML5AudioSound
    ...
    /**
      ...
      * @param time The current timestamp as generated by the Request Animation Frame or SetTimeout.
      */
    /* protected */ def update(time: Double): Unit = js.native
