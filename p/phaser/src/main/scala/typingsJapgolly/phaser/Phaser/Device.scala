...
object Device {
  ...
  object Input {
    ...
    inline def apply(gamepads: Boolean, mspointer: Boolean, touch: Boolean, wheelType: String): typingsJapgolly.phaser.Phaser.Device.Input = {
      ...
      __obj.asInstanceOf[typingsJapgolly.phaser.Phaser.Device.Input]
    }
    
    extension [Self <: typingsJapgolly.phaser.Phaser.Device.Input](x: Self) {
