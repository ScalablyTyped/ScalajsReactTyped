...
object Cache {
  ...
  object BaseCache {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction2(add), destroy = destroy.toJsFn, entries = entries.asInstanceOf[js.Any], events = events.asInstanceOf[js.Any], exists = js.Any.fromFunction1(exists), get = js.Any.fromFunction1(get), getKeys = getKeys.toJsFn, has = js.Any.fromFunction1(has), remove = js.Any.fromFunction1(remove))
