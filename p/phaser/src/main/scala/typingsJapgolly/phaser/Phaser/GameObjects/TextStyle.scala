...
class TextStyle protected () extends js.Object {
  /**
    ...
    */
  def this(text: Text, style: typingsJapgolly.phaser.Phaser.Types.GameObjects.Text.TextStyle) = this()
  /**
    * The text alignment.
    */
  ...
  /**
    ...
    */
  def setStyle(style: typingsJapgolly.phaser.Phaser.Types.GameObjects.Text.TextStyle): Text = js.native
  def setStyle(style: typingsJapgolly.phaser.Phaser.Types.GameObjects.Text.TextStyle, updateText: Boolean): Text = js.native
  def setStyle(
