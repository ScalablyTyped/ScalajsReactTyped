...
object Create {
  ...
  object GenerateTextureConfig {
    ...
    extension [Self <: GenerateTextureConfig](x: Self) {
      ...
      inline def setPostRender(value: (/* canvas */ HTMLCanvasElement, /* context */ CanvasRenderingContext2D) => Callback): Self = StObject.set(x, "postRender", js.Any.fromFunction2((t0: /* canvas */ HTMLCanvasElement, t1: /* context */ CanvasRenderingContext2D) => (value(t0, t1)).runNow()))
      
      inline def setPostRenderUndefined: Self = StObject.set(x, "postRender", js.undefined)
      
      inline def setPreRender(value: (/* canvas */ HTMLCanvasElement, /* context */ CanvasRenderingContext2D) => Callback): Self = StObject.set(x, "preRender", js.Any.fromFunction2((t0: /* canvas */ HTMLCanvasElement, t1: /* context */ CanvasRenderingContext2D) => (value(t0, t1)).runNow()))
