...
import typingsJapgolly.phaser.Phaser.Types.Core.GameConfig
...
object Scale {
  ...
  object ScaleModes extends StObject {
    ...
    sealed trait ENVELOP
      extends StObject
         with typingsJapgolly.phaser.Phaser.Scale.ScaleModes
  ...
  /**
    ...
    */
  type ScaleModeType = typingsJapgolly.phaser.Phaser.Scale.ScaleModes
