package typingsJapgolly.phaser.Phaser.Scale
...
object ScaleModes extends js.Object {
  ...
  /* 4 */ @js.native
  object ENVELOP
    extends TopLevel[typingsJapgolly.phaser.Phaser.Scale.ScaleModes.ENVELOP with Double]
  
  /* 3 */ @js.native
  object FIT
    extends TopLevel[typingsJapgolly.phaser.Phaser.Scale.ScaleModes.FIT with Double]
  
  /* 2 */ @js.native
  object HEIGHT_CONTROLS_WIDTH
    extends TopLevel[typingsJapgolly.phaser.Phaser.Scale.ScaleModes.HEIGHT_CONTROLS_WIDTH with Double]
  
  /* 0 */ @js.native
  object NONE
    extends TopLevel[typingsJapgolly.phaser.Phaser.Scale.ScaleModes.NONE with Double]
  
  /* 5 */ @js.native
  object RESIZE
    extends TopLevel[typingsJapgolly.phaser.Phaser.Scale.ScaleModes.RESIZE with Double]
  
  /* 1 */ @js.native
  object WIDTH_CONTROLS_HEIGHT
    extends TopLevel[typingsJapgolly.phaser.Phaser.Scale.ScaleModes.WIDTH_CONTROLS_HEIGHT with Double]
