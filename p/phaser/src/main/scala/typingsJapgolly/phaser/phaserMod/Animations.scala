...
object Animations extends js.Object {
  ...
  class Animation protected ()
    extends typingsJapgolly.phaser.Phaser.Animations.Animation {
    /**
      * 
  ...
  class AnimationFrame protected ()
    extends typingsJapgolly.phaser.Phaser.Animations.AnimationFrame {
    /**
      * 
  ...
  class AnimationManager protected ()
    extends typingsJapgolly.phaser.Phaser.Animations.AnimationManager {
    /**
      * 
