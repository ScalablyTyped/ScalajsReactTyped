...
object Structs extends js.Object {
  ...
  class List[T] protected ()
    extends typingsJapgolly.phaser.Phaser.Structs.List[T] {
    /**
      * 
  ...
  class Map[K, V] protected ()
    extends typingsJapgolly.phaser.Phaser.Structs.Map[K, V] {
    /**
      * 
  ...
  class ProcessQueue[T] ()
    extends typingsJapgolly.phaser.Phaser.Structs.ProcessQueue[T]
  ...
  @js.native
  class RTree ()
    extends typingsJapgolly.phaser.Phaser.Structs.RTree
  ...
  /**
    ...
    */
  class Set[T] ()
    extends typingsJapgolly.phaser.Phaser.Structs.Set[T] {
  ...
  /**
    ...
    */
  class Size ()
    extends typingsJapgolly.phaser.Phaser.Structs.Size {
