...
object Renderer extends js.Object {
  ...
  object Canvas extends js.Object {
    ...
    class CanvasRenderer protected ()
      extends typingsJapgolly.phaser.Phaser.Renderer.Canvas.CanvasRenderer {
      /**
        * 
  ...
  object WebGL extends js.Object {
    ...
    class WebGLPipeline protected ()
      extends typingsJapgolly.phaser.Phaser.Renderer.WebGL.WebGLPipeline {
      /**
        * 
    ...
    class WebGLRenderer protected ()
      extends typingsJapgolly.phaser.Phaser.Renderer.WebGL.WebGLRenderer {
      /**
        * 
    ...
    object Pipelines extends js.Object {
      ...
      class BitmapMaskPipeline protected ()
        extends typingsJapgolly.phaser.Phaser.Renderer.WebGL.Pipelines.BitmapMaskPipeline {
        /**
          * 
      ...
      class ForwardDiffuseLightPipeline protected ()
        extends typingsJapgolly.phaser.Phaser.Renderer.WebGL.Pipelines.ForwardDiffuseLightPipeline {
        /**
          * 
      ...
      class TextureTintPipeline protected ()
        extends typingsJapgolly.phaser.Phaser.Renderer.WebGL.Pipelines.TextureTintPipeline {
        /**
          * 
