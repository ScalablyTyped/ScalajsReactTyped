...
import typingsJapgolly.phaser.ContentLoadedCallback
...
object DOM extends js.Object {
  ...
  class RequestAnimationFrame ()
    extends typingsJapgolly.phaser.Phaser.DOM.RequestAnimationFrame
  ...
  def AddToDOM(element: HTMLElement, parent: typingsJapgolly.std.HTMLElement): HTMLElement = js.native
  /**
