...
object Sound extends js.Object {
  ...
  class BaseSound protected ()
    extends typingsJapgolly.phaser.Phaser.Sound.BaseSound {
    /**
      * 
  ...
  class BaseSoundManager protected ()
    extends typingsJapgolly.phaser.Phaser.Sound.BaseSoundManager {
    /**
      * 
  ...
  class HTML5AudioSound protected ()
    extends typingsJapgolly.phaser.Phaser.Sound.HTML5AudioSound {
    /**
      * 
      * @param manager Reference to the current sound manager instance.
      * @param key Asset key for the sound.
  ...
  class HTML5AudioSoundManager protected ()
    extends typingsJapgolly.phaser.Phaser.Sound.HTML5AudioSoundManager {
    /**
      * 
      * @param game Reference to the current game instance.
      */
  ...
  class NoAudioSound protected ()
    extends typingsJapgolly.phaser.Phaser.Sound.NoAudioSound {
    /**
      * 
      * @param manager Reference to the current sound manager instance.
      * @param key Asset key for the sound.
  ...
  class NoAudioSoundManager protected ()
    extends typingsJapgolly.phaser.Phaser.Sound.NoAudioSoundManager {
    /**
      * 
      * @param game Reference to the current game instance.
      */
  ...
  class WebAudioSound protected ()
    extends typingsJapgolly.phaser.Phaser.Sound.WebAudioSound {
    /**
      * 
      * @param manager Reference to the current sound manager instance.
      * @param key Asset key for the sound.
  ...
  class WebAudioSoundManager protected ()
    extends typingsJapgolly.phaser.Phaser.Sound.WebAudioSoundManager {
    /**
      * 
      * @param game Reference to the current game instance.
      */
  ...
  /**
    ...
    * @param game Reference to the current game instance.
    */
  def SoundManagerCreator(game: typingsJapgolly.phaser.Phaser.Game): typingsJapgolly.phaser.Phaser.Sound.HTML5AudioSoundManager | typingsJapgolly.phaser.Phaser.Sound.WebAudioSoundManager | typingsJapgolly.phaser.Phaser.Sound.NoAudioSoundManager = js.native
  @js.native
