...
object Textures extends js.Object {
  ...
  class CanvasTexture protected ()
    extends typingsJapgolly.phaser.Phaser.Textures.CanvasTexture {
    /**
      * 
      ...
      */
    def this(
      manager: typingsJapgolly.phaser.Phaser.Textures.TextureManager,
      key: String,
  ...
  class Frame protected ()
    extends typingsJapgolly.phaser.Phaser.Textures.Frame {
    def this(
  ...
  class Texture protected ()
    extends typingsJapgolly.phaser.Phaser.Textures.Texture {
    def this(
      manager: typingsJapgolly.phaser.Phaser.Textures.TextureManager,
      key: String,
  ...
  class TextureManager protected ()
    extends typingsJapgolly.phaser.Phaser.Textures.TextureManager {
    /**
      * 
  ...
  class TextureSource protected ()
    extends typingsJapgolly.phaser.Phaser.Textures.TextureSource {
    def this(texture: typingsJapgolly.phaser.Phaser.Textures.Texture, source: RenderTexture) = this()
    def this(texture: typingsJapgolly.phaser.Phaser.Textures.Texture, source: HTMLCanvasElement) = this()
    /**
      * 
      ...
      */
    def this(texture: typingsJapgolly.phaser.Phaser.Textures.Texture, source: HTMLImageElement) = this()
    def this(texture: typingsJapgolly.phaser.Phaser.Textures.Texture, source: HTMLVideoElement) = this()
    def this(texture: typingsJapgolly.phaser.Phaser.Textures.Texture, source: WebGLTexture) = this()
    def this(texture: typingsJapgolly.phaser.Phaser.Textures.Texture, source: RenderTexture, width: integer) = this()
    def this(texture: typingsJapgolly.phaser.Phaser.Textures.Texture, source: HTMLCanvasElement, width: integer) = this()
    def this(texture: typingsJapgolly.phaser.Phaser.Textures.Texture, source: HTMLImageElement, width: integer) = this()
    def this(texture: typingsJapgolly.phaser.Phaser.Textures.Texture, source: HTMLVideoElement, width: integer) = this()
    def this(texture: typingsJapgolly.phaser.Phaser.Textures.Texture, source: WebGLTexture, width: integer) = this()
    def this(
      texture: typingsJapgolly.phaser.Phaser.Textures.Texture,
  ...
  object FilterMode extends js.Object {
    /* 0 */ val LINEAR: typingsJapgolly.phaser.Phaser.Textures.FilterMode.LINEAR with Double = js.native
    /* 1 */ val NEAREST: typingsJapgolly.phaser.Phaser.Textures.FilterMode.NEAREST with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.phaser.Phaser.Textures.FilterMode with Double] = js.native
  }
