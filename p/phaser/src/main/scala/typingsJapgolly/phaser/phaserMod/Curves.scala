...
object Curves extends js.Object {
  ...
  class CubicBezier protected ()
    extends typingsJapgolly.phaser.Phaser.Curves.CubicBezier {
  ...
  class Curve protected ()
    extends typingsJapgolly.phaser.Phaser.Curves.Curve {
    /**
      * 
  ...
  class Ellipse protected ()
    extends typingsJapgolly.phaser.Phaser.Curves.Ellipse {
    /**
      * 
  ...
  class Line protected ()
    extends typingsJapgolly.phaser.Phaser.Curves.Line {
  ...
  /**
    ...
    */
  class MoveTo ()
    extends typingsJapgolly.phaser.Phaser.Curves.MoveTo {
  ...
  /**
    ...
    */
  class Path ()
    extends typingsJapgolly.phaser.Phaser.Curves.Path {
    def this(x: Double) = this()
    def this(x: Double, y: Double) = this()
  }
  ...
  class QuadraticBezier protected ()
    extends typingsJapgolly.phaser.Phaser.Curves.QuadraticBezier {
  ...
  /**
    ...
    */
  class Spline ()
    extends typingsJapgolly.phaser.Phaser.Curves.Spline {
  ...
  object CubicBezier extends js.Object {
    /**
      ...
      */
    def fromJSON(data: JSONCurve): typingsJapgolly.phaser.Phaser.Curves.CubicBezier = js.native
  }
  ...
  object Ellipse extends js.Object {
    /**
      ...
      * @param data The JSON object containing this curve data.
      */
    def fromJSON(data: JSONEllipseCurve): typingsJapgolly.phaser.Phaser.Curves.Ellipse = js.native
  }
  ...
  object Line extends js.Object {
    /**
      ...
      * @param data The JSON object containing this curve data.
      */
    def fromJSON(data: JSONCurve): typingsJapgolly.phaser.Phaser.Curves.Line = js.native
  }
  ...
  object QuadraticBezier extends js.Object {
    /**
      ...
      * @param data The JSON object containing this curve data.
      */
    def fromJSON(data: JSONCurve): typingsJapgolly.phaser.Phaser.Curves.QuadraticBezier = js.native
  }
  ...
  object Spline extends js.Object {
    /**
      ...
      * @param data The JSON object containing this curve data.
      */
    def fromJSON(data: JSONCurve): typingsJapgolly.phaser.Phaser.Curves.Spline = js.native
  }
