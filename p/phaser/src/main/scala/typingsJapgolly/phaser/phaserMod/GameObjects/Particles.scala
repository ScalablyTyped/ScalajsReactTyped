...
object Particles extends js.Object {
  ...
  class EmitterOp protected ()
    extends typingsJapgolly.phaser.Phaser.GameObjects.Particles.EmitterOp {
    /**
      * 
  ...
  /**
    ...
    */
  class GravityWell ()
    extends typingsJapgolly.phaser.Phaser.GameObjects.Particles.GravityWell {
  ...
  class Particle protected ()
    extends typingsJapgolly.phaser.Phaser.GameObjects.Particles.Particle {
    /**
      * 
  ...
  class ParticleEmitter protected ()
    extends typingsJapgolly.phaser.Phaser.GameObjects.Particles.ParticleEmitter {
    /**
      * 
  ...
  class ParticleEmitterManager protected ()
    extends typingsJapgolly.phaser.Phaser.GameObjects.Particles.ParticleEmitterManager {
    /**
      * 
  ...
  object Zones extends js.Object {
    ...
    class DeathZone protected ()
      extends typingsJapgolly.phaser.Phaser.GameObjects.Particles.Zones.DeathZone {
      /**
        * 
    ...
    class EdgeZone protected ()
      extends typingsJapgolly.phaser.Phaser.GameObjects.Particles.Zones.EdgeZone {
      /**
        * 
    ...
    class RandomZone protected ()
      extends typingsJapgolly.phaser.Phaser.GameObjects.Particles.Zones.RandomZone {
      /**
        * 
