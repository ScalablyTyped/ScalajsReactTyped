...
object Cameras extends js.Object {
  ...
  object Controls extends js.Object {
    ...
    class FixedKeyControl protected ()
      extends typingsJapgolly.phaser.Phaser.Cameras.Controls.FixedKeyControl {
      /**
        * 
    ...
    class SmoothedKeyControl protected ()
      extends typingsJapgolly.phaser.Phaser.Cameras.Controls.SmoothedKeyControl {
      /**
        * 
  ...
  object Scene2D extends js.Object {
    ...
    class BaseCamera protected ()
      extends typingsJapgolly.phaser.Phaser.Cameras.Scene2D.BaseCamera {
      /**
        * 
    ...
    class Camera protected ()
      extends typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Camera {
      /**
        * 
        * @param x The x position of the Camera, relative to the top-left of the game canvas.
        * @param y The y position of the Camera, relative to the top-left of the game canvas.
    ...
    class CameraManager protected ()
      extends typingsJapgolly.phaser.Phaser.Cameras.Scene2D.CameraManager {
      /**
        * 
    ...
    object Effects extends js.Object {
      ...
      class Fade protected ()
        extends typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.Fade {
        /**
          * 
      ...
      class Flash protected ()
        extends typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.Flash {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      @js.native
      class Pan protected ()
        extends typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.Pan {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      class Shake protected ()
        extends typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.Shake {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      class Zoom protected ()
        extends typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.Zoom {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
