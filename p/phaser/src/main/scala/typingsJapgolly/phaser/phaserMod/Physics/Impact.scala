...
object Impact extends js.Object {
  ...
  class Body protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Impact.Body {
    /**
      * 
      ...
      */
    def this(world: typingsJapgolly.phaser.Phaser.Physics.Impact.World, x: Double, y: Double) = this()
    def this(world: typingsJapgolly.phaser.Phaser.Physics.Impact.World, x: Double, y: Double, sx: Double) = this()
    def this(
      world: typingsJapgolly.phaser.Phaser.Physics.Impact.World,
      x: Double,
      y: Double,
      sx: Double,
      sy: Double
  ...
  /**
    ...
    */
  class CollisionMap ()
    extends typingsJapgolly.phaser.Phaser.Physics.Impact.CollisionMap {
  ...
  class Factory protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Impact.Factory {
    /**
      * 
      * @param world A reference to the Impact Physics world.
      */
    def this(world: typingsJapgolly.phaser.Phaser.Physics.Impact.World) = this()
  }
  ...
  class ImpactBody protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Impact.ImpactBody {
    /**
      * 
      * @param world [description]
  ...
  class ImpactImage protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Impact.ImpactImage {
    /**
      * 
      ...
      */
    def this(world: typingsJapgolly.phaser.Phaser.Physics.Impact.World, x: Double, y: Double, texture: String) = this()
    def this(
      world: typingsJapgolly.phaser.Phaser.Physics.Impact.World,
      x: Double,
      y: Double,
  ...
  class ImpactPhysics protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Impact.ImpactPhysics {
    /**
      * 
  ...
  class ImpactSprite protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Impact.ImpactSprite {
    /**
      * 
      * @param world [description]
      * @param x The horizontal position of this Game Object in the world.
  ...
  class World protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Impact.World {
    /**
      * 
  ...
  def SeparateX(
    world: typingsJapgolly.phaser.Phaser.Physics.Impact.World,
    left: typingsJapgolly.phaser.Phaser.Physics.Impact.Body,
    right: typingsJapgolly.phaser.Phaser.Physics.Impact.Body
  ): Unit = js.native
  def SeparateX(
    world: typingsJapgolly.phaser.Phaser.Physics.Impact.World,
    left: typingsJapgolly.phaser.Phaser.Physics.Impact.Body,
    right: typingsJapgolly.phaser.Phaser.Physics.Impact.Body,
    weak: typingsJapgolly.phaser.Phaser.Physics.Impact.Body
  ): Unit = js.native
  /**
    * [description]
    * @param world [description]
  ...
  def SeparateY(
    world: typingsJapgolly.phaser.Phaser.Physics.Impact.World,
    top: typingsJapgolly.phaser.Phaser.Physics.Impact.Body,
    bottom: typingsJapgolly.phaser.Phaser.Physics.Impact.Body
  ): Unit = js.native
  def SeparateY(
    world: typingsJapgolly.phaser.Phaser.Physics.Impact.World,
    top: typingsJapgolly.phaser.Phaser.Physics.Impact.Body,
  ...
  def Solver(
    world: typingsJapgolly.phaser.Phaser.Physics.Impact.World,
    bodyA: typingsJapgolly.phaser.Phaser.Physics.Impact.Body,
    bodyB: typingsJapgolly.phaser.Phaser.Physics.Impact.Body
  ): Unit = js.native
  /**
    ...
    */
  def UpdateMotion(body: typingsJapgolly.phaser.Phaser.Physics.Impact.Body, res: js.Object): Unit = js.native
  /**
  ...
  object COLLIDES extends js.Object {
    /* 3 */ val ACTIVE: typingsJapgolly.phaser.Phaser.Physics.Impact.COLLIDES.ACTIVE with Double = js.native
    /* 4 */ val FIXED: typingsJapgolly.phaser.Phaser.Physics.Impact.COLLIDES.FIXED with Double = js.native
    /* 1 */ val LITE: typingsJapgolly.phaser.Phaser.Physics.Impact.COLLIDES.LITE with Double = js.native
    /* 0 */ val NEVER: typingsJapgolly.phaser.Phaser.Physics.Impact.COLLIDES.NEVER with Double = js.native
    /* 2 */ val PASSIVE: typingsJapgolly.phaser.Phaser.Physics.Impact.COLLIDES.PASSIVE with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.phaser.Phaser.Physics.Impact.COLLIDES with Double] = js.native
  }
  ...
  object TYPE extends js.Object {
    /* 1 */ val A: typingsJapgolly.phaser.Phaser.Physics.Impact.TYPE.A with Double = js.native
    /* 2 */ val B: typingsJapgolly.phaser.Phaser.Physics.Impact.TYPE.B with Double = js.native
    /* 3 */ val BOTH: typingsJapgolly.phaser.Phaser.Physics.Impact.TYPE.BOTH with Double = js.native
    /* 0 */ val NONE: typingsJapgolly.phaser.Phaser.Physics.Impact.TYPE.NONE with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.phaser.Phaser.Physics.Impact.TYPE with Double] = js.native
  }
