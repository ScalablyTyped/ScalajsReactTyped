package typingsJapgolly.phaser.phaserMod.Input
...
object Keyboard extends js.Object {
  ...
  @js.native
  class Key protected ()
    extends typingsJapgolly.phaser.Phaser.Input.Keyboard.Key {
    /**
      * 
      * @param plugin The Keyboard Plugin instance that owns this Key object.
      * @param keyCode The keycode of this key.
      */
    def this(plugin: typingsJapgolly.phaser.Phaser.Input.Keyboard.KeyboardPlugin, keyCode: integer) = this()
  }
  ...
  class KeyCombo protected ()
    extends typingsJapgolly.phaser.Phaser.Input.Keyboard.KeyCombo {
    /**
      * 
  ...
  class KeyboardManager protected ()
    extends typingsJapgolly.phaser.Phaser.Input.Keyboard.KeyboardManager {
    /**
      * 
  ...
  class KeyboardPlugin protected ()
    extends typingsJapgolly.phaser.Phaser.Input.Keyboard.KeyboardPlugin {
    /**
      * 
  ...
  /**
    ...
    */
  def DownDuration(key: typingsJapgolly.phaser.Phaser.Input.Keyboard.Key): Boolean = js.native
  def DownDuration(key: typingsJapgolly.phaser.Phaser.Input.Keyboard.Key, duration: integer): Boolean = js.native
  /**
    ...
    */
  def JustDown(key: typingsJapgolly.phaser.Phaser.Input.Keyboard.Key): Boolean = js.native
  /**
    ...
    */
  def JustUp(key: typingsJapgolly.phaser.Phaser.Input.Keyboard.Key): Boolean = js.native
  /**
    ...
    */
  def UpDuration(key: typingsJapgolly.phaser.Phaser.Input.Keyboard.Key): Boolean = js.native
  def UpDuration(key: typingsJapgolly.phaser.Phaser.Input.Keyboard.Key, duration: integer): Boolean = js.native
  @js.native
