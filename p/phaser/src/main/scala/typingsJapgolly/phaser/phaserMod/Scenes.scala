...
object Scenes extends js.Object {
  ...
  class SceneManager protected ()
    extends typingsJapgolly.phaser.Phaser.Scenes.SceneManager {
    /**
      * 
  ...
  class ScenePlugin protected ()
    extends typingsJapgolly.phaser.Phaser.Scenes.ScenePlugin {
    /**
      * 
  ...
  class Systems protected ()
    extends typingsJapgolly.phaser.Phaser.Scenes.Systems {
    /**
      * 
  ...
  /**
    ...
    */
  def GetPhysicsPlugins(sys: typingsJapgolly.phaser.Phaser.Scenes.Systems): js.Array[_] = js.native
  /**
    ...
    */
  def GetScenePlugins(sys: typingsJapgolly.phaser.Phaser.Scenes.Systems): js.Array[_] = js.native
  @js.native
