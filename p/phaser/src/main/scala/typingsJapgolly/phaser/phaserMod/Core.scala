...
object Core extends js.Object {
  ...
  /**
    ...
    */
  class Config ()
    extends typingsJapgolly.phaser.Phaser.Core.Config {
  ...
  class TimeStep protected ()
    extends typingsJapgolly.phaser.Phaser.Core.TimeStep {
    /**
      * 
  ...
  /**
    ...
    */
  def CreateRenderer(game: typingsJapgolly.phaser.Phaser.Game): Unit = js.native
  /**
    ...
    */
  def DebugHeader(game: typingsJapgolly.phaser.Phaser.Game): Unit = js.native
  /**
    ...
    */
  def VisibilityHandler(game: typingsJapgolly.phaser.Phaser.Game): Unit = js.native
  @js.native
