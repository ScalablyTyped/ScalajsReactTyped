...
object Plugins extends js.Object {
  ...
  class BasePlugin protected ()
    extends typingsJapgolly.phaser.Phaser.Plugins.BasePlugin {
    /**
      * 
  ...
  class PluginManager protected ()
    extends typingsJapgolly.phaser.Phaser.Plugins.PluginManager {
    /**
      * 
  ...
  class ScenePlugin protected ()
    extends typingsJapgolly.phaser.Phaser.Plugins.ScenePlugin {
    /**
      * 
