...
object Tweens extends js.Object {
  ...
  class Timeline protected ()
    extends typingsJapgolly.phaser.Phaser.Tweens.Timeline {
    /**
      * 
  ...
  class Tween protected ()
    extends typingsJapgolly.phaser.Phaser.Tweens.Tween {
    def this(
  ...
  class TweenManager protected ()
    extends typingsJapgolly.phaser.Phaser.Tweens.TweenManager {
    /**
      * 
  ...
  object Builders extends js.Object {
    ...
    /**
      ...
      */
    def GetTweens(config: TimelineBuilderConfig): js.Array[typingsJapgolly.phaser.Phaser.Tweens.Tween] = js.native
    /**
    ...
    ): typingsJapgolly.phaser.Phaser.Tweens.Tween = js.native
    /**
    ...
    /**
      ...
      * @param config The configuration object for the Timeline.
      */
    def TimelineBuilder(manager: typingsJapgolly.phaser.Phaser.Tweens.TweenManager, config: TimelineBuilderConfig): typingsJapgolly.phaser.Phaser.Tweens.Timeline = js.native
    def TweenBuilder(
      parent: typingsJapgolly.phaser.Phaser.Tweens.Timeline,
      config: js.Object,
      defaults: TweenConfigDefaults
