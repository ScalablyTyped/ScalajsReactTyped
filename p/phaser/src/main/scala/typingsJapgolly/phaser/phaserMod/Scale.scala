...
object Scale extends js.Object {
  ...
  class ScaleManager protected ()
    extends typingsJapgolly.phaser.Phaser.Scale.ScaleManager {
    /**
      * 
  ...
  object Center extends js.Object {
    /* 1 */ val CENTER_BOTH: typingsJapgolly.phaser.Phaser.Scale.Center.CENTER_BOTH with Double = js.native
    /* 2 */ val CENTER_HORIZONTALLY: typingsJapgolly.phaser.Phaser.Scale.Center.CENTER_HORIZONTALLY with Double = js.native
    /* 3 */ val CENTER_VERTICALLY: typingsJapgolly.phaser.Phaser.Scale.Center.CENTER_VERTICALLY with Double = js.native
    /* 0 */ val NO_CENTER: typingsJapgolly.phaser.Phaser.Scale.Center.NO_CENTER with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.phaser.Phaser.Scale.Center with Double] = js.native
  }
  ...
  object Orientation extends js.Object {
    /* 0 */ val LANDSCAPE: typingsJapgolly.phaser.Phaser.Scale.Orientation.LANDSCAPE with Double = js.native
    /* 1 */ val PORTRAIT: typingsJapgolly.phaser.Phaser.Scale.Orientation.PORTRAIT with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.phaser.Phaser.Scale.Orientation with Double] = js.native
  }
  ...
  object ScaleModes extends js.Object {
    /* 4 */ val ENVELOP: typingsJapgolly.phaser.Phaser.Scale.ScaleModes.ENVELOP with Double = js.native
    /* 3 */ val FIT: typingsJapgolly.phaser.Phaser.Scale.ScaleModes.FIT with Double = js.native
    /* 2 */ val HEIGHT_CONTROLS_WIDTH: typingsJapgolly.phaser.Phaser.Scale.ScaleModes.HEIGHT_CONTROLS_WIDTH with Double = js.native
    /* 0 */ val NONE: typingsJapgolly.phaser.Phaser.Scale.ScaleModes.NONE with Double = js.native
    /* 5 */ val RESIZE: typingsJapgolly.phaser.Phaser.Scale.ScaleModes.RESIZE with Double = js.native
    /* 1 */ val WIDTH_CONTROLS_HEIGHT: typingsJapgolly.phaser.Phaser.Scale.ScaleModes.WIDTH_CONTROLS_HEIGHT with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.phaser.Phaser.Scale.ScaleModes with Double] = js.native
  }
  ...
  object Zoom extends js.Object {
    /* 3 */ val MAX_ZOOM: typingsJapgolly.phaser.Phaser.Scale.Zoom.MAX_ZOOM with Double = js.native
    /* 0 */ val NO_ZOOM: typingsJapgolly.phaser.Phaser.Scale.Zoom.NO_ZOOM with Double = js.native
    /* 1 */ val ZOOM_2X: typingsJapgolly.phaser.Phaser.Scale.Zoom.ZOOM_2X with Double = js.native
    /* 2 */ val ZOOM_4X: typingsJapgolly.phaser.Phaser.Scale.Zoom.ZOOM_4X with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.phaser.Phaser.Scale.Zoom with Double] = js.native
  }
