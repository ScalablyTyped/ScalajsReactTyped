...
class Text protected ()
  extends typingsJapgolly.phaser.Phaser.GameObjects.Text {
  /**
    * 
...
object Text extends js.Object {
  /**
    ...
    */
  def GetTextSize(text: typingsJapgolly.phaser.Phaser.GameObjects.Text, size: TextMetrics, lines: js.Array[_]): js.Object = js.native
  /**
    * Calculates the ascent, descent and fontSize of a given font style.
    * @param textStyle The TextStyle object to measure.
    */
  def MeasureText(textStyle: typingsJapgolly.phaser.Phaser.GameObjects.TextStyle): TextMetrics = js.native
}
