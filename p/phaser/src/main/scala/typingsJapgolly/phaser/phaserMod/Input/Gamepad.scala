...
object Gamepad extends js.Object {
  ...
  class Axis protected ()
    extends typingsJapgolly.phaser.Phaser.Input.Gamepad.Axis {
    /**
      * 
      * @param pad A reference to the Gamepad that this Axis belongs to.
      * @param index The index of this Axis.
      */
    def this(pad: typingsJapgolly.phaser.Phaser.Input.Gamepad.Gamepad, index: integer) = this()
  }
  ...
  class Button protected ()
    extends typingsJapgolly.phaser.Phaser.Input.Gamepad.Button {
    /**
      * 
  ...
  class Gamepad protected ()
    extends typingsJapgolly.phaser.Phaser.Input.Gamepad.Gamepad {
    /**
      * 
  ...
  class GamepadPlugin protected ()
    extends typingsJapgolly.phaser.Phaser.Input.Gamepad.GamepadPlugin {
    /**
      * 
