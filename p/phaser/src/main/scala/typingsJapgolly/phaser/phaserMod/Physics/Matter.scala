package typingsJapgolly.phaser.phaserMod.Physics
...
object Matter extends js.Object {
  ...
  @js.native
  class BodyBounds ()
    extends typingsJapgolly.phaser.Phaser.Physics.Matter.BodyBounds
  ...
  class Factory protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Matter.Factory {
    /**
      * 
  ...
  class Image protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Matter.Image {
    /**
      * 
  ...
  class MatterPhysics protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Matter.MatterPhysics {
    /**
      * 
  ...
  class PointerConstraint protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Matter.PointerConstraint {
    /**
      * 
      ...
      */
    def this(scene: Scene, world: typingsJapgolly.phaser.Phaser.Physics.Matter.World) = this()
    def this(scene: Scene, world: typingsJapgolly.phaser.Phaser.Physics.Matter.World, options: js.Object) = this()
  }
  ...
  class Sprite protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Matter.Sprite {
    /**
      * 
      * @param world A reference to the Matter.World instance that this body belongs to.
      * @param x The horizontal position of this Game Object in the world.
  ...
  class TileBody protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Matter.TileBody {
    /**
      * 
  ...
  class World protected ()
    extends typingsJapgolly.phaser.Phaser.Physics.Matter.World {
    /**
      * 
  ...
  /**
    ...
    */
  def MatterGameObject(world: typingsJapgolly.phaser.Phaser.Physics.Matter.World, gameObject: GameObject): GameObject = js.native
  def MatterGameObject(world: typingsJapgolly.phaser.Phaser.Physics.Matter.World, gameObject: GameObject, options: Body): GameObject = js.native
