...
object Core {
  ...
  open class Config ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Core.Config {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def postBoot(game: typingsJapgolly.phaser.Phaser.Game): Unit = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def preBoot(game: typingsJapgolly.phaser.Phaser.Game): Unit = js.native
  ...
  /**
    ...
    */
  inline def CreateRenderer(game: typingsJapgolly.phaser.Phaser.Game): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("CreateRenderer")(game.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def DebugHeader(game: typingsJapgolly.phaser.Phaser.Game): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("DebugHeader")(game.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  open class TimeStep protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Core.TimeStep {
    /**
      * 
      * @param game A reference to the Phaser.Game instance that owns this Time Step.
      */
    def this(game: typingsJapgolly.phaser.Phaser.Game, config: FPSConfig) = this()
  }
  ...
  /**
    ...
    */
  inline def VisibilityHandler(game: typingsJapgolly.phaser.Phaser.Game): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("VisibilityHandler")(game.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
