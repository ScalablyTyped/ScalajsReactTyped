...
object Structs {
  ...
  open class List[T] protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Structs.List[T] {
    /**
      * 
  ...
  open class Map[K, V] protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Structs.Map[K, V] {
    /**
      * 
  ...
  open class ProcessQueue[T] ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Structs.ProcessQueue[T]
  ...
  open class RTree ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Structs.RTree
  
  /**
    * A Set is a collection of unique elements.
    */
  @JSGlobal("Phaser.Structs.Set")
  @js.native
  /**
    * 
  ...
  open class Set[T] ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Structs.Set[T] {
  ...
  open class Size ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Structs.Size {
