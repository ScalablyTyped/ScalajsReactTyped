...
object Scenes {
  ...
  /**
    ...
    */
  inline def GetPhysicsPlugins(sys: typingsJapgolly.phaser.Phaser.Scenes.Systems): js.Array[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("GetPhysicsPlugins")(sys.asInstanceOf[js.Any]).asInstanceOf[js.Array[Any]]
  ...
  /**
    ...
    */
  inline def GetScenePlugins(sys: typingsJapgolly.phaser.Phaser.Scenes.Systems): js.Array[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("GetScenePlugins")(sys.asInstanceOf[js.Any]).asInstanceOf[js.Array[Any]]
  ...
  open class SceneManager protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Scenes.SceneManager {
    /**
      * 
      * @param game The Phaser.Game instance this Scene Manager belongs to.
      * @param sceneConfig Scene specific configuration settings.
      */
    def this(game: typingsJapgolly.phaser.Phaser.Game, sceneConfig: js.Object) = this()
  }
  ...
  open class ScenePlugin protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Scenes.ScenePlugin {
    /**
      * 
  ...
  open class Systems protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Scenes.Systems {
    /**
      * 
      * @param scene The Scene that owns this Systems instance.
      * @param config Scene specific configuration settings.
      */
    def this(scene: typingsJapgolly.phaser.Phaser.Scene, config: String) = this()
    def this(scene: typingsJapgolly.phaser.Phaser.Scene, config: SettingsConfig) = this()
  }
}
