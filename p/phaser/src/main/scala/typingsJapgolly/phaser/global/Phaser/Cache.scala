...
import typingsJapgolly.phaser.Phaser.Structs.Map
...
object Cache {
  ...
  open class BaseCache ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Cache.BaseCache {
  ...
  open class CacheManager protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Cache.CacheManager {
    /**
      * 
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def addCustom(key: String): typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    
    /**
      * A Cache storing all non-streaming audio files, typically added via the Loader.
      */
    /* CompleteClass */
    var audio: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    
    /**
      * A Cache storing all binary files, typically added via the Loader.
      */
    /* CompleteClass */
    var binary: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var bitmapFont: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var custom: StringDictionary[typingsJapgolly.phaser.Phaser.Cache.BaseCache] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var html: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    
    /**
      * A Cache storing all JSON data files, typically added via the Loader.
      */
    /* CompleteClass */
    var json: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    
    /**
      * A Cache storing all WaveFront OBJ files, typically added via the Loader.
      */
    /* CompleteClass */
    var obj: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    
    /**
      * A Cache storing all physics data files, typically added via the Loader.
      */
    /* CompleteClass */
    var physics: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    
    /**
      * A Cache storing all shader source files, typically added via the Loader.
      */
    /* CompleteClass */
    var shader: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    
    /**
      * A Cache storing all text files, typically added via the Loader.
      */
    /* CompleteClass */
    var text: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var tilemap: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    
    /**
      * A Cache storing all non-streaming video files, typically added via the Loader.
      */
    /* CompleteClass */
    var video: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
    
    /**
      * A Cache storing all xml data files, typically added via the Loader.
      */
    /* CompleteClass */
    var xml: typingsJapgolly.phaser.Phaser.Cache.BaseCache = js.native
  }
