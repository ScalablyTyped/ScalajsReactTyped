...
@js.native
open class TransformConstraintData protected ()
  extends StObject
     with typingsJapgolly.phaser.spine.TransformConstraintData {
  ...
  /* CompleteClass */
  var target: typingsJapgolly.phaser.spine.BoneData = js.native
