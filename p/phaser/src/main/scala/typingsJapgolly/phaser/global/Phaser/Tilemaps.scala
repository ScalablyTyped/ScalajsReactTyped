...
import typingsJapgolly.phaser.Phaser.Tilemaps.OrientationType
import typingsJapgolly.phaser.Phaser.Types.GameObjects.Sprite.SpriteConfig
import typingsJapgolly.phaser.Phaser.Types.Tilemaps.DebugStyleOptions
import typingsJapgolly.phaser.Phaser.Types.Tilemaps.FilteringOptions
import typingsJapgolly.phaser.Phaser.Types.Tilemaps.GIDData
import typingsJapgolly.phaser.Phaser.Types.Tilemaps.LayerDataConfig
...
object Tilemaps {
  ...
  object Components {
    ...
    @JSGlobal("Phaser.Tilemaps.Components")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      ...
      */
    inline def CalculateFacesAt(tileX: Double, tileY: Double, layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("CalculateFacesAt")(tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    inline def CalculateFacesWithin(
      ...
      width: Double,
      height: Double,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ...
    /**
      ...
      */
    inline def CheckIsoBounds(tileX: Double, tileY: Double, layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("CheckIsoBounds")(tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    inline def CheckIsoBounds(
      tileX: Double,
      tileY: Double,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera
    ): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("CheckIsoBounds")(tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    /**
      ...
      * @param camera The Camera to run the cull check against.
      */
    inline def CullBounds(layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData, camera: Camera): Rectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("CullBounds")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any])).asInstanceOf[Rectangle]
    ...
    /**
      ...
      */
    inline def CullTiles(layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData, camera: Camera): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("CullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def CullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: js.Array[Any]
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("CullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], outputArray.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def CullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: js.Array[Any],
      renderOrder: Double
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("CullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], outputArray.asInstanceOf[js.Any], renderOrder.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def CullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: Unit,
    ...
    inline def FilterTiles(
      ...
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("FilterTiles")(callback.asInstanceOf[js.Any], context.asInstanceOf[js.Any], tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any], filteringOptions.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def FindByIndex(
      index: Double,
      skip: Double,
      reverse: Boolean,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): typingsJapgolly.phaser.Phaser.Tilemaps.Tile = (^.asInstanceOf[js.Dynamic].applyDynamic("FindByIndex")(index.asInstanceOf[js.Any], skip.asInstanceOf[js.Any], reverse.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]
    ...
    inline def FindTile(
      ...
      filteringOptions: FilteringOptions,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): typingsJapgolly.phaser.Phaser.Tilemaps.Tile = (^.asInstanceOf[js.Dynamic].applyDynamic("FindTile")(callback.asInstanceOf[js.Any], context.asInstanceOf[js.Any], tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any], filteringOptions.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def GetTileAt(
      tileX: Double,
      tileY: Double,
      nonNull: Boolean,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): typingsJapgolly.phaser.Phaser.Tilemaps.Tile = (^.asInstanceOf[js.Dynamic].applyDynamic("GetTileAt")(tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], nonNull.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]
    ...
    inline def GetTileAtWorldXY(
      ...
      camera: Camera,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): typingsJapgolly.phaser.Phaser.Tilemaps.Tile = (^.asInstanceOf[js.Dynamic].applyDynamic("GetTileAtWorldXY")(worldX.asInstanceOf[js.Any], worldY.asInstanceOf[js.Any], nonNull.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]
    ...
    inline def GetTilesWithin(
      ...
      filteringOptions: FilteringOptions,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("GetTilesWithin")(tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any], filteringOptions.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    ...
    inline def GetTilesWithinShape(
      ...
      camera: Camera,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("GetTilesWithinShape")(shape.asInstanceOf[js.Any], filteringOptions.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def GetTilesWithinShape(
      shape: Line,
      filteringOptions: FilteringOptions,
      camera: Camera,
    ...
    inline def GetTilesWithinWorldXY(
      ...
      camera: Camera,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("GetTilesWithinWorldXY")(worldX.asInstanceOf[js.Any], worldY.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any], filteringOptions.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def HasTileAt(tileX: Double, tileY: Double, layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("HasTileAt")(tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def HasTileAtWorldXY(
      worldX: Double,
      worldY: Double,
      camera: Camera,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("HasTileAtWorldXY")(worldX.asInstanceOf[js.Any], worldY.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    /**
      ...
      * @param camera The Camera to run the cull check against.
      */
    inline def HexagonalCullBounds(layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData, camera: Camera): js.Object = (^.asInstanceOf[js.Dynamic].applyDynamic("HexagonalCullBounds")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any])).asInstanceOf[js.Object]
    ...
    /**
      ...
      * @param renderOrder The rendering order constant. Default 0.
      */
    inline def HexagonalCullTiles(layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData, camera: Camera): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("HexagonalCullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def HexagonalCullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: js.Array[Any]
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("HexagonalCullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], outputArray.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def HexagonalCullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: js.Array[Any],
      renderOrder: Double
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("HexagonalCullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], outputArray.asInstanceOf[js.Any], renderOrder.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def HexagonalCullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: Unit,
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def HexagonalTileToWorldY(tileY: Double, camera: Camera, layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("HexagonalTileToWorldY")(tileY.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Double]
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def IsInLayerBounds(tileX: Double, tileY: Double, layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("IsInLayerBounds")(tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    /**
      ...
      * @param renderOrder The rendering order constant. Default 0.
      */
    inline def IsometricCullTiles(layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData, camera: Camera): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("IsometricCullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def IsometricCullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: js.Array[Any]
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("IsometricCullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], outputArray.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def IsometricCullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: js.Array[Any],
      renderOrder: Double
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("IsometricCullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], outputArray.asInstanceOf[js.Any], renderOrder.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def IsometricCullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: Unit,
    ...
    inline def PutTileAt(
      ...
      recalculateFaces: Boolean,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): typingsJapgolly.phaser.Phaser.Tilemaps.Tile = (^.asInstanceOf[js.Dynamic].applyDynamic("PutTileAt")(tile.asInstanceOf[js.Any], tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], recalculateFaces.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]
    inline def PutTileAt(
      tile: typingsJapgolly.phaser.Phaser.Tilemaps.Tile,
      tileX: Double,
      tileY: Double,
      recalculateFaces: Boolean,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ...
    inline def PutTileAtWorldXY(
      ...
      camera: Camera,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): typingsJapgolly.phaser.Phaser.Tilemaps.Tile = (^.asInstanceOf[js.Dynamic].applyDynamic("PutTileAtWorldXY")(tile.asInstanceOf[js.Any], worldX.asInstanceOf[js.Any], worldY.asInstanceOf[js.Any], recalculateFaces.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]
    inline def PutTileAtWorldXY(
      tile: typingsJapgolly.phaser.Phaser.Tilemaps.Tile,
      worldX: Double,
      worldY: Double,
    ...
    inline def PutTilesAt(
      tile: js.Array[
          (js.Array[Double | typingsJapgolly.phaser.Phaser.Tilemaps.Tile]) | Double | typingsJapgolly.phaser.Phaser.Tilemaps.Tile
        ],
      tileX: Double,
      tileY: Double,
      recalculateFaces: Boolean,
    ...
    inline def RemoveTileAt(
      ...
      recalculateFaces: Boolean,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): typingsJapgolly.phaser.Phaser.Tilemaps.Tile = (^.asInstanceOf[js.Dynamic].applyDynamic("RemoveTileAt")(tileX.asInstanceOf[js.Any], tileY.asInstanceOf[js.Any], replaceWithNull.asInstanceOf[js.Any], recalculateFaces.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]
    ...
    inline def RemoveTileAtWorldXY(
      ...
      camera: Camera,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): typingsJapgolly.phaser.Phaser.Tilemaps.Tile = (^.asInstanceOf[js.Dynamic].applyDynamic("RemoveTileAtWorldXY")(worldX.asInstanceOf[js.Any], worldY.asInstanceOf[js.Any], replaceWithNull.asInstanceOf[js.Any], recalculateFaces.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]
    ...
    inline def RunCull(
      ...
      renderOrder: Double,
      outputArray: js.Array[Any]
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("RunCull")(layer.asInstanceOf[js.Any], bounds.asInstanceOf[js.Any], renderOrder.asInstanceOf[js.Any], outputArray.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def SetCollisionFromCollisionGroup(
      collides: Boolean,
      recalculateFaces: Boolean,
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData
    ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("SetCollisionFromCollisionGroup")(collides.asInstanceOf[js.Any], recalculateFaces.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def SetLayerCollisionIndex(tileIndex: Double, collides: Boolean, layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("SetLayerCollisionIndex")(tileIndex.asInstanceOf[js.Any], collides.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /**
      ...
      */
    inline def SetTileCollision(tile: typingsJapgolly.phaser.Phaser.Tilemaps.Tile): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("SetTileCollision")(tile.asInstanceOf[js.Any]).asInstanceOf[Unit]
    inline def SetTileCollision(tile: typingsJapgolly.phaser.Phaser.Tilemaps.Tile, collides: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("SetTileCollision")(tile.asInstanceOf[js.Any], collides.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /**
      ...
      * @param camera The Camera to run the cull check against.
      */
    inline def StaggeredCullBounds(layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData, camera: Camera): js.Object = (^.asInstanceOf[js.Dynamic].applyDynamic("StaggeredCullBounds")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any])).asInstanceOf[js.Object]
    ...
    /**
      ...
      * @param renderOrder The rendering order constant. Default 0.
      */
    inline def StaggeredCullTiles(layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData, camera: Camera): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("StaggeredCullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def StaggeredCullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: js.Array[Any]
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("StaggeredCullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], outputArray.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def StaggeredCullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: js.Array[Any],
      renderOrder: Double
    ): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile] = (^.asInstanceOf[js.Dynamic].applyDynamic("StaggeredCullTiles")(layer.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], outputArray.asInstanceOf[js.Any], renderOrder.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]]
    inline def StaggeredCullTiles(
      layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData,
      camera: Camera,
      outputArray: Unit,
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def StaggeredTileToWorldY(tileY: Double, camera: Camera, layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("StaggeredTileToWorldY")(tileY.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Double]
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def TileToWorldX(tileX: Double, camera: Camera, layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("TileToWorldX")(tileX.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Double]
    ...
    /**
      ...
      * @param layer The Tilemap Layer to act upon.
      */
    inline def TileToWorldY(tileY: Double, camera: Camera, layer: typingsJapgolly.phaser.Phaser.Tilemaps.LayerData): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("TileToWorldY")(tileY.asInstanceOf[js.Any], camera.asInstanceOf[js.Any], layer.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  object Formats {
    ...
    @JSGlobal("Phaser.Tilemaps.Formats")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      * 2D Array Map Type
      */
    @JSGlobal("Phaser.Tilemaps.Formats.ARRAY_2D")
    @js.native
    ...
    /**
      * CSV Map Type
      */
    @JSGlobal("Phaser.Tilemaps.Formats.CSV")
    @js.native
    ...
    /**
      * Tiled JSON Map Type
      */
    @JSGlobal("Phaser.Tilemaps.Formats.TILED_JSON")
    @js.native
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Tilemaps.Formats.WELTMEISTER")
    @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.Tilemaps.HEXAGONAL")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.Tilemaps.ISOMETRIC")
  @js.native
  ...
  open class ImageCollection protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tilemaps.ImageCollection {
    /**
      * 
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def addImage(gid: Double, image: String): typingsJapgolly.phaser.Phaser.Tilemaps.ImageCollection = js.native
  ...
  open class LayerData ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tilemaps.LayerData {
    ...
    /**
      ...
      */
    /* CompleteClass */
    var data: js.Array[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tile]] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var tilemapLayer: typingsJapgolly.phaser.Phaser.Tilemaps.TilemapLayer = js.native
  ...
  open class MapData ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tilemaps.MapData {
    ...
    /**
      ...
      */
    /* CompleteClass */
    var layers: js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.LayerData] | typingsJapgolly.phaser.Phaser.Tilemaps.ObjectLayer = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var tilesets: js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.Tileset] = js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.Tilemaps.ORTHOGONAL")
  @js.native
  ...
  open class ObjectLayer ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tilemaps.ObjectLayer {
  ...
  object Orientation extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.phaser.Phaser.Tilemaps.Orientation & Double] = js.native
    
    /* 3 */ val HEXAGONAL: typingsJapgolly.phaser.Phaser.Tilemaps.Orientation.HEXAGONAL & Double = js.native
    
    /* 1 */ val ISOMETRIC: typingsJapgolly.phaser.Phaser.Tilemaps.Orientation.ISOMETRIC & Double = js.native
    
    /* 0 */ val ORTHOGONAL: typingsJapgolly.phaser.Phaser.Tilemaps.Orientation.ORTHOGONAL & Double = js.native
    
    /* 2 */ val STAGGERED: typingsJapgolly.phaser.Phaser.Tilemaps.Orientation.STAGGERED & Double = js.native
  }
  ...
  ): typingsJapgolly.phaser.Phaser.Tilemaps.Tilemap = (^.asInstanceOf[js.Dynamic].applyDynamic("ParseToTilemap")(scene.asInstanceOf[js.Any], key.asInstanceOf[js.Any], tileWidth.asInstanceOf[js.Any], tileHeight.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any], data.asInstanceOf[js.Any], insertNull.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.Tilemap]
  ...
  object Parsers {
    ...
    object Impact {
      ...
      @JSGlobal("Phaser.Tilemaps.Parsers.Impact")
      @js.native
      val ^ : js.Any = js.native
      ...
      /**
        ...
        */
      inline def ParseTileLayers(json: js.Object, insertNull: Boolean): js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.LayerData] = (^.asInstanceOf[js.Dynamic].applyDynamic("ParseTileLayers")(json.asInstanceOf[js.Any], insertNull.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tilemaps.LayerData]]
      ...
      /**
        ...
        */
      inline def ParseWeltmeister(name: String, json: js.Object, insertNull: Boolean): typingsJapgolly.phaser.Phaser.Tilemaps.MapData = (^.asInstanceOf[js.Dynamic].applyDynamic("ParseWeltmeister")(name.asInstanceOf[js.Any], json.asInstanceOf[js.Any], insertNull.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.MapData]
    }
    ...
    inline def Parse(
      ...
      tileHeight: Double,
      insertNull: Boolean
    ): typingsJapgolly.phaser.Phaser.Tilemaps.MapData = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(name.asInstanceOf[js.Any], mapFormat.asInstanceOf[js.Any], data.asInstanceOf[js.Any], tileWidth.asInstanceOf[js.Any], tileHeight.asInstanceOf[js.Any], insertNull.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.MapData]
    /**
    ...
    inline def Parse2DArray(
      ...
      tileHeight: Double,
      insertNull: Boolean
    ): typingsJapgolly.phaser.Phaser.Tilemaps.MapData = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse2DArray")(name.asInstanceOf[js.Any], data.asInstanceOf[js.Any], tileWidth.asInstanceOf[js.Any], tileHeight.asInstanceOf[js.Any], insertNull.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.MapData]
    ...
    /**
      ...
      * the default value set.
      */
    inline def ParseCSV(name: String, data: String, tileWidth: Double, tileHeight: Double, insertNull: Boolean): typingsJapgolly.phaser.Phaser.Tilemaps.MapData = (^.asInstanceOf[js.Dynamic].applyDynamic("ParseCSV")(name.asInstanceOf[js.Any], data.asInstanceOf[js.Any], tileWidth.asInstanceOf[js.Any], tileHeight.asInstanceOf[js.Any], insertNull.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.MapData]
    
    object Tiled {
      
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled")
      @js.native
      val ^ : js.Any = js.native
      ...
      /**
        ...
        */
      inline def AssignTileProperties(mapData: typingsJapgolly.phaser.Phaser.Tilemaps.MapData): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("AssignTileProperties")(mapData.asInstanceOf[js.Any]).asInstanceOf[Unit]
      ...
      /**
        ...
        * @param mapData The Map Data object.
        */
      inline def BuildTilesetIndex(mapData: typingsJapgolly.phaser.Phaser.Tilemaps.MapData): js.Array[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("BuildTilesetIndex")(mapData.asInstanceOf[js.Any]).asInstanceOf[js.Array[Any]]
      ...
      /**
        ...
        * the default value set.
        */
      inline def ParseJSONTiled(name: String, json: js.Object, insertNull: Boolean): typingsJapgolly.phaser.Phaser.Tilemaps.MapData = (^.asInstanceOf[js.Dynamic].applyDynamic("ParseJSONTiled")(name.asInstanceOf[js.Any], json.asInstanceOf[js.Any], insertNull.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tilemaps.MapData]
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.Tilemaps.STAGGERED")
  @js.native
  ...
  open class Tile protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tilemaps.Tile {
    /**
      * 
  ...
  open class Tilemap protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tilemaps.Tilemap {
    /**
      * 
      * @param scene The Scene to which this Tilemap belongs.
    ...
    def this(
      scene: typingsJapgolly.phaser.Phaser.Scene,
      mapData: typingsJapgolly.phaser.Phaser.Tilemaps.MapData
    ) = this()
  }
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.Tilemaps.TilemapLayer")
  @js.native
  open class TilemapLayer protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tilemaps.TilemapLayer {
    /**
      * 
    ...
    def this(
      scene: typingsJapgolly.phaser.Phaser.Scene,
      tilemap: typingsJapgolly.phaser.Phaser.Tilemaps.Tilemap,
      layerIndex: Double,
      tileset: String
    ) = this()
    def this(
      ...
      tilemap: typingsJapgolly.phaser.Phaser.Tilemaps.Tilemap,
      layerIndex: Double,
      tileset: js.Array[String | typingsJapgolly.phaser.Phaser.Tilemaps.Tileset]
    ) = this()
    def this(
      scene: typingsJapgolly.phaser.Phaser.Scene,
      tilemap: typingsJapgolly.phaser.Phaser.Tilemaps.Tilemap,
      layerIndex: Double,
      tileset: typingsJapgolly.phaser.Phaser.Tilemaps.Tileset
    ) = this()
    def this(
      scene: typingsJapgolly.phaser.Phaser.Scene,
      tilemap: typingsJapgolly.phaser.Phaser.Tilemaps.Tilemap,
  ...
  open class Tileset protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tilemaps.Tileset {
    /**
      * 
