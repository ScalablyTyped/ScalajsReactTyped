...
import typingsJapgolly.phaser.Phaser.Input.Keyboard.Key
...
object Cameras {
  ...
  object Controls {
    ...
    open class FixedKeyControl protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Cameras.Controls.FixedKeyControl {
      /**
        * 
    ...
    open class SmoothedKeyControl protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Cameras.Controls.SmoothedKeyControl {
      /**
        * 
  ...
  object Scene2D {
    ...
    open class BaseCamera protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Cameras.Scene2D.BaseCamera {
      /**
        * 
    ...
    open class Camera protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Camera {
      /**
        * 
        * @param x The x position of the Camera, relative to the top-left of the game canvas.
        * @param y The y position of the Camera, relative to the top-left of the game canvas.
    ...
    open class CameraManager protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Cameras.Scene2D.CameraManager {
      /**
        * 
    ...
    object Effects {
      ...
      open class Fade protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.Fade {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
        def this(camera: typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Camera) = this()
        
        /**
          * The Camera this effect belongs to.
          */
        /* CompleteClass */
        override val camera: typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Camera = js.native
        ...
        ): typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Camera = js.native
      ...
      open class Flash protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.Flash {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      open class Pan protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.Pan {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      open class RotateTo protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.RotateTo {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      open class Shake protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.Shake {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      open class Zoom protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Cameras.Scene2D.Effects.Zoom {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
