...
open class SkeletonBinary protected ()
  extends StObject
     with typingsJapgolly.phaser.spine.SkeletonBinary {
  ...
  /* CompleteClass */
  override def readSkeletonData(binary: js.typedarray.Uint8Array): typingsJapgolly.phaser.spine.SkeletonData = js.native
  ...
  override def setCurve(
    timeline: typingsJapgolly.phaser.spine.CurveTimeline,
    frameIndex: Double,
    cx1: Double,
    cy1: Double,
    cx2: Double,
...
object SkeletonBinary {
  ...
  @js.native
  def BlendModeValues: js.Array[typingsJapgolly.phaser.spine.BlendMode] = js.native
  inline def BlendModeValues_=(x: js.Array[typingsJapgolly.phaser.spine.BlendMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BlendModeValues")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def PositionModeValues: js.Array[typingsJapgolly.phaser.spine.PositionMode] = js.native
  inline def PositionModeValues_=(x: js.Array[typingsJapgolly.phaser.spine.PositionMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PositionModeValues")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSGlobal("spine.SkeletonBinary.RotateModeValues")
  @js.native
  def RotateModeValues: js.Array[typingsJapgolly.phaser.spine.RotateMode] = js.native
  inline def RotateModeValues_=(x: js.Array[typingsJapgolly.phaser.spine.RotateMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RotateModeValues")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def SpacingModeValues: js.Array[typingsJapgolly.phaser.spine.SpacingMode] = js.native
  inline def SpacingModeValues_=(x: js.Array[typingsJapgolly.phaser.spine.SpacingMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SpacingModeValues")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSGlobal("spine.SkeletonBinary.TransformModeValues")
  @js.native
  def TransformModeValues: js.Array[typingsJapgolly.phaser.spine.TransformMode] = js.native
  inline def TransformModeValues_=(x: js.Array[typingsJapgolly.phaser.spine.TransformMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TransformModeValues")(x.asInstanceOf[js.Any])
}
