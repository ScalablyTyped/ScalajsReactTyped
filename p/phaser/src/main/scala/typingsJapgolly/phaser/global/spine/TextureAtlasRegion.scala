...
open class TextureAtlasRegion ()
  extends StObject
     with typingsJapgolly.phaser.spine.TextureAtlasRegion {
  ...
  /* CompleteClass */
  var page: typingsJapgolly.phaser.spine.TextureAtlasPage = js.native
  ...
  /* CompleteClass */
  var texture: typingsJapgolly.phaser.spine.Texture = js.native
