...
import typingsJapgolly.phaser.Phaser.Types.Renderer.WebGL.WebGLConst
...
object Renderer {
  ...
  object Canvas {
    ...
    open class CanvasRenderer protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Renderer.Canvas.CanvasRenderer {
      /**
        * 
    ...
    inline def SetTransform(
      renderer: typingsJapgolly.phaser.Phaser.Renderer.Canvas.CanvasRenderer,
  ...
  object WebGL {
    ...
    open class PipelineManager protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Renderer.WebGL.PipelineManager {
      /**
        * 
        * @param renderer A reference to the WebGL Renderer that owns this Pipeline Manager.
        */
      def this(renderer: typingsJapgolly.phaser.Phaser.Renderer.WebGL.WebGLRenderer) = this()
    }
    ...
    object Pipelines {
      ...
      open class BitmapMaskPipeline protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Renderer.WebGL.Pipelines.BitmapMaskPipeline {
        /**
          * 
      ...
      open class GraphicsPipeline protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Renderer.WebGL.Pipelines.GraphicsPipeline {
        /**
          * 
          * @param config The configuration options for this pipeline.
          */
      ...
      open class LightPipeline protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Renderer.WebGL.Pipelines.LightPipeline {
        /**
          * 
          * @param config The configuration options for this pipeline.
          */
      ...
      open class MultiPipeline protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Renderer.WebGL.Pipelines.MultiPipeline {
        /**
          * 
          * @param config The configuration options for this pipeline.
          */
      ...
      open class PointLightPipeline protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Renderer.WebGL.Pipelines.PointLightPipeline {
        /**
          * 
          * @param config The configuration options for this pipeline.
          */
      ...
      open class PostFXPipeline protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Renderer.WebGL.Pipelines.PostFXPipeline {
        /**
          * 
          * @param config The configuration options for this pipeline.
          */
      ...
      open class UtilityPipeline protected ()
        extends StObject
           with typingsJapgolly.phaser.Phaser.Renderer.WebGL.Pipelines.UtilityPipeline {
        /**
          * 
          * @param config The configuration options for this pipeline.
          */
    ...
    open class RenderTarget protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Renderer.WebGL.RenderTarget {
      /**
        * 
    ...
    open class WebGLPipeline protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Renderer.WebGL.WebGLPipeline {
      /**
        * 
    ...
    open class WebGLRenderer protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Renderer.WebGL.WebGLRenderer {
      /**
        * 
    ...
    open class WebGLShader protected ()
      extends StObject
         with typingsJapgolly.phaser.Phaser.Renderer.WebGL.WebGLShader {
      /**
        * 
        ...
        */
      def this(
        pipeline: typingsJapgolly.phaser.Phaser.Renderer.WebGL.WebGLPipeline,
        name: String,
        vertexShader: String,
