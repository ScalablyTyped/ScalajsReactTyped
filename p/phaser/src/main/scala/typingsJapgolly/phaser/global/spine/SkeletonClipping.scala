...
open class SkeletonClipping ()
  extends StObject
     with typingsJapgolly.phaser.spine.SkeletonClipping {
  ...
  /* CompleteClass */
  override def clipEndWithSlot(slot: typingsJapgolly.phaser.spine.Slot): Unit = js.native
  
  /* private */ /* CompleteClass */
  var clipOutput: Any = js.native
  
  /* CompleteClass */
  override def clipStart(slot: typingsJapgolly.phaser.spine.Slot, clip: typingsJapgolly.phaser.spine.ClippingAttachment): Double = js.native
