...
import typingsJapgolly.phaser.Phaser.Types.Tweens.StaggerConfig
import typingsJapgolly.phaser.Phaser.Types.Tweens.TimelineBuilderConfig
import typingsJapgolly.phaser.Phaser.Types.Tweens.TweenBuilderConfig
import typingsJapgolly.phaser.Phaser.Types.Tweens.TweenConfigDefaults
import typingsJapgolly.phaser.Phaser.Types.Tweens.TweenDataConfig
...
object Tweens {
  ...
  object Builders {
    ...
    /**
      ...
      */
    inline def GetTweens(config: TimelineBuilderConfig): js.Array[typingsJapgolly.phaser.Phaser.Tweens.Tween] = ^.asInstanceOf[js.Dynamic].applyDynamic("GetTweens")(config.asInstanceOf[js.Any]).asInstanceOf[js.Array[typingsJapgolly.phaser.Phaser.Tweens.Tween]]
    ...
    inline def NumberTweenBuilder(
      parent: typingsJapgolly.phaser.Phaser.Tweens.Timeline,
      config: NumberTweenBuilderConfig,
      defaults: TweenConfigDefaults
    ): typingsJapgolly.phaser.Phaser.Tweens.Tween = (^.asInstanceOf[js.Dynamic].applyDynamic("NumberTweenBuilder")(parent.asInstanceOf[js.Any], config.asInstanceOf[js.Any], defaults.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tweens.Tween]
    /**
      ...
      */
    inline def NumberTweenBuilder(
      parent: typingsJapgolly.phaser.Phaser.Tweens.TweenManager,
      config: NumberTweenBuilderConfig,
      defaults: TweenConfigDefaults
    ): typingsJapgolly.phaser.Phaser.Tweens.Tween = (^.asInstanceOf[js.Dynamic].applyDynamic("NumberTweenBuilder")(parent.asInstanceOf[js.Any], config.asInstanceOf[js.Any], defaults.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tweens.Tween]
    ...
    /**
      ...
      * @param config The configuration object for the Timeline.
      */
    inline def TimelineBuilder(manager: typingsJapgolly.phaser.Phaser.Tweens.TweenManager, config: TimelineBuilderConfig): typingsJapgolly.phaser.Phaser.Tweens.Timeline = (^.asInstanceOf[js.Dynamic].applyDynamic("TimelineBuilder")(manager.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tweens.Timeline]
    
    inline def TweenBuilder(
      parent: typingsJapgolly.phaser.Phaser.Tweens.Timeline,
      config: js.Object,
      defaults: TweenConfigDefaults
    ): typingsJapgolly.phaser.Phaser.Tweens.Tween = (^.asInstanceOf[js.Dynamic].applyDynamic("TweenBuilder")(parent.asInstanceOf[js.Any], config.asInstanceOf[js.Any], defaults.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.phaser.Phaser.Tweens.Tween]
    inline def TweenBuilder(
      parent: typingsJapgolly.phaser.Phaser.Tweens.Timeline,
  ...
  open class Timeline protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tweens.Timeline {
    /**
      * 
      * @param manager The Tween Manager which owns this Timeline.
      */
    def this(manager: typingsJapgolly.phaser.Phaser.Tweens.TweenManager) = this()
  }
  ...
  open class Tween protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tweens.Tween {
    def this(
      parent: typingsJapgolly.phaser.Phaser.Tweens.Timeline,
  ...
  open class TweenManager protected ()
    extends StObject
       with typingsJapgolly.phaser.Phaser.Tweens.TweenManager {
    /**
      * 
