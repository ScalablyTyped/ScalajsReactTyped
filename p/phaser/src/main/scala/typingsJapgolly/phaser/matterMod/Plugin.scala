...
import typingsJapgolly.phaser.anon.Dict
import typingsJapgolly.phaser.anon.IsRange
import typingsJapgolly.phaser.anon.Name
import typingsJapgolly.phaser.anon.Uses
...
open class Plugin ()
  extends StObject
     with typingsJapgolly.phaser.MatterJS.Plugin {
...
object Plugin {
  ...
  /**
    ...
    */
  /* static member */
  inline def isFor(plugin: typingsJapgolly.phaser.MatterJS.Plugin, module: Dict): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isFor")(plugin.asInstanceOf[js.Any], module.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  /* static member */
  inline def register(plugin: typingsJapgolly.phaser.MatterJS.Plugin): typingsJapgolly.phaser.MatterJS.Plugin = ^.asInstanceOf[js.Dynamic].applyDynamic("register")(plugin.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.phaser.MatterJS.Plugin]
  ...
  /**
    ...
    */
  /* static member */
  inline def resolve(dependency: String): js.UndefOr[typingsJapgolly.phaser.MatterJS.Plugin] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(dependency.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.phaser.MatterJS.Plugin]]
  ...
  inline def toString_(plugin: typingsJapgolly.phaser.MatterJS.Plugin): String = ^.asInstanceOf[js.Dynamic].applyDynamic("toString")(plugin.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  /**
    ...
    */
  /* static member */
  inline def use(module: Uses, plugins: js.Array[typingsJapgolly.phaser.MatterJS.Plugin | String]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("use")(module.asInstanceOf[js.Any], plugins.asInstanceOf[js.Any])).asInstanceOf[Unit]
