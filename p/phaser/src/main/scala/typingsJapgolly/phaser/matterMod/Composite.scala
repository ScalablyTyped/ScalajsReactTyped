...
import typingsJapgolly.phaser.MatterJS.ICompositeDefinition
...
open class Composite ()
  extends StObject
     with typingsJapgolly.phaser.MatterJS.Composite
object Composite {
  ...
  /**
    ...
    */
  /* static member */
  inline def rotate(composite: CompositeType, rotation: Double, point: typingsJapgolly.phaser.MatterJS.Vector): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("rotate")(composite.asInstanceOf[js.Any], rotation.asInstanceOf[js.Any], point.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def rotate(
  ...
  /**
    ...
    */
  /* static member */
  inline def translate(composite: CompositeType, translation: typingsJapgolly.phaser.MatterJS.Vector): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("translate")(composite.asInstanceOf[js.Any], translation.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def translate(composite: CompositeType, translation: typingsJapgolly.phaser.MatterJS.Vector, recursive: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("translate")(composite.asInstanceOf[js.Any], translation.asInstanceOf[js.Any], recursive.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
