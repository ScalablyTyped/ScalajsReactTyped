...
import typingsJapgolly.phaser.MatterJS.IChamferableBodyDefinition
...
open class Body ()
  extends StObject
     with typingsJapgolly.phaser.MatterJS.Body
object Body {
  ...
  inline def applyForce(
    body: BodyType,
    position: typingsJapgolly.phaser.MatterJS.Vector,
    force: typingsJapgolly.phaser.MatterJS.Vector
  ...
  /**
    ...
    */
  /* static member */
  inline def create(options: IChamferableBodyDefinition): typingsJapgolly.phaser.MatterJS.Body = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.phaser.MatterJS.Body]
  ...
  inline def scale(body: BodyType, scaleX: Double, scaleY: Double, point: typingsJapgolly.phaser.MatterJS.Vector): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("scale")(body.asInstanceOf[js.Any], scaleX.asInstanceOf[js.Any], scaleY.asInstanceOf[js.Any], point.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def setPosition(body: BodyType, position: typingsJapgolly.phaser.MatterJS.Vector): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setPosition")(body.asInstanceOf[js.Any], position.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def setVelocity(body: BodyType, velocity: typingsJapgolly.phaser.MatterJS.Vector): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setVelocity")(body.asInstanceOf[js.Any], velocity.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def setVertices(body: BodyType, vertices: js.Array[typingsJapgolly.phaser.MatterJS.Vector]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setVertices")(body.asInstanceOf[js.Any], vertices.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def translate(body: BodyType, translation: typingsJapgolly.phaser.MatterJS.Vector): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("translate")(body.asInstanceOf[js.Any], translation.asInstanceOf[js.Any])).asInstanceOf[Unit]
