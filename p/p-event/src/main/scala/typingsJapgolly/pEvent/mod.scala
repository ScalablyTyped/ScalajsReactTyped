...
object mod {
  ...
  object Emitter {
    ...
    extension [Self <: Emitter[?, ?], EventName /* <: String | js.Symbol */, EmittedType /* <: js.Array[Any] */](x: Self & (Emitter[EventName, EmittedType])) {
      ...
      inline def setAddEventListener(value: (EventName, /* listener */ js.Function1[EmittedType, Unit]) => Callback): Self = StObject.set(x, "addEventListener", js.Any.fromFunction2((t0: EventName, t1: /* listener */ js.Function1[EmittedType, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setAddEventListenerUndefined: Self = StObject.set(x, "addEventListener", js.undefined)
      
      inline def setAddListener(value: (EventName, /* listener */ js.Function1[EmittedType, Unit]) => Callback): Self = StObject.set(x, "addListener", js.Any.fromFunction2((t0: EventName, t1: /* listener */ js.Function1[EmittedType, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setAddListenerUndefined: Self = StObject.set(x, "addListener", js.undefined)
      
      inline def setOff(value: (EventName, /* listener */ js.Function1[EmittedType, Unit]) => Callback): Self = StObject.set(x, "off", js.Any.fromFunction2((t0: EventName, t1: /* listener */ js.Function1[EmittedType, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setOffUndefined: Self = StObject.set(x, "off", js.undefined)
      
      inline def setOn(value: (EventName, /* listener */ js.Function1[EmittedType, Unit]) => Callback): Self = StObject.set(x, "on", js.Any.fromFunction2((t0: EventName, t1: /* listener */ js.Function1[EmittedType, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setOnUndefined: Self = StObject.set(x, "on", js.undefined)
      
      inline def setRemoveEventListener(value: (EventName, /* listener */ js.Function1[EmittedType, Unit]) => Callback): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction2((t0: EventName, t1: /* listener */ js.Function1[EmittedType, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setRemoveEventListenerUndefined: Self = StObject.set(x, "removeEventListener", js.undefined)
      
      inline def setRemoveListener(value: (EventName, /* listener */ js.Function1[EmittedType, Unit]) => Callback): Self = StObject.set(x, "removeListener", js.Any.fromFunction2((t0: EventName, t1: /* listener */ js.Function1[EmittedType, Unit]) => (value(t0, t1)).runNow()))
