...
import typingsJapgolly.page.anon.PartialOptions
...
object PageJS {
  ...
  trait Static extends StObject {
    ...
    /**
      ...
      * @type {Context}
      */
    var Context: typingsJapgolly.page.PageJS.Context = js.native
    
    /**
      * Expose Route
      * @type {Route}
      */
    var Route: typingsJapgolly.page.PageJS.Route = js.native
