...
import typingsJapgolly.pdfkit.PDFKit.Mixins.OpenTypeFeatures
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined parent pdfmake.pdfmake/interfaces.ContentBase */
/* Inlined parent pdfmake.pdfmake/interfaces.ForbidOtherElementProperties<'text'> */
trait ContentAnchor
  extends StObject
     with _Content {
  ...
  /**
    ...
    */
  var text: String | ContentAnchor | (js.Array[String | ContentAnchor])
...
object ContentAnchor {
  ...
  inline def apply(id: String, text: String | ContentAnchor | (js.Array[String | ContentAnchor])): ContentAnchor = {
  ...
  extension [Self <: ContentAnchor](x: Self) {
    ...
    inline def setText(value: String | ContentAnchor | (js.Array[String | ContentAnchor])): Self = StObject.set(x, "text", value.asInstanceOf[js.Any])
    
    inline def setTextVarargs(value: (String | ContentAnchor)*): Self = StObject.set(x, "text", js.Array(value*))
