...
object BufferOptions {
  ...
  extension [Self <: BufferOptions](x: Self) {
    ...
    inline def setProgressCallback(value: /* progress */ Double => Callback): Self = StObject.set(x, "progressCallback", js.Any.fromFunction1((t0: /* progress */ Double) => value(t0).runNow()))
