...
import typingsJapgolly.passportAzureAd.commonMod.IBaseStrategyOption
import typingsJapgolly.passportAzureAd.commonMod.ITokenPayload
import typingsJapgolly.passportAzureAd.commonMod.VerifyCallback
