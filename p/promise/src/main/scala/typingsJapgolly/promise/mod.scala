package typingsJapgolly.promise

import org.scalablytyped.runtime.Instantiable1
import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.promise.promiseStrings.fulfilled
import typingsJapgolly.promise.promiseStrings.rejected
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.promise.mod.PromiseFulfilledResult[T]
    - typingsJapgolly.promise.mod.PromiseRejectedResult
  */
  trait PromiseSettledResult[T] extends StObject
  object PromiseSettledResult {
    
    inline def PromiseFulfilledResult[T](value: T): typingsJapgolly.promise.mod.PromiseFulfilledResult[T] = {
      val __obj = js.Dynamic.literal(status = "fulfilled", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.promise.mod.PromiseFulfilledResult[T]]
    }
    
    inline def PromiseRejectedResult(reason: Any): typingsJapgolly.promise.mod.PromiseRejectedResult = {
      val __obj = js.Dynamic.literal(reason = reason.asInstanceOf[js.Any], status = "rejected")
      __obj.asInstanceOf[typingsJapgolly.promise.mod.PromiseRejectedResult]
    }
  }
