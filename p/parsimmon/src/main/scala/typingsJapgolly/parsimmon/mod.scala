...
import typingsJapgolly.parsimmon.parsimmonInts.`-1`
...
object mod {
  ...
  */
  ...
  object Reply {
    ...
    inline def FailureReply(expected: js.Array[String], furthest: Double, value: Null): typingsJapgolly.parsimmon.mod.FailureReply = {
      val __obj = js.Dynamic.literal(expected = expected.asInstanceOf[js.Any], furthest = furthest.asInstanceOf[js.Any], index = -1, status = false, value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.parsimmon.mod.FailureReply]
    }
    
    inline def SuccessReply[T](expected: js.Array[String], index: Double, value: T): typingsJapgolly.parsimmon.mod.SuccessReply[T] = {
      ...
      __obj.asInstanceOf[typingsJapgolly.parsimmon.mod.SuccessReply[T]]
    }
  }
  ...
  */
  ...
  object Result {
    ...
    inline def Failure(expected: js.Array[String], index: Index_): typingsJapgolly.parsimmon.mod.Failure = {
      val __obj = js.Dynamic.literal(expected = expected.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], status = false)
      __obj.asInstanceOf[typingsJapgolly.parsimmon.mod.Failure]
    }
    
    inline def Success[T](value: T): typingsJapgolly.parsimmon.mod.Success[T] = {
      val __obj = js.Dynamic.literal(status = true, value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.parsimmon.mod.Success[T]]
    }
  }
