...
import typingsJapgolly.pngjs.anon.Blue
import typingsJapgolly.pngjs.anon.FnCall
import typingsJapgolly.pngjs.anon.Read
import typingsJapgolly.pngjs.pngjsInts.`16`
import typingsJapgolly.pngjs.pngjsInts.`1`
import typingsJapgolly.pngjs.pngjsInts.`2`
import typingsJapgolly.pngjs.pngjsInts.`3`
import typingsJapgolly.pngjs.pngjsInts.`4`
import typingsJapgolly.pngjs.pngjsInts.`8`
...
object mod {
  ...
  */
  ...
  - typingsJapgolly.pngjs.mod.Metadata because var conflicts: height, width. Inlined alpha, bpp, color, colorType, depth, interlace, palette */ @js.native
