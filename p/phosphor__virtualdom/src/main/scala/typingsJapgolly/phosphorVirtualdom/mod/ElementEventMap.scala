...
trait ElementEventMap extends js.Object {
  ...
  var ondurationchange: Event_
  var onemptied: Event_
  var onended: MediaStreamErrorEvent
  var onerror: ErrorEvent
  var onfocus: FocusEvent
  var oninput: Event_
  var oninvalid: Event_
  var onkeydown: KeyboardEvent
  var onkeypress: KeyboardEvent
  var onkeyup: KeyboardEvent
  var onload: Event_
  var onloadeddata: Event_
  var onloadedmetadata: Event_
  var onloadend: Event_
  var onloadstart: Event_
  ...
  var onratechange: Event_
  var onreset: Event_
  var onscroll: UIEvent
  var onseeked: Event_
  var onseeking: Event_
  var onselect: UIEvent
  var onselectstart: Event_
  var onstalled: Event_
  var onsubmit: Event_
  var onsuspend: Event_
  var ontimeupdate: Event_
  var onvolumechange: Event_
  var onwaiting: Event_
}
