...
import typingsJapgolly.promClient.mod.Histogram.Internal
...
object Histogram {
  ...
  object Internal {
    ...
    inline def apply[T /* <: String */](
      ...
      startTimer: CallbackTo[js.Function1[/* labels */ js.UndefOr[LabelValues[T]], Unit]]
    ): Internal[T] = {
    ...
    extension [Self <: Internal[?], T /* <: String */](x: Self & Internal[T]) {
      ...
      inline def setStartTimer(value: CallbackTo[js.Function1[/* labels */ js.UndefOr[LabelValues[T]], Unit]]): Self = StObject.set(x, "startTimer", value.toJsFn)
    }
  }
}
