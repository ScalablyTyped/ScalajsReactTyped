...
import typingsJapgolly.promClient.mod.Summary.Internal
...
object Summary {
  ...
  object Internal {
    ...
    inline def apply[T /* <: String */](
      ...
      startTimer: CallbackTo[js.Function1[/* labels */ js.UndefOr[LabelValues[T]], Double]]
    ): Internal[T] = {
      val __obj = js.Dynamic.literal(observe = js.Any.fromFunction1((t0: Double) => observe(t0).runNow()), startTimer = startTimer.toJsFn)
      __obj.asInstanceOf[Internal[T]]
    }
    
    extension [Self <: Internal[?], T /* <: String */](x: Self & Internal[T]) {
      
      inline def setObserve(value: Double => Callback): Self = StObject.set(x, "observe", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setStartTimer(value: CallbackTo[js.Function1[/* labels */ js.UndefOr[LabelValues[T]], Double]]): Self = StObject.set(x, "startTimer", value.toJsFn)
    }
  }
}
