...
import typingsJapgolly.prosemirrorModel.anon.A
import typingsJapgolly.prosemirrorModel.anon.ContentDOM
import typingsJapgolly.prosemirrorModel.anon.Document
import typingsJapgolly.prosemirrorModel.anon.Index
import typingsJapgolly.prosemirrorModel.anon.Offset
import typingsJapgolly.prosemirrorModel.prosemirrorModelBooleans.`false`
import typingsJapgolly.prosemirrorModel.prosemirrorModelStrings.full
import typingsJapgolly.prosemirrorModel.prosemirrorModelStrings.normal
import typingsJapgolly.prosemirrorModel.prosemirrorModelStrings.pre
  ...
  */
  ...
  open class Schema[Nodes /* <: String */, Marks /* <: String */] protected () extends StObject {
    ...
    /**
      ...
      */
    var marks: (/* import warning: importer.ImportType#apply Failed type conversion: {readonly [ name in Marks ]: prosemirror-model.prosemirror-model.MarkType} */ js.Any) & StringDictionary[MarkType] = js.native
    ...
    /**
      ...
      */
    var nodes: (/* import warning: importer.ImportType#apply Failed type conversion: {readonly [ name in Nodes ]: prosemirror-model.prosemirror-model.NodeType} */ js.Any) & StringDictionary[NodeType] = js.native
    ...
    /**
      ...
      (not raw objects).
      */
    var spec: typingsJapgolly.prosemirrorModel.anon.Marks = js.native
  ...
  */
  ...
  object Mark {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(addToSet = js.Any.fromFunction1(addToSet), attrs = attrs.asInstanceOf[js.Any], isInSet = js.Any.fromFunction1(isInSet), removeFromSet = js.Any.fromFunction1(removeFromSet), toJSON = toJSON.toJsFn)
  ...
  */
  ...
  trait Node extends StObject {
    ...
    /**
      ...
      node.
      */
    def childAfter(pos: Double): typingsJapgolly.prosemirrorModel.anon.Node = js.native
    ...
    /**
      ...
      node.
      */
    def childBefore(pos: Double): typingsJapgolly.prosemirrorModel.anon.Node = js.native
  ...
  */
  trait SchemaSpec[Nodes /* <: String */, Marks /* <: String */] extends StObject {
    ...
    var marks: js.UndefOr[
        (/* import warning: importer.ImportType#apply Failed type conversion: {[ name in Marks ]: prosemirror-model.prosemirror-model.MarkSpec} */ js.Any) | default[MarkSpec]
      ] = js.undefined
    ...
    /**
      ...
      */
    var nodes: (/* import warning: importer.ImportType#apply Failed type conversion: {[ name in Nodes ]: prosemirror-model.prosemirror-model.NodeSpec} */ js.Any) | default[NodeSpec]
  ...
  object SchemaSpec {
    ...
    inline def apply[Nodes /* <: String */, Marks /* <: String */](
      nodes: (/* import warning: importer.ImportType#apply Failed type conversion: {[ name in Nodes ]: prosemirror-model.prosemirror-model.NodeSpec} */ js.Any) | default[NodeSpec]
    ...
    extension [Self <: SchemaSpec[?, ?], Nodes /* <: String */, Marks /* <: String */](x: Self & (SchemaSpec[Nodes, Marks])) {
      ...
      inline def setNodes(
        value: (/* import warning: importer.ImportType#apply Failed type conversion: {[ name in Nodes ]: prosemirror-model.prosemirror-model.NodeSpec} */ js.Any) | default[NodeSpec]
