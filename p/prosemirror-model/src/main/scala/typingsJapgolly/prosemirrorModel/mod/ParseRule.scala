...
object ParseRule {
  ...
  def apply(
    ...
    context: String = null,
    getAttrs: /* p */ org.scalajs.dom.raw.Node | String => CallbackTo[js.UndefOr[StringDictionary[js.Any] | `false` | Null]] = null,
    getContent: (/* p */ org.scalajs.dom.raw.Node, /* schema */ js.Any) => CallbackTo[Fragment[js.Any]] = null,
    ...
    if (getAttrs != null) __obj.updateDynamic("getAttrs")(js.Any.fromFunction1((t0: /* p */ org.scalajs.dom.raw.Node | java.lang.String) => getAttrs(t0).runNow()))
    if (getContent != null) __obj.updateDynamic("getContent")(js.Any.fromFunction2((t0: /* p */ org.scalajs.dom.raw.Node, t1: /* schema */ js.Any) => getContent(t0, t1).runNow()))
