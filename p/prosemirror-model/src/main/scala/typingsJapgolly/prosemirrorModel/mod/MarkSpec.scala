...
object MarkSpec {
  ...
  /* key */ StringDictionary[js.Any] = null,
    ...
    toDOM: (/* mark */ Mark[js.Any], /* inline */ Boolean) => CallbackTo[DOMOutputSpec] = null
  ): MarkSpec = {
    ...
    if (toDOM != null) __obj.updateDynamic("toDOM")(js.Any.fromFunction2((t0: /* mark */ typingsJapgolly.prosemirrorModel.mod.Mark[js.Any], t1: /* inline */ scala.Boolean) => toDOM(t0, t1).runNow()))
