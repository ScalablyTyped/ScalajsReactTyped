package typingsJapgolly.piwikReactRouter
...
object mod {
  ...
  object PiwikReactRouter {
    ...
    inline def apply(
      ...
      disconnectFromHistory: CallbackTo[Boolean],
      push: Any => Callback,
      setUserId: String => Callback,
      track: PiwikReactRouterTrack => Callback,
      trackError: (PiwikReactRouterTrackErrorEvent, String) => Callback
    ): PiwikReactRouter = {
      val __obj = js.Dynamic.literal(_isShim = _isShim.asInstanceOf[js.Any], connectToHistory = js.Any.fromFunction2(connectToHistory), disconnectFromHistory = disconnectFromHistory.toJsFn, push = js.Any.fromFunction1((t0: Any) => push(t0).runNow()), setUserId = js.Any.fromFunction1((t0: String) => setUserId(t0).runNow()), track = js.Any.fromFunction1((t0: PiwikReactRouterTrack) => track(t0).runNow()), trackError = js.Any.fromFunction2((t0: PiwikReactRouterTrackErrorEvent, t1: String) => (trackError(t0, t1)).runNow()))
    ...
    extension [Self <: PiwikReactRouter](x: Self) {
      ...
      inline def setDisconnectFromHistory(value: CallbackTo[Boolean]): Self = StObject.set(x, "disconnectFromHistory", value.toJsFn)
      
      inline def setPush(value: Any => Callback): Self = StObject.set(x, "push", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def setSetUserId(value: String => Callback): Self = StObject.set(x, "setUserId", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setTrack(value: PiwikReactRouterTrack => Callback): Self = StObject.set(x, "track", js.Any.fromFunction1((t0: PiwikReactRouterTrack) => value(t0).runNow()))
      
      inline def setTrackError(value: (PiwikReactRouterTrackErrorEvent, String) => Callback): Self = StObject.set(x, "trackError", js.Any.fromFunction2((t0: PiwikReactRouterTrackErrorEvent, t1: String) => (value(t0, t1)).runNow()))
  ...
  object PiwikReactRouterHistory {
    ...
    extension [Self <: PiwikReactRouterHistory](x: Self) {
      ...
      inline def setListen(value: /* location */ String => Callback): Self = StObject.set(x, "listen", js.Any.fromFunction1((t0: /* location */ String) => value(t0).runNow()))
