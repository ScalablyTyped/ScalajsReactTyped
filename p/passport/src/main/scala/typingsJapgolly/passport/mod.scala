package typingsJapgolly.passport

import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.express.mod.Handler
import typingsJapgolly.express.mod.Request_
import typingsJapgolly.node.httpMod.IncomingMessage
import typingsJapgolly.passport.anon.Dictkey
import typingsJapgolly.passport.anon.FamilyName
import typingsJapgolly.passport.anon.Instantiable
import typingsJapgolly.passport.anon.KeepSessionInfo
import typingsJapgolly.passport.anon.PauseStream
import typingsJapgolly.passport.anon.Type
import typingsJapgolly.passport.anon.UserProperty
import typingsJapgolly.passport.anon.Value
import typingsJapgolly.passport.anon.`0`
import typingsJapgolly.passport.mod.global.Express.User
import typingsJapgolly.passport.passportBooleans.`false`
