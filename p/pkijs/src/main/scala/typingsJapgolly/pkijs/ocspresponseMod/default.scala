...
class default () extends OCSPResponse {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createForCertificate(certificate: typingsJapgolly.pkijs.certificateMod.default, parameters: CreateFroCertificateParams): js.Thenable[Unit] = js.native
  /* CompleteClass */
