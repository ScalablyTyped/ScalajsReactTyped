...
class default () extends SingleResponse {
  ...
  /* CompleteClass */
  override var certID: typingsJapgolly.pkijs.certIDMod.default = js.native
  /* CompleteClass */
  override var certStatus: js.Any = js.native
  /* CompleteClass */
  override var singleExtensions: js.Array[typingsJapgolly.pkijs.extensionMod.default] = js.native
  /* CompleteClass */
