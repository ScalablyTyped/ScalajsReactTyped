...
trait SignedDataVerifyResult extends StObject {
  
  var certificatePath: js.Array[Certificate]
...
object SignedDataVerifyResult {
  
  inline def apply(certificatePath: js.Array[Certificate], message: String): SignedDataVerifyResult = {
    val __obj = js.Dynamic.literal(certificatePath = certificatePath.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any])
