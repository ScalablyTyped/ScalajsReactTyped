...
import typingsJapgolly.asn1js.mod.BmpString
import typingsJapgolly.asn1js.mod.CharacterString
import typingsJapgolly.asn1js.mod.GeneralString
import typingsJapgolly.asn1js.mod.GraphicString
import typingsJapgolly.asn1js.mod.IA5String
import typingsJapgolly.asn1js.mod.NumericString
import typingsJapgolly.asn1js.mod.OctetString
import typingsJapgolly.asn1js.mod.OctetStringJson
import typingsJapgolly.asn1js.mod.PrintableString
import typingsJapgolly.asn1js.mod.TeletexString
import typingsJapgolly.asn1js.mod.UniversalString
import typingsJapgolly.asn1js.mod.Utf8String
import typingsJapgolly.asn1js.mod.VideotexString
import typingsJapgolly.asn1js.mod.VisibleString
import typingsJapgolly.pkijs.anon.AttrCertValidityPeriod
import typingsJapgolly.pkijs.anon.Attributes
import typingsJapgolly.pkijs.anon.BaseCertificateID
import typingsJapgolly.pkijs.anon.Certs
import typingsJapgolly.pkijs.anon.Coefficient
import typingsJapgolly.pkijs.anon.Content
import typingsJapgolly.pkijs.anon.Critical
import typingsJapgolly.pkijs.anon.CrlExtensions
import typingsJapgolly.pkijs.anon.Crls
import typingsJapgolly.pkijs.anon.Date
import typingsJapgolly.pkijs.anon.Digest
import typingsJapgolly.pkijs.anon.EContent
import typingsJapgolly.pkijs.anon.FailInfo
import typingsJapgolly.pkijs.anon.GeneralTimeName
import typingsJapgolly.pkijs.anon.HashAlgorithm
import typingsJapgolly.pkijs.anon.HashedMessage
import typingsJapgolly.pkijs.anon.Id
import typingsJapgolly.pkijs.anon.Issuer
import typingsJapgolly.pkijs.anon.Iterations
import typingsJapgolly.pkijs.anon.Micros
import typingsJapgolly.pkijs.anon.NotAfter
import typingsJapgolly.pkijs.anon.NotAfterTime
import typingsJapgolly.pkijs.anon.Other
import typingsJapgolly.pkijs.anon.ProducedAt
import typingsJapgolly.pkijs.anon.RepeatedSequence
import typingsJapgolly.pkijs.anon.RequestExtensions
import typingsJapgolly.pkijs.anon.Response
import typingsJapgolly.pkijs.anon.SchemaCompatibleparsingEr
import typingsJapgolly.pkijs.anon.SetName
import typingsJapgolly.pkijs.anon.SignatureAlgorithm
import typingsJapgolly.pkijs.anon.TagNumber
import typingsJapgolly.pkijs.anon.Type
import typingsJapgolly.pkijs.anon.Value
import typingsJapgolly.pkijs.mod.^
import typingsJapgolly.pkijs.pkijsBooleans.`true`
...
type AlgorithmIdentifierSchema = SchemaParameters[typingsJapgolly.pkijs.anon.AlgorithmIdentifier]
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.pkijs.mod.PrivateKeyInfoJson
  - org.scalajs.dom.JsonWebKey
  - typingsJapgolly.pkijs.mod.PKCS8ShroudedKeyBagJson
  - typingsJapgolly.pkijs.mod.CertBagJson
  - typingsJapgolly.pkijs.mod.CRLBagJson
  - typingsJapgolly.pkijs.mod.SecretBagJson
  - typingsJapgolly.pkijs.mod.SafeContentsJson
*/
...
type EncryptedContentInfoSchema = SchemaParameters[typingsJapgolly.pkijs.anon.ContentEncryptionAlgorithm]

type ExtensionParsedValue = SchemaCompatibleparsingEr | SchemaType

type ExtensionSchema = SchemaParameters[Critical]

type ExtensionsSchema = SchemaParameters[typingsJapgolly.pkijs.anon.Extension]
...
type GeneralNamesSchema = SchemaParameters[typingsJapgolly.pkijs.anon.GeneralNames]
...
type KeyAgreeRecipientIdentifierSchema = SchemaParameters[typingsJapgolly.pkijs.anon.IssuerAndSerialNumber]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.pkijs.anon.PrivateKey
*/
...
type PublicKeyInfoSchema = SchemaParameters[typingsJapgolly.pkijs.anon.Algorithm]

type QCStatementSchema = SchemaParameters[Id]

type RecipientEncryptedKeysSchema = SchemaParameters[typingsJapgolly.pkijs.anon.RecipientEncryptedKeys]
...
type RequestSchema = SchemaParameters[typingsJapgolly.pkijs.anon.Extensions]
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.pkijs.mod.ContentInfo
  - typingsJapgolly.pkijs.mod.EncryptedData
  - typingsJapgolly.pkijs.mod.EnvelopedData
  - js.Object
*/
...
type SingleResponseSchema = SchemaParameters[typingsJapgolly.pkijs.anon.CertID]
