...
import typingsJapgolly.pkijs.anon.SafeContentsArray
...
trait AuthenticatedSafe
  ...
  def parseInternalValues(parameters: typingsJapgolly.pkijs.anon.SafeContents): js.Promise[Unit] = js.native
  def parseInternalValues(parameters: typingsJapgolly.pkijs.anon.SafeContents, crypto: ICryptoEngine): js.Promise[Unit] = js.native
}
