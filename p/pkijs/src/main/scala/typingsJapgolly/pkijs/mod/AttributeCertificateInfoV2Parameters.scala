...
import typingsJapgolly.pkijs.pkijsStrings.base64
import typingsJapgolly.pkijs.pkijsStrings.base64url
import typingsJapgolly.pkijs.pkijsStrings.hex
...
object AttributeCertificateInfoV2Parameters {
  ...
  extension [Self <: AttributeCertificateInfoV2Parameters](x: Self) {
    ...
    inline def setClassName(value: CallbackTo[String]): Self = StObject.set(x, "className", value.toJsFn)
    ...
    inline def setFromSchema(value: /* schema */ SchemaType => Callback): Self = StObject.set(x, "fromSchema", js.Any.fromFunction1((t0: /* schema */ SchemaType) => value(t0).runNow()))
    ...
    inline def setToJSON(value: CallbackTo[AttributeCertificateInfoV2Json]): Self = StObject.set(x, "toJSON", value.toJsFn)
    
    inline def setToJSONUndefined: Self = StObject.set(x, "toJSON", js.undefined)
    
    inline def setToSchema(value: CallbackTo[Sequence]): Self = StObject.set(x, "toSchema", value.toJsFn)
