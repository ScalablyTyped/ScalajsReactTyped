...
trait Pbkdf2HashAlgorithm
  ...
  var pbkdf2HashAlgorithm: org.scalajs.dom.Algorithm
}
object Pbkdf2HashAlgorithm {
  ...
  inline def apply(
    ...
    pbkdf2HashAlgorithm: org.scalajs.dom.Algorithm
  ): Pbkdf2HashAlgorithm = {
  ...
  extension [Self <: Pbkdf2HashAlgorithm](x: Self) {
    ...
    inline def setPbkdf2HashAlgorithm(value: org.scalajs.dom.Algorithm): Self = StObject.set(x, "pbkdf2HashAlgorithm", value.asInstanceOf[js.Any])
  }
}
