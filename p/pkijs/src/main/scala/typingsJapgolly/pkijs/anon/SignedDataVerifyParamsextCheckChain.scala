...
import typingsJapgolly.pkijs.mod.CertificateChainValidationEngine
import typingsJapgolly.pkijs.mod.FindIssuerCallback
import typingsJapgolly.pkijs.mod.FindOriginCallback
import typingsJapgolly.pkijs.mod.ICryptoEngine
import typingsJapgolly.pkijs.pkijsBooleans.`true`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined pkijs.pkijs.SignedDataVerifyParams & {  extendedMode :true} */
trait SignedDataVerifyParamsextCheckChain extends StObject {
  ...
  var extendedMode: js.UndefOr[Boolean] & `true`
...
object SignedDataVerifyParamsextCheckChain {
  
  inline def apply(extendedMode: js.UndefOr[Boolean] & `true`): SignedDataVerifyParamsextCheckChain = {
    val __obj = js.Dynamic.literal(extendedMode = extendedMode.asInstanceOf[js.Any])
    __obj.asInstanceOf[SignedDataVerifyParamsextCheckChain]
  }
  
  extension [Self <: SignedDataVerifyParamsextCheckChain](x: Self) {
    ...
    inline def setExtendedMode(value: js.UndefOr[Boolean] & `true`): Self = StObject.set(x, "extendedMode", value.asInstanceOf[js.Any])
