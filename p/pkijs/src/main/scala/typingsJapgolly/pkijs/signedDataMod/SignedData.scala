...
trait SignedData extends js.Object {
  var certificates: js.UndefOr[
    js.Array[
      typingsJapgolly.pkijs.certificateMod.default | typingsJapgolly.pkijs.otherCertificateFormatMod.default
    ]
  ] = js.native
  var crls: js.UndefOr[
    js.Array[
      typingsJapgolly.pkijs.certificateRevocationListMod.default | typingsJapgolly.pkijs.otherRevocationInfoFormatMod.default
    ]
  ] = js.native
  var digestAlgorithms: js.Array[typingsJapgolly.pkijs.algorithmIdentifierMod.default] = js.native
  var encapContentInfo: typingsJapgolly.pkijs.encapsulatedContentInfoMod.default = js.native
  var signerInfos: js.Array[typingsJapgolly.pkijs.signerInfoMod.default] = js.native
