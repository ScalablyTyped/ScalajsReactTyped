...
trait VerifyParams extends js.Object {
  ...
  var trustedCerts: js.UndefOr[js.Array[typingsJapgolly.pkijs.certificateMod.default]] = js.undefined
}
...
object VerifyParams {
  ...
  def apply(
    ...
    trustedCerts: js.Array[typingsJapgolly.pkijs.certificateMod.default] = null
  ): VerifyParams = {
