...
class default () extends KeyAgreeRecipientInfo {
  ...
  /* CompleteClass */
  override var originator: typingsJapgolly.pkijs.originatorIdentifierOrKeyMod.default = js.native
  /* CompleteClass */
  override var recipientCertificate: typingsJapgolly.pkijs.certificateMod.default = js.native
  /* CompleteClass */
  override var recipientEncryptedKeys: typingsJapgolly.pkijs.recipientEncryptedKeysMod.default = js.native
  /* CompleteClass */
