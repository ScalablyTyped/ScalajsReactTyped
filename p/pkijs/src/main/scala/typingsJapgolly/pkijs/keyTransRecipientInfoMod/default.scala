...
class default () extends KeyTransRecipientInfo {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var recipientCertificate: typingsJapgolly.pkijs.certificateMod.default = js.native
  /* CompleteClass */
  override var rid: typingsJapgolly.pkijs.recipientIdentifierMod.default = js.native
  /* CompleteClass */
