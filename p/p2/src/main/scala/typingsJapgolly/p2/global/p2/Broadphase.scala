...
open class Broadphase protected ()
  extends typingsJapgolly.p2.mod.Broadphase {
...
object Broadphase {
  ...
  inline def aabbCheck(bodyA: typingsJapgolly.p2.mod.Body, bodyB: typingsJapgolly.p2.mod.Body): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("aabbCheck")(bodyA.asInstanceOf[js.Any], bodyB.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def boundingRadiusCheck(bodyA: typingsJapgolly.p2.mod.Body, bodyB: typingsJapgolly.p2.mod.Body): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("boundingRadiusCheck")(bodyA.asInstanceOf[js.Any], bodyB.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def canCollide(bodyA: typingsJapgolly.p2.mod.Body, bodyB: typingsJapgolly.p2.mod.Body): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("canCollide")(bodyA.asInstanceOf[js.Any], bodyB.asInstanceOf[js.Any])).asInstanceOf[Boolean]
}
