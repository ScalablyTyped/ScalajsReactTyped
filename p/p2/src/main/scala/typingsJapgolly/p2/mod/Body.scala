...
import typingsJapgolly.p2.anon.OptimalDecomp
import typingsJapgolly.p2.anon.Type
import typingsJapgolly.p2.anon.`0`
import typingsJapgolly.p2.anon.`1`
...
object Body {
  ...
  @js.native
  def AWAKE: typingsJapgolly.p2.p2Ints.`0` = js.native
  inline def AWAKE_=(x: typingsJapgolly.p2.p2Ints.`0`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AWAKE")(x.asInstanceOf[js.Any])
  
  @JSImport("p2", "Body.DYNAMIC")
  @js.native
  def DYNAMIC: typingsJapgolly.p2.p2Ints.`1` = js.native
  inline def DYNAMIC_=(x: typingsJapgolly.p2.p2Ints.`1`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DYNAMIC")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def SLEEPY: typingsJapgolly.p2.p2Ints.`1` = js.native
  inline def SLEEPY_=(x: typingsJapgolly.p2.p2Ints.`1`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SLEEPY")(x.asInstanceOf[js.Any])
