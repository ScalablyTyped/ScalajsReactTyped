...
import typingsJapgolly.p2.anon.BodyA
import typingsJapgolly.p2.anon.BodyB
import typingsJapgolly.p2.anon.BodyType
import typingsJapgolly.p2.anon.ContactEquations
import typingsJapgolly.p2.anon.Pairs
import typingsJapgolly.p2.anon.Relaxation
import typingsJapgolly.p2.anon.ShapeA
import typingsJapgolly.p2.anon.`2`
import typingsJapgolly.p2.p2Booleans.`false`
...
open class World () extends EventEmitter {
  ...
  var addBodyEvent: typingsJapgolly.p2.anon.Body = js.native
  ...
  var addSpringEvent: typingsJapgolly.p2.anon.Spring = js.native
...
object World {
  ...
  @js.native
  def BODY_SLEEPING: typingsJapgolly.p2.p2Ints.`2` = js.native
  inline def BODY_SLEEPING_=(x: typingsJapgolly.p2.p2Ints.`2`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BODY_SLEEPING")(x.asInstanceOf[js.Any])
