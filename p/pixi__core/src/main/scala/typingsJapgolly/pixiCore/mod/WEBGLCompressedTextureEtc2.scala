...
trait WEBGLCompressedTextureEtc2 extends StObject {
...
object WEBGLCompressedTextureEtc2 {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[WEBGLCompressedTextureEtc2]
  }
  
  extension [Self <: WEBGLCompressedTextureEtc2](x: Self) {
