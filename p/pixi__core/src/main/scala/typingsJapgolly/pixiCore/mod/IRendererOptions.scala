...
import typingsJapgolly.pixiCore.pixiCoreStrings.notMultiplied
import typingsJapgolly.std.WebGLPowerPreference
...
trait IRendererOptions
  extends StObject
     with typingsJapgolly.pixiCore.GlobalMixins.IRendererOptions {
