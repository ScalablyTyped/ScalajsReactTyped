...
object typesMod {
  ...
  */
  ...
  object PromiseResult {
    ...
    inline def PromiseRejection[E](reason: E): typingsJapgolly.promiseAllsettled.typesMod.PromiseRejection[E] = {
      val __obj = js.Dynamic.literal(reason = reason.asInstanceOf[js.Any], status = "rejected")
      __obj.asInstanceOf[typingsJapgolly.promiseAllsettled.typesMod.PromiseRejection[E]]
    }
    
    inline def PromiseResolution[T](value: T): typingsJapgolly.promiseAllsettled.typesMod.PromiseResolution[T] = {
      val __obj = js.Dynamic.literal(status = "fulfilled", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.promiseAllsettled.typesMod.PromiseResolution[T]]
    }
  }
