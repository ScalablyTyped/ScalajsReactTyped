package typingsJapgolly.promiseAllsettled.mod

import typingsJapgolly.promiseAllsettled.FnCall
...
trait ExportedImplementationType extends js.Object {
  ...
  def apply[T /* <: Array[js.Any] */](iterable: PromiseTuple[T]): js.Promise[typingsJapgolly.promiseAllsettled.implementationMod.PromiseResultTuple[T]] = js.native
  def apply[T](iterable: Iterable[js.Promise[T] | T]): js.Promise[js.Array[typingsJapgolly.promiseAllsettled.typesMod.PromiseResult[T, _]]] = js.native
  ...
  def implementation[T /* <: Array[js.Any] */](iterable: PromiseTuple[T]): js.Promise[typingsJapgolly.promiseAllsettled.implementationMod.PromiseResultTuple[T]] = js.native
  def implementation[T](iterable: Iterable[js.Promise[T] | T]): js.Promise[js.Array[typingsJapgolly.promiseAllsettled.typesMod.PromiseResult[T, _]]] = js.native
