package typingsJapgolly.pgMinify
...
object mod {
  ...
  object parsingErrorCode extends StObject {
    ...
    /* 3 */ val multiLineQI: typingsJapgolly.pgMinify.mod.parsingErrorCode.multiLineQI & Double = js.native
    
    @js.native
    sealed trait unclosedMLC
      extends StObject
         with parsingErrorCode
    /* 0 */ val unclosedMLC: typingsJapgolly.pgMinify.mod.parsingErrorCode.unclosedMLC & Double = js.native
    ...
    sealed trait unclosedQI
      extends StObject
         with parsingErrorCode
    /* 2 */ val unclosedQI: typingsJapgolly.pgMinify.mod.parsingErrorCode.unclosedQI & Double = js.native
    ...
    sealed trait unclosedText
      extends StObject
         with parsingErrorCode
    /* 1 */ val unclosedText: typingsJapgolly.pgMinify.mod.parsingErrorCode.unclosedText & Double = js.native
  }
