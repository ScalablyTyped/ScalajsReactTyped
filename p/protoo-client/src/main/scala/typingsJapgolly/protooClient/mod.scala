package typingsJapgolly.protooClient

import typingsJapgolly.protooClient.anon.ClientConfig
import typingsJapgolly.protooClient.protooClientBooleans.`true`
import typingsJapgolly.protooClient.protooClientStrings.close
import typingsJapgolly.protooClient.protooClientStrings.disconnected
import typingsJapgolly.protooClient.protooClientStrings.failed
import typingsJapgolly.protooClient.protooClientStrings.notification
import typingsJapgolly.protooClient.protooClientStrings.open
import typingsJapgolly.protooClient.protooClientStrings.request
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.protooClient.anon.Data
    - typingsJapgolly.protooClient.anon.ErrorCode
  */
  trait ProtooResponse extends StObject
  object ProtooResponse {
    
    inline def Data(data: Any, id: Double): typingsJapgolly.protooClient.anon.Data = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], ok = true, response = true)
      __obj.asInstanceOf[typingsJapgolly.protooClient.anon.Data]
    }
    
    inline def ErrorCode(errorCode: Double, errorReason: String, id: Double): typingsJapgolly.protooClient.anon.ErrorCode = {
      ...
      __obj.asInstanceOf[typingsJapgolly.protooClient.anon.ErrorCode]
    }
  }
}
