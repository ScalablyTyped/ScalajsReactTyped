...
import typingsJapgolly.postcssModules.postcssModulesBooleans.`true`
import typingsJapgolly.postcssModules.postcssModulesStrings.camelCase
import typingsJapgolly.postcssModules.postcssModulesStrings.camelCaseOnly
import typingsJapgolly.postcssModules.postcssModulesStrings.dashes
import typingsJapgolly.postcssModules.postcssModulesStrings.dashesOnly
import typingsJapgolly.postcssModules.postcssModulesStrings.global
import typingsJapgolly.postcssModules.postcssModulesStrings.local
  ...
  trait Options extends StObject {
    ...
    var Loader: js.UndefOr[
        Instantiable2[
          ...
          typingsJapgolly.postcssModules.mod.Loader
        ]
      ] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setGetJSON(
        value: (/* cssFilename */ String, /* json */ StringDictionary[String], /* outputFilename */ js.UndefOr[String]) => Callback
      ): Self = StObject.set(x, "getJSON", js.Any.fromFunction3((t0: /* cssFilename */ String, t1: /* json */ StringDictionary[String], t2: /* outputFilename */ js.UndefOr[String]) => (value(t0, t1, t2)).runNow()))
