...
import typingsJapgolly.prismjs.mod.Environment
import typingsJapgolly.prismjs.mod.Grammar
import typingsJapgolly.prismjs.mod.HighlightCallback
import typingsJapgolly.prismjs.mod.Languages_
import typingsJapgolly.prismjs.mod.TokenStream
import typingsJapgolly.prismjs.mod.hooks.ElementEnvironment
import typingsJapgolly.prismjs.mod.hooks.ElementHighlightedEnvironment
import typingsJapgolly.prismjs.mod.hooks.HookCallback
import typingsJapgolly.prismjs.mod.hooks.RegisteredHooks
import typingsJapgolly.prismjs.mod.hooks.RequiredEnvironment
import typingsJapgolly.prismjs.mod.hooks.TokenizeEnvironment
import typingsJapgolly.prismjs.mod.util.Identifier
...
object global {
  ...
  object Prism {
    ...
    open class Token protected ()
      extends typingsJapgolly.prismjs.mod.Token {
      /**
        * Creates a new token.
        *
    ...
    object Token {
      ...
      inline def stringify(token: TokenStream, language: String, parent: js.Array[String | typingsJapgolly.prismjs.mod.Token]): String = (^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(token.asInstanceOf[js.Any], language.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[String]
    }
    ...
    inline def tokenize(text: String, grammar: Grammar): js.Array[String | typingsJapgolly.prismjs.mod.Token] = (^.asInstanceOf[js.Dynamic].applyDynamic("tokenize")(text.asInstanceOf[js.Any], grammar.asInstanceOf[js.Any])).asInstanceOf[js.Array[String | typingsJapgolly.prismjs.mod.Token]]
