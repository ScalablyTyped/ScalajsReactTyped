...
import typingsJapgolly.protocolBuffersSchema.anon.From
...
object typesMod {
  ...
  trait Enum extends StObject {
    ...
    var values: StringDictionary[typingsJapgolly.protocolBuffersSchema.anon.Options]
  }
  object Enum {
    ...
    inline def apply(
      name: String,
      options: Options,
      values: StringDictionary[typingsJapgolly.protocolBuffersSchema.anon.Options]
    ): Enum = {
    ...
    extension [Self <: Enum](x: Self) {
      ...
      inline def setValues(value: StringDictionary[typingsJapgolly.protocolBuffersSchema.anon.Options]): Self = StObject.set(x, "values", value.asInstanceOf[js.Any])
    }
  }
