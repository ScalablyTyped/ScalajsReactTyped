package typingsJapgolly.passportGithub
...
import typingsJapgolly.passportGithub.passportGithubBooleans.`true`
...
object mod {
  ...
  type Strategy = typingsJapgolly.passportOauth2.mod.Strategy
