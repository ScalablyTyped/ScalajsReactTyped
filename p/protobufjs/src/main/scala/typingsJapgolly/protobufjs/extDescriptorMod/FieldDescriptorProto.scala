...
/* Inlined protobufjs.protobufjs.Type & {  Label :protobufjs.protobufjs.Enum,   Type :protobufjs.protobufjs.Enum} */
object FieldDescriptorProto {
  
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.Label")
  @js.native
  def Label: Enum = js.native
  inline def Label_=(x: Enum): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Label")(x.asInstanceOf[js.Any])
  
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.Type")
  @js.native
  def Type: Enum = js.native
  inline def Type_=(x: Enum): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Type")(x.asInstanceOf[js.Any])
  ...
  /** Comment text, if any. */
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.comment")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.ctor")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.extensions")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.fieldsArray")
  @js.native
  val fieldsArray: js.Array[Field] = js.native
  
  /** Defining file name. */
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.filename")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.fullName")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.name")
  @js.native
  def name: String = js.native
  inline def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  /** Nested objects by name. */
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.nested")
  @js.native
  def nested: js.UndefOr[StringDictionary[ReflectionObject]] = js.native
  
  /** Nested objects of this namespace as an array for iteration. */
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.nestedArray")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.oneofsArray")
  @js.native
  val oneofsArray: js.Array[OneOf] = js.native
  
  /** Options. */
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.options")
  @js.native
  ...
  /** Parent namespace. */
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.parent")
  @js.native
  ...
  /** Parsed Options. */
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.parsedOptions")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.reserved")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.resolved")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldDescriptorProto.root")
  @js.native
