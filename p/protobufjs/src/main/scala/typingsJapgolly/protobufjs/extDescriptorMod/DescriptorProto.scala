...
object DescriptorProto {
  ...
  inline def ExtensionRange_=(x: Type): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ExtensionRange")(x.asInstanceOf[js.Any])
  
  @JSImport("protobufjs/ext/descriptor", "DescriptorProto.ReservedRange")
  @js.native
  def ReservedRange: Type = js.native
  inline def ReservedRange_=(x: Type): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ReservedRange")(x.asInstanceOf[js.Any])
