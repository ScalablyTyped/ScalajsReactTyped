...
object Namespace extends js.Object {
  /**
    ...
    */
  def arrayToJSON(array: js.Array[typingsJapgolly.protobufjs.mod.ReflectionObject]): js.UndefOr[StringDictionary[js.Any]] = js.native
  def arrayToJSON(array: js.Array[typingsJapgolly.protobufjs.mod.ReflectionObject], toJSONOptions: IToJSONOptions): js.UndefOr[StringDictionary[js.Any]] = js.native
  /**
    ...
    */
  def fromJSON(name: String, json: StringDictionary[js.Any]): typingsJapgolly.protobufjs.mod.Namespace = js.native
