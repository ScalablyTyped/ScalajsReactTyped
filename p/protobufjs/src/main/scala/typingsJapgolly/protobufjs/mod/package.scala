...
package object mod {
  ...
  type LoadCallback = js.Function2[
    ...
    /* root */ js.UndefOr[typingsJapgolly.protobufjs.mod.Root], 
    scala.Unit
  ]
  /**
  ...
  {[ P in keyof T ]:? T[P]}
    */ typingsJapgolly.protobufjs.protobufjsStrings.Properties with T
  /**
  ...
  type RPCImpl = js.Function3[
    /* method */ typingsJapgolly.protobufjs.mod.Method | (typingsJapgolly.protobufjs.mod.rpc.ServiceMethod[
      typingsJapgolly.protobufjs.mod.Message[js.Object], 
      typingsJapgolly.protobufjs.mod.Message[js.Object]
    ]), 
    /* requestData */ scala.scalajs.js.typedarray.Uint8Array, 
    /* callback */ typingsJapgolly.protobufjs.mod.RPCImplCallback, 
    scala.Unit
  ]
  /**
  ...
  /**
    ...
    */
  type TypeDecorator[T /* <: typingsJapgolly.protobufjs.mod.Message[T] */] = js.Function1[/* target */ typingsJapgolly.protobufjs.mod.Constructor[T], scala.Unit]
  /**
  ...
  type WrapperFromObjectConverter = js.ThisFunction1[
    /* this */ typingsJapgolly.protobufjs.mod.Type, 
  ...
  type WrapperToObjectConverter = js.ThisFunction2[
    /* this */ typingsJapgolly.protobufjs.mod.Type, 
    /* message */ typingsJapgolly.protobufjs.mod.Message[js.Object], 
    /* options */ js.UndefOr[typingsJapgolly.protobufjs.mod.IConversionOptions], 
