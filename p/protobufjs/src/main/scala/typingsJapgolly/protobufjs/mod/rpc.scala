...
import typingsJapgolly.protobufjs.mod.util.EventEmitter
...
object rpc {
  ...
  open class Service protected () extends EventEmitter {
    ...
    /**
      ...
      * @returns `this`
      */
    def end(): typingsJapgolly.protobufjs.mod.rpc.Service = js.native
    def end(endedByRPC: Boolean): typingsJapgolly.protobufjs.mod.rpc.Service = js.native
