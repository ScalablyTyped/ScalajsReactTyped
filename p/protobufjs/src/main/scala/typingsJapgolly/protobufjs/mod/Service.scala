...
open class Service protected () extends NamespaceBase {
  ...
  /**
    ...
    */
  def create(rpcImpl: RPCImpl): typingsJapgolly.protobufjs.mod.rpc.Service = js.native
  def create(rpcImpl: RPCImpl, requestDelimited: Boolean): typingsJapgolly.protobufjs.mod.rpc.Service = js.native
  def create(rpcImpl: RPCImpl, requestDelimited: Boolean, responseDelimited: Boolean): typingsJapgolly.protobufjs.mod.rpc.Service = js.native
  def create(rpcImpl: RPCImpl, requestDelimited: Unit, responseDelimited: Boolean): typingsJapgolly.protobufjs.mod.rpc.Service = js.native
