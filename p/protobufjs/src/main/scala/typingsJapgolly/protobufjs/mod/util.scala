...
object util {
  ...
  object LongBits {
    ...
    /**
      ...
      */
    /* static member */
    inline def from(value: typingsJapgolly.protobufjs.mod.Long): LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[LongBits]
  ...
  object base64 {
    ...
    @JSImport("protobufjs", "util.base64")
    @js.native
    val ^ : js.Any = js.native
  ...
  object float {
    ...
    @JSImport("protobufjs", "util.float")
    @js.native
    val ^ : js.Any = js.native
