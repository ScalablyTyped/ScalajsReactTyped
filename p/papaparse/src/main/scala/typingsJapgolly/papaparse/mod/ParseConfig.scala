...
import typingsJapgolly.papaparse.papaparseBooleans.`false`
import typingsJapgolly.papaparse.papaparseStrings.Carriagereturn
import typingsJapgolly.papaparse.papaparseStrings.CarriagereturnLinefeed
import typingsJapgolly.papaparse.papaparseStrings.Linefeed
...
object ParseConfig {
  ...
  extension [Self <: ParseConfig[?, ?], T, TInput](x: Self & (ParseConfig[T, TInput])) {
    ...
    inline def setComplete(value: (/* results */ ParseResult[T], /* file */ TInput) => Callback): Self = StObject.set(x, "complete", js.Any.fromFunction2((t0: /* results */ ParseResult[T], t1: /* file */ TInput) => (value(t0, t1)).runNow()))
    ...
    inline def setStep(value: (/* results */ ParseStepResult[T], /* parser */ Parser) => Callback): Self = StObject.set(x, "step", js.Any.fromFunction2((t0: /* results */ ParseStepResult[T], t1: /* parser */ Parser) => (value(t0, t1)).runNow()))
