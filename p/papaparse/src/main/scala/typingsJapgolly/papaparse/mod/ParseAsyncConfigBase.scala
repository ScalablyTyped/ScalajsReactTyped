...
object ParseAsyncConfigBase {
  ...
  extension [Self <: ParseAsyncConfigBase[?, ?], T, TInput](x: Self & (ParseAsyncConfigBase[T, TInput])) {
    ...
    inline def setChunk(value: (/* results */ ParseResult[T], /* parser */ Parser) => Callback): Self = StObject.set(x, "chunk", js.Any.fromFunction2((t0: /* results */ ParseResult[T], t1: /* parser */ Parser) => (value(t0, t1)).runNow()))
    ...
    inline def setError(value: (/* error */ js.Error, /* file */ TInput) => Callback): Self = StObject.set(x, "error", js.Any.fromFunction2((t0: /* error */ js.Error, t1: /* file */ TInput) => (value(t0, t1)).runNow()))
