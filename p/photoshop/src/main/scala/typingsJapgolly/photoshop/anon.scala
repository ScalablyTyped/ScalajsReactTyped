...
import typingsJapgolly.photoshop.domConstantsMod.ResampleMethod
import typingsJapgolly.photoshop.domCoreModulesMod.ActionDescriptor
import typingsJapgolly.photoshop.domCoreModulesMod.BatchPlayCommandOptions
import typingsJapgolly.photoshop.domCoreModulesMod.CPUInfo
import typingsJapgolly.photoshop.domCoreModulesMod.ColorConversionModel
import typingsJapgolly.photoshop.domCoreModulesMod.ExecuteAsModalOptions
import typingsJapgolly.photoshop.domCoreModulesMod.ExecutionContext
import typingsJapgolly.photoshop.domCoreModulesMod.GPUInfo
import typingsJapgolly.photoshop.domCoreModulesMod.NotificationListener
import typingsJapgolly.photoshop.domCoreModulesMod.Scheduling
import typingsJapgolly.photoshop.domObjectsMod.BMPSaveOptions
import typingsJapgolly.photoshop.domObjectsMod.GIFSaveOptions
import typingsJapgolly.photoshop.domObjectsMod.JPEGSaveOptions
import typingsJapgolly.photoshop.domObjectsMod.PNGSaveOptions
import typingsJapgolly.photoshop.domObjectsMod.PhotoshopSaveOptions
import typingsJapgolly.photoshop.photoshopStrings.angleUnit
import typingsJapgolly.photoshop.photoshopStrings.document
import typingsJapgolly.photoshop.utilColorTypesMod.ColorDescriptor
...
object anon {
  ...
  trait HistoryStateInfo extends StObject {
    ...
    var historyStateInfo: typingsJapgolly.photoshop.domCoreModulesMod.HistoryStateInfo
  }
  object HistoryStateInfo {
    
    inline def apply(historyStateInfo: typingsJapgolly.photoshop.domCoreModulesMod.HistoryStateInfo): HistoryStateInfo = {
    ...
    extension [Self <: HistoryStateInfo](x: Self) {
      ...
      inline def setHistoryStateInfo(value: typingsJapgolly.photoshop.domCoreModulesMod.HistoryStateInfo): Self = StObject.set(x, "historyStateInfo", value.asInstanceOf[js.Any])
    }
  }
  ...
  object ResumeHistory {
    ...
    inline def apply(resumeHistory: Double => Callback, suspendHistory: HistoryStateInfo => js.Promise[Double]): ResumeHistory = {
      val __obj = js.Dynamic.literal(resumeHistory = js.Any.fromFunction1((t0: Double) => resumeHistory(t0).runNow()), suspendHistory = js.Any.fromFunction1(suspendHistory))
      __obj.asInstanceOf[ResumeHistory]
    }
    
    extension [Self <: ResumeHistory](x: Self) {
      
      inline def setResumeHistory(value: Double => Callback): Self = StObject.set(x, "resumeHistory", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
