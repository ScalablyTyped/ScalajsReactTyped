...
import typingsJapgolly.photoshop.domActionsMod.ActionSet
import typingsJapgolly.photoshop.domCollectionsDocumentsMod.Documents
import typingsJapgolly.photoshop.domCollectionsTextFontsMod.TextFonts
import typingsJapgolly.photoshop.domConstantsMod.DialogModes
...
import typingsJapgolly.photoshop.domObjectsCreateOptionsMod.DocumentCreateOptions
import typingsJapgolly.photoshop.domObjectsSolidColorMod.SolidColor
import typingsJapgolly.photoshop.domObjectsToolMod.Tool
...
object domPhotoshopMod {
  ...
  open class Photoshop () extends StObject {
    ...
    /**
      ...
      * Allows for polyfills into the Action class
      */
    var Action: Instantiable1[/* id */ Double, typingsJapgolly.photoshop.domActionsMod.Action] = js.native
    
    /**
      * @ignore
      * Allows for polyfills into the Action Set class
      */
    var ActionSet: Instantiable1[/* id */ Any, typingsJapgolly.photoshop.domActionsMod.ActionSet] = js.native
    
    /**
      * @ignore
      * Allows for polyfills into the Document class
      */
    var Document: Instantiable1[/* id */ Double, typingsJapgolly.photoshop.domDocumentMod.Document] = js.native
    
    /**
      * @ignore
      * Allows for polyfills into the Layer class
      */
    var Layer: Instantiable2[/* id */ Double, /* docId */ Double, typingsJapgolly.photoshop.domLayerMod.Layer] = js.native
    
    /**
      * @ignore
      * Allows for polyfills into the Application object
      */
    var Photoshop: Instantiable0[typingsJapgolly.photoshop.domPhotoshopMod.Photoshop] = js.native
    
    /**
      * @ignore
      * Exposes SolidColor class for constructing objects
      */
    var SolidColor: Instantiable0[typingsJapgolly.photoshop.domObjectsSolidColorMod.SolidColor] = js.native
