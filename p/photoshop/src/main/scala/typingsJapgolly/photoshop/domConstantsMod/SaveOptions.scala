...
object SaveOptions extends StObject {
  ...
  sealed trait DONOTSAVECHANGES
    extends StObject
       with SaveOptions
  /* 0 */ val DONOTSAVECHANGES: typingsJapgolly.photoshop.domConstantsMod.SaveOptions.DONOTSAVECHANGES & Double = js.native
  ...
  sealed trait PROMPTTOSAVECHANGES
    extends StObject
       with SaveOptions
  /* 1 */ val PROMPTTOSAVECHANGES: typingsJapgolly.photoshop.domConstantsMod.SaveOptions.PROMPTTOSAVECHANGES & Double = js.native
  ...
  sealed trait SAVECHANGES
    extends StObject
       with SaveOptions
  /* 2 */ val SAVECHANGES: typingsJapgolly.photoshop.domConstantsMod.SaveOptions.SAVECHANGES & Double = js.native
}
