...
import typingsJapgolly.photoshop.anon.ClassID
import typingsJapgolly.photoshop.anon.CommandID
import typingsJapgolly.photoshop.anon.Height
import typingsJapgolly.photoshop.anon.MenuID
import typingsJapgolly.photoshop.anon.Message
import typingsJapgolly.photoshop.anon.TypeofphotoshopAction
import typingsJapgolly.photoshop.anon.TypeofphotoshopCore
...
import typingsJapgolly.photoshop.domPhotoshopMod.Photoshop
...
object mod {
  ...
  object app extends Shortcut {
    ...
    @js.native
    val ^ : typingsJapgolly.photoshop.domPhotoshopMod.Photoshop = js.native
    ...
    open class Action protected ()
      extends typingsJapgolly.photoshop.domActionsMod.Action {
      /**
        * @ignore
        */
    ...
    open class ActionSet protected ()
      extends typingsJapgolly.photoshop.domActionsMod.ActionSet {
      /**
        * @ignore
        */
    ...
    open class Document protected ()
      extends typingsJapgolly.photoshop.domDocumentMod.Document {
      /**
        * @ignore
        */
      def this(id: Double) = this()
    ...
    open class Layer protected ()
      extends typingsJapgolly.photoshop.domLayerMod.Layer {
      /**
        * @ignore
        */
    ...
    open class Photoshop ()
      extends typingsJapgolly.photoshop.domPhotoshopMod.Photoshop
    ...
    open class SolidColor ()
      extends typingsJapgolly.photoshop.domObjectsSolidColorMod.SolidColor
    
    type _To = typingsJapgolly.photoshop.domPhotoshopMod.Photoshop
    
    /* This means you don't have to write `^`, but can instead just say `app.foo` */
    override def _to: typingsJapgolly.photoshop.domPhotoshopMod.Photoshop = ^
  }
