...
import typingsJapgolly.photoshop.anon.Interpolation
import typingsJapgolly.photoshop.domCollectionsLayersMod.Layers
import typingsJapgolly.photoshop.domConstantsMod.AnchorPosition
import typingsJapgolly.photoshop.domConstantsMod.BlendMode
import typingsJapgolly.photoshop.domConstantsMod.ElementPlacement
import typingsJapgolly.photoshop.domConstantsMod.LayerKind
import typingsJapgolly.photoshop.domConstantsMod.RasterizeType
import typingsJapgolly.photoshop.domDocumentMod.Document
import typingsJapgolly.photoshop.domObjectsBoundsMod.Bounds
import typingsJapgolly.photoshop.photoshopStrings.both
import typingsJapgolly.photoshop.photoshopStrings.horizontal
import typingsJapgolly.photoshop.photoshopStrings.vertical
import typingsJapgolly.photoshop.utilUnitMod.AngleValue
import typingsJapgolly.photoshop.utilUnitMod.PercentValue
import typingsJapgolly.photoshop.utilUnitMod.PixelValue
...
object domLayerMod {
  ...
  object PSLayerKind extends StObject {
    ...
    sealed trait adjustment
      extends StObject
         with PSLayerKind
    /* 2 */ val adjustment: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.adjustment & Double = js.native
    
    @js.native
    sealed trait any
      extends StObject
         with PSLayerKind
    /* 0 */ val any: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.any & Double = js.native
    
    @js.native
    sealed trait background
      extends StObject
         with PSLayerKind
    /* 12 */ val background: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.background & Double = js.native
    
    @js.native
    sealed trait gradient
      extends StObject
         with PSLayerKind
    /* 9 */ val gradient: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.gradient & Double = js.native
    
    @js.native
    sealed trait group
      extends StObject
         with PSLayerKind
    /* 7 */ val group: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.group & Double = js.native
    
    @js.native
    sealed trait groupEnd
      extends StObject
         with PSLayerKind
    /* 13 */ val groupEnd: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.groupEnd & Double = js.native
    
    @js.native
    sealed trait pattern
      extends StObject
         with PSLayerKind
    /* 10 */ val pattern: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.pattern & Double = js.native
    
    @js.native
    sealed trait pixel
      extends StObject
         with PSLayerKind
    /* 1 */ val pixel: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.pixel & Double = js.native
    
    @js.native
    sealed trait smartObject
      extends StObject
         with PSLayerKind
    /* 5 */ val smartObject: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.smartObject & Double = js.native
    
    @js.native
    sealed trait solidColor
      extends StObject
         with PSLayerKind
    /* 11 */ val solidColor: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.solidColor & Double = js.native
    
    @js.native
    sealed trait text
      extends StObject
         with PSLayerKind
    /* 3 */ val text: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.text & Double = js.native
    
    @js.native
    sealed trait threeD
      extends StObject
         with PSLayerKind
    /* 8 */ val threeD: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.threeD & Double = js.native
    
    @js.native
    sealed trait vector
      extends StObject
         with PSLayerKind
    /* 4 */ val vector: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.vector & Double = js.native
    
    @js.native
    sealed trait video
      extends StObject
         with PSLayerKind
    /* 6 */ val video: typingsJapgolly.photoshop.domLayerMod.PSLayerKind.video & Double = js.native
  }
