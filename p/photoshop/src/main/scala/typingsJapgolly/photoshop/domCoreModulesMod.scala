...
import typingsJapgolly.photoshop.anon.Id
import typingsJapgolly.photoshop.anon.MenuID
import typingsJapgolly.photoshop.anon.Message
import typingsJapgolly.photoshop.anon.Name
import typingsJapgolly.photoshop.anon.ResumeHistory
import typingsJapgolly.photoshop.photoshopInts.`15`
import typingsJapgolly.photoshop.photoshopInts.`16`
import typingsJapgolly.photoshop.photoshopInts.`4`
import typingsJapgolly.photoshop.photoshopInts.`5`
import typingsJapgolly.photoshop.photoshopInts.`6`
import typingsJapgolly.photoshop.photoshopStrings.execute
import typingsJapgolly.photoshop.photoshopStrings.fail
import typingsJapgolly.photoshop.photoshopStrings.rosetta2
import typingsJapgolly.photoshop.photoshopStrings.wait
...
object domCoreModulesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.photoshop.photoshopStrings.Intel
    - typingsJapgolly.photoshop.photoshopStrings.AMD
    - typingsJapgolly.photoshop.photoshopStrings.ARM
    - typingsJapgolly.photoshop.photoshopStrings.Unknown
  */
  trait CPUVendorKind extends StObject
  object CPUVendorKind {
    
    inline def AMD: typingsJapgolly.photoshop.photoshopStrings.AMD = "AMD".asInstanceOf[typingsJapgolly.photoshop.photoshopStrings.AMD]
    
    inline def ARM: typingsJapgolly.photoshop.photoshopStrings.ARM = "ARM".asInstanceOf[typingsJapgolly.photoshop.photoshopStrings.ARM]
    
    inline def Intel: typingsJapgolly.photoshop.photoshopStrings.Intel = "Intel".asInstanceOf[typingsJapgolly.photoshop.photoshopStrings.Intel]
    
    inline def Unknown: typingsJapgolly.photoshop.photoshopStrings.Unknown = "Unknown".asInstanceOf[typingsJapgolly.photoshop.photoshopStrings.Unknown]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.photoshop.photoshopInts.`15`
    - typingsJapgolly.photoshop.photoshopInts.`4`
    - typingsJapgolly.photoshop.photoshopInts.`5`
    - typingsJapgolly.photoshop.photoshopInts.`6`
    - typingsJapgolly.photoshop.photoshopInts.`16`
  */
