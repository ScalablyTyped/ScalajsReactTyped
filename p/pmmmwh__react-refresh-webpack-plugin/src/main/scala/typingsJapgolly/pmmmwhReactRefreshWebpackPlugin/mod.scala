...
import typingsJapgolly.pmmmwhReactRefreshWebpackPlugin.typesLibTypesMod.NormalizedPluginOptions
import typingsJapgolly.pmmmwhReactRefreshWebpackPlugin.typesLibTypesMod.ReactRefreshPluginOptions
