...
import typingsJapgolly.peberminta.pebermintaBooleans.`false`
import typingsJapgolly.peberminta.pebermintaBooleans.`true`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.peberminta.mod.Match_[TValue]
    - typingsJapgolly.peberminta.mod.NonMatch
  */
  trait Result[TValue] extends StObject
  object Result {
    
    inline def Match_[TValue](position: Double, value: TValue): typingsJapgolly.peberminta.mod.Match_[TValue] = {
      val __obj = js.Dynamic.literal(matched = true, position = position.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.peberminta.mod.Match_[TValue]]
    }
    
    inline def NonMatch(): typingsJapgolly.peberminta.mod.NonMatch = {
      val __obj = js.Dynamic.literal(matched = false)
      __obj.asInstanceOf[typingsJapgolly.peberminta.mod.NonMatch]
    }
  }
}
