...
trait Placement extends StObject {
  ...
  var placement: typingsJapgolly.popperjsCore.libEnumsMod.Placement
...
object Placement {
  ...
  inline def apply(placement: typingsJapgolly.popperjsCore.libEnumsMod.Placement, popper: Rect, reference: Rect): Placement = {
