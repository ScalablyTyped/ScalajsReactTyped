...
trait PartialOptionsAllowedAutoPlacements extends StObject {
  ...
  var allowedAutoPlacements: js.UndefOr[js.Array[typingsJapgolly.popperjsCore.libEnumsMod.Placement]] = js.undefined
  ...
  var fallbackPlacements: js.UndefOr[js.Array[typingsJapgolly.popperjsCore.libEnumsMod.Placement]] = js.undefined
...
object PartialOptionsAllowedAutoPlacements {
  ...
  extension [Self <: PartialOptionsAllowedAutoPlacements](x: Self) {
    ...
    inline def setAllowedAutoPlacements(value: js.Array[typingsJapgolly.popperjsCore.libEnumsMod.Placement]): Self = StObject.set(x, "allowedAutoPlacements", value.asInstanceOf[js.Any])
    
    inline def setAllowedAutoPlacementsUndefined: Self = StObject.set(x, "allowedAutoPlacements", js.undefined)
    
    inline def setAllowedAutoPlacementsVarargs(value: typingsJapgolly.popperjsCore.libEnumsMod.Placement*): Self = StObject.set(x, "allowedAutoPlacements", js.Array(value*))
    ...
    inline def setFallbackPlacements(value: js.Array[typingsJapgolly.popperjsCore.libEnumsMod.Placement]): Self = StObject.set(x, "fallbackPlacements", value.asInstanceOf[js.Any])
    
    inline def setFallbackPlacementsUndefined: Self = StObject.set(x, "fallbackPlacements", js.undefined)
    
    inline def setFallbackPlacementsVarargs(value: typingsJapgolly.popperjsCore.libEnumsMod.Placement*): Self = StObject.set(x, "fallbackPlacements", js.Array(value*))
