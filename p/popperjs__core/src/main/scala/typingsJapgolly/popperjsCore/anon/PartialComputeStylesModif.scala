...
import typingsJapgolly.popperjsCore.libModifiersComputeStylesMod.Options
...
trait PartialComputeStylesModif
  extends StObject
  ...
  var name: js.UndefOr[computeStyles] = js.undefined
  
  var options: js.UndefOr[PartialOptionsAdaptive] = js.undefined
...
object PartialComputeStylesModif {
  ...
  inline def apply(): PartialComputeStylesModif = {
  ...
  extension [Self <: PartialComputeStylesModif](x: Self) {
    ...
    inline def setName(value: computeStyles): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    
    inline def setNameUndefined: Self = StObject.set(x, "name", js.undefined)
    
    inline def setOptions(value: PartialOptionsAdaptive): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
