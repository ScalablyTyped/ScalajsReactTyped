...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Network.ResourceTiming
...
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonSecurityDetailsMod.SecurityDetails
