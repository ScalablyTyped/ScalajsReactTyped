...
import typingsJapgolly.puppeteerCore.anon.BrowserConnectOptionsbrowBrowserURL
...
import typingsJapgolly.puppeteerCore.puppeteerCoreStrings.cdp
import typingsJapgolly.puppeteerCore.puppeteerCoreStrings.webDriverBiDi
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libEsmPuppeteerCommonBrowserConnectorMod {
  
  @JSImport("puppeteer-core/lib/esm/puppeteer/common/BrowserConnector", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def connectToCDPBrowser(options: BrowserConnectOptionsbrowBrowserURL): js.Promise[CDPBrowser] = ^.asInstanceOf[js.Dynamic].applyDynamic("_connectToCDPBrowser")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[CDPBrowser]]
