...
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonLifecycleWatcherMod.ProtocolLifeCycleEvent
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonLifecycleWatcherMod.PuppeteerLifeCycleEvent
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonTargetManagerMod.TargetManagerEmittedEvents
import typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonInputMod.MouseButton
import typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonUskeyboardlayoutMod._KeyInput
import typingsJapgolly.puppeteerCore.mod.ActionResult
import typingsJapgolly.puppeteerCore.mod.BrowserContextEmittedEvents
import typingsJapgolly.puppeteerCore.mod.BrowserEmittedEvents
import typingsJapgolly.puppeteerCore.mod.ChromeReleaseChannel
import typingsJapgolly.puppeteerCore.mod.ErrorCode
import typingsJapgolly.puppeteerCore.mod.LowerCasePaperFormat
import typingsJapgolly.puppeteerCore.mod.PageEmittedEvents
import typingsJapgolly.puppeteerCore.mod.Permission
import typingsJapgolly.puppeteerCore.mod.Platform
import typingsJapgolly.puppeteerCore.mod.Product
...
object puppeteerCoreStrings {
  ...
  sealed trait ^
    extends StObject
       with _KeyInput
       with typingsJapgolly.puppeteerCore.mod._KeyInput
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonUskeyboardlayoutMod._KeyInput
  ...
  - typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonUskeyboardlayoutMod._KeyInput because Already inherited
  - typingsJapgolly.puppeteerCore.mod._KeyInput because Already inherited
  - typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonUskeyboardlayoutMod._KeyInput because Already inherited */ @js.native
  sealed trait Comma
    extends StObject
       with _KeyInput
       with typingsJapgolly.puppeteerCore.mod._KeyInput
  ...
  sealed trait DOMContentLoaded
    extends StObject
       ...
       with typingsJapgolly.puppeteerCore.mod.ProtocolLifeCycleEvent
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonLifecycleWatcherMod.ProtocolLifeCycleEvent
  ...
  sealed trait a0
    extends StObject
       ...
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonPdfoptionsMod.LowerCasePaperFormat
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonPdfoptionsMod.LowerCasePaperFormat
  ...
  sealed trait abort_
    extends StObject
       with ActionResult
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonHttprequestMod.ActionResult
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonHttprequestMod.ActionResult
  ...
  sealed trait aborted
    extends StObject
       with ErrorCode
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonHttprequestMod.ErrorCode
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonHttprequestMod.ErrorCode
  ...
  sealed trait accelerometer
    extends StObject
       with Permission
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerApiBrowserMod.Permission
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerApiBrowserMod.Permission
  ...
  sealed trait assert
    extends StObject
       ...
       with typingsJapgolly.puppeteerCore.mod.ConsoleMessageType
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonConsoleMessageMod.ConsoleMessageType
  ...
  sealed trait back
    extends StObject
       with MouseButton
       with typingsJapgolly.puppeteerCore.mod.MouseButton
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonInputMod.MouseButton
  ...
  sealed trait chrome
    extends StObject
       ...
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerNodeLaunchOptionsMod.ChromeReleaseChannel
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerNodeLaunchOptionsMod.ChromeReleaseChannel
       with Product
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonProductMod.Product
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonProductMod.Product
  ...
  sealed trait close
    extends StObject
       ...
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerApiPageMod.PageEmittedEvents
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerApiPageMod.PageEmittedEvents
  ...
  sealed trait disconnected
    extends StObject
       ...
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerApiBrowserMod.BrowserEmittedEvents
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerApiBrowserMod.BrowserEmittedEvents
  ...
  sealed trait domcontentloaded_
    extends StObject
       ...
       with typingsJapgolly.puppeteerCore.mod.PuppeteerLifeCycleEvent
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonLifecycleWatcherMod.PuppeteerLifeCycleEvent
  ...
  sealed trait linux
    extends StObject
       with Platform
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerNodeBrowserFetcherMod.Platform
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerNodeBrowserFetcherMod.Platform
  ...
  sealed trait targetAvailable
    extends StObject
       ...
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonTargetManagerMod.TargetManagerEmittedEvents
  ...
  sealed trait targetchanged_
    extends StObject
       ...
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerApiBrowserMod.BrowserContextEmittedEvents
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerApiBrowserMod.BrowserContextEmittedEvents
       with BrowserEmittedEvents
       with typingsJapgolly.puppeteerCore.libEsmPuppeteerApiBrowserMod.BrowserEmittedEvents
       with typingsJapgolly.puppeteerCore.libCjsPuppeteerApiBrowserMod.BrowserEmittedEvents
