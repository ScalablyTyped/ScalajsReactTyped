...
object libCjsPuppeteerInjectedInjectedMod {
  ...
  object default {
    ...
    open class IntervalPoller[T] protected ()
      extends typingsJapgolly.puppeteerCore.libCjsPuppeteerInjectedPollerMod.IntervalPoller[T] {
      def this(
    ...
    val IntervalPoller: Instantiable2[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        /* ms */ Double, 
        typingsJapgolly.puppeteerCore.libCjsPuppeteerInjectedPollerMod.IntervalPoller[js.Object]
      ] = js.native
    ...
    open class MutationPoller[T] protected ()
      extends typingsJapgolly.puppeteerCore.libCjsPuppeteerInjectedPollerMod.MutationPoller[T] {
      def this(
        fn: js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]],
        root: Node
      ) = this()
    ...
    val MutationPoller: Instantiable2[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        /* root */ Node, 
        typingsJapgolly.puppeteerCore.libCjsPuppeteerInjectedPollerMod.MutationPoller[js.Object]
      ] = js.native
    ...
    open class RAFPoller[T] protected ()
      extends typingsJapgolly.puppeteerCore.libCjsPuppeteerInjectedPollerMod.RAFPoller[T] {
    ...
    val RAFPoller: Instantiable1[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        typingsJapgolly.puppeteerCore.libCjsPuppeteerInjectedPollerMod.RAFPoller[js.Object]
      ] = js.native
