...
import typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonFrameTreeMod.FrameTree
import typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonNetworkManagerMod.NetworkManager
import typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonTargetMod.Target
import typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonTimeoutSettingsMod.TimeoutSettings
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libEsmPuppeteerCommonFrameManagerMod {
  ...
  object FrameManagerEmittedEvents {
    ...
    @JSImport("puppeteer-core/lib/esm/puppeteer/common/FrameManager", "FrameManagerEmittedEvents.FrameSwapped")
    @js.native
