...
trait PuppeteerErrors extends StObject {
  ...
  var ProtocolError: Instantiable0[typingsJapgolly.puppeteerCore.mod.ProtocolError]
  
  var TimeoutError: Instantiable0[typingsJapgolly.puppeteerCore.mod.TimeoutError]
}
