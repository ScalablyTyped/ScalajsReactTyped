...
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonInputMod.MouseButton
...
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonTypesMod.HandleOr
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonTypesMod._HandleOr
