...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Fetch.RequestPausedEvent
...
object libCjsPuppeteerCommonNetworkEventManagerMod {
  
  @JSImport("puppeteer-core/lib/cjs/puppeteer/common/NetworkEventManager", "NetworkEventManager")
  @js.native
