...
@JSImport("puppeteer-core/lib/esm/puppeteer/types", "ChromeLauncher")
@js.native
open class ChromeLauncher protected ()
  extends typingsJapgolly.puppeteerCore.libEsmPuppeteerNodeChromeLauncherMod.ChromeLauncher {
