...
@JSImport("puppeteer-core/lib/esm/puppeteer/types", "FirefoxLauncher")
@js.native
open class FirefoxLauncher protected ()
  extends typingsJapgolly.puppeteerCore.libEsmPuppeteerNodeFirefoxLauncherMod.FirefoxLauncher {
