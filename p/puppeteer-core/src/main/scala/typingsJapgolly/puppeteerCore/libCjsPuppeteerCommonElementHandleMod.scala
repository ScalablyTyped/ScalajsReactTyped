...
import typingsJapgolly.puppeteerCore.libCjsPuppeteerApiPageMod.ScreenshotOptions
...
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonJshandleMod.BoundingBox
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonJshandleMod.BoxModel
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonJshandleMod.ClickOptions
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonJshandleMod.JSHandle
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonJshandleMod.Offset
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonJshandleMod.Point
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonJshandleMod.PressOptions
