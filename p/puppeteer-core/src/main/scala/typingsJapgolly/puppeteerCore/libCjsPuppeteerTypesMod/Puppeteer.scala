...
import typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonPuppeteerMod.CommonPuppeteerSettings
...
open class Puppeteer protected ()
  extends typingsJapgolly.puppeteerCore.libCjsPuppeteerPuppeteerCoreMod.Puppeteer {
  /**
    * @internal
    */
