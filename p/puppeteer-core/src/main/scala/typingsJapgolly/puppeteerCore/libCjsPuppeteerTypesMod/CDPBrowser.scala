...
import typingsJapgolly.puppeteerCore.libCjsPuppeteerApiBrowserMod.BrowserCloseCallback
...
open class CDPBrowser protected ()
  extends typingsJapgolly.puppeteerCore.libCjsPuppeteerCommonBrowserMod.CDPBrowser {
  /**
    * @internal
    */
  def this(
