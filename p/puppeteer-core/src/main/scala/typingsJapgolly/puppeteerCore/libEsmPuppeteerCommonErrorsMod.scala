...
object libEsmPuppeteerCommonErrorsMod {
  ...
  trait PuppeteerErrors extends StObject {
    ...
    var ProtocolError: Instantiable0[typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonErrorsMod.ProtocolError]
    
    var TimeoutError: Instantiable0[typingsJapgolly.puppeteerCore.libEsmPuppeteerCommonErrorsMod.TimeoutError]
  }
