package typingsJapgolly.postcssConvertValues

import typingsJapgolly.postcss.mod.Plugin
import typingsJapgolly.postcssConvertValues.postcssConvertValuesBooleans.`true`
...
object mod {
  ...
  trait Options
    extends StObject
       with typingsJapgolly.browserslist.mod.Options {
