...
import typingsJapgolly.picomatch.anon.Alnum
...
object libConstantsMod {
  ...
  inline def globChars[T /* <: Boolean */](win32: T): /* import warning: importer.ImportType#apply Failed type conversion: T extends true ? {  SLASH_LITERAL :string,   QMARK :string,   STAR :string,   DOTS_SLASH :string,   NO_DOT :string,   NO_DOTS :string,   NO_DOT_SLASH :string,   NO_DOTS_SLASH :string,   QMARK_NO_DOT :string,   START_ANCHOR :string,   END_ANCHOR :string} & typeof POSIX_CHARS : {  DOT_LITERAL :string,   PLUS_LITERAL :string,   QMARK_LITERAL :string,   SLASH_LITERAL :string,   ONE_CHAR :string,   QMARK :string,   END_ANCHOR :string,   DOTS_SLASH :string,   NO_DOT :string,   NO_DOTS :string,   NO_DOT_SLASH :string,   NO_DOTS_SLASH :string,   QMARK_NO_DOT :string,   STAR :string,   START_ANCHOR :string} */ js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("globChars")(win32.asInstanceOf[js.Any]).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: T extends true ? {  SLASH_LITERAL :string,   QMARK :string,   STAR :string,   DOTS_SLASH :string,   NO_DOT :string,   NO_DOTS :string,   NO_DOT_SLASH :string,   NO_DOTS_SLASH :string,   QMARK_NO_DOT :string,   START_ANCHOR :string,   END_ANCHOR :string} & typeof POSIX_CHARS : {  DOT_LITERAL :string,   PLUS_LITERAL :string,   QMARK_LITERAL :string,   SLASH_LITERAL :string,   ONE_CHAR :string,   QMARK :string,   END_ANCHOR :string,   DOTS_SLASH :string,   NO_DOT :string,   NO_DOTS :string,   NO_DOT_SLASH :string,   NO_DOTS_SLASH :string,   QMARK_NO_DOT :string,   STAR :string,   START_ANCHOR :string} */ js.Any]
}
