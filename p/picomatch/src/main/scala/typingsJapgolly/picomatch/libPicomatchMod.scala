...
object libPicomatchMod {
  ...
  object PicomatchOptions {
    ...
    extension [Self <: PicomatchOptions](x: Self) {
      ...
      inline def setOnIgnore(value: /* result */ Result => Callback): Self = StObject.set(x, "onIgnore", js.Any.fromFunction1((t0: /* result */ Result) => value(t0).runNow()))
      
      inline def setOnIgnoreUndefined: Self = StObject.set(x, "onIgnore", js.undefined)
      
      inline def setOnMatch(value: /* result */ Result => Callback): Self = StObject.set(x, "onMatch", js.Any.fromFunction1((t0: /* result */ Result) => value(t0).runNow()))
      
      inline def setOnMatchUndefined: Self = StObject.set(x, "onMatch", js.undefined)
      
      inline def setOnResult(value: /* result */ Result => Callback): Self = StObject.set(x, "onResult", js.Any.fromFunction1((t0: /* result */ Result) => value(t0).runNow()))
