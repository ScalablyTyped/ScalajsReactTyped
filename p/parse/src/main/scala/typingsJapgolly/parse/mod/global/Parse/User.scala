...
import typingsJapgolly.parse.mod.global.Parse.^
...
trait User[T /* <: Attributes */]
  ...
  def linkWith(provider: String, options: typingsJapgolly.parse.anon.AuthData): js.Promise[this.type] = js.native
  def linkWith(provider: String, options: typingsJapgolly.parse.anon.AuthData, saveOpts: FullOptions): js.Promise[this.type] = js.native
  def linkWith(provider: AuthProvider, options: typingsJapgolly.parse.anon.AuthData): js.Promise[this.type] = js.native
  def linkWith(provider: AuthProvider, options: typingsJapgolly.parse.anon.AuthData, saveOpts: FullOptions): js.Promise[this.type] = js.native
