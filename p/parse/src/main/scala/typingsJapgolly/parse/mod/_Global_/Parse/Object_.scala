...
import typingsJapgolly.parse.mod._Global_.Parse.Object.DestroyOptions
import typingsJapgolly.parse.mod._Global_.Parse.Object.FetchOptions
import typingsJapgolly.parse.mod._Global_.Parse.Object.SaveOptions
import typingsJapgolly.parse.mod._Global_.Parse.Object.SetOptions
import typingsJapgolly.parse.mod._Global_.Parse.Object.ToJSON
import typingsJapgolly.parse.parseBooleans.`false`
...
trait Object_[T /* <: Attributes */] extends js.Object {
  ...
  {[ key in K ]: T[key]}
    */ typingsJapgolly.parse.parseStrings.Object with T) | Partial[T]
