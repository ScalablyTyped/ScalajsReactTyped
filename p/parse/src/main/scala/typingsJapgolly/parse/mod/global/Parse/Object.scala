...
import typingsJapgolly.parse.mod.global.Parse.Object.DestroyOptions
import typingsJapgolly.parse.mod.global.Parse.Object.FetchOptions
import typingsJapgolly.parse.mod.global.Parse.Object.SaveOptions
import typingsJapgolly.parse.mod.global.Parse.Object.SetOptions
import typingsJapgolly.parse.mod.global.Parse.Object.ToJSON
...
trait Object[T /* <: Attributes */] extends StObject {
  ...
  def revert(keys: (Extract[typingsJapgolly.parse.parseStrings.ACL, String])*): Unit = js.native
...
object Object extends Shortcut {
  ...
  - typingsJapgolly.parse.mod.global.Parse.WaitOption because var conflicts: wait. Inlined  */ trait DestroyOptions
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.parse.mod.global.Parse.WaitOption because var conflicts: wait. Inlined  */ trait SaveOptions
    extends StObject
