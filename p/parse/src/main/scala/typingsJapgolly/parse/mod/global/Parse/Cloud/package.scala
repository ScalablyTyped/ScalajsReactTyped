...
import typingsJapgolly.parse.mod.global.Parse.Cloud.^
import typingsJapgolly.parse.mod.global.Parse.File
import typingsJapgolly.parse.mod.global.Parse.Object
import typingsJapgolly.parse.mod.global.Parse.Query
import typingsJapgolly.parse.mod.global.Parse.Session
...
inline def afterLogin(func: js.Function1[/* request */ TriggerRequest[User[Attributes]], PromiseLike[Unit] | Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("afterLogin")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
inline def afterLogin(
  func: js.Function1[/* request */ TriggerRequest[User[Attributes]], PromiseLike[Unit] | Unit],
  validator: js.Function1[/* request */ FunctionRequest[Params], Any]
...
inline def afterLogout(func: js.Function1[/* request */ TriggerRequest[Session[Attributes]], PromiseLike[Unit] | Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("afterLogout")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
inline def afterLogout(
  func: js.Function1[/* request */ TriggerRequest[Session[Attributes]], PromiseLike[Unit] | Unit],
  validator: js.Function1[/* request */ FunctionRequest[Params], Any]
...
inline def beforeFind[T /* <: Object[Attributes] */](
  ...
  (js.Promise[Query[T] | Unit]) | Query[T] | Unit
]
...
inline def beforeLogin(func: js.Function1[/* request */ TriggerRequest[User[Attributes]], PromiseLike[Unit] | Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("beforeLogin")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
...
inline def beforeSaveFile(func: js.Function1[/* request */ FileTriggerRequest, PromiseLike[File] | Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("beforeSaveFile")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
inline def beforeSaveFile(
  func: js.Function1[/* request */ FileTriggerRequest, PromiseLike[File] | Unit],
  validator: js.Function1[/* request */ FunctionRequest[Params], Any]
...
type AfterDeleteRequest[T] = TriggerRequest[T]

// tslint:disable-line no-empty-interface
type BeforeDeleteRequest[T] = TriggerRequest[T]

type Params = StringDictionary[Any]

type ValidatorFields = StringDictionary[ValidatorField]
