...
import typingsJapgolly.puppeteer.mod.DialogType
import typingsJapgolly.puppeteer.mod.ErrorCode
import typingsJapgolly.puppeteer.mod.HttpMethod
import typingsJapgolly.puppeteer.mod.LoadEvent
import typingsJapgolly.puppeteer.mod.MediaType
import typingsJapgolly.puppeteer.mod.MouseButtons
import typingsJapgolly.puppeteer.mod.PDFFormat
import typingsJapgolly.puppeteer.mod.Permission
import typingsJapgolly.puppeteer.mod.Platform
import typingsJapgolly.puppeteer.mod.ResourceType
import typingsJapgolly.puppeteer.mod.SameSiteSetting
import typingsJapgolly.puppeteer.mod.TargetType
