...
import typingsJapgolly.puppeteer.mod.ActionResult
import typingsJapgolly.puppeteer.mod.BrowserContextEmittedEvents
import typingsJapgolly.puppeteer.mod.BrowserEmittedEvents
import typingsJapgolly.puppeteer.mod.ChromeReleaseChannel
import typingsJapgolly.puppeteer.mod.ConsoleMessageType
import typingsJapgolly.puppeteer.mod.ErrorCode
import typingsJapgolly.puppeteer.mod.LowerCasePaperFormat
import typingsJapgolly.puppeteer.mod.MouseButton
import typingsJapgolly.puppeteer.mod.PageEmittedEvents
import typingsJapgolly.puppeteer.mod.Permission
import typingsJapgolly.puppeteer.mod.Platform
import typingsJapgolly.puppeteer.mod.Product
import typingsJapgolly.puppeteer.mod.ProtocolLifeCycleEvent
import typingsJapgolly.puppeteer.mod.PuppeteerLifeCycleEvent
import typingsJapgolly.puppeteer.mod._KeyInput
...
object puppeteerStrings {
  ...
  - typingsJapgolly.puppeteer.mod._KeyInput because Already inherited */ @js.native
  sealed trait Comma
    extends StObject
       with _KeyInput
