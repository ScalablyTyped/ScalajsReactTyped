...
trait PageEventObject extends StObject {
  ...
  var metrics: typingsJapgolly.puppeteer.anon.Metrics
...
object PageEventObject {
  ...
  inline def apply(
    ...
    metrics: typingsJapgolly.puppeteer.anon.Metrics,
    pageerror: js.Error,
    popup: Page,
    request: HTTPRequest,
  ...
  extension [Self <: PageEventObject](x: Self) {
    ...
    inline def setMetrics(value: typingsJapgolly.puppeteer.anon.Metrics): Self = StObject.set(x, "metrics", value.asInstanceOf[js.Any])
