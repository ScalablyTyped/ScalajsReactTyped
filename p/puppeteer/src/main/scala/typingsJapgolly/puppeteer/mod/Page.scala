...
import typingsJapgolly.puppeteer.anon.Button
import typingsJapgolly.puppeteer.anon.Default
import typingsJapgolly.puppeteer.anon.Delay
import typingsJapgolly.puppeteer.anon.Hidden
import typingsJapgolly.puppeteer.anon.IdleTime
import typingsJapgolly.puppeteer.anon.IsScreenUnlocked
import typingsJapgolly.puppeteer.anon.OmitFrameAddStyleTagOptio
import typingsJapgolly.puppeteer.anon.RunBeforeUnload
import typingsJapgolly.puppeteer.anon.Timeout
import typingsJapgolly.puppeteer.anon.WaitForOptionsrefererstri
import typingsJapgolly.puppeteer.puppeteerStrings.achromatopsia
import typingsJapgolly.puppeteer.puppeteerStrings.blurredVision
import typingsJapgolly.puppeteer.puppeteerStrings.close
import typingsJapgolly.puppeteer.puppeteerStrings.console
import typingsJapgolly.puppeteer.puppeteerStrings.deuteranopia
...
import typingsJapgolly.puppeteer.puppeteerStrings.none
import typingsJapgolly.puppeteer.puppeteerStrings.pageerror
import typingsJapgolly.puppeteer.puppeteerStrings.popup
import typingsJapgolly.puppeteer.puppeteerStrings.protanopia
...
import typingsJapgolly.puppeteer.puppeteerStrings.tritanopia
...
open class Page () extends EventEmitter {
  ...
  def off_metrics(
    eventName: metrics,
    handler: js.Function1[/* event */ typingsJapgolly.puppeteer.anon.Metrics, Unit]
