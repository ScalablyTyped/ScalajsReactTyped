...
import typingsJapgolly.puppeteer.anon.Delay
import typingsJapgolly.puppeteer.anon.Hidden
import typingsJapgolly.puppeteer.anon.Threshold
...
@JSImport("puppeteer", "ElementHandle")
@js.native
open class ElementHandle[ElementType /* <: Node */] () extends JSHandle[ElementType] {
