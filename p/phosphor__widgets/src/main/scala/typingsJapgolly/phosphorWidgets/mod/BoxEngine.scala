...
object BoxEngine extends js.Object {
  /**
    ...
    */
  def adjust(
    sizers: ArrayLike[typingsJapgolly.phosphorWidgets.boxengineMod.BoxSizer],
    index: Double,
    delta: Double
  ): Unit = js.native
  /**
    ...
    */
  def calc(sizers: ArrayLike[typingsJapgolly.phosphorWidgets.boxengineMod.BoxSizer], space: Double): Double = js.native
}
