package typingsJapgolly.phosphorWidgets.tabbarMod

import org.scalajs.dom.raw.HTMLUListElement
import typingsJapgolly.phosphorSignaling.mod.ISignal
import typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.ICurrentChangedArgs
import typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.IOptions
import typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.IRenderer
import typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.ITabActivateRequestedArgs
import typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.ITabCloseRequestedArgs
import typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.ITabDetachRequestedArgs
import typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.ITabMovedArgs
import typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.InsertBehavior
import typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.Orientation
import typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.RemoveBehavior
import typingsJapgolly.phosphorWidgets.titleMod.Title
...
class TabBar_[T] () extends Widget {
  ...
  def addTab(value: typingsJapgolly.phosphorWidgets.titleMod.Title.IOptions[T]): Title[T] = js.native
  /**
  ...
  def insertTab(index: Double, value: typingsJapgolly.phosphorWidgets.titleMod.Title.IOptions[T]): Title[T] = js.native
  /**
    * Release the mouse and restore the non-dragged tab positions.
    *
    * #### Notes
