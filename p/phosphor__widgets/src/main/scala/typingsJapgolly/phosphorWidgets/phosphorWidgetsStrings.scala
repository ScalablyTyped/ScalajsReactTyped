...
import typingsJapgolly.phosphorWidgets.boxlayoutMod.BoxLayout.Alignment
import typingsJapgolly.phosphorWidgets.boxlayoutMod.BoxLayout.Direction
import typingsJapgolly.phosphorWidgets.docklayoutMod.DockLayout.InsertMode
...
import typingsJapgolly.phosphorWidgets.scrollbarMod.ScrollBar.Orientation
...
object phosphorWidgetsStrings {
  ...
  sealed trait center
    extends Alignment
       with typingsJapgolly.phosphorWidgets.splitlayoutMod.SplitLayout.Alignment
  ...
  sealed trait horizontal
    extends Orientation
       with typingsJapgolly.phosphorWidgets.splitlayoutMod.SplitLayout.Orientation
       with typingsJapgolly.phosphorWidgets.tabbarMod.TabBar.Orientation
