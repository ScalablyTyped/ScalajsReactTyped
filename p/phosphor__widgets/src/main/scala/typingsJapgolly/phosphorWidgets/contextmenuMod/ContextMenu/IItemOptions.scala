package typingsJapgolly.phosphorWidgets.contextmenuMod.ContextMenu

import typingsJapgolly.phosphorCoreutils.jsonMod.ReadonlyJSONObject
import typingsJapgolly.phosphorWidgets.menuMod.Menu
import typingsJapgolly.phosphorWidgets.menuMod.Menu.ItemType
...
/**
  ...
  */
trait IItemOptions
  extends typingsJapgolly.phosphorWidgets.menuMod.Menu.IItemOptions {
  /**
