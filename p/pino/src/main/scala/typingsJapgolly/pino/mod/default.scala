...
object default {
  ...
  /**
    ...
    */
  inline def apply[Options /* <: typingsJapgolly.pino.mod.pino.LoggerOptions | typingsJapgolly.pino.mod.pino.DestinationStream */](): typingsJapgolly.pino.mod.pino.Logger[Options] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.pino.mod.pino.Logger[Options]]
  /**
    ...
    * @returns a new logger instance.
    */
  inline def apply[Options /* <: typingsJapgolly.pino.mod.pino.LoggerOptions */](options: Options, stream: typingsJapgolly.pino.mod.pino.DestinationStream): typingsJapgolly.pino.mod.pino.Logger[Options] = (^.asInstanceOf[js.Dynamic].apply(options.asInstanceOf[js.Any], stream.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pino.mod.pino.Logger[Options]]
  inline def apply[Options /* <: typingsJapgolly.pino.mod.pino.LoggerOptions | typingsJapgolly.pino.mod.pino.DestinationStream */](optionsOrStream: Options): typingsJapgolly.pino.mod.pino.Logger[Options] = ^.asInstanceOf[js.Dynamic].apply(optionsOrStream.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.pino.mod.pino.Logger[Options]]
  ...
  inline def destination(dest: typingsJapgolly.pino.mod.pino.DestinationStream): SonicBoom = ^.asInstanceOf[js.Dynamic].applyDynamic("destination")(dest.asInstanceOf[js.Any]).asInstanceOf[SonicBoom]
  ...
  @js.native
  val levels: typingsJapgolly.pino.mod.pino.LevelMapping = js.native
  ...
  ): typingsJapgolly.pino.mod.pino.MultiStreamRes = ^.asInstanceOf[js.Dynamic].applyDynamic("multistream")(streamsArray.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.pino.mod.pino.MultiStreamRes]
  inline def multistream(
    streamsArray: js.Array[
      typingsJapgolly.pino.mod.pino.DestinationStream | typingsJapgolly.pino.mod.pino.StreamEntry
    ],
    opts: typingsJapgolly.pino.mod.pino.MultiStreamOptions
  ): typingsJapgolly.pino.mod.pino.MultiStreamRes = (^.asInstanceOf[js.Dynamic].applyDynamic("multistream")(streamsArray.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pino.mod.pino.MultiStreamRes]
  inline def multistream(streamsArray: typingsJapgolly.pino.mod.pino.DestinationStream): typingsJapgolly.pino.mod.pino.MultiStreamRes = ^.asInstanceOf[js.Dynamic].applyDynamic("multistream")(streamsArray.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.pino.mod.pino.MultiStreamRes]
  inline def multistream(
    streamsArray: typingsJapgolly.pino.mod.pino.DestinationStream,
    opts: typingsJapgolly.pino.mod.pino.MultiStreamOptions
  ): typingsJapgolly.pino.mod.pino.MultiStreamRes = (^.asInstanceOf[js.Dynamic].applyDynamic("multistream")(streamsArray.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pino.mod.pino.MultiStreamRes]
  inline def multistream(streamsArray: typingsJapgolly.pino.mod.pino.StreamEntry): typingsJapgolly.pino.mod.pino.MultiStreamRes = ^.asInstanceOf[js.Dynamic].applyDynamic("multistream")(streamsArray.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.pino.mod.pino.MultiStreamRes]
  inline def multistream(
    streamsArray: typingsJapgolly.pino.mod.pino.StreamEntry,
    opts: typingsJapgolly.pino.mod.pino.MultiStreamOptions
  ): typingsJapgolly.pino.mod.pino.MultiStreamRes = (^.asInstanceOf[js.Dynamic].applyDynamic("multistream")(streamsArray.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pino.mod.pino.MultiStreamRes]
