...
import typingsJapgolly.pino.anon.AsObject
import typingsJapgolly.pino.anon.LogMethod
import typingsJapgolly.pino.mod.MixinFn
import typingsJapgolly.pino.mod.MixinMergeStrategyFn
import typingsJapgolly.pino.mod.OnChildCallback
...
trait LoggerOptions extends StObject {
  ...
  /**
    ...
    */
  var formatters: js.UndefOr[typingsJapgolly.pino.anon.Bindings] = js.undefined
  ...
  /**
    ...
    */
  var onChild: js.UndefOr[OnChildCallback[typingsJapgolly.pino.mod.LoggerOptions]] = js.undefined
...
object LoggerOptions {
  ...
  extension [Self <: LoggerOptions](x: Self) {
    ...
    inline def setFormatters(value: typingsJapgolly.pino.anon.Bindings): Self = StObject.set(x, "formatters", value.asInstanceOf[js.Any])
    ...
    inline def setOnChild(value: /* child */ Logger[typingsJapgolly.pino.mod.LoggerOptions & ChildLoggerOptions] => Callback): Self = StObject.set(x, "onChild", js.Any.fromFunction1((t0: /* child */ Logger[typingsJapgolly.pino.mod.LoggerOptions & ChildLoggerOptions]) => value(t0).runNow()))
