...
object mod {
  ...
  object EDeflateStrategy extends StObject {
    ...
    /* 0 */ val DEFAULT_STRATEGY: typingsJapgolly.pngAsync.mod.EDeflateStrategy.DEFAULT_STRATEGY & Double = js.native
    
    @js.native
    sealed trait FILTERED
      extends StObject
         with EDeflateStrategy
    /* 1 */ val FILTERED: typingsJapgolly.pngAsync.mod.EDeflateStrategy.FILTERED & Double = js.native
    
    @js.native
    sealed trait FIXED
      extends StObject
         with EDeflateStrategy
    /* 4 */ val FIXED: typingsJapgolly.pngAsync.mod.EDeflateStrategy.FIXED & Double = js.native
    
    @js.native
    sealed trait HUFFMAN_ONLY
      extends StObject
         with EDeflateStrategy
    /* 2 */ val HUFFMAN_ONLY: typingsJapgolly.pngAsync.mod.EDeflateStrategy.HUFFMAN_ONLY & Double = js.native
    
    @js.native
    sealed trait RLE
      extends StObject
         with EDeflateStrategy
    /* 3 */ val RLE: typingsJapgolly.pngAsync.mod.EDeflateStrategy.RLE & Double = js.native
  }
  ...
  object EFilterType extends StObject {
    ...
    sealed trait Auto
      extends StObject
         with EFilterType
    /* -1 */ val Auto: typingsJapgolly.pngAsync.mod.EFilterType.Auto & Double = js.native
    
    @js.native
    sealed trait Average
      extends StObject
         with EFilterType
    /* 3 */ val Average: typingsJapgolly.pngAsync.mod.EFilterType.Average & Double = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with EFilterType
    /* 0 */ val None: typingsJapgolly.pngAsync.mod.EFilterType.None & Double = js.native
    
    @js.native
    sealed trait Paeth
      extends StObject
         with EFilterType
    /* 4 */ val Paeth: typingsJapgolly.pngAsync.mod.EFilterType.Paeth & Double = js.native
    
    @js.native
    sealed trait Sub
      extends StObject
         with EFilterType
    /* 1 */ val Sub: typingsJapgolly.pngAsync.mod.EFilterType.Sub & Double = js.native
    
    @js.native
    sealed trait Up
      extends StObject
         with EFilterType
    /* 2 */ val Up: typingsJapgolly.pngAsync.mod.EFilterType.Up & Double = js.native
  }
