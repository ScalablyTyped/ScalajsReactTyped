...
object distTypingsBlotAbstractContainerMod {
  ...
  trait ContainerBlot
    ...
    @JSName("next")
    var next_ContainerBlot: typingsJapgolly.parchment.distTypingsBlotBlockMod.default | ContainerBlot | Null = js.native
    
    @JSName("prev")
    var prev_ContainerBlot: typingsJapgolly.parchment.distTypingsBlotBlockMod.default | ContainerBlot | Null = js.native
  }
}
