...
object distTypingsBlotAbstractLeafMod {
  ...
  - typingsJapgolly.parchment.distTypingsBlotAbstractBlotMod.Leaf because var conflicts: domNode, next, parent, prev, scroll, statics. Inlined index, position, value */ @js.native
  trait LeafBlot
