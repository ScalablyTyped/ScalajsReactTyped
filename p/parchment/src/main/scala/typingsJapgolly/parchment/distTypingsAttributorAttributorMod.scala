...
object distTypingsAttributorAttributorMod {
  ...
  object Attributor {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction2(add), attrName = attrName.asInstanceOf[js.Any], canAdd = js.Any.fromFunction2(canAdd), keyName = keyName.asInstanceOf[js.Any], remove = js.Any.fromFunction1((t0: HTMLElement) => remove(t0).runNow()), scope = scope.asInstanceOf[js.Any], value = js.Any.fromFunction1(value))
    ...
    extension [Self <: Attributor](x: Self) {
      ...
      inline def setRemove(value: HTMLElement => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction1((t0: HTMLElement) => value(t0).runNow()))
