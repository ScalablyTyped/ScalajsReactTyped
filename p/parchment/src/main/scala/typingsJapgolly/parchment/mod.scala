...
import typingsJapgolly.parchment.distTypingsAttributorAttributorMod.AttributorOptions
import typingsJapgolly.parchment.distTypingsAttributorAttributorMod.default
...
object mod {
  ...
  open class AttributorStore protected ()
    extends typingsJapgolly.parchment.distTypingsAttributorStoreMod.default {
  ...
  open class ClassAttributor ()
    extends typingsJapgolly.parchment.distTypingsAttributorClassMod.default
  ...
  open class ContainerBlot ()
    extends typingsJapgolly.parchment.distTypingsBlotAbstractContainerMod.default
  ...
  open class EmbedBlot ()
    extends typingsJapgolly.parchment.distTypingsBlotEmbedMod.default
  object EmbedBlot {
  ...
  open class InlineBlot protected ()
    extends typingsJapgolly.parchment.distTypingsBlotInlineMod.default {
    def this(scroll: Root, domNode: Node) = this()
  }
  object InlineBlot {
  ...
  @js.native
  open class Registry ()
    extends typingsJapgolly.parchment.distTypingsRegistryMod.default
  /* static members */
  object Registry {
  ...
  object Scope extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.parchment.distTypingsScopeMod.Scope & Double] = js.native
  ...
  open class ScrollBlot protected ()
    extends typingsJapgolly.parchment.distTypingsBlotScrollMod.default {
  ...
  object ScrollBlot {
    ...
    open class defaultChild protected ()
      extends typingsJapgolly.parchment.distTypingsBlotScrollMod.default.defaultChild {
      def this(scroll: Root, domNode: Node) = this()
    }
    /* was `typeof BlockBlot` */
    object defaultChild {
  ...
  open class StyleAttributor ()
    extends typingsJapgolly.parchment.distTypingsAttributorStyleMod.default
  ...
  open class TextBlot protected ()
    extends typingsJapgolly.parchment.distTypingsBlotTextMod.default {
