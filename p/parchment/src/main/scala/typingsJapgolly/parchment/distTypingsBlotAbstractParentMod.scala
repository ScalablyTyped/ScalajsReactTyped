...
import typingsJapgolly.parchment.distTypingsBlotAbstractBlotMod.Parent
...
object distTypingsBlotAbstractParentMod {
  ...
  - typingsJapgolly.parchment.distTypingsBlotAbstractBlotMod.Parent because var conflicts: domNode, next, parent, prev, scroll, statics. Inlined children, appendChild, descendant, descendant, descendants, descendants, insertBefore, insertBefore, moveChildren, moveChildren, path, path, removeChild, unwrap */ @js.native
  trait ParentBlot
    extends typingsJapgolly.parchment.distTypingsBlotAbstractShadowMod.default {
    ...
    var children: typingsJapgolly.parchment.distTypingsCollectionLinkedListMod.default[Blot] = js.native
