package typingsJapgolly.prettyQuick

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.prettier.mod.ResolveConfigOptions
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnCheckFile(value: (/* file */ String, /* isFormatted */ Boolean) => Callback): Self = StObject.set(x, "onCheckFile", js.Any.fromFunction2((t0: /* file */ String, t1: /* isFormatted */ Boolean) => (value(t0, t1)).runNow()))
      
      inline def setOnCheckFileUndefined: Self = StObject.set(x, "onCheckFile", js.undefined)
      
      inline def setOnExamineFile(value: /* file */ String => Callback): Self = StObject.set(x, "onExamineFile", js.Any.fromFunction1((t0: /* file */ String) => value(t0).runNow()))
      
      inline def setOnExamineFileUndefined: Self = StObject.set(x, "onExamineFile", js.undefined)
      
      inline def setOnFoundChangedFiles(value: /* changedFiles */ js.Array[String] => Callback): Self = StObject.set(x, "onFoundChangedFiles", js.Any.fromFunction1((t0: /* changedFiles */ js.Array[String]) => value(t0).runNow()))
      
      inline def setOnFoundChangedFilesUndefined: Self = StObject.set(x, "onFoundChangedFiles", js.undefined)
      
      inline def setOnFoundSinceRevision(value: (/* name */ String, /* revision */ String) => Callback): Self = StObject.set(x, "onFoundSinceRevision", js.Any.fromFunction2((t0: /* name */ String, t1: /* revision */ String) => (value(t0, t1)).runNow()))
      
      inline def setOnFoundSinceRevisionUndefined: Self = StObject.set(x, "onFoundSinceRevision", js.undefined)
      
      inline def setOnPartiallyStagedFile(value: /* file */ String => Callback): Self = StObject.set(x, "onPartiallyStagedFile", js.Any.fromFunction1((t0: /* file */ String) => value(t0).runNow()))
      
      inline def setOnPartiallyStagedFileUndefined: Self = StObject.set(x, "onPartiallyStagedFile", js.undefined)
      
      inline def setOnWriteFile(value: /* file */ String => Callback): Self = StObject.set(x, "onWriteFile", js.Any.fromFunction1((t0: /* file */ String) => value(t0).runNow()))
