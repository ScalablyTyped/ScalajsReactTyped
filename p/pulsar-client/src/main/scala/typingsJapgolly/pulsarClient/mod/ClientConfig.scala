...
object ClientConfig {
  ...
  extension [Self <: ClientConfig](x: Self) {
    ...
    inline def setLog(
      value: (/* level */ LogLevel, /* file */ String, /* line */ Double, /* message */ String) => Callback
    ): Self = StObject.set(x, "log", js.Any.fromFunction4((t0: /* level */ LogLevel, t1: /* file */ String, t2: /* line */ Double, t3: /* message */ String) => (value(t0, t1, t2, t3)).runNow()))
