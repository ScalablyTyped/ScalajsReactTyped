...
object ConsumerConfig {
  ...
  extension [Self <: ConsumerConfig](x: Self) {
    ...
    inline def setListener(value: (/* message */ Message, /* consumer */ Consumer) => Callback): Self = StObject.set(x, "listener", js.Any.fromFunction2((t0: /* message */ Message, t1: /* consumer */ Consumer) => (value(t0, t1)).runNow()))
