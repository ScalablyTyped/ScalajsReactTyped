...
object ReaderConfig {
  ...
  extension [Self <: ReaderConfig](x: Self) {
    ...
    inline def setListener(value: (/* message */ Message, /* reader */ Reader) => Callback): Self = StObject.set(x, "listener", js.Any.fromFunction2((t0: /* message */ Message, t1: /* reader */ Reader) => (value(t0, t1)).runNow()))
