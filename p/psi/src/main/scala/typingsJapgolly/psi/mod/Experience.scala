...
trait Experience extends StObject {
  ...
  var metrics: StringDictionary[typingsJapgolly.psi.anon.Category]
...
object Experience {
  ...
  inline def apply(
    id: String,
    initial_url: String,
    metrics: StringDictionary[typingsJapgolly.psi.anon.Category],
  ...
  extension [Self <: Experience](x: Self) {
    ...
    inline def setMetrics(value: StringDictionary[typingsJapgolly.psi.anon.Category]): Self = StObject.set(x, "metrics", value.asInstanceOf[js.Any])
