...
@JSImport("@pixi/compressed-textures", "CompressedTextureLoader")
@js.native
open class CompressedTextureLoader () extends StObject
/* static members */
object CompressedTextureLoader {
  ...
  @JSImport("@pixi/compressed-textures", "CompressedTextureLoader._textureExtensions")
  @js.native
  ...
  @JSImport("@pixi/compressed-textures", "CompressedTextureLoader._textureFormats")
  @js.native
  ...
  /** @ignore */
  @JSImport("@pixi/compressed-textures", "CompressedTextureLoader.extension")
  @js.native
