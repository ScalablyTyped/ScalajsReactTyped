package typingsJapgolly.pathwatcher
...
object mod {
  ...
  object PathWatchErrorThrownEvent {
    ...
    inline def apply(error: js.Error, handle: Callback): PathWatchErrorThrownEvent = {
  ...
  object PathWatcher {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(close = close.toJsFn, onDidChange = js.Any.fromFunction1(onDidChange))
