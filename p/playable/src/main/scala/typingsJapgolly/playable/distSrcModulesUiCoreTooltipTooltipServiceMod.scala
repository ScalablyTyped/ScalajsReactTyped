...
import typingsJapgolly.playable.distSrcModulesUiCoreTooltipTypesMod.ITooltipReference
import typingsJapgolly.playable.distSrcModulesUiCoreTooltipTypesMod.ITooltipReferenceOptions
import typingsJapgolly.playable.distSrcModulesUiCoreTooltipTypesMod.ITooltipService
import typingsJapgolly.playable.distSrcModulesUiCoreTooltipTypesMod.ITooltipShowOptions
