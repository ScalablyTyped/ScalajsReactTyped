...
import typingsJapgolly.playable.anon.FullScreenManager
import typingsJapgolly.playable.distSrcModulesUiControlsFullScreenTypesMod.IFullScreenControl
...
object distSrcModulesUiControlsFullScreenFullScreenMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typingsJapgolly.playable.distSrcModulesUiControlsFullScreenFullScreenDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiControlsFullScreenFullScreenDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IFullScreenViewConfig, 
  ...
  trait FullScreenControl
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiControlsFullScreenFullScreenDotviewMod.default
  }
  object FullScreenControl {
    ...
    extension [Self <: FullScreenControl](x: Self) {
      ...
      inline def setView(value: typingsJapgolly.playable.distSrcModulesUiControlsFullScreenFullScreenDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
