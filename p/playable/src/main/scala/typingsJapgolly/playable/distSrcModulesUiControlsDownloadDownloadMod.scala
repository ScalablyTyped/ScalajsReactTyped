...
import typingsJapgolly.playable.anon.TextMap
import typingsJapgolly.playable.distSrcModulesUiControlsDownloadTypesMod.IDownloadButton
...
object distSrcModulesUiControlsDownloadDownloadMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typingsJapgolly.playable.distSrcModulesUiControlsDownloadDownloadDotviewMod.default = js.native
  }
  object default {
    ...
    open class View protected ()
      extends typingsJapgolly.playable.distSrcModulesUiControlsDownloadDownloadDotviewMod.default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiControlsDownloadDownloadDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IDownloadViewConfig, 
  ...
  trait DownloadButton
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiControlsDownloadDownloadDotviewMod.default
  }
  object DownloadButton {
    ...
    extension [Self <: DownloadButton](x: Self) {
      ...
      inline def setView(value: typingsJapgolly.playable.distSrcModulesUiControlsDownloadDownloadDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
