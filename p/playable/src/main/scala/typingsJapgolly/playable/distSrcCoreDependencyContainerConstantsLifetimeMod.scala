...
object distSrcCoreDependencyContainerConstantsLifetimeMod {
  ...
  object default extends StObject {
    ...
    /* "scoped" */ val SCOPED: typingsJapgolly.playable.distSrcCoreDependencyContainerConstantsLifetimeMod.Lifetime.SCOPED & String = js.native
    
    /* "singleton" */ val SINGLETON: typingsJapgolly.playable.distSrcCoreDependencyContainerConstantsLifetimeMod.Lifetime.SINGLETON & String = js.native
    
    /* "transient" */ val TRANSIENT: typingsJapgolly.playable.distSrcCoreDependencyContainerConstantsLifetimeMod.Lifetime.TRANSIENT & String = js.native
  }
