...
import typingsJapgolly.playable.distSrcModulesRootContainerTypesMod.IRootContainerViewConfig
import typingsJapgolly.playable.distSrcModulesRootContainerTypesMod.IRootContainerViewStyles
...
object distSrcModulesRootContainerRootContainerDotviewMod {
  ...
  trait RootContainerView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[IRootContainerViewStyles] {
