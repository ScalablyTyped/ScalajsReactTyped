...
import typingsJapgolly.playable.anon.PictureInPicture
import typingsJapgolly.playable.distSrcModulesUiControlsPictureInPictureTypesMod.IPictureInPictureControl
...
object distSrcModulesUiControlsPictureInPicturePictureInPictureMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typingsJapgolly.playable.distSrcModulesUiControlsPictureInPicturePictureInPictureDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiControlsPictureInPicturePictureInPictureDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IPictureInPictureViewConfig, 
  ...
  trait PictureInPictureControl
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiControlsPictureInPicturePictureInPictureDotviewMod.default
  }
  object PictureInPictureControl {
    ...
    extension [Self <: PictureInPictureControl](x: Self) {
      ...
      inline def setView(
        value: typingsJapgolly.playable.distSrcModulesUiControlsPictureInPicturePictureInPictureDotviewMod.default
