...
import typingsJapgolly.playable.anon.InteractionIndicator
import typingsJapgolly.playable.distSrcModulesUiScreenTypesMod.IScreen
...
object distSrcModulesUiScreenScreenMod {
  ...
  object default {
    ...
    open class View protected ()
      extends typingsJapgolly.playable.distSrcModulesUiScreenScreenDotviewMod.default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiScreenScreenDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IScreenViewConfig, 
  ...
  trait Screen
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiScreenScreenDotviewMod.default = js.native
  }
}
