...
import typingsJapgolly.playable.distSrcModulesUiInteractionIndicatorTypesMod.IInteractionIndicatorViewStyles
...
object distSrcModulesUiInteractionIndicatorInteractionIndicatorDotviewMod {
  ...
  trait InteractionIndicatorView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[IInteractionIndicatorViewStyles] {
