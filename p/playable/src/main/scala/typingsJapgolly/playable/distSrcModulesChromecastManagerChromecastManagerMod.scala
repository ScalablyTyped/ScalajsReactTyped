...
object distSrcModulesChromecastManagerChromecastManagerMod {
  ...
  object ChromecastEvents extends StObject {
    ...
    /* "ui-events/chromecast-resumed" */ val CHROMECAST_CASTS_RESUMED: typingsJapgolly.playable.distSrcModulesChromecastManagerChromecastManagerMod.ChromecastEvents.CHROMECAST_CASTS_RESUMED & String = js.native
    
    @js.native
    sealed trait CHROMECAST_CASTS_STARTED
      extends StObject
         with ChromecastEvents
    /* "ui-events/chromecast-started" */ val CHROMECAST_CASTS_STARTED: typingsJapgolly.playable.distSrcModulesChromecastManagerChromecastManagerMod.ChromecastEvents.CHROMECAST_CASTS_STARTED & String = js.native
    
    @js.native
    sealed trait CHROMECAST_CASTS_STOPED
      extends StObject
         with ChromecastEvents
    /* "ui-events/chromecast-stoped" */ val CHROMECAST_CASTS_STOPED: typingsJapgolly.playable.distSrcModulesChromecastManagerChromecastManagerMod.ChromecastEvents.CHROMECAST_CASTS_STOPED & String = js.native
    
    @js.native
    sealed trait CHROMECAST_CONNECTED
      extends StObject
         with ChromecastEvents
    /* "ui-events/chromecast-connected" */ val CHROMECAST_CONNECTED: typingsJapgolly.playable.distSrcModulesChromecastManagerChromecastManagerMod.ChromecastEvents.CHROMECAST_CONNECTED & String = js.native
    
    @js.native
    sealed trait CHROMECAST_CONNECTING
      extends StObject
         with ChromecastEvents
    /* "ui-events/chromecast-connecting" */ val CHROMECAST_CONNECTING: typingsJapgolly.playable.distSrcModulesChromecastManagerChromecastManagerMod.ChromecastEvents.CHROMECAST_CONNECTING & String = js.native
    
    @js.native
    sealed trait CHROMECAST_INITED
      extends StObject
         with ChromecastEvents
    /* "ui-events/chromecast-inited" */ val CHROMECAST_INITED: typingsJapgolly.playable.distSrcModulesChromecastManagerChromecastManagerMod.ChromecastEvents.CHROMECAST_INITED & String = js.native
    
    @js.native
    sealed trait CHROMECAST_NOT_CONNECTED
      extends StObject
         with ChromecastEvents
    /* "ui-events/chromecast-not-connected" */ val CHROMECAST_NOT_CONNECTED: typingsJapgolly.playable.distSrcModulesChromecastManagerChromecastManagerMod.ChromecastEvents.CHROMECAST_NOT_CONNECTED & String = js.native
    
    @js.native
    sealed trait CHROMECAST_NO_DEVICES_AVAILABLE
      extends StObject
         with ChromecastEvents
    /* "ui-events/chromecast-not-available" */ val CHROMECAST_NO_DEVICES_AVAILABLE: typingsJapgolly.playable.distSrcModulesChromecastManagerChromecastManagerMod.ChromecastEvents.CHROMECAST_NO_DEVICES_AVAILABLE & String = js.native
  }
  ...
  object ChromecastManager {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(_bindToContextEvents = _bindToContextEvents.asInstanceOf[js.Any], _context = _context.asInstanceOf[js.Any], _engine = _engine.asInstanceOf[js.Any], _eventEmitter = _eventEmitter.asInstanceOf[js.Any], _initCastContext = _initCastContext.asInstanceOf[js.Any], _insertCastCallback = _insertCastCallback.asInstanceOf[js.Any], _onCastStateChange = _onCastStateChange.asInstanceOf[js.Any], _onSessionStateChange = _onSessionStateChange.asInstanceOf[js.Any], destroy = destroy.toJsFn, isCasting = isCasting.asInstanceOf[js.Any], isEnabled = isEnabled.asInstanceOf[js.Any])
