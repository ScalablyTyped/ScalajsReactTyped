...
import typingsJapgolly.playable.anon.EngineEventEmitter
import typingsJapgolly.playable.distSrcModulesUiControlsTimeTypesMod.ITimeControl
import typingsJapgolly.playable.distSrcModulesUiControlsTimeTypesMod.ITimeViewConfig
...
object distSrcModulesUiControlsTimeTimeMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typingsJapgolly.playable.distSrcModulesUiControlsTimeTimeDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiControlsTimeTimeDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ ITimeViewConfig, 
  ...
  trait TimeControl
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiControlsTimeTimeDotviewMod.default
  }
  object TimeControl {
    ...
    extension [Self <: TimeControl](x: Self) {
      ...
      inline def setView(value: typingsJapgolly.playable.distSrcModulesUiControlsTimeTimeDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
