...
import typingsJapgolly.playable.distSrcModulesUiControlsProgressTypesMod.IProgressViewStyles
...
object distSrcModulesUiControlsProgressProgressDotviewMod {
  ...
  @js.native
  trait ProgressView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[IProgressViewStyles] {
