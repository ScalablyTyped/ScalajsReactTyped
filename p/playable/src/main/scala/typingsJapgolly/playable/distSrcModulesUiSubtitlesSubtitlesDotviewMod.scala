...
import typingsJapgolly.playable.distSrcModulesUiSubtitlesTypesMod.ISubtitlesViewStyles
...
object distSrcModulesUiSubtitlesSubtitlesDotviewMod {
  ...
  @js.native
  trait SubtitlesView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[ISubtitlesViewStyles] {
