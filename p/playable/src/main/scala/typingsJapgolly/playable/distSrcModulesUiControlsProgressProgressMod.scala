...
import typingsJapgolly.playable.anon.LiveStateEngine
import typingsJapgolly.playable.distSrcModulesUiControlsProgressTypesMod.IProgressControl
import typingsJapgolly.playable.distSrcModulesUiControlsProgressTypesMod.IProgressViewConfig
...
object distSrcModulesUiControlsProgressProgressMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typingsJapgolly.playable.distSrcModulesUiControlsProgressProgressDotviewMod.default = js.native
  }
  object default {
    ...
    open class View protected ()
      extends typingsJapgolly.playable.distSrcModulesUiControlsProgressProgressDotviewMod.default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiControlsProgressProgressDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IProgressViewConfig, 
  ...
  trait ProgressControl
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiControlsProgressProgressDotviewMod.default
  }
  object ProgressControl {
    ...
    extension [Self <: ProgressControl](x: Self) {
      ...
      inline def setView(value: typingsJapgolly.playable.distSrcModulesUiControlsProgressProgressDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
