...
import typingsJapgolly.playable.distSrcModulesUiControlsTimeTypesMod.ITimeViewStyles
...
object distSrcModulesUiControlsTimeTimeDotviewMod {
  ...
  @js.native
  trait TimeView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[ITimeViewStyles] {
