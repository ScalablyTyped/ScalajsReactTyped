...
import typingsJapgolly.playable.anon.Position
...
object distSrcModulesUiBottomBlockTypesMod {
  ...
  object IBottomBlockAPI {
    ...
    extension [Self <: IBottomBlockAPI](x: Self) {
      ...
      inline def setHideDownloadButton(value: Callback): Self = StObject.set(x, "hideDownloadButton", value.toJsFn)
      ...
      inline def setHideLogo(value: Callback): Self = StObject.set(x, "hideLogo", value.toJsFn)
      ...
      inline def setSetAlwaysShowLogo(value: /* flag */ Boolean => Callback): Self = StObject.set(x, "setAlwaysShowLogo", js.Any.fromFunction1((t0: /* flag */ Boolean) => value(t0).runNow()))
      
      inline def setSetAlwaysShowLogoUndefined: Self = StObject.set(x, "setAlwaysShowLogo", js.undefined)
      
      inline def setShowDownloadButton(value: Callback): Self = StObject.set(x, "showDownloadButton", value.toJsFn)
      ...
      inline def setShowLogo(value: Callback): Self = StObject.set(x, "showLogo", value.toJsFn)
