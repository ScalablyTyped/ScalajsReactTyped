...
object distSrcModulesPlaybackEngineOutputNativeNativeEventsBroadcasterMod {
  ...
  object NativeEventsBroadcaster {
    ...
    inline def apply(
      ...
      _unbindEvents: Any,
      _video: Any,
      checkVolumeChangeAfterLoadStart: Callback,
      destroy: Callback
    ): NativeEventsBroadcaster = {
      val __obj = js.Dynamic.literal(_bindCallbacks = _bindCallbacks.asInstanceOf[js.Any], _bindEvents = _bindEvents.asInstanceOf[js.Any], _checkVolumeChanges = _checkVolumeChanges.asInstanceOf[js.Any], _currentMute = _currentMute.asInstanceOf[js.Any], _currentVolume = _currentVolume.asInstanceOf[js.Any], _eventEmitter = _eventEmitter.asInstanceOf[js.Any], _processEventFromVideo = _processEventFromVideo.asInstanceOf[js.Any], _shouldCheckVolume = _shouldCheckVolume.asInstanceOf[js.Any], _unbindEvents = _unbindEvents.asInstanceOf[js.Any], _video = _video.asInstanceOf[js.Any], checkVolumeChangeAfterLoadStart = checkVolumeChangeAfterLoadStart.toJsFn, destroy = destroy.toJsFn)
      __obj.asInstanceOf[NativeEventsBroadcaster]
    }
    
    extension [Self <: NativeEventsBroadcaster](x: Self) {
      
      inline def setCheckVolumeChangeAfterLoadStart(value: Callback): Self = StObject.set(x, "checkVolumeChangeAfterLoadStart", value.toJsFn)
