...
import typingsJapgolly.playable.anon.TooltipService
...
object distSrcModulesUiControlsVolumeVolumeMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typingsJapgolly.playable.distSrcModulesUiControlsVolumeVolumeDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    def View: Instantiable1[
        /* config */ IVolumeViewConfig, 
        typingsJapgolly.playable.distSrcModulesUiControlsVolumeVolumeDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IVolumeViewConfig, 
  ...
  trait VolumeControl
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiControlsVolumeVolumeDotviewMod.default
  }
  object VolumeControl {
    ...
    extension [Self <: VolumeControl](x: Self) {
      ...
      inline def setView(value: typingsJapgolly.playable.distSrcModulesUiControlsVolumeVolumeDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
