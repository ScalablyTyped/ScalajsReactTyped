...
object distSrcModulesUiControlsLogoTypesMod {
  ...
  object ILogoAPI {
    ...
    extension [Self <: ILogoAPI](x: Self) {
      ...
      inline def setSetLogo(value: /* src */ String => Callback): Self = StObject.set(x, "setLogo", js.Any.fromFunction1((t0: /* src */ String) => value(t0).runNow()))
      
      inline def setSetLogoClickCallback(value: /* callback */ js.UndefOr[js.Function0[Unit]] => Callback): Self = StObject.set(x, "setLogoClickCallback", js.Any.fromFunction1((t0: /* callback */ js.UndefOr[js.Function0[Unit]]) => value(t0).runNow()))
  ...
  object ILogoViewCallbacks {
    ...
    inline def apply(onLogoClick: Callback): ILogoViewCallbacks = {
      val __obj = js.Dynamic.literal(onLogoClick = onLogoClick.toJsFn)
      __obj.asInstanceOf[ILogoViewCallbacks]
    }
    
    extension [Self <: ILogoViewCallbacks](x: Self) {
      
      inline def setOnLogoClick(value: Callback): Self = StObject.set(x, "onLogoClick", value.toJsFn)
    }
  }
