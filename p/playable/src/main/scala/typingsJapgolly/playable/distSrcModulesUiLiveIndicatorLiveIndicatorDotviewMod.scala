...
import typingsJapgolly.playable.distSrcModulesUiLiveIndicatorTypesMod.ILiveIndicatorViewConfig
import typingsJapgolly.playable.distSrcModulesUiLiveIndicatorTypesMod.ILiveIndicatorViewStyles
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distSrcModulesUiLiveIndicatorLiveIndicatorDotviewMod {
  ...
  trait LiveIndicatorView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[ILiveIndicatorViewStyles] {
