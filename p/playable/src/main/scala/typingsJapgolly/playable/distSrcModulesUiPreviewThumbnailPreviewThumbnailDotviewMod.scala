...
import typingsJapgolly.playable.distSrcModulesUiPreviewThumbnailTypesMod.IPreviewThumbnailViewStyles
...
object distSrcModulesUiPreviewThumbnailPreviewThumbnailDotviewMod {
  ...
  trait PreviewThumbnailView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[IPreviewThumbnailViewStyles] {
