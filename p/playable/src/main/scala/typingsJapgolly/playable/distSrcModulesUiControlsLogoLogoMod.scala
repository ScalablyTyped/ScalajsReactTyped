...
object distSrcModulesUiControlsLogoLogoMod {
  ...
  object default {
    ...
    open class View protected ()
      extends typingsJapgolly.playable.distSrcModulesUiControlsLogoLogoDotviewMod.default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiControlsLogoLogoDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ ILogoViewConfig, 
  ...
  trait Logo
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiControlsLogoLogoDotviewMod.default = js.native
  }
}
