...
import typingsJapgolly.playable.anon.BottomBlock
import typingsJapgolly.playable.distSrcModulesUiControlsChromecastTypesMod.IChromecastButton
...
object distSrcModulesUiControlsChromecastChromecastMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typingsJapgolly.playable.distSrcModulesUiControlsChromecastChromecastDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiControlsChromecastChromecastDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IChromecastViewConfig, 
  ...
  trait ChromecastButton
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiControlsChromecastChromecastDotviewMod.default
  }
  object ChromecastButton {
    ...
    extension [Self <: ChromecastButton](x: Self) {
      ...
      inline def setView(value: typingsJapgolly.playable.distSrcModulesUiControlsChromecastChromecastDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
