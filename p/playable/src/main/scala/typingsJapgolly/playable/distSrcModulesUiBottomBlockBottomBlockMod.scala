...
import typingsJapgolly.playable.distSrcModulesUiControlsLogoTypesMod.ILogoControl
import typingsJapgolly.playable.distSrcModulesUiControlsPictureInPictureTypesMod.IPictureInPictureControl
import typingsJapgolly.playable.distSrcModulesUiControlsPlayTypesMod.IPlayControl
...
import typingsJapgolly.playable.distSrcModulesUiControlsVolumeTypesMod.IVolumeControl
...
object distSrcModulesUiBottomBlockBottomBlockMod {
  ...
  object default {
    ...
    open class View protected ()
      extends typingsJapgolly.playable.distSrcModulesUiBottomBlockBottomBlockDotviewMod.default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiBottomBlockBottomBlockDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IBottomBlockViewConfig, 
  ...
  trait BottomBlock
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiBottomBlockBottomBlockDotviewMod.default = js.native
  }
