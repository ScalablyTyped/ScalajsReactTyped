...
import typingsJapgolly.playable.distSrcModulesUiBottomBlockTypesMod.IBottomBlockViewConfig
import typingsJapgolly.playable.distSrcModulesUiBottomBlockTypesMod.IBottomBlockViewStyles
...
object distSrcModulesUiBottomBlockBottomBlockDotviewMod {
  ...
  trait BottomBlockView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[IBottomBlockViewStyles] {
