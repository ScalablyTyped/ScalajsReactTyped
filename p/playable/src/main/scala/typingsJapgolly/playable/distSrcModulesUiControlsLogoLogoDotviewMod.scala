...
import typingsJapgolly.playable.distSrcModulesUiControlsLogoTypesMod.ILogoViewConfig
import typingsJapgolly.playable.distSrcModulesUiControlsLogoTypesMod.ILogoViewStyles
...
object distSrcModulesUiControlsLogoLogoDotviewMod {
  ...
  @js.native
  trait LogoView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[ILogoViewStyles] {
