...
import typingsJapgolly.playable.anon.Loader
import typingsJapgolly.playable.distSrcModulesUiOverlayTypesMod.IOverlay
...
object distSrcModulesUiOverlayOverlayMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typingsJapgolly.playable.distSrcModulesUiOverlayOverlayDotviewMod.default = js.native
  }
  object default {
    ...
    open class View protected ()
      extends typingsJapgolly.playable.distSrcModulesUiOverlayOverlayDotviewMod.default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiOverlayOverlayDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IOverlayViewConfig, 
  ...
  trait Overlay
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiOverlayOverlayDotviewMod.default
  }
  object Overlay {
    ...
    extension [Self <: Overlay](x: Self) {
      ...
      inline def setTurnOffOverlayTransparency(value: Callback): Self = StObject.set(x, "turnOffOverlayTransparency", value.toJsFn)
      
      inline def setTurnOnOverlayTransparency(value: Callback): Self = StObject.set(x, "turnOnOverlayTransparency", value.toJsFn)
      
      inline def setView(value: typingsJapgolly.playable.distSrcModulesUiOverlayOverlayDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
