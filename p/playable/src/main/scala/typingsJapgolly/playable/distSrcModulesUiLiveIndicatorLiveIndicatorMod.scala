...
import typingsJapgolly.playable.anon.EventEmitterTextMap
...
object distSrcModulesUiLiveIndicatorLiveIndicatorMod {
  ...
  object default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiLiveIndicatorLiveIndicatorDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ ILiveIndicatorViewConfig, 
  ...
  trait LiveIndicator
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiLiveIndicatorLiveIndicatorDotviewMod.default = js.native
  }
}
