...
import typingsJapgolly.playable.anon.Screen
...
object distSrcModulesUiMainUiBlockMainUiBlockMod {
  ...
  object default {
    ...
    open class View protected ()
      extends typingsJapgolly.playable.distSrcModulesUiMainUiBlockMainUiBlockDotviewMod.default {
  ...
  trait MainUIBlock
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiMainUiBlockMainUiBlockDotviewMod.default = js.native
  }
  object MainUIBlock {
    
    /* was `typeof MainUIBlockView` */
    type View = typingsJapgolly.playable.distSrcModulesUiMainUiBlockMainUiBlockDotviewMod.default
  }
}
