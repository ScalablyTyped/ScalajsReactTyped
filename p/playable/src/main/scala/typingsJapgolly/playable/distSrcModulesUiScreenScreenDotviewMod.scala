...
import typingsJapgolly.playable.distSrcModulesUiScreenTypesMod.IScreenViewConfig
import typingsJapgolly.playable.distSrcModulesUiScreenTypesMod.IScreenViewStyles
...
object distSrcModulesUiScreenScreenDotviewMod {
  ...
  @js.native
  trait ScreenView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[IScreenViewStyles] {
