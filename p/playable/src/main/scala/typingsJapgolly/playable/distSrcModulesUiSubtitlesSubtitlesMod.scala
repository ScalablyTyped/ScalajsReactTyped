...
import typingsJapgolly.playable.anon.EventEmitterRootContainer
import typingsJapgolly.playable.distSrcModulesUiSubtitlesTypesMod.ISubtitles
...
object distSrcModulesUiSubtitlesSubtitlesMod {
  ...
  object default {
    ...
    @js.native
    open class View ()
      extends typingsJapgolly.playable.distSrcModulesUiSubtitlesSubtitlesDotviewMod.default
  ...
  trait Subtitles
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiSubtitlesSubtitlesDotviewMod.default = js.native
  }
  object Subtitles {
    
    /* was `typeof SubtitlesView` */
    type View = typingsJapgolly.playable.distSrcModulesUiSubtitlesSubtitlesDotviewMod.default
  }
}
