...
import typingsJapgolly.playable.distSrcModulesUiLiveIndicatorTypesMod.ILiveIndicator
import typingsJapgolly.playable.distSrcModulesUiTitleTypesMod.ITitle
import typingsJapgolly.playable.distSrcModulesUiTopBlockTypesMod.ITopBlock
...
object distSrcModulesUiTopBlockTopBlockMod {
  ...
  object default {
    ...
    open class View protected ()
      extends typingsJapgolly.playable.distSrcModulesUiTopBlockTopBlockDotviewMod.default {
    ...
    def View: Instantiable1[
        ...
        typingsJapgolly.playable.distSrcModulesUiTopBlockTopBlockDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ ITopBlockViewConfig, 
  ...
  trait TopBlock
    ...
    var view: typingsJapgolly.playable.distSrcModulesUiTopBlockTopBlockDotviewMod.default = js.native
  }
}
