...
import typingsJapgolly.playable.distSrcModulesUiDebugPanelTypesMod.IDebugPanelViewStyles
...
object distSrcModulesUiDebugPanelDebugPanelDotviewMod {
  ...
  trait DebugPanelView
    extends typingsJapgolly.playable.distSrcModulesUiCoreViewMod.default[IDebugPanelViewStyles] {
