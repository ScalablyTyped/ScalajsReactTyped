package typingsJapgolly.piCamera

import typingsJapgolly.piCamera.mod.ConfigKey
import typingsJapgolly.piCamera.mod.Mode
...
object piCameraStrings {
  ...
  sealed trait demo
    extends StObject
       with ConfigKey
  inline def demo: demo = "demo".asInstanceOf[demo]
  ...
  sealed trait framerate
    extends StObject
       with ConfigKey
  inline def framerate: framerate = "framerate".asInstanceOf[framerate]
  ...
  sealed trait hflip
    extends StObject
       with ConfigKey
  inline def hflip: hflip = "hflip".asInstanceOf[hflip]
  ...
  sealed trait shutter
    extends StObject
       with ConfigKey
  inline def shutter: shutter = "shutter".asInstanceOf[shutter]
  ...
  sealed trait vflip
    extends StObject
       with ConfigKey
  inline def vflip: vflip = "vflip".asInstanceOf[vflip]
  ...
  sealed trait vstab
    extends StObject
       with ConfigKey
  inline def vstab: vstab = "vstab".asInstanceOf[vstab]
