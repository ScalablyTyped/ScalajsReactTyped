...
import typingsJapgolly.paypalCordovaPlugin.anon.Authorizationid
import typingsJapgolly.paypalCordovaPlugin.anon.Code
...
object PayPalCordovaPlugin {
  ...
  object PayPalMobileStatic {
    ...
    inline def apply(
      ...
      renderProfileSharingUI: (js.Array[String], js.Function1[/* result */ Any, Unit], js.Function1[/* cancelReason */ String, Unit]) => Callback,
      ...
      val __obj = js.Dynamic.literal(applicationCorrelationIDForEnvironment = js.Any.fromFunction2((t0: String, t1: js.Function1[/* applicationCorrelationId */ String, Unit]) => (applicationCorrelationIDForEnvironment(t0, t1)).runNow()), clientMetadataID = js.Any.fromFunction1((t0: js.Function1[/* clientMetadataId */ String, Unit]) => clientMetadataID(t0).runNow()), init = js.Any.fromFunction2((t0: PayPalClientIds, t1: js.Function0[Unit]) => (init(t0, t1)).runNow()), prepareToRender = js.Any.fromFunction3((t0: String, t1: PayPalConfiguration, t2: js.Function0[Unit]) => (prepareToRender(t0, t1, t2)).runNow()), renderFuturePaymentUI = js.Any.fromFunction2((t0: js.Function1[/* result */ FuturePaymentResult, Unit], t1: js.Function1[/* cancelReason */ String, Unit]) => (renderFuturePaymentUI(t0, t1)).runNow()), renderProfileSharingUI = js.Any.fromFunction3((t0: js.Array[String], t1: js.Function1[/* result */ Any, Unit], t2: js.Function1[/* cancelReason */ String, Unit]) => (renderProfileSharingUI(t0, t1, t2)).runNow()), renderSinglePaymentUI = js.Any.fromFunction3((t0: PayPalPayment, t1: js.Function1[/* result */ SinglePaymentResult, Unit], t2: js.Function1[/* cancelReason */ String, Unit]) => (renderSinglePaymentUI(t0, t1, t2)).runNow()), version = js.Any.fromFunction1((t0: js.Function1[/* result */ String, Unit]) => version(t0).runNow()))
      __obj.asInstanceOf[PayPalMobileStatic]
    }
    
    extension [Self <: PayPalMobileStatic](x: Self) {
      
      inline def setApplicationCorrelationIDForEnvironment(value: (String, js.Function1[/* applicationCorrelationId */ String, Unit]) => Callback): Self = StObject.set(x, "applicationCorrelationIDForEnvironment", js.Any.fromFunction2((t0: String, t1: js.Function1[/* applicationCorrelationId */ String, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setClientMetadataID(value: js.Function1[/* clientMetadataId */ String, Unit] => Callback): Self = StObject.set(x, "clientMetadataID", js.Any.fromFunction1((t0: js.Function1[/* clientMetadataId */ String, Unit]) => value(t0).runNow()))
      
      inline def setInit(value: (PayPalClientIds, js.Function0[Unit]) => Callback): Self = StObject.set(x, "init", js.Any.fromFunction2((t0: PayPalClientIds, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
      
      inline def setPrepareToRender(value: (String, PayPalConfiguration, js.Function0[Unit]) => Callback): Self = StObject.set(x, "prepareToRender", js.Any.fromFunction3((t0: String, t1: PayPalConfiguration, t2: js.Function0[Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setRenderFuturePaymentUI(
        value: (js.Function1[/* result */ FuturePaymentResult, Unit], js.Function1[/* cancelReason */ String, Unit]) => Callback
      ): Self = StObject.set(x, "renderFuturePaymentUI", js.Any.fromFunction2((t0: js.Function1[/* result */ FuturePaymentResult, Unit], t1: js.Function1[/* cancelReason */ String, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setRenderProfileSharingUI(
        value: (js.Array[String], js.Function1[/* result */ Any, Unit], js.Function1[/* cancelReason */ String, Unit]) => Callback
      ): Self = StObject.set(x, "renderProfileSharingUI", js.Any.fromFunction3((t0: js.Array[String], t1: js.Function1[/* result */ Any, Unit], t2: js.Function1[/* cancelReason */ String, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setRenderSinglePaymentUI(
        value: (PayPalPayment, js.Function1[/* result */ SinglePaymentResult, Unit], js.Function1[/* cancelReason */ String, Unit]) => Callback
      ): Self = StObject.set(x, "renderSinglePaymentUI", js.Any.fromFunction3((t0: PayPalPayment, t1: js.Function1[/* result */ SinglePaymentResult, Unit], t2: js.Function1[/* cancelReason */ String, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setVersion(value: js.Function1[/* result */ String, Unit] => Callback): Self = StObject.set(x, "version", js.Any.fromFunction1((t0: js.Function1[/* result */ String, Unit]) => value(t0).runNow()))
    }
  }
