...
import typingsJapgolly.paypalCordovaPlugin.PayPalCordovaPlugin.PayPalMobileStatic
...
object global {
  ...
  open class PayPalConfiguration ()
    extends StObject
       with typingsJapgolly.paypalCordovaPlugin.PayPalConfiguration {
  ...
  open class PayPalItem protected ()
    extends StObject
       with typingsJapgolly.paypalCordovaPlugin.PayPalItem {
    /**
  ...
  open class PayPalPayment protected ()
    extends StObject
       with typingsJapgolly.paypalCordovaPlugin.PayPalPayment {
    /**
    ...
    def this(
      ...
      intent: String,
      details: typingsJapgolly.paypalCordovaPlugin.PayPalPaymentDetails
    ) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    var details: typingsJapgolly.paypalCordovaPlugin.PayPalPaymentDetails = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var items: js.Array[typingsJapgolly.paypalCordovaPlugin.PayPalItem] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var shippingAddress: typingsJapgolly.paypalCordovaPlugin.PayPalShippingAddress = js.native
  ...
  open class PayPalPaymentDetails protected ()
    extends StObject
       with typingsJapgolly.paypalCordovaPlugin.PayPalPaymentDetails {
    /**
  ...
  open class PayPalShippingAddress protected ()
    extends StObject
       with typingsJapgolly.paypalCordovaPlugin.PayPalShippingAddress {
    /**
