...
import typingsJapgolly.paypalCheckoutServerSdk.paypalCheckoutServerSdkStrings.BUSINESS_REGISTRATION_NUMBER
import typingsJapgolly.paypalCheckoutServerSdk.paypalCheckoutServerSdkStrings.TAX_IDENTIFICATION_NUMBER
