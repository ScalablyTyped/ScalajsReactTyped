...
import typingsJapgolly.paypalCheckoutServerSdk.libOrdersLibMod.OrdersCapture.RequestData
import typingsJapgolly.paypalCheckoutServerSdk.libOrdersLibMod.OrdersCapture.RequestHeaders
