...
object core {
  ...
  open class AccessToken protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libLibMod.core.AccessToken {
  ...
  open class AccessTokenRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libLibMod.core.AccessTokenRequest {
  ...
  open class LiveEnvironment protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libLibMod.core.LiveEnvironment {
  ...
  open class PayPalEnvironment protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libLibMod.core.PayPalEnvironment {
    /**
  ...
  open class PayPalHttpClient protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libLibMod.core.PayPalHttpClient {
    /**
  ...
  open class RefreshTokenRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libLibMod.core.RefreshTokenRequest {
    /**
  ...
  open class SandboxEnvironment protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libLibMod.core.SandboxEnvironment {
    def this(clientId: String, clientSecret: String) = this()
  }
}
