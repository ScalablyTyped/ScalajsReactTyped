...
import typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.CapturesRefund.RequestData
import typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.CapturesRefund.RequestHeaders
