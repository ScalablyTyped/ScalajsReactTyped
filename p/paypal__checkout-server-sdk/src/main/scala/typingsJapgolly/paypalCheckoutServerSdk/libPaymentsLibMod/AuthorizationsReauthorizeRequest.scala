...
import typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.AuthorizationsReauthorize.RequestData
import typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.AuthorizationsReauthorize.RequestHeaders
