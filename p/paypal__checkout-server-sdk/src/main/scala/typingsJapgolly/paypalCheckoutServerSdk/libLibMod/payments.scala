...
object payments {
  ...
  open class AuthorizationsCaptureRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.AuthorizationsCaptureRequest {
  ...
  open class AuthorizationsGetRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.AuthorizationsGetRequest {
    def this(authorizationId: String) = this()
  }
  ...
  open class AuthorizationsReauthorizeRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.AuthorizationsReauthorizeRequest {
    def this(authorizationId: String) = this()
  }
  ...
  open class AuthorizationsVoidRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.AuthorizationsVoidRequest {
    def this(authorizationId: String) = this()
  }
  ...
  open class BasePaymentRequest[H /* <: BasePaymentHeaders */, D] protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.BasePaymentRequest[H, D] {
    def this(authorizationId: String) = this()
  }
  ...
  open class CapturesGetRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.CapturesGetRequest {
    def this(authorizationId: String) = this()
  }
  ...
  open class CapturesRefundRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.CapturesRefundRequest {
  ...
  open class RefundsGetRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libPaymentsLibMod.RefundsGetRequest {
