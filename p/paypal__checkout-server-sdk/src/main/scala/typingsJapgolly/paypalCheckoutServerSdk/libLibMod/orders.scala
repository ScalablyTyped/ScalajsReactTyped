...
object orders {
  ...
  open class BaseOrderRequest[H /* <: BaseOrderHeaders */, B] protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libOrdersLibMod.BaseOrderRequest[H, B] {
  ...
  open class OrdersAuthorizeRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libOrdersLibMod.OrdersAuthorizeRequest {
    def this(orderId: String) = this()
  }
  ...
  open class OrdersCaptureRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libOrdersLibMod.OrdersCaptureRequest {
    def this(orderId: String) = this()
  }
  ...
  open class OrdersCreateRequest ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libOrdersLibMod.OrdersCreateRequest
  
  @JSImport("@paypal/checkout-server-sdk/lib/lib", "orders.OrdersGetRequest")
  @js.native
  open class OrdersGetRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libOrdersLibMod.OrdersGetRequest {
    def this(orderId: String) = this()
  }
  ...
  open class OrdersPatchRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libOrdersLibMod.OrdersPatchRequest {
    def this(orderId: String) = this()
  }
  ...
  open class OrdersValidateRequest protected ()
    extends typingsJapgolly.paypalCheckoutServerSdk.libOrdersLibMod.OrdersValidateRequest {
    def this(orderId: String) = this()
  }
