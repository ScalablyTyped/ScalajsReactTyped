...
object buildTypesValidationsMod {
  ...
  open class EnumerationValidation protected ()
    extends typingsJapgolly.peculiarJsonSchema.buildTypesValidationsEnumerationMod.EnumerationValidation {
  ...
  open class ExclusiveValidation ()
    extends typingsJapgolly.peculiarJsonSchema.buildTypesValidationsExclusiveMod.ExclusiveValidation {
  ...
  open class InclusiveValidation ()
    extends typingsJapgolly.peculiarJsonSchema.buildTypesValidationsInclusiveMod.InclusiveValidation {
    def this(min: Double) = this()
    def this(min: Double, max: Double) = this()
    def this(min: Unit, max: Double) = this()
  }
  ...
  open class LengthValidation ()
    extends typingsJapgolly.peculiarJsonSchema.buildTypesValidationsLengthMod.LengthValidation {
  ...
  open class PatternValidation protected ()
    extends typingsJapgolly.peculiarJsonSchema.buildTypesValidationsPatternMod.PatternValidation {
