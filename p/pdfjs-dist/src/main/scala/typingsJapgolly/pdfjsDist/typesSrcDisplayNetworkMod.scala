...
import typingsJapgolly.pdfjsDist.typesSrcSharedUtilMod.MissingPDFException
import typingsJapgolly.pdfjsDist.typesSrcSharedUtilMod.PromiseCapability
import typingsJapgolly.pdfjsDist.typesSrcSharedUtilMod.UnexpectedResponseException
...
object typesSrcDisplayNetworkMod {
  ...
  object NetworkManager {
    ...
    inline def apply(
      ...
      onProgress: (Any, Any) => Callback,
      onStateChange: (Any, Any) => Callback,
      pendingRequests: Any,
      request: Any => Double,
    ...
    extension [Self <: NetworkManager](x: Self) {
      ...
      inline def setOnProgress(value: (Any, Any) => Callback): Self = StObject.set(x, "onProgress", js.Any.fromFunction2((t0: Any, t1: Any) => (value(t0, t1)).runNow()))
      
      inline def setOnStateChange(value: (Any, Any) => Callback): Self = StObject.set(x, "onStateChange", js.Any.fromFunction2((t0: Any, t1: Any) => (value(t0, t1)).runNow()))
