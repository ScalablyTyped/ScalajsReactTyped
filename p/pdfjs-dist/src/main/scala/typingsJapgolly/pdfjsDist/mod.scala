...
object mod {
  ...
  open class AnnotationEditorLayer protected ()
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayEditorAnnotationEditorLayerMod.AnnotationEditorLayer {
    /**
  ...
  open class AnnotationEditorUIManager protected ()
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayEditorToolsMod.AnnotationEditorUIManager {
  ...
  open class AnnotationLayer ()
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayAnnotationLayerMod.AnnotationLayer
  /* static members */
  object AnnotationLayer {
    ...
    inline def `__Numbersign26@NumbersignsetDimensions`(
      div: HTMLDivElement,
      hasWidthHeightRotation: typingsJapgolly.pdfjsDist.typesSrcDisplayAnnotationLayerMod.PageViewport
  ...
  open class InvalidPDFException protected ()
    extends typingsJapgolly.pdfjsDist.typesSrcSharedUtilMod.InvalidPDFException {
  ...
  open class LoopbackPort ()
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayApiMod.LoopbackPort
  
  @JSImport("pdfjs-dist", "MissingPDFException")
  @js.native
  open class MissingPDFException protected ()
    extends typingsJapgolly.pdfjsDist.typesSrcSharedUtilMod.MissingPDFException {
    def this(msg: Any) = this()
  }
  ...
  open class PDFDataRangeTransport protected ()
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayApiMod.PDFDataRangeTransport {
    /**
      * @param {number} length
  ...
  open class PDFDateString ()
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayDisplayUtilsMod.PDFDateString
  /* static members */
  ...
  open class PDFWorker ()
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayApiMod.PDFWorker {
  ...
  open class PixelsPerInch ()
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayDisplayUtilsMod.PixelsPerInch
  /* static members */
  ...
  open class RenderingCancelledException protected ()
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayDisplayUtilsMod.RenderingCancelledException {
  ...
  open class UnexpectedResponseException protected ()
    extends typingsJapgolly.pdfjsDist.typesSrcSharedUtilMod.UnexpectedResponseException {
  ...
  @js.native
  open class Util ()
    extends typingsJapgolly.pdfjsDist.typesSrcSharedUtilMod.Util
  /* static members */
  object Util {
  ...
  @js.native
  open class XfaLayer ()
    extends typingsJapgolly.pdfjsDist.typesSrcDisplayXfaLayerMod.XfaLayer
  /* static members */
  object XfaLayer {
  ...
  inline def getDocument(src: GetDocumentParameters): typingsJapgolly.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask = ^.asInstanceOf[js.Dynamic].applyDynamic("getDocument")(src.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask]
  ...
  inline def renderTextLayer(renderParameters: TextLayerRenderParameters): typingsJapgolly.pdfjsDist.typesSrcDisplayTextLayerMod.TextLayerRenderTask = ^.asInstanceOf[js.Dynamic].applyDynamic("renderTextLayer")(renderParameters.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.pdfjsDist.typesSrcDisplayTextLayerMod.TextLayerRenderTask]
  ...
  type PDFDocumentLoadingTask = typingsJapgolly.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask
  
  type PDFDocumentProxy = typingsJapgolly.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentProxy
  
  type PDFPageProxy = typingsJapgolly.pdfjsDist.typesSrcDisplayApiMod.PDFPageProxy
  
  type PageViewport = typingsJapgolly.pdfjsDist.typesSrcDisplayDisplayUtilsMod.PageViewport
  
  type RenderTask = typingsJapgolly.pdfjsDist.typesSrcDisplayApiMod.RenderTask
  
  type TextLayerRenderTask = typingsJapgolly.pdfjsDist.typesSrcDisplayTextLayerMod.TextLayerRenderTask
}
