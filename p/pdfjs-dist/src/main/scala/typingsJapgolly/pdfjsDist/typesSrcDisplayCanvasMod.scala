...
import typingsJapgolly.pdfjsDist.anon.Background
import typingsJapgolly.pdfjsDist.anon.Img
import typingsJapgolly.pdfjsDist.anon.OffsetX
...
object typesSrcDisplayCanvasMod {
  ...
  object CachedCanvases {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(cache = cache.asInstanceOf[js.Any], canvasFactory = canvasFactory.asInstanceOf[js.Any], clear = clear.toJsFn, delete = js.Any.fromFunction1((t0: Any) => delete(t0).runNow()), getCanvas = js.Any.fromFunction3(getCanvas))
