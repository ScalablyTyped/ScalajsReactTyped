...
object PDFRenderParams {
  ...
  def apply(
    ...
    continueCallback: /* _continue */ js.Function0[Unit] => Callback = null,
    ...
    if (continueCallback != null) __obj.updateDynamic("continueCallback")(js.Any.fromFunction1((t0: /* _continue */ js.Function0[scala.Unit]) => continueCallback(t0).runNow()))
