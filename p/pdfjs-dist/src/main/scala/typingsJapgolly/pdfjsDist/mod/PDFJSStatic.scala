...
object PDFJSStatic {
  @scala.inline
  def apply(
    PDFSinglePageViewer: PDFViewerParams => Callback,
    PDFViewer: PDFViewerParams => Callback,
    cMapPacked: Boolean,
    cMapUrl: String,
