...
import typingsJapgolly.pdfjsDist.typesSrcDisplayEditorToolsMod.ColorManager
...
object typesSrcDisplayEditorEditorMod {
  ...
  open class AnnotationEditor protected () extends StObject {
    ...
    var parent: typingsJapgolly.pdfjsDist.typesSrcDisplayEditorAnnotationEditorLayerMod.AnnotationEditorLayer = js.native
  ...
  type AnnotationEditorLayer = typingsJapgolly.pdfjsDist.typesSrcDisplayEditorAnnotationEditorLayerMod.AnnotationEditorLayer
