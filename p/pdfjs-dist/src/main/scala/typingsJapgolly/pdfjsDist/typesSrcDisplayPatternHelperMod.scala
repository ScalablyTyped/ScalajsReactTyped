...
import typingsJapgolly.pdfjsDist.anon.OffsetY
import typingsJapgolly.pdfjsDist.anon.Scale
import typingsJapgolly.pdfjsDist.anon.ScaleX
...
object typesSrcDisplayPatternHelperMod {
  ...
  object BaseShadingPattern {
    ...
    inline def apply(getPattern: Callback): BaseShadingPattern = {
      val __obj = js.Dynamic.literal(getPattern = getPattern.toJsFn)
      __obj.asInstanceOf[BaseShadingPattern]
    }
    
    extension [Self <: BaseShadingPattern](x: Self) {
      
      inline def setGetPattern(value: Callback): Self = StObject.set(x, "getPattern", value.toJsFn)
    }
  }
  ...
  object DummyShadingPattern {
    ...
    inline def apply(getPattern: Callback): DummyShadingPattern = {
      val __obj = js.Dynamic.literal(getPattern = getPattern.toJsFn)
