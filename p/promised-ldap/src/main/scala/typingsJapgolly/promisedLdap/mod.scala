...
import typingsJapgolly.promisedLdap.anon.Email
import typingsJapgolly.promisedLdap.anon.Entries
import typingsJapgolly.promisedLdap.anon.Url
...
object mod {
  ...
  trait Client extends EventEmitter {
    ...
    def _search(base: String, options: typingsJapgolly.ldapjs.mod.SearchOptions, controls: Unit, _bypass: Boolean): js.Promise[EventEmitter] = js.native
    ...
    def search(base: String, options: typingsJapgolly.ldapjs.mod.SearchOptions): js.Promise[Entries] = js.native
    def search(base: String, options: typingsJapgolly.ldapjs.mod.SearchOptions, controls: js.Array[Control]): js.Promise[Entries] = js.native
    def search(base: String, options: typingsJapgolly.ldapjs.mod.SearchOptions, controls: Control): js.Promise[Entries] = js.native
  ...
  type SearchOptions = typingsJapgolly.ldapjs.mod.SearchOptions
}
