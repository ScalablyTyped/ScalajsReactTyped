...
object mod {
  ...
  inline def find(schema: typingsJapgolly.propertyInformation.libFindMod.Schema, value: String): typingsJapgolly.propertyInformation.libUtilInfoMod.Info = (^.asInstanceOf[js.Dynamic].applyDynamic("find")(schema.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.propertyInformation.libUtilInfoMod.Info]
  ...
  @js.native
  val html: typingsJapgolly.propertyInformation.libUtilSchemaMod.Schema = js.native
  ...
  @js.native
  val svg: typingsJapgolly.propertyInformation.libUtilSchemaMod.Schema = js.native
  
  type Info = typingsJapgolly.propertyInformation.libUtilInfoMod.Info
