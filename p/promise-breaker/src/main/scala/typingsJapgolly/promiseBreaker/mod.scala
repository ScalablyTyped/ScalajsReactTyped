...
import typingsJapgolly.promiseBreaker.mod.PromiseBreaker.BrokenFn0
import typingsJapgolly.promiseBreaker.mod.PromiseBreaker.BrokenFn1
import typingsJapgolly.promiseBreaker.mod.PromiseBreaker.BrokenFn2
import typingsJapgolly.promiseBreaker.mod.PromiseBreaker.BrokenFn3
import typingsJapgolly.promiseBreaker.mod.PromiseBreaker.Callback
import typingsJapgolly.promiseBreaker.mod.PromiseBreaker.MakeBreakOptions
import typingsJapgolly.promiseBreaker.mod.PromiseBreaker.PromiseBreaker
...
object mod {
  ...
  object PromiseBreaker {
    ...
    trait PromiseBreaker
      ...
      def withPromise(promiseImpl: PromiseConstructor): typingsJapgolly.promiseBreaker.mod.PromiseBreaker.PromiseBreaker = js.native
    }
