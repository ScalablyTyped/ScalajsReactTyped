package typingsJapgolly.printer

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.printer.printerStrings.AUTO
import typingsJapgolly.printer.printerStrings.CANCEL
import typingsJapgolly.printer.printerStrings.COMMAND
import typingsJapgolly.printer.printerStrings.JPEG
import typingsJapgolly.printer.printerStrings.PDF
import typingsJapgolly.printer.printerStrings.POSTSCRIPT
import typingsJapgolly.printer.printerStrings.RAW
import typingsJapgolly.printer.printerStrings.TEXT
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.printer.printerStrings.PAUSED
    - typingsJapgolly.printer.printerStrings.PRINTING
    - typingsJapgolly.printer.printerStrings.PRINTED
    - typingsJapgolly.printer.printerStrings.CANCELLED
    - typingsJapgolly.printer.printerStrings.PENDING
    - typingsJapgolly.printer.printerStrings.ABORTED
  */
  trait JobStatus extends StObject
  object JobStatus {
    
    inline def ABORTED: typingsJapgolly.printer.printerStrings.ABORTED = "ABORTED".asInstanceOf[typingsJapgolly.printer.printerStrings.ABORTED]
    
    inline def CANCELLED: typingsJapgolly.printer.printerStrings.CANCELLED = "CANCELLED".asInstanceOf[typingsJapgolly.printer.printerStrings.CANCELLED]
    
    inline def PAUSED: typingsJapgolly.printer.printerStrings.PAUSED = "PAUSED".asInstanceOf[typingsJapgolly.printer.printerStrings.PAUSED]
    
    inline def PENDING: typingsJapgolly.printer.printerStrings.PENDING = "PENDING".asInstanceOf[typingsJapgolly.printer.printerStrings.PENDING]
    
    inline def PRINTED: typingsJapgolly.printer.printerStrings.PRINTED = "PRINTED".asInstanceOf[typingsJapgolly.printer.printerStrings.PRINTED]
    
    inline def PRINTING: typingsJapgolly.printer.printerStrings.PRINTING = "PRINTING".asInstanceOf[typingsJapgolly.printer.printerStrings.PRINTING]
  }
