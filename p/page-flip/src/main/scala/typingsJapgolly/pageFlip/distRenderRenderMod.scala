...
object distRenderRenderMod {
  ...
  object AnimationProcess {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(duration = duration.asInstanceOf[js.Any], durationFrame = durationFrame.asInstanceOf[js.Any], frames = frames.asInstanceOf[js.Any], onAnimateEnd = onAnimateEnd.toJsFn, startedAt = startedAt.asInstanceOf[js.Any])
    ...
    extension [Self <: AnimationProcess](x: Self) {
      ...
      inline def setOnAnimateEnd(value: Callback): Self = StObject.set(x, "onAnimateEnd", value.toJsFn)
