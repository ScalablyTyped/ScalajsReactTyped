...
object global {
  ...
  object St {
    ...
    open class CanvasRender protected ()
      extends typingsJapgolly.pageFlip.mod.CanvasRender {
      def this(
    ...
    open class CanvasUI protected ()
      extends typingsJapgolly.pageFlip.mod.CanvasUI {
    ...
    open class EventObject ()
      extends typingsJapgolly.pageFlip.mod.EventObject
    
    @JSGlobal("St.Flip")
    @js.native
    open class Flip protected ()
      extends typingsJapgolly.pageFlip.mod.Flip {
      def this(
    ...
    open class FlipCalculation protected ()
      extends typingsJapgolly.pageFlip.mod.FlipCalculation {
    ...
    open class HTMLPage protected ()
      extends typingsJapgolly.pageFlip.mod.HTMLPage {
      def this(
        render: typingsJapgolly.pageFlip.distRenderRenderMod.Render,
        element: HTMLElement,
        density: PageDensity
    ...
    open class HTMLPageCollection protected ()
      extends typingsJapgolly.pageFlip.mod.HTMLPageCollection {
      def this(
        app: typingsJapgolly.pageFlip.distPageFlipMod.PageFlip,
        render: typingsJapgolly.pageFlip.distRenderRenderMod.Render,
        element: HTMLElement,
    ...
    open class HTMLRender protected ()
      extends typingsJapgolly.pageFlip.mod.HTMLRender {
    ...
    open class HTMLUI protected ()
      extends typingsJapgolly.pageFlip.mod.HTMLUI {
      def this(
        inBlock: HTMLElement,
        app: typingsJapgolly.pageFlip.distPageFlipMod.PageFlip,
        setting: FlipSetting,
    ...
    open class ImagePage protected ()
      extends typingsJapgolly.pageFlip.mod.ImagePage {
    ...
    open class ImagePageCollection protected ()
      extends typingsJapgolly.pageFlip.mod.ImagePageCollection {
      def this(
        app: typingsJapgolly.pageFlip.distPageFlipMod.PageFlip,
        render: typingsJapgolly.pageFlip.distRenderRenderMod.Render,
    ...
    open class Page protected ()
      extends typingsJapgolly.pageFlip.mod.Page {
    ...
    open class PageCollection protected ()
      extends typingsJapgolly.pageFlip.mod.PageCollection {
      /* protected */ def this(
        app: typingsJapgolly.pageFlip.distPageFlipMod.PageFlip,
        render: typingsJapgolly.pageFlip.distRenderRenderMod.Render
      ) = this()
    ...
    open class PageFlip protected ()
      extends typingsJapgolly.pageFlip.mod.PageFlip {
      /**
    ...
    open class Render protected ()
      extends typingsJapgolly.pageFlip.mod.Render {
    ...
    @js.native
    open class Settings ()
      extends typingsJapgolly.pageFlip.mod.Settings
    ...
    open class UI protected ()
      extends typingsJapgolly.pageFlip.mod.UI {
