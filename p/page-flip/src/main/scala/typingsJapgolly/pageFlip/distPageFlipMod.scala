...
import typingsJapgolly.pageFlip.distBasicTypesMod.PageRect
...
import typingsJapgolly.pageFlip.distEventEventObjectMod.EventObject
import typingsJapgolly.pageFlip.distFlipFlipMod.Flip
import typingsJapgolly.pageFlip.distFlipFlipMod.FlipCorner
import typingsJapgolly.pageFlip.distFlipFlipMod.FlippingState
...
object distPageFlipMod {
  ...
  open class PageFlip protected () extends EventObject {
    ...
    /**
      ...
      */
    def loadFromHTML(items: NodeList[HTMLElement & Node]): Unit = js.native
    ...
    /**
      ...
      */
    def updateFromHtml(items: NodeList[HTMLElement & Node]): Unit = js.native
