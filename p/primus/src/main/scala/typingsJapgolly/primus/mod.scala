...
import typingsJapgolly.primus.anon.Authenticate
import typingsJapgolly.primus.anon.Close
import typingsJapgolly.primus.anon.Factor
import typingsJapgolly.primus.anon.Ip
import typingsJapgolly.primus.anon.Name
import typingsJapgolly.primus.anon.Reconnect
import typingsJapgolly.primus.mod.emits.emits
import typingsJapgolly.primus.mod.emits.fn
import typingsJapgolly.primus.mod.emits.parser
import typingsJapgolly.primus.primusStrings.`reconnect failed`
import typingsJapgolly.primus.primusStrings.`reconnect scheduled`
import typingsJapgolly.primus.primusStrings.`reconnect timeout`
import typingsJapgolly.primus.primusStrings.browserchannel
import typingsJapgolly.primus.primusStrings.connection
import typingsJapgolly.primus.primusStrings.data
import typingsJapgolly.primus.primusStrings.disconnect
import typingsJapgolly.primus.primusStrings.disconnection
import typingsJapgolly.primus.primusStrings.end
import typingsJapgolly.primus.primusStrings.engineDotio
import typingsJapgolly.primus.primusStrings.error
import typingsJapgolly.primus.primusStrings.faye
import typingsJapgolly.primus.primusStrings.incoming
import typingsJapgolly.primus.primusStrings.online
import typingsJapgolly.primus.primusStrings.open
import typingsJapgolly.primus.primusStrings.outgoing
import typingsJapgolly.primus.primusStrings.plugin
import typingsJapgolly.primus.primusStrings.plugout
import typingsJapgolly.primus.primusStrings.reconnect
import typingsJapgolly.primus.primusStrings.reconnected
import typingsJapgolly.primus.primusStrings.sockjs
import typingsJapgolly.primus.primusStrings.timeout
import typingsJapgolly.primus.primusStrings.uws
import typingsJapgolly.primus.primusStrings.websockets
...
object mod {
  ...
  object Parser {
    ...
    inline def apply(
      decoder: (Any, js.Function2[/* error */ js.Error, /* response */ Any, Unit]) => Callback,
      encoder: (Any, js.Function2[/* error */ js.Error, /* response */ Any, Unit]) => Callback
    ): Parser = {
      val __obj = js.Dynamic.literal(decoder = js.Any.fromFunction2((t0: Any, t1: js.Function2[/* error */ js.Error, /* response */ Any, Unit]) => (decoder(t0, t1)).runNow()), encoder = js.Any.fromFunction2((t0: Any, t1: js.Function2[/* error */ js.Error, /* response */ Any, Unit]) => (encoder(t0, t1)).runNow()))
      __obj.asInstanceOf[Parser]
    }
    
    extension [Self <: Parser](x: Self) {
      
      inline def setDecoder(value: (Any, js.Function2[/* error */ js.Error, /* response */ Any, Unit]) => Callback): Self = StObject.set(x, "decoder", js.Any.fromFunction2((t0: Any, t1: js.Function2[/* error */ js.Error, /* response */ Any, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setEncoder(value: (Any, js.Function2[/* error */ js.Error, /* response */ Any, Unit]) => Callback): Self = StObject.set(x, "encoder", js.Any.fromFunction2((t0: Any, t1: js.Function2[/* error */ js.Error, /* response */ Any, Unit]) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object PrimusOptions {
    ...
    extension [Self <: PrimusOptions](x: Self) {
      ...
      inline def setAuthorization(
        value: (/* req */ IncomingMessage, /* done */ js.Function1[/* err */ js.UndefOr[String | js.Error | Authenticate], Unit]) => Callback
      ): Self = StObject.set(x, "authorization", js.Any.fromFunction2((t0: /* req */ IncomingMessage, t1: /* done */ js.Function1[/* err */ js.UndefOr[String | js.Error | Authenticate], Unit]) => (value(t0, t1)).runNow()))
      ...
      inline def setIdGenerator(value: CallbackTo[String]): Self = StObject.set(x, "idGenerator", value.toJsFn)
