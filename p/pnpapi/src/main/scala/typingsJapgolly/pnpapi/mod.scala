...
import typingsJapgolly.pnpapi.anon.ConsiderBuiltins
import typingsJapgolly.pnpapi.anon.Extensions
import typingsJapgolly.pnpapi.anon.`0`
...
object mod {
  ...
  */
  ...
  object PackageLocator {
    ...
    inline def PhysicalPackageLocator(name: String, reference: String): typingsJapgolly.pnpapi.mod.PhysicalPackageLocator = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], reference = reference.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.pnpapi.mod.PhysicalPackageLocator]
    }
    
    inline def TopLevelPackageLocator(name: Null, reference: Null): typingsJapgolly.pnpapi.mod.TopLevelPackageLocator = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], reference = reference.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.pnpapi.mod.TopLevelPackageLocator]
    }
  }
