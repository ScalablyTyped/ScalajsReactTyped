package typingsJapgolly.pinyin4js
...
object mod {
  ...
  @js.native
  val FIRST_LETTER: typingsJapgolly.pinyin4js.mod.FIRST_LETTER = js.native
  type FIRST_LETTER = String
  
  @JSImport("pinyin4js", "WITHOUT_TONE")
  @js.native
  val WITHOUT_TONE: typingsJapgolly.pinyin4js.mod.WITHOUT_TONE = js.native
  type WITHOUT_TONE = String
  
  @JSImport("pinyin4js", "WITH_TONE_MARK")
  @js.native
  val WITH_TONE_MARK: typingsJapgolly.pinyin4js.mod.WITH_TONE_MARK = js.native
  type WITH_TONE_MARK = String
  
  @JSImport("pinyin4js", "WITH_TONE_NUMBER")
  @js.native
  val WITH_TONE_NUMBER: typingsJapgolly.pinyin4js.mod.WITH_TONE_NUMBER = js.native
  ...
  type format = typingsJapgolly.pinyin4js.mod.WITH_TONE_NUMBER | typingsJapgolly.pinyin4js.mod.WITHOUT_TONE | typingsJapgolly.pinyin4js.mod.WITH_TONE_MARK | typingsJapgolly.pinyin4js.mod.FIRST_LETTER
}
