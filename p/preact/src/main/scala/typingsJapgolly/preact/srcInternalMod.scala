...
object srcInternalMod {
  ...
  object HookType extends StObject {
    ...
    sealed trait useCallback
      extends StObject
         with HookType
    /* 8 */ val useCallback: typingsJapgolly.preact.srcInternalMod.HookType.useCallback & Double = js.native
    
    @js.native
    sealed trait useContext
      extends StObject
         with HookType
    /* 9 */ val useContext: typingsJapgolly.preact.srcInternalMod.HookType.useContext & Double = js.native
    ...
    sealed trait useDebugvalue
      extends StObject
         with HookType
    /* 11 */ val useDebugvalue: typingsJapgolly.preact.srcInternalMod.HookType.useDebugvalue & Double = js.native
    
    @js.native
    sealed trait useEffect
      extends StObject
         with HookType
    /* 3 */ val useEffect: typingsJapgolly.preact.srcInternalMod.HookType.useEffect & Double = js.native
    
    @js.native
    sealed trait useErrorBoundary
      extends StObject
         with HookType
    /* 10 */ val useErrorBoundary: typingsJapgolly.preact.srcInternalMod.HookType.useErrorBoundary & Double = js.native
    
    @js.native
    sealed trait useImperativeHandle
      extends StObject
         with HookType
    /* 6 */ val useImperativeHandle: typingsJapgolly.preact.srcInternalMod.HookType.useImperativeHandle & Double = js.native
    
    @js.native
    sealed trait useLayoutEffect
      extends StObject
         with HookType
    /* 4 */ val useLayoutEffect: typingsJapgolly.preact.srcInternalMod.HookType.useLayoutEffect & Double = js.native
    
    @js.native
    sealed trait useMemo
      extends StObject
         with HookType
    /* 7 */ val useMemo: typingsJapgolly.preact.srcInternalMod.HookType.useMemo & Double = js.native
    
    @js.native
    sealed trait useReducer
      extends StObject
         with HookType
    /* 2 */ val useReducer: typingsJapgolly.preact.srcInternalMod.HookType.useReducer & Double = js.native
    
    @js.native
    sealed trait useRef
      extends StObject
         with HookType
    /* 5 */ val useRef: typingsJapgolly.preact.srcInternalMod.HookType.useRef & Double = js.native
    
    @js.native
    sealed trait useState
      extends StObject
         with HookType
    /* 1 */ val useState: typingsJapgolly.preact.srcInternalMod.HookType.useState & Double = js.native
  }
  ...
  trait ComponentClass[P]
    extends StObject
       with typingsJapgolly.preact.mod.ComponentClass[P, js.Object]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.preact.srcInternalMod.ComponentClass[P]
    - typingsJapgolly.preact.srcInternalMod.FunctionComponent[P]
  */
  ...
  trait FunctionComponent[P]
    extends StObject
       with typingsJapgolly.preact.mod.FunctionComponent[P]
       with ComponentType[P] {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.preact.srcInternalMod.RefObject[T]
    - typingsJapgolly.preact.srcInternalMod.RefCallback[T]
  */
  ...
  trait VNode[P]
    extends StObject
       with typingsJapgolly.preact.mod.VNode[P] {
  ...
  object VNode {
    ...
    inline def apply[P](
      ...
      `type`: typingsJapgolly.preact.mod.ComponentType[P] | String
    ): VNode[P] = {
