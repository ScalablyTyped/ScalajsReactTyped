...
import typingsJapgolly.preact.srcInternalMod.ComponentChild
import typingsJapgolly.preact.srcInternalMod.ComponentChildren
...
object anon {
  ...
  trait Children[T] extends StObject {
    ...
    def children(value: T): typingsJapgolly.preact.mod.ComponentChildren
  }
  object Children {
    
    inline def apply[T](children: T => typingsJapgolly.preact.mod.ComponentChildren): Children[T] = {
    ...
    extension [Self <: Children[?], T](x: Self & Children[T]) {
      ...
      inline def setChildren(value: T => typingsJapgolly.preact.mod.ComponentChildren): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    }
  }
  
  trait ChildrenComponentChildren extends StObject {
    
    var children: typingsJapgolly.preact.mod.ComponentChildren
  }
  object ChildrenComponentChildren {
    ...
    extension [Self <: ChildrenComponentChildren](x: Self) {
      ...
      inline def setChildren(value: typingsJapgolly.preact.mod.ComponentChildren): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenNull: Self = StObject.set(x, "children", null)
      
      inline def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
      
      inline def setChildrenVarargs(value: typingsJapgolly.preact.mod.ComponentChild*): Self = StObject.set(x, "children", js.Array(value*))
    }
  }
  ...
  trait Ref[RefType] extends StObject {
    ...
    var children: js.UndefOr[typingsJapgolly.preact.mod.ComponentChildren] = js.undefined
    
    var ref: js.UndefOr[typingsJapgolly.preact.mod.Ref[RefType]] = js.undefined
  }
  object Ref {
    ...
    extension [Self <: Ref[?], RefType](x: Self & Ref[RefType]) {
      ...
      inline def setRef(value: typingsJapgolly.preact.mod.Ref[RefType]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      inline def setRefFunction1(value: /* instance */ RefType | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: /* instance */ RefType | Null) => value(t0).runNow()))
