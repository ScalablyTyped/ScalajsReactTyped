...
object TargetedKeyboardEvent {
  ...
  inline def apply[Target /* <: EventTarget */](
    ...
    initKeyboardEvent: (/* typeArg */ String, /* bubblesArg */ js.UndefOr[Boolean], /* cancelableArg */ js.UndefOr[Boolean], /* viewArg */ js.UndefOr[Window | Null], /* keyArg */ js.UndefOr[String], /* locationArg */ js.UndefOr[Double], /* ctrlKey */ js.UndefOr[Boolean], /* altKey */ js.UndefOr[Boolean], /* shiftKey */ js.UndefOr[Boolean], /* metaKey */ js.UndefOr[Boolean]) => Callback,
    ...
    val __obj = js.Dynamic.literal(AT_TARGET = AT_TARGET.asInstanceOf[js.Any], BUBBLING_PHASE = BUBBLING_PHASE.asInstanceOf[js.Any], CAPTURING_PHASE = CAPTURING_PHASE.asInstanceOf[js.Any], DOM_KEY_LOCATION_LEFT = DOM_KEY_LOCATION_LEFT.asInstanceOf[js.Any], DOM_KEY_LOCATION_NUMPAD = DOM_KEY_LOCATION_NUMPAD.asInstanceOf[js.Any], DOM_KEY_LOCATION_RIGHT = DOM_KEY_LOCATION_RIGHT.asInstanceOf[js.Any], DOM_KEY_LOCATION_STANDARD = DOM_KEY_LOCATION_STANDARD.asInstanceOf[js.Any], NONE = NONE.asInstanceOf[js.Any], altKey = altKey.asInstanceOf[js.Any], bubbles = bubbles.asInstanceOf[js.Any], cancelBubble = cancelBubble.asInstanceOf[js.Any], cancelable = cancelable.asInstanceOf[js.Any], charCode = charCode.asInstanceOf[js.Any], code = code.asInstanceOf[js.Any], composed = composed.asInstanceOf[js.Any], composedPath = composedPath.toJsFn, ctrlKey = ctrlKey.asInstanceOf[js.Any], currentTarget = currentTarget.asInstanceOf[js.Any], defaultPrevented = defaultPrevented.asInstanceOf[js.Any], detail = detail.asInstanceOf[js.Any], eventPhase = eventPhase.asInstanceOf[js.Any], getModifierState = js.Any.fromFunction1(getModifierState), initEvent = js.Any.fromFunction1((t0: /* type */ String) => initEvent(t0).runNow()), initKeyboardEvent = js.Any.fromFunction10((t0: /* typeArg */ String, t1: /* bubblesArg */ js.UndefOr[Boolean], t2: /* cancelableArg */ js.UndefOr[Boolean], t3: /* viewArg */ js.UndefOr[Window | Null], t4: /* keyArg */ js.UndefOr[String], t5: /* locationArg */ js.UndefOr[Double], t6: /* ctrlKey */ js.UndefOr[Boolean], t7: /* altKey */ js.UndefOr[Boolean], t8: /* shiftKey */ js.UndefOr[Boolean], t9: /* metaKey */ js.UndefOr[Boolean]) => (initKeyboardEvent(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9)).runNow()), initUIEvent = js.Any.fromFunction1((t0: /* typeArg */ String) => initUIEvent(t0).runNow()), isComposing = isComposing.asInstanceOf[js.Any], isTrusted = isTrusted.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any], keyCode = keyCode.asInstanceOf[js.Any], location = location.asInstanceOf[js.Any], metaKey = metaKey.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, repeat = repeat.asInstanceOf[js.Any], returnValue = returnValue.asInstanceOf[js.Any], shiftKey = shiftKey.asInstanceOf[js.Any], stopImmediatePropagation = stopImmediatePropagation.toJsFn, stopPropagation = stopPropagation.toJsFn, timeStamp = timeStamp.asInstanceOf[js.Any], which = which.asInstanceOf[js.Any])
  ...
  extension [Self <: TargetedKeyboardEvent[?], Target /* <: EventTarget */](x: Self & TargetedKeyboardEvent[Target]) {
    ...
    inline def setInitKeyboardEvent(
      value: (/* typeArg */ String, /* bubblesArg */ js.UndefOr[Boolean], /* cancelableArg */ js.UndefOr[Boolean], /* viewArg */ js.UndefOr[Window | Null], /* keyArg */ js.UndefOr[String], /* locationArg */ js.UndefOr[Double], /* ctrlKey */ js.UndefOr[Boolean], /* altKey */ js.UndefOr[Boolean], /* shiftKey */ js.UndefOr[Boolean], /* metaKey */ js.UndefOr[Boolean]) => Callback
    ): Self = StObject.set(x, "initKeyboardEvent", js.Any.fromFunction10((t0: /* typeArg */ String, t1: /* bubblesArg */ js.UndefOr[Boolean], t2: /* cancelableArg */ js.UndefOr[Boolean], t3: /* viewArg */ js.UndefOr[Window | Null], t4: /* keyArg */ js.UndefOr[String], t5: /* locationArg */ js.UndefOr[Double], t6: /* ctrlKey */ js.UndefOr[Boolean], t7: /* altKey */ js.UndefOr[Boolean], t8: /* shiftKey */ js.UndefOr[Boolean], t9: /* metaKey */ js.UndefOr[Boolean]) => (value(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9)).runNow()))
