...
import typingsJapgolly.powerappsComponentFramework.ComponentFramework.UserSettingApi.DateFormattingInfo
import typingsJapgolly.powerappsComponentFramework.ComponentFramework.UserSettingApi.NumberFormattingInfo
