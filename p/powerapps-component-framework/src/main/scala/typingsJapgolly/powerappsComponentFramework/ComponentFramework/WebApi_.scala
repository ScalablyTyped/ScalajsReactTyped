...
import typingsJapgolly.powerappsComponentFramework.ComponentFramework.WebApi.Entity
import typingsJapgolly.powerappsComponentFramework.ComponentFramework.WebApi.RetrieveMultipleResponse
