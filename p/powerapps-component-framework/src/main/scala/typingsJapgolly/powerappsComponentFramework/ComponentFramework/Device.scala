...
import typingsJapgolly.powerappsComponentFramework.ComponentFramework.DeviceApi.CaptureImageOptions
import typingsJapgolly.powerappsComponentFramework.ComponentFramework.DeviceApi.PickFileOptions
import typingsJapgolly.powerappsComponentFramework.ComponentFramework.DeviceApi.Position
