...
import typingsJapgolly.proj4.mod.InterfaceCoordinates
import typingsJapgolly.proj4.mod.InterfaceProjection
import typingsJapgolly.proj4.mod.ProjectionDefinition
import typingsJapgolly.proj4.mod.TemplateCoordinates
