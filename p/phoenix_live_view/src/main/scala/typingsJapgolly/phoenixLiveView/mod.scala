package typingsJapgolly.phoenixLiveView
...
object mod {
  ...
  object DomOptions {
    ...
    extension [Self <: DomOptions](x: Self) {
      ...
      inline def setOnElUpdated(value: /* el */ HTMLElement => Callback): Self = StObject.set(x, "onElUpdated", js.Any.fromFunction1((t0: /* el */ HTMLElement) => value(t0).runNow()))
      ...
      inline def setOnNodeDiscarded(value: /* node */ Node => Callback): Self = StObject.set(x, "onNodeDiscarded", js.Any.fromFunction1((t0: /* node */ Node) => value(t0).runNow()))
  ...
  object SocketOptions {
    ...
    extension [Self <: SocketOptions](x: Self) {
      ...
      inline def setViewLogger(value: (/* view */ View, /* kind */ String, /* msg */ Any, /* obj */ Any) => Callback): Self = StObject.set(x, "viewLogger", js.Any.fromFunction4((t0: /* view */ View, t1: /* kind */ String, t2: /* msg */ Any, t3: /* obj */ Any) => (value(t0, t1, t2, t3)).runNow()))
