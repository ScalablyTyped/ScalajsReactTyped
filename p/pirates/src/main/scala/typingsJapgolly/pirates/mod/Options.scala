package typingsJapgolly.pirates.mod
...
object Options {
  ...
  def apply(
    ...
    matcher: /* code */ String => CallbackTo[Boolean] = null
  ): Options = {
    ...
    if (matcher != null) __obj.updateDynamic("matcher")(js.Any.fromFunction1((t0: /* code */ java.lang.String) => matcher(t0).runNow()))
