package typingsJapgolly.pkginfo

import typingsJapgolly.node.NodeModule
import typingsJapgolly.pkginfo.mod.PkgInfo.FindResults
import typingsJapgolly.pkginfo.mod.PkgInfo.Options
import typingsJapgolly.pkginfo.mod.PkgInfo.PkgInfo
...
object mod {
  ...
  object PkgInfo {
    ...
    trait PkgInfo extends StObject {
      ...
      def apply(pmodule: NodeModule, options: String, properties: String*): typingsJapgolly.pkginfo.mod.PkgInfo.PkgInfo = js.native
      def apply(pmodule: NodeModule, options: js.Array[String], properties: String*): typingsJapgolly.pkginfo.mod.PkgInfo.PkgInfo = js.native
      def apply(pmodule: NodeModule, options: Unit, properties: String*): typingsJapgolly.pkginfo.mod.PkgInfo.PkgInfo = js.native
      def apply(pmodule: NodeModule, options: Options, properties: String*): typingsJapgolly.pkginfo.mod.PkgInfo.PkgInfo = js.native
