...
import typingsJapgolly.pagerJackrabbit.anon.Amqp
...
object mod {
  ...
  object exchangeType extends StObject {
    ...
    sealed trait direct
      extends StObject
         with exchangeType
    /* "direct" */ val direct: typingsJapgolly.pagerJackrabbit.mod.exchangeType.direct & String = js.native
    
    @js.native
    sealed trait fanout
      extends StObject
         with exchangeType
    /* "fanout" */ val fanout: typingsJapgolly.pagerJackrabbit.mod.exchangeType.fanout & String = js.native
    
    @js.native
    sealed trait topic
      extends StObject
         with exchangeType
    /* "topic" */ val topic: typingsJapgolly.pagerJackrabbit.mod.exchangeType.topic & String = js.native
  }
