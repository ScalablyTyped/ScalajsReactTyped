...
import typingsJapgolly.poissonDiskSampling.anon.Data
import typingsJapgolly.poissonDiskSampling.anon.MinDistance
...
object srcImplementationsFixedDensityMod {
  ...
  object FixedDensityPDS {
    ...
    inline def apply(
      ...
      getAllPointsWithDistance: Callback,
      grid: Data,
      ...
      val __obj = js.Dynamic.literal(addPoint = js.Any.fromFunction1(addPoint), addRandomPoint = addRandomPoint.toJsFn, cellSize = cellSize.asInstanceOf[js.Any], deltaDistance = deltaDistance.asInstanceOf[js.Any], dimension = dimension.asInstanceOf[js.Any], directAddPoint = js.Any.fromFunction1(directAddPoint), fill = fill.toJsFn, getAllPoints = getAllPoints.toJsFn, getAllPointsWithDistance = getAllPointsWithDistance.toJsFn, grid = grid.asInstanceOf[js.Any], gridShape = gridShape.asInstanceOf[js.Any], inNeighbourhood = js.Any.fromFunction1(inNeighbourhood), maxDistance = maxDistance.asInstanceOf[js.Any], maxTries = maxTries.asInstanceOf[js.Any], minDistance = minDistance.asInstanceOf[js.Any], minDistancePlusEpsilon = minDistancePlusEpsilon.asInstanceOf[js.Any], neighbourhood = neighbourhood.asInstanceOf[js.Any], next = next.toJsFn, processList = processList.asInstanceOf[js.Any], reset = reset.toJsFn, samplePoints = samplePoints.asInstanceOf[js.Any], shape = shape.asInstanceOf[js.Any], squaredMinDistance = squaredMinDistance.asInstanceOf[js.Any], currentPoint = null, rng = null)
    ...
    extension [Self <: FixedDensityPDS](x: Self) {
      ...
      inline def setGetAllPointsWithDistance(value: Callback): Self = StObject.set(x, "getAllPointsWithDistance", value.toJsFn)
