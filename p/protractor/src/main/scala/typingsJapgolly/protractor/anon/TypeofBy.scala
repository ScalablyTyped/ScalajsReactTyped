...
trait TypeofBy
  ...
  /**
    ...
    */
  def className(name: String): typingsJapgolly.seleniumWebdriver.libByMod.By = js.native
  ...
  /**
    ...
    */
  def css(selector: String): typingsJapgolly.seleniumWebdriver.libByMod.By = js.native
  ...
  /**
    ...
    * @return {!By} The new locator.
    */
  def id(id: String): typingsJapgolly.seleniumWebdriver.libByMod.By = js.native
  ...
  /**
    ...
    * @return {!By} The new locator.
    */
  def linkText(text: String): typingsJapgolly.seleniumWebdriver.libByMod.By = js.native
  ...
  /**
    ...
    * @return {!By} The new locator.
    */
  def name(name: String): typingsJapgolly.seleniumWebdriver.libByMod.By = js.native
  ...
  /**
    ...
    * @return {!By} The new locator.
    */
  def partialLinkText(text: String): typingsJapgolly.seleniumWebdriver.libByMod.By = js.native
  ...
  /**
    ...
    */
  def tagName(name: String): typingsJapgolly.seleniumWebdriver.libByMod.By = js.native
  ...
  /**
    ...
    */
  def xpath(xpath: String): typingsJapgolly.seleniumWebdriver.libByMod.By = js.native
}
