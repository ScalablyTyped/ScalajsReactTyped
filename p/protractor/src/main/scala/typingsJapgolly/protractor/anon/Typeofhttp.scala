...
import typingsJapgolly.seleniumWebdriver.httpMod.HttpClient
import typingsJapgolly.seleniumWebdriver.httpMod.Response
...
trait Typeofhttp extends StObject {
  ...
  var Executor: Instantiable1[/* client */ HttpClient, typingsJapgolly.seleniumWebdriver.httpMod.Executor] = js.native
  
  var HttpClient: Instantiable1[/* serverUrl */ String, typingsJapgolly.seleniumWebdriver.httpMod.HttpClient] = js.native
  
  var Request: Instantiable2[
    /* method */ String, 
    /* path */ String, 
    typingsJapgolly.seleniumWebdriver.httpMod.Request
  ] = js.native
  ...
  var Response: Instantiable3[
    ...
    /* headers */ js.Object, 
    /* body */ String, 
    typingsJapgolly.seleniumWebdriver.httpMod.Response
  ] = js.native
