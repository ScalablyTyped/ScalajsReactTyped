...
import typingsJapgolly.protractor.anon.DefaultTimeoutInterval
import typingsJapgolly.protractor.anon.Dictkey
import typingsJapgolly.protractor.anon.JvmArgs
import typingsJapgolly.protractor.anon.Reporter
import typingsJapgolly.protractor.builtPluginsMod.PluginConfig
...
object builtConfigMod {
  ...
  object Config {
    ...
    extension [Self <: Config](x: Self) {
      ...
      inline def setAfterLaunch(value: /* exitCode */ Double => Callback): Self = StObject.set(x, "afterLaunch", js.Any.fromFunction1((t0: /* exitCode */ Double) => value(t0).runNow()))
      ...
      inline def setBeforeLaunch(value: Callback): Self = StObject.set(x, "beforeLaunch", value.toJsFn)
      ...
      inline def setOnCleanUp(value: /* exitCode */ Double => Callback): Self = StObject.set(x, "onCleanUp", js.Any.fromFunction1((t0: /* exitCode */ Double) => value(t0).runNow()))
      ...
      inline def setOnPrepare(value: Callback): Self = StObject.set(x, "onPrepare", value.toJsFn)
