...
object builtLoggerMod {
  ...
  object LogLevel extends StObject {
    ...
    sealed trait DEBUG
      extends StObject
         with LogLevel
    /* 3 */ val DEBUG: typingsJapgolly.protractor.builtLoggerMod.LogLevel.DEBUG & Double = js.native
    
    @js.native
    sealed trait ERROR
      extends StObject
         with LogLevel
    /* 0 */ val ERROR: typingsJapgolly.protractor.builtLoggerMod.LogLevel.ERROR & Double = js.native
    
    @js.native
    sealed trait INFO
      extends StObject
         with LogLevel
    /* 2 */ val INFO: typingsJapgolly.protractor.builtLoggerMod.LogLevel.INFO & Double = js.native
    
    @js.native
    sealed trait WARN
      extends StObject
         with LogLevel
    /* 1 */ val WARN: typingsJapgolly.protractor.builtLoggerMod.LogLevel.WARN & Double = js.native
  }
  ...
  object WriteTo extends StObject {
    ...
    sealed trait BOTH
      extends StObject
         with WriteTo
    /* 2 */ val BOTH: typingsJapgolly.protractor.builtLoggerMod.WriteTo.BOTH & Double = js.native
    
    @js.native
    sealed trait CONSOLE
      extends StObject
         with WriteTo
    /* 0 */ val CONSOLE: typingsJapgolly.protractor.builtLoggerMod.WriteTo.CONSOLE & Double = js.native
    
    @js.native
    sealed trait FILE
      extends StObject
         with WriteTo
    /* 1 */ val FILE: typingsJapgolly.protractor.builtLoggerMod.WriteTo.FILE & Double = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with WriteTo
    /* 3 */ val NONE: typingsJapgolly.protractor.builtLoggerMod.WriteTo.NONE & Double = js.native
  }
}
