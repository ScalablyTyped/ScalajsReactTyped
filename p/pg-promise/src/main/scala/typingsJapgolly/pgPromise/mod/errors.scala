...
import typingsJapgolly.pgMinify.mod.SQLParsingError
...
object errors {
  ...
  object queryResultErrorCode extends StObject {
    ...
    /* 2 */ val multiple: typingsJapgolly.pgPromise.mod.errors.queryResultErrorCode.multiple & Double = js.native
    
    @js.native
    sealed trait noData
      extends StObject
         with queryResultErrorCode
    /* 0 */ val noData: typingsJapgolly.pgPromise.mod.errors.queryResultErrorCode.noData & Double = js.native
    
    @js.native
    sealed trait notEmpty
      extends StObject
         with queryResultErrorCode
    /* 1 */ val notEmpty: typingsJapgolly.pgPromise.mod.errors.queryResultErrorCode.notEmpty & Double = js.native
  }
}
