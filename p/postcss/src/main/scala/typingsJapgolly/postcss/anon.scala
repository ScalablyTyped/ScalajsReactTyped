...
import typingsJapgolly.postcss.libAtRuleMod.AtRuleRaws
import typingsJapgolly.postcss.libCommentMod.CommentRaws
import typingsJapgolly.postcss.libDeclarationMod.DeclarationRaws
import typingsJapgolly.postcss.libNodeMod.ChildNode
import typingsJapgolly.postcss.libNodeMod.ChildProps
import typingsJapgolly.postcss.libNodeMod.Source
import typingsJapgolly.postcss.libResultMod.default
import typingsJapgolly.postcss.libRuleMod.RuleRaws
...
object anon {
  ...
  trait Postcss
    ...
    var postcss: TransformCallback | typingsJapgolly.postcss.libProcessorMod.default
  }
  object Postcss {
    
    inline def apply(postcss: TransformCallback | typingsJapgolly.postcss.libProcessorMod.default): Postcss = {
    ...
    extension [Self <: Postcss](x: Self) {
      ...
      inline def setPostcss(value: TransformCallback | typingsJapgolly.postcss.libProcessorMod.default): Self = StObject.set(x, "postcss", value.asInstanceOf[js.Any])
      
      inline def setPostcssFunction2(
        value: (/* root */ typingsJapgolly.postcss.libRootMod.default, /* result */ default) => js.Promise[Unit] | Unit
