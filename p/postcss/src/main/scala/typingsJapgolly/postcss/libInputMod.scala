...
import typingsJapgolly.postcss.anon.Col
import typingsJapgolly.postcss.mod.ProcessOptions
import typingsJapgolly.postcss.postcssBooleans.`false`
...
object libInputMod {
  ...
  trait Input extends StObject {
    ...
    /**
      ...
      * ```
      */
    var map: typingsJapgolly.postcss.libPreviousMapMod.default = js.native
