...
import typingsJapgolly.postcss.anon.PartialAtRuleProps
import typingsJapgolly.postcss.anon.Raw
...
import typingsJapgolly.postcss.postcssStrings.atrule
...
object libAtRuleMod {
  ...
  @js.native
  trait AtRule
    extends typingsJapgolly.postcss.libContainerMod.default[ChildNode] {
    ...
    @JSName("parent")
    var parent_AtRule: js.UndefOr[typingsJapgolly.postcss.libContainerMod.default[ChildNode]] = js.native
