...
object postcssStrings {
  
  @js.native
  sealed trait CssSyntaxError extends StObject
  inline def CssSyntaxError: CssSyntaxError = "CssSyntaxError".asInstanceOf[CssSyntaxError]
  ...
  @js.native
  sealed trait decl extends StObject
  inline def decl: decl = "decl".asInstanceOf[decl]
