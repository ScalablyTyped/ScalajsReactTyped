...
import typingsJapgolly.postcss.postcssStrings.warning
...
object libWarningMod {
  ...
  open class default protected ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    var node: typingsJapgolly.postcss.libNodeMod.default = js.native
  ...
  trait Warning extends StObject {
    ...
    /**
      ...
      * ```
      */
    var node: typingsJapgolly.postcss.libNodeMod.default
  ...
  object Warning {
    ...
    inline def apply(
      column: Double,
      line: Double,
      node: typingsJapgolly.postcss.libNodeMod.default,
      plugin: String,
      text: String
    ): Warning = {
    ...
    extension [Self <: Warning](x: Self) {
      ...
      inline def setNode(value: typingsJapgolly.postcss.libNodeMod.default): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
  ...
  trait WarningOptions extends StObject {
    ...
    /**
      ...
      */
    var node: js.UndefOr[typingsJapgolly.postcss.libNodeMod.default] = js.undefined
