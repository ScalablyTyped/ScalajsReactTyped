...
import typingsJapgolly.postcss.anon.PartialCommentProps
...
import typingsJapgolly.postcss.libNodeMod.NodeProps
import typingsJapgolly.postcss.postcssStrings.comment
...
object libCommentMod {
  ...
  trait Comment
    ...
    @JSName("parent")
    var parent_Comment: js.UndefOr[typingsJapgolly.postcss.libContainerMod.default[ChildNode]] = js.native
