...
object libListMod extends Shortcut {
  ...
  @js.native
  val default: typingsJapgolly.postcss.libListMod.List = js.native
  ...
  object List {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.postcss.libListMod.List = {
      ...
      __obj.asInstanceOf[typingsJapgolly.postcss.libListMod.List]
    }
    
    extension [Self <: typingsJapgolly.postcss.libListMod.List](x: Self) {
  ...
  type _To = typingsJapgolly.postcss.libListMod.List
  
  /* This means you don't have to write `default`, but can instead just say `libListMod.foo` */
  override def _to: typingsJapgolly.postcss.libListMod.List = default
}
