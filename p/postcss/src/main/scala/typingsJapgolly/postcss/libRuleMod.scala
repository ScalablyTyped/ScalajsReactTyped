...
import typingsJapgolly.postcss.anon.PartialRuleProps
...
import typingsJapgolly.postcss.postcssStrings.rule
...
object libRuleMod {
  ...
  trait Rule
    ...
    @JSName("parent")
    var parent_Rule: js.UndefOr[typingsJapgolly.postcss.libContainerMod.default[ChildNode]] = js.native
