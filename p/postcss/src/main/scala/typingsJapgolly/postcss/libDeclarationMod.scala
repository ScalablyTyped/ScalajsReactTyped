...
import typingsJapgolly.postcss.anon.PartialDeclarationProps
...
import typingsJapgolly.postcss.postcssStrings.decl
...
object libDeclarationMod {
  ...
  trait Declaration
    ...
    @JSName("parent")
    var parent_Declaration: js.UndefOr[typingsJapgolly.postcss.libContainerMod.default[ChildNode]] = js.native
