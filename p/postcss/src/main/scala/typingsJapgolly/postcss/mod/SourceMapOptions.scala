...
trait SourceMapOptions extends StObject {
  ...
  var annotation: js.UndefOr[
    String | Boolean | (js.Function2[/* file */ String, /* root */ typingsJapgolly.postcss.libRootMod.default, String])
  ] = js.undefined
...
object SourceMapOptions {
  ...
  extension [Self <: SourceMapOptions](x: Self) {
    ...
    inline def setAnnotation(
      value: String | Boolean | (js.Function2[/* file */ String, /* root */ typingsJapgolly.postcss.libRootMod.default, String])
    ): Self = StObject.set(x, "annotation", value.asInstanceOf[js.Any])
    
    inline def setAnnotationFunction2(value: (/* file */ String, /* root */ typingsJapgolly.postcss.libRootMod.default) => String): Self = StObject.set(x, "annotation", js.Any.fromFunction2(value))
