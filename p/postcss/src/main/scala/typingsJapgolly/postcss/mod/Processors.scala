...
object Processors {
  ...
  extension [Self <: Processors](x: Self) {
    ...
    inline def setAtRuleExitFunction2(
      value: (/* atRule */ typingsJapgolly.postcss.libAtRuleMod.default, /* helper */ Helpers) => js.Promise[Unit] | Unit
    ...
    inline def setComment(
      value: (/* comment */ typingsJapgolly.postcss.libCommentMod.default, /* helper */ Helpers) => js.Promise[Unit] | Unit
    ...
    inline def setDeclarationExitFunction2(
      value: (/* decl */ typingsJapgolly.postcss.libDeclarationMod.default, /* helper */ Helpers) => js.Promise[Unit] | Unit
    ...
    inline def setDocument(
      value: (/* document */ typingsJapgolly.postcss.libDocumentMod.default, /* helper */ Helpers) => js.Promise[Unit] | Unit
    ...
    inline def setExit(
      value: (/* root */ typingsJapgolly.postcss.libRootMod.default, /* helper */ Helpers) => js.Promise[Unit] | Unit
    ...
    inline def setRule(
      value: (/* rule */ typingsJapgolly.postcss.libRuleMod.default, /* helper */ Helpers) => js.Promise[Unit] | Unit
