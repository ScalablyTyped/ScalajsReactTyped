...
trait Plugin
  ...
  var prepare: js.UndefOr[
    js.Function1[/* result */ typingsJapgolly.postcss.libResultMod.default, Processors]
  ] = js.undefined
}
object Plugin {
  ...
  extension [Self <: Plugin](x: Self) {
    ...
    inline def setPrepare(value: /* result */ typingsJapgolly.postcss.libResultMod.default => Processors): Self = StObject.set(x, "prepare", js.Any.fromFunction1(value))
