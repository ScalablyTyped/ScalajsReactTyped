...
object libContainerMod {
  ...
  @js.native
  open class default[Child /* <: typingsJapgolly.postcss.libNodeMod.default */] () extends Container[Child]
  
  @js.native
  trait Container[Child /* <: typingsJapgolly.postcss.libNodeMod.default */]
    ...
    /**
      ...
      */
    def append(
      nodes: (typingsJapgolly.postcss.libNodeMod.default | (js.Array[ChildProps | String | typingsJapgolly.postcss.libNodeMod.default]) | ChildProps | String)*
    ): this.type = js.native
