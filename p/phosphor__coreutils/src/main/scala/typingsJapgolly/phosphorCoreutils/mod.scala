...
import typingsJapgolly.phosphorCoreutils.jsonMod.ReadonlyJSONArray
...
object mod extends js.Object {
  @js.native
  class MimeData ()
    extends typingsJapgolly.phosphorCoreutils.mimeMod.MimeData
  ...
  class PromiseDelegate[T] ()
    extends typingsJapgolly.phosphorCoreutils.promiseMod.PromiseDelegate[T]
  
  @js.native
  class Token[T] protected ()
    extends typingsJapgolly.phosphorCoreutils.tokenMod.Token[T] {
    /**
