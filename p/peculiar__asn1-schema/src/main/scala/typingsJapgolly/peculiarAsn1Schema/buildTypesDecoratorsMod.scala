...
import typingsJapgolly.peculiarAsn1Schema.buildTypesEnumsMod.AsnTypeTypes
import typingsJapgolly.peculiarAsn1Schema.buildTypesTypesMod.IAsnConverter
import typingsJapgolly.peculiarAsn1Schema.buildTypesTypesMod.IEmptyConstructor
...
object buildTypesDecoratorsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.peculiarAsn1Schema.buildTypesEnumsMod.AsnPropTypes
    - typingsJapgolly.peculiarAsn1Schema.buildTypesTypesMod.IEmptyConstructor[T]
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.peculiarAsn1Schema.peculiarAsn1SchemaStrings.sequence
    - typingsJapgolly.peculiarAsn1Schema.peculiarAsn1SchemaStrings.set
  */
  trait AsnRepeatTypeString extends StObject
  object AsnRepeatTypeString {
    
    inline def sequence: typingsJapgolly.peculiarAsn1Schema.peculiarAsn1SchemaStrings.sequence = "sequence".asInstanceOf[typingsJapgolly.peculiarAsn1Schema.peculiarAsn1SchemaStrings.sequence]
    
    inline def set: typingsJapgolly.peculiarAsn1Schema.peculiarAsn1SchemaStrings.set = "set".asInstanceOf[typingsJapgolly.peculiarAsn1Schema.peculiarAsn1SchemaStrings.set]
  }
