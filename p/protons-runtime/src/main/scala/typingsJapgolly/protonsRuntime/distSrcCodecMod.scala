...
object distSrcCodecMod {
  ...
  object CODEC_TYPES extends StObject {
    ...
    sealed trait BIT32
      extends StObject
         with CODEC_TYPES
    /* 5 */ val BIT32: typingsJapgolly.protonsRuntime.distSrcCodecMod.CODEC_TYPES.BIT32 & Double = js.native
    
    @js.native
    sealed trait BIT64
      extends StObject
         with CODEC_TYPES
    /* 1 */ val BIT64: typingsJapgolly.protonsRuntime.distSrcCodecMod.CODEC_TYPES.BIT64 & Double = js.native
    
    @js.native
    sealed trait END_GROUP
      extends StObject
         with CODEC_TYPES
    /* 4 */ val END_GROUP: typingsJapgolly.protonsRuntime.distSrcCodecMod.CODEC_TYPES.END_GROUP & Double = js.native
    
    @js.native
    sealed trait LENGTH_DELIMITED
      extends StObject
         with CODEC_TYPES
    /* 2 */ val LENGTH_DELIMITED: typingsJapgolly.protonsRuntime.distSrcCodecMod.CODEC_TYPES.LENGTH_DELIMITED & Double = js.native
    
    @js.native
    sealed trait START_GROUP
      extends StObject
         with CODEC_TYPES
    /* 3 */ val START_GROUP: typingsJapgolly.protonsRuntime.distSrcCodecMod.CODEC_TYPES.START_GROUP & Double = js.native
    
    @js.native
    sealed trait VARINT
      extends StObject
         with CODEC_TYPES
    /* 0 */ val VARINT: typingsJapgolly.protonsRuntime.distSrcCodecMod.CODEC_TYPES.VARINT & Double = js.native
  }
  ...
  object Codec {
    ...
    inline def apply[T](
      ...
      encode: (T, /* writer */ Writer, /* opts */ js.UndefOr[EncodeOptions]) => Callback,
      name: String,
      `type`: CODEC_TYPES
    ): Codec[T] = {
      val __obj = js.Dynamic.literal(decode = js.Any.fromFunction2(decode), encode = js.Any.fromFunction3((t0: T, t1: /* writer */ Writer, t2: /* opts */ js.UndefOr[EncodeOptions]) => (encode(t0, t1, t2)).runNow()), name = name.asInstanceOf[js.Any])
    ...
    extension [Self <: Codec[?], T](x: Self & Codec[T]) {
      ...
      inline def setEncode(value: (T, /* writer */ Writer, /* opts */ js.UndefOr[EncodeOptions]) => Callback): Self = StObject.set(x, "encode", js.Any.fromFunction3((t0: T, t1: /* writer */ Writer, t2: /* opts */ js.UndefOr[EncodeOptions]) => (value(t0, t1, t2)).runNow()))
