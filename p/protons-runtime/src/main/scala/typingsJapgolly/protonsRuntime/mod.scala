...
import typingsJapgolly.protonsRuntime.protonsRuntimeBooleans.`true`
...
object mod {
  ...
  object Writer {
    ...
    inline def apply(
      ...
      finish: CallbackTo[js.typedarray.Uint8Array],
      fixed32: Double => Writer,
      fixed64: js.BigInt => Writer,
      float: Double => Writer,
      fork: CallbackTo[Writer],
      int32: Double => Writer,
      int64: js.BigInt => Writer,
      ldelim: CallbackTo[Writer],
      len: Double,
      reset: CallbackTo[Writer],
    ...
    extension [Self <: Writer](x: Self) {
      ...
      inline def setFinish(value: CallbackTo[js.typedarray.Uint8Array]): Self = StObject.set(x, "finish", value.toJsFn)
      ...
      inline def setFork(value: CallbackTo[Writer]): Self = StObject.set(x, "fork", value.toJsFn)
      ...
      inline def setLdelim(value: CallbackTo[Writer]): Self = StObject.set(x, "ldelim", value.toJsFn)
      
      inline def setLen(value: Double): Self = StObject.set(x, "len", value.asInstanceOf[js.Any])
      
      inline def setReset(value: CallbackTo[Writer]): Self = StObject.set(x, "reset", value.toJsFn)
