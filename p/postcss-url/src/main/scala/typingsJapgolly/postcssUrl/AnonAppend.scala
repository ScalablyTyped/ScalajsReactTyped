...
import typingsJapgolly.postcssUrl.mod.CustomHashFunction
import typingsJapgolly.postcssUrl.postcssUrlStrings.xxhash32
import typingsJapgolly.postcssUrl.postcssUrlStrings.xxhash64
