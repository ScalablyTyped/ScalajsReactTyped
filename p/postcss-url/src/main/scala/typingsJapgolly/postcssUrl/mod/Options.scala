package typingsJapgolly.postcssUrl.mod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.postcssUrl.AnonAbsolutePath
import typingsJapgolly.postcssUrl.AnonAppend
import typingsJapgolly.postcssUrl.AnonFile
import typingsJapgolly.postcssUrl.postcssUrlStrings.`inline`
import typingsJapgolly.postcssUrl.postcssUrlStrings.copy
import typingsJapgolly.postcssUrl.postcssUrlStrings.rebase
...
object Options {
  ...
  def apply(
    ...
    fallback: (/* asset */ AnonAbsolutePath, /* dir */ AnonFile) => CallbackTo[String] = null,
    filter: js.RegExp | CustomFilterFunction | String = null,
    ...
    if (fallback != null) __obj.updateDynamic("fallback")(js.Any.fromFunction2((t0: /* asset */ typingsJapgolly.postcssUrl.AnonAbsolutePath, t1: /* dir */ typingsJapgolly.postcssUrl.AnonFile) => fallback(t0, t1).runNow()))
