package typingsJapgolly.parseListing
...
object mod {
  ...
  object access extends StObject {
    ...
    sealed trait GROUP_ACCESS
      extends StObject
         with access
    /* 1 */ val GROUP_ACCESS: typingsJapgolly.parseListing.mod.access.GROUP_ACCESS & Double = js.native
    
    @js.native
    sealed trait USER_ACCESS
      extends StObject
         with access
    /* 0 */ val USER_ACCESS: typingsJapgolly.parseListing.mod.access.USER_ACCESS & Double = js.native
    
    @js.native
    sealed trait WORLD_ACCESS
      extends StObject
         with access
    /* 2 */ val WORLD_ACCESS: typingsJapgolly.parseListing.mod.access.WORLD_ACCESS & Double = js.native
  }
  ...
  object nodeTypes extends StObject {
    ...
    sealed trait DIRECTORY_TYPE
      extends StObject
         with nodeTypes
    /* 1 */ val DIRECTORY_TYPE: typingsJapgolly.parseListing.mod.nodeTypes.DIRECTORY_TYPE & Double = js.native
    
    @js.native
    sealed trait FILE_TYPE
      extends StObject
         with nodeTypes
    /* 0 */ val FILE_TYPE: typingsJapgolly.parseListing.mod.nodeTypes.FILE_TYPE & Double = js.native
    
    @js.native
    sealed trait SYMBOLIC_LINK_TYPE
      extends StObject
         with nodeTypes
    /* 2 */ val SYMBOLIC_LINK_TYPE: typingsJapgolly.parseListing.mod.nodeTypes.SYMBOLIC_LINK_TYPE & Double = js.native
    
    @js.native
    sealed trait UNKNOWN_TYPE
      extends StObject
         with nodeTypes
    /* 3 */ val UNKNOWN_TYPE: typingsJapgolly.parseListing.mod.nodeTypes.UNKNOWN_TYPE & Double = js.native
  }
  ...
  object permissions extends StObject {
    ...
    sealed trait EXECUTE_PERMISSION
      extends StObject
         with permissions
    /* 2 */ val EXECUTE_PERMISSION: typingsJapgolly.parseListing.mod.permissions.EXECUTE_PERMISSION & Double = js.native
    
    @js.native
    sealed trait READ_PERMISSION
      extends StObject
         with permissions
    /* 0 */ val READ_PERMISSION: typingsJapgolly.parseListing.mod.permissions.READ_PERMISSION & Double = js.native
    
    @js.native
    sealed trait WRITE_PERMISSION
      extends StObject
         with permissions
    /* 1 */ val WRITE_PERMISSION: typingsJapgolly.parseListing.mod.permissions.WRITE_PERMISSION & Double = js.native
  }
