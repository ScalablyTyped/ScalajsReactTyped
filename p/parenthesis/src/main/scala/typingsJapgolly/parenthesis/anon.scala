package typingsJapgolly.parenthesis

import typingsJapgolly.parenthesis.parenthesisBooleans.`false`
import typingsJapgolly.parenthesis.parenthesisBooleans.`true`
