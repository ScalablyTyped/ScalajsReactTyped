package typingsJapgolly.plv8Internal

import typingsJapgolly.plv8Internal.LoggingLevel.DEBUG1
import typingsJapgolly.plv8Internal.LoggingLevel.DEBUG2
import typingsJapgolly.plv8Internal.LoggingLevel.DEBUG3
import typingsJapgolly.plv8Internal.LoggingLevel.DEBUG4
import typingsJapgolly.plv8Internal.LoggingLevel.DEBUG5
import typingsJapgolly.plv8Internal.LoggingLevel.ERROR
import typingsJapgolly.plv8Internal.LoggingLevel.INFO
import typingsJapgolly.plv8Internal.LoggingLevel.LOG
import typingsJapgolly.plv8Internal.LoggingLevel.NOTICE
import typingsJapgolly.plv8Internal.LoggingLevel.WARNING
...
object global {
  ...
  object LoggingLevel extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.plv8Internal.LoggingLevel & Double] = js.native
    
    /* 14 */ val DEBUG1: typingsJapgolly.plv8Internal.LoggingLevel.DEBUG1 & Double = js.native
    
    /* 13 */ val DEBUG2: typingsJapgolly.plv8Internal.LoggingLevel.DEBUG2 & Double = js.native
    
    /* 12 */ val DEBUG3: typingsJapgolly.plv8Internal.LoggingLevel.DEBUG3 & Double = js.native
    
    /* 11 */ val DEBUG4: typingsJapgolly.plv8Internal.LoggingLevel.DEBUG4 & Double = js.native
    
    /* 10 */ val DEBUG5: typingsJapgolly.plv8Internal.LoggingLevel.DEBUG5 & Double = js.native
    
    /* 21 */ val ERROR: typingsJapgolly.plv8Internal.LoggingLevel.ERROR & Double = js.native
    
    /* 17 */ val INFO: typingsJapgolly.plv8Internal.LoggingLevel.INFO & Double = js.native
    
    /* 15 */ val LOG: typingsJapgolly.plv8Internal.LoggingLevel.LOG & Double = js.native
    
    /* 18 */ val NOTICE: typingsJapgolly.plv8Internal.LoggingLevel.NOTICE & Double = js.native
    
    /* 19 */ val WARNING: typingsJapgolly.plv8Internal.LoggingLevel.WARNING & Double = js.native
  }
  
  @JSGlobal("NOTICE")
  @js.native
  def NOTICE: typingsJapgolly.plv8Internal.LoggingLevel.NOTICE = js.native
  ...
  object SeekType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.plv8Internal.SeekType & Double] = js.native
    
    /* 0 */ val WINDOW_SEEK_CURRENT: typingsJapgolly.plv8Internal.SeekType.WINDOW_SEEK_CURRENT & Double = js.native
    
    /* 1 */ val WINDOW_SEEK_HEAD: typingsJapgolly.plv8Internal.SeekType.WINDOW_SEEK_HEAD & Double = js.native
    
    /* 2 */ val WINDOW_SEEK_TAIL: typingsJapgolly.plv8Internal.SeekType.WINDOW_SEEK_TAIL & Double = js.native
  }
  
  @JSGlobal("WARNING")
  @js.native
  def WARNING: typingsJapgolly.plv8Internal.LoggingLevel.WARNING = js.native
