package typingsJapgolly.powerAssert

import org.scalablytyped.runtime.Instantiable0
import org.scalablytyped.runtime.Instantiable1
import typingsJapgolly.powerAssert.anon.Actual
import typingsJapgolly.powerAssert.anon.TypeofpowerAssert
import typingsJapgolly.powerAssert.mod.Options
...
object global {
  ...
  object assert {
    ...
    open class AssertionError ()
      extends typingsJapgolly.powerAssert.mod.AssertionError {
    ...
    object strict {
      ...
      @js.native
      def AssertionError: Instantiable1[/* options */ js.UndefOr[Actual], typingsJapgolly.powerAssert.mod.AssertionError] = js.native
      ...
      inline def AssertionError_=(x: Instantiable1[/* options */ js.UndefOr[Actual], typingsJapgolly.powerAssert.mod.AssertionError]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AssertionError")(x.asInstanceOf[js.Any])
