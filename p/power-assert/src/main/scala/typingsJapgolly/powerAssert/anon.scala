...
object anon {
  ...
  object Actual {
    ...
    extension [Self <: Actual](x: Self) {
      ...
      inline def setStackStartFunction(value: CallbackTo[js.UndefOr[Unit]]): Self = StObject.set(x, "stackStartFunction", value.toJsFn)
  ...
  trait TypeofpowerAssert extends StObject {
    ...
    var AssertionError: Instantiable1[/* options */ js.UndefOr[Actual], typingsJapgolly.powerAssert.mod.AssertionError] = js.native
