...
object mod {
  ...
  trait Options extends StObject {
    ...
    var output: js.UndefOr[typingsJapgolly.powerAssertFormatter.mod.Options] = js.undefined
  }
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setAssertion(value: typingsJapgolly.empower.mod.Options): Self = StObject.set(x, "assertion", value.asInstanceOf[js.Any])
      
      inline def setAssertionUndefined: Self = StObject.set(x, "assertion", js.undefined)
      
      inline def setOutput(value: typingsJapgolly.powerAssertFormatter.mod.Options): Self = StObject.set(x, "output", value.asInstanceOf[js.Any])
