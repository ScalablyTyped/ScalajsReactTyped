...
import typingsJapgolly.prosemirrorModel.mod.ParseRule
...
import typingsJapgolly.prosemirrorView.anon.Atom
import typingsJapgolly.prosemirrorView.anon.Bottom
import typingsJapgolly.prosemirrorView.anon.ContentDOM
import typingsJapgolly.prosemirrorView.anon.From
import typingsJapgolly.prosemirrorView.anon.Inside
import typingsJapgolly.prosemirrorView.anon.Left
import typingsJapgolly.prosemirrorView.anon.Mount
import typingsJapgolly.prosemirrorView.anon.Move
import typingsJapgolly.prosemirrorView.anon.Node
import typingsJapgolly.prosemirrorView.anon.OnRemove
import typingsJapgolly.prosemirrorView.anon.PartialDirectEditorProps
import typingsJapgolly.prosemirrorView.anon.Right
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.attributes
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.backward
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.clipboardParser
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.clipboardSerializer
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.clipboardTextParser
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.clipboardTextSerializer
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.createSelectionBetween
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.decorations
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.domParser
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.down
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.editable
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.forward
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleClick
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleClickOn
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleDOMEvents
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleDoubleClick
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleDoubleClickOn
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleDrop
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleKeyDown
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleKeyPress
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handlePaste
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleScrollToSelection
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleTextInput
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleTripleClick
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.handleTripleClickOn
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.left
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.markViews
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.nodeViews
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.right
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.scrollMargin
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.scrollThreshold
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.transformCopied
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.transformPasted
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.transformPastedHTML
import typingsJapgolly.prosemirrorView.prosemirrorViewStrings.transformPastedText
...
object mod {
  ...
  */
  ...
  trait DecorationSet
    ...
    /**
      ...
      */
    def add(doc: typingsJapgolly.prosemirrorModel.mod.Node, decorations: js.Array[Decoration]): DecorationSet = js.native
    ...
    def map(mapping: Mapping, doc: typingsJapgolly.prosemirrorModel.mod.Node, options: OnRemove): DecorationSet = js.native
  ...
  */
  trait DecorationSource extends StObject {
    ...
    /**
      ...
      document.
      */
    def map(mapping: Mapping, node: typingsJapgolly.prosemirrorModel.mod.Node): DecorationSource
  }
  object DecorationSource {
    
    inline def apply(map: (Mapping, typingsJapgolly.prosemirrorModel.mod.Node) => DecorationSource): DecorationSource = {
    ...
    extension [Self <: DecorationSource](x: Self) {
      ...
      inline def setMap(value: (Mapping, typingsJapgolly.prosemirrorModel.mod.Node) => DecorationSource): Self = StObject.set(x, "map", js.Any.fromFunction2(value))
    }
  }
  ...
  */
  ...
  object NodeView {
    ...
    extension [Self <: NodeView](x: Self) {
      ...
      inline def setDeselectNode(value: Callback): Self = StObject.set(x, "deselectNode", value.toJsFn)
      ...
      inline def setSelectNode(value: Callback): Self = StObject.set(x, "selectNode", value.toJsFn)
      
      inline def setSelectNodeUndefined: Self = StObject.set(x, "selectNode", js.undefined)
      
      inline def setSetSelection(value: (/* anchor */ Double, /* head */ Double, /* root */ Document | ShadowRoot) => Callback): Self = StObject.set(x, "setSelection", js.Any.fromFunction3((t0: /* anchor */ Double, t1: /* head */ Double, t2: /* root */ Document | ShadowRoot) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setUpdate(
        value: (/* node */ typingsJapgolly.prosemirrorModel.mod.Node, /* decorations */ js.Array[Decoration], /* innerDecorations */ DecorationSource) => Boolean
  ...
  */
  ...
  trait ViewDesc extends StObject {
    ...
    var node: typingsJapgolly.prosemirrorModel.mod.Node | Null = js.native
  ...
  object global {
    ...
    object Node {
      ...
      inline def apply(): typingsJapgolly.prosemirrorView.mod.global.Node = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.prosemirrorView.mod.global.Node]
      }
      
      extension [Self <: typingsJapgolly.prosemirrorView.mod.global.Node](x: Self) {
