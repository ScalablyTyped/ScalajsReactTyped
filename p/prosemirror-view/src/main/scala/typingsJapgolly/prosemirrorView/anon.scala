...
import typingsJapgolly.prosemirrorView.mod.DOMNode
import typingsJapgolly.prosemirrorView.mod.DecorationSource
import typingsJapgolly.prosemirrorView.mod.MarkViewConstructor
import typingsJapgolly.prosemirrorView.mod.NodeViewConstructor
...
object anon {
  ...
  object OnRemove {
    ...
    extension [Self <: OnRemove](x: Self) {
      ...
      inline def setOnRemove(value: /* decorationSpec */ Any => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: /* decorationSpec */ Any) => value(t0).runNow()))
  ...
  trait PartialDirectEditorProps extends StObject {
    ...
    var handleClickOn: js.UndefOr[
        js.ThisFunction6[
          ...
          /* view */ this.type, 
          /* pos */ Double, 
          /* node */ typingsJapgolly.prosemirrorModel.mod.Node, 
          /* nodePos */ Double, 
          /* event */ MouseEvent, 
          /* direct */ Boolean, 
          Boolean | Unit
  ...
  object PartialDirectEditorProps {
    ...
    extension [Self <: PartialDirectEditorProps](x: Self) {
      ...
      inline def setDispatchTransaction(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Transaction */ /* tr */ Any => Callback
      ): Self = StObject.set(x, "dispatchTransaction", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Transaction */ /* tr */ Any) => value(t0).runNow()))
  ...
  trait eventinkeyofDOMEventMapth extends StObject {
    ...
    var progress: js.UndefOr[
        js.ThisFunction2[/* this */ Any, /* view */ this.type, /* event */ ProgressEvent, Boolean | Unit]
      ] = js.undefined
  ...
  object eventinkeyofDOMEventMapth {
    ...
    extension [Self <: eventinkeyofDOMEventMapth](x: Self) {
      ...
      inline def setProgress(
        value: js.ThisFunction2[/* this */ Any, eventinkeyofDOMEventMapth, /* event */ ProgressEvent, Boolean | Unit]
