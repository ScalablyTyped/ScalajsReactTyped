...
object potraceStrings {
  ...
  @js.native
  sealed trait dominant extends StObject
  inline def dominant: dominant = "dominant".asInstanceOf[dominant]
  ...
  @js.native
  sealed trait minority extends StObject
  inline def minority: minority = "minority".asInstanceOf[minority]
