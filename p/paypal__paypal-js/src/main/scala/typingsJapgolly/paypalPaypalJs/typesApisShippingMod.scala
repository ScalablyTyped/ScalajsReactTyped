...
import typingsJapgolly.paypalPaypalJs.anon.Currencycode
...
object typesApisShippingMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.SHIPPING
    - typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.PICKUP
  */
  trait ShippingOptionType extends StObject
  object ShippingOptionType {
    
    inline def PICKUP: typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.PICKUP = "PICKUP".asInstanceOf[typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.PICKUP]
    
    inline def SHIPPING: typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.SHIPPING = "SHIPPING".asInstanceOf[typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.SHIPPING]
  }
}
