...
import typingsJapgolly.paypalPaypalJs.anon.Partialgivennamestringsur
import typingsJapgolly.paypalPaypalJs.anon.Phonenumber
import typingsJapgolly.paypalPaypalJs.anon.Taxid
