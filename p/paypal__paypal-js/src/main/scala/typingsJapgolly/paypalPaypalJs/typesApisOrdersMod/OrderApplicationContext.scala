...
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.BILLING
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.CONTINUE
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.LOGIN
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.NO_PREFERENCE
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.PAY_NOW
