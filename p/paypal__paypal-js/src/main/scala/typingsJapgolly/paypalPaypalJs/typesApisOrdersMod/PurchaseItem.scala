...
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.DIGITAL_GOODS
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.DONATION
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.PHYSICAL_GOODS
