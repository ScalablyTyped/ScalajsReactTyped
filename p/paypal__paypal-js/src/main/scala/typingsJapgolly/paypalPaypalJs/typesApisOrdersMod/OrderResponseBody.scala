...
import typingsJapgolly.paypalPaypalJs.anon.PartialPayer
import typingsJapgolly.paypalPaypalJs.anon.PartialissuerPaypalCARDIS
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.APPROVED
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.COMPLETED
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.PAYER_ACTION_REQUIRED
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.SAVED
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.VOIDED
