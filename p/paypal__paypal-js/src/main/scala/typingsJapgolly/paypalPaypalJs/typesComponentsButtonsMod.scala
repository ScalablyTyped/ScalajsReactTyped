...
import typingsJapgolly.paypalPaypalJs.anon.Activate
import typingsJapgolly.paypalPaypalJs.anon.Authorize
import typingsJapgolly.paypalPaypalJs.anon.Color
import typingsJapgolly.paypalPaypalJs.anon.Create
import typingsJapgolly.paypalPaypalJs.anon.Patch
import typingsJapgolly.paypalPaypalJs.anon.`1`
import typingsJapgolly.paypalPaypalJs.typesApisShippingMod.SelectedShippingOption
import typingsJapgolly.paypalPaypalJs.typesApisShippingMod.ShippingAddress
...
object typesComponentsButtonsMod {
  ...
  object OnApproveActions {
    ...
    inline def apply(redirect: String => Callback, restart: Callback): OnApproveActions = {
      val __obj = js.Dynamic.literal(redirect = js.Any.fromFunction1((t0: String) => redirect(t0).runNow()), restart = restart.toJsFn)
    ...
    extension [Self <: OnApproveActions](x: Self) {
      ...
      inline def setRedirect(value: String => Callback): Self = StObject.set(x, "redirect", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
  ...
  object OnCancelledActions {
    ...
    inline def apply(redirect: Callback): OnCancelledActions = {
      val __obj = js.Dynamic.literal(redirect = redirect.toJsFn)
      __obj.asInstanceOf[OnCancelledActions]
    }
    
    extension [Self <: OnCancelledActions](x: Self) {
      
      inline def setRedirect(value: Callback): Self = StObject.set(x, "redirect", value.toJsFn)
    }
  }
  ...
  object OnClickActions {
    ...
    inline def apply(reject: CallbackTo[js.Promise[Unit]], resolve: CallbackTo[js.Promise[Unit]]): OnClickActions = {
    ...
    extension [Self <: OnClickActions](x: Self) {
      ...
      inline def setReject(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "reject", value.toJsFn)
      
      inline def setResolve(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "resolve", value.toJsFn)
    }
  }
  ...
  object OnInitActions {
    ...
    inline def apply(disable: CallbackTo[js.Promise[Unit]], enable: CallbackTo[js.Promise[Unit]]): OnInitActions = {
  ...
  object OnShippingChangeActions {
    ...
    inline def apply(order: Patch, reject: CallbackTo[js.Promise[Unit]], resolve: CallbackTo[js.Promise[Unit]]): OnShippingChangeActions = {
      val __obj = js.Dynamic.literal(order = order.asInstanceOf[js.Any], reject = reject.toJsFn, resolve = resolve.toJsFn)
  ...
  object PayPalButtonsComponentOptions {
    ...
    extension [Self <: PayPalButtonsComponentOptions](x: Self) {
      ...
      inline def setCreateBillingAgreement(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "createBillingAgreement", value.toJsFn)
      ...
      inline def setOnCancel(value: (/* data */ Record[String, Any], /* actions */ OnCancelledActions) => Callback): Self = StObject.set(x, "onCancel", js.Any.fromFunction2((t0: /* data */ Record[String, Any], t1: /* actions */ OnCancelledActions) => (value(t0, t1)).runNow()))
      ...
      inline def setOnError(value: /* err */ Record[String, Any] => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* err */ Record[String, Any]) => value(t0).runNow()))
      
      inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
      
      inline def setOnInit(value: (/* data */ Record[String, Any], /* actions */ OnInitActions) => Callback): Self = StObject.set(x, "onInit", js.Any.fromFunction2((t0: /* data */ Record[String, Any], t1: /* actions */ OnInitActions) => (value(t0, t1)).runNow()))
