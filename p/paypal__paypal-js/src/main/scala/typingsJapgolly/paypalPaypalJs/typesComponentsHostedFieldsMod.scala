...
import typingsJapgolly.paypalPaypalJs.anon.Attribute
import typingsJapgolly.paypalPaypalJs.anon.Brand
import typingsJapgolly.paypalPaypalJs.anon.ClassName
import typingsJapgolly.paypalPaypalJs.anon.Code
import typingsJapgolly.paypalPaypalJs.anon.Company
import typingsJapgolly.paypalPaypalJs.anon.Eligible
import typingsJapgolly.paypalPaypalJs.anon.Field
import typingsJapgolly.paypalPaypalJs.anon.keyinnumbercvvexpirationD
...
object typesComponentsHostedFieldsMod {
  ...
  object Installments {
    ...
    inline def apply(
      onInstallmentsAvailable: AvailableInstallments => Callback,
      onInstallmentsRequested: CallbackTo[js.Promise[InstallmentsConfiguration] | InstallmentsConfiguration]
    ): Installments = {
      val __obj = js.Dynamic.literal(onInstallmentsAvailable = js.Any.fromFunction1((t0: AvailableInstallments) => onInstallmentsAvailable(t0).runNow()), onInstallmentsRequested = onInstallmentsRequested.toJsFn)
      __obj.asInstanceOf[Installments]
    }
    
    extension [Self <: Installments](x: Self) {
      
      inline def setOnInstallmentsAvailable(value: AvailableInstallments => Callback): Self = StObject.set(x, "onInstallmentsAvailable", js.Any.fromFunction1((t0: AvailableInstallments) => value(t0).runNow()))
      
      inline def setOnInstallmentsError(value: /* error */ Record[String, Any] => Callback): Self = StObject.set(x, "onInstallmentsError", js.Any.fromFunction1((t0: /* error */ Record[String, Any]) => value(t0).runNow()))
      
      inline def setOnInstallmentsErrorUndefined: Self = StObject.set(x, "onInstallmentsError", js.undefined)
      
      inline def setOnInstallmentsRequested(value: CallbackTo[js.Promise[InstallmentsConfiguration] | InstallmentsConfiguration]): Self = StObject.set(x, "onInstallmentsRequested", value.toJsFn)
    }
  }
  ...
  object PayPalHostedFieldsComponent {
    ...
    inline def apply(
      isEligible: CallbackTo[Boolean],
      render: PayPalHostedFieldsComponentOptions => js.Promise[HostedFieldsHandler]
    ): PayPalHostedFieldsComponent = {
      val __obj = js.Dynamic.literal(isEligible = isEligible.toJsFn, render = js.Any.fromFunction1(render))
      __obj.asInstanceOf[PayPalHostedFieldsComponent]
    }
    
    extension [Self <: PayPalHostedFieldsComponent](x: Self) {
      
      inline def setIsEligible(value: CallbackTo[Boolean]): Self = StObject.set(x, "isEligible", value.toJsFn)
  ...
  object PayPalHostedFieldsComponentOptions {
    ...
    inline def apply(createOrder: CallbackTo[js.Promise[String]]): PayPalHostedFieldsComponentOptions = {
      val __obj = js.Dynamic.literal(createOrder = createOrder.toJsFn)
      __obj.asInstanceOf[PayPalHostedFieldsComponentOptions]
    }
    
    extension [Self <: PayPalHostedFieldsComponentOptions](x: Self) {
      
      inline def setCreateOrder(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "createOrder", value.toJsFn)
