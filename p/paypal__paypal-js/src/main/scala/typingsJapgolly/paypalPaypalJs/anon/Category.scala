...
trait Category extends StObject {
  ...
  var category: typingsJapgolly.paypalPaypalJs.typesApisSubscriptionsCommonsMod.Category
...
object Category {
  ...
  inline def apply(
    category: typingsJapgolly.paypalPaypalJs.typesApisSubscriptionsCommonsMod.Category,
    description: String,
    home_url: String,
    image_url: String,
    name: String,
  ...
  extension [Self <: Category](x: Self) {
    ...
    inline def setCategory(value: typingsJapgolly.paypalPaypalJs.typesApisSubscriptionsCommonsMod.Category): Self = StObject.set(x, "category", value.asInstanceOf[js.Any])
