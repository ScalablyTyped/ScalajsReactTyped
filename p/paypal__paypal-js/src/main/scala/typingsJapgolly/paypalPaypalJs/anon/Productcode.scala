...
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.EXPRESS_CHECKOUT
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.WEBSITE_PAYMENTS_STANDARD
