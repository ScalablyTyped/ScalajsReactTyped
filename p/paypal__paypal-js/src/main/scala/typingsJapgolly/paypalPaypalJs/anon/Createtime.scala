...
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.ACTIVE
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.INACTIVE
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.IN_PROGRESS
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.TIERED
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.VOLUME
