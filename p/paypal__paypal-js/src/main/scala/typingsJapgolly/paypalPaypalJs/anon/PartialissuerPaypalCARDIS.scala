...
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.CARD_ISSUER_INSTALLMENTS
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.Paypal_
