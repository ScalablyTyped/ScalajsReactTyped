...
trait Address extends StObject {
  ...
  var address: typingsJapgolly.paypalPaypalJs.typesApisCommonsMod.Address
...
object Address {
  ...
  inline def apply(address: typingsJapgolly.paypalPaypalJs.typesApisCommonsMod.Address): Address = {
  ...
  extension [Self <: Address](x: Self) {
    ...
    inline def setAddress(value: typingsJapgolly.paypalPaypalJs.typesApisCommonsMod.Address): Self = StObject.set(x, "address", value.asInstanceOf[js.Any])
