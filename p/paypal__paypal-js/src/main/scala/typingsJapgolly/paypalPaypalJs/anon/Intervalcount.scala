...
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.DAY
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.MONTH
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.SEMI_MONTH
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.WEEK
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.YEAR
