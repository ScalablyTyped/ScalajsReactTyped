...
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.CANCEL
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.CONTINUE
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.POSTPAID
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.PREPAID
