...
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.BATCH
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.MOBILE_APP
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.MOBILE_WEB
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.PAY_WITH_CRYPTO
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.WEB
