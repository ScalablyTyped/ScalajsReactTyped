...
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.CONNECT
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.DELETE
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.GET
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.HEAD
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.OPTIONS
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.PATCH
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.POST
import typingsJapgolly.paypalPaypalJs.paypalPaypalJsStrings.PUT
