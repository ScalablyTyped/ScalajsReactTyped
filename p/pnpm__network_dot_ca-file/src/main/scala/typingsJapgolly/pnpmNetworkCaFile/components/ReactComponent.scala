package typingsJapgolly.pnpmNetworkCaFile.components
...
object ReactComponent {
  ...
  implicit def make(companion: ReactComponent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SVGPropsSVGSVGElementtitl): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
