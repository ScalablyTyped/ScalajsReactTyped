package typingsJapgolly.packageInfo
...
object mod {
  ...
  inline def apply(name: String): js.Promise[Package] = ^.asInstanceOf[js.Dynamic].apply(name.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Package]]
