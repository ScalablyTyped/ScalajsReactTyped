package typingsJapgolly.pouchdbAdapterCordovaSqlite.PouchDB.AdapterCordovaSqlite

import typingsJapgolly.pouchdbAdapterCordovaSqlite.pouchdbAdapterCordovaSqliteStrings.`cordova-sqlite`
