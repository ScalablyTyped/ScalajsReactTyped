...
import typingsJapgolly.passportInstagramGraph.passportInstagramGraphBooleans.`false`
import typingsJapgolly.passportInstagramGraph.passportInstagramGraphBooleans.`true`
