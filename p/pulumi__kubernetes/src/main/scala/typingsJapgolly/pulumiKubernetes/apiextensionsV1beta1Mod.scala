...
object apiextensionsV1beta1Mod extends js.Object {
  ...
  class CustomResourceDefinition protected ()
    extends typingsJapgolly.pulumiKubernetes.customResourceDefinitionMod.CustomResourceDefinition {
    /**
  ...
  class CustomResourceDefinitionList protected ()
    extends typingsJapgolly.pulumiKubernetes.customResourceDefinitionListMod.CustomResourceDefinitionList {
    /**
