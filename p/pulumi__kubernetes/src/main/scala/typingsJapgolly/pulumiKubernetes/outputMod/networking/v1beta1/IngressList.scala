...
trait IngressList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.IngressList
  /**
...
object IngressList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.IngressList,
    metadata: ListMeta
  ): IngressList = {
