...
trait LocalSubjectAccessReview extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.LocalSubjectAccessReview
...
object LocalSubjectAccessReview {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.LocalSubjectAccessReview,
    metadata: ObjectMeta,
