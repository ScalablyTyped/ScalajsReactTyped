package typingsJapgolly.pulumiKubernetes.outputMod.scheduling.v1beta1
...
trait PriorityClass extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityClass
  /**
...
object PriorityClass {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityClass,
    metadata: ObjectMeta,
