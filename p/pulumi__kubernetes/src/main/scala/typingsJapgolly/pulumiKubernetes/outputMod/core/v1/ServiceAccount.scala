...
trait ServiceAccount extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ServiceAccount
  /**
...
object ServiceAccount {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ServiceAccount,
    metadata: ObjectMeta,
