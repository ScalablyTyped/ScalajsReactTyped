...
trait PersistentVolumeClaimList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeClaimList
  /**
...
object PersistentVolumeClaimList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeClaimList,
    metadata: ListMeta
