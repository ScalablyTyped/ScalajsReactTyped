package typingsJapgolly.pulumiKubernetes.outputMod.batch.v2alpha1
...
trait CronJobList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CronJobList
  /**
...
object CronJobList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CronJobList,
    metadata: ListMeta
  ): CronJobList = {
