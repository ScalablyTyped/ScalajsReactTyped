...
trait NamespaceList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.NamespaceList
  /**
...
object NamespaceList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.NamespaceList,
    metadata: ListMeta
  ): NamespaceList = {
