...
trait ControllerRevisionList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevisionList
  /**
    * More info:
...
object ControllerRevisionList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevisionList,
    metadata: ListMeta
