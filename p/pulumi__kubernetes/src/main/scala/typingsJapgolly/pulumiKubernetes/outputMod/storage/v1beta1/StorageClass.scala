...
trait StorageClass extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StorageClass
  /**
...
object StorageClass {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StorageClass,
    metadata: ObjectMeta,
