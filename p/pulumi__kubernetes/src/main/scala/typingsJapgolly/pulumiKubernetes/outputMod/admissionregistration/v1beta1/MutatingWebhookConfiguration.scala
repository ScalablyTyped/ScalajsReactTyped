...
trait MutatingWebhookConfiguration extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.MutatingWebhookConfiguration
  /**
...
object MutatingWebhookConfiguration {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.MutatingWebhookConfiguration,
    metadata: ObjectMeta,
