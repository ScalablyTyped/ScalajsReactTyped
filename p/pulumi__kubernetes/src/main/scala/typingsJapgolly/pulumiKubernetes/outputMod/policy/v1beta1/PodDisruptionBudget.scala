...
trait PodDisruptionBudget extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudget
...
object PodDisruptionBudget {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudget,
    metadata: ObjectMeta,
