...
trait TokenRequest extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.TokenRequest
...
object TokenRequest {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.TokenRequest,
    metadata: ObjectMeta,
