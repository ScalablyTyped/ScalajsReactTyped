...
trait AuditSinkList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.AuditSinkList
...
object AuditSinkList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.AuditSinkList,
    metadata: ListMeta
  ): AuditSinkList = {
