...
trait CustomResourceDefinition extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CustomResourceDefinition
...
object CustomResourceDefinition {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CustomResourceDefinition,
    metadata: ObjectMeta,
