...
trait PriorityLevelConfigurationList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfigurationList
  /**
...
object PriorityLevelConfigurationList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfigurationList,
    metadata: ListMeta
