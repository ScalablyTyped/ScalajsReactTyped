...
trait RuntimeClassList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClassList
  /**
...
object RuntimeClassList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClassList,
    metadata: ListMeta
  ): RuntimeClassList = {
