...
trait ReplicationController extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ReplicationController
  /**
...
object ReplicationController {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ReplicationController,
    metadata: ObjectMeta,
