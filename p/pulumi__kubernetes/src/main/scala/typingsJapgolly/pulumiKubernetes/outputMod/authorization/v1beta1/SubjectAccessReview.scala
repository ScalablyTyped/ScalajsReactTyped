...
trait SubjectAccessReview extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.SubjectAccessReview
...
object SubjectAccessReview {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.SubjectAccessReview,
    metadata: ObjectMeta,
