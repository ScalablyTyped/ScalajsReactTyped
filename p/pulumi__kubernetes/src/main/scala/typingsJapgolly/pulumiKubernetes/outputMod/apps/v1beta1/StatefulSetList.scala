...
trait StatefulSetList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StatefulSetList
...
object StatefulSetList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StatefulSetList,
    metadata: ListMeta
  ): StatefulSetList = {
