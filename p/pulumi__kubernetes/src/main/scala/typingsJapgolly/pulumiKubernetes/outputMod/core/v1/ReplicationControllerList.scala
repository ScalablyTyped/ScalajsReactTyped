...
trait ReplicationControllerList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList
  /**
...
object ReplicationControllerList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList,
    metadata: ListMeta
