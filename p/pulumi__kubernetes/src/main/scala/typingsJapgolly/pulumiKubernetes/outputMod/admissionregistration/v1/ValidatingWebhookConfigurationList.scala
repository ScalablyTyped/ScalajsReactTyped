...
trait ValidatingWebhookConfigurationList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfigurationList
  /**
...
object ValidatingWebhookConfigurationList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfigurationList,
    metadata: ListMeta
