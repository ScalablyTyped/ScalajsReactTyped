...
trait CertificateSigningRequest extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CertificateSigningRequest
...
object CertificateSigningRequest {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CertificateSigningRequest,
    metadata: ObjectMeta,
