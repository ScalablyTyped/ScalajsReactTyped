...
trait RoleBindingList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.RoleBindingList
  /**
...
object RoleBindingList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.RoleBindingList,
    metadata: ListMeta
  ): RoleBindingList = {
