package typingsJapgolly.pulumiKubernetes.outputMod.admissionregistration.v1beta1
...
trait MutatingWebhookConfigurationList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.MutatingWebhookConfigurationList
  /**
...
object MutatingWebhookConfigurationList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.MutatingWebhookConfigurationList,
    metadata: ListMeta
