...
trait PriorityLevelConfiguration extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfiguration
  /**
...
object PriorityLevelConfiguration {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfiguration,
    metadata: ObjectMeta,
