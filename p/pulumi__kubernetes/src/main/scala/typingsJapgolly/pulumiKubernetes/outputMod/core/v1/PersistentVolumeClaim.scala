...
trait PersistentVolumeClaim extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeClaim
  /**
...
object PersistentVolumeClaim {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeClaim,
    metadata: ObjectMeta,
