...
trait ServiceList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ServiceList
  /**
...
object ServiceList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ServiceList,
    metadata: ListMeta
  ): ServiceList = {
