...
trait RuntimeClass extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClass
  /**
    * More info:
...
object RuntimeClass {
  ...
  def apply(
    ...
    handler: String,
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClass,
    metadata: ObjectMeta,
    overhead: Overhead,
