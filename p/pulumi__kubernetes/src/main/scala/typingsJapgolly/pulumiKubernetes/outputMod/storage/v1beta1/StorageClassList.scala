package typingsJapgolly.pulumiKubernetes.outputMod.storage.v1beta1
...
trait StorageClassList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StorageClassList
  /**
...
object StorageClassList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StorageClassList,
    metadata: ListMeta
  ): StorageClassList = {
