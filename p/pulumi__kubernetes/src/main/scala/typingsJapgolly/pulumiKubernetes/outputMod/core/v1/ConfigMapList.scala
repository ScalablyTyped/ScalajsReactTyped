...
trait ConfigMapList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ConfigMapList
  /**
    * More info:
...
object ConfigMapList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ConfigMapList,
    metadata: ListMeta
  ): ConfigMapList = {
