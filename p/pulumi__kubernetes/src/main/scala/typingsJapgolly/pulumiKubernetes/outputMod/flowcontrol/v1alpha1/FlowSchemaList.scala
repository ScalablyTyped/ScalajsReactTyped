...
trait FlowSchemaList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList
  /**
...
object FlowSchemaList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList,
    metadata: ListMeta
  ): FlowSchemaList = {
