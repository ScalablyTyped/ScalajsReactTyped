...
trait ComponentStatusList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatusList
  /**
...
object ComponentStatusList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatusList,
    metadata: ListMeta
  ): ComponentStatusList = {
