...
trait LimitRangeList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.LimitRangeList
  /**
...
object LimitRangeList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.LimitRangeList,
    metadata: ListMeta
  ): LimitRangeList = {
