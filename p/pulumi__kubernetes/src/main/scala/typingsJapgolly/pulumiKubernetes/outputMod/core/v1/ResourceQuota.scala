...
trait ResourceQuota extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota
  /**
...
object ResourceQuota {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota,
    metadata: ObjectMeta,
