...
trait PodPresetList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodPresetList
  /**
...
object PodPresetList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodPresetList,
    metadata: ListMeta
  ): PodPresetList = {
