...
trait PersistentVolumeList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeList
  /**
...
object PersistentVolumeList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeList,
    metadata: ListMeta
