...
trait ClusterRoleBindingList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleBindingList
  /**
...
object ClusterRoleBindingList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleBindingList,
    metadata: ListMeta
