...
trait CustomResourceDefinitionList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CustomResourceDefinitionList
...
object CustomResourceDefinitionList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CustomResourceDefinitionList,
    metadata: ListMeta
