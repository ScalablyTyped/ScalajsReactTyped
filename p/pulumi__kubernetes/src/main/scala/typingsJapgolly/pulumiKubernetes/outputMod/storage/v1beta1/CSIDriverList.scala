...
trait CSIDriverList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList
  /**
...
object CSIDriverList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList,
    metadata: ListMeta
  ): CSIDriverList = {
