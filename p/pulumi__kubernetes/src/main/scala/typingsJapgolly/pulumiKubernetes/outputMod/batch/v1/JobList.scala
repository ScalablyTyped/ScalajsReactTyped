package typingsJapgolly.pulumiKubernetes.outputMod.batch.v1
...
trait JobList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.JobList
  /**
...
object JobList {
  ...
  def apply(
    ...
    items: js.Array[Job],
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.JobList,
    metadata: ListMeta
  ): JobList = {
