...
trait PodTemplateList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodTemplateList
  /**
...
object PodTemplateList {
  ...
  def apply(
    ...
    kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodTemplateList,
    metadata: ListMeta
  ): PodTemplateList = {
