...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.autoscaling.v2beta1.HorizontalPodAutoscalerSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.autoscaling.v2beta1.HorizontalPodAutoscalerStatus
...
object autoscalingV2beta1HorizontalPodAutoscalerMod {
  ...
  trait HorizontalPodAutoscalerArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.autoscaling.v2beta1.HorizontalPodAutoscalerSpec
        ]
      ] = js.undefined
  }
