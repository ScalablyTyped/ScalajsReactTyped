...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.events.v1beta1.Event
...
object eventsV1beta1EventListMod {
  
  @JSImport("@pulumi/kubernetes/events/v1beta1/eventList", "EventList")
  @js.native
  open class EventList protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.EventList] = js.native
  ...
  trait EventListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.events.v1beta1.Event]]
      ]
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.EventList]] = js.undefined
  ...
  object EventListArgs {
    ...
    extension [Self <: EventListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.events.v1beta1.Event]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.EventList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
