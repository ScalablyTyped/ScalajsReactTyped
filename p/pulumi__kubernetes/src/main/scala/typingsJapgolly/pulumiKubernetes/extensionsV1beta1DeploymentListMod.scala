...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.Deployment
...
object extensionsV1beta1DeploymentListMod {
  ...
  object DeploymentList {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/deploymentList.DeploymentList */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/deploymentList.DeploymentList */ Boolean]
  }
  ...
  trait DeploymentListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.Deployment]
        ]
      ]
  ...
  object DeploymentListArgs {
    ...
    extension [Self <: DeploymentListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.Deployment]*): Self = StObject.set(x, "items", js.Array(value*))
