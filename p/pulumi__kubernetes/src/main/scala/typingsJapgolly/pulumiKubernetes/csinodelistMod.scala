...
import typingsJapgolly.pulumiKubernetes.outputMod.storage.v1beta1.CSINode
...
object csinodelistMod extends js.Object {
  ...
  class CSINodeList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSINodeList] = js.native
    /**
