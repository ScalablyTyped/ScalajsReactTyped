...
object rbacV1beta1ClusterRoleBindingPatchMod {
  
  @JSImport("@pulumi/kubernetes/rbac/v1beta1/clusterRoleBindingPatch", "ClusterRoleBindingPatch")
  @js.native
  ...
  object ClusterRoleBindingPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1beta1/clusterRoleBindingPatch.ClusterRoleBindingPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1beta1/clusterRoleBindingPatch.ClusterRoleBindingPatch */ Boolean]
  }
