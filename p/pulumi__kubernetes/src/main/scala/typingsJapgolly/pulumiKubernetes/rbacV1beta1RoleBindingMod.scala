...
object rbacV1beta1RoleBindingMod {
  ...
  object RoleBinding {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1beta1/roleBinding.RoleBinding */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1beta1/roleBinding.RoleBinding */ Boolean]
  }
  ...
  object RoleBindingArgs {
    ...
    inline def apply(roleRef: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1beta1.RoleRef]): RoleBindingArgs = {
