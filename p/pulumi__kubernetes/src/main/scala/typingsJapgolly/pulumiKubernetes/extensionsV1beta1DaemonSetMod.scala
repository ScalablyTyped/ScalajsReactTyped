...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.DaemonSetSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.DaemonSetStatus
...
object extensionsV1beta1DaemonSetMod {
  ...
  object DaemonSet {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/daemonSet.DaemonSet */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/daemonSet.DaemonSet */ Boolean]
  }
  ...
  trait DaemonSetArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.DaemonSetSpec]
      ] = js.undefined
  }
  object DaemonSetArgs {
    ...
    extension [Self <: DaemonSetArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.DaemonSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
