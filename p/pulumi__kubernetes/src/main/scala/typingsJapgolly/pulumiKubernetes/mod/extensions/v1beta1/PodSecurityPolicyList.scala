...
class PodSecurityPolicyList protected ()
  extends typingsJapgolly.pulumiKubernetes.extensionsMod.v1beta1.PodSecurityPolicyList {
  /**
  ...
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicyList
  ) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicyList,
...
object PodSecurityPolicyList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.podSecurityPolicyListMod.PodSecurityPolicyList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.podSecurityPolicyListMod.PodSecurityPolicyList = js.native
  /**
