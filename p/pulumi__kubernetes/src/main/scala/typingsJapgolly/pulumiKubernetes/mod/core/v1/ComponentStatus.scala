...
class ComponentStatus protected ()
  extends typingsJapgolly.pulumiKubernetes.coreMod.v1.ComponentStatus {
  /**
...
object ComponentStatus extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.componentStatusMod.ComponentStatus = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.componentStatusMod.ComponentStatus = js.native
  /**
