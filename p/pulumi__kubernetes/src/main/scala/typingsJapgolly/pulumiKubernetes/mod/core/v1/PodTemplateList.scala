...
class PodTemplateList protected ()
  extends typingsJapgolly.pulumiKubernetes.coreMod.v1.PodTemplateList {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.PodTemplateList) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.PodTemplateList,
...
object PodTemplateList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.podTemplateListMod.PodTemplateList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.podTemplateListMod.PodTemplateList = js.native
  /**
