...
class PodTemplate protected ()
  extends typingsJapgolly.pulumiKubernetes.coreMod.v1.PodTemplate {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.PodTemplate) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.PodTemplate,
...
object PodTemplate extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.podTemplateMod.PodTemplate = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.podTemplateMod.PodTemplate = js.native
  /**
