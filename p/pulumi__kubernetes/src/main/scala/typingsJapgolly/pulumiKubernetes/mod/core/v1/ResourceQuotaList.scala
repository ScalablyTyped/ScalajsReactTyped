...
class ResourceQuotaList protected ()
  extends typingsJapgolly.pulumiKubernetes.coreMod.v1.ResourceQuotaList {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ResourceQuotaList) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ResourceQuotaList,
...
object ResourceQuotaList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaList = js.native
  /**
