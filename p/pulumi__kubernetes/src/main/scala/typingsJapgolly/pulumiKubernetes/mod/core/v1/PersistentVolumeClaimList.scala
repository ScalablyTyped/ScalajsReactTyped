...
class PersistentVolumeClaimList protected ()
  extends typingsJapgolly.pulumiKubernetes.coreMod.v1.PersistentVolumeClaimList {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.PersistentVolumeClaimList) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.PersistentVolumeClaimList,
...
object PersistentVolumeClaimList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.persistentVolumeClaimListMod.PersistentVolumeClaimList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.persistentVolumeClaimListMod.PersistentVolumeClaimList = js.native
  /**
