...
object coordination extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class Lease protected ()
      extends typingsJapgolly.pulumiKubernetes.coordinationMod.v1.Lease {
      /**
    ...
    class LeaseList protected ()
      extends typingsJapgolly.pulumiKubernetes.coordinationMod.v1.LeaseList {
      /**
  ...
  object v1beta1 extends js.Object {
    @js.native
    class Lease protected ()
      extends typingsJapgolly.pulumiKubernetes.coordinationMod.v1beta1.Lease {
      /**
    ...
    @js.native
    class LeaseList protected ()
      extends typingsJapgolly.pulumiKubernetes.coordinationMod.v1beta1.LeaseList {
      /**
