...
class DaemonSet protected ()
  extends typingsJapgolly.pulumiKubernetes.extensionsMod.v1beta1.DaemonSet {
  /**
...
object DaemonSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.v1beta1DaemonSetMod.DaemonSet = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.v1beta1DaemonSetMod.DaemonSet = js.native
  /**
