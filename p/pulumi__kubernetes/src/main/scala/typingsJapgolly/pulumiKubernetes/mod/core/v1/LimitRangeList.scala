...
class LimitRangeList protected ()
  extends typingsJapgolly.pulumiKubernetes.coreMod.v1.LimitRangeList {
  /**
...
object LimitRangeList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.limitRangeListMod.LimitRangeList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.limitRangeListMod.LimitRangeList = js.native
  /**
