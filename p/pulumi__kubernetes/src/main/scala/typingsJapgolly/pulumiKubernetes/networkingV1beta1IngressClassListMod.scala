...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.networking.v1beta1.IngressClass
...
object networkingV1beta1IngressClassListMod {
  
  @JSImport("@pulumi/kubernetes/networking/v1beta1/ingressClassList", "IngressClassList")
  @js.native
  open class IngressClassList protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.IngressClassList] = js.native
  ...
  trait IngressClassListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.networking.v1beta1.IngressClass]
        ]
      ]
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.IngressClassList]] = js.undefined
  ...
  object IngressClassListArgs {
    ...
    extension [Self <: IngressClassListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.networking.v1beta1.IngressClass]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.IngressClassList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
