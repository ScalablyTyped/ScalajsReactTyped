...
import typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIDriver
...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1beta1.CSIDriverSpecPatch
...
object storageV1beta1CsidriverPatchMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1beta1/csidriverPatch", "CSIDriverPatch")
  @js.native
  open class CSIDriverPatch protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[CSIDriver] = js.native
    ...
    /**
      ...
      */
    val spec: Output_[CSIDriverSpecPatch] = js.native
  }
  /* static members */
  object CSIDriverPatch {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): CSIDriverPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[CSIDriverPatch]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): CSIDriverPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[CSIDriverPatch]
  ...
  trait CSIDriverPatchArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[CSIDriver]] = js.undefined
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSIDriverSpecPatch
        ]
      ] = js.undefined
  }
  object CSIDriverPatchArgs {
    
    inline def apply(): CSIDriverPatchArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CSIDriverPatchArgs]
    }
    
    extension [Self <: CSIDriverPatchArgs](x: Self) {
      ...
      inline def setKind(value: Input[CSIDriver]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
