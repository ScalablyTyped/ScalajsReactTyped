...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.batch.v1beta1.CronJobSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.batch.v1beta1.CronJobStatusPatch
...
object batchV1beta1CronJobPatchMod {
  
  @JSImport("@pulumi/kubernetes/batch/v1beta1/cronJobPatch", "CronJobPatch")
  @js.native
  ...
  trait CronJobPatchArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.batch.v1beta1.CronJobSpecPatch]
      ] = js.undefined
  }
  object CronJobPatchArgs {
    ...
    extension [Self <: CronJobPatchArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.batch.v1beta1.CronJobSpecPatch]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
