...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1alpha1.VolumeAttachmentSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1alpha1.VolumeAttachmentStatus
...
object storageV1alpha1VolumeAttachmentMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1alpha1/volumeAttachment", "VolumeAttachment")
  @js.native
  open class VolumeAttachment protected () extends CustomResource {
    /**
  ...
  trait VolumeAttachmentArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: Input[
        typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1alpha1.VolumeAttachmentSpec
      ]
  }
