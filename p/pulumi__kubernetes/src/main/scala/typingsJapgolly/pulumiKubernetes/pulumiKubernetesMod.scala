...
object pulumiKubernetesMod extends js.Object {
  ...
  object v1alpha1 extends js.Object {
    ...
    class RuntimeClass protected ()
      extends typingsJapgolly.pulumiKubernetes.nodeV1alpha1Mod.RuntimeClass {
      /**
    ...
    class RuntimeClassList protected ()
      extends typingsJapgolly.pulumiKubernetes.nodeV1alpha1Mod.RuntimeClassList {
      /**
  ...
  object v1beta1 extends js.Object {
    @js.native
    class RuntimeClass protected ()
      extends typingsJapgolly.pulumiKubernetes.nodeV1beta1Mod.RuntimeClass {
      /**
    ...
    @js.native
    class RuntimeClassList protected ()
      extends typingsJapgolly.pulumiKubernetes.nodeV1beta1Mod.RuntimeClassList {
      /**
