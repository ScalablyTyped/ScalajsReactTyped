...
import typingsJapgolly.pulumiKubernetes.outputMod.authentication.v1beta1.TokenReviewSpec
import typingsJapgolly.pulumiKubernetes.outputMod.authentication.v1beta1.TokenReviewStatus
