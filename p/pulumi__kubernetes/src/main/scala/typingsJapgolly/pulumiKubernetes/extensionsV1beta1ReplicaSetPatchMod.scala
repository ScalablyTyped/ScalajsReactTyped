...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.ReplicaSetSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.ReplicaSetStatusPatch
...
object extensionsV1beta1ReplicaSetPatchMod {
  
  @JSImport("@pulumi/kubernetes/extensions/v1beta1/replicaSetPatch", "ReplicaSetPatch")
  @js.native
  ...
  object ReplicaSetPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/replicaSetPatch.ReplicaSetPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/replicaSetPatch.ReplicaSetPatch */ Boolean]
  }
  ...
  trait ReplicaSetPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.ReplicaSetSpecPatch
        ]
      ] = js.undefined
  }
