...
object storageV1Mod extends js.Object {
  ...
  class CSINode protected ()
    extends typingsJapgolly.pulumiKubernetes.v1CsinodeMod.CSINode {
    /**
  ...
  class CSINodeList protected ()
    extends typingsJapgolly.pulumiKubernetes.v1CsinodelistMod.CSINodeList {
    /**
  ...
  class StorageClass protected ()
    extends typingsJapgolly.pulumiKubernetes.v1StorageClassMod.StorageClass {
    /**
  ...
  class StorageClassList protected ()
    extends typingsJapgolly.pulumiKubernetes.v1StorageClassListMod.StorageClassList {
    /**
  ...
  class VolumeAttachment protected ()
    extends typingsJapgolly.pulumiKubernetes.v1VolumeAttachmentMod.VolumeAttachment {
    /**
  ...
  class VolumeAttachmentList protected ()
    extends typingsJapgolly.pulumiKubernetes.v1VolumeAttachmentListMod.VolumeAttachmentList {
    /**
