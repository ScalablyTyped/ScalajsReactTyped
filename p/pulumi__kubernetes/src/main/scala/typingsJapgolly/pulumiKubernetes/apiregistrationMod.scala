...
object apiregistrationMod extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class APIService protected ()
      extends typingsJapgolly.pulumiKubernetes.apiregistrationV1Mod.APIService {
      /**
    ...
    class APIServiceList protected ()
      extends typingsJapgolly.pulumiKubernetes.apiregistrationV1Mod.APIServiceList {
      /**
  ...
  object v1beta1 extends js.Object {
    @js.native
    class APIService protected ()
      extends typingsJapgolly.pulumiKubernetes.apiregistrationV1beta1Mod.APIService {
      /**
    ...
    @js.native
    class APIServiceList protected ()
      extends typingsJapgolly.pulumiKubernetes.apiregistrationV1beta1Mod.APIServiceList {
      /**
