...
import typingsJapgolly.pulumiKubernetes.apiregistrationV1beta1ApiserviceListMod.APIServiceList
import typingsJapgolly.pulumiKubernetes.apiregistrationV1beta1ApiserviceListMod.APIServiceListArgs
import typingsJapgolly.pulumiKubernetes.apiregistrationV1beta1ApiserviceMod.APIService
import typingsJapgolly.pulumiKubernetes.apiregistrationV1beta1ApiserviceMod.APIServiceArgs
import typingsJapgolly.pulumiKubernetes.apiregistrationV1beta1ApiservicePatchMod.APIServicePatch
...
object apiregistrationMod {
  ...
  object v1beta1 {
    ...
    @JSImport("@pulumi/kubernetes/apiregistration", "v1beta1.APIService")
    @js.native
    open class APIServiceCls protected () extends APIService {
      /**
    ...
    @JSImport("@pulumi/kubernetes/apiregistration", "v1beta1.APIServiceList")
    @js.native
    open class APIServiceListCls protected () extends APIServiceList {
      /**
    ...
    @JSImport("@pulumi/kubernetes/apiregistration", "v1beta1.APIServicePatch")
    @js.native
    open class APIServicePatchCls protected () extends APIServicePatch {
      /**
