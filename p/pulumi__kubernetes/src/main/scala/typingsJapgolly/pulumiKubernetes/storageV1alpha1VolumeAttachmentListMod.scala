...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1alpha1.VolumeAttachment
...
object storageV1alpha1VolumeAttachmentListMod {
  ...
  trait VolumeAttachmentListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1alpha1.VolumeAttachment]
        ]
      ]
  ...
  object VolumeAttachmentListArgs {
    ...
    extension [Self <: VolumeAttachmentListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1alpha1.VolumeAttachment]*): Self = StObject.set(x, "items", js.Array(value*))
