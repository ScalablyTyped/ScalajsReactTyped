...
object flowcontrolV1alpha1PriorityLevelConfigurationMod {
  ...
  trait PriorityLevelConfigurationArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.flowcontrol.v1alpha1.PriorityLevelConfigurationSpec
        ]
      ] = js.undefined
  }
