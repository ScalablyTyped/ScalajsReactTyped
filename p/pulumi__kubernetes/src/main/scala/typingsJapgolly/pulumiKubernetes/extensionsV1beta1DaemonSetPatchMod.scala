...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.DaemonSetSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.DaemonSetStatusPatch
...
object extensionsV1beta1DaemonSetPatchMod {
  
  @JSImport("@pulumi/kubernetes/extensions/v1beta1/daemonSetPatch", "DaemonSetPatch")
  @js.native
  ...
  object DaemonSetPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/daemonSetPatch.DaemonSetPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/daemonSetPatch.DaemonSetPatch */ Boolean]
  }
  ...
  trait DaemonSetPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.DaemonSetSpecPatch
        ]
      ] = js.undefined
  }
