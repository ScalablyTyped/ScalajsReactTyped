...
object v1Mod extends js.Object {
  ...
  class MutatingWebhookConfiguration protected ()
    extends typingsJapgolly.pulumiKubernetes.v1MutatingWebhookConfigurationMod.MutatingWebhookConfiguration {
    /**
  ...
  class MutatingWebhookConfigurationList protected ()
    extends typingsJapgolly.pulumiKubernetes.v1MutatingWebhookConfigurationListMod.MutatingWebhookConfigurationList {
    /**
  ...
  class ValidatingWebhookConfiguration protected ()
    extends typingsJapgolly.pulumiKubernetes.v1ValidatingWebhookConfigurationMod.ValidatingWebhookConfiguration {
    /**
  ...
  class ValidatingWebhookConfigurationList protected ()
    extends typingsJapgolly.pulumiKubernetes.v1ValidatingWebhookConfigurationListMod.ValidatingWebhookConfigurationList {
    /**
