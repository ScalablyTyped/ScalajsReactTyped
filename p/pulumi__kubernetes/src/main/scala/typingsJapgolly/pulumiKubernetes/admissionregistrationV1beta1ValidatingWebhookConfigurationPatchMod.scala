...
import typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfiguration
import typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.admissionregistrationDotk8sDotioSlashv1beta1
import typingsJapgolly.pulumiKubernetes.typesOutputMod.admissionregistration.v1beta1.ValidatingWebhookPatch
...
object admissionregistrationV1beta1ValidatingWebhookConfigurationPatchMod {
  
  @JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/validatingWebhookConfigurationPatch", "ValidatingWebhookConfigurationPatch")
  @js.native
  open class ValidatingWebhookConfigurationPatch protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[ValidatingWebhookConfiguration] = js.native
    ...
    /**
      ...
      */
    val webhooks: Output_[js.Array[ValidatingWebhookPatch]] = js.native
  }
  /* static members */
  object ValidatingWebhookConfigurationPatch {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): ValidatingWebhookConfigurationPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[ValidatingWebhookConfigurationPatch]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): ValidatingWebhookConfigurationPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[ValidatingWebhookConfigurationPatch]
  ...
  trait ValidatingWebhookConfigurationPatchArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[ValidatingWebhookConfiguration]] = js.undefined
    ...
    var webhooks: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsJapgolly.pulumiKubernetes.typesInputMod.admissionregistration.v1beta1.ValidatingWebhookPatch
            ]
          ]
        ]
      ] = js.undefined
  }
  object ValidatingWebhookConfigurationPatchArgs {
    
    inline def apply(): ValidatingWebhookConfigurationPatchArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ValidatingWebhookConfigurationPatchArgs]
    }
    
    extension [Self <: ValidatingWebhookConfigurationPatchArgs](x: Self) {
      ...
      inline def setKind(value: Input[ValidatingWebhookConfiguration]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      inline def setWebhooksVarargs(
        value: (Input[
              typingsJapgolly.pulumiKubernetes.typesInputMod.admissionregistration.v1beta1.ValidatingWebhookPatch
            ])*
      ): Self = StObject.set(x, "webhooks", js.Array(value*))
    }
  }
}
