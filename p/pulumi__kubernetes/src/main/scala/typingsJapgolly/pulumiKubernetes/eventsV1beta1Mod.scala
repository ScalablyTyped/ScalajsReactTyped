...
object eventsV1beta1Mod {
  ...
  type Event = typingsJapgolly.pulumiKubernetes.eventsV1beta1EventMod.Event
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@pulumi/kubernetes/events/v1beta1", "Event")
  @js.native
  open class EventCls protected ()
    extends typingsJapgolly.pulumiKubernetes.eventsV1beta1EventMod.Event {
    /**
  ...
  type EventList = typingsJapgolly.pulumiKubernetes.eventsV1beta1EventListMod.EventList
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@pulumi/kubernetes/events/v1beta1", "EventList")
  @js.native
  open class EventListCls protected ()
    extends typingsJapgolly.pulumiKubernetes.eventsV1beta1EventListMod.EventList {
    /**
  ...
  type EventPatch = typingsJapgolly.pulumiKubernetes.eventsV1beta1EventPatchMod.EventPatch
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@pulumi/kubernetes/events/v1beta1", "EventPatch")
  @js.native
  open class EventPatchCls protected ()
    extends typingsJapgolly.pulumiKubernetes.eventsV1beta1EventPatchMod.EventPatch {
    /**
