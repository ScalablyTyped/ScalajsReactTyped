...
@JSImport("@pulumi/kubernetes/core/v1/PersistentVolumeClaim", JSImport.Namespace)
@js.native
object persistentVolumeClaimMod extends js.Object {
  @js.native
  class PersistentVolumeClaim protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeClaim] = js.native
    /**
