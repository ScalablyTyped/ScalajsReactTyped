...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1beta1.PriorityLevelConfigurationSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1beta1.PriorityLevelConfigurationStatusPatch
...
object flowcontrolV1beta1PriorityLevelConfigurationPatchMod {
  
  @JSImport("@pulumi/kubernetes/flowcontrol/v1beta1/priorityLevelConfigurationPatch", "PriorityLevelConfigurationPatch")
  @js.native
  ...
  object PriorityLevelConfigurationPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/flowcontrol/v1beta1/priorityLevelConfigurationPatch.PriorityLevelConfigurationPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/flowcontrol/v1beta1/priorityLevelConfigurationPatch.PriorityLevelConfigurationPatch */ Boolean]
  }
  ...
  trait PriorityLevelConfigurationPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.flowcontrol.v1beta1.PriorityLevelConfigurationSpecPatch
        ]
      ] = js.undefined
  }
