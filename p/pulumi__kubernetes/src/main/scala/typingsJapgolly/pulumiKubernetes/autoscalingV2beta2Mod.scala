...
object autoscalingV2beta2Mod {
  ...
  type HorizontalPodAutoscaler = typingsJapgolly.pulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerMod.HorizontalPodAutoscaler
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@pulumi/kubernetes/autoscaling/v2beta2", "HorizontalPodAutoscaler")
  @js.native
  open class HorizontalPodAutoscalerCls protected ()
    extends typingsJapgolly.pulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerMod.HorizontalPodAutoscaler {
    /**
  ...
  type HorizontalPodAutoscalerList = typingsJapgolly.pulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerListMod.HorizontalPodAutoscalerList
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@pulumi/kubernetes/autoscaling/v2beta2", "HorizontalPodAutoscalerList")
  @js.native
  open class HorizontalPodAutoscalerListCls protected ()
    extends typingsJapgolly.pulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerListMod.HorizontalPodAutoscalerList {
    /**
  ...
  type HorizontalPodAutoscalerPatch = typingsJapgolly.pulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerPatchMod.HorizontalPodAutoscalerPatch
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@pulumi/kubernetes/autoscaling/v2beta2", "HorizontalPodAutoscalerPatch")
  @js.native
  open class HorizontalPodAutoscalerPatchCls protected ()
    extends typingsJapgolly.pulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerPatchMod.HorizontalPodAutoscalerPatch {
    /**
