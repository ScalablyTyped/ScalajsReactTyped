...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1beta1.CSINodeSpec
...
object storageV1beta1CsinodeMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1beta1/csinode", "CSINode")
  @js.native
  open class CSINode protected () extends CustomResource {
    /**
  ...
  trait CSINodeArgs extends StObject {
    ...
    /**
      * spec is the specification of CSINode
      */
    var spec: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSINodeSpec]
  }
  object CSINodeArgs {
    
    inline def apply(spec: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSINodeSpec]): CSINodeArgs = {
    ...
    extension [Self <: CSINodeArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSINodeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
