...
import typingsJapgolly.pulumiKubernetes.outputMod.rbac.v1alpha1.RoleRef
import typingsJapgolly.pulumiKubernetes.outputMod.rbac.v1alpha1.Subject
...
@js.native
object roleBindingMod extends js.Object {
  @js.native
  class RoleBinding protected () extends CustomResource {
    ...
    def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding) = this()
    def this(
      name: String,
      args: typingsJapgolly.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding,
