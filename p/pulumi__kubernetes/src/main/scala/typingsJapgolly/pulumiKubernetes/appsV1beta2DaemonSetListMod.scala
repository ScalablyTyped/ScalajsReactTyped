...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.DaemonSet
...
object appsV1beta2DaemonSetListMod {
  ...
  trait DaemonSetListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.DaemonSet]]
      ]
  ...
  object DaemonSetListArgs {
    ...
    extension [Self <: DaemonSetListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.DaemonSet]*): Self = StObject.set(x, "items", js.Array(value*))
