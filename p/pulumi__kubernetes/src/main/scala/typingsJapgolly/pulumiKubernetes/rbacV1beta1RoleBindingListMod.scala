...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.rbac.v1beta1.RoleBinding
...
object rbacV1beta1RoleBindingListMod {
  ...
  object RoleBindingList {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1beta1/roleBindingList.RoleBindingList */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1beta1/roleBindingList.RoleBindingList */ Boolean]
  }
  ...
  trait RoleBindingListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1beta1.RoleBinding]]
      ]
  ...
  object RoleBindingListArgs {
    ...
    extension [Self <: RoleBindingListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1beta1.RoleBinding]*): Self = StObject.set(x, "items", js.Array(value*))
