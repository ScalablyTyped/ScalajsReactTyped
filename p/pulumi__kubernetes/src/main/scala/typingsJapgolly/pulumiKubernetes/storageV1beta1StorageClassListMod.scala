...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1beta1.StorageClass
...
object storageV1beta1StorageClassListMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1beta1/storageClassList", "StorageClassList")
  @js.native
  open class StorageClassList protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StorageClassList] = js.native
  ...
  trait StorageClassListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.StorageClass]
        ]
      ]
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StorageClassList]] = js.undefined
  ...
  object StorageClassListArgs {
    ...
    extension [Self <: StorageClassListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.StorageClass]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StorageClassList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
