...
import typingsJapgolly.pulumiKubernetes.outputMod.apps.v1beta2.DaemonSetSpec
import typingsJapgolly.pulumiKubernetes.outputMod.apps.v1beta2.DaemonSetStatus
