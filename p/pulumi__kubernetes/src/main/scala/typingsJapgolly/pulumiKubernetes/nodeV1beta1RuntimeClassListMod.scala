...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.node.v1beta1.RuntimeClass
...
object nodeV1beta1RuntimeClassListMod {
  ...
  object RuntimeClassList {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/node/v1beta1/runtimeClassList.RuntimeClassList */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/node/v1beta1/runtimeClassList.RuntimeClassList */ Boolean]
  }
  ...
  trait RuntimeClassListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.node.v1beta1.RuntimeClass]]
      ]
  ...
  object RuntimeClassListArgs {
    ...
    extension [Self <: RuntimeClassListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.node.v1beta1.RuntimeClass]*): Self = StObject.set(x, "items", js.Array(value*))
