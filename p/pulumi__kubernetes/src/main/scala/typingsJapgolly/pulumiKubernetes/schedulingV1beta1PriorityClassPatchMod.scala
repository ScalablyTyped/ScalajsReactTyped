...
object schedulingV1beta1PriorityClassPatchMod {
  
  @JSImport("@pulumi/kubernetes/scheduling/v1beta1/priorityClassPatch", "PriorityClassPatch")
  @js.native
  ...
  object PriorityClassPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/scheduling/v1beta1/priorityClassPatch.PriorityClassPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/scheduling/v1beta1/priorityClassPatch.PriorityClassPatch */ Boolean]
  }
