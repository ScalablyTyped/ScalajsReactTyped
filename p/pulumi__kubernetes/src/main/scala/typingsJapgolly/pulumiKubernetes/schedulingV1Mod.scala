...
object schedulingV1Mod extends js.Object {
  ...
  class PriorityClass protected ()
    extends typingsJapgolly.pulumiKubernetes.v1PriorityClassMod.PriorityClass {
    /**
  ...
  class PriorityClassList protected ()
    extends typingsJapgolly.pulumiKubernetes.v1PriorityClassListMod.PriorityClassList {
    /**
