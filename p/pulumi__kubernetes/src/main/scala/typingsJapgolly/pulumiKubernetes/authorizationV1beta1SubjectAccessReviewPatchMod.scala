...
object authorizationV1beta1SubjectAccessReviewPatchMod {
  
  @JSImport("@pulumi/kubernetes/authorization/v1beta1/subjectAccessReviewPatch", "SubjectAccessReviewPatch")
  @js.native
  open class SubjectAccessReviewPatch protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[SubjectAccessReview] = js.native
  ...
  object SubjectAccessReviewPatch {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): SubjectAccessReviewPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[SubjectAccessReviewPatch]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): SubjectAccessReviewPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[SubjectAccessReviewPatch]
  ...
  trait SubjectAccessReviewPatchArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[SubjectAccessReview]] = js.undefined
  ...
  object SubjectAccessReviewPatchArgs {
    
    inline def apply(): SubjectAccessReviewPatchArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SubjectAccessReviewPatchArgs]
    }
    
    extension [Self <: SubjectAccessReviewPatchArgs](x: Self) {
      ...
      inline def setKind(value: Input[SubjectAccessReview]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
