...
import typingsJapgolly.pulumiKubernetes.outputMod.apiextensions.v1beta1.CustomResourceDefinitionSpec
import typingsJapgolly.pulumiKubernetes.outputMod.apiextensions.v1beta1.CustomResourceDefinitionStatus
