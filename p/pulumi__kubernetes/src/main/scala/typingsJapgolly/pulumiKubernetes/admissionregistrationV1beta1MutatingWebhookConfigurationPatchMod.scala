...
import typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.MutatingWebhookConfiguration
import typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.admissionregistrationDotk8sDotioSlashv1beta1
import typingsJapgolly.pulumiKubernetes.typesOutputMod.admissionregistration.v1beta1.MutatingWebhookPatch
...
object admissionregistrationV1beta1MutatingWebhookConfigurationPatchMod {
  
  @JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/mutatingWebhookConfigurationPatch", "MutatingWebhookConfigurationPatch")
  @js.native
  open class MutatingWebhookConfigurationPatch protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[MutatingWebhookConfiguration] = js.native
    ...
    /**
      ...
      */
    val webhooks: Output_[js.Array[MutatingWebhookPatch]] = js.native
  }
  /* static members */
  object MutatingWebhookConfigurationPatch {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): MutatingWebhookConfigurationPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[MutatingWebhookConfigurationPatch]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): MutatingWebhookConfigurationPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[MutatingWebhookConfigurationPatch]
  ...
  trait MutatingWebhookConfigurationPatchArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[MutatingWebhookConfiguration]] = js.undefined
    ...
    var webhooks: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsJapgolly.pulumiKubernetes.typesInputMod.admissionregistration.v1beta1.MutatingWebhookPatch
            ]
          ]
        ]
      ] = js.undefined
  }
  object MutatingWebhookConfigurationPatchArgs {
    
    inline def apply(): MutatingWebhookConfigurationPatchArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MutatingWebhookConfigurationPatchArgs]
    }
    
    extension [Self <: MutatingWebhookConfigurationPatchArgs](x: Self) {
      ...
      inline def setKind(value: Input[MutatingWebhookConfiguration]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
