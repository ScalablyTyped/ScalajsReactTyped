...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.autoscaling.v2beta1.HorizontalPodAutoscaler
...
object autoscalingV2beta1HorizontalPodAutoscalerListMod {
  
  @JSImport("@pulumi/kubernetes/autoscaling/v2beta1/horizontalPodAutoscalerList", "HorizontalPodAutoscalerList")
  @js.native
  open class HorizontalPodAutoscalerList protected () extends CustomResource {
    /**
  ...
  trait HorizontalPodAutoscalerListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[
            typingsJapgolly.pulumiKubernetes.typesInputMod.autoscaling.v2beta1.HorizontalPodAutoscaler
          ]
        ]
      ]
