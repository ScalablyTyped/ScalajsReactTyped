...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1beta2.FlowSchemaSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1beta2.FlowSchemaStatus
...
object flowcontrolV1beta2FlowSchemaMod {
  
  @JSImport("@pulumi/kubernetes/flowcontrol/v1beta2/flowSchema", "FlowSchema")
  @js.native
  ...
  object FlowSchema {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/flowcontrol/v1beta2/flowSchema.FlowSchema */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/flowcontrol/v1beta2/flowSchema.FlowSchema */ Boolean]
  }
  ...
  trait FlowSchemaArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.flowcontrol.v1beta2.FlowSchemaSpec
        ]
      ] = js.undefined
  }
