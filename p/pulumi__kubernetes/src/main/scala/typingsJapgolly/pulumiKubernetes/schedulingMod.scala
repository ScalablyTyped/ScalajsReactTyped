...
object schedulingMod extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class PriorityClass protected ()
      extends typingsJapgolly.pulumiKubernetes.schedulingV1Mod.PriorityClass {
      /**
    ...
    class PriorityClassList protected ()
      extends typingsJapgolly.pulumiKubernetes.schedulingV1Mod.PriorityClassList {
      /**
  ...
  object v1alpha1 extends js.Object {
    @js.native
    class PriorityClass protected ()
      extends typingsJapgolly.pulumiKubernetes.schedulingV1alpha1Mod.PriorityClass {
      /**
    ...
    @js.native
    class PriorityClassList protected ()
      extends typingsJapgolly.pulumiKubernetes.schedulingV1alpha1Mod.PriorityClassList {
      /**
  ...
  object v1beta1 extends js.Object {
    @js.native
    class PriorityClass protected ()
      extends typingsJapgolly.pulumiKubernetes.schedulingV1beta1Mod.PriorityClass {
      /**
    ...
    @js.native
    class PriorityClassList protected ()
      extends typingsJapgolly.pulumiKubernetes.schedulingV1beta1Mod.PriorityClassList {
      /**
