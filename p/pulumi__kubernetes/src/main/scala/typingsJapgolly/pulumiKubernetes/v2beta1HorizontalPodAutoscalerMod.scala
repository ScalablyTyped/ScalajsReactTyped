...
import typingsJapgolly.pulumiKubernetes.outputMod.autoscaling.v2beta1.HorizontalPodAutoscalerSpec
import typingsJapgolly.pulumiKubernetes.outputMod.autoscaling.v2beta1.HorizontalPodAutoscalerStatus
