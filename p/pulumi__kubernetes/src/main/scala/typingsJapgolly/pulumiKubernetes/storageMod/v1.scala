...
object v1 extends js.Object {
  ...
  class CSINode protected ()
    extends typingsJapgolly.pulumiKubernetes.storageV1Mod.CSINode {
    /**
  ...
  class CSINodeList protected ()
    extends typingsJapgolly.pulumiKubernetes.storageV1Mod.CSINodeList {
    /**
  ...
  class StorageClass protected ()
    extends typingsJapgolly.pulumiKubernetes.storageV1Mod.StorageClass {
    /**
  ...
  class StorageClassList protected ()
    extends typingsJapgolly.pulumiKubernetes.storageV1Mod.StorageClassList {
    /**
  ...
  class VolumeAttachment protected ()
    extends typingsJapgolly.pulumiKubernetes.storageV1Mod.VolumeAttachment {
    /**
  ...
  class VolumeAttachmentList protected ()
    extends typingsJapgolly.pulumiKubernetes.storageV1Mod.VolumeAttachmentList {
    /**
