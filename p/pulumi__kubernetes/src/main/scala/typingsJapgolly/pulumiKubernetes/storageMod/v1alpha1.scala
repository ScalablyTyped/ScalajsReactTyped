...
object v1alpha1 extends js.Object {
  ...
  class VolumeAttachment protected ()
    extends typingsJapgolly.pulumiKubernetes.storageV1alpha1Mod.VolumeAttachment {
    /**
  ...
  class VolumeAttachmentList protected ()
    extends typingsJapgolly.pulumiKubernetes.storageV1alpha1Mod.VolumeAttachmentList {
    /**
