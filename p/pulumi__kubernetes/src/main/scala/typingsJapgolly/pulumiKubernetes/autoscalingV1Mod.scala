...
object autoscalingV1Mod extends js.Object {
  ...
  class HorizontalPodAutoscaler protected ()
    extends typingsJapgolly.pulumiKubernetes.horizontalPodAutoscalerMod.HorizontalPodAutoscaler {
    /**
  ...
  class HorizontalPodAutoscalerList protected ()
    extends typingsJapgolly.pulumiKubernetes.horizontalPodAutoscalerListMod.HorizontalPodAutoscalerList {
    /**
