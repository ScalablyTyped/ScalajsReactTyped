...
object flowcontrolV1alpha1FlowSchemaListMod {
  
  @JSImport("@pulumi/kubernetes/flowcontrol/v1alpha1/flowSchemaList", "FlowSchemaList")
  @js.native
  open class FlowSchemaList protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList] = js.native
  ...
  object FlowSchemaList {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): FlowSchemaList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[FlowSchemaList]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): FlowSchemaList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[FlowSchemaList]
  ...
  trait FlowSchemaListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.flowcontrol.v1alpha1.FlowSchema]
        ]
      ]
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList]] = js.undefined
  ...
  object FlowSchemaListArgs {
    ...
    extension [Self <: FlowSchemaListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.flowcontrol.v1alpha1.FlowSchema]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
