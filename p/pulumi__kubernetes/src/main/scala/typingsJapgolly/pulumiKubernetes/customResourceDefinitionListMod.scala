...
import typingsJapgolly.pulumiKubernetes.outputMod.apiextensions.v1beta1.CustomResourceDefinition
...
@JSImport("@pulumi/kubernetes/apiextensions/v1beta1/CustomResourceDefinitionList", JSImport.Namespace)
@js.native
object customResourceDefinitionListMod extends js.Object {
  @js.native
