...
import typingsJapgolly.pulumiKubernetes.outputMod.rbac.v1beta1.AggregationRule
import typingsJapgolly.pulumiKubernetes.outputMod.rbac.v1beta1.PolicyRule
...
@JSImport("@pulumi/kubernetes/rbac/v1beta1/ClusterRole", JSImport.Namespace)
@js.native
object v1beta1ClusterRoleMod extends js.Object {
  @js.native
