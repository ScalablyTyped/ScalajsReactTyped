...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta1.StatefulSet
...
object appsV1beta1StatefulSetListMod {
  
  @JSImport("@pulumi/kubernetes/apps/v1beta1/statefulSetList", "StatefulSetList")
  @js.native
  ...
  trait StatefulSetListArgs extends StObject {
    ...
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta1.StatefulSet]]
      ]
  ...
  object StatefulSetListArgs {
    ...
    extension [Self <: StatefulSetListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta1.StatefulSet]*): Self = StObject.set(x, "items", js.Array(value*))
