...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.discovery.v1beta1.EndpointSlice
...
object discoveryV1beta1EndpointSliceListMod {
  
  @JSImport("@pulumi/kubernetes/discovery/v1beta1/endpointSliceList", "EndpointSliceList")
  @js.native
  open class EndpointSliceList protected () extends CustomResource {
    /**
  ...
  object EndpointSliceList {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): EndpointSliceList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[EndpointSliceList]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): EndpointSliceList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[EndpointSliceList]
  ...
  trait EndpointSliceListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.discovery.v1beta1.EndpointSlice]
        ]
      ]
  ...
  object EndpointSliceListArgs {
    ...
    extension [Self <: EndpointSliceListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.discovery.v1beta1.EndpointSlice]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
