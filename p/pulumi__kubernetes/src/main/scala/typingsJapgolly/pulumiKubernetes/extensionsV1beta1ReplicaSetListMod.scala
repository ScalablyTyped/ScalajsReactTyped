...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.ReplicaSet
...
object extensionsV1beta1ReplicaSetListMod {
  ...
  trait ReplicaSetListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.ReplicaSet]
        ]
      ]
  ...
  object ReplicaSetListArgs {
    ...
    extension [Self <: ReplicaSetListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.ReplicaSet]*): Self = StObject.set(x, "items", js.Array(value*))
