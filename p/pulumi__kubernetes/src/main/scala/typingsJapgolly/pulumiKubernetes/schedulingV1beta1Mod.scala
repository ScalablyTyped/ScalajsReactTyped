...
object schedulingV1beta1Mod extends js.Object {
  ...
  class PriorityClass protected ()
    extends typingsJapgolly.pulumiKubernetes.v1beta1PriorityClassMod.PriorityClass {
    /**
  ...
  class PriorityClassList protected ()
    extends typingsJapgolly.pulumiKubernetes.v1beta1PriorityClassListMod.PriorityClassList {
    /**
