...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.ReplicaSetSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.ReplicaSetStatus
...
object extensionsV1beta1ReplicaSetMod {
  ...
  object ReplicaSet {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/replicaSet.ReplicaSet */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/replicaSet.ReplicaSet */ Boolean]
  }
  ...
  trait ReplicaSetArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.ReplicaSetSpec]
      ] = js.undefined
  }
  object ReplicaSetArgs {
    ...
    extension [Self <: ReplicaSetArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.ReplicaSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
