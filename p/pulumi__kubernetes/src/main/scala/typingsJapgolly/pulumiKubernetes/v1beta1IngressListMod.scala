...
import typingsJapgolly.pulumiKubernetes.outputMod.networking.v1beta1.Ingress
...
@JSImport("@pulumi/kubernetes/networking/v1beta1/IngressList", JSImport.Namespace)
@js.native
object v1beta1IngressListMod extends js.Object {
  @js.native
