...
object apiextensionsV1Mod extends js.Object {
  ...
  class CustomResourceDefinition protected ()
    extends typingsJapgolly.pulumiKubernetes.v1CustomResourceDefinitionMod.CustomResourceDefinition {
    /**
  ...
  class CustomResourceDefinitionList protected ()
    extends typingsJapgolly.pulumiKubernetes.v1CustomResourceDefinitionListMod.CustomResourceDefinitionList {
    /**
