...
/**
  ...
  */
trait StorageOSVolumeSourcePatch extends StObject {
...
object StorageOSVolumeSourcePatch {
  
  inline def apply(): StorageOSVolumeSourcePatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StorageOSVolumeSourcePatch]
  }
  
  extension [Self <: StorageOSVolumeSourcePatch](x: Self) {
