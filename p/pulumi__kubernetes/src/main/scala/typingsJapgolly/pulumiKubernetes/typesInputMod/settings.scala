...
import typingsJapgolly.pulumiKubernetes.typesInputMod.core.v1.EnvFromSource
import typingsJapgolly.pulumiKubernetes.typesInputMod.core.v1.EnvFromSourcePatch
import typingsJapgolly.pulumiKubernetes.typesInputMod.core.v1.EnvVar
import typingsJapgolly.pulumiKubernetes.typesInputMod.core.v1.EnvVarPatch
import typingsJapgolly.pulumiKubernetes.typesInputMod.core.v1.Volume
import typingsJapgolly.pulumiKubernetes.typesInputMod.core.v1.VolumeMount
import typingsJapgolly.pulumiKubernetes.typesInputMod.core.v1.VolumeMountPatch
import typingsJapgolly.pulumiKubernetes.typesInputMod.core.v1.VolumePatch
  ...
  object v1alpha1 {
    ...
    trait PodPreset extends StObject {
      ...
      /**
        ...
        */
      var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodPreset]] = js.undefined
    ...
    object PodPreset {
      ...
      extension [Self <: PodPreset](x: Self) {
        ...
        inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodPreset]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    ...
    object PodPresetSpec {
      ...
      extension [Self <: PodPresetSpec](x: Self) {
        ...
        inline def setEnvFromVarargs(value: Input[EnvFromSource]*): Self = StObject.set(x, "envFrom", js.Array(value*))
        
        inline def setEnvUndefined: Self = StObject.set(x, "env", js.undefined)
        
        inline def setEnvVarargs(value: Input[EnvVar]*): Self = StObject.set(x, "env", js.Array(value*))
        ...
        inline def setVolumeMountsVarargs(value: Input[VolumeMount]*): Self = StObject.set(x, "volumeMounts", js.Array(value*))
    ...
    object PodPresetSpecPatch {
      ...
      inline def apply(): PodPresetSpecPatch = {
        val __obj = js.Dynamic.literal()
