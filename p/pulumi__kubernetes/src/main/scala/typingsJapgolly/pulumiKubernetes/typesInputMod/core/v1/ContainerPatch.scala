...
/**
  ...
  */
trait ContainerPatch extends StObject {
...
object ContainerPatch {
  
  inline def apply(): ContainerPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ContainerPatch]
  }
  
  extension [Self <: ContainerPatch](x: Self) {
