  ...
  object v1alpha1 {
    ...
    trait AuditSinkSpecPatch extends StObject {
      ...
      /**
        * Policy defines the policy for selecting which events should be sent to the webhook required
        */
      var policy: js.UndefOr[Input[PolicyPatch]] = js.undefined
      
      /**
        * Webhook to send events required
        */
      var webhook: js.UndefOr[Input[WebhookPatch]] = js.undefined
    }
    object AuditSinkSpecPatch {
      
      inline def apply(): AuditSinkSpecPatch = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: AuditSinkSpecPatch](x: Self) {
        ...
        inline def setPolicy(value: Input[PolicyPatch]): Self = StObject.set(x, "policy", value.asInstanceOf[js.Any])
        
        inline def setPolicyUndefined: Self = StObject.set(x, "policy", js.undefined)
        
        inline def setWebhook(value: Input[WebhookPatch]): Self = StObject.set(x, "webhook", value.asInstanceOf[js.Any])
    ...
    object Policy {
      ...
      extension [Self <: Policy](x: Self) {
        ...
        inline def setStagesVarargs(value: Input[String]*): Self = StObject.set(x, "stages", js.Array(value*))
      }
    }
    ...
    trait WebhookPatch extends StObject {
      ...
      /**
        * Throttle holds the options for throttling the webhook
        */
      var throttle: js.UndefOr[Input[WebhookThrottleConfigPatch]] = js.undefined
    }
    object WebhookPatch {
      
      inline def apply(): WebhookPatch = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: WebhookPatch](x: Self) {
        ...
        inline def setThrottle(value: Input[WebhookThrottleConfigPatch]): Self = StObject.set(x, "throttle", value.asInstanceOf[js.Any])
    ...
    object WebhookThrottleConfigPatch {
      ...
      inline def apply(): WebhookThrottleConfigPatch = {
        val __obj = js.Dynamic.literal()
