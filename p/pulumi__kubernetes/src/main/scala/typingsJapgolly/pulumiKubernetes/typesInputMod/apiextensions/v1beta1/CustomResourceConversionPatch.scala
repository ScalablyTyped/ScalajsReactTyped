...
trait CustomResourceConversionPatch extends StObject {
  ...
  /**
    ...
    */
  var webhookClientConfig: js.UndefOr[Input[WebhookClientConfigPatch]] = js.undefined
}
object CustomResourceConversionPatch {
  ...
  extension [Self <: CustomResourceConversionPatch](x: Self) {
    ...
    inline def setWebhookClientConfig(value: Input[WebhookClientConfigPatch]): Self = StObject.set(x, "webhookClientConfig", value.asInstanceOf[js.Any])
