...
object Container {
  ...
  extension [Self <: Container](x: Self) {
    ...
    inline def setPortsVarargs(value: Input[ContainerPort]*): Self = StObject.set(x, "ports", js.Array(value*))
    ...
    inline def setVolumeDevicesVarargs(value: Input[VolumeDevice]*): Self = StObject.set(x, "volumeDevices", js.Array(value*))
