...
object Endpoints {
  ...
  extension [Self <: Endpoints](x: Self) {
    ...
    inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Endpoints]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    ...
    inline def setSubsetsVarargs(value: Input[EndpointSubset]*): Self = StObject.set(x, "subsets", js.Array(value*))
  }
}
