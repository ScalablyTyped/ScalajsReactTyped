...
/**
  ...
  */
trait ServiceSpecPatch extends StObject {
  
  /**
    * allocateLoadBalancerNodePorts defines if NodePorts will be automatically allocated for services with type LoadBalancer.  Default is "true". It may be set to "false" if the cluster load-balancer does not rely on NodePorts.  If the caller requests specific NodePorts (by specifying a value), those requests will be respected, regardless of this field. This field may only be set for services with type LoadBalancer and will be cleared if the type is changed to any other type.
    */
  var allocateLoadBalancerNodePorts: js.UndefOr[Input[Boolean]] = js.undefined
  ...
  /**
    ...
    */
  var clusterIPs: js.UndefOr[Input[js.Array[Input[String]]]] = js.undefined
  ...
  /**
    ...
    */
  var internalTrafficPolicy: js.UndefOr[Input[String]] = js.undefined
  ...
  /**
    ...
    */
  var ipFamilies: js.UndefOr[Input[js.Array[Input[String]]]] = js.undefined
  ...
  /**
    ...
    */
  var ipFamilyPolicy: js.UndefOr[Input[String]] = js.undefined
  ...
  /**
    ...
    */
  var loadBalancerClass: js.UndefOr[Input[String]] = js.undefined
  ...
  /**
    ...
    */
  var ports: js.UndefOr[Input[js.Array[Input[ServicePortPatch]]]] = js.undefined
  ...
  /**
    ...
    */
  var sessionAffinityConfig: js.UndefOr[Input[SessionAffinityConfigPatch]] = js.undefined
  ...
  var `type`: js.UndefOr[
    Input[
      String | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify enums.core.v1.ServiceSpecType */ Any)
    ]
  ] = js.undefined
}
object ServiceSpecPatch {
  
  inline def apply(): ServiceSpecPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ServiceSpecPatch]
  }
  
  extension [Self <: ServiceSpecPatch](x: Self) {
    
    inline def setAllocateLoadBalancerNodePorts(value: Input[Boolean]): Self = StObject.set(x, "allocateLoadBalancerNodePorts", value.asInstanceOf[js.Any])
    
    inline def setAllocateLoadBalancerNodePortsUndefined: Self = StObject.set(x, "allocateLoadBalancerNodePorts", js.undefined)
    ...
    inline def setClusterIPs(value: Input[js.Array[Input[String]]]): Self = StObject.set(x, "clusterIPs", value.asInstanceOf[js.Any])
    
    inline def setClusterIPsUndefined: Self = StObject.set(x, "clusterIPs", js.undefined)
    
    inline def setClusterIPsVarargs(value: Input[String]*): Self = StObject.set(x, "clusterIPs", js.Array(value*))
    ...
    inline def setExternalIPsVarargs(value: Input[String]*): Self = StObject.set(x, "externalIPs", js.Array(value*))
    ...
    inline def setInternalTrafficPolicy(value: Input[String]): Self = StObject.set(x, "internalTrafficPolicy", value.asInstanceOf[js.Any])
    
    inline def setInternalTrafficPolicyUndefined: Self = StObject.set(x, "internalTrafficPolicy", js.undefined)
    
    inline def setIpFamilies(value: Input[js.Array[Input[String]]]): Self = StObject.set(x, "ipFamilies", value.asInstanceOf[js.Any])
    
    inline def setIpFamiliesUndefined: Self = StObject.set(x, "ipFamilies", js.undefined)
    
    inline def setIpFamiliesVarargs(value: Input[String]*): Self = StObject.set(x, "ipFamilies", js.Array(value*))
    
    inline def setIpFamily(value: Input[String]): Self = StObject.set(x, "ipFamily", value.asInstanceOf[js.Any])
    
    inline def setIpFamilyPolicy(value: Input[String]): Self = StObject.set(x, "ipFamilyPolicy", value.asInstanceOf[js.Any])
    
    inline def setIpFamilyPolicyUndefined: Self = StObject.set(x, "ipFamilyPolicy", js.undefined)
    
    inline def setIpFamilyUndefined: Self = StObject.set(x, "ipFamily", js.undefined)
    
    inline def setLoadBalancerClass(value: Input[String]): Self = StObject.set(x, "loadBalancerClass", value.asInstanceOf[js.Any])
    
    inline def setLoadBalancerClassUndefined: Self = StObject.set(x, "loadBalancerClass", js.undefined)
    ...
    inline def setLoadBalancerSourceRangesVarargs(value: Input[String]*): Self = StObject.set(x, "loadBalancerSourceRanges", js.Array(value*))
    
    inline def setPorts(value: Input[js.Array[Input[ServicePortPatch]]]): Self = StObject.set(x, "ports", value.asInstanceOf[js.Any])
    
    inline def setPortsUndefined: Self = StObject.set(x, "ports", js.undefined)
    
    inline def setPortsVarargs(value: Input[ServicePortPatch]*): Self = StObject.set(x, "ports", js.Array(value*))
    ...
    inline def setSessionAffinityConfig(value: Input[SessionAffinityConfigPatch]): Self = StObject.set(x, "sessionAffinityConfig", value.asInstanceOf[js.Any])
