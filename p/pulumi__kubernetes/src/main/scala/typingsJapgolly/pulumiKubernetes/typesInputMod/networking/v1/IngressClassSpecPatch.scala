...
trait IngressClassSpecPatch extends StObject {
  ...
  /**
    ...
    */
  var parameters: js.UndefOr[Input[IngressClassParametersReferencePatch]] = js.undefined
}
object IngressClassSpecPatch {
  ...
  extension [Self <: IngressClassSpecPatch](x: Self) {
    ...
    inline def setParameters(value: Input[IngressClassParametersReferencePatch]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
