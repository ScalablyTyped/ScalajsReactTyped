...
trait LimitedPriorityLevelConfigurationPatch extends StObject {
  ...
  /**
    ...
    */
  var limitResponse: js.UndefOr[Input[LimitResponsePatch]] = js.undefined
}
object LimitedPriorityLevelConfigurationPatch {
  
  inline def apply(): LimitedPriorityLevelConfigurationPatch = {
  ...
  extension [Self <: LimitedPriorityLevelConfigurationPatch](x: Self) {
    ...
    inline def setLimitResponse(value: Input[LimitResponsePatch]): Self = StObject.set(x, "limitResponse", value.asInstanceOf[js.Any])
