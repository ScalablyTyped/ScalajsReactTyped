...
trait PodFailurePolicyOnExitCodesRequirement extends StObject {
  ...
  /**
    ...
    */
  var values: Input[js.Array[Input[Double]]]
}
object PodFailurePolicyOnExitCodesRequirement {
  
  inline def apply(operator: Input[String], values: Input[js.Array[Input[Double]]]): PodFailurePolicyOnExitCodesRequirement = {
