...
/**
  ...
  */
trait SELinuxOptionsPatch extends StObject {
...
object SELinuxOptionsPatch {
  
  inline def apply(): SELinuxOptionsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SELinuxOptionsPatch]
  }
  
  extension [Self <: SELinuxOptionsPatch](x: Self) {
