...
trait ISCSIPersistentVolumeSourcePatch extends StObject {
  ...
  /**
    ...
    */
  var iqn: js.UndefOr[Input[String]] = js.undefined
  ...
  /**
    ...
    */
  var targetPortal: js.UndefOr[Input[String]] = js.undefined
}
object ISCSIPersistentVolumeSourcePatch {
  
  inline def apply(): ISCSIPersistentVolumeSourcePatch = {
  ...
  extension [Self <: ISCSIPersistentVolumeSourcePatch](x: Self) {
    ...
    inline def setIqnUndefined: Self = StObject.set(x, "iqn", js.undefined)
    ...
    inline def setTargetPortalUndefined: Self = StObject.set(x, "targetPortal", js.undefined)
  }
}
