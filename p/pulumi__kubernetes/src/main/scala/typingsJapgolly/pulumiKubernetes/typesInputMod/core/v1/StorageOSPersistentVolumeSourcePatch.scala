...
/**
  ...
  */
trait StorageOSPersistentVolumeSourcePatch extends StObject {
  ...
  /**
    ...
    */
  var secretRef: js.UndefOr[Input[ObjectReferencePatch]] = js.undefined
...
object StorageOSPersistentVolumeSourcePatch {
  
  inline def apply(): StorageOSPersistentVolumeSourcePatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StorageOSPersistentVolumeSourcePatch]
  }
  
  extension [Self <: StorageOSPersistentVolumeSourcePatch](x: Self) {
    ...
    inline def setSecretRef(value: Input[ObjectReferencePatch]): Self = StObject.set(x, "secretRef", value.asInstanceOf[js.Any])
