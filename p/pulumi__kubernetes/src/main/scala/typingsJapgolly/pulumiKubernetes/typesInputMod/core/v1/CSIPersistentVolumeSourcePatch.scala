...
trait CSIPersistentVolumeSourcePatch extends StObject {
  ...
  /**
    ...
    */
  var controllerExpandSecretRef: js.UndefOr[Input[SecretReferencePatch]] = js.undefined
  
  /**
    * controllerPublishSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI ControllerPublishVolume and ControllerUnpublishVolume calls. This field is optional, and may be empty if no secret is required. If the secret object contains more than one secret, all secrets are passed.
    */
  var controllerPublishSecretRef: js.UndefOr[Input[SecretReferencePatch]] = js.undefined
  ...
  /**
    ...
    */
  var nodeExpandSecretRef: js.UndefOr[Input[SecretReferencePatch]] = js.undefined
  
  /**
    * nodePublishSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI NodePublishVolume and NodeUnpublishVolume calls. This field is optional, and may be empty if no secret is required. If the secret object contains more than one secret, all secrets are passed.
    */
  var nodePublishSecretRef: js.UndefOr[Input[SecretReferencePatch]] = js.undefined
  
  /**
    * nodeStageSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI NodeStageVolume and NodeStageVolume and NodeUnstageVolume calls. This field is optional, and may be empty if no secret is required. If the secret object contains more than one secret, all secrets are passed.
    */
  var nodeStageSecretRef: js.UndefOr[Input[SecretReferencePatch]] = js.undefined
  ...
  /**
    ...
    */
  var volumeHandle: js.UndefOr[Input[String]] = js.undefined
}
object CSIPersistentVolumeSourcePatch {
  
  inline def apply(): CSIPersistentVolumeSourcePatch = {
  ...
  extension [Self <: CSIPersistentVolumeSourcePatch](x: Self) {
    ...
    inline def setControllerExpandSecretRef(value: Input[SecretReferencePatch]): Self = StObject.set(x, "controllerExpandSecretRef", value.asInstanceOf[js.Any])
    
    inline def setControllerExpandSecretRefUndefined: Self = StObject.set(x, "controllerExpandSecretRef", js.undefined)
    
    inline def setControllerPublishSecretRef(value: Input[SecretReferencePatch]): Self = StObject.set(x, "controllerPublishSecretRef", value.asInstanceOf[js.Any])
    ...
    inline def setNodeExpandSecretRef(value: Input[SecretReferencePatch]): Self = StObject.set(x, "nodeExpandSecretRef", value.asInstanceOf[js.Any])
    
    inline def setNodeExpandSecretRefUndefined: Self = StObject.set(x, "nodeExpandSecretRef", js.undefined)
    
    inline def setNodePublishSecretRef(value: Input[SecretReferencePatch]): Self = StObject.set(x, "nodePublishSecretRef", value.asInstanceOf[js.Any])
    
    inline def setNodePublishSecretRefUndefined: Self = StObject.set(x, "nodePublishSecretRef", js.undefined)
    
    inline def setNodeStageSecretRef(value: Input[SecretReferencePatch]): Self = StObject.set(x, "nodeStageSecretRef", value.asInstanceOf[js.Any])
