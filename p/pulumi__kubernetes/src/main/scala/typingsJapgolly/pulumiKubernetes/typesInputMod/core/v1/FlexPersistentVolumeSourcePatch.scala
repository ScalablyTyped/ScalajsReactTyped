...
/**
  ...
  */
trait FlexPersistentVolumeSourcePatch extends StObject {
...
object FlexPersistentVolumeSourcePatch {
  
  inline def apply(): FlexPersistentVolumeSourcePatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FlexPersistentVolumeSourcePatch]
  }
  
  extension [Self <: FlexPersistentVolumeSourcePatch](x: Self) {
