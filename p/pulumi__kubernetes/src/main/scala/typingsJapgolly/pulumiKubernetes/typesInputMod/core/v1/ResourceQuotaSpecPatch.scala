...
trait ResourceQuotaSpecPatch extends StObject {
  ...
  /**
    ...
    */
  var scopeSelector: js.UndefOr[Input[ScopeSelectorPatch]] = js.undefined
...
object ResourceQuotaSpecPatch {
  ...
  inline def apply(): ResourceQuotaSpecPatch = {
  ...
  extension [Self <: ResourceQuotaSpecPatch](x: Self) {
    ...
    inline def setScopeSelector(value: Input[ScopeSelectorPatch]): Self = StObject.set(x, "scopeSelector", value.asInstanceOf[js.Any])
