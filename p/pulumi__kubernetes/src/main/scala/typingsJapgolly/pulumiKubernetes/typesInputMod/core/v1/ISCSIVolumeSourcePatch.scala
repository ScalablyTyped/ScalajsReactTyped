...
/**
  ...
  */
trait ISCSIVolumeSourcePatch extends StObject {
...
object ISCSIVolumeSourcePatch {
  
  inline def apply(): ISCSIVolumeSourcePatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ISCSIVolumeSourcePatch]
  }
  
  extension [Self <: ISCSIVolumeSourcePatch](x: Self) {
