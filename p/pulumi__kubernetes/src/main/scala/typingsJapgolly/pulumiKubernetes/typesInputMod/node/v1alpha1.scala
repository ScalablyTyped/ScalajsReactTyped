...
object v1alpha1 {
  ...
  object RuntimeClass {
    ...
    inline def apply(spec: Input[RuntimeClassSpec]): RuntimeClass = {
    ...
    extension [Self <: RuntimeClass](x: Self) {
      ...
      inline def setSpec(value: Input[RuntimeClassSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
  ...
  object RuntimeClassSpec {
    ...
    inline def apply(runtimeHandler: Input[String]): RuntimeClassSpec = {
    ...
    extension [Self <: RuntimeClassSpec](x: Self) {
      ...
      inline def setRuntimeHandler(value: Input[String]): Self = StObject.set(x, "runtimeHandler", value.asInstanceOf[js.Any])
  ...
  trait RuntimeClassSpecPatch extends StObject {
    ...
    /**
      * Overhead represents the resource overhead associated with running a pod for a given RuntimeClass. For more details, see https://git.k8s.io/enhancements/keps/sig-node/20190226-pod-overhead.md This field is alpha-level as of Kubernetes v1.15, and is only honored by servers that enable the PodOverhead feature.
      */
    var overhead: js.UndefOr[Input[OverheadPatch]] = js.undefined
    
    /**
      * RuntimeHandler specifies the underlying runtime and configuration that the CRI implementation will use to handle pods of this class. The possible values are specific to the node & CRI configuration.  It is assumed that all handlers are available on every node, and handlers of the same name are equivalent on every node. For example, a handler called "runc" might specify that the runc OCI runtime (using native Linux containers) will be used to run the containers in a pod. The RuntimeHandler must conform to the DNS Label (RFC 1123) requirements and is immutable.
      */
    var runtimeHandler: js.UndefOr[Input[String]] = js.undefined
    
    /**
      * Scheduling holds the scheduling constraints to ensure that pods running with this RuntimeClass are scheduled to nodes that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes.
      */
    var scheduling: js.UndefOr[Input[SchedulingPatch]] = js.undefined
  }
  object RuntimeClassSpecPatch {
    
    inline def apply(): RuntimeClassSpecPatch = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: RuntimeClassSpecPatch](x: Self) {
      ...
      inline def setOverhead(value: Input[OverheadPatch]): Self = StObject.set(x, "overhead", value.asInstanceOf[js.Any])
      
      inline def setOverheadUndefined: Self = StObject.set(x, "overhead", js.undefined)
      
      inline def setRuntimeHandler(value: Input[String]): Self = StObject.set(x, "runtimeHandler", value.asInstanceOf[js.Any])
      
      inline def setRuntimeHandlerUndefined: Self = StObject.set(x, "runtimeHandler", js.undefined)
      
      inline def setScheduling(value: Input[SchedulingPatch]): Self = StObject.set(x, "scheduling", value.asInstanceOf[js.Any])
