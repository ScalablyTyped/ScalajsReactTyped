...
trait Namespace extends StObject {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Namespace]] = js.undefined
...
object Namespace {
  ...
  extension [Self <: Namespace](x: Self) {
    ...
    inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Namespace]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
