...
object ObjectMeta {
  ...
  extension [Self <: ObjectMeta](x: Self) {
    ...
    inline def setManagedFieldsVarargs(value: Input[ManagedFieldsEntry]*): Self = StObject.set(x, "managedFields", js.Array(value*))
    ...
    inline def setOwnerReferencesVarargs(value: Input[OwnerReference]*): Self = StObject.set(x, "ownerReferences", js.Array(value*))
