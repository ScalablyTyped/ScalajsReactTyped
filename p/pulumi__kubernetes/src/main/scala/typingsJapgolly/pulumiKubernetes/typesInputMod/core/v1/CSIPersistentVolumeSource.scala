...
trait CSIPersistentVolumeSource extends StObject {
  ...
  /**
    ...
    */
  var nodeExpandSecretRef: js.UndefOr[Input[SecretReference]] = js.undefined
...
object CSIPersistentVolumeSource {
  ...
  extension [Self <: CSIPersistentVolumeSource](x: Self) {
    ...
    inline def setNodeExpandSecretRef(value: Input[SecretReference]): Self = StObject.set(x, "nodeExpandSecretRef", value.asInstanceOf[js.Any])
    
    inline def setNodeExpandSecretRefUndefined: Self = StObject.set(x, "nodeExpandSecretRef", js.undefined)
