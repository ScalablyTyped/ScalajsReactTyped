...
object PodStatus {
  ...
  extension [Self <: PodStatus](x: Self) {
    ...
    inline def setConditionsVarargs(value: Input[PodCondition]*): Self = StObject.set(x, "conditions", js.Array(value*))
    ...
    inline def setContainerStatusesVarargs(value: Input[ContainerStatus]*): Self = StObject.set(x, "containerStatuses", js.Array(value*))
    ...
    inline def setEphemeralContainerStatusesVarargs(value: Input[ContainerStatus]*): Self = StObject.set(x, "ephemeralContainerStatuses", js.Array(value*))
    ...
    inline def setInitContainerStatusesVarargs(value: Input[ContainerStatus]*): Self = StObject.set(x, "initContainerStatuses", js.Array(value*))
    ...
    inline def setPodIPsVarargs(value: Input[PodIP]*): Self = StObject.set(x, "podIPs", js.Array(value*))
