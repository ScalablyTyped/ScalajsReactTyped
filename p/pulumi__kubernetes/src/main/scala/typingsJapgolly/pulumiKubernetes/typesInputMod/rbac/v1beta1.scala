package typingsJapgolly.pulumiKubernetes.typesInputMod.rbac
...
object v1beta1 {
  ...
  object AggregationRule {
    ...
    extension [Self <: AggregationRule](x: Self) {
      ...
      inline def setClusterRoleSelectorsVarargs(value: Input[LabelSelector]*): Self = StObject.set(x, "clusterRoleSelectors", js.Array(value*))
    }
  }
  ...
  trait AggregationRulePatch extends StObject {
    ...
    /**
      * ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added
      */
    var clusterRoleSelectors: js.UndefOr[Input[js.Array[Input[LabelSelectorPatch]]]] = js.undefined
  }
  object AggregationRulePatch {
    
    inline def apply(): AggregationRulePatch = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: AggregationRulePatch](x: Self) {
      ...
      inline def setClusterRoleSelectors(value: Input[js.Array[Input[LabelSelectorPatch]]]): Self = StObject.set(x, "clusterRoleSelectors", value.asInstanceOf[js.Any])
      
      inline def setClusterRoleSelectorsUndefined: Self = StObject.set(x, "clusterRoleSelectors", js.undefined)
      
      inline def setClusterRoleSelectorsVarargs(value: Input[LabelSelectorPatch]*): Self = StObject.set(x, "clusterRoleSelectors", js.Array(value*))
    }
  }
  ...
  object ClusterRole {
    ...
    extension [Self <: ClusterRole](x: Self) {
      ...
      inline def setRulesVarargs(value: Input[PolicyRule]*): Self = StObject.set(x, "rules", js.Array(value*))
    }
  }
  ...
  object PolicyRule {
    ...
    extension [Self <: PolicyRule](x: Self) {
      ...
      inline def setResourceNamesVarargs(value: Input[String]*): Self = StObject.set(x, "resourceNames", js.Array(value*))
  ...
  object PolicyRulePatch {
    ...
    inline def apply(): PolicyRulePatch = {
      val __obj = js.Dynamic.literal()
