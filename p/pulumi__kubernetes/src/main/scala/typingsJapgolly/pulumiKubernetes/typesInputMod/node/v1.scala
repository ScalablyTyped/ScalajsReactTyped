...
object v1 {
  ...
  trait RuntimeClass extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: js.UndefOr[Input[nodeDotk8sDotioSlashv1]] = js.undefined
  ...
  object RuntimeClass {
    ...
    extension [Self <: RuntimeClass](x: Self) {
      ...
      inline def setApiVersion(value: Input[nodeDotk8sDotioSlashv1]): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
