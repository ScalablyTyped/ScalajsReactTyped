...
object EndpointSubset {
  ...
  extension [Self <: EndpointSubset](x: Self) {
    ...
    inline def setAddressesVarargs(value: Input[EndpointAddress]*): Self = StObject.set(x, "addresses", js.Array(value*))
    ...
    inline def setNotReadyAddressesVarargs(value: Input[EndpointAddress]*): Self = StObject.set(x, "notReadyAddresses", js.Array(value*))
