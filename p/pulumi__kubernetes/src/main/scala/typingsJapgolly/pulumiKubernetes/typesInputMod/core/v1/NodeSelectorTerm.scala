...
object NodeSelectorTerm {
  ...
  extension [Self <: NodeSelectorTerm](x: Self) {
    ...
    inline def setMatchExpressionsVarargs(value: Input[NodeSelectorRequirement]*): Self = StObject.set(x, "matchExpressions", js.Array(value*))
    ...
    inline def setMatchFieldsVarargs(value: Input[NodeSelectorRequirement]*): Self = StObject.set(x, "matchFields", js.Array(value*))
  }
}
