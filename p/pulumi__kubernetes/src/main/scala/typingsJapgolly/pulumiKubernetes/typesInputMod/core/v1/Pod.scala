...
trait Pod extends StObject {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Pod]] = js.undefined
...
object Pod {
  ...
  extension [Self <: Pod](x: Self) {
    ...
    inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Pod]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
