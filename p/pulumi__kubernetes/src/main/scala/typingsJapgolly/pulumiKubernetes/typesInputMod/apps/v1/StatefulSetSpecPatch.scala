...
trait StatefulSetSpecPatch extends StObject {
  ...
  /**
    ...
    */
  var persistentVolumeClaimRetentionPolicy: js.UndefOr[Input[StatefulSetPersistentVolumeClaimRetentionPolicyPatch]] = js.undefined
...
object StatefulSetSpecPatch {
  ...
  extension [Self <: StatefulSetSpecPatch](x: Self) {
    ...
    inline def setPersistentVolumeClaimRetentionPolicy(value: Input[StatefulSetPersistentVolumeClaimRetentionPolicyPatch]): Self = StObject.set(x, "persistentVolumeClaimRetentionPolicy", value.asInstanceOf[js.Any])
