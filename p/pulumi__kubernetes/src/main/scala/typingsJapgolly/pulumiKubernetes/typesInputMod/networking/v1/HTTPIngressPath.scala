...
trait HTTPIngressPath extends StObject {
  ...
  /**
    ...
    */
  var pathType: Input[String]
}
object HTTPIngressPath {
  
  inline def apply(backend: Input[IngressBackend], pathType: Input[String]): HTTPIngressPath = {
    val __obj = js.Dynamic.literal(backend = backend.asInstanceOf[js.Any], pathType = pathType.asInstanceOf[js.Any])
