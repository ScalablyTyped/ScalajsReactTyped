...
/**
  ...
  */
trait PersistentVolumeClaimSpecPatch extends StObject {
  ...
  /**
    ...
    */
  var dataSource: js.UndefOr[Input[TypedLocalObjectReferencePatch]] = js.undefined
  ...
  /**
    ...
    */
  var dataSourceRef: js.UndefOr[Input[TypedLocalObjectReferencePatch]] = js.undefined
...
object PersistentVolumeClaimSpecPatch {
  
  inline def apply(): PersistentVolumeClaimSpecPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PersistentVolumeClaimSpecPatch]
  }
  
  extension [Self <: PersistentVolumeClaimSpecPatch](x: Self) {
    ...
    inline def setDataSource(value: Input[TypedLocalObjectReferencePatch]): Self = StObject.set(x, "dataSource", value.asInstanceOf[js.Any])
    
    inline def setDataSourceRef(value: Input[TypedLocalObjectReferencePatch]): Self = StObject.set(x, "dataSourceRef", value.asInstanceOf[js.Any])
