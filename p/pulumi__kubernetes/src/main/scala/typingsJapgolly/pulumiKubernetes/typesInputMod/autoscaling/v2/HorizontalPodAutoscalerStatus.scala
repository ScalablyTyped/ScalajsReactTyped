...
trait HorizontalPodAutoscalerStatus extends StObject {
  ...
  /**
    ...
    */
  var conditions: js.UndefOr[Input[js.Array[Input[HorizontalPodAutoscalerCondition]]]] = js.undefined
...
object HorizontalPodAutoscalerStatus {
  ...
  inline def apply(desiredReplicas: Input[Double]): HorizontalPodAutoscalerStatus = {
    val __obj = js.Dynamic.literal(desiredReplicas = desiredReplicas.asInstanceOf[js.Any])
  ...
  extension [Self <: HorizontalPodAutoscalerStatus](x: Self) {
    ...
    inline def setConditionsVarargs(value: Input[HorizontalPodAutoscalerCondition]*): Self = StObject.set(x, "conditions", js.Array(value*))
    ...
    inline def setCurrentMetricsVarargs(value: Input[MetricStatus]*): Self = StObject.set(x, "currentMetrics", js.Array(value*))
