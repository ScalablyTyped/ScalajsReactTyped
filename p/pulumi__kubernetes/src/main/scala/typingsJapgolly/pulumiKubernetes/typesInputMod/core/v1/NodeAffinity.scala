...
object NodeAffinity {
  ...
  extension [Self <: NodeAffinity](x: Self) {
    ...
    inline def setPreferredDuringSchedulingIgnoredDuringExecutionVarargs(value: Input[PreferredSchedulingTerm]*): Self = StObject.set(x, "preferredDuringSchedulingIgnoredDuringExecution", js.Array(value*))
