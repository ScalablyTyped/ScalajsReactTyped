...
trait PodDNSConfigPatch extends StObject {
  ...
  /**
    ...
    */
  var options: js.UndefOr[Input[js.Array[Input[PodDNSConfigOptionPatch]]]] = js.undefined
...
object PodDNSConfigPatch {
  ...
  inline def apply(): PodDNSConfigPatch = {
  ...
  extension [Self <: PodDNSConfigPatch](x: Self) {
    ...
    inline def setOptions(value: Input[js.Array[Input[PodDNSConfigOptionPatch]]]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    
    inline def setOptionsUndefined: Self = StObject.set(x, "options", js.undefined)
    
    inline def setOptionsVarargs(value: Input[PodDNSConfigOptionPatch]*): Self = StObject.set(x, "options", js.Array(value*))
