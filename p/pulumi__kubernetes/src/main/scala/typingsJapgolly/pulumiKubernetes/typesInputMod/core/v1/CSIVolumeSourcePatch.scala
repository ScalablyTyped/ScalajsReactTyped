...
trait CSIVolumeSourcePatch extends StObject {
  ...
  /**
    ...
    */
  var nodePublishSecretRef: js.UndefOr[Input[LocalObjectReferencePatch]] = js.undefined
...
object CSIVolumeSourcePatch {
  ...
  inline def apply(): CSIVolumeSourcePatch = {
  ...
  extension [Self <: CSIVolumeSourcePatch](x: Self) {
    ...
    inline def setNodePublishSecretRef(value: Input[LocalObjectReferencePatch]): Self = StObject.set(x, "nodePublishSecretRef", value.asInstanceOf[js.Any])
