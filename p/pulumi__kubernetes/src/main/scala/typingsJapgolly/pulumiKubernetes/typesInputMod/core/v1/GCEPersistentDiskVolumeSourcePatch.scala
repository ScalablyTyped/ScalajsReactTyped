...
trait GCEPersistentDiskVolumeSourcePatch extends StObject {
  ...
  /**
    ...
    */
  var pdName: js.UndefOr[Input[String]] = js.undefined
...
object GCEPersistentDiskVolumeSourcePatch {
  ...
  inline def apply(): GCEPersistentDiskVolumeSourcePatch = {
  ...
  extension [Self <: GCEPersistentDiskVolumeSourcePatch](x: Self) {
    ...
    inline def setPdNameUndefined: Self = StObject.set(x, "pdName", js.undefined)
