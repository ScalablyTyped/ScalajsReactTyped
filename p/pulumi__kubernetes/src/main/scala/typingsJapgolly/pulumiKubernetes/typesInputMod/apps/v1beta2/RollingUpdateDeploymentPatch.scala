...
/**
  ...
  */
trait RollingUpdateDeploymentPatch extends StObject {
...
object RollingUpdateDeploymentPatch {
  
  inline def apply(): RollingUpdateDeploymentPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RollingUpdateDeploymentPatch]
  }
  
  extension [Self <: RollingUpdateDeploymentPatch](x: Self) {
