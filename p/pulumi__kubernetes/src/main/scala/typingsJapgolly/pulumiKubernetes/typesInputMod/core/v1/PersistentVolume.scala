...
object PersistentVolume {
  ...
  inline def apply(): PersistentVolume = {
  ...
  extension [Self <: PersistentVolume](x: Self) {
    ...
    inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolume]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    ...
    inline def setSpec(value: Input[PersistentVolumeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    
    inline def setSpecUndefined: Self = StObject.set(x, "spec", js.undefined)
    
    inline def setStatus(value: Input[PersistentVolumeStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
