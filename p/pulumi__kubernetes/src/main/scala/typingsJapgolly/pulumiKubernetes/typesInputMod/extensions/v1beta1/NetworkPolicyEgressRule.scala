...
object NetworkPolicyEgressRule {
  ...
  extension [Self <: NetworkPolicyEgressRule](x: Self) {
    ...
    inline def setPortsVarargs(value: Input[NetworkPolicyPort]*): Self = StObject.set(x, "ports", js.Array(value*))
    ...
    inline def setToVarargs(value: Input[NetworkPolicyPeer]*): Self = StObject.set(x, "to", js.Array(value*))
  }
}
