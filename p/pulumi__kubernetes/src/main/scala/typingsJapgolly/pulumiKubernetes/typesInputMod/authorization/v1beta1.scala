package typingsJapgolly.pulumiKubernetes.typesInputMod.authorization
...
object v1beta1 {
  ...
  object NonResourceAttributesPatch {
    ...
    inline def apply(): NonResourceAttributesPatch = {
      val __obj = js.Dynamic.literal()
  ...
  object ResourceAttributesPatch {
    ...
    inline def apply(): ResourceAttributesPatch = {
      val __obj = js.Dynamic.literal()
  ...
  trait SelfSubjectAccessReviewSpecPatch extends StObject {
    ...
    /**
      * NonResourceAttributes describes information for a non-resource access request
      */
    var nonResourceAttributes: js.UndefOr[Input[NonResourceAttributesPatch]] = js.undefined
    
    /**
      * ResourceAuthorizationAttributes describes information for a resource access request
      */
    var resourceAttributes: js.UndefOr[Input[ResourceAttributesPatch]] = js.undefined
  }
  object SelfSubjectAccessReviewSpecPatch {
    
    inline def apply(): SelfSubjectAccessReviewSpecPatch = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: SelfSubjectAccessReviewSpecPatch](x: Self) {
      ...
      inline def setNonResourceAttributes(value: Input[NonResourceAttributesPatch]): Self = StObject.set(x, "nonResourceAttributes", value.asInstanceOf[js.Any])
      
      inline def setNonResourceAttributesUndefined: Self = StObject.set(x, "nonResourceAttributes", js.undefined)
      
      inline def setResourceAttributes(value: Input[ResourceAttributesPatch]): Self = StObject.set(x, "resourceAttributes", value.asInstanceOf[js.Any])
  ...
  object SelfSubjectRulesReviewSpecPatch {
    ...
    inline def apply(): SelfSubjectRulesReviewSpecPatch = {
      val __obj = js.Dynamic.literal()
  ...
  object SubjectAccessReviewSpec {
    ...
    extension [Self <: SubjectAccessReviewSpec](x: Self) {
      ...
      inline def setGroupVarargs(value: Input[String]*): Self = StObject.set(x, "group", js.Array(value*))
  ...
  /**
    * SubjectAccessReviewSpec is a description of the access request.  Exactly one of ResourceAuthorizationAttributes and NonResourceAuthorizationAttributes must be set
    */
  trait SubjectAccessReviewSpecPatch extends StObject {
  ...
  object SubjectAccessReviewSpecPatch {
    
    inline def apply(): SubjectAccessReviewSpecPatch = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SubjectAccessReviewSpecPatch]
    }
    
    extension [Self <: SubjectAccessReviewSpecPatch](x: Self) {
