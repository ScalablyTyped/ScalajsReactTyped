...
/**
  ...
  */
trait ReplicationControllerSpecPatch extends StObject {
...
object ReplicationControllerSpecPatch {
  
  inline def apply(): ReplicationControllerSpecPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReplicationControllerSpecPatch]
  }
  
  extension [Self <: ReplicationControllerSpecPatch](x: Self) {
