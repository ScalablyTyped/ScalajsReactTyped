...
object PodTemplate {
  ...
  extension [Self <: PodTemplate](x: Self) {
    ...
    inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodTemplate]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
