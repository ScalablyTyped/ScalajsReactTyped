...
object NetworkPolicySpec {
  ...
  extension [Self <: NetworkPolicySpec](x: Self) {
    ...
    inline def setEgressVarargs(value: Input[NetworkPolicyEgressRule]*): Self = StObject.set(x, "egress", js.Array(value*))
    ...
    inline def setIngressVarargs(value: Input[NetworkPolicyIngressRule]*): Self = StObject.set(x, "ingress", js.Array(value*))
