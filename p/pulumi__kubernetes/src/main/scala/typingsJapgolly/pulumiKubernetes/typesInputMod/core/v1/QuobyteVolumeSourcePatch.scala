...
/**
  ...
  */
trait QuobyteVolumeSourcePatch extends StObject {
  ...
  /**
    ...
    */
  var registry: js.UndefOr[Input[String]] = js.undefined
  ...
  /**
    ...
    */
  var volume: js.UndefOr[Input[String]] = js.undefined
}
object QuobyteVolumeSourcePatch {
  
  inline def apply(): QuobyteVolumeSourcePatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[QuobyteVolumeSourcePatch]
  }
  
  extension [Self <: QuobyteVolumeSourcePatch](x: Self) {
