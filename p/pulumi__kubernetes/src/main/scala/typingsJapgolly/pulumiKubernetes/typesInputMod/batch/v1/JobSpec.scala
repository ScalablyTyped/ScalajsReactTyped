...
trait JobSpec extends StObject {
  ...
  /**
    ...
    */
  var podFailurePolicy: js.UndefOr[Input[PodFailurePolicy]] = js.undefined
...
object JobSpec {
  ...
  extension [Self <: JobSpec](x: Self) {
    ...
    inline def setPodFailurePolicy(value: Input[PodFailurePolicy]): Self = StObject.set(x, "podFailurePolicy", value.asInstanceOf[js.Any])
