...
trait ReplicationController extends StObject {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ReplicationController]
  ] = js.undefined
...
object ReplicationController {
  ...
  inline def apply(): ReplicationController = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReplicationController]
  }
  
  extension [Self <: ReplicationController](x: Self) {
    ...
    inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ReplicationController]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    ...
    inline def setSpec(value: Input[ReplicationControllerSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    
    inline def setSpecUndefined: Self = StObject.set(x, "spec", js.undefined)
    
    inline def setStatus(value: Input[ReplicationControllerStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
