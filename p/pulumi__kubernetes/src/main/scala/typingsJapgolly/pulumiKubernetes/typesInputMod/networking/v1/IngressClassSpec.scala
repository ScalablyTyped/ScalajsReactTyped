...
trait IngressClassSpec extends StObject {
  ...
  /**
    ...
    */
  var parameters: js.UndefOr[Input[IngressClassParametersReference]] = js.undefined
}
object IngressClassSpec {
  ...
  extension [Self <: IngressClassSpec](x: Self) {
    ...
    inline def setParameters(value: Input[IngressClassParametersReference]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
