...
object CustomResourceDefinitionStatus {
  ...
  extension [Self <: CustomResourceDefinitionStatus](x: Self) {
    ...
    inline def setConditionsVarargs(value: Input[CustomResourceDefinitionCondition]*): Self = StObject.set(x, "conditions", js.Array(value*))
    ...
    inline def setStoredVersionsVarargs(value: Input[String]*): Self = StObject.set(x, "storedVersions", js.Array(value*))
  }
}
