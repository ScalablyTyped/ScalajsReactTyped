...
trait CSINodeDriverPatch extends StObject {
  ...
  /**
    ...
    */
  var allocatable: js.UndefOr[Input[VolumeNodeResourcesPatch]] = js.undefined
  ...
  /**
    ...
    */
  var nodeID: js.UndefOr[Input[String]] = js.undefined
...
object CSINodeDriverPatch {
  ...
  inline def apply(): CSINodeDriverPatch = {
  ...
  extension [Self <: CSINodeDriverPatch](x: Self) {
    ...
    inline def setAllocatable(value: Input[VolumeNodeResourcesPatch]): Self = StObject.set(x, "allocatable", value.asInstanceOf[js.Any])
