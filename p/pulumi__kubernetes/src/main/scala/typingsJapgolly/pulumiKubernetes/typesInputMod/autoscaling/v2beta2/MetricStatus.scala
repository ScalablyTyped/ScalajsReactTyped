...
trait MetricStatus extends StObject {
  ...
  /**
    ...
    */
  var containerResource: js.UndefOr[Input[ContainerResourceMetricStatus]] = js.undefined
...
object MetricStatus {
  ...
  extension [Self <: MetricStatus](x: Self) {
    ...
    inline def setContainerResource(value: Input[ContainerResourceMetricStatus]): Self = StObject.set(x, "containerResource", value.asInstanceOf[js.Any])
