...
@JSImport("@pulumi/kubernetes/core/v1/ResourceQuota", JSImport.Namespace)
@js.native
object resourceQuotaMod extends js.Object {
  @js.native
  class ResourceQuota protected () extends CustomResource {
    ...
    def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ResourceQuota) = this()
    def this(
      name: String,
      args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ResourceQuota,
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota] = js.native
    /**
