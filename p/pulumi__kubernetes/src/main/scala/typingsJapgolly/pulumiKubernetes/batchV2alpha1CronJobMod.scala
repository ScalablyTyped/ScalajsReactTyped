...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.batch.v2alpha1.CronJobSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.batch.v2alpha1.CronJobStatus
...
object batchV2alpha1CronJobMod {
  
  @JSImport("@pulumi/kubernetes/batch/v2alpha1/cronJob", "CronJob")
  @js.native
  open class CronJob protected () extends CustomResource {
    /**
  ...
  object CronJob {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/batch/v2alpha1/cronJob.CronJob */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/batch/v2alpha1/cronJob.CronJob */ Boolean]
  }
  ...
  trait CronJobArgs extends StObject {
    ...
    /**
      * Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    var spec: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.batch.v2alpha1.CronJobSpec]] = js.undefined
  }
  object CronJobArgs {
    ...
    extension [Self <: CronJobArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.batch.v2alpha1.CronJobSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
