...
import typingsJapgolly.pulumiKubernetes.outputMod.storage.v1beta1.VolumeAttachmentSpec
import typingsJapgolly.pulumiKubernetes.outputMod.storage.v1beta1.VolumeAttachmentStatus
