...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.admissionregistration.v1beta1.MutatingWebhook
...
object admissionregistrationV1beta1MutatingWebhookConfigurationMod {
  
  @JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/mutatingWebhookConfiguration", "MutatingWebhookConfiguration")
  @js.native
  open class MutatingWebhookConfiguration protected () extends CustomResource {
    /**
  ...
  trait MutatingWebhookConfigurationArgs extends StObject {
    ...
    var webhooks: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsJapgolly.pulumiKubernetes.typesInputMod.admissionregistration.v1beta1.MutatingWebhook
            ]
          ]
        ]
      ] = js.undefined
