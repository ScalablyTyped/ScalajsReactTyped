...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.rbac.v1beta1.Role
...
object rbacV1beta1RoleListMod {
  ...
  object RoleList {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1beta1/roleList.RoleList */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1beta1/roleList.RoleList */ Boolean]
  }
  ...
  trait RoleListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1beta1.Role]]
      ]
  ...
  object RoleListArgs {
    ...
    extension [Self <: RoleListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1beta1.Role]*): Self = StObject.set(x, "items", js.Array(value*))
