...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.policy.v1beta1.PodSecurityPolicySpecPatch
...
object policyV1beta1PodSecurityPolicyPatchMod {
  
  @JSImport("@pulumi/kubernetes/policy/v1beta1/podSecurityPolicyPatch", "PodSecurityPolicyPatch")
  @js.native
  ...
  object PodSecurityPolicyPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/policy/v1beta1/podSecurityPolicyPatch.PodSecurityPolicyPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/policy/v1beta1/podSecurityPolicyPatch.PodSecurityPolicyPatch */ Boolean]
  }
  ...
  trait PodSecurityPolicyPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.policy.v1beta1.PodSecurityPolicySpecPatch
        ]
      ] = js.undefined
  }
