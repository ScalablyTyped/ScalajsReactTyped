...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.DeploymentSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.DeploymentStatus
...
object appsV1beta2DeploymentMod {
  ...
  object Deployment {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/deployment.Deployment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/deployment.Deployment */ Boolean]
  }
  ...
  trait DeploymentArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.DeploymentSpec]
      ] = js.undefined
  }
  object DeploymentArgs {
    ...
    extension [Self <: DeploymentArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.DeploymentSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
