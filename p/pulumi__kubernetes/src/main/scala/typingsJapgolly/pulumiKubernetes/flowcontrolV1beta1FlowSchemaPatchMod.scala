...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1beta1.FlowSchemaSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1beta1.FlowSchemaStatusPatch
...
object flowcontrolV1beta1FlowSchemaPatchMod {
  
  @JSImport("@pulumi/kubernetes/flowcontrol/v1beta1/flowSchemaPatch", "FlowSchemaPatch")
  @js.native
  ...
  object FlowSchemaPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/flowcontrol/v1beta1/flowSchemaPatch.FlowSchemaPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/flowcontrol/v1beta1/flowSchemaPatch.FlowSchemaPatch */ Boolean]
  }
  ...
  trait FlowSchemaPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.flowcontrol.v1beta1.FlowSchemaSpecPatch
        ]
      ] = js.undefined
  }
