...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1alpha1.PriorityLevelConfigurationSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1alpha1.PriorityLevelConfigurationStatusPatch
...
object flowcontrolV1alpha1PriorityLevelConfigurationPatchMod {
  
  @JSImport("@pulumi/kubernetes/flowcontrol/v1alpha1/priorityLevelConfigurationPatch", "PriorityLevelConfigurationPatch")
  @js.native
  ...
  trait PriorityLevelConfigurationPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.flowcontrol.v1alpha1.PriorityLevelConfigurationSpecPatch
        ]
      ] = js.undefined
  }
