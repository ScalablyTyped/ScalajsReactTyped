...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.rbac.v1alpha1.AggregationRule
...
object rbacV1alpha1ClusterRoleMod {
  ...
  trait ClusterRoleArgs extends StObject {
    ...
    var aggregationRule: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.AggregationRule]
      ] = js.undefined
  ...
  object ClusterRoleArgs {
    ...
    extension [Self <: ClusterRoleArgs](x: Self) {
      ...
      inline def setAggregationRule(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.AggregationRule]): Self = StObject.set(x, "aggregationRule", value.asInstanceOf[js.Any])
