...
object settingsV1alpha1PodPresetMod {
  
  @JSImport("@pulumi/kubernetes/settings/v1alpha1/podPreset", "PodPreset")
  @js.native
  open class PodPreset protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodPreset] = js.native
  ...
  object PodPreset {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): PodPreset = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[PodPreset]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): PodPreset = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PodPreset]
  ...
  trait PodPresetArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.settings.v1alpha1.PodPresetSpec]
      ] = js.undefined
  }
  object PodPresetArgs {
    
    inline def apply(): PodPresetArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PodPresetArgs]
    }
    
    extension [Self <: PodPresetArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.settings.v1alpha1.PodPresetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
