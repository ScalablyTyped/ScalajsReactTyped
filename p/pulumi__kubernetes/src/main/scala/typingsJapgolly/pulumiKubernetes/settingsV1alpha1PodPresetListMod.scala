...
object settingsV1alpha1PodPresetListMod {
  
  @JSImport("@pulumi/kubernetes/settings/v1alpha1/podPresetList", "PodPresetList")
  @js.native
  open class PodPresetList protected () extends CustomResource {
    /**
  ...
  trait PodPresetListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.settings.v1alpha1.PodPreset]
        ]
      ]
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodPresetList]] = js.undefined
  ...
  object PodPresetListArgs {
    ...
    extension [Self <: PodPresetListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.settings.v1alpha1.PodPreset]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodPresetList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
