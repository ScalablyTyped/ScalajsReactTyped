...
object rbacV1alpha1ClusterRoleBindingMod {
  ...
  object ClusterRoleBindingArgs {
    ...
    inline def apply(roleRef: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.RoleRef]): ClusterRoleBindingArgs = {
