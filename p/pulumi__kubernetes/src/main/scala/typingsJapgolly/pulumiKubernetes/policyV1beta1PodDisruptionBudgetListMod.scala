...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.policy.v1beta1.PodDisruptionBudget
...
object policyV1beta1PodDisruptionBudgetListMod {
  
  @JSImport("@pulumi/kubernetes/policy/v1beta1/podDisruptionBudgetList", "PodDisruptionBudgetList")
  @js.native
  open class PodDisruptionBudgetList protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudgetList] = js.native
  ...
  trait PodDisruptionBudgetListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[
            typingsJapgolly.pulumiKubernetes.typesInputMod.policy.v1beta1.PodDisruptionBudget
          ]
        ]
      ]
  ...
  object PodDisruptionBudgetListArgs {
    ...
    extension [Self <: PodDisruptionBudgetListArgs](x: Self) {
      ...
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudgetList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
