...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta1.ControllerRevision
...
object appsV1beta1ControllerRevisionListMod {
  ...
  trait ControllerRevisionListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta1.ControllerRevision]
        ]
      ]
  ...
  object ControllerRevisionListArgs {
    ...
    extension [Self <: ControllerRevisionListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta1.ControllerRevision]*): Self = StObject.set(x, "items", js.Array(value*))
