...
@JSImport("@pulumi/kubernetes/core/v1/EndpointsList", JSImport.Namespace)
@js.native
object endpointsListMod extends js.Object {
  @js.native
  class EndpointsList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.EndpointsList] = js.native
    /**
