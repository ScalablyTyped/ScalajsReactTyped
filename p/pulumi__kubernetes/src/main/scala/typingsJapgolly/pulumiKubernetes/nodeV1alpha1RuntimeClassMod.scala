...
object nodeV1alpha1RuntimeClassMod {
  ...
  trait RuntimeClassArgs extends StObject {
    ...
    /**
      * Specification of the RuntimeClass More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    var spec: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.node.v1alpha1.RuntimeClassSpec]
  }
  object RuntimeClassArgs {
    
    inline def apply(spec: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.node.v1alpha1.RuntimeClassSpec]): RuntimeClassArgs = {
    ...
    extension [Self <: RuntimeClassArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.node.v1alpha1.RuntimeClassSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
