...
class NetworkPolicyList protected ()
  extends typingsJapgolly.pulumiKubernetes.networkPolicyListMod.NetworkPolicyList {
  /**
...
object NetworkPolicyList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.networkPolicyListMod.NetworkPolicyList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.networkPolicyListMod.NetworkPolicyList = js.native
  /**
