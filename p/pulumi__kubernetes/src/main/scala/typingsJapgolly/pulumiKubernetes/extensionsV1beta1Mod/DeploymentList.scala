...
class DeploymentList protected ()
  extends typingsJapgolly.pulumiKubernetes.v1beta1DeploymentListMod.DeploymentList {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.extensions.v1beta1.DeploymentList) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.extensions.v1beta1.DeploymentList,
...
object DeploymentList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.v1beta1DeploymentListMod.DeploymentList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.v1beta1DeploymentListMod.DeploymentList = js.native
  /**
