...
object storageV1beta1CsistorageCapacityMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1beta1/csistorageCapacity", "CSIStorageCapacity")
  @js.native
  open class CSIStorageCapacity protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIStorageCapacity] = js.native
    ...
    /**
      ...
      */
    val nodeTopology: Output_[LabelSelector] = js.native
  ...
  object CSIStorageCapacity {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): CSIStorageCapacity = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[CSIStorageCapacity]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): CSIStorageCapacity = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[CSIStorageCapacity]
  ...
  trait CSIStorageCapacityArgs extends StObject {
    ...
    /**
      * NodeTopology defines which nodes have access to the storage for which capacity was reported. If not set, the storage is not accessible from any node in the cluster. If empty, the storage is accessible from all nodes. This field is immutable.
      */
    var nodeTopology: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.meta.v1.LabelSelector]] = js.undefined
  ...
  object CSIStorageCapacityArgs {
    
    inline def apply(storageClassName: Input[String]): CSIStorageCapacityArgs = {
      val __obj = js.Dynamic.literal(storageClassName = storageClassName.asInstanceOf[js.Any])
      __obj.asInstanceOf[CSIStorageCapacityArgs]
    }
    
    extension [Self <: CSIStorageCapacityArgs](x: Self) {
      ...
      inline def setNodeTopology(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.meta.v1.LabelSelector]): Self = StObject.set(x, "nodeTopology", value.asInstanceOf[js.Any])
