...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1beta1.CSIDriverSpec
...
object storageV1beta1CsidriverMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1beta1/csidriver", "CSIDriver")
  @js.native
  open class CSIDriver protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIDriver] = js.native
  ...
  trait CSIDriverArgs extends StObject {
    ...
    /**
      * Specification of the CSI Driver.
      */
    var spec: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSIDriverSpec]
  }
  object CSIDriverArgs {
    
    inline def apply(spec: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSIDriverSpec]): CSIDriverArgs = {
    ...
    extension [Self <: CSIDriverArgs](x: Self) {
      ...
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIDriver]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSIDriverSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
