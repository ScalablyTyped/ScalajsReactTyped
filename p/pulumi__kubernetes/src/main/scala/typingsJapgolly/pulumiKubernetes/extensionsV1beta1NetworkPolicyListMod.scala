...
object extensionsV1beta1NetworkPolicyListMod {
  
  @JSImport("@pulumi/kubernetes/extensions/v1beta1/networkPolicyList", "NetworkPolicyList")
  @js.native
  open class NetworkPolicyList protected () extends CustomResource {
    /**
  ...
  trait NetworkPolicyListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.NetworkPolicy]
        ]
      ]
  ...
  object NetworkPolicyListArgs {
    ...
    extension [Self <: NetworkPolicyListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.NetworkPolicy]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
