...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1beta1.VolumeAttachmentSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1beta1.VolumeAttachmentStatus
...
object storageV1beta1VolumeAttachmentMod {
  ...
  object VolumeAttachment {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/storage/v1beta1/volumeAttachment.VolumeAttachment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/storage/v1beta1/volumeAttachment.VolumeAttachment */ Boolean]
  }
  ...
  trait VolumeAttachmentArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: Input[
        typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.VolumeAttachmentSpec
      ]
  }
