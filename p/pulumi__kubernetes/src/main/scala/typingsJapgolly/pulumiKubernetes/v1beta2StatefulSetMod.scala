...
import typingsJapgolly.pulumiKubernetes.outputMod.apps.v1beta2.StatefulSetSpec
import typingsJapgolly.pulumiKubernetes.outputMod.apps.v1beta2.StatefulSetStatus
...
@JSImport("@pulumi/kubernetes/apps/v1beta2/StatefulSet", JSImport.Namespace)
@js.native
object v1beta2StatefulSetMod extends js.Object {
  @js.native
