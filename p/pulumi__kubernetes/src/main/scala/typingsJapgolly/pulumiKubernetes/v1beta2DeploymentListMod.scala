...
import typingsJapgolly.pulumiKubernetes.outputMod.apps.v1beta2.Deployment
...
@JSImport("@pulumi/kubernetes/apps/v1beta2/DeploymentList", JSImport.Namespace)
@js.native
object v1beta2DeploymentListMod extends js.Object {
  @js.native
