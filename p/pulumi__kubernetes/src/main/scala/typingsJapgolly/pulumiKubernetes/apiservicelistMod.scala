...
import typingsJapgolly.pulumiKubernetes.outputMod.apiregistration.v1beta1.APIService
...
@JSImport("@pulumi/kubernetes/apiregistration/v1beta1/APIServiceList", JSImport.Namespace)
@js.native
object apiservicelistMod extends js.Object {
  @js.native
