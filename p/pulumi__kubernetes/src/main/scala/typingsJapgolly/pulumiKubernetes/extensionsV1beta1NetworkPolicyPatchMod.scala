...
import typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy
import typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.extensionsSlashv1beta1
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.NetworkPolicySpecPatch
...
object extensionsV1beta1NetworkPolicyPatchMod {
  
  @JSImport("@pulumi/kubernetes/extensions/v1beta1/networkPolicyPatch", "NetworkPolicyPatch")
  @js.native
  open class NetworkPolicyPatch protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[NetworkPolicy] = js.native
    ...
    /**
      ...
      */
    val spec: Output_[NetworkPolicySpecPatch] = js.native
  }
  /* static members */
  object NetworkPolicyPatch {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): NetworkPolicyPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[NetworkPolicyPatch]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): NetworkPolicyPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[NetworkPolicyPatch]
  ...
  trait NetworkPolicyPatchArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[NetworkPolicy]] = js.undefined
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.NetworkPolicySpecPatch
        ]
      ] = js.undefined
  }
  object NetworkPolicyPatchArgs {
    
    inline def apply(): NetworkPolicyPatchArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[NetworkPolicyPatchArgs]
    }
    
    extension [Self <: NetworkPolicyPatchArgs](x: Self) {
      ...
      inline def setKind(value: Input[NetworkPolicy]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
