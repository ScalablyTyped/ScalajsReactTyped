...
object nodeV1beta1Mod extends js.Object {
  ...
  class RuntimeClass protected ()
    extends typingsJapgolly.pulumiKubernetes.v1beta1RuntimeClassMod.RuntimeClass {
    /**
  ...
  class RuntimeClassList protected ()
    extends typingsJapgolly.pulumiKubernetes.v1beta1RuntimeClassListMod.RuntimeClassList {
    /**
