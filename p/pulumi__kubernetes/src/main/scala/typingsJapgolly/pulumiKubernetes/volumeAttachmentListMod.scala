...
import typingsJapgolly.pulumiKubernetes.outputMod.storage.v1alpha1.VolumeAttachment
...
@js.native
object volumeAttachmentListMod extends js.Object {
  @js.native
  class VolumeAttachmentList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachmentList] = js.native
    /**
