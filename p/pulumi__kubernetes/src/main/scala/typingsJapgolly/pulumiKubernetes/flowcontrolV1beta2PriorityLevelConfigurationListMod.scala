...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1beta2.PriorityLevelConfiguration
...
object flowcontrolV1beta2PriorityLevelConfigurationListMod {
  
  @JSImport("@pulumi/kubernetes/flowcontrol/v1beta2/priorityLevelConfigurationList", "PriorityLevelConfigurationList")
  @js.native
  ...
  object PriorityLevelConfigurationList {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/flowcontrol/v1beta2/priorityLevelConfigurationList.PriorityLevelConfigurationList */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/flowcontrol/v1beta2/priorityLevelConfigurationList.PriorityLevelConfigurationList */ Boolean]
  }
  ...
  trait PriorityLevelConfigurationListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[
            typingsJapgolly.pulumiKubernetes.typesInputMod.flowcontrol.v1beta2.PriorityLevelConfiguration
          ]
        ]
      ]
