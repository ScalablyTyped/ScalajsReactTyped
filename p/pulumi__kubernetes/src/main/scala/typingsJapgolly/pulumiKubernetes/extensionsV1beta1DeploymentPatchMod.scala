...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.DeploymentSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.DeploymentStatusPatch
...
object extensionsV1beta1DeploymentPatchMod {
  
  @JSImport("@pulumi/kubernetes/extensions/v1beta1/deploymentPatch", "DeploymentPatch")
  @js.native
  ...
  object DeploymentPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/deploymentPatch.DeploymentPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/deploymentPatch.DeploymentPatch */ Boolean]
  }
  ...
  trait DeploymentPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.DeploymentSpecPatch
        ]
      ] = js.undefined
  }
