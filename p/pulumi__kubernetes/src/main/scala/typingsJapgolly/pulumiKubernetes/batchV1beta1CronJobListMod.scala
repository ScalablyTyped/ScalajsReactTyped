...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.batch.v1beta1.CronJob
...
object batchV1beta1CronJobListMod {
  ...
  trait CronJobListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.batch.v1beta1.CronJob]]
      ]
  ...
  object CronJobListArgs {
    ...
    extension [Self <: CronJobListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.batch.v1beta1.CronJob]*): Self = StObject.set(x, "items", js.Array(value*))
