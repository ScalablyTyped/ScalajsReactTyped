...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1alpha1.FlowSchemaSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1alpha1.FlowSchemaStatusPatch
...
object flowcontrolV1alpha1FlowSchemaPatchMod {
  
  @JSImport("@pulumi/kubernetes/flowcontrol/v1alpha1/flowSchemaPatch", "FlowSchemaPatch")
  @js.native
  ...
  trait FlowSchemaPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.flowcontrol.v1alpha1.FlowSchemaSpecPatch
        ]
      ] = js.undefined
  }
