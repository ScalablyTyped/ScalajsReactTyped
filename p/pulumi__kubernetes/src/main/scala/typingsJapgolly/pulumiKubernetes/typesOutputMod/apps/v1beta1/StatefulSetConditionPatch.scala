...
/**
  ...
  */
trait StatefulSetConditionPatch extends StObject {
...
object StatefulSetConditionPatch {
  
  inline def apply(lastTransitionTime: String, message: String, reason: String, status: String, `type`: String): StatefulSetConditionPatch = {
    ...
    __obj.asInstanceOf[StatefulSetConditionPatch]
  }
  
  extension [Self <: StatefulSetConditionPatch](x: Self) {
