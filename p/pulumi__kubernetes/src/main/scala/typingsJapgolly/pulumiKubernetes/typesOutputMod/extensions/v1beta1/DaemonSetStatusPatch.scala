...
/**
  ...
  */
trait DaemonSetStatusPatch extends StObject {
  ...
  /**
    ...
    */
  var conditions: js.Array[DaemonSetConditionPatch]
...
object DaemonSetStatusPatch {
  
  inline def apply(
    collisionCount: Double,
    conditions: js.Array[DaemonSetConditionPatch],
    ...
    __obj.asInstanceOf[DaemonSetStatusPatch]
  }
  
  extension [Self <: DaemonSetStatusPatch](x: Self) {
    
    inline def setCollisionCount(value: Double): Self = StObject.set(x, "collisionCount", value.asInstanceOf[js.Any])
    
    inline def setConditions(value: js.Array[DaemonSetConditionPatch]): Self = StObject.set(x, "conditions", value.asInstanceOf[js.Any])
    
    inline def setConditionsVarargs(value: DaemonSetConditionPatch*): Self = StObject.set(x, "conditions", js.Array(value*))
