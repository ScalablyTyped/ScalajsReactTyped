...
trait ObjectMetaPatch extends StObject {
  ...
  /**
    ...
    */
  var managedFields: js.Array[ManagedFieldsEntryPatch]
  ...
  /**
    ...
    */
  var ownerReferences: js.Array[OwnerReferencePatch]
...
object ObjectMetaPatch {
  ...
  inline def apply(
    ...
    managedFields: js.Array[ManagedFieldsEntryPatch],
    name: String,
    namespace: String,
    ownerReferences: js.Array[OwnerReferencePatch],
  ...
  extension [Self <: ObjectMetaPatch](x: Self) {
    ...
    inline def setManagedFields(value: js.Array[ManagedFieldsEntryPatch]): Self = StObject.set(x, "managedFields", value.asInstanceOf[js.Any])
    
    inline def setManagedFieldsVarargs(value: ManagedFieldsEntryPatch*): Self = StObject.set(x, "managedFields", js.Array(value*))
    
    inline def setName(value: String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    
    inline def setNamespace(value: String): Self = StObject.set(x, "namespace", value.asInstanceOf[js.Any])
    
    inline def setOwnerReferences(value: js.Array[OwnerReferencePatch]): Self = StObject.set(x, "ownerReferences", value.asInstanceOf[js.Any])
    
    inline def setOwnerReferencesVarargs(value: OwnerReferencePatch*): Self = StObject.set(x, "ownerReferences", js.Array(value*))
