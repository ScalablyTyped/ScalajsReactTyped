...
object RuntimeClassStrategyOptionsPatch {
  ...
  inline def apply(allowedRuntimeClassNames: js.Array[String], defaultRuntimeClassName: String): RuntimeClassStrategyOptionsPatch = {
  ...
  extension [Self <: RuntimeClassStrategyOptionsPatch](x: Self) {
    ...
    inline def setAllowedRuntimeClassNamesVarargs(value: String*): Self = StObject.set(x, "allowedRuntimeClassNames", js.Array(value*))
