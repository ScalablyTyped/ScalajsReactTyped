...
object FlowSchema {
  ...
  inline def apply(metadata: ObjectMeta, spec: FlowSchemaSpec, status: FlowSchemaStatus): FlowSchema = {
    val __obj = js.Dynamic.literal(apiVersion = "flowcontrol.apiserver.k8s.io/v1beta1", kind = "FlowSchema", metadata = metadata.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
