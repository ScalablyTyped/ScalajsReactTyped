...
trait PersistentVolumeClaimSpecPatch extends StObject {
  ...
  /**
    ...
    */
  var dataSource: TypedLocalObjectReferencePatch
  ...
  /**
    ...
    */
  var dataSourceRef: TypedLocalObjectReferencePatch
...
object PersistentVolumeClaimSpecPatch {
  ...
  inline def apply(
    ...
    dataSourceRef: TypedLocalObjectReferencePatch,
  ...
  extension [Self <: PersistentVolumeClaimSpecPatch](x: Self) {
    ...
    inline def setDataSource(value: TypedLocalObjectReferencePatch): Self = StObject.set(x, "dataSource", value.asInstanceOf[js.Any])
    
    inline def setDataSourceRef(value: TypedLocalObjectReferencePatch): Self = StObject.set(x, "dataSourceRef", value.asInstanceOf[js.Any])
