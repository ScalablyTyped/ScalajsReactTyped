...
trait HorizontalPodAutoscaler extends StObject {
  ...
  /**
    ...
    */
  var apiVersion: autoscalingSlashv2
...
object HorizontalPodAutoscaler {
  ...
  inline def apply(metadata: ObjectMeta, spec: HorizontalPodAutoscalerSpec, status: HorizontalPodAutoscalerStatus): HorizontalPodAutoscaler = {
    val __obj = js.Dynamic.literal(apiVersion = "autoscaling/v2", kind = "HorizontalPodAutoscaler", metadata = metadata.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[HorizontalPodAutoscaler]
  }
  
  extension [Self <: HorizontalPodAutoscaler](x: Self) {
    
    inline def setApiVersion(value: autoscalingSlashv2): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
