...
/**
  ...
  */
trait PriorityLevelConfigurationConditionPatch extends StObject {
...
object PriorityLevelConfigurationConditionPatch {
  
  inline def apply(lastTransitionTime: String, message: String, reason: String, status: String, `type`: String): PriorityLevelConfigurationConditionPatch = {
    ...
    __obj.asInstanceOf[PriorityLevelConfigurationConditionPatch]
  }
  
  extension [Self <: PriorityLevelConfigurationConditionPatch](x: Self) {
