...
trait Namespace extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Namespace
...
object Namespace {
  ...
  extension [Self <: Namespace](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Namespace): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
