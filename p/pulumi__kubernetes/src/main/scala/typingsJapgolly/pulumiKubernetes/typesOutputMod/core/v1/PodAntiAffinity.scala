...
object PodAntiAffinity {
  ...
  extension [Self <: PodAntiAffinity](x: Self) {
    ...
    inline def setPreferredDuringSchedulingIgnoredDuringExecutionVarargs(value: WeightedPodAffinityTerm*): Self = StObject.set(x, "preferredDuringSchedulingIgnoredDuringExecution", js.Array(value*))
    ...
    inline def setRequiredDuringSchedulingIgnoredDuringExecutionVarargs(value: PodAffinityTerm*): Self = StObject.set(x, "requiredDuringSchedulingIgnoredDuringExecution", js.Array(value*))
  }
}
