...
trait IngressClassSpecPatch extends StObject {
  ...
  /**
    ...
    */
  var parameters: TypedLocalObjectReferencePatch
}
object IngressClassSpecPatch {
  
  inline def apply(controller: String, parameters: TypedLocalObjectReferencePatch): IngressClassSpecPatch = {
  ...
  extension [Self <: IngressClassSpecPatch](x: Self) {
    ...
    inline def setParameters(value: TypedLocalObjectReferencePatch): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
  }
}
