...
/**
  ...
  */
trait EndpointAddressPatch extends StObject {
...
object EndpointAddressPatch {
  
  inline def apply(hostname: String, ip: String, nodeName: String, targetRef: ObjectReferencePatch): EndpointAddressPatch = {
    ...
    __obj.asInstanceOf[EndpointAddressPatch]
  }
  
  extension [Self <: EndpointAddressPatch](x: Self) {
