...
object NodeStatus {
  ...
  extension [Self <: NodeStatus](x: Self) {
    ...
    inline def setAddressesVarargs(value: NodeAddress*): Self = StObject.set(x, "addresses", js.Array(value*))
    ...
    inline def setConditionsVarargs(value: NodeCondition*): Self = StObject.set(x, "conditions", js.Array(value*))
    ...
    inline def setImagesVarargs(value: ContainerImage*): Self = StObject.set(x, "images", js.Array(value*))
    ...
    inline def setVolumesAttachedVarargs(value: AttachedVolume*): Self = StObject.set(x, "volumesAttached", js.Array(value*))
