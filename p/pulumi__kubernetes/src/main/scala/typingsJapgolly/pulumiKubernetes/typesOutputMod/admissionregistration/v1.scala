package typingsJapgolly.pulumiKubernetes.typesOutputMod.admissionregistration
...
object v1 {
  ...
  object MutatingWebhook {
    ...
    extension [Self <: MutatingWebhook](x: Self) {
      ...
      inline def setAdmissionReviewVersionsVarargs(value: String*): Self = StObject.set(x, "admissionReviewVersions", js.Array(value*))
      ...
      inline def setRulesVarargs(value: RuleWithOperations*): Self = StObject.set(x, "rules", js.Array(value*))
  ...
  trait MutatingWebhookConfiguration extends StObject {
    ...
    /**
      ...
      */
    var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.MutatingWebhookConfiguration
  ...
  object MutatingWebhookConfiguration {
    ...
    extension [Self <: MutatingWebhookConfiguration](x: Self) {
      ...
      inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.MutatingWebhookConfiguration): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      inline def setWebhooksVarargs(value: MutatingWebhook*): Self = StObject.set(x, "webhooks", js.Array(value*))
    }
  }
  ...
  trait MutatingWebhookPatch extends StObject {
    ...
    /**
      * ObjectSelector decides whether to run the webhook based on if the object has matching labels. objectSelector is evaluated against both the oldObject and newObject that would be sent to the webhook, and is considered to match if either object matches the selector. A null object (oldObject in the case of create, or newObject in the case of delete) or an object that cannot have labels (like a DeploymentRollback or a PodProxyOptions object) is not considered to match. Use the object selector only if the webhook is opt-in, because end users may skip the admission webhook by setting the labels. Default to the empty LabelSelector, which matches everything.
      */
    var objectSelector: LabelSelectorPatch
    ...
    /**
      * Rules describes what operations on what resources/subresources the webhook cares about. The webhook cares about an operation if it matches _any_ Rule. However, in order to prevent ValidatingAdmissionWebhooks and MutatingAdmissionWebhooks from putting the cluster in a state which cannot be recovered from without completely disabling the plugin, ValidatingAdmissionWebhooks and MutatingAdmissionWebhooks are never called on admission requests for ValidatingWebhookConfiguration and MutatingWebhookConfiguration objects.
      */
    var rules: js.Array[RuleWithOperationsPatch]
  ...
  object MutatingWebhookPatch {
    ...
    inline def apply(
      admissionReviewVersions: js.Array[String],
      clientConfig: WebhookClientConfigPatch,
      failurePolicy: String,
      matchPolicy: String,
      name: String,
      namespaceSelector: LabelSelectorPatch,
      objectSelector: LabelSelectorPatch,
      reinvocationPolicy: String,
      rules: js.Array[RuleWithOperationsPatch],
      sideEffects: String,
      timeoutSeconds: Double
    ...
    extension [Self <: MutatingWebhookPatch](x: Self) {
      ...
      inline def setObjectSelector(value: LabelSelectorPatch): Self = StObject.set(x, "objectSelector", value.asInstanceOf[js.Any])
      
      inline def setReinvocationPolicy(value: String): Self = StObject.set(x, "reinvocationPolicy", value.asInstanceOf[js.Any])
      
      inline def setRules(value: js.Array[RuleWithOperationsPatch]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
      
      inline def setRulesVarargs(value: RuleWithOperationsPatch*): Self = StObject.set(x, "rules", js.Array(value*))
  ...
  trait ValidatingWebhookConfiguration extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfiguration
  ...
  object ValidatingWebhookConfiguration {
    ...
    extension [Self <: ValidatingWebhookConfiguration](x: Self) {
      ...
      inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ValidatingWebhookConfiguration): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      
      inline def setMetadata(value: ObjectMeta): Self = StObject.set(x, "metadata", value.asInstanceOf[js.Any])
      
      inline def setWebhooks(value: js.Array[ValidatingWebhook]): Self = StObject.set(x, "webhooks", value.asInstanceOf[js.Any])
      
      inline def setWebhooksVarargs(value: ValidatingWebhook*): Self = StObject.set(x, "webhooks", js.Array(value*))
    }
  }
