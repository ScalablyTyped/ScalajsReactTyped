...
trait ReplicaSet extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSet
...
object ReplicaSet {
  ...
  inline def apply(metadata: ObjectMeta, spec: ReplicaSetSpec, status: ReplicaSetStatus): ReplicaSet = {
    val __obj = js.Dynamic.literal(apiVersion = "apps/v1beta2", kind = "ReplicaSet", metadata = metadata.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
  ...
  extension [Self <: ReplicaSet](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSet): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
