...
trait PodTemplate extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodTemplate
...
object PodTemplate {
  ...
  extension [Self <: PodTemplate](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodTemplate): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
