...
/**
  ...
  */
trait MetricValueStatusPatch extends StObject {
...
object MetricValueStatusPatch {
  
  inline def apply(averageUtilization: Double, averageValue: String, value: String): MetricValueStatusPatch = {
    ...
    __obj.asInstanceOf[MetricValueStatusPatch]
  }
  
  extension [Self <: MetricValueStatusPatch](x: Self) {
