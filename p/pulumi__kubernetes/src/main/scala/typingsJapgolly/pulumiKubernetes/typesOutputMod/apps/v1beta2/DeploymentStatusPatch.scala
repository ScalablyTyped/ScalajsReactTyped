...
/**
  ...
  */
trait DeploymentStatusPatch extends StObject {
  ...
  /**
    ...
    */
  var conditions: js.Array[DeploymentConditionPatch]
...
object DeploymentStatusPatch {
  
  inline def apply(
    availableReplicas: Double,
    collisionCount: Double,
    conditions: js.Array[DeploymentConditionPatch],
    ...
    __obj.asInstanceOf[DeploymentStatusPatch]
  }
  
  extension [Self <: DeploymentStatusPatch](x: Self) {
    ...
    inline def setConditions(value: js.Array[DeploymentConditionPatch]): Self = StObject.set(x, "conditions", value.asInstanceOf[js.Any])
    
    inline def setConditionsVarargs(value: DeploymentConditionPatch*): Self = StObject.set(x, "conditions", js.Array(value*))
