...
trait FlowSchema extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.FlowSchema
...
object FlowSchema {
  ...
  inline def apply(metadata: ObjectMeta, spec: FlowSchemaSpec, status: FlowSchemaStatus): FlowSchema = {
    val __obj = js.Dynamic.literal(apiVersion = "flowcontrol.apiserver.k8s.io/v1beta2", kind = "FlowSchema", metadata = metadata.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
  ...
  extension [Self <: FlowSchema](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.FlowSchema): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
