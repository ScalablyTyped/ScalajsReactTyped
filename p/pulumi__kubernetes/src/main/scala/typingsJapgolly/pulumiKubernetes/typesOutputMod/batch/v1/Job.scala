...
trait Job extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Job
...
object Job {
  ...
  extension [Self <: Job](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Job): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
