...
/**
  ...
  */
trait JobStatusPatch extends StObject {
  ...
  /**
    ...
    */
  var conditions: js.Array[JobConditionPatch]
  ...
  /**
    ...
    */
  var uncountedTerminatedPods: UncountedTerminatedPodsPatch
}
object JobStatusPatch {
  
  inline def apply(
    active: Double,
    completedIndexes: String,
    completionTime: String,
    conditions: js.Array[JobConditionPatch],
    failed: Double,
    ready: Double,
    startTime: String,
    succeeded: Double,
    uncountedTerminatedPods: UncountedTerminatedPodsPatch
  ): JobStatusPatch = {
    ...
    __obj.asInstanceOf[JobStatusPatch]
  }
  
  extension [Self <: JobStatusPatch](x: Self) {
    ...
    inline def setConditions(value: js.Array[JobConditionPatch]): Self = StObject.set(x, "conditions", value.asInstanceOf[js.Any])
    
    inline def setConditionsVarargs(value: JobConditionPatch*): Self = StObject.set(x, "conditions", js.Array(value*))
    ...
    inline def setUncountedTerminatedPods(value: UncountedTerminatedPodsPatch): Self = StObject.set(x, "uncountedTerminatedPods", value.asInstanceOf[js.Any])
  }
}
