  ...
  object v1 {
    ...
    trait Lease extends StObject {
      ...
      /**
        ...
        */
      var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Lease
    ...
    object Lease {
      ...
      extension [Self <: Lease](x: Self) {
        ...
        inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Lease): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
