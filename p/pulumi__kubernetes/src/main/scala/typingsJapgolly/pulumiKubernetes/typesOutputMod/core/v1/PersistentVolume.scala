...
trait PersistentVolume extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolume
...
object PersistentVolume {
  ...
  extension [Self <: PersistentVolume](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolume): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
