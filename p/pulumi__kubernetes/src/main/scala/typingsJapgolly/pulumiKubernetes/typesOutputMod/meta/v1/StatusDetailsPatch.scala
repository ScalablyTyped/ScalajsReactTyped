...
trait StatusDetailsPatch extends StObject {
  ...
  /**
    ...
    */
  var causes: js.Array[StatusCausePatch]
...
object StatusDetailsPatch {
  ...
  inline def apply(
    causes: js.Array[StatusCausePatch],
    group: String,
    kind: String,
    name: String,
  ...
  extension [Self <: StatusDetailsPatch](x: Self) {
    ...
    inline def setCauses(value: js.Array[StatusCausePatch]): Self = StObject.set(x, "causes", value.asInstanceOf[js.Any])
    
    inline def setCausesVarargs(value: StatusCausePatch*): Self = StObject.set(x, "causes", js.Array(value*))
