...
object IngressClassSpec {
  ...
  inline def apply(controller: String, parameters: IngressClassParametersReference): IngressClassSpec = {
  ...
  extension [Self <: IngressClassSpec](x: Self) {
    ...
    inline def setParameters(value: IngressClassParametersReference): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
  }
}
