...
trait CustomResourceDefinitionVersionPatch extends StObject {
  ...
  /**
    ...
    */
  var schema: CustomResourceValidationPatch
...
object CustomResourceDefinitionVersionPatch {
  ...
  inline def apply(
    ...
    name: String,
    schema: CustomResourceValidationPatch,
    served: Boolean,
    storage: Boolean,
  ...
  extension [Self <: CustomResourceDefinitionVersionPatch](x: Self) {
    ...
    inline def setSchema(value: CustomResourceValidationPatch): Self = StObject.set(x, "schema", value.asInstanceOf[js.Any])
