...
trait PriorityLevelConfiguration extends StObject {
  ...
  /**
    ...
    */
  var apiVersion: flowcontrolDotapiserverDotk8sDotioSlashv1beta2
  
  /**
    * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfiguration
...
object PriorityLevelConfiguration {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(apiVersion = "flowcontrol.apiserver.k8s.io/v1beta2", kind = "PriorityLevelConfiguration", metadata = metadata.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[PriorityLevelConfiguration]
  }
  
  extension [Self <: PriorityLevelConfiguration](x: Self) {
    
    inline def setApiVersion(value: flowcontrolDotapiserverDotk8sDotioSlashv1beta2): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
    
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfiguration): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
