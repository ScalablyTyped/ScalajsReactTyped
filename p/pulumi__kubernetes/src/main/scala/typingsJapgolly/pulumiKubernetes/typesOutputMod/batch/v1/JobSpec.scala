...
trait JobSpec extends StObject {
  ...
  /**
    ...
    */
  var podFailurePolicy: PodFailurePolicy
...
object JobSpec {
  ...
  extension [Self <: JobSpec](x: Self) {
    ...
    inline def setPodFailurePolicy(value: PodFailurePolicy): Self = StObject.set(x, "podFailurePolicy", value.asInstanceOf[js.Any])
