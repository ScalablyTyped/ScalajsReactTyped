...
trait ResourceQuota extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota
...
object ResourceQuota {
  ...
  extension [Self <: ResourceQuota](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
