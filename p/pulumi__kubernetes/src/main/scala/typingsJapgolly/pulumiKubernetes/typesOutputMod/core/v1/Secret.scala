...
trait Secret extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Secret
...
object Secret {
  ...
  extension [Self <: Secret](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Secret): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
