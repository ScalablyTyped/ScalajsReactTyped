...
trait PriorityLevelConfiguration extends StObject {
  ...
  /**
    ...
    */
  var apiVersion: flowcontrolDotapiserverDotk8sDotioSlashv1beta1
...
object PriorityLevelConfiguration {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(apiVersion = "flowcontrol.apiserver.k8s.io/v1beta1", kind = "PriorityLevelConfiguration", metadata = metadata.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[PriorityLevelConfiguration]
  }
  
  extension [Self <: PriorityLevelConfiguration](x: Self) {
    
    inline def setApiVersion(value: flowcontrolDotapiserverDotk8sDotioSlashv1beta1): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
