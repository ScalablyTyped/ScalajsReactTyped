...
object CustomResourceDefinitionSpec {
  ...
  extension [Self <: CustomResourceDefinitionSpec](x: Self) {
    ...
    inline def setAdditionalPrinterColumnsVarargs(value: CustomResourceColumnDefinition*): Self = StObject.set(x, "additionalPrinterColumns", js.Array(value*))
    ...
    inline def setValidation(value: CustomResourceValidation): Self = StObject.set(x, "validation", value.asInstanceOf[js.Any])
    ...
    inline def setVersionsVarargs(value: CustomResourceDefinitionVersion*): Self = StObject.set(x, "versions", js.Array(value*))
  }
}
