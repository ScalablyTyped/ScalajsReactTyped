...
/**
  ...
  */
trait DeploymentConditionPatch extends StObject {
...
object DeploymentConditionPatch {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[DeploymentConditionPatch]
  }
  
  extension [Self <: DeploymentConditionPatch](x: Self) {
