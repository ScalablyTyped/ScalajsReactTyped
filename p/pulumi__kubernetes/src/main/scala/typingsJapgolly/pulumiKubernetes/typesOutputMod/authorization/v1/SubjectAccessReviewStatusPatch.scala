...
/**
  ...
  */
trait SubjectAccessReviewStatusPatch extends StObject {
...
object SubjectAccessReviewStatusPatch {
  
  inline def apply(allowed: Boolean, denied: Boolean, evaluationError: String, reason: String): SubjectAccessReviewStatusPatch = {
    ...
    __obj.asInstanceOf[SubjectAccessReviewStatusPatch]
  }
  
  extension [Self <: SubjectAccessReviewStatusPatch](x: Self) {
