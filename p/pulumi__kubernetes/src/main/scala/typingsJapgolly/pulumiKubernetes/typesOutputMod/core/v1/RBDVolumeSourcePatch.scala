...
/**
  ...
  */
trait RBDVolumeSourcePatch extends StObject {
...
object RBDVolumeSourcePatch {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[RBDVolumeSourcePatch]
  }
  
  extension [Self <: RBDVolumeSourcePatch](x: Self) {
