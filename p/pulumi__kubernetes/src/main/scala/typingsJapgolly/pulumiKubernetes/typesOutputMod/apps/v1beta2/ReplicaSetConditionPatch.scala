...
/**
  ...
  */
trait ReplicaSetConditionPatch extends StObject {
...
object ReplicaSetConditionPatch {
  
  inline def apply(lastTransitionTime: String, message: String, reason: String, status: String, `type`: String): ReplicaSetConditionPatch = {
    ...
    __obj.asInstanceOf[ReplicaSetConditionPatch]
  }
  
  extension [Self <: ReplicaSetConditionPatch](x: Self) {
