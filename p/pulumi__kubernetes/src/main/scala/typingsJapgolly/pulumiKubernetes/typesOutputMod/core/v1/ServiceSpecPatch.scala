...
trait ServiceSpecPatch extends StObject {
  ...
  /**
    ...
    */
  var ports: js.Array[ServicePortPatch]
  ...
  /**
    ...
    */
  var sessionAffinityConfig: SessionAffinityConfigPatch
...
object ServiceSpecPatch {
  ...
  inline def apply(
    ...
    ports: js.Array[ServicePortPatch],
    publishNotReadyAddresses: Boolean,
    selector: StringDictionary[String],
    sessionAffinity: String,
    sessionAffinityConfig: SessionAffinityConfigPatch,
  ...
  extension [Self <: ServiceSpecPatch](x: Self) {
    ...
    inline def setPorts(value: js.Array[ServicePortPatch]): Self = StObject.set(x, "ports", value.asInstanceOf[js.Any])
    
    inline def setPortsVarargs(value: ServicePortPatch*): Self = StObject.set(x, "ports", js.Array(value*))
    ...
    inline def setSessionAffinityConfig(value: SessionAffinityConfigPatch): Self = StObject.set(x, "sessionAffinityConfig", value.asInstanceOf[js.Any])
