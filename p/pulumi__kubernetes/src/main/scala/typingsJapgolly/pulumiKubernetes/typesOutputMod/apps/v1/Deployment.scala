...
trait Deployment extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Deployment
...
object Deployment {
  ...
  inline def apply(metadata: ObjectMeta, spec: DeploymentSpec, status: DeploymentStatus): Deployment = {
    val __obj = js.Dynamic.literal(apiVersion = "apps/v1", kind = "Deployment", metadata = metadata.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
  ...
  extension [Self <: Deployment](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Deployment): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
