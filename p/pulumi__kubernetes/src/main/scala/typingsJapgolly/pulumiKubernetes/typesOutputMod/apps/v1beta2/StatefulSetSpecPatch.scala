...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.core.v1.PersistentVolumeClaimPatch
...
trait StatefulSetSpecPatch extends StObject {
  ...
  /**
    ...
    */
  var updateStrategy: StatefulSetUpdateStrategyPatch
  
  /**
    * volumeClaimTemplates is a list of claims that pods are allowed to reference. The StatefulSet controller is responsible for mapping network identities to claims in a way that maintains the identity of a pod. Every claim in this list must have at least one matching (by name) volumeMount in one container in the template. A claim in this list takes precedence over any volumes in the template, with the same name.
    */
  var volumeClaimTemplates: js.Array[PersistentVolumeClaimPatch]
}
object StatefulSetSpecPatch {
  ...
  inline def apply(
    ...
    updateStrategy: StatefulSetUpdateStrategyPatch,
    volumeClaimTemplates: js.Array[PersistentVolumeClaimPatch]
  ...
  extension [Self <: StatefulSetSpecPatch](x: Self) {
    ...
    inline def setUpdateStrategy(value: StatefulSetUpdateStrategyPatch): Self = StObject.set(x, "updateStrategy", value.asInstanceOf[js.Any])
    
    inline def setVolumeClaimTemplates(value: js.Array[PersistentVolumeClaimPatch]): Self = StObject.set(x, "volumeClaimTemplates", value.asInstanceOf[js.Any])
    
    inline def setVolumeClaimTemplatesVarargs(value: PersistentVolumeClaimPatch*): Self = StObject.set(x, "volumeClaimTemplates", js.Array(value*))
  }
}
