...
/**
  ...
  */
trait CephFSPersistentVolumeSourcePatch extends StObject {
...
object CephFSPersistentVolumeSourcePatch {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CephFSPersistentVolumeSourcePatch]
  }
  
  extension [Self <: CephFSPersistentVolumeSourcePatch](x: Self) {
