...
/**
  ...
  */
trait NamespaceConditionPatch extends StObject {
...
object NamespaceConditionPatch {
  
  inline def apply(lastTransitionTime: String, message: String, reason: String, status: String, `type`: String): NamespaceConditionPatch = {
    ...
    __obj.asInstanceOf[NamespaceConditionPatch]
  }
  
  extension [Self <: NamespaceConditionPatch](x: Self) {
