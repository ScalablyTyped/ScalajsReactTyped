...
trait Service extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Service
...
object Service {
  ...
  extension [Self <: Service](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Service): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
