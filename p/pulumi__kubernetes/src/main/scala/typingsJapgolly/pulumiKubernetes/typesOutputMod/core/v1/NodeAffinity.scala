...
object NodeAffinity {
  ...
  extension [Self <: NodeAffinity](x: Self) {
    ...
    inline def setPreferredDuringSchedulingIgnoredDuringExecutionVarargs(value: PreferredSchedulingTerm*): Self = StObject.set(x, "preferredDuringSchedulingIgnoredDuringExecution", js.Array(value*))
