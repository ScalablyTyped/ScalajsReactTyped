...
trait PersistentVolumeClaimStatusPatch extends StObject {
  ...
  /**
    ...
    */
  var conditions: js.Array[PersistentVolumeClaimConditionPatch]
...
object PersistentVolumeClaimStatusPatch {
  ...
  inline def apply(
    ...
    conditions: js.Array[PersistentVolumeClaimConditionPatch],
    phase: String,
    resizeStatus: String
  ...
  extension [Self <: PersistentVolumeClaimStatusPatch](x: Self) {
    ...
    inline def setConditions(value: js.Array[PersistentVolumeClaimConditionPatch]): Self = StObject.set(x, "conditions", value.asInstanceOf[js.Any])
    
    inline def setConditionsVarargs(value: PersistentVolumeClaimConditionPatch*): Self = StObject.set(x, "conditions", js.Array(value*))
