...
/**
  ...
  */
trait DownwardAPIVolumeSourcePatch extends StObject {
...
object DownwardAPIVolumeSourcePatch {
  
  inline def apply(defaultMode: Double, items: js.Array[DownwardAPIVolumeFilePatch]): DownwardAPIVolumeSourcePatch = {
    val __obj = js.Dynamic.literal(defaultMode = defaultMode.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[DownwardAPIVolumeSourcePatch]
  }
  
  extension [Self <: DownwardAPIVolumeSourcePatch](x: Self) {
