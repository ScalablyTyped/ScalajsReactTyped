...
trait MetricStatus extends StObject {
  ...
  /**
    ...
    */
  var containerResource: ContainerResourceMetricStatus
...
object MetricStatus {
  ...
  extension [Self <: MetricStatus](x: Self) {
    ...
    inline def setContainerResource(value: ContainerResourceMetricStatus): Self = StObject.set(x, "containerResource", value.asInstanceOf[js.Any])
