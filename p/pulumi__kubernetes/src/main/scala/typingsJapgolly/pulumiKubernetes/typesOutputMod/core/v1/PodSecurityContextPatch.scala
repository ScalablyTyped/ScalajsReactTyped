...
trait PodSecurityContextPatch extends StObject {
  ...
  /**
    ...
    */
  var sysctls: js.Array[SysctlPatch]
...
object PodSecurityContextPatch {
  ...
  extension [Self <: PodSecurityContextPatch](x: Self) {
    ...
    inline def setSupplementalGroupsVarargs(value: Double*): Self = StObject.set(x, "supplementalGroups", js.Array(value*))
    
    inline def setSysctls(value: js.Array[SysctlPatch]): Self = StObject.set(x, "sysctls", value.asInstanceOf[js.Any])
    
    inline def setSysctlsVarargs(value: SysctlPatch*): Self = StObject.set(x, "sysctls", js.Array(value*))
