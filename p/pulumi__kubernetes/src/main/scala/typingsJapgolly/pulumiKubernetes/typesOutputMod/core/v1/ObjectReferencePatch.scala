...
/**
  ...
  */
trait ObjectReferencePatch extends StObject {
...
object ObjectReferencePatch {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ObjectReferencePatch]
  }
  
  extension [Self <: ObjectReferencePatch](x: Self) {
