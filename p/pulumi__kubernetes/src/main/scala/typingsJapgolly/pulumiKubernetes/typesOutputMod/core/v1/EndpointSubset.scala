...
object EndpointSubset {
  ...
  extension [Self <: EndpointSubset](x: Self) {
    ...
    inline def setAddressesVarargs(value: EndpointAddress*): Self = StObject.set(x, "addresses", js.Array(value*))
    ...
    inline def setNotReadyAddressesVarargs(value: EndpointAddress*): Self = StObject.set(x, "notReadyAddresses", js.Array(value*))
