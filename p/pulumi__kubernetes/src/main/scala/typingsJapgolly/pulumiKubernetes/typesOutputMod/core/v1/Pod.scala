...
trait Pod extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Pod
...
object Pod {
  ...
  extension [Self <: Pod](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Pod): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
