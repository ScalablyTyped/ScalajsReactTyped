...
object ControllerRevision {
  ...
  inline def apply(data: Any, metadata: ObjectMeta, revision: Double): ControllerRevision = {
    val __obj = js.Dynamic.literal(apiVersion = "apps/v1beta2", data = data.asInstanceOf[js.Any], kind = "ControllerRevision", metadata = metadata.asInstanceOf[js.Any], revision = revision.asInstanceOf[js.Any])
