  ...
  object v1 {
    ...
    trait PriorityClass extends StObject {
      ...
      /**
        ...
        */
      var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityClass
    ...
    object PriorityClass {
      ...
      extension [Self <: PriorityClass](x: Self) {
        ...
        inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityClass): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
