...
trait CSIDriverSpecPatch extends StObject {
  ...
  /**
    ...
    * This is an alpha feature and only available when the CSIServiceAccountToken feature is enabled.
    */
  var tokenRequests: js.Array[TokenRequestPatch]
...
object CSIDriverSpecPatch {
  ...
  inline def apply(
    ...
    tokenRequests: js.Array[TokenRequestPatch],
  ...
  extension [Self <: CSIDriverSpecPatch](x: Self) {
    ...
    inline def setTokenRequests(value: js.Array[TokenRequestPatch]): Self = StObject.set(x, "tokenRequests", value.asInstanceOf[js.Any])
    
    inline def setTokenRequestsVarargs(value: TokenRequestPatch*): Self = StObject.set(x, "tokenRequests", js.Array(value*))
