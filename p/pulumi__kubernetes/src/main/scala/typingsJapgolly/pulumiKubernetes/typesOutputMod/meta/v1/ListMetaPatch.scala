...
/**
  ...
  */
trait ListMetaPatch extends StObject {
...
object ListMetaPatch {
  
  inline def apply(continue: String, remainingItemCount: Double, resourceVersion: String, selfLink: String): ListMetaPatch = {
    ...
    __obj.asInstanceOf[ListMetaPatch]
  }
  
  extension [Self <: ListMetaPatch](x: Self) {
