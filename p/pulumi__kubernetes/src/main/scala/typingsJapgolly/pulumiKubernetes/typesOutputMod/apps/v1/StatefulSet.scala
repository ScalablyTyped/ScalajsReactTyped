...
trait StatefulSet extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StatefulSet
...
object StatefulSet {
  ...
  extension [Self <: StatefulSet](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StatefulSet): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
