package typingsJapgolly.pulumiKubernetes.typesOutputMod.autoscaling
...
object v1 {
  ...
  object CrossVersionObjectReferencePatch {
    ...
    inline def apply(apiVersion: String, kind: String, name: String): CrossVersionObjectReferencePatch = {
      val __obj = js.Dynamic.literal(apiVersion = apiVersion.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
  ...
  trait HorizontalPodAutoscaler extends StObject {
    ...
    /**
      ...
      */
    var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.HorizontalPodAutoscaler
  ...
  object HorizontalPodAutoscaler {
    ...
    extension [Self <: HorizontalPodAutoscaler](x: Self) {
      ...
      inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.HorizontalPodAutoscaler): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
