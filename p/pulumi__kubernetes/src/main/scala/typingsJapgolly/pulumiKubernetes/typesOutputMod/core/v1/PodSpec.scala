...
object PodSpec {
  ...
  extension [Self <: PodSpec](x: Self) {
    ...
    inline def setEphemeralContainersVarargs(value: EphemeralContainer*): Self = StObject.set(x, "ephemeralContainers", js.Array(value*))
    
    inline def setHostAliases(value: js.Array[HostAlias]): Self = StObject.set(x, "hostAliases", value.asInstanceOf[js.Any])
    
    inline def setHostAliasesVarargs(value: HostAlias*): Self = StObject.set(x, "hostAliases", js.Array(value*))
    ...
    inline def setInitContainersVarargs(value: Container*): Self = StObject.set(x, "initContainers", js.Array(value*))
    ...
    inline def setOs(value: PodOS): Self = StObject.set(x, "os", value.asInstanceOf[js.Any])
    ...
    inline def setReadinessGatesVarargs(value: PodReadinessGate*): Self = StObject.set(x, "readinessGates", js.Array(value*))
    ...
    inline def setTopologySpreadConstraintsVarargs(value: TopologySpreadConstraint*): Self = StObject.set(x, "topologySpreadConstraints", js.Array(value*))
