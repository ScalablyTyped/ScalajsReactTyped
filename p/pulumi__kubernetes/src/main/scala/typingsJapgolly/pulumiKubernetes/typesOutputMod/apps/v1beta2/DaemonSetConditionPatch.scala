...
/**
  ...
  */
trait DaemonSetConditionPatch extends StObject {
...
object DaemonSetConditionPatch {
  
  inline def apply(lastTransitionTime: String, message: String, reason: String, status: String, `type`: String): DaemonSetConditionPatch = {
    ...
    __obj.asInstanceOf[DaemonSetConditionPatch]
  }
  
  extension [Self <: DaemonSetConditionPatch](x: Self) {
