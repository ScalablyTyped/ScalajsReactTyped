...
/**
  ...
  */
trait ScaleIOPersistentVolumeSourcePatch extends StObject {
...
object ScaleIOPersistentVolumeSourcePatch {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ScaleIOPersistentVolumeSourcePatch]
  }
  
  extension [Self <: ScaleIOPersistentVolumeSourcePatch](x: Self) {
