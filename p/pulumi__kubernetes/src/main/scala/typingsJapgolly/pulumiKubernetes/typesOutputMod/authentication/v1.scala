package typingsJapgolly.pulumiKubernetes.typesOutputMod.authentication
...
object v1 {
  ...
  object BoundObjectReferencePatch {
    ...
    inline def apply(apiVersion: String, kind: String, name: String, uid: String): BoundObjectReferencePatch = {
      val __obj = js.Dynamic.literal(apiVersion = apiVersion.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], uid = uid.asInstanceOf[js.Any])
  ...
  trait TokenRequestSpecPatch extends StObject {
    ...
    /**
      * BoundObjectRef is a reference to an object that the token will be bound to. The token will only be valid for as long as the bound object exists. NOTE: The API server's TokenReview endpoint will validate the BoundObjectRef, but other audiences may not. Keep ExpirationSeconds small if you want prompt revocation.
      */
    var boundObjectRef: BoundObjectReferencePatch
  ...
  object TokenRequestSpecPatch {
    ...
    inline def apply(audiences: js.Array[String], boundObjectRef: BoundObjectReferencePatch, expirationSeconds: Double): TokenRequestSpecPatch = {
      val __obj = js.Dynamic.literal(audiences = audiences.asInstanceOf[js.Any], boundObjectRef = boundObjectRef.asInstanceOf[js.Any], expirationSeconds = expirationSeconds.asInstanceOf[js.Any])
    ...
    extension [Self <: TokenRequestSpecPatch](x: Self) {
      ...
      inline def setBoundObjectRef(value: BoundObjectReferencePatch): Self = StObject.set(x, "boundObjectRef", value.asInstanceOf[js.Any])
  ...
  /**
    * TokenRequestStatus is the result of a token request.
    */
  trait TokenRequestStatusPatch extends StObject {
  ...
  object TokenRequestStatusPatch {
    
    inline def apply(expirationTimestamp: String, token: String): TokenRequestStatusPatch = {
      val __obj = js.Dynamic.literal(expirationTimestamp = expirationTimestamp.asInstanceOf[js.Any], token = token.asInstanceOf[js.Any])
      __obj.asInstanceOf[TokenRequestStatusPatch]
    }
    
    extension [Self <: TokenRequestStatusPatch](x: Self) {
  ...
  object TokenReviewSpecPatch {
    ...
    inline def apply(audiences: js.Array[String], token: String): TokenReviewSpecPatch = {
      val __obj = js.Dynamic.literal(audiences = audiences.asInstanceOf[js.Any], token = token.asInstanceOf[js.Any])
  ...
  /**
    * TokenReviewStatus is the result of the token authentication request.
    */
  trait TokenReviewStatusPatch extends StObject {
    ...
    /**
      * User is the UserInfo associated with the provided token.
      */
    var user: UserInfoPatch
  }
  object TokenReviewStatusPatch {
    
    inline def apply(audiences: js.Array[String], authenticated: Boolean, error: String, user: UserInfoPatch): TokenReviewStatusPatch = {
      val __obj = js.Dynamic.literal(audiences = audiences.asInstanceOf[js.Any], authenticated = authenticated.asInstanceOf[js.Any], error = error.asInstanceOf[js.Any], user = user.asInstanceOf[js.Any])
      __obj.asInstanceOf[TokenReviewStatusPatch]
    }
    
    extension [Self <: TokenReviewStatusPatch](x: Self) {
      ...
      inline def setUser(value: UserInfoPatch): Self = StObject.set(x, "user", value.asInstanceOf[js.Any])
    }
  }
  ...
  /**
    * UserInfo holds the information about the user needed to implement the user.Info interface.
    */
  trait UserInfoPatch extends StObject {
  ...
  object UserInfoPatch {
    
    inline def apply(extra: StringDictionary[js.Array[String]], groups: js.Array[String], uid: String, username: String): UserInfoPatch = {
      val __obj = js.Dynamic.literal(extra = extra.asInstanceOf[js.Any], groups = groups.asInstanceOf[js.Any], uid = uid.asInstanceOf[js.Any], username = username.asInstanceOf[js.Any])
      __obj.asInstanceOf[UserInfoPatch]
    }
    
    extension [Self <: UserInfoPatch](x: Self) {
