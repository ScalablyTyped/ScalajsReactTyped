...
trait StatefulSetSpecPatch extends StObject {
  ...
  /**
    ...
    */
  var persistentVolumeClaimRetentionPolicy: StatefulSetPersistentVolumeClaimRetentionPolicyPatch
...
object StatefulSetSpecPatch {
  ...
  inline def apply(
    ...
    persistentVolumeClaimRetentionPolicy: StatefulSetPersistentVolumeClaimRetentionPolicyPatch,
  ...
  extension [Self <: StatefulSetSpecPatch](x: Self) {
    ...
    inline def setPersistentVolumeClaimRetentionPolicy(value: StatefulSetPersistentVolumeClaimRetentionPolicyPatch): Self = StObject.set(x, "persistentVolumeClaimRetentionPolicy", value.asInstanceOf[js.Any])
