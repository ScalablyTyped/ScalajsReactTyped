...
/**
  ...
  */
trait CinderVolumeSourcePatch extends StObject {
...
object CinderVolumeSourcePatch {
  
  inline def apply(fsType: String, readOnly: Boolean, secretRef: LocalObjectReferencePatch, volumeID: String): CinderVolumeSourcePatch = {
    ...
    __obj.asInstanceOf[CinderVolumeSourcePatch]
  }
  
  extension [Self <: CinderVolumeSourcePatch](x: Self) {
