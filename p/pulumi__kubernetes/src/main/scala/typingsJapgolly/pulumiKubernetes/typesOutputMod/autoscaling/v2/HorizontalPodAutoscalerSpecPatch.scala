...
trait HorizontalPodAutoscalerSpecPatch extends StObject {
  ...
  /**
    ...
    */
  var behavior: HorizontalPodAutoscalerBehaviorPatch
...
object HorizontalPodAutoscalerSpecPatch {
  ...
  extension [Self <: HorizontalPodAutoscalerSpecPatch](x: Self) {
    ...
    inline def setBehavior(value: HorizontalPodAutoscalerBehaviorPatch): Self = StObject.set(x, "behavior", value.asInstanceOf[js.Any])
