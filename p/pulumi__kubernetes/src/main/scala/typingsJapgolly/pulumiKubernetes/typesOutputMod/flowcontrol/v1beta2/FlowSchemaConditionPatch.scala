...
/**
  ...
  */
trait FlowSchemaConditionPatch extends StObject {
...
object FlowSchemaConditionPatch {
  
  inline def apply(lastTransitionTime: String, message: String, reason: String, status: String, `type`: String): FlowSchemaConditionPatch = {
    ...
    __obj.asInstanceOf[FlowSchemaConditionPatch]
  }
  
  extension [Self <: FlowSchemaConditionPatch](x: Self) {
