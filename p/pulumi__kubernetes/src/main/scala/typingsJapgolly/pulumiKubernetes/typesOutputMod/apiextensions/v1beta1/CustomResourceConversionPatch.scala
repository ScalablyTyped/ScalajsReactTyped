...
trait CustomResourceConversionPatch extends StObject {
  ...
  /**
    ...
    */
  var webhookClientConfig: WebhookClientConfigPatch
}
object CustomResourceConversionPatch {
  ...
  inline def apply(
    ...
    strategy: String,
    webhookClientConfig: WebhookClientConfigPatch
  ...
  extension [Self <: CustomResourceConversionPatch](x: Self) {
    ...
    inline def setWebhookClientConfig(value: WebhookClientConfigPatch): Self = StObject.set(x, "webhookClientConfig", value.asInstanceOf[js.Any])
  }
}
