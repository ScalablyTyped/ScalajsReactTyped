...
object NodeSelectorTerm {
  ...
  extension [Self <: NodeSelectorTerm](x: Self) {
    ...
    inline def setMatchExpressionsVarargs(value: NodeSelectorRequirement*): Self = StObject.set(x, "matchExpressions", js.Array(value*))
    ...
    inline def setMatchFieldsVarargs(value: NodeSelectorRequirement*): Self = StObject.set(x, "matchFields", js.Array(value*))
  }
}
