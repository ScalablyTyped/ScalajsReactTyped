...
trait Endpoints extends StObject {
  ...
  /**
    ...
    */
  var kind: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Endpoints
...
object Endpoints {
  ...
  extension [Self <: Endpoints](x: Self) {
    ...
    inline def setKind(value: typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Endpoints): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    ...
    inline def setSubsetsVarargs(value: EndpointSubset*): Self = StObject.set(x, "subsets", js.Array(value*))
  }
}
