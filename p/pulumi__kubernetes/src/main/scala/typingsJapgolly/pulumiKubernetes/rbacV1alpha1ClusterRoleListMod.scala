...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.rbac.v1alpha1.ClusterRole
...
object rbacV1alpha1ClusterRoleListMod {
  ...
  trait ClusterRoleListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.ClusterRole]]
      ]
  ...
  object ClusterRoleListArgs {
    ...
    extension [Self <: ClusterRoleListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.ClusterRole]*): Self = StObject.set(x, "items", js.Array(value*))
