...
object authorizationV1Mod extends js.Object {
  ...
  class LocalSubjectAccessReview protected ()
    extends typingsJapgolly.pulumiKubernetes.v1LocalSubjectAccessReviewMod.LocalSubjectAccessReview {
    /**
  ...
  class SelfSubjectAccessReview protected ()
    extends typingsJapgolly.pulumiKubernetes.v1SelfSubjectAccessReviewMod.SelfSubjectAccessReview {
    /**
  ...
  class SelfSubjectRulesReview protected ()
    extends typingsJapgolly.pulumiKubernetes.v1SelfSubjectRulesReviewMod.SelfSubjectRulesReview {
    /**
  ...
  class SubjectAccessReview protected ()
    extends typingsJapgolly.pulumiKubernetes.v1SubjectAccessReviewMod.SubjectAccessReview {
    /**
