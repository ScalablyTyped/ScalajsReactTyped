...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.ReplicaSetSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.ReplicaSetStatus
...
object appsV1beta2ReplicaSetMod {
  
  @JSImport("@pulumi/kubernetes/apps/v1beta2/replicaSet", "ReplicaSet")
  @js.native
  open class ReplicaSet protected () extends CustomResource {
    /**
  ...
  trait ReplicaSetArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.ReplicaSetSpec]
      ] = js.undefined
  }
  object ReplicaSetArgs {
    ...
    extension [Self <: ReplicaSetArgs](x: Self) {
      ...
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSet]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.ReplicaSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
