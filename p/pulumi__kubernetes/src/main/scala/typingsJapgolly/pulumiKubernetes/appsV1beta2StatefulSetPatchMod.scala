...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.StatefulSetSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.StatefulSetStatusPatch
...
object appsV1beta2StatefulSetPatchMod {
  
  @JSImport("@pulumi/kubernetes/apps/v1beta2/statefulSetPatch", "StatefulSetPatch")
  @js.native
  ...
  object StatefulSetPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/statefulSetPatch.StatefulSetPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/statefulSetPatch.StatefulSetPatch */ Boolean]
  }
  ...
  trait StatefulSetPatchArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.StatefulSetSpecPatch]
      ] = js.undefined
  }
  object StatefulSetPatchArgs {
    ...
    extension [Self <: StatefulSetPatchArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.StatefulSetSpecPatch]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
