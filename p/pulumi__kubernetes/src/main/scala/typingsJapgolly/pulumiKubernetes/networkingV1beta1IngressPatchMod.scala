...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.networking.v1beta1.IngressSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.networking.v1beta1.IngressStatusPatch
...
object networkingV1beta1IngressPatchMod {
  
  @JSImport("@pulumi/kubernetes/networking/v1beta1/ingressPatch", "IngressPatch")
  @js.native
  ...
  object IngressPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/networking/v1beta1/ingressPatch.IngressPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/networking/v1beta1/ingressPatch.IngressPatch */ Boolean]
  }
  ...
  trait IngressPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.networking.v1beta1.IngressSpecPatch
        ]
      ] = js.undefined
  }
