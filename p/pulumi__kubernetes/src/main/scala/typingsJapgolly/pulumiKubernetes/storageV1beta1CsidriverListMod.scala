...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1beta1.CSIDriver
...
object storageV1beta1CsidriverListMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1beta1/csidriverList", "CSIDriverList")
  @js.native
  open class CSIDriverList protected () extends CustomResource {
    /**
  ...
  trait CSIDriverListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSIDriver]]
      ]
  ...
  object CSIDriverListArgs {
    ...
    extension [Self <: CSIDriverListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSIDriver]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
