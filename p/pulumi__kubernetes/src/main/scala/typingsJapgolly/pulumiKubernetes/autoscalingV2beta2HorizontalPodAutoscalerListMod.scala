...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.autoscaling.v2beta2.HorizontalPodAutoscaler
...
object autoscalingV2beta2HorizontalPodAutoscalerListMod {
  ...
  trait HorizontalPodAutoscalerListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[
            typingsJapgolly.pulumiKubernetes.typesInputMod.autoscaling.v2beta2.HorizontalPodAutoscaler
          ]
        ]
      ]
