...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.DeploymentSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.DeploymentStatusPatch
...
object appsV1beta2DeploymentPatchMod {
  
  @JSImport("@pulumi/kubernetes/apps/v1beta2/deploymentPatch", "DeploymentPatch")
  @js.native
  ...
  object DeploymentPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/deploymentPatch.DeploymentPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/deploymentPatch.DeploymentPatch */ Boolean]
  }
  ...
  trait DeploymentPatchArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.DeploymentSpecPatch]
      ] = js.undefined
  }
  object DeploymentPatchArgs {
    ...
    extension [Self <: DeploymentPatchArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.DeploymentSpecPatch]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
