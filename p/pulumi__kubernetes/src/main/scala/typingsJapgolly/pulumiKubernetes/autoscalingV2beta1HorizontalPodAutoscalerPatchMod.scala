...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.autoscaling.v2beta1.HorizontalPodAutoscalerSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.autoscaling.v2beta1.HorizontalPodAutoscalerStatusPatch
...
object autoscalingV2beta1HorizontalPodAutoscalerPatchMod {
  
  @JSImport("@pulumi/kubernetes/autoscaling/v2beta1/horizontalPodAutoscalerPatch", "HorizontalPodAutoscalerPatch")
  @js.native
  ...
  trait HorizontalPodAutoscalerPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.autoscaling.v2beta1.HorizontalPodAutoscalerSpecPatch
        ]
      ] = js.undefined
  }
