...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.policy.v1beta1.PodSecurityPolicySpec
...
object policyV1beta1PodSecurityPolicyMod {
  ...
  object PodSecurityPolicy {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/policy/v1beta1/podSecurityPolicy.PodSecurityPolicy */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/policy/v1beta1/podSecurityPolicy.PodSecurityPolicy */ Boolean]
  }
  ...
  trait PodSecurityPolicyArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.policy.v1beta1.PodSecurityPolicySpec
        ]
      ] = js.undefined
  }
