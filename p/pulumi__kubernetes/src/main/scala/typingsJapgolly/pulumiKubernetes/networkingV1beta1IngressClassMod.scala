...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.networking.v1beta1.IngressClassSpec
...
object networkingV1beta1IngressClassMod {
  
  @JSImport("@pulumi/kubernetes/networking/v1beta1/ingressClass", "IngressClass")
  @js.native
  open class IngressClass protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.IngressClass] = js.native
  ...
  trait IngressClassArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.networking.v1beta1.IngressClassSpec
        ]
      ] = js.undefined
  }
