...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1beta1.CSINode
...
object storageV1beta1CsinodeListMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1beta1/csinodeList", "CSINodeList")
  @js.native
  open class CSINodeList protected () extends CustomResource {
    /**
  ...
  trait CSINodeListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSINode]]
      ]
  ...
  object CSINodeListArgs {
    ...
    extension [Self <: CSINodeListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSINode]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSINodeList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
