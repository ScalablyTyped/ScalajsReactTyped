...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.node.v1alpha1.RuntimeClassSpecPatch
...
object nodeV1alpha1RuntimeClassPatchMod {
  
  @JSImport("@pulumi/kubernetes/node/v1alpha1/runtimeClassPatch", "RuntimeClassPatch")
  @js.native
  open class RuntimeClassPatch protected () extends CustomResource {
    ...
    /**
      ...
      */
    val spec: Output_[RuntimeClassSpecPatch] = js.native
  }
  /* static members */
  ...
  trait RuntimeClassPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.node.v1alpha1.RuntimeClassSpecPatch
        ]
      ] = js.undefined
  }
