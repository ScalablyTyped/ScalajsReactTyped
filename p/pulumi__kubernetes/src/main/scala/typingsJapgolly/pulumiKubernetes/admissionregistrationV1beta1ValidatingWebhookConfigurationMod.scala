...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.admissionregistration.v1beta1.ValidatingWebhook
...
object admissionregistrationV1beta1ValidatingWebhookConfigurationMod {
  
  @JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/validatingWebhookConfiguration", "ValidatingWebhookConfiguration")
  @js.native
  open class ValidatingWebhookConfiguration protected () extends CustomResource {
    /**
  ...
  trait ValidatingWebhookConfigurationArgs extends StObject {
    ...
    var webhooks: js.UndefOr[
        Input[
          js.Array[
            Input[
              typingsJapgolly.pulumiKubernetes.typesInputMod.admissionregistration.v1beta1.ValidatingWebhook
            ]
          ]
        ]
      ] = js.undefined
