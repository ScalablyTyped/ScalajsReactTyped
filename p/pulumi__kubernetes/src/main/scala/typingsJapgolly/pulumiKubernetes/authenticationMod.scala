...
object authenticationMod extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class TokenRequest protected ()
      extends typingsJapgolly.pulumiKubernetes.authenticationV1Mod.TokenRequest {
      /**
    ...
    class TokenReview protected ()
      extends typingsJapgolly.pulumiKubernetes.authenticationV1Mod.TokenReview {
      /**
  ...
  object v1beta1 extends js.Object {
    @js.native
    class TokenReview protected ()
      extends typingsJapgolly.pulumiKubernetes.authenticationV1beta1Mod.TokenReview {
      /**
