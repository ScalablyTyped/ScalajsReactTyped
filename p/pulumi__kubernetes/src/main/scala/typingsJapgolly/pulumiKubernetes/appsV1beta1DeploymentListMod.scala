...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta1.Deployment
...
object appsV1beta1DeploymentListMod {
  ...
  trait DeploymentListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta1.Deployment]]
      ]
  ...
  object DeploymentListArgs {
    ...
    extension [Self <: DeploymentListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta1.Deployment]*): Self = StObject.set(x, "items", js.Array(value*))
