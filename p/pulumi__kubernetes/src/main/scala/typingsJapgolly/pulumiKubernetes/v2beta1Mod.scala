...
object v2beta1Mod extends js.Object {
  ...
  class HorizontalPodAutoscaler protected ()
    extends typingsJapgolly.pulumiKubernetes.v2beta1HorizontalPodAutoscalerMod.HorizontalPodAutoscaler {
    /**
  ...
  class HorizontalPodAutoscalerList protected ()
    extends typingsJapgolly.pulumiKubernetes.v2beta1HorizontalPodAutoscalerListMod.HorizontalPodAutoscalerList {
    /**
