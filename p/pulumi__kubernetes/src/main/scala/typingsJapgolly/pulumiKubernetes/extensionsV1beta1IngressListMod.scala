...
object extensionsV1beta1IngressListMod {
  ...
  trait IngressListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.Ingress]]
      ]
  ...
  object IngressListArgs {
    ...
    extension [Self <: IngressListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.Ingress]*): Self = StObject.set(x, "items", js.Array(value*))
