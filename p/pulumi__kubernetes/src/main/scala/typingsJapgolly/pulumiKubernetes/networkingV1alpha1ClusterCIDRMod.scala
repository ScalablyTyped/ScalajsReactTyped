...
object networkingV1alpha1ClusterCIDRMod {
  
  @JSImport("@pulumi/kubernetes/networking/v1alpha1/clusterCIDR", "ClusterCIDR")
  @js.native
  open class ClusterCIDR protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ClusterCIDR] = js.native
    ...
    /**
      ...
      */
    val spec: Output_[ClusterCIDRSpec] = js.native
  }
  /* static members */
  object ClusterCIDR {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): ClusterCIDR = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[ClusterCIDR]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): ClusterCIDR = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[ClusterCIDR]
  ...
  trait ClusterCIDRArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.networking.v1alpha1.ClusterCIDRSpec
        ]
      ] = js.undefined
  }
  object ClusterCIDRArgs {
    
    inline def apply(): ClusterCIDRArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ClusterCIDRArgs]
    }
    
    extension [Self <: ClusterCIDRArgs](x: Self) {
