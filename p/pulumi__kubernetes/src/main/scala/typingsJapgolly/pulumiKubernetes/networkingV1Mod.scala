...
object networkingV1Mod extends js.Object {
  ...
  class NetworkPolicy protected ()
    extends typingsJapgolly.pulumiKubernetes.v1NetworkPolicyMod.NetworkPolicy {
    /**
  ...
  class NetworkPolicyList protected ()
    extends typingsJapgolly.pulumiKubernetes.v1NetworkPolicyListMod.NetworkPolicyList {
    /**
