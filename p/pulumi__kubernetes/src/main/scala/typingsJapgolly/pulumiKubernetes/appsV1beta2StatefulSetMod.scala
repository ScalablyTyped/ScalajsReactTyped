...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.StatefulSetSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta2.StatefulSetStatus
...
object appsV1beta2StatefulSetMod {
  ...
  object StatefulSet {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/statefulSet.StatefulSet */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/statefulSet.StatefulSet */ Boolean]
  }
  ...
  trait StatefulSetArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.StatefulSetSpec]
      ] = js.undefined
  }
  object StatefulSetArgs {
    ...
    extension [Self <: StatefulSetArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta2.StatefulSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
