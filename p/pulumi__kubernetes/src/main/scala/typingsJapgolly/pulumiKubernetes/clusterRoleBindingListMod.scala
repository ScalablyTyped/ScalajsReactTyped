...
import typingsJapgolly.pulumiKubernetes.outputMod.rbac.v1alpha1.ClusterRoleBinding
...
@js.native
object clusterRoleBindingListMod extends js.Object {
  @js.native
  class ClusterRoleBindingList protected () extends CustomResource {
    ...
    def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRoleBindingList) = this()
    def this(
      name: String,
      args: typingsJapgolly.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRoleBindingList,
