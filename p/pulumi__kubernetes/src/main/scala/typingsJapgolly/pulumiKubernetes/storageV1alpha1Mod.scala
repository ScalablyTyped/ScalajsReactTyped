...
object storageV1alpha1Mod extends js.Object {
  ...
  class VolumeAttachment protected ()
    extends typingsJapgolly.pulumiKubernetes.volumeAttachmentMod.VolumeAttachment {
    /**
  ...
  class VolumeAttachmentList protected ()
    extends typingsJapgolly.pulumiKubernetes.volumeAttachmentListMod.VolumeAttachmentList {
    /**
