...
import typingsJapgolly.pulumiKubernetes.outputMod.storage.v1beta1.StorageClass
...
@JSImport("@pulumi/kubernetes/storage/v1beta1/StorageClassList", JSImport.Namespace)
@js.native
object storageClassListMod extends js.Object {
  @js.native
