...
class ServiceAccountList protected ()
  extends typingsJapgolly.pulumiKubernetes.serviceAccountListMod.ServiceAccountList {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ServiceAccountList) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ServiceAccountList,
...
object ServiceAccountList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.serviceAccountListMod.ServiceAccountList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.serviceAccountListMod.ServiceAccountList = js.native
  /**
