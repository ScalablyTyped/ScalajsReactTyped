...
class ReplicationController protected ()
  extends typingsJapgolly.pulumiKubernetes.replicationControllerMod.ReplicationController {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ReplicationController) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ReplicationController,
...
object ReplicationController extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.replicationControllerMod.ReplicationController = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.replicationControllerMod.ReplicationController = js.native
  /**
