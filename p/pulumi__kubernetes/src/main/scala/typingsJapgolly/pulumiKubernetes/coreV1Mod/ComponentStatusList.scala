...
class ComponentStatusList protected ()
  extends typingsJapgolly.pulumiKubernetes.componentStatusListMod.ComponentStatusList {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ComponentStatusList) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ComponentStatusList,
...
object ComponentStatusList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.componentStatusListMod.ComponentStatusList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.componentStatusListMod.ComponentStatusList = js.native
  /**
