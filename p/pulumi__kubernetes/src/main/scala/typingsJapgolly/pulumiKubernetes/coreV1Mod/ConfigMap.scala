...
class ConfigMap protected ()
  extends typingsJapgolly.pulumiKubernetes.configMapMod.ConfigMap {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ConfigMap) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ConfigMap,
...
object ConfigMap extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.configMapMod.ConfigMap = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.configMapMod.ConfigMap = js.native
  /**
