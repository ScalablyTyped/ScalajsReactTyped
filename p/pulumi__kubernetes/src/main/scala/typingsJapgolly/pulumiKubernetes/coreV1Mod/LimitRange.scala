...
class LimitRange protected ()
  extends typingsJapgolly.pulumiKubernetes.limitRangeMod.LimitRange {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.LimitRange) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.LimitRange,
...
object LimitRange extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.limitRangeMod.LimitRange = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.limitRangeMod.LimitRange = js.native
  /**
