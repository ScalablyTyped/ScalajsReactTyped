...
class ServiceList protected ()
  extends typingsJapgolly.pulumiKubernetes.serviceListMod.ServiceList {
  /**
...
object ServiceList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.serviceListMod.ServiceList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.serviceListMod.ServiceList = js.native
  /**
