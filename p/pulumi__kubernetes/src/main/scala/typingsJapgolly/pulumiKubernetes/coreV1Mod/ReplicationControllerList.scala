...
class ReplicationControllerList protected ()
  extends typingsJapgolly.pulumiKubernetes.replicationControllerListMod.ReplicationControllerList {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ReplicationControllerList) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ReplicationControllerList,
...
object ReplicationControllerList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.replicationControllerListMod.ReplicationControllerList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.replicationControllerListMod.ReplicationControllerList = js.native
  /**
