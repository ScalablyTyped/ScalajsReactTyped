...
class PersistentVolumeList protected ()
  extends typingsJapgolly.pulumiKubernetes.persistentVolumeListMod.PersistentVolumeList {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.PersistentVolumeList) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.PersistentVolumeList,
...
object PersistentVolumeList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.persistentVolumeListMod.PersistentVolumeList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.persistentVolumeListMod.PersistentVolumeList = js.native
  /**
