...
class PersistentVolume protected ()
  extends typingsJapgolly.pulumiKubernetes.persistentVolumeMod.PersistentVolume {
  /**
...
object PersistentVolume extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.persistentVolumeMod.PersistentVolume = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.persistentVolumeMod.PersistentVolume = js.native
  /**
