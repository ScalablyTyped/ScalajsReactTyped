...
class ConfigMapList protected ()
  extends typingsJapgolly.pulumiKubernetes.configMapListMod.ConfigMapList {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ConfigMapList) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ConfigMapList,
...
object ConfigMapList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.configMapListMod.ConfigMapList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.configMapListMod.ConfigMapList = js.native
  /**
