...
class NamespaceList protected ()
  extends typingsJapgolly.pulumiKubernetes.namespaceListMod.NamespaceList {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.NamespaceList) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.core.v1.NamespaceList,
...
object NamespaceList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.namespaceListMod.NamespaceList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.namespaceListMod.NamespaceList = js.native
  /**
