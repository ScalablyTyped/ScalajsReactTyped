...
class ServiceAccount protected ()
  extends typingsJapgolly.pulumiKubernetes.serviceAccountMod.ServiceAccount {
  /**
...
object ServiceAccount extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.serviceAccountMod.ServiceAccount = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.serviceAccountMod.ServiceAccount = js.native
  /**
