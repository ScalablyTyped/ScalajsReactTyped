...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.DeploymentSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.extensions.v1beta1.DeploymentStatus
...
object extensionsV1beta1DeploymentMod {
  
  @JSImport("@pulumi/kubernetes/extensions/v1beta1/deployment", "Deployment")
  @js.native
  open class Deployment protected () extends CustomResource {
    /**
  ...
  object Deployment {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/deployment.Deployment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/deployment.Deployment */ Boolean]
  }
  ...
  trait DeploymentArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.DeploymentSpec]
      ] = js.undefined
  }
  object DeploymentArgs {
    ...
    extension [Self <: DeploymentArgs](x: Self) {
      ...
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Deployment]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.DeploymentSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
