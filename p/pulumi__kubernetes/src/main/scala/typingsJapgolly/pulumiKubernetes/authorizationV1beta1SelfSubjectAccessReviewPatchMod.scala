...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.authorization.v1beta1.SelfSubjectAccessReviewSpecPatch
...
object authorizationV1beta1SelfSubjectAccessReviewPatchMod {
  
  @JSImport("@pulumi/kubernetes/authorization/v1beta1/selfSubjectAccessReviewPatch", "SelfSubjectAccessReviewPatch")
  @js.native
  open class SelfSubjectAccessReviewPatch protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[SelfSubjectAccessReview] = js.native
    ...
    /**
      ...
      */
    val spec: Output_[SelfSubjectAccessReviewSpecPatch] = js.native
  ...
  object SelfSubjectAccessReviewPatch {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): SelfSubjectAccessReviewPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[SelfSubjectAccessReviewPatch]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): SelfSubjectAccessReviewPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[SelfSubjectAccessReviewPatch]
  ...
  trait SelfSubjectAccessReviewPatchArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[SelfSubjectAccessReview]] = js.undefined
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.authorization.v1beta1.SelfSubjectAccessReviewSpecPatch
        ]
      ] = js.undefined
  }
  object SelfSubjectAccessReviewPatchArgs {
    
    inline def apply(): SelfSubjectAccessReviewPatchArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SelfSubjectAccessReviewPatchArgs]
    }
    
    extension [Self <: SelfSubjectAccessReviewPatchArgs](x: Self) {
      ...
      inline def setKind(value: Input[SelfSubjectAccessReview]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
