...
trait PodSecurityPolicyList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList]
  ] = js.undefined
  /**
...
object PodSecurityPolicyList {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList] = null,
