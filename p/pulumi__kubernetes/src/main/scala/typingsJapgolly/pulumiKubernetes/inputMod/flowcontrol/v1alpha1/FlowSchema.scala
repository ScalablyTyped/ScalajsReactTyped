package typingsJapgolly.pulumiKubernetes.inputMod.flowcontrol.v1alpha1
...
object FlowSchema {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.FlowSchema] = null,
