...
trait LimitRange extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.LimitRange]] = js.undefined
  /**
...
object LimitRange {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.LimitRange] = null,
