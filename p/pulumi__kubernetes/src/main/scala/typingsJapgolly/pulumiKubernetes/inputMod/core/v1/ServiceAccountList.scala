...
trait ServiceAccountList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ServiceAccountList]
  ] = js.undefined
  /**
...
object ServiceAccountList {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ServiceAccountList] = null,
