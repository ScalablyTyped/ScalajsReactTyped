...
trait CSIDriverList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList]] = js.undefined
  /**
...
object CSIDriverList {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIDriverList] = null,
