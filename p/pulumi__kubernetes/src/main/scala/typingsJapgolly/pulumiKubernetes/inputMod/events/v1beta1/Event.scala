package typingsJapgolly.pulumiKubernetes.inputMod.events.v1beta1

import typingsJapgolly.pulumiKubernetes.inputMod.core.v1.EventSource
import typingsJapgolly.pulumiKubernetes.inputMod.core.v1.ObjectReference
...
object Event {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Event] = null,
