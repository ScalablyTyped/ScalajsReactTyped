package typingsJapgolly.pulumiKubernetes.inputMod.scheduling.v1alpha1
...
object PriorityClass {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PriorityClass] = null,
