...
trait NetworkPolicyList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList]
  ] = js.undefined
  /**
...
object NetworkPolicyList {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList] = null,
