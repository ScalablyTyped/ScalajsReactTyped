...
import typingsJapgolly.pulumiKubernetes.inputMod.core.v1.TopologySelectorTerm
...
object StorageClass {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.StorageClass] = null,
