...
trait PersistentVolume extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolume]] = js.undefined
  /**
...
object PersistentVolume {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolume] = null,
