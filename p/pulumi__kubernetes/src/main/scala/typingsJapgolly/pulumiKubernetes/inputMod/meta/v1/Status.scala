...
trait Status extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Status]] = js.undefined
  /**
...
object Status {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.Status] = null,
