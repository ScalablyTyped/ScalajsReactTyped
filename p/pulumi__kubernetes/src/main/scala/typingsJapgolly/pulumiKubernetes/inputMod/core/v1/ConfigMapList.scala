...
trait ConfigMapList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ConfigMapList]] = js.undefined
  /**
    * More info:
...
object ConfigMapList {
  ...
  def apply(
    ...
    kind: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.ConfigMapList] = null,
