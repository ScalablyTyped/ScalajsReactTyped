...
import typingsJapgolly.pulumiKubernetes.outputMod.policy.v1beta1.PodSecurityPolicy
...
@js.native
object v1beta1PodSecurityPolicyListMod extends js.Object {
  @js.native
  class PodSecurityPolicyList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList] = js.native
    /**
