...
class ResourceQuota protected ()
  extends typingsJapgolly.pulumiKubernetes.coreV1Mod.ResourceQuota {
  /**
...
object ResourceQuota extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.resourceQuotaMod.ResourceQuota = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.resourceQuotaMod.ResourceQuota = js.native
  /**
