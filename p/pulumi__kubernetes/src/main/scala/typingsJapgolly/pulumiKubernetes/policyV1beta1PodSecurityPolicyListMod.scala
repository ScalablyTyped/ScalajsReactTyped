...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.policy.v1beta1.PodSecurityPolicy
...
object policyV1beta1PodSecurityPolicyListMod {
  
  @JSImport("@pulumi/kubernetes/policy/v1beta1/podSecurityPolicyList", "PodSecurityPolicyList")
  @js.native
  open class PodSecurityPolicyList protected () extends CustomResource {
    /**
  ...
  trait PodSecurityPolicyListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.policy.v1beta1.PodSecurityPolicy]
        ]
      ]
  ...
  object PodSecurityPolicyListArgs {
    ...
    extension [Self <: PodSecurityPolicyListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.policy.v1beta1.PodSecurityPolicy]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
