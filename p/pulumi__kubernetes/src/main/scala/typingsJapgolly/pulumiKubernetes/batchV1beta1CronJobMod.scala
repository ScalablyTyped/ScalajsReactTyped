...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.batch.v1beta1.CronJobSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.batch.v1beta1.CronJobStatus
...
object batchV1beta1CronJobMod {
  ...
  trait CronJobArgs extends StObject {
    ...
    /**
      * Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    var spec: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.batch.v1beta1.CronJobSpec]] = js.undefined
  }
  object CronJobArgs {
    ...
    extension [Self <: CronJobArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.batch.v1beta1.CronJobSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
