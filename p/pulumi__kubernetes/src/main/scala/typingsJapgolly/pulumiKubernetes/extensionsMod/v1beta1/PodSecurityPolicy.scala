...
class PodSecurityPolicy protected ()
  extends typingsJapgolly.pulumiKubernetes.extensionsV1beta1Mod.PodSecurityPolicy {
  /**
  ...
  def this(name: String, args: typingsJapgolly.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicy) = this()
  def this(
    name: String,
    args: typingsJapgolly.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicy,
...
object PodSecurityPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiKubernetes.podSecurityPolicyMod.PodSecurityPolicy = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typingsJapgolly.pulumiKubernetes.podSecurityPolicyMod.PodSecurityPolicy = js.native
  /**
