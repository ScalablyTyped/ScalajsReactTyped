...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.certificates.v1beta1.CertificateSigningRequestSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.certificates.v1beta1.CertificateSigningRequestStatus
...
object certificatesV1beta1CertificateSigningRequestMod {
  
  @JSImport("@pulumi/kubernetes/certificates/v1beta1/certificateSigningRequest", "CertificateSigningRequest")
  @js.native
  open class CertificateSigningRequest protected () extends CustomResource {
    /**
  ...
  trait CertificateSigningRequestArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.certificates.v1beta1.CertificateSigningRequestSpec
        ]
      ] = js.undefined
  }
