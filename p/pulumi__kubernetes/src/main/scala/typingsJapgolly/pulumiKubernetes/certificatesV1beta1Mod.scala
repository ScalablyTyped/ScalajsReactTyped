...
object certificatesV1beta1Mod extends js.Object {
  ...
  class CertificateSigningRequest protected ()
    extends typingsJapgolly.pulumiKubernetes.certificateSigningRequestMod.CertificateSigningRequest {
    /**
  ...
  class CertificateSigningRequestList protected ()
    extends typingsJapgolly.pulumiKubernetes.certificateSigningRequestListMod.CertificateSigningRequestList {
    /**
