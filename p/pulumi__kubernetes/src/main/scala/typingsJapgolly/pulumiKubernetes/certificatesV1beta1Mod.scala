...
object certificatesV1beta1Mod {
  ...
  type CertificateSigningRequest = typingsJapgolly.pulumiKubernetes.certificatesV1beta1CertificateSigningRequestMod.CertificateSigningRequest
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@pulumi/kubernetes/certificates/v1beta1", "CertificateSigningRequest")
  @js.native
  open class CertificateSigningRequestCls protected ()
    extends typingsJapgolly.pulumiKubernetes.certificatesV1beta1CertificateSigningRequestMod.CertificateSigningRequest {
    /**
  ...
  type CertificateSigningRequestList = typingsJapgolly.pulumiKubernetes.certificatesV1beta1CertificateSigningRequestListMod.CertificateSigningRequestList
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@pulumi/kubernetes/certificates/v1beta1", "CertificateSigningRequestList")
  @js.native
  open class CertificateSigningRequestListCls protected ()
    extends typingsJapgolly.pulumiKubernetes.certificatesV1beta1CertificateSigningRequestListMod.CertificateSigningRequestList {
    /**
  ...
  type CertificateSigningRequestPatch = typingsJapgolly.pulumiKubernetes.certificatesV1beta1CertificateSigningRequestPatchMod.CertificateSigningRequestPatch
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@pulumi/kubernetes/certificates/v1beta1", "CertificateSigningRequestPatch")
  @js.native
  open class CertificateSigningRequestPatchCls protected ()
    extends typingsJapgolly.pulumiKubernetes.certificatesV1beta1CertificateSigningRequestPatchMod.CertificateSigningRequestPatch {
    /**
