...
object storageV1beta1StorageClassMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1beta1/storageClass", "StorageClass")
  @js.native
  open class StorageClass protected () extends CustomResource {
    /**
  ...
  trait StorageClassArgs extends StObject {
    ...
    var allowedTopologies: js.UndefOr[
        Input[
          js.Array[
            Input[typingsJapgolly.pulumiKubernetes.typesInputMod.core.v1.TopologySelectorTerm]
          ]
        ]
      ] = js.undefined
  ...
  object StorageClassArgs {
    ...
    extension [Self <: StorageClassArgs](x: Self) {
      ...
      inline def setAllowedTopologiesVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.core.v1.TopologySelectorTerm]*): Self = StObject.set(x, "allowedTopologies", js.Array(value*))
