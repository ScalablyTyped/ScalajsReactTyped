...
import typingsJapgolly.pulumiKubernetes.outputMod.storage.v1alpha1.VolumeAttachmentSpec
import typingsJapgolly.pulumiKubernetes.outputMod.storage.v1alpha1.VolumeAttachmentStatus
