...
object extensionsV1beta1NetworkPolicyMod {
  
  @JSImport("@pulumi/kubernetes/extensions/v1beta1/networkPolicy", "NetworkPolicy")
  @js.native
  open class NetworkPolicy protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy] = js.native
  ...
  trait NetworkPolicyArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy]] = js.undefined
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.extensions.v1beta1.NetworkPolicySpec
        ]
      ] = js.undefined
  }
  object NetworkPolicyArgs {
    ...
    extension [Self <: NetworkPolicyArgs](x: Self) {
      ...
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
