...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1beta1.CSIStorageCapacity
...
object storageV1beta1CsistorageCapacityListMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1beta1/csistorageCapacityList", "CSIStorageCapacityList")
  @js.native
  open class CSIStorageCapacityList protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val items: Output_[js.Array[CSIStorageCapacity]] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIStorageCapacityList] = js.native
  ...
  object CSIStorageCapacityList {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): CSIStorageCapacityList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[CSIStorageCapacityList]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): CSIStorageCapacityList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[CSIStorageCapacityList]
  ...
  trait CSIStorageCapacityListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[
            typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.CSIStorageCapacity
          ]
        ]
      ]
    ...
    /**
      ...
      */
    var kind: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIStorageCapacityList]
      ] = js.undefined
  ...
  object CSIStorageCapacityListArgs {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[CSIStorageCapacityListArgs]
    }
    
    extension [Self <: CSIStorageCapacityListArgs](x: Self) {
      ...
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.CSIStorageCapacityList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
