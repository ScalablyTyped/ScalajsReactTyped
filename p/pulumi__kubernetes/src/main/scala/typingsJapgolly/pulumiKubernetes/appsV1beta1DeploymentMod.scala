...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta1.DeploymentSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.apps.v1beta1.DeploymentStatus
...
object appsV1beta1DeploymentMod {
  ...
  trait DeploymentArgs extends StObject {
    ...
    /**
      ...
      */
    var spec: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta1.DeploymentSpec]
      ] = js.undefined
  }
  object DeploymentArgs {
    ...
    extension [Self <: DeploymentArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.apps.v1beta1.DeploymentSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
