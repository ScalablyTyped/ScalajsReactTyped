...
object authorizationV1beta1SubjectAccessReviewMod {
  
  @JSImport("@pulumi/kubernetes/authorization/v1beta1/subjectAccessReview", "SubjectAccessReview")
  @js.native
  open class SubjectAccessReview protected () extends CustomResource {
    /**
  ...
  object SubjectAccessReviewArgs {
    ...
    extension [Self <: SubjectAccessReviewArgs](x: Self) {
      ...
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.SubjectAccessReview]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
