...
object appsV1beta1Mod extends js.Object {
  ...
  class ControllerRevision protected ()
    extends typingsJapgolly.pulumiKubernetes.controllerRevisionMod.ControllerRevision {
    /**
  ...
  class ControllerRevisionList protected ()
    extends typingsJapgolly.pulumiKubernetes.controllerRevisionListMod.ControllerRevisionList {
    /**
  ...
  class Deployment protected ()
    extends typingsJapgolly.pulumiKubernetes.deploymentMod.Deployment {
    /**
  ...
  class DeploymentList protected ()
    extends typingsJapgolly.pulumiKubernetes.deploymentListMod.DeploymentList {
    /**
  ...
  class StatefulSet protected ()
    extends typingsJapgolly.pulumiKubernetes.statefulSetMod.StatefulSet {
    /**
  ...
  class StatefulSetList protected ()
    extends typingsJapgolly.pulumiKubernetes.statefulSetListMod.StatefulSetList {
    /**
