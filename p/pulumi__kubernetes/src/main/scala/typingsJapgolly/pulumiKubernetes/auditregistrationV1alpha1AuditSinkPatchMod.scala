...
import typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.AuditSink
import typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.auditregistrationDotk8sDotioSlashv1alpha1
import typingsJapgolly.pulumiKubernetes.typesOutputMod.auditregistration.v1alpha1.AuditSinkSpecPatch
...
object auditregistrationV1alpha1AuditSinkPatchMod {
  
  @JSImport("@pulumi/kubernetes/auditregistration/v1alpha1/auditSinkPatch", "AuditSinkPatch")
  @js.native
  open class AuditSinkPatch protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[AuditSink] = js.native
    ...
    /**
      ...
      */
    val spec: Output_[AuditSinkSpecPatch] = js.native
  }
  /* static members */
  object AuditSinkPatch {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): AuditSinkPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[AuditSinkPatch]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): AuditSinkPatch = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[AuditSinkPatch]
  ...
  trait AuditSinkPatchArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[AuditSink]] = js.undefined
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.auditregistration.v1alpha1.AuditSinkSpecPatch
        ]
      ] = js.undefined
  }
  object AuditSinkPatchArgs {
    
    inline def apply(): AuditSinkPatchArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AuditSinkPatchArgs]
    }
    
    extension [Self <: AuditSinkPatchArgs](x: Self) {
      ...
      inline def setKind(value: Input[AuditSink]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
