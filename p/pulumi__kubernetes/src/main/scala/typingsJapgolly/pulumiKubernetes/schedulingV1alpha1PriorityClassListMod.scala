...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.scheduling.v1alpha1.PriorityClass
...
object schedulingV1alpha1PriorityClassListMod {
  ...
  trait PriorityClassListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.scheduling.v1alpha1.PriorityClass]
        ]
      ]
  ...
  object PriorityClassListArgs {
    ...
    extension [Self <: PriorityClassListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.scheduling.v1alpha1.PriorityClass]*): Self = StObject.set(x, "items", js.Array(value*))
