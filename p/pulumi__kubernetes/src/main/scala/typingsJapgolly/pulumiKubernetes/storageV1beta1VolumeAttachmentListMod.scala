...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1beta1.VolumeAttachment
...
object storageV1beta1VolumeAttachmentListMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1beta1/volumeAttachmentList", "VolumeAttachmentList")
  @js.native
  open class VolumeAttachmentList protected () extends CustomResource {
    /**
  ...
  trait VolumeAttachmentListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.VolumeAttachment]
        ]
      ]
  ...
  object VolumeAttachmentListArgs {
    ...
    extension [Self <: VolumeAttachmentListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1beta1.VolumeAttachment]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachmentList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
