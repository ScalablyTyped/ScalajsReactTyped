...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.rbac.v1alpha1.Role
...
object rbacV1alpha1RoleListMod {
  
  @JSImport("@pulumi/kubernetes/rbac/v1alpha1/roleList", "RoleList")
  @js.native
  open class RoleList protected () extends CustomResource {
    /**
  ...
  trait RoleListArgs extends StObject {
    ...
    /**
      ...
      */
    var items: Input[
        js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.Role]]
      ]
  ...
  object RoleListArgs {
    ...
    extension [Self <: RoleListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.Role]*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.RoleList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
