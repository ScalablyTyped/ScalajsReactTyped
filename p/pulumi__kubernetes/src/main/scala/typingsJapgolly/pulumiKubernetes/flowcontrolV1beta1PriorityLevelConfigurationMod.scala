...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1beta1.PriorityLevelConfigurationSpec
import typingsJapgolly.pulumiKubernetes.typesOutputMod.flowcontrol.v1beta1.PriorityLevelConfigurationStatus
...
object flowcontrolV1beta1PriorityLevelConfigurationMod {
  
  @JSImport("@pulumi/kubernetes/flowcontrol/v1beta1/priorityLevelConfiguration", "PriorityLevelConfiguration")
  @js.native
  ...
  object PriorityLevelConfiguration {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/flowcontrol/v1beta1/priorityLevelConfiguration.PriorityLevelConfiguration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/flowcontrol/v1beta1/priorityLevelConfiguration.PriorityLevelConfiguration */ Boolean]
  }
  ...
  trait PriorityLevelConfigurationArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.flowcontrol.v1beta1.PriorityLevelConfigurationSpec
        ]
      ] = js.undefined
  }
