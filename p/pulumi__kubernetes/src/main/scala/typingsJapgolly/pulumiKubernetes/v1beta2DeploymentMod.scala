...
import typingsJapgolly.pulumiKubernetes.outputMod.apps.v1beta2.DeploymentSpec
import typingsJapgolly.pulumiKubernetes.outputMod.apps.v1beta2.DeploymentStatus
