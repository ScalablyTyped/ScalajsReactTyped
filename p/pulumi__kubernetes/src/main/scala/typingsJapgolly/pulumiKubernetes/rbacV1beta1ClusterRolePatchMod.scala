...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.rbac.v1beta1.AggregationRulePatch
...
object rbacV1beta1ClusterRolePatchMod {
  
  @JSImport("@pulumi/kubernetes/rbac/v1beta1/clusterRolePatch", "ClusterRolePatch")
  @js.native
  ...
  object ClusterRolePatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1beta1/clusterRolePatch.ClusterRolePatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1beta1/clusterRolePatch.ClusterRolePatch */ Boolean]
  }
  ...
  trait ClusterRolePatchArgs extends StObject {
    ...
    var aggregationRule: js.UndefOr[
        Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1beta1.AggregationRulePatch]
      ] = js.undefined
  ...
  object ClusterRolePatchArgs {
    ...
    extension [Self <: ClusterRolePatchArgs](x: Self) {
      ...
      inline def setAggregationRule(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1beta1.AggregationRulePatch]): Self = StObject.set(x, "aggregationRule", value.asInstanceOf[js.Any])
