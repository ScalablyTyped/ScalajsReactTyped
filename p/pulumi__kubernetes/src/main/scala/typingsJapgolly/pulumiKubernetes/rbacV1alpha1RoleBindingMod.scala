...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.rbac.v1alpha1.RoleRef
import typingsJapgolly.pulumiKubernetes.typesOutputMod.rbac.v1alpha1.Subject
...
object rbacV1alpha1RoleBindingMod {
  
  @JSImport("@pulumi/kubernetes/rbac/v1alpha1/roleBinding", "RoleBinding")
  @js.native
  open class RoleBinding protected () extends CustomResource {
    /**
    ...
    /**
      ...
      */
    val kind: Output_[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.RoleBinding] = js.native
  ...
  trait RoleBindingArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    var kind: js.UndefOr[Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.RoleBinding]] = js.undefined
    ...
    /**
      * RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
      */
    var roleRef: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.RoleRef]
    ...
    var subjects: js.UndefOr[
        Input[
          js.Array[Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.Subject]]
        ]
      ] = js.undefined
  }
  object RoleBindingArgs {
    
    inline def apply(roleRef: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.RoleRef]): RoleBindingArgs = {
    ...
    extension [Self <: RoleBindingArgs](x: Self) {
      ...
      inline def setKind(value: Input[typingsJapgolly.pulumiKubernetes.pulumiKubernetesStrings.RoleBinding]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      inline def setRoleRef(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.RoleRef]): Self = StObject.set(x, "roleRef", value.asInstanceOf[js.Any])
      ...
      inline def setSubjectsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1alpha1.Subject]*): Self = StObject.set(x, "subjects", js.Array(value*))
    }
  }
}
