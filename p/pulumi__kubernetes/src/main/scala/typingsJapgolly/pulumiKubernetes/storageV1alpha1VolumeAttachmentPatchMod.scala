...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1alpha1.VolumeAttachmentSpecPatch
import typingsJapgolly.pulumiKubernetes.typesOutputMod.storage.v1alpha1.VolumeAttachmentStatusPatch
...
object storageV1alpha1VolumeAttachmentPatchMod {
  
  @JSImport("@pulumi/kubernetes/storage/v1alpha1/volumeAttachmentPatch", "VolumeAttachmentPatch")
  @js.native
  ...
  trait VolumeAttachmentPatchArgs extends StObject {
    ...
    var spec: js.UndefOr[
        Input[
          typingsJapgolly.pulumiKubernetes.typesInputMod.storage.v1alpha1.VolumeAttachmentSpecPatch
        ]
      ] = js.undefined
  }
