...
import typingsJapgolly.pulumiKubernetes.typesOutputMod.rbac.v1beta1.ClusterRoleBinding
...
object rbacV1beta1ClusterRoleBindingListMod {
  ...
  trait ClusterRoleBindingListArgs extends StObject {
    ...
    var items: Input[
        js.Array[
          Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1beta1.ClusterRoleBinding]
        ]
      ]
  ...
  object ClusterRoleBindingListArgs {
    ...
    extension [Self <: ClusterRoleBindingListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typingsJapgolly.pulumiKubernetes.typesInputMod.rbac.v1beta1.ClusterRoleBinding]*): Self = StObject.set(x, "items", js.Array(value*))
