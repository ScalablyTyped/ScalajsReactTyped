...
object appsV1beta2ControllerRevisionPatchMod {
  
  @JSImport("@pulumi/kubernetes/apps/v1beta2/controllerRevisionPatch", "ControllerRevisionPatch")
  @js.native
  ...
  object ControllerRevisionPatch {
    ...
    /**
      ...
      */
    inline def isInstance(obj: Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/controllerRevisionPatch.ControllerRevisionPatch */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/controllerRevisionPatch.ControllerRevisionPatch */ Boolean]
  }
