package typingsJapgolly.parseTorrent
...
object mod extends Shortcut {
  ...
  - typingsJapgolly.parseTorrentFile.mod.Instance because var conflicts: announce, constructor, infoHash, infoHashBuffer, name, urlList. Inlined pieceLength, `private`, files, pieces, info, createdBy, lastPieceLength, created, length, infoBuffer */ trait Instance
    extends StObject
       with typingsJapgolly.magnetUri.mod.Instance {
