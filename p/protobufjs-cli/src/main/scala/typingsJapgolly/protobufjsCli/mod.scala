package typingsJapgolly.protobufjsCli

import typingsJapgolly.protobufjsCli.pbjsMod.pbjsCallback
import typingsJapgolly.protobufjsCli.pbtsMod.pbtsCallback
