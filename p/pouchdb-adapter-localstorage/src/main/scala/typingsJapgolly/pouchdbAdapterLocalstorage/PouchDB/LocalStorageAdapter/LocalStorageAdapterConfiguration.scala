package typingsJapgolly.pouchdbAdapterLocalstorage.PouchDB.LocalStorageAdapter

import typingsJapgolly.pouchdbAdapterLocalstorage.pouchdbAdapterLocalstorageStrings.localstorage
