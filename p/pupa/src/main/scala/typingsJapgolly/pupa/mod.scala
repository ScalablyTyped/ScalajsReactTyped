package typingsJapgolly.pupa

import typingsJapgolly.pupa.anon.Key
...
object mod {
  ...
  open class MissingValueError protected ()
    ...
    @JSName("name")
    var name_MissingValueError: typingsJapgolly.pupa.pupaStrings.MissingValueError = js.native
  }
