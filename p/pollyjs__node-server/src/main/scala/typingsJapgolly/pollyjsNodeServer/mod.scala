...
import typingsJapgolly.pollyjsNodeServer.anon.PartialConfig
import typingsJapgolly.pollyjsNodeServer.anon.PartialServerConfig
import typingsJapgolly.pollyjsNodeServer.anon.PickConfigrecordingsDir
...
object mod {
  ...
  open class Server () extends StObject {
    ...
    def listen(): typingsJapgolly.node.httpMod.Server[
    ...
    def listen(port: Double, host: String): typingsJapgolly.node.httpMod.Server[
        Instantiable1[/* socket */ Socket, IncomingMessage], 
        Instantiable1[
          /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
          ServerResponse[IncomingMessage]
    ...
    def listen(port: Unit, host: String): typingsJapgolly.node.httpMod.Server[
        Instantiable1[/* socket */ Socket, IncomingMessage], 
        Instantiable1[
          /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
          ServerResponse[IncomingMessage]
