...
import typingsJapgolly.plottable.anon.PickDOMRectxywidthheight
...
import typingsJapgolly.plottable.buildSrcCoreFormattersMod.DatumFormatter
...
object buildSrcPlotsBarPlotMod {
  ...
  /* keyof plottable.anon.End */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.plottable.plottableStrings.end
    - typingsJapgolly.plottable.plottableStrings.start
    - typingsJapgolly.plottable.plottableStrings.middle
  */
  ...
  /* keyof plottable.anon.Horizontal */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.plottable.plottableStrings.vertical
    - typingsJapgolly.plottable.plottableStrings.horizontal
  */
  ...
  /* keyof plottable.anon.Middle */ /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.plottable.plottableStrings.start
    - typingsJapgolly.plottable.plottableStrings.middle
    - typingsJapgolly.plottable.plottableStrings.outside
  */
