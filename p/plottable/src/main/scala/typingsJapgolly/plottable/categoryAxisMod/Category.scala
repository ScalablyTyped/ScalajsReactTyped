package typingsJapgolly.plottable.categoryAxisMod
...
class Category protected () extends Axis[String] {
  ...
  def getDownsampleInfo(scale: typingsJapgolly.plottable.scalesMod.Category): IDownsampleInfo = js.native
  def getDownsampleInfo(scale: typingsJapgolly.plottable.scalesMod.Category, domain: js.Array[String]): IDownsampleInfo = js.native
  /**
