...
import typingsJapgolly.plottable.dispatcherMod.Dispatcher
...
@js.native
object touchDispatcherMod extends js.Object {
  @js.native
  ...
  object Touch extends js.Object {
    ...
    /**
      ...
      */
    def getDispatcher(component: Component): typingsJapgolly.plottable.dispatchersMod.Touch = js.native
  }
