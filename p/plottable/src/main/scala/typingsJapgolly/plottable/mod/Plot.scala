...
/**
  ...
  */
open class Plot ()
  extends typingsJapgolly.plottable.buildSrcPlotsPlotMod.Plot
/* static members */
object Plot {
  ...
  inline def applyDrawSteps(drawSteps: js.Array[DrawStep], dataset: typingsJapgolly.plottable.buildSrcCoreDatasetMod.Dataset): js.Array[AppliedDrawStep] = (^.asInstanceOf[js.Dynamic].applyDynamic("applyDrawSteps")(drawSteps.asInstanceOf[js.Any], dataset.asInstanceOf[js.Any])).asInstanceOf[js.Array[AppliedDrawStep]]
