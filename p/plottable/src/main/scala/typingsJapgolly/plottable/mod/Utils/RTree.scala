...
object RTree extends js.Object {
  @js.native
  class RTree[T] ()
    extends typingsJapgolly.plottable.utilsMod.RTree.RTree[T] {
  ...
  class RTreeBounds protected ()
    extends typingsJapgolly.plottable.utilsMod.RTree.RTreeBounds {
    def this(xl: Double, yl: Double, xh: Double, yh: Double) = this()
  }
  
  @js.native
  class RTreeNode[T] protected ()
    extends typingsJapgolly.plottable.utilsMod.RTree.RTreeNode[T] {
