...
object Utils {
  ...
  open class Bucket protected ()
    extends typingsJapgolly.plottable.buildSrcUtilsMod.Bucket {
  ...
  open class CallbackSet[CB /* <: js.Function */] ()
    extends typingsJapgolly.plottable.buildSrcUtilsMod.CallbackSet[CB]
  ...
  open class EntityStore[T /* <: IPositionedEntity */] ()
    extends typingsJapgolly.plottable.buildSrcUtilsMod.EntityStore[T]
  
  @JSImport("plottable", "Utils.Map")
  @js.native
  open class Map[K, V] ()
    extends typingsJapgolly.plottable.buildSrcUtilsMod.Map[K, V]
  ...
  object RTree {
    ...
    @js.native
    open class RTree[T] ()
      extends typingsJapgolly.plottable.buildSrcUtilsMod.RTree.RTree[T] {
    ...
    open class RTreeBounds protected ()
      extends typingsJapgolly.plottable.buildSrcUtilsMod.RTree.RTreeBounds {
    ...
    open class RTreeNode[T] protected ()
      extends typingsJapgolly.plottable.buildSrcUtilsMod.RTree.RTreeNode[T] {
  ...
  @js.native
  open class Set[T] ()
    extends typingsJapgolly.plottable.buildSrcUtilsMod.Set[T]
  ...
  object Stacking {
    ...
    inline def stack(
      datasets: js.Array[typingsJapgolly.plottable.buildSrcCoreDatasetMod.Dataset],
  ...
  open class Translator protected ()
    extends typingsJapgolly.plottable.buildSrcUtilsMod.Translator {
  ...
  object Translator {
    ...
    /**
      ...
      */
    inline def isEventInside(component: typingsJapgolly.plottable.buildSrcComponentsComponentMod.Component, e: Event): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isEventInside")(component.asInstanceOf[js.Any], e.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  }
  ...
  inline def getTranslator(component: typingsJapgolly.plottable.buildSrcComponentsComponentMod.Component): typingsJapgolly.plottable.buildSrcUtilsTransformAwareTranslatorMod.Translator = ^.asInstanceOf[js.Dynamic].applyDynamic("getTranslator")(component.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.plottable.buildSrcUtilsTransformAwareTranslatorMod.Translator]
}
