...
import typingsJapgolly.plottable.buildSrcComponentsLabelMod.LabelFontSizePx
import typingsJapgolly.plottable.buildSrcScalesMod.Color
import typingsJapgolly.plottable.buildSrcScalesMod.InterpolatedColor
...
object Components {
  ...
  open class AxisLabel ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.AxisLabel {
  ...
  open class DragBoxLayer ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.DragBoxLayer
  
  @JSImport("plottable", "Components.DragLineLayer")
  @js.native
  open class DragLineLayer[D] protected ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.DragLineLayer[D] {
  ...
  open class Gridlines ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.Gridlines {
    def this(xScale: typingsJapgolly.plottable.buildSrcScalesScaleMod.Scale[Any, Any]) = this()
    def this(xScale: Null, yScale: typingsJapgolly.plottable.buildSrcScalesScaleMod.Scale[Any, Any]) = this()
    def this(
      xScale: typingsJapgolly.plottable.buildSrcScalesScaleMod.Scale[Any, Any],
      yScale: typingsJapgolly.plottable.buildSrcScalesScaleMod.Scale[Any, Any]
    ) = this()
  }
  ...
  /**
    ...
    */
  open class Group ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.Group {
    def this(components: js.Array[typingsJapgolly.plottable.buildSrcComponentsComponentMod.Component]) = this()
  }
  
  @JSImport("plottable", "Components.GuideLineLayer")
  @js.native
  open class GuideLineLayer[D] protected ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.GuideLineLayer[D] {
    def this(orientation: String) = this()
  }
  /* static members */
  ...
  open class InterpolatedColorLegend protected ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.InterpolatedColorLegend {
    /**
  ...
  /**
    ...
    */
  open class Label ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.Label {
  ...
  open class Legend protected ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.Legend {
    /**
  ...
  open class PlotGroup ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.PlotGroup {
    def this(components: js.Array[typingsJapgolly.plottable.buildSrcComponentsComponentMod.Component]) = this()
  }
  ...
  object PropertyMode extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.plottable.buildSrcComponentsSelectionBoxLayerMod.PropertyMode & Double
      ] = js.native
    
    /* 1 */ val PIXEL: typingsJapgolly.plottable.buildSrcComponentsSelectionBoxLayerMod.PropertyMode.PIXEL & Double = js.native
    
    /* 0 */ val VALUE: typingsJapgolly.plottable.buildSrcComponentsSelectionBoxLayerMod.PropertyMode.VALUE & Double = js.native
  }
  
  @JSImport("plottable", "Components.SelectionBoxLayer")
  @js.native
  open class SelectionBoxLayer ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.SelectionBoxLayer
  ...
  /**
    ...
    */
  open class Table ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.Table {
    def this(rows: js.Array[
            js.Array[
              js.UndefOr[typingsJapgolly.plottable.buildSrcComponentsComponentMod.Component | Null]
            ]
          ]) = this()
  }
  /* static members */
  ...
  open class TitleLabel ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.TitleLabel {
    def this(text: String) = this()
    def this(text: String, angle: Double) = this()
    def this(text: Unit, angle: Double) = this()
  }
  ...
  open class WrappedLabel ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.WrappedLabel {
    def this(displayText: String) = this()
    def this(displayText: String, angle: Double) = this()
    def this(displayText: Unit, angle: Double) = this()
  }
  ...
  open class XDragBoxLayer ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.XDragBoxLayer
  ...
  open class YDragBoxLayer ()
    extends typingsJapgolly.plottable.buildSrcComponentsMod.YDragBoxLayer
}
