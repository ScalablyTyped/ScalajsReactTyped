...
object Axes extends js.Object {
  ...
  class Category protected ()
    extends typingsJapgolly.plottable.axesMod.Category {
    /**
    ...
    def this(
      scale: typingsJapgolly.plottable.scalesMod.Category,
  ...
  class Numeric protected ()
    extends typingsJapgolly.plottable.axesMod.Numeric {
    /**
      ...
      */
    def this(
      scale: typingsJapgolly.plottable.quantitativeScaleMod.QuantitativeScale[Double],
      orientation: typingsJapgolly.plottable.axisMod.AxisOrientation
    ) = this()
  }
  ...
  class Time protected ()
    extends typingsJapgolly.plottable.axesMod.Time {
    /**
