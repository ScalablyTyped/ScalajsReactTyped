...
import typingsJapgolly.plottable.canvasDrawerMod.IFillStyle
import typingsJapgolly.plottable.canvasDrawerMod.IStrokeStyle
...
object drawersMod extends js.Object {
  ...
  class ArcOutlineSVGDrawer ()
    extends typingsJapgolly.plottable.arcOutlineDrawerMod.ArcOutlineSVGDrawer
  
  @js.native
  class ArcSVGDrawer ()
    extends typingsJapgolly.plottable.arcDrawerMod.ArcSVGDrawer
  
  @js.native
  class AreaSVGDrawer ()
    extends typingsJapgolly.plottable.areaDrawerMod.AreaSVGDrawer
  
  @js.native
  class CanvasDrawer protected ()
    extends typingsJapgolly.plottable.canvasDrawerMod.CanvasDrawer {
    /**
  ...
  @js.native
  class LineSVGDrawer ()
    extends typingsJapgolly.plottable.lineDrawerMod.LineSVGDrawer
  ...
  class ProxyDrawer protected ()
    ...
    /**
      ...
      */
    def this(
      _svgDrawerFactory: js.Function0[typingsJapgolly.plottable.svgDrawerMod.SVGDrawer],
      _canvasDrawerFactory: js.Function1[
            /* ctx */ CanvasRenderingContext2D, 
            typingsJapgolly.plottable.canvasDrawerMod.CanvasDrawer
          ]
    ) = this()
  }
  ...
  class RectangleCanvasDrawer protected ()
    extends typingsJapgolly.plottable.rectangleDrawerMod.RectangleCanvasDrawer {
    def this(ctx: CanvasRenderingContext2D) = this()
  }
  
  @js.native
  class RectangleSVGDrawer ()
    extends typingsJapgolly.plottable.rectangleDrawerMod.RectangleSVGDrawer {
    def this(_rootClassName: String) = this()
  }
  
  @js.native
  class SVGDrawer protected ()
    extends typingsJapgolly.plottable.svgDrawerMod.SVGDrawer {
    /**
  ...
  class SegmentSVGDrawer ()
    extends typingsJapgolly.plottable.segmentDrawerMod.SegmentSVGDrawer
  
  @js.native
  class SymbolSVGDrawer ()
    extends typingsJapgolly.plottable.symbolDrawerMod.SymbolSVGDrawer
