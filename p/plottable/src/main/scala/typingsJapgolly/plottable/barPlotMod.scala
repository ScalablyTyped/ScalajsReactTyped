...
import typingsJapgolly.plottable.commonsMod.ITransformableAccessorScaleBinding
import typingsJapgolly.plottable.datasetMod.Dataset
import typingsJapgolly.plottable.drawersMod.ProxyDrawer
import typingsJapgolly.plottable.formattersMod.DatumFormatter
...
object barPlotMod extends js.Object {
  ...
  object BarAlignment extends js.Object {
    var end: typingsJapgolly.plottable.plottableStrings.end = js.native
    var middle: typingsJapgolly.plottable.plottableStrings.middle = js.native
    var start: typingsJapgolly.plottable.plottableStrings.start = js.native
  }
  
  @js.native
  object BarOrientation extends js.Object {
    var horizontal: typingsJapgolly.plottable.plottableStrings.horizontal = js.native
    var vertical: typingsJapgolly.plottable.plottableStrings.vertical = js.native
  }
  ...
  object LabelsPosition extends js.Object {
    var end: typingsJapgolly.plottable.plottableStrings.end = js.native
    var middle: typingsJapgolly.plottable.plottableStrings.middle = js.native
    var outside: typingsJapgolly.plottable.plottableStrings.outside = js.native
    var start: typingsJapgolly.plottable.plottableStrings.start = js.native
  }
