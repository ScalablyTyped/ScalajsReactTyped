...
object buildSrcDispatchersTouchDispatcherMod {
  ...
  object Touch {
    ...
    /**
      ...
      */
    inline def getDispatcher(component: Component): typingsJapgolly.plottable.buildSrcDispatchersMod.Touch = ^.asInstanceOf[js.Dynamic].applyDynamic("getDispatcher")(component.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.plottable.buildSrcDispatchersMod.Touch]
  }
