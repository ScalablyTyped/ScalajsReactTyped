...
object buildSrcDispatchersMod {
  ...
  /**
    ...
    */
  open class Key ()
    extends typingsJapgolly.plottable.buildSrcDispatchersKeyDispatcherMod.Key
  /* static members */
  object Key {
  ...
  /* private */ open class Mouse ()
    extends typingsJapgolly.plottable.buildSrcDispatchersMouseDispatcherMod.Mouse
  /* static members */
  object Mouse {
  ...
  open class Touch protected ()
    extends typingsJapgolly.plottable.buildSrcDispatchersTouchDispatcherMod.Touch {
    /**
      * This constructor should not be invoked directly.
      *
