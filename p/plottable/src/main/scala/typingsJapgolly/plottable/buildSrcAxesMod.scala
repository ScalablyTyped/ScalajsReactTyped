...
object buildSrcAxesMod {
  
  @JSImport("plottable/build/src/axes", "Category")
  @js.native
  open class Category protected ()
    extends typingsJapgolly.plottable.buildSrcAxesCategoryAxisMod.Category {
    /**
  ...
  open class Numeric protected ()
    extends typingsJapgolly.plottable.buildSrcAxesNumericAxisMod.Numeric {
    /**
  ...
  open class Time protected ()
    extends typingsJapgolly.plottable.buildSrcAxesTimeAxisMod.Time {
    /**
