...
object buildSrcComponentsMod {
  ...
  open class AxisLabel ()
    extends typingsJapgolly.plottable.buildSrcComponentsLabelMod.AxisLabel {
  ...
  open class DragBoxLayer ()
    extends typingsJapgolly.plottable.buildSrcComponentsDragBoxLayerMod.DragBoxLayer
  
  @JSImport("plottable/build/src/components", "DragLineLayer")
  @js.native
  open class DragLineLayer[D] protected ()
    extends typingsJapgolly.plottable.buildSrcComponentsDragLineLayerMod.DragLineLayer[D] {
  ...
  open class Gridlines ()
    extends typingsJapgolly.plottable.buildSrcComponentsGridlinesMod.Gridlines {
  ...
  /**
    ...
    */
  open class Group ()
    extends typingsJapgolly.plottable.buildSrcComponentsGroupMod.Group {
  ...
  open class GuideLineLayer[D] protected ()
    extends typingsJapgolly.plottable.buildSrcComponentsGuideLineLayerMod.GuideLineLayer[D] {
    def this(orientation: String) = this()
  }
  /* static members */
  ...
  open class InterpolatedColorLegend protected ()
    extends typingsJapgolly.plottable.buildSrcComponentsInterpolatedColorLegendMod.InterpolatedColorLegend {
    /**
  ...
  /**
    ...
    */
  open class Label ()
    extends typingsJapgolly.plottable.buildSrcComponentsLabelMod.Label {
  ...
  open class Legend protected ()
    extends typingsJapgolly.plottable.buildSrcComponentsLegendMod.Legend {
    /**
  ...
  open class PlotGroup ()
    extends typingsJapgolly.plottable.buildSrcComponentsPlotGroupMod.PlotGroup {
    def this(components: js.Array[Component]) = this()
  }
  ...
  open class SelectionBoxLayer ()
    extends typingsJapgolly.plottable.buildSrcComponentsSelectionBoxLayerMod.SelectionBoxLayer
  ...
  /**
    ...
    */
  open class Table ()
    extends typingsJapgolly.plottable.buildSrcComponentsTableMod.Table {
  ...
  open class TitleLabel ()
    extends typingsJapgolly.plottable.buildSrcComponentsLabelMod.TitleLabel {
    def this(text: String) = this()
    def this(text: String, angle: Double) = this()
    def this(text: Unit, angle: Double) = this()
  }
  ...
  open class WrappedLabel ()
    extends typingsJapgolly.plottable.buildSrcComponentsWrappedLabelMod.WrappedLabel {
    def this(displayText: String) = this()
    def this(displayText: String, angle: Double) = this()
    def this(displayText: Unit, angle: Double) = this()
  }
  ...
  open class XDragBoxLayer ()
    extends typingsJapgolly.plottable.buildSrcComponentsXDragBoxLayerMod.XDragBoxLayer
  ...
  open class YDragBoxLayer ()
    extends typingsJapgolly.plottable.buildSrcComponentsYDragBoxLayerMod.YDragBoxLayer
}
