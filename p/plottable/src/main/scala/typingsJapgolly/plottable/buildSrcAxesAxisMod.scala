...
object buildSrcAxesAxisMod {
  ...
  /* keyof plottable.anon.Bottom */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.plottable.plottableStrings.left
    - typingsJapgolly.plottable.plottableStrings.top
    - typingsJapgolly.plottable.plottableStrings.bottom
    - typingsJapgolly.plottable.plottableStrings.right
  */
  ...
  object AxisOrientation {
    ...
    @js.native
    def left: typingsJapgolly.plottable.plottableStrings.left = js.native
    ...
    @js.native
    def right: typingsJapgolly.plottable.plottableStrings.right = js.native
