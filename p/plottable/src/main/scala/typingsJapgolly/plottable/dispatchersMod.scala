...
object dispatchersMod extends js.Object {
  ...
  /**
    ...
    */
  class Key ()
    extends typingsJapgolly.plottable.keyDispatcherMod.Key
  ...
  class Mouse protected ()
    extends typingsJapgolly.plottable.mouseDispatcherMod.Mouse
  
  @js.native
  class Touch protected ()
    extends typingsJapgolly.plottable.touchDispatcherMod.Touch {
    /**
      * This constructor should not be invoked directly.
      *
