...
import typingsJapgolly.plottable.anon.Y
...
import typingsJapgolly.plottable.buildSrcDrawersDrawStepMod.DrawStep
import typingsJapgolly.plottable.buildSrcDrawersDrawerMod.ProxyDrawer
import typingsJapgolly.plottable.buildSrcPlotsCommonsMod.IAccessorScaleBinding
import typingsJapgolly.plottable.buildSrcPlotsCommonsMod.ILightweightPlotEntity
...
import typingsJapgolly.plottable.buildSrcUtilsEntityStoreMod.IEntityStore
import typingsJapgolly.plottable.buildSrcUtilsMod.Map
...
object buildSrcPlotsPlotMod {
  ...
  open class Plot () extends Component {
    ...
    /**
      ...
      */
    /* protected */ def _createNodesForDataset(dataset: Dataset): typingsJapgolly.plottable.buildSrcDrawersMod.ProxyDrawer = js.native
    ...
    /**
      ...
      */
    /* protected */ var _propertyBindings: typingsJapgolly.std.Map[
  ...
  /* keyof plottable.anon.Canvas */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.plottable.plottableStrings.canvas
    - typingsJapgolly.plottable.plottableStrings.svg
  */
