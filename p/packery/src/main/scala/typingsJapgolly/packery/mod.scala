package typingsJapgolly.packery
...
object mod {
  ...
  open class Packery protected () extends StObject {
    ...
    /**
      ...
      */
    def addItems(elements: NodeList[Node]): Unit = js.native
    ...
    /**
      ...
      * @param {NodeList} elements [description]
      */
    def appended(elements: NodeList[Node]): Unit = js.native
    ...
    /**
      ...
      * @param {NodeList} elements [description]
      */
    def prepended(elements: NodeList[Node]): Unit = js.native
    ...
    /**
      ...
      * @param {NodeList} elements [description]
      */
    def stamp(elements: NodeList[Node]): Unit = js.native
    ...
    /**
      ...
      */
    def unstamp(element: NodeList[Node]): Unit = js.native
  }
