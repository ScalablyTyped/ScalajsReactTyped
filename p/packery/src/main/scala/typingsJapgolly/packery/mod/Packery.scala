...
class Packery protected () extends js.Object {
  ...
  /**
    ...
    */
  def addItems(elements: js.Array[typingsJapgolly.std.Element]): Unit = js.native
  /**
    * [addItems Add item elements to the Packery instance]
    * @param {Element} elements [description]
    */
  def addItems(elements: typingsJapgolly.std.Element): Unit = js.native
  /**
    * [addItems Add item elements to the Packery instance]
  ...
  /**
    ...
    * @param {Array<Element>} elements [description]
    */
  def appended(elements: js.Array[typingsJapgolly.std.Element]): Unit = js.native
  /**
    * [appended Add and lay out newly appended item elements]
    * @param {Element} elements [description]
    */
  def appended(elements: typingsJapgolly.std.Element): Unit = js.native
  /**
    * [appended Add and lay out newly appended item elements]
    * @param {NodeList} elements [description]
    */
  ...
  /**
    ...
    * @param {Array<Element>} elements [description]
    */
  def prepended(elements: js.Array[typingsJapgolly.std.Element]): Unit = js.native
  /**
    * [prepended Add and lay out newly prepended item elements at the beginning of layout]
    * @param {Element} elements [description]
    */
  def prepended(elements: typingsJapgolly.std.Element): Unit = js.native
  /**
    * [prepended Add and lay out newly prepended item elements at the beginning of layout]
    * @param {NodeList} elements [description]
    */
  ...
  /**
    ...
    * @param {Array<Element>} elements [description]
    */
  def stamp(elements: js.Array[typingsJapgolly.std.Element]): Unit = js.native
  /**
    * [stamp Stamp the elements in the layout. Packery will lay out item elements around stamped element]
    * @param {Element} elements [description]
    */
  def stamp(elements: typingsJapgolly.std.Element): Unit = js.native
  /**
    * [stamp Stamp the elements in the layout. Packery will lay out item elements around stamped element]
    * @param {NodeList} elements [description]
    */
  ...
  /**
    ...
    */
  def unstamp(element: js.Array[typingsJapgolly.std.Element]): Unit = js.native
  /**
    * [unstamp Un-stamp the elements, so that Packery will no longer layout item elements around them]
    * @param {Element} element [description]
    */
  def unstamp(element: typingsJapgolly.std.Element): Unit = js.native
  /**
    * [unstamp Un-stamp the elements, so that Packery will no longer layout item elements around them]
