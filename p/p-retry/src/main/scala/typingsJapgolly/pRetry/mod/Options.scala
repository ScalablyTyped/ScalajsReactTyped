...
object Options {
  ...
  def apply(
    ...
    onFailedAttempt: /* error */ FailedAttemptError => CallbackTo[Unit | js.Promise[Unit]] = null,
    ...
    if (onFailedAttempt != null) __obj.updateDynamic("onFailedAttempt")(js.Any.fromFunction1((t0: /* error */ typingsJapgolly.pRetry.mod.FailedAttemptError) => onFailedAttempt(t0).runNow()))
