...
import typingsJapgolly.passportInstagramToken.passportInstagramTokenBooleans.`false`
import typingsJapgolly.passportInstagramToken.passportInstagramTokenBooleans.`true`
