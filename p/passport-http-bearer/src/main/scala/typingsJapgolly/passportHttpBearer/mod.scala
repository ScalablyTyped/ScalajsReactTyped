...
import typingsJapgolly.expressServeStaticCore.mod.MediaType
...
object mod {
  ...
  object KoaPassportExpressRequestMock {
    ...
    extension [Self <: KoaPassportExpressRequestMock](x: Self) {
      ...
      inline def setAccepts(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "accepts", value.toJsFn)
      
      inline def setAcceptsCharsets(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "acceptsCharsets", value.toJsFn)
      
      inline def setAcceptsCharsetsUndefined: Self = StObject.set(x, "acceptsCharsets", js.undefined)
      
      inline def setAcceptsEncodings(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "acceptsEncodings", value.toJsFn)
      
      inline def setAcceptsEncodingsUndefined: Self = StObject.set(x, "acceptsEncodings", js.undefined)
      
      inline def setAcceptsLanguages(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "acceptsLanguages", value.toJsFn)
