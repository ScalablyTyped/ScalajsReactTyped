...
import typingsJapgolly.phonegapPluginPush.anon.Alert
import typingsJapgolly.phonegapPluginPush.anon.ApplicationServerKey
import typingsJapgolly.phonegapPluginPush.anon.ClearBadge
import typingsJapgolly.phonegapPluginPush.phonegapPluginPushStrings.error
import typingsJapgolly.phonegapPluginPush.phonegapPluginPushStrings.notification
import typingsJapgolly.phonegapPluginPush.phonegapPluginPushStrings.registration
...
object PhonegapPluginPush {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.phonegapPluginPush.PhonegapPluginPush.RegistrationEventResponse
    - typingsJapgolly.phonegapPluginPush.PhonegapPluginPush.NotificationEventResponse
    - js.Error
  */
  ...
  object _EventResponse {
    ...
    inline def NotificationEventResponse(
      ...
      val __obj = js.Dynamic.literal(additionalData = additionalData.asInstanceOf[js.Any], count = count.asInstanceOf[js.Any], image = image.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], sound = sound.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.phonegapPluginPush.PhonegapPluginPush.NotificationEventResponse]
    }
    
    inline def RegistrationEventResponse(registrationId: String): typingsJapgolly.phonegapPluginPush.PhonegapPluginPush.RegistrationEventResponse = {
      val __obj = js.Dynamic.literal(registrationId = registrationId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.phonegapPluginPush.PhonegapPluginPush.RegistrationEventResponse]
    }
  }
}
