...
trait TweenDefinition extends TransitionDefinition {
  ...
  var from: js.UndefOr[typingsJapgolly.popmotion.valueMod.Value] = js.undefined
  ...
  var to: js.UndefOr[typingsJapgolly.popmotion.valueMod.Value] = js.undefined
  var `type`: tween
...
object TweenDefinition {
  ...
  def apply(
    ...
    from: typingsJapgolly.popmotion.valueMod.Value = null,
    ...
    to: typingsJapgolly.popmotion.valueMod.Value = null,
