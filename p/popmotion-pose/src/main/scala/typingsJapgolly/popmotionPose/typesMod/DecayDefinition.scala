...
import typingsJapgolly.popmotion.decayTypesMod.ModifyTarget
import typingsJapgolly.popmotionPose.popmotionPoseStrings.decay
...
object DecayDefinition {
  ...
  def apply(
    ...
    max: Int | Double = null,
    min: Int | Double = null,
    modifyTarget: /* v */ Double => CallbackTo[Double] = null,
    ...
    if (modifyTarget != null) __obj.updateDynamic("modifyTarget")(js.Any.fromFunction1((t0: /* v */ scala.Double) => modifyTarget(t0).runNow()))
