...
version := "2.0-dt-20191022Z-2f8559"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "oauth" % "0.9-dt-20181015Z-c270fb",
  "org.scalablytyped.japgolly" %%% "passport" % "1.0-dt-20191119Z-ab0228",
  "org.scalablytyped.japgolly" %%% "passport-oauth2" % "1.4-dt-20181204Z-4622fc",
