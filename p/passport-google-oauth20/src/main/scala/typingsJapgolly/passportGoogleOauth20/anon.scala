...
import typingsJapgolly.passportGoogleOauth20.passportGoogleOauth20Strings.`false`
import typingsJapgolly.passportGoogleOauth20.passportGoogleOauth20Strings.`true`
