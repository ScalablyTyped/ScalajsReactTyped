...
import typingsJapgolly.poly2tri.mod.SweepContextOptions
import typingsJapgolly.poly2tri.mod.XY
...
object global {
  ...
  object poly2tri {
    ...
    /**
      ...
      */
    open class Point ()
      extends typingsJapgolly.poly2tri.mod.Point {
    ...
    object Point {
      ...
      /**
        ...
        */
      inline def add(a: XY, b: XY): typingsJapgolly.poly2tri.mod.Point = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.poly2tri.mod.Point]
      ...
      inline def cross(a: Double, b: XY): typingsJapgolly.poly2tri.mod.Point = (^.asInstanceOf[js.Dynamic].applyDynamic("cross")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.poly2tri.mod.Point]
      inline def cross(a: XY, b: Double): typingsJapgolly.poly2tri.mod.Point = (^.asInstanceOf[js.Dynamic].applyDynamic("cross")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.poly2tri.mod.Point]
      /**
      ...
      /**
        ...
        * @return the resulting Point object.
        */
      inline def mul(s: Double, p: XY): typingsJapgolly.poly2tri.mod.Point = (^.asInstanceOf[js.Dynamic].applyDynamic("mul")(s.asInstanceOf[js.Any], p.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.poly2tri.mod.Point]
      ...
      /**
        ...
        * @return the resulting Point object.
        */
      inline def negate(p: XY): typingsJapgolly.poly2tri.mod.Point = ^.asInstanceOf[js.Dynamic].applyDynamic("negate")(p.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.poly2tri.mod.Point]
      ...
      /**
        ...
        * @return the resulting Point object.
        */
      inline def sub(a: XY, b: XY): typingsJapgolly.poly2tri.mod.Point = (^.asInstanceOf[js.Dynamic].applyDynamic("sub")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.poly2tri.mod.Point]
    ...
    open class PointError protected ()
      extends typingsJapgolly.poly2tri.mod.PointError {
      /**
    ...
    open class SweepContext protected ()
      extends typingsJapgolly.poly2tri.mod.SweepContext {
      /**
    ...
    open class Triangle protected ()
      extends typingsJapgolly.poly2tri.mod.Triangle {
