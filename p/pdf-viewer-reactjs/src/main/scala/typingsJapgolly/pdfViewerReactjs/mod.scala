package typingsJapgolly.pdfViewerReactjs
...
object mod {
  ...
  object defaultProps {
    ...
    @js.native
    def document: js.UndefOr[org.scalajs.dom.Document] = js.native
    inline def document_=(x: js.UndefOr[org.scalajs.dom.Document]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("document")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def loader: js.UndefOr[Node] = js.native
    inline def loader_=(x: js.UndefOr[Node]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("loader")(x.asInstanceOf[js.Any])
  ...
  type AlertHandler = js.Function1[/* err */ Err, Node]
  ...
  type PDFViewer = japgolly.scalajs.react.facade.React.Component[PDFViewerProps & js.Object, js.Object]
  ...
  object PDFViewerProps {
    ...
    inline def apply(document: org.scalajs.dom.Document): PDFViewerProps = {
    ...
    extension [Self <: PDFViewerProps](x: Self) {
      ...
      inline def setAlert(value: /* err */ Err => Node): Self = StObject.set(x, "alert", js.Any.fromFunction1(value))
      ...
      inline def setGetMaxPageCount(value: /* pageCount */ Double => Callback): Self = StObject.set(x, "getMaxPageCount", js.Any.fromFunction1((t0: /* pageCount */ Double) => value(t0).runNow()))
      ...
      inline def setOnDocumentClick(value: Callback): Self = StObject.set(x, "onDocumentClick", value.toJsFn)
      
      inline def setOnDocumentClickUndefined: Self = StObject.set(x, "onDocumentClick", js.undefined)
      
      inline def setOnNextBtnClick(value: /* page */ Double => Callback): Self = StObject.set(x, "onNextBtnClick", js.Any.fromFunction1((t0: /* page */ Double) => value(t0).runNow()))
      
      inline def setOnNextBtnClickUndefined: Self = StObject.set(x, "onNextBtnClick", js.undefined)
      
      inline def setOnPrevBtnClick(value: /* page */ Double => Callback): Self = StObject.set(x, "onPrevBtnClick", js.Any.fromFunction1((t0: /* page */ Double) => value(t0).runNow()))
      
      inline def setOnPrevBtnClickUndefined: Self = StObject.set(x, "onPrevBtnClick", js.undefined)
      
      inline def setOnRotation(value: /* angle */ Double => Callback): Self = StObject.set(x, "onRotation", js.Any.fromFunction1((t0: /* angle */ Double) => value(t0).runNow()))
      
      inline def setOnRotationUndefined: Self = StObject.set(x, "onRotation", js.undefined)
      
      inline def setOnZoom(value: /* scale */ Double => Callback): Self = StObject.set(x, "onZoom", js.Any.fromFunction1((t0: /* scale */ Double) => value(t0).runNow()))
