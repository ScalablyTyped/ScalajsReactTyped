...
import typingsJapgolly.poseCore.poseCoreNumbers.`-1`
import typingsJapgolly.poseCore.poseCoreNumbers.`1`
...
object Pose {
  ...
  def apply[A, TD](
    ...
    if (preTransition != null) __obj.updateDynamic("preTransition")(js.Any.fromFunction1((t0: /* props */ typingsJapgolly.poseCore.typesMod.Props) => preTransition(t0).runNow()))
