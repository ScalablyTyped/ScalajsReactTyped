package typingsJapgolly.propDashTypes
...
package object propDashTypesMod {
  ...
  {[ K in keyof V ]: -? prop-types.prop-types.InferType<V[K]>}
    */ typingsJapgolly.propDashTypes.propDashTypesStrings.InferPropsInner with V
  ...
  */
  ...
  {[ K in keyof T ]:? prop-types.prop-types.Validator<T[K]>}
    */ typingsJapgolly.propDashTypes.propDashTypesStrings.ValidationMap with T
}
