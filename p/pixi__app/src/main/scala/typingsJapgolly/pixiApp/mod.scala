...
object mod {
  ...
  open class Application ()
    extends StObject
       with typingsJapgolly.pixiApp.GlobalMixins.Application {
  ...
  trait IApplicationOptions
    extends StObject
       ...
       with typingsJapgolly.pixiApp.GlobalMixins.IApplicationOptions
  ...
  object IApplicationPlugin {
    ...
    inline def apply(destroy: Callback, init: IApplicationOptions => Callback): IApplicationPlugin = {
      val __obj = js.Dynamic.literal(destroy = destroy.toJsFn, init = js.Any.fromFunction1((t0: IApplicationOptions) => init(t0).runNow()))
    ...
    extension [Self <: IApplicationPlugin](x: Self) {
      ...
      inline def setInit(value: IApplicationOptions => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: IApplicationOptions) => value(t0).runNow()))
    }
  }
  ...
  object ResizeableRenderer {
    ...
    inline def apply(resize: (/* desiredScreenWidth */ Double, /* desiredScreenHeight */ Double) => Callback): ResizeableRenderer = {
      val __obj = js.Dynamic.literal(resize = js.Any.fromFunction2((t0: /* desiredScreenWidth */ Double, t1: /* desiredScreenHeight */ Double) => (resize(t0, t1)).runNow()))
      __obj.asInstanceOf[ResizeableRenderer]
    }
    
    extension [Self <: ResizeableRenderer](x: Self) {
      
      inline def setResize(value: (/* desiredScreenWidth */ Double, /* desiredScreenHeight */ Double) => Callback): Self = StObject.set(x, "resize", js.Any.fromFunction2((t0: /* desiredScreenWidth */ Double, t1: /* desiredScreenHeight */ Double) => (value(t0, t1)).runNow()))
    }
  }
}
