...
import typingsJapgolly.popmotion.anon.Done
...
import typingsJapgolly.popmotion.popmotionStrings.loop
import typingsJapgolly.popmotion.popmotionStrings.mirror
import typingsJapgolly.popmotion.popmotionStrings.reverse
...
object libAnimationsTypesMod {
  ...
  object Animation {
    ...
    inline def apply[V](flipTarget: Callback, next: Double => Done[V]): Animation[V] = {
      val __obj = js.Dynamic.literal(flipTarget = flipTarget.toJsFn, next = js.Any.fromFunction1(next))
      __obj.asInstanceOf[Animation[V]]
    }
    
    extension [Self <: Animation[?], V](x: Self & Animation[V]) {
      
      inline def setFlipTarget(value: Callback): Self = StObject.set(x, "flipTarget", value.toJsFn)
  ...
  object DriverControls {
    ...
    inline def apply(start: Callback, stop: Callback): DriverControls = {
  ...
  object InertiaOptions {
    ...
    extension [Self <: InertiaOptions](x: Self) {
      ...
      inline def setOnUpdate(value: /* v */ Double => Callback): Self = StObject.set(x, "onUpdate", js.Any.fromFunction1((t0: /* v */ Double) => value(t0).runNow()))
  ...
  object PlaybackControls {
    ...
    inline def apply(stop: Callback): PlaybackControls = {
  ...
  object PlaybackOptions {
    ...
    extension [Self <: PlaybackOptions[?], V](x: Self & PlaybackOptions[V]) {
      ...
      inline def setOnRepeat(value: Callback): Self = StObject.set(x, "onRepeat", value.toJsFn)
      ...
      inline def setOnUpdate(value: /* latest */ V => Callback): Self = StObject.set(x, "onUpdate", js.Any.fromFunction1((t0: /* latest */ V) => value(t0).runNow()))
