package typingsJapgolly.prepper

import typingsJapgolly.node.eventsMod.EventEmitter
import typingsJapgolly.node.eventsMod.EventEmitterOptions
import typingsJapgolly.prepper.anon.Exclude
import typingsJapgolly.prepper.anon.Invert
import typingsJapgolly.prepper.anon.Level
import typingsJapgolly.prepper.anon.Size
import typingsJapgolly.prepper.mod.handlers.Handler
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.prepper.prepperStrings.trace
    - typingsJapgolly.prepper.prepperStrings.debug
    - typingsJapgolly.prepper.prepperStrings.info
    - typingsJapgolly.prepper.prepperStrings.warn
    - typingsJapgolly.prepper.prepperStrings.error
    - typingsJapgolly.prepper.prepperStrings.fatal
  */
  trait LogLevel extends StObject
  object LogLevel {
    
    inline def debug: typingsJapgolly.prepper.prepperStrings.debug = "debug".asInstanceOf[typingsJapgolly.prepper.prepperStrings.debug]
    
    inline def error: typingsJapgolly.prepper.prepperStrings.error = "error".asInstanceOf[typingsJapgolly.prepper.prepperStrings.error]
    
    inline def fatal: typingsJapgolly.prepper.prepperStrings.fatal = "fatal".asInstanceOf[typingsJapgolly.prepper.prepperStrings.fatal]
    
    inline def info: typingsJapgolly.prepper.prepperStrings.info = "info".asInstanceOf[typingsJapgolly.prepper.prepperStrings.info]
    
    inline def trace: typingsJapgolly.prepper.prepperStrings.trace = "trace".asInstanceOf[typingsJapgolly.prepper.prepperStrings.trace]
    
    inline def warn: typingsJapgolly.prepper.prepperStrings.warn = "warn".asInstanceOf[typingsJapgolly.prepper.prepperStrings.warn]
  }
