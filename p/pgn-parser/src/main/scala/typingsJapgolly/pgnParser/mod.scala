package typingsJapgolly.pgnParser
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pgnParser.pgnParserStrings.`1-0`
    - typingsJapgolly.pgnParser.pgnParserStrings.`0-1`
    - typingsJapgolly.pgnParser.pgnParserStrings.`1Slash2-1Slash2`
    - typingsJapgolly.pgnParser.pgnParserStrings.Asterisk
  */
  trait Result extends StObject
  object Result {
    
    inline def `0-1`: typingsJapgolly.pgnParser.pgnParserStrings.`0-1` = "0-1".asInstanceOf[typingsJapgolly.pgnParser.pgnParserStrings.`0-1`]
    
    inline def `1-0`: typingsJapgolly.pgnParser.pgnParserStrings.`1-0` = "1-0".asInstanceOf[typingsJapgolly.pgnParser.pgnParserStrings.`1-0`]
    
    inline def `1Slash2-1Slash2`: typingsJapgolly.pgnParser.pgnParserStrings.`1Slash2-1Slash2` = "1/2-1/2".asInstanceOf[typingsJapgolly.pgnParser.pgnParserStrings.`1Slash2-1Slash2`]
    
    inline def Asterisk: typingsJapgolly.pgnParser.pgnParserStrings.Asterisk = "*".asInstanceOf[typingsJapgolly.pgnParser.pgnParserStrings.Asterisk]
  }
