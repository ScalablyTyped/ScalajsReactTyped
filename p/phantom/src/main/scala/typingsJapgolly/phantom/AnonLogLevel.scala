...
import typingsJapgolly.phantom.phantomStrings.debug
import typingsJapgolly.phantom.phantomStrings.error
import typingsJapgolly.phantom.phantomStrings.info
import typingsJapgolly.phantom.phantomStrings.warn
