package typingsJapgolly.promiseFnRetry
...
object mod {
  ...
  object RetryOptions {
    ...
    extension [Self <: RetryOptions](x: Self) {
      ...
      inline def setOnRetry(value: (/* err */ Any, /* optionsParsed */ RetryControlOptions) => Callback): Self = StObject.set(x, "onRetry", js.Any.fromFunction2((t0: /* err */ Any, t1: /* optionsParsed */ RetryControlOptions) => (value(t0, t1)).runNow()))
