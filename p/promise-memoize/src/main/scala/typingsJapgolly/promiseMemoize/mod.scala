...
import typingsJapgolly.promiseMemoize.anon.Clear
import typingsJapgolly.promiseMemoize.promiseMemoizeStrings.json
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - js.Array[
  typingsJapgolly.promiseMemoize.promiseMemoizeStrings.json | (js.Function1[/ * arg * / scala.Any, scala.Any])]
  */
