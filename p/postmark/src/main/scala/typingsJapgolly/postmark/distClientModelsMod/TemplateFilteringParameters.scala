...
open class TemplateFilteringParameters ()
  extends typingsJapgolly.postmark.distClientModelsTemplatesTemplateMod.TemplateFilteringParameters {
  ...
  def this(
    count: Double,
    offset: Double,
    templateType: typingsJapgolly.postmark.distClientModelsTemplatesTemplateMod.TemplateTypes
  ) = this()
  def this(
    count: Double,
    offset: Unit,
