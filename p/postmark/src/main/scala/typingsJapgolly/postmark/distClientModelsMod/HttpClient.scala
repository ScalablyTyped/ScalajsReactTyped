...
import typingsJapgolly.postmark.distClientModelsClientClientOptionsMod.ClientOptions.Configuration
...
/* protected */ open class HttpClient ()
  extends typingsJapgolly.postmark.distClientModelsClientHttpClientMod.HttpClient {
