...
@js.native
open class OutboundMessageTrackingFilteringParameters protected ()
  extends typingsJapgolly.postmark.distClientModelsMessagesMessageFilteringParametersMod.OutboundMessageTrackingFilteringParameters {
  def this(
