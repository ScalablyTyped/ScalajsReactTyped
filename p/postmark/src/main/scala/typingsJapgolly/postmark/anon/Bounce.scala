...
import typingsJapgolly.postmark.distClientModelsWebhooksWebhookMod.BounceWebhookTrigger
import typingsJapgolly.postmark.distClientModelsWebhooksWebhookMod.OpenWebhookTrigger
import typingsJapgolly.postmark.distClientModelsWebhooksWebhookMod.SpamWebhookTrigger
import typingsJapgolly.postmark.distClientModelsWebhooksWebhookMod.WebhookTrigger
