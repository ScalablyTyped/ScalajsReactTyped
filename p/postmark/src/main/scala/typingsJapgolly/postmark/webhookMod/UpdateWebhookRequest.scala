package typingsJapgolly.postmark.webhookMod

import typingsJapgolly.postmark.messageSupportingTypesMod.Header
...
class UpdateWebhookRequest () extends js.Object {
  ...
  var HttpAuth: js.UndefOr[typingsJapgolly.postmark.webhookMod.HttpAuth] = js.native
