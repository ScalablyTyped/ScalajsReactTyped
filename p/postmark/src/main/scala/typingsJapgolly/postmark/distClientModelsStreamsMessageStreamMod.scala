...
object distClientModelsStreamsMessageStreamMod {
  ...
  open class CreateMessageStreamRequest protected () extends StObject {
    ...
    var SubscriptionManagementConfiguration: js.UndefOr[
        typingsJapgolly.postmark.distClientModelsStreamsMessageStreamMod.SubscriptionManagementConfiguration
      ] = js.native
  }
  ...
  object UnsubscribeHandlingTypes extends StObject {
    ...
    /* "Custom" */ val Custom: typingsJapgolly.postmark.distClientModelsStreamsMessageStreamMod.UnsubscribeHandlingTypes.Custom & String = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with UnsubscribeHandlingTypes
    /* "None" */ val None: typingsJapgolly.postmark.distClientModelsStreamsMessageStreamMod.UnsubscribeHandlingTypes.None & String = js.native
    
    @js.native
    sealed trait Postmark
      extends StObject
         with UnsubscribeHandlingTypes
    /* "Postmark" */ val Postmark: typingsJapgolly.postmark.distClientModelsStreamsMessageStreamMod.UnsubscribeHandlingTypes.Postmark & String = js.native
  }
  ...
  trait MessageStream extends StObject {
    ...
    var SubscriptionManagementConfiguration: typingsJapgolly.postmark.distClientModelsStreamsMessageStreamMod.SubscriptionManagementConfiguration
