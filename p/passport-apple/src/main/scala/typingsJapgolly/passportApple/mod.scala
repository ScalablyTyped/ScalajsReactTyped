...
import typingsJapgolly.passportApple.passportAppleBooleans.`false`
import typingsJapgolly.passportApple.passportAppleBooleans.`true`
import typingsJapgolly.passportApple.passportAppleStrings.`name email`
import typingsJapgolly.passportApple.passportAppleStrings.apple
import typingsJapgolly.passportApple.passportAppleStrings.form_post
