...
import typingsJapgolly.pexrtc.PexRTC.AudioStatistics
import typingsJapgolly.pexrtc.PexRTC.LayoutTypes
import typingsJapgolly.pexrtc.PexRTC.VideoStatistics
import typingsJapgolly.pexrtc.pexrtcStrings.`video-only`
import typingsJapgolly.pexrtc.pexrtcStrings.audio
import typingsJapgolly.pexrtc.pexrtcStrings.keep_conference_alive
import typingsJapgolly.pexrtc.pexrtcStrings.keep_conference_alive_if_multiple
import typingsJapgolly.pexrtc.pexrtcStrings.keep_conference_alive_never
import typingsJapgolly.pexrtc.pexrtcStrings.video
...
object anon {
  ...
  trait Calltype extends StObject {
    ...
    var keep_conference_alive: js.UndefOr[
        typingsJapgolly.pexrtc.pexrtcStrings.keep_conference_alive | keep_conference_alive_if_multiple | keep_conference_alive_never
      ] = js.undefined
