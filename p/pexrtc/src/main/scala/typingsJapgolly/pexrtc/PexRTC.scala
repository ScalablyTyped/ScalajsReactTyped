package typingsJapgolly.pexrtc

import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.EventSource
import org.scalajs.dom.MediaStream
import typingsJapgolly.pexrtc.PexRTC.AnyParticipant
import typingsJapgolly.pexrtc.PexRTC.CallTypes
import typingsJapgolly.pexrtc.PexRTC.ChatMessage
import typingsJapgolly.pexrtc.PexRTC.LayoutResponse
import typingsJapgolly.pexrtc.PexRTC.Participant
import typingsJapgolly.pexrtc.PexRTC.ParticipantRole
import typingsJapgolly.pexrtc.PexRTC.PexMediaStream
import typingsJapgolly.pexrtc.PexRTC.PinStatus
import typingsJapgolly.pexrtc.PexRTC.Role
import typingsJapgolly.pexrtc.PexRTC.ServiceType
import typingsJapgolly.pexrtc.PexRTC.Statistics
import typingsJapgolly.pexrtc.anon.Audio
import typingsJapgolly.pexrtc.anon.Calltype
import typingsJapgolly.pexrtc.anon.Credential
import typingsJapgolly.pexrtc.anon.Enableactivespeakerindication
import typingsJapgolly.pexrtc.anon.Guestmuted
import typingsJapgolly.pexrtc.anon.IceServers
import typingsJapgolly.pexrtc.anon.MutedAudio
import typingsJapgolly.pexrtc.anon.Participantuuid
import typingsJapgolly.pexrtc.anon.PickAnyParticipantuuid
import typingsJapgolly.pexrtc.anon.Result
import typingsJapgolly.pexrtc.anon.Status
import typingsJapgolly.pexrtc.pexrtcBooleans.`false`
import typingsJapgolly.pexrtc.pexrtcStrings.allow
import typingsJapgolly.pexrtc.pexrtcStrings.auto
import typingsJapgolly.pexrtc.pexrtcStrings.chair
import typingsJapgolly.pexrtc.pexrtcStrings.continue
import typingsJapgolly.pexrtc.pexrtcStrings.deny
import typingsJapgolly.pexrtc.pexrtcStrings.down
import typingsJapgolly.pexrtc.pexrtcStrings.gateway
import typingsJapgolly.pexrtc.pexrtcStrings.guest_
import typingsJapgolly.pexrtc.pexrtcStrings.h323
import typingsJapgolly.pexrtc.pexrtcStrings.in
import typingsJapgolly.pexrtc.pexrtcStrings.left
import typingsJapgolly.pexrtc.pexrtcStrings.mssip
import typingsJapgolly.pexrtc.pexrtcStrings.out
import typingsJapgolly.pexrtc.pexrtcStrings.pan
import typingsJapgolly.pexrtc.pexrtcStrings.right
import typingsJapgolly.pexrtc.pexrtcStrings.rtmp
import typingsJapgolly.pexrtc.pexrtcStrings.screen
import typingsJapgolly.pexrtc.pexrtcStrings.sip
import typingsJapgolly.pexrtc.pexrtcStrings.standard
import typingsJapgolly.pexrtc.pexrtcStrings.start
import typingsJapgolly.pexrtc.pexrtcStrings.stop
import typingsJapgolly.pexrtc.pexrtcStrings.test_call
import typingsJapgolly.pexrtc.pexrtcStrings.tilt
import typingsJapgolly.pexrtc.pexrtcStrings.up
import typingsJapgolly.pexrtc.pexrtcStrings.zoom
...
trait PexRTC extends StObject {
  ...
  val service_type: typingsJapgolly.pexrtc.pexrtcStrings.conference | gateway | test_call = js.native
...
object PexRTC {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pexrtc.PexRTC.GuestParticipant
    - typingsJapgolly.pexrtc.PexRTC.HostParticipant
  */
  ...
  object AnyParticipant {
    ...
    inline def GuestParticipant(
      ...
      __obj.asInstanceOf[typingsJapgolly.pexrtc.PexRTC.GuestParticipant]
    }
    ...
    inline def HostParticipant(
      ...
      __obj.asInstanceOf[typingsJapgolly.pexrtc.PexRTC.HostParticipant]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pexrtc.pexrtcStrings.presentation
    - typingsJapgolly.pexrtc.pexrtcStrings.screen
    - typingsJapgolly.pexrtc.pexrtcStrings.audioonly
    - typingsJapgolly.pexrtc.pexrtcStrings.recvonly
    - typingsJapgolly.pexrtc.pexrtcStrings.rtmp
    - typingsJapgolly.pexrtc.pexrtcStrings.stream
    - typingsJapgolly.pexrtc.pexrtcStrings.none
  */
  trait CallTypes extends StObject
  object CallTypes {
    
    inline def audioonly: typingsJapgolly.pexrtc.pexrtcStrings.audioonly = "audioonly".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.audioonly]
    
    inline def none: typingsJapgolly.pexrtc.pexrtcStrings.none = "none".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.none]
    
    inline def presentation: typingsJapgolly.pexrtc.pexrtcStrings.presentation = "presentation".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.presentation]
    
    inline def recvonly: typingsJapgolly.pexrtc.pexrtcStrings.recvonly = "recvonly".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.recvonly]
    
    inline def rtmp: typingsJapgolly.pexrtc.pexrtcStrings.rtmp = "rtmp".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.rtmp]
    
    inline def screen: typingsJapgolly.pexrtc.pexrtcStrings.screen = "screen".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.screen]
    
    inline def stream: typingsJapgolly.pexrtc.pexrtcStrings.stream = "stream".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.stream]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pexrtc.pexrtcStrings.`1Colon0`
    - typingsJapgolly.pexrtc.pexrtcStrings.`1Colon7`
    - typingsJapgolly.pexrtc.pexrtcStrings.`1Colon21`
    - typingsJapgolly.pexrtc.pexrtcStrings.`2Colon21`
    - typingsJapgolly.pexrtc.pexrtcStrings.`4Colon0`
    - typingsJapgolly.pexrtc.pexrtcStrings.`5Colon7`
    - typingsJapgolly.pexrtc.pexrtcStrings.ac
  */
  trait LayoutTypes extends StObject
  object LayoutTypes {
    
    inline def `1Colon0`: typingsJapgolly.pexrtc.pexrtcStrings.`1Colon0` = "1:0".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.`1Colon0`]
    
    inline def `1Colon21`: typingsJapgolly.pexrtc.pexrtcStrings.`1Colon21` = "1:21".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.`1Colon21`]
    
    inline def `1Colon7`: typingsJapgolly.pexrtc.pexrtcStrings.`1Colon7` = "1:7".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.`1Colon7`]
    
    inline def `2Colon21`: typingsJapgolly.pexrtc.pexrtcStrings.`2Colon21` = "2:21".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.`2Colon21`]
    
    inline def `4Colon0`: typingsJapgolly.pexrtc.pexrtcStrings.`4Colon0` = "4:0".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.`4Colon0`]
    
    inline def `5Colon7`: typingsJapgolly.pexrtc.pexrtcStrings.`5Colon7` = "5:7".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.`5Colon7`]
    
    inline def ac: typingsJapgolly.pexrtc.pexrtcStrings.ac = "ac".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.ac]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pexrtc.pexrtcStrings.chair
    - typingsJapgolly.pexrtc.pexrtcStrings.guest_
  */
  trait ParticipantRole extends StObject
  object ParticipantRole {
    
    inline def chair: typingsJapgolly.pexrtc.pexrtcStrings.chair = "chair".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.chair]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pexrtc.pexrtcStrings.none
    - typingsJapgolly.pexrtc.pexrtcStrings.required
    - typingsJapgolly.pexrtc.pexrtcStrings.optional
  */
  ...
  object PinStatus {
    ...
    inline def optional: typingsJapgolly.pexrtc.pexrtcStrings.optional = "optional".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.optional]
    
    inline def required: typingsJapgolly.pexrtc.pexrtcStrings.required = "required".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.required]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pexrtc.pexrtcStrings.HOST
    - typingsJapgolly.pexrtc.pexrtcStrings.GUEST
  */
  trait Role extends StObject
  object Role {
    
    inline def GUEST: typingsJapgolly.pexrtc.pexrtcStrings.GUEST = "GUEST".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.GUEST]
    
    inline def HOST: typingsJapgolly.pexrtc.pexrtcStrings.HOST = "HOST".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.HOST]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pexrtc.pexrtcStrings.connecting
    - typingsJapgolly.pexrtc.pexrtcStrings.waiting_room
    - typingsJapgolly.pexrtc.pexrtcStrings.ivr
    - typingsJapgolly.pexrtc.pexrtcStrings.conference
    - typingsJapgolly.pexrtc.pexrtcStrings.lecture
    - typingsJapgolly.pexrtc.pexrtcStrings.gateway
    - typingsJapgolly.pexrtc.pexrtcStrings.test_call
  */
  trait ServiceType extends StObject
  object ServiceType {
    
    inline def conference: typingsJapgolly.pexrtc.pexrtcStrings.conference = "conference".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.conference]
    
    inline def connecting: typingsJapgolly.pexrtc.pexrtcStrings.connecting = "connecting".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.connecting]
    
    inline def gateway: typingsJapgolly.pexrtc.pexrtcStrings.gateway = "gateway".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.gateway]
    
    inline def ivr: typingsJapgolly.pexrtc.pexrtcStrings.ivr = "ivr".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.ivr]
    
    inline def lecture: typingsJapgolly.pexrtc.pexrtcStrings.lecture = "lecture".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.lecture]
    
    inline def test_call: typingsJapgolly.pexrtc.pexrtcStrings.test_call = "test_call".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.test_call]
    
    inline def waiting_room: typingsJapgolly.pexrtc.pexrtcStrings.waiting_room = "waiting_room".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.waiting_room]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pexrtc.pexrtcStrings.YES
    - typingsJapgolly.pexrtc.pexrtcStrings.NO
  */
  trait YesNo extends StObject
  object YesNo {
    
    inline def NO: typingsJapgolly.pexrtc.pexrtcStrings.NO = "NO".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.NO]
    
    inline def YES: typingsJapgolly.pexrtc.pexrtcStrings.YES = "YES".asInstanceOf[typingsJapgolly.pexrtc.pexrtcStrings.YES]
  }
}
