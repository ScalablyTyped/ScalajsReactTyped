package typingsJapgolly.pbf2json

import typingsJapgolly.node.streamMod.Transform
import typingsJapgolly.pbf2json.anon.E
import typingsJapgolly.pbf2json.pbf2jsonStrings.entrance
import typingsJapgolly.pbf2json.pbf2jsonStrings.node
import typingsJapgolly.pbf2json.pbf2jsonStrings.relation
import typingsJapgolly.pbf2json.pbf2jsonStrings.way
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pbf2json.mod.Node
    - typingsJapgolly.pbf2json.mod.Way
    - typingsJapgolly.pbf2json.mod.Relation
  */
  trait Item extends StObject
  object Item {
    
    inline def Node(id: Double, lat: Double, lon: Double, tags: Tags): typingsJapgolly.pbf2json.mod.Node = {
      ...
      __obj.asInstanceOf[typingsJapgolly.pbf2json.mod.Node]
    }
    
    inline def Relation(bounds: E, centroid: Centroid, id: Double, tags: Tags): typingsJapgolly.pbf2json.mod.Relation = {
      ...
      __obj.asInstanceOf[typingsJapgolly.pbf2json.mod.Relation]
    }
    
    inline def Way(bounds: E, centroid: Centroid, id: Double, nodes: js.Array[Coordinate], tags: Tags): typingsJapgolly.pbf2json.mod.Way = {
      ...
      __obj.asInstanceOf[typingsJapgolly.pbf2json.mod.Way]
    }
  }
