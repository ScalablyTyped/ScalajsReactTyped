...
import typingsJapgolly.pdfFillForm.anon.Id
...
object mod {
  ...
  - typingsJapgolly.pdfFillForm.mod.Options because Already inherited */ trait ImgPdfOptions
    extends StObject
       with PdfOptions {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pdfFillForm.mod.PdfOptions
    - typingsJapgolly.pdfFillForm.mod.ImgPdfOptions
  */
  trait Options extends StObject
  object Options {
    
    inline def ImgPdfOptions(): typingsJapgolly.pdfFillForm.mod.ImgPdfOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.pdfFillForm.mod.ImgPdfOptions]
    }
    
    inline def PdfOptions(): typingsJapgolly.pdfFillForm.mod.PdfOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.pdfFillForm.mod.PdfOptions]
    }
  }
