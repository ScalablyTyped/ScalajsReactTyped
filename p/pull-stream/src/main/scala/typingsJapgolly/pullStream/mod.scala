...
object mod {
  ...
  object Duplex {
    ...
    inline def apply[In, Out](
      sink: /* source */ Source[Out] => Callback,
      source: (/* endOrError */ Abort, /* cb */ SourceCallback[In]) => Callback
    ): Duplex[In, Out] = {
      val __obj = js.Dynamic.literal(sink = js.Any.fromFunction1((t0: /* source */ Source[Out]) => sink(t0).runNow()), source = js.Any.fromFunction2((t0: /* endOrError */ Abort, t1: /* cb */ SourceCallback[In]) => (source(t0, t1)).runNow()))
  ...
  object DuplexSink {
    ...
    inline def apply[Out](sink: /* source */ Source[Out] => Callback): DuplexSink[Out] = {
      val __obj = js.Dynamic.literal(sink = js.Any.fromFunction1((t0: /* source */ Source[Out]) => sink(t0).runNow()))
      __obj.asInstanceOf[DuplexSink[Out]]
    }
    
    extension [Self <: DuplexSink[?], Out](x: Self & DuplexSink[Out]) {
      
      inline def setSink(value: /* source */ Source[Out] => Callback): Self = StObject.set(x, "sink", js.Any.fromFunction1((t0: /* source */ Source[Out]) => value(t0).runNow()))
    }
  }
  ...
  object DuplexSource {
    ...
    inline def apply[In](source: (/* endOrError */ Abort, /* cb */ SourceCallback[In]) => Callback): DuplexSource[In] = {
      val __obj = js.Dynamic.literal(source = js.Any.fromFunction2((t0: /* endOrError */ Abort, t1: /* cb */ SourceCallback[In]) => (source(t0, t1)).runNow()))
      __obj.asInstanceOf[DuplexSource[In]]
    }
    
    extension [Self <: DuplexSource[?], In](x: Self & DuplexSource[In]) {
      
      inline def setSource(value: (/* endOrError */ Abort, /* cb */ SourceCallback[In]) => Callback): Self = StObject.set(x, "source", js.Any.fromFunction2((t0: /* endOrError */ Abort, t1: /* cb */ SourceCallback[In]) => (value(t0, t1)).runNow()))
    }
  }
