...
object sinksMod {
  ...
  inline def collect[T](cb: js.Function2[/* err */ EndOrError, /* results */ js.Array[T], Any]): Sink[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("collect")(cb.asInstanceOf[js.Any]).asInstanceOf[Sink[T]]
  
  @JSImport("pull-stream/sinks", "concat")
  @js.native
  val concat: js.Function1[
    /* cb */ js.UndefOr[js.Function2[/* err */ EndOrError, /* result */ String, Any]], 
    Sink[String]
  ] = js.native
  
  inline def drain[T](): Sink[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("drain")().asInstanceOf[Sink[T]]
  inline def drain[T](op: js.Function1[/* data */ T, Any]): Sink[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("drain")(op.asInstanceOf[js.Any]).asInstanceOf[Sink[T]]
  inline def drain[T](op: js.Function1[/* data */ T, Any], cb: js.Function1[/* err */ EndOrError, Any]): Sink[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("drain")(op.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Sink[T]]
  inline def drain[T](op: Unit, cb: js.Function1[/* err */ EndOrError, Any]): Sink[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("drain")(op.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Sink[T]]
  
  inline def find[T](): Sink[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("find")().asInstanceOf[Sink[T]]
  inline def find[T](cb: js.Function2[/* err */ EndOrError, /* results */ js.Array[T], Any]): Sink[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("find")(cb.asInstanceOf[js.Any]).asInstanceOf[Sink[T]]
  ...
  inline def find[T](test: /* keyof T */ String, cb: js.Function2[/* err */ EndOrError, /* result */ T, Any]): Sink[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("find")(test.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Sink[T]]
  ...
  @js.native
  val log: js.Function0[Sink[Any]] = js.native
  
  @JSImport("pull-stream/sinks", "onEnd")
  @js.native
  val onEnd: js.Function1[/* cb */ js.UndefOr[js.Function1[/* err */ EndOrError, Any]], Sink[Any]] = js.native
