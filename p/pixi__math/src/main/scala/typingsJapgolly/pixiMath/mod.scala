package typingsJapgolly.pixiMath

import typingsJapgolly.pixiMath.mod.SHAPES.CIRC
import typingsJapgolly.pixiMath.mod.SHAPES.ELIP
import typingsJapgolly.pixiMath.mod.SHAPES.POLY
import typingsJapgolly.pixiMath.mod.SHAPES.RECT
import typingsJapgolly.pixiMath.mod.SHAPES.RREC
...
object mod {
  ...
  open class ObservablePoint[T] protected ()
    extends StObject
       with IPoint
       with typingsJapgolly.pixiMath.GlobalMixins.Point {
    /**
  ...
  open class Rectangle protected ()
    extends StObject
       with typingsJapgolly.pixiMath.GlobalMixins.Rectangle
       with IShape {
    /**
  ...
  open class Transform ()
    extends StObject
       with typingsJapgolly.pixiMath.GlobalMixins.Transform {
  ...
  trait IPointData
    extends StObject
       with typingsJapgolly.pixiMath.GlobalMixins.IPointData {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pixiMath.mod.Circle
    - typingsJapgolly.pixiMath.mod.Ellipse
    - typingsJapgolly.pixiMath.mod.Polygon
    - typingsJapgolly.pixiMath.mod.Rectangle
    - typingsJapgolly.pixiMath.mod.RoundedRectangle
  */
