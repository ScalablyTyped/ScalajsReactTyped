...
open class Button ()
  extends StObject
     with typingsJapgolly.photonui.photonui.Button {
  ...
  /* CompleteClass */
  var leftIcon: typingsJapgolly.photonui.photonui.BaseIcon = js.native
  ...
  /* CompleteClass */
  var rightIcon: typingsJapgolly.photonui.photonui.BaseIcon = js.native
