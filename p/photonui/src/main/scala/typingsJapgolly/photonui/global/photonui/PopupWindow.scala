...
open class PopupWindow ()
  extends StObject
     with typingsJapgolly.photonui.photonui.PopupWindow {
  ...
  /* CompleteClass */
  override def popupWidget(widget: typingsJapgolly.photonui.photonui.Widget): Unit = js.native
  
  /* CompleteClass */
  override def popupXY(x: Double, y: Double): Unit = js.native
