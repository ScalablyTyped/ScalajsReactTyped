...
open class ColorPickerDialog ()
  extends StObject
     with typingsJapgolly.photonui.photonui.ColorPickerDialog {
  
  /* CompleteClass */
  var absolutePosition: X = js.native
  
  /* CompleteClass */
  override def addButton(widget: typingsJapgolly.photonui.photonui.Widget, layoutOptions: Any): Unit = js.native
  ...
  /* CompleteClass */
  var buttons: js.Array[typingsJapgolly.photonui.photonui.Widget] = js.native
  ...
  /* CompleteClass */
  override def removeButton(widget: typingsJapgolly.photonui.photonui.Widget): Unit = js.native
