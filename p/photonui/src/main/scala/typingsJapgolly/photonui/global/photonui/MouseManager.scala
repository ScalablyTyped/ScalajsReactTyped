...
open class MouseManager ()
  extends StObject
     with typingsJapgolly.photonui.photonui.MouseManager {
  def this(element: HTMLElement) = this()
  def this(element: typingsJapgolly.photonui.photonui.Widget) = this()
  ...
  def this(element: typingsJapgolly.photonui.photonui.Widget, params: StringDictionary[Any]) = this()
