...
object Window {
  ...
  extension [Self <: Window](x: Self) {
    ...
    inline def setMoveToBack(value: Callback): Self = StObject.set(x, "moveToBack", value.toJsFn)
    
    inline def setMoveToFront(value: Callback): Self = StObject.set(x, "moveToFront", value.toJsFn)
