...
import typingsJapgolly.pnpmNpmConf.pnpmNpmConfBooleans.`false`
import typingsJapgolly.pnpmNpmConf.pnpmNpmConfBooleans.`true`
...
object anon {
  ...
  trait TypeofimportedUrl extends StObject {
    ...
    /**
      ...
      */
    var URLSearchParams: Instantiable0[typingsJapgolly.node.urlMod.URLSearchParams] = js.native
