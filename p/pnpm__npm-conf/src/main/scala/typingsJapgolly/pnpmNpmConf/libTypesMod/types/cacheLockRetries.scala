...
object cacheLockRetries {
  ...
  /* standard es5 */
  inline def apply(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("cache-lock-retries")().asInstanceOf[Double]
  inline def apply(value: Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("cache-lock-retries")(value.asInstanceOf[js.Any]).asInstanceOf[Double]
}
