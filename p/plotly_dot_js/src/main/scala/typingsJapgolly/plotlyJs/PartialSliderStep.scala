...
import typingsJapgolly.plotlyJs.plotlyJsStrings.relayout
import typingsJapgolly.plotlyJs.plotlyJsStrings.restyle
import typingsJapgolly.plotlyJs.plotlyJsStrings.skip
import typingsJapgolly.plotlyJs.plotlyJsStrings.update
