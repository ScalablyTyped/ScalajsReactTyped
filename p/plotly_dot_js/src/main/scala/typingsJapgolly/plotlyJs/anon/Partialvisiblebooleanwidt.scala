...
trait Partialvisiblebooleanwidt extends StObject {
  ...
  var fillcolor: js.UndefOr[typingsJapgolly.plotlyJs.mod.Color] = js.undefined
...
object Partialvisiblebooleanwidt {
  ...
  extension [Self <: Partialvisiblebooleanwidt](x: Self) {
    ...
    inline def setFillcolor(value: typingsJapgolly.plotlyJs.mod.Color): Self = StObject.set(x, "fillcolor", value.asInstanceOf[js.Any])
