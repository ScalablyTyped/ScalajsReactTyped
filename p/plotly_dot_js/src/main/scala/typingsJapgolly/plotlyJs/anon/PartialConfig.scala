...
trait PartialConfig extends StObject {
  ...
  var logging: js.UndefOr[
    Boolean | typingsJapgolly.plotlyJs.plotlyJsInts.`0` | typingsJapgolly.plotlyJs.plotlyJsInts.`1` | `2`
  ] = js.undefined
...
object PartialConfig {
  ...
  extension [Self <: PartialConfig](x: Self) {
    ...
    inline def setLogging(
      value: Boolean | typingsJapgolly.plotlyJs.plotlyJsInts.`0` | typingsJapgolly.plotlyJs.plotlyJsInts.`1` | `2`
    ): Self = StObject.set(x, "logging", value.asInstanceOf[js.Any])
