...
trait PartialSlider extends StObject {
  ...
  var activebgcolor: js.UndefOr[typingsJapgolly.plotlyJs.mod.Color] = js.undefined
  ...
  var currentvalue: js.UndefOr[PartialCurrentValue] = js.undefined
...
object PartialSlider {
  ...
  inline def apply(): PartialSlider = {
  ...
  extension [Self <: PartialSlider](x: Self) {
    ...
    inline def setActivebgcolor(value: typingsJapgolly.plotlyJs.mod.Color): Self = StObject.set(x, "activebgcolor", value.asInstanceOf[js.Any])
