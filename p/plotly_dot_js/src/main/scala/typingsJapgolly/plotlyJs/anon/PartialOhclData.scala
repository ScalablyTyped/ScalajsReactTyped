...
import typingsJapgolly.plotlyJs.plotlyJsStrings.ohcl
import typingsJapgolly.plotlyJs.plotlyJsStrings.start
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Partial<plotly.js.plotly.js/lib/traces/ohcl.OhclData> */
trait PartialOhclData
  extends StObject
     with Data {
  ...
  var `type`: js.UndefOr[ohcl] = js.undefined
...
object PartialOhclData {
  
  inline def apply(): PartialOhclData = {
  ...
  extension [Self <: PartialOhclData](x: Self) {
    ...
    inline def setType(value: ohcl): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
