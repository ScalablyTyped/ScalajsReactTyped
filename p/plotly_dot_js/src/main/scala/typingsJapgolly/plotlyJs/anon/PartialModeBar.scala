...
trait PartialModeBar extends StObject {
  ...
  var activecolor: js.UndefOr[typingsJapgolly.plotlyJs.mod.Color] = js.undefined
...
object PartialModeBar {
  ...
  extension [Self <: PartialModeBar](x: Self) {
    ...
    inline def setActivecolor(value: typingsJapgolly.plotlyJs.mod.Color): Self = StObject.set(x, "activecolor", value.asInstanceOf[js.Any])
