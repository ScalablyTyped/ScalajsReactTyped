...
import typingsJapgolly.plotlyJs.mod.ColorBar
...
import typingsJapgolly.plotlyJs.mod.Pattern
import typingsJapgolly.plotlyJs.mod.ScatterMarkerLine
...
trait PartialPlotMarkerCauto extends StObject {
  ...
  var color: js.UndefOr[
    typingsJapgolly.plotlyJs.mod.Color | js.Array[typingsJapgolly.plotlyJs.mod.Color]
  ] = js.undefined
  
  var colorbar: js.UndefOr[Partial[ColorBar]] = js.undefined
  
  var colors: js.UndefOr[js.Array[typingsJapgolly.plotlyJs.mod.Color]] = js.undefined
...
object PartialPlotMarkerCauto {
  ...
  extension [Self <: PartialPlotMarkerCauto](x: Self) {
    ...
    inline def setColor(value: typingsJapgolly.plotlyJs.mod.Color | js.Array[typingsJapgolly.plotlyJs.mod.Color]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    
    inline def setColorUndefined: Self = StObject.set(x, "color", js.undefined)
    
    inline def setColorVarargs(
      value: (js.UndefOr[
          (js.Array[js.UndefOr[String | Double | Null]]) | typingsJapgolly.plotlyJs.mod.Color | Double | Null | String
        ])*
    ...
    inline def setColors(value: js.Array[typingsJapgolly.plotlyJs.mod.Color]): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
    
    inline def setColorsUndefined: Self = StObject.set(x, "colors", js.undefined)
    
    inline def setColorsVarargs(value: typingsJapgolly.plotlyJs.mod.Color*): Self = StObject.set(x, "colors", js.Array(value*))
