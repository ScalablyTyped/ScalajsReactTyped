...
import typingsJapgolly.plotlyJs.mod.DataTitle
...
trait PartialSceneAxis extends StObject {
  
  var autorange: js.UndefOr[`true` | `false` | reversed] = js.undefined
  
  var backgroundcolor: js.UndefOr[typingsJapgolly.plotlyJs.mod.Color] = js.undefined
...
object PartialSceneAxis {
  ...
  inline def apply(): PartialSceneAxis = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSceneAxis]
  }
  
  extension [Self <: PartialSceneAxis](x: Self) {
    ...
    inline def setBackgroundcolor(value: typingsJapgolly.plotlyJs.mod.Color): Self = StObject.set(x, "backgroundcolor", value.asInstanceOf[js.Any])
    ...
    inline def setShowaxeslabelsUndefined: Self = StObject.set(x, "showaxeslabels", js.undefined)
    ...
    inline def setSpikesidesUndefined: Self = StObject.set(x, "spikesides", js.undefined)
