...
trait PartialLayout extends StObject {
  ...
  var paper_bgcolor: js.UndefOr[typingsJapgolly.plotlyJs.mod.Color] = js.undefined
  
  var plot_bgcolor: js.UndefOr[typingsJapgolly.plotlyJs.mod.Color] = js.undefined
...
object PartialLayout {
  ...
  extension [Self <: PartialLayout](x: Self) {
    ...
    inline def setPaper_bgcolor(value: typingsJapgolly.plotlyJs.mod.Color): Self = StObject.set(x, "paper_bgcolor", value.asInstanceOf[js.Any])
    ...
    inline def setPlot_bgcolor(value: typingsJapgolly.plotlyJs.mod.Color): Self = StObject.set(x, "plot_bgcolor", value.asInstanceOf[js.Any])
