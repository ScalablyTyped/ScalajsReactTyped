...
import typingsJapgolly.plotlyJs.anon.PartialGaugeBarColor
import typingsJapgolly.plotlyJs.anon.PartialThresholdLine
...
trait Gauge extends StObject {
  ...
  var steps: js.Array[typingsJapgolly.plotlyJs.anon.Color]
...
object Gauge {
  ...
  inline def apply(
    ...
    steps: js.Array[typingsJapgolly.plotlyJs.anon.Color],
  ...
  extension [Self <: Gauge](x: Self) {
    ...
    inline def setSteps(value: js.Array[typingsJapgolly.plotlyJs.anon.Color]): Self = StObject.set(x, "steps", value.asInstanceOf[js.Any])
    
    inline def setStepsVarargs(value: typingsJapgolly.plotlyJs.anon.Color*): Self = StObject.set(x, "steps", js.Array(value*))
