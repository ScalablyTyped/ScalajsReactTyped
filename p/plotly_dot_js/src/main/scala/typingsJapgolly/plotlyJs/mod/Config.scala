...
import typingsJapgolly.plotlyJs.PartialEdits
import typingsJapgolly.plotlyJs.Partialfilenamestringscal
...
import typingsJapgolly.plotlyJs.plotlyJsNumbers.`2`
...
object Config {
  ...
  def apply(
    ...
    scrollZoom: Boolean,
    sendData: Boolean,
    setBackground: CallbackTo[String | opaque | transparent],
