...
trait PartialLayoutAxisAutomargin extends js.Object {
...
object PartialLayoutAxisAutomargin {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PartialLayoutAxisAutomargin]
  }
}
