...
import typingsJapgolly.pusherJs.typesSrcCoreAuthOptionsMod.ChannelAuthorizationOptions
import typingsJapgolly.pusherJs.typesSrcCoreAuthOptionsMod.UserAuthenticationOptions
import typingsJapgolly.pusherJs.typesSrcCoreConfigMod.AuthTransport
...
object typesSrcCoreDefaultsMod {
  ...
  object DefaultConfig {
    ...
    extension [Self <: DefaultConfig](x: Self) {
