...
object typesSrcCoreAuthOptionsMod {
  ...
  object AuthRequestType extends StObject {
    ...
    /* "channel-authorization" */ val ChannelAuthorization: typingsJapgolly.pusherJs.typesSrcCoreAuthOptionsMod.AuthRequestType.ChannelAuthorization & String = js.native
    
    @js.native
    sealed trait UserAuthentication
      extends StObject
         with AuthRequestType
    /* "user-authentication" */ val UserAuthentication: typingsJapgolly.pusherJs.typesSrcCoreAuthOptionsMod.AuthRequestType.UserAuthentication & String = js.native
  }
