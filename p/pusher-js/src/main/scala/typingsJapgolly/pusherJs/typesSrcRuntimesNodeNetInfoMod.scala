...
object typesSrcRuntimesNodeNetInfoMod {
  
  @JSImport("pusher-js/types/src/runtimes/node/net_info", JSImport.Namespace)
  @js.native
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Reachability * / any */ @JSImport("pusher-js/types/src/runtimes/node/net_info", "NetInfo")
  @js.native
  ...
  @JSImport("pusher-js/types/src/runtimes/node/net_info", "Network")
  @js.native
