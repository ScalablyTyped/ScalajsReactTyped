...
import typingsJapgolly.pusherJs.typesSrcCoreTransportsTransportHooksMod.TransportHooks
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typesSrcCoreTransportsTransportMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    override def createConnection(name: String, priority: Double, key: String, options: Any): typingsJapgolly.pusherJs.typesSrcCoreTransportsTransportConnectionMod.default = js.native
  ...
  trait Transport extends StObject {
    ...
    def createConnection(name: String, priority: Double, key: String, options: Any): typingsJapgolly.pusherJs.typesSrcCoreTransportsTransportConnectionMod.default
  ...
  object Transport {
    ...
    inline def apply(
      createConnection: (String, Double, String, Any) => typingsJapgolly.pusherJs.typesSrcCoreTransportsTransportConnectionMod.default,
    ...
    extension [Self <: Transport](x: Self) {
      ...
      inline def setCreateConnection(
        value: (String, Double, String, Any) => typingsJapgolly.pusherJs.typesSrcCoreTransportsTransportConnectionMod.default
