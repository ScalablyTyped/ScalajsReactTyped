...
object typesSrcCoreUserMod {
  ...
  open class default protected () extends UserFacade {
    def this(pusher: typingsJapgolly.pusherJs.typesSrcCorePusherMod.default) = this()
  }
  ...
  trait UserFacade
    ...
    var pusher: typingsJapgolly.pusherJs.typesSrcCorePusherMod.default = js.native
    
    var serverToUserChannel: typingsJapgolly.pusherJs.typesSrcCoreChannelsChannelMod.default = js.native
