...
object typesSrcRuntimesWorkerTimelineFetchTimelineMod {
  
  object default {
    
    @JSImport("pusher-js/types/src/runtimes/worker/timeline/fetch_timeline", JSImport.Default)
    @js.native
    ...
    @JSImport("pusher-js/types/src/runtimes/worker/timeline/fetch_timeline", "default.name")
    @js.native
