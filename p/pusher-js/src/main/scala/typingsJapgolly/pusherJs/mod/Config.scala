...
import typingsJapgolly.pusherJs.AnonAuthorize
...
object Config {
  ...
  def apply(
    ...
    authorizer: (/* channel */ Channel, /* options */ Config) => CallbackTo[AnonAuthorize] = null,
    cluster: String = null,
    ...
    if (authorizer != null) __obj.updateDynamic("authorizer")(js.Any.fromFunction2((t0: /* channel */ typingsJapgolly.pusherJs.mod.Channel, t1: /* options */ typingsJapgolly.pusherJs.mod.Config) => authorizer(t0, t1).runNow()))
