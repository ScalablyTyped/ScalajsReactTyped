...
import typingsJapgolly.pusherJs.typesSrcCoreChannelsMetadataMod.Metadata
...
object typesSrcCoreEventsDispatcherMod {
  ...
  trait Dispatcher extends StObject {
    ...
    var callbacks: typingsJapgolly.pusherJs.typesSrcCoreEventsCallbackRegistryMod.default = js.native
