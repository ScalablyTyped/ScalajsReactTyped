...
object typesSrcCoreTimelineLevelMod {
  ...
  object default extends StObject {
    ...
    /* 7 */ val DEBUG: typingsJapgolly.pusherJs.typesSrcCoreTimelineLevelMod.TimelineLevel.DEBUG & Double = js.native
    
    /* 3 */ val ERROR: typingsJapgolly.pusherJs.typesSrcCoreTimelineLevelMod.TimelineLevel.ERROR & Double = js.native
    
    /* 6 */ val INFO: typingsJapgolly.pusherJs.typesSrcCoreTimelineLevelMod.TimelineLevel.INFO & Double = js.native
  }
