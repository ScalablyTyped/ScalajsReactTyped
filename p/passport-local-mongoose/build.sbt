...
version := "4.0.0-dt-20200226Z-4e4770"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "passport-local" % "1.0.0-dt-20200225Z-2730a7",
  "org.scalablytyped.japgolly" %%% "passport-strategy" % "v0.2.0-dt-20200225Z-ce1701",
