...
import typingsJapgolly.pascalcase.anon.ToString
...
object mod {
  ...
  inline def apply(value: ToString): String = ^.asInstanceOf[js.Dynamic].apply(value.asInstanceOf[js.Any]).asInstanceOf[String]
