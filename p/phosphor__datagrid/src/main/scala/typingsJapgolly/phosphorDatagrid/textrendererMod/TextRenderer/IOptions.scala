...
object IOptions {
  ...
  def apply(
    ...
    format: /* config */ ICellConfig => CallbackTo[String] = null,
    ...
    if (format != null) __obj.updateDynamic("format")(js.Any.fromFunction1((t0: /* config */ typingsJapgolly.phosphorDatagrid.cellrendererMod.CellRenderer.ICellConfig) => format(t0).runNow()))
