...
object PhoneGapNfc {
  ...
  object Ndef {
    ...
    extension [Self <: Ndef](x: Self) {
      ...
      inline def setEmptyRecord(value: CallbackTo[NdefRecord]): Self = StObject.set(x, "emptyRecord", value.toJsFn)
  ...
  object Window {
    ...
    inline def apply(fireNfcTagEvent: (TagEvent, String) => Callback, ndef: Ndef, nfc: Nfc, util: Util): Window = {
      val __obj = js.Dynamic.literal(fireNfcTagEvent = js.Any.fromFunction2((t0: TagEvent, t1: String) => (fireNfcTagEvent(t0, t1)).runNow()), ndef = ndef.asInstanceOf[js.Any], nfc = nfc.asInstanceOf[js.Any], util = util.asInstanceOf[js.Any])
      __obj.asInstanceOf[Window]
    }
    
    extension [Self <: Window](x: Self) {
      
      inline def setFireNfcTagEvent(value: (TagEvent, String) => Callback): Self = StObject.set(x, "fireNfcTagEvent", js.Any.fromFunction2((t0: TagEvent, t1: String) => (value(t0, t1)).runNow()))
