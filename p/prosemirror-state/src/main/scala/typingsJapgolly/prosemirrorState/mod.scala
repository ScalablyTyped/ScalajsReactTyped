...
import typingsJapgolly.prosemirrorState.anon.Plugins
import typingsJapgolly.prosemirrorState.anon.State
import typingsJapgolly.prosemirrorTransform.mod.Mappable
import typingsJapgolly.prosemirrorTransform.mod.Transform
  ...
  */
  ...
  object PluginView {
    ...
    extension [Self <: PluginView](x: Self) {
      ...
      inline def setUpdate(value: (/* view */ EditorView, /* prevState */ EditorState) => Callback): Self = StObject.set(x, "update", js.Any.fromFunction2((t0: /* view */ EditorView, t1: /* prevState */ EditorState) => (value(t0, t1)).runNow()))
