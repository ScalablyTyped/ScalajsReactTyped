...
object ConnectionType extends StObject {
  ...
  sealed trait Data
    extends StObject
       with ConnectionType
  /* "data" */ val Data: typingsJapgolly.peerjs.mod.ConnectionType.Data & String = js.native
  
  @js.native
  sealed trait Media
    extends StObject
       with ConnectionType
  /* "media" */ val Media: typingsJapgolly.peerjs.mod.ConnectionType.Media & String = js.native
}
