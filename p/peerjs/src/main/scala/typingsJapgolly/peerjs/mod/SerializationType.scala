...
object SerializationType extends StObject {
  ...
  /* "binary" */ val Binary: typingsJapgolly.peerjs.mod.SerializationType.Binary & String = js.native
  
  @js.native
  sealed trait BinaryUTF8
    extends StObject
       with SerializationType
  /* "binary-utf8" */ val BinaryUTF8: typingsJapgolly.peerjs.mod.SerializationType.BinaryUTF8 & String = js.native
  
  @js.native
  sealed trait JSON
    extends StObject
       with SerializationType
  /* "json" */ val JSON: typingsJapgolly.peerjs.mod.SerializationType.JSON & String = js.native
}
