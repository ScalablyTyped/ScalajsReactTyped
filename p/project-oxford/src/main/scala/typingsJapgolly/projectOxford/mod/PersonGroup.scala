...
import typingsJapgolly.projectOxford.mod.PersonGroupResponses.TrainingStatus
...
class PersonGroup () extends js.Object {
  ...
  /**
    ...
    * @return {Promise}                    - Promise resolving with the resulting JSON
    */
  def get(personGroupId: String): ^[typingsJapgolly.projectOxford.mod.PersonGroupResponses.PersonGroup] = js.native
  /**
    * Lists all person groups in the current subscription.
    * @return {Promise}                    - Promise resolving with the resulting JSON
    */
  def list(): ^[js.Array[typingsJapgolly.projectOxford.mod.PersonGroupResponses.PersonGroup]] = js.native
  /**
