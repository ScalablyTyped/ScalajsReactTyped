...
object PersonGroupResponses {
  ...
  object PersonGroup {
    ...
    inline def apply(name: String, personGroupId: String, userData: String): typingsJapgolly.projectOxford.mod.PersonGroupResponses.PersonGroup = {
      ...
      __obj.asInstanceOf[typingsJapgolly.projectOxford.mod.PersonGroupResponses.PersonGroup]
    }
    
    extension [Self <: typingsJapgolly.projectOxford.mod.PersonGroupResponses.PersonGroup](x: Self) {
