...
object PersonResponses {
  ...
  object Person {
    ...
    inline def apply(faceIds: js.Array[String], name: String, personId: String, userData: String): typingsJapgolly.projectOxford.mod.PersonResponses.Person = {
      ...
      __obj.asInstanceOf[typingsJapgolly.projectOxford.mod.PersonResponses.Person]
    }
    
    extension [Self <: typingsJapgolly.projectOxford.mod.PersonResponses.Person](x: Self) {
