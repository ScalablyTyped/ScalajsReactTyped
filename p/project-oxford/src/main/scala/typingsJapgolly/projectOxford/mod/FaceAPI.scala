...
import typingsJapgolly.projectOxford.mod.FaceResponses.Grouping
import typingsJapgolly.projectOxford.mod.FaceResponses.Similar
import typingsJapgolly.projectOxford.mod.FaceResponses.Verify
import typingsJapgolly.projectOxford.mod.Options.Detect
import typingsJapgolly.projectOxford.mod.Options.Identify
...
class FaceAPI () extends js.Object {
  ...
  /**
    ...
    */
  def detect(options: Detect): ^[js.Array[typingsJapgolly.projectOxford.mod.FaceResponses.Detect]] = js.native
  /**
  ...
  /**
    ...
    * @return {Promise}            - Promise resolving with the resulting JSON
    */
  def identify(faceIDs: js.Array[String], options: Identify): ^[js.Array[typingsJapgolly.projectOxford.mod.FaceResponses.Identify]] = js.native
  /**
