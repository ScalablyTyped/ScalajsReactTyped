package typingsJapgolly.postcssValuesParser

import japgolly.scalajs.react.Callback
import typingsJapgolly.postcss.libNodeMod.NodeErrorOptions
import typingsJapgolly.postcss.libNodeMod.Source
import typingsJapgolly.postcss.libWarningMod.WarningOptions
import typingsJapgolly.postcss.mod.CssSyntaxError
import typingsJapgolly.postcss.mod.Result
import typingsJapgolly.postcssValuesParser.anon.Map
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.atrule
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.comment
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.end
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.func
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.interpolation
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.numeric
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.operator
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.punctuation
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.quoted
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.root
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.start
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.unicodeRange
import typingsJapgolly.postcssValuesParser.postcssValuesParserStrings.word
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.postcssValuesParser.mod.AtWord
    - typingsJapgolly.postcssValuesParser.mod.Comment
    - typingsJapgolly.postcssValuesParser.mod.Func
    - typingsJapgolly.postcssValuesParser.mod.Interpolation
    - typingsJapgolly.postcssValuesParser.mod.Numeric
    - typingsJapgolly.postcssValuesParser.mod.Operator
    - typingsJapgolly.postcssValuesParser.mod.Punctuation
    - typingsJapgolly.postcssValuesParser.mod.Quoted
    - typingsJapgolly.postcssValuesParser.mod.UnicodeRange
    - typingsJapgolly.postcssValuesParser.mod.Word
  */
  trait ChildNode
    extends StObject
       with Node
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.postcssValuesParser.mod.Root
    - typingsJapgolly.postcssValuesParser.mod.Func
    - typingsJapgolly.postcssValuesParser.mod.Interpolation
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.postcssValuesParser.mod.Root
    - typingsJapgolly.postcssValuesParser.mod.ChildNode
  */
  ...
  object Syntax {
    ...
    extension [Self <: Syntax](x: Self) {
      ...
      inline def setStringify(value: (/* node */ Node, /* builder */ Builder) => Callback): Self = StObject.set(x, "stringify", js.Any.fromFunction2((t0: /* node */ Node, t1: /* builder */ Builder) => (value(t0, t1)).runNow()))
