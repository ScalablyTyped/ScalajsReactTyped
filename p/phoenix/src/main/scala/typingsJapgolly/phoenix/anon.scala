...
object anon {
  ...
  object PartialSocketConnectOptio {
    ...
    extension [Self <: PartialSocketConnectOptio](x: Self) {
      ...
      inline def setDecode(value: (/* payload */ String, /* callback */ js.Function1[/* decoded */ Any, Unit]) => Callback): Self = StObject.set(x, "decode", js.Any.fromFunction2((t0: /* payload */ String, t1: /* callback */ js.Function1[/* decoded */ Any, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setDecodeUndefined: Self = StObject.set(x, "decode", js.undefined)
      
      inline def setEncode(value: (/* payload */ js.Object, /* callback */ js.Function1[/* encoded */ Any, Unit]) => Callback): Self = StObject.set(x, "encode", js.Any.fromFunction2((t0: /* payload */ js.Object, t1: /* callback */ js.Function1[/* encoded */ Any, Unit]) => (value(t0, t1)).runNow()))
      ...
      inline def setLogger(value: (/* kind */ String, /* message */ String, /* data */ Any) => Callback): Self = StObject.set(x, "logger", js.Any.fromFunction3((t0: /* kind */ String, t1: /* message */ String, t2: /* data */ Any) => (value(t0, t1, t2)).runNow()))
