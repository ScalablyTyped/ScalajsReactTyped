...
import typingsJapgolly.typescript.mod.VisitResult
...
object distSrcTsqueryTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.phenomnomnominalTsquery.phenomnomnominalTsqueryStrings.regexp
    - typingsJapgolly.phenomnomnominalTsquery.phenomnomnominalTsqueryStrings.literal
    - typingsJapgolly.phenomnomnominalTsquery.phenomnomnominalTsqueryStrings.`type`
  */
  trait TSQueryAttributeOperatorType extends StObject
  object TSQueryAttributeOperatorType {
    
    inline def literal: typingsJapgolly.phenomnomnominalTsquery.phenomnomnominalTsqueryStrings.literal = "literal".asInstanceOf[typingsJapgolly.phenomnomnominalTsquery.phenomnomnominalTsqueryStrings.literal]
    
    inline def regexp: typingsJapgolly.phenomnomnominalTsquery.phenomnomnominalTsqueryStrings.regexp = "regexp".asInstanceOf[typingsJapgolly.phenomnomnominalTsquery.phenomnomnominalTsqueryStrings.regexp]
    
    inline def `type`: typingsJapgolly.phenomnomnominalTsquery.phenomnomnominalTsqueryStrings.`type` = "type".asInstanceOf[typingsJapgolly.phenomnomnominalTsquery.phenomnomnominalTsqueryStrings.`type`]
  }
