package typingsJapgolly.postcssNormalizeUrl

import typingsJapgolly.postcss.mod.Plugin
import typingsJapgolly.postcssNormalizeUrl.postcssNormalizeUrlBooleans.`true`
...
object mod {
  ...
  type Options = typingsJapgolly.normalizeUrl.mod.Options
}
