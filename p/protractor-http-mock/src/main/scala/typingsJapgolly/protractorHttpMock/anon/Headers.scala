...
import typingsJapgolly.protractorHttpMock.protractorHttpMockStrings.GET
...
trait Headers extends StObject {
  ...
  var headers: js.UndefOr[typingsJapgolly.protractorHttpMock.mod.requests.Headers] = js.undefined
...
object Headers {
  ...
  extension [Self <: Headers](x: Self) {
    ...
    inline def setHeaders(value: typingsJapgolly.protractorHttpMock.mod.requests.Headers): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
