...
object mod {
  ...
  */
  ...
  object PolyfillFlag {
    ...
    inline def always: typingsJapgolly.polyfillService.polyfillServiceStrings.always = "always".asInstanceOf[typingsJapgolly.polyfillService.polyfillServiceStrings.always]
    
    inline def gated: typingsJapgolly.polyfillService.polyfillServiceStrings.gated = "gated".asInstanceOf[typingsJapgolly.polyfillService.polyfillServiceStrings.gated]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.polyfillService.polyfillServiceStrings.polyfill
    - typingsJapgolly.polyfillService.polyfillServiceStrings.ignore
  */
  trait Unknown extends StObject
  object Unknown {
    
    inline def ignore: typingsJapgolly.polyfillService.polyfillServiceStrings.ignore = "ignore".asInstanceOf[typingsJapgolly.polyfillService.polyfillServiceStrings.ignore]
    
    inline def polyfill: typingsJapgolly.polyfillService.polyfillServiceStrings.polyfill = "polyfill".asInstanceOf[typingsJapgolly.polyfillService.polyfillServiceStrings.polyfill]
  }
}
