...
object pixiTextStrings {
  
  @js.native
  sealed trait `100`
    extends StObject
       with TextStyleFontWeight
  ...
  sealed trait normal
    extends StObject
       with TextStyleFontStyle
       with TextStyleFontVariant
       with TextStyleFontWeight
       with TextStyleWhiteSpace
