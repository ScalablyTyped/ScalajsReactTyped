...
import typingsJapgolly.pouchdbFind.PouchDB.Find.Selector
import typingsJapgolly.pouchdbReplication.pouchdbReplicationBooleans.`false`
import typingsJapgolly.pouchdbReplication.pouchdbReplicationStrings.source
import typingsJapgolly.pouchdbReplication.pouchdbReplicationStrings.target
...
object SyncOptions {
  @scala.inline
  def apply(
    back_off_function: /* delay */ Double => CallbackTo[Double] = null,
    ...
    if (back_off_function != null) __obj.updateDynamic("back_off_function")(js.Any.fromFunction1((t0: /* delay */ scala.Double) => back_off_function(t0).runNow()))
