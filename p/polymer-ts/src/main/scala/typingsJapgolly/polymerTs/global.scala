...
object global {
  ...
  object Polymer_ {
    ...
    @js.native
    def dom: typingsJapgolly.polymerTs.polymer.dom = js.native
  ...
  object polymer {
    ...
    open class Base ()
      extends StObject
         with typingsJapgolly.polymerTs.polymer.Base {
    ...
    object Base {
      ...
      /* static member */
      inline def create[T /* <: typingsJapgolly.polymerTs.polymer.Base */](args: Any*): T = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(args.asInstanceOf[Seq[js.Any]]*).asInstanceOf[T]
    ...
    open class PolymerBase ()
      extends StObject
         with typingsJapgolly.polymerTs.polymer.PolymerBase {
    ...
    inline def createClass[T /* <: typingsJapgolly.polymerTs.polymer.Base */](element: Instantiable1[/* args (repeated) */ Any, T]): Instantiable1[/* args (repeated) */ Any, T] = ^.asInstanceOf[js.Dynamic].applyDynamic("createClass")(element.asInstanceOf[js.Any]).asInstanceOf[Instantiable1[/* args (repeated) */ Any, T]]
    ...
    inline def createElement[T /* <: typingsJapgolly.polymerTs.polymer.Base */](element: Instantiable1[/* args (repeated) */ Any, T]): Instantiable1[/* args (repeated) */ Any, T] = ^.asInstanceOf[js.Dynamic].applyDynamic("createElement")(element.asInstanceOf[js.Any]).asInstanceOf[Instantiable1[/* args (repeated) */ Any, T]]
