package typingsJapgolly.pReflect

import typingsJapgolly.pReflect.pReflectBooleans.`false`
import typingsJapgolly.pReflect.pReflectBooleans.`true`
import typingsJapgolly.pReflect.pReflectStrings.fulfilled
import typingsJapgolly.pReflect.pReflectStrings.rejected
...
object mod {
  ...
  */
  ...
  object PromiseResult {
    ...
    inline def PromiseFulfilledResult[ValueType](value: ValueType): typingsJapgolly.pReflect.mod.PromiseFulfilledResult[ValueType] = {
      val __obj = js.Dynamic.literal(isFulfilled = true, isRejected = false, status = "fulfilled", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.pReflect.mod.PromiseFulfilledResult[ValueType]]
    }
    
    inline def PromiseRejectedResult(reason: Any): typingsJapgolly.pReflect.mod.PromiseRejectedResult = {
      val __obj = js.Dynamic.literal(isFulfilled = false, isRejected = true, reason = reason.asInstanceOf[js.Any], status = "rejected")
      __obj.asInstanceOf[typingsJapgolly.pReflect.mod.PromiseRejectedResult]
    }
  }
}
