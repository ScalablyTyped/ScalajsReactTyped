package typingsJapgolly.paypalPayoutsSdk

import typingsJapgolly.paypalPayoutsSdk.mod.RecipientType
import typingsJapgolly.paypalPayoutsSdk.mod.RecipientWallet
