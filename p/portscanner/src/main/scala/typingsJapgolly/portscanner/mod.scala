...
object mod {
  ...
  */
  ...
  object Status {
    ...
    inline def closed: typingsJapgolly.portscanner.portscannerStrings.closed = "closed".asInstanceOf[typingsJapgolly.portscanner.portscannerStrings.closed]
    
    inline def open: typingsJapgolly.portscanner.portscannerStrings.open = "open".asInstanceOf[typingsJapgolly.portscanner.portscannerStrings.open]
  }
