package typingsJapgolly.pahoMqtt

import japgolly.scalajs.react.Callback
import typingsJapgolly.pahoMqtt.mod.global.Paho.MQTT.TypedArray
import typingsJapgolly.pahoMqtt.pahoMqttInts.`3`
import typingsJapgolly.pahoMqtt.pahoMqttInts.`4`
import typingsJapgolly.pahoMqtt.pahoMqttStrings.Debug
...
object mod {
  ...
  open class Client protected ()
    extends typingsJapgolly.pahoMqtt.mod.global.Paho.MQTT.Client {
    /**
  ...
  open class Message protected ()
    extends typingsJapgolly.pahoMqtt.mod.global.Paho.MQTT.Message {
    /**
      ...
      object MQTT {
        ...
        open class Client protected () extends StObject {
          ...
          /**
            ...
            */
          def onMessageArrived(message: typingsJapgolly.pahoMqtt.mod.global.Paho.MQTT.Message): Unit = js.native
          /**
            * called when a message has arrived in this Paho.MQTT.client.
            * Parameters passed to the onMessageArrived callback are:
            * <li> {@link Paho.MQTT.Message} that has arrived.
          ...
          /**
            ...
            */
          def onMessageDelivered(message: typingsJapgolly.pahoMqtt.mod.global.Paho.MQTT.Message): Unit = js.native
          /**
            * called when a message has been delivered.
            * All processing that this Client will ever do has been completed. So, for example,
            * in the case of a Qos=2 message sent by this client, the PubComp flow has been received from the server
          ...
          /**
            ...
            */
          def send(message: typingsJapgolly.pahoMqtt.mod.global.Paho.MQTT.Message): Unit = js.native
          /**
            * Send a message to the consumers of the destination in the Message.
            *
        ...
        trait ConnectionOptions extends StObject {
          ...
          var willMessage: js.UndefOr[typingsJapgolly.pahoMqtt.mod.global.Paho.MQTT.Message] = js.undefined
        }
        object ConnectionOptions {
          ...
          extension [Self <: ConnectionOptions](x: Self) {
            ...
            inline def setOnFailure(value: /* e */ ErrorWithInvocationContext => Callback): Self = StObject.set(x, "onFailure", js.Any.fromFunction1((t0: /* e */ ErrorWithInvocationContext) => value(t0).runNow()))
            
            inline def setOnFailureUndefined: Self = StObject.set(x, "onFailure", js.undefined)
            
            inline def setOnSuccess(value: /* o */ WithInvocationContext => Callback): Self = StObject.set(x, "onSuccess", js.Any.fromFunction1((t0: /* o */ WithInvocationContext) => value(t0).runNow()))
            ...
            inline def setWillMessage(value: typingsJapgolly.pahoMqtt.mod.global.Paho.MQTT.Message): Self = StObject.set(x, "willMessage", value.asInstanceOf[js.Any])
        ...
        /**
          ...
          */
        type OnMessageHandler = js.Function1[/* message */ typingsJapgolly.pahoMqtt.mod.global.Paho.MQTT.Message, Unit]
        ...
        /* Rewritten from type alias, can be one of: 
          - typingsJapgolly.pahoMqtt.pahoMqttInts.`0`
          - typingsJapgolly.pahoMqtt.pahoMqttInts.`1`
          - typingsJapgolly.pahoMqtt.pahoMqttInts.`2`
        */
        trait Qos extends StObject
        object Qos {
          
          inline def `0`: typingsJapgolly.pahoMqtt.pahoMqttInts.`0` = 0.asInstanceOf[typingsJapgolly.pahoMqtt.pahoMqttInts.`0`]
          
          inline def `1`: typingsJapgolly.pahoMqtt.pahoMqttInts.`1` = 1.asInstanceOf[typingsJapgolly.pahoMqtt.pahoMqttInts.`1`]
          
          inline def `2`: typingsJapgolly.pahoMqtt.pahoMqttInts.`2` = 2.asInstanceOf[typingsJapgolly.pahoMqtt.pahoMqttInts.`2`]
        }
        ...
        object SubscribeOptions {
          ...
          extension [Self <: SubscribeOptions](x: Self) {
            ...
            inline def setOnSuccess(value: /* o */ OnSubscribeSuccessParams => Callback): Self = StObject.set(x, "onSuccess", js.Any.fromFunction1((t0: /* o */ OnSubscribeSuccessParams) => value(t0).runNow()))
