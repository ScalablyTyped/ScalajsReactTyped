...
object distCjsCommonForeignContentMod {
  
  @JSImport("parse5/dist/cjs/common/foreign-content", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("parse5/dist/cjs/common/foreign-content", "SVG_TAG_NAMES_ADJUSTMENT_MAP")
  @js.native
