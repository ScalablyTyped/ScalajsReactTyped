...
import typingsJapgolly.parse5.anon.`0`
import typingsJapgolly.parse5.distCommonErrorCodesMod.ERR
import typingsJapgolly.parse5.distCommonErrorCodesMod.ParserError
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distTokenizerPreprocessorMod {
  
  @JSImport("parse5/dist/tokenizer/preprocessor", "Preprocessor")
  @js.native
  open class Preprocessor protected () extends StObject {
    def this(handler: `0`) = this()
