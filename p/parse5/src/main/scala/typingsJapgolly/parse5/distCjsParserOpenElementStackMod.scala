...
object distCjsParserOpenElementStackMod {
  ...
  object StackHandler {
    ...
    inline def apply[T /* <: TreeAdapterTypeMap[Any, Any, Any, Any, Any, Any, Any, Any, Any, Any] */](
      onItemPop: (/* import warning: importer.ImportType#apply Failed type conversion: T['parentNode'] */ js.Any, Boolean) => Callback,
      onItemPush: (/* import warning: importer.ImportType#apply Failed type conversion: T['parentNode'] */ js.Any, Double, Boolean) => Callback
    ): StackHandler[T] = {
      val __obj = js.Dynamic.literal(onItemPop = js.Any.fromFunction2((t0: /* import warning: importer.ImportType#apply Failed type conversion: T['parentNode'] */ js.Any, t1: Boolean) => (onItemPop(t0, t1)).runNow()), onItemPush = js.Any.fromFunction3((t0: /* import warning: importer.ImportType#apply Failed type conversion: T['parentNode'] */ js.Any, t1: Double, t2: Boolean) => (onItemPush(t0, t1, t2)).runNow()))
    ...
    extension [Self <: StackHandler[?], T /* <: TreeAdapterTypeMap[Any, Any, Any, Any, Any, Any, Any, Any, Any, Any] */](x: Self & StackHandler[T]) {
      ...
      inline def setOnItemPop(
        value: (/* import warning: importer.ImportType#apply Failed type conversion: T['parentNode'] */ js.Any, Boolean) => Callback
      ): Self = StObject.set(x, "onItemPop", js.Any.fromFunction2((t0: /* import warning: importer.ImportType#apply Failed type conversion: T['parentNode'] */ js.Any, t1: Boolean) => (value(t0, t1)).runNow()))
      
      inline def setOnItemPush(
        value: (/* import warning: importer.ImportType#apply Failed type conversion: T['parentNode'] */ js.Any, Double, Boolean) => Callback
      ): Self = StObject.set(x, "onItemPush", js.Any.fromFunction3((t0: /* import warning: importer.ImportType#apply Failed type conversion: T['parentNode'] */ js.Any, t1: Double, t2: Boolean) => (value(t0, t1, t2)).runNow()))
    }
  }
}
