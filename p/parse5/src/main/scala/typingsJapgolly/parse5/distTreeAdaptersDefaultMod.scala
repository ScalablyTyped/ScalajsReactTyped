...
import typingsJapgolly.parse5.distCommonHtmlMod.DOCUMENT_MODE
import typingsJapgolly.parse5.distCommonHtmlMod.NS
import typingsJapgolly.parse5.distCommonTokenMod.Attribute
import typingsJapgolly.parse5.distCommonTokenMod.ElementLocation
import typingsJapgolly.parse5.distCommonTokenMod.Location
...
object distTreeAdaptersDefaultMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.Element
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.Template
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.CommentNode
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.TextNode
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.DocumentType
  */
  trait ChildNode
    extends StObject
       with Node
  object ChildNode {
    ...
    inline def CommentNode(data: String): typingsJapgolly.parse5.distTreeAdaptersDefaultMod.CommentNode = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], nodeName = "#comment", parentNode = null)
      __obj.asInstanceOf[typingsJapgolly.parse5.distTreeAdaptersDefaultMod.CommentNode]
    }
    
    inline def DocumentType(name: String, publicId: String, systemId: String): typingsJapgolly.parse5.distTreeAdaptersDefaultMod.DocumentType = {
      ...
      __obj.asInstanceOf[typingsJapgolly.parse5.distTreeAdaptersDefaultMod.DocumentType]
    }
    ...
    inline def Element(
      ...
      __obj.asInstanceOf[typingsJapgolly.parse5.distTreeAdaptersDefaultMod.Element]
    }
    ...
    inline def Template(
      ...
      __obj.asInstanceOf[typingsJapgolly.parse5.distTreeAdaptersDefaultMod.Template]
    }
    
    inline def TextNode(value: String): typingsJapgolly.parse5.distTreeAdaptersDefaultMod.TextNode = {
      val __obj = js.Dynamic.literal(nodeName = "#text", value = value.asInstanceOf[js.Any], parentNode = null)
      __obj.asInstanceOf[typingsJapgolly.parse5.distTreeAdaptersDefaultMod.TextNode]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.ParentNode
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.ChildNode
  */
  ...
  object Node {
    ...
    inline def Document(childNodes: js.Array[ChildNode], mode: DOCUMENT_MODE): typingsJapgolly.parse5.distTreeAdaptersDefaultMod.Document = {
      val __obj = js.Dynamic.literal(childNodes = childNodes.asInstanceOf[js.Any], mode = mode.asInstanceOf[js.Any], nodeName = "#document")
      __obj.asInstanceOf[typingsJapgolly.parse5.distTreeAdaptersDefaultMod.Document]
    }
    
    inline def DocumentFragment(childNodes: js.Array[ChildNode]): typingsJapgolly.parse5.distTreeAdaptersDefaultMod.DocumentFragment = {
      val __obj = js.Dynamic.literal(childNodes = childNodes.asInstanceOf[js.Any], nodeName = "#document-fragment")
      __obj.asInstanceOf[typingsJapgolly.parse5.distTreeAdaptersDefaultMod.DocumentFragment]
    }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.Document
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.DocumentFragment
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.Element
    - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.Template
  */
  trait ParentNode
  ...
  - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.Node because Already inherited
  - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.ParentNode because Already inherited
  - typingsJapgolly.parse5.distTreeAdaptersDefaultMod.ChildNode because Already inherited */ trait Template
    extends StObject
       with Element {
