package typingsJapgolly.passportSocketio
...
object mod {
  ...
  object PassportSocketIoOptions {
    ...
    extension [Self <: PassportSocketIoOptions](x: Self) {
      ...
      inline def setFail(
        value: (/* data */ Any, /* message */ String, /* critical */ Boolean, /* accept */ js.Function2[/* err */ js.UndefOr[Any], /* accepted */ js.UndefOr[Boolean], Unit]) => Callback
      ): Self = StObject.set(x, "fail", js.Any.fromFunction4((t0: /* data */ Any, t1: /* message */ String, t2: /* critical */ Boolean, t3: /* accept */ js.Function2[/* err */ js.UndefOr[Any], /* accepted */ js.UndefOr[Boolean], Unit]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setSuccess(
        value: (/* data */ Any, /* accept */ js.Function2[/* err */ js.UndefOr[Any], /* accepted */ js.UndefOr[Boolean], Unit]) => Callback
      ): Self = StObject.set(x, "success", js.Any.fromFunction2((t0: /* data */ Any, t1: /* accept */ js.Function2[/* err */ js.UndefOr[Any], /* accepted */ js.UndefOr[Boolean], Unit]) => (value(t0, t1)).runNow()))
