package typingsJapgolly.ptomasroosReactNativeMultiSlider
...
object mod {
  ...
  type MultiSlider = japgolly.scalajs.react.facade.React.Component[MultiSliderProps & js.Object, js.Object]
  ...
  object MultiSliderProps {
    ...
    extension [Self <: MultiSliderProps](x: Self) {
      ...
      inline def setOnToggleOne(value: Callback): Self = StObject.set(x, "onToggleOne", value.toJsFn)
      
      inline def setOnToggleOneUndefined: Self = StObject.set(x, "onToggleOne", js.undefined)
      
      inline def setOnToggleTwo(value: Callback): Self = StObject.set(x, "onToggleTwo", value.toJsFn)
      
      inline def setOnToggleTwoUndefined: Self = StObject.set(x, "onToggleTwo", js.undefined)
      
      inline def setOnValuesChange(value: /* values */ js.Array[Double] => Callback): Self = StObject.set(x, "onValuesChange", js.Any.fromFunction1((t0: /* values */ js.Array[Double]) => value(t0).runNow()))
      
      inline def setOnValuesChangeFinish(value: /* values */ js.Array[Double] => Callback): Self = StObject.set(x, "onValuesChangeFinish", js.Any.fromFunction1((t0: /* values */ js.Array[Double]) => value(t0).runNow()))
      
      inline def setOnValuesChangeFinishUndefined: Self = StObject.set(x, "onValuesChangeFinish", js.undefined)
      
      inline def setOnValuesChangeStart(value: Callback): Self = StObject.set(x, "onValuesChangeStart", value.toJsFn)
