package typingsJapgolly.parse5ParserStream
...
import typingsJapgolly.parse5.mod.Parser
import typingsJapgolly.parse5ParserStream.parse5ParserStreamStrings.script
