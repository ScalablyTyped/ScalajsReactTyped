package typingsJapgolly.prosemirrorTables
...
import typingsJapgolly.prosemirrorState.mod.PluginKey
import typingsJapgolly.prosemirrorState.mod.Selection
import typingsJapgolly.prosemirrorState.mod.Transaction
import typingsJapgolly.prosemirrorTables.anon.Bottom
import typingsJapgolly.prosemirrorTables.anon.CellMinWidth
import typingsJapgolly.prosemirrorTables.anon.RecordTableRolesNodeType
import typingsJapgolly.prosemirrorTables.anon.UseDeprecatedLogic
import typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.column
import typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.row
import typingsJapgolly.prosemirrorTransform.mod.Mappable
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.table
    - typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.row
    - typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.cell
    - typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.header_cell
  */
  trait TableRoles extends StObject
  object TableRoles {
    
    inline def cell: typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.cell = "cell".asInstanceOf[typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.cell]
    
    inline def header_cell: typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.header_cell = "header_cell".asInstanceOf[typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.header_cell]
    
    inline def row: typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.row = "row".asInstanceOf[typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.row]
    
    inline def table: typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.table = "table".asInstanceOf[typingsJapgolly.prosemirrorTables.prosemirrorTablesStrings.table]
  }
