...
import typingsJapgolly.promiseFs.AnonEncoding
...
object readFile extends js.Object {
  ...
  def apply(path: Double, options: typingsJapgolly.promiseFs.AnonEncodingFlag): js.Promise[String | Buffer] = js.native
  def apply(path: Double, options: typingsJapgolly.promiseFs.AnonFlag): js.Promise[String] = js.native
  ...
  def apply(path: PathLike, options: typingsJapgolly.promiseFs.AnonEncodingFlag): js.Promise[String | Buffer] = js.native
  def apply(path: PathLike, options: typingsJapgolly.promiseFs.AnonFlag): js.Promise[String] = js.native
