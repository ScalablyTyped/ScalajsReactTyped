...
import typingsJapgolly.promiseFs.Anon3
...
object readdir extends js.Object {
  ...
  def apply(path: PathLike, options: typingsJapgolly.promiseFs.Anon4): js.Promise[js.Array[typingsJapgolly.node.fsMod.Dirent]] = js.native
  def apply(path: PathLike, options: typingsJapgolly.promiseFs.AnonEncodingWithFileTypes): js.Promise[js.Array[Buffer]] = js.native
  def apply(path: PathLike, options: typingsJapgolly.promiseFs.AnonWithFileTypes): js.Promise[js.Array[String]] = js.native
