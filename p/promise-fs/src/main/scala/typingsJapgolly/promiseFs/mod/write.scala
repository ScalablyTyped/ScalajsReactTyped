...
import typingsJapgolly.promiseFs.AnonBufferBytesWritten
import typingsJapgolly.promiseFs.AnonBufferDataViewBytesWrittenNumber
import typingsJapgolly.promiseFs.AnonBufferFloat32ArrayBytesWrittenNumber
import typingsJapgolly.promiseFs.AnonBufferFloat64ArrayBytesWrittenNumber
import typingsJapgolly.promiseFs.AnonBufferInt16ArrayBytesWrittenNumber
import typingsJapgolly.promiseFs.AnonBufferInt32ArrayBytesWrittenNumber
import typingsJapgolly.promiseFs.AnonBufferInt8ArrayBytesWrittenNumber
import typingsJapgolly.promiseFs.AnonBufferString
import typingsJapgolly.promiseFs.AnonBufferUint16Array
import typingsJapgolly.promiseFs.AnonBytesWritten
import typingsJapgolly.promiseFs.AnonBytesWrittenNumber
...
object write extends js.Object {
  ...
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint16Array): js.Promise[typingsJapgolly.node.AnonBufferBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint16Array, offset: Double): js.Promise[typingsJapgolly.node.AnonBufferBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint16Array, offset: Double, length: Double): js.Promise[typingsJapgolly.node.AnonBufferBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint16Array, offset: Double, length: Double, position: Double): js.Promise[typingsJapgolly.node.AnonBufferBytesWritten] = js.native
  @JSName("__promisify__")
  ...
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint8ClampedArray): js.Promise[typingsJapgolly.node.AnonBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint8ClampedArray, offset: Double): js.Promise[typingsJapgolly.node.AnonBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint8ClampedArray, offset: Double, length: Double): js.Promise[typingsJapgolly.node.AnonBytesWritten] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, buffer: Uint8ClampedArray, offset: Double, length: Double, position: Double): js.Promise[typingsJapgolly.node.AnonBytesWritten] = js.native
  /**
    * Asynchronously writes `string` to the file referenced by the supplied file descriptor.
    * @param fd A file descriptor.
    * @param string A string to write. If something other than a string is supplied it will be coerced to a string.
    ...
    */
  @JSName("__promisify__")
  def promisify(fd: Double, string: js.Any): js.Promise[typingsJapgolly.node.AnonBufferString] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, string: js.Any, position: Double): js.Promise[typingsJapgolly.node.AnonBufferString] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, string: js.Any, position: Double, encoding: String): js.Promise[typingsJapgolly.node.AnonBufferString] = js.native
  @JSName("__promisify__")
  def promisify(fd: Double, string: js.Any, position: Null, encoding: String): js.Promise[typingsJapgolly.node.AnonBufferString] = js.native
}
