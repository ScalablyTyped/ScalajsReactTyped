...
import typingsJapgolly.propertyExpr.anon.ContentSecurityPolicy
import typingsJapgolly.propertyExpr.anon.Instantiable
...
object mod extends Shortcut {
  ...
  object Cache {
    ...
    inline def apply(clear: Callback, get: String => Any, set: (String, Any) => Any): Cache = {
