...
trait TokenConfig extends js.Object {
  ...
  var getAttrs: js.UndefOr[
    js.Function1[/* token */ typingsJapgolly.markdownIt.tokenMod.^, Record[String, _]]
  ] = js.undefined
  /**
...
object TokenConfig {
  ...
  def apply(
    ...
    block: String = null,
    getAttrs: /* token */ typingsJapgolly.markdownIt.tokenMod.^ => CallbackTo[Record[String, js.Any]] = null,
    ...
    if (getAttrs != null) __obj.updateDynamic("getAttrs")(js.Any.fromFunction1((t0: /* token */ typingsJapgolly.markdownIt.tokenMod.^) => getAttrs(t0).runNow()))
