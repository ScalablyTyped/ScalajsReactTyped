package typingsJapgolly.promiseAbortable
...
object mod {
  ...
  object AbortSignal {
    ...
    inline def apply(aborted: Boolean, onabort: Any => Callback): AbortSignal = {
      val __obj = js.Dynamic.literal(aborted = aborted.asInstanceOf[js.Any], onabort = js.Any.fromFunction1((t0: Any) => onabort(t0).runNow()))
