...
import typingsJapgolly.protooServer.protooServerStrings.notification
import typingsJapgolly.protooServer.protooServerStrings.request
...
object mod {
  ...
  open class WebSocketServer protected () extends StObject {
    ...
    def this(server: typingsJapgolly.node.httpsMod.Server[
  ...
  trait ConnectionRequestInfo extends StObject {
    ...
    var socket: typingsJapgolly.node.netMod.Socket
  }
  object ConnectionRequestInfo {
    
    inline def apply(origin: String, request: IncomingMessage, socket: typingsJapgolly.node.netMod.Socket): ConnectionRequestInfo = {
    ...
    extension [Self <: ConnectionRequestInfo](x: Self) {
      ...
      inline def setSocket(value: typingsJapgolly.node.netMod.Socket): Self = StObject.set(x, "socket", value.asInstanceOf[js.Any])
    }
  }
  ...
  object WebSocketTransport {
    ...
    inline def apply(close: Callback, closed: Boolean, send: Any => js.Promise[Unit]): WebSocketTransport = {
      val __obj = js.Dynamic.literal(close = close.toJsFn, closed = closed.asInstanceOf[js.Any], send = js.Any.fromFunction1(send))
