package typingsJapgolly.protractorHelpers.mod

import typingsJapgolly.protractorHelpers.mod._Global_.protractor.ElementArrayFinder
import typingsJapgolly.protractorHelpers.mod._Global_.protractor.ElementFinder
