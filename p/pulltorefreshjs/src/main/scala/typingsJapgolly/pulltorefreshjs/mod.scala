...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setGetMarkup(value: CallbackTo[String]): Self = StObject.set(x, "getMarkup", value.toJsFn)
      ...
      inline def setOnRefresh(value: CallbackTo[PromiseLike[Unit] | Unit]): Self = StObject.set(x, "onRefresh", value.toJsFn)
      ...
      inline def setShouldPullToRefresh(value: CallbackTo[Boolean]): Self = StObject.set(x, "shouldPullToRefresh", value.toJsFn)
  ...
  object PullToRefreshInstance {
    ...
    inline def apply(destroy: Callback): PullToRefreshInstance = {
