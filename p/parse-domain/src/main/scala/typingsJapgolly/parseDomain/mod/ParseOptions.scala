package typingsJapgolly.parseDomain.mod
...
trait ParseOptions extends js.Object {
  var customTlds: js.UndefOr[js.RegExp | js.Array[String]] = js.undefined
  var privateTlds: js.UndefOr[Boolean] = js.undefined
}

object ParseOptions {
  @scala.inline
  def apply(customTlds: js.RegExp | js.Array[String] = null, privateTlds: js.UndefOr[Boolean] = js.undefined): ParseOptions = {
