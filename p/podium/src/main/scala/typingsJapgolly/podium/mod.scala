...
import typingsJapgolly.podium.anon.Channel
  ...
  object CriteriaObject {
    ...
    extension [Self <: CriteriaObject](x: Self) {
      ...
      inline def setListener(
        value: (/* data */ Any, /* tags */ js.UndefOr[Tags], /* callback */ js.UndefOr[js.Function0[Unit]]) => Callback
      ): Self = StObject.set(x, "listener", js.Any.fromFunction3((t0: /* data */ Any, t1: /* tags */ js.UndefOr[Tags], t2: /* callback */ js.UndefOr[js.Function0[Unit]]) => (value(t0, t1, t2)).runNow()))
