...
object MouseEvent {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(currentTarget = currentTarget.asInstanceOf[js.Any], delta = delta.asInstanceOf[js.Any], modifiers = modifiers.asInstanceOf[js.Any], point = point.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, stop = stop.toJsFn, stopPropagation = stopPropagation.toJsFn, target = target.asInstanceOf[js.Any], timeStamp = timeStamp.asInstanceOf[js.Any])
