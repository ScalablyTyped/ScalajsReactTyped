...
object PaperScope {
  ...
  /** 
    ...
    */
  /* static member */
  inline def get(id: Any): typingsJapgolly.paper.paper.PaperScope = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(id.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.paper.paper.PaperScope]
}
