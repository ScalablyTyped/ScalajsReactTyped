...
open class Color protected ()
  ...
  /** 
    ...
    */
  def this(
    gradient: typingsJapgolly.paper.paper.Gradient,
    origin: typingsJapgolly.paper.paper.Point,
    destination: typingsJapgolly.paper.paper.Point
  ) = this()
  /** 
  ...
  def this(
    ...
    origin: typingsJapgolly.paper.paper.Point,
    destination: typingsJapgolly.paper.paper.Point,
    highlight: typingsJapgolly.paper.paper.Point
  ) = this()
...
object Color {
  ...
  /** 
    ...
    */
  /* static member */
  inline def random(): typingsJapgolly.paper.paper.Color = ^.asInstanceOf[js.Dynamic].applyDynamic("random")().asInstanceOf[typingsJapgolly.paper.paper.Color]
}
