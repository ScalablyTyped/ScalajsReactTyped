...
import typingsJapgolly.pico8parse.pico8parseBooleans.`false`
import typingsJapgolly.pico8parse.pico8parseBooleans.`true`
...
object anon {
  ...
  object PartialOptions {
    ...
    extension [Self <: PartialOptions](x: Self) {
      ...
      inline def setOnCreateNode(value: /* node */ Node => Callback): Self = StObject.set(x, "onCreateNode", js.Any.fromFunction1((t0: /* node */ Node) => value(t0).runNow()))
      ...
      inline def setOnLocalDeclaration(value: /* identifier */ Identifier_ => Callback): Self = StObject.set(x, "onLocalDeclaration", js.Any.fromFunction1((t0: /* identifier */ Identifier_) => value(t0).runNow()))
