...
import typingsJapgolly.pico8parse.mod.LuaVersion
import typingsJapgolly.pico8parse.mod.Parser
import typingsJapgolly.pico8parse.mod.ast.AssignmentOperatorStatement_
import typingsJapgolly.pico8parse.mod.ast.AssignmentStatement_
import typingsJapgolly.pico8parse.mod.ast.BinaryExpression_
import typingsJapgolly.pico8parse.mod.ast.BinaryOperator
import typingsJapgolly.pico8parse.mod.ast.BreakStatement_
import typingsJapgolly.pico8parse.mod.ast.CallExpression_
import typingsJapgolly.pico8parse.mod.ast.CallStatement_
import typingsJapgolly.pico8parse.mod.ast.Chunk_
import typingsJapgolly.pico8parse.mod.ast.Comment_
import typingsJapgolly.pico8parse.mod.ast.ComparisonOperator
import typingsJapgolly.pico8parse.mod.ast.DoStatement_
import typingsJapgolly.pico8parse.mod.ast.ElseClause_
import typingsJapgolly.pico8parse.mod.ast.ElseifClause_
import typingsJapgolly.pico8parse.mod.ast.Expression
import typingsJapgolly.pico8parse.mod.ast.ForGenericStatement_
import typingsJapgolly.pico8parse.mod.ast.ForNumericStatement_
import typingsJapgolly.pico8parse.mod.ast.FunctionDeclaration
import typingsJapgolly.pico8parse.mod.ast.GotoStatement_
import typingsJapgolly.pico8parse.mod.ast.Identifier_
import typingsJapgolly.pico8parse.mod.ast.IfClause_
import typingsJapgolly.pico8parse.mod.ast.IfStatementClauses
import typingsJapgolly.pico8parse.mod.ast.IfStatement_
import typingsJapgolly.pico8parse.mod.ast.IndexExpression_
import typingsJapgolly.pico8parse.mod.ast.LabelStatement_
import typingsJapgolly.pico8parse.mod.ast.LocalStatement_
import typingsJapgolly.pico8parse.mod.ast.LogicalExpression
import typingsJapgolly.pico8parse.mod.ast.MemberExpression_
import typingsJapgolly.pico8parse.mod.ast.Node
import typingsJapgolly.pico8parse.mod.ast.RepeatStatement_
import typingsJapgolly.pico8parse.mod.ast.ReturnStatement_
import typingsJapgolly.pico8parse.mod.ast.Statement
import typingsJapgolly.pico8parse.mod.ast.StringCallExpression_
import typingsJapgolly.pico8parse.mod.ast.TableCallExpression_
import typingsJapgolly.pico8parse.mod.ast.TableConstructorExpression_
import typingsJapgolly.pico8parse.mod.ast.TableKeyString_
import typingsJapgolly.pico8parse.mod.ast.TableKey_
import typingsJapgolly.pico8parse.mod.ast.TableValue_
import typingsJapgolly.pico8parse.mod.ast.Token
import typingsJapgolly.pico8parse.mod.ast.UnaryExpression_
import typingsJapgolly.pico8parse.mod.ast.UnaryOperator
import typingsJapgolly.pico8parse.mod.ast.VarargLiteral
import typingsJapgolly.pico8parse.mod.ast.WhileStatement_
import typingsJapgolly.pico8parse.mod.tokenTypes.BooleanLiteral
import typingsJapgolly.pico8parse.mod.tokenTypes.NilLiteral
import typingsJapgolly.pico8parse.mod.tokenTypes.NumericLiteral
import typingsJapgolly.pico8parse.mod.tokenTypes.StringLiteral
import typingsJapgolly.pico8parse.pico8parseStrings.Colon
import typingsJapgolly.pico8parse.pico8parseStrings.Dot
import typingsJapgolly.pico8parse.pico8parseStrings.DotDotDot
import typingsJapgolly.pico8parse.pico8parseStrings.`false`
import typingsJapgolly.pico8parse.pico8parseStrings.`pseudo-latin1`
import typingsJapgolly.pico8parse.pico8parseStrings.`true`
import typingsJapgolly.pico8parse.pico8parseStrings.`x-user-defined`
import typingsJapgolly.pico8parse.pico8parseStrings.and
import typingsJapgolly.pico8parse.pico8parseStrings.nil
import typingsJapgolly.pico8parse.pico8parseStrings.none
...
object global {
  ...
  object pico8parse {
    ...
    open class SyntaxError ()
      extends typingsJapgolly.pico8parse.mod.SyntaxError
    ...
    object ast {
      ...
      inline def literal(`type`: BooleanLiteral, value: Boolean, raw: `true` | `false`): typingsJapgolly.pico8parse.mod.ast.BooleanLiteral = (^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any], raw.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pico8parse.mod.ast.BooleanLiteral]
      inline def literal(`type`: NumericLiteral, value: Double, raw: String): typingsJapgolly.pico8parse.mod.ast.NumericLiteral = (^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any], raw.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pico8parse.mod.ast.NumericLiteral]
      inline def literal(`type`: StringLiteral, value: String, raw: String): typingsJapgolly.pico8parse.mod.ast.StringLiteral = (^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any], raw.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pico8parse.mod.ast.StringLiteral]
      inline def literal(`type`: StringLiteral, value: String, raw: String, rawInterrupted: String): typingsJapgolly.pico8parse.mod.ast.StringLiteral = (^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any], raw.asInstanceOf[js.Any], rawInterrupted.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pico8parse.mod.ast.StringLiteral]
      inline def literal(`type`: typingsJapgolly.pico8parse.mod.tokenTypes.VarargLiteral, value: DotDotDot, raw: DotDotDot): VarargLiteral = (^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any], raw.asInstanceOf[js.Any])).asInstanceOf[VarargLiteral]
      
      inline def literal_nil(`type`: NilLiteral, value: Null, raw: nil): typingsJapgolly.pico8parse.mod.ast.NilLiteral = (^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any], raw.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pico8parse.mod.ast.NilLiteral]
    ...
    object defaultOptions {
      ...
      @js.native
      def extendedIdentifiers: js.UndefOr[typingsJapgolly.pico8parse.pico8parseBooleans.`false`] = js.native
      inline def extendedIdentifiers_=(x: js.UndefOr[typingsJapgolly.pico8parse.pico8parseBooleans.`false`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("extendedIdentifiers")(x.asInstanceOf[js.Any])
    ...
    object tokenTypes extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.pico8parse.mod.tokenTypes & Double] = js.native
