...
object Options {
  ...
  extension [Self <: Options](x: Self) {
    ...
    inline def setOnLocalDeclaration(value: Identifier_ => Callback): Self = StObject.set(x, "onLocalDeclaration", js.Any.fromFunction1((t0: Identifier_) => value(t0).runNow()))
