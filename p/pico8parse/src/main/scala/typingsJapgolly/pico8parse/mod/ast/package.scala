...
import typingsJapgolly.pico8parse.mod.ast.^
import typingsJapgolly.pico8parse.pico8parseStrings.BreakStatement
...
inline def literal(
  `type`: typingsJapgolly.pico8parse.mod.tokenTypes.BooleanLiteral,
  value: Boolean,
  raw: `true` | `false`
): BooleanLiteral = (^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any], raw.asInstanceOf[js.Any])).asInstanceOf[BooleanLiteral]
inline def literal(`type`: typingsJapgolly.pico8parse.mod.tokenTypes.NumericLiteral, value: Double, raw: String): NumericLiteral = (^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any], raw.asInstanceOf[js.Any])).asInstanceOf[NumericLiteral]
inline def literal(`type`: typingsJapgolly.pico8parse.mod.tokenTypes.StringLiteral, value: String, raw: String): StringLiteral = (^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any], raw.asInstanceOf[js.Any])).asInstanceOf[StringLiteral]
inline def literal(
  `type`: typingsJapgolly.pico8parse.mod.tokenTypes.StringLiteral,
  value: String,
  raw: String,
...
inline def literal_nil(`type`: typingsJapgolly.pico8parse.mod.tokenTypes.NilLiteral, value: Null, raw: nil): NilLiteral = (^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any], raw.asInstanceOf[js.Any])).asInstanceOf[NilLiteral]
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.pico8parse.pico8parseStrings.Plussign
  - typingsJapgolly.pico8parse.pico8parseStrings.`-_`
  - typingsJapgolly.pico8parse.pico8parseStrings.Asterisk
  - typingsJapgolly.pico8parse.pico8parseStrings.Percentsign
  - typingsJapgolly.pico8parse.pico8parseStrings.^
  - typingsJapgolly.pico8parse.pico8parseStrings.Slash
  - typingsJapgolly.pico8parse.pico8parseStrings.SlashSlash
  - typingsJapgolly.pico8parse.pico8parseStrings.Ampersand
  - typingsJapgolly.pico8parse.pico8parseStrings.Verticalline
  - typingsJapgolly.pico8parse.pico8parseStrings.Tilde
  - typingsJapgolly.pico8parse.pico8parseStrings.LessthansignLessthansign
  - typingsJapgolly.pico8parse.pico8parseStrings.GreaterthansignGreaterthansign
  - typingsJapgolly.pico8parse.pico8parseStrings.DotDot
  - typingsJapgolly.pico8parse.pico8parseStrings.GreaterthansignGreaterthansignGreaterthansign
  - typingsJapgolly.pico8parse.pico8parseStrings.LessthansignLessthansignGreaterthansign
  - typingsJapgolly.pico8parse.pico8parseStrings.GreaterthansignGreaterthansignLessthansign
  - typingsJapgolly.pico8parse.pico8parseStrings.`^^`
  - / * \ * / java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.pico8parse.mod.ast.Statement
  - typingsJapgolly.pico8parse.mod.ast.Expression
  - typingsJapgolly.pico8parse.mod.ast.IfClause_
  - typingsJapgolly.pico8parse.mod.ast.ElseifClause_
  - typingsJapgolly.pico8parse.mod.ast.ElseClause_
  - typingsJapgolly.pico8parse.mod.ast.Chunk_
  - typingsJapgolly.pico8parse.mod.ast.TableKey_
  - typingsJapgolly.pico8parse.mod.ast.TableKeyString_
  - typingsJapgolly.pico8parse.mod.ast.TableValue_
  - typingsJapgolly.pico8parse.mod.ast.Comment_
*/
type Node = _Node | BreakStatement_

/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.pico8parse.mod.ast.LabelStatement_
  - typingsJapgolly.pico8parse.mod.ast.BreakStatement_
  - typingsJapgolly.pico8parse.mod.ast.GotoStatement_
  - typingsJapgolly.pico8parse.mod.ast.ReturnStatement_
  - typingsJapgolly.pico8parse.mod.ast.IfStatement_
  - typingsJapgolly.pico8parse.mod.ast.WhileStatement_
  - typingsJapgolly.pico8parse.mod.ast.DoStatement_
  - typingsJapgolly.pico8parse.mod.ast.RepeatStatement_
  - typingsJapgolly.pico8parse.mod.ast.LocalStatement_
  - typingsJapgolly.pico8parse.mod.ast.AssignmentStatement_
  - typingsJapgolly.pico8parse.mod.ast.AssignmentOperatorStatement_
  - typingsJapgolly.pico8parse.mod.ast.CallStatement_
  - typingsJapgolly.pico8parse.mod.ast.FunctionDeclaration
  - typingsJapgolly.pico8parse.mod.ast.ForNumericStatement_
  - typingsJapgolly.pico8parse.mod.ast.ForGenericStatement_
*/
