...
object libSchemaDotinterfaceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.parquetjs.libSchemaDotinterfaceMod.SingleFieldInterface
    - typingsJapgolly.parquetjs.libSchemaDotinterfaceMod.NestedFieldsInterface
  */
  trait SchemaInterfaceField extends StObject
  object SchemaInterfaceField {
    
    inline def NestedFieldsInterface(fields: SchemaInterface): typingsJapgolly.parquetjs.libSchemaDotinterfaceMod.NestedFieldsInterface = {
      val __obj = js.Dynamic.literal(fields = fields.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.parquetjs.libSchemaDotinterfaceMod.NestedFieldsInterface]
    }
    
    inline def SingleFieldInterface(`type`: String): typingsJapgolly.parquetjs.libSchemaDotinterfaceMod.SingleFieldInterface = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.parquetjs.libSchemaDotinterfaceMod.SingleFieldInterface]
    }
  }
