...
class Pica () extends js.Object {
  ...
  /**
    ...
    */
  def resize(from: typingsJapgolly.std.HTMLCanvasElement, to: HTMLCanvasElement): js.Promise[HTMLCanvasElement] = js.native
  def resize(from: typingsJapgolly.std.HTMLCanvasElement, to: HTMLCanvasElement, options: PicaResizeOptions): js.Promise[HTMLCanvasElement] = js.native
