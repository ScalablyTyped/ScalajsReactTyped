...
import typingsJapgolly.postmanCollection.anon.Enabled
import typingsJapgolly.postmanCollection.anon.IgnoreCase
...
- typingsJapgolly.postmanCollection.mod.RequestDefinition because var conflicts: description, disabled, id, name. Inlined url, method, header, body, auth, proxy, certificate */ @JSImport("postman-collection", "Request")
@js.native
