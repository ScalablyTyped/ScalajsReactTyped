...
import typingsJapgolly.postmanCollection.AnonEncode
import typingsJapgolly.postmanCollection.AnonKeyValue
...
- typingsJapgolly.postmanCollection.mod.QueryParamDefinition because var conflicts: description, disabled, id, name. Inlined key, value, system */ @JSImport("postman-collection", "QueryParam")
@js.native
