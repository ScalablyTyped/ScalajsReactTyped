...
object Variable {
  ...
  @js.native
  def types: typingsJapgolly.postmanCollection.anon.Any = js.native
  inline def types_=(x: typingsJapgolly.postmanCollection.anon.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("types")(x.asInstanceOf[js.Any])
}
