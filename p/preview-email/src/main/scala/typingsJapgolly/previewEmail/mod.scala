package typingsJapgolly.previewEmail
...
object mod {
  ...
  /**
    ...
    */
  inline def apply(message: typingsJapgolly.nodemailer.libMailerMod.Options): js.Promise[String] = ^.asInstanceOf[js.Dynamic].apply(message.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
  inline def apply(message: typingsJapgolly.nodemailer.libMailerMod.Options, options: Options): js.Promise[String] = (^.asInstanceOf[js.Dynamic].apply(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[String]]
