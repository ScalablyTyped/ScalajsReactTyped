...
import typingsJapgolly.node.ttyMod.ReadStream
import typingsJapgolly.node.ttyMod.WriteStream
import typingsJapgolly.prompt.promptStrings.SIGINT
import typingsJapgolly.prompt.promptStrings.invalid
import typingsJapgolly.prompt.promptStrings.pause
import typingsJapgolly.prompt.promptStrings.resume
import typingsJapgolly.prompt.promptStrings.start
import typingsJapgolly.prompt.promptStrings.stop
import typingsJapgolly.revalidator.Revalidator.Formats
import typingsJapgolly.revalidator.Revalidator.ISchema
import typingsJapgolly.revalidator.Revalidator.JSONSchema
import typingsJapgolly.revalidator.Revalidator.Types
...
object mod {
  ...
  @js.native
  open class ^ ()
    extends typingsJapgolly.prompt.mod.prompt
  @JSImport("prompt", JSImport.Namespace)
  @js.native
  ...
  object RevalidatorSchema {
    ...
    extension [Self <: RevalidatorSchema](x: Self) {
      ...
      inline def setAsk(value: CallbackTo[Boolean]): Self = StObject.set(x, "ask", value.toJsFn)
  ...
  trait prompt extends EventEmitter {
    ...
    @JSName("on")
    def on_prompt(
      event: typingsJapgolly.prompt.promptStrings.prompt,
