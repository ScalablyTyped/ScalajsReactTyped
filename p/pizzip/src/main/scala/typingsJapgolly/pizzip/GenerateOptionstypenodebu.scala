...
object GenerateOptionstypenodebu {
  ...
  def apply(
    ...
    encodeFileName: /* name */ String => CallbackTo[Buffer] = null,
    ...
    if (encodeFileName != null) __obj.updateDynamic("encodeFileName")(js.Any.fromFunction1((t0: /* name */ java.lang.String) => encodeFileName(t0).runNow()))
