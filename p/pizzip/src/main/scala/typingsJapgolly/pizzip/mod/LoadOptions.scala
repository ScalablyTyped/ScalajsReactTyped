...
object LoadOptions {
  ...
  def apply(
    ...
    decodeFileName: /* bytes */ scala.scalajs.js.typedarray.Uint8Array | js.Array[Double] => CallbackTo[String] = null,
    ...
    if (decodeFileName != null) __obj.updateDynamic("decodeFileName")(js.Any.fromFunction1((t0: /* bytes */ scala.scalajs.js.typedarray.Uint8Array | js.Array[scala.Double]) => decodeFileName(t0).runNow()))
