...
import typingsJapgolly.paypalRestSdk.mod.Item
...
object anon {
  ...
  trait Address extends StObject {
    ...
    var address: typingsJapgolly.paypalRestSdk.mod.Address
  ...
  object Address {
    ...
    inline def apply(address: typingsJapgolly.paypalRestSdk.mod.Address, first_name: String, last_name: String): Address = {
    ...
    extension [Self <: Address](x: Self) {
      ...
      inline def setAddress(value: typingsJapgolly.paypalRestSdk.mod.Address): Self = StObject.set(x, "address", value.asInstanceOf[js.Any])
  ...
  trait Items extends StObject {
    ...
    var shipping_address: js.UndefOr[typingsJapgolly.paypalRestSdk.mod.Address] = js.undefined
  ...
  object Items {
    ...
    extension [Self <: Items](x: Self) {
      ...
      inline def setShipping_address(value: typingsJapgolly.paypalRestSdk.mod.Address): Self = StObject.set(x, "shipping_address", value.asInstanceOf[js.Any])
