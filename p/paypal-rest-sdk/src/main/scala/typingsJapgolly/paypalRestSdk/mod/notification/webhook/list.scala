...
import typingsJapgolly.paypalRestSdk.mod.QueryParameters
...
object list extends js.Object {
  ...
  def apply(data: CallbackFunction[WebhookListResponse], config: CallbackFunction[WebhookListResponse]): Unit = js.native
  def apply(
    data: CallbackFunction[WebhookListResponse],
    config: CallbackFunction[WebhookListResponse],
    cb: CallbackFunction[WebhookListResponse]
