...
object RadioButtons {
  def apply(
    ...
    RadioButtonsProps, 
    typingsJapgolly.protonNative.mod.RadioButtons, 
    Unit, 
    RadioButtonsProps
  ] = {
  ...
  typingsJapgolly.protonNative.mod.RadioButtonsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.protonNative.mod.RadioButtons](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.protonNative.mod.RadioButtonsProps])(children: _*)
  }
