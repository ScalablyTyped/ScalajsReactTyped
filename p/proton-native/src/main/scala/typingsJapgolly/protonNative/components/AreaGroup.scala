...
import typingsJapgolly.protonNative.mod.AreaGroupProps
...
object AreaGroup {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[AreaGroupProps, typingsJapgolly.protonNative.mod.AreaGroup, Unit, AreaGroupProps] = {
  ...
  typingsJapgolly.protonNative.mod.AreaGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.protonNative.mod.AreaGroup](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.protonNative.mod.AreaGroupProps])(children: _*)
  }
