...
import typingsJapgolly.protonNative.mod.AreaCircleProps
...
object AreaCircle {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[AreaCircleProps, typingsJapgolly.protonNative.mod.AreaCircle, Unit, AreaCircleProps] = {
  ...
  typingsJapgolly.protonNative.mod.AreaCircleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.protonNative.mod.AreaCircle](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.protonNative.mod.AreaCircleProps])(children: _*)
  }
