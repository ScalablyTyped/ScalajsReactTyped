...
object Slider {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SliderProps, typingsJapgolly.protonNative.mod.Slider, Unit, SliderProps] = {
  ...
  typingsJapgolly.protonNative.mod.SliderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.protonNative.mod.Slider](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.protonNative.mod.SliderProps])(children: _*)
  }
