...
object Form {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FormProps, typingsJapgolly.protonNative.mod.Form, Unit, FormProps] = {
  ...
  typingsJapgolly.protonNative.mod.FormProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.protonNative.mod.Form](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.protonNative.mod.FormProps])(children: _*)
  }
