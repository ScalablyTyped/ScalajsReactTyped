...
object SpinBox {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SpinBoxProps, typingsJapgolly.protonNative.mod.SpinBox, Unit, SpinBoxProps] = {
  ...
  typingsJapgolly.protonNative.mod.SpinBoxProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.protonNative.mod.SpinBox](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.protonNative.mod.SpinBoxProps])(children: _*)
  }
