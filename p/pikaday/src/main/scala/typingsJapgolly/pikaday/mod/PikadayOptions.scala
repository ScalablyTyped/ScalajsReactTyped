package typingsJapgolly.pikaday.mod
...
object PikadayOptions {
  ...
  def apply(
    ...
    disableDayFn: /* date */ js.Date => CallbackTo[Boolean] = null,
    ...
    parse: (/* date */ String, /* format */ String) => CallbackTo[js.Date | Null] = null,
    ...
    theme: String = null,
    toString: (/* date */ js.Date, /* format */ js.UndefOr[String]) => CallbackTo[String] = null,
    ...
    if (disableDayFn != null) __obj.updateDynamic("disableDayFn")(js.Any.fromFunction1((t0: /* date */ js.Date) => disableDayFn(t0).runNow()))
    ...
    if (parse != null) __obj.updateDynamic("parse")(js.Any.fromFunction2((t0: /* date */ java.lang.String, t1: /* format */ java.lang.String) => parse(t0, t1).runNow()))
    ...
    if (toString != null) __obj.updateDynamic("toString")(js.Any.fromFunction2((t0: /* date */ js.Date, t1: /* format */ js.UndefOr[java.lang.String]) => toString(t0, t1).runNow()))
