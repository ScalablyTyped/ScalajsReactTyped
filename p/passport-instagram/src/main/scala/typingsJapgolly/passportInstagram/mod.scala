package typingsJapgolly.passportInstagram

import typingsJapgolly.express.mod.Request_
import typingsJapgolly.passportInstagram.passportInstagramBooleans.`false`
import typingsJapgolly.passportInstagram.passportInstagramBooleans.`true`
