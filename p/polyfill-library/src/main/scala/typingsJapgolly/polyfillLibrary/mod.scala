...
import typingsJapgolly.polyfillLibrary.anon.AliasOf
import typingsJapgolly.polyfillLibrary.anon.Flags
import typingsJapgolly.polyfillLibrary.polyfillLibraryBooleans.`false`
import typingsJapgolly.polyfillLibrary.polyfillLibraryStrings.ignore
import typingsJapgolly.polyfillLibrary.polyfillLibraryStrings.polyfill
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.polyfillLibrary.polyfillLibraryStrings.always
    - typingsJapgolly.polyfillLibrary.polyfillLibraryStrings.gated
  */
  trait Flag extends StObject
  object Flag {
    
    inline def always: typingsJapgolly.polyfillLibrary.polyfillLibraryStrings.always = "always".asInstanceOf[typingsJapgolly.polyfillLibrary.polyfillLibraryStrings.always]
    
    inline def gated: typingsJapgolly.polyfillLibrary.polyfillLibraryStrings.gated = "gated".asInstanceOf[typingsJapgolly.polyfillLibrary.polyfillLibraryStrings.gated]
  }
