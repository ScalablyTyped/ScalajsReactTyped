...
import typingsJapgolly.payuEmeaSdk.anon.Error
import typingsJapgolly.payuEmeaSdk.payuEmeaSdkStrings.technical
import typingsJapgolly.payuEmeaSdk.payuEmeaSdkStrings.validation
