package typingsJapgolly.pWaitFor
...
object mod {
  ...
  open class TimeoutError ()
    extends typingsJapgolly.pTimeout.mod.TimeoutError {
  ...
  trait Options[ResolveValueType] extends StObject {
    ...
    /**
    	...
    	```
    	*/
    val timeout: js.UndefOr[Double | typingsJapgolly.pTimeout.mod.Options[ResolveValueType]] = js.undefined
  }
  object Options {
    ...
    extension [Self <: Options[?], ResolveValueType](x: Self & Options[ResolveValueType]) {
      ...
      inline def setTimeout(value: Double | typingsJapgolly.pTimeout.mod.Options[ResolveValueType]): Self = StObject.set(x, "timeout", value.asInstanceOf[js.Any])
