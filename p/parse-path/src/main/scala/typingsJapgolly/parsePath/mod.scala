...
object mod {
  ...
  */
  ...
  object Protocol {
    ...
    inline def file: typingsJapgolly.parsePath.parsePathStrings.file = "file".asInstanceOf[typingsJapgolly.parsePath.parsePathStrings.file]
    
    inline def git: typingsJapgolly.parsePath.parsePathStrings.git = "git".asInstanceOf[typingsJapgolly.parsePath.parsePathStrings.git]
    
    inline def http: typingsJapgolly.parsePath.parsePathStrings.http = "http".asInstanceOf[typingsJapgolly.parsePath.parsePathStrings.http]
    
    inline def https: typingsJapgolly.parsePath.parsePathStrings.https = "https".asInstanceOf[typingsJapgolly.parsePath.parsePathStrings.https]
    
    inline def ssh: typingsJapgolly.parsePath.parsePathStrings.ssh = "ssh".asInstanceOf[typingsJapgolly.parsePath.parsePathStrings.ssh]
  }
}
