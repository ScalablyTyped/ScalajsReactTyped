package typingsJapgolly.pixiMeshExtras

import typingsJapgolly.pixiConstants.mod.DRAW_MODES
import typingsJapgolly.pixiCore.mod.IArrayBuffer
import typingsJapgolly.pixiCore.mod.ITypedArray
...
import typingsJapgolly.pixiMesh.mod.Mesh
import typingsJapgolly.pixiMesh.mod.MeshGeometry
import typingsJapgolly.pixiMesh.mod.MeshMaterial
...
object mod {
  ...
  open class NineSlicePlane protected ()
    extends SimplePlane
       with typingsJapgolly.pixiMeshExtras.GlobalMixins.NineSlicePlane {
    /**
