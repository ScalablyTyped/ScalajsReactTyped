...
object typesLibColornamesMod {
  
  @JSImport("postcss-merge-longhand/types/lib/colornames", JSImport.Namespace)
  @js.native
  ...
  @JSImport("postcss-merge-longhand/types/lib/colornames", "size")
  @js.native
