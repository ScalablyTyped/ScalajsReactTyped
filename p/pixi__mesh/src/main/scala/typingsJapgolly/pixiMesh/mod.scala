package typingsJapgolly.pixiMesh
...
import typingsJapgolly.pixiCore.mod.Program
...
import typingsJapgolly.pixiCore.mod.TextureMatrix
...
object mod {
  ...
  open class Mesh[T /* <: Shader */] protected ()
    extends Container[DisplayObject]
       with typingsJapgolly.pixiMesh.GlobalMixins.Mesh {
    /**
  ...
  open class MeshMaterial protected ()
    extends Shader
       with typingsJapgolly.pixiMesh.GlobalMixins.MeshMaterial {
    /**
