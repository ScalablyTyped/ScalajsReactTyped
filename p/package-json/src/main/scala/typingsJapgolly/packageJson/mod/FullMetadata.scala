...
import typingsJapgolly.packageJson.AnonDictversion
import typingsJapgolly.packageJson.AnonEmail
import typingsJapgolly.packageJson.AnonType
import typingsJapgolly.packageJson.AnonUrl
