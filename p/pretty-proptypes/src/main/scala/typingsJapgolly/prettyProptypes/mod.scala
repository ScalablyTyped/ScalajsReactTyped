package typingsJapgolly.prettyProptypes

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.prettyProptypes.anon.PartialComponents
import typingsJapgolly.prettyProptypes.prettyProptypesStrings.`object`
import typingsJapgolly.prettyProptypes.prettyProptypesStrings.generic
import typingsJapgolly.prettyProptypes.prettyProptypesStrings.intersection
...
object mod {
  ...
  trait DynamicPropsProps extends StObject {
    ...
    var props: typingsJapgolly.prettyProptypes.anon.Component
    
    var shouldCollapseProps: js.UndefOr[Boolean] = js.undefined
  }
  object DynamicPropsProps {
    
    inline def apply(props: typingsJapgolly.prettyProptypes.anon.Component): DynamicPropsProps = {
    ...
    extension [Self <: DynamicPropsProps](x: Self) {
      ...
      inline def setProps(value: typingsJapgolly.prettyProptypes.anon.Component): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
  ...
  type Props = japgolly.scalajs.react.facade.React.Component[DynamicPropsProps & js.Object, js.Object]
}
