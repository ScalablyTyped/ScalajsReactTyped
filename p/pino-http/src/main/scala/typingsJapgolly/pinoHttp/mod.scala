...
object mod {
  ...
  object httpAugmentingMod {
    ...
    object IncomingMessage {
      ...
      inline def apply(id: ReqId, log: Logger[LoggerOptions]): typingsJapgolly.pinoHttp.mod.httpAugmentingMod.IncomingMessage = {
        val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], log = log.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.pinoHttp.mod.httpAugmentingMod.IncomingMessage]
      }
      
      extension [Self <: typingsJapgolly.pinoHttp.mod.httpAugmentingMod.IncomingMessage](x: Self) {
    ...
    object ServerResponse {
      ...
      inline def apply(): typingsJapgolly.pinoHttp.mod.httpAugmentingMod.ServerResponse = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.pinoHttp.mod.httpAugmentingMod.ServerResponse]
      }
      
      extension [Self <: typingsJapgolly.pinoHttp.mod.httpAugmentingMod.ServerResponse](x: Self) {
