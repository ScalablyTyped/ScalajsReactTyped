...
trait AuthKey extends StObject {
  ...
  var origin: js.UndefOr[String | js.Array[String]] = js.undefined
  ...
  var subscribeRequestTimeout: js.UndefOr[Double] = js.undefined
  
  var suppressLeaveEvents: js.UndefOr[Boolean] = js.undefined
  
  var useRandomIVs: js.UndefOr[Boolean] = js.undefined
}
object AuthKey {
  
  inline def apply(subscribeKey: String): AuthKey = {
  ...
  extension [Self <: AuthKey](x: Self) {
    ...
    inline def setOrigin(value: String | js.Array[String]): Self = StObject.set(x, "origin", value.asInstanceOf[js.Any])
    ...
    inline def setSubscribeRequestTimeout(value: Double): Self = StObject.set(x, "subscribeRequestTimeout", value.asInstanceOf[js.Any])
    
    inline def setSubscribeRequestTimeoutUndefined: Self = StObject.set(x, "subscribeRequestTimeout", js.undefined)
    ...
    inline def setUseRandomIVs(value: Boolean): Self = StObject.set(x, "useRandomIVs", value.asInstanceOf[js.Any])
    
    inline def setUseRandomIVsUndefined: Self = StObject.set(x, "useRandomIVs", js.undefined)
  }
}
