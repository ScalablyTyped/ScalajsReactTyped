...
object global {
  ...
  open class Acceleration ()
    extends StObject
       with typingsJapgolly.phonegap.Acceleration {
  ...
  open class CameraPopoverOptions protected ()
    extends StObject
       with typingsJapgolly.phonegap.CameraPopoverOptions {
  ...
  @JSGlobal("Connection")
  @js.native
  def Connection: typingsJapgolly.phonegap.Connection = js.native
  ...
  open class ContactField protected ()
    extends StObject
       with typingsJapgolly.phonegap.ContactField {
  ...
  open class ContactFindOptions ()
    extends StObject
       with typingsJapgolly.phonegap.ContactFindOptions
  ...
  open class ContactName ()
    extends StObject
       with typingsJapgolly.phonegap.ContactName {
  ...
  open class FileTransfer ()
    extends StObject
       with typingsJapgolly.phonegap.FileTransfer
  ...
  open class FileUploadOptions ()
    extends StObject
       with typingsJapgolly.phonegap.FileUploadOptions
  ...
  @JSGlobal("Keyboard")
  @js.native
  def Keyboard: typingsJapgolly.phonegap.Keyboard = js.native
  ...
  @js.native
  def LocalFileSystem: typingsJapgolly.phonegap.LocalFileSystem = js.native
  ...
  open class Media protected ()
    extends StObject
       with typingsJapgolly.phonegap.Media {
    def this(
      src: String,
  ...
  @JSGlobal("StatusBar")
  @js.native
  def StatusBar: typingsJapgolly.phonegap.StatusBar = js.native
