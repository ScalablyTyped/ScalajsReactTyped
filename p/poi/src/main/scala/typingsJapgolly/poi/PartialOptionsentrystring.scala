...
import typingsJapgolly.htmlWebpackPlugin.mod.TemplateParametersAssets
...
import typingsJapgolly.poi.poiStrings.dependency
import typingsJapgolly.poi.poiStrings.head
import typingsJapgolly.poi.poiStrings.manual
import typingsJapgolly.poi.poiStrings.none
