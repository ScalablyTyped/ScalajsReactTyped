package typingsJapgolly.poi.mod.ConfigLoader
...
object Options {
  ...
  def apply(
    ...
    parseJSON: /* str */ String => CallbackTo[js.Any] = null,
    stopDir: String = null
  ): Options = {
    ...
    if (parseJSON != null) __obj.updateDynamic("parseJSON")(js.Any.fromFunction1((t0: /* str */ java.lang.String) => parseJSON(t0).runNow()))
