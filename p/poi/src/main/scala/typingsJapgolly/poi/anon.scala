...
import typingsJapgolly.htmlWebpackPlugin.mod.MinifyOptions
import typingsJapgolly.htmlWebpackPlugin.mod.ProcessedOptions
import typingsJapgolly.poi.poiBooleans.`false`
import typingsJapgolly.poi.poiBooleans.`true`
import typingsJapgolly.poi.poiStrings.all
import typingsJapgolly.poi.poiStrings.auto
import typingsJapgolly.poi.poiStrings.blocking
import typingsJapgolly.poi.poiStrings.body
import typingsJapgolly.poi.poiStrings.defer
import typingsJapgolly.poi.poiStrings.head
import typingsJapgolly.poi.poiStrings.manual
import typingsJapgolly.poi.poiStrings.module
