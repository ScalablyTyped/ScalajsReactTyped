...
object IAddOptions {
  ...
  extension [Self <: IAddOptions](x: Self) {
    ...
    inline def setCallback(value: /* resource */ LoaderResource => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* resource */ LoaderResource) => value(t0).runNow()))
    ...
    inline def setOnComplete(value: /* resource */ LoaderResource => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction1((t0: /* resource */ LoaderResource) => value(t0).runNow()))
