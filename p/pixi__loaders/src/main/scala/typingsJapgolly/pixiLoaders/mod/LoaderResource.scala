...
import typingsJapgolly.pixiLoaders.mod.LoaderResource.OnProgressSignal
import typingsJapgolly.pixiLoaders.mod.LoaderResource.OnStartSignal
import typingsJapgolly.pixiLoaders.mod.LoaderResource.TYPE
...
open class LoaderResource protected ()
  extends StObject
     with typingsJapgolly.pixiLoaders.GlobalMixins.LoaderResource
     with typingsJapgolly.pixiLoaders.GlobalMixins.ILoaderResource {
  /**
