...
import typingsJapgolly.pixiLoaders.anon.TypeofLoader
import typingsJapgolly.pixiLoaders.mod.Loader.OnErrorSignal
import typingsJapgolly.pixiLoaders.mod.Loader.OnLoadSignal
import typingsJapgolly.pixiLoaders.mod.Loader.OnProgressSignal
import typingsJapgolly.pixiLoaders.mod.Loader.OnStartSignal
import typingsJapgolly.pixiLoaders.mod.LoaderResource.OnCompleteSignal
...
open class Loader () extends StObject {
  ...
  def load(cb: typingsJapgolly.pixiLoaders.mod.Loader.OnCompleteSignal): this.type = js.native
  
  /** Loading state of the loader, true if it is currently loading resources. */
  var loading: Boolean = js.native
  
  /** Dispatched when the queued resources all load. */
  var onComplete: Signal[typingsJapgolly.pixiLoaders.mod.Loader.OnCompleteSignal] = js.native
