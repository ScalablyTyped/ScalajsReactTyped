...
object tableMod {
  ...
  trait Table extends StObject {
    ...
    /**
      ...
      */
    def get(query: js.Object): js.Promise[Any] = js.native
    ...
    /**
      ...
      * the lookup fails.
      */
    def scan(): js.Promise[js.Array[Any]] = js.native
    def scan(callback: js.Function1[/* items */ js.Array[Any], js.Promise[Boolean]]): js.Promise[Unit] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pulumiCloud.pulumiCloudStrings.string
    - typingsJapgolly.pulumiCloud.pulumiCloudStrings.number
    - typingsJapgolly.pulumiCloud.pulumiCloudStrings.boolean
  */
  trait PrimaryKeyType extends StObject
  object PrimaryKeyType {
    
    inline def boolean: typingsJapgolly.pulumiCloud.pulumiCloudStrings.boolean = "boolean".asInstanceOf[typingsJapgolly.pulumiCloud.pulumiCloudStrings.boolean]
    
    inline def number: typingsJapgolly.pulumiCloud.pulumiCloudStrings.number = "number".asInstanceOf[typingsJapgolly.pulumiCloud.pulumiCloudStrings.number]
    
    inline def string: typingsJapgolly.pulumiCloud.pulumiCloudStrings.string = "string".asInstanceOf[typingsJapgolly.pulumiCloud.pulumiCloudStrings.string]
  }
