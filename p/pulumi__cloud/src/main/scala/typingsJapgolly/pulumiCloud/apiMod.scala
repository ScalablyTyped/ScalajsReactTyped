...
import typingsJapgolly.pulumiCloud.serviceMod.Endpoint
...
object apiMod {
  ...
  object HttpDeployment {
    ...
    extension [Self <: HttpDeployment](x: Self) {
      ...
      inline def setCustomDomainNamesVarargs(value: Output_[String]*): Self = StObject.set(x, "customDomainNames", js.Array(value*))
  ...
  trait Response extends StObject {
    ...
    /**
      ...
      * the HTTP response.
      */
    def json(obj: Any): Unit = js.native
