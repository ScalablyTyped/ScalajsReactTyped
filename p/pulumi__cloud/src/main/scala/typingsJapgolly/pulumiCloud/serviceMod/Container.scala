...
object Container {
  ...
  extension [Self <: Container](x: Self) {
    ...
    inline def setFunction(value: Callback): Self = StObject.set(x, "function", value.toJsFn)
    ...
    inline def setVolumesVarargs(value: ContainerVolumeMount*): Self = StObject.set(x, "volumes", js.Array(value*))
  }
}
