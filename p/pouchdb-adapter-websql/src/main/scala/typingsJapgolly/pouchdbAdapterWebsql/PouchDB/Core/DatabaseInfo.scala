package typingsJapgolly.pouchdbAdapterWebsql.PouchDB.Core

import typingsJapgolly.pouchdbAdapterWebsql.pouchdbAdapterWebsqlStrings.`UTF-16`
import typingsJapgolly.pouchdbAdapterWebsql.pouchdbAdapterWebsqlStrings.`UTF-8`
