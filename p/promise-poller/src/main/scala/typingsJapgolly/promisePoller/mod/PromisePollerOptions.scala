package typingsJapgolly.promisePoller.mod
...
object PromisePollerOptions {
  @scala.inline
  def apply[T](
    taskFn: CallbackTo[T | js.Thenable[T]],
    ...
    min: Int | Double = null,
    name: String = null,
    progressCallback: (/* retriesRemaining */ Double, /* error */ js.Any) => Callback = null,
    retries: Int | Double = null,
    shouldContinue: (/* reason */ js.Any, /* value */ js.UndefOr[T]) => CallbackTo[Boolean] = null,
    start: Int | Double = null,
    strategy: `fixed-interval` | `linear-backoff` | `exponential-backoff` = null,
    timeout: Int | Double = null
  ): PromisePollerOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("taskFn")(taskFn.toJsFn)
    ...
    if (progressCallback != null) __obj.updateDynamic("progressCallback")(js.Any.fromFunction2((t0: /* retriesRemaining */ scala.Double, t1: /* error */ js.Any) => progressCallback(t0, t1).runNow()))
    if (retries != null) __obj.updateDynamic("retries")(retries.asInstanceOf[js.Any])
    if (shouldContinue != null) __obj.updateDynamic("shouldContinue")(js.Any.fromFunction2((t0: /* reason */ js.Any, t1: /* value */ js.UndefOr[T]) => shouldContinue(t0, t1).runNow()))
