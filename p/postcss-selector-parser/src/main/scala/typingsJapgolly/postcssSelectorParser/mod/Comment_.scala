...
trait Comment_
  ...
  @JSName("type")
  var type_Comment_ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.comment
}
object Comment_ {
  ...
  extension [Self <: Comment_](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.comment): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
