...
trait Identifier
  ...
  @JSName("type")
  var type_Identifier: typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.id
}
object Identifier {
  ...
  extension [Self <: Identifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.id): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
