...
import typingsJapgolly.postcssSelectorParser.anon.After
import typingsJapgolly.postcssSelectorParser.anon.Insensitive
import typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings._empty
import typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.attributeNS
import typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.i
import typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.insensitive
import typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.namespace
import typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.ns
import typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.operator
import typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.value
...
trait Attribute_
  ...
  /**
    ...
    */
  def offsetOf(
    part: ns | namespace | typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.attribute | attributeNS | operator | value | insensitive
  ): Double = js.native
  ...
  @JSName("type")
  var type_Attribute_ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.attribute = js.native
}
