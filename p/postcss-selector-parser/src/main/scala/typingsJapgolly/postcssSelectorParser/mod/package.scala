...
import typingsJapgolly.postcssSelectorParser.mod.^
import typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.Quotationmark
...
inline def ATTRIBUTE__ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.attribute = ^.asInstanceOf[js.Dynamic].selectDynamic("ATTRIBUTE").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.attribute]

inline def CLASS: `class` = ^.asInstanceOf[js.Dynamic].selectDynamic("CLASS").asInstanceOf[`class`]

inline def COMBINATOR__ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.combinator = ^.asInstanceOf[js.Dynamic].selectDynamic("COMBINATOR").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.combinator]

inline def COMMENT__ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.comment = ^.asInstanceOf[js.Dynamic].selectDynamic("COMMENT").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.comment]

inline def ID_ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.id = ^.asInstanceOf[js.Dynamic].selectDynamic("ID").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.id]

inline def NESTING__ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.nesting = ^.asInstanceOf[js.Dynamic].selectDynamic("NESTING").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.nesting]

inline def PSEUDO__ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.pseudo = ^.asInstanceOf[js.Dynamic].selectDynamic("PSEUDO").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.pseudo]

inline def ROOT__ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.root = ^.asInstanceOf[js.Dynamic].selectDynamic("ROOT").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.root]

inline def SELECTOR__ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.selector = ^.asInstanceOf[js.Dynamic].selectDynamic("SELECTOR").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.selector]

inline def STRING__ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.string = ^.asInstanceOf[js.Dynamic].selectDynamic("STRING").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.string]

inline def TAG__ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.tag = ^.asInstanceOf[js.Dynamic].selectDynamic("TAG").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.tag]

inline def UNIVERSAL__ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.universal = ^.asInstanceOf[js.Dynamic].selectDynamic("UNIVERSAL").asInstanceOf[typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.universal]
