...
trait Universal_
  ...
  @JSName("type")
  var type_Universal_ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.universal
}
object Universal_ {
  ...
  extension [Self <: Universal_](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.universal): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
