...
trait String_
  ...
  @JSName("type")
  var type_String_ : typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.string
}
object String_ {
  ...
  extension [Self <: String_](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.postcssSelectorParser.postcssSelectorParserStrings.string): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
