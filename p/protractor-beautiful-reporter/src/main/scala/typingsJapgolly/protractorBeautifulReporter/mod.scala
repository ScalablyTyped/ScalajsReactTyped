package typingsJapgolly.protractorBeautifulReporter

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.jasmine.jasmine.CustomReporter
import typingsJapgolly.jasmine.jasmine.SpecResult
import typingsJapgolly.protractorBeautifulReporter.anon.Name
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.belowHeader
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.footer
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.h
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.hColonm
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.hColonmColons
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.header
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.hm
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.hms
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.m
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.ms
import typingsJapgolly.protractorBeautifulReporter.protractorBeautifulReporterStrings.s
...
object mod {
  ...
  object HtmlReporter {
    ...
    inline def apply(
      getJasmine2Reporter: CallbackTo[CustomReporter],
      jasmine2MetaDataBuilder: (Null, js.Array[String], SpecResult, Capabilities) => StubMetaData
    ): HtmlReporter = {
      val __obj = js.Dynamic.literal(getJasmine2Reporter = getJasmine2Reporter.toJsFn, jasmine2MetaDataBuilder = js.Any.fromFunction4(jasmine2MetaDataBuilder))
      __obj.asInstanceOf[HtmlReporter]
    }
    
    extension [Self <: HtmlReporter](x: Self) {
      
      inline def setGetJasmine2Reporter(value: CallbackTo[CustomReporter]): Self = StObject.set(x, "getJasmine2Reporter", value.toJsFn)
