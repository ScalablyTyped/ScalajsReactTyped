...
object messagesMessagesMod {
  ...
  object MessagesMessage {
    ...
    extension [Self <: MessagesMessage](x: Self) {
      ...
      inline def setIconFunction1(value: /* options */ IconOptions[MessagesProps] => Node): Self = StObject.set(x, "icon", js.Any.fromFunction1(value))
  ...
  object MessagesProps {
    ...
    extension [Self <: MessagesProps](x: Self) {
      ...
      inline def setOnClick(value: /* message */ MessagesMessage => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* message */ MessagesMessage) => value(t0).runNow()))
      ...
      inline def setOnRemove(value: /* message */ MessagesMessage => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: /* message */ MessagesMessage) => value(t0).runNow()))
