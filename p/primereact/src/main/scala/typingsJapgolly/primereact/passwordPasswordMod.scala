...
object passwordPasswordMod {
  
  @JSImport("primereact/password/password", "Password")
  @js.native
  open class Password protected () extends Component[PasswordProps, Any, Any] {
  ...
  type PasswordContentType = Node | (js.Function1[/* props */ PasswordProps, Node])
  
  type PasswordFooterType = Node | (js.Function1[/* props */ PasswordProps, Node])
  
  type PasswordHeaderType = Node | (js.Function1[/* props */ PasswordProps, Node])
  ...
  object PasswordIconParams {
    ...
    inline def apply(className: String, element: VdomElement, onClick: Callback, props: PasswordProps): PasswordIconParams = {
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], element = element.rawElement.asInstanceOf[js.Any], onClick = onClick.toJsFn, props = props.asInstanceOf[js.Any])
    ...
    extension [Self <: PasswordIconParams](x: Self) {
      ...
      inline def setProps(value: PasswordProps): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
  
  type PasswordIconType = Node | (js.Function1[/* e */ PasswordIconParams, Node])
  ...
  trait PasswordProps extends StObject {
    ...
    var onInput: js.UndefOr[
        js.Function2[/* event */ ReactEventFrom[HTMLInputElement], /* validatePattern */ Boolean, Unit]
      ] = js.undefined
  ...
  object PasswordProps {
    ...
    extension [Self <: PasswordProps](x: Self) {
      ...
      inline def setContentFunction1(value: /* props */ PasswordProps => Node): Self = StObject.set(x, "content", js.Any.fromFunction1(value))
      ...
      inline def setFooterFunction1(value: /* props */ PasswordProps => Node): Self = StObject.set(x, "footer", js.Any.fromFunction1(value))
      ...
      inline def setHeaderFunction1(value: /* props */ PasswordProps => Node): Self = StObject.set(x, "header", js.Any.fromFunction1(value))
      ...
      inline def setIconFunction1(value: /* e */ PasswordIconParams => Node): Self = StObject.set(x, "icon", js.Any.fromFunction1(value))
      ...
      inline def setMediumRegex(value: String): Self = StObject.set(x, "mediumRegex", value.asInstanceOf[js.Any])
      
      inline def setMediumRegexUndefined: Self = StObject.set(x, "mediumRegex", js.undefined)
      ...
      inline def setOnInput(value: (/* event */ ReactEventFrom[HTMLInputElement], /* validatePattern */ Boolean) => Callback): Self = StObject.set(x, "onInput", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[HTMLInputElement], t1: /* validatePattern */ Boolean) => (value(t0, t1)).runNow()))
      ...
      inline def setStrongRegex(value: String): Self = StObject.set(x, "strongRegex", value.asInstanceOf[js.Any])
      
      inline def setStrongRegexUndefined: Self = StObject.set(x, "strongRegex", js.undefined)
      ...
      inline def setToggleMask(value: Boolean): Self = StObject.set(x, "toggleMask", value.asInstanceOf[js.Any])
      
      inline def setToggleMaskUndefined: Self = StObject.set(x, "toggleMask", js.undefined)
