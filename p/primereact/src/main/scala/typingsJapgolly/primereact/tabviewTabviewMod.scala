...
object tabviewTabviewMod {
  ...
  trait TabPanelHeaderTemplateOptions extends StObject {
    ...
    def onClick(event: ReactMouseEventFrom[HTMLElement]): Unit
  ...
  object TabPanelHeaderTemplateOptions {
    ...
    inline def apply(
      ...
      element: VdomElement,
      index: Double,
      leftIconElement: VdomElement,
      onClick: ReactMouseEventFrom[HTMLElement] => Callback,
      props: TabPanelProps,
      rightIconElement: VdomElement,
      selected: Boolean,
      titleClassName: String,
      titleElement: VdomElement
    ): TabPanelHeaderTemplateOptions = {
      val __obj = js.Dynamic.literal(ariaControls = ariaControls.asInstanceOf[js.Any], className = className.asInstanceOf[js.Any], element = element.rawElement.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], leftIconElement = leftIconElement.rawElement.asInstanceOf[js.Any], onClick = js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLElement]) => onClick(t0).runNow()), props = props.asInstanceOf[js.Any], rightIconElement = rightIconElement.rawElement.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any], titleClassName = titleClassName.asInstanceOf[js.Any], titleElement = titleElement.rawElement.asInstanceOf[js.Any])
    ...
    extension [Self <: TabPanelHeaderTemplateOptions](x: Self) {
      ...
      inline def setLeftIconElement(value: VdomElement): Self = StObject.set(x, "leftIconElement", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setRightIconElement(value: VdomElement): Self = StObject.set(x, "rightIconElement", value.rawElement.asInstanceOf[js.Any])
      
      inline def setSelected(value: Boolean): Self = StObject.set(x, "selected", value.asInstanceOf[js.Any])
      
      inline def setTitleClassName(value: String): Self = StObject.set(x, "titleClassName", value.asInstanceOf[js.Any])
      
      inline def setTitleElement(value: VdomElement): Self = StObject.set(x, "titleElement", value.rawElement.asInstanceOf[js.Any])
    }
  }
  
  type TabPanelHeaderTemplateType = Node | (js.Function1[/* options */ TabPanelHeaderTemplateOptions, Node])
  ...
  object TabPanelProps {
    ...
    extension [Self <: TabPanelProps](x: Self) {
      ...
      inline def setHeaderTemplateFunction1(value: /* options */ TabPanelHeaderTemplateOptions => Node): Self = StObject.set(x, "headerTemplate", js.Any.fromFunction1(value))
  ...
  object TabViewProps {
    ...
    extension [Self <: TabViewProps](x: Self) {
      ...
      inline def setOnBeforeTabChange(value: /* e */ TabViewTabChangeParams => Callback): Self = StObject.set(x, "onBeforeTabChange", js.Any.fromFunction1((t0: /* e */ TabViewTabChangeParams) => value(t0).runNow()))
      
      inline def setOnBeforeTabChangeUndefined: Self = StObject.set(x, "onBeforeTabChange", js.undefined)
      
      inline def setOnBeforeTabClose(value: /* e */ TabViewTabCloseParams => Callback): Self = StObject.set(x, "onBeforeTabClose", js.Any.fromFunction1((t0: /* e */ TabViewTabCloseParams) => value(t0).runNow()))
      ...
      inline def setOnTabChange(value: /* e */ TabViewTabChangeParams => Callback): Self = StObject.set(x, "onTabChange", js.Any.fromFunction1((t0: /* e */ TabViewTabChangeParams) => value(t0).runNow()))
      
      inline def setOnTabChangeUndefined: Self = StObject.set(x, "onTabChange", js.undefined)
      
      inline def setOnTabClose(value: /* e */ TabViewTabCloseParams => Callback): Self = StObject.set(x, "onTabClose", js.Any.fromFunction1((t0: /* e */ TabViewTabCloseParams) => value(t0).runNow()))
  ...
  object TabViewTabChangeParams {
    ...
    inline def apply(index: Double, originalEvent: ReactEventFrom[org.scalajs.dom.Element]): TabViewTabChangeParams = {
  ...
  object TabViewTabCloseParams {
    ...
    inline def apply(index: Double, originalEvent: ReactEventFrom[org.scalajs.dom.Element]): TabViewTabCloseParams = {
      val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], originalEvent = originalEvent.asInstanceOf[js.Any])
