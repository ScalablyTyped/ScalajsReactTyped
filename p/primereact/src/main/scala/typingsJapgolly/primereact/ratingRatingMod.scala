...
object ratingRatingMod {
  ...
  @JSImport("primereact/rating/rating", "Rating")
  @js.native
  open class Rating protected () extends Component[RatingProps, Any, Any] {
  ...
  object RatingProps {
    ...
    extension [Self <: RatingProps](x: Self) {
      ...
      inline def setCancelIcon(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<RatingProps> */ Any
      ): Self = StObject.set(x, "cancelIcon", value.asInstanceOf[js.Any])
      
      inline def setCancelIconProps(value: HTMLAttributes[HTMLSpanElement]): Self = StObject.set(x, "cancelIconProps", value.asInstanceOf[js.Any])
      
      inline def setCancelIconPropsUndefined: Self = StObject.set(x, "cancelIconProps", js.undefined)
      ...
      inline def setOffIconProps(value: HTMLAttributes[HTMLSpanElement]): Self = StObject.set(x, "offIconProps", value.asInstanceOf[js.Any])
      
      inline def setOffIconPropsUndefined: Self = StObject.set(x, "offIconProps", js.undefined)
      ...
      inline def setOnChange(value: /* e */ RatingChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ RatingChangeParams) => value(t0).runNow()))
      ...
      inline def setOnIconProps(value: HTMLAttributes[HTMLSpanElement]): Self = StObject.set(x, "onIconProps", value.asInstanceOf[js.Any])
      
      inline def setOnIconPropsUndefined: Self = StObject.set(x, "onIconProps", js.undefined)
