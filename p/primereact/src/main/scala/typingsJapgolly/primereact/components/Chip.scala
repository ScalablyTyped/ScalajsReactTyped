...
import typingsJapgolly.primereact.chipChipMod.ChipProps
...
object Chip {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Chip] {
    ...
    inline def onRemove(value: /* event */ ReactMouseEventFrom[HTMLElement] => Callback): this.type = set("onRemove", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLElement]) => value(t0).runNow()))
    ...
    inline def removeIcon(value: String): this.type = set("removeIcon", value.asInstanceOf[js.Any])
    ...
    inline def template(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify TemplateType<ChipProps> */ Any
    ): this.type = set("template", value.asInstanceOf[js.Any])
