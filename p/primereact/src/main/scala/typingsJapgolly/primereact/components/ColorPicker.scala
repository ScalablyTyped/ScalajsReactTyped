...
import typingsJapgolly.primereact.colorpickerColorpickerMod.ColorPickerAppendToType
import typingsJapgolly.primereact.colorpickerColorpickerMod.ColorPickerChangeParams
import typingsJapgolly.primereact.colorpickerColorpickerMod.ColorPickerProps
import typingsJapgolly.primereact.colorpickerColorpickerMod.ColorPickerValueType
...
object ColorPicker {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.ColorPicker] {
    ...
    inline def appendTo(value: ColorPickerAppendToType): this.type = set("appendTo", value.asInstanceOf[js.Any])
    ...
    inline def defaultColor(value: String): this.type = set("defaultColor", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* e */ ColorPickerChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ ColorPickerChangeParams) => value(t0).runNow()))
    ...
    inline def value(value: ColorPickerValueType): this.type = set("value", value.asInstanceOf[js.Any])
