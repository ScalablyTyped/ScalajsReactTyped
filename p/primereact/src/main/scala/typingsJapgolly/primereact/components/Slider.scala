...
import typingsJapgolly.primereact.sliderSliderMod.SliderChangeParams
import typingsJapgolly.primereact.sliderSliderMod.SliderOrientationType
import typingsJapgolly.primereact.sliderSliderMod.SliderProps
import typingsJapgolly.primereact.sliderSliderMod.SliderSlideEndParams
import typingsJapgolly.primereact.sliderSliderMod.SliderValueType
...
object Slider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Slider] {
    ...
    inline def onChange(value: /* e */ SliderChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ SliderChangeParams) => value(t0).runNow()))
    ...
    inline def onSlideEnd(value: /* e */ SliderSlideEndParams => Callback): this.type = set("onSlideEnd", js.Any.fromFunction1((t0: /* e */ SliderSlideEndParams) => value(t0).runNow()))
    ...
    inline def orientation(value: SliderOrientationType): this.type = set("orientation", value.asInstanceOf[js.Any])
    ...
    inline def value(value: SliderValueType): this.type = set("value", value.asInstanceOf[js.Any])
