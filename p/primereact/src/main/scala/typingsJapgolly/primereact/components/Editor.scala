...
import typingsJapgolly.primereact.editorEditorMod.EditorProps
import typingsJapgolly.primereact.editorEditorMod.EditorSelectionChangeParams
import typingsJapgolly.primereact.editorEditorMod.EditorTextChangeParams
...
object Editor {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Editor] {
    ...
    inline def formats(value: js.Array[String]): this.type = set("formats", value.asInstanceOf[js.Any])
    
    inline def formatsVarargs(value: String*): this.type = set("formats", js.Array(value*))
    
    inline def headerTemplate(value: VdomNode): this.type = set("headerTemplate", value.rawNode.asInstanceOf[js.Any])
    ...
    inline def modules(value: Any): this.type = set("modules", value.asInstanceOf[js.Any])
    ...
    inline def onLoad(value: /* quill */ Any => Callback): this.type = set("onLoad", js.Any.fromFunction1((t0: /* quill */ Any) => value(t0).runNow()))
    ...
    inline def onSelectionChange(value: /* e */ EditorSelectionChangeParams => Callback): this.type = set("onSelectionChange", js.Any.fromFunction1((t0: /* e */ EditorSelectionChangeParams) => value(t0).runNow()))
    ...
    inline def onTextChange(value: /* e */ EditorTextChangeParams => Callback): this.type = set("onTextChange", js.Any.fromFunction1((t0: /* e */ EditorTextChangeParams) => value(t0).runNow()))
