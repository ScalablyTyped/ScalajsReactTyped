...
import typingsJapgolly.primereact.calendarCalendarMod.DateMetaData
import typingsJapgolly.primereact.calendarCalendarMod.LocaleSettings
...
object Calendar {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CalendarProps, typingsJapgolly.primereact.calendarMod.Calendar, Unit, CalendarProps] = {
  ...
  typingsJapgolly.primereact.calendarCalendarMod.CalendarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.primereact.calendarMod.Calendar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.primereact.calendarCalendarMod.CalendarProps])(children: _*)
  }
