...
import typingsJapgolly.primereact.megamenuMegamenuMod.MegaMenuEndTemplate
import typingsJapgolly.primereact.megamenuMegamenuMod.MegaMenuOrientationType
import typingsJapgolly.primereact.megamenuMegamenuMod.MegaMenuProps
import typingsJapgolly.primereact.megamenuMegamenuMod.MegaMenuStartTemplate
...
object MegaMenu {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.MegaMenu] {
    ...
    inline def end(value: MegaMenuEndTemplate): this.type = set("end", value.asInstanceOf[js.Any])
    
    inline def endFunction1(value: /* props */ MegaMenuProps => Node): this.type = set("end", js.Any.fromFunction1(value))
    
    inline def endNull: this.type = set("end", null)
    
    inline def endVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("end", js.Array(value*))
    
    inline def endVdomElement(value: VdomElement): this.type = set("end", value.rawElement.asInstanceOf[js.Any])
    ...
    ): this.type = set("model", value.asInstanceOf[js.Any])
    
    inline def modelVarargs(
      value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify MenuItem */ Any)*
    ): this.type = set("model", js.Array(value*))
    ...
    inline def orientation(value: MegaMenuOrientationType): this.type = set("orientation", value.asInstanceOf[js.Any])
    ...
    inline def start(value: MegaMenuStartTemplate): this.type = set("start", value.asInstanceOf[js.Any])
    
    inline def startFunction1(value: /* props */ MegaMenuProps => Node): this.type = set("start", js.Any.fromFunction1(value))
    
    inline def startNull: this.type = set("start", null)
    
    inline def startVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("start", js.Array(value*))
    
    inline def startVdomElement(value: VdomElement): this.type = set("start", value.rawElement.asInstanceOf[js.Any])
