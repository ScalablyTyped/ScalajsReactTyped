...
import typingsJapgolly.primereact.fieldsetFieldsetMod.FieldsetProps
import typingsJapgolly.primereact.fieldsetFieldsetMod.FieldsetToggleParams
...
object Fieldset {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Fieldset] {
    ...
    inline def onCollapse(value: /* event */ ReactMouseEventFrom[HTMLElement] => Callback): this.type = set("onCollapse", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLElement]) => value(t0).runNow()))
    ...
    inline def onExpand(value: /* event */ ReactMouseEventFrom[HTMLElement] => Callback): this.type = set("onExpand", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLElement]) => value(t0).runNow()))
    ...
    inline def onToggle(value: /* e */ FieldsetToggleParams => Callback): this.type = set("onToggle", js.Any.fromFunction1((t0: /* e */ FieldsetToggleParams) => value(t0).runNow()))
