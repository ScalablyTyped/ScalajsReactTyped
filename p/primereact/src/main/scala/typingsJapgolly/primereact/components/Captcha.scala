...
object Captcha {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Captcha] {
    ...
    inline def onResponse(value: /* response */ Any => Callback): this.type = set("onResponse", js.Any.fromFunction1((t0: /* response */ Any) => value(t0).runNow()))
