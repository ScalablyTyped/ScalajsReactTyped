...
import typingsJapgolly.primereact.deferredcontentDeferredcontentMod.DeferredContentProps
...
object DeferredContent {
  ...
  @JSImport("primereact", "DeferredContent")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.DeferredContent] {
    ...
    inline def onLoad(value: /* event */ ReactEventFrom[Element] => Callback): this.type = set("onLoad", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
