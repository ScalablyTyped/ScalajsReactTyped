...
import typingsJapgolly.primereact.knobKnobMod.KnobChangeParams
import typingsJapgolly.primereact.knobKnobMod.KnobProps
...
object Knob {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Knob] {
    ...
    inline def onChange(value: /* e */ KnobChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ KnobChangeParams) => value(t0).runNow()))
    ...
    inline def rangeColor(value: String): this.type = set("rangeColor", value.asInstanceOf[js.Any])
    ...
    inline def valueTemplate(value: String): this.type = set("valueTemplate", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Knob.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: KnobProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
