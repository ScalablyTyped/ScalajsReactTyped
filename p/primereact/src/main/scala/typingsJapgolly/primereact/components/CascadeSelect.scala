...
import typingsJapgolly.primereact.cascadeselectCascadeselectMod.CascadeSelectAppendToType
import typingsJapgolly.primereact.cascadeselectCascadeselectMod.CascadeSelectChangeParams
import typingsJapgolly.primereact.cascadeselectCascadeselectMod.CascadeSelectGroupChangeParams
import typingsJapgolly.primereact.cascadeselectCascadeselectMod.CascadeSelectItemTemplateType
import typingsJapgolly.primereact.cascadeselectCascadeselectMod.CascadeSelectProps
...
object CascadeSelect {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.CascadeSelect] {
    ...
    inline def appendTo(value: CascadeSelectAppendToType): this.type = set("appendTo", value.asInstanceOf[js.Any])
    ...
    inline def itemTemplate(value: CascadeSelectItemTemplateType): this.type = set("itemTemplate", value.asInstanceOf[js.Any])
    ...
    inline def onBeforeHide(value: Callback): this.type = set("onBeforeHide", value.toJsFn)
    ...
    inline def onBeforeShow(value: Callback): this.type = set("onBeforeShow", value.toJsFn)
    ...
    inline def onChange(value: /* e */ CascadeSelectChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ CascadeSelectChangeParams) => value(t0).runNow()))
    ...
    inline def onGroupChange(value: /* e */ CascadeSelectGroupChangeParams => Callback): this.type = set("onGroupChange", js.Any.fromFunction1((t0: /* e */ CascadeSelectGroupChangeParams) => value(t0).runNow()))
    ...
    inline def optionGroupChildren(value: js.Array[String]): this.type = set("optionGroupChildren", value.asInstanceOf[js.Any])
    
    inline def optionGroupChildrenVarargs(value: String*): this.type = set("optionGroupChildren", js.Array(value*))
  ...
  implicit def make(companion: CascadeSelect.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CascadeSelectProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
