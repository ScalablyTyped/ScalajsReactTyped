...
import typingsJapgolly.primereact.menuMenuMod.MenuAppendToType
...
object Menu {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Menu] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def appendTo(value: MenuAppendToType): this.type = set("appendTo", value.asInstanceOf[js.Any])
