...
import typingsJapgolly.primereact.slidemenuSlidemenuMod.SlideMenuAppendToType
import typingsJapgolly.primereact.slidemenuSlidemenuMod.SlideMenuProps
...
object SlideMenu {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.SlideMenu] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def appendTo(value: SlideMenuAppendToType): this.type = set("appendTo", value.asInstanceOf[js.Any])
    ...
    inline def backLabel(value: String): this.type = set("backLabel", value.asInstanceOf[js.Any])
    ...
    inline def effectDuration(value: Double): this.type = set("effectDuration", value.asInstanceOf[js.Any])
    ...
    inline def menuWidth(value: Double): this.type = set("menuWidth", value.asInstanceOf[js.Any])
    ...
    inline def viewportHeight(value: Double): this.type = set("viewportHeight", value.asInstanceOf[js.Any])
