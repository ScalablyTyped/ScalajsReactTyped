...
import typingsJapgolly.primereact.togglebuttonTogglebuttonMod.ToggleButtonChangeParams
import typingsJapgolly.primereact.togglebuttonTogglebuttonMod.ToggleButtonIconPositionType
import typingsJapgolly.primereact.togglebuttonTogglebuttonMod.ToggleButtonProps
...
object ToggleButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.ToggleButton] {
    ...
    inline def iconPos(value: ToggleButtonIconPositionType): this.type = set("iconPos", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("offIcon", value.asInstanceOf[js.Any])
    
    inline def offLabel(value: String): this.type = set("offLabel", value.asInstanceOf[js.Any])
    ...
    inline def onBlur(value: /* event */ ReactFocusEventFrom[HTMLElement] => Callback): this.type = set("onBlur", js.Any.fromFunction1((t0: /* event */ ReactFocusEventFrom[HTMLElement]) => value(t0).runNow()))
    ...
    inline def onChange(value: /* e */ ToggleButtonChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ ToggleButtonChangeParams) => value(t0).runNow()))
    ...
    inline def onFocus(value: /* event */ ReactFocusEventFrom[HTMLElement] => Callback): this.type = set("onFocus", js.Any.fromFunction1((t0: /* event */ ReactFocusEventFrom[HTMLElement]) => value(t0).runNow()))
    
    inline def onIcon(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<ToggleButtonProps> */ Any
    ): this.type = set("onIcon", value.asInstanceOf[js.Any])
    ...
    inline def onLabel(value: String): this.type = set("onLabel", value.asInstanceOf[js.Any])
