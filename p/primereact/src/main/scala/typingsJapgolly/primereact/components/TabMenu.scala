...
import typingsJapgolly.primereact.tabmenuTabmenuMod.TabMenuProps
import typingsJapgolly.primereact.tabmenuTabmenuMod.TabMenuTabChangeParams
...
object TabMenu {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.TabMenu] {
    ...
    inline def onTabChange(value: /* e */ TabMenuTabChangeParams => Callback): this.type = set("onTabChange", js.Any.fromFunction1((t0: /* e */ TabMenuTabChangeParams) => value(t0).runNow()))
