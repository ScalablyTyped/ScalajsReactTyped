...
import typingsJapgolly.primereact.splitbuttonSplitbuttonMod.SplitButtonAppendToType
import typingsJapgolly.primereact.splitbuttonSplitbuttonMod.SplitButtonProps
...
object SplitButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.SplitButton] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def appendTo(value: SplitButtonAppendToType): this.type = set("appendTo", value.asInstanceOf[js.Any])
    ...
    inline def loadingIcon(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<SplitButtonProps> */ Any
    ): this.type = set("loadingIcon", value.asInstanceOf[js.Any])
    
    inline def menuButtonClassName(value: String): this.type = set("menuButtonClassName", value.asInstanceOf[js.Any])
    
    inline def menuButtonProps(value: Any): this.type = set("menuButtonProps", value.asInstanceOf[js.Any])
    
    inline def menuClassName(value: String): this.type = set("menuClassName", value.asInstanceOf[js.Any])
    
    inline def menuStyle(value: js.Object): this.type = set("menuStyle", value.asInstanceOf[js.Any])
