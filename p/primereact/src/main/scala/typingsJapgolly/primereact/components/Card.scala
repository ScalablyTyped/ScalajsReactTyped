...
import typingsJapgolly.primereact.cardCardMod.CardTemplateTypes
...
object Card {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Card] {
    ...
    inline def footer(value: CardTemplateTypes): this.type = set("footer", value.asInstanceOf[js.Any])
    
    inline def footerFunction1(value: /* props */ CardProps => Node): this.type = set("footer", js.Any.fromFunction1(value))
    ...
    inline def header(value: CardTemplateTypes): this.type = set("header", value.asInstanceOf[js.Any])
    
    inline def headerFunction1(value: /* props */ CardProps => Node): this.type = set("header", js.Any.fromFunction1(value))
    ...
    inline def subTitle(value: CardTemplateTypes): this.type = set("subTitle", value.asInstanceOf[js.Any])
    
    inline def subTitleFunction1(value: /* props */ CardProps => Node): this.type = set("subTitle", js.Any.fromFunction1(value))
    ...
    inline def title(value: CardTemplateTypes): this.type = set("title", value.asInstanceOf[js.Any])
    
    inline def titleFunction1(value: /* props */ CardProps => Node): this.type = set("title", js.Any.fromFunction1(value))
