...
import typingsJapgolly.primereact.carouselCarouselMod.CarouselPageChangeParams
import typingsJapgolly.primereact.carouselCarouselMod.CarouselProps
import typingsJapgolly.primereact.carouselCarouselMod.CarouselResponsiveOptions
...
object Carousel {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Carousel] {
    ...
    inline def indicatorsContentClassName(value: String): this.type = set("indicatorsContentClassName", value.asInstanceOf[js.Any])
    ...
    inline def numScroll(value: Double): this.type = set("numScroll", value.asInstanceOf[js.Any])
    ...
    inline def onPageChange(value: /* e */ CarouselPageChangeParams => Callback): this.type = set("onPageChange", js.Any.fromFunction1((t0: /* e */ CarouselPageChangeParams) => value(t0).runNow()))
    ...
    inline def orientation(value: CarouselOrientationType): this.type = set("orientation", value.asInstanceOf[js.Any])
    ...
    inline def responsiveOptions(value: js.Array[CarouselResponsiveOptions]): this.type = set("responsiveOptions", value.asInstanceOf[js.Any])
    
    inline def responsiveOptionsVarargs(value: CarouselResponsiveOptions*): this.type = set("responsiveOptions", js.Array(value*))
    ...
    inline def showNavigators(value: Boolean): this.type = set("showNavigators", value.asInstanceOf[js.Any])
    ...
    inline def verticalViewPortHeight(value: String): this.type = set("verticalViewPortHeight", value.asInstanceOf[js.Any])
