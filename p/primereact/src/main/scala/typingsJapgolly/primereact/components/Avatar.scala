...
import typingsJapgolly.primereact.avatarAvatarMod.AvatarProps
import typingsJapgolly.primereact.avatarAvatarMod.AvatarShapeType
import typingsJapgolly.primereact.avatarAvatarMod.AvatarSizeType
import typingsJapgolly.primereact.avatarAvatarMod.AvatarTemplateType
...
object Avatar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Avatar] {
    ...
    inline def onImageError(value: /* event */ ReactEventFrom[Element] => Callback): this.type = set("onImageError", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
    ...
    inline def shape(value: AvatarShapeType): this.type = set("shape", value.asInstanceOf[js.Any])
    
    inline def size(value: AvatarSizeType): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def template(value: AvatarTemplateType): this.type = set("template", value.asInstanceOf[js.Any])
    
    inline def templateFunction1(value: /* props */ AvatarProps => Node): this.type = set("template", js.Any.fromFunction1(value))
    
    inline def templateNull: this.type = set("template", null)
    
    inline def templateVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("template", js.Array(value*))
    
    inline def templateVdomElement(value: VdomElement): this.type = set("template", value.rawElement.asInstanceOf[js.Any])
