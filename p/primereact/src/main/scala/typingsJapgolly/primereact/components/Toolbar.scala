...
import typingsJapgolly.primereact.toolbarToolbarMod.ToolbarProps
import typingsJapgolly.primereact.toolbarToolbarMod.ToolbarTemplateType
...
object Toolbar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Toolbar] {
    ...
    inline def left(value: ToolbarTemplateType): this.type = set("left", value.asInstanceOf[js.Any])
    
    inline def leftFunction1(value: /* props */ ToolbarProps => Node): this.type = set("left", js.Any.fromFunction1(value))
    ...
    inline def right(value: ToolbarTemplateType): this.type = set("right", value.asInstanceOf[js.Any])
    
    inline def rightFunction1(value: /* props */ ToolbarProps => Node): this.type = set("right", js.Any.fromFunction1(value))
