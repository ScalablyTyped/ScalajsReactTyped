...
import typingsJapgolly.primereact.speeddialSpeeddialMod.SpeedDialButtonOptions
import typingsJapgolly.primereact.speeddialSpeeddialMod.SpeedDialButtonTemplateType
import typingsJapgolly.primereact.speeddialSpeeddialMod.SpeedDialDirectionType
import typingsJapgolly.primereact.speeddialSpeeddialMod.SpeedDialProps
...
object SpeedDial {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.SpeedDial] {
    ...
    inline def buttonClassName(value: String): this.type = set("buttonClassName", value.asInstanceOf[js.Any])
    
    inline def buttonStyle(value: js.Object): this.type = set("buttonStyle", value.asInstanceOf[js.Any])
    
    inline def buttonTemplate(value: SpeedDialButtonTemplateType): this.type = set("buttonTemplate", value.asInstanceOf[js.Any])
    
    inline def buttonTemplateFunction1(value: /* options */ SpeedDialButtonOptions => Node): this.type = set("buttonTemplate", js.Any.fromFunction1(value))
    
    inline def buttonTemplateNull: this.type = set("buttonTemplate", null)
    
    inline def buttonTemplateVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("buttonTemplate", js.Array(value*))
    
    inline def buttonTemplateVdomElement(value: VdomElement): this.type = set("buttonTemplate", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def direction(value: SpeedDialDirectionType): this.type = set("direction", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("hideIcon", value.asInstanceOf[js.Any])
    
    inline def hideOnClickOutside(value: Boolean): this.type = set("hideOnClickOutside", value.asInstanceOf[js.Any])
    ...
    inline def rotateAnimation(value: Boolean): this.type = set("rotateAnimation", value.asInstanceOf[js.Any])
    
    inline def security(value: String): this.type = set("security", value.asInstanceOf[js.Any])
    
    inline def showIcon(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<SpeedDialProps> */ Any
    ): this.type = set("showIcon", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: SpeedDialType): this.type = set("type", value.asInstanceOf[js.Any])
