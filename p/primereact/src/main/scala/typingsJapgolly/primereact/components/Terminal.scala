...
import typingsJapgolly.primereact.terminalTerminalMod.TerminalProps
...
object Terminal {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Terminal] {
    ...
    inline def welcomeMessage(value: String): this.type = set("welcomeMessage", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: Terminal.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TerminalProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
