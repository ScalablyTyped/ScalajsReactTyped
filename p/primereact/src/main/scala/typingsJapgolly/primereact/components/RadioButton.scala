...
import typingsJapgolly.primereact.radiobuttonRadiobuttonMod.RadioButtonChangeParams
import typingsJapgolly.primereact.radiobuttonRadiobuttonMod.RadioButtonProps
...
object RadioButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.RadioButton] {
    ...
    inline def onChange(value: /* e */ RadioButtonChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ RadioButtonChangeParams) => value(t0).runNow()))
