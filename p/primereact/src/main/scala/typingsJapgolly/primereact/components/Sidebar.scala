...
import typingsJapgolly.primereact.sidebarSidebarMod.SidebarAppendToType
import typingsJapgolly.primereact.sidebarSidebarMod.SidebarPositionType
import typingsJapgolly.primereact.sidebarSidebarMod.SidebarProps
import typingsJapgolly.primereact.sidebarSidebarMod.SidebarTemplateType
...
object Sidebar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Sidebar] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def appendTo(value: SidebarAppendToType): this.type = set("appendTo", value.asInstanceOf[js.Any])
    ...
    inline def icons(value: SidebarTemplateType): this.type = set("icons", value.asInstanceOf[js.Any])
    
    inline def iconsFunction1(value: /* props */ SidebarProps => Node): this.type = set("icons", js.Any.fromFunction1(value))
    ...
    inline def position(value: SidebarPositionType): this.type = set("position", value.asInstanceOf[js.Any])
