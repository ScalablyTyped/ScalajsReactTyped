...
import typingsJapgolly.primereact.multistatecheckboxMultistatecheckboxMod.MultiStateCheckboxChangeParams
import typingsJapgolly.primereact.multistatecheckboxMultistatecheckboxMod.MultiStateCheckboxIconTemplateParams
import typingsJapgolly.primereact.multistatecheckboxMultistatecheckboxMod.MultiStateCheckboxIconTemplateType
import typingsJapgolly.primereact.multistatecheckboxMultistatecheckboxMod.MultiStateCheckboxOption
import typingsJapgolly.primereact.multistatecheckboxMultistatecheckboxMod.MultiStateCheckboxOptionsType
import typingsJapgolly.primereact.multistatecheckboxMultistatecheckboxMod.MultiStateCheckboxProps
...
object MultiStateCheckbox {
  
  @JSImport("primereact", "MultiStateCheckbox")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.MultiStateCheckbox] {
    ...
    inline def empty(value: Boolean): this.type = set("empty", value.asInstanceOf[js.Any])
    ...
    inline def iconTemplate(value: MultiStateCheckboxIconTemplateType): this.type = set("iconTemplate", value.asInstanceOf[js.Any])
    
    inline def iconTemplateFunction1(value: /* options */ MultiStateCheckboxIconTemplateParams => Node): this.type = set("iconTemplate", js.Any.fromFunction1(value))
    
    inline def iconTemplateNull: this.type = set("iconTemplate", null)
    
    inline def iconTemplateVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("iconTemplate", js.Array(value*))
    
    inline def iconTemplateVdomElement(value: VdomElement): this.type = set("iconTemplate", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* e */ MultiStateCheckboxChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ MultiStateCheckboxChangeParams) => value(t0).runNow()))
    ...
    inline def options(value: MultiStateCheckboxOptionsType): this.type = set("options", value.asInstanceOf[js.Any])
    
    inline def optionsVarargs(value: (Any | MultiStateCheckboxOption)*): this.type = set("options", js.Array(value*))
  ...
  implicit def make(companion: MultiStateCheckbox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MultiStateCheckboxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
