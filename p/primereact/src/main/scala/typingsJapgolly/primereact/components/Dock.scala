...
import typingsJapgolly.primereact.dockDockMod.DockFooterTemplateOptions
import typingsJapgolly.primereact.dockDockMod.DockFooterType
import typingsJapgolly.primereact.dockDockMod.DockHeaderTemplateOptions
import typingsJapgolly.primereact.dockDockMod.DockHeaderType
import typingsJapgolly.primereact.dockDockMod.DockPositionType
import typingsJapgolly.primereact.dockDockMod.DockProps
...
object Dock {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Dock] {
    ...
    inline def footer(value: DockFooterType): this.type = set("footer", value.asInstanceOf[js.Any])
    
    inline def footerFunction1(value: /* options */ DockFooterTemplateOptions => Node): this.type = set("footer", js.Any.fromFunction1(value))
    ...
    inline def header(value: DockHeaderType): this.type = set("header", value.asInstanceOf[js.Any])
    
    inline def headerFunction1(value: /* options */ DockHeaderTemplateOptions => Node): this.type = set("header", js.Any.fromFunction1(value))
    ...
    inline def magnification(value: Boolean): this.type = set("magnification", value.asInstanceOf[js.Any])
    ...
    inline def position(value: DockPositionType): this.type = set("position", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Dock.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DockProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
