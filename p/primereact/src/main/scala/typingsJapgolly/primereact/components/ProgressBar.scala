...
import typingsJapgolly.primereact.progressbarProgressbarMod.ProgressBarValueType
...
object ProgressBar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.ProgressBar] {
    ...
    inline def displayValueTemplate(value: /* value */ ProgressBarValueType => Node): this.type = set("displayValueTemplate", js.Any.fromFunction1(value))
    ...
    inline def mode(value: ProgressBarModeType): this.type = set("mode", value.asInstanceOf[js.Any])
    ...
    inline def value(value: ProgressBarValueType): this.type = set("value", value.asInstanceOf[js.Any])
