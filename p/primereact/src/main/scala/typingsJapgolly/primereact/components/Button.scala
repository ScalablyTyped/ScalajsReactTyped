...
object Button {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ButtonProps, typingsJapgolly.primereact.buttonMod.Button, Unit, ButtonProps] = {
  ...
  typingsJapgolly.primereact.buttonButtonMod.ButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.primereact.buttonMod.Button](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.primereact.buttonButtonMod.ButtonProps])(children: _*)
  }
