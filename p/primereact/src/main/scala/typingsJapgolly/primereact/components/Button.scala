...
import typingsJapgolly.primereact.primereactStrings.button
...
import typingsJapgolly.primereact.primereactStrings.reset
...
import typingsJapgolly.primereact.primereactStrings.submit
...
object Button {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Button] {
    ...
    inline def badge(value: String): this.type = set("badge", value.asInstanceOf[js.Any])
    ...
    inline def iconPos(value: ButtonPositionType): this.type = set("iconPos", value.asInstanceOf[js.Any])
