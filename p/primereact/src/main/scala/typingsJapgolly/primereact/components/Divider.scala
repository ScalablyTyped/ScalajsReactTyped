...
import typingsJapgolly.primereact.dividerDividerMod.DividerProps
...
object Divider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Divider] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def align(value: DividerAlignType): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    inline def layout(value: DividerLayoutType): this.type = set("layout", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: DividerBorderType): this.type = set("type", value.asInstanceOf[js.Any])
