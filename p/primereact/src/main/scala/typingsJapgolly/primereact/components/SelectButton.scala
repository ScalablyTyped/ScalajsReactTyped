...
import typingsJapgolly.primereact.selectbuttonSelectbuttonMod.SelectButtonChangeParams
import typingsJapgolly.primereact.selectbuttonSelectbuttonMod.SelectButtonOptionDisabledType
import typingsJapgolly.primereact.selectbuttonSelectbuttonMod.SelectButtonProps
...
object SelectButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.SelectButton] {
    ...
    inline def itemTemplate(value: /* option */ Any => Node): this.type = set("itemTemplate", js.Any.fromFunction1(value))
    ...
    inline def onChange(value: /* e */ SelectButtonChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ SelectButtonChangeParams) => value(t0).runNow()))
    ...
    inline def optionDisabled(value: SelectButtonOptionDisabledType): this.type = set("optionDisabled", value.asInstanceOf[js.Any])
