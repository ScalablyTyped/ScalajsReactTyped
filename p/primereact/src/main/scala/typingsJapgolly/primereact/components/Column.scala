...
import typingsJapgolly.primereact.AnonField
...
object Column {
  def apply(
    ...
    editor: /* props */ js.Any => CallbackTo[js.UndefOr[Element]] = null,
    editorValidator: /* props */ js.Any => CallbackTo[Boolean] = null,
    ...
    filterFunction: (/* value */ js.Any, /* filter */ js.Any) => Callback = null,
    ...
    onEditorCancel: /* props */ js.Any => Callback = null,
    onEditorSubmit: /* props */ js.Any => Callback = null,
    ...
    sortFunction: /* e */ AnonField => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ColumnProps, typingsJapgolly.primereact.columnMod.Column, Unit, ColumnProps] = {
    ...
    if (editor != null) __obj.updateDynamic("editor")(js.Any.fromFunction1((t0: /* props */ js.Any) => editor(t0).runNow()))
    if (editorValidator != null) __obj.updateDynamic("editorValidator")(js.Any.fromFunction1((t0: /* props */ js.Any) => editorValidator(t0).runNow()))
    ...
    if (filterFunction != null) __obj.updateDynamic("filterFunction")(js.Any.fromFunction2((t0: /* value */ js.Any, t1: /* filter */ js.Any) => filterFunction(t0, t1).runNow()))
    ...
    if (onEditorCancel != null) __obj.updateDynamic("onEditorCancel")(js.Any.fromFunction1((t0: /* props */ js.Any) => onEditorCancel(t0).runNow()))
    if (onEditorSubmit != null) __obj.updateDynamic("onEditorSubmit")(js.Any.fromFunction1((t0: /* props */ js.Any) => onEditorSubmit(t0).runNow()))
    ...
    if (sortFunction != null) __obj.updateDynamic("sortFunction")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.primereact.AnonField) => sortFunction(t0).runNow()))
  ...
  typingsJapgolly.primereact.columnColumnMod.ColumnProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.primereact.columnMod.Column](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.primereact.columnColumnMod.ColumnProps])(children: _*)
  }
