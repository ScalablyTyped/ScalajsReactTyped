...
import typingsJapgolly.primereact.organizationchartOrganizationchartMod.OrganizationChartNodeData
import typingsJapgolly.primereact.organizationchartOrganizationchartMod.OrganizationChartNodeSelectParams
import typingsJapgolly.primereact.organizationchartOrganizationchartMod.OrganizationChartNodeUnselectParams
import typingsJapgolly.primereact.organizationchartOrganizationchartMod.OrganizationChartProps
import typingsJapgolly.primereact.organizationchartOrganizationchartMod.OrganizationChartSelectionModeType
import typingsJapgolly.primereact.organizationchartOrganizationchartMod.OrganizationChartSelectionNodeDataType
...
object OrganizationChart {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.OrganizationChart] {
    ...
    inline def nodeTemplate(value: /* node */ OrganizationChartNodeData => Node): this.type = set("nodeTemplate", js.Any.fromFunction1(value))
    ...
    inline def onNodeSelect(value: /* e */ OrganizationChartNodeSelectParams => Callback): this.type = set("onNodeSelect", js.Any.fromFunction1((t0: /* e */ OrganizationChartNodeSelectParams) => value(t0).runNow()))
    
    inline def onNodeUnselect(value: /* e */ OrganizationChartNodeUnselectParams => Callback): this.type = set("onNodeUnselect", js.Any.fromFunction1((t0: /* e */ OrganizationChartNodeUnselectParams) => value(t0).runNow()))
    ...
    inline def selection(value: OrganizationChartSelectionNodeDataType): this.type = set("selection", value.asInstanceOf[js.Any])
    
    inline def selectionChange(value: /* node */ OrganizationChartSelectionNodeDataType => Callback): this.type = set("selectionChange", js.Any.fromFunction1((t0: /* node */ OrganizationChartSelectionNodeDataType) => value(t0).runNow()))
    
    inline def selectionMode(value: OrganizationChartSelectionModeType): this.type = set("selectionMode", value.asInstanceOf[js.Any])
    
    inline def selectionNull: this.type = set("selection", null)
    
    inline def selectionVarargs(value: OrganizationChartNodeData*): this.type = set("selection", js.Array(value*))
    ...
    inline def value(value: js.Array[OrganizationChartNodeData]): this.type = set("value", value.asInstanceOf[js.Any])
    
    inline def valueVarargs(value: OrganizationChartNodeData*): this.type = set("value", js.Array(value*))
