...
import typingsJapgolly.primereact.toastToastMod.ToastAppendToType
import typingsJapgolly.primereact.toastToastMod.ToastMessage
import typingsJapgolly.primereact.toastToastMod.ToastPositionType
import typingsJapgolly.primereact.toastToastMod.ToastProps
...
object Toast {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Toast] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def appendTo(value: ToastAppendToType): this.type = set("appendTo", value.asInstanceOf[js.Any])
    ...
    inline def onClick(value: /* message */ ToastMessage => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: /* message */ ToastMessage) => value(t0).runNow()))
    ...
    inline def onRemove(value: /* message */ ToastMessage => Callback): this.type = set("onRemove", js.Any.fromFunction1((t0: /* message */ ToastMessage) => value(t0).runNow()))
    ...
    inline def position(value: ToastPositionType): this.type = set("position", value.asInstanceOf[js.Any])
