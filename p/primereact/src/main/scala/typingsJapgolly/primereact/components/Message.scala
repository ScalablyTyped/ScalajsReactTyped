...
import typingsJapgolly.primereact.messageMessageMod.MessageContentType
...
import typingsJapgolly.primereact.messageMessageMod.MessageTextType
...
object Message {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Message] {
    ...
    inline def content(value: MessageContentType): this.type = set("content", value.asInstanceOf[js.Any])
    
    inline def contentEditable(value: Booleanish | inherit): this.type = set("contentEditable", value.asInstanceOf[js.Any])
    
    inline def contentFunction1(value: /* props */ MessageProps => Node): this.type = set("content", js.Any.fromFunction1(value))
    ...
    inline def icon(value: IconType[MessageProps]): this.type = set("icon", value.asInstanceOf[js.Any])
    
    inline def iconFunction1(value: /* options */ IconOptions[MessageProps] => Node): this.type = set("icon", js.Any.fromFunction1(value))
    ...
    inline def severity(value: MessageSeverityType): this.type = set("severity", value.asInstanceOf[js.Any])
    ...
    inline def text(value: MessageTextType): this.type = set("text", value.asInstanceOf[js.Any])
    
    inline def textFunction1(value: /* props */ MessageProps => Node): this.type = set("text", js.Any.fromFunction1(value))
