...
import typingsJapgolly.primereact.dataTableMod.DataTableProps
...
object DataTable {
  def apply(
    ...
    DataTableProps, 
    typingsJapgolly.primereact.primereactDatatableMod.DataTable, 
    Unit, 
    DataTableProps
  ] = {
  ...
  typingsJapgolly.primereact.dataTableMod.DataTableProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.primereact.primereactDatatableMod.DataTable](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.primereact.dataTableMod.DataTableProps])(children: _*)
  }
