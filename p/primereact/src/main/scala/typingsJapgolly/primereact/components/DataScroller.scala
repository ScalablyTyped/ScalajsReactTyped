...
import typingsJapgolly.primereact.datascrollerDatascrollerMod.DataScrollerEmptyMessageType
import typingsJapgolly.primereact.datascrollerDatascrollerMod.DataScrollerLazyLoadParams
import typingsJapgolly.primereact.datascrollerDatascrollerMod.DataScrollerProps
...
object DataScroller {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.DataScroller] {
    ...
    inline def emptyMessage(value: DataScrollerEmptyMessageType): this.type = set("emptyMessage", value.asInstanceOf[js.Any])
    
    inline def emptyMessageFunction1(value: /* props */ DataScrollerProps => Node): this.type = set("emptyMessage", js.Any.fromFunction1(value))
    ...
    inline def loader(value: Boolean): this.type = set("loader", value.asInstanceOf[js.Any])
    ...
    inline def onLazyLoad(value: /* e */ DataScrollerLazyLoadParams => Callback): this.type = set("onLazyLoad", js.Any.fromFunction1((t0: /* e */ DataScrollerLazyLoadParams) => value(t0).runNow()))
