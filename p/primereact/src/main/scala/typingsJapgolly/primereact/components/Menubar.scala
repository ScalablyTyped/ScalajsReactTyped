...
import typingsJapgolly.primereact.menubarMenubarMod.MenubarEndTemplate
import typingsJapgolly.primereact.menubarMenubarMod.MenubarProps
import typingsJapgolly.primereact.menubarMenubarMod.MenubarStartTemplate
...
object Menubar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Menubar] {
    ...
    inline def end(value: MenubarEndTemplate): this.type = set("end", value.asInstanceOf[js.Any])
    
    inline def endFunction1(value: /* props */ MenubarProps => Node): this.type = set("end", js.Any.fromFunction1(value))
    ...
    inline def start(value: MenubarStartTemplate): this.type = set("start", value.asInstanceOf[js.Any])
    
    inline def startFunction1(value: /* props */ MenubarProps => Node): this.type = set("start", js.Any.fromFunction1(value))
