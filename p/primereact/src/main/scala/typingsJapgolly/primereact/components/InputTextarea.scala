...
import typingsJapgolly.primereact.inputtextareaInputtextareaMod.InputTextareaProps
...
object InputTextarea {
  ...
  @JSImport("primereact", "InputTextarea")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.InputTextarea] {
