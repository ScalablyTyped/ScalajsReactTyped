...
import typingsJapgolly.primereact.overlaypanelOverlaypanelMod.OverlayPanelAppendToType
import typingsJapgolly.primereact.overlaypanelOverlaypanelMod.OverlayPanelBreakpoints
import typingsJapgolly.primereact.overlaypanelOverlaypanelMod.OverlayPanelProps
...
object OverlayPanel {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.OverlayPanel] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def appendTo(value: OverlayPanelAppendToType): this.type = set("appendTo", value.asInstanceOf[js.Any])
    ...
    inline def ariaCloseLabel(value: String): this.type = set("ariaCloseLabel", value.asInstanceOf[js.Any])
    ...
    inline def breakpoints(value: OverlayPanelBreakpoints): this.type = set("breakpoints", value.asInstanceOf[js.Any])
    ...
    inline def showCloseIcon(value: Boolean): this.type = set("showCloseIcon", value.asInstanceOf[js.Any])
