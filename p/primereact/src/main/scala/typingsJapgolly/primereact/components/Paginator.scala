...
import typingsJapgolly.primereact.paginatorPaginatorMod.PaginatorAppendToType
import typingsJapgolly.primereact.paginatorPaginatorMod.PaginatorPageState
import typingsJapgolly.primereact.paginatorPaginatorMod.PaginatorProps
import typingsJapgolly.primereact.paginatorPaginatorMod.PaginatorTemplate
...
object Paginator {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Paginator] {
    ...
    inline def dropdownAppendTo(value: PaginatorAppendToType): this.type = set("dropdownAppendTo", value.asInstanceOf[js.Any])
    
    inline def dropdownAppendToNull: this.type = set("dropdownAppendTo", null)
    ...
    inline def onPageChange(value: /* event */ PaginatorPageState => Callback): this.type = set("onPageChange", js.Any.fromFunction1((t0: /* event */ PaginatorPageState) => value(t0).runNow()))
    ...
    inline def template(value: PaginatorTemplate): this.type = set("template", value.asInstanceOf[js.Any])
