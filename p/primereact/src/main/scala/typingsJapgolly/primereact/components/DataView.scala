...
import typingsJapgolly.primereact.dataviewDataviewMod.DataViewAppendToType
import typingsJapgolly.primereact.dataviewDataviewMod.DataViewLayoutType
import typingsJapgolly.primereact.dataviewDataviewMod.DataViewPageParams
import typingsJapgolly.primereact.dataviewDataviewMod.DataViewPaginatorPositionType
import typingsJapgolly.primereact.dataviewDataviewMod.DataViewProps
import typingsJapgolly.primereact.dataviewDataviewMod.DataViewSortOrderType
...
object DataView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.DataView] {
    ...
    inline def gutter(value: Boolean): this.type = set("gutter", value.asInstanceOf[js.Any])
    ...
    inline def itemTemplate(value: (/* item */ Any, /* layout */ DataViewLayoutType) => Node): this.type = set("itemTemplate", js.Any.fromFunction2(value))
    ...
    inline def onPage(value: /* e */ DataViewPageParams => Callback): this.type = set("onPage", js.Any.fromFunction1((t0: /* e */ DataViewPageParams) => value(t0).runNow()))
    ...
    inline def paginatorDropdownAppendTo(value: DataViewAppendToType): this.type = set("paginatorDropdownAppendTo", value.asInstanceOf[js.Any])
    ...
    inline def paginatorPosition(value: DataViewPaginatorPositionType): this.type = set("paginatorPosition", value.asInstanceOf[js.Any])
    ...
    inline def sortOrder(value: DataViewSortOrderType): this.type = set("sortOrder", value.asInstanceOf[js.Any])
