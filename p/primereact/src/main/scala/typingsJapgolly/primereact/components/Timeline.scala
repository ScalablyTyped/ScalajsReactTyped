...
import typingsJapgolly.primereact.timelineTimelineMod.TimelineProps
import typingsJapgolly.primereact.timelineTimelineMod.TimelineTemplateType
...
object Timeline {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Timeline] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def align(value: TimelineAlignType): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    inline def content(value: TimelineTemplateType): this.type = set("content", value.asInstanceOf[js.Any])
    
    inline def contentEditable(value: Booleanish | inherit): this.type = set("contentEditable", value.asInstanceOf[js.Any])
    
    inline def contentFunction2(value: (/* item */ Any, /* index */ Double) => Node): this.type = set("content", js.Any.fromFunction2(value))
    ...
    inline def layout(value: TimelineLayoutType): this.type = set("layout", value.asInstanceOf[js.Any])
    
    inline def marker(value: TimelineTemplateType): this.type = set("marker", value.asInstanceOf[js.Any])
    
    inline def markerFunction2(value: (/* item */ Any, /* index */ Double) => Node): this.type = set("marker", js.Any.fromFunction2(value))
    
    inline def markerNull: this.type = set("marker", null)
    
    inline def markerVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("marker", js.Array(value*))
    
    inline def markerVdomElement(value: VdomElement): this.type = set("marker", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def opposite(value: TimelineTemplateType): this.type = set("opposite", value.asInstanceOf[js.Any])
    
    inline def oppositeFunction2(value: (/* item */ Any, /* index */ Double) => Node): this.type = set("opposite", js.Any.fromFunction2(value))
    
    inline def oppositeNull: this.type = set("opposite", null)
    
    inline def oppositeVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("opposite", js.Array(value*))
    
    inline def oppositeVdomElement(value: VdomElement): this.type = set("opposite", value.rawElement.asInstanceOf[js.Any])
