...
import typingsJapgolly.primereact.accordionAccordionMod.AccordionActiveIndexType
import typingsJapgolly.primereact.accordionAccordionMod.AccordionEventParams
import typingsJapgolly.primereact.accordionAccordionMod.AccordionProps
...
object Accordion {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Accordion] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def activeIndex(value: AccordionActiveIndexType): this.type = set("activeIndex", value.asInstanceOf[js.Any])
    
    inline def activeIndexNull: this.type = set("activeIndex", null)
    ...
    inline def onTabChange(value: /* e */ AccordionEventParams => Callback): this.type = set("onTabChange", js.Any.fromFunction1((t0: /* e */ AccordionEventParams) => value(t0).runNow()))
    
    inline def onTabClose(value: /* e */ AccordionEventParams => Callback): this.type = set("onTabClose", js.Any.fromFunction1((t0: /* e */ AccordionEventParams) => value(t0).runNow()))
    
    inline def onTabOpen(value: /* e */ AccordionEventParams => Callback): this.type = set("onTabOpen", js.Any.fromFunction1((t0: /* e */ AccordionEventParams) => value(t0).runNow()))
