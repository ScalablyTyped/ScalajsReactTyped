...
import typingsJapgolly.primereact.skeletonSkeletonMod.SkeletonProps
...
object Skeleton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Skeleton] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def animation(value: SkeletonAnimationType): this.type = set("animation", value.asInstanceOf[js.Any])
    ...
    inline def borderRadius(value: String): this.type = set("borderRadius", value.asInstanceOf[js.Any])
    ...
    inline def shape(value: SkeletonShapeType): this.type = set("shape", value.asInstanceOf[js.Any])
