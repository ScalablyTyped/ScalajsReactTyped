...
import typingsJapgolly.primereact.splitterSplitterMod.SplitterProps
import typingsJapgolly.primereact.splitterSplitterMod.SplitterResizeEndParams
...
object Splitter {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Splitter] {
    ...
    inline def layout(value: SplitterLayoutType): this.type = set("layout", value.asInstanceOf[js.Any])
    ...
    inline def onResizeEnd(value: /* e */ SplitterResizeEndParams => Callback): this.type = set("onResizeEnd", js.Any.fromFunction1((t0: /* e */ SplitterResizeEndParams) => value(t0).runNow()))
    ...
    inline def stateStorage(value: SplitterStateStorageType): this.type = set("stateStorage", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Splitter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SplitterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
