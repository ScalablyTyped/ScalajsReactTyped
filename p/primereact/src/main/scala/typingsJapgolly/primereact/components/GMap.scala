...
import typingsJapgolly.primereact.gmapGmapMod.GMapEventParams
import typingsJapgolly.primereact.gmapGmapMod.GMapProps
...
object GMap {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.GMap] {
    ...
    inline def onMapClick(value: /* event */ ReactEventFrom[Element] => Callback): this.type = set("onMapClick", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
    
    inline def onMapDragEnd(value: Callback): this.type = set("onMapDragEnd", value.toJsFn)
    
    inline def onMapReady(value: /* map */ Any => Callback): this.type = set("onMapReady", js.Any.fromFunction1((t0: /* map */ Any) => value(t0).runNow()))
    ...
    inline def onOverlayClick(value: /* e */ GMapEventParams => Callback): this.type = set("onOverlayClick", js.Any.fromFunction1((t0: /* e */ GMapEventParams) => value(t0).runNow()))
    
    inline def onOverlayDrag(value: /* event */ ReactEventFrom[Element] => Callback): this.type = set("onOverlayDrag", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
    
    inline def onOverlayDragEnd(value: /* event */ ReactEventFrom[Element] => Callback): this.type = set("onOverlayDragEnd", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
    
    inline def onOverlayDragStart(value: /* event */ ReactEventFrom[Element] => Callback): this.type = set("onOverlayDragStart", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
    ...
    inline def onZoomChanged(value: Callback): this.type = set("onZoomChanged", value.toJsFn)
    
    inline def options(value: js.Object): this.type = set("options", value.asInstanceOf[js.Any])
    
    inline def overlays(value: js.Array[Any]): this.type = set("overlays", value.asInstanceOf[js.Any])
    
    inline def overlaysVarargs(value: Any*): this.type = set("overlays", js.Array(value*))
