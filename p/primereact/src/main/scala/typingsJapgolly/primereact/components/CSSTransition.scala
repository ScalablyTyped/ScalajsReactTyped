...
import typingsJapgolly.primereact.csstransitionCsstransitionMod.CSSTransitionProps
...
object CSSTransition {
  ...
  open class Builder[Ref /* <: js.UndefOr[HTMLElement] */] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.CSSTransition[Ref]]
