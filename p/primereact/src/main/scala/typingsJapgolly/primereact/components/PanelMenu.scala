...
import typingsJapgolly.primereact.panelmenuPanelmenuMod.PanelMenuProps
...
object PanelMenu {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.PanelMenu] {
