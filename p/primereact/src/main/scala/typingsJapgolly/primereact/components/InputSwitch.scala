...
import typingsJapgolly.primereact.inputswitchInputswitchMod.InputSwitchChangeParams
import typingsJapgolly.primereact.inputswitchInputswitchMod.InputSwitchProps
...
object InputSwitch {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.InputSwitch] {
    ...
    inline def checked(value: Any): this.type = set("checked", value.asInstanceOf[js.Any])
    ...
    inline def falseValue(value: Any): this.type = set("falseValue", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* e */ InputSwitchChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ InputSwitchChangeParams) => value(t0).runNow()))
    ...
    inline def trueValue(value: Any): this.type = set("trueValue", value.asInstanceOf[js.Any])
