...
import typingsJapgolly.primereact.messagesMessagesMod.MessagesMessage
import typingsJapgolly.primereact.messagesMessagesMod.MessagesProps
...
object Messages {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Messages] {
    ...
    inline def onClick(value: /* message */ MessagesMessage => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: /* message */ MessagesMessage) => value(t0).runNow()))
    ...
    inline def onRemove(value: /* message */ MessagesMessage => Callback): this.type = set("onRemove", js.Any.fromFunction1((t0: /* message */ MessagesMessage) => value(t0).runNow()))
