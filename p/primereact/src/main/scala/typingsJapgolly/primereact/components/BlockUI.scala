...
import typingsJapgolly.primereact.blockuiBlockuiMod.BlockUIProps
import typingsJapgolly.primereact.blockuiBlockuiMod.BlockUITemplateType
...
object BlockUI {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.BlockUI] {
    ...
    inline def blocked(value: Boolean): this.type = set("blocked", value.asInstanceOf[js.Any])
    ...
    inline def onBlocked(value: Callback): this.type = set("onBlocked", value.toJsFn)
    ...
    inline def onUnblocked(value: Callback): this.type = set("onUnblocked", value.toJsFn)
    ...
    inline def template(value: BlockUITemplateType): this.type = set("template", value.asInstanceOf[js.Any])
    
    inline def templateFunction1(value: /* props */ BlockUIProps => Node): this.type = set("template", js.Any.fromFunction1(value))
  ...
  implicit def make(companion: BlockUI.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: BlockUIProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
