...
import typingsJapgolly.primereact.ratingRatingMod.RatingChangeParams
import typingsJapgolly.primereact.ratingRatingMod.RatingProps
...
object Rating {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Rating] {
    ...
    inline def cancel(value: Boolean): this.type = set("cancel", value.asInstanceOf[js.Any])
    
    inline def cancelIcon(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<RatingProps> */ Any
    ): this.type = set("cancelIcon", value.asInstanceOf[js.Any])
    
    inline def cancelIconProps(value: HTMLAttributes[HTMLSpanElement]): this.type = set("cancelIconProps", value.asInstanceOf[js.Any])
    ...
    inline def offIconProps(value: HTMLAttributes[HTMLSpanElement]): this.type = set("offIconProps", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* e */ RatingChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ RatingChangeParams) => value(t0).runNow()))
    ...
    inline def onIconProps(value: HTMLAttributes[HTMLSpanElement]): this.type = set("onIconProps", value.asInstanceOf[js.Any])
    ...
    inline def stars(value: Double): this.type = set("stars", value.asInstanceOf[js.Any])
