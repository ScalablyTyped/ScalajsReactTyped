...
import typingsJapgolly.primereact.orderlistOrderlistMod.OrderListChangeParams
import typingsJapgolly.primereact.orderlistOrderlistMod.OrderListFilterOptions
import typingsJapgolly.primereact.orderlistOrderlistMod.OrderListFilterTemplateType
import typingsJapgolly.primereact.orderlistOrderlistMod.OrderListProps
...
object OrderList {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.OrderList] {
    ...
    inline def dragdrop(value: Boolean): this.type = set("dragdrop", value.asInstanceOf[js.Any])
    ...
    inline def filterTemplate(value: OrderListFilterTemplateType): this.type = set("filterTemplate", value.asInstanceOf[js.Any])
    
    inline def filterTemplateFunction1(value: /* options */ OrderListFilterOptions => Node): this.type = set("filterTemplate", js.Any.fromFunction1(value))
    ...
    inline def itemTemplate(value: /* item */ Any => Node): this.type = set("itemTemplate", js.Any.fromFunction1(value))
    ...
    inline def onChange(value: /* e */ OrderListChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ OrderListChangeParams) => value(t0).runNow()))
