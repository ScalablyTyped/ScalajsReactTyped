...
import typingsJapgolly.primereact.inplaceInplaceMod.InplaceProps
import typingsJapgolly.primereact.inplaceInplaceMod.InplaceToggleParams
...
object Inplace {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Inplace] {
    ...
    inline def onClose(value: /* event */ ReactMouseEventFrom[HTMLElement] => Callback): this.type = set("onClose", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLElement]) => value(t0).runNow()))
    ...
    inline def onOpen(value: /* event */ ReactMouseEventFrom[HTMLElement] => Callback): this.type = set("onOpen", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLElement]) => value(t0).runNow()))
    ...
    inline def onToggle(value: /* e */ InplaceToggleParams => Callback): this.type = set("onToggle", js.Any.fromFunction1((t0: /* e */ InplaceToggleParams) => value(t0).runNow()))
