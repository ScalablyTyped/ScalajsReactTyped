...
import typingsJapgolly.primereact.checkboxCheckboxMod.CheckboxChangeParams
import typingsJapgolly.primereact.checkboxCheckboxMod.CheckboxProps
...
object Checkbox {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Checkbox] {
    ...
    inline def onChange(value: /* e */ CheckboxChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ CheckboxChangeParams) => value(t0).runNow()))
