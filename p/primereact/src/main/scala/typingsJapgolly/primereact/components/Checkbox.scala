...
object Checkbox {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CheckboxProps, typingsJapgolly.primereact.checkboxMod.Checkbox, Unit, CheckboxProps] = {
  ...
  typingsJapgolly.primereact.checkboxCheckboxMod.CheckboxProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.primereact.checkboxMod.Checkbox](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.primereact.checkboxCheckboxMod.CheckboxProps])(children: _*)
  }
