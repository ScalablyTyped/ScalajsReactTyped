...
import typingsJapgolly.primereact.tieredmenuTieredmenuMod.TieredMenuAppendToType
import typingsJapgolly.primereact.tieredmenuTieredmenuMod.TieredMenuProps
...
object TieredMenu {
  ...
  @JSImport("primereact", "TieredMenu")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.TieredMenu] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def appendTo(value: TieredMenuAppendToType): this.type = set("appendTo", value.asInstanceOf[js.Any])
    ...
    inline def onHide(value: /* e */ ReactEventFrom[Element] => Callback): this.type = set("onHide", js.Any.fromFunction1((t0: /* e */ ReactEventFrom[Element]) => value(t0).runNow()))
    ...
    inline def onShow(value: /* e */ ReactEventFrom[Element] => Callback): this.type = set("onShow", js.Any.fromFunction1((t0: /* e */ ReactEventFrom[Element]) => value(t0).runNow()))
