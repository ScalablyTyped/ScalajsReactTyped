...
import typingsJapgolly.primereact.panelPanelMod.PanelHeaderTemplateOptions
import typingsJapgolly.primereact.panelPanelMod.PanelHeaderTemplateType
import typingsJapgolly.primereact.panelPanelMod.PanelIconsTemplateType
import typingsJapgolly.primereact.panelPanelMod.PanelProps
import typingsJapgolly.primereact.panelPanelMod.PanelToggleParams
...
object Panel {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Panel] {
    ...
    inline def collapseIcon(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<PanelProps> */ Any
    ): this.type = set("collapseIcon", value.asInstanceOf[js.Any])
    ...
    inline def expandIcon(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<PanelProps> */ Any
    ): this.type = set("expandIcon", value.asInstanceOf[js.Any])
    ...
    inline def headerTemplate(value: PanelHeaderTemplateType): this.type = set("headerTemplate", value.asInstanceOf[js.Any])
    
    inline def headerTemplateFunction1(value: /* options */ PanelHeaderTemplateOptions => Node): this.type = set("headerTemplate", js.Any.fromFunction1(value))
    ...
    inline def icons(value: PanelIconsTemplateType): this.type = set("icons", value.asInstanceOf[js.Any])
    
    inline def iconsFunction1(value: /* props */ PanelProps => Node): this.type = set("icons", js.Any.fromFunction1(value))
    ...
    inline def onCollapse(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): this.type = set("onCollapse", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def onExpand(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): this.type = set("onExpand", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def onToggle(value: /* e */ PanelToggleParams => Callback): this.type = set("onToggle", js.Any.fromFunction1((t0: /* e */ PanelToggleParams) => value(t0).runNow()))
    ...
    inline def toggleable(value: Boolean): this.type = set("toggleable", value.asInstanceOf[js.Any])
