...
import typingsJapgolly.primereact.inputtextInputtextMod.InputTextProps
...
object InputText {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.InputText] {
    ...
    inline def validateOnly(value: Boolean): this.type = set("validateOnly", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: InputText.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InputTextProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
