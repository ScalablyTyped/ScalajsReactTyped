...
import typingsJapgolly.primereact.tabviewTabviewMod.TabViewProps
import typingsJapgolly.primereact.tabviewTabviewMod.TabViewTabChangeParams
import typingsJapgolly.primereact.tabviewTabviewMod.TabViewTabCloseParams
...
object TabView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.TabView] {
    ...
    inline def onBeforeTabChange(value: /* e */ TabViewTabChangeParams => Callback): this.type = set("onBeforeTabChange", js.Any.fromFunction1((t0: /* e */ TabViewTabChangeParams) => value(t0).runNow()))
    
    inline def onBeforeTabClose(value: /* e */ TabViewTabCloseParams => Callback): this.type = set("onBeforeTabClose", js.Any.fromFunction1((t0: /* e */ TabViewTabCloseParams) => value(t0).runNow()))
    ...
    inline def onTabChange(value: /* e */ TabViewTabChangeParams => Callback): this.type = set("onTabChange", js.Any.fromFunction1((t0: /* e */ TabViewTabChangeParams) => value(t0).runNow()))
    
    inline def onTabClose(value: /* e */ TabViewTabCloseParams => Callback): this.type = set("onTabClose", js.Any.fromFunction1((t0: /* e */ TabViewTabCloseParams) => value(t0).runNow()))
    ...
    inline def panelContainerClassName(value: String): this.type = set("panelContainerClassName", value.asInstanceOf[js.Any])
    
    inline def panelContainerStyle(value: js.Object): this.type = set("panelContainerStyle", value.asInstanceOf[js.Any])
