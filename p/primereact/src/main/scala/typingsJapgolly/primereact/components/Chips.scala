...
object Chips {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ChipsProps, typingsJapgolly.primereact.chipsMod.Chips, Unit, ChipsProps] = {
  ...
  typingsJapgolly.primereact.chipsChipsMod.ChipsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.primereact.chipsMod.Chips](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.primereact.chipsChipsMod.ChipsProps])(children: _*)
  }
