...
import typingsJapgolly.primereact.chipsChipsMod.ChipsAddParams
import typingsJapgolly.primereact.chipsChipsMod.ChipsChangeParams
import typingsJapgolly.primereact.chipsChipsMod.ChipsProps
import typingsJapgolly.primereact.chipsChipsMod.ChipsRemovableOptions
import typingsJapgolly.primereact.chipsChipsMod.ChipsRemovableType
import typingsJapgolly.primereact.chipsChipsMod.ChipsRemoveParams
...
object Chips {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.Chips] {
    ...
    inline def allowDuplicate(value: Boolean): this.type = set("allowDuplicate", value.asInstanceOf[js.Any])
    ...
    inline def onAdd(value: /* e */ ChipsAddParams => Callback): this.type = set("onAdd", js.Any.fromFunction1((t0: /* e */ ChipsAddParams) => value(t0).runNow()))
    ...
    inline def onChange(value: /* e */ ChipsChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ ChipsChangeParams) => value(t0).runNow()))
    ...
    inline def onRemove(value: /* e */ ChipsRemoveParams => Callback): this.type = set("onRemove", js.Any.fromFunction1((t0: /* e */ ChipsRemoveParams) => value(t0).runNow()))
    ...
    inline def removable(value: ChipsRemovableType): this.type = set("removable", value.asInstanceOf[js.Any])
    
    inline def removableFunction1(value: /* options */ ChipsRemovableOptions => Boolean): this.type = set("removable", js.Any.fromFunction1(value))
