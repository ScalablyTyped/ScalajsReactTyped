...
import typingsJapgolly.primereact.tristatecheckboxTristatecheckboxMod.TriStateCheckboxChangeParams
import typingsJapgolly.primereact.tristatecheckboxTristatecheckboxMod.TriStateCheckboxProps
...
object TriStateCheckbox {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.primereact.mod.TriStateCheckbox] {
    ...
    inline def onChange(value: /* e */ TriStateCheckboxChangeParams => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* e */ TriStateCheckboxChangeParams) => value(t0).runNow()))
