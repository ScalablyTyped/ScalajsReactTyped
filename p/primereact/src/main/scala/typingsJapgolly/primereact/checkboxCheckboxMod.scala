...
object checkboxCheckboxMod {
  ...
  object CheckboxProps {
    ...
    extension [Self <: CheckboxProps](x: Self) {
      ...
      inline def setOnChange(value: /* e */ CheckboxChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ CheckboxChangeParams) => value(t0).runNow()))
