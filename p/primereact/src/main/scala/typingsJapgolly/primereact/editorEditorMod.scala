...
object editorEditorMod {
  ...
  /* Inlined parent std.Omit<react.react.DetailedHTMLProps<react.react.InputHTMLAttributes<std.HTMLDivElement>, std.HTMLDivElement>, 'ref'> */
  trait EditorProps extends StObject {
    ...
    var headerTemplate: js.UndefOr[Node] = js.undefined
  ...
  object EditorProps {
    ...
    extension [Self <: EditorProps](x: Self) {
      ...
      inline def setHeaderTemplate(value: VdomNode): Self = StObject.set(x, "headerTemplate", value.rawNode.asInstanceOf[js.Any])
      ...
      inline def setOnLoad(value: /* quill */ Any => Callback): Self = StObject.set(x, "onLoad", js.Any.fromFunction1((t0: /* quill */ Any) => value(t0).runNow()))
      ...
      inline def setOnSelectionChange(value: /* e */ EditorSelectionChangeParams => Callback): Self = StObject.set(x, "onSelectionChange", js.Any.fromFunction1((t0: /* e */ EditorSelectionChangeParams) => value(t0).runNow()))
      ...
      inline def setOnTextChange(value: /* e */ EditorTextChangeParams => Callback): Self = StObject.set(x, "onTextChange", js.Any.fromFunction1((t0: /* e */ EditorTextChangeParams) => value(t0).runNow()))
