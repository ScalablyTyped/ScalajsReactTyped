...
object panelmenuPanelmenuMod {
  
  @JSImport("primereact/panelmenu/panelmenu", "PanelMenu")
  @js.native
  open class PanelMenu protected () extends Component[PanelMenuProps, Any, Any] {
    def this(props: PanelMenuProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: PanelMenuProps, context: Any) = this()
