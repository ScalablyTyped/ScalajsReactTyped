...
object dataviewDataviewMod {
  
  @JSImport("primereact/dataview/dataview", "DataView")
  @js.native
  open class DataView protected () extends Component[DataViewProps, Any, Any] {
  ...
  @JSImport("primereact/dataview/dataview", "DataViewLayoutOptions")
  @js.native
  open class DataViewLayoutOptions protected () extends Component[DataViewLayoutOptionsProps, Any, Any] {
  ...
  trait DataViewLayoutOptionsChangeParams extends StObject {
    ...
    var originalEvent: ReactMouseEventFrom[HTMLButtonElement]
    
    var value: DataViewLayoutType
  }
  object DataViewLayoutOptionsChangeParams {
    
    inline def apply(originalEvent: ReactMouseEventFrom[HTMLButtonElement], value: DataViewLayoutType): DataViewLayoutOptionsChangeParams = {
    ...
    extension [Self <: DataViewLayoutOptionsChangeParams](x: Self) {
      ...
      inline def setOriginalEvent(value: ReactMouseEventFrom[HTMLButtonElement]): Self = StObject.set(x, "originalEvent", value.asInstanceOf[js.Any])
  ...
  object DataViewLayoutOptionsProps {
    ...
    inline def apply(onChange: DataViewLayoutOptionsChangeParams => Callback): DataViewLayoutOptionsProps = {
      val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1((t0: DataViewLayoutOptionsChangeParams) => onChange(t0).runNow()))
    ...
    extension [Self <: DataViewLayoutOptionsProps](x: Self) {
      ...
      inline def setOnChange(value: DataViewLayoutOptionsChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: DataViewLayoutOptionsChangeParams) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.list
    - typingsJapgolly.primereact.primereactStrings.grid
    - java.lang.String & (typingsJapgolly.std.Record[java.lang.String, scala.Any])
  */
  ...
  */
  ...
  trait DataViewProps extends StObject {
    ...
    var itemTemplate: js.UndefOr[js.Function2[/* item */ Any, /* layout */ DataViewLayoutType, Node]] = js.undefined
  ...
  object DataViewProps {
    ...
    extension [Self <: DataViewProps](x: Self) {
      ...
      inline def setItemTemplate(value: (/* item */ Any, /* layout */ DataViewLayoutType) => Node): Self = StObject.set(x, "itemTemplate", js.Any.fromFunction2(value))
      ...
      inline def setOnPage(value: /* e */ DataViewPageParams => Callback): Self = StObject.set(x, "onPage", js.Any.fromFunction1((t0: /* e */ DataViewPageParams) => value(t0).runNow()))
