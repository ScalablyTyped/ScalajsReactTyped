...
import typingsJapgolly.primereact.utilsUtilsMod.IconOptions
import typingsJapgolly.primereact.utilsUtilsMod.IconType
...
object messageMessageMod {
  ...
  @JSImport("primereact/message/message", "Message")
  @js.native
  open class Message protected () extends Component[MessageProps, Any, Any] {
  ...
  type MessageContentType = Node | (js.Function1[/* props */ MessageProps, Node])
  ...
  object MessageProps {
    ...
    extension [Self <: MessageProps](x: Self) {
      ...
      inline def setContentFunction1(value: /* props */ MessageProps => Node): Self = StObject.set(x, "content", js.Any.fromFunction1(value))
      ...
      inline def setIcon(value: IconType[MessageProps]): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      
      inline def setIconFunction1(value: /* options */ IconOptions[MessageProps] => Node): Self = StObject.set(x, "icon", js.Any.fromFunction1(value))
      ...
      inline def setTextFunction1(value: /* props */ MessageProps => Node): Self = StObject.set(x, "text", js.Any.fromFunction1(value))
  ...
  */
  ...
  type MessageTextType = Node | (js.Function1[/* props */ MessageProps, Node])
}
