  ...
  */
  ...
  object CarouselProps {
    ...
    extension [Self <: CarouselProps](x: Self) {
      ...
      inline def setOnPageChange(value: /* e */ CarouselPageChangeParams => Callback): Self = StObject.set(x, "onPageChange", js.Any.fromFunction1((t0: /* e */ CarouselPageChangeParams) => value(t0).runNow()))
