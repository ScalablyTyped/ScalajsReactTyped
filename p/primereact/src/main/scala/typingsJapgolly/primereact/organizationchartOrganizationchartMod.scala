...
object organizationchartOrganizationchartMod {
  ...
  object OrganizationChartNodeSelectParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[Element]): OrganizationChartNodeSelectParams = {
  ...
  object OrganizationChartProps {
    ...
    extension [Self <: OrganizationChartProps](x: Self) {
      ...
      inline def setNodeTemplate(value: /* node */ OrganizationChartNodeData => Node): Self = StObject.set(x, "nodeTemplate", js.Any.fromFunction1(value))
      ...
      inline def setOnNodeSelect(value: /* e */ OrganizationChartNodeSelectParams => Callback): Self = StObject.set(x, "onNodeSelect", js.Any.fromFunction1((t0: /* e */ OrganizationChartNodeSelectParams) => value(t0).runNow()))
      
      inline def setOnNodeSelectUndefined: Self = StObject.set(x, "onNodeSelect", js.undefined)
      
      inline def setOnNodeUnselect(value: /* e */ OrganizationChartNodeUnselectParams => Callback): Self = StObject.set(x, "onNodeUnselect", js.Any.fromFunction1((t0: /* e */ OrganizationChartNodeUnselectParams) => value(t0).runNow()))
      ...
      inline def setSelectionChange(value: /* node */ OrganizationChartSelectionNodeDataType => Callback): Self = StObject.set(x, "selectionChange", js.Any.fromFunction1((t0: /* node */ OrganizationChartSelectionNodeDataType) => value(t0).runNow()))
