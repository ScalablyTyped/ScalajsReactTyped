...
object multistatecheckboxMultistatecheckboxMod {
  
  @JSImport("primereact/multistatecheckbox/multistatecheckbox", "MultiStateCheckbox")
  @js.native
  open class MultiStateCheckbox protected () extends Component[MultiStateCheckboxProps, Any, Any] {
  ...
  object MultiStateCheckboxChangeParams {
    ...
    extension [Self <: MultiStateCheckboxChangeParams](x: Self) {
      ...
      inline def setTarget(value: MultiStateCheckboxChangeTargetOptions): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
  ...
  object MultiStateCheckboxChangeTargetOptions {
    ...
    inline def apply(id: String, name: String): MultiStateCheckboxChangeTargetOptions = {
  ...
  object MultiStateCheckboxIconTemplateParams {
    ...
    inline def apply(className: String, element: VdomElement, props: MultiStateCheckboxProps): MultiStateCheckboxIconTemplateParams = {
    ...
    extension [Self <: MultiStateCheckboxIconTemplateParams](x: Self) {
      ...
      inline def setOption(value: MultiStateCheckboxOption): Self = StObject.set(x, "option", value.asInstanceOf[js.Any])
      
      inline def setOptionNull: Self = StObject.set(x, "option", null)
      
      inline def setOptionUndefined: Self = StObject.set(x, "option", js.undefined)
      
      inline def setProps(value: MultiStateCheckboxProps): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
  
  type MultiStateCheckboxIconTemplateType = Node | (js.Function1[/* options */ MultiStateCheckboxIconTemplateParams, Node])
  ...
  object MultiStateCheckboxProps {
    
    inline def apply(): MultiStateCheckboxProps = {
    ...
    extension [Self <: MultiStateCheckboxProps](x: Self) {
      ...
      inline def setIconTemplateFunction1(value: /* options */ MultiStateCheckboxIconTemplateParams => Node): Self = StObject.set(x, "iconTemplate", js.Any.fromFunction1(value))
      
      inline def setIconTemplateNull: Self = StObject.set(x, "iconTemplate", null)
      
      inline def setIconTemplateUndefined: Self = StObject.set(x, "iconTemplate", js.undefined)
      
      inline def setIconTemplateVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "iconTemplate", js.Array(value*))
      
      inline def setIconTemplateVdomElement(value: VdomElement): Self = StObject.set(x, "iconTemplate", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: /* e */ MultiStateCheckboxChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ MultiStateCheckboxChangeParams) => value(t0).runNow()))
      ...
      inline def setOptionsVarargs(value: (Any | MultiStateCheckboxOption)*): Self = StObject.set(x, "options", js.Array(value*))
