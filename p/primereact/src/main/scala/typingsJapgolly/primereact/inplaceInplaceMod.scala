...
object inplaceInplaceMod {
  
  @JSImport("primereact/inplace/inplace", "Inplace")
  @js.native
  open class Inplace protected () extends Component[InplaceProps, Any, Any] {
  ...
  trait InplaceProps extends StObject {
    ...
    var onClose: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[HTMLElement], Unit]] = js.undefined
    ...
    var onOpen: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[HTMLElement], Unit]] = js.undefined
  ...
  object InplaceProps {
    ...
    extension [Self <: InplaceProps](x: Self) {
      ...
      inline def setOnClose(value: /* event */ ReactMouseEventFrom[HTMLElement] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLElement]) => value(t0).runNow()))
      ...
      inline def setOnOpen(value: /* event */ ReactMouseEventFrom[HTMLElement] => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLElement]) => value(t0).runNow()))
      ...
      inline def setOnToggle(value: /* e */ InplaceToggleParams => Callback): Self = StObject.set(x, "onToggle", js.Any.fromFunction1((t0: /* e */ InplaceToggleParams) => value(t0).runNow()))
  ...
  object InplaceToggleParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[org.scalajs.dom.Element], value: Boolean): InplaceToggleParams = {
