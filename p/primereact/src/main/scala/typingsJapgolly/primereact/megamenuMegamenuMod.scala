...
object megamenuMegamenuMod {
  ...
  type MegaMenuEndTemplate = Node | (js.Function1[/* props */ MegaMenuProps, Node])
  ...
  */
  ...
  object MegaMenuProps {
    ...
    extension [Self <: MegaMenuProps](x: Self) {
      ...
      inline def setEndFunction1(value: /* props */ MegaMenuProps => Node): Self = StObject.set(x, "end", js.Any.fromFunction1(value))
      ...
      inline def setStartFunction1(value: /* props */ MegaMenuProps => Node): Self = StObject.set(x, "start", js.Any.fromFunction1(value))
  ...
  type MegaMenuStartTemplate = Node | (js.Function1[/* props */ MegaMenuProps, Node])
}
