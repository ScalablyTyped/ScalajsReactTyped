...
object deferredcontentDeferredcontentMod {
  
  @JSImport("primereact/deferredcontent/deferredcontent", "DeferredContent")
  @js.native
  open class DeferredContent protected () extends Component[DeferredContentProps, Any, Any] {
    def this(props: DeferredContentProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: DeferredContentProps, context: Any) = this()
  ...
  trait DeferredContentProps extends StObject {
    ...
    var onLoad: js.UndefOr[js.Function1[/* event */ ReactEventFrom[Element], Unit]] = js.undefined
  ...
  object DeferredContentProps {
    ...
    extension [Self <: DeferredContentProps](x: Self) {
      ...
      inline def setOnLoad(value: /* event */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onLoad", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
