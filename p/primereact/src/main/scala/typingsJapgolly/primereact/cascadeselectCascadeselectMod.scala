...
object cascadeselectCascadeselectMod {
  ...
  object CascadeSelectChangeParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[Element], value: Any): CascadeSelectChangeParams = {
  ...
  type CascadeSelectItemTemplateType = Node | (js.Function1[/* option */ Any, Node])
  ...
  object CascadeSelectProps {
    ...
    extension [Self <: CascadeSelectProps](x: Self) {
      ...
      inline def setOnBeforeHide(value: Callback): Self = StObject.set(x, "onBeforeHide", value.toJsFn)
      ...
      inline def setOnBeforeShow(value: Callback): Self = StObject.set(x, "onBeforeShow", value.toJsFn)
      ...
      inline def setOnChange(value: /* e */ CascadeSelectChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ CascadeSelectChangeParams) => value(t0).runNow()))
      ...
      inline def setOnGroupChange(value: /* e */ CascadeSelectGroupChangeParams => Callback): Self = StObject.set(x, "onGroupChange", js.Any.fromFunction1((t0: /* e */ CascadeSelectGroupChangeParams) => value(t0).runNow()))
