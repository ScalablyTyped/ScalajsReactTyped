...
object menubarMenubarMod {
  ...
  type MenubarEndTemplate = Node | (js.Function1[/* props */ MenubarProps, Node])
  ...
  object MenubarProps {
    ...
    extension [Self <: MenubarProps](x: Self) {
      ...
      inline def setEndFunction1(value: /* props */ MenubarProps => Node): Self = StObject.set(x, "end", js.Any.fromFunction1(value))
      ...
      inline def setStartFunction1(value: /* props */ MenubarProps => Node): Self = StObject.set(x, "start", js.Any.fromFunction1(value))
  ...
  type MenubarStartTemplate = Node | (js.Function1[/* props */ MenubarProps, Node])
}
