...
object avatarAvatarMod {
  ...
  @JSImport("primereact/avatar/avatar", "Avatar")
  @js.native
  ...
  trait AvatarProps extends StObject {
    ...
    var onImageError: js.UndefOr[js.Function1[/* event */ ReactEventFrom[Element], Unit]] = js.undefined
  ...
  object AvatarProps {
    ...
    extension [Self <: AvatarProps](x: Self) {
      ...
      inline def setIcon(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<AvatarProps> */ Any
      ...
      inline def setOnImageError(value: /* event */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onImageError", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
      ...
      inline def setTemplateFunction1(value: /* props */ AvatarProps => Node): Self = StObject.set(x, "template", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.square
  ...
  */
  ...
  object AvatarShapeType {
    ...
    inline def square: typingsJapgolly.primereact.primereactStrings.square = "square".asInstanceOf[typingsJapgolly.primereact.primereactStrings.square]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.normal
    - typingsJapgolly.primereact.primereactStrings.large
    - typingsJapgolly.primereact.primereactStrings.xlarge
  */
  trait AvatarSizeType extends StObject
  object AvatarSizeType {
    
    inline def large: typingsJapgolly.primereact.primereactStrings.large = "large".asInstanceOf[typingsJapgolly.primereact.primereactStrings.large]
    
    inline def normal: typingsJapgolly.primereact.primereactStrings.normal = "normal".asInstanceOf[typingsJapgolly.primereact.primereactStrings.normal]
    
    inline def xlarge: typingsJapgolly.primereact.primereactStrings.xlarge = "xlarge".asInstanceOf[typingsJapgolly.primereact.primereactStrings.xlarge]
  }
  
  type AvatarTemplateType = Node | (js.Function1[/* props */ AvatarProps, Node])
}
