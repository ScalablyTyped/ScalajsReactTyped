...
object toastToastMod {
  ...
  @JSImport("primereact/toast/toast", "Toast")
  @js.native
  open class Toast protected () extends Component[ToastProps, Any, Any] {
  ...
  object ToastMessage {
    ...
    extension [Self <: ToastMessage](x: Self) {
      ...
      inline def setDetail(value: VdomNode): Self = StObject.set(x, "detail", value.rawNode.asInstanceOf[js.Any])
      ...
      inline def setSummary(value: VdomNode): Self = StObject.set(x, "summary", value.rawNode.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.primereact.primereactStrings.`top-center`
    - typingsJapgolly.primereact.primereactStrings.`top-left`
    - typingsJapgolly.primereact.primereactStrings.`top-right`
    - typingsJapgolly.primereact.primereactStrings.`bottom-center`
  ...
  */
  ...
  object ToastPositionType {
    ...
    inline def `bottom-center`: typingsJapgolly.primereact.primereactStrings.`bottom-center` = "bottom-center".asInstanceOf[typingsJapgolly.primereact.primereactStrings.`bottom-center`]
    ...
    inline def `top-center`: typingsJapgolly.primereact.primereactStrings.`top-center` = "top-center".asInstanceOf[typingsJapgolly.primereact.primereactStrings.`top-center`]
  ...
  object ToastProps {
    ...
    extension [Self <: ToastProps](x: Self) {
      ...
      inline def setOnClick(value: /* message */ ToastMessage => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* message */ ToastMessage) => value(t0).runNow()))
      ...
      inline def setOnRemove(value: /* message */ ToastMessage => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: /* message */ ToastMessage) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.success
    - typingsJapgolly.primereact.primereactStrings.info
    - typingsJapgolly.primereact.primereactStrings.warn
    - typingsJapgolly.primereact.primereactStrings.error
  */
  trait ToastSeverityType extends StObject
  object ToastSeverityType {
    
    inline def error: typingsJapgolly.primereact.primereactStrings.error = "error".asInstanceOf[typingsJapgolly.primereact.primereactStrings.error]
    
    inline def info: typingsJapgolly.primereact.primereactStrings.info = "info".asInstanceOf[typingsJapgolly.primereact.primereactStrings.info]
    
    inline def success: typingsJapgolly.primereact.primereactStrings.success = "success".asInstanceOf[typingsJapgolly.primereact.primereactStrings.success]
    
    inline def warn: typingsJapgolly.primereact.primereactStrings.warn = "warn".asInstanceOf[typingsJapgolly.primereact.primereactStrings.warn]
  }
}
