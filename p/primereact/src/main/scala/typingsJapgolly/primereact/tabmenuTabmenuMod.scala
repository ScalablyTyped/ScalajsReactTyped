...
object tabmenuTabmenuMod {
  ...
  object TabMenuProps {
    ...
    extension [Self <: TabMenuProps](x: Self) {
      ...
      inline def setOnTabChange(value: /* e */ TabMenuTabChangeParams => Callback): Self = StObject.set(x, "onTabChange", js.Any.fromFunction1((t0: /* e */ TabMenuTabChangeParams) => value(t0).runNow()))
