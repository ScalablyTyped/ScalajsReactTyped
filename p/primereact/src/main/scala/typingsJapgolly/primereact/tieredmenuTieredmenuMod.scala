...
object tieredmenuTieredmenuMod {
  ...
  open class TieredMenu protected () extends Component[TieredMenuProps, Any, Any] {
    ...
    def toggle(event: ReactEventFrom[Element]): Unit = js.native
  }
  ...
  trait TieredMenuProps extends StObject {
    ...
    var onHide: js.UndefOr[js.Function1[/* e */ ReactEventFrom[Element], Unit]] = js.undefined
    ...
    var onShow: js.UndefOr[js.Function1[/* e */ ReactEventFrom[Element], Unit]] = js.undefined
  ...
  object TieredMenuProps {
    ...
    extension [Self <: TieredMenuProps](x: Self) {
      ...
      inline def setOnHide(value: /* e */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onHide", js.Any.fromFunction1((t0: /* e */ ReactEventFrom[Element]) => value(t0).runNow()))
      ...
      inline def setOnShow(value: /* e */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* e */ ReactEventFrom[Element]) => value(t0).runNow()))
