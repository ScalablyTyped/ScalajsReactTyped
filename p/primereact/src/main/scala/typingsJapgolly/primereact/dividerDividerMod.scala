...
object dividerDividerMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.solid
    - typingsJapgolly.primereact.primereactStrings.dashed
    - typingsJapgolly.primereact.primereactStrings.dotted
  */
  trait DividerBorderType extends StObject
  object DividerBorderType {
    
    inline def dashed: typingsJapgolly.primereact.primereactStrings.dashed = "dashed".asInstanceOf[typingsJapgolly.primereact.primereactStrings.dashed]
    
    inline def dotted: typingsJapgolly.primereact.primereactStrings.dotted = "dotted".asInstanceOf[typingsJapgolly.primereact.primereactStrings.dotted]
    
    inline def solid: typingsJapgolly.primereact.primereactStrings.solid = "solid".asInstanceOf[typingsJapgolly.primereact.primereactStrings.solid]
  }
