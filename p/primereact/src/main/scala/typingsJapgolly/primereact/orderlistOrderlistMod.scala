...
object orderlistOrderlistMod {
  
  @JSImport("primereact/orderlist/orderlist", "OrderList")
  @js.native
  open class OrderList protected () extends Component[OrderListProps, Any, Any] {
  ...
  object OrderListChangeParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[Element], value: Any): OrderListChangeParams = {
  ...
  object OrderListFilterOptions {
    ...
    inline def apply(): OrderListFilterOptions = {
  ...
  type OrderListFilterTemplateType = Node | (js.Function1[/* options */ OrderListFilterOptions, Node])
  ...
  trait OrderListProps extends StObject {
    ...
    var itemTemplate: js.UndefOr[js.Function1[/* item */ Any, Node]] = js.undefined
  ...
  object OrderListProps {
    ...
    extension [Self <: OrderListProps](x: Self) {
      ...
      inline def setFilterTemplateFunction1(value: /* options */ OrderListFilterOptions => Node): Self = StObject.set(x, "filterTemplate", js.Any.fromFunction1(value))
      ...
      inline def setItemTemplate(value: /* item */ Any => Node): Self = StObject.set(x, "itemTemplate", js.Any.fromFunction1(value))
      ...
      inline def setOnChange(value: /* e */ OrderListChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ OrderListChangeParams) => value(t0).runNow()))
