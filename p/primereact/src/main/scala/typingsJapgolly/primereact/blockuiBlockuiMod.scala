...
object blockuiBlockuiMod {
  ...
  object BlockUIProps {
    ...
    extension [Self <: BlockUIProps](x: Self) {
      ...
      inline def setOnBlocked(value: Callback): Self = StObject.set(x, "onBlocked", value.toJsFn)
      ...
      inline def setOnUnblocked(value: Callback): Self = StObject.set(x, "onUnblocked", value.toJsFn)
      ...
      inline def setTemplateFunction1(value: /* props */ BlockUIProps => Node): Self = StObject.set(x, "template", js.Any.fromFunction1(value))
  ...
  type BlockUITemplateType = Node | (js.Function1[/* props */ BlockUIProps, Node])
}
