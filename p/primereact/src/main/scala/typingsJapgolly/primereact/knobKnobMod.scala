...
object knobKnobMod {
  ...
  @JSImport("primereact/knob/knob", "Knob")
  @js.native
  open class Knob protected () extends Component[KnobProps, Any, Any] {
  ...
  trait KnobProps extends StObject {
  ...
  object KnobProps {
    ...
    extension [Self <: KnobProps](x: Self) {
      ...
      inline def setOnChange(value: /* e */ KnobChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ KnobChangeParams) => value(t0).runNow()))
      ...
      inline def setRangeColor(value: String): Self = StObject.set(x, "rangeColor", value.asInstanceOf[js.Any])
      
      inline def setRangeColorUndefined: Self = StObject.set(x, "rangeColor", js.undefined)
      ...
      inline def setValueTemplate(value: String): Self = StObject.set(x, "valueTemplate", value.asInstanceOf[js.Any])
