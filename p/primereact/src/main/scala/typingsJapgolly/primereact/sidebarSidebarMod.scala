...
object sidebarSidebarMod {
  
  @JSImport("primereact/sidebar/sidebar", "Sidebar")
  @js.native
  ...
  */
  ...
  object SidebarProps {
    ...
    inline def apply(onHide: Callback): SidebarProps = {
    ...
    extension [Self <: SidebarProps](x: Self) {
      ...
      inline def setIconsFunction1(value: /* props */ SidebarProps => Node): Self = StObject.set(x, "icons", js.Any.fromFunction1(value))
      
      inline def setIconsNull: Self = StObject.set(x, "icons", null)
      
      inline def setIconsUndefined: Self = StObject.set(x, "icons", js.undefined)
      
      inline def setIconsVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "icons", js.Array(value*))
  ...
  type SidebarTemplateType = Node | (js.Function1[/* props */ SidebarProps, Node])
}
