...
object galleriaGalleriaMod {
  ...
  */
  ...
  trait GalleriaProps extends StObject {
    ...
    var caption: js.UndefOr[js.Function1[/* item */ Any, Node]] = js.undefined
    ...
    var indicator: js.UndefOr[js.Function1[/* index */ Double, Node]] = js.undefined
    ...
    var item: js.UndefOr[js.Function1[/* item */ Any, Node]] = js.undefined
    ...
    var thumbnail: js.UndefOr[js.Function1[/* item */ Any, Node]] = js.undefined
  ...
  object GalleriaProps {
    ...
    extension [Self <: GalleriaProps](x: Self) {
      ...
      inline def setCaption(value: /* item */ Any => Node): Self = StObject.set(x, "caption", js.Any.fromFunction1(value))
      ...
      inline def setIndicator(value: /* index */ Double => Node): Self = StObject.set(x, "indicator", js.Any.fromFunction1(value))
      ...
      inline def setItem(value: /* item */ Any => Node): Self = StObject.set(x, "item", js.Any.fromFunction1(value))
      ...
      inline def setOnItemChange(value: /* e */ GalleriaItemChangeParams => Callback): Self = StObject.set(x, "onItemChange", js.Any.fromFunction1((t0: /* e */ GalleriaItemChangeParams) => value(t0).runNow()))
      ...
      inline def setThumbnail(value: /* item */ Any => Node): Self = StObject.set(x, "thumbnail", js.Any.fromFunction1(value))
