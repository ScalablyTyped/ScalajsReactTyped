...
object dropdownDropdownMod {
  ...
  @JSImport("primereact/dropdown/dropdown", "Dropdown")
  @js.native
  open class Dropdown protected () extends Component[DropdownProps, Any, Any] {
  ...
  type DropdownEmptyFilterMessageType = Node | (js.Function1[/* props */ DropdownProps, Node])
  
  type DropdownEmptyMessageType = Node | (js.Function1[/* props */ DropdownProps, Node])
  ...
  object DropdownFilterOptions {
    ...
    inline def apply(): DropdownFilterOptions = {
  ...
  object DropdownFilterParams {
    ...
    inline def apply(filter: String, originalEvent: ReactEventFrom[Element]): DropdownFilterParams = {
  ...
  type DropdownFilterTemplateType = Node | (js.Function1[/* options */ DropdownFilterOptions, Node])
  
  type DropdownItemTemplateType = Node | (js.Function1[/* option */ Any, Node])
  
  type DropdownOptionDisabledType = String | (js.Function1[/* option */ Any, Boolean])
  
  type DropdownOptionGroupTemplateType = Node | (js.Function2[/* option */ Any, /* index */ Double, Node])
  ...
  object DropdownProps {
    ...
    extension [Self <: DropdownProps](x: Self) {
      ...
      inline def setEmptyFilterMessageFunction1(value: /* props */ DropdownProps => Node): Self = StObject.set(x, "emptyFilterMessage", js.Any.fromFunction1(value))
      
      inline def setEmptyFilterMessageNull: Self = StObject.set(x, "emptyFilterMessage", null)
      
      inline def setEmptyFilterMessageUndefined: Self = StObject.set(x, "emptyFilterMessage", js.undefined)
      
      inline def setEmptyFilterMessageVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "emptyFilterMessage", js.Array(value*))
      
      inline def setEmptyFilterMessageVdomElement(value: VdomElement): Self = StObject.set(x, "emptyFilterMessage", value.rawElement.asInstanceOf[js.Any])
      
      inline def setEmptyMessage(value: DropdownEmptyMessageType): Self = StObject.set(x, "emptyMessage", value.asInstanceOf[js.Any])
      
      inline def setEmptyMessageFunction1(value: /* props */ DropdownProps => Node): Self = StObject.set(x, "emptyMessage", js.Any.fromFunction1(value))
      ...
      inline def setEmptyMessageVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "emptyMessage", js.Array(value*))
      ...
      inline def setFilterTemplateFunction1(value: /* options */ DropdownFilterOptions => Node): Self = StObject.set(x, "filterTemplate", js.Any.fromFunction1(value))
      ...
      inline def setItemTemplateFunction1(value: /* option */ Any => Node): Self = StObject.set(x, "itemTemplate", js.Any.fromFunction1(value))
      ...
      inline def setOnChange(value: /* e */ DropdownChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ DropdownChangeParams) => value(t0).runNow()))
      ...
      inline def setOnFilter(value: /* e */ DropdownFilterParams => Callback): Self = StObject.set(x, "onFilter", js.Any.fromFunction1((t0: /* e */ DropdownFilterParams) => value(t0).runNow()))
      ...
      inline def setOptionGroupTemplateFunction2(value: (/* option */ Any, /* index */ Double) => Node): Self = StObject.set(x, "optionGroupTemplate", js.Any.fromFunction2(value))
      ...
      inline def setShowFilterClear(value: Boolean): Self = StObject.set(x, "showFilterClear", value.asInstanceOf[js.Any])
      
      inline def setShowFilterClearUndefined: Self = StObject.set(x, "showFilterClear", js.undefined)
      ...
      inline def setValueTemplateFunction2(value: (/* option */ Any, /* props */ DropdownProps) => Node): Self = StObject.set(x, "valueTemplate", js.Any.fromFunction2(value))
  ...
  type DropdownValueTemplateType = Node | (js.Function2[/* option */ Any, /* props */ DropdownProps, Node])
}
