...
object splitbuttonSplitbuttonMod {
  
  @JSImport("primereact/splitbutton/splitbutton", "SplitButton")
  @js.native
  open class SplitButton protected () extends Component[SplitButtonProps, Any, Any] {
  ...
  object SplitButtonProps {
    ...
    extension [Self <: SplitButtonProps](x: Self) {
      ...
      inline def setButtonTemplate(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify TemplateType<SplitButtonProps> */ Any
      ...
      inline def setDropdownIcon(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<SplitButtonProps> */ Any
      ...
      inline def setMenuButtonClassName(value: String): Self = StObject.set(x, "menuButtonClassName", value.asInstanceOf[js.Any])
      
      inline def setMenuButtonClassNameUndefined: Self = StObject.set(x, "menuButtonClassName", js.undefined)
      
      inline def setMenuButtonProps(value: Any): Self = StObject.set(x, "menuButtonProps", value.asInstanceOf[js.Any])
      
      inline def setMenuButtonPropsUndefined: Self = StObject.set(x, "menuButtonProps", js.undefined)
