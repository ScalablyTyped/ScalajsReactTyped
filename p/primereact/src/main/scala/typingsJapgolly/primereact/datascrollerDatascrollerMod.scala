...
object datascrollerDatascrollerMod {
  ...
  type DataScrollerEmptyMessageType = Node | (js.Function1[/* props */ DataScrollerProps, Node])
  ...
  object DataScrollerProps {
    ...
    extension [Self <: DataScrollerProps](x: Self) {
      ...
      inline def setEmptyMessageFunction1(value: /* props */ DataScrollerProps => Node): Self = StObject.set(x, "emptyMessage", js.Any.fromFunction1(value))
      ...
      inline def setOnLazyLoad(value: /* e */ DataScrollerLazyLoadParams => Callback): Self = StObject.set(x, "onLazyLoad", js.Any.fromFunction1((t0: /* e */ DataScrollerLazyLoadParams) => value(t0).runNow()))
