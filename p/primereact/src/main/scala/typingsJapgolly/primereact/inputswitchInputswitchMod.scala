...
object inputswitchInputswitchMod {
  
  @JSImport("primereact/inputswitch/inputswitch", "InputSwitch")
  @js.native
  open class InputSwitch protected () extends Component[InputSwitchProps, Any, Any] {
  ...
  object InputSwitchProps {
    ...
    extension [Self <: InputSwitchProps](x: Self) {
      ...
      inline def setFalseValue(value: Any): Self = StObject.set(x, "falseValue", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: /* e */ InputSwitchChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ InputSwitchChangeParams) => value(t0).runNow()))
      ...
      inline def setTrueValue(value: Any): Self = StObject.set(x, "trueValue", value.asInstanceOf[js.Any])
