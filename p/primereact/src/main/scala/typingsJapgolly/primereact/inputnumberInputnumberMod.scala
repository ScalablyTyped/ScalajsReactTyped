...
import typingsJapgolly.primereact.inputtextInputtextMod.InputText
...
object inputnumberInputnumberMod {
  ...
  object InputNumberChangeParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[Element]): InputNumberChangeParams = {
  ...
  object InputNumberProps {
    ...
    extension [Self <: InputNumberProps](x: Self) {
      ...
      inline def setOnChange(value: /* e */ InputNumberChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ InputNumberChangeParams) => value(t0).runNow()))
      ...
      inline def setOnValueChange(value: /* e */ InputNumberValueChangeParams => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction1((t0: /* e */ InputNumberValueChangeParams) => value(t0).runNow()))
  ...
  object InputNumberValueChangeParams {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(originalEvent = originalEvent.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, stopPropagation = stopPropagation.toJsFn, target = target.asInstanceOf[js.Any], value = null)
