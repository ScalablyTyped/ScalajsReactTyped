...
object togglebuttonTogglebuttonMod {
  ...
  @JSImport("primereact/togglebutton/togglebutton", "ToggleButton")
  @js.native
  open class ToggleButton protected () extends Component[ToggleButtonProps, Any, Any] {
  ...
  object ToggleButtonChangeParams {
    ...
    extension [Self <: ToggleButtonChangeParams](x: Self) {
      ...
      inline def setTarget(value: ToggleButtonChangeTargetOptions): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
  ...
  object ToggleButtonChangeTargetOptions {
    ...
    inline def apply(id: String, name: String, value: Boolean): ToggleButtonChangeTargetOptions = {
  ...
  */
  ...
  object ToggleButtonProps {
    ...
    inline def apply(): ToggleButtonProps = {
    ...
    extension [Self <: ToggleButtonProps](x: Self) {
      ...
      ): Self = StObject.set(x, "offIcon", value.asInstanceOf[js.Any])
      
      inline def setOffIconUndefined: Self = StObject.set(x, "offIcon", js.undefined)
      ...
      inline def setOnBlur(value: /* event */ ReactFocusEventFrom[HTMLElement] => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* event */ ReactFocusEventFrom[HTMLElement]) => value(t0).runNow()))
      ...
      inline def setOnChange(value: /* e */ ToggleButtonChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ ToggleButtonChangeParams) => value(t0).runNow()))
      ...
      inline def setOnIcon(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<ToggleButtonProps> */ Any
      ): Self = StObject.set(x, "onIcon", value.asInstanceOf[js.Any])
