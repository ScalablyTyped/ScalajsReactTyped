...
object sliderSliderMod {
  ...
  object SliderChangeParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[Element], value: SliderValueType): SliderChangeParams = {
  ...
  */
  ...
  object SliderProps {
    ...
    extension [Self <: SliderProps](x: Self) {
      ...
      inline def setOnChange(value: /* e */ SliderChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ SliderChangeParams) => value(t0).runNow()))
      ...
      inline def setOnSlideEnd(value: /* e */ SliderSlideEndParams => Callback): Self = StObject.set(x, "onSlideEnd", js.Any.fromFunction1((t0: /* e */ SliderSlideEndParams) => value(t0).runNow()))
