...
object speeddialSpeeddialMod {
  ...
  object SpeedDialButtonOptions {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], element = element.rawElement.asInstanceOf[js.Any], iconClassName = iconClassName.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any], visible = visible.asInstanceOf[js.Any])
  ...
  type SpeedDialButtonTemplateType = Node | (js.Function1[/* options */ SpeedDialButtonOptions, Node])
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.up
    - typingsJapgolly.primereact.primereactStrings.down
    - typingsJapgolly.primereact.primereactStrings.left
    - typingsJapgolly.primereact.primereactStrings.right
    - typingsJapgolly.primereact.primereactStrings.`up-left`
    - typingsJapgolly.primereact.primereactStrings.`up-right`
    - typingsJapgolly.primereact.primereactStrings.`down-left`
    - typingsJapgolly.primereact.primereactStrings.`down-right`
  */
  trait SpeedDialDirectionType extends StObject
  object SpeedDialDirectionType {
    
    inline def down: typingsJapgolly.primereact.primereactStrings.down = "down".asInstanceOf[typingsJapgolly.primereact.primereactStrings.down]
    
    inline def `down-left`: typingsJapgolly.primereact.primereactStrings.`down-left` = "down-left".asInstanceOf[typingsJapgolly.primereact.primereactStrings.`down-left`]
    
    inline def `down-right`: typingsJapgolly.primereact.primereactStrings.`down-right` = "down-right".asInstanceOf[typingsJapgolly.primereact.primereactStrings.`down-right`]
    ...
    inline def up: typingsJapgolly.primereact.primereactStrings.up = "up".asInstanceOf[typingsJapgolly.primereact.primereactStrings.up]
    
    inline def `up-left`: typingsJapgolly.primereact.primereactStrings.`up-left` = "up-left".asInstanceOf[typingsJapgolly.primereact.primereactStrings.`up-left`]
    
    inline def `up-right`: typingsJapgolly.primereact.primereactStrings.`up-right` = "up-right".asInstanceOf[typingsJapgolly.primereact.primereactStrings.`up-right`]
  }
  ...
  object SpeedDialProps {
    ...
    extension [Self <: SpeedDialProps](x: Self) {
      ...
      inline def setButtonTemplateFunction1(value: /* options */ SpeedDialButtonOptions => Node): Self = StObject.set(x, "buttonTemplate", js.Any.fromFunction1(value))
      
      inline def setButtonTemplateNull: Self = StObject.set(x, "buttonTemplate", null)
      
      inline def setButtonTemplateUndefined: Self = StObject.set(x, "buttonTemplate", js.undefined)
      
      inline def setButtonTemplateVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "buttonTemplate", js.Array(value*))
      
      inline def setButtonTemplateVdomElement(value: VdomElement): Self = StObject.set(x, "buttonTemplate", value.rawElement.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.linear
    - typingsJapgolly.primereact.primereactStrings.circle
    - typingsJapgolly.primereact.primereactStrings.`semi-circle`
    - typingsJapgolly.primereact.primereactStrings.`quarter-circle`
  */
  trait SpeedDialType extends StObject
  object SpeedDialType {
    
    inline def circle: typingsJapgolly.primereact.primereactStrings.circle = "circle".asInstanceOf[typingsJapgolly.primereact.primereactStrings.circle]
    
    inline def linear: typingsJapgolly.primereact.primereactStrings.linear = "linear".asInstanceOf[typingsJapgolly.primereact.primereactStrings.linear]
    
    inline def `quarter-circle`: typingsJapgolly.primereact.primereactStrings.`quarter-circle` = "quarter-circle".asInstanceOf[typingsJapgolly.primereact.primereactStrings.`quarter-circle`]
    
    inline def `semi-circle`: typingsJapgolly.primereact.primereactStrings.`semi-circle` = "semi-circle".asInstanceOf[typingsJapgolly.primereact.primereactStrings.`semi-circle`]
  }
}
