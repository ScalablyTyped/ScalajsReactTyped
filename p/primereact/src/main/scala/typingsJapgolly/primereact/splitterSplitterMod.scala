...
object splitterSplitterMod {
  
  @JSImport("primereact/splitter/splitter", "Splitter")
  @js.native
  open class Splitter protected () extends Component[SplitterProps, Any, Any] {
  ...
  @JSImport("primereact/splitter/splitter", "SplitterPanel")
  @js.native
  open class SplitterPanel protected () extends Component[SplitterPanelProps, Any, Any] {
  ...
  */
  ...
  object SplitterPanelProps {
    ...
    inline def apply(): SplitterPanelProps = {
  ...
  object SplitterProps {
    
    inline def apply(): SplitterProps = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: SplitterProps](x: Self) {
      ...
      inline def setOnResizeEnd(value: /* e */ SplitterResizeEndParams => Callback): Self = StObject.set(x, "onResizeEnd", js.Any.fromFunction1((t0: /* e */ SplitterResizeEndParams) => value(t0).runNow()))
  ...
  object SplitterResizeEndParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[org.scalajs.dom.Element], sizes: js.Array[Double]): SplitterResizeEndParams = {
