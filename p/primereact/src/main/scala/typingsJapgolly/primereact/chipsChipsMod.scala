...
object chipsChipsMod {
  ...
  object ChipsAddParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[Element], value: Any): ChipsAddParams = {
  ...
  object ChipsProps {
    ...
    extension [Self <: ChipsProps](x: Self) {
      ...
      inline def setOnAdd(value: /* e */ ChipsAddParams => Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction1((t0: /* e */ ChipsAddParams) => value(t0).runNow()))
      ...
      inline def setOnChange(value: /* e */ ChipsChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ ChipsChangeParams) => value(t0).runNow()))
      ...
      inline def setOnRemove(value: /* e */ ChipsRemoveParams => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: /* e */ ChipsRemoveParams) => value(t0).runNow()))
