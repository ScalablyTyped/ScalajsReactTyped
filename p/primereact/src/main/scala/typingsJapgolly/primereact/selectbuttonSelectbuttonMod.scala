...
object selectbuttonSelectbuttonMod {
  
  @JSImport("primereact/selectbutton/selectbutton", "SelectButton")
  @js.native
  open class SelectButton protected () extends Component[SelectButtonProps, Any, Any] {
  ...
  trait SelectButtonProps extends StObject {
    ...
    var itemTemplate: js.UndefOr[js.Function1[/* option */ Any, Node]] = js.undefined
  ...
  object SelectButtonProps {
    ...
    extension [Self <: SelectButtonProps](x: Self) {
      ...
      inline def setItemTemplate(value: /* option */ Any => Node): Self = StObject.set(x, "itemTemplate", js.Any.fromFunction1(value))
      ...
      inline def setOnChange(value: /* e */ SelectButtonChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ SelectButtonChangeParams) => value(t0).runNow()))
