...
object dockDockMod {
  ...
  @JSImport("primereact/dock/dock", "Dock")
  @js.native
  open class Dock protected () extends Component[DockProps, Any, Any] {
  ...
  type DockFooterType = Node | (js.Function1[/* options */ DockFooterTemplateOptions, Node])
  ...
  object DockHeaderTemplateOptions {
    ...
    inline def apply(props: DockProps): DockHeaderTemplateOptions = {
  ...
  type DockHeaderType = Node | (js.Function1[/* options */ DockHeaderTemplateOptions, Node])
  ...
  */
  ...
  trait DockProps extends StObject {
  ...
  object DockProps {
    ...
    extension [Self <: DockProps](x: Self) {
      ...
      inline def setFooterFunction1(value: /* options */ DockFooterTemplateOptions => Node): Self = StObject.set(x, "footer", js.Any.fromFunction1(value))
      ...
      inline def setHeaderFunction1(value: /* options */ DockHeaderTemplateOptions => Node): Self = StObject.set(x, "header", js.Any.fromFunction1(value))
      ...
      inline def setMagnification(value: Boolean): Self = StObject.set(x, "magnification", value.asInstanceOf[js.Any])
