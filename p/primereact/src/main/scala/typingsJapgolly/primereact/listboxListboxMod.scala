...
object listboxListboxMod {
  ...
  type ListBoxFilterTemplateType = Node | (js.Function1[/* options */ ListBoxFilterOptions, Node])
  ...
  object ListBoxFilterValueChangeParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[Element], value: Any): ListBoxFilterValueChangeParams = {
  ...
  type ListBoxItemTemplateType = Node | (js.Function1[/* option */ Any, Node])
  
  type ListBoxOptionDisabledType = String | (js.Function1[/* option */ Any, Boolean])
  
  type ListBoxOptionGroupTemplateType = Node | (js.Function2[/* option */ Any, /* index */ Double, Node])
  ...
  object ListBoxProps {
    ...
    extension [Self <: ListBoxProps](x: Self) {
      ...
      inline def setFilterTemplateFunction1(value: /* options */ ListBoxFilterOptions => Node): Self = StObject.set(x, "filterTemplate", js.Any.fromFunction1(value))
      ...
      inline def setOnChange(value: /* e */ ListBoxChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ ListBoxChangeParams) => value(t0).runNow()))
      ...
      inline def setOnFilterValueChange(value: /* e */ ListBoxFilterValueChangeParams => Callback): Self = StObject.set(x, "onFilterValueChange", js.Any.fromFunction1((t0: /* e */ ListBoxFilterValueChangeParams) => value(t0).runNow()))
