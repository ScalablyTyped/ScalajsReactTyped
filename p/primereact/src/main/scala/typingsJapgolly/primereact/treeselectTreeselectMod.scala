...
object treeselectTreeselectMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.comma
    - typingsJapgolly.primereact.primereactStrings.chip
  */
  trait TreeSelectDisplayType extends StObject
  object TreeSelectDisplayType {
    
    inline def chip: typingsJapgolly.primereact.primereactStrings.chip = "chip".asInstanceOf[typingsJapgolly.primereact.primereactStrings.chip]
    
    inline def comma: typingsJapgolly.primereact.primereactStrings.comma = "comma".asInstanceOf[typingsJapgolly.primereact.primereactStrings.comma]
  }
  ...
  object TreeSelectExpandedParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[Element], value: TreeSelectExpandedKeysType): TreeSelectExpandedParams = {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.lenient
    - typingsJapgolly.primereact.primereactStrings.strict
  */
  trait TreeSelectFilterModeType extends StObject
  object TreeSelectFilterModeType {
    
    inline def lenient: typingsJapgolly.primereact.primereactStrings.lenient = "lenient".asInstanceOf[typingsJapgolly.primereact.primereactStrings.lenient]
    
    inline def strict: typingsJapgolly.primereact.primereactStrings.strict = "strict".asInstanceOf[typingsJapgolly.primereact.primereactStrings.strict]
  }
  ...
  type TreeSelectFilterTemplateType = Node | (js.Function1[/* options */ TreeSelectFilterOptions, Node])
  ...
  object TreeSelectFilterValueChangeParams {
    ...
    inline def apply(originalEvent: ReactEventFrom[HTMLInputElement], value: String): TreeSelectFilterValueChangeParams = {
      val __obj = js.Dynamic.literal(originalEvent = originalEvent.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
  ...
  type TreeSelectPanelFooterTemplateType = Node | (js.Function1[/* props */ TreeSelectProps, Node])
  
  trait TreeSelectPanelHeaderTemplateOptions extends StObject {
    
    var className: String
    
    var closeElement: typingsJapgolly.react.mod.global.JSX.Element
    
    var closeElementClassName: String
    
    var closeIconClassName: String
    
    var element: typingsJapgolly.react.mod.global.JSX.Element
    
    var filterElement: typingsJapgolly.react.mod.global.JSX.Element
  ...
  object TreeSelectPanelHeaderTemplateOptions {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], closeElement = closeElement.rawElement.asInstanceOf[js.Any], closeElementClassName = closeElementClassName.asInstanceOf[js.Any], closeIconClassName = closeIconClassName.asInstanceOf[js.Any], element = element.rawElement.asInstanceOf[js.Any], filterElement = filterElement.rawElement.asInstanceOf[js.Any], onCloseClick = onCloseClick.toJsFn, props = props.asInstanceOf[js.Any])
    ...
    extension [Self <: TreeSelectPanelHeaderTemplateOptions](x: Self) {
      ...
      inline def setCloseElement(value: VdomElement): Self = StObject.set(x, "closeElement", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnCloseClick(value: Callback): Self = StObject.set(x, "onCloseClick", value.toJsFn)
      
      inline def setProps(value: TreeSelectProps): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
    }
  }
  
  type TreeSelectPanelHeaderTemplateType = Node | (js.Function1[/* options */ TreeSelectPanelHeaderTemplateOptions, Node])
  ...
  object TreeSelectProps {
    ...
    extension [Self <: TreeSelectProps](x: Self) {
      ...
      inline def setFilterTemplateFunction1(value: /* options */ TreeSelectFilterOptions => Node): Self = StObject.set(x, "filterTemplate", js.Any.fromFunction1(value))
      ...
      inline def setFilterTemplateVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "filterTemplate", js.Array(value*))
      ...
      inline def setOnChange(value: /* e */ TreeSelectChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ TreeSelectChangeParams) => value(t0).runNow()))
      ...
      inline def setOnFilterValueChange(value: /* e */ TreeSelectFilterValueChangeParams => Callback): Self = StObject.set(x, "onFilterValueChange", js.Any.fromFunction1((t0: /* e */ TreeSelectFilterValueChangeParams) => value(t0).runNow()))
      ...
      inline def setOnNodeCollapse(value: /* e */ TreeSelectEventNodeParams => Callback): Self = StObject.set(x, "onNodeCollapse", js.Any.fromFunction1((t0: /* e */ TreeSelectEventNodeParams) => value(t0).runNow()))
      
      inline def setOnNodeCollapseUndefined: Self = StObject.set(x, "onNodeCollapse", js.undefined)
      
      inline def setOnNodeExpand(value: /* e */ TreeSelectEventNodeParams => Callback): Self = StObject.set(x, "onNodeExpand", js.Any.fromFunction1((t0: /* e */ TreeSelectEventNodeParams) => value(t0).runNow()))
      
      inline def setOnNodeExpandUndefined: Self = StObject.set(x, "onNodeExpand", js.undefined)
      
      inline def setOnNodeSelect(value: /* e */ TreeSelectEventNodeParams => Callback): Self = StObject.set(x, "onNodeSelect", js.Any.fromFunction1((t0: /* e */ TreeSelectEventNodeParams) => value(t0).runNow()))
      
      inline def setOnNodeSelectUndefined: Self = StObject.set(x, "onNodeSelect", js.undefined)
      
      inline def setOnNodeUnselect(value: /* e */ TreeSelectEventNodeParams => Callback): Self = StObject.set(x, "onNodeUnselect", js.Any.fromFunction1((t0: /* e */ TreeSelectEventNodeParams) => value(t0).runNow()))
      ...
      inline def setOnToggle(value: /* e */ TreeSelectExpandedParams => Callback): Self = StObject.set(x, "onToggle", js.Any.fromFunction1((t0: /* e */ TreeSelectExpandedParams) => value(t0).runNow()))
      ...
      inline def setPanelFooterTemplateFunction1(value: /* props */ TreeSelectProps => Node): Self = StObject.set(x, "panelFooterTemplate", js.Any.fromFunction1(value))
      
      inline def setPanelFooterTemplateNull: Self = StObject.set(x, "panelFooterTemplate", null)
      
      inline def setPanelFooterTemplateUndefined: Self = StObject.set(x, "panelFooterTemplate", js.undefined)
      
      inline def setPanelFooterTemplateVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "panelFooterTemplate", js.Array(value*))
      
      inline def setPanelFooterTemplateVdomElement(value: VdomElement): Self = StObject.set(x, "panelFooterTemplate", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setPanelHeaderTemplateFunction1(value: /* options */ TreeSelectPanelHeaderTemplateOptions => Node): Self = StObject.set(x, "panelHeaderTemplate", js.Any.fromFunction1(value))
      
      inline def setPanelHeaderTemplateNull: Self = StObject.set(x, "panelHeaderTemplate", null)
      
      inline def setPanelHeaderTemplateUndefined: Self = StObject.set(x, "panelHeaderTemplate", js.undefined)
      
      inline def setPanelHeaderTemplateVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "panelHeaderTemplate", js.Array(value*))
      
      inline def setPanelHeaderTemplateVdomElement(value: VdomElement): Self = StObject.set(x, "panelHeaderTemplate", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setValueTemplateNull: Self = StObject.set(x, "valueTemplate", null)
      
      inline def setValueTemplateUndefined: Self = StObject.set(x, "valueTemplate", js.undefined)
      
      inline def setValueTemplateVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "valueTemplate", js.Array(value*))
      
      inline def setValueTemplateVdomElement(value: VdomElement): Self = StObject.set(x, "valueTemplate", value.rawElement.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.single
    - typingsJapgolly.primereact.primereactStrings.multiple
    - typingsJapgolly.primereact.primereactStrings.checkbox
  */
  trait TreeSelectSelectionModeType extends StObject
  object TreeSelectSelectionModeType {
    
    inline def checkbox: typingsJapgolly.primereact.primereactStrings.checkbox = "checkbox".asInstanceOf[typingsJapgolly.primereact.primereactStrings.checkbox]
    
    inline def multiple: typingsJapgolly.primereact.primereactStrings.multiple = "multiple".asInstanceOf[typingsJapgolly.primereact.primereactStrings.multiple]
    
    inline def single: typingsJapgolly.primereact.primereactStrings.single = "single".asInstanceOf[typingsJapgolly.primereact.primereactStrings.single]
  }
  
  type TreeSelectValueTemplateType = Node | (js.Function2[
