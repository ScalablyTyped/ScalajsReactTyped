...
object chipChipMod {
  ...
  trait ChipProps extends StObject {
    ...
    var onRemove: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[HTMLElement], Unit]] = js.undefined
  ...
  object ChipProps {
    ...
    extension [Self <: ChipProps](x: Self) {
      ...
      inline def setOnRemove(value: /* event */ ReactMouseEventFrom[HTMLElement] => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLElement]) => value(t0).runNow()))
