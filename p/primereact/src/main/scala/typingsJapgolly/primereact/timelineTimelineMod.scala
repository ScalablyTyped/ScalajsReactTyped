...
object timelineTimelineMod {
  ...
  @JSImport("primereact/timeline/timeline", "Timeline")
  @js.native
  open class Timeline protected () extends Component[TimelineProps, Any, Any] {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.primereact.primereactStrings.alternate
  */
  trait TimelineAlignType extends StObject
  object TimelineAlignType {
    
    inline def alternate: typingsJapgolly.primereact.primereactStrings.alternate = "alternate".asInstanceOf[typingsJapgolly.primereact.primereactStrings.alternate]
  ...
  */
  ...
  object TimelineProps {
    ...
    extension [Self <: TimelineProps](x: Self) {
      ...
      inline def setContentFunction2(value: (/* item */ Any, /* index */ Double) => Node): Self = StObject.set(x, "content", js.Any.fromFunction2(value))
      ...
      inline def setMarkerFunction2(value: (/* item */ Any, /* index */ Double) => Node): Self = StObject.set(x, "marker", js.Any.fromFunction2(value))
      
      inline def setMarkerNull: Self = StObject.set(x, "marker", null)
      
      inline def setMarkerUndefined: Self = StObject.set(x, "marker", js.undefined)
      
      inline def setMarkerVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "marker", js.Array(value*))
      
      inline def setMarkerVdomElement(value: VdomElement): Self = StObject.set(x, "marker", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOppositeFunction2(value: (/* item */ Any, /* index */ Double) => Node): Self = StObject.set(x, "opposite", js.Any.fromFunction2(value))
      
      inline def setOppositeNull: Self = StObject.set(x, "opposite", null)
      
      inline def setOppositeUndefined: Self = StObject.set(x, "opposite", js.undefined)
      
      inline def setOppositeVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "opposite", js.Array(value*))
      
      inline def setOppositeVdomElement(value: VdomElement): Self = StObject.set(x, "opposite", value.rawElement.asInstanceOf[js.Any])
  ...
  type TimelineTemplateType = Node | (js.Function2[/* item */ Any, /* index */ Double, Node])
}
