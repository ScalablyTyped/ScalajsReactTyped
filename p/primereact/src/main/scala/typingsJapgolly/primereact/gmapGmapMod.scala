...
object gmapGmapMod {
  ...
  object GMapEventParams {
    ...
    inline def apply(map: Any, originalEvent: ReactEventFrom[Element], overlay: Any): GMapEventParams = {
  ...
  trait GMapProps extends StObject {
    ...
    var onMapClick: js.UndefOr[js.Function1[/* event */ ReactEventFrom[Element], Unit]] = js.undefined
    ...
    var onOverlayDrag: js.UndefOr[js.Function1[/* event */ ReactEventFrom[Element], Unit]] = js.undefined
    
    var onOverlayDragEnd: js.UndefOr[js.Function1[/* event */ ReactEventFrom[Element], Unit]] = js.undefined
    
    var onOverlayDragStart: js.UndefOr[js.Function1[/* event */ ReactEventFrom[Element], Unit]] = js.undefined
  ...
  object GMapProps {
    ...
    extension [Self <: GMapProps](x: Self) {
      ...
      inline def setOnMapClick(value: /* event */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onMapClick", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
      
      inline def setOnMapClickUndefined: Self = StObject.set(x, "onMapClick", js.undefined)
      
      inline def setOnMapDragEnd(value: Callback): Self = StObject.set(x, "onMapDragEnd", value.toJsFn)
      
      inline def setOnMapDragEndUndefined: Self = StObject.set(x, "onMapDragEnd", js.undefined)
      
      inline def setOnMapReady(value: /* map */ Any => Callback): Self = StObject.set(x, "onMapReady", js.Any.fromFunction1((t0: /* map */ Any) => value(t0).runNow()))
      ...
      inline def setOnOverlayClick(value: /* e */ GMapEventParams => Callback): Self = StObject.set(x, "onOverlayClick", js.Any.fromFunction1((t0: /* e */ GMapEventParams) => value(t0).runNow()))
      
      inline def setOnOverlayClickUndefined: Self = StObject.set(x, "onOverlayClick", js.undefined)
      
      inline def setOnOverlayDrag(value: /* event */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onOverlayDrag", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
      
      inline def setOnOverlayDragEnd(value: /* event */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onOverlayDragEnd", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
      
      inline def setOnOverlayDragEndUndefined: Self = StObject.set(x, "onOverlayDragEnd", js.undefined)
      
      inline def setOnOverlayDragStart(value: /* event */ ReactEventFrom[Element] => Callback): Self = StObject.set(x, "onOverlayDragStart", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[Element]) => value(t0).runNow()))
      ...
      inline def setOnZoomChanged(value: Callback): Self = StObject.set(x, "onZoomChanged", value.toJsFn)
