...
object cardCardMod {
  ...
  @JSImport("primereact/card/card", "Card")
  @js.native
  ...
  object CardProps {
    ...
    extension [Self <: CardProps](x: Self) {
      ...
      inline def setFooterFunction1(value: /* props */ CardProps => Node): Self = StObject.set(x, "footer", js.Any.fromFunction1(value))
      ...
      inline def setHeaderFunction1(value: /* props */ CardProps => Node): Self = StObject.set(x, "header", js.Any.fromFunction1(value))
      ...
      inline def setSubTitleFunction1(value: /* props */ CardProps => Node): Self = StObject.set(x, "subTitle", js.Any.fromFunction1(value))
      ...
      inline def setTitleFunction1(value: /* props */ CardProps => Node): Self = StObject.set(x, "title", js.Any.fromFunction1(value))
  ...
  type CardTemplateTypes = Node | (js.Function1[/* props */ CardProps, Node])
}
