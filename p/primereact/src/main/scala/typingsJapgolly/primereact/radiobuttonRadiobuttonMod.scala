...
object radiobuttonRadiobuttonMod {
  ...
  @JSImport("primereact/radiobutton/radiobutton", "RadioButton")
  @js.native
  open class RadioButton protected () extends Component[RadioButtonProps, Any, Any] {
    ...
    def select(e: ReactEventFrom[Element]): Unit = js.native
  }
  
  trait RadioButtonChangeParams extends StObject {
    ...
    var target: RadioButtonChangeTargetOptions
    
    var value: Any
  }
  object RadioButtonChangeParams {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(checked = checked.asInstanceOf[js.Any], originalEvent = originalEvent.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, stopPropagation = stopPropagation.toJsFn, target = target.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    ...
    extension [Self <: RadioButtonChangeParams](x: Self) {
      ...
      inline def setTarget(value: RadioButtonChangeTargetOptions): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
      
      inline def setValue(value: Any): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
    }
  }
  
  trait RadioButtonChangeTargetOptions extends StObject {
  ...
  object RadioButtonChangeTargetOptions {
    
    inline def apply(checked: Boolean, id: String, name: String, `type`: String, value: Any): RadioButtonChangeTargetOptions = {
  ...
  trait RadioButtonProps extends StObject {
    ...
    var onChange: js.UndefOr[js.Function1[/* e */ RadioButtonChangeParams, Unit]] = js.undefined
  ...
  object RadioButtonProps {
    ...
    extension [Self <: RadioButtonProps](x: Self) {
      ...
      inline def setOnChange(value: /* e */ RadioButtonChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ RadioButtonChangeParams) => value(t0).runNow()))
