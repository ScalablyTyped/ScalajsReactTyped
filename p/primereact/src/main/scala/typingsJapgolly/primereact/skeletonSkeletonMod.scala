...
object skeletonSkeletonMod {
  ...
  @JSImport("primereact/skeleton/skeleton", "Skeleton")
  @js.native
  open class Skeleton protected () extends Component[SkeletonProps, Any, Any] {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.wave
    - typingsJapgolly.primereact.primereactStrings.none
  */
  trait SkeletonAnimationType extends StObject
  object SkeletonAnimationType {
    
    inline def none: typingsJapgolly.primereact.primereactStrings.none = "none".asInstanceOf[typingsJapgolly.primereact.primereactStrings.none]
    
    inline def wave: typingsJapgolly.primereact.primereactStrings.wave = "wave".asInstanceOf[typingsJapgolly.primereact.primereactStrings.wave]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.rectangle
  ...
  */
  ...
  object SkeletonShapeType {
    ...
    inline def rectangle: typingsJapgolly.primereact.primereactStrings.rectangle = "rectangle".asInstanceOf[typingsJapgolly.primereact.primereactStrings.rectangle]
  }
}
