...
object accordionAccordionMod {
  ...
  object AccordionEventParams {
    ...
    inline def apply(index: Double, originalEvent: ReactMouseEventFrom[HTMLElement]): AccordionEventParams = {
  ...
  object AccordionProps {
    ...
    extension [Self <: AccordionProps](x: Self) {
      ...
      inline def setOnTabChange(value: /* e */ AccordionEventParams => Callback): Self = StObject.set(x, "onTabChange", js.Any.fromFunction1((t0: /* e */ AccordionEventParams) => value(t0).runNow()))
      
      inline def setOnTabChangeUndefined: Self = StObject.set(x, "onTabChange", js.undefined)
      
      inline def setOnTabClose(value: /* e */ AccordionEventParams => Callback): Self = StObject.set(x, "onTabClose", js.Any.fromFunction1((t0: /* e */ AccordionEventParams) => value(t0).runNow()))
      
      inline def setOnTabCloseUndefined: Self = StObject.set(x, "onTabClose", js.undefined)
      
      inline def setOnTabOpen(value: /* e */ AccordionEventParams => Callback): Self = StObject.set(x, "onTabOpen", js.Any.fromFunction1((t0: /* e */ AccordionEventParams) => value(t0).runNow()))
  ...
  type AccordionTabHeaderTemplateType = Node | (js.Function1[/* props */ AccordionTabProps, Node])
  ...
  object AccordionTabProps {
    ...
    extension [Self <: AccordionTabProps](x: Self) {
      ...
      inline def setHeaderTemplateFunction1(value: /* props */ AccordionTabProps => Node): Self = StObject.set(x, "headerTemplate", js.Any.fromFunction1(value))
