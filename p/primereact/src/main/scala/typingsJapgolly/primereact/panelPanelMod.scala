...
object panelPanelMod {
  ...
  trait PanelHeaderTemplateOptions extends StObject {
    ...
    def onTogglerClick(event: ReactMouseEventFrom[HTMLElement]): Unit
  ...
  object PanelHeaderTemplateOptions {
    ...
    inline def apply(
      ...
      iconsElement: VdomElement,
      onTogglerClick: ReactMouseEventFrom[HTMLElement] => Callback,
      props: PanelProps,
      titleClassName: String,
      titleElement: VdomElement,
      togglerClassName: String,
      togglerElement: VdomElement,
      togglerIconClassName: String
    ): PanelHeaderTemplateOptions = {
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], collapsed = collapsed.asInstanceOf[js.Any], element = element.rawElement.asInstanceOf[js.Any], iconsClassName = iconsClassName.asInstanceOf[js.Any], iconsElement = iconsElement.rawElement.asInstanceOf[js.Any], onTogglerClick = js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLElement]) => onTogglerClick(t0).runNow()), props = props.asInstanceOf[js.Any], titleClassName = titleClassName.asInstanceOf[js.Any], titleElement = titleElement.rawElement.asInstanceOf[js.Any], togglerClassName = togglerClassName.asInstanceOf[js.Any], togglerElement = togglerElement.rawElement.asInstanceOf[js.Any], togglerIconClassName = togglerIconClassName.asInstanceOf[js.Any])
    ...
    extension [Self <: PanelHeaderTemplateOptions](x: Self) {
      ...
      inline def setIconsElement(value: VdomElement): Self = StObject.set(x, "iconsElement", value.rawElement.asInstanceOf[js.Any])
      
      inline def setOnTogglerClick(value: ReactMouseEventFrom[HTMLElement] => Callback): Self = StObject.set(x, "onTogglerClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLElement]) => value(t0).runNow()))
      ...
      inline def setTogglerElement(value: VdomElement): Self = StObject.set(x, "togglerElement", value.rawElement.asInstanceOf[js.Any])
      
      inline def setTogglerIconClassName(value: String): Self = StObject.set(x, "togglerIconClassName", value.asInstanceOf[js.Any])
    }
  }
  
  type PanelHeaderTemplateType = Node | (js.Function1[/* options */ PanelHeaderTemplateOptions, Node])
  
  type PanelIconsTemplateType = Node | (js.Function1[/* props */ PanelProps, Node])
  ...
  trait PanelProps extends StObject {
    ...
    var onCollapse: js.UndefOr[js.Function1[/* event */ ReactEventFrom[org.scalajs.dom.Element], Unit]] = js.undefined
    ...
    var onExpand: js.UndefOr[js.Function1[/* event */ ReactEventFrom[org.scalajs.dom.Element], Unit]] = js.undefined
  ...
  object PanelProps {
    ...
    extension [Self <: PanelProps](x: Self) {
      ...
      inline def setHeaderTemplateFunction1(value: /* options */ PanelHeaderTemplateOptions => Node): Self = StObject.set(x, "headerTemplate", js.Any.fromFunction1(value))
      ...
      inline def setIconsFunction1(value: /* props */ PanelProps => Node): Self = StObject.set(x, "icons", js.Any.fromFunction1(value))
      ...
      inline def setOnCollapse(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onCollapse", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setOnExpand(value: /* event */ ReactEventFrom[org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onExpand", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setOnToggle(value: /* e */ PanelToggleParams => Callback): Self = StObject.set(x, "onToggle", js.Any.fromFunction1((t0: /* e */ PanelToggleParams) => value(t0).runNow()))
  ...
  object PanelToggleParams {
    ...
    inline def apply(originalEvent: ReactMouseEventFrom[HTMLElement], value: Boolean): PanelToggleParams = {
