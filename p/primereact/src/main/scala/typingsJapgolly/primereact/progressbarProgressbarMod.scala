...
object progressbarProgressbarMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.determinate
    - typingsJapgolly.primereact.primereactStrings.indeterminate
  */
  trait ProgressBarModeType extends StObject
  object ProgressBarModeType {
    
    inline def determinate: typingsJapgolly.primereact.primereactStrings.determinate = "determinate".asInstanceOf[typingsJapgolly.primereact.primereactStrings.determinate]
    
    inline def indeterminate: typingsJapgolly.primereact.primereactStrings.indeterminate = "indeterminate".asInstanceOf[typingsJapgolly.primereact.primereactStrings.indeterminate]
  }
  ...
  trait ProgressBarProps extends StObject {
    ...
    var displayValueTemplate: js.UndefOr[js.Function1[/* value */ ProgressBarValueType, Node]] = js.undefined
  ...
  object ProgressBarProps {
    ...
    extension [Self <: ProgressBarProps](x: Self) {
      ...
      inline def setDisplayValueTemplate(value: /* value */ ProgressBarValueType => Node): Self = StObject.set(x, "displayValueTemplate", js.Any.fromFunction1(value))
