...
object stepsStepsMod {
  
  @JSImport("primereact/steps/steps", "Steps")
  @js.native
  open class Steps protected () extends Component[StepsProps, Any, Any] {
  ...
  /* Inlined parent std.Omit<react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLDivElement>, std.HTMLDivElement>, 'onSelect' | 'ref'> */
  ...
  object StepsProps {
    ...
    extension [Self <: StepsProps](x: Self) {
      ...
      inline def setOnSelect(value: /* e */ StepsSelectParams => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction1((t0: /* e */ StepsSelectParams) => value(t0).runNow()))
  ...
  object StepsSelectParams {
    ...
    inline def apply(
      ...
      originalEvent: ReactEventFrom[org.scalajs.dom.Element]
    ): StepsSelectParams = {
