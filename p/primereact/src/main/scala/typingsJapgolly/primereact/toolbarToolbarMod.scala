...
object toolbarToolbarMod {
  ...
  object ToolbarProps {
    ...
    extension [Self <: ToolbarProps](x: Self) {
      ...
      inline def setLeftFunction1(value: /* props */ ToolbarProps => Node): Self = StObject.set(x, "left", js.Any.fromFunction1(value))
      ...
      inline def setRightFunction1(value: /* props */ ToolbarProps => Node): Self = StObject.set(x, "right", js.Any.fromFunction1(value))
  ...
  type ToolbarTemplateType = Node | (js.Function1[/* props */ ToolbarProps, Node])
}
