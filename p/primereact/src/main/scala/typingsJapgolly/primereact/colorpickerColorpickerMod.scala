...
object colorpickerColorpickerMod {
  ...
  @JSImport("primereact/colorpicker/colorpicker", "ColorPicker")
  @js.native
  open class ColorPicker protected () extends Component[ColorPickerProps, Any, Any] {
  ...
  object ColorPickerChangeParams {
    ...
    inline def apply(preventDefault: Callback, stopPropagation: Callback, target: ColorPickerChangeTargetOptions): ColorPickerChangeParams = {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.primereact.primereactStrings.hex
    - typingsJapgolly.primereact.primereactStrings.rgb
    - typingsJapgolly.primereact.primereactStrings.hsb
  */
  trait ColorPickerFormatType extends StObject
  object ColorPickerFormatType {
    
    inline def hex: typingsJapgolly.primereact.primereactStrings.hex = "hex".asInstanceOf[typingsJapgolly.primereact.primereactStrings.hex]
    
    inline def hsb: typingsJapgolly.primereact.primereactStrings.hsb = "hsb".asInstanceOf[typingsJapgolly.primereact.primereactStrings.hsb]
    
    inline def rgb: typingsJapgolly.primereact.primereactStrings.rgb = "rgb".asInstanceOf[typingsJapgolly.primereact.primereactStrings.rgb]
  }
  ...
  object ColorPickerHSBType {
    ...
    inline def apply(b: Double, h: Double, s: Double): ColorPickerHSBType = {
  ...
  /* Inlined parent std.Omit<react.react.DetailedHTMLProps<react.react.InputHTMLAttributes<std.HTMLInputElement>, std.HTMLInputElement>, 'onChange' | 'value' | 'ref'> */
  ...
  object ColorPickerProps {
    ...
    inline def apply(): ColorPickerProps = {
    ...
    extension [Self <: ColorPickerProps](x: Self) {
      ...
      inline def setOnChange(value: /* e */ ColorPickerChangeParams => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ ColorPickerChangeParams) => value(t0).runNow()))
  ...
  object ColorPickerRGBType {
    ...
    inline def apply(b: Double, g: Double, r: Double): ColorPickerRGBType = {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.primereact.colorpickerColorpickerMod.ColorPickerRGBType
    - typingsJapgolly.primereact.colorpickerColorpickerMod.ColorPickerHSBType
    - scala.Unit
  */
  ...
  object _ColorPickerValueType {
    ...
    inline def ColorPickerHSBType(b: Double, h: Double, s: Double): typingsJapgolly.primereact.colorpickerColorpickerMod.ColorPickerHSBType = {
      val __obj = js.Dynamic.literal(b = b.asInstanceOf[js.Any], h = h.asInstanceOf[js.Any], s = s.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.primereact.colorpickerColorpickerMod.ColorPickerHSBType]
    }
    
    inline def ColorPickerRGBType(b: Double, g: Double, r: Double): typingsJapgolly.primereact.colorpickerColorpickerMod.ColorPickerRGBType = {
      val __obj = js.Dynamic.literal(b = b.asInstanceOf[js.Any], g = g.asInstanceOf[js.Any], r = r.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.primereact.colorpickerColorpickerMod.ColorPickerRGBType]
    }
  }
}
