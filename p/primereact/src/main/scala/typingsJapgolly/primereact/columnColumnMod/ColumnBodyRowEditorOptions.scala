...
object ColumnBodyRowEditorOptions {
  ...
  extension [Self <: ColumnBodyRowEditorOptions](x: Self) {
    ...
    inline def setOnCancelClick(value: /* e */ Any => Callback): Self = StObject.set(x, "onCancelClick", js.Any.fromFunction1((t0: /* e */ Any) => value(t0).runNow()))
    
    inline def setOnCancelClickUndefined: Self = StObject.set(x, "onCancelClick", js.undefined)
    
    inline def setOnInitClick(value: /* e */ Any => Callback): Self = StObject.set(x, "onInitClick", js.Any.fromFunction1((t0: /* e */ Any) => value(t0).runNow()))
    
    inline def setOnInitClickUndefined: Self = StObject.set(x, "onInitClick", js.undefined)
    
    inline def setOnSaveClick(value: /* e */ Any => Callback): Self = StObject.set(x, "onSaveClick", js.Any.fromFunction1((t0: /* e */ Any) => value(t0).runNow()))
