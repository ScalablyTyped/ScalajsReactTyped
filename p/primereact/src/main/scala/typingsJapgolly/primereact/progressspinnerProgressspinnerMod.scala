...
object progressspinnerProgressspinnerMod {
  
  @JSImport("primereact/progressspinner/progressspinner", "ProgressSpinner")
  @js.native
  open class ProgressSpinner protected () extends Component[ProgressSpinnerProps, Any, Any] {
    def this(props: ProgressSpinnerProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: ProgressSpinnerProps, context: Any) = this()
