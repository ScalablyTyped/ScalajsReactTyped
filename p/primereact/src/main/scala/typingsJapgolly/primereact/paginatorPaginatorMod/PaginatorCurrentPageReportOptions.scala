...
object PaginatorCurrentPageReportOptions {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], currentPage = currentPage.asInstanceOf[js.Any], element = element.rawElement.asInstanceOf[js.Any], first = first.asInstanceOf[js.Any], last = last.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any], rows = rows.asInstanceOf[js.Any], totalPages = totalPages.asInstanceOf[js.Any], totalRecords = totalRecords.asInstanceOf[js.Any])
