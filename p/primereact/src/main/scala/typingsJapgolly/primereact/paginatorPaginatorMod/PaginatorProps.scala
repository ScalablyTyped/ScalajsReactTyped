...
object PaginatorProps {
  ...
  extension [Self <: PaginatorProps](x: Self) {
    ...
    inline def setLeftContent(value: VdomNode): Self = StObject.set(x, "leftContent", value.rawNode.asInstanceOf[js.Any])
    
    inline def setLeftContentNull: Self = StObject.set(x, "leftContent", null)
    
    inline def setLeftContentUndefined: Self = StObject.set(x, "leftContent", js.undefined)
    
    inline def setLeftContentVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "leftContent", js.Array(value*))
    
    inline def setLeftContentVdomElement(value: VdomElement): Self = StObject.set(x, "leftContent", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def setOnPageChange(value: /* event */ PaginatorPageState => Callback): Self = StObject.set(x, "onPageChange", js.Any.fromFunction1((t0: /* event */ PaginatorPageState) => value(t0).runNow()))
    ...
    inline def setRightContent(value: VdomNode): Self = StObject.set(x, "rightContent", value.rawNode.asInstanceOf[js.Any])
    
    inline def setRightContentNull: Self = StObject.set(x, "rightContent", null)
    
    inline def setRightContentUndefined: Self = StObject.set(x, "rightContent", js.undefined)
    
    inline def setRightContentVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "rightContent", js.Array(value*))
    
    inline def setRightContentVdomElement(value: VdomElement): Self = StObject.set(x, "rightContent", value.rawElement.asInstanceOf[js.Any])
