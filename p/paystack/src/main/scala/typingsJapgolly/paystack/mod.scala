...
import typingsJapgolly.paystack.anon.Charge
import typingsJapgolly.paystack.anon.Create
import typingsJapgolly.paystack.anon.Disable
import typingsJapgolly.paystack.anon.Get
import typingsJapgolly.paystack.anon.Listbanks
import typingsJapgolly.paystack.anon.Update
...
object mod {
  ...
  trait Object extends StObject {
    ...
    var plan: typingsJapgolly.paystack.anon.List
  ...
  object Object {
    ...
    inline def apply(
      ...
      misc: Listbanks,
      page: Get,
      plan: typingsJapgolly.paystack.anon.List,
      subaccount: Update,
    ...
    extension [Self <: Object](x: Self) {
      ...
      inline def setPlan(value: typingsJapgolly.paystack.anon.List): Self = StObject.set(x, "plan", value.asInstanceOf[js.Any])
