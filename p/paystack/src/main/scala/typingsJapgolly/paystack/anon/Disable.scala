...
object Disable {
  ...
  inline def apply(
    ...
    list: CallbackTo[js.Promise[ResponsedataArrayanymetaa]]
  ): Disable = {
    val __obj = js.Dynamic.literal(create = js.Any.fromFunction1(create), disable = js.Any.fromFunction1(disable), enable = js.Any.fromFunction1(enable), get = js.Any.fromFunction1(get), list = list.toJsFn)
  ...
  extension [Self <: Disable](x: Self) {
    ...
    inline def setList(value: CallbackTo[js.Promise[ResponsedataArrayanymetaa]]): Self = StObject.set(x, "list", value.toJsFn)
  }
}
