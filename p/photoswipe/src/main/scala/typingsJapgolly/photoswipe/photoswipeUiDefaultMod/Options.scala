...
import typingsJapgolly.photoswipe.AnonBottom
...
trait Options
  extends typingsJapgolly.photoswipe.mod.Options {
  /**
...
object Options {
  @scala.inline
  def apply(
    addCaptionHTMLFn: (/* item */ Item, /* captionEl */ HTMLElement, /* isFake */ Boolean) => CallbackTo[Boolean] = null,
    ...
    getDoubleTapZoom: (/* isMouseClick */ Boolean, /* item */ typingsJapgolly.photoswipe.mod.Item) => CallbackTo[Double] = null,
    getImageURLForShare: /* shareButtonData */ ShareButtonData => CallbackTo[String] = null,
    getNumItemsFn: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getPageURLForShare: /* shareButtonData */ ShareButtonData => CallbackTo[String] = null,
    getTextForShare: /* shareButtonData */ ShareButtonData => CallbackTo[String] = null,
    ...
    parseShareButtonOut: (/* shareButtonData */ ShareButtonData, /* shareButtonOut */ String) => CallbackTo[String] = null,
    ...
    if (addCaptionHTMLFn != null) __obj.updateDynamic("addCaptionHTMLFn")(js.Any.fromFunction3((t0: /* item */ typingsJapgolly.photoswipe.photoswipeUiDefaultMod.Item, t1: /* captionEl */ org.scalajs.dom.raw.HTMLElement, t2: /* isFake */ scala.Boolean) => addCaptionHTMLFn(t0, t1, t2).runNow()))
    ...
    if (getImageURLForShare != null) __obj.updateDynamic("getImageURLForShare")(js.Any.fromFunction1((t0: /* shareButtonData */ typingsJapgolly.photoswipe.photoswipeUiDefaultMod.ShareButtonData) => getImageURLForShare(t0).runNow()))
    getNumItemsFn.foreach(p => __obj.updateDynamic("getNumItemsFn")(p.toJsFn))
    if (getPageURLForShare != null) __obj.updateDynamic("getPageURLForShare")(js.Any.fromFunction1((t0: /* shareButtonData */ typingsJapgolly.photoswipe.photoswipeUiDefaultMod.ShareButtonData) => getPageURLForShare(t0).runNow()))
    if (getTextForShare != null) __obj.updateDynamic("getTextForShare")(js.Any.fromFunction1((t0: /* shareButtonData */ typingsJapgolly.photoswipe.photoswipeUiDefaultMod.ShareButtonData) => getTextForShare(t0).runNow()))
    ...
    if (parseShareButtonOut != null) __obj.updateDynamic("parseShareButtonOut")(js.Any.fromFunction2((t0: /* shareButtonData */ typingsJapgolly.photoswipe.photoswipeUiDefaultMod.ShareButtonData, t1: /* shareButtonOut */ java.lang.String) => parseShareButtonOut(t0, t1).runNow()))
