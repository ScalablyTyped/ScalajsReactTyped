...
object automationProjectSettingsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.nodejs
    - typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.go
    - typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.python
    - typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.dotnet
  */
  trait ProjectRuntime extends StObject
  object ProjectRuntime {
    
    inline def dotnet: typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.dotnet = "dotnet".asInstanceOf[typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.dotnet]
    
    inline def go: typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.go = "go".asInstanceOf[typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.go]
    
    inline def nodejs: typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.nodejs = "nodejs".asInstanceOf[typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.nodejs]
    
    inline def python: typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.python = "python".asInstanceOf[typingsJapgolly.pulumiPulumi.pulumiPulumiStrings.python]
  }
