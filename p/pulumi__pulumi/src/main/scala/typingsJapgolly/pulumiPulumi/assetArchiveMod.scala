...
import typingsJapgolly.pulumiPulumi.assetAssetMod.Asset
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object assetArchiveMod {
  
  /* note: abstract class */ @JSImport("@pulumi/pulumi/asset/archive", "Archive")
  @js.native
  ...
  @js.native
  open class AssetArchive protected () extends Archive {
  ...
  @js.native
  open class FileArchive protected () extends Archive {
  ...
  @js.native
  open class RemoteArchive protected () extends Archive {
