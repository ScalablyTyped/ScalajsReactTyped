...
object resourceMod {
  ...
  @js.native
  open class ComponentResource[TData] protected () extends Resource {
    /**
  ...
  /* note: abstract class */ @JSImport("@pulumi/pulumi/resource", "CustomResource")
  @js.native
  open class CustomResource protected () extends Resource {
    /**
  ...
  @js.native
  open class DependencyProviderResource protected () extends ProviderResource {
    def this(ref: String) = this()
  }
  
  @JSImport("@pulumi/pulumi/resource", "DependencyResource")
  @js.native
  open class DependencyResource protected () extends CustomResource {
    def this(urn: URN) = this()
  }
  
  /* note: abstract class */ @JSImport("@pulumi/pulumi/resource", "ProviderResource")
  @js.native
  open class ProviderResource protected () extends CustomResource {
    /**
  ...
  /* note: abstract class */ @JSImport("@pulumi/pulumi/resource", "Resource")
  @js.native
  ...
  inline def allAliases(
    childAliases: js.Array[Input[URN | Alias]],
    childName: String,
    childType: String,
    parent: Resource,
    parentName: String
  ): js.Array[Output_[URN]] = (^.asInstanceOf[js.Dynamic].applyDynamic("allAliases")(childAliases.asInstanceOf[js.Any], childName.asInstanceOf[js.Any], childType.asInstanceOf[js.Any], parent.asInstanceOf[js.Any], parentName.asInstanceOf[js.Any])).asInstanceOf[js.Array[Output_[URN]]]
  ...
  object ComponentResourceOptions {
    ...
    extension [Self <: ComponentResourceOptions](x: Self) {
      ...
      inline def setProvidersVarargs(value: ProviderResource*): Self = StObject.set(x, "providers", js.Array(value*))
    }
  }
  ...
  object CustomResourceOptions {
    ...
    extension [Self <: CustomResourceOptions](x: Self) {
      ...
      inline def setAdditionalSecretOutputsVarargs(value: String*): Self = StObject.set(x, "additionalSecretOutputs", js.Array(value*))
  ...
  trait ResourceOptions extends StObject {
    ...
    /**
      ...
      */
    var pluginDownloadURL: js.UndefOr[String] = js.undefined
    ...
    /**
      ...
      */
    var replaceOnChanges: js.UndefOr[js.Array[String]] = js.undefined
    
    /**
      * If set to True, the providers Delete method will not be called for this resource.
      */
    var retainOnDelete: js.UndefOr[Boolean] = js.undefined
    ...
    /**
      ...
      */
    var urn: js.UndefOr[URN] = js.undefined
  ...
  object ResourceOptions {
    ...
    extension [Self <: ResourceOptions](x: Self) {
      ...
      inline def setAliasesVarargs(value: (Input[URN | Alias])*): Self = StObject.set(x, "aliases", js.Array(value*))
      ...
      inline def setDependsOnVarargs(value: Input[Resource]*): Self = StObject.set(x, "dependsOn", js.Array(value*))
      ...
      inline def setPluginDownloadURL(value: String): Self = StObject.set(x, "pluginDownloadURL", value.asInstanceOf[js.Any])
      
      inline def setPluginDownloadURLUndefined: Self = StObject.set(x, "pluginDownloadURL", js.undefined)
      ...
      inline def setReplaceOnChanges(value: js.Array[String]): Self = StObject.set(x, "replaceOnChanges", value.asInstanceOf[js.Any])
      
      inline def setReplaceOnChangesUndefined: Self = StObject.set(x, "replaceOnChanges", js.undefined)
      
      inline def setReplaceOnChangesVarargs(value: String*): Self = StObject.set(x, "replaceOnChanges", js.Array(value*))
      
      inline def setRetainOnDelete(value: Boolean): Self = StObject.set(x, "retainOnDelete", value.asInstanceOf[js.Any])
      ...
      inline def setTransformationsVarargs(value: ResourceTransformation*): Self = StObject.set(x, "transformations", js.Array(value*))
      
      inline def setUrn(value: URN): Self = StObject.set(x, "urn", value.asInstanceOf[js.Any])
