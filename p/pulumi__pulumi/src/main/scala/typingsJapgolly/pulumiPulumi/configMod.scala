...
object configMod {
  ...
  open class Config () extends StObject {
    ...
    /**
      ...
      */
    /* private */ var fullKey: Any = js.native
    ...
    /* private */ var getBooleanImpl: Any = js.native
    ...
    /**
      ...
      * @param opts An options bag to constrain legal values.
      */
    /* private */ var getImpl: Any = js.native
    ...
    /* private */ var getNumberImpl: Any = js.native
    ...
    /* private */ var getObjectImpl: Any = js.native
    ...
    /* private */ var requireBooleanImpl: Any = js.native
    
    /* private */ var requireImpl: Any = js.native
    ...
    /* private */ var requireNumberImpl: Any = js.native
    ...
    /* private */ var requireObjectImpl: Any = js.native
  ...
  object StringConfigOptions {
    ...
    extension [Self <: StringConfigOptions[?], K /* <: String */](x: Self & StringConfigOptions[K]) {
      ...
      inline def setAllowedValuesVarargs(value: K*): Self = StObject.set(x, "allowedValues", js.Array(value*))
