...
object runtime {
  ...
  open class Stack protected ()
    extends typingsJapgolly.pulumiPulumi.runtimeMod.Stack {
  ...
  inline def call[T](tok: String, props: Inputs): typingsJapgolly.pulumiPulumi.outputMod.Output_[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("call")(tok.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pulumiPulumi.outputMod.Output_[T]]
  inline def call[T](tok: String, props: Inputs, res: typingsJapgolly.pulumiPulumi.resourceMod.Resource): typingsJapgolly.pulumiPulumi.outputMod.Output_[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("call")(tok.asInstanceOf[js.Any], props.asInstanceOf[js.Any], res.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.pulumiPulumi.outputMod.Output_[T]]
  ...
  inline def getResource(
    ...
    custom: Boolean,
    urn: String
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("getResource")(res.asInstanceOf[js.Any], parent.asInstanceOf[js.Any], props.asInstanceOf[js.Any], custom.asInstanceOf[js.Any], urn.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def getResource(
    res: typingsJapgolly.pulumiPulumi.resourceMod.Resource,
  ...
  inline def listResourceOutputs[U /* <: typingsJapgolly.pulumiPulumi.resourceMod.Resource */](): AsyncQueryable[ResolvedResource[U]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listResourceOutputs")().asInstanceOf[AsyncQueryable[ResolvedResource[U]]]
  inline def listResourceOutputs[U /* <: typingsJapgolly.pulumiPulumi.resourceMod.Resource */](typeFilter: js.Function1[/* o */ Any, /* is U */ Boolean]): AsyncQueryable[ResolvedResource[U]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listResourceOutputs")(typeFilter.asInstanceOf[js.Any]).asInstanceOf[AsyncQueryable[ResolvedResource[U]]]
  inline def listResourceOutputs[U /* <: typingsJapgolly.pulumiPulumi.resourceMod.Resource */](typeFilter: js.Function1[/* o */ Any, /* is U */ Boolean], stackName: String): AsyncQueryable[ResolvedResource[U]] = (^.asInstanceOf[js.Dynamic].applyDynamic("listResourceOutputs")(typeFilter.asInstanceOf[js.Any], stackName.asInstanceOf[js.Any])).asInstanceOf[AsyncQueryable[ResolvedResource[U]]]
  inline def listResourceOutputs[U /* <: typingsJapgolly.pulumiPulumi.resourceMod.Resource */](typeFilter: Unit, stackName: String): AsyncQueryable[ResolvedResource[U]] = (^.asInstanceOf[js.Dynamic].applyDynamic("listResourceOutputs")(typeFilter.asInstanceOf[js.Any], stackName.asInstanceOf[js.Any])).asInstanceOf[AsyncQueryable[ResolvedResource[U]]]
  ...
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("readResource")(res.asInstanceOf[js.Any], parent.asInstanceOf[js.Any], t.asInstanceOf[js.Any], name.asInstanceOf[js.Any], props.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def readResource(
    res: typingsJapgolly.pulumiPulumi.resourceMod.Resource,
    parent: typingsJapgolly.pulumiPulumi.resourceMod.Resource,
    t: String,
  ...
  inline def registerResource(
    ...
    custom: Boolean,
    remote: Boolean,
    newDependency: js.Function1[/* urn */ URN, typingsJapgolly.pulumiPulumi.resourceMod.Resource],
    props: Inputs,
    opts: ResourceOptions
  ...
  inline def registerResourceOutputs(res: typingsJapgolly.pulumiPulumi.resourceMod.Resource, outputs: js.Promise[Inputs]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("registerResourceOutputs")(res.asInstanceOf[js.Any], outputs.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def registerResourceOutputs(res: typingsJapgolly.pulumiPulumi.resourceMod.Resource, outputs: Inputs): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("registerResourceOutputs")(res.asInstanceOf[js.Any], outputs.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def resolveProperties(
    ...
    resolvers: Record[
      ...
      js.Function5[
        ...
        /* isKnown */ Boolean, 
        /* isSecret */ Boolean, 
        /* deps */ js.UndefOr[js.Array[typingsJapgolly.pulumiPulumi.resourceMod.Resource]], 
    ...
    name: String,
    allProps: Any,
    deps: Record[String, js.Array[typingsJapgolly.pulumiPulumi.resourceMod.Resource]]
  ...
  ): js.Promise[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("serializeProperty")(ctx.asInstanceOf[js.Any], prop.asInstanceOf[js.Any], dependentResources.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Any]]
  inline def serializeProperty(
    ctx: String,
    prop: Input[Any],
    dependentResources: Set[typingsJapgolly.pulumiPulumi.resourceMod.Resource],
    opts: SerializationOptions
  ): js.Promise[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("serializeProperty")(ctx.asInstanceOf[js.Any], prop.asInstanceOf[js.Any], dependentResources.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Any]]
  ...
  inline def serializeResourceProperties(label: String, props: Inputs, opts: SerializationOptions): js.Promise[
    js.Tuple2[
      Record[String, Any], 
      Map[String, Set[typingsJapgolly.pulumiPulumi.resourceMod.Resource]]
    ]
  ] = (^.asInstanceOf[js.Dynamic].applyDynamic("serializeResourceProperties")(label.asInstanceOf[js.Any], props.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[
    js.Tuple2[
      Record[String, Any], 
      Map[String, Set[typingsJapgolly.pulumiPulumi.resourceMod.Resource]]
    ]
  ...
  inline def setRootResource(res: typingsJapgolly.pulumiPulumi.resourceMod.ComponentResource[Any]): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("setRootResource")(res.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  inline def transferProperties(onto: typingsJapgolly.pulumiPulumi.resourceMod.Resource, label: String, props: Inputs): OutputResolvers = (^.asInstanceOf[js.Dynamic].applyDynamic("transferProperties")(onto.asInstanceOf[js.Any], label.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[OutputResolvers]
