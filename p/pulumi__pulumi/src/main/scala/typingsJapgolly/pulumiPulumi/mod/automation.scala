...
object automation {
  ...
  @JSImport("@pulumi/pulumi", "automation")
  @js.native
  ...
  open class CommandError ()
    extends typingsJapgolly.pulumiPulumi.automationMod.CommandError
  
  @JSImport("@pulumi/pulumi", "automation.ConcurrentUpdateError")
  @js.native
  open class ConcurrentUpdateError ()
    extends typingsJapgolly.pulumiPulumi.automationMod.ConcurrentUpdateError
  ...
  /* private */ open class LocalWorkspace ()
    extends typingsJapgolly.pulumiPulumi.automationMod.LocalWorkspace
  /* static members */
  ...
  /* private */ open class Stack ()
    extends typingsJapgolly.pulumiPulumi.automationMod.Stack
  /* static members */
  object Stack {
  ...
  open class StackAlreadyExistsError ()
    extends typingsJapgolly.pulumiPulumi.automationMod.StackAlreadyExistsError
  
  @JSImport("@pulumi/pulumi", "automation.StackNotFoundError")
  @js.native
  open class StackNotFoundError ()
    extends typingsJapgolly.pulumiPulumi.automationMod.StackNotFoundError
