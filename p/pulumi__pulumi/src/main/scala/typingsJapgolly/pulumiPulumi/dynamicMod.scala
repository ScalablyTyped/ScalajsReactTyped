...
object dynamicMod {
  ...
  @js.native
  open class Resource protected () extends CustomResource {
    /**
  ...
  trait ResourceProvider extends StObject {
    ...
    /**
      ...
      */
    var check: js.UndefOr[js.Function2[/* olds */ Any, /* news */ Any, js.Promise[CheckResult]]] = js.undefined
    ...
    /**
      ...
      */
    def create(inputs: Any): js.Promise[CreateResult]
    ...
    /**
      ...
      */
    var delete: js.UndefOr[js.Function2[/* id */ ID, /* props */ Any, js.Promise[Unit]]] = js.undefined
    ...
    /**
      ...
      */
    var diff: js.UndefOr[
        js.Function3[/* id */ ID, /* olds */ Any, /* news */ Any, js.Promise[DiffResult]]
      ] = js.undefined
    ...
    /**
      ...
      */
    var read: js.UndefOr[js.Function2[/* id */ ID, /* props */ js.UndefOr[Any], js.Promise[ReadResult]]] = js.undefined
    ...
    var update: js.UndefOr[
        js.Function3[/* id */ ID, /* olds */ Any, /* news */ Any, js.Promise[UpdateResult]]
      ] = js.undefined
  }
  object ResourceProvider {
    
    inline def apply(create: Any => js.Promise[CreateResult]): ResourceProvider = {
    ...
    extension [Self <: ResourceProvider](x: Self) {
      ...
      inline def setCheck(value: (/* olds */ Any, /* news */ Any) => js.Promise[CheckResult]): Self = StObject.set(x, "check", js.Any.fromFunction2(value))
      
      inline def setCheckUndefined: Self = StObject.set(x, "check", js.undefined)
      
      inline def setCreate(value: Any => js.Promise[CreateResult]): Self = StObject.set(x, "create", js.Any.fromFunction1(value))
      
      inline def setDelete(value: (/* id */ ID, /* props */ Any) => js.Promise[Unit]): Self = StObject.set(x, "delete", js.Any.fromFunction2(value))
      
      inline def setDeleteUndefined: Self = StObject.set(x, "delete", js.undefined)
      
      inline def setDiff(value: (/* id */ ID, /* olds */ Any, /* news */ Any) => js.Promise[DiffResult]): Self = StObject.set(x, "diff", js.Any.fromFunction3(value))
      
      inline def setDiffUndefined: Self = StObject.set(x, "diff", js.undefined)
      
      inline def setRead(value: (/* id */ ID, /* props */ js.UndefOr[Any]) => js.Promise[ReadResult]): Self = StObject.set(x, "read", js.Any.fromFunction2(value))
      
      inline def setReadUndefined: Self = StObject.set(x, "read", js.undefined)
      
      inline def setUpdate(value: (/* id */ ID, /* olds */ Any, /* news */ Any) => js.Promise[UpdateResult]): Self = StObject.set(x, "update", js.Any.fromFunction3(value))
