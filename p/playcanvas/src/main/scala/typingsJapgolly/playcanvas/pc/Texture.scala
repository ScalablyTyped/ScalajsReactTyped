...
import typingsJapgolly.playcanvas.AnonFace
...
class Texture protected () extends js.Object {
  ...
  def setSource(source: js.Array[HTMLCanvasElement | typingsJapgolly.std.HTMLImageElement | HTMLVideoElement]): Unit = js.native
  def setSource(
    source: js.Array[HTMLCanvasElement | typingsJapgolly.std.HTMLImageElement | HTMLVideoElement],
    mipLevel: Double
  ): Unit = js.native
  /**
    * @function
  ...
  def setSource(source: typingsJapgolly.std.HTMLImageElement): Unit = js.native
  def setSource(source: typingsJapgolly.std.HTMLImageElement, mipLevel: Double): Unit = js.native
