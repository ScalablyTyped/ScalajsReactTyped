...
import typingsJapgolly.playcanvas.pc.callbacks.VrFrame
import typingsJapgolly.std.VRDisplay
import typingsJapgolly.std.VRDisplayCapabilities
import typingsJapgolly.std.VRFrameData
...
class VrDisplay protected () extends EventHandler {
  ...
  /**
    ...
    */
  def exitPresent(callback: typingsJapgolly.playcanvas.pc.callbacks.VrDisplay): Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def requestPresent(callback: typingsJapgolly.playcanvas.pc.callbacks.VrDisplay): Unit = js.native
  /**
    * @function
