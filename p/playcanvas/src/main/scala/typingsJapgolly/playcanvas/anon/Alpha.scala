...
import typingsJapgolly.playcanvas.playcanvasStrings.`high-performance`
import typingsJapgolly.playcanvas.playcanvasStrings.`low-power`
import typingsJapgolly.playcanvas.playcanvasStrings.default
