...
object TypeofScriptType {
  ...
  inline def apply(__getScriptName: Any, __name: Any, extend: js.Object => japgolly.scalajs.react.Callback): TypeofScriptType = {
    val __obj = js.Dynamic.literal(__getScriptName = __getScriptName.asInstanceOf[js.Any], __name = __name.asInstanceOf[js.Any], extend = js.Any.fromFunction1((t0: js.Object) => extend(t0).runNow()))
    __obj.asInstanceOf[TypeofScriptType]
  }
  
  extension [Self <: TypeofScriptType](x: Self) {
    
    inline def setExtend(value: js.Object => japgolly.scalajs.react.Callback): Self = StObject.set(x, "extend", js.Any.fromFunction1((t0: js.Object) => value(t0).runNow()))
