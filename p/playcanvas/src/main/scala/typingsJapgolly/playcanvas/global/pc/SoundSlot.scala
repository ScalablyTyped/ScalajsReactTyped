...
import typingsJapgolly.playcanvas.anon.Asset
...
open class SoundSlot protected ()
  extends typingsJapgolly.playcanvas.mod.SoundSlot {
  /**
    ...
    * played by this slot.
    */
  def this(component: typingsJapgolly.playcanvas.mod.SoundComponent) = this()
  def this(component: typingsJapgolly.playcanvas.mod.SoundComponent, name: String) = this()
  def this(component: typingsJapgolly.playcanvas.mod.SoundComponent, name: String, options: Asset) = this()
  def this(component: typingsJapgolly.playcanvas.mod.SoundComponent, name: Unit, options: Asset) = this()
}
