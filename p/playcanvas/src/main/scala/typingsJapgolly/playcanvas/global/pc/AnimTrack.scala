...
open class AnimTrack protected ()
  extends typingsJapgolly.playcanvas.mod.AnimTrack {
  /**
  ...
  def this(
    name: String,
    duration: Double,
    inputs: js.Array[typingsJapgolly.playcanvas.mod.AnimData],
    outputs: js.Array[typingsJapgolly.playcanvas.mod.AnimData],
    curves: js.Array[typingsJapgolly.playcanvas.mod.AnimCurve]
  ) = this()
  def this(
    name: String,
    duration: Double,
    ...
    outputs: js.Array[typingsJapgolly.playcanvas.mod.AnimData],
    curves: js.Array[typingsJapgolly.playcanvas.mod.AnimCurve],
    animEvents: typingsJapgolly.playcanvas.mod.AnimEvents
  ) = this()
}
