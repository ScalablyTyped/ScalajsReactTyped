...
open class ElementDragHelper protected ()
  extends typingsJapgolly.playcanvas.mod.ElementDragHelper {
  /**
    ...
    */
  def this(element: typingsJapgolly.playcanvas.mod.ElementComponent) = this()
  def this(element: typingsJapgolly.playcanvas.mod.ElementComponent, axis: String) = this()
}
