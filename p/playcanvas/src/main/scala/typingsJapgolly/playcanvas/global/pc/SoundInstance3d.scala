...
import typingsJapgolly.playcanvas.anon.DistanceModel
...
open class SoundInstance3d protected ()
  extends typingsJapgolly.playcanvas.mod.SoundInstance3d {
  /**
    ...
    */
  def this(manager: typingsJapgolly.playcanvas.mod.SoundManager, sound: typingsJapgolly.playcanvas.mod.Sound) = this()
  def this(
    manager: typingsJapgolly.playcanvas.mod.SoundManager,
    sound: typingsJapgolly.playcanvas.mod.Sound,
