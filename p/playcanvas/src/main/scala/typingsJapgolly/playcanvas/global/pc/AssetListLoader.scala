...
open class AssetListLoader protected ()
  extends typingsJapgolly.playcanvas.mod.AssetListLoader {
  /**
    ...
    * ], pc.app.assets);
    */
  def this(assetList: js.Array[Asset_ | Double], assetRegistry: typingsJapgolly.playcanvas.mod.AssetRegistry) = this()
}
