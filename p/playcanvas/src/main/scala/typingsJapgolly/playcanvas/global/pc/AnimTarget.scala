...
import typingsJapgolly.playcanvas.mod.AnimSetter
import typingsJapgolly.playcanvas.playcanvasStrings.quaternion
import typingsJapgolly.playcanvas.playcanvasStrings.vector
...
open class AnimTarget protected ()
  extends typingsJapgolly.playcanvas.mod.AnimTarget {
  /**
