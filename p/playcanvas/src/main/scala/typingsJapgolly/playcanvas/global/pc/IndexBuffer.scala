...
open class IndexBuffer protected ()
  extends typingsJapgolly.playcanvas.mod.IndexBuffer {
  /**
    ...
    *                                      indices);
    */
  def this(graphicsDevice: typingsJapgolly.playcanvas.mod.GraphicsDevice, format: Double, numIndices: Double) = this()
  def this(
