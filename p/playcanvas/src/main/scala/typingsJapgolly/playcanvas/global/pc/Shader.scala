...
import typingsJapgolly.playcanvas.anon.Attributes
...
open class Shader protected ()
  extends typingsJapgolly.playcanvas.mod.Shader {
  /**
    ...
    */
  def this(graphicsDevice: typingsJapgolly.playcanvas.mod.GraphicsDevice, definition: Attributes) = this()
}
