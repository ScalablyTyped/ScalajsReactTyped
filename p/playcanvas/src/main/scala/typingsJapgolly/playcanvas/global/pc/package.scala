...
import typingsJapgolly.playcanvas.anon.Authority
import typingsJapgolly.playcanvas.anon.BaseRadius
import typingsJapgolly.playcanvas.anon.BlendIndices
import typingsJapgolly.playcanvas.anon.CalculateTangents
import typingsJapgolly.playcanvas.anon.Call
import typingsJapgolly.playcanvas.anon.CapSegments
import typingsJapgolly.playcanvas.anon.Distribution
import typingsJapgolly.playcanvas.anon.EagerWorkers
import typingsJapgolly.playcanvas.anon.HalfExtents
import typingsJapgolly.playcanvas.anon.Height
import typingsJapgolly.playcanvas.anon.IsGGGR
import typingsJapgolly.playcanvas.anon.LatitudeBands
import typingsJapgolly.playcanvas.anon.RingRadius
import typingsJapgolly.playcanvas.anon.TypeofScriptType
import typingsJapgolly.playcanvas.global.pc.^
import typingsJapgolly.playcanvas.mod.AppBase
import typingsJapgolly.playcanvas.mod.Http_
import typingsJapgolly.playcanvas.mod.ScriptType
import typingsJapgolly.playcanvas.mod.Texture
import typingsJapgolly.playcanvas.mod.Vec4
import typingsJapgolly.playcanvas.playcanvasInts.`0`
import typingsJapgolly.playcanvas.playcanvasInts.`1024`
import typingsJapgolly.playcanvas.playcanvasInts.`10`
import typingsJapgolly.playcanvas.playcanvasInts.`11`
import typingsJapgolly.playcanvas.playcanvasInts.`128`
import typingsJapgolly.playcanvas.playcanvasInts.`12`
import typingsJapgolly.playcanvas.playcanvasInts.`13`
import typingsJapgolly.playcanvas.playcanvasInts.`14`
import typingsJapgolly.playcanvas.playcanvasInts.`15`
import typingsJapgolly.playcanvas.playcanvasInts.`16384`
import typingsJapgolly.playcanvas.playcanvasInts.`16`
import typingsJapgolly.playcanvas.playcanvasInts.`17`
import typingsJapgolly.playcanvas.playcanvasInts.`18`
import typingsJapgolly.playcanvas.playcanvasInts.`19`
import typingsJapgolly.playcanvas.playcanvasInts.`1`
import typingsJapgolly.playcanvas.playcanvasInts.`2048`
import typingsJapgolly.playcanvas.playcanvasInts.`20`
import typingsJapgolly.playcanvas.playcanvasInts.`21`
import typingsJapgolly.playcanvas.playcanvasInts.`22`
import typingsJapgolly.playcanvas.playcanvasInts.`23`
import typingsJapgolly.playcanvas.playcanvasInts.`256`
import typingsJapgolly.playcanvas.playcanvasInts.`2`
import typingsJapgolly.playcanvas.playcanvasInts.`32`
import typingsJapgolly.playcanvas.playcanvasInts.`3`
import typingsJapgolly.playcanvas.playcanvasInts.`4096`
import typingsJapgolly.playcanvas.playcanvasInts.`4`
import typingsJapgolly.playcanvas.playcanvasInts.`512`
import typingsJapgolly.playcanvas.playcanvasInts.`5`
import typingsJapgolly.playcanvas.playcanvasInts.`64`
import typingsJapgolly.playcanvas.playcanvasInts.`65535`
import typingsJapgolly.playcanvas.playcanvasInts.`6`
import typingsJapgolly.playcanvas.playcanvasInts.`7`
import typingsJapgolly.playcanvas.playcanvasInts.`8192`
import typingsJapgolly.playcanvas.playcanvasInts.`8`
import typingsJapgolly.playcanvas.playcanvasInts.`9`
import typingsJapgolly.playcanvas.playcanvasStrings.$_CURRENT_SDK_REVISION
import typingsJapgolly.playcanvas.playcanvasStrings.$_CURRENT_SDK_VERSION
import typingsJapgolly.playcanvas.playcanvasStrings.ATTR
import typingsJapgolly.playcanvas.playcanvasStrings.TEXCOORD
import typingsJapgolly.playcanvas.playcanvasStrings.`1Dot55`
import typingsJapgolly.playcanvas.playcanvasStrings.`1Dot56`
import typingsJapgolly.playcanvas.playcanvasStrings.`1Dot57`
import typingsJapgolly.playcanvas.playcanvasStrings.`1d`
import typingsJapgolly.playcanvas.playcanvasStrings.`2d-array`
import typingsJapgolly.playcanvas.playcanvasStrings.`2d`
import typingsJapgolly.playcanvas.playcanvasStrings.`3d`
import typingsJapgolly.playcanvas.playcanvasStrings.`cube-array`
import typingsJapgolly.playcanvas.playcanvasStrings.`unfilterable-float`
import typingsJapgolly.playcanvas.playcanvasStrings.bitmap
import typingsJapgolly.playcanvas.playcanvasStrings.cube
import typingsJapgolly.playcanvas.playcanvasStrings.default
import typingsJapgolly.playcanvas.playcanvasStrings.depth
import typingsJapgolly.playcanvas.playcanvasStrings.float
import typingsJapgolly.playcanvas.playcanvasStrings.gamepad
import typingsJapgolly.playcanvas.playcanvasStrings.key
import typingsJapgolly.playcanvas.playcanvasStrings.keyboard
import typingsJapgolly.playcanvas.playcanvasStrings.mouse
import typingsJapgolly.playcanvas.playcanvasStrings.mousex
import typingsJapgolly.playcanvas.playcanvasStrings.mousey
import typingsJapgolly.playcanvas.playcanvasStrings.msdf
import typingsJapgolly.playcanvas.playcanvasStrings.padlx
import typingsJapgolly.playcanvas.playcanvasStrings.padly
import typingsJapgolly.playcanvas.playcanvasStrings.padrx
import typingsJapgolly.playcanvas.playcanvasStrings.padry
import typingsJapgolly.playcanvas.playcanvasStrings.screen
import typingsJapgolly.playcanvas.playcanvasStrings.webgl
import typingsJapgolly.playcanvas.playcanvasStrings.webgpu
...
): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("basisTranscode")(device.asInstanceOf[js.Any], url.asInstanceOf[js.Any], data.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Boolean]
inline def basisTranscode(
  device: typingsJapgolly.playcanvas.mod.GraphicsDevice,
  url: String,
  data: js.Object,
...
/**
  ...
  */
inline def createBox(device: typingsJapgolly.playcanvas.mod.GraphicsDevice): typingsJapgolly.playcanvas.mod.Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createBox")(device.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
inline def createBox(device: typingsJapgolly.playcanvas.mod.GraphicsDevice, opts: CalculateTangents): typingsJapgolly.playcanvas.mod.Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createBox")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
...
/**
  ...
  */
inline def createCapsule(device: typingsJapgolly.playcanvas.mod.GraphicsDevice): typingsJapgolly.playcanvas.mod.Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createCapsule")(device.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
inline def createCapsule(device: typingsJapgolly.playcanvas.mod.GraphicsDevice, opts: Height): typingsJapgolly.playcanvas.mod.Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createCapsule")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
...
/**
  ...
  */
inline def createCone(device: typingsJapgolly.playcanvas.mod.GraphicsDevice): typingsJapgolly.playcanvas.mod.Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createCone")(device.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
inline def createCone(device: typingsJapgolly.playcanvas.mod.GraphicsDevice, opts: BaseRadius): typingsJapgolly.playcanvas.mod.Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createCone")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
...
/**
  ...
  * @returns {Mesh} A new cylinder-shaped mesh.
  */
inline def createCylinder(device: typingsJapgolly.playcanvas.mod.GraphicsDevice): typingsJapgolly.playcanvas.mod.Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createCylinder")(device.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
inline def createCylinder(device: typingsJapgolly.playcanvas.mod.GraphicsDevice, opts: CapSegments): typingsJapgolly.playcanvas.mod.Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createCylinder")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
...
/**
  ...
  * });
  */
inline def createMesh(device: typingsJapgolly.playcanvas.mod.GraphicsDevice, positions: js.Array[Double]): typingsJapgolly.playcanvas.mod.Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createMesh")(device.asInstanceOf[js.Any], positions.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
inline def createMesh(
  device: typingsJapgolly.playcanvas.mod.GraphicsDevice,
  positions: js.Array[Double],
  opts: BlendIndices
): typingsJapgolly.playcanvas.mod.Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createMesh")(device.asInstanceOf[js.Any], positions.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
...
/**
  ...
  */
inline def createPlane(device: typingsJapgolly.playcanvas.mod.GraphicsDevice): typingsJapgolly.playcanvas.mod.Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createPlane")(device.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
inline def createPlane(device: typingsJapgolly.playcanvas.mod.GraphicsDevice, opts: HalfExtents): typingsJapgolly.playcanvas.mod.Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createPlane")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
...
/**
  ...
  */
inline def createShader(device: typingsJapgolly.playcanvas.mod.GraphicsDevice, vsName: String, psName: String): typingsJapgolly.playcanvas.mod.Shader = (^.asInstanceOf[js.Dynamic].applyDynamic("createShader")(device.asInstanceOf[js.Any], vsName.asInstanceOf[js.Any], psName.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Shader]
inline def createShader(
  device: typingsJapgolly.playcanvas.mod.GraphicsDevice,
  vsName: String,
  psName: String,
  useTransformFeedback: Boolean
): typingsJapgolly.playcanvas.mod.Shader = (^.asInstanceOf[js.Dynamic].applyDynamic("createShader")(device.asInstanceOf[js.Any], vsName.asInstanceOf[js.Any], psName.asInstanceOf[js.Any], useTransformFeedback.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Shader]
...
inline def createShaderFromCode(
  ...
  psCode: String,
  uName: String
): typingsJapgolly.playcanvas.mod.Shader = (^.asInstanceOf[js.Dynamic].applyDynamic("createShaderFromCode")(device.asInstanceOf[js.Any], vsCode.asInstanceOf[js.Any], psCode.asInstanceOf[js.Any], uName.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Shader]
inline def createShaderFromCode(
  device: typingsJapgolly.playcanvas.mod.GraphicsDevice,
  vsCode: String,
  psCode: String,
  uName: String,
  useTransformFeedback: Boolean
): typingsJapgolly.playcanvas.mod.Shader = (^.asInstanceOf[js.Dynamic].applyDynamic("createShaderFromCode")(device.asInstanceOf[js.Any], vsCode.asInstanceOf[js.Any], psCode.asInstanceOf[js.Any], uName.asInstanceOf[js.Any], useTransformFeedback.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Shader]
inline def createShaderFromCode(
  device: typingsJapgolly.playcanvas.mod.GraphicsDevice,
  vsCode: String,
  psCode: String,
  ...
  useTransformFeedback: Boolean,
  psPreamble: String
): typingsJapgolly.playcanvas.mod.Shader = (^.asInstanceOf[js.Dynamic].applyDynamic("createShaderFromCode")(device.asInstanceOf[js.Any], vsCode.asInstanceOf[js.Any], psCode.asInstanceOf[js.Any], uName.asInstanceOf[js.Any], useTransformFeedback.asInstanceOf[js.Any], psPreamble.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Shader]
inline def createShaderFromCode(
  device: typingsJapgolly.playcanvas.mod.GraphicsDevice,
  vsCode: String,
  psCode: String,
...
/**
  ...
  */
inline def createSphere(device: typingsJapgolly.playcanvas.mod.GraphicsDevice): typingsJapgolly.playcanvas.mod.Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createSphere")(device.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
inline def createSphere(device: typingsJapgolly.playcanvas.mod.GraphicsDevice, opts: LatitudeBands): typingsJapgolly.playcanvas.mod.Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createSphere")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
...
/**
  ...
  */
inline def createTorus(device: typingsJapgolly.playcanvas.mod.GraphicsDevice): typingsJapgolly.playcanvas.mod.Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createTorus")(device.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
inline def createTorus(device: typingsJapgolly.playcanvas.mod.GraphicsDevice, opts: RingRadius): typingsJapgolly.playcanvas.mod.Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createTorus")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.playcanvas.mod.Mesh]
...
inline def drawFullscreenQuad(
  device: typingsJapgolly.playcanvas.mod.GraphicsDevice,
  target: typingsJapgolly.playcanvas.mod.RenderTarget,
  vertexBuffer: typingsJapgolly.playcanvas.mod.VertexBuffer,
  shader: typingsJapgolly.playcanvas.mod.Shader
...
/**
  ...
  * @param {boolean} [useBlend] - True to enable blending. Defaults to false, disabling blending.
  */
inline def drawTexture(device: typingsJapgolly.playcanvas.mod.GraphicsDevice, texture: Texture): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("drawTexture")(device.asInstanceOf[js.Any], texture.asInstanceOf[js.Any])).asInstanceOf[Unit]
