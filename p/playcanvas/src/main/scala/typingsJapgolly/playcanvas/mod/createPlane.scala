...
import typingsJapgolly.playcanvas.AnonHalfExtents
...
object createPlane extends js.Object {
  ...
  def apply(device: typingsJapgolly.playcanvas.pc.GraphicsDevice, opts: AnonHalfExtents): typingsJapgolly.playcanvas.pc.Mesh = js.native
}
