...
import typingsJapgolly.playcanvas.anon.EventName
...
/**
  ...
  * @ignore
  */
@JSImport("playcanvas", "EntityReference")
@js.native
open class EntityReference protected () extends EventHandler {
  /**
  ...
  def _callAllGainOrLoseListeners(listenerMap: Any): Unit = js.native
  
  def _callGainOrLoseListener(componentName: Any, listenerMap: Any): Unit = js.native
  
  def _configureEventListeners(externalEventConfig: Any, internalEventConfig: Any): Unit = js.native
  
  var _entity: Entity = js.native
  
  var _entityPropertyName: String = js.native
  
  var _eventListenerConfigs: js.Array[EventName] = js.native
  
  def _getEventSource(sourceName: Any, isDestroying: Any): Any = js.native
  
  def _onAfterEntityChange(): Unit = js.native
  
  def _onBeforeEntityChange(): Unit = js.native
  
  def _onComponentAdd(entity: Any, component: Any): Unit = js.native
  
  def _onComponentRemove(entity: Any, component: Any): Unit = js.native
  
  def _onEntityDestroy(entity: Any): Unit = js.native
  
  def _onParentComponentRemove(entity: Any, component: Any): Unit = js.native
  
  def _onSceneLoaded(): Unit = js.native
  
  def _onSetEntity(name: Any, oldValue: Any, newValue: Any): Unit = js.native
  
  var _parentComponent: Component = js.native
  
  def _parseEventListenerConfig(eventConfig: Any, prefix: Any, scope: Any): js.Array[EventName] = js.native
  
  def _safeToggleListener(onOrOff: Any, config: Any, isDestroying: Any): Unit = js.native
  
  def _toggleComponentListeners(onOrOff: Any, componentName: Any, isDestroying: Any): Unit = js.native
  
  def _toggleEntityListeners(onOrOff: Any, isDestroying: Any): Unit = js.native
  
  def _toggleLifecycleListeners(onOrOff: Any): Unit = js.native
  
  def _updateEntityReference(): Unit = js.native
  ...
  /**
    ...
    */
  def hasComponent(componentName: String): Boolean = js.native
  ...
  /**
    ...
    * @private
    */
  /* private */ var onParentComponentEnable: Any = js.native
}
