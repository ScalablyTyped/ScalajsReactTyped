...
import typingsJapgolly.playcanvas.AnonColors
...
object createMesh extends js.Object {
  /**
    ...
    *     });
    */
  def apply(device: typingsJapgolly.playcanvas.pc.GraphicsDevice, positions: js.Array[Double]): typingsJapgolly.playcanvas.pc.Mesh = js.native
  def apply(
    device: typingsJapgolly.playcanvas.pc.GraphicsDevice,
    positions: js.Array[Double],
    opts: AnonColors
  ): typingsJapgolly.playcanvas.pc.Mesh = js.native
}
