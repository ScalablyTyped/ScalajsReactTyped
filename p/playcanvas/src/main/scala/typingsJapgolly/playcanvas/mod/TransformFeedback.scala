...
class TransformFeedback protected ()
  extends typingsJapgolly.playcanvas.pc.TransformFeedback {
  def this(inputBuffer: typingsJapgolly.playcanvas.pc.VertexBuffer) = this()
  def this(inputBuffer: typingsJapgolly.playcanvas.pc.VertexBuffer, usage: Double) = this()
}
