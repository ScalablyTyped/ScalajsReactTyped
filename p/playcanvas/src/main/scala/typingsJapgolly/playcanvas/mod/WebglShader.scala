...
object WebglShader {
  ...
  inline def apply(
    ...
    compileAndLink: (WebglGraphicsDevice, Shader) => Callback,
    destroy: Shader => Callback,
    ...
    restoreContext: (WebglGraphicsDevice, Shader) => Callback,
    samplers: js.Array[Any],
    uniforms: js.Array[Any]
  ): WebglShader = {
    val __obj = js.Dynamic.literal(_compileShaderSource = _compileShaderSource.asInstanceOf[js.Any], _isCompiled = _isCompiled.asInstanceOf[js.Any], _processError = _processError.asInstanceOf[js.Any], attributes = attributes.asInstanceOf[js.Any], compileAndLink = js.Any.fromFunction2((t0: WebglGraphicsDevice, t1: Shader) => (compileAndLink(t0, t1)).runNow()), destroy = js.Any.fromFunction1((t0: Shader) => destroy(t0).runNow()), glFragmentShader = glFragmentShader.asInstanceOf[js.Any], glProgram = glProgram.asInstanceOf[js.Any], glVertexShader = glVertexShader.asInstanceOf[js.Any], init = init.toJsFn, loseContext = loseContext.toJsFn, postLink = js.Any.fromFunction2(postLink), restoreContext = js.Any.fromFunction2((t0: WebglGraphicsDevice, t1: Shader) => (restoreContext(t0, t1)).runNow()), samplers = samplers.asInstanceOf[js.Any], uniforms = uniforms.asInstanceOf[js.Any])
  ...
  extension [Self <: WebglShader](x: Self) {
    ...
    inline def setCompileAndLink(value: (WebglGraphicsDevice, Shader) => Callback): Self = StObject.set(x, "compileAndLink", js.Any.fromFunction2((t0: WebglGraphicsDevice, t1: Shader) => (value(t0, t1)).runNow()))
    
    inline def setDestroy(value: Shader => Callback): Self = StObject.set(x, "destroy", js.Any.fromFunction1((t0: Shader) => value(t0).runNow()))
    ...
    inline def setRestoreContext(value: (WebglGraphicsDevice, Shader) => Callback): Self = StObject.set(x, "restoreContext", js.Any.fromFunction2((t0: WebglGraphicsDevice, t1: Shader) => (value(t0, t1)).runNow()))
