...
class VertexFormat protected ()
  extends typingsJapgolly.playcanvas.pc.VertexFormat {
  def this(graphicsDevice: typingsJapgolly.playcanvas.pc.GraphicsDevice, description: js.Array[js.Object]) = this()
}
