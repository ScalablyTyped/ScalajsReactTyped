...
object drawFullscreenQuad extends js.Object {
  ...
  def apply(
    ...
    target: typingsJapgolly.playcanvas.pc.RenderTarget,
    vertexBuffer: typingsJapgolly.playcanvas.pc.VertexBuffer,
    shader: typingsJapgolly.playcanvas.pc.Shader
  ): Unit = js.native
  def apply(
    device: typingsJapgolly.playcanvas.pc.GraphicsDevice,
    target: typingsJapgolly.playcanvas.pc.RenderTarget,
    vertexBuffer: typingsJapgolly.playcanvas.pc.VertexBuffer,
    shader: typingsJapgolly.playcanvas.pc.Shader,
    rect: typingsJapgolly.playcanvas.pc.Vec4
  ): Unit = js.native
}
