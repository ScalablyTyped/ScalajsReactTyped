...
object ParticleGPUUpdater {
  ...
  extension [Self <: ParticleGPUUpdater](x: Self) {
    ...
    inline def setRandomize(value: Callback): Self = StObject.set(x, "randomize", value.toJsFn)
    
    inline def setUpdate(value: (Any, Any, Any, Any, Any) => Callback): Self = StObject.set(x, "update", js.Any.fromFunction5((t0: Any, t1: Any, t2: Any, t3: Any, t4: Any) => (value(t0, t1, t2, t3, t4)).runNow()))
    ...
    inline def set_setInputBounds(value: Callback): Self = StObject.set(x, "_setInputBounds", value.toJsFn)
  }
}
