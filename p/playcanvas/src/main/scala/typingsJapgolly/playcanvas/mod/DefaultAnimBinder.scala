...
import typingsJapgolly.playcanvas.anon.LocalPosition
...
object DefaultAnimBinder {
  ...
  extension [Self <: DefaultAnimBinder](x: Self) {
    ...
    inline def setUnresolve(value: Any => Callback): Self = StObject.set(x, "unresolve", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
