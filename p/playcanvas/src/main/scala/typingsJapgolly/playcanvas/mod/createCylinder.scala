...
import typingsJapgolly.playcanvas.AnonCapSegments
...
object createCylinder extends js.Object {
  ...
  def apply(device: typingsJapgolly.playcanvas.pc.GraphicsDevice, opts: AnonCapSegments): typingsJapgolly.playcanvas.pc.Mesh = js.native
}
