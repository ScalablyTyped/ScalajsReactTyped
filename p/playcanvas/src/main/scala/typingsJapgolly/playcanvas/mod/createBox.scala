...
import typingsJapgolly.playcanvas.AnonHeightSegments
...
object createBox extends js.Object {
  ...
  def apply(device: typingsJapgolly.playcanvas.pc.GraphicsDevice, opts: AnonHeightSegments): typingsJapgolly.playcanvas.pc.Mesh = js.native
}
