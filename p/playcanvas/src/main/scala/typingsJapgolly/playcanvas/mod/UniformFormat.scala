...
object UniformFormat {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(byteSize = byteSize.asInstanceOf[js.Any], calculateOffset = js.Any.fromFunction1((t0: Any) => calculateOffset(t0).runNow()), count = count.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any], scopeId = scopeId.asInstanceOf[js.Any])
  ...
  extension [Self <: UniformFormat](x: Self) {
    ...
    inline def setCalculateOffset(value: Any => Callback): Self = StObject.set(x, "calculateOffset", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
