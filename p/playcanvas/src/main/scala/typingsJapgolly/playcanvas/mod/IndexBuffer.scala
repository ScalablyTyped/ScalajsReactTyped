...
class IndexBuffer protected ()
  extends typingsJapgolly.playcanvas.pc.IndexBuffer {
  def this(graphicsDevice: typingsJapgolly.playcanvas.pc.GraphicsDevice, format: Double, numIndices: Double) = this()
  def this(
