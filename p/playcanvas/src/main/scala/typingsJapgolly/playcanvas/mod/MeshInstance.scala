...
class MeshInstance protected ()
  extends typingsJapgolly.playcanvas.pc.MeshInstance {
  def this(
    node: typingsJapgolly.playcanvas.pc.GraphNode,
    mesh: typingsJapgolly.playcanvas.pc.Mesh,
    material: typingsJapgolly.playcanvas.pc.Material
  ) = this()
}
