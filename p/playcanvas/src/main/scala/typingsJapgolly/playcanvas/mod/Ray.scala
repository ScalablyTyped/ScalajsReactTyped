...
@js.native
class Ray ()
  extends typingsJapgolly.playcanvas.pc.Ray {
  def this(origin: typingsJapgolly.playcanvas.pc.Vec3) = this()
  def this(origin: typingsJapgolly.playcanvas.pc.Vec3, direction: typingsJapgolly.playcanvas.pc.Vec3) = this()
}
