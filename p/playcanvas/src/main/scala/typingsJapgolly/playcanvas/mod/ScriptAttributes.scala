...
import typingsJapgolly.playcanvas.anon.Array
...
object ScriptAttributes {
  ...
  inline def apply(
    add: (String, Array) => Callback,
    get: String => js.Object | Null,
    has: String => Boolean,
    remove: String => Boolean,
    scriptType: TypeofScriptType & (Instantiable1[/* args */ App, ScriptType])
  ): ScriptAttributes = {
    val __obj = js.Dynamic.literal(add = js.Any.fromFunction2((t0: String, t1: Array) => (add(t0, t1)).runNow()), get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has), remove = js.Any.fromFunction1(remove), scriptType = scriptType.asInstanceOf[js.Any])
    __obj.asInstanceOf[ScriptAttributes]
  }
  
  extension [Self <: ScriptAttributes](x: Self) {
    
    inline def setAdd(value: (String, Array) => Callback): Self = StObject.set(x, "add", js.Any.fromFunction2((t0: String, t1: Array) => (value(t0, t1)).runNow()))
