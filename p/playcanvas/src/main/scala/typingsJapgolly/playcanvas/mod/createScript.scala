...
object createScript extends js.Object {
  /**
    ...
    * };
    */
  def apply(name: String): typingsJapgolly.playcanvas.pc.ScriptType = js.native
  def apply(name: String, app: typingsJapgolly.playcanvas.pc.Application): typingsJapgolly.playcanvas.pc.ScriptType = js.native
}
