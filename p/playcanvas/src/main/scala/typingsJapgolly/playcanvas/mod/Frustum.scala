...
object Frustum {
  ...
  inline def apply(
    ...
    setFromMat4: Mat4 => Callback
  ): Frustum = {
    val __obj = js.Dynamic.literal(containsPoint = js.Any.fromFunction1(containsPoint), containsSphere = js.Any.fromFunction1(containsSphere), planes = planes.asInstanceOf[js.Any], setFromMat4 = js.Any.fromFunction1((t0: Mat4) => setFromMat4(t0).runNow()))
  ...
  extension [Self <: Frustum](x: Self) {
    ...
    inline def setSetFromMat4(value: Mat4 => Callback): Self = StObject.set(x, "setFromMat4", js.Any.fromFunction1((t0: Mat4) => value(t0).runNow()))
  }
}
