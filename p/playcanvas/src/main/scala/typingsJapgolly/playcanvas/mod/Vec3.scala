...
@js.native
class Vec3 ()
  extends typingsJapgolly.playcanvas.pc.Vec3 {
...
object Vec3 extends js.Object {
  /**
    ...
    */
  val BACK: typingsJapgolly.playcanvas.pc.Vec3 = js.native
  /**
    * @static
    * @readonly
    * @name pc.Vec3.DOWN
    ...
    */
  val DOWN: typingsJapgolly.playcanvas.pc.Vec3 = js.native
  /**
    * @static
    * @readonly
    ...
    * @description A constant vector set to [0, 0, -1].
    */
  val FORWARD: typingsJapgolly.playcanvas.pc.Vec3 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    */
  val LEFT: typingsJapgolly.playcanvas.pc.Vec3 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    */
  val ONE: typingsJapgolly.playcanvas.pc.Vec3 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    * @description A constant vector set to [1, 0, 0].
    */
  val RIGHT: typingsJapgolly.playcanvas.pc.Vec3 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    * @description A constant vector set to [0, 1, 0].
    */
  val UP: typingsJapgolly.playcanvas.pc.Vec3 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    */
  val ZERO: typingsJapgolly.playcanvas.pc.Vec3 = js.native
}
