...
object Vec3 {
  ...
  inline def apply(
    ...
    normalize: CallbackTo[Vec3],
    project: Vec3 => Vec3,
    round: CallbackTo[Vec3],
  ...
  extension [Self <: Vec3](x: Self) {
    ...
    inline def setCeil(value: CallbackTo[Vec3]): Self = StObject.set(x, "ceil", value.toJsFn)
    ...
    inline def setFloor(value: CallbackTo[Vec3]): Self = StObject.set(x, "floor", value.toJsFn)
    ...
    inline def setNormalize(value: CallbackTo[Vec3]): Self = StObject.set(x, "normalize", value.toJsFn)
    
    inline def setProject(value: Vec3 => Vec3): Self = StObject.set(x, "project", js.Any.fromFunction1(value))
    
    inline def setRound(value: CallbackTo[Vec3]): Self = StObject.set(x, "round", value.toJsFn)
