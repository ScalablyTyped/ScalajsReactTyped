...
object Vec4 {
  ...
  extension [Self <: Vec4](x: Self) {
    ...
    inline def setCeil(value: CallbackTo[Vec4]): Self = StObject.set(x, "ceil", value.toJsFn)
    ...
    inline def setFloor(value: CallbackTo[Vec4]): Self = StObject.set(x, "floor", value.toJsFn)
    ...
    inline def setRound(value: CallbackTo[Vec4]): Self = StObject.set(x, "round", value.toJsFn)
