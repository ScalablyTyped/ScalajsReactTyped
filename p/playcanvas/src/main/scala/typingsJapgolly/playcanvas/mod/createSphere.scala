...
import typingsJapgolly.playcanvas.AnonRadius
...
object createSphere extends js.Object {
  ...
  def apply(device: typingsJapgolly.playcanvas.pc.GraphicsDevice, opts: AnonRadius): typingsJapgolly.playcanvas.pc.Mesh = js.native
}
