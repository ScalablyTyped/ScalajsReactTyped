...
object RenderPass {
  ...
  inline def apply(
    ...
    init: RenderTarget => Callback,
    name: String,
    render: Callback,
    renderTarget: RenderTarget,
    requiresCubemaps: Boolean,
    samples: Double,
    setClearColor: Color => Callback,
    setClearDepth: Double => Callback,
    setClearStencil: Double => Callback
  ): RenderPass = {
    val __obj = js.Dynamic.literal(colorOps = colorOps.asInstanceOf[js.Any], depthStencilOps = depthStencilOps.asInstanceOf[js.Any], device = device.asInstanceOf[js.Any], execute = execute.asInstanceOf[js.Any], fullSizeClearRect = fullSizeClearRect.asInstanceOf[js.Any], init = js.Any.fromFunction1((t0: RenderTarget) => init(t0).runNow()), name = name.asInstanceOf[js.Any], render = render.toJsFn, renderTarget = renderTarget.asInstanceOf[js.Any], requiresCubemaps = requiresCubemaps.asInstanceOf[js.Any], samples = samples.asInstanceOf[js.Any], setClearColor = js.Any.fromFunction1((t0: Color) => setClearColor(t0).runNow()), setClearDepth = js.Any.fromFunction1((t0: Double) => setClearDepth(t0).runNow()), setClearStencil = js.Any.fromFunction1((t0: Double) => setClearStencil(t0).runNow()))
  ...
  extension [Self <: RenderPass](x: Self) {
    ...
    inline def setInit(value: RenderTarget => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: RenderTarget) => value(t0).runNow()))
    ...
    inline def setSetClearColor(value: Color => Callback): Self = StObject.set(x, "setClearColor", js.Any.fromFunction1((t0: Color) => value(t0).runNow()))
    
    inline def setSetClearDepth(value: Double => Callback): Self = StObject.set(x, "setClearDepth", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    
    inline def setSetClearStencil(value: Double => Callback): Self = StObject.set(x, "setClearStencil", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
  }
}
