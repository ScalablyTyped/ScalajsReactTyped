...
object Vec2 {
  ...
  inline def apply(
    ...
    normalize: CallbackTo[Vec2],
    round: CallbackTo[Vec2],
  ...
  extension [Self <: Vec2](x: Self) {
    ...
    inline def setCeil(value: CallbackTo[Vec2]): Self = StObject.set(x, "ceil", value.toJsFn)
    ...
    inline def setFloor(value: CallbackTo[Vec2]): Self = StObject.set(x, "floor", value.toJsFn)
    ...
    inline def setNormalize(value: CallbackTo[Vec2]): Self = StObject.set(x, "normalize", value.toJsFn)
    
    inline def setRound(value: CallbackTo[Vec2]): Self = StObject.set(x, "round", value.toJsFn)
