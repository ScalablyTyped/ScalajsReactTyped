...
@js.native
class Vec2 ()
  extends typingsJapgolly.playcanvas.pc.Vec2 {
...
object Vec2 extends js.Object {
  /**
    ...
    */
  val ONE: typingsJapgolly.playcanvas.pc.Vec2 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    */
  val RIGHT: typingsJapgolly.playcanvas.pc.Vec2 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    */
  val UP: typingsJapgolly.playcanvas.pc.Vec2 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    */
  val ZERO: typingsJapgolly.playcanvas.pc.Vec2 = js.native
}
