...
class ElementDragHelper protected ()
  extends typingsJapgolly.playcanvas.pc.ElementDragHelper {
  def this(element: typingsJapgolly.playcanvas.pc.ElementComponent) = this()
  def this(element: typingsJapgolly.playcanvas.pc.ElementComponent, axis: String) = this()
}
