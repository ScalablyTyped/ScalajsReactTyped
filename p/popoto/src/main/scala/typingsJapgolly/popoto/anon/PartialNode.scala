...
object PartialNode {
  ...
  extension [Self <: PartialNode](x: Self) {
    ...
    inline def setDisplayResults(value: /* pElmt */ SVGPathElement => Callback): Self = StObject.set(x, "displayResults", js.Any.fromFunction1((t0: /* pElmt */ SVGPathElement) => value(t0).runNow()))
