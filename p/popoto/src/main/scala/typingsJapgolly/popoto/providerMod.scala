...
import typingsJapgolly.popoto.anon.LinkDEFAULTPROVIDERLinkPr
import typingsJapgolly.popoto.anon.NodeDEFAULTPROVIDERNodePr
import typingsJapgolly.popoto.anon.ReadonlyTEXT0IMAGE1SVG2SY
import typingsJapgolly.popoto.anon.TaxonomyDEFAULTPROVIDERTa
import typingsJapgolly.popoto.queryMod.Query.NEO4J_INTERNAL_ID
...
object providerMod {
  ...
  object Node {
    ...
    inline def apply(
      ...
      displayResults: SVGPathElement => Callback,
    ...
    extension [Self <: Node](x: Self) {
      ...
      inline def setDisplayResults(value: SVGPathElement => Callback): Self = StObject.set(x, "displayResults", js.Any.fromFunction1((t0: SVGPathElement) => value(t0).runNow()))
