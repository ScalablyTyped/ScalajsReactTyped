package typingsJapgolly.phosphorCollections.linkedlistMod.LinkedList
...
trait INode[T] extends js.Object {
  /**
    ...
    */
  val list: typingsJapgolly.phosphorCollections.linkedlistMod.LinkedList[T] | Null
  /**
...
object INode {
  ...
  def apply[T](
    value: T,
    list: typingsJapgolly.phosphorCollections.linkedlistMod.LinkedList[T] = null,
    next: INode[T] = null,
    prev: INode[T] = null
  ): INode[T] = {
