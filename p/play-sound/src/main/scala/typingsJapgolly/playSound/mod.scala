...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.playSound.playSoundStrings.mplayer
    - typingsJapgolly.playSound.playSoundStrings.afplay
    - typingsJapgolly.playSound.playSoundStrings.mpg123
    - typingsJapgolly.playSound.playSoundStrings.mpg321
    - typingsJapgolly.playSound.playSoundStrings.play
    - typingsJapgolly.playSound.playSoundStrings.omxplayer
    - typingsJapgolly.playSound.playSoundStrings.aplay
    - typingsJapgolly.playSound.playSoundStrings.cmdmp3
  */
  trait Players extends StObject
  object Players {
    
    inline def afplay: typingsJapgolly.playSound.playSoundStrings.afplay = "afplay".asInstanceOf[typingsJapgolly.playSound.playSoundStrings.afplay]
    
    inline def aplay: typingsJapgolly.playSound.playSoundStrings.aplay = "aplay".asInstanceOf[typingsJapgolly.playSound.playSoundStrings.aplay]
    
    inline def cmdmp3: typingsJapgolly.playSound.playSoundStrings.cmdmp3 = "cmdmp3".asInstanceOf[typingsJapgolly.playSound.playSoundStrings.cmdmp3]
    
    inline def mpg123: typingsJapgolly.playSound.playSoundStrings.mpg123 = "mpg123".asInstanceOf[typingsJapgolly.playSound.playSoundStrings.mpg123]
    
    inline def mpg321: typingsJapgolly.playSound.playSoundStrings.mpg321 = "mpg321".asInstanceOf[typingsJapgolly.playSound.playSoundStrings.mpg321]
    
    inline def mplayer: typingsJapgolly.playSound.playSoundStrings.mplayer = "mplayer".asInstanceOf[typingsJapgolly.playSound.playSoundStrings.mplayer]
    
    inline def omxplayer: typingsJapgolly.playSound.playSoundStrings.omxplayer = "omxplayer".asInstanceOf[typingsJapgolly.playSound.playSoundStrings.omxplayer]
    
    inline def play: typingsJapgolly.playSound.playSoundStrings.play = "play".asInstanceOf[typingsJapgolly.playSound.playSoundStrings.play]
  }
}
