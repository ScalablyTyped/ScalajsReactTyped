package typingsJapgolly.pixiDisplay
...
import typingsJapgolly.pixiDisplay.anon.ContainerDisplayObjectAddChildAt
import typingsJapgolly.pixiDisplay.anon.TemporaryDisplayObjectAngle
...
import typingsJapgolly.pixiMath.mod.Transform
...
object mod {
  ...
  open class Container[T /* <: typingsJapgolly.pixiDisplay.anon.DisplayObject */] ()
    extends DisplayObject
       with typingsJapgolly.pixiDisplay.GlobalMixins.Container {
  ...
  open class DisplayObject ()
    ...
    def removeChild(child: typingsJapgolly.pixiDisplay.anon.DisplayObject): Unit = js.native
    ...
    def toLocal[P /* <: IPointData */](position: IPointData, from: typingsJapgolly.pixiDisplay.anon.DisplayObject): P = js.native
    def toLocal[P /* <: IPointData */](position: IPointData, from: typingsJapgolly.pixiDisplay.anon.DisplayObject, point: P): P = js.native
    def toLocal[P /* <: IPointData */](
      position: IPointData,
      from: typingsJapgolly.pixiDisplay.anon.DisplayObject,
      point: P,
      skipUpdate: Boolean
    ): P = js.native
    def toLocal[P /* <: IPointData */](
