package typingsJapgolly.pdfThumbnail
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pdfThumbnail.pdfThumbnailStrings.compress
    - typingsJapgolly.pdfThumbnail.pdfThumbnailStrings.crop
    - typingsJapgolly.pdfThumbnail.pdfThumbnailStrings.resize
  */
  trait Operations extends StObject
  object Operations {
    
    inline def compress: typingsJapgolly.pdfThumbnail.pdfThumbnailStrings.compress = "compress".asInstanceOf[typingsJapgolly.pdfThumbnail.pdfThumbnailStrings.compress]
    
    inline def crop: typingsJapgolly.pdfThumbnail.pdfThumbnailStrings.crop = "crop".asInstanceOf[typingsJapgolly.pdfThumbnail.pdfThumbnailStrings.crop]
    
    inline def resize: typingsJapgolly.pdfThumbnail.pdfThumbnailStrings.resize = "resize".asInstanceOf[typingsJapgolly.pdfThumbnail.pdfThumbnailStrings.resize]
  }
