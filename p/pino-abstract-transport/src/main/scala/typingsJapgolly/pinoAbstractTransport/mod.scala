package typingsJapgolly.pinoAbstractTransport

import japgolly.scalajs.react.Callback
import typingsJapgolly.node.streamMod.Transform
import typingsJapgolly.pinoAbstractTransport.pinoAbstractTransportBooleans.`false`
import typingsJapgolly.pinoAbstractTransport.pinoAbstractTransportBooleans.`true`
import typingsJapgolly.pinoAbstractTransport.pinoAbstractTransportStrings.lines
import typingsJapgolly.pinoAbstractTransport.pinoAbstractTransportStrings.unknown
...
object mod {
  ...
  object OnUnknown {
    ...
    inline def apply(on: (unknown, js.Function2[/* line */ String, /* error */ Any, Unit]) => Callback): OnUnknown = {
      val __obj = js.Dynamic.literal(on = js.Any.fromFunction2((t0: unknown, t1: js.Function2[/* line */ String, /* error */ Any, Unit]) => (on(t0, t1)).runNow()))
      __obj.asInstanceOf[OnUnknown]
    }
    
    extension [Self <: OnUnknown](x: Self) {
      
      inline def setOn(value: (unknown, js.Function2[/* line */ String, /* error */ Any, Unit]) => Callback): Self = StObject.set(x, "on", js.Any.fromFunction2((t0: unknown, t1: js.Function2[/* line */ String, /* error */ Any, Unit]) => (value(t0, t1)).runNow()))
    }
  }
}
