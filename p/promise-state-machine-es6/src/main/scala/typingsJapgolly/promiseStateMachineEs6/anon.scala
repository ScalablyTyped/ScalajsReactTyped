...
import typingsJapgolly.promiseStateMachineEs6.mod.DotNode
import typingsJapgolly.promiseStateMachineEs6.mod.DotNodeStringified
...
object anon {
  ...
  trait Events[State, Transitions /* <: String */] extends StObject {
    ...
    var events: typingsJapgolly.promiseStateMachineEs6.mod.Events[State, Transitions]
    
    var initial: State
  }
  object Events {
    
    inline def apply[State, Transitions /* <: String */](events: typingsJapgolly.promiseStateMachineEs6.mod.Events[State, Transitions], initial: State): Events[State, Transitions] = {
    ...
    extension [Self <: Events[?, ?], State, Transitions /* <: String */](x: Self & (Events[State, Transitions])) {
      ...
      inline def setEvents(value: typingsJapgolly.promiseStateMachineEs6.mod.Events[State, Transitions]): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
