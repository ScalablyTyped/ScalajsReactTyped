...
object VisualDataRoleKind extends StObject {
  ...
  /* 0 */ val Grouping: typingsJapgolly.powerbiVisualsTools.mod.VisualDataRoleKind.Grouping & Double = js.native
  ...
  sealed trait GroupingOrMeasure
    extends StObject
       with VisualDataRoleKind
  /* 2 */ val GroupingOrMeasure: typingsJapgolly.powerbiVisualsTools.mod.VisualDataRoleKind.GroupingOrMeasure & Double = js.native
  ...
  sealed trait Measure
    extends StObject
       with VisualDataRoleKind
  /* 1 */ val Measure: typingsJapgolly.powerbiVisualsTools.mod.VisualDataRoleKind.Measure & Double = js.native
}
