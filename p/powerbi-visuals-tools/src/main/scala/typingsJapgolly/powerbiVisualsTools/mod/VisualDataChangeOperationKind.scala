...
object VisualDataChangeOperationKind extends StObject {
  ...
  /* 1 */ val Append: typingsJapgolly.powerbiVisualsTools.mod.VisualDataChangeOperationKind.Append & Double = js.native
  
  @js.native
  sealed trait Create
    extends StObject
       with VisualDataChangeOperationKind
  /* 0 */ val Create: typingsJapgolly.powerbiVisualsTools.mod.VisualDataChangeOperationKind.Create & Double = js.native
}
