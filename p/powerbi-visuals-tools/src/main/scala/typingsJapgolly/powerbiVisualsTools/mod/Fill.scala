...
import typingsJapgolly.powerbiVisualsTools.anon.Color
import typingsJapgolly.powerbiVisualsTools.anon.EndColor
import typingsJapgolly.powerbiVisualsTools.anon.PatternKind
