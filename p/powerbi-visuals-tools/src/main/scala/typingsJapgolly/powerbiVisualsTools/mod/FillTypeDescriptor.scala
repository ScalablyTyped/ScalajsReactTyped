...
import typingsJapgolly.powerbiVisualsTools.anon.ColorPatternKind
import typingsJapgolly.powerbiVisualsTools.anon.StartColor
import typingsJapgolly.powerbiVisualsTools.anon.`0`
