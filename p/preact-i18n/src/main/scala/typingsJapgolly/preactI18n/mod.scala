...
import typingsJapgolly.preactI18n.anon.Definition
import typingsJapgolly.preactI18n.anon.Scope
...
object mod {
  ...
  object default extends StObject {
    ...
    /* 1 */ val IntlContext: typingsJapgolly.preactI18n.mod.Intl_.IntlContext & Double = js.native
    
    /* 2 */ val IntlProvider: typingsJapgolly.preactI18n.mod.Intl_.IntlProvider & Double = js.native
    
    /* 5 */ val Localizer: typingsJapgolly.preactI18n.mod.Intl_.Localizer & Double = js.native
    
    /* 4 */ val MarkupText: typingsJapgolly.preactI18n.mod.Intl_.MarkupText & Double = js.native
    
    /* 3 */ val Text: typingsJapgolly.preactI18n.mod.Intl_.Text & Double = js.native
    
    /* 0 */ val intl: typingsJapgolly.preactI18n.mod.Intl_.intl & Double = js.native
    
    /* 8 */ val translate: typingsJapgolly.preactI18n.mod.Intl_.translate & Double = js.native
    
    /* 7 */ val useText: typingsJapgolly.preactI18n.mod.Intl_.useText & Double = js.native
    
    /* 6 */ val withText: typingsJapgolly.preactI18n.mod.Intl_.withText & Double = js.native
  }
