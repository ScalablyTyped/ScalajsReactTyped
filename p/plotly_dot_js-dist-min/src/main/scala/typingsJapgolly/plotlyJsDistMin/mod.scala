package typingsJapgolly.plotlyJsDistMin
...
import typingsJapgolly.plotlyJs.mod.PlotlyModule
import typingsJapgolly.plotlyJs.mod.Root
import typingsJapgolly.plotlyJs.mod.RootOrData
...
object mod {
  ...
  @JSImport("plotly.js-dist-min", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("plotly.js-dist-min", "Plots")
  @js.native
