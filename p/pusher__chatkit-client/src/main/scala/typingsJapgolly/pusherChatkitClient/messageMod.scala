...
object messageMod {
  ...
  object AttachmentPayload {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any], url = url.toJsFn, urlExpiry = urlExpiry.toJsFn)
    ...
    extension [Self <: AttachmentPayload](x: Self) {
      ...
      inline def setUrl(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "url", value.toJsFn)
      
      inline def setUrlExpiry(value: CallbackTo[js.Promise[js.Date]]): Self = StObject.set(x, "urlExpiry", value.toJsFn)
    }
  }
  ...
  */
  ...
  object MessagePayload {
    ...
    inline def AttachmentPayload(
      ...
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any], url = url.toJsFn, urlExpiry = urlExpiry.toJsFn)
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.pusherChatkitClient.messageMod.AttachmentPayload]
    }
    
    inline def InlinePayload(content: String, `type`: String): typingsJapgolly.pusherChatkitClient.messageMod.InlinePayload = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.pusherChatkitClient.messageMod.InlinePayload]
    }
    
    inline def UrlPayload(`type`: String, url: String): typingsJapgolly.pusherChatkitClient.messageMod.UrlPayload = {
      val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.pusherChatkitClient.messageMod.UrlPayload]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.pusherChatkitClient.messageMod.InlinePayload
    - typingsJapgolly.pusherChatkitClient.messageMod.UrlPayload
    - typingsJapgolly.pusherChatkitClient.messageMod.FilePayload
  */
  trait SendMessagePayload extends StObject
  object SendMessagePayload {
    
    inline def FilePayload(file: Blob): typingsJapgolly.pusherChatkitClient.messageMod.FilePayload = {
      val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.pusherChatkitClient.messageMod.FilePayload]
    }
