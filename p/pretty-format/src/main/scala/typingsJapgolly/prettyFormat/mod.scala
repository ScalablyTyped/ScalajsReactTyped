...
import typingsJapgolly.prettyFormat.anon.Close
import typingsJapgolly.prettyFormat.anon.RequiredPartialreadonlyco
import typingsJapgolly.prettyFormat.prettyFormatBooleans.`false`
import typingsJapgolly.prettyFormat.prettyFormatBooleans.`true`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.prettyFormat.mod.NewPlugin
    - typingsJapgolly.prettyFormat.mod.OldPlugin
  */
  trait Plugin2 extends StObject
  object Plugin2 {
    
    inline def NewPlugin(serialize: (Any, Config, String, Double, Refs, Printer) => String, test: /* arg0 */ Any => Boolean): typingsJapgolly.prettyFormat.mod.NewPlugin = {
      val __obj = js.Dynamic.literal(serialize = js.Any.fromFunction6(serialize), test = js.Any.fromFunction1(test))
      __obj.asInstanceOf[typingsJapgolly.prettyFormat.mod.NewPlugin]
    }
    
    inline def OldPlugin(print: (Any, Print, Indent, PluginOptions, Colors) => String, test: /* arg0 */ Any => Boolean): typingsJapgolly.prettyFormat.mod.OldPlugin = {
      val __obj = js.Dynamic.literal(print = js.Any.fromFunction5(print), test = js.Any.fromFunction1(test))
      __obj.asInstanceOf[typingsJapgolly.prettyFormat.mod.OldPlugin]
    }
  }
