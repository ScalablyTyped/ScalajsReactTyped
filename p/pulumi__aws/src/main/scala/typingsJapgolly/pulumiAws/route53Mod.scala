...
object route53Mod extends js.Object {
  ...
  class DelegationSet protected ()
    extends typingsJapgolly.pulumiAws.delegationSetMod.DelegationSet {
    /**
  ...
  class HealthCheck protected ()
    extends typingsJapgolly.pulumiAws.healthCheckMod.HealthCheck {
    /**
  ...
  class QueryLog protected ()
    extends typingsJapgolly.pulumiAws.queryLogMod.QueryLog {
    /**
  ...
  class Record protected ()
    extends typingsJapgolly.pulumiAws.recordMod.Record {
    /**
  ...
  class ResolverEndpoint protected ()
    extends typingsJapgolly.pulumiAws.resolverEndpointMod.ResolverEndpoint {
    /**
  ...
  class ResolverRule protected ()
    extends typingsJapgolly.pulumiAws.resolverRuleMod.ResolverRule {
    /**
  ...
  class ResolverRuleAssociation protected ()
    extends typingsJapgolly.pulumiAws.resolverRuleAssociationMod.ResolverRuleAssociation {
    /**
  ...
  class Zone protected ()
    extends typingsJapgolly.pulumiAws.zoneMod.Zone {
    /**
  ...
  class ZoneAssociation protected ()
    extends typingsJapgolly.pulumiAws.zoneAssociationMod.ZoneAssociation {
    /**
