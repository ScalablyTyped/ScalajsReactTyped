package typingsJapgolly.pulumiAws.getTargetGroupMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.pulumiAws.outputMod.alb.GetTargetGroupHealthCheck
import typingsJapgolly.pulumiAws.outputMod.alb.GetTargetGroupStickiness
