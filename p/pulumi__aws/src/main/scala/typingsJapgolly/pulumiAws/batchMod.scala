...
object batchMod extends js.Object {
  ...
  class ComputeEnvironment protected ()
    extends typingsJapgolly.pulumiAws.computeEnvironmentMod.ComputeEnvironment {
    /**
  ...
  class JobDefinition protected ()
    extends typingsJapgolly.pulumiAws.jobDefinitionMod.JobDefinition {
    /**
  ...
  class JobQueue protected ()
    extends typingsJapgolly.pulumiAws.jobQueueMod.JobQueue {
    /**
