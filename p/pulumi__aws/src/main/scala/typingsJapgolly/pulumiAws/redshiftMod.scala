...
object redshiftMod extends js.Object {
  ...
  class Cluster protected ()
    extends typingsJapgolly.pulumiAws.redshiftClusterMod.Cluster {
    /**
  ...
  class EventSubscription protected ()
    extends typingsJapgolly.pulumiAws.redshiftEventSubscriptionMod.EventSubscription {
    /**
  ...
  class ParameterGroup protected ()
    extends typingsJapgolly.pulumiAws.redshiftParameterGroupMod.ParameterGroup {
    /**
  ...
  class SecurityGroup protected ()
    extends typingsJapgolly.pulumiAws.redshiftSecurityGroupMod.SecurityGroup {
    /**
  ...
  class SnapshotCopyGrant protected ()
    extends typingsJapgolly.pulumiAws.snapshotCopyGrantMod.SnapshotCopyGrant {
    /**
  ...
  class SnapshotSchedule protected ()
    extends typingsJapgolly.pulumiAws.snapshotScheduleMod.SnapshotSchedule {
    /**
  ...
  class SnapshotScheduleAssociation protected ()
    extends typingsJapgolly.pulumiAws.snapshotScheduleAssociationMod.SnapshotScheduleAssociation {
    /**
  ...
  class SubnetGroup protected ()
    extends typingsJapgolly.pulumiAws.redshiftSubnetGroupMod.SubnetGroup {
    /**
