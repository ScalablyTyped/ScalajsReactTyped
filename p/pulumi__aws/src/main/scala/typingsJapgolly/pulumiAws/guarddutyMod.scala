...
object guarddutyMod extends js.Object {
  ...
  class Detector protected ()
    extends typingsJapgolly.pulumiAws.detectorMod.Detector {
    /**
  ...
  class IPSet protected ()
    extends typingsJapgolly.pulumiAws.iPSetMod.IPSet {
    /**
  ...
  class InviteAccepter protected ()
    extends typingsJapgolly.pulumiAws.inviteAccepterMod.InviteAccepter {
    /**
  ...
  class Member protected ()
    extends typingsJapgolly.pulumiAws.memberMod.Member {
    /**
  ...
  class ThreatIntelSet protected ()
    extends typingsJapgolly.pulumiAws.threatIntelSetMod.ThreatIntelSet {
    /**
