...
import typingsJapgolly.pulumiAws.outputMod.lambda.GetFunctionDeadLetterConfig
import typingsJapgolly.pulumiAws.outputMod.lambda.GetFunctionEnvironment
import typingsJapgolly.pulumiAws.outputMod.lambda.GetFunctionTracingConfig
import typingsJapgolly.pulumiAws.outputMod.lambda.GetFunctionVpcConfig
