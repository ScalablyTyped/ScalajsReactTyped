...
object storagegatewayMod extends js.Object {
  ...
  class Cache protected ()
    extends typingsJapgolly.pulumiAws.cacheMod.Cache {
    /**
  ...
  class CachesIscsiVolume protected ()
    extends typingsJapgolly.pulumiAws.cachesIscsiVolumeMod.CachesIscsiVolume {
    /**
  ...
  class Gateway protected ()
    extends typingsJapgolly.pulumiAws.storagegatewayGatewayMod.Gateway {
    /**
  ...
  class NfsFileShare protected ()
    extends typingsJapgolly.pulumiAws.nfsFileShareMod.NfsFileShare {
    /**
  ...
  class SmbFileShare protected ()
    extends typingsJapgolly.pulumiAws.smbFileShareMod.SmbFileShare {
    /**
  ...
  class UploadBuffer protected ()
    extends typingsJapgolly.pulumiAws.uploadBufferMod.UploadBuffer {
    /**
  ...
  class WorkingStorage protected ()
    extends typingsJapgolly.pulumiAws.workingStorageMod.WorkingStorage {
    /**
