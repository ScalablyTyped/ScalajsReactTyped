...
object securityhubMod extends js.Object {
  ...
  class Account protected ()
    extends typingsJapgolly.pulumiAws.securityhubAccountMod.Account {
    /**
  ...
  class ProductSubscription protected ()
    extends typingsJapgolly.pulumiAws.productSubscriptionMod.ProductSubscription {
    /**
  ...
  class StandardsSubscription protected ()
    extends typingsJapgolly.pulumiAws.standardsSubscriptionMod.StandardsSubscription {
    /**
