...
import typingsJapgolly.pulumiAws.wafRegexMatchSetMod.RegexMatchSetArgs
import typingsJapgolly.pulumiAws.wafRegexMatchSetMod.RegexMatchSetState
...
class RegexMatchSet protected ()
  extends typingsJapgolly.pulumiAws.wafRegexMatchSetMod.RegexMatchSet {
  /**
...
object RegexMatchSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.wafRegexMatchSetMod.RegexMatchSet = js.native
  def get(name: String, id: Input[ID], state: RegexMatchSetState): typingsJapgolly.pulumiAws.wafRegexMatchSetMod.RegexMatchSet = js.native
  def get(name: String, id: Input[ID], state: RegexMatchSetState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.wafRegexMatchSetMod.RegexMatchSet = js.native
  /**
