...
import typingsJapgolly.pulumiAws.outputMod.ec2.AmiFromInstanceEbsBlockDevice
import typingsJapgolly.pulumiAws.outputMod.ec2.AmiFromInstanceEphemeralBlockDevice
