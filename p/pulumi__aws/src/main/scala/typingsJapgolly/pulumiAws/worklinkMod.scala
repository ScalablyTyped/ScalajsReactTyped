...
object worklinkMod extends js.Object {
  ...
  class Fleet protected ()
    extends typingsJapgolly.pulumiAws.worklinkFleetMod.Fleet {
    /**
  ...
  class WebsiteCertificateAuthorityAssociation protected ()
    extends typingsJapgolly.pulumiAws.websiteCertificateAuthorityAssociationMod.WebsiteCertificateAuthorityAssociation {
    /**
