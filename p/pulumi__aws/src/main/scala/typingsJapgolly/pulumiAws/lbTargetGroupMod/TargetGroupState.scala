package typingsJapgolly.pulumiAws.lbTargetGroupMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.pulumiAws.inputMod.lb.TargetGroupHealthCheck
import typingsJapgolly.pulumiAws.inputMod.lb.TargetGroupStickiness
