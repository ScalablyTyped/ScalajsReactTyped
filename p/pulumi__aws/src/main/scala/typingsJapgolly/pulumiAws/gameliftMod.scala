...
object gameliftMod extends js.Object {
  ...
  class Alias protected ()
    extends typingsJapgolly.pulumiAws.aliasMod.Alias {
    /**
  ...
  class Build protected ()
    extends typingsJapgolly.pulumiAws.buildMod.Build {
    /**
  ...
  class Fleet protected ()
    extends typingsJapgolly.pulumiAws.gameliftFleetMod.Fleet {
    /**
  ...
  class GameSessionQueue protected ()
    extends typingsJapgolly.pulumiAws.gameSessionQueueMod.GameSessionQueue {
    /**
