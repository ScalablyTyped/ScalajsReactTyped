...
object elasticacheMod extends js.Object {
  ...
  class Cluster protected ()
    extends typingsJapgolly.pulumiAws.elasticacheClusterMod.Cluster {
    /**
  ...
  class ParameterGroup protected ()
    extends typingsJapgolly.pulumiAws.elasticacheParameterGroupMod.ParameterGroup {
    /**
  ...
  class ReplicationGroup protected ()
    extends typingsJapgolly.pulumiAws.replicationGroupMod.ReplicationGroup {
    /**
  ...
  class SecurityGroup protected ()
    extends typingsJapgolly.pulumiAws.elasticacheSecurityGroupMod.SecurityGroup {
    /**
  ...
  class SubnetGroup protected ()
    extends typingsJapgolly.pulumiAws.elasticacheSubnetGroupMod.SubnetGroup {
    /**
