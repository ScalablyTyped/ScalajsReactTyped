package typingsJapgolly.pulumiAws.getBundleMod

import typingsJapgolly.pulumiAws.outputMod.workspaces.GetBundleComputeType
import typingsJapgolly.pulumiAws.outputMod.workspaces.GetBundleRootStorage
import typingsJapgolly.pulumiAws.outputMod.workspaces.GetBundleUserStorage
