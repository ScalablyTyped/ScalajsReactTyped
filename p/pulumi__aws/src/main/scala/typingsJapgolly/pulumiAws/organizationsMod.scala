...
object organizationsMod extends js.Object {
  ...
  class Account protected ()
    extends typingsJapgolly.pulumiAws.organizationsAccountMod.Account {
    /**
  ...
  class Organization protected ()
    extends typingsJapgolly.pulumiAws.organizationMod.Organization {
    /**
  ...
  class OrganizationalUnit protected ()
    extends typingsJapgolly.pulumiAws.organizationalUnitMod.OrganizationalUnit {
    /**
  ...
  class Policy protected ()
    extends typingsJapgolly.pulumiAws.organizationsPolicyMod.Policy {
    /**
  ...
  class PolicyAttachment protected ()
    extends typingsJapgolly.pulumiAws.organizationsPolicyAttachmentMod.PolicyAttachment {
    /**
