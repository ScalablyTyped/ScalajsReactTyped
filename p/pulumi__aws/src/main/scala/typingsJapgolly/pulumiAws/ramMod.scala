...
object ramMod extends js.Object {
  ...
  class PrincipalAssociation protected ()
    extends typingsJapgolly.pulumiAws.principalAssociationMod.PrincipalAssociation {
    /**
  ...
  class ResourceAssociation protected ()
    extends typingsJapgolly.pulumiAws.resourceAssociationMod.ResourceAssociation {
    /**
  ...
  class ResourceShare protected ()
    extends typingsJapgolly.pulumiAws.resourceShareMod.ResourceShare {
    /**
  ...
  class ResourceShareAccepter protected ()
    extends typingsJapgolly.pulumiAws.resourceShareAccepterMod.ResourceShareAccepter {
    /**
