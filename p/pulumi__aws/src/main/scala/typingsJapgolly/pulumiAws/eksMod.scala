...
object eksMod extends js.Object {
  ...
  class Cluster protected ()
    extends typingsJapgolly.pulumiAws.eksClusterMod.Cluster {
    /**
  ...
  class FargateProfile protected ()
    extends typingsJapgolly.pulumiAws.fargateProfileMod.FargateProfile {
    /**
  ...
  class NodeGroup protected ()
    extends typingsJapgolly.pulumiAws.nodeGroupMod.NodeGroup {
    /**
