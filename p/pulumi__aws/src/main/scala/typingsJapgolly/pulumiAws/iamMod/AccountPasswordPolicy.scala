...
import typingsJapgolly.pulumiAws.accountPasswordPolicyMod.AccountPasswordPolicyArgs
import typingsJapgolly.pulumiAws.accountPasswordPolicyMod.AccountPasswordPolicyState
...
class AccountPasswordPolicy protected ()
  extends typingsJapgolly.pulumiAws.accountPasswordPolicyMod.AccountPasswordPolicy {
  /**
...
object AccountPasswordPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.accountPasswordPolicyMod.AccountPasswordPolicy = js.native
  def get(name: String, id: Input[ID], state: AccountPasswordPolicyState): typingsJapgolly.pulumiAws.accountPasswordPolicyMod.AccountPasswordPolicy = js.native
  def get(name: String, id: Input[ID], state: AccountPasswordPolicyState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.accountPasswordPolicyMod.AccountPasswordPolicy = js.native
  /**
