...
import typingsJapgolly.pulumiAws.userPolicyMod.UserPolicyArgs
import typingsJapgolly.pulumiAws.userPolicyMod.UserPolicyState
...
class UserPolicy protected ()
  extends typingsJapgolly.pulumiAws.userPolicyMod.UserPolicy {
  /**
...
object UserPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.userPolicyMod.UserPolicy = js.native
  def get(name: String, id: Input[ID], state: UserPolicyState): typingsJapgolly.pulumiAws.userPolicyMod.UserPolicy = js.native
  def get(name: String, id: Input[ID], state: UserPolicyState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.userPolicyMod.UserPolicy = js.native
  /**
