...
import typingsJapgolly.pulumiAws.samlProviderMod.SamlProviderArgs
import typingsJapgolly.pulumiAws.samlProviderMod.SamlProviderState
...
class SamlProvider protected ()
  extends typingsJapgolly.pulumiAws.samlProviderMod.SamlProvider {
  /**
...
object SamlProvider extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.samlProviderMod.SamlProvider = js.native
  def get(name: String, id: Input[ID], state: SamlProviderState): typingsJapgolly.pulumiAws.samlProviderMod.SamlProvider = js.native
  def get(name: String, id: Input[ID], state: SamlProviderState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.samlProviderMod.SamlProvider = js.native
  /**
