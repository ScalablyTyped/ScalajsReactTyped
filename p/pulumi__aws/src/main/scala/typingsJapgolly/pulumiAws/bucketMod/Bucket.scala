package typingsJapgolly.pulumiAws.bucketMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.pulumiAws.outputMod.s3.BucketCorsRule
import typingsJapgolly.pulumiAws.outputMod.s3.BucketLifecycleRule
import typingsJapgolly.pulumiAws.outputMod.s3.BucketLogging
import typingsJapgolly.pulumiAws.outputMod.s3.BucketObjectLockConfiguration
import typingsJapgolly.pulumiAws.outputMod.s3.BucketReplicationConfiguration
import typingsJapgolly.pulumiAws.outputMod.s3.BucketServerSideEncryptionConfiguration
import typingsJapgolly.pulumiAws.outputMod.s3.BucketVersioning
import typingsJapgolly.pulumiAws.outputMod.s3.BucketWebsite
import typingsJapgolly.pulumiAws.s3MixinsMod.BucketEventHandler
import typingsJapgolly.pulumiAws.s3MixinsMod.BucketEventSubscription
import typingsJapgolly.pulumiAws.s3MixinsMod.BucketEventSubscriptionArgs
import typingsJapgolly.pulumiAws.s3MixinsMod.ObjectCreatedSubscriptionArgs
import typingsJapgolly.pulumiAws.s3MixinsMod.ObjectRemovedSubscriptionArgs
