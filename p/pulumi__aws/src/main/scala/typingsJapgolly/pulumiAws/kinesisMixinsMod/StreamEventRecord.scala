...
import typingsJapgolly.pulumiAws.AnonKinesisSchemaVersion
import typingsJapgolly.pulumiAws.pulumiAwsStrings.awsColonkinesis
import typingsJapgolly.pulumiAws.pulumiAwsStrings.awsColonkinesisColonrecord
