...
object ebsMod extends js.Object {
  ...
  class DefaultKmsKey protected ()
    extends typingsJapgolly.pulumiAws.defaultKmsKeyMod.DefaultKmsKey {
    /**
  ...
  class EncryptionByDefault protected ()
    extends typingsJapgolly.pulumiAws.encryptionByDefaultMod.EncryptionByDefault {
    /**
  ...
  class Snapshot protected ()
    extends typingsJapgolly.pulumiAws.snapshotMod.Snapshot {
    /**
  ...
  class SnapshotCopy protected ()
    extends typingsJapgolly.pulumiAws.snapshotCopyMod.SnapshotCopy {
    /**
  ...
  class Volume protected ()
    extends typingsJapgolly.pulumiAws.volumeMod.Volume {
    /**
