...
import typingsJapgolly.pulumiAws.analyticsApplicationMod.AnalyticsApplicationArgs
import typingsJapgolly.pulumiAws.analyticsApplicationMod.AnalyticsApplicationState
...
class AnalyticsApplication protected ()
  extends typingsJapgolly.pulumiAws.analyticsApplicationMod.AnalyticsApplication {
  /**
...
object AnalyticsApplication extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.analyticsApplicationMod.AnalyticsApplication = js.native
  def get(name: String, id: Input[ID], state: AnalyticsApplicationState): typingsJapgolly.pulumiAws.analyticsApplicationMod.AnalyticsApplication = js.native
  def get(name: String, id: Input[ID], state: AnalyticsApplicationState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.analyticsApplicationMod.AnalyticsApplication = js.native
  /**
