...
object cfgMod extends js.Object {
  ...
  class AggregateAuthorization protected ()
    extends typingsJapgolly.pulumiAws.aggregateAuthorizationMod.AggregateAuthorization {
    /**
  ...
  class ConfigurationAggregator protected ()
    extends typingsJapgolly.pulumiAws.configurationAggregatorMod.ConfigurationAggregator {
    /**
  ...
  class DeliveryChannel protected ()
    extends typingsJapgolly.pulumiAws.deliveryChannelMod.DeliveryChannel {
    /**
  ...
  class OrganizationCustomRule protected ()
    extends typingsJapgolly.pulumiAws.organizationCustomRuleMod.OrganizationCustomRule {
    /**
  ...
  class OrganizationManagedRule protected ()
    extends typingsJapgolly.pulumiAws.organizationManagedRuleMod.OrganizationManagedRule {
    /**
  ...
  class Recorder protected ()
    extends typingsJapgolly.pulumiAws.recorderMod.Recorder {
    /**
  ...
  class RecorderStatus protected ()
    extends typingsJapgolly.pulumiAws.recorderStatusMod.RecorderStatus {
    /**
  ...
  class Rule protected ()
    extends typingsJapgolly.pulumiAws.ruleMod.Rule {
    /**
