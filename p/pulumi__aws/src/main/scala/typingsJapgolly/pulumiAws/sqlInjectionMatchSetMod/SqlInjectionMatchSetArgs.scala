package typingsJapgolly.pulumiAws.sqlInjectionMatchSetMod

import typingsJapgolly.pulumiAws.inputMod.wafregional.SqlInjectionMatchSetSqlInjectionMatchTuple
