package typingsJapgolly.pulumiAws.patchBaselineMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.pulumiAws.inputMod.ssm.PatchBaselineApprovalRule
import typingsJapgolly.pulumiAws.inputMod.ssm.PatchBaselineGlobalFilter
