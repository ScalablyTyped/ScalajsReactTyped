...
object datasyncMod extends js.Object {
  ...
  class Agent protected ()
    extends typingsJapgolly.pulumiAws.agentMod.Agent {
    /**
  ...
  class EfsLocation protected ()
    extends typingsJapgolly.pulumiAws.efsLocationMod.EfsLocation {
    /**
  ...
  class LocationSmb protected ()
    extends typingsJapgolly.pulumiAws.locationSmbMod.LocationSmb {
    /**
  ...
  class NfsLocation protected ()
    extends typingsJapgolly.pulumiAws.nfsLocationMod.NfsLocation {
    /**
  ...
  class S3Location protected ()
    extends typingsJapgolly.pulumiAws.s3LocationMod.S3Location {
    /**
  ...
  class Task protected ()
    extends typingsJapgolly.pulumiAws.taskMod.Task {
    /**
