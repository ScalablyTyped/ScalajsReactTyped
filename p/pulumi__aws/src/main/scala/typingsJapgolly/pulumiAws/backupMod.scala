...
object backupMod extends js.Object {
  ...
  class Plan protected ()
    extends typingsJapgolly.pulumiAws.planMod.Plan {
    /**
  ...
  class Selection protected ()
    extends typingsJapgolly.pulumiAws.selectionMod.Selection {
    /**
  ...
  class Vault protected ()
    extends typingsJapgolly.pulumiAws.vaultMod.Vault {
    /**
