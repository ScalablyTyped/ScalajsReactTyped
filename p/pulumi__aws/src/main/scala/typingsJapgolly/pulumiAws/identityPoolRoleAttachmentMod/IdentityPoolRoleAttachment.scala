...
import typingsJapgolly.pulumiAws.outputMod.cognito.IdentityPoolRoleAttachmentRoleMapping
import typingsJapgolly.pulumiAws.outputMod.cognito.IdentityPoolRoleAttachmentRoles
