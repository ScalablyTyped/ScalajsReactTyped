package typingsJapgolly.pulumiAws.providerMod

import typingsJapgolly.pulumiAws.inputMod.ProviderAssumeRole
import typingsJapgolly.pulumiAws.inputMod.ProviderEndpoint
