package typingsJapgolly.pulumiAws.getTableMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.pulumiAws.outputMod.dynamodb.GetTableAttribute
import typingsJapgolly.pulumiAws.outputMod.dynamodb.GetTableGlobalSecondaryIndex
import typingsJapgolly.pulumiAws.outputMod.dynamodb.GetTableLocalSecondaryIndex
import typingsJapgolly.pulumiAws.outputMod.dynamodb.GetTablePointInTimeRecovery
import typingsJapgolly.pulumiAws.outputMod.dynamodb.GetTableServerSideEncryption
import typingsJapgolly.pulumiAws.outputMod.dynamodb.GetTableTtl
