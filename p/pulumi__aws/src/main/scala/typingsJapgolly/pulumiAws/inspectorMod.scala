...
object inspectorMod extends js.Object {
  ...
  class AssessmentTarget protected ()
    extends typingsJapgolly.pulumiAws.assessmentTargetMod.AssessmentTarget {
    /**
  ...
  class AssessmentTemplate protected ()
    extends typingsJapgolly.pulumiAws.assessmentTemplateMod.AssessmentTemplate {
    /**
  ...
  class ResourceGroup protected ()
    extends typingsJapgolly.pulumiAws.resourceGroupMod.ResourceGroup {
    /**
