...
object cloudfrontMod extends js.Object {
  ...
  class Distribution protected ()
    extends typingsJapgolly.pulumiAws.distributionMod.Distribution {
    /**
  ...
  class OriginAccessIdentity protected ()
    extends typingsJapgolly.pulumiAws.originAccessIdentityMod.OriginAccessIdentity {
    /**
  ...
  class PublicKey protected ()
    extends typingsJapgolly.pulumiAws.publicKeyMod.PublicKey {
    /**
