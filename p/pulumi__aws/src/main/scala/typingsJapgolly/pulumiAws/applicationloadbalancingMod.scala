...
object applicationloadbalancingMod extends js.Object {
  ...
  class Listener protected ()
    extends typingsJapgolly.pulumiAws.applicationloadbalancingListenerMod.Listener {
    /**
  ...
  class ListenerCertificate protected ()
    extends typingsJapgolly.pulumiAws.applicationloadbalancingListenerCertificateMod.ListenerCertificate {
    /**
  ...
  class ListenerRule protected ()
    extends typingsJapgolly.pulumiAws.applicationloadbalancingListenerRuleMod.ListenerRule {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsJapgolly.pulumiAws.applicationloadbalancingLoadBalancerMod.LoadBalancer {
    /**
  ...
  class TargetGroup protected ()
    extends typingsJapgolly.pulumiAws.applicationloadbalancingTargetGroupMod.TargetGroup {
    /**
  ...
  class TargetGroupAttachment protected ()
    extends typingsJapgolly.pulumiAws.applicationloadbalancingTargetGroupAttachmentMod.TargetGroupAttachment {
    /**
