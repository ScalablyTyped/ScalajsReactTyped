...
object codebuildMod extends js.Object {
  ...
  class Project protected ()
    extends typingsJapgolly.pulumiAws.projectMod.Project {
    /**
  ...
  class SourceCredential protected ()
    extends typingsJapgolly.pulumiAws.sourceCredentialMod.SourceCredential {
    /**
  ...
  class Webhook protected ()
    extends typingsJapgolly.pulumiAws.webhookMod.Webhook {
    /**
