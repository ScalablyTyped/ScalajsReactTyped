...
object ssmMod extends js.Object {
  ...
  class Activation protected ()
    extends typingsJapgolly.pulumiAws.activationMod.Activation {
    /**
  ...
  class Association protected ()
    extends typingsJapgolly.pulumiAws.ssmAssociationMod.Association {
    /**
  ...
  class Document protected ()
    extends typingsJapgolly.pulumiAws.documentMod.Document {
    /**
  ...
  class MaintenanceWindow protected ()
    extends typingsJapgolly.pulumiAws.maintenanceWindowMod.MaintenanceWindow {
    /**
  ...
  class MaintenanceWindowTarget protected ()
    extends typingsJapgolly.pulumiAws.maintenanceWindowTargetMod.MaintenanceWindowTarget {
    /**
  ...
  class MaintenanceWindowTask protected ()
    extends typingsJapgolly.pulumiAws.maintenanceWindowTaskMod.MaintenanceWindowTask {
    /**
  ...
  class Parameter protected ()
    extends typingsJapgolly.pulumiAws.parameterMod.Parameter {
    /**
  ...
  class PatchBaseline protected ()
    extends typingsJapgolly.pulumiAws.patchBaselineMod.PatchBaseline {
    /**
  ...
  class PatchGroup protected ()
    extends typingsJapgolly.pulumiAws.patchGroupMod.PatchGroup {
    /**
  ...
  class ResourceDataSync protected ()
    extends typingsJapgolly.pulumiAws.resourceDataSyncMod.ResourceDataSync {
    /**
