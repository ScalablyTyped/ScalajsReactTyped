...
object sagemakerMod extends js.Object {
  ...
  class Endpoint protected ()
    extends typingsJapgolly.pulumiAws.sagemakerEndpointMod.Endpoint {
    /**
  ...
  class EndpointConfiguration protected ()
    extends typingsJapgolly.pulumiAws.endpointConfigurationMod.EndpointConfiguration {
    /**
  ...
  class Model protected ()
    extends typingsJapgolly.pulumiAws.sagemakerModelMod.Model {
    /**
  ...
  class NotebookInstance protected ()
    extends typingsJapgolly.pulumiAws.notebookInstanceMod.NotebookInstance {
    /**
  ...
  class NotebookInstanceLifecycleConfiguration protected ()
    extends typingsJapgolly.pulumiAws.notebookInstanceLifecycleConfigurationMod.NotebookInstanceLifecycleConfiguration {
    /**
