...
object ecrMod extends js.Object {
  ...
  class LifecyclePolicy protected ()
    extends typingsJapgolly.pulumiAws.ecrLifecyclePolicyMod.LifecyclePolicy {
    /**
  ...
  class Repository protected ()
    extends typingsJapgolly.pulumiAws.ecrRepositoryMod.Repository {
    /**
  ...
  class RepositoryPolicy protected ()
    extends typingsJapgolly.pulumiAws.repositoryPolicyMod.RepositoryPolicy {
    /**
