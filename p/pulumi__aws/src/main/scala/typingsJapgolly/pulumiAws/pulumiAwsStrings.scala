...
import typingsJapgolly.pulumiAws.cannedAclMod.CannedAcl
import typingsJapgolly.pulumiAws.containerMod.KernelCapability
import typingsJapgolly.pulumiAws.containerMod.LogDriver
import typingsJapgolly.pulumiAws.containerMod.Protocol
import typingsJapgolly.pulumiAws.containerMod.UlimitName
import typingsJapgolly.pulumiAws.documentsMod.Principal
import typingsJapgolly.pulumiAws.engineModeMod.EngineMode
import typingsJapgolly.pulumiAws.engineTypeMod.EngineType
...
import typingsJapgolly.pulumiAws.protocolTypeMod.ProtocolType
...
import typingsJapgolly.pulumiAws.storageTypeMod.StorageType
...
object pulumiAwsStrings {
  ...
  sealed trait application
    extends LoadBalancerType
       with typingsJapgolly.pulumiAws.loadBalancerTypeMod.LoadBalancerType
  ...
  sealed trait dbDotm1Dotlarge
    extends typingsJapgolly.pulumiAws.rdsInstanceTypeMod.InstanceType
  ...
  sealed trait dualstack
    extends IpAddressType
       with typingsJapgolly.pulumiAws.ipAddressTypeMod.IpAddressType
