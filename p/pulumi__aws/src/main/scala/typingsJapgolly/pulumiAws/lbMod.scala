...
object lbMod extends js.Object {
  ...
  class Listener protected ()
    extends typingsJapgolly.pulumiAws.lbListenerMod.Listener {
    /**
  ...
  class ListenerCertificate protected ()
    extends typingsJapgolly.pulumiAws.lbListenerCertificateMod.ListenerCertificate {
    /**
  ...
  class ListenerRule protected ()
    extends typingsJapgolly.pulumiAws.lbListenerRuleMod.ListenerRule {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsJapgolly.pulumiAws.lbLoadBalancerMod.LoadBalancer {
    /**
  ...
  class TargetGroup protected ()
    extends typingsJapgolly.pulumiAws.lbTargetGroupMod.TargetGroup {
    /**
  ...
  class TargetGroupAttachment protected ()
    extends typingsJapgolly.pulumiAws.lbTargetGroupAttachmentMod.TargetGroupAttachment {
    /**
