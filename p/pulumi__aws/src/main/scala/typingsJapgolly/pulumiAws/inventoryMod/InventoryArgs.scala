package typingsJapgolly.pulumiAws.inventoryMod

import typingsJapgolly.pulumiAws.inputMod.s3.InventoryDestination
import typingsJapgolly.pulumiAws.inputMod.s3.InventoryFilter
import typingsJapgolly.pulumiAws.inputMod.s3.InventorySchedule
