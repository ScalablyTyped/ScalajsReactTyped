...
import typingsJapgolly.pulumiAws.haproxyLayerMod.HaproxyLayerArgs
import typingsJapgolly.pulumiAws.haproxyLayerMod.HaproxyLayerState
...
class HaproxyLayer protected ()
  extends typingsJapgolly.pulumiAws.haproxyLayerMod.HaproxyLayer {
  /**
...
object HaproxyLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.haproxyLayerMod.HaproxyLayer = js.native
  def get(name: String, id: Input[ID], state: HaproxyLayerState): typingsJapgolly.pulumiAws.haproxyLayerMod.HaproxyLayer = js.native
  def get(name: String, id: Input[ID], state: HaproxyLayerState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.haproxyLayerMod.HaproxyLayer = js.native
  /**
