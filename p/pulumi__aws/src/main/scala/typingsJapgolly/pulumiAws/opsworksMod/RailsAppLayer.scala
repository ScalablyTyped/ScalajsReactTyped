...
import typingsJapgolly.pulumiAws.railsAppLayerMod.RailsAppLayerArgs
import typingsJapgolly.pulumiAws.railsAppLayerMod.RailsAppLayerState
...
class RailsAppLayer protected ()
  extends typingsJapgolly.pulumiAws.railsAppLayerMod.RailsAppLayer {
  /**
...
object RailsAppLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.railsAppLayerMod.RailsAppLayer = js.native
  def get(name: String, id: Input[ID], state: RailsAppLayerState): typingsJapgolly.pulumiAws.railsAppLayerMod.RailsAppLayer = js.native
  def get(name: String, id: Input[ID], state: RailsAppLayerState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.railsAppLayerMod.RailsAppLayer = js.native
  /**
