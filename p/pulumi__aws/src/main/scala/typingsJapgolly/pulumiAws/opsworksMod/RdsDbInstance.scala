...
import typingsJapgolly.pulumiAws.rdsDbInstanceMod.RdsDbInstanceArgs
import typingsJapgolly.pulumiAws.rdsDbInstanceMod.RdsDbInstanceState
...
class RdsDbInstance protected ()
  extends typingsJapgolly.pulumiAws.rdsDbInstanceMod.RdsDbInstance {
  /**
...
object RdsDbInstance extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.rdsDbInstanceMod.RdsDbInstance = js.native
  def get(name: String, id: Input[ID], state: RdsDbInstanceState): typingsJapgolly.pulumiAws.rdsDbInstanceMod.RdsDbInstance = js.native
  def get(name: String, id: Input[ID], state: RdsDbInstanceState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.rdsDbInstanceMod.RdsDbInstance = js.native
  /**
