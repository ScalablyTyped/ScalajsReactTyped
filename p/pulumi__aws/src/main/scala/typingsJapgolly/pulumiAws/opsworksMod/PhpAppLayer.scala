...
import typingsJapgolly.pulumiAws.phpAppLayerMod.PhpAppLayerArgs
import typingsJapgolly.pulumiAws.phpAppLayerMod.PhpAppLayerState
...
class PhpAppLayer protected ()
  extends typingsJapgolly.pulumiAws.phpAppLayerMod.PhpAppLayer {
  /**
...
object PhpAppLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.phpAppLayerMod.PhpAppLayer = js.native
  def get(name: String, id: Input[ID], state: PhpAppLayerState): typingsJapgolly.pulumiAws.phpAppLayerMod.PhpAppLayer = js.native
  def get(name: String, id: Input[ID], state: PhpAppLayerState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.phpAppLayerMod.PhpAppLayer = js.native
  /**
