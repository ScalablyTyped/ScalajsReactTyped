...
import typingsJapgolly.pulumiAws.geoMatchSetMod.GeoMatchSetArgs
import typingsJapgolly.pulumiAws.geoMatchSetMod.GeoMatchSetState
...
class GeoMatchSet protected ()
  extends typingsJapgolly.pulumiAws.geoMatchSetMod.GeoMatchSet {
  /**
...
object GeoMatchSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.geoMatchSetMod.GeoMatchSet = js.native
  def get(name: String, id: Input[ID], state: GeoMatchSetState): typingsJapgolly.pulumiAws.geoMatchSetMod.GeoMatchSet = js.native
  def get(name: String, id: Input[ID], state: GeoMatchSetState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.geoMatchSetMod.GeoMatchSet = js.native
  /**
