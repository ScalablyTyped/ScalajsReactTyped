...
import typingsJapgolly.pulumiAws.regexMatchSetMod.RegexMatchSetArgs
import typingsJapgolly.pulumiAws.regexMatchSetMod.RegexMatchSetState
...
class RegexMatchSet protected ()
  extends typingsJapgolly.pulumiAws.regexMatchSetMod.RegexMatchSet {
  /**
...
object RegexMatchSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.regexMatchSetMod.RegexMatchSet = js.native
  def get(name: String, id: Input[ID], state: RegexMatchSetState): typingsJapgolly.pulumiAws.regexMatchSetMod.RegexMatchSet = js.native
  def get(name: String, id: Input[ID], state: RegexMatchSetState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.regexMatchSetMod.RegexMatchSet = js.native
  /**
