...
import typingsJapgolly.pulumiAws.outputMod.elasticbeanstalk.EnvironmentAllSetting
import typingsJapgolly.pulumiAws.outputMod.elasticbeanstalk.EnvironmentSetting
