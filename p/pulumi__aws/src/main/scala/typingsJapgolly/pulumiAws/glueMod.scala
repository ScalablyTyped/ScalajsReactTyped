...
object glueMod extends js.Object {
  ...
  class CatalogDatabase protected ()
    extends typingsJapgolly.pulumiAws.catalogDatabaseMod.CatalogDatabase {
    /**
  ...
  class CatalogTable protected ()
    extends typingsJapgolly.pulumiAws.catalogTableMod.CatalogTable {
    /**
  ...
  class Classifier protected ()
    extends typingsJapgolly.pulumiAws.classifierMod.Classifier {
    /**
  ...
  class Connection protected ()
    extends typingsJapgolly.pulumiAws.glueConnectionMod.Connection {
    /**
  ...
  class Crawler protected ()
    extends typingsJapgolly.pulumiAws.crawlerMod.Crawler {
    /**
  ...
  @js.native
  class Job protected ()
    extends typingsJapgolly.pulumiAws.jobMod.Job {
    /**
  ...
  class SecurityConfiguration protected ()
    extends typingsJapgolly.pulumiAws.glueSecurityConfigurationMod.SecurityConfiguration {
    /**
  ...
  class Trigger protected ()
    extends typingsJapgolly.pulumiAws.glueTriggerMod.Trigger {
    /**
  ...
  class Workflow protected ()
    extends typingsJapgolly.pulumiAws.workflowMod.Workflow {
    /**
