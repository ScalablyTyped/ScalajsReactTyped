package typingsJapgolly.pulumiAws.phpAppLayerMod

import typingsJapgolly.pulumiAws.outputMod.opsworks.PhpAppLayerEbsVolume
...
@js.native
class PhpAppLayer protected () extends CustomResource {
  /**
  ...
  /**
    ...
    */
  val ebsVolumes: Output_[js.UndefOr[js.Array[PhpAppLayerEbsVolume]]] = js.native
  /**
