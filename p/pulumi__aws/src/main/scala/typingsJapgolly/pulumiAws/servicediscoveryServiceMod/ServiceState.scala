...
import typingsJapgolly.pulumiAws.inputMod.servicediscovery.ServiceDnsConfig
import typingsJapgolly.pulumiAws.inputMod.servicediscovery.ServiceHealthCheckConfig
import typingsJapgolly.pulumiAws.inputMod.servicediscovery.ServiceHealthCheckCustomConfig
