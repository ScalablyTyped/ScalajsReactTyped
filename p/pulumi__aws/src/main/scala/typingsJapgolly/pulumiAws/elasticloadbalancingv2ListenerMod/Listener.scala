package typingsJapgolly.pulumiAws.elasticloadbalancingv2ListenerMod

import typingsJapgolly.pulumiAws.outputMod.elasticloadbalancingv2.ListenerDefaultAction
