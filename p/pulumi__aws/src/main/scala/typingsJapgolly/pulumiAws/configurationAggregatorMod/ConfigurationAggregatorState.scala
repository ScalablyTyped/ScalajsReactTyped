...
import typingsJapgolly.pulumiAws.inputMod.cfg.ConfigurationAggregatorAccountAggregationSource
import typingsJapgolly.pulumiAws.inputMod.cfg.ConfigurationAggregatorOrganizationAggregationSource
