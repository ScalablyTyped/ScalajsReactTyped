package typingsJapgolly.pulumiAws.lbGetLoadBalancerMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.pulumiAws.outputMod.lb.GetLoadBalancerAccessLogs
import typingsJapgolly.pulumiAws.outputMod.lb.GetLoadBalancerSubnetMapping
