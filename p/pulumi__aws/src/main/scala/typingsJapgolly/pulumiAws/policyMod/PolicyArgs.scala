...
import typingsJapgolly.pulumiAws.inputMod.appautoscaling.PolicyStepScalingPolicyConfiguration
import typingsJapgolly.pulumiAws.inputMod.appautoscaling.PolicyTargetTrackingScalingPolicyConfiguration
