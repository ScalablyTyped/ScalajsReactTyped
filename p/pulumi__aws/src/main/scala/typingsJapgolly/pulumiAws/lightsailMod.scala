...
object lightsailMod extends js.Object {
  ...
  class Domain protected ()
    extends typingsJapgolly.pulumiAws.lightsailDomainMod.Domain {
    /**
  ...
  class Instance protected ()
    extends typingsJapgolly.pulumiAws.lightsailInstanceMod.Instance {
    /**
  ...
  class KeyPair protected ()
    extends typingsJapgolly.pulumiAws.lightsailKeyPairMod.KeyPair {
    /**
  ...
  class StaticIp protected ()
    extends typingsJapgolly.pulumiAws.staticIpMod.StaticIp {
    /**
  ...
  class StaticIpAttachment protected ()
    extends typingsJapgolly.pulumiAws.staticIpAttachmentMod.StaticIpAttachment {
    /**
