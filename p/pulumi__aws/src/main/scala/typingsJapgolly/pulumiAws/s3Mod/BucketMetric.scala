...
import typingsJapgolly.pulumiAws.bucketMetricMod.BucketMetricArgs
import typingsJapgolly.pulumiAws.bucketMetricMod.BucketMetricState
...
class BucketMetric protected ()
  extends typingsJapgolly.pulumiAws.bucketMetricMod.BucketMetric {
  /**
...
object BucketMetric extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.bucketMetricMod.BucketMetric = js.native
  def get(name: String, id: Input[ID], state: BucketMetricState): typingsJapgolly.pulumiAws.bucketMetricMod.BucketMetric = js.native
  def get(name: String, id: Input[ID], state: BucketMetricState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.bucketMetricMod.BucketMetric = js.native
  /**
