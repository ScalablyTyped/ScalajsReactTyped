package typingsJapgolly.pulumiAws.loadBalancerPolicyMod

import typingsJapgolly.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerPolicyPolicyAttribute
