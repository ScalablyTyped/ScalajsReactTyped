...
import typingsJapgolly.pulumiAws.amiLaunchPermissionMod.AmiLaunchPermissionArgs
import typingsJapgolly.pulumiAws.amiLaunchPermissionMod.AmiLaunchPermissionState
...
class AmiLaunchPermission protected ()
  extends typingsJapgolly.pulumiAws.amiLaunchPermissionMod.AmiLaunchPermission {
  /**
...
object AmiLaunchPermission extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.amiLaunchPermissionMod.AmiLaunchPermission = js.native
  def get(name: String, id: Input[ID], state: AmiLaunchPermissionState): typingsJapgolly.pulumiAws.amiLaunchPermissionMod.AmiLaunchPermission = js.native
  def get(name: String, id: Input[ID], state: AmiLaunchPermissionState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.amiLaunchPermissionMod.AmiLaunchPermission = js.native
  /**
