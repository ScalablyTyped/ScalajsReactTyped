...
import typingsJapgolly.pulumiAws.peeringConnectionOptionsMod.PeeringConnectionOptionsArgs
import typingsJapgolly.pulumiAws.peeringConnectionOptionsMod.PeeringConnectionOptionsState
...
class PeeringConnectionOptions protected ()
  extends typingsJapgolly.pulumiAws.peeringConnectionOptionsMod.PeeringConnectionOptions {
  /**
...
object PeeringConnectionOptions extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.peeringConnectionOptionsMod.PeeringConnectionOptions = js.native
  def get(name: String, id: Input[ID], state: PeeringConnectionOptionsState): typingsJapgolly.pulumiAws.peeringConnectionOptionsMod.PeeringConnectionOptions = js.native
  def get(name: String, id: Input[ID], state: PeeringConnectionOptionsState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.peeringConnectionOptionsMod.PeeringConnectionOptions = js.native
  /**
