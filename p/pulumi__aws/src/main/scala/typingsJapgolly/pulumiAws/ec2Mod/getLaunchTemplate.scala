...
import typingsJapgolly.pulumiAws.getLaunchTemplateMod.GetLaunchTemplateArgs
import typingsJapgolly.pulumiAws.getLaunchTemplateMod.GetLaunchTemplateResult
