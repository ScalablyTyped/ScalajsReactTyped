...
import typingsJapgolly.pulumiAws.proxyProtocolPolicyMod.ProxyProtocolPolicyArgs
import typingsJapgolly.pulumiAws.proxyProtocolPolicyMod.ProxyProtocolPolicyState
...
class ProxyProtocolPolicy protected ()
  extends typingsJapgolly.pulumiAws.proxyProtocolPolicyMod.ProxyProtocolPolicy {
  /**
...
object ProxyProtocolPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.proxyProtocolPolicyMod.ProxyProtocolPolicy = js.native
  def get(name: String, id: Input[ID], state: ProxyProtocolPolicyState): typingsJapgolly.pulumiAws.proxyProtocolPolicyMod.ProxyProtocolPolicy = js.native
  def get(name: String, id: Input[ID], state: ProxyProtocolPolicyState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.proxyProtocolPolicyMod.ProxyProtocolPolicy = js.native
  /**
