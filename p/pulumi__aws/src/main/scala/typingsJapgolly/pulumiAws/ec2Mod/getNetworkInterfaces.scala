...
import typingsJapgolly.pulumiAws.getNetworkInterfacesMod.GetNetworkInterfacesArgs
import typingsJapgolly.pulumiAws.getNetworkInterfacesMod.GetNetworkInterfacesResult
