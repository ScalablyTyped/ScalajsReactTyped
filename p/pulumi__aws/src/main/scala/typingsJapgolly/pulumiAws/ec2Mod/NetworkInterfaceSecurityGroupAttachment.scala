...
import typingsJapgolly.pulumiAws.networkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachmentArgs
import typingsJapgolly.pulumiAws.networkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachmentState
...
class NetworkInterfaceSecurityGroupAttachment protected ()
  extends typingsJapgolly.pulumiAws.networkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachment {
  /**
...
object NetworkInterfaceSecurityGroupAttachment extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.networkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachment = js.native
  def get(name: String, id: Input[ID], state: NetworkInterfaceSecurityGroupAttachmentState): typingsJapgolly.pulumiAws.networkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachment = js.native
  def get(
    name: String,
    id: Input[ID],
    state: NetworkInterfaceSecurityGroupAttachmentState,
    opts: CustomResourceOptions
  ): typingsJapgolly.pulumiAws.networkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachment = js.native
  /**
