...
import typingsJapgolly.pulumiAws.defaultSecurityGroupMod.DefaultSecurityGroupArgs
import typingsJapgolly.pulumiAws.defaultSecurityGroupMod.DefaultSecurityGroupState
...
class DefaultSecurityGroup protected ()
  extends typingsJapgolly.pulumiAws.defaultSecurityGroupMod.DefaultSecurityGroup {
  /**
...
object DefaultSecurityGroup extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.defaultSecurityGroupMod.DefaultSecurityGroup = js.native
  def get(name: String, id: Input[ID], state: DefaultSecurityGroupState): typingsJapgolly.pulumiAws.defaultSecurityGroupMod.DefaultSecurityGroup = js.native
  def get(name: String, id: Input[ID], state: DefaultSecurityGroupState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.defaultSecurityGroupMod.DefaultSecurityGroup = js.native
  /**
