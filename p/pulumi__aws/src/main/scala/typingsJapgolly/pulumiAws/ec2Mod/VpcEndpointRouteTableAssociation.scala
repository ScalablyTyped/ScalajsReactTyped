...
import typingsJapgolly.pulumiAws.vpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociationArgs
import typingsJapgolly.pulumiAws.vpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociationState
...
class VpcEndpointRouteTableAssociation protected ()
  extends typingsJapgolly.pulumiAws.vpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociation {
  /**
...
object VpcEndpointRouteTableAssociation extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.vpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociation = js.native
  def get(name: String, id: Input[ID], state: VpcEndpointRouteTableAssociationState): typingsJapgolly.pulumiAws.vpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociation = js.native
  def get(
    name: String,
    id: Input[ID],
    state: VpcEndpointRouteTableAssociationState,
    opts: CustomResourceOptions
  ): typingsJapgolly.pulumiAws.vpcEndpointRouteTableAssociationMod.VpcEndpointRouteTableAssociation = js.native
  /**
