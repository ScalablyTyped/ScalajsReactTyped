...
import typingsJapgolly.pulumiAws.spotFleetRequestMod.SpotFleetRequestArgs
import typingsJapgolly.pulumiAws.spotFleetRequestMod.SpotFleetRequestState
...
class SpotFleetRequest protected ()
  extends typingsJapgolly.pulumiAws.spotFleetRequestMod.SpotFleetRequest {
  /**
...
object SpotFleetRequest extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.spotFleetRequestMod.SpotFleetRequest = js.native
  def get(name: String, id: Input[ID], state: SpotFleetRequestState): typingsJapgolly.pulumiAws.spotFleetRequestMod.SpotFleetRequest = js.native
  def get(name: String, id: Input[ID], state: SpotFleetRequestState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.spotFleetRequestMod.SpotFleetRequest = js.native
  /**
