...
import typingsJapgolly.pulumiAws.spotInstanceRequestMod.SpotInstanceRequestArgs
import typingsJapgolly.pulumiAws.spotInstanceRequestMod.SpotInstanceRequestState
...
class SpotInstanceRequest protected ()
  extends typingsJapgolly.pulumiAws.spotInstanceRequestMod.SpotInstanceRequest {
  /**
...
object SpotInstanceRequest extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.spotInstanceRequestMod.SpotInstanceRequest = js.native
  def get(name: String, id: Input[ID], state: SpotInstanceRequestState): typingsJapgolly.pulumiAws.spotInstanceRequestMod.SpotInstanceRequest = js.native
  def get(name: String, id: Input[ID], state: SpotInstanceRequestState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.spotInstanceRequestMod.SpotInstanceRequest = js.native
  /**
