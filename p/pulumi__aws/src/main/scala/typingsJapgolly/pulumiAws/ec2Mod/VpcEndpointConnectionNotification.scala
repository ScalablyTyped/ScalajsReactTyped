...
import typingsJapgolly.pulumiAws.vpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotificationArgs
import typingsJapgolly.pulumiAws.vpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotificationState
...
class VpcEndpointConnectionNotification protected ()
  extends typingsJapgolly.pulumiAws.vpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotification {
  /**
...
object VpcEndpointConnectionNotification extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.vpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotification = js.native
  def get(name: String, id: Input[ID], state: VpcEndpointConnectionNotificationState): typingsJapgolly.pulumiAws.vpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotification = js.native
  def get(
    name: String,
    id: Input[ID],
    state: VpcEndpointConnectionNotificationState,
    opts: CustomResourceOptions
  ): typingsJapgolly.pulumiAws.vpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotification = js.native
  /**
