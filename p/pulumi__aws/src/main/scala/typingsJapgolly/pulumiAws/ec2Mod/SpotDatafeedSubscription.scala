...
import typingsJapgolly.pulumiAws.spotDatafeedSubscriptionMod.SpotDatafeedSubscriptionArgs
import typingsJapgolly.pulumiAws.spotDatafeedSubscriptionMod.SpotDatafeedSubscriptionState
...
class SpotDatafeedSubscription protected ()
  extends typingsJapgolly.pulumiAws.spotDatafeedSubscriptionMod.SpotDatafeedSubscription {
  /**
...
object SpotDatafeedSubscription extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.spotDatafeedSubscriptionMod.SpotDatafeedSubscription = js.native
  def get(name: String, id: Input[ID], state: SpotDatafeedSubscriptionState): typingsJapgolly.pulumiAws.spotDatafeedSubscriptionMod.SpotDatafeedSubscription = js.native
  def get(name: String, id: Input[ID], state: SpotDatafeedSubscriptionState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.spotDatafeedSubscriptionMod.SpotDatafeedSubscription = js.native
  /**
