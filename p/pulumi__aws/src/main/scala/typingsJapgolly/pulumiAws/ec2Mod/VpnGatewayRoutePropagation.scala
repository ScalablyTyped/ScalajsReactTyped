...
import typingsJapgolly.pulumiAws.vpnGatewayRoutePropagationMod.VpnGatewayRoutePropagationArgs
import typingsJapgolly.pulumiAws.vpnGatewayRoutePropagationMod.VpnGatewayRoutePropagationState
...
class VpnGatewayRoutePropagation protected ()
  extends typingsJapgolly.pulumiAws.vpnGatewayRoutePropagationMod.VpnGatewayRoutePropagation {
  /**
...
object VpnGatewayRoutePropagation extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.vpnGatewayRoutePropagationMod.VpnGatewayRoutePropagation = js.native
  def get(name: String, id: Input[ID], state: VpnGatewayRoutePropagationState): typingsJapgolly.pulumiAws.vpnGatewayRoutePropagationMod.VpnGatewayRoutePropagation = js.native
  def get(name: String, id: Input[ID], state: VpnGatewayRoutePropagationState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.vpnGatewayRoutePropagationMod.VpnGatewayRoutePropagation = js.native
  /**
