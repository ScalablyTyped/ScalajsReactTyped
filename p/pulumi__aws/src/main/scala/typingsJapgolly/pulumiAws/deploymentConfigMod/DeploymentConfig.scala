package typingsJapgolly.pulumiAws.deploymentConfigMod

import typingsJapgolly.pulumiAws.outputMod.codedeploy.DeploymentConfigMinimumHealthyHosts
import typingsJapgolly.pulumiAws.outputMod.codedeploy.DeploymentConfigTrafficRoutingConfig
