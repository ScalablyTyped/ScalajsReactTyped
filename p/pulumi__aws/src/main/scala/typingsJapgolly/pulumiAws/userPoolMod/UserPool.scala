...
import typingsJapgolly.pulumiAws.outputMod.cognito.UserPoolAdminCreateUserConfig
import typingsJapgolly.pulumiAws.outputMod.cognito.UserPoolDeviceConfiguration
import typingsJapgolly.pulumiAws.outputMod.cognito.UserPoolEmailConfiguration
import typingsJapgolly.pulumiAws.outputMod.cognito.UserPoolLambdaConfig
import typingsJapgolly.pulumiAws.outputMod.cognito.UserPoolPasswordPolicy
import typingsJapgolly.pulumiAws.outputMod.cognito.UserPoolSchema
import typingsJapgolly.pulumiAws.outputMod.cognito.UserPoolSmsConfiguration
import typingsJapgolly.pulumiAws.outputMod.cognito.UserPoolUserPoolAddOns
import typingsJapgolly.pulumiAws.outputMod.cognito.UserPoolVerificationMessageTemplate
