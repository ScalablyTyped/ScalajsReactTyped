...
import typingsJapgolly.pulumiAws.outputMod.opsworks.InstanceEbsBlockDevice
import typingsJapgolly.pulumiAws.outputMod.opsworks.InstanceEphemeralBlockDevice
import typingsJapgolly.pulumiAws.outputMod.opsworks.InstanceRootBlockDevice
