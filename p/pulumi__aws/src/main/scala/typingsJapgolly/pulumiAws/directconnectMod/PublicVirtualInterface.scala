...
import typingsJapgolly.pulumiAws.publicVirtualInterfaceMod.PublicVirtualInterfaceArgs
import typingsJapgolly.pulumiAws.publicVirtualInterfaceMod.PublicVirtualInterfaceState
...
class PublicVirtualInterface protected ()
  extends typingsJapgolly.pulumiAws.publicVirtualInterfaceMod.PublicVirtualInterface {
  /**
...
object PublicVirtualInterface extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.publicVirtualInterfaceMod.PublicVirtualInterface = js.native
  def get(name: String, id: Input[ID], state: PublicVirtualInterfaceState): typingsJapgolly.pulumiAws.publicVirtualInterfaceMod.PublicVirtualInterface = js.native
  def get(name: String, id: Input[ID], state: PublicVirtualInterfaceState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.publicVirtualInterfaceMod.PublicVirtualInterface = js.native
  /**
