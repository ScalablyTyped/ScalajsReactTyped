...
import typingsJapgolly.pulumiAws.linkAggregationGroupMod.LinkAggregationGroupArgs
import typingsJapgolly.pulumiAws.linkAggregationGroupMod.LinkAggregationGroupState
...
class LinkAggregationGroup protected ()
  extends typingsJapgolly.pulumiAws.linkAggregationGroupMod.LinkAggregationGroup {
  /**
...
object LinkAggregationGroup extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.linkAggregationGroupMod.LinkAggregationGroup = js.native
  def get(name: String, id: Input[ID], state: LinkAggregationGroupState): typingsJapgolly.pulumiAws.linkAggregationGroupMod.LinkAggregationGroup = js.native
  def get(name: String, id: Input[ID], state: LinkAggregationGroupState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.linkAggregationGroupMod.LinkAggregationGroup = js.native
  /**
