...
import typingsJapgolly.pulumiAws.connectionAssociationMod.ConnectionAssociationArgs
import typingsJapgolly.pulumiAws.connectionAssociationMod.ConnectionAssociationState
...
class ConnectionAssociation protected ()
  extends typingsJapgolly.pulumiAws.connectionAssociationMod.ConnectionAssociation {
  /**
...
object ConnectionAssociation extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.connectionAssociationMod.ConnectionAssociation = js.native
  def get(name: String, id: Input[ID], state: ConnectionAssociationState): typingsJapgolly.pulumiAws.connectionAssociationMod.ConnectionAssociation = js.native
  def get(name: String, id: Input[ID], state: ConnectionAssociationState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.connectionAssociationMod.ConnectionAssociation = js.native
  /**
