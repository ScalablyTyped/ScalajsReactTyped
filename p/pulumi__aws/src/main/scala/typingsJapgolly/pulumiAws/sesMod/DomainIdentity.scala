...
import typingsJapgolly.pulumiAws.domainIdentityMod.DomainIdentityArgs
import typingsJapgolly.pulumiAws.domainIdentityMod.DomainIdentityState
...
class DomainIdentity protected ()
  extends typingsJapgolly.pulumiAws.domainIdentityMod.DomainIdentity {
  /**
...
object DomainIdentity extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.domainIdentityMod.DomainIdentity = js.native
  def get(name: String, id: Input[ID], state: DomainIdentityState): typingsJapgolly.pulumiAws.domainIdentityMod.DomainIdentity = js.native
  def get(name: String, id: Input[ID], state: DomainIdentityState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.domainIdentityMod.DomainIdentity = js.native
  /**
