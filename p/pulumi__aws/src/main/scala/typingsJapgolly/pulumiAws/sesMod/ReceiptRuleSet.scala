...
import typingsJapgolly.pulumiAws.receiptRuleSetMod.ReceiptRuleSetArgs
import typingsJapgolly.pulumiAws.receiptRuleSetMod.ReceiptRuleSetState
...
class ReceiptRuleSet protected ()
  extends typingsJapgolly.pulumiAws.receiptRuleSetMod.ReceiptRuleSet {
  /**
...
object ReceiptRuleSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.receiptRuleSetMod.ReceiptRuleSet = js.native
  def get(name: String, id: Input[ID], state: ReceiptRuleSetState): typingsJapgolly.pulumiAws.receiptRuleSetMod.ReceiptRuleSet = js.native
  def get(name: String, id: Input[ID], state: ReceiptRuleSetState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.receiptRuleSetMod.ReceiptRuleSet = js.native
  /**
