...
import typingsJapgolly.pulumiAws.domainIdentityVerificationMod.DomainIdentityVerificationArgs
import typingsJapgolly.pulumiAws.domainIdentityVerificationMod.DomainIdentityVerificationState
...
class DomainIdentityVerification protected ()
  extends typingsJapgolly.pulumiAws.domainIdentityVerificationMod.DomainIdentityVerification {
  /**
...
object DomainIdentityVerification extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.domainIdentityVerificationMod.DomainIdentityVerification = js.native
  def get(name: String, id: Input[ID], state: DomainIdentityVerificationState): typingsJapgolly.pulumiAws.domainIdentityVerificationMod.DomainIdentityVerification = js.native
  def get(name: String, id: Input[ID], state: DomainIdentityVerificationState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.domainIdentityVerificationMod.DomainIdentityVerification = js.native
  /**
