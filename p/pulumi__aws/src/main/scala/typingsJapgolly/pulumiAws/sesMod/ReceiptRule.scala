...
import typingsJapgolly.pulumiAws.receiptRuleMod.ReceiptRuleArgs
import typingsJapgolly.pulumiAws.receiptRuleMod.ReceiptRuleState
...
class ReceiptRule protected ()
  extends typingsJapgolly.pulumiAws.receiptRuleMod.ReceiptRule {
  /**
...
object ReceiptRule extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.receiptRuleMod.ReceiptRule = js.native
  def get(name: String, id: Input[ID], state: ReceiptRuleState): typingsJapgolly.pulumiAws.receiptRuleMod.ReceiptRule = js.native
  def get(name: String, id: Input[ID], state: ReceiptRuleState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.receiptRuleMod.ReceiptRule = js.native
  /**
