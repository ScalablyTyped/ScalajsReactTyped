package typingsJapgolly.pulumiAws.elasticloadbalancingv2GetListenerMod

import typingsJapgolly.pulumiAws.outputMod.elasticloadbalancingv2.GetListenerDefaultAction
