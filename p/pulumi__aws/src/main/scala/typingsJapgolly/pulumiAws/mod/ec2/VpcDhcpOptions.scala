...
import typingsJapgolly.pulumiAws.vpcDhcpOptionsMod.VpcDhcpOptionsArgs
import typingsJapgolly.pulumiAws.vpcDhcpOptionsMod.VpcDhcpOptionsState
...
class VpcDhcpOptions protected ()
  extends typingsJapgolly.pulumiAws.ec2Mod.VpcDhcpOptions {
  /**
...
object VpcDhcpOptions extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.vpcDhcpOptionsMod.VpcDhcpOptions = js.native
  def get(name: String, id: Input[ID], state: VpcDhcpOptionsState): typingsJapgolly.pulumiAws.vpcDhcpOptionsMod.VpcDhcpOptions = js.native
  def get(name: String, id: Input[ID], state: VpcDhcpOptionsState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.vpcDhcpOptionsMod.VpcDhcpOptions = js.native
  /**
