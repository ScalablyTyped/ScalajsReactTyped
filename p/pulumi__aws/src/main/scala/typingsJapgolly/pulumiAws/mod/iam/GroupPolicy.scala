...
import typingsJapgolly.pulumiAws.groupPolicyMod.GroupPolicyArgs
import typingsJapgolly.pulumiAws.groupPolicyMod.GroupPolicyState
...
class GroupPolicy protected ()
  extends typingsJapgolly.pulumiAws.iamMod.GroupPolicy {
  /**
...
object GroupPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.groupPolicyMod.GroupPolicy = js.native
  def get(name: String, id: Input[ID], state: GroupPolicyState): typingsJapgolly.pulumiAws.groupPolicyMod.GroupPolicy = js.native
  def get(name: String, id: Input[ID], state: GroupPolicyState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.groupPolicyMod.GroupPolicy = js.native
  /**
