...
object autoscaling extends js.Object {
  ...
  class Attachment protected ()
    extends typingsJapgolly.pulumiAws.autoscalingMod.Attachment {
    /**
  ...
  class Group protected ()
    extends typingsJapgolly.pulumiAws.autoscalingMod.Group {
    /**
  ...
  class LifecycleHook protected ()
    extends typingsJapgolly.pulumiAws.autoscalingMod.LifecycleHook {
    /**
  ...
  class Notification protected ()
    extends typingsJapgolly.pulumiAws.autoscalingMod.Notification {
    /**
  ...
  class Policy protected ()
    extends typingsJapgolly.pulumiAws.autoscalingMod.Policy {
    /**
  ...
  class Schedule protected ()
    extends typingsJapgolly.pulumiAws.autoscalingMod.Schedule {
    /**
