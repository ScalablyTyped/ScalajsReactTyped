...
object kms extends js.Object {
  ...
  class Alias protected ()
    extends typingsJapgolly.pulumiAws.kmsMod.Alias {
    /**
  ...
  class Ciphertext protected ()
    extends typingsJapgolly.pulumiAws.kmsMod.Ciphertext {
    /**
  ...
  class ExternalKey protected ()
    extends typingsJapgolly.pulumiAws.kmsMod.ExternalKey {
    /**
  ...
  class Grant protected ()
    extends typingsJapgolly.pulumiAws.kmsMod.Grant {
    /**
  ...
  @js.native
  class Key protected ()
    extends typingsJapgolly.pulumiAws.kmsMod.Key {
    /**
