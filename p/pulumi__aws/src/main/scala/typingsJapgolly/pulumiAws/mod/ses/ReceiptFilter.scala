...
import typingsJapgolly.pulumiAws.receiptFilterMod.ReceiptFilterArgs
import typingsJapgolly.pulumiAws.receiptFilterMod.ReceiptFilterState
...
class ReceiptFilter protected ()
  extends typingsJapgolly.pulumiAws.sesMod.ReceiptFilter {
  /**
...
object ReceiptFilter extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.receiptFilterMod.ReceiptFilter = js.native
  def get(name: String, id: Input[ID], state: ReceiptFilterState): typingsJapgolly.pulumiAws.receiptFilterMod.ReceiptFilter = js.native
  def get(name: String, id: Input[ID], state: ReceiptFilterState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.receiptFilterMod.ReceiptFilter = js.native
  /**
