...
import typingsJapgolly.pulumiAws.vpcLinkMod.VpcLinkArgs
import typingsJapgolly.pulumiAws.vpcLinkMod.VpcLinkState
...
class VpcLink protected ()
  extends typingsJapgolly.pulumiAws.apigatewayMod.VpcLink {
  /**
...
object VpcLink extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.vpcLinkMod.VpcLink = js.native
  def get(name: String, id: Input[ID], state: VpcLinkState): typingsJapgolly.pulumiAws.vpcLinkMod.VpcLink = js.native
  def get(name: String, id: Input[ID], state: VpcLinkState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.vpcLinkMod.VpcLink = js.native
  /**
