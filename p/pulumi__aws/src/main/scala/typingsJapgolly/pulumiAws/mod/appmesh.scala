...
object appmesh extends js.Object {
  ...
  class Mesh protected ()
    extends typingsJapgolly.pulumiAws.appmeshMod.Mesh {
    /**
  ...
  class Route protected ()
    extends typingsJapgolly.pulumiAws.appmeshMod.Route {
    /**
  ...
  class VirtualNode protected ()
    extends typingsJapgolly.pulumiAws.appmeshMod.VirtualNode {
    /**
  ...
  class VirtualRouter protected ()
    extends typingsJapgolly.pulumiAws.appmeshMod.VirtualRouter {
    /**
  ...
  class VirtualService protected ()
    extends typingsJapgolly.pulumiAws.appmeshMod.VirtualService {
    /**
