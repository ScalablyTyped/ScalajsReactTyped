...
import typingsJapgolly.pulumiAws.gatewayAssociationMod.GatewayAssociationArgs
import typingsJapgolly.pulumiAws.gatewayAssociationMod.GatewayAssociationState
...
class GatewayAssociation protected ()
  extends typingsJapgolly.pulumiAws.directconnectMod.GatewayAssociation {
  /**
...
object GatewayAssociation extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.gatewayAssociationMod.GatewayAssociation = js.native
  def get(name: String, id: Input[ID], state: GatewayAssociationState): typingsJapgolly.pulumiAws.gatewayAssociationMod.GatewayAssociation = js.native
  def get(name: String, id: Input[ID], state: GatewayAssociationState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.gatewayAssociationMod.GatewayAssociation = js.native
  /**
