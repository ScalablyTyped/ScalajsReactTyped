...
import typingsJapgolly.pulumiAws.memcachedLayerMod.MemcachedLayerArgs
import typingsJapgolly.pulumiAws.memcachedLayerMod.MemcachedLayerState
...
class MemcachedLayer protected ()
  extends typingsJapgolly.pulumiAws.opsworksMod.MemcachedLayer {
  /**
...
object MemcachedLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.memcachedLayerMod.MemcachedLayer = js.native
  def get(name: String, id: Input[ID], state: MemcachedLayerState): typingsJapgolly.pulumiAws.memcachedLayerMod.MemcachedLayer = js.native
  def get(name: String, id: Input[ID], state: MemcachedLayerState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.memcachedLayerMod.MemcachedLayer = js.native
  /**
