...
object alb extends js.Object {
  ...
  class Listener protected ()
    extends typingsJapgolly.pulumiAws.albMod.Listener {
    /**
  ...
  class ListenerCertificate protected ()
    extends typingsJapgolly.pulumiAws.albMod.ListenerCertificate {
    /**
  ...
  class ListenerRule protected ()
    extends typingsJapgolly.pulumiAws.albMod.ListenerRule {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsJapgolly.pulumiAws.albMod.LoadBalancer {
    /**
  ...
  class TargetGroup protected ()
    extends typingsJapgolly.pulumiAws.albMod.TargetGroup {
    /**
  ...
  class TargetGroupAttachment protected ()
    extends typingsJapgolly.pulumiAws.albMod.TargetGroupAttachment {
    /**
