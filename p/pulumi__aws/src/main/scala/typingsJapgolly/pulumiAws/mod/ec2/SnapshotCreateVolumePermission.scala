...
import typingsJapgolly.pulumiAws.snapshotCreateVolumePermissionMod.SnapshotCreateVolumePermissionArgs
import typingsJapgolly.pulumiAws.snapshotCreateVolumePermissionMod.SnapshotCreateVolumePermissionState
...
class SnapshotCreateVolumePermission protected ()
  extends typingsJapgolly.pulumiAws.ec2Mod.SnapshotCreateVolumePermission {
  /**
...
object SnapshotCreateVolumePermission extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.snapshotCreateVolumePermissionMod.SnapshotCreateVolumePermission = js.native
  def get(name: String, id: Input[ID], state: SnapshotCreateVolumePermissionState): typingsJapgolly.pulumiAws.snapshotCreateVolumePermissionMod.SnapshotCreateVolumePermission = js.native
  def get(
    name: String,
    id: Input[ID],
    state: SnapshotCreateVolumePermissionState,
    opts: CustomResourceOptions
  ): typingsJapgolly.pulumiAws.snapshotCreateVolumePermissionMod.SnapshotCreateVolumePermission = js.native
  /**
