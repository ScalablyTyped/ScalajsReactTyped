...
import typingsJapgolly.pulumiAws.apnsChannelMod.ApnsChannelArgs
import typingsJapgolly.pulumiAws.apnsChannelMod.ApnsChannelState
...
class ApnsChannel protected ()
  extends typingsJapgolly.pulumiAws.pinpointMod.ApnsChannel {
  /**
...
object ApnsChannel extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.apnsChannelMod.ApnsChannel = js.native
  def get(name: String, id: Input[ID], state: ApnsChannelState): typingsJapgolly.pulumiAws.apnsChannelMod.ApnsChannel = js.native
  def get(name: String, id: Input[ID], state: ApnsChannelState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.apnsChannelMod.ApnsChannel = js.native
  /**
