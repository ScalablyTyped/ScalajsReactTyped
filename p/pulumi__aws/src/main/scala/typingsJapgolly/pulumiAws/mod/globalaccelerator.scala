...
object globalaccelerator extends js.Object {
  ...
  class Accelerator protected ()
    extends typingsJapgolly.pulumiAws.globalacceleratorMod.Accelerator {
    /**
  ...
  class EndpointGroup protected ()
    extends typingsJapgolly.pulumiAws.globalacceleratorMod.EndpointGroup {
    /**
  ...
  class Listener protected ()
    extends typingsJapgolly.pulumiAws.globalacceleratorMod.Listener {
    /**
