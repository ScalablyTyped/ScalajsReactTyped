...
object codedeploy extends js.Object {
  ...
  class Application protected ()
    extends typingsJapgolly.pulumiAws.codedeployMod.Application {
    /**
  ...
  class DeploymentConfig protected ()
    extends typingsJapgolly.pulumiAws.codedeployMod.DeploymentConfig {
    /**
  ...
  class DeploymentGroup protected ()
    extends typingsJapgolly.pulumiAws.codedeployMod.DeploymentGroup {
    /**
