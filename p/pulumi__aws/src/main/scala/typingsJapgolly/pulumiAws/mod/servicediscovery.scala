...
object servicediscovery extends js.Object {
  ...
  class HttpNamespace protected ()
    extends typingsJapgolly.pulumiAws.servicediscoveryMod.HttpNamespace {
    /**
  ...
  class PrivateDnsNamespace protected ()
    extends typingsJapgolly.pulumiAws.servicediscoveryMod.PrivateDnsNamespace {
    /**
  ...
  class PublicDnsNamespace protected ()
    extends typingsJapgolly.pulumiAws.servicediscoveryMod.PublicDnsNamespace {
    /**
  ...
  class Service protected ()
    extends typingsJapgolly.pulumiAws.servicediscoveryMod.Service {
    /**
