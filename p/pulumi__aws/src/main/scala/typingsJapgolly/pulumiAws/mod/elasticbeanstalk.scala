...
object elasticbeanstalk extends js.Object {
  ...
  class Application protected ()
    extends typingsJapgolly.pulumiAws.elasticbeanstalkMod.Application {
    /**
  ...
  class ApplicationVersion protected ()
    extends typingsJapgolly.pulumiAws.elasticbeanstalkMod.ApplicationVersion {
    /**
  ...
  class ConfigurationTemplate protected ()
    extends typingsJapgolly.pulumiAws.elasticbeanstalkMod.ConfigurationTemplate {
    /**
  ...
  class Environment protected ()
    extends typingsJapgolly.pulumiAws.elasticbeanstalkMod.Environment {
    /**
