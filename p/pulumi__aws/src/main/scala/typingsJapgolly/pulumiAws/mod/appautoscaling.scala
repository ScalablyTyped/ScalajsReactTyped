...
object appautoscaling extends js.Object {
  ...
  class Policy protected ()
    extends typingsJapgolly.pulumiAws.appautoscalingMod.Policy {
    /**
  ...
  class ScheduledAction protected ()
    extends typingsJapgolly.pulumiAws.appautoscalingMod.ScheduledAction {
    /**
  ...
  class Target protected ()
    extends typingsJapgolly.pulumiAws.appautoscalingMod.Target {
    /**
