...
object emr extends js.Object {
  ...
  class Cluster protected ()
    extends typingsJapgolly.pulumiAws.emrMod.Cluster {
    /**
  ...
  class InstanceGroup protected ()
    extends typingsJapgolly.pulumiAws.emrMod.InstanceGroup {
    /**
  ...
  class SecurityConfiguration protected ()
    extends typingsJapgolly.pulumiAws.emrMod.SecurityConfiguration {
    /**
