...
import typingsJapgolly.pulumiAws.identityPolicyMod.IdentityPolicyArgs
import typingsJapgolly.pulumiAws.identityPolicyMod.IdentityPolicyState
...
class IdentityPolicy protected ()
  extends typingsJapgolly.pulumiAws.sesMod.IdentityPolicy {
  /**
...
object IdentityPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.identityPolicyMod.IdentityPolicy = js.native
  def get(name: String, id: Input[ID], state: IdentityPolicyState): typingsJapgolly.pulumiAws.identityPolicyMod.IdentityPolicy = js.native
  def get(name: String, id: Input[ID], state: IdentityPolicyState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.identityPolicyMod.IdentityPolicy = js.native
  /**
