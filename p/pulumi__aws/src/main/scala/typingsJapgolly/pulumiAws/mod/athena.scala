...
object athena extends js.Object {
  ...
  class Database protected ()
    extends typingsJapgolly.pulumiAws.athenaMod.Database {
    /**
  ...
  class NamedQuery protected ()
    extends typingsJapgolly.pulumiAws.athenaMod.NamedQuery {
    /**
  ...
  class Workgroup protected ()
    extends typingsJapgolly.pulumiAws.athenaMod.Workgroup {
    /**
