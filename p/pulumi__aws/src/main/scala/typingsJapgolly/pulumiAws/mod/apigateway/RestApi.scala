...
import typingsJapgolly.pulumiAws.restApiMod.RestApiArgs
import typingsJapgolly.pulumiAws.restApiMod.RestApiState
...
class RestApi protected ()
  extends typingsJapgolly.pulumiAws.apigatewayMod.RestApi {
  /**
...
object RestApi extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.restApiMod.RestApi = js.native
  def get(name: String, id: Input[ID], state: RestApiState): typingsJapgolly.pulumiAws.restApiMod.RestApi = js.native
  def get(name: String, id: Input[ID], state: RestApiState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.restApiMod.RestApi = js.native
  /**
