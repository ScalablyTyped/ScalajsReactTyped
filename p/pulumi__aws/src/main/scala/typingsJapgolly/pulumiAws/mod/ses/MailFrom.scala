...
import typingsJapgolly.pulumiAws.mailFromMod.MailFromArgs
import typingsJapgolly.pulumiAws.mailFromMod.MailFromState
...
class MailFrom protected ()
  extends typingsJapgolly.pulumiAws.sesMod.MailFrom {
  /**
...
object MailFrom extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.mailFromMod.MailFrom = js.native
  def get(name: String, id: Input[ID], state: MailFromState): typingsJapgolly.pulumiAws.mailFromMod.MailFrom = js.native
  def get(name: String, id: Input[ID], state: MailFromState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.mailFromMod.MailFrom = js.native
  /**
