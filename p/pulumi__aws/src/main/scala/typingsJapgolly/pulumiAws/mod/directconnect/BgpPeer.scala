...
import typingsJapgolly.pulumiAws.bgpPeerMod.BgpPeerArgs
import typingsJapgolly.pulumiAws.bgpPeerMod.BgpPeerState
...
class BgpPeer protected ()
  extends typingsJapgolly.pulumiAws.directconnectMod.BgpPeer {
  /**
...
object BgpPeer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.bgpPeerMod.BgpPeer = js.native
  def get(name: String, id: Input[ID], state: BgpPeerState): typingsJapgolly.pulumiAws.bgpPeerMod.BgpPeer = js.native
  def get(name: String, id: Input[ID], state: BgpPeerState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.bgpPeerMod.BgpPeer = js.native
  /**
