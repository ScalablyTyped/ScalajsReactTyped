...
object iot extends js.Object {
  ...
  class Certificate protected ()
    extends typingsJapgolly.pulumiAws.iotMod.Certificate {
    /**
  ...
  class Policy protected ()
    extends typingsJapgolly.pulumiAws.iotMod.Policy {
    /**
  ...
  class PolicyAttachment protected ()
    extends typingsJapgolly.pulumiAws.iotMod.PolicyAttachment {
    /**
  ...
  class RoleAlias protected ()
    extends typingsJapgolly.pulumiAws.iotMod.RoleAlias {
    /**
  ...
  class Thing protected ()
    extends typingsJapgolly.pulumiAws.iotMod.Thing {
    /**
  ...
  class ThingPrincipalAttachment protected ()
    extends typingsJapgolly.pulumiAws.iotMod.ThingPrincipalAttachment {
    /**
  ...
  class ThingType protected ()
    extends typingsJapgolly.pulumiAws.iotMod.ThingType {
    /**
  ...
  class TopicRule protected ()
    extends typingsJapgolly.pulumiAws.iotMod.TopicRule {
    /**
