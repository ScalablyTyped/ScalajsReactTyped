...
object docdb extends js.Object {
  ...
  class Cluster protected ()
    extends typingsJapgolly.pulumiAws.docdbMod.Cluster {
    /**
  ...
  class ClusterInstance protected ()
    extends typingsJapgolly.pulumiAws.docdbMod.ClusterInstance {
    /**
  ...
  class ClusterParameterGroup protected ()
    extends typingsJapgolly.pulumiAws.docdbMod.ClusterParameterGroup {
    /**
  ...
  class ClusterSnapshot protected ()
    extends typingsJapgolly.pulumiAws.docdbMod.ClusterSnapshot {
    /**
  ...
  class SubnetGroup protected ()
    extends typingsJapgolly.pulumiAws.docdbMod.SubnetGroup {
    /**
