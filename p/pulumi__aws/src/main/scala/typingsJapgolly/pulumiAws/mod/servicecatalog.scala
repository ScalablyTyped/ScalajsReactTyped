...
import typingsJapgolly.pulumiAws.portfolioMod.PortfolioArgs
import typingsJapgolly.pulumiAws.portfolioMod.PortfolioState
...
object servicecatalog extends js.Object {
  ...
  class Portfolio protected ()
    extends typingsJapgolly.pulumiAws.servicecatalogMod.Portfolio {
    /**
  ...
  object Portfolio extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.portfolioMod.Portfolio = js.native
    def get(name: String, id: Input[ID], state: PortfolioState): typingsJapgolly.pulumiAws.portfolioMod.Portfolio = js.native
    def get(name: String, id: Input[ID], state: PortfolioState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.portfolioMod.Portfolio = js.native
    /**
