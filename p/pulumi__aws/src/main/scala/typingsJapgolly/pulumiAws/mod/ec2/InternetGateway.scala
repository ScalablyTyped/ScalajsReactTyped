...
import typingsJapgolly.pulumiAws.internetGatewayMod.InternetGatewayArgs
import typingsJapgolly.pulumiAws.internetGatewayMod.InternetGatewayState
...
class InternetGateway protected ()
  extends typingsJapgolly.pulumiAws.ec2Mod.InternetGateway {
  /**
...
object InternetGateway extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.internetGatewayMod.InternetGateway = js.native
  def get(name: String, id: Input[ID], state: InternetGatewayState): typingsJapgolly.pulumiAws.internetGatewayMod.InternetGateway = js.native
  def get(name: String, id: Input[ID], state: InternetGatewayState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.internetGatewayMod.InternetGateway = js.native
  /**
