...
import typingsJapgolly.pulumiAws.gangliaLayerMod.GangliaLayerArgs
import typingsJapgolly.pulumiAws.gangliaLayerMod.GangliaLayerState
...
class GangliaLayer protected ()
  extends typingsJapgolly.pulumiAws.opsworksMod.GangliaLayer {
  /**
...
object GangliaLayer extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.gangliaLayerMod.GangliaLayer = js.native
  def get(name: String, id: Input[ID], state: GangliaLayerState): typingsJapgolly.pulumiAws.gangliaLayerMod.GangliaLayer = js.native
  def get(name: String, id: Input[ID], state: GangliaLayerState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.gangliaLayerMod.GangliaLayer = js.native
  /**
