...
import typingsJapgolly.pulumiAws.defaultSubnetMod.DefaultSubnetArgs
import typingsJapgolly.pulumiAws.defaultSubnetMod.DefaultSubnetState
...
class DefaultSubnet protected ()
  extends typingsJapgolly.pulumiAws.ec2Mod.DefaultSubnet {
  /**
...
object DefaultSubnet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.defaultSubnetMod.DefaultSubnet = js.native
  def get(name: String, id: Input[ID], state: DefaultSubnetState): typingsJapgolly.pulumiAws.defaultSubnetMod.DefaultSubnet = js.native
  def get(name: String, id: Input[ID], state: DefaultSubnetState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.defaultSubnetMod.DefaultSubnet = js.native
  /**
