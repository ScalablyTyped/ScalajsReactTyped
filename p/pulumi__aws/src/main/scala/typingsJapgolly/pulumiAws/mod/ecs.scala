...
object ecs extends js.Object {
  ...
  class CapacityProvider protected ()
    extends typingsJapgolly.pulumiAws.ecsMod.CapacityProvider {
    /**
  ...
  class Cluster protected ()
    extends typingsJapgolly.pulumiAws.ecsMod.Cluster {
    /**
  ...
  class Service protected ()
    extends typingsJapgolly.pulumiAws.ecsMod.Service {
    /**
  ...
  class TaskDefinition protected ()
    extends typingsJapgolly.pulumiAws.ecsMod.TaskDefinition {
    /**
