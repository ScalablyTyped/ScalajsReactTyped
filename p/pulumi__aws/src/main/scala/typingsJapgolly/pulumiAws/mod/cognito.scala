...
object cognito extends js.Object {
  ...
  class IdentityPool protected ()
    extends typingsJapgolly.pulumiAws.cognitoMod.IdentityPool {
    /**
  ...
  class IdentityPoolRoleAttachment protected ()
    extends typingsJapgolly.pulumiAws.cognitoMod.IdentityPoolRoleAttachment {
    /**
  ...
  class IdentityProvider protected ()
    extends typingsJapgolly.pulumiAws.cognitoMod.IdentityProvider {
    /**
  ...
  class ResourceServer protected ()
    extends typingsJapgolly.pulumiAws.cognitoMod.ResourceServer {
    /**
  ...
  class UserGroup protected ()
    extends typingsJapgolly.pulumiAws.cognitoMod.UserGroup {
    /**
  ...
  class UserPool protected ()
    extends typingsJapgolly.pulumiAws.cognitoMod.UserPool {
    /**
  ...
  class UserPoolClient protected ()
    extends typingsJapgolly.pulumiAws.cognitoMod.UserPoolClient {
    /**
  ...
  class UserPoolDomain protected ()
    extends typingsJapgolly.pulumiAws.cognitoMod.UserPoolDomain {
    /**
