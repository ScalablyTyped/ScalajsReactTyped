...
object neptune extends js.Object {
  ...
  class Cluster protected ()
    extends typingsJapgolly.pulumiAws.neptuneMod.Cluster {
    /**
  ...
  class ClusterInstance protected ()
    extends typingsJapgolly.pulumiAws.neptuneMod.ClusterInstance {
    /**
  ...
  class ClusterParameterGroup protected ()
    extends typingsJapgolly.pulumiAws.neptuneMod.ClusterParameterGroup {
    /**
  ...
  class ClusterSnapshot protected ()
    extends typingsJapgolly.pulumiAws.neptuneMod.ClusterSnapshot {
    /**
  ...
  class EventSubscription protected ()
    extends typingsJapgolly.pulumiAws.neptuneMod.EventSubscription {
    /**
  ...
  class ParameterGroup protected ()
    extends typingsJapgolly.pulumiAws.neptuneMod.ParameterGroup {
    /**
  ...
  class SubnetGroup protected ()
    extends typingsJapgolly.pulumiAws.neptuneMod.SubnetGroup {
    /**
