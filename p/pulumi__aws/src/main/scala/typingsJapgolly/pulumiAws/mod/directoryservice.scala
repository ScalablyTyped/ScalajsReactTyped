...
object directoryservice extends js.Object {
  ...
  class ConditionalForwader protected ()
    extends typingsJapgolly.pulumiAws.directoryserviceMod.ConditionalForwader {
    /**
  ...
  class Directory protected ()
    extends typingsJapgolly.pulumiAws.directoryserviceMod.Directory {
    /**
  ...
  class LogService protected ()
    extends typingsJapgolly.pulumiAws.directoryserviceMod.LogService {
    /**
