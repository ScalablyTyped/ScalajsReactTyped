...
object elb extends js.Object {
  ...
  class AppCookieStickinessPolicy protected ()
    extends typingsJapgolly.pulumiAws.elbMod.AppCookieStickinessPolicy {
    /**
  ...
  class Attachment protected ()
    extends typingsJapgolly.pulumiAws.elbMod.Attachment {
    /**
  ...
  class ListenerPolicy protected ()
    extends typingsJapgolly.pulumiAws.elbMod.ListenerPolicy {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsJapgolly.pulumiAws.elbMod.LoadBalancer {
    /**
  ...
  class LoadBalancerBackendServerPolicy protected ()
    extends typingsJapgolly.pulumiAws.elbMod.LoadBalancerBackendServerPolicy {
    /**
  ...
  class LoadBalancerCookieStickinessPolicy protected ()
    extends typingsJapgolly.pulumiAws.elbMod.LoadBalancerCookieStickinessPolicy {
    /**
  ...
  class LoadBalancerPolicy protected ()
    extends typingsJapgolly.pulumiAws.elbMod.LoadBalancerPolicy {
    /**
  ...
  class SslNegotiationPolicy protected ()
    extends typingsJapgolly.pulumiAws.elbMod.SslNegotiationPolicy {
    /**
