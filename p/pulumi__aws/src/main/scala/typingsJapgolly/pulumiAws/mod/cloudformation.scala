...
object cloudformation extends js.Object {
  ...
  class Stack protected ()
    extends typingsJapgolly.pulumiAws.cloudformationMod.Stack {
    /**
  ...
  class StackSet protected ()
    extends typingsJapgolly.pulumiAws.cloudformationMod.StackSet {
    /**
  ...
  class StackSetInstance protected ()
    extends typingsJapgolly.pulumiAws.cloudformationMod.StackSetInstance {
    /**
