...
object elasticloadbalancingv2 extends js.Object {
  ...
  class Listener protected ()
    extends typingsJapgolly.pulumiAws.elasticloadbalancingv2Mod.Listener {
    /**
  ...
  class ListenerCertificate protected ()
    extends typingsJapgolly.pulumiAws.elasticloadbalancingv2Mod.ListenerCertificate {
    /**
  ...
  class ListenerRule protected ()
    extends typingsJapgolly.pulumiAws.elasticloadbalancingv2Mod.ListenerRule {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsJapgolly.pulumiAws.elasticloadbalancingv2Mod.LoadBalancer {
    /**
  ...
  class TargetGroup protected ()
    extends typingsJapgolly.pulumiAws.elasticloadbalancingv2Mod.TargetGroup {
    /**
  ...
  class TargetGroupAttachment protected ()
    extends typingsJapgolly.pulumiAws.elasticloadbalancingv2Mod.TargetGroupAttachment {
    /**
