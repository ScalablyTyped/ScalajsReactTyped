...
import typingsJapgolly.pulumiAws.globalClusterMod.GlobalClusterArgs
import typingsJapgolly.pulumiAws.globalClusterMod.GlobalClusterState
...
class GlobalCluster protected ()
  extends typingsJapgolly.pulumiAws.rdsMod.GlobalCluster {
  /**
...
object GlobalCluster extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.globalClusterMod.GlobalCluster = js.native
  def get(name: String, id: Input[ID], state: GlobalClusterState): typingsJapgolly.pulumiAws.globalClusterMod.GlobalCluster = js.native
  def get(name: String, id: Input[ID], state: GlobalClusterState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.globalClusterMod.GlobalCluster = js.native
  /**
