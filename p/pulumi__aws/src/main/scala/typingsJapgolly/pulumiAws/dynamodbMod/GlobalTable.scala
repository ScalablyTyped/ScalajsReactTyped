...
import typingsJapgolly.pulumiAws.globalTableMod.GlobalTableArgs
import typingsJapgolly.pulumiAws.globalTableMod.GlobalTableState
...
class GlobalTable protected ()
  extends typingsJapgolly.pulumiAws.globalTableMod.GlobalTable {
  /**
...
object GlobalTable extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.globalTableMod.GlobalTable = js.native
  def get(name: String, id: Input[ID], state: GlobalTableState): typingsJapgolly.pulumiAws.globalTableMod.GlobalTable = js.native
  def get(name: String, id: Input[ID], state: GlobalTableState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.globalTableMod.GlobalTable = js.native
  /**
