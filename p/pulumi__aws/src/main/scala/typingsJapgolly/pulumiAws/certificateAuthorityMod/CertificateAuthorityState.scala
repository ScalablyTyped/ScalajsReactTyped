...
import typingsJapgolly.pulumiAws.inputMod.acmpca.CertificateAuthorityCertificateAuthorityConfiguration
import typingsJapgolly.pulumiAws.inputMod.acmpca.CertificateAuthorityRevocationConfiguration
