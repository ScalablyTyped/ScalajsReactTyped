...
import typingsJapgolly.pulumiAws.eventStreamMod.EventStreamArgs
import typingsJapgolly.pulumiAws.eventStreamMod.EventStreamState
...
class EventStream protected ()
  extends typingsJapgolly.pulumiAws.eventStreamMod.EventStream {
  /**
...
object EventStream extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.eventStreamMod.EventStream = js.native
  def get(name: String, id: Input[ID], state: EventStreamState): typingsJapgolly.pulumiAws.eventStreamMod.EventStream = js.native
  def get(name: String, id: Input[ID], state: EventStreamState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.eventStreamMod.EventStream = js.native
  /**
