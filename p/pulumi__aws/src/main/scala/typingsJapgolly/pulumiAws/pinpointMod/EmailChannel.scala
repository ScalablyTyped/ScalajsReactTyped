...
import typingsJapgolly.pulumiAws.emailChannelMod.EmailChannelArgs
import typingsJapgolly.pulumiAws.emailChannelMod.EmailChannelState
...
class EmailChannel protected ()
  extends typingsJapgolly.pulumiAws.emailChannelMod.EmailChannel {
  /**
...
object EmailChannel extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.emailChannelMod.EmailChannel = js.native
  def get(name: String, id: Input[ID], state: EmailChannelState): typingsJapgolly.pulumiAws.emailChannelMod.EmailChannel = js.native
  def get(name: String, id: Input[ID], state: EmailChannelState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.emailChannelMod.EmailChannel = js.native
  /**
