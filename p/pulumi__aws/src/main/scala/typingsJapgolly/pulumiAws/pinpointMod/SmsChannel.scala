...
import typingsJapgolly.pulumiAws.smsChannelMod.SmsChannelArgs
import typingsJapgolly.pulumiAws.smsChannelMod.SmsChannelState
...
class SmsChannel protected ()
  extends typingsJapgolly.pulumiAws.smsChannelMod.SmsChannel {
  /**
...
object SmsChannel extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.smsChannelMod.SmsChannel = js.native
  def get(name: String, id: Input[ID], state: SmsChannelState): typingsJapgolly.pulumiAws.smsChannelMod.SmsChannel = js.native
  def get(name: String, id: Input[ID], state: SmsChannelState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.smsChannelMod.SmsChannel = js.native
  /**
