package typingsJapgolly.pulumiAws.lbGetTargetGroupMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.pulumiAws.outputMod.lb.GetTargetGroupHealthCheck
import typingsJapgolly.pulumiAws.outputMod.lb.GetTargetGroupStickiness
