...
object transferMod extends js.Object {
  ...
  class Server protected ()
    extends typingsJapgolly.pulumiAws.serverMod.Server {
    /**
  ...
  class SshKey protected ()
    extends typingsJapgolly.pulumiAws.transferSshKeyMod.SshKey {
    /**
  ...
  class User protected ()
    extends typingsJapgolly.pulumiAws.transferUserMod.User {
    /**
