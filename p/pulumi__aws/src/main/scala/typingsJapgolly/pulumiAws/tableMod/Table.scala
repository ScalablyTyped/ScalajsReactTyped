...
import typingsJapgolly.pulumiAws.dynamodbMixinsMod.TableEventSubscription
import typingsJapgolly.pulumiAws.dynamodbMixinsMod.TableEventSubscriptionArgs
import typingsJapgolly.pulumiAws.outputMod.dynamodb.TableAttribute
import typingsJapgolly.pulumiAws.outputMod.dynamodb.TableGlobalSecondaryIndex
import typingsJapgolly.pulumiAws.outputMod.dynamodb.TableLocalSecondaryIndex
import typingsJapgolly.pulumiAws.outputMod.dynamodb.TablePointInTimeRecovery
import typingsJapgolly.pulumiAws.outputMod.dynamodb.TableServerSideEncryption
import typingsJapgolly.pulumiAws.outputMod.dynamodb.TableTtl
