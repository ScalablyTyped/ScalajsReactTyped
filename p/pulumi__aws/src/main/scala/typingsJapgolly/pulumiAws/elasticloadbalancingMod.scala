...
object elasticloadbalancingMod extends js.Object {
  ...
  class AppCookieStickinessPolicy protected ()
    extends typingsJapgolly.pulumiAws.appCookieStickinessPolicyMod.AppCookieStickinessPolicy {
    /**
  ...
  class Attachment protected ()
    extends typingsJapgolly.pulumiAws.elasticloadbalancingAttachmentMod.Attachment {
    /**
  ...
  class ListenerPolicy protected ()
    extends typingsJapgolly.pulumiAws.listenerPolicyMod.ListenerPolicy {
    /**
  ...
  class LoadBalancer protected ()
    extends typingsJapgolly.pulumiAws.elasticloadbalancingLoadBalancerMod.LoadBalancer {
    /**
  ...
  class LoadBalancerBackendServerPolicy protected ()
    extends typingsJapgolly.pulumiAws.loadBalancerBackendServerPolicyMod.LoadBalancerBackendServerPolicy {
    /**
  ...
  class LoadBalancerCookieStickinessPolicy protected ()
    extends typingsJapgolly.pulumiAws.loadBalancerCookieStickinessPolicyMod.LoadBalancerCookieStickinessPolicy {
    /**
  ...
  class LoadBalancerPolicy protected ()
    extends typingsJapgolly.pulumiAws.loadBalancerPolicyMod.LoadBalancerPolicy {
    /**
  ...
  class SslNegotiationPolicy protected ()
    extends typingsJapgolly.pulumiAws.sslNegotiationPolicyMod.SslNegotiationPolicy {
    /**
