...
object ec2transitgatewayMod extends js.Object {
  ...
  class Route protected ()
    extends typingsJapgolly.pulumiAws.ec2transitgatewayRouteMod.Route {
    /**
  ...
  class RouteTable protected ()
    extends typingsJapgolly.pulumiAws.routeTableMod.RouteTable {
    /**
  ...
  class RouteTableAssociation protected ()
    extends typingsJapgolly.pulumiAws.routeTableAssociationMod.RouteTableAssociation {
    /**
  ...
  class RouteTablePropagation protected ()
    extends typingsJapgolly.pulumiAws.routeTablePropagationMod.RouteTablePropagation {
    /**
  ...
  class TransitGateway protected ()
    extends typingsJapgolly.pulumiAws.transitGatewayMod.TransitGateway {
    /**
  ...
  class VpcAttachment protected ()
    extends typingsJapgolly.pulumiAws.vpcAttachmentMod.VpcAttachment {
    /**
  ...
  class VpcAttachmentAccepter protected ()
    extends typingsJapgolly.pulumiAws.vpcAttachmentAccepterMod.VpcAttachmentAccepter {
    /**
