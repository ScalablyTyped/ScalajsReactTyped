package typingsJapgolly.pulumiAws.glueSecurityConfigurationMod

import typingsJapgolly.pulumiAws.outputMod.glue.SecurityConfigurationEncryptionConfiguration
