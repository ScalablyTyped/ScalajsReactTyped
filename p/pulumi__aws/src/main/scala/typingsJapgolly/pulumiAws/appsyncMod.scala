...
object appsyncMod extends js.Object {
  ...
  class ApiKey protected ()
    extends typingsJapgolly.pulumiAws.appsyncApiKeyMod.ApiKey {
    /**
  ...
  class DataSource protected ()
    extends typingsJapgolly.pulumiAws.dataSourceMod.DataSource {
    /**
  ...
  class Function protected ()
    extends typingsJapgolly.pulumiAws.functionMod.Function {
    /**
  ...
  class GraphQLApi protected ()
    extends typingsJapgolly.pulumiAws.graphQLApiMod.GraphQLApi {
    /**
  ...
  class Resolver protected ()
    extends typingsJapgolly.pulumiAws.resolverMod.Resolver {
    /**
