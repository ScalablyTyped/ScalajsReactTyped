package typingsJapgolly.pulumiAws.routingRulesMod
...
trait RoutingRule extends js.Object {
  /**
    ...
    */
  var Condition: js.UndefOr[typingsJapgolly.pulumiAws.routingRulesMod.Condition] = js.native
  /**
    ...
    */
  var Redirect: typingsJapgolly.pulumiAws.routingRulesMod.Redirect = js.native
}
