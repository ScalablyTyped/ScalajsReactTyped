...
import typingsJapgolly.pulumiAws.inputMod.autoscaling.PolicyStepAdjustment
import typingsJapgolly.pulumiAws.inputMod.autoscaling.PolicyTargetTrackingConfiguration
