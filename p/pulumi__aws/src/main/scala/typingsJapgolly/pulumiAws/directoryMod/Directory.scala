...
import typingsJapgolly.pulumiAws.outputMod.directoryservice.DirectoryConnectSettings
import typingsJapgolly.pulumiAws.outputMod.directoryservice.DirectoryVpcSettings
