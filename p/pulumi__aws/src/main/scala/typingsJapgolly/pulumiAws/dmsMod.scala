...
object dmsMod extends js.Object {
  ...
  class Certificate protected ()
    extends typingsJapgolly.pulumiAws.dmsCertificateMod.Certificate {
    /**
  ...
  class Endpoint protected ()
    extends typingsJapgolly.pulumiAws.endpointMod.Endpoint {
    /**
  ...
  class ReplicationInstance protected ()
    extends typingsJapgolly.pulumiAws.replicationInstanceMod.ReplicationInstance {
    /**
  ...
  class ReplicationSubnetGroup protected ()
    extends typingsJapgolly.pulumiAws.replicationSubnetGroupMod.ReplicationSubnetGroup {
    /**
  ...
  class ReplicationTask protected ()
    extends typingsJapgolly.pulumiAws.replicationTaskMod.ReplicationTask {
    /**
