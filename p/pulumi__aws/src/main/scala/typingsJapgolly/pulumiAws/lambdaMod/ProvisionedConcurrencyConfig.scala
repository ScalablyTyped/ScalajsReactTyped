...
import typingsJapgolly.pulumiAws.provisionedConcurrencyConfigMod.ProvisionedConcurrencyConfigArgs
import typingsJapgolly.pulumiAws.provisionedConcurrencyConfigMod.ProvisionedConcurrencyConfigState
...
class ProvisionedConcurrencyConfig protected ()
  extends typingsJapgolly.pulumiAws.provisionedConcurrencyConfigMod.ProvisionedConcurrencyConfig {
  /**
...
object ProvisionedConcurrencyConfig extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.provisionedConcurrencyConfigMod.ProvisionedConcurrencyConfig = js.native
  def get(name: String, id: Input[ID], state: ProvisionedConcurrencyConfigState): typingsJapgolly.pulumiAws.provisionedConcurrencyConfigMod.ProvisionedConcurrencyConfig = js.native
  def get(name: String, id: Input[ID], state: ProvisionedConcurrencyConfigState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.provisionedConcurrencyConfigMod.ProvisionedConcurrencyConfig = js.native
  /**
