...
object daxMod extends js.Object {
  ...
  class Cluster protected ()
    extends typingsJapgolly.pulumiAws.daxClusterMod.Cluster {
    /**
  ...
  class ParameterGroup protected ()
    extends typingsJapgolly.pulumiAws.parameterGroupMod.ParameterGroup {
    /**
  ...
  class SubnetGroup protected ()
    extends typingsJapgolly.pulumiAws.subnetGroupMod.SubnetGroup {
    /**
