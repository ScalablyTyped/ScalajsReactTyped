...
import typingsJapgolly.pulumiAws.clientCertificateMod.ClientCertificateArgs
import typingsJapgolly.pulumiAws.clientCertificateMod.ClientCertificateState
...
class ClientCertificate protected ()
  extends typingsJapgolly.pulumiAws.clientCertificateMod.ClientCertificate {
  /**
...
object ClientCertificate extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.clientCertificateMod.ClientCertificate = js.native
  def get(name: String, id: Input[ID], state: ClientCertificateState): typingsJapgolly.pulumiAws.clientCertificateMod.ClientCertificate = js.native
  def get(name: String, id: Input[ID], state: ClientCertificateState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.clientCertificateMod.ClientCertificate = js.native
  /**
