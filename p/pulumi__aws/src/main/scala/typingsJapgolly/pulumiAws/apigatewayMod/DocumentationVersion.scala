...
import typingsJapgolly.pulumiAws.documentationVersionMod.DocumentationVersionArgs
import typingsJapgolly.pulumiAws.documentationVersionMod.DocumentationVersionState
...
class DocumentationVersion protected ()
  extends typingsJapgolly.pulumiAws.documentationVersionMod.DocumentationVersion {
  /**
...
object DocumentationVersion extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typingsJapgolly.pulumiAws.documentationVersionMod.DocumentationVersion = js.native
  def get(name: String, id: Input[ID], state: DocumentationVersionState): typingsJapgolly.pulumiAws.documentationVersionMod.DocumentationVersion = js.native
  def get(name: String, id: Input[ID], state: DocumentationVersionState, opts: CustomResourceOptions): typingsJapgolly.pulumiAws.documentationVersionMod.DocumentationVersion = js.native
  /**
