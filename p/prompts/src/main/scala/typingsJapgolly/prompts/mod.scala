...
import typingsJapgolly.prompts.promptsBooleans.`false`
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnCancel(value: (/* prompt */ PromptObject[String], /* answers */ Any) => Callback): Self = StObject.set(x, "onCancel", js.Any.fromFunction2((t0: /* prompt */ PromptObject[String], t1: /* answers */ Any) => (value(t0, t1)).runNow()))
      
      inline def setOnCancelUndefined: Self = StObject.set(x, "onCancel", js.undefined)
      
      inline def setOnSubmit(
        value: (/* prompt */ PromptObject[String], /* answer */ Any, /* answers */ js.Array[Any]) => Callback
      ): Self = StObject.set(x, "onSubmit", js.Any.fromFunction3((t0: /* prompt */ PromptObject[String], t1: /* answer */ Any, t2: /* answers */ js.Array[Any]) => (value(t0, t1, t2)).runNow()))
  ...
  object PromptObject {
    ...
    extension [Self <: PromptObject[?], T /* <: String */](x: Self & PromptObject[T]) {
      ...
      inline def setFormat(value: (/* prev */ Any, /* values */ Answers[T], /* prompt */ PromptObject[String]) => Callback): Self = StObject.set(x, "format", js.Any.fromFunction3((t0: /* prev */ Any, t1: /* values */ Answers[T], t2: /* prompt */ PromptObject[String]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnState(value: (/* prev */ Any, /* values */ Answers[T], /* prompt */ PromptObject[String]) => Callback): Self = StObject.set(x, "onState", js.Any.fromFunction3((t0: /* prev */ Any, t1: /* values */ Answers[T], t2: /* prompt */ PromptObject[String]) => (value(t0, t1, t2)).runNow()))
  ...
  */
  ...
  object PromptType {
    ...
    inline def autocomplete: typingsJapgolly.prompts.promptsStrings.autocomplete = "autocomplete".asInstanceOf[typingsJapgolly.prompts.promptsStrings.autocomplete]
    
    inline def autocompleteMultiselect: typingsJapgolly.prompts.promptsStrings.autocompleteMultiselect = "autocompleteMultiselect".asInstanceOf[typingsJapgolly.prompts.promptsStrings.autocompleteMultiselect]
    
    inline def confirm: typingsJapgolly.prompts.promptsStrings.confirm = "confirm".asInstanceOf[typingsJapgolly.prompts.promptsStrings.confirm]
    
    inline def date: typingsJapgolly.prompts.promptsStrings.date = "date".asInstanceOf[typingsJapgolly.prompts.promptsStrings.date]
    
    inline def invisible: typingsJapgolly.prompts.promptsStrings.invisible = "invisible".asInstanceOf[typingsJapgolly.prompts.promptsStrings.invisible]
    
    inline def list: typingsJapgolly.prompts.promptsStrings.list = "list".asInstanceOf[typingsJapgolly.prompts.promptsStrings.list]
    
    inline def multiselect: typingsJapgolly.prompts.promptsStrings.multiselect = "multiselect".asInstanceOf[typingsJapgolly.prompts.promptsStrings.multiselect]
    
    inline def number: typingsJapgolly.prompts.promptsStrings.number = "number".asInstanceOf[typingsJapgolly.prompts.promptsStrings.number]
    
    inline def password: typingsJapgolly.prompts.promptsStrings.password = "password".asInstanceOf[typingsJapgolly.prompts.promptsStrings.password]
    
    inline def select: typingsJapgolly.prompts.promptsStrings.select = "select".asInstanceOf[typingsJapgolly.prompts.promptsStrings.select]
    
    inline def text: typingsJapgolly.prompts.promptsStrings.text = "text".asInstanceOf[typingsJapgolly.prompts.promptsStrings.text]
    
    inline def toggle: typingsJapgolly.prompts.promptsStrings.toggle = "toggle".asInstanceOf[typingsJapgolly.prompts.promptsStrings.toggle]
  }
