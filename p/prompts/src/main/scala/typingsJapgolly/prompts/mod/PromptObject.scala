...
object PromptObject {
  ...
  def apply[T /* <: String */](
    ...
    format: (/* prev */ js.Any, /* values */ Answers[T], /* prompt */ PromptObject[String]) => Callback = null,
    hint: String = null,
    ...
    min: Int | Double = null,
    onState: (/* prev */ js.Any, /* values */ Answers[T], /* prompt */ PromptObject[String]) => Callback = null,
    round: Int | Double = null,
    seperator: String = null,
    style: String = null,
    suggest: (/* input */ js.Any, /* choices */ js.Array[Choice]) => CallbackTo[js.Promise[js.Any]] = null,
    `type`: PromptType | Falsy | (PrevCaller[T, PromptType | Falsy]) = null,
    validate: (/* prev */ js.Any, /* values */ Answers[T], /* prompt */ PromptObject[String]) => CallbackTo[Boolean | String | (js.Promise[Boolean | String])] = null
  ): PromptObject[T] = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    if (active != null) __obj.updateDynamic("active")(active.asInstanceOf[js.Any])
    if (choices != null) __obj.updateDynamic("choices")(choices.asInstanceOf[js.Any])
    if (!js.isUndefined(float)) __obj.updateDynamic("float")(float.asInstanceOf[js.Any])
    if (format != null) __obj.updateDynamic("format")(js.Any.fromFunction3((t0: /* prev */ js.Any, t1: /* values */ typingsJapgolly.prompts.mod.Answers[T], t2: /* prompt */ typingsJapgolly.prompts.mod.PromptObject[java.lang.String]) => format(t0, t1, t2).runNow()))
    ...
    if (onState != null) __obj.updateDynamic("onState")(js.Any.fromFunction3((t0: /* prev */ js.Any, t1: /* values */ typingsJapgolly.prompts.mod.Answers[T], t2: /* prompt */ typingsJapgolly.prompts.mod.PromptObject[java.lang.String]) => onState(t0, t1, t2).runNow()))
    if (round != null) __obj.updateDynamic("round")(round.asInstanceOf[js.Any])
    if (seperator != null) __obj.updateDynamic("seperator")(seperator.asInstanceOf[js.Any])
    if (style != null) __obj.updateDynamic("style")(style.asInstanceOf[js.Any])
    if (suggest != null) __obj.updateDynamic("suggest")(js.Any.fromFunction2((t0: /* input */ js.Any, t1: /* choices */ js.Array[typingsJapgolly.prompts.mod.Choice]) => suggest(t0, t1).runNow()))
    if (`type` != null) __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    if (validate != null) __obj.updateDynamic("validate")(js.Any.fromFunction3((t0: /* prev */ js.Any, t1: /* values */ typingsJapgolly.prompts.mod.Answers[T], t2: /* prompt */ typingsJapgolly.prompts.mod.PromptObject[java.lang.String]) => validate(t0, t1, t2).runNow()))
