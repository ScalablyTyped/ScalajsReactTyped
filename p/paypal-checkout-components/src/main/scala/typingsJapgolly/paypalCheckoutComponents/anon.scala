...
import typingsJapgolly.paypalCheckoutComponents.modulesCallbackDataMod.AuthorizationData
import typingsJapgolly.paypalCheckoutComponents.modulesCallbackDataMod.AuthorizationResponse
import typingsJapgolly.paypalCheckoutComponents.modulesCallbackDataMod.CancellationData
import typingsJapgolly.paypalCheckoutComponents.modulesConfigurationMod.ButtonStyle
import typingsJapgolly.paypalCheckoutComponents.modulesConfigurationMod.Environment
...
object anon {
  ...
  object AccessToken {
    ...
    extension [Self <: AccessToken](x: Self) {
      ...
      inline def setAccessToken(value: Callback): Self = StObject.set(x, "accessToken", value.toJsFn)
      ...
      inline def setOnCancel(value: (/* data */ CancellationData, /* actions */ js.Object) => Callback): Self = StObject.set(x, "onCancel", js.Any.fromFunction2((t0: /* data */ CancellationData, t1: /* actions */ js.Object) => (value(t0, t1)).runNow()))
      ...
      inline def setOnShippingChange(value: Callback): Self = StObject.set(x, "onShippingChange", value.toJsFn)
      
      inline def setOnShippingChangeUndefined: Self = StObject.set(x, "onShippingChange", js.undefined)
      
      inline def setPayment(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "payment", value.toJsFn)
