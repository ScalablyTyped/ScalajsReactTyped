...
import typingsJapgolly.`11tyEleventyImg`.`11tyEleventyImgStrings`.avif
import typingsJapgolly.`11tyEleventyImg`.`11tyEleventyImgStrings`.jpeg
import typingsJapgolly.`11tyEleventyImg`.`11tyEleventyImgStrings`.png
import typingsJapgolly.`11tyEleventyImg`.`11tyEleventyImgStrings`.svg
import typingsJapgolly.`11tyEleventyImg`.`11tyEleventyImgStrings`.webp
import typingsJapgolly.`11tyEleventyImg`.mod.FormatHook
