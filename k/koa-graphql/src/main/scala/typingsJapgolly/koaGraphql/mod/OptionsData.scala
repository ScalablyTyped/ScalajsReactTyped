package typingsJapgolly.koaGraphql.mod

import japgolly.scalajs.react.CallbackTo
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.expressGraphql.mod.RequestInfo
...
object OptionsData {
  ...
  def apply(
    ...
    formatError: (/* error */ GraphQLError, /* context */ js.UndefOr[js.Any]) => CallbackTo[js.Any] = null,
    ...
    if (formatError != null) __obj.updateDynamic("formatError")(js.Any.fromFunction2((t0: /* error */ typingsJapgolly.graphql.mod.GraphQLError, t1: /* context */ js.UndefOr[js.Any]) => formatError(t0, t1).runNow()))
