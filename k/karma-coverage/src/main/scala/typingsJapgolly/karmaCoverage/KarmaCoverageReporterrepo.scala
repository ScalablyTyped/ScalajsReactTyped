...
import typingsJapgolly.karmaCoverage.mod.KarmaCoverageReporter
import typingsJapgolly.karmaCoverage.mod.Reporter
import typingsJapgolly.karmaCoverage.mod.ReporterType
