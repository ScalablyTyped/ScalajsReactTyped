package typingsJapgolly.karmaHtmlDetailedReporter

import typingsJapgolly.karmaHtmlDetailedReporter.karmaHtmlDetailedReporterStrings.`type`
import typingsJapgolly.karmaHtmlDetailedReporter.karmaHtmlDetailedReporterStrings.factory
