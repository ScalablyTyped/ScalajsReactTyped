...
import typingsJapgolly.knockout.AnonControlsDescendantBindings
...
object KoLiteActivityBindingHandler {
  ...
  def apply(
    ...
    init: (js.Any, /* valueAccessor */ js.Function0[js.Any], /* allBindingsAccessor */ KnockoutAllBindingsAccessor, js.Any, /* bindingContext */ KnockoutBindingContext) => CallbackTo[Unit | AnonControlsDescendantBindings] = null,
    options: js.Any = null,
    ...
    if (init != null) __obj.updateDynamic("init")(js.Any.fromFunction5((t0: js.Any, t1: /* valueAccessor */ js.Function0[js.Any], t2: /* allBindingsAccessor */ typingsJapgolly.knockout.KnockoutAllBindingsAccessor, t3: js.Any, t4: /* bindingContext */ typingsJapgolly.knockout.KnockoutBindingContext) => init(t0, t1, t2, t3, t4).runNow()))
