package typingsJapgolly.karmaCoverageIstanbulReporter.mod.karmaAugmentingMod

import typingsJapgolly.karmaCoverageIstanbulReporter.mod.CoverageIstanbulReporter
