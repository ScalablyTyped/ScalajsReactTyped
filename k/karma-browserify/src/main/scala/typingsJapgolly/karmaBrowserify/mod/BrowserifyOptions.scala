...
import typingsJapgolly.browserify.mod.InputFile
...
object BrowserifyOptions {
  ...
  def apply(
    ...
    configure: /* bundle */ BrowserifyObject => Callback = null,
    ...
    if (configure != null) __obj.updateDynamic("configure")(js.Any.fromFunction1((t0: /* bundle */ typingsJapgolly.browserify.mod.BrowserifyObject) => configure(t0).runNow()))
