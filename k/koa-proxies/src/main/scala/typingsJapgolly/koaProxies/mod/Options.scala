package typingsJapgolly.koaProxies.mod
...
import typingsJapgolly.httpProxy.mod.ProxyTargetUrl
...
object Options {
  ...
  def apply(
    ...
    rewrite: (/* url */ String, /* ctx */ DefaultContext) => CallbackTo[String] = null,
    ...
    if (rewrite != null) __obj.updateDynamic("rewrite")(js.Any.fromFunction2((t0: /* url */ java.lang.String, t1: /* ctx */ typingsJapgolly.koa.mod.DefaultContext) => rewrite(t0, t1).runNow()))
