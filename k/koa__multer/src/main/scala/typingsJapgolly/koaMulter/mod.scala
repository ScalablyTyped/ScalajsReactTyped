...
import typingsJapgolly.koaMulter.anon.FieldNameSize
...
object mod {
  ...
  object DiskStorageOptions {
    ...
    extension [Self <: DiskStorageOptions](x: Self) {
      ...
      inline def setDestinationFunction3(
        value: (/* req */ IncomingMessage, /* file */ File, /* callback */ js.Function2[/* error */ js.Error | Null, /* destination */ String, Unit]) => Callback
      ): Self = StObject.set(x, "destination", js.Any.fromFunction3((t0: /* req */ IncomingMessage, t1: /* file */ File, t2: /* callback */ js.Function2[/* error */ js.Error | Null, /* destination */ String, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setDestinationUndefined: Self = StObject.set(x, "destination", js.undefined)
      
      inline def setFilename(
        value: (/* req */ IncomingMessage, /* file */ File, /* callback */ js.Function2[/* error */ js.Error | Null, /* filename */ String, Unit]) => Callback
      ): Self = StObject.set(x, "filename", js.Any.fromFunction3((t0: /* req */ IncomingMessage, t1: /* file */ File, t2: /* callback */ js.Function2[/* error */ js.Error | Null, /* filename */ String, Unit]) => (value(t0, t1, t2)).runNow()))
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setFileFilter(
        value: (/* req */ IncomingMessage, /* file */ File, /* callback */ js.Function2[/* error */ js.Error | Null, /* acceptFile */ Boolean, Unit]) => Callback
      ): Self = StObject.set(x, "fileFilter", js.Any.fromFunction3((t0: /* req */ IncomingMessage, t1: /* file */ File, t2: /* callback */ js.Function2[/* error */ js.Error | Null, /* acceptFile */ Boolean, Unit]) => (value(t0, t1, t2)).runNow()))
  ...
  object StorageEngine {
    ...
    inline def apply(
      _handleFile: (IncomingMessage, File, js.Function2[/* error */ js.UndefOr[Any], /* info */ js.UndefOr[File], Unit]) => Callback,
      _removeFile: (IncomingMessage, File, js.Function1[/* error */ js.Error, Unit]) => Callback
    ): StorageEngine = {
      val __obj = js.Dynamic.literal(_handleFile = js.Any.fromFunction3((t0: IncomingMessage, t1: File, t2: js.Function2[/* error */ js.UndefOr[Any], /* info */ js.UndefOr[File], Unit]) => (_handleFile(t0, t1, t2)).runNow()), _removeFile = js.Any.fromFunction3((t0: IncomingMessage, t1: File, t2: js.Function1[/* error */ js.Error, Unit]) => (_removeFile(t0, t1, t2)).runNow()))
    ...
    extension [Self <: StorageEngine](x: Self) {
      ...
      inline def set_handleFile(
        value: (IncomingMessage, File, js.Function2[/* error */ js.UndefOr[Any], /* info */ js.UndefOr[File], Unit]) => Callback
      ): Self = StObject.set(x, "_handleFile", js.Any.fromFunction3((t0: IncomingMessage, t1: File, t2: js.Function2[/* error */ js.UndefOr[Any], /* info */ js.UndefOr[File], Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def set_removeFile(value: (IncomingMessage, File, js.Function1[/* error */ js.Error, Unit]) => Callback): Self = StObject.set(x, "_removeFile", js.Any.fromFunction3((t0: IncomingMessage, t1: File, t2: js.Function1[/* error */ js.Error, Unit]) => (value(t0, t1, t2)).runNow()))
    }
  }
  ...
  object koaAugmentingMod {
    ...
    trait DefaultContext extends StObject {
      ...
      var files: js.UndefOr[
            StringDictionary[js.Array[org.scalajs.dom.File]] | js.Array[org.scalajs.dom.File]
          ] = js.undefined
    }
    object DefaultContext {
      
      inline def apply(file: org.scalajs.dom.File): typingsJapgolly.koaMulter.mod.koaAugmentingMod.DefaultContext = {
        val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.koaMulter.mod.koaAugmentingMod.DefaultContext]
      }
      
      extension [Self <: typingsJapgolly.koaMulter.mod.koaAugmentingMod.DefaultContext](x: Self) {
        
        inline def setFile(value: org.scalajs.dom.File): Self = StObject.set(x, "file", value.asInstanceOf[js.Any])
        
        inline def setFiles(value: StringDictionary[js.Array[org.scalajs.dom.File]] | js.Array[org.scalajs.dom.File]): Self = StObject.set(x, "files", value.asInstanceOf[js.Any])
    ...
    object Request {
      ...
      inline def apply(file: org.scalajs.dom.File): Request = {
        val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
