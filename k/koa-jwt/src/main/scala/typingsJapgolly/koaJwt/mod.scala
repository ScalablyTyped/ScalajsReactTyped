package typingsJapgolly.koaJwt

import typingsJapgolly.koa.mod.Context
import typingsJapgolly.koa.mod.DefaultContext
import typingsJapgolly.koa.mod.DefaultState
import typingsJapgolly.koaJwt.anon.Custom
...
object mod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify compose.Middleware<ParameterizedContext<StateT, ContextT, ResponseBodyT>> * / any */ trait Middleware extends StObject {
    ...
    def unless(): typingsJapgolly.koa.mod.Middleware[DefaultState, DefaultContext, Any]
    def unless(params: Custom): typingsJapgolly.koa.mod.Middleware[DefaultState, DefaultContext, Any]
    @JSName("unless")
  ...
  object Middleware {
    ...
    inline def apply(
      unless: /* params */ js.UndefOr[Custom] => typingsJapgolly.koa.mod.Middleware[DefaultState, DefaultContext, Any]
    ): Middleware = {
    ...
    extension [Self <: Middleware](x: Self) {
      ...
      inline def setUnless(
        value: /* params */ js.UndefOr[Custom] => typingsJapgolly.koa.mod.Middleware[DefaultState, DefaultContext, Any]
  ...
  type UnlessOptions = js.Function1[
    ...
    typingsJapgolly.koa.mod.Middleware[DefaultState, DefaultContext, Any]
  ]
}
