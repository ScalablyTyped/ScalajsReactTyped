...
object KBarSearch {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def defaultPlaceholder(value: String): this.type = set("defaultPlaceholder", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: KBarSearch.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InputHTMLAttributesHTMLIn): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
