...
import typingsJapgolly.kbar.kbarStrings.`additions removals`
import typingsJapgolly.kbar.kbarStrings.`additions text`
import typingsJapgolly.kbar.kbarStrings.`inline`
import typingsJapgolly.kbar.kbarStrings.`removals additions`
import typingsJapgolly.kbar.kbarStrings.`removals text`
import typingsJapgolly.kbar.kbarStrings.`text additions`
import typingsJapgolly.kbar.kbarStrings.`text removals`
import typingsJapgolly.kbar.kbarStrings.additions
import typingsJapgolly.kbar.kbarStrings.all
import typingsJapgolly.kbar.kbarStrings.ascending
import typingsJapgolly.kbar.kbarStrings.assertive
import typingsJapgolly.kbar.kbarStrings.both
import typingsJapgolly.kbar.kbarStrings.copy
import typingsJapgolly.kbar.kbarStrings.date
import typingsJapgolly.kbar.kbarStrings.decimal
import typingsJapgolly.kbar.kbarStrings.descending
import typingsJapgolly.kbar.kbarStrings.dialog
import typingsJapgolly.kbar.kbarStrings.done
import typingsJapgolly.kbar.kbarStrings.email
import typingsJapgolly.kbar.kbarStrings.enter
import typingsJapgolly.kbar.kbarStrings.environment
import typingsJapgolly.kbar.kbarStrings.execute
import typingsJapgolly.kbar.kbarStrings.go
import typingsJapgolly.kbar.kbarStrings.grammar
import typingsJapgolly.kbar.kbarStrings.grid
import typingsJapgolly.kbar.kbarStrings.horizontal
import typingsJapgolly.kbar.kbarStrings.inherit
import typingsJapgolly.kbar.kbarStrings.link
import typingsJapgolly.kbar.kbarStrings.list
import typingsJapgolly.kbar.kbarStrings.listbox
import typingsJapgolly.kbar.kbarStrings.location
import typingsJapgolly.kbar.kbarStrings.menu
import typingsJapgolly.kbar.kbarStrings.mixed
import typingsJapgolly.kbar.kbarStrings.move
import typingsJapgolly.kbar.kbarStrings.next
import typingsJapgolly.kbar.kbarStrings.no
import typingsJapgolly.kbar.kbarStrings.none
import typingsJapgolly.kbar.kbarStrings.numeric
import typingsJapgolly.kbar.kbarStrings.off
import typingsJapgolly.kbar.kbarStrings.on
import typingsJapgolly.kbar.kbarStrings.other
import typingsJapgolly.kbar.kbarStrings.page
import typingsJapgolly.kbar.kbarStrings.polite
import typingsJapgolly.kbar.kbarStrings.popup
import typingsJapgolly.kbar.kbarStrings.previous
import typingsJapgolly.kbar.kbarStrings.removals
import typingsJapgolly.kbar.kbarStrings.search
import typingsJapgolly.kbar.kbarStrings.send
import typingsJapgolly.kbar.kbarStrings.spelling
import typingsJapgolly.kbar.kbarStrings.step
import typingsJapgolly.kbar.kbarStrings.tel
import typingsJapgolly.kbar.kbarStrings.text
import typingsJapgolly.kbar.kbarStrings.time
import typingsJapgolly.kbar.kbarStrings.tree
import typingsJapgolly.kbar.kbarStrings.url
import typingsJapgolly.kbar.kbarStrings.user
import typingsJapgolly.kbar.kbarStrings.vertical
import typingsJapgolly.kbar.kbarStrings.yes
import typingsJapgolly.kbar.libActionActionImplMod.ActionImpl
import typingsJapgolly.kbar.libTypesMod.ActionId
import typingsJapgolly.kbar.libTypesMod.ActionSection
import typingsJapgolly.kbar.libTypesMod.HistoryItem
import typingsJapgolly.kbar.libTypesMod.Priority
...
object anon {
  ...
  trait EnterMs extends StObject {
    
    var enterMs: js.UndefOr[Double] = js.undefined
    
    var exitMs: js.UndefOr[Double] = js.undefined
  }
  object EnterMs {
    
    inline def apply(): EnterMs = {
    ...
    extension [Self <: EnterMs](x: Self) {
      ...
      inline def setEnterMsUndefined: Self = StObject.set(x, "enterMs", js.undefined)
      
      inline def setExitMs(value: Double): Self = StObject.set(x, "exitMs", value.asInstanceOf[js.Any])
      
      inline def setExitMsUndefined: Self = StObject.set(x, "exitMs", js.undefined)
    }
  }
  
  trait IgnoreWhenFocused extends StObject {
    
    var ignoreWhenFocused: js.Array[String]
  }
  object IgnoreWhenFocused {
    
    inline def apply(ignoreWhenFocused: js.Array[String]): IgnoreWhenFocused = {
      val __obj = js.Dynamic.literal(ignoreWhenFocused = ignoreWhenFocused.asInstanceOf[js.Any])
    ...
    extension [Self <: IgnoreWhenFocused](x: Self) {
      ...
      inline def setIgnoreWhenFocusedVarargs(value: String*): Self = StObject.set(x, "ignoreWhenFocused", js.Array(value*))
    }
  }
  
  /* Inlined react.react.InputHTMLAttributes<std.HTMLInputElement> & {  defaultPlaceholder :string | undefined} */
  trait InputHTMLAttributesHTMLIn extends StObject {
    ...
    var defaultPlaceholder: js.UndefOr[String] = js.undefined
  ...
  object InputHTMLAttributesHTMLIn {
    
    inline def apply(): InputHTMLAttributesHTMLIn = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: InputHTMLAttributesHTMLIn](x: Self) {
      ...
      inline def setDefaultPlaceholder(value: String): Self = StObject.set(x, "defaultPlaceholder", value.asInstanceOf[js.Any])
      
      inline def setDefaultPlaceholderUndefined: Self = StObject.set(x, "defaultPlaceholder", js.undefined)
  ...
  object Name {
    ...
    inline def apply(name: String, priority: Priority): Name = {
  ...
  /* Inlined std.Omit<kbar.kbar/lib/types.Action, 'id'> */
  trait OmitActionid extends StObject {
  ...
  object OmitActionid {
    ...
    inline def apply(name: String): OmitActionid = {
  ...
  trait OnClose extends StObject {
    ...
    var onQueryChange: js.UndefOr[js.Function1[/* searchQuery */ String, Unit]] = js.undefined
    
    var onSelectAction: js.UndefOr[js.Function1[/* action */ ActionImpl, Unit]] = js.undefined
  }
  object OnClose {
    ...
    extension [Self <: OnClose](x: Self) {
      ...
      inline def setOnQueryChange(value: /* searchQuery */ String => Callback): Self = StObject.set(x, "onQueryChange", js.Any.fromFunction1((t0: /* searchQuery */ String) => value(t0).runNow()))
      
      inline def setOnQueryChangeUndefined: Self = StObject.set(x, "onQueryChange", js.undefined)
      
      inline def setOnSelectAction(value: /* action */ ActionImpl => Callback): Self = StObject.set(x, "onSelectAction", js.Any.fromFunction1((t0: /* action */ ActionImpl) => value(t0).runNow()))
      
      inline def setOnSelectActionUndefined: Self = StObject.set(x, "onSelectAction", js.undefined)
    }
  }
  
  trait Perform extends StObject {
    
    var perform: js.Function1[/* args */ Any, Any]
  }
  object Perform {
    
    inline def apply(perform: /* args */ Any => Any): Perform = {
  ...
  trait Redo extends StObject {
    ...
    var redo: js.Function1[/* item */ js.UndefOr[HistoryItem], Unit]
    
    var undo: js.Function1[/* item */ js.UndefOr[HistoryItem], Unit]
  }
  object Redo {
    
    inline def apply(
      redo: /* item */ js.UndefOr[HistoryItem] => Callback,
      undo: /* item */ js.UndefOr[HistoryItem] => Callback
    ): Redo = {
      val __obj = js.Dynamic.literal(redo = js.Any.fromFunction1((t0: /* item */ js.UndefOr[HistoryItem]) => redo(t0).runNow()), undo = js.Any.fromFunction1((t0: /* item */ js.UndefOr[HistoryItem]) => undo(t0).runNow()))
      __obj.asInstanceOf[Redo]
    }
    
    extension [Self <: Redo](x: Self) {
      
      inline def setRedo(value: /* item */ js.UndefOr[HistoryItem] => Callback): Self = StObject.set(x, "redo", js.Any.fromFunction1((t0: /* item */ js.UndefOr[HistoryItem]) => value(t0).runNow()))
      
      inline def setUndo(value: /* item */ js.UndefOr[HistoryItem] => Callback): Self = StObject.set(x, "undo", js.Any.fromFunction1((t0: /* item */ js.UndefOr[HistoryItem]) => value(t0).runNow()))
    }
  }
  
  trait Results extends StObject {
    
    var results: js.Array[String | ActionImpl]
    
    var rootActionId: js.UndefOr[String | Null] = js.undefined
  }
  object Results {
    
    inline def apply(results: js.Array[String | ActionImpl]): Results = {
    ...
    extension [Self <: Results](x: Self) {
      ...
      inline def setResultsVarargs(value: (String | ActionImpl)*): Self = StObject.set(x, "results", js.Array(value*))
      
      inline def setRootActionId(value: String): Self = StObject.set(x, "rootActionId", value.asInstanceOf[js.Any])
      
      inline def setRootActionIdNull: Self = StObject.set(x, "rootActionId", null)
      
      inline def setRootActionIdUndefined: Self = StObject.set(x, "rootActionId", js.undefined)
    }
  }
}
