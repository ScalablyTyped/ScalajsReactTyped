...
object KramedOptions {
  ...
  def apply(
    ...
    highlight: (/* code */ String, /* lang */ String, /* callback */ js.UndefOr[js.Function0[Unit]]) => CallbackTo[String] = null,
    ...
    if (highlight != null) __obj.updateDynamic("highlight")(js.Any.fromFunction3((t0: /* code */ java.lang.String, t1: /* lang */ java.lang.String, t2: /* callback */ js.UndefOr[js.Function0[scala.Unit]]) => highlight(t0, t1, t2).runNow()))
