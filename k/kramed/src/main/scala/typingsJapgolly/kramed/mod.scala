...
import typingsJapgolly.kramed.anon.Align
import typingsJapgolly.kramed.anon.Instantiable
import typingsJapgolly.kramed.anon.InstantiableKramedParser
...
object mod {
  ...
  object KramedRenderer {
    ...
    extension [Self <: KramedRenderer](x: Self) {
      ...
      inline def setBr(value: CallbackTo[String]): Self = StObject.set(x, "br", value.toJsFn)
      ...
      inline def setHr(value: CallbackTo[String]): Self = StObject.set(x, "hr", value.toJsFn)
