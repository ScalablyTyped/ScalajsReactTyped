...
version := "1.0-dt-20211202Z-5c27e1"
scalaVersion := "3.1.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "busboy" % "1.5-dt-20220624Z-404502",
  "org.scalablytyped.japgolly" %%% "co-body" % "6.1-dt-20211202Z-86db7a",
  ...
  "org.scalablytyped.japgolly" %%% "koa-joi-router" % "8.0-dt-20220106Z-b1c390",
