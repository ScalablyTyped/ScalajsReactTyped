...
import typingsJapgolly.knockoutTransformations.anon.Dispose
...
object KnockoutTransformations {
  ...
  object MappingOption {
    ...
    extension [Self <: MappingOption[?, ?], T, TResult](x: Self & (MappingOption[T, TResult])) {
      ...
      inline def setDisposeItem(value: /* item */ TResult => Callback): Self = StObject.set(x, "disposeItem", js.Any.fromFunction1((t0: /* item */ TResult) => value(t0).runNow()))
