...
import typingsJapgolly.kendoUi.anon.TypeofTreeListModel
...
open class TreeListModel ()
  extends StObject
     with typingsJapgolly.kendoUi.kendo.data.TreeListModel {
