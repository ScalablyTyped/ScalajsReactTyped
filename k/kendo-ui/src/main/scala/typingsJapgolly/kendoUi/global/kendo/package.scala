...
import typingsJapgolly.kendoUi.anon.Calendar
import typingsJapgolly.kendoUi.anon.TypeofWidget
import typingsJapgolly.kendoUi.anon.Typeofui
import typingsJapgolly.kendoUi.anon.TypeofuiActionSheet
import typingsJapgolly.kendoUi.anon.TypeofuiArcGauge
import typingsJapgolly.kendoUi.global.kendo.^
import typingsJapgolly.kendoUi.kendo.History
import typingsJapgolly.kendoUi.kendo.TemplateOptions
...
inline def fx(element: Element): typingsJapgolly.kendoUi.kendo.effects.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("fx")(element.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kendoUi.kendo.effects.Element]
inline def fx(element: JQuery): typingsJapgolly.kendoUi.kendo.effects.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("fx")(element.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kendoUi.kendo.effects.Element]
inline def fx(selector: String): typingsJapgolly.kendoUi.kendo.effects.Element = ^.asInstanceOf[js.Dynamic].applyDynamic("fx")(selector.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kendoUi.kendo.effects.Element]
...
inline def parseColor(color: String, noerror: Boolean): typingsJapgolly.kendoUi.kendo.Color = (^.asInstanceOf[js.Dynamic].applyDynamic("parseColor")(color.asInstanceOf[js.Any], noerror.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.kendoUi.kendo.Color]
