...
object filemanager {
  ...
  open class FileManagerCommand ()
    extends StObject
       with typingsJapgolly.kendoUi.kendo.ui.filemanager.FileManagerCommand
  ...
  object commands {
    ...
    open class ChangeViewCommand ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.ui.filemanager.commands.ChangeViewCommand
    
    @JSGlobal("kendo.ui.filemanager.commands.CopyCommand")
    @js.native
    open class CopyCommand ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.ui.filemanager.commands.CopyCommand
    
    @JSGlobal("kendo.ui.filemanager.commands.CreateFolderCommand")
    @js.native
    open class CreateFolderCommand ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.ui.filemanager.commands.CreateFolderCommand
    
    @JSGlobal("kendo.ui.filemanager.commands.DeleteCommand")
    @js.native
    open class DeleteCommand ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.ui.filemanager.commands.DeleteCommand
    
    @JSGlobal("kendo.ui.filemanager.commands.MoveCommand")
    @js.native
    open class MoveCommand ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.ui.filemanager.commands.MoveCommand
    
    @JSGlobal("kendo.ui.filemanager.commands.OpenDialogCommand")
    @js.native
    open class OpenDialogCommand ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.ui.filemanager.commands.OpenDialogCommand
    
    @JSGlobal("kendo.ui.filemanager.commands.RenameCommand")
    @js.native
    open class RenameCommand ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.ui.filemanager.commands.RenameCommand
    
    @JSGlobal("kendo.ui.filemanager.commands.SearchCommand")
    @js.native
    open class SearchCommand ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.ui.filemanager.commands.SearchCommand
    
    @JSGlobal("kendo.ui.filemanager.commands.SortCommand")
    @js.native
    open class SortCommand ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.ui.filemanager.commands.SortCommand
    
    @JSGlobal("kendo.ui.filemanager.commands.TogglePaneCommand")
    @js.native
    open class TogglePaneCommand ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.ui.filemanager.commands.TogglePaneCommand {
