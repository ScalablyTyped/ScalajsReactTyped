...
object spreadsheet {
  ...
  open class CustomFilter ()
    extends StObject
       with typingsJapgolly.kendoUi.kendo.spreadsheet.CustomFilter
  
  @JSGlobal("kendo.spreadsheet.DynamicFilter")
  @js.native
  open class DynamicFilter ()
    extends StObject
       with typingsJapgolly.kendoUi.kendo.spreadsheet.DynamicFilter
  
  @JSGlobal("kendo.spreadsheet.Range")
  @js.native
  open class Range ()
    extends StObject
       with typingsJapgolly.kendoUi.kendo.spreadsheet.Range
  
  @JSGlobal("kendo.spreadsheet.Sheet")
  @js.native
  open class Sheet ()
    extends StObject
       with typingsJapgolly.kendoUi.kendo.spreadsheet.Sheet
  
  @JSGlobal("kendo.spreadsheet.TopFilter")
  @js.native
  open class TopFilter ()
    extends StObject
       with typingsJapgolly.kendoUi.kendo.spreadsheet.TopFilter
  
  @JSGlobal("kendo.spreadsheet.ValueFilter")
  @js.native
  open class ValueFilter ()
    extends StObject
       with typingsJapgolly.kendoUi.kendo.spreadsheet.ValueFilter
