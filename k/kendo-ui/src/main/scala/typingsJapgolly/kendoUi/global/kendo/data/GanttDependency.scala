...
import typingsJapgolly.kendoUi.anon.TypeofGanttDependency
...
open class GanttDependency ()
  extends StObject
     with typingsJapgolly.kendoUi.kendo.data.GanttDependency {
