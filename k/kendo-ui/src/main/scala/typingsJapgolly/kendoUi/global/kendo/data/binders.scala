...
import typingsJapgolly.kendoUi.kendo.data.DataSourceBinder
...
object binders {
  ...
  object input {
    ...
    open class checked ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.data.binders.input.checked
  }
  ...
  object select {
    ...
    open class source ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.data.binders.source
    
    @JSGlobal("kendo.data.binders.select.value")
    @js.native
    open class value ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.data.binders.select.value
  }
  ...
  open class value ()
    extends StObject
       with typingsJapgolly.kendoUi.kendo.data.binders.value
  ...
  object widget {
    ...
    open class checked ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.data.binders.widget.checked
    ...
    object dropdowntree {
      ...
      open class value ()
        extends StObject
           with typingsJapgolly.kendoUi.kendo.data.binders.widget.dropdowntree.value
    }
    ...
    open class end ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.data.binders.widget.end
    ...
    object multiselect {
      ...
      open class value ()
        extends StObject
           with typingsJapgolly.kendoUi.kendo.data.binders.widget.multiselect.value
    }
    ...
    open class start ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.data.binders.widget.start
    
    @JSGlobal("kendo.data.binders.widget.value")
    @js.native
    open class value ()
      extends StObject
         with typingsJapgolly.kendoUi.kendo.data.binders.widget.value
