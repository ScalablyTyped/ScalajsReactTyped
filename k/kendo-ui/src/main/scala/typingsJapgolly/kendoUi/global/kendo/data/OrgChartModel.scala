...
import typingsJapgolly.kendoUi.anon.TypeofOrgChartModel
...
open class OrgChartModel ()
  extends StObject
     with typingsJapgolly.kendoUi.kendo.data.OrgChartModel {
