...
object WizardOptions {
  ...
  extension [Self <: WizardOptions](x: Self) {
    ...
    inline def setActivate(value: /* e */ WizardActivateEvent => Callback): Self = StObject.set(x, "activate", js.Any.fromFunction1((t0: /* e */ WizardActivateEvent) => value(t0).runNow()))
    
    inline def setActivateUndefined: Self = StObject.set(x, "activate", js.undefined)
    
    inline def setContentLoad(value: /* e */ WizardContentLoadEvent => Callback): Self = StObject.set(x, "contentLoad", js.Any.fromFunction1((t0: /* e */ WizardContentLoadEvent) => value(t0).runNow()))
    ...
    inline def setDone(value: /* e */ WizardDoneEvent => Callback): Self = StObject.set(x, "done", js.Any.fromFunction1((t0: /* e */ WizardDoneEvent) => value(t0).runNow()))
    
    inline def setDoneUndefined: Self = StObject.set(x, "done", js.undefined)
    
    inline def setError(value: /* e */ WizardErrorEvent => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* e */ WizardErrorEvent) => value(t0).runNow()))
    
    inline def setErrorUndefined: Self = StObject.set(x, "error", js.undefined)
    
    inline def setFormValidateFailed(value: /* e */ WizardFormValidateFailedEvent => Callback): Self = StObject.set(x, "formValidateFailed", js.Any.fromFunction1((t0: /* e */ WizardFormValidateFailedEvent) => value(t0).runNow()))
    ...
    inline def setReset(value: /* e */ WizardResetEvent => Callback): Self = StObject.set(x, "reset", js.Any.fromFunction1((t0: /* e */ WizardResetEvent) => value(t0).runNow()))
    
    inline def setResetUndefined: Self = StObject.set(x, "reset", js.undefined)
    
    inline def setSelect(value: /* e */ WizardSelectEvent => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* e */ WizardSelectEvent) => value(t0).runNow()))
