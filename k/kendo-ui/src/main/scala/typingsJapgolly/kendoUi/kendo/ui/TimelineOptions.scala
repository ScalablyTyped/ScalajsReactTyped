...
object TimelineOptions {
  ...
  extension [Self <: TimelineOptions](x: Self) {
    ...
    inline def setActionClick(value: /* e */ TimelineActionClickEvent => Callback): Self = StObject.set(x, "actionClick", js.Any.fromFunction1((t0: /* e */ TimelineActionClickEvent) => value(t0).runNow()))
    ...
    inline def setChange(value: /* e */ TimelineChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ TimelineChangeEvent) => value(t0).runNow()))
    
    inline def setChangeUndefined: Self = StObject.set(x, "change", js.undefined)
    
    inline def setCollapse(value: /* e */ TimelineCollapseEvent => Callback): Self = StObject.set(x, "collapse", js.Any.fromFunction1((t0: /* e */ TimelineCollapseEvent) => value(t0).runNow()))
    ...
    inline def setDataBound(value: /* e */ TimelineDataBoundEvent => Callback): Self = StObject.set(x, "dataBound", js.Any.fromFunction1((t0: /* e */ TimelineDataBoundEvent) => value(t0).runNow()))
    ...
    inline def setExpand(value: /* e */ TimelineExpandEvent => Callback): Self = StObject.set(x, "expand", js.Any.fromFunction1((t0: /* e */ TimelineExpandEvent) => value(t0).runNow()))
    ...
    inline def setNavigate(value: /* e */ TimelineNavigateEvent => Callback): Self = StObject.set(x, "navigate", js.Any.fromFunction1((t0: /* e */ TimelineNavigateEvent) => value(t0).runNow()))
