...
object SparklineValueAxisItemTitle {
  ...
  inline def apply(): SparklineValueAxisItemTitle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SparklineValueAxisItemTitle]
  }
  
  extension [Self <: SparklineValueAxisItemTitle](x: Self) {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: SparklineValueAxisItemTitleBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
