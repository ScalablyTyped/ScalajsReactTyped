...
trait SparklineSeriesLeaveEvent
  extends StObject
     with SparklineEvent {
...
object SparklineSeriesLeaveEvent {
  ...
  inline def apply(isDefaultPrevented: CallbackTo[Boolean], preventDefault: js.Function, sender: Sparkline): SparklineSeriesLeaveEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = isDefaultPrevented.toJsFn, preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[SparklineSeriesLeaveEvent]
  }
  
  extension [Self <: SparklineSeriesLeaveEvent](x: Self) {
    ...
    inline def setSeries(value: SparklineSeriesLeaveEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
