...
object StockChartPdf {
  ...
  inline def apply(): StockChartPdf = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartPdf]
  }
  
  extension [Self <: StockChartPdf](x: Self) {
    ...
    inline def setMargin(value: StockChartPdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
