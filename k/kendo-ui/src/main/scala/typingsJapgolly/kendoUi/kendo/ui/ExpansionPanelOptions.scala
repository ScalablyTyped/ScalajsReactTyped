...
object ExpansionPanelOptions {
  ...
  extension [Self <: ExpansionPanelOptions](x: Self) {
    ...
    inline def setCollapse(value: /* e */ ExpansionPanelEvent => Callback): Self = StObject.set(x, "collapse", js.Any.fromFunction1((t0: /* e */ ExpansionPanelEvent) => value(t0).runNow()))
    ...
    inline def setComplete(value: /* e */ ExpansionPanelEvent => Callback): Self = StObject.set(x, "complete", js.Any.fromFunction1((t0: /* e */ ExpansionPanelEvent) => value(t0).runNow()))
    ...
    inline def setExpand(value: /* e */ ExpansionPanelEvent => Callback): Self = StObject.set(x, "expand", js.Any.fromFunction1((t0: /* e */ ExpansionPanelEvent) => value(t0).runNow()))
