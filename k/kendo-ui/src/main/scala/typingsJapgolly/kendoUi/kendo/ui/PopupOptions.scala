...
object PopupOptions {
  ...
  extension [Self <: PopupOptions](x: Self) {
    ...
    inline def setActivate(value: /* e */ PopupActivateEvent => Callback): Self = StObject.set(x, "activate", js.Any.fromFunction1((t0: /* e */ PopupActivateEvent) => value(t0).runNow()))
    ...
    inline def setClose(value: /* e */ PopupCloseEvent => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: /* e */ PopupCloseEvent) => value(t0).runNow()))
    ...
    inline def setDeactivate(value: /* e */ PopupDeactivateEvent => Callback): Self = StObject.set(x, "deactivate", js.Any.fromFunction1((t0: /* e */ PopupDeactivateEvent) => value(t0).runNow()))
    ...
    inline def setOpen(value: /* e */ PopupOpenEvent => Callback): Self = StObject.set(x, "open", js.Any.fromFunction1((t0: /* e */ PopupOpenEvent) => value(t0).runNow()))
