...
object ComboBoxOptions {
  ...
  def apply(
    ...
    cascade: /* e */ ComboBoxCascadeEvent => Callback = null,
    cascadeFrom: String = null,
    cascadeFromField: String = null,
    change: /* e */ ComboBoxChangeEvent => Callback = null,
    clearButton: js.UndefOr[Boolean] = js.undefined,
    close: /* e */ ComboBoxCloseEvent => Callback = null,
    dataBound: /* e */ ComboBoxDataBoundEvent => Callback = null,
    ...
    filter: String = null,
    filtering: /* e */ ComboBoxFilteringEvent => Callback = null,
    ...
    open: /* e */ ComboBoxOpenEvent => Callback = null,
    placeholder: String = null,
    popup: ComboBoxPopup = null,
    select: /* e */ ComboBoxSelectEvent => Callback = null,
    ...
    if (cascade != null) __obj.updateDynamic("cascade")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.ComboBoxCascadeEvent) => cascade(t0).runNow()))
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.ComboBoxChangeEvent) => change(t0).runNow()))
    if (!js.isUndefined(clearButton)) __obj.updateDynamic("clearButton")(clearButton.asInstanceOf[js.Any])
    if (close != null) __obj.updateDynamic("close")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.ComboBoxCloseEvent) => close(t0).runNow()))
    if (dataBound != null) __obj.updateDynamic("dataBound")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.ComboBoxDataBoundEvent) => dataBound(t0).runNow()))
    ...
    if (filtering != null) __obj.updateDynamic("filtering")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.ComboBoxFilteringEvent) => filtering(t0).runNow()))
    ...
    if (open != null) __obj.updateDynamic("open")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.ComboBoxOpenEvent) => open(t0).runNow()))
    if (placeholder != null) __obj.updateDynamic("placeholder")(placeholder.asInstanceOf[js.Any])
    if (popup != null) __obj.updateDynamic("popup")(popup.asInstanceOf[js.Any])
    if (select != null) __obj.updateDynamic("select")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.ComboBoxSelectEvent) => select(t0).runNow()))
