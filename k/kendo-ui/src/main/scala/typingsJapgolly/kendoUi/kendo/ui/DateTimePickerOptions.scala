...
object DateTimePickerOptions {
  ...
  extension [Self <: DateTimePickerOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ DateTimePickerChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ DateTimePickerChangeEvent) => value(t0).runNow()))
    
    inline def setChangeUndefined: Self = StObject.set(x, "change", js.undefined)
    
    inline def setClose(value: /* e */ DateTimePickerCloseEvent => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: /* e */ DateTimePickerCloseEvent) => value(t0).runNow()))
    ...
    inline def setOpen(value: /* e */ DateTimePickerOpenEvent => Callback): Self = StObject.set(x, "open", js.Any.fromFunction1((t0: /* e */ DateTimePickerOpenEvent) => value(t0).runNow()))
