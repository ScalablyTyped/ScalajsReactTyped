...
object ColorGradientOptions {
  ...
  extension [Self <: ColorGradientOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ ColorGradientChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ ColorGradientChangeEvent) => value(t0).runNow()))
