...
trait DiagramConnectionDefaultsContent extends StObject {
...
object DiagramConnectionDefaultsContent {
  ...
  inline def apply(): DiagramConnectionDefaultsContent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramConnectionDefaultsContent]
  }
  
  extension [Self <: DiagramConnectionDefaultsContent](x: Self) {
