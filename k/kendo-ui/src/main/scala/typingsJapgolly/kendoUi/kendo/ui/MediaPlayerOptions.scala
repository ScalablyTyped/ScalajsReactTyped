...
object MediaPlayerOptions {
  ...
  extension [Self <: MediaPlayerOptions](x: Self) {
    ...
    inline def setEnd(value: /* e */ MediaPlayerEvent => Callback): Self = StObject.set(x, "end", js.Any.fromFunction1((t0: /* e */ MediaPlayerEvent) => value(t0).runNow()))
    ...
    inline def setPause(value: /* e */ MediaPlayerEvent => Callback): Self = StObject.set(x, "pause", js.Any.fromFunction1((t0: /* e */ MediaPlayerEvent) => value(t0).runNow()))
    
    inline def setPauseUndefined: Self = StObject.set(x, "pause", js.undefined)
    
    inline def setPlay(value: /* e */ MediaPlayerEvent => Callback): Self = StObject.set(x, "play", js.Any.fromFunction1((t0: /* e */ MediaPlayerEvent) => value(t0).runNow()))
    
    inline def setPlayUndefined: Self = StObject.set(x, "play", js.undefined)
    
    inline def setReady(value: /* e */ MediaPlayerEvent => Callback): Self = StObject.set(x, "ready", js.Any.fromFunction1((t0: /* e */ MediaPlayerEvent) => value(t0).runNow()))
    
    inline def setReadyUndefined: Self = StObject.set(x, "ready", js.undefined)
    
    inline def setTimeChange(value: /* e */ MediaPlayerEvent => Callback): Self = StObject.set(x, "timeChange", js.Any.fromFunction1((t0: /* e */ MediaPlayerEvent) => value(t0).runNow()))
    
    inline def setTimeChangeUndefined: Self = StObject.set(x, "timeChange", js.undefined)
    
    inline def setVolume(value: Double): Self = StObject.set(x, "volume", value.asInstanceOf[js.Any])
    
    inline def setVolumeChange(value: /* e */ MediaPlayerEvent => Callback): Self = StObject.set(x, "volumeChange", js.Any.fromFunction1((t0: /* e */ MediaPlayerEvent) => value(t0).runNow()))
