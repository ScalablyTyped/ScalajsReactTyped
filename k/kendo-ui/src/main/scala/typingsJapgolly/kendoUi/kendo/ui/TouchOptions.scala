...
object TouchOptions {
  ...
  extension [Self <: TouchOptions](x: Self) {
    ...
    inline def setDoubletap(value: /* e */ TouchDoubletapEvent => Callback): Self = StObject.set(x, "doubletap", js.Any.fromFunction1((t0: /* e */ TouchDoubletapEvent) => value(t0).runNow()))
    
    inline def setDoubletapUndefined: Self = StObject.set(x, "doubletap", js.undefined)
    
    inline def setDrag(value: /* e */ TouchDragEvent => Callback): Self = StObject.set(x, "drag", js.Any.fromFunction1((t0: /* e */ TouchDragEvent) => value(t0).runNow()))
    
    inline def setDragUndefined: Self = StObject.set(x, "drag", js.undefined)
    
    inline def setDragend(value: /* e */ TouchDragendEvent => Callback): Self = StObject.set(x, "dragend", js.Any.fromFunction1((t0: /* e */ TouchDragendEvent) => value(t0).runNow()))
    
    inline def setDragendUndefined: Self = StObject.set(x, "dragend", js.undefined)
    
    inline def setDragstart(value: /* e */ TouchDragstartEvent => Callback): Self = StObject.set(x, "dragstart", js.Any.fromFunction1((t0: /* e */ TouchDragstartEvent) => value(t0).runNow()))
    ...
    inline def setGesturechange(value: /* e */ TouchGesturechangeEvent => Callback): Self = StObject.set(x, "gesturechange", js.Any.fromFunction1((t0: /* e */ TouchGesturechangeEvent) => value(t0).runNow()))
    
    inline def setGesturechangeUndefined: Self = StObject.set(x, "gesturechange", js.undefined)
    
    inline def setGestureend(value: /* e */ TouchGestureendEvent => Callback): Self = StObject.set(x, "gestureend", js.Any.fromFunction1((t0: /* e */ TouchGestureendEvent) => value(t0).runNow()))
    
    inline def setGestureendUndefined: Self = StObject.set(x, "gestureend", js.undefined)
    
    inline def setGesturestart(value: /* e */ TouchGesturestartEvent => Callback): Self = StObject.set(x, "gesturestart", js.Any.fromFunction1((t0: /* e */ TouchGesturestartEvent) => value(t0).runNow()))
    
    inline def setGesturestartUndefined: Self = StObject.set(x, "gesturestart", js.undefined)
    
    inline def setHold(value: /* e */ TouchHoldEvent => Callback): Self = StObject.set(x, "hold", js.Any.fromFunction1((t0: /* e */ TouchHoldEvent) => value(t0).runNow()))
    ...
    inline def setSwipe(value: /* e */ TouchSwipeEvent => Callback): Self = StObject.set(x, "swipe", js.Any.fromFunction1((t0: /* e */ TouchSwipeEvent) => value(t0).runNow()))
    
    inline def setSwipeUndefined: Self = StObject.set(x, "swipe", js.undefined)
    
    inline def setTap(value: /* e */ TouchTapEvent => Callback): Self = StObject.set(x, "tap", js.Any.fromFunction1((t0: /* e */ TouchTapEvent) => value(t0).runNow()))
    
    inline def setTapUndefined: Self = StObject.set(x, "tap", js.undefined)
    
    inline def setTouchstart(value: /* e */ TouchTouchstartEvent => Callback): Self = StObject.set(x, "touchstart", js.Any.fromFunction1((t0: /* e */ TouchTouchstartEvent) => value(t0).runNow()))
