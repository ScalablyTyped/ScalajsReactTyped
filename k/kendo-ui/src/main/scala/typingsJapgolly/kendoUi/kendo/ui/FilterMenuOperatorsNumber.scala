...
trait FilterMenuOperatorsNumber extends StObject {
  ...
  @JSName("eq")
  var eq_FFilterMenuOperatorsNumber: js.UndefOr[String] = js.undefined
...
object FilterMenuOperatorsNumber {
  ...
  inline def apply(): FilterMenuOperatorsNumber = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FilterMenuOperatorsNumber]
  }
  
  extension [Self <: FilterMenuOperatorsNumber](x: Self) {
