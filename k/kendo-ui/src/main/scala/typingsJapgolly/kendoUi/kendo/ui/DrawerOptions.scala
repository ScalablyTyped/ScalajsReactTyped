...
object DrawerOptions {
  ...
  extension [Self <: DrawerOptions](x: Self) {
    ...
    inline def setItemClick(value: /* e */ DrawerEvent => Callback): Self = StObject.set(x, "itemClick", js.Any.fromFunction1((t0: /* e */ DrawerEvent) => value(t0).runNow()))
    ...
    inline def setShow(value: /* e */ DrawerEvent => Callback): Self = StObject.set(x, "show", js.Any.fromFunction1((t0: /* e */ DrawerEvent) => value(t0).runNow()))
