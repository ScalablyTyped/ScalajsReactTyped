...
object PanelBarOptions {
  ...
  extension [Self <: PanelBarOptions](x: Self) {
    ...
    inline def setActivate(value: /* e */ PanelBarActivateEvent => Callback): Self = StObject.set(x, "activate", js.Any.fromFunction1((t0: /* e */ PanelBarActivateEvent) => value(t0).runNow()))
    ...
    inline def setCollapse(value: /* e */ PanelBarCollapseEvent => Callback): Self = StObject.set(x, "collapse", js.Any.fromFunction1((t0: /* e */ PanelBarCollapseEvent) => value(t0).runNow()))
    
    inline def setCollapseUndefined: Self = StObject.set(x, "collapse", js.undefined)
    
    inline def setContentLoad(value: /* e */ PanelBarContentLoadEvent => Callback): Self = StObject.set(x, "contentLoad", js.Any.fromFunction1((t0: /* e */ PanelBarContentLoadEvent) => value(t0).runNow()))
    ...
    inline def setDataBound(value: /* e */ PanelBarDataBoundEvent => Callback): Self = StObject.set(x, "dataBound", js.Any.fromFunction1((t0: /* e */ PanelBarDataBoundEvent) => value(t0).runNow()))
    ...
    inline def setError(value: /* e */ PanelBarErrorEvent => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* e */ PanelBarErrorEvent) => value(t0).runNow()))
    
    inline def setErrorUndefined: Self = StObject.set(x, "error", js.undefined)
    
    inline def setExpand(value: /* e */ PanelBarExpandEvent => Callback): Self = StObject.set(x, "expand", js.Any.fromFunction1((t0: /* e */ PanelBarExpandEvent) => value(t0).runNow()))
    ...
    inline def setSelect(value: /* e */ PanelBarSelectEvent => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* e */ PanelBarSelectEvent) => value(t0).runNow()))
