...
trait StockChartValueAxisItemCrosshair extends StObject {
...
object StockChartValueAxisItemCrosshair {
  ...
  inline def apply(): StockChartValueAxisItemCrosshair = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartValueAxisItemCrosshair]
  }
  
  extension [Self <: StockChartValueAxisItemCrosshair](x: Self) {
    ...
    inline def setTooltip(value: StockChartValueAxisItemCrosshairTooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
