...
trait StockChartLegendItemHoverEvent
  extends StObject
...
object StockChartLegendItemHoverEvent {
  ...
  inline def apply(isDefaultPrevented: CallbackTo[Boolean], preventDefault: js.Function, sender: StockChart): StockChartLegendItemHoverEvent = {
