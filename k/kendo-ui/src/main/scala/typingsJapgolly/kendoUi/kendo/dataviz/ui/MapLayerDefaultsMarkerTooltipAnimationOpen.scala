...
trait MapLayerDefaultsMarkerTooltipAnimationOpen extends StObject {
...
object MapLayerDefaultsMarkerTooltipAnimationOpen {
  ...
  inline def apply(): MapLayerDefaultsMarkerTooltipAnimationOpen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MapLayerDefaultsMarkerTooltipAnimationOpen]
  }
  
  extension [Self <: MapLayerDefaultsMarkerTooltipAnimationOpen](x: Self) {
