...
object StockChartSeriesItemTooltip {
  ...
  inline def apply(): StockChartSeriesItemTooltip = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartSeriesItemTooltip]
  }
  
  extension [Self <: StockChartSeriesItemTooltip](x: Self) {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: StockChartSeriesItemTooltipBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
