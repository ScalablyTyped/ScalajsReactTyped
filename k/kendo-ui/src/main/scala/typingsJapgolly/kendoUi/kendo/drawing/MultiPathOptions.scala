...
trait MultiPathOptions extends StObject {
...
object MultiPathOptions {
  ...
  inline def apply(): MultiPathOptions = {
  ...
  extension [Self <: MultiPathOptions](x: Self) {
    ...
    inline def setFill(value: FillOptions): Self = StObject.set(x, "fill", value.asInstanceOf[js.Any])
    ...
    inline def setStroke(value: StrokeOptions): Self = StObject.set(x, "stroke", value.asInstanceOf[js.Any])
