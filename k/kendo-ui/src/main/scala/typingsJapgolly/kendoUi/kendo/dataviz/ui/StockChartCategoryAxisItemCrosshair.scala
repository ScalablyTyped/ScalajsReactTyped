...
object StockChartCategoryAxisItemCrosshair {
  ...
  inline def apply(): StockChartCategoryAxisItemCrosshair = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartCategoryAxisItemCrosshair]
  }
  
  extension [Self <: StockChartCategoryAxisItemCrosshair](x: Self) {
    ...
    inline def setTooltip(value: StockChartCategoryAxisItemCrosshairTooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
