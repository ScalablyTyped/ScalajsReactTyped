...
class Grid protected () extends Widget {
  ...
  def cellIndex(cell: typingsJapgolly.std.Element): Double = js.native
  ...
  def collapseGroup(row: typingsJapgolly.std.Element): Unit = js.native
  def collapseRow(row: String): Unit = js.native
  def collapseRow(row: JQuery): Unit = js.native
  def collapseRow(row: typingsJapgolly.std.Element): Unit = js.native
  ...
  def expandGroup(row: typingsJapgolly.std.Element): Unit = js.native
  def expandRow(row: String): Unit = js.native
  def expandRow(row: JQuery): Unit = js.native
  def expandRow(row: typingsJapgolly.std.Element): Unit = js.native
