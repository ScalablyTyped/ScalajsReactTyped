...
trait MultiPath
  ...
  def curveTo(controlOut: Any, controlIn: Any, endPoint: Any): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  def curveTo(controlOut: Any, controlIn: Any, endPoint: Point): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  def curveTo(controlOut: Any, controlIn: Point, endPoint: Any): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  def curveTo(controlOut: Any, controlIn: Point, endPoint: Point): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  def curveTo(controlOut: Point, controlIn: Any, endPoint: Any): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  def curveTo(controlOut: Point, controlIn: Any, endPoint: Point): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  def curveTo(controlOut: Point, controlIn: Point, endPoint: Any): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  ...
  def lineTo(x: Any): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  def lineTo(x: Any, y: Double): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  ...
  def moveTo(x: Any): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  def moveTo(x: Any, y: Double): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
  ...
  def stroke(color: String, width: Unit, opacity: Double): typingsJapgolly.kendoUi.kendo.drawing.MultiPath = js.native
}
