...
object DataSourceTransport {
  ...
  extension [Self <: DataSourceTransport](x: Self) {
    ...
    inline def setBatchFunction1(value: /* options */ DataSourceTransportOptions => Callback): Self = StObject.set(x, "batch", js.Any.fromFunction1((t0: /* options */ DataSourceTransportOptions) => value(t0).runNow()))
    ...
    inline def setCreateFunction1(value: /* options */ DataSourceTransportOptions => Callback): Self = StObject.set(x, "create", js.Any.fromFunction1((t0: /* options */ DataSourceTransportOptions) => value(t0).runNow()))
    ...
    inline def setDestroyFunction1(value: /* options */ DataSourceTransportOptions => Callback): Self = StObject.set(x, "destroy", js.Any.fromFunction1((t0: /* options */ DataSourceTransportOptions) => value(t0).runNow()))
    ...
    inline def setReadFunction1(value: /* options */ DataSourceTransportOptions => Callback): Self = StObject.set(x, "read", js.Any.fromFunction1((t0: /* options */ DataSourceTransportOptions) => value(t0).runNow()))
    ...
    inline def setSignalrFunction1(value: /* options */ DataSourceTransportOptions => Callback): Self = StObject.set(x, "signalr", js.Any.fromFunction1((t0: /* options */ DataSourceTransportOptions) => value(t0).runNow()))
    ...
    inline def setUpdateFunction1(value: /* options */ DataSourceTransportOptions => Callback): Self = StObject.set(x, "update", js.Any.fromFunction1((t0: /* options */ DataSourceTransportOptions) => value(t0).runNow()))
