...
object RadioButtonOptions {
  ...
  extension [Self <: RadioButtonOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ RadioButtonChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ RadioButtonChangeEvent) => value(t0).runNow()))
