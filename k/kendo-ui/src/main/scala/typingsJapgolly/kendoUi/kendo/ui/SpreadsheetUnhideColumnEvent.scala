...
trait SpreadsheetUnhideColumnEvent
  extends StObject
...
object SpreadsheetUnhideColumnEvent {
  ...
  inline def apply(isDefaultPrevented: CallbackTo[Boolean], preventDefault: js.Function, sender: Spreadsheet): SpreadsheetUnhideColumnEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = isDefaultPrevented.toJsFn, preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[SpreadsheetUnhideColumnEvent]
  }
  
  extension [Self <: SpreadsheetUnhideColumnEvent](x: Self) {
