...
object ChartSeriesDefaultsLabels {
  ...
  inline def apply(): ChartSeriesDefaultsLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartSeriesDefaultsLabels]
  }
  
  extension [Self <: ChartSeriesDefaultsLabels](x: Self) {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: ChartSeriesDefaultsLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    inline def setFrom(value: ChartSeriesDefaultsLabelsFrom): Self = StObject.set(x, "from", value.asInstanceOf[js.Any])
    
    inline def setFromUndefined: Self = StObject.set(x, "from", js.undefined)
    
    inline def setMargin(value: Double | ChartSeriesDefaultsLabelsMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    ...
    inline def setTo(value: ChartSeriesDefaultsLabelsTo): Self = StObject.set(x, "to", value.asInstanceOf[js.Any])
