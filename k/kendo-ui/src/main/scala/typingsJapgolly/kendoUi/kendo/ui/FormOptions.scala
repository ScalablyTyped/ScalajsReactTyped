...
import typingsJapgolly.kendoUi.kendoUiStrings.grid
import typingsJapgolly.kendoUi.kendoUiStrings.horizontal
import typingsJapgolly.kendoUi.kendoUiStrings.vertical
...
object FormOptions {
  ...
  extension [Self <: FormOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ FormChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ FormChangeEvent) => value(t0).runNow()))
    
    inline def setChangeUndefined: Self = StObject.set(x, "change", js.undefined)
    
    inline def setClear(value: /* e */ FormClearEvent => Callback): Self = StObject.set(x, "clear", js.Any.fromFunction1((t0: /* e */ FormClearEvent) => value(t0).runNow()))
    ...
    inline def setSubmit(value: /* e */ FormSubmitEvent => Callback): Self = StObject.set(x, "submit", js.Any.fromFunction1((t0: /* e */ FormSubmitEvent) => value(t0).runNow()))
    ...
    inline def setValidate(value: /* e */ FormValidateEvent => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* e */ FormValidateEvent) => value(t0).runNow()))
    
    inline def setValidateField(value: /* e */ FormValidateFieldEvent => Callback): Self = StObject.set(x, "validateField", js.Any.fromFunction1((t0: /* e */ FormValidateFieldEvent) => value(t0).runNow()))
