...
object PivotGridV2Options {
  ...
  extension [Self <: PivotGridV2Options](x: Self) {
    ...
    inline def setCollapseMember(value: /* e */ PivotGridV2CollapseMemberEvent => Callback): Self = StObject.set(x, "collapseMember", js.Any.fromFunction1((t0: /* e */ PivotGridV2CollapseMemberEvent) => value(t0).runNow()))
    ...
    inline def setDataBinding(value: /* e */ PivotGridV2DataBindingEvent => Callback): Self = StObject.set(x, "dataBinding", js.Any.fromFunction1((t0: /* e */ PivotGridV2DataBindingEvent) => value(t0).runNow()))
    
    inline def setDataBindingUndefined: Self = StObject.set(x, "dataBinding", js.undefined)
    
    inline def setDataBound(value: /* e */ PivotGridV2DataBoundEvent => Callback): Self = StObject.set(x, "dataBound", js.Any.fromFunction1((t0: /* e */ PivotGridV2DataBoundEvent) => value(t0).runNow()))
    ...
    inline def setExpandMember(value: /* e */ PivotGridV2ExpandMemberEvent => Callback): Self = StObject.set(x, "expandMember", js.Any.fromFunction1((t0: /* e */ PivotGridV2ExpandMemberEvent) => value(t0).runNow()))
    ...
    inline def setPdfExport(value: /* e */ PivotGridV2PdfExportEvent => Callback): Self = StObject.set(x, "pdfExport", js.Any.fromFunction1((t0: /* e */ PivotGridV2PdfExportEvent) => value(t0).runNow()))
