...
object ScrollViewOptions {
  ...
  def apply(
    ...
    changing: /* e */ ScrollViewChangingEvent => Callback = null,
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.mobile.ui.ScrollViewChangeEvent) => change(t0).runNow()))
    if (changing != null) __obj.updateDynamic("changing")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.mobile.ui.ScrollViewChangingEvent) => changing(t0).runNow()))
    ...
    if (refresh != null) __obj.updateDynamic("refresh")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.mobile.ui.ScrollViewRefreshEvent) => refresh(t0).runNow()))
