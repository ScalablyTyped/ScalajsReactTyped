...
object ScrollViewOptions {
  ...
  extension [Self <: ScrollViewOptions](x: Self) {
    ...
    inline def setChanging(value: /* e */ ScrollViewChangingEvent => Callback): Self = StObject.set(x, "changing", js.Any.fromFunction1((t0: /* e */ ScrollViewChangingEvent) => value(t0).runNow()))
