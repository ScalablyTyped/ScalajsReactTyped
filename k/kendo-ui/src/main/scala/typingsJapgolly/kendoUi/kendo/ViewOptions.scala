...
object ViewOptions {
  ...
  extension [Self <: ViewOptions](x: Self) {
    ...
    inline def setHide(value: /* e */ ViewEvent => Callback): Self = StObject.set(x, "hide", js.Any.fromFunction1((t0: /* e */ ViewEvent) => value(t0).runNow()))
    
    inline def setHideUndefined: Self = StObject.set(x, "hide", js.undefined)
    
    inline def setInit(value: /* e */ ViewEvent => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: /* e */ ViewEvent) => value(t0).runNow()))
    ...
    inline def setShow(value: /* e */ ViewEvent => Callback): Self = StObject.set(x, "show", js.Any.fromFunction1((t0: /* e */ ViewEvent) => value(t0).runNow()))
