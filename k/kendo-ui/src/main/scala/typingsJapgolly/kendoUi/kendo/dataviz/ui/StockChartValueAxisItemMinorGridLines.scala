...
trait StockChartValueAxisItemMinorGridLines extends StObject {
...
object StockChartValueAxisItemMinorGridLines {
  ...
  inline def apply(): StockChartValueAxisItemMinorGridLines = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartValueAxisItemMinorGridLines]
  }
  
  extension [Self <: StockChartValueAxisItemMinorGridLines](x: Self) {
