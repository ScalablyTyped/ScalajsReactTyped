...
object SurfaceTooltipCloseEvent {
  ...
  inline def apply(isDefaultPrevented: CallbackTo[Boolean], preventDefault: js.Function, sender: Surface): SurfaceTooltipCloseEvent = {
  ...
  extension [Self <: SurfaceTooltipCloseEvent](x: Self) {
    ...
    inline def setTarget(value: typingsJapgolly.kendoUi.kendo.drawing.Element): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
