...
object CollapsibleOptions {
  ...
  extension [Self <: CollapsibleOptions](x: Self) {
    ...
    inline def setCollapse(value: /* e */ CollapsibleEvent => Callback): Self = StObject.set(x, "collapse", js.Any.fromFunction1((t0: /* e */ CollapsibleEvent) => value(t0).runNow()))
    ...
    inline def setExpand(value: /* e */ CollapsibleEvent => Callback): Self = StObject.set(x, "expand", js.Any.fromFunction1((t0: /* e */ CollapsibleEvent) => value(t0).runNow()))
