...
object SparklineSeriesDefaultsTooltip {
  ...
  inline def apply(): SparklineSeriesDefaultsTooltip = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SparklineSeriesDefaultsTooltip]
  }
  
  extension [Self <: SparklineSeriesDefaultsTooltip](x: Self) {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: SparklineSeriesDefaultsTooltipBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
