...
object EditorOptions {
  ...
  extension [Self <: EditorOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ EditorEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ EditorEvent) => value(t0).runNow()))
    ...
    inline def setExecute(value: /* e */ EditorExecuteEvent => Callback): Self = StObject.set(x, "execute", js.Any.fromFunction1((t0: /* e */ EditorExecuteEvent) => value(t0).runNow()))
    ...
    inline def setKeydown(value: /* e */ EditorEvent => Callback): Self = StObject.set(x, "keydown", js.Any.fromFunction1((t0: /* e */ EditorEvent) => value(t0).runNow()))
    
    inline def setKeydownUndefined: Self = StObject.set(x, "keydown", js.undefined)
    
    inline def setKeyup(value: /* e */ EditorEvent => Callback): Self = StObject.set(x, "keyup", js.Any.fromFunction1((t0: /* e */ EditorEvent) => value(t0).runNow()))
    ...
    inline def setPaste(value: /* e */ EditorPasteEvent => Callback): Self = StObject.set(x, "paste", js.Any.fromFunction1((t0: /* e */ EditorPasteEvent) => value(t0).runNow()))
    ...
    inline def setPdfExport(value: /* e */ EditorPdfExportEvent => Callback): Self = StObject.set(x, "pdfExport", js.Any.fromFunction1((t0: /* e */ EditorPdfExportEvent) => value(t0).runNow()))
    ...
    inline def setSelect(value: /* e */ EditorEvent => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* e */ EditorEvent) => value(t0).runNow()))
