...
object WindowOptions {
  ...
  extension [Self <: WindowOptions](x: Self) {
    ...
    inline def setActivate(value: /* e */ WindowEvent => Callback): Self = StObject.set(x, "activate", js.Any.fromFunction1((t0: /* e */ WindowEvent) => value(t0).runNow()))
    ...
    inline def setClose(value: /* e */ WindowCloseEvent => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: /* e */ WindowCloseEvent) => value(t0).runNow()))
    ...
    inline def setDeactivate(value: /* e */ WindowEvent => Callback): Self = StObject.set(x, "deactivate", js.Any.fromFunction1((t0: /* e */ WindowEvent) => value(t0).runNow()))
    
    inline def setDeactivateUndefined: Self = StObject.set(x, "deactivate", js.undefined)
    
    inline def setDragend(value: /* e */ WindowEvent => Callback): Self = StObject.set(x, "dragend", js.Any.fromFunction1((t0: /* e */ WindowEvent) => value(t0).runNow()))
    ...
    inline def setDragstart(value: /* e */ WindowEvent => Callback): Self = StObject.set(x, "dragstart", js.Any.fromFunction1((t0: /* e */ WindowEvent) => value(t0).runNow()))
    
    inline def setDragstartUndefined: Self = StObject.set(x, "dragstart", js.undefined)
    
    inline def setError(value: /* e */ WindowErrorEvent => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* e */ WindowErrorEvent) => value(t0).runNow()))
    ...
    inline def setMaximize(value: /* e */ WindowEvent => Callback): Self = StObject.set(x, "maximize", js.Any.fromFunction1((t0: /* e */ WindowEvent) => value(t0).runNow()))
    ...
    inline def setMinimize(value: /* e */ WindowEvent => Callback): Self = StObject.set(x, "minimize", js.Any.fromFunction1((t0: /* e */ WindowEvent) => value(t0).runNow()))
    ...
    inline def setOpen(value: /* e */ WindowEvent => Callback): Self = StObject.set(x, "open", js.Any.fromFunction1((t0: /* e */ WindowEvent) => value(t0).runNow()))
    ...
    inline def setRefresh(value: /* e */ WindowEvent => Callback): Self = StObject.set(x, "refresh", js.Any.fromFunction1((t0: /* e */ WindowEvent) => value(t0).runNow()))
    ...
    inline def setResize(value: /* e */ WindowEvent => Callback): Self = StObject.set(x, "resize", js.Any.fromFunction1((t0: /* e */ WindowEvent) => value(t0).runNow()))
