...
object TooltipOptions {
  ...
  extension [Self <: TooltipOptions](x: Self) {
    ...
    inline def setContentLoad(value: /* e */ TooltipEvent => Callback): Self = StObject.set(x, "contentLoad", js.Any.fromFunction1((t0: /* e */ TooltipEvent) => value(t0).runNow()))
    
    inline def setContentLoadUndefined: Self = StObject.set(x, "contentLoad", js.undefined)
    
    inline def setContentUndefined: Self = StObject.set(x, "content", js.undefined)
    
    inline def setError(value: /* e */ TooltipErrorEvent => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* e */ TooltipErrorEvent) => value(t0).runNow()))
    ...
    inline def setHide(value: /* e */ TooltipEvent => Callback): Self = StObject.set(x, "hide", js.Any.fromFunction1((t0: /* e */ TooltipEvent) => value(t0).runNow()))
    ...
    inline def setRequestStart(value: /* e */ TooltipRequestStartEvent => Callback): Self = StObject.set(x, "requestStart", js.Any.fromFunction1((t0: /* e */ TooltipRequestStartEvent) => value(t0).runNow()))
    
    inline def setRequestStartUndefined: Self = StObject.set(x, "requestStart", js.undefined)
    
    inline def setShow(value: /* e */ TooltipEvent => Callback): Self = StObject.set(x, "show", js.Any.fromFunction1((t0: /* e */ TooltipEvent) => value(t0).runNow()))
