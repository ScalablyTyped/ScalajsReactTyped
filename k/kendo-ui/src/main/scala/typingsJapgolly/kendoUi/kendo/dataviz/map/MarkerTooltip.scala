...
object MarkerTooltip {
  ...
  inline def apply(): MarkerTooltip = {
  ...
  extension [Self <: MarkerTooltip](x: Self) {
    ...
    inline def setContent(value: String | js.Function | MarkerTooltipContent): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
