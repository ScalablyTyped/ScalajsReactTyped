...
object DropDownListOptions {
  ...
  def apply(
    ...
    cascade: /* e */ DropDownListCascadeEvent => Callback = null,
    cascadeFrom: String = null,
    cascadeFromField: String = null,
    change: /* e */ DropDownListChangeEvent => Callback = null,
    close: /* e */ DropDownListCloseEvent => Callback = null,
    dataBound: /* e */ DropDownListDataBoundEvent => Callback = null,
    ...
    filter: String = null,
    filtering: /* e */ DropDownListFilteringEvent => Callback = null,
    ...
    if (cascade != null) __obj.updateDynamic("cascade")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.DropDownListCascadeEvent) => cascade(t0).runNow()))
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.DropDownListChangeEvent) => change(t0).runNow()))
    if (close != null) __obj.updateDynamic("close")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.DropDownListCloseEvent) => close(t0).runNow()))
    if (dataBound != null) __obj.updateDynamic("dataBound")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.DropDownListDataBoundEvent) => dataBound(t0).runNow()))
    ...
    if (filtering != null) __obj.updateDynamic("filtering")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.DropDownListFilteringEvent) => filtering(t0).runNow()))
    ...
    if (open != null) __obj.updateDynamic("open")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.DropDownListOpenEvent) => open(t0).runNow()))
    ...
    if (select != null) __obj.updateDynamic("select")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.DropDownListSelectEvent) => select(t0).runNow()))
