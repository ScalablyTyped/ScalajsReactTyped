...
object StockChartNavigatorCategoryAxisNotesDataItemIcon {
  ...
  inline def apply(): StockChartNavigatorCategoryAxisNotesDataItemIcon = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartNavigatorCategoryAxisNotesDataItemIcon]
  }
  
  extension [Self <: StockChartNavigatorCategoryAxisNotesDataItemIcon](x: Self) {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: StockChartNavigatorCategoryAxisNotesDataItemIconBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
