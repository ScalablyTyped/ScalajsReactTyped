...
object FloatingActionButtonOptions {
  ...
  extension [Self <: FloatingActionButtonOptions](x: Self) {
    ...
    inline def setClick(value: /* e */ FloatingActionButtonClickEvent => Callback): Self = StObject.set(x, "click", js.Any.fromFunction1((t0: /* e */ FloatingActionButtonClickEvent) => value(t0).runNow()))
    
    inline def setClickUndefined: Self = StObject.set(x, "click", js.undefined)
    
    inline def setCollapse(value: /* e */ FloatingActionButtonCollapseEvent => Callback): Self = StObject.set(x, "collapse", js.Any.fromFunction1((t0: /* e */ FloatingActionButtonCollapseEvent) => value(t0).runNow()))
    ...
    inline def setExpand(value: /* e */ FloatingActionButtonExpandEvent => Callback): Self = StObject.set(x, "expand", js.Any.fromFunction1((t0: /* e */ FloatingActionButtonExpandEvent) => value(t0).runNow()))
