...
object RatingOptions {
  ...
  extension [Self <: RatingOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ RatingChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ RatingChangeEvent) => value(t0).runNow()))
    ...
    inline def setSelect(value: /* e */ RatingSelectEvent => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* e */ RatingSelectEvent) => value(t0).runNow()))
