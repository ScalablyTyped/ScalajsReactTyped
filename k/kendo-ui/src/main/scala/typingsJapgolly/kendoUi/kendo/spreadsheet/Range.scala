...
trait Range
  ...
  @JSName("enable")
  def enable_Boolean(): Boolean = js.native
  ...
  def italic(): Unit = js.native
  def italic(value: Boolean): Unit = js.native
  @JSName("italic")
  def italic_Boolean(): Boolean = js.native
  ...
  @JSName("wrap")
  def wrap_Boolean(): Boolean = js.native
}
