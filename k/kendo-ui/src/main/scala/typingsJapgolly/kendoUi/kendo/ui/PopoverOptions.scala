...
object PopoverOptions {
  ...
  extension [Self <: PopoverOptions](x: Self) {
    ...
    inline def setHide(value: /* e */ PopoverEvent => Callback): Self = StObject.set(x, "hide", js.Any.fromFunction1((t0: /* e */ PopoverEvent) => value(t0).runNow()))
    ...
    inline def setShow(value: /* e */ PopoverEvent => Callback): Self = StObject.set(x, "show", js.Any.fromFunction1((t0: /* e */ PopoverEvent) => value(t0).runNow()))
