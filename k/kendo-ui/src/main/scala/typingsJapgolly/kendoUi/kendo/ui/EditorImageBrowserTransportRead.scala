...
trait EditorImageBrowserTransportRead extends StObject {
...
object EditorImageBrowserTransportRead {
  ...
  inline def apply(): EditorImageBrowserTransportRead = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EditorImageBrowserTransportRead]
  }
  
  extension [Self <: EditorImageBrowserTransportRead](x: Self) {
