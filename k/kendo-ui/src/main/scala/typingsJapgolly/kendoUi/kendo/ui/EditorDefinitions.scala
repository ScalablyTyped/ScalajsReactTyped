...
object EditorDefinitions {
  ...
  inline def apply(
    ...
    kendoEditor: (/* container */ JQuery | Element | String, /* options */ EditorDefinitionOptions) => Callback,
  ...
  extension [Self <: EditorDefinitions](x: Self) {
    ...
    inline def setKendoEditor(
      value: (/* container */ JQuery | Element | String, /* options */ EditorDefinitionOptions) => Callback
    ): Self = StObject.set(x, "kendoEditor", js.Any.fromFunction2((t0: /* container */ JQuery | Element | String, t1: /* options */ EditorDefinitionOptions) => (value(t0, t1)).runNow()))
