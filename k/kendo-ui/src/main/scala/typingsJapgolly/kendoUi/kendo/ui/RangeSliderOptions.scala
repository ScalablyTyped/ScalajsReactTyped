...
object RangeSliderOptions {
  ...
  extension [Self <: RangeSliderOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ RangeSliderChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ RangeSliderChangeEvent) => value(t0).runNow()))
    ...
    inline def setSlide(value: /* e */ RangeSliderSlideEvent => Callback): Self = StObject.set(x, "slide", js.Any.fromFunction1((t0: /* e */ RangeSliderSlideEvent) => value(t0).runNow()))
