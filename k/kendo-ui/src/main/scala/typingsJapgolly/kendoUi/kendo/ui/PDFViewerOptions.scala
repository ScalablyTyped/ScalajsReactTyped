...
object PDFViewerOptions {
  ...
  def apply(
    ...
    error: /* e */ PDFViewerErrorEvent => Callback = null,
    height: Double | String = null,
    messages: PDFViewerMessages = null,
    name: String = null,
    open: /* e */ PDFViewerOpenEvent => Callback = null,
    page: Int | Double = null,
    pdfjsProcessing: PDFViewerPdfjsProcessing = null,
    render: /* e */ PDFViewerRenderEvent => Callback = null,
    ...
    if (error != null) __obj.updateDynamic("error")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.PDFViewerErrorEvent) => error(t0).runNow()))
    if (height != null) __obj.updateDynamic("height")(height.asInstanceOf[js.Any])
    if (messages != null) __obj.updateDynamic("messages")(messages.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (open != null) __obj.updateDynamic("open")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.PDFViewerOpenEvent) => open(t0).runNow()))
    if (page != null) __obj.updateDynamic("page")(page.asInstanceOf[js.Any])
    if (pdfjsProcessing != null) __obj.updateDynamic("pdfjsProcessing")(pdfjsProcessing.asInstanceOf[js.Any])
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.PDFViewerRenderEvent) => render(t0).runNow()))
