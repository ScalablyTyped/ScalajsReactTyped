...
object DatePickerOptions {
  ...
  extension [Self <: DatePickerOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ DatePickerChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ DatePickerChangeEvent) => value(t0).runNow()))
    
    inline def setChangeUndefined: Self = StObject.set(x, "change", js.undefined)
    
    inline def setClose(value: /* e */ DatePickerCloseEvent => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: /* e */ DatePickerCloseEvent) => value(t0).runNow()))
    ...
    inline def setOpen(value: /* e */ DatePickerOpenEvent => Callback): Self = StObject.set(x, "open", js.Any.fromFunction1((t0: /* e */ DatePickerOpenEvent) => value(t0).runNow()))
