...
object CalendarOptions {
  @scala.inline
  def apply(
    change: /* e */ CalendarEvent => Callback = null,
    culture: String = null,
    dates: js.Any = null,
    depth: String = null,
    ...
    name: String = null,
    navigate: /* e */ CalendarEvent => Callback = null,
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.CalendarEvent) => change(t0).runNow()))
    ...
    if (navigate != null) __obj.updateDynamic("navigate")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.CalendarEvent) => navigate(t0).runNow()))
