...
object CalendarOptions {
  ...
  extension [Self <: CalendarOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ CalendarEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ CalendarEvent) => value(t0).runNow()))
    ...
    inline def setNavigate(value: /* e */ CalendarEvent => Callback): Self = StObject.set(x, "navigate", js.Any.fromFunction1((t0: /* e */ CalendarEvent) => value(t0).runNow()))
