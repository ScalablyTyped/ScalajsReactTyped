...
object ChartCategoryAxisItemCrosshair {
  ...
  inline def apply(): ChartCategoryAxisItemCrosshair = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartCategoryAxisItemCrosshair]
  }
  
  extension [Self <: ChartCategoryAxisItemCrosshair](x: Self) {
    ...
    inline def setTooltip(value: ChartCategoryAxisItemCrosshairTooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
