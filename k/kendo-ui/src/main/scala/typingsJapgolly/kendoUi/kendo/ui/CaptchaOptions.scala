...
object CaptchaOptions {
  ...
  extension [Self <: CaptchaOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ CaptchaChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ CaptchaChangeEvent) => value(t0).runNow()))
    ...
    inline def setError(value: /* e */ CaptchaErrorEvent => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* e */ CaptchaErrorEvent) => value(t0).runNow()))
    ...
    inline def setRequestEnd(value: /* e */ CaptchaRequestEndEvent => Callback): Self = StObject.set(x, "requestEnd", js.Any.fromFunction1((t0: /* e */ CaptchaRequestEndEvent) => value(t0).runNow()))
    
    inline def setRequestEndUndefined: Self = StObject.set(x, "requestEnd", js.undefined)
    
    inline def setRequestStart(value: /* e */ CaptchaRequestStartEvent => Callback): Self = StObject.set(x, "requestStart", js.Any.fromFunction1((t0: /* e */ CaptchaRequestStartEvent) => value(t0).runNow()))
