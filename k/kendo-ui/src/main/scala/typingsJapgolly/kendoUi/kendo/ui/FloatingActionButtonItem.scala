...
object FloatingActionButtonItem {
  ...
  extension [Self <: FloatingActionButtonItem](x: Self) {
    ...
    inline def setClick(value: /* e */ FloatingActionButtonItemClickEvent => Callback): Self = StObject.set(x, "click", js.Any.fromFunction1((t0: /* e */ FloatingActionButtonItemClickEvent) => value(t0).runNow()))
