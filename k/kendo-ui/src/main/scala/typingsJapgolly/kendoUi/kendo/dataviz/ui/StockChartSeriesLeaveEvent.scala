...
trait StockChartSeriesLeaveEvent
  extends StObject
...
object StockChartSeriesLeaveEvent {
  ...
  inline def apply(isDefaultPrevented: CallbackTo[Boolean], preventDefault: js.Function, sender: StockChart): StockChartSeriesLeaveEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = isDefaultPrevented.toJsFn, preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartSeriesLeaveEvent]
  }
  
  extension [Self <: StockChartSeriesLeaveEvent](x: Self) {
    ...
    inline def setSeries(value: StockChartSeriesLeaveEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
