...
object SurfaceOptions {
  ...
  def apply(
    ...
    if (click != null) __obj.updateDynamic("click")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.dataviz.drawing.SurfaceClickEvent) => click(t0).runNow()))
    if (height != null) __obj.updateDynamic("height")(height.asInstanceOf[js.Any])
    if (mouseenter != null) __obj.updateDynamic("mouseenter")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.dataviz.drawing.SurfaceMouseenterEvent) => mouseenter(t0).runNow()))
    if (mouseleave != null) __obj.updateDynamic("mouseleave")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.dataviz.drawing.SurfaceMouseleaveEvent) => mouseleave(t0).runNow()))
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (tooltip != null) __obj.updateDynamic("tooltip")(tooltip.asInstanceOf[js.Any])
    if (tooltipClose != null) __obj.updateDynamic("tooltipClose")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.dataviz.drawing.SurfaceTooltipCloseEvent) => tooltipClose(t0).runNow()))
    if (tooltipOpen != null) __obj.updateDynamic("tooltipOpen")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.dataviz.drawing.SurfaceTooltipOpenEvent) => tooltipOpen(t0).runNow()))
