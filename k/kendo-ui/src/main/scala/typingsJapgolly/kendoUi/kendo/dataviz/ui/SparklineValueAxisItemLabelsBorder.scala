...
trait SparklineValueAxisItemLabelsBorder extends js.Object {
...
object SparklineValueAxisItemLabelsBorder {
  @scala.inline
  def apply(color: String = null, dashType: String = null, width: Int | Double = null): SparklineValueAxisItemLabelsBorder = {
