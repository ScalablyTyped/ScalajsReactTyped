...
object ChartValueAxisItemLabels {
  ...
  inline def apply(): ChartValueAxisItemLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartValueAxisItemLabels]
  }
  
  extension [Self <: ChartValueAxisItemLabels](x: Self) {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: ChartValueAxisItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    inline def setMargin(value: Double | ChartValueAxisItemLabelsMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    ...
    inline def setPadding(value: Double | ChartValueAxisItemLabelsPadding): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
    
    inline def setPaddingUndefined: Self = StObject.set(x, "padding", js.undefined)
    
    inline def setRotation(value: String | Double | ChartValueAxisItemLabelsRotation): Self = StObject.set(x, "rotation", value.asInstanceOf[js.Any])
