...
object StockChartSeriesDefaultsLabels {
  ...
  inline def apply(): StockChartSeriesDefaultsLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartSeriesDefaultsLabels]
  }
  
  extension [Self <: StockChartSeriesDefaultsLabels](x: Self) {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: StockChartSeriesDefaultsLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
