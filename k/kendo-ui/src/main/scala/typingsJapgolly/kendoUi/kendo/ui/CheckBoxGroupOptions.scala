...
object CheckBoxGroupOptions {
  ...
  extension [Self <: CheckBoxGroupOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ CheckBoxGroupChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ CheckBoxGroupChangeEvent) => value(t0).runNow()))
    ...
    inline def setFocus(value: /* e */ CheckBoxGroupFocusEvent => Callback): Self = StObject.set(x, "focus", js.Any.fromFunction1((t0: /* e */ CheckBoxGroupFocusEvent) => value(t0).runNow()))
    ...
    inline def setSelect(value: /* e */ CheckBoxGroupSelectEvent => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* e */ CheckBoxGroupSelectEvent) => value(t0).runNow()))
