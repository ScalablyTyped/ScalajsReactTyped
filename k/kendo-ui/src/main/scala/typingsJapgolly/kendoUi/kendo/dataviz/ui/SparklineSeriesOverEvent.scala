...
object SparklineSeriesOverEvent {
  ...
  inline def apply(isDefaultPrevented: CallbackTo[Boolean], preventDefault: js.Function, sender: Sparkline): SparklineSeriesOverEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = isDefaultPrevented.toJsFn, preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[SparklineSeriesOverEvent]
  }
  
  extension [Self <: SparklineSeriesOverEvent](x: Self) {
    ...
    inline def setSeries(value: SparklineSeriesOverEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
