...
class Menu protected () extends Widget {
  ...
  def close(element: typingsJapgolly.std.Element): Menu = js.native
  def enable(element: String, enable: Boolean): Menu = js.native
  def enable(element: JQuery, enable: Boolean): Menu = js.native
  def enable(element: typingsJapgolly.std.Element, enable: Boolean): Menu = js.native
  ...
  def insertAfter(item: js.Any, referenceItem: typingsJapgolly.std.Element): Menu = js.native
  ...
  def insertBefore(item: js.Any, referenceItem: typingsJapgolly.std.Element): Menu = js.native
  def open(element: String): Menu = js.native
  def open(element: JQuery): Menu = js.native
  def open(element: typingsJapgolly.std.Element): Menu = js.native
  def remove(element: String): Menu = js.native
  def remove(element: JQuery): Menu = js.native
  def remove(element: typingsJapgolly.std.Element): Menu = js.native
}
