...
object BreadcrumbOptions {
  ...
  extension [Self <: BreadcrumbOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ BreadcrumbChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ BreadcrumbChangeEvent) => value(t0).runNow()))
    
    inline def setChangeUndefined: Self = StObject.set(x, "change", js.undefined)
    
    inline def setClick(value: /* e */ BreadcrumbClickEvent => Callback): Self = StObject.set(x, "click", js.Any.fromFunction1((t0: /* e */ BreadcrumbClickEvent) => value(t0).runNow()))
