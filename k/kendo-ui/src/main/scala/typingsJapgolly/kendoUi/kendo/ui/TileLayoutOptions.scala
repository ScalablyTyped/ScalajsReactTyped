...
object TileLayoutOptions {
  ...
  extension [Self <: TileLayoutOptions](x: Self) {
    ...
    inline def setReorder(value: /* e */ TileLayoutReorderEvent => Callback): Self = StObject.set(x, "reorder", js.Any.fromFunction1((t0: /* e */ TileLayoutReorderEvent) => value(t0).runNow()))
    ...
    inline def setResize(value: /* e */ TileLayoutResizeEvent => Callback): Self = StObject.set(x, "resize", js.Any.fromFunction1((t0: /* e */ TileLayoutResizeEvent) => value(t0).runNow()))
