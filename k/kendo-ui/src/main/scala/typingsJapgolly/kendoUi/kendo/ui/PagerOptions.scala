...
object PagerOptions {
  ...
  def apply(
    ...
    change: /* e */ PagerChangeEvent => Callback = null,
    ...
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.PagerChangeEvent) => change(t0).runNow()))
