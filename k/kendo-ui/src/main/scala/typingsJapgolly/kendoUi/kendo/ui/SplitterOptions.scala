...
object SplitterOptions {
  ...
  extension [Self <: SplitterOptions](x: Self) {
    ...
    inline def setCollapse(value: /* e */ SplitterCollapseEvent => Callback): Self = StObject.set(x, "collapse", js.Any.fromFunction1((t0: /* e */ SplitterCollapseEvent) => value(t0).runNow()))
    
    inline def setCollapseUndefined: Self = StObject.set(x, "collapse", js.undefined)
    
    inline def setContentLoad(value: /* e */ SplitterContentLoadEvent => Callback): Self = StObject.set(x, "contentLoad", js.Any.fromFunction1((t0: /* e */ SplitterContentLoadEvent) => value(t0).runNow()))
    
    inline def setContentLoadUndefined: Self = StObject.set(x, "contentLoad", js.undefined)
    
    inline def setError(value: /* e */ SplitterErrorEvent => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* e */ SplitterErrorEvent) => value(t0).runNow()))
    
    inline def setErrorUndefined: Self = StObject.set(x, "error", js.undefined)
    
    inline def setExpand(value: /* e */ SplitterExpandEvent => Callback): Self = StObject.set(x, "expand", js.Any.fromFunction1((t0: /* e */ SplitterExpandEvent) => value(t0).runNow()))
    
    inline def setExpandUndefined: Self = StObject.set(x, "expand", js.undefined)
    
    inline def setLayoutChange(value: /* e */ SplitterEvent => Callback): Self = StObject.set(x, "layoutChange", js.Any.fromFunction1((t0: /* e */ SplitterEvent) => value(t0).runNow()))
    ...
    inline def setResize(value: /* e */ SplitterEvent => Callback): Self = StObject.set(x, "resize", js.Any.fromFunction1((t0: /* e */ SplitterEvent) => value(t0).runNow()))
