...
trait DiagramPdf extends StObject {
...
object DiagramPdf {
  ...
  extension [Self <: DiagramPdf](x: Self) {
    ...
    inline def setMargin(value: DiagramPdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
