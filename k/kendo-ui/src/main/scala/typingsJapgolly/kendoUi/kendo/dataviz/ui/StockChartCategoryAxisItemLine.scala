...
trait StockChartCategoryAxisItemLine extends StObject {
...
object StockChartCategoryAxisItemLine {
  ...
  inline def apply(): StockChartCategoryAxisItemLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartCategoryAxisItemLine]
  }
  
  extension [Self <: StockChartCategoryAxisItemLine](x: Self) {
