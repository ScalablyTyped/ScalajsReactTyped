...
trait TreeListPdf extends StObject {
...
object TreeListPdf {
  ...
  extension [Self <: TreeListPdf](x: Self) {
    ...
    inline def setMargin(value: TreeListPdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
