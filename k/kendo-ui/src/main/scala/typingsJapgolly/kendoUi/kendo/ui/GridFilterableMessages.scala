...
object GridFilterableMessages {
  ...
  inline def apply(): GridFilterableMessages = {
  ...
  extension [Self <: GridFilterableMessages](x: Self) {
    ...
    inline def setCheckAll(value: String): Self = StObject.set(x, "checkAll", value.asInstanceOf[js.Any])
    ...
    inline def setSelectedItemsFormat(value: String): Self = StObject.set(x, "selectedItemsFormat", value.asInstanceOf[js.Any])
    
    inline def setSelectedItemsFormatUndefined: Self = StObject.set(x, "selectedItemsFormat", js.undefined)
