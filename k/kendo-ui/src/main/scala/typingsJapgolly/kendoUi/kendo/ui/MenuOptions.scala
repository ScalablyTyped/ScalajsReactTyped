...
object MenuOptions {
  ...
  extension [Self <: MenuOptions](x: Self) {
    ...
    inline def setActivate(value: /* e */ MenuActivateEvent => Callback): Self = StObject.set(x, "activate", js.Any.fromFunction1((t0: /* e */ MenuActivateEvent) => value(t0).runNow()))
    ...
    inline def setClose(value: /* e */ MenuCloseEvent => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: /* e */ MenuCloseEvent) => value(t0).runNow()))
    ...
    inline def setDeactivate(value: /* e */ MenuDeactivateEvent => Callback): Self = StObject.set(x, "deactivate", js.Any.fromFunction1((t0: /* e */ MenuDeactivateEvent) => value(t0).runNow()))
    ...
    inline def setOpen(value: /* e */ MenuOpenEvent => Callback): Self = StObject.set(x, "open", js.Any.fromFunction1((t0: /* e */ MenuOpenEvent) => value(t0).runNow()))
    ...
    inline def setSelect(value: /* e */ MenuSelectEvent => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* e */ MenuSelectEvent) => value(t0).runNow()))
