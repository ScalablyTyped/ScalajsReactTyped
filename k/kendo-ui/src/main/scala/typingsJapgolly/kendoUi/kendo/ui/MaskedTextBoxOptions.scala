...
object MaskedTextBoxOptions {
  ...
  extension [Self <: MaskedTextBoxOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ MaskedTextBoxChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ MaskedTextBoxChangeEvent) => value(t0).runNow()))
