...
object BottomNavigationOptions {
  ...
  extension [Self <: BottomNavigationOptions](x: Self) {
    ...
    inline def setSelect(value: /* e */ BottomNavigationSelectEvent => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* e */ BottomNavigationSelectEvent) => value(t0).runNow()))
