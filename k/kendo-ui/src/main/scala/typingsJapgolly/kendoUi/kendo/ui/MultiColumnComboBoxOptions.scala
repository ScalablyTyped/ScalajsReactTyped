...
object MultiColumnComboBoxOptions {
  ...
  extension [Self <: MultiColumnComboBoxOptions](x: Self) {
    ...
    inline def setCascade(value: /* e */ MultiColumnComboBoxCascadeEvent => Callback): Self = StObject.set(x, "cascade", js.Any.fromFunction1((t0: /* e */ MultiColumnComboBoxCascadeEvent) => value(t0).runNow()))
    ...
    inline def setChange(value: /* e */ MultiColumnComboBoxChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ MultiColumnComboBoxChangeEvent) => value(t0).runNow()))
    ...
    inline def setClose(value: /* e */ MultiColumnComboBoxCloseEvent => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: /* e */ MultiColumnComboBoxCloseEvent) => value(t0).runNow()))
    ...
    inline def setDataBound(value: /* e */ MultiColumnComboBoxDataBoundEvent => Callback): Self = StObject.set(x, "dataBound", js.Any.fromFunction1((t0: /* e */ MultiColumnComboBoxDataBoundEvent) => value(t0).runNow()))
    ...
    inline def setFiltering(value: /* e */ MultiColumnComboBoxFilteringEvent => Callback): Self = StObject.set(x, "filtering", js.Any.fromFunction1((t0: /* e */ MultiColumnComboBoxFilteringEvent) => value(t0).runNow()))
    ...
    inline def setOpen(value: /* e */ MultiColumnComboBoxOpenEvent => Callback): Self = StObject.set(x, "open", js.Any.fromFunction1((t0: /* e */ MultiColumnComboBoxOpenEvent) => value(t0).runNow()))
    ...
    inline def setSelect(value: /* e */ MultiColumnComboBoxSelectEvent => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* e */ MultiColumnComboBoxSelectEvent) => value(t0).runNow()))
