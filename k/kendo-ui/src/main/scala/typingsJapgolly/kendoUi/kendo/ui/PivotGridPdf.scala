...
trait PivotGridPdf extends StObject {
...
object PivotGridPdf {
  ...
  extension [Self <: PivotGridPdf](x: Self) {
    ...
    inline def setMargin(value: PivotGridPdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
