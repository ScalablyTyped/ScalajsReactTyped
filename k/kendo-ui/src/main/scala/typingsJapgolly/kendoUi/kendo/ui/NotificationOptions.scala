...
object NotificationOptions {
  ...
  extension [Self <: NotificationOptions](x: Self) {
    ...
    inline def setHide(value: /* e */ NotificationHideEvent => Callback): Self = StObject.set(x, "hide", js.Any.fromFunction1((t0: /* e */ NotificationHideEvent) => value(t0).runNow()))
    ...
    inline def setShow(value: /* e */ NotificationShowEvent => Callback): Self = StObject.set(x, "show", js.Any.fromFunction1((t0: /* e */ NotificationShowEvent) => value(t0).runNow()))
