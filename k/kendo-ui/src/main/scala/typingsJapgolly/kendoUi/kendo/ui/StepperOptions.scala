...
object StepperOptions {
  ...
  extension [Self <: StepperOptions](x: Self) {
    ...
    inline def setActivate(value: /* e */ StepperActivateEvent => Callback): Self = StObject.set(x, "activate", js.Any.fromFunction1((t0: /* e */ StepperActivateEvent) => value(t0).runNow()))
    ...
    inline def setSelect(value: /* e */ StepperSelectEvent => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* e */ StepperSelectEvent) => value(t0).runNow()))
