...
object DateRangePickerOptions {
  ...
  extension [Self <: DateRangePickerOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ DateRangePickerChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ DateRangePickerChangeEvent) => value(t0).runNow()))
    
    inline def setChangeUndefined: Self = StObject.set(x, "change", js.undefined)
    
    inline def setClose(value: /* e */ DateRangePickerCloseEvent => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: /* e */ DateRangePickerCloseEvent) => value(t0).runNow()))
    ...
    inline def setOpen(value: /* e */ DateRangePickerOpenEvent => Callback): Self = StObject.set(x, "open", js.Any.fromFunction1((t0: /* e */ DateRangePickerOpenEvent) => value(t0).runNow()))
