...
trait SparklineAxisLabelClickEvent
  extends StObject
     with SparklineEvent {
...
object SparklineAxisLabelClickEvent {
  ...
  inline def apply(isDefaultPrevented: CallbackTo[Boolean], preventDefault: js.Function, sender: Sparkline): SparklineAxisLabelClickEvent = {
