...
object StockChartValueAxisItemTitle {
  ...
  inline def apply(): StockChartValueAxisItemTitle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartValueAxisItemTitle]
  }
  
  extension [Self <: StockChartValueAxisItemTitle](x: Self) {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: StockChartValueAxisItemTitleBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
