...
object SparklineValueAxisItemLabels {
  ...
  inline def apply(): SparklineValueAxisItemLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SparklineValueAxisItemLabels]
  }
  
  extension [Self <: SparklineValueAxisItemLabels](x: Self) {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: SparklineValueAxisItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
