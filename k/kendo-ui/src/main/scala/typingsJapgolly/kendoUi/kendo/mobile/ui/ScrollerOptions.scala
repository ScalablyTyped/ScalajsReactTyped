...
object ScrollerOptions {
  ...
  extension [Self <: ScrollerOptions](x: Self) {
    ...
    inline def setPull(value: /* e */ ScrollerEvent => Callback): Self = StObject.set(x, "pull", js.Any.fromFunction1((t0: /* e */ ScrollerEvent) => value(t0).runNow()))
    ...
    inline def setResize(value: /* e */ ScrollerEvent => Callback): Self = StObject.set(x, "resize", js.Any.fromFunction1((t0: /* e */ ScrollerEvent) => value(t0).runNow()))
    
    inline def setResizeUndefined: Self = StObject.set(x, "resize", js.undefined)
    
    inline def setScroll(value: /* e */ ScrollerScrollEvent => Callback): Self = StObject.set(x, "scroll", js.Any.fromFunction1((t0: /* e */ ScrollerScrollEvent) => value(t0).runNow()))
