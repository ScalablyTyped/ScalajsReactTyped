...
trait StockChartNavigatorSeriesItemLabels extends StObject {
...
object StockChartNavigatorSeriesItemLabels {
  ...
  inline def apply(): StockChartNavigatorSeriesItemLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartNavigatorSeriesItemLabels]
  }
  
  extension [Self <: StockChartNavigatorSeriesItemLabels](x: Self) {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: StockChartNavigatorSeriesItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
