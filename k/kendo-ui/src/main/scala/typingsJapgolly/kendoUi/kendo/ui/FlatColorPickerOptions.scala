...
object FlatColorPickerOptions {
  ...
  extension [Self <: FlatColorPickerOptions](x: Self) {
    ...
    inline def setChange(value: /* e */ FlatColorPickerChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ FlatColorPickerChangeEvent) => value(t0).runNow()))
