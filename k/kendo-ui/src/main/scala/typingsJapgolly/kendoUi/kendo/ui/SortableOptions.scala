...
object SortableOptions {
  ...
  def apply(
    ...
    axis: String = null,
    cancel: /* e */ SortableCancelEvent => Callback = null,
    change: /* e */ SortableChangeEvent => Callback = null,
    connectWith: String = null,
    container: String | JQuery = null,
    cursor: String = null,
    cursorOffset: SortableCursorOffset = null,
    disabled: String = null,
    end: /* e */ SortableEndEvent => Callback = null,
    filter: String = null,
    handler: String = null,
    hint: js.Function | String | JQuery = null,
    holdToDrag: js.UndefOr[Boolean] = js.undefined,
    ignore: String = null,
    move: /* e */ SortableMoveEvent => Callback = null,
    name: String = null,
    placeholder: js.Function | String | JQuery = null,
    start: /* e */ SortableStartEvent => Callback = null
  ): SortableOptions = {
    val __obj = js.Dynamic.literal()
    if (!js.isUndefined(autoScroll)) __obj.updateDynamic("autoScroll")(autoScroll.asInstanceOf[js.Any])
    if (axis != null) __obj.updateDynamic("axis")(axis.asInstanceOf[js.Any])
    if (cancel != null) __obj.updateDynamic("cancel")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.SortableCancelEvent) => cancel(t0).runNow()))
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.SortableChangeEvent) => change(t0).runNow()))
    ...
    if (end != null) __obj.updateDynamic("end")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.SortableEndEvent) => end(t0).runNow()))
    ...
    if (move != null) __obj.updateDynamic("move")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.SortableMoveEvent) => move(t0).runNow()))
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (placeholder != null) __obj.updateDynamic("placeholder")(placeholder.asInstanceOf[js.Any])
    if (start != null) __obj.updateDynamic("start")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.kendoUi.kendo.ui.SortableStartEvent) => start(t0).runNow()))
