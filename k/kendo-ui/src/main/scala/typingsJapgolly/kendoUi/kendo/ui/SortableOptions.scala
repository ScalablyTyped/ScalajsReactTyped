...
object SortableOptions {
  ...
  extension [Self <: SortableOptions](x: Self) {
    ...
    inline def setCancel(value: /* e */ SortableCancelEvent => Callback): Self = StObject.set(x, "cancel", js.Any.fromFunction1((t0: /* e */ SortableCancelEvent) => value(t0).runNow()))
    
    inline def setCancelUndefined: Self = StObject.set(x, "cancel", js.undefined)
    
    inline def setChange(value: /* e */ SortableChangeEvent => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* e */ SortableChangeEvent) => value(t0).runNow()))
    ...
    inline def setEnd(value: /* e */ SortableEndEvent => Callback): Self = StObject.set(x, "end", js.Any.fromFunction1((t0: /* e */ SortableEndEvent) => value(t0).runNow()))
    ...
    inline def setMove(value: /* e */ SortableMoveEvent => Callback): Self = StObject.set(x, "move", js.Any.fromFunction1((t0: /* e */ SortableMoveEvent) => value(t0).runNow()))
    ...
    inline def setStart(value: /* e */ SortableStartEvent => Callback): Self = StObject.set(x, "start", js.Any.fromFunction1((t0: /* e */ SortableStartEvent) => value(t0).runNow()))
