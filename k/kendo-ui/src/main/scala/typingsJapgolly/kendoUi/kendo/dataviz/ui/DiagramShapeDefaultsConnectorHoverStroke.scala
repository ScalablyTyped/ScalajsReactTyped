...
trait DiagramShapeDefaultsConnectorHoverStroke extends StObject {
...
object DiagramShapeDefaultsConnectorHoverStroke {
  ...
  inline def apply(): DiagramShapeDefaultsConnectorHoverStroke = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramShapeDefaultsConnectorHoverStroke]
  }
  
  extension [Self <: DiagramShapeDefaultsConnectorHoverStroke](x: Self) {
