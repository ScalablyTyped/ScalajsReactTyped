...
object TreeMapOptions {
  ...
  extension [Self <: TreeMapOptions](x: Self) {
    ...
    inline def setDataBound(value: /* e */ TreeMapDataBoundEvent => Callback): Self = StObject.set(x, "dataBound", js.Any.fromFunction1((t0: /* e */ TreeMapDataBoundEvent) => value(t0).runNow()))
    ...
    inline def setItemCreated(value: /* e */ TreeMapItemCreatedEvent => Callback): Self = StObject.set(x, "itemCreated", js.Any.fromFunction1((t0: /* e */ TreeMapItemCreatedEvent) => value(t0).runNow()))
