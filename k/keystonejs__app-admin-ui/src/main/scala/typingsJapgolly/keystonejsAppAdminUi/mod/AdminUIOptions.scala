package typingsJapgolly.keystonejsAppAdminUi.mod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.keystonejsAppAdminUi.AnonAuthentication
...
object AdminUIOptions {
  ...
  def apply[ListNames /* <: String */, UserType /* <: js.Object */](
    ...
    isAccessAllowed: /* opts */ AnonAuthentication[UserType, ListNames] => CallbackTo[Boolean] = null,
    ...
    if (isAccessAllowed != null) __obj.updateDynamic("isAccessAllowed")(js.Any.fromFunction1((t0: /* opts */ typingsJapgolly.keystonejsAppAdminUi.AnonAuthentication[UserType, ListNames]) => isAccessAllowed(t0).runNow()))
