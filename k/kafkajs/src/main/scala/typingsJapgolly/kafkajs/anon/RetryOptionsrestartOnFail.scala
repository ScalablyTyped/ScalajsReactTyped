...
/* Inlined kafkajs.kafkajs.RetryOptions & {  restartOnFailure :(err : std.Error): std.Promise<boolean> | undefined} */
trait RetryOptionsrestartOnFail extends StObject {
...
object RetryOptionsrestartOnFail {
  
  inline def apply(): RetryOptionsrestartOnFail = {
