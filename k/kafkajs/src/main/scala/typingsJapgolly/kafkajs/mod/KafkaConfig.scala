...
trait KafkaConfig extends StObject {
  ...
  var logCreator: js.UndefOr[typingsJapgolly.kafkajs.mod.logCreator] = js.undefined
  
  var logLevel: js.UndefOr[typingsJapgolly.kafkajs.mod.logLevel] = js.undefined
...
object KafkaConfig {
  ...
  extension [Self <: KafkaConfig](x: Self) {
    ...
    inline def setBrokersCallbackTo(value: CallbackTo[js.Array[String] | js.Promise[js.Array[String]]]): Self = StObject.set(x, "brokers", value.toJsFn)
