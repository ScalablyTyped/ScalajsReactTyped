...
object AssignerProtocol {
  ...
  @js.native
  def MemberAssignment: ISerializer[typingsJapgolly.kafkajs.mod.MemberAssignment] = js.native
  ...
  @js.native
  def MemberMetadata: ISerializer[typingsJapgolly.kafkajs.mod.MemberMetadata] = js.native
