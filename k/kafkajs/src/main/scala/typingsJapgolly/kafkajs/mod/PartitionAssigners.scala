...
object PartitionAssigners {
  ...
  inline def roundRobin(config: typingsJapgolly.kafkajs.anon.Cluster): Assigner = ^.asInstanceOf[js.Dynamic].applyDynamic("roundRobin")(config.asInstanceOf[js.Any]).asInstanceOf[Assigner]
