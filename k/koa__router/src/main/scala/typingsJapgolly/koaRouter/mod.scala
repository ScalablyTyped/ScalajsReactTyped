...
object mod {
  ...
  type Middleware[StateT, ContextT, BodyT] = typingsJapgolly.koa.mod.Middleware[StateT, ContextT & (RouterParamContext[StateT, ContextT]), BodyT]
  ...
  object RouterAllowedMethodsOptions {
    ...
    extension [Self <: RouterAllowedMethodsOptions](x: Self) {
      ...
      inline def setMethodNotAllowed(value: CallbackTo[Any]): Self = StObject.set(x, "methodNotAllowed", value.toJsFn)
      
      inline def setMethodNotAllowedUndefined: Self = StObject.set(x, "methodNotAllowed", js.undefined)
      
      inline def setNotImplemented(value: CallbackTo[Any]): Self = StObject.set(x, "notImplemented", value.toJsFn)
