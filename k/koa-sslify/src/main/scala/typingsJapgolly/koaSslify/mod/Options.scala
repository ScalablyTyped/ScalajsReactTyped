...
object Options {
  ...
  def apply(
    ...
    resolver: /* ctx */ Context => CallbackTo[Boolean] = null,
    ...
    if (resolver != null) __obj.updateDynamic("resolver")(js.Any.fromFunction1((t0: /* ctx */ typingsJapgolly.koa.mod.Context) => resolver(t0).runNow()))
