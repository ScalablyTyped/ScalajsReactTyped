...
import typingsJapgolly.kapsule.anon.PartialState
...
object mod {
  ...
  object PropCfg {
    ...
    extension [Self <: PropCfg](x: Self) {
      ...
      inline def setOnChange(value: (/* newVal */ PropVal, /* state */ State, /* prevVal */ PropVal) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction3((t0: /* newVal */ PropVal, t1: /* state */ State, t2: /* prevVal */ PropVal) => (value(t0, t1, t2)).runNow()))
  ...
  object State {
    ...
    inline def apply(_rerender: Callback, initialised: Boolean): State = {
      val __obj = js.Dynamic.literal(_rerender = _rerender.toJsFn, initialised = initialised.asInstanceOf[js.Any])
