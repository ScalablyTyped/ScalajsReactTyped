...
import typingsJapgolly.knuddelsUserappsApi.AnonMethod
import typingsJapgolly.knuddelsUserappsApi.AnonOnFailure
import typingsJapgolly.knuddelsUserappsApi.AnonOnSuccess
