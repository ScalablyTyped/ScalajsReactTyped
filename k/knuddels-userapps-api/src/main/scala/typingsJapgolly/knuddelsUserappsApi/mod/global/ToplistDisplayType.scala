...
@js.native
open class ToplistDisplayType () extends StObject
object ToplistDisplayType {
  
  /**
    * @see https://developer.knuddels.de/docs/classes/ToplistDisplayType.html#property_Label
    */
  /* static member */
  @JSGlobal("ToplistDisplayType.Label")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ToplistDisplayType.LabelAndRank")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ToplistDisplayType.Value")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ToplistDisplayType.ValueAndRank")
  @js.native
