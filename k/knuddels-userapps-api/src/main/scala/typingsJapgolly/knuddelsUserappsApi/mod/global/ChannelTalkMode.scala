...
@js.native
open class ChannelTalkMode () extends StObject
object ChannelTalkMode {
  
  /**
    * @see https://developer.knuddels.de/docs/classes/ChannelTalkMode.html#property_Everyone
    */
  /* static member */
  @JSGlobal("ChannelTalkMode.Everyone")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ChannelTalkMode.FilteredByModerators")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("ChannelTalkMode.OnlyWithTalkPermission")
  @js.native
