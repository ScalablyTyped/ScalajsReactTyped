...
import typingsJapgolly.knockoutPreRendered.anon.Element
  ...
  object Loader {
    ...
    extension [Self <: Loader](x: Self) {
      ...
      inline def setGetConfig(
        value: (/* componentName */ String, /* callback */ js.Function1[/* result */ ComponentConfig, Unit]) => Callback
      ): Self = StObject.set(x, "getConfig", js.Any.fromFunction2((t0: /* componentName */ String, t1: /* callback */ js.Function1[/* result */ ComponentConfig, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setGetConfigUndefined: Self = StObject.set(x, "getConfig", js.undefined)
      
      inline def setLoadComponent(
        value: (/* componentName */ String, /* config */ ComponentConfig, /* callback */ js.Function1[/* result */ Definition, Unit]) => Callback
      ): Self = StObject.set(x, "loadComponent", js.Any.fromFunction3((t0: /* componentName */ String, t1: /* config */ ComponentConfig, t2: /* callback */ js.Function1[/* result */ Definition, Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setLoadComponentUndefined: Self = StObject.set(x, "loadComponent", js.undefined)
      
      inline def setLoadTemplate(
        value: (/* componentName */ String, /* templateConfig */ Any, /* callback */ js.Function1[/* result */ js.Array[Node], Unit]) => Callback
      ): Self = StObject.set(x, "loadTemplate", js.Any.fromFunction3((t0: /* componentName */ String, t1: /* templateConfig */ Any, t2: /* callback */ js.Function1[/* result */ js.Array[Node], Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setLoadTemplateUndefined: Self = StObject.set(x, "loadTemplate", js.undefined)
      
      inline def setLoadViewModel(
        value: (/* componentName */ String, /* viewModelConfig */ Any, /* callback */ js.Function1[/* result */ Any, Unit]) => Callback
      ): Self = StObject.set(x, "loadViewModel", js.Any.fromFunction3((t0: /* componentName */ String, t1: /* viewModelConfig */ Any, t2: /* callback */ js.Function1[/* result */ Any, Unit]) => (value(t0, t1, t2)).runNow()))
