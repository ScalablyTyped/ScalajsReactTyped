...
object KnockoutBindingProvider {
  ...
  def apply(
    ...
    __obj.updateDynamic("getBindings")(js.Any.fromFunction2((t0: org.scalajs.dom.raw.Node, t1: typingsJapgolly.knockoutPreRendered.KnockoutBindingContext) => getBindings(t0, t1).runNow()))
    __obj.updateDynamic("nodeHasBindings")(js.Any.fromFunction1((t0: org.scalajs.dom.raw.Node) => nodeHasBindings(t0).runNow()))
    if (getBindingAccessors != null) __obj.updateDynamic("getBindingAccessors")(js.Any.fromFunction2((t0: /* node */ org.scalajs.dom.raw.Node, t1: /* bindingContext */ typingsJapgolly.knockoutPreRendered.KnockoutBindingContext) => getBindingAccessors(t0, t1).runNow()))
