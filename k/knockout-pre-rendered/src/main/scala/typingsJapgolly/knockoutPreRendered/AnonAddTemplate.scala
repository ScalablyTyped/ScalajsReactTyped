...
object AnonAddTemplate {
  ...
  def apply(
    ...
    __obj.updateDynamic("renderTemplateSource")(js.Any.fromFunction3((t0: js.Object, t1: typingsJapgolly.knockoutPreRendered.KnockoutBindingContext, t2: js.Object) => renderTemplateSource(t0, t1, t2).runNow()))
