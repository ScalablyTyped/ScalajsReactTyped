...
object KnockoutBindingHandler {
  ...
  def apply(
    ...
    if (init != null) __obj.updateDynamic("init")(js.Any.fromFunction5((t0: /* element */ js.Any, t1: /* valueAccessor */ js.Function0[js.Any], t2: /* allBindingsAccessor */ js.UndefOr[typingsJapgolly.knockoutPreRendered.KnockoutAllBindingsAccessor], t3: /* viewModel */ js.UndefOr[js.Any], t4: /* bindingContext */ js.UndefOr[typingsJapgolly.knockoutPreRendered.KnockoutBindingContext]) => init(t0, t1, t2, t3, t4).runNow()))
  ...
  js.Function2[/* name */ java.lang.String, /* value */ java.lang.String, scala.Unit]]) => preprocess(t0, t1, t2).runNow()))
    if (update != null) __obj.updateDynamic("update")(js.Any.fromFunction5((t0: /* element */ js.Any, t1: /* valueAccessor */ js.Function0[js.Any], t2: /* allBindingsAccessor */ js.UndefOr[typingsJapgolly.knockoutPreRendered.KnockoutAllBindingsAccessor], t3: /* viewModel */ js.UndefOr[js.Any], t4: /* bindingContext */ js.UndefOr[typingsJapgolly.knockoutPreRendered.KnockoutBindingContext]) => update(t0, t1, t2, t3, t4).runNow()))
