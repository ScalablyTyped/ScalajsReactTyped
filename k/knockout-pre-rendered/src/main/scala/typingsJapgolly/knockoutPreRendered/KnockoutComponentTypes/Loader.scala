...
object Loader {
  ...
  /* result */ typingsJapgolly.knockoutPreRendered.KnockoutComponentTypes.ComponentConfig, 
  scala.Unit]) => getConfig(t0, t1).runNow()))
    if (loadComponent != null) __obj.updateDynamic("loadComponent")(js.Any.fromFunction3((t0: /* componentName */ java.lang.String, t1: /* config */ typingsJapgolly.knockoutPreRendered.KnockoutComponentTypes.ComponentConfig, t2: /* callback */ js.Function1[
  /* result */ typingsJapgolly.knockoutPreRendered.KnockoutComponentTypes.Definition, 
