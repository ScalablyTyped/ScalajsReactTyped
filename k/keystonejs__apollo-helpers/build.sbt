...
version := "5.0-dt-20191115Z-94d444"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "keystonejs__fields" % "5.1-dt-20191115Z-9e5751",
  "org.scalablytyped.japgolly" %%% "keystonejs__keystone" % "5.2-dt-20191231Z-0406b2",
