...
import typingsJapgolly.koaHbs.anon.FnCall
import typingsJapgolly.koaHbs.anon.TypeofUtils
...
object mod extends Shortcut {
  ...
  open class SafeString protected ()
    extends typingsJapgolly.handlebars.mod.SafeString {
    def this(str: String) = this()
  }
  
  trait Hbs extends StObject {
    
    var SafeString: Instantiable1[/* str */ String, typingsJapgolly.handlebars.mod.SafeString]
  ...
  object Hbs {
    ...
    inline def apply(
      SafeString: Instantiable1[/* str */ String, typingsJapgolly.handlebars.mod.SafeString],
      Utils: TypeofUtils,
    ...
    extension [Self <: Hbs](x: Self) {
      ...
      inline def setSafeString(value: Instantiable1[/* str */ String, typingsJapgolly.handlebars.mod.SafeString]): Self = StObject.set(x, "SafeString", value.asInstanceOf[js.Any])
