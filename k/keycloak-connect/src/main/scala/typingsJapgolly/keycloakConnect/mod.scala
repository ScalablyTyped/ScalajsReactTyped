...
import typingsJapgolly.keycloakConnect.anon.Admin
import typingsJapgolly.keycloakConnect.anon.Id
import typingsJapgolly.keycloakConnect.keycloakConnectBooleans.`false`
...
object mod extends Shortcut {
  ...
  object Grant {
    ...
    inline def apply(isExpired: CallbackTo[Boolean], update: Grant => Callback): Grant = {
      val __obj = js.Dynamic.literal(isExpired = isExpired.toJsFn, update = js.Any.fromFunction1((t0: Grant) => update(t0).runNow()))
    ...
    extension [Self <: Grant](x: Self) {
      ...
      inline def setUpdate(value: Grant => Callback): Self = StObject.set(x, "update", js.Any.fromFunction1((t0: Grant) => value(t0).runNow()))
    }
  }
  ...
  object Token {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(hasApplicationRole = js.Any.fromFunction2(hasApplicationRole), hasRealmRole = js.Any.fromFunction1(hasRealmRole), hasRole = js.Any.fromFunction1(hasRole), isExpired = isExpired.toJsFn)
