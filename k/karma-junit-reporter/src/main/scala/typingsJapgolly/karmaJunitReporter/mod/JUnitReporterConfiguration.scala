package typingsJapgolly.karmaJunitReporter.mod
...
object JUnitReporterConfiguration {
  @scala.inline
  def apply(
    classNameFormatter: (/* browser */ js.Any, /* result */ js.Any) => CallbackTo[String] = null,
    nameFormatter: (/* browser */ js.Any, /* result */ js.Any) => CallbackTo[String] = null,
    ...
    if (classNameFormatter != null) __obj.updateDynamic("classNameFormatter")(js.Any.fromFunction2((t0: /* browser */ js.Any, t1: /* result */ js.Any) => classNameFormatter(t0, t1).runNow()))
    if (nameFormatter != null) __obj.updateDynamic("nameFormatter")(js.Any.fromFunction2((t0: /* browser */ js.Any, t1: /* result */ js.Any) => nameFormatter(t0, t1).runNow()))
