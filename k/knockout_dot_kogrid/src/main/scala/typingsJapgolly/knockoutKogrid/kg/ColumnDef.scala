...
object ColumnDef {
  ...
  def apply(
    ...
    cellFormatter: /* val */ js.Any => CallbackTo[String] = null,
    ...
    if (cellFormatter != null) __obj.updateDynamic("cellFormatter")(js.Any.fromFunction1((t0: /* val */ js.Any) => cellFormatter(t0).runNow()))
