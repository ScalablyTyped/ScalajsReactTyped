...
object GridOptions {
  ...
  def apply[EntityType](
    ...
    afterSelectionChange: /* row */ Row[EntityType] => Callback = null,
    beforeSelectionChange: /* row */ Row[EntityType] => CallbackTo[Boolean] = null,
    ...
    if (afterSelectionChange != null) __obj.updateDynamic("afterSelectionChange")(js.Any.fromFunction1((t0: /* row */ typingsJapgolly.knockoutKogrid.kg.Row[EntityType]) => afterSelectionChange(t0).runNow()))
    if (beforeSelectionChange != null) __obj.updateDynamic("beforeSelectionChange")(js.Any.fromFunction1((t0: /* row */ typingsJapgolly.knockoutKogrid.kg.Row[EntityType]) => beforeSelectionChange(t0).runNow()))
