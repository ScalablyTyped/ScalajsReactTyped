...
import typingsJapgolly.jquery.JQueryGenericPromise
...
object kg {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.knockoutKogrid.knockoutKogridStrings.asc
    - typingsJapgolly.knockoutKogrid.knockoutKogridStrings.desc
  */
  trait Direction extends StObject
  object Direction {
    
    inline def asc: typingsJapgolly.knockoutKogrid.knockoutKogridStrings.asc = "asc".asInstanceOf[typingsJapgolly.knockoutKogrid.knockoutKogridStrings.asc]
    
    inline def desc: typingsJapgolly.knockoutKogrid.knockoutKogridStrings.desc = "desc".asInstanceOf[typingsJapgolly.knockoutKogrid.knockoutKogridStrings.desc]
  }
  ...
  object DomUtilityService {
    ...
    inline def apply(BuildStyles: Grid[Any] => Callback, UpdateGridLayout: Grid[Any] => Callback): DomUtilityService = {
      val __obj = js.Dynamic.literal(BuildStyles = js.Any.fromFunction1((t0: Grid[Any]) => BuildStyles(t0).runNow()), UpdateGridLayout = js.Any.fromFunction1((t0: Grid[Any]) => UpdateGridLayout(t0).runNow()))
      __obj.asInstanceOf[DomUtilityService]
    }
    
    extension [Self <: DomUtilityService](x: Self) {
      
      inline def setBuildStyles(value: Grid[Any] => Callback): Self = StObject.set(x, "BuildStyles", js.Any.fromFunction1((t0: Grid[Any]) => value(t0).runNow()))
      
      inline def setUpdateGridLayout(value: Grid[Any] => Callback): Self = StObject.set(x, "UpdateGridLayout", js.Any.fromFunction1((t0: Grid[Any]) => value(t0).runNow()))
    }
  }
  ...
  object Grid {
    ...
    inline def apply[EntityType](
      ...
      val __obj = js.Dynamic.literal(config = config.asInstanceOf[js.Any], configureColumnWidths = configureColumnWidths.toJsFn, rowFactory = rowFactory.asInstanceOf[js.Any], selectionService = selectionService.asInstanceOf[js.Any])
  ...
  object GridOptions {
    ...
    extension [Self <: GridOptions[?], EntityType](x: Self & GridOptions[EntityType]) {
      ...
      inline def setAfterSelectionChange(value: /* row */ Row[EntityType] => Callback): Self = StObject.set(x, "afterSelectionChange", js.Any.fromFunction1((t0: /* row */ Row[EntityType]) => value(t0).runNow()))
  ...
  object Plugin {
    ...
    inline def apply[EntityType](onGridInit: Grid[EntityType] => Callback): Plugin[EntityType] = {
      val __obj = js.Dynamic.literal(onGridInit = js.Any.fromFunction1((t0: Grid[EntityType]) => onGridInit(t0).runNow()))
      __obj.asInstanceOf[Plugin[EntityType]]
    }
    
    extension [Self <: Plugin[?], EntityType](x: Self & Plugin[EntityType]) {
      
      inline def setOnGridInit(value: Grid[EntityType] => Callback): Self = StObject.set(x, "onGridInit", js.Any.fromFunction1((t0: Grid[EntityType]) => value(t0).runNow()))
    }
  }
  ...
  object SelectionService {
    ...
    inline def apply[EntityType](
      ...
      val __obj = js.Dynamic.literal(lastClickedRow = lastClickedRow.asInstanceOf[js.Any], multi = multi.asInstanceOf[js.Any], setSelection = js.Any.fromFunction2((t0: Row[EntityType], t1: Boolean) => (setSelection(t0, t1)).runNow()))
    ...
    extension [Self <: SelectionService[?], EntityType](x: Self & SelectionService[EntityType]) {
      ...
      inline def setSetSelection(value: (Row[EntityType], Boolean) => Callback): Self = StObject.set(x, "setSelection", js.Any.fromFunction2((t0: Row[EntityType], t1: Boolean) => (value(t0, t1)).runNow()))
    }
  }
