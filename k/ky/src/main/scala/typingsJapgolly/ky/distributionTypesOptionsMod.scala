...
import typingsJapgolly.ky.anon.RequiredHeaderskeyofHeade
import typingsJapgolly.ky.anon.RequiredHookskeyofHooks
import typingsJapgolly.ky.anon.RequiredRetryOptionskeyof
import typingsJapgolly.ky.distributionTypesCommonMod.LiteralUnion
import typingsJapgolly.ky.distributionTypesHooksMod.Hooks
import typingsJapgolly.ky.distributionTypesRetryMod.RetryOptions
...
object distributionTypesOptionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ky.kyStrings.get
    - typingsJapgolly.ky.kyStrings.post
    - typingsJapgolly.ky.kyStrings.put
    - typingsJapgolly.ky.kyStrings.patch
    - typingsJapgolly.ky.kyStrings.head
    - typingsJapgolly.ky.kyStrings.delete
  */
  trait HttpMethod extends StObject
  object HttpMethod {
    
    inline def delete: typingsJapgolly.ky.kyStrings.delete = "delete".asInstanceOf[typingsJapgolly.ky.kyStrings.delete]
    
    inline def get: typingsJapgolly.ky.kyStrings.get = "get".asInstanceOf[typingsJapgolly.ky.kyStrings.get]
    
    inline def head: typingsJapgolly.ky.kyStrings.head = "head".asInstanceOf[typingsJapgolly.ky.kyStrings.head]
    
    inline def patch: typingsJapgolly.ky.kyStrings.patch = "patch".asInstanceOf[typingsJapgolly.ky.kyStrings.patch]
    
    inline def post: typingsJapgolly.ky.kyStrings.post = "post".asInstanceOf[typingsJapgolly.ky.kyStrings.post]
    
    inline def put: typingsJapgolly.ky.kyStrings.put = "put".asInstanceOf[typingsJapgolly.ky.kyStrings.put]
  }
  ...
  object InternalOptions {
    ...
    extension [Self <: InternalOptions](x: Self) {
      ...
      inline def setOnDownloadProgress(value: (/* progress */ DownloadProgress, /* chunk */ js.typedarray.Uint8Array) => Callback): Self = StObject.set(x, "onDownloadProgress", js.Any.fromFunction2((t0: /* progress */ DownloadProgress, t1: /* chunk */ js.typedarray.Uint8Array) => (value(t0, t1)).runNow()))
  ...
  trait NormalizedOptions
    extends StObject
       with typingsJapgolly.std.RequestInit {
