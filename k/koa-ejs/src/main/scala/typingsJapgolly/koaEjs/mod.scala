package typingsJapgolly.koaEjs
...
import typingsJapgolly.koaEjs.koaEjsBooleans.`false`
...
object mod {
  ...
  /**
    ...
    */
  inline def apply(app: typingsJapgolly.koa.mod.^[DefaultState, DefaultContext], settings: Settings): Unit = (^.asInstanceOf[js.Dynamic].apply(app.asInstanceOf[js.Any], settings.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  object ejs {
    ...
    @JSImport("koa-ejs", "ejs.Template")
    @js.native
    def Template: Any | (Instantiable1[/* text */ String, typingsJapgolly.ejs.mod.Template]) = js.native
    inline def Template_=(x: Any | (Instantiable1[/* text */ String, typingsJapgolly.ejs.mod.Template])): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Template")(x.asInstanceOf[js.Any])
    ...
    @js.native
    val name: typingsJapgolly.koaEjs.koaEjsStrings.ejs = js.native
