package typingsJapgolly.knockback
...
import typingsJapgolly.knockback.Knockback.FactoryOptions
import typingsJapgolly.knockback.Knockback.Static
import typingsJapgolly.knockback.Knockback.StoreOptions
import typingsJapgolly.knockback.Knockback.ViewModelOptions
...
object global {
  ...
  object Knockback {
    ...
    open class DefaultObservable protected ()
      extends StObject
         with typingsJapgolly.knockback.Knockback.DefaultObservable {
      def this(
    ...
    open class Destroyable ()
      extends StObject
         with typingsJapgolly.knockback.Knockback.Destroyable {
    ...
    open class EventWatcher ()
      extends StObject
         with typingsJapgolly.knockback.Knockback.EventWatcher {
    ...
    open class Factory protected ()
      extends StObject
         with typingsJapgolly.knockback.Knockback.Factory {
    ...
    open class LocalizedObservable protected ()
      extends StObject
         with typingsJapgolly.knockback.Knockback.LocalizedObservable {
    ...
    open class Statistics ()
      extends StObject
         with typingsJapgolly.knockback.Knockback.Statistics {
    ...
    open class Store protected ()
      extends StObject
         with typingsJapgolly.knockback.Knockback.Store {
    ...
    open class TriggeredObservable protected ()
      extends StObject
         with typingsJapgolly.knockback.Knockback.TriggeredObservable {
    ...
    open class ViewModel ()
      extends StObject
         with typingsJapgolly.knockback.Knockback.ViewModel {
      ...
      def this(model: Unit, options: Unit, viewModel: typingsJapgolly.knockback.Knockback.ViewModel) = this()
      def this(model: Unit, options: ViewModelOptions, viewModel: typingsJapgolly.knockback.Knockback.ViewModel) = this()
      def this(
        model: Model[Any, ModelSetOptions, Any],
        options: Unit,
        viewModel: typingsJapgolly.knockback.Knockback.ViewModel
      ) = this()
      def this(
        model: Model[Any, ModelSetOptions, Any],
