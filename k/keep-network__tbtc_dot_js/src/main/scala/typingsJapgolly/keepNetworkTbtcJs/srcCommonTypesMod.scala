...
import typingsJapgolly.keepNetworkTbtcJs.anon.OmitFoundTransactionvalue
import typingsJapgolly.keepNetworkTbtcJs.srcBitcoinHelpersMod.BitcoinNetworkType
...
object srcCommonTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.function
    - typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.constructor
    - typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.event
    - typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.fallback
  */
  trait AbiType extends StObject
  object AbiType {
    
    inline def constructor: typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.constructor = "constructor".asInstanceOf[typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.constructor]
    
    inline def event: typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.event = "event".asInstanceOf[typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.event]
    
    inline def fallback: typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.fallback = "fallback".asInstanceOf[typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.fallback]
    
    inline def function: typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.function = "function".asInstanceOf[typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.function]
  }
  ...
  object DepositBaseClass {
    ...
    inline def apply(
      ...
      contract: Contract,
      factory: Any,
      getCurrentState: CallbackTo[js.Promise[Double]],
      getLatestRedemptionDetails: CallbackTo[js.Promise[Null | RedemptionDetails]],
      keepContract: Contract,
      publicKeyPoint: js.Promise[KeyPoint]
    ): DepositBaseClass = {
      val __obj = js.Dynamic.literal(address = address.asInstanceOf[js.Any], constructFundingProof = js.Any.fromFunction2(constructFundingProof), contract = contract.asInstanceOf[js.Any], factory = factory.asInstanceOf[js.Any], getCurrentState = getCurrentState.toJsFn, getLatestRedemptionDetails = getLatestRedemptionDetails.toJsFn, keepContract = keepContract.asInstanceOf[js.Any], publicKeyPoint = publicKeyPoint.asInstanceOf[js.Any])
    ...
    extension [Self <: DepositBaseClass](x: Self) {
      ...
      inline def setGetCurrentState(value: CallbackTo[js.Promise[Double]]): Self = StObject.set(x, "getCurrentState", value.toJsFn)
      
      inline def setGetLatestRedemptionDetails(value: CallbackTo[js.Promise[Null | RedemptionDetails]]): Self = StObject.set(x, "getLatestRedemptionDetails", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.pure
    - typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.view
    - typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.nonpayable
    - typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.payable
  */
  trait StateMutabilityType extends StObject
  object StateMutabilityType {
    
    inline def nonpayable: typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.nonpayable = "nonpayable".asInstanceOf[typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.nonpayable]
    
    inline def payable: typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.payable = "payable".asInstanceOf[typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.payable]
    
    inline def pure: typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.pure = "pure".asInstanceOf[typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.pure]
    
    inline def view: typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.view = "view".asInstanceOf[typingsJapgolly.keepNetworkTbtcJs.keepNetworkTbtcJsStrings.view]
  }
