...
import typingsJapgolly.keepNetworkTbtcJs.anon.ACTIVE
import typingsJapgolly.keepNetworkTbtcJs.anon.Confirmations
import typingsJapgolly.keepNetworkTbtcJs.anon.DepositAddress
import typingsJapgolly.keepNetworkTbtcJs.anon.Digest
import typingsJapgolly.keepNetworkTbtcJs.anon.OmitFoundTransactionvalue
import typingsJapgolly.keepNetworkTbtcJs.anon.RequiredConfirmations
...
import typingsJapgolly.keepNetworkTbtcJs.srcCommonTypesMod.DepositBaseClass
import typingsJapgolly.keepNetworkTbtcJs.srcCommonTypesMod.KeyPoint
import typingsJapgolly.keepNetworkTbtcJs.srcCommonTypesMod.RedemptionDetails
...
object srcDepositMod {
  ...
  trait Deposit
    ...
    def getCurrentRedemption(): js.Promise[typingsJapgolly.keepNetworkTbtcJs.srcRedemptionMod.default | Null] = js.native
    ...
    def requestRedemption(redeemerAddress: String): js.Promise[typingsJapgolly.keepNetworkTbtcJs.srcRedemptionMod.default] = js.native
