...
object CompressOptions {
  ...
  def apply(
    ...
    filter: /* content_type */ String => CallbackTo[Boolean] = null,
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction1((t0: /* content_type */ java.lang.String) => filter(t0).runNow()))
