...
object Tokens {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(backgroundAlertCritical = backgroundAlertCritical.asInstanceOf[js.Any], backgroundAlertInfo = backgroundAlertInfo.asInstanceOf[js.Any], backgroundAlertSuccess = backgroundAlertSuccess.asInstanceOf[js.Any], backgroundAlertWarning = backgroundAlertWarning.asInstanceOf[js.Any], backgroundBadgeCritical = backgroundBadgeCritical.asInstanceOf[js.Any], backgroundBadgeDark = backgroundBadgeDark.asInstanceOf[js.Any], backgroundBadgeInfo = backgroundBadgeInfo.asInstanceOf[js.Any], backgroundBadgeNeutral = backgroundBadgeNeutral.asInstanceOf[js.Any], backgroundBadgeSuccess = backgroundBadgeSuccess.asInstanceOf[js.Any], backgroundBadgeWarning = backgroundBadgeWarning.asInstanceOf[js.Any], backgroundBadgeWhite = backgroundBadgeWhite.asInstanceOf[js.Any], backgroundBody = backgroundBody.asInstanceOf[js.Any], backgroundButtonBordered = backgroundButtonBordered.asInstanceOf[js.Any], backgroundButtonBorderedActive = backgroundButtonBorderedActive.asInstanceOf[js.Any], backgroundButtonBorderedHover = backgroundButtonBorderedHover.asInstanceOf[js.Any], backgroundButtonCritical = backgroundButtonCritical.asInstanceOf[js.Any], backgroundButtonCriticalActive = backgroundButtonCriticalActive.asInstanceOf[js.Any], backgroundButtonCriticalHover = backgroundButtonCriticalHover.asInstanceOf[js.Any], backgroundButtonFacebook = backgroundButtonFacebook.asInstanceOf[js.Any], backgroundButtonFacebookActive = backgroundButtonFacebookActive.asInstanceOf[js.Any], backgroundButtonFacebookHover = backgroundButtonFacebookHover.asInstanceOf[js.Any], backgroundButtonGoogle = backgroundButtonGoogle.asInstanceOf[js.Any], backgroundButtonGoogleActive = backgroundButtonGoogleActive.asInstanceOf[js.Any], backgroundButtonGoogleHover = backgroundButtonGoogleHover.asInstanceOf[js.Any], backgroundButtonInfo = backgroundButtonInfo.asInstanceOf[js.Any], backgroundButtonInfoActive = backgroundButtonInfoActive.asInstanceOf[js.Any], backgroundButtonInfoHover = backgroundButtonInfoHover.asInstanceOf[js.Any], backgroundButtonLinkPrimary = backgroundButtonLinkPrimary.asInstanceOf[js.Any], backgroundButtonLinkPrimaryActive = backgroundButtonLinkPrimaryActive.asInstanceOf[js.Any], backgroundButtonLinkPrimaryHover = backgroundButtonLinkPrimaryHover.asInstanceOf[js.Any], backgroundButtonLinkSecondary = backgroundButtonLinkSecondary.asInstanceOf[js.Any], backgroundButtonLinkSecondaryActive = backgroundButtonLinkSecondaryActive.asInstanceOf[js.Any], backgroundButtonLinkSecondaryHover = backgroundButtonLinkSecondaryHover.asInstanceOf[js.Any], backgroundButtonPrimary = backgroundButtonPrimary.asInstanceOf[js.Any], backgroundButtonPrimaryActive = backgroundButtonPrimaryActive.asInstanceOf[js.Any], backgroundButtonPrimaryHover = backgroundButtonPrimaryHover.asInstanceOf[js.Any], backgroundButtonSecondary = backgroundButtonSecondary.asInstanceOf[js.Any], backgroundButtonSecondaryActive = backgroundButtonSecondaryActive.asInstanceOf[js.Any], backgroundButtonSecondaryHover = backgroundButtonSecondaryHover.asInstanceOf[js.Any], backgroundButtonSuccess = backgroundButtonSuccess.asInstanceOf[js.Any], backgroundButtonSuccessActive = backgroundButtonSuccessActive.asInstanceOf[js.Any], backgroundButtonSuccessHover = backgroundButtonSuccessHover.asInstanceOf[js.Any], backgroundButtonWarning = backgroundButtonWarning.asInstanceOf[js.Any], backgroundButtonWarningActive = backgroundButtonWarningActive.asInstanceOf[js.Any], backgroundButtonWarningHover = backgroundButtonWarningHover.asInstanceOf[js.Any], backgroundButtonWhite = backgroundButtonWhite.asInstanceOf[js.Any], backgroundButtonWhiteActive = backgroundButtonWhiteActive.asInstanceOf[js.Any], backgroundButtonWhiteBordered = backgroundButtonWhiteBordered.asInstanceOf[js.Any], backgroundButtonWhiteBorderedActive = backgroundButtonWhiteBorderedActive.asInstanceOf[js.Any], backgroundButtonWhiteBorderedHover = backgroundButtonWhiteBorderedHover.asInstanceOf[js.Any], backgroundButtonWhiteHover = backgroundButtonWhiteHover.asInstanceOf[js.Any], backgroundCard = backgroundCard.asInstanceOf[js.Any], backgroundCarrierLogo = backgroundCarrierLogo.asInstanceOf[js.Any], backgroundCountryFlag = backgroundCountryFlag.asInstanceOf[js.Any], backgroundIllustration = backgroundIllustration.asInstanceOf[js.Any], backgroundInput = backgroundInput.asInstanceOf[js.Any], backgroundInputDisabled = backgroundInputDisabled.asInstanceOf[js.Any], backgroundModal = backgroundModal.asInstanceOf[js.Any], backgroundSeparator = backgroundSeparator.asInstanceOf[js.Any], backgroundServiceLogo = backgroundServiceLogo.asInstanceOf[js.Any], backgroundTable = backgroundTable.asInstanceOf[js.Any], backgroundTableEven = backgroundTableEven.asInstanceOf[js.Any], backgroundTableHover = backgroundTableHover.asInstanceOf[js.Any], backgroundTableShadowLeft = backgroundTableShadowLeft.asInstanceOf[js.Any], backgroundTableShadowRight = backgroundTableShadowRight.asInstanceOf[js.Any], backgroundTag = backgroundTag.asInstanceOf[js.Any], backgroundTagActive = backgroundTagActive.asInstanceOf[js.Any], backgroundTagHover = backgroundTagHover.asInstanceOf[js.Any], backgroundTagSelected = backgroundTagSelected.asInstanceOf[js.Any], backgroundTagSelectedActive = backgroundTagSelectedActive.asInstanceOf[js.Any], backgroundTagSelectedHover = backgroundTagSelectedHover.asInstanceOf[js.Any], borderColorButtonCriticalBordered = borderColorButtonCriticalBordered.asInstanceOf[js.Any], borderColorButtonCriticalBorderedActive = borderColorButtonCriticalBorderedActive.asInstanceOf[js.Any], borderColorButtonCriticalBorderedHover = borderColorButtonCriticalBorderedHover.asInstanceOf[js.Any], borderColorButtonFacebookBordered = borderColorButtonFacebookBordered.asInstanceOf[js.Any], borderColorButtonFacebookBorderedActive = borderColorButtonFacebookBorderedActive.asInstanceOf[js.Any], borderColorButtonFacebookBorderedHover = borderColorButtonFacebookBorderedHover.asInstanceOf[js.Any], borderColorButtonGoogleBordered = borderColorButtonGoogleBordered.asInstanceOf[js.Any], borderColorButtonGoogleBorderedActive = borderColorButtonGoogleBorderedActive.asInstanceOf[js.Any], borderColorButtonGoogleBorderedHover = borderColorButtonGoogleBorderedHover.asInstanceOf[js.Any], borderColorButtonInfoBordered = borderColorButtonInfoBordered.asInstanceOf[js.Any], borderColorButtonInfoBorderedActive = borderColorButtonInfoBorderedActive.asInstanceOf[js.Any], borderColorButtonInfoBorderedHover = borderColorButtonInfoBorderedHover.asInstanceOf[js.Any], borderColorButtonPrimaryBordered = borderColorButtonPrimaryBordered.asInstanceOf[js.Any], borderColorButtonPrimaryBorderedActive = borderColorButtonPrimaryBorderedActive.asInstanceOf[js.Any], borderColorButtonPrimaryBorderedHover = borderColorButtonPrimaryBorderedHover.asInstanceOf[js.Any], borderColorButtonSecondaryBordered = borderColorButtonSecondaryBordered.asInstanceOf[js.Any], borderColorButtonSecondaryBorderedActive = borderColorButtonSecondaryBorderedActive.asInstanceOf[js.Any], borderColorButtonSecondaryBorderedHover = borderColorButtonSecondaryBorderedHover.asInstanceOf[js.Any], borderColorButtonSuccessBordered = borderColorButtonSuccessBordered.asInstanceOf[js.Any], borderColorButtonSuccessBorderedActive = borderColorButtonSuccessBorderedActive.asInstanceOf[js.Any], borderColorButtonSuccessBorderedHover = borderColorButtonSuccessBorderedHover.asInstanceOf[js.Any], borderColorButtonWarningBordered = borderColorButtonWarningBordered.asInstanceOf[js.Any], borderColorButtonWarningBorderedActive = borderColorButtonWarningBorderedActive.asInstanceOf[js.Any], borderColorButtonWarningBorderedHover = borderColorButtonWarningBorderedHover.asInstanceOf[js.Any], borderColorButtonWhiteBordered = borderColorButtonWhiteBordered.asInstanceOf[js.Any], borderColorButtonWhiteBorderedActive = borderColorButtonWhiteBorderedActive.asInstanceOf[js.Any], borderColorButtonWhiteBorderedHover = borderColorButtonWhiteBorderedHover.asInstanceOf[js.Any], borderColorCard = borderColorCard.asInstanceOf[js.Any], borderColorCheckboxRadio = borderColorCheckboxRadio.asInstanceOf[js.Any], borderColorCheckboxRadioActive = borderColorCheckboxRadioActive.asInstanceOf[js.Any], borderColorCheckboxRadioError = borderColorCheckboxRadioError.asInstanceOf[js.Any], borderColorCheckboxRadioFocus = borderColorCheckboxRadioFocus.asInstanceOf[js.Any], borderColorCheckboxRadioHover = borderColorCheckboxRadioHover.asInstanceOf[js.Any], borderColorInput = borderColorInput.asInstanceOf[js.Any], borderColorInputActive = borderColorInputActive.asInstanceOf[js.Any], borderColorInputError = borderColorInputError.asInstanceOf[js.Any], borderColorInputErrorFocus = borderColorInputErrorFocus.asInstanceOf[js.Any], borderColorInputErrorHover = borderColorInputErrorHover.asInstanceOf[js.Any], borderColorInputFocus = borderColorInputFocus.asInstanceOf[js.Any], borderColorInputHover = borderColorInputHover.asInstanceOf[js.Any], borderColorModal = borderColorModal.asInstanceOf[js.Any], borderColorTable = borderColorTable.asInstanceOf[js.Any], borderColorTableCell = borderColorTableCell.asInstanceOf[js.Any], borderColorTableHead = borderColorTableHead.asInstanceOf[js.Any], borderColorTag = borderColorTag.asInstanceOf[js.Any], borderColorTagFocus = borderColorTagFocus.asInstanceOf[js.Any], borderRadiusBadge = borderRadiusBadge.asInstanceOf[js.Any], borderRadiusCircle = borderRadiusCircle.asInstanceOf[js.Any], borderRadiusLarge = borderRadiusLarge.asInstanceOf[js.Any], borderRadiusNormal = borderRadiusNormal.asInstanceOf[js.Any], borderRadiusSmall = borderRadiusSmall.asInstanceOf[js.Any], borderStyleCard = borderStyleCard.asInstanceOf[js.Any], borderStyleInput = borderStyleInput.asInstanceOf[js.Any], borderWidthCard = borderWidthCard.asInstanceOf[js.Any], borderWidthInput = borderWidthInput.asInstanceOf[js.Any], borderWidthInputFocus = borderWidthInputFocus.asInstanceOf[js.Any], boxShadowActionable = boxShadowActionable.asInstanceOf[js.Any], boxShadowButtonFocus = boxShadowButtonFocus.asInstanceOf[js.Any], boxShadowElevatedLevel1 = boxShadowElevatedLevel1.asInstanceOf[js.Any], boxShadowModal = boxShadowModal.asInstanceOf[js.Any], colorAlertIconCritical = colorAlertIconCritical.asInstanceOf[js.Any], colorAlertIconInfo = colorAlertIconInfo.asInstanceOf[js.Any], colorAlertIconSuccess = colorAlertIconSuccess.asInstanceOf[js.Any], colorAlertIconWarning = colorAlertIconWarning.asInstanceOf[js.Any], colorFormLabel = colorFormLabel.asInstanceOf[js.Any], colorFormLabelFilled = colorFormLabelFilled.asInstanceOf[js.Any], colorHeading = colorHeading.asInstanceOf[js.Any], colorHeadingInverted = colorHeadingInverted.asInstanceOf[js.Any], colorIconAttention = colorIconAttention.asInstanceOf[js.Any], colorIconCheckboxRadio = colorIconCheckboxRadio.asInstanceOf[js.Any], colorIconCheckboxRadioDisabled = colorIconCheckboxRadioDisabled.asInstanceOf[js.Any], colorIconCritical = colorIconCritical.asInstanceOf[js.Any], colorIconInfo = colorIconInfo.asInstanceOf[js.Any], colorIconInput = colorIconInput.asInstanceOf[js.Any], colorIconPrimary = colorIconPrimary.asInstanceOf[js.Any], colorIconRadioButton = colorIconRadioButton.asInstanceOf[js.Any], colorIconRadioButtonDisabled = colorIconRadioButtonDisabled.asInstanceOf[js.Any], colorIconSecondary = colorIconSecondary.asInstanceOf[js.Any], colorIconSuccess = colorIconSuccess.asInstanceOf[js.Any], colorIconTertiary = colorIconTertiary.asInstanceOf[js.Any], colorIconWarning = colorIconWarning.asInstanceOf[js.Any], colorInfoCheckBoxRadio = colorInfoCheckBoxRadio.asInstanceOf[js.Any], colorPlaceholderInput = colorPlaceholderInput.asInstanceOf[js.Any], colorPlaceholderInputError = colorPlaceholderInputError.asInstanceOf[js.Any], colorPlaceholderInputFile = colorPlaceholderInputFile.asInstanceOf[js.Any], colorPlaceholderInputFileError = colorPlaceholderInputFileError.asInstanceOf[js.Any], colorStopoverArrow = colorStopoverArrow.asInstanceOf[js.Any], colorTextAlertCritical = colorTextAlertCritical.asInstanceOf[js.Any], colorTextAlertInfo = colorTextAlertInfo.asInstanceOf[js.Any], colorTextAlertLink = colorTextAlertLink.asInstanceOf[js.Any], colorTextAlertSuccess = colorTextAlertSuccess.asInstanceOf[js.Any], colorTextAlertWarning = colorTextAlertWarning.asInstanceOf[js.Any], colorTextAttention = colorTextAttention.asInstanceOf[js.Any], colorTextBadgeCritical = colorTextBadgeCritical.asInstanceOf[js.Any], colorTextBadgeDark = colorTextBadgeDark.asInstanceOf[js.Any], colorTextBadgeInfo = colorTextBadgeInfo.asInstanceOf[js.Any], colorTextBadgeNeutral = colorTextBadgeNeutral.asInstanceOf[js.Any], colorTextBadgeSuccess = colorTextBadgeSuccess.asInstanceOf[js.Any], colorTextBadgeWarning = colorTextBadgeWarning.asInstanceOf[js.Any], colorTextBadgeWhite = colorTextBadgeWhite.asInstanceOf[js.Any], colorTextButtonCritical = colorTextButtonCritical.asInstanceOf[js.Any], colorTextButtonCriticalActive = colorTextButtonCriticalActive.asInstanceOf[js.Any], colorTextButtonCriticalBordered = colorTextButtonCriticalBordered.asInstanceOf[js.Any], colorTextButtonCriticalBorderedActive = colorTextButtonCriticalBorderedActive.asInstanceOf[js.Any], colorTextButtonCriticalBorderedHover = colorTextButtonCriticalBorderedHover.asInstanceOf[js.Any], colorTextButtonCriticalHover = colorTextButtonCriticalHover.asInstanceOf[js.Any], colorTextButtonFacebook = colorTextButtonFacebook.asInstanceOf[js.Any], colorTextButtonFacebookActive = colorTextButtonFacebookActive.asInstanceOf[js.Any], colorTextButtonFacebookBordered = colorTextButtonFacebookBordered.asInstanceOf[js.Any], colorTextButtonFacebookBorderedActive = colorTextButtonFacebookBorderedActive.asInstanceOf[js.Any], colorTextButtonFacebookBorderedHover = colorTextButtonFacebookBorderedHover.asInstanceOf[js.Any], colorTextButtonFacebookHover = colorTextButtonFacebookHover.asInstanceOf[js.Any], colorTextButtonFilled = colorTextButtonFilled.asInstanceOf[js.Any], colorTextButtonFilledActive = colorTextButtonFilledActive.asInstanceOf[js.Any], colorTextButtonFilledHover = colorTextButtonFilledHover.asInstanceOf[js.Any], colorTextButtonGoogle = colorTextButtonGoogle.asInstanceOf[js.Any], colorTextButtonGoogleActive = colorTextButtonGoogleActive.asInstanceOf[js.Any], colorTextButtonGoogleBordered = colorTextButtonGoogleBordered.asInstanceOf[js.Any], colorTextButtonGoogleBorderedActive = colorTextButtonGoogleBorderedActive.asInstanceOf[js.Any], colorTextButtonGoogleBorderedHover = colorTextButtonGoogleBorderedHover.asInstanceOf[js.Any], colorTextButtonGoogleHover = colorTextButtonGoogleHover.asInstanceOf[js.Any], colorTextButtonInfo = colorTextButtonInfo.asInstanceOf[js.Any], colorTextButtonInfoActive = colorTextButtonInfoActive.asInstanceOf[js.Any], colorTextButtonInfoBordered = colorTextButtonInfoBordered.asInstanceOf[js.Any], colorTextButtonInfoBorderedActive = colorTextButtonInfoBorderedActive.asInstanceOf[js.Any], colorTextButtonInfoBorderedHover = colorTextButtonInfoBorderedHover.asInstanceOf[js.Any], colorTextButtonInfoHover = colorTextButtonInfoHover.asInstanceOf[js.Any], colorTextButtonLinkPrimary = colorTextButtonLinkPrimary.asInstanceOf[js.Any], colorTextButtonLinkPrimaryActive = colorTextButtonLinkPrimaryActive.asInstanceOf[js.Any], colorTextButtonLinkPrimaryHover = colorTextButtonLinkPrimaryHover.asInstanceOf[js.Any], colorTextButtonLinkSecondary = colorTextButtonLinkSecondary.asInstanceOf[js.Any], colorTextButtonLinkSecondaryActive = colorTextButtonLinkSecondaryActive.asInstanceOf[js.Any], colorTextButtonLinkSecondaryHover = colorTextButtonLinkSecondaryHover.asInstanceOf[js.Any], colorTextButtonPrimary = colorTextButtonPrimary.asInstanceOf[js.Any], colorTextButtonPrimaryActive = colorTextButtonPrimaryActive.asInstanceOf[js.Any], colorTextButtonPrimaryBordered = colorTextButtonPrimaryBordered.asInstanceOf[js.Any], colorTextButtonPrimaryBorderedActive = colorTextButtonPrimaryBorderedActive.asInstanceOf[js.Any], colorTextButtonPrimaryBorderedHover = colorTextButtonPrimaryBorderedHover.asInstanceOf[js.Any], colorTextButtonPrimaryHover = colorTextButtonPrimaryHover.asInstanceOf[js.Any], colorTextButtonSecondary = colorTextButtonSecondary.asInstanceOf[js.Any], colorTextButtonSecondaryActive = colorTextButtonSecondaryActive.asInstanceOf[js.Any], colorTextButtonSecondaryBordered = colorTextButtonSecondaryBordered.asInstanceOf[js.Any], colorTextButtonSecondaryBorderedActive = colorTextButtonSecondaryBorderedActive.asInstanceOf[js.Any], colorTextButtonSecondaryBorderedHover = colorTextButtonSecondaryBorderedHover.asInstanceOf[js.Any], colorTextButtonSecondaryHover = colorTextButtonSecondaryHover.asInstanceOf[js.Any], colorTextButtonSuccess = colorTextButtonSuccess.asInstanceOf[js.Any], colorTextButtonSuccessActive = colorTextButtonSuccessActive.asInstanceOf[js.Any], colorTextButtonSuccessBordered = colorTextButtonSuccessBordered.asInstanceOf[js.Any], colorTextButtonSuccessBorderedActive = colorTextButtonSuccessBorderedActive.asInstanceOf[js.Any], colorTextButtonSuccessBorderedHover = colorTextButtonSuccessBorderedHover.asInstanceOf[js.Any], colorTextButtonSuccessHover = colorTextButtonSuccessHover.asInstanceOf[js.Any], colorTextButtonWarning = colorTextButtonWarning.asInstanceOf[js.Any], colorTextButtonWarningActive = colorTextButtonWarningActive.asInstanceOf[js.Any], colorTextButtonWarningBordered = colorTextButtonWarningBordered.asInstanceOf[js.Any], colorTextButtonWarningBorderedActive = colorTextButtonWarningBorderedActive.asInstanceOf[js.Any], colorTextButtonWarningBorderedHover = colorTextButtonWarningBorderedHover.asInstanceOf[js.Any], colorTextButtonWarningHover = colorTextButtonWarningHover.asInstanceOf[js.Any], colorTextButtonWhite = colorTextButtonWhite.asInstanceOf[js.Any], colorTextButtonWhiteActive = colorTextButtonWhiteActive.asInstanceOf[js.Any], colorTextButtonWhiteBordered = colorTextButtonWhiteBordered.asInstanceOf[js.Any], colorTextButtonWhiteBorderedActive = colorTextButtonWhiteBorderedActive.asInstanceOf[js.Any], colorTextButtonWhiteBorderedHover = colorTextButtonWhiteBorderedHover.asInstanceOf[js.Any], colorTextButtonWhiteHover = colorTextButtonWhiteHover.asInstanceOf[js.Any], colorTextCritical = colorTextCritical.asInstanceOf[js.Any], colorTextError = colorTextError.asInstanceOf[js.Any], colorTextInfo = colorTextInfo.asInstanceOf[js.Any], colorTextInput = colorTextInput.asInstanceOf[js.Any], colorTextInputDisabled = colorTextInputDisabled.asInstanceOf[js.Any], colorTextInputPrefix = colorTextInputPrefix.asInstanceOf[js.Any], colorTextLinkPrimary = colorTextLinkPrimary.asInstanceOf[js.Any], colorTextLinkPrimaryHover = colorTextLinkPrimaryHover.asInstanceOf[js.Any], colorTextLinkSecondary = colorTextLinkSecondary.asInstanceOf[js.Any], colorTextLinkSecondaryHover = colorTextLinkSecondaryHover.asInstanceOf[js.Any], colorTextLoading = colorTextLoading.asInstanceOf[js.Any], colorTextPrimary = colorTextPrimary.asInstanceOf[js.Any], colorTextSecondary = colorTextSecondary.asInstanceOf[js.Any], colorTextSuccess = colorTextSuccess.asInstanceOf[js.Any], colorTextTable = colorTextTable.asInstanceOf[js.Any], colorTextTag = colorTextTag.asInstanceOf[js.Any], colorTextTagSelected = colorTextTagSelected.asInstanceOf[js.Any], colorTextWarning = colorTextWarning.asInstanceOf[js.Any], colorTextWhite = colorTextWhite.asInstanceOf[js.Any], durationFast = durationFast.asInstanceOf[js.Any])
