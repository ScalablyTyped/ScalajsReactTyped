package typingsJapgolly.kakaomaps

import typingsJapgolly.kakaomaps.kakao.maps.LatLng
import typingsJapgolly.kakaomaps.kakao.maps.LatLngBounds
import typingsJapgolly.kakaomaps.kakao.maps.Map
import typingsJapgolly.kakaomaps.kakao.maps.MarkerImage
import typingsJapgolly.kakaomaps.kakao.maps.Point
import typingsJapgolly.kakaomaps.kakao.maps.Roadview
import typingsJapgolly.kakaomaps.kakao.maps.Size
import typingsJapgolly.kakaomaps.kakao.maps.Viewpoint
import typingsJapgolly.kakaomaps.kakao.maps.services.AnalyzeType
import typingsJapgolly.kakaomaps.kakao.maps.services.Coords
import typingsJapgolly.kakaomaps.kakao.maps.services.SortBy
...
object anon {
  ...
  trait DrawingManager extends StObject {
    ...
    var drawingManager: js.UndefOr[typingsJapgolly.kakaomaps.kakao.maps.drawing.DrawingManager] = js.undefined
  }
  object DrawingManager {
    ...
    extension [Self <: DrawingManager](x: Self) {
      ...
      inline def setDrawingManager(value: typingsJapgolly.kakaomaps.kakao.maps.drawing.DrawingManager): Self = StObject.set(x, "drawingManager", value.asInstanceOf[js.Any])
