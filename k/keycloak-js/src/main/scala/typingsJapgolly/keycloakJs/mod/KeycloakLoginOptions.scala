...
import typingsJapgolly.keycloakJs.keycloakJsStrings.login
import typingsJapgolly.keycloakJs.keycloakJsStrings.none
import typingsJapgolly.keycloakJs.keycloakJsStrings.register
