...
import typingsJapgolly.keycloakJs.keycloakJsStrings.cancelled
import typingsJapgolly.keycloakJs.keycloakJsStrings.error
import typingsJapgolly.keycloakJs.keycloakJsStrings.success
