...
import typingsJapgolly.keycloakJs.keycloakJsStrings.`cordova-native`
import typingsJapgolly.keycloakJs.keycloakJsStrings.cordova
...
trait KeycloakInitOptions extends StObject {
  ...
  var adapter: js.UndefOr[
    typingsJapgolly.keycloakJs.keycloakJsStrings.default | cordova | `cordova-native` | KeycloakAdapter
  ] = js.undefined
...
object KeycloakInitOptions {
  ...
  extension [Self <: KeycloakInitOptions](x: Self) {
    ...
    inline def setAdapter(
      value: typingsJapgolly.keycloakJs.keycloakJsStrings.default | cordova | `cordova-native` | KeycloakAdapter
