...
import typingsJapgolly.keycloakJs.mod.KeycloakConfig
import typingsJapgolly.keycloakJs.mod.default
...
object global {
  ...
  object Keycloak {
    ...
    @JSGlobal("Keycloak")
    @js.native
    def apply(): typingsJapgolly.keycloakJs.mod.Keycloak = js.native
    @JSGlobal("Keycloak")
    @js.native
    def apply(config: String): typingsJapgolly.keycloakJs.mod.Keycloak = js.native
    @JSGlobal("Keycloak")
    @js.native
    def apply(config: KeycloakConfig): typingsJapgolly.keycloakJs.mod.Keycloak = js.native
  }
}
