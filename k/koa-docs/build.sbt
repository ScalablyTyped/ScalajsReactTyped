...
name := "koa-docs"
version := "2.1-dt-20191104Z-1b8a4f"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "co-body" % "0.0-unknown-dt-20200226Z-f1b331",
  ...
  "org.scalablytyped.japgolly" %%% "koa-joi-router" % "5.2-dt-20191107Z-a6e048",
  ...
  "org.scalablytyped.japgolly" %%% "qs" % "6.9-dt-20200225Z-a64618",
