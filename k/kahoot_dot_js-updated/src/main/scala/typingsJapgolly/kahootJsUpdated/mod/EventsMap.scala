...
trait EventsMap extends StObject {
  ...
  var NameAccept: typingsJapgolly.kahootJsUpdated.mod.NameAccept
  
  var Podium: typingsJapgolly.kahootJsUpdated.mod.Podium
  
  var QuestionEnd: typingsJapgolly.kahootJsUpdated.mod.QuestionEnd
  
  var QuestionReady: typingsJapgolly.kahootJsUpdated.mod.QuestionReady
  
  var QuestionStart: typingsJapgolly.kahootJsUpdated.mod.QuestionStart
  
  var QuizEnd: typingsJapgolly.kahootJsUpdated.mod.QuizEnd
  
  var QuizStart: typingsJapgolly.kahootJsUpdated.mod.QuizStart
  
  var RecoveryData: typingsJapgolly.kahootJsUpdated.mod.RecoveryData
  
  var TeamAccept: typingsJapgolly.kahootJsUpdated.mod.TeamAccept
  
  var TeamTalk: typingsJapgolly.kahootJsUpdated.mod.TeamTalk
  
  var TimeOver: typingsJapgolly.kahootJsUpdated.mod.TimeOver
