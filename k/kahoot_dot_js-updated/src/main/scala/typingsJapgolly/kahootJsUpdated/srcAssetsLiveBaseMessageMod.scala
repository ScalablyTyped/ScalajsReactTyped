...
object srcAssetsLiveBaseMessageMod {
  ...
  open class ^ protected ()
    ...
    def this(client: typingsJapgolly.kahootJsUpdated.mod.^, channel: String) = this()
    def this(client: typingsJapgolly.kahootJsUpdated.mod.^, channel: String, data: Any) = this()
