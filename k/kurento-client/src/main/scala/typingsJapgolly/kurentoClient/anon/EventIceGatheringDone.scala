...
trait EventIceGatheringDone extends StObject {
  ...
  var `type`: IceGatheringDone
}
object EventIceGatheringDone {
  
  inline def apply(source: String, tags: js.Array[Tag], timestamp: String, timestampMillis: String): EventIceGatheringDone = {
    ...
    __obj.updateDynamic("type")("IceGatheringDone")
  ...
  extension [Self <: EventIceGatheringDone](x: Self) {
    ...
    inline def setType(value: IceGatheringDone): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
