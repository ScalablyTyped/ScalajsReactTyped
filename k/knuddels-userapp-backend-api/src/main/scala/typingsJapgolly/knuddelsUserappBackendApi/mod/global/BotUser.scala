...
import typingsJapgolly.knuddelsUserappBackendApi.anon.DisplayReasonText
import typingsJapgolly.knuddelsUserappBackendApi.anon.OnError
...
- typingsJapgolly.knuddelsUserappBackendApi.mod._KnuddelsJsonData because Already inherited
- typingsJapgolly.knuddelsUserappBackendApi.mod._KnuddelsSerializable because Already inherited */ @JSGlobal("BotUser")
@js.native
