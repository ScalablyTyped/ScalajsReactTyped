package typingsJapgolly.knockoutMapping

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.knockoutMapping.anon.Copy
import typingsJapgolly.knockoutMapping.mod.global.KnockoutMapping
...
object mod extends Shortcut {
  ...
  object global {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.knockoutMapping.mod.global.KnockoutMappingSpecificOptions[T]
      - typingsJapgolly.knockoutMapping.mod.global.KnockoutMappingStandardOptions
    */
    ...
    object KnockoutPropertyMappingCallBack {
      ...
      extension [Self <: KnockoutPropertyMappingCallBack](x: Self) {
        ...
        inline def setCreate(value: /* options */ KnockoutMappingCreateOptions => Callback): Self = StObject.set(x, "create", js.Any.fromFunction1((t0: /* options */ KnockoutMappingCreateOptions) => value(t0).runNow()))
        ...
        inline def setUpdate(value: /* options */ KnockoutMappingUpdateOptions => Callback): Self = StObject.set(x, "update", js.Any.fromFunction1((t0: /* options */ KnockoutMappingUpdateOptions) => value(t0).runNow()))
