...
import typingsJapgolly.koaBetterBody.anon.Custom
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setHandler(
        value: (/* ctx */ ParameterizedContext[DefaultState, DefaultContext, Any], Options, /* next */ Next) => Callback
      ): Self = StObject.set(x, "handler", js.Any.fromFunction3((t0: /* ctx */ ParameterizedContext[DefaultState, DefaultContext, Any], t1: Options, t2: /* next */ Next) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnError(
        value: (/* err */ Any, /* ctx */ ParameterizedContext[DefaultState, DefaultContext, Any]) => Callback
      ): Self = StObject.set(x, "onError", js.Any.fromFunction2((t0: /* err */ Any, t1: /* ctx */ ParameterizedContext[DefaultState, DefaultContext, Any]) => (value(t0, t1)).runNow()))
