...
object katexStrings {
  ...
  @js.native
  sealed trait DollarDollar extends StObject
  ...
  @js.native
  sealed trait htmlAndMathml extends StObject
  inline def htmlAndMathml: htmlAndMathml = "htmlAndMathml".asInstanceOf[htmlAndMathml]
