...
import typingsJapgolly.katex.katexStrings.html
import typingsJapgolly.katex.katexStrings.htmlAndMathml
import typingsJapgolly.katex.katexStrings.mathml
...
object mod {
  ...
  open class default ()
    extends StObject
       with typingsJapgolly.katex.mod.katex
  /* static members */
  object default {
