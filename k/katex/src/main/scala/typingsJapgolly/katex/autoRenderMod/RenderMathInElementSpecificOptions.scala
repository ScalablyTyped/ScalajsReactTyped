...
object RenderMathInElementSpecificOptions {
  ...
  def apply(
    ...
    errorCallback: (/* msg */ String, /* err */ js.Error) => Callback = null,
    ...
    if (errorCallback != null) __obj.updateDynamic("errorCallback")(js.Any.fromFunction2((t0: /* msg */ java.lang.String, t1: /* err */ js.Error) => errorCallback(t0, t1).runNow()))
