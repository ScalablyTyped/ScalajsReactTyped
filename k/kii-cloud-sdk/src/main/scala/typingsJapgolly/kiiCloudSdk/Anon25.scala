...
object Anon25 {
  ...
  def apply(
    ...
    success: (KiiPushSubscription, KiiTopic, Boolean) => CallbackTo[js.Any]
  ): Anon25 = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("failure")(js.Any.fromFunction1((t0: js.Error) => failure(t0).runNow()))
    __obj.updateDynamic("success")(js.Any.fromFunction3((t0: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiPushSubscription, t1: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic, t2: scala.Boolean) => success(t0, t1, t2).runNow()))
