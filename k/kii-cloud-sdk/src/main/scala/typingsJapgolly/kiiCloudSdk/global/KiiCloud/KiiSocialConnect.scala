...
import typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialConnectOptions
import typingsJapgolly.kiiCloudSdk.anon.`36`
...
open class KiiSocialConnect ()
  extends StObject
     with typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialConnect
object KiiSocialConnect {
  ...
  /**
    ...
    */
  /* static member */
  inline def getAccessTokenExpirationForNetwork(networkName: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialNetworkName): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getAccessTokenExpirationForNetwork")(networkName.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  /**
    ...
    */
  /* static member */
  inline def getAccessTokenForNetwork(networkName: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialNetworkName): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getAccessTokenForNetwork")(networkName.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  /**
    ...
    */
  /* static member */
  inline def getAccessTokenObjectForNetwork(networkName: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialNetworkName): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getAccessTokenObjectForNetwork")(networkName.asInstanceOf[js.Any]).asInstanceOf[Any]
  ...
  inline def linkCurrentUserWithNetwork(
    networkName: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialNetworkName,
    options: KiiSocialConnectOptions
  ): js.Promise[
    js.Tuple2[
      typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser, 
      typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialNetworkName
    ]
  ...
  /**
    ...
    */
  /* static member */
  inline def unLinkCurrentUserFromNetwork(networkName: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialNetworkName): js.Promise[
    js.Tuple2[
      typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser, 
      typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialNetworkName
    ]
  ...
  inline def unLinkCurrentUserFromNetwork(networkName: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialNetworkName, callbacks: `36`): js.Promise[
    js.Tuple2[
      typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser, 
      typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSocialNetworkName
    ]
