...
import typingsJapgolly.kiiCloudSdk.anon.`34`
import typingsJapgolly.kiiCloudSdk.anon.`35`
...
open class Kii ()
  extends StObject
     with typingsJapgolly.kiiCloudSdk.KiiCloud.Kii
object Kii {
  ...
  /**
    ...
    */
  /* static member */
  inline def authenticateAsAppAdmin(clientId: String, clientSecret: String): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiAppAdminContext] = (^.asInstanceOf[js.Dynamic].applyDynamic("authenticateAsAppAdmin")(clientId.asInstanceOf[js.Any], clientSecret.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiAppAdminContext]]
  inline def authenticateAsAppAdmin(clientId: String, clientSecret: String, callbacks: `34`): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiAppAdminContext] = (^.asInstanceOf[js.Dynamic].applyDynamic("authenticateAsAppAdmin")(clientId.asInstanceOf[js.Any], clientSecret.asInstanceOf[js.Any], callbacks.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiAppAdminContext]]
  ...
  /**
    ...
    */
  /* static member */
  inline def authenticateAsThing(vendorThingID: String, password: String): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThingContext] = (^.asInstanceOf[js.Dynamic].applyDynamic("authenticateAsThing")(vendorThingID.asInstanceOf[js.Any], password.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThingContext]]
  inline def authenticateAsThing(vendorThingID: String, password: String, callbacks: `35`): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThingContext] = (^.asInstanceOf[js.Dynamic].applyDynamic("authenticateAsThing")(vendorThingID.asInstanceOf[js.Any], password.asInstanceOf[js.Any], callbacks.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThingContext]]
  ...
  /**
    ...
    */
  /* static member */
  inline def authenticateAsThingWithToken(thingID: String, token: String): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThingContext] = (^.asInstanceOf[js.Dynamic].applyDynamic("authenticateAsThingWithToken")(thingID.asInstanceOf[js.Any], token.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThingContext]]
  inline def authenticateAsThingWithToken(thingID: String, token: String, callbacks: `35`): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThingContext] = (^.asInstanceOf[js.Dynamic].applyDynamic("authenticateAsThingWithToken")(thingID.asInstanceOf[js.Any], token.asInstanceOf[js.Any], callbacks.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThingContext]]
  ...
  /**
    ...
    */
  /* static member */
  inline def bucketWithName(bucketName: String): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiBucket = ^.asInstanceOf[js.Dynamic].applyDynamic("bucketWithName")(bucketName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiBucket]
  ...
  /**
    ...
    */
  /* static member */
  inline def encryptedBucketWithName(bucketName: String): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiBucket = ^.asInstanceOf[js.Dynamic].applyDynamic("encryptedBucketWithName")(bucketName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiBucket]
  ...
  /**
    ...
    */
  /* static member */
  inline def groupWithName(groupName: String): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup = ^.asInstanceOf[js.Dynamic].applyDynamic("groupWithName")(groupName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup]
  ...
  /**
    ...
    */
  /* static member */
  inline def groupWithNameAndMembers(groupName: String, members: js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser]): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("groupWithNameAndMembers")(groupName.asInstanceOf[js.Any], members.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup]
  ...
  /**
    ...
    */
  /* static member */
  inline def initializeWithSite(appID: String, appKey: String, site: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSite): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("initializeWithSite")(appID.asInstanceOf[js.Any], appKey.asInstanceOf[js.Any], site.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def initializeWithSite(
    appID: String,
    appKey: String,
    site: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiSite,
    analyticsOption: Any
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("initializeWithSite")(appID.asInstanceOf[js.Any], appKey.asInstanceOf[js.Any], site.asInstanceOf[js.Any], analyticsOption.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def listTopics(): js.Promise[js.Tuple2[js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic], String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listTopics")().asInstanceOf[js.Promise[js.Tuple2[js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic], String]]]
  inline def listTopics(callbacks: Unit, paginationKey: String): js.Promise[js.Tuple2[js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic], String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("listTopics")(callbacks.asInstanceOf[js.Any], paginationKey.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Tuple2[js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic], String]]]
  inline def listTopics(callbacks: `4`): js.Promise[js.Tuple2[js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic], String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listTopics")(callbacks.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Tuple2[js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic], String]]]
  inline def listTopics(callbacks: `4`, paginationKey: String): js.Promise[js.Tuple2[js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic], String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("listTopics")(callbacks.asInstanceOf[js.Any], paginationKey.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Tuple2[js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic], String]]]
  ...
  /**
    ...
    */
  /* static member */
  inline def serverCodeEntry(entryName: String): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiServerCodeEntry = ^.asInstanceOf[js.Dynamic].applyDynamic("serverCodeEntry")(entryName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiServerCodeEntry]
  ...
  /**
    ...
    */
  /* static member */
  inline def serverCodeEntryWithVersion(entryName: String, version: String): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiServerCodeEntry = (^.asInstanceOf[js.Dynamic].applyDynamic("serverCodeEntryWithVersion")(entryName.asInstanceOf[js.Any], version.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiServerCodeEntry]
  ...
  /**
    ...
    */
  /* static member */
  inline def topicWithName(topicName: String): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic = ^.asInstanceOf[js.Dynamic].applyDynamic("topicWithName")(topicName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiTopic]
}
