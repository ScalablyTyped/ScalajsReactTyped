...
open class KiiObject ()
  extends StObject
     with typingsJapgolly.kiiCloudSdk.KiiCloud.KiiObject
object KiiObject {
  ...
  /**
    ...
    */
  /* static member */
  inline def objectWithURI(uri: String): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiObject = ^.asInstanceOf[js.Dynamic].applyDynamic("objectWithURI")(uri.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiObject]
}
