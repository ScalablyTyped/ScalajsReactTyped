...
open class KiiQuery ()
  extends StObject
     with typingsJapgolly.kiiCloudSdk.KiiCloud.KiiQuery {
...
object KiiQuery {
  ...
  /**
    ...
    */
  /* static member */
  inline def queryWithClause(clause: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiClause): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiQuery = ^.asInstanceOf[js.Dynamic].applyDynamic("queryWithClause")(clause.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiQuery]
}
