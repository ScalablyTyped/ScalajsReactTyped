...
import typingsJapgolly.kiiCloudSdk.KiiCloud.KiiACLSubject
...
open class KiiACLEntry ()
  extends StObject
     with typingsJapgolly.kiiCloudSdk.KiiCloud.KiiACLEntry {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getAction(): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiACLAction = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setAction(value: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiACLAction): Unit = js.native
...
object KiiACLEntry {
  ...
  /**
    ...
    */
  /* static member */
  inline def entryWithSubject(Subject: KiiACLSubject, action: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiACLAction): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiACLEntry = (^.asInstanceOf[js.Dynamic].applyDynamic("entryWithSubject")(Subject.asInstanceOf[js.Any], action.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiACLEntry]
}
