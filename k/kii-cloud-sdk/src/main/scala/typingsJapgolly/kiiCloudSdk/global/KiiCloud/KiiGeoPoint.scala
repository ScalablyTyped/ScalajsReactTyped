...
open class KiiGeoPoint ()
  extends StObject
     with typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGeoPoint {
...
object KiiGeoPoint {
  ...
  /**
    ...
    */
  /* static member */
  inline def geoPoint(latitude: Double, longitude: Double): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGeoPoint = (^.asInstanceOf[js.Dynamic].applyDynamic("geoPoint")(latitude.asInstanceOf[js.Any], longitude.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGeoPoint]
}
