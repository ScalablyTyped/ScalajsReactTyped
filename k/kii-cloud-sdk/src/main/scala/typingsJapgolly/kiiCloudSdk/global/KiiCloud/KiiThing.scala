...
import typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThingFields
...
open class KiiThing ()
  extends StObject
     with typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing
object KiiThing {
  ...
  /**
    ...
    */
  /* static member */
  inline def loadWithThingID(thingID: String): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadWithThingID")(thingID.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing]]
  inline def loadWithThingID(thingID: String, callbacks: `1`): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing] = (^.asInstanceOf[js.Dynamic].applyDynamic("loadWithThingID")(thingID.asInstanceOf[js.Any], callbacks.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing]]
  ...
  /**
    ...
    */
  /* static member */
  inline def loadWithVendorThingID(vendorThingID: String): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadWithVendorThingID")(vendorThingID.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing]]
  inline def loadWithVendorThingID(vendorThingID: String, callbacks: `1`): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing] = (^.asInstanceOf[js.Dynamic].applyDynamic("loadWithVendorThingID")(vendorThingID.asInstanceOf[js.Any], callbacks.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing]]
  ...
  /**
    ...
    */
  /* static member */
  inline def register(fields: KiiThingFields): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing] = ^.asInstanceOf[js.Dynamic].applyDynamic("register")(fields.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing]]
  inline def register(fields: KiiThingFields, callbacks: `1`): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing] = (^.asInstanceOf[js.Dynamic].applyDynamic("register")(fields.asInstanceOf[js.Any], callbacks.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiThing]]
  
  inline def registerOwnerWithThingID(thingID: String, owner: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("registerOwnerWithThingID")(thingID.asInstanceOf[js.Any], owner.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup]]
  inline def registerOwnerWithThingID(thingID: String, owner: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup, callbacks: `3`): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("registerOwnerWithThingID")(thingID.asInstanceOf[js.Any], owner.asInstanceOf[js.Any], callbacks.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup]]
  /**
    ...
    */
  /* static member */
  inline def registerOwnerWithThingID(thingID: String, owner: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser] = (^.asInstanceOf[js.Dynamic].applyDynamic("registerOwnerWithThingID")(thingID.asInstanceOf[js.Any], owner.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser]]
  inline def registerOwnerWithThingID(thingID: String, owner: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser, callbacks: `2`): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser] = (^.asInstanceOf[js.Dynamic].applyDynamic("registerOwnerWithThingID")(thingID.asInstanceOf[js.Any], owner.asInstanceOf[js.Any], callbacks.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser]]
  
  inline def registerOwnerWithVendorThingID(vendorThingID: String, owner: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("registerOwnerWithVendorThingID")(vendorThingID.asInstanceOf[js.Any], owner.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup]]
  inline def registerOwnerWithVendorThingID(vendorThingID: String, owner: typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup, callbacks: `3`): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("registerOwnerWithVendorThingID")(vendorThingID.asInstanceOf[js.Any], owner.asInstanceOf[js.Any], callbacks.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup]]
  /**
    * Register user/group as owner of specified thing.
    * <br>Need user login before execute this API.
    * <br>Note: if you obtain thing instance from {@link KiiAppAdminContext},
