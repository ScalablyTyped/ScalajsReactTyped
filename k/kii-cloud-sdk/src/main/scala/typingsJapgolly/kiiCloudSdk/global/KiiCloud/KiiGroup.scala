...
import typingsJapgolly.kiiCloudSdk.anon.`10`
...
open class KiiGroup ()
  extends StObject
     with typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup
object KiiGroup {
  ...
  /**
    ...
    */
  /* static member */
  inline def groupWithID(groupId: String): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup = ^.asInstanceOf[js.Dynamic].applyDynamic("groupWithID")(groupId.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup]
  ...
  /**
    ...
    */
  /* static member */
  inline def groupWithURI(uri: String): typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup = ^.asInstanceOf[js.Dynamic].applyDynamic("groupWithURI")(uri.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup]
  ...
  inline def registerGroupWithID(
    groupID: String,
    groupName: String,
    members: js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser]
  ): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("registerGroupWithID")(groupID.asInstanceOf[js.Any], groupName.asInstanceOf[js.Any], members.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup]]
  inline def registerGroupWithID(
    groupID: String,
    groupName: String,
    members: js.Array[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiUser],
    callbacks: `10`
  ): js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("registerGroupWithID")(groupID.asInstanceOf[js.Any], groupName.asInstanceOf[js.Any], members.asInstanceOf[js.Any], callbacks.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.kiiCloudSdk.KiiCloud.KiiGroup]]
}
