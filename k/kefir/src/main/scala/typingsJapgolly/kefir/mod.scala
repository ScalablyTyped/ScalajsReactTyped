...
import typingsJapgolly.kefir.anon.Ap
import typingsJapgolly.kefir.anon.Convert
import typingsJapgolly.kefir.anon.ConvertValue
import typingsJapgolly.kefir.anon.FlushOnChange
import typingsJapgolly.kefir.anon.FlushOnEnd
import typingsJapgolly.kefir.anon.Fn0
import typingsJapgolly.kefir.anon.Fn1
import typingsJapgolly.kefir.anon.FnCall
import typingsJapgolly.kefir.anon.FnCallError
import typingsJapgolly.kefir.anon.FnCallFn
import typingsJapgolly.kefir.anon.FnCallGenerator
import typingsJapgolly.kefir.anon.FnCallIntervalFn
import typingsJapgolly.kefir.anon.FnCallIntervalHandler
import typingsJapgolly.kefir.anon.FnCallIntervalValues
import typingsJapgolly.kefir.anon.FnCallObservable
import typingsJapgolly.kefir.anon.FnCallObss
import typingsJapgolly.kefir.anon.FnCallObssObssPCombinator
import typingsJapgolly.kefir.anon.FnCallObssPassiveObssCombinator
import typingsJapgolly.kefir.anon.FnCallPromise
import typingsJapgolly.kefir.anon.FnCallSubscribe
import typingsJapgolly.kefir.anon.FnCallTargetEventNameTransform
import typingsJapgolly.kefir.anon.FnCallValue
import typingsJapgolly.kefir.anon.Immediate
import typingsJapgolly.kefir.anon.Leading
import typingsJapgolly.kefir.anon.Off
import typingsJapgolly.kefir.anon.Unsubscribe
...
object mod {
  ...
  object default {
    ...
    @js.native
    def Observable: Instantiable0[typingsJapgolly.kefir.mod.Observable[js.Object, js.Object]] = js.native
    ...
    @JSImport("kefir", "default.Pool")
    @js.native
    def Pool_ : Instantiable0[typingsJapgolly.kefir.mod.Pool_[js.Object, js.Object]] = js.native
    ...
    @js.native
    def Property: Instantiable0[typingsJapgolly.kefir.mod.Property[js.Object, js.Object]] = js.native
    ...
    @JSImport("kefir", "default.Stream")
    @js.native
    def Stream_ : Instantiable0[typingsJapgolly.kefir.mod.Stream_[js.Object, js.Object]] = js.native
    ...
    @js.native
    def staticLand: typingsJapgolly.kefir.anon.Observable = js.native
    inline def staticLand_=(x: typingsJapgolly.kefir.anon.Observable): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("staticLand")(x.asInstanceOf[js.Any])
  ...
  object Emitter {
    ...
    inline def apply[V, E](
      ...
      val __obj = js.Dynamic.literal(emit = js.Any.fromFunction1(emit), emitEvent = js.Any.fromFunction1(emitEvent), end = end.toJsFn, error = js.Any.fromFunction1(error), event = js.Any.fromFunction1(event), value = js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.kefir.anon.Type[V]
    - typingsJapgolly.kefir.anon.Value[E]
    - typingsJapgolly.kefir.anon.TypeValue
  */
  trait Event[V, E] extends StObject
  object Event {
    
    inline def Type[V](value: V): typingsJapgolly.kefir.anon.Type[V] = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("value")
      __obj.asInstanceOf[typingsJapgolly.kefir.anon.Type[V]]
    }
    
    inline def TypeValue(value: Unit): typingsJapgolly.kefir.anon.TypeValue = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("end")
      __obj.asInstanceOf[typingsJapgolly.kefir.anon.TypeValue]
    }
    
    inline def Value[E](value: E): typingsJapgolly.kefir.anon.Value[E] = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("error")
      __obj.asInstanceOf[typingsJapgolly.kefir.anon.Value[E]]
    }
  }
  ...
  object Observer {
    ...
    extension [Self <: Observer[?, ?], T, S](x: Self & (Observer[T, S])) {
      ...
      inline def setError(value: /* error */ S => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* error */ S) => value(t0).runNow()))
      
      inline def setErrorUndefined: Self = StObject.set(x, "error", js.undefined)
      
      inline def setValue(value: /* value */ T => Callback): Self = StObject.set(x, "value", js.Any.fromFunction1((t0: /* value */ T) => value(t0).runNow()))
