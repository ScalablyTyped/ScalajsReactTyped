...
import typingsJapgolly.kamailioKemi.kamailioKemiStrings.crit
import typingsJapgolly.kamailioKemi.kamailioKemiStrings.warn
import typingsJapgolly.kamailioKemi.mod.KamailioKemi.Flag
import typingsJapgolly.kamailioKemi.mod.global.KSR.^
...
inline def log(
  level: typingsJapgolly.kamailioKemi.kamailioKemiStrings.dbg | typingsJapgolly.kamailioKemi.kamailioKemiStrings.info | warn | crit | typingsJapgolly.kamailioKemi.kamailioKemiStrings.err,
  msg: String
