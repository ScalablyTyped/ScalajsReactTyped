...
object x {
  ...
  inline def modf(name: String, params: String*): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("modf")(scala.List(name.asInstanceOf[js.Any]).`++`(params.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Double]
}
