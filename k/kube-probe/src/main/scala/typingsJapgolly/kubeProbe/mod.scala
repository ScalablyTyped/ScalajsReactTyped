...
import typingsJapgolly.overloadProtection.mod.ProtectionConfig
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setLivenessCallback(value: Callback): Self = StObject.set(x, "livenessCallback", value.toJsFn)
      ...
      inline def setReadinessCallback(value: Callback): Self = StObject.set(x, "readinessCallback", value.toJsFn)
