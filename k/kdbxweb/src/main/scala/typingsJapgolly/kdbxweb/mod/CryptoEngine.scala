...
object CryptoEngine extends js.Object {
  ...
  def configure(newSubtle: typingsJapgolly.std.SubtleCrypto): Unit = js.native
  def configure(newSubtle: typingsJapgolly.std.SubtleCrypto, newWebCrypto: Null, newNodeCrypto: Crypto_): Unit = js.native
  def configure(newSubtle: typingsJapgolly.std.SubtleCrypto, newWebCrypto: Crypto_): Unit = js.native
  def configure(newSubtle: typingsJapgolly.std.SubtleCrypto, newWebCrypto: Crypto_, newNodeCrypto: Crypto_): Unit = js.native
