...
import typingsJapgolly.kdbxweb.distTypesFormatKdbxBinariesMod.KdbxBinaryOrRef
...
object XmlUtils {
  ...
  inline def getProtectedText(node: Node): js.UndefOr[typingsJapgolly.kdbxweb.distTypesCryptoProtectedValueMod.ProtectedValue | String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getProtectedText")(node.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.kdbxweb.distTypesCryptoProtectedValueMod.ProtectedValue | String]]
  ...
  inline def getUuid(node: Node): js.UndefOr[typingsJapgolly.kdbxweb.distTypesFormatKdbxUuidMod.KdbxUuid] = ^.asInstanceOf[js.Dynamic].applyDynamic("getUuid")(node.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.kdbxweb.distTypesFormatKdbxUuidMod.KdbxUuid]]
  ...
  inline def setProtectedText(node: Node, text: typingsJapgolly.kdbxweb.distTypesCryptoProtectedValueMod.ProtectedValue): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setProtectedText")(node.asInstanceOf[js.Any], text.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def setProtectedValues(
    node: Node,
    protectSaltGenerator: typingsJapgolly.kdbxweb.distTypesCryptoProtectSaltGeneratorMod.ProtectSaltGenerator
  ...
  inline def setUuid(node: Node, uuid: typingsJapgolly.kdbxweb.distTypesFormatKdbxUuidMod.KdbxUuid): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setUuid")(node.asInstanceOf[js.Any], uuid.asInstanceOf[js.Any])).asInstanceOf[Unit]
