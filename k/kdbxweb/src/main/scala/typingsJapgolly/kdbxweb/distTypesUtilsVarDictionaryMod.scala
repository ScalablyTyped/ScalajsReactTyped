...
import typingsJapgolly.kdbxweb.distTypesUtilsInt64Mod.Int64
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distTypesUtilsVarDictionaryMod {
  ...
  object ValueType extends StObject {
    ...
    sealed trait Bool
      extends StObject
         with ValueType
    /* 8 */ val Bool: typingsJapgolly.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.Bool & Double = js.native
    
    @js.native
    sealed trait Bytes
      extends StObject
         with ValueType
    /* 66 */ val Bytes: typingsJapgolly.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.Bytes & Double = js.native
    
    @js.native
    sealed trait Int32
      extends StObject
         with ValueType
    /* 12 */ val Int32: typingsJapgolly.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.Int32 & Double = js.native
    
    @js.native
    sealed trait Int64
      extends StObject
         with ValueType
    /* 13 */ val Int64: typingsJapgolly.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.Int64 & Double = js.native
    
    @js.native
    sealed trait String
      extends StObject
         with ValueType
    /* 24 */ val String: typingsJapgolly.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.String & Double = js.native
    
    @js.native
    sealed trait UInt32
      extends StObject
         with ValueType
    /* 4 */ val UInt32: typingsJapgolly.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.UInt32 & Double = js.native
    
    @js.native
    sealed trait UInt64
      extends StObject
         with ValueType
    /* 5 */ val UInt64: typingsJapgolly.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.UInt64 & Double = js.native
  }
