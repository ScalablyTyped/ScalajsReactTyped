...
object Assign {
  ...
  extension [Self <: Assign](x: Self) {
    ...
    inline def setCreateCanvasElement(value: CallbackTo[HTMLCanvasElement]): Self = StObject.set(x, "createCanvasElement", value.toJsFn)
    
    inline def setCreateImageElement(value: CallbackTo[HTMLImageElement]): Self = StObject.set(x, "createImageElement", value.toJsFn)
    
    inline def setDegToRad(value: Double => Double): Self = StObject.set(x, "degToRad", js.Any.fromFunction1(value))
    
    inline def setEach(value: (Any, Any) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "each", js.Any.fromFunction2((t0: Any, t1: Any) => (value(t0, t1)).runNow()))
    
    inline def setError(value: String => japgolly.scalajs.react.Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    
    inline def setGetRGB(value: String => RGB): Self = StObject.set(x, "getRGB", js.Any.fromFunction1(value))
    
    inline def setGetRandomColor(value: CallbackTo[String]): Self = StObject.set(x, "getRandomColor", value.toJsFn)
    ...
    inline def setRequestAnimFrame(value: js.Function => japgolly.scalajs.react.Callback): Self = StObject.set(x, "requestAnimFrame", js.Any.fromFunction1((t0: js.Function) => value(t0).runNow()))
    
    inline def setThrow(value: String => scala.Nothing): Self = StObject.set(x, "throw", js.Any.fromFunction1(value))
    
    inline def setWarn(value: String => japgolly.scalajs.react.Callback): Self = StObject.set(x, "warn", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    ...
    inline def set_urlToImage(value: (String, js.Function) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "_urlToImage", js.Any.fromFunction2((t0: String, t1: js.Function) => (value(t0, t1)).runNow()))
  }
}
