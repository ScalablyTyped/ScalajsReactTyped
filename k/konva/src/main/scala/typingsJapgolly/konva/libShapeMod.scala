...
import typingsJapgolly.konva.anon.Y
import typingsJapgolly.konva.konvaStrings.auto
...
object libShapeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.konva.konvaStrings.butt
    - typingsJapgolly.konva.konvaStrings.round
    - typingsJapgolly.konva.konvaStrings.square
  */
  trait LineCap extends StObject
  object LineCap {
    
    inline def butt: typingsJapgolly.konva.konvaStrings.butt = "butt".asInstanceOf[typingsJapgolly.konva.konvaStrings.butt]
    
    inline def round: typingsJapgolly.konva.konvaStrings.round = "round".asInstanceOf[typingsJapgolly.konva.konvaStrings.round]
    
    inline def square: typingsJapgolly.konva.konvaStrings.square = "square".asInstanceOf[typingsJapgolly.konva.konvaStrings.square]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.konva.konvaStrings.round
    - typingsJapgolly.konva.konvaStrings.bevel
    - typingsJapgolly.konva.konvaStrings.miter
  */
  trait LineJoin extends StObject
  object LineJoin {
    
    inline def bevel: typingsJapgolly.konva.konvaStrings.bevel = "bevel".asInstanceOf[typingsJapgolly.konva.konvaStrings.bevel]
    
    inline def miter: typingsJapgolly.konva.konvaStrings.miter = "miter".asInstanceOf[typingsJapgolly.konva.konvaStrings.miter]
  ...
  object ShapeConfig {
    ...
    extension [Self <: ShapeConfig](x: Self) {
      ...
      inline def setHitFunc(value: (/* con */ Context, /* shape */ Shape[ShapeConfig]) => Callback): Self = StObject.set(x, "hitFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ Shape[ShapeConfig]) => (value(t0, t1)).runNow()))
      ...
      inline def setSceneFunc(value: (/* con */ Context, /* shape */ Shape[ShapeConfig]) => Callback): Self = StObject.set(x, "sceneFunc", js.Any.fromFunction2((t0: /* con */ Context, t1: /* shape */ Shape[ShapeConfig]) => (value(t0, t1)).runNow()))
