...
object libGlobalMod {
  ...
  @JSImport("konva/lib/Global", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object Konva {
    
    @JSImport("konva/lib/Global", "Konva")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("konva/lib/Global", "Konva.angleDeg")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.autoDrawEnabled")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.capturePointerEventsEnabled")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.dblClickWindow")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.document")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.dragButtons")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.dragDistance")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.enableTrace")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva._global")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.hitOnDragEnabled")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.isBrowser")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.isUnminified")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva._mouseDblClickPointerId")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva._mouseInDblClickWindow")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva._mouseListenClick")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.pixelRatio")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva._pointerDblClickPointerId")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.pointerEventsEnabled")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva._pointerInDblClickWindow")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva._pointerListenClick")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.showWarnings")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva._touchDblClickPointerId")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva._touchInDblClickWindow")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva._touchListenClick")
    @js.native
    ...
    @JSImport("konva/lib/Global", "Konva.version")
    @js.native
    def version: String = js.native
    inline def version_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("version")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("konva/lib/Global", "glob")
  @js.native
  val glob: Any = js.native
  
  inline def registerNode(NodeClass: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("_registerNode")(NodeClass.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
