...
trait Color extends StObject {
  ...
  // default 'small'
  var color: js.UndefOr[typingsJapgolly.kakaoJsSdk.Kakao.Channel.Color] = js.undefined
...
object Color {
  ...
  extension [Self <: Color](x: Self) {
    ...
    inline def setColor(value: typingsJapgolly.kakaoJsSdk.Kakao.Channel.Color): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
