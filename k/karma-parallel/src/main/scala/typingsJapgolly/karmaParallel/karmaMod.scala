...
import typingsJapgolly.karmaParallel.karmaParallelStrings.`description-length`
import typingsJapgolly.karmaParallel.karmaParallelStrings.`round-robin`
import typingsJapgolly.karmaParallel.karmaParallelStrings.custom
