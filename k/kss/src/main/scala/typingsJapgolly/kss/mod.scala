...
import typingsJapgolly.kss.kssBooleans.`false`
...
object mod {
  ...
  object KssOptions {
    ...
    extension [Self <: KssOptions](x: Self) {
      ...
      inline def setLogErrorFunction(value: /* repeated */ String => Callback): Self = StObject.set(x, "logErrorFunction", js.Any.fromFunction1((t0: /* repeated */ String) => value(t0).runNow()))
