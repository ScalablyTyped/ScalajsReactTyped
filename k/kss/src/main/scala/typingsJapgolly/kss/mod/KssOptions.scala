...
object KssOptions {
  ...
  def apply(
    ...
    logErrorFunction: /* repeated */ String => Callback = null,
    ...
    if (logErrorFunction != null) __obj.updateDynamic("logErrorFunction")(js.Any.fromFunction1((t0: /* repeated */ java.lang.String) => logErrorFunction(t0).runNow()))
