...
import typingsJapgolly.k6.anon.Max
import typingsJapgolly.k6.anon.Policy
import typingsJapgolly.k6.httpMod.CipherSuite
import typingsJapgolly.k6.k6Strings.`constant-arrival-rate`
import typingsJapgolly.k6.k6Strings.`constant-vus`
import typingsJapgolly.k6.k6Strings.`externally-controlled`
import typingsJapgolly.k6.k6Strings.`per-vu-iterations`
import typingsJapgolly.k6.k6Strings.`ramping-arrival-rate`
import typingsJapgolly.k6.k6Strings.`ramping-vus`
import typingsJapgolly.k6.k6Strings.`shared-iterations`
...
object optionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.k6.k6Strings.`shared-iterations`
    - typingsJapgolly.k6.k6Strings.`per-vu-iterations`
    - typingsJapgolly.k6.k6Strings.`constant-vus`
    - typingsJapgolly.k6.k6Strings.`ramping-vus`
    - typingsJapgolly.k6.k6Strings.`constant-arrival-rate`
    - typingsJapgolly.k6.k6Strings.`ramping-arrival-rate`
    - typingsJapgolly.k6.k6Strings.`externally-controlled`
  */
  trait ExecutorOptions extends StObject
  object ExecutorOptions {
    
    inline def `constant-arrival-rate`: typingsJapgolly.k6.k6Strings.`constant-arrival-rate` = "constant-arrival-rate".asInstanceOf[typingsJapgolly.k6.k6Strings.`constant-arrival-rate`]
    
    inline def `constant-vus`: typingsJapgolly.k6.k6Strings.`constant-vus` = "constant-vus".asInstanceOf[typingsJapgolly.k6.k6Strings.`constant-vus`]
    
    inline def `externally-controlled`: typingsJapgolly.k6.k6Strings.`externally-controlled` = "externally-controlled".asInstanceOf[typingsJapgolly.k6.k6Strings.`externally-controlled`]
    
    inline def `per-vu-iterations`: typingsJapgolly.k6.k6Strings.`per-vu-iterations` = "per-vu-iterations".asInstanceOf[typingsJapgolly.k6.k6Strings.`per-vu-iterations`]
    
    inline def `ramping-arrival-rate`: typingsJapgolly.k6.k6Strings.`ramping-arrival-rate` = "ramping-arrival-rate".asInstanceOf[typingsJapgolly.k6.k6Strings.`ramping-arrival-rate`]
    
    inline def `ramping-vus`: typingsJapgolly.k6.k6Strings.`ramping-vus` = "ramping-vus".asInstanceOf[typingsJapgolly.k6.k6Strings.`ramping-vus`]
    
    inline def `shared-iterations`: typingsJapgolly.k6.k6Strings.`shared-iterations` = "shared-iterations".asInstanceOf[typingsJapgolly.k6.k6Strings.`shared-iterations`]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.k6.optionsMod.SharedIterationsScenario
    - typingsJapgolly.k6.optionsMod.PerVUIterationsScenario
    - typingsJapgolly.k6.optionsMod.ConstantVUsScenario
    - typingsJapgolly.k6.optionsMod.RampingVUsScenario
    - typingsJapgolly.k6.optionsMod.ConstantArrivalRateScenario
    - typingsJapgolly.k6.optionsMod.RampingArrivalRateScenario
    - typingsJapgolly.k6.optionsMod.ExternallyControlledScenario
  */
