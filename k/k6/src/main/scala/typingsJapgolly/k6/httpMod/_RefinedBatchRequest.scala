...
object _RefinedBatchRequest {
  ...
  inline def ObjectRefinedBatchRequest[RT /* <: js.UndefOr[ResponseType] */](method: String, url: String | HttpURL): typingsJapgolly.k6.httpMod.ObjectRefinedBatchRequest[RT] = {
    val __obj = js.Dynamic.literal(method = method.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsJapgolly.k6.httpMod.ObjectRefinedBatchRequest[RT]]
  }
}
