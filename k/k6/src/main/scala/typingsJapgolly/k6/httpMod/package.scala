...
import typingsJapgolly.k6.anon.Replace
import typingsJapgolly.k6.httpMod.^
...
/* Rewritten from type alias, can be one of: 
  - java.lang.String
  - typingsJapgolly.k6.httpMod.HttpURL
  - typingsJapgolly.k6.httpMod.ArrayBatchRequest
  - typingsJapgolly.k6.httpMod.ObjectBatchRequest
*/
...
/* Rewritten from type alias, can be one of: 
  - java.lang.String
  - typingsJapgolly.k6.httpMod.HttpURL
  - typingsJapgolly.k6.httpMod.ArrayRefinedBatchRequest[RT]
  - typingsJapgolly.k6.httpMod.ObjectRefinedBatchRequest[RT]
*/
