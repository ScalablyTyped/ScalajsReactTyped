...
import typingsJapgolly.k6.k6Strings.arrayBuffer
...
object experimentalWebsocketsMod {
  ...
  object EventName extends StObject {
    ...
    sealed trait Close
      extends StObject
         with EventName
    /* "close" */ val Close: typingsJapgolly.k6.experimentalWebsocketsMod.EventName.Close & String = js.native
    ...
    sealed trait Error
      extends StObject
         with EventName
    /* "error" */ val Error: typingsJapgolly.k6.experimentalWebsocketsMod.EventName.Error & String = js.native
    ...
    sealed trait Message
      extends StObject
         with EventName
    /* "message" */ val Message: typingsJapgolly.k6.experimentalWebsocketsMod.EventName.Message & String = js.native
    ...
    sealed trait Open
      extends StObject
         with EventName
    /* "open" */ val Open: typingsJapgolly.k6.experimentalWebsocketsMod.EventName.Open & String = js.native
  }
  ...
  object MessageType extends StObject {
    ...
    sealed trait Binary
      extends StObject
         with MessageType
    /* 2 */ val Binary: typingsJapgolly.k6.experimentalWebsocketsMod.MessageType.Binary & Double = js.native
    ...
    sealed trait Close
      extends StObject
         with MessageType
    /* 8 */ val Close: typingsJapgolly.k6.experimentalWebsocketsMod.MessageType.Close & Double = js.native
    ...
    sealed trait PingMessage
      extends StObject
         with MessageType
    /* 9 */ val PingMessage: typingsJapgolly.k6.experimentalWebsocketsMod.MessageType.PingMessage & Double = js.native
    ...
    sealed trait PongMessage
      extends StObject
         with MessageType
    /* 10 */ val PongMessage: typingsJapgolly.k6.experimentalWebsocketsMod.MessageType.PongMessage & Double = js.native
    ...
    sealed trait Text
      extends StObject
         with MessageType
    /* 1 */ val Text: typingsJapgolly.k6.experimentalWebsocketsMod.MessageType.Text & Double = js.native
  }
  ...
  object ReadyState extends StObject {
    ...
    sealed trait Closed
      extends StObject
         with ReadyState
    /* 3 */ val Closed: typingsJapgolly.k6.experimentalWebsocketsMod.ReadyState.Closed & Double = js.native
    ...
    sealed trait Closing
      extends StObject
         with ReadyState
    /* 2 */ val Closing: typingsJapgolly.k6.experimentalWebsocketsMod.ReadyState.Closing & Double = js.native
    ...
    sealed trait Connecting
      extends StObject
         with ReadyState
    /* 0 */ val Connecting: typingsJapgolly.k6.experimentalWebsocketsMod.ReadyState.Connecting & Double = js.native
    ...
    sealed trait Open
      extends StObject
         with ReadyState
    /* 1 */ val Open: typingsJapgolly.k6.experimentalWebsocketsMod.ReadyState.Open & Double = js.native
  }
