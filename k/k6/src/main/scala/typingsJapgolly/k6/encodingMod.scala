...
import typingsJapgolly.k6.k6Strings.s
...
object encodingMod {
  ...
  */
  ...
  object Base64Variant {
    ...
    inline def rawstd: typingsJapgolly.k6.k6Strings.rawstd = "rawstd".asInstanceOf[typingsJapgolly.k6.k6Strings.rawstd]
    
    inline def rawurl: typingsJapgolly.k6.k6Strings.rawurl = "rawurl".asInstanceOf[typingsJapgolly.k6.k6Strings.rawurl]
    
    inline def std: typingsJapgolly.k6.k6Strings.std = "std".asInstanceOf[typingsJapgolly.k6.k6Strings.std]
    
    inline def url: typingsJapgolly.k6.k6Strings.url = "url".asInstanceOf[typingsJapgolly.k6.k6Strings.url]
  }
}
