...
import typingsJapgolly.k6.httpMod.CookieJar_
...
object wsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.k6.k6Strings.binaryMessage
  */
  trait EventType extends StObject
  object EventType {
    
    inline def binaryMessage: typingsJapgolly.k6.k6Strings.binaryMessage = "binaryMessage".asInstanceOf[typingsJapgolly.k6.k6Strings.binaryMessage]
    
    inline def close: typingsJapgolly.k6.k6Strings.close = "close".asInstanceOf[typingsJapgolly.k6.k6Strings.close]
    
    inline def error: typingsJapgolly.k6.k6Strings.error = "error".asInstanceOf[typingsJapgolly.k6.k6Strings.error]
    
    inline def message: typingsJapgolly.k6.k6Strings.message = "message".asInstanceOf[typingsJapgolly.k6.k6Strings.message]
    
    inline def open: typingsJapgolly.k6.k6Strings.open = "open".asInstanceOf[typingsJapgolly.k6.k6Strings.open]
    
    inline def ping: typingsJapgolly.k6.k6Strings.ping = "ping".asInstanceOf[typingsJapgolly.k6.k6Strings.ping]
    
    inline def pong: typingsJapgolly.k6.k6Strings.pong = "pong".asInstanceOf[typingsJapgolly.k6.k6Strings.pong]
  }
