package typingsJapgolly.knockoutPaging.KnockoutComponentTypes
...
object Loader {
  ...
  /* result */ typingsJapgolly.knockoutPaging.KnockoutComponentTypes.ComponentConfig, 
  scala.Unit]) => getConfig(t0, t1).runNow()))
    if (loadComponent != null) __obj.updateDynamic("loadComponent")(js.Any.fromFunction3((t0: /* componentName */ java.lang.String, t1: /* config */ typingsJapgolly.knockoutPaging.KnockoutComponentTypes.ComponentConfig, t2: /* callback */ js.Function1[
  /* result */ typingsJapgolly.knockoutPaging.KnockoutComponentTypes.Definition, 
