...
object KnockoutVirtualElements {
  ...
  def apply(
    ...
    __obj.updateDynamic("childNodes")(js.Any.fromFunction1((t0: typingsJapgolly.knockoutPaging.KnockoutVirtualElement) => childNodes(t0).runNow()))
    __obj.updateDynamic("emptyNode")(js.Any.fromFunction1((t0: typingsJapgolly.knockoutPaging.KnockoutVirtualElement) => emptyNode(t0).runNow()))
    __obj.updateDynamic("firstChild")(js.Any.fromFunction1((t0: typingsJapgolly.knockoutPaging.KnockoutVirtualElement) => firstChild(t0).runNow()))
    __obj.updateDynamic("insertAfter")(js.Any.fromFunction3((t0: typingsJapgolly.knockoutPaging.KnockoutVirtualElement, t1: org.scalajs.dom.raw.Node, t2: org.scalajs.dom.raw.Node) => insertAfter(t0, t1, t2).runNow()))
    __obj.updateDynamic("nextSibling")(js.Any.fromFunction1((t0: typingsJapgolly.knockoutPaging.KnockoutVirtualElement) => nextSibling(t0).runNow()))
    __obj.updateDynamic("prepend")(js.Any.fromFunction2((t0: typingsJapgolly.knockoutPaging.KnockoutVirtualElement, t1: org.scalajs.dom.raw.Node) => prepend(t0, t1).runNow()))
    __obj.updateDynamic("setDomNodeChildren")(js.Any.fromFunction2((t0: typingsJapgolly.knockoutPaging.KnockoutVirtualElement, t1: typingsJapgolly.knockoutPaging.AnonDictindex) => setDomNodeChildren(t0, t1).runNow()))
