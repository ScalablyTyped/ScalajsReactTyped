package typingsJapgolly.klawSync.mod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.klawSync.AnonReaddirSync
...
object Options {
  ...
  def apply(
    ...
    filter: /* item */ Item => CallbackTo[Boolean] = null,
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction1((t0: /* item */ typingsJapgolly.klawSync.mod.Item) => filter(t0).runNow()))
