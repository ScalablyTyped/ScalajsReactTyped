...
import typingsJapgolly.knockout.mod.^
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.knockout.mod.Subscribable_[T]
  - typingsJapgolly.knockout.mod.Observable_[T]
  - typingsJapgolly.knockout.mod.Computed_[T]
