...
import typingsJapgolly.knockout.knockoutStrings.added
import typingsJapgolly.knockout.knockoutStrings.deleted
import typingsJapgolly.knockout.knockoutStrings.retained
...
object utils {
  ...
  object MappingOptions {
    ...
    extension [Self <: MappingOptions[?], T](x: Self & MappingOptions[T]) {
      ...
      inline def setAfterAdd(value: (/* nodes */ js.Array[Node], /* index */ Double, T) => Callback): Self = StObject.set(x, "afterAdd", js.Any.fromFunction3((t0: /* nodes */ js.Array[Node], t1: /* index */ Double, t2: T) => (value(t0, t1, t2)).runNow()))
      
      inline def setAfterAddUndefined: Self = StObject.set(x, "afterAdd", js.undefined)
      
      inline def setAfterMove(value: (/* nodes */ js.Array[Node], /* index */ Double, T) => Callback): Self = StObject.set(x, "afterMove", js.Any.fromFunction3((t0: /* nodes */ js.Array[Node], t1: /* index */ Double, t2: T) => (value(t0, t1, t2)).runNow()))
      
      inline def setAfterMoveUndefined: Self = StObject.set(x, "afterMove", js.undefined)
      
      inline def setAfterRemove(value: (/* nodes */ js.Array[Node], /* index */ Double, T) => Callback): Self = StObject.set(x, "afterRemove", js.Any.fromFunction3((t0: /* nodes */ js.Array[Node], t1: /* index */ Double, t2: T) => (value(t0, t1, t2)).runNow()))
      
      inline def setAfterRemoveUndefined: Self = StObject.set(x, "afterRemove", js.undefined)
      
      inline def setBeforeMove(value: (/* nodes */ js.Array[Node], /* index */ Double, T) => Callback): Self = StObject.set(x, "beforeMove", js.Any.fromFunction3((t0: /* nodes */ js.Array[Node], t1: /* index */ Double, t2: T) => (value(t0, t1, t2)).runNow()))
      
      inline def setBeforeMoveUndefined: Self = StObject.set(x, "beforeMove", js.undefined)
      
      inline def setBeforeRemove(value: (/* nodes */ js.Array[Node], /* index */ Double, T) => Callback): Self = StObject.set(x, "beforeRemove", js.Any.fromFunction3((t0: /* nodes */ js.Array[Node], t1: /* index */ Double, t2: T) => (value(t0, t1, t2)).runNow()))
  ...
  object PostJsonOptions {
    ...
    extension [Self <: PostJsonOptions](x: Self) {
      ...
      inline def setSubmitter(value: /* form */ HTMLFormElement => Callback): Self = StObject.set(x, "submitter", js.Any.fromFunction1((t0: /* form */ HTMLFormElement) => value(t0).runNow()))
