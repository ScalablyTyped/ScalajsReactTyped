...
import typingsJapgolly.knockout.AnonElement
...
object Definition {
  ...
  def apply(
    ...
    if (createViewModel != null) __obj.updateDynamic("createViewModel")(js.Any.fromFunction2((t0: /* params */ js.Any, t1: /* options */ typingsJapgolly.knockout.AnonElement) => createViewModel(t0, t1).runNow()))
