...
import typingsJapgolly.knockout.knockoutStrings.ignoreTargetNode
import typingsJapgolly.knockout.knockoutStrings.replaceChildren
import typingsJapgolly.knockout.knockoutStrings.replaceNode
import typingsJapgolly.knockout.mod.BindingAccessors
import typingsJapgolly.knockout.mod.BindingContext
import typingsJapgolly.knockout.mod.BindingContextExtendCallback
import typingsJapgolly.knockout.mod.BindingHandler
import typingsJapgolly.knockout.mod.BindingHandlers_
import typingsJapgolly.knockout.mod.BindingOptions
import typingsJapgolly.knockout.mod.ComputedContext_
import typingsJapgolly.knockout.mod.ComputedFunctions
import typingsJapgolly.knockout.mod.ComputedOptions
import typingsJapgolly.knockout.mod.ComputedReadFunction
import typingsJapgolly.knockout.mod.Computed_
import typingsJapgolly.knockout.mod.Extenders_
import typingsJapgolly.knockout.mod.IBindingProvider
import typingsJapgolly.knockout.mod.MaybeObservableArray
import typingsJapgolly.knockout.mod.MaybeSubscribable
import typingsJapgolly.knockout.mod.ObservableArrayFunctions
import typingsJapgolly.knockout.mod.ObservableArray_
import typingsJapgolly.knockout.mod.ObservableFunctions
import typingsJapgolly.knockout.mod.Observable_
import typingsJapgolly.knockout.mod.Options_
import typingsJapgolly.knockout.mod.PureComputed_
import typingsJapgolly.knockout.mod.SubscribableFunctions
import typingsJapgolly.knockout.mod.Subscription
import typingsJapgolly.knockout.mod.SubscriptionCallback
import typingsJapgolly.knockout.mod.TemplateOptions
import typingsJapgolly.knockout.mod.Unwrapped
import typingsJapgolly.knockout.mod.VirtualElementsAllowedBindings
import typingsJapgolly.knockout.mod.components.Config
import typingsJapgolly.knockout.mod.components.DefaultLoader_
import typingsJapgolly.knockout.mod.components.Loader
import typingsJapgolly.knockout.mod.expressionRewriting.KeyValue
import typingsJapgolly.knockout.mod.expressionRewriting.TwoWayBindings
import typingsJapgolly.knockout.mod.utils.ArrayChanges
import typingsJapgolly.knockout.mod.utils.CompareArraysOptions
import typingsJapgolly.knockout.mod.utils.MappingAfterAddFunction
import typingsJapgolly.knockout.mod.utils.MappingFunction
import typingsJapgolly.knockout.mod.utils.MappingOptions
import typingsJapgolly.knockout.mod.utils.PostJsonOptions
...
object global {
  ...
  object ko {
    ...
    open class bindingProvider ()
      extends typingsJapgolly.knockout.mod.bindingProvider
    /* static members */
    ...
    open class jqueryTmplTemplateEngine ()
      extends typingsJapgolly.knockout.mod.jqueryTmplTemplateEngine
    ...
    open class nativeTemplateEngine ()
      extends typingsJapgolly.knockout.mod.nativeTemplateEngine
    ...
    inline def setTemplateEngine(templateEngine: typingsJapgolly.knockout.mod.templateEngine): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setTemplateEngine")(templateEngine.asInstanceOf[js.Any]).asInstanceOf[Unit]
    ...
    open class templateEngine ()
      extends typingsJapgolly.knockout.mod.templateEngine
    ...
    object templateSources {
      ...
      open class anonymousTemplate protected ()
        extends typingsJapgolly.knockout.mod.templateSources.anonymousTemplate {
      ...
      open class domElement protected ()
        extends typingsJapgolly.knockout.mod.templateSources.domElement {
        def this(element: Node) = this()
      }
    }
