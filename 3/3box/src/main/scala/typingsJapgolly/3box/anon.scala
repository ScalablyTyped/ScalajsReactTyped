...
object anon {
  ...
  object ConsentCallback {
    ...
    extension [Self <: ConsentCallback](x: Self) {
      ...
      inline def setConsentCallback(value: Callback): Self = StObject.set(x, "consentCallback", value.toJsFn)
  ...
  object OnSyncDone {
    ...
    extension [Self <: OnSyncDone](x: Self) {
      ...
      inline def setOnSyncDone(value: Callback): Self = StObject.set(x, "onSyncDone", value.toJsFn)
