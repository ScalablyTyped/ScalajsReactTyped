...
import typingsJapgolly.`3box`.mod.ThreadPost
...
object global {
  ...
  object Box {
    ...
    @js.native
    open class ^ ()
      extends typingsJapgolly.`3box`.mod.^
    ...
    /* static member */
    inline def create(ethereumProvider: Any): js.Promise[typingsJapgolly.`3box`.mod.Box] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(ethereumProvider.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.`3box`.mod.Box]]
    ...
    /* static member */
    inline def openBox(address: String, ethereumProvider: Any): js.Promise[typingsJapgolly.`3box`.mod.Box] = (^.asInstanceOf[js.Dynamic].applyDynamic("openBox")(address.asInstanceOf[js.Any], ethereumProvider.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.`3box`.mod.Box]]
    inline def openBox(address: String, ethereumProvider: Any, opts: ConsentCallback): js.Promise[typingsJapgolly.`3box`.mod.Box] = (^.asInstanceOf[js.Dynamic].applyDynamic("openBox")(address.asInstanceOf[js.Any], ethereumProvider.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.`3box`.mod.Box]]
