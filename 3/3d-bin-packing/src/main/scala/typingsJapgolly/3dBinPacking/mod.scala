...
object mod extends js.Object {
  ...
  class GAWrapperArray protected ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.GAWrapperArray {
    /**
  ...
  /**
    ...
    */
  class InstanceArray ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.InstanceArray
  ...
  /**
    ...
    */
  class InstanceForm ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.InstanceForm {
  ...
  class InstanceFormArray ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.InstanceFormArray
  ...
  /**
    ...
    */
  class Packer ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.Packer {
    /**
  ...
  /**
    ...
    */
  class PackerForm ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.PackerForm {
    /**
  ...
  /**
    ...
    */
  class Product ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.Product {
    /**
      * Construct from members.
      *
  ...
  class Wrap protected ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.Wrap {
    /**
  ...
  /**
    ...
    */
  class Wrapper ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.Wrapper {
    /**
      * Copy Constructor.
      */
    def this(wrapper: typingsJapgolly.`3dBinPacking`.bws.packer.Wrapper) = this()
  ...
  /**
    ...
    */
  class WrapperArray ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.WrapperArray
  ...
  /**
    ...
    */
  class WrapperGroup ()
    extends typingsJapgolly.`3dBinPacking`.bws.packer.WrapperGroup {
    /**
