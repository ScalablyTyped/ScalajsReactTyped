...
object boxologic {
  ...
  object Boxologic {
    ...
    inline def apply(
      ...
      cboxi: Any,
      check_found: CallbackTo[Any],
      construct_layers: CallbackTo[Any],
      decode: CallbackTo[Any],
      encode: CallbackTo[Any],
      evened: Any,
      find_box: (Any, Any, Any, Any, Any) => Any,
      find_layer: Any => Any,
      find_smallest_z: CallbackTo[Any],
      hundred_percent: Any,
      inspect_validity: CallbackTo[Any],
      instanceArray: Any,
      iterate_layer: Any => Any,
      iterate_orientations: CallbackTo[Any],
      layer_done: Any,
      layer_in_layer: Any,
      layer_map: Any,
      layer_thickness: Any,
      ...
      report_results: CallbackTo[Any],
      scrap_list: Any,
      scrap_min_z: Any,
      total_box_volume: Any,
      volume_check: CallbackTo[Any],
      wrapper: Any,
      write_box_file: CallbackTo[Any]
    ): Boxologic = {
      val __obj = js.Dynamic.literal(analyze_box = js.Any.fromFunction9(analyze_box), bbfx = bbfx.asInstanceOf[js.Any], bbfy = bbfy.asInstanceOf[js.Any], bbfz = bbfz.asInstanceOf[js.Any], bboxi = bboxi.asInstanceOf[js.Any], bboxx = bboxx.asInstanceOf[js.Any], bboxy = bboxy.asInstanceOf[js.Any], bboxz = bboxz.asInstanceOf[js.Any], best_layer = best_layer.asInstanceOf[js.Any], best_orientation = best_orientation.asInstanceOf[js.Any], best_solution_volume = best_solution_volume.asInstanceOf[js.Any], bfx = bfx.asInstanceOf[js.Any], bfy = bfy.asInstanceOf[js.Any], bfz = bfz.asInstanceOf[js.Any], box_array = box_array.asInstanceOf[js.Any], boxi = boxi.asInstanceOf[js.Any], boxx = boxx.asInstanceOf[js.Any], boxy = boxy.asInstanceOf[js.Any], boxz = boxz.asInstanceOf[js.Any], cbox_layout_height = cbox_layout_height.asInstanceOf[js.Any], cbox_layout_length = cbox_layout_length.asInstanceOf[js.Any], cbox_layout_width = cbox_layout_width.asInstanceOf[js.Any], cboxi = cboxi.asInstanceOf[js.Any], check_found = check_found.toJsFn, construct_layers = construct_layers.toJsFn, decode = decode.toJsFn, encode = encode.toJsFn, evened = evened.asInstanceOf[js.Any], find_box = js.Any.fromFunction5(find_box), find_layer = js.Any.fromFunction1(find_layer), find_smallest_z = find_smallest_z.toJsFn, hundred_percent = hundred_percent.asInstanceOf[js.Any], inspect_validity = inspect_validity.toJsFn, instanceArray = instanceArray.asInstanceOf[js.Any], iterate_layer = js.Any.fromFunction1(iterate_layer), iterate_orientations = iterate_orientations.toJsFn, layer_done = layer_done.asInstanceOf[js.Any], layer_in_layer = layer_in_layer.asInstanceOf[js.Any], layer_map = layer_map.asInstanceOf[js.Any], layer_thickness = layer_thickness.asInstanceOf[js.Any], leftInstances = leftInstances.asInstanceOf[js.Any], lilz = lilz.asInstanceOf[js.Any], pack = pack.toJsFn, pack_layer = pack_layer.toJsFn, packed_layout_height = packed_layout_height.asInstanceOf[js.Any], packed_volume = packed_volume.asInstanceOf[js.Any], packing = packing.asInstanceOf[js.Any], packing_best = packing_best.asInstanceOf[js.Any], pallet = pallet.asInstanceOf[js.Any], pre_layer = pre_layer.asInstanceOf[js.Any], remain_layout_height = remain_layout_height.asInstanceOf[js.Any], remain_layout_length = remain_layout_length.asInstanceOf[js.Any], report_results = report_results.toJsFn, scrap_list = scrap_list.asInstanceOf[js.Any], scrap_min_z = scrap_min_z.asInstanceOf[js.Any], total_box_volume = total_box_volume.asInstanceOf[js.Any], volume_check = volume_check.toJsFn, wrapper = wrapper.asInstanceOf[js.Any], write_box_file = write_box_file.toJsFn)
    ...
    extension [Self <: Boxologic](x: Self) {
      ...
      inline def setCheck_found(value: CallbackTo[Any]): Self = StObject.set(x, "check_found", value.toJsFn)
      
      inline def setConstruct_layers(value: CallbackTo[Any]): Self = StObject.set(x, "construct_layers", value.toJsFn)
      
      inline def setDecode(value: CallbackTo[Any]): Self = StObject.set(x, "decode", value.toJsFn)
      
      inline def setEncode(value: CallbackTo[Any]): Self = StObject.set(x, "encode", value.toJsFn)
      ...
      inline def setFind_smallest_z(value: CallbackTo[Any]): Self = StObject.set(x, "find_smallest_z", value.toJsFn)
      
      inline def setHundred_percent(value: Any): Self = StObject.set(x, "hundred_percent", value.asInstanceOf[js.Any])
      
      inline def setInspect_validity(value: CallbackTo[Any]): Self = StObject.set(x, "inspect_validity", value.toJsFn)
      ...
      inline def setIterate_orientations(value: CallbackTo[Any]): Self = StObject.set(x, "iterate_orientations", value.toJsFn)
      ...
      inline def setPack(value: CallbackTo[Any]): Self = StObject.set(x, "pack", value.toJsFn)
      
      inline def setPack_layer(value: CallbackTo[Any]): Self = StObject.set(x, "pack_layer", value.toJsFn)
      ...
      inline def setReport_results(value: CallbackTo[Any]): Self = StObject.set(x, "report_results", value.toJsFn)
      ...
      inline def setVolume_check(value: CallbackTo[Any]): Self = StObject.set(x, "volume_check", value.toJsFn)
      
      inline def setWrapper(value: Any): Self = StObject.set(x, "wrapper", value.asInstanceOf[js.Any])
      
      inline def setWrite_box_file(value: CallbackTo[Any]): Self = StObject.set(x, "write_box_file", value.toJsFn)
    }
  }
  ...
  object Pallet {
    ...
    inline def apply(
      ...
      layout_width: Double,
      length: Double,
      set_orientation: Double => Callback,
      volume: Double,
      width: Double
    ): Pallet = {
      val __obj = js.Dynamic.literal(height = height.asInstanceOf[js.Any], layout_height = layout_height.asInstanceOf[js.Any], layout_length = layout_length.asInstanceOf[js.Any], layout_width = layout_width.asInstanceOf[js.Any], length = length.asInstanceOf[js.Any], set_orientation = js.Any.fromFunction1((t0: Double) => set_orientation(t0).runNow()), volume = volume.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
      __obj.asInstanceOf[Pallet]
    }
    
    extension [Self <: Pallet](x: Self) {
      
      inline def setSet_orientation(value: Double => Callback): Self = StObject.set(x, "set_orientation", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    }
  }
