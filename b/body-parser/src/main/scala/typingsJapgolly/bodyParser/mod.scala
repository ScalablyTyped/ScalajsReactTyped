  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setVerify(
        value: (/* req */ IncomingMessage, /* res */ ServerResponse[IncomingMessage], /* buf */ Buffer, /* encoding */ String) => Callback
      ): Self = StObject.set(x, "verify", js.Any.fromFunction4((t0: /* req */ IncomingMessage, t1: /* res */ ServerResponse[IncomingMessage], t2: /* buf */ Buffer, t3: /* encoding */ String) => (value(t0, t1, t2, t3)).runNow()))
