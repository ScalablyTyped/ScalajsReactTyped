...
import typingsJapgolly.bugsnagJs.AnonInstantiable
import typingsJapgolly.bugsnagJs.commonMod.BeforeSession
import typingsJapgolly.bugsnagJs.commonMod.IConfig
import typingsJapgolly.bugsnagJs.commonMod.IFinalConfig
...
class Client () extends js.Object {
  var BugsnagBreadcrumb: Instantiable4[
    ...
    typingsJapgolly.bugsnagJs.breadcrumbMod.default
  ] = js.native
  var BugsnagReport: AnonInstantiable = js.native
  var BugsnagSession: Instantiable0[typingsJapgolly.bugsnagJs.sessionMod.default] = js.native
