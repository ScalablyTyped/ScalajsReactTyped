...
import typingsJapgolly.bugsnagJs.anon.Notify
import typingsJapgolly.bugsnagJs.typesClientMod.Client
import typingsJapgolly.bugsnagJs.typesClientMod.ILogger
import typingsJapgolly.bugsnagJs.typesReportMod.default
