...
import typingsJapgolly.bugsnagJs.anon.Dictkey
import typingsJapgolly.bugsnagJs.anon.ReleaseStage
import typingsJapgolly.bugsnagJs.anon.Url
...
object typesReportMod {
  ...
  trait Report extends StObject {
    ...
    var breadcrumbs: js.Array[typingsJapgolly.bugsnagJs.typesBreadcrumbMod.default] = js.native
