...
import typingsJapgolly.beanstalkd.beanstalkdStrings.close
import typingsJapgolly.beanstalkd.beanstalkdStrings.connect
import typingsJapgolly.beanstalkd.beanstalkdStrings.data
import typingsJapgolly.beanstalkd.beanstalkdStrings.drain
import typingsJapgolly.beanstalkd.beanstalkdStrings.end
import typingsJapgolly.beanstalkd.beanstalkdStrings.error
import typingsJapgolly.beanstalkd.beanstalkdStrings.lookup
import typingsJapgolly.beanstalkd.beanstalkdStrings.on
import typingsJapgolly.beanstalkd.beanstalkdStrings.timeout
...
object mod {
  ...
  */
  ...
  object BeanstalkdJobState {
    ...
    inline def buried: typingsJapgolly.beanstalkd.beanstalkdStrings.buried = "buried".asInstanceOf[typingsJapgolly.beanstalkd.beanstalkdStrings.buried]
    
    inline def delayed: typingsJapgolly.beanstalkd.beanstalkdStrings.delayed = "delayed".asInstanceOf[typingsJapgolly.beanstalkd.beanstalkdStrings.delayed]
    
    inline def ready: typingsJapgolly.beanstalkd.beanstalkdStrings.ready = "ready".asInstanceOf[typingsJapgolly.beanstalkd.beanstalkdStrings.ready]
    
    inline def reserved: typingsJapgolly.beanstalkd.beanstalkdStrings.reserved = "reserved".asInstanceOf[typingsJapgolly.beanstalkd.beanstalkdStrings.reserved]
  }
  ...
  object BeanstalkdProtocol {
    ...
    extension [Self <: BeanstalkdProtocol](x: Self) {
      ...
      inline def setAddCommand(value: String => Callback): Self = StObject.set(x, "addCommand", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setAddReply(value: String => Callback): Self = StObject.set(x, "addReply", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setAddType(value: (String, Any) => Callback): Self = StObject.set(x, "addType", js.Any.fromFunction2((t0: String, t1: Any) => (value(t0, t1)).runNow()))
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait UnPromise[T] extends StObject
