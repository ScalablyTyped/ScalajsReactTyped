...
trait PushpinTool extends StObject {
  ...
  def onmarkend(event: typingsJapgolly.baidumapWebSdk.anon.Marker): Unit
...
object PushpinTool {
  ...
  inline def apply(
    ...
    onmarkend: typingsJapgolly.baidumapWebSdk.anon.Marker => japgolly.scalajs.react.Callback,
    open: CallbackTo[Boolean],
    setCursor: String => String,
    setIcon: Icon => Icon
  ): PushpinTool = {
    val __obj = js.Dynamic.literal(close = close.toJsFn, getCursor = getCursor.toJsFn, getIcon = getIcon.toJsFn, onmarkend = js.Any.fromFunction1((t0: typingsJapgolly.baidumapWebSdk.anon.Marker) => onmarkend(t0).runNow()), open = open.toJsFn, setCursor = js.Any.fromFunction1(setCursor), setIcon = js.Any.fromFunction1(setIcon))
  ...
  extension [Self <: PushpinTool](x: Self) {
    ...
    inline def setOnmarkend(value: typingsJapgolly.baidumapWebSdk.anon.Marker => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onmarkend", js.Any.fromFunction1((t0: typingsJapgolly.baidumapWebSdk.anon.Marker) => value(t0).runNow()))
