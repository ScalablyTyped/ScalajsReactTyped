...
import typingsJapgolly.baidumapWebSdk.anon.Spots
import typingsJapgolly.baidumapWebSdk.anon.Target
import typingsJapgolly.baidumapWebSdk.anon.Type
...
trait Map extends StObject {
  ...
  def onclick(event: typingsJapgolly.baidumapWebSdk.anon.Overlay): Unit = js.native
  ...
  def ondragstart(event: typingsJapgolly.baidumapWebSdk.anon.Pixel): Unit = js.native
  ...
  def onlongpress(event: typingsJapgolly.baidumapWebSdk.anon.Pixel): Unit = js.native
  
  def onmaptypechange(event: Target): Unit = js.native
  
  def onmousemove(event: typingsJapgolly.baidumapWebSdk.anon.Overlay): Unit = js.native
  ...
  def onresize(event: typingsJapgolly.baidumapWebSdk.anon.Size): Unit = js.native
  
  def onrightclick(event: typingsJapgolly.baidumapWebSdk.anon.Overlay): Unit = js.native
  
  def onrightdblclick(event: typingsJapgolly.baidumapWebSdk.anon.Overlay): Unit = js.native
  
  def ontilesloaded(event: Target): Unit = js.native
  
  def ontouchend(event: typingsJapgolly.baidumapWebSdk.anon.Pixel): Unit = js.native
  
  def ontouchmove(event: typingsJapgolly.baidumapWebSdk.anon.Pixel): Unit = js.native
  
  def ontouchstart(event: typingsJapgolly.baidumapWebSdk.anon.Pixel): Unit = js.native
