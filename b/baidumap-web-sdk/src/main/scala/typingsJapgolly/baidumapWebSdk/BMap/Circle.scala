...
object Circle {
  ...
  extension [Self <: Circle](x: Self) {
    ...
    inline def setSetCenter(value: Point => japgolly.scalajs.react.Callback): Self = StObject.set(x, "setCenter", js.Any.fromFunction1((t0: Point) => value(t0).runNow()))
    ...
    inline def setSetRadius(value: Double => japgolly.scalajs.react.Callback): Self = StObject.set(x, "setRadius", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
