...
trait LocalSearch extends StObject {
  ...
  def searchInBounds(keyword: String, bounds: Bounds, option: typingsJapgolly.baidumapWebSdk.anon.CustomData): Unit = js.native
  def searchInBounds(keyword: js.Array[String], bounds: Bounds): Unit = js.native
  def searchInBounds(keyword: js.Array[String], bounds: Bounds, option: typingsJapgolly.baidumapWebSdk.anon.CustomData): Unit = js.native
  ...
  def searchNearby(
    ...
    center: String,
    radius: Double,
    option: typingsJapgolly.baidumapWebSdk.anon.CustomData
  ): Unit = js.native
