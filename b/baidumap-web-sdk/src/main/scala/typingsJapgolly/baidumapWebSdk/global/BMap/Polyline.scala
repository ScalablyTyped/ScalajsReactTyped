...
import typingsJapgolly.baidumapWebSdk.BMap.PolylineOptions
...
open class Polyline protected ()
  extends StObject
     with typingsJapgolly.baidumapWebSdk.BMap.Polyline {
  def this(points: js.Array[typingsJapgolly.baidumapWebSdk.BMap.Point]) = this()
  def this(points: js.Array[typingsJapgolly.baidumapWebSdk.BMap.Point], opts: PolylineOptions) = this()
  ...
  /* CompleteClass */
  override def getPath(): js.Array[typingsJapgolly.baidumapWebSdk.BMap.Point] = js.native
  ...
  /* CompleteClass */
  override def setPath(path: js.Array[typingsJapgolly.baidumapWebSdk.BMap.Point]): Unit = js.native
  
  /* CompleteClass */
  override def setPointAt(index: Double, point: typingsJapgolly.baidumapWebSdk.BMap.Point): Unit = js.native
  
  /* CompleteClass */
  override def setPositionAt(index: Double, point: typingsJapgolly.baidumapWebSdk.BMap.Point): Unit = js.native
