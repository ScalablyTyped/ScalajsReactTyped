...
import typingsJapgolly.baidumapWebSdk.BMap.LengthUnit
import typingsJapgolly.baidumapWebSdk.BMap.ScaleControlOptions
...
open class ScaleControl ()
  extends StObject
     with typingsJapgolly.baidumapWebSdk.BMap.ScaleControl {
