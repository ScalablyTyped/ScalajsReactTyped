...
import typingsJapgolly.baidumapWebSdk.BMap.PolygonOptions
...
open class Polygon protected ()
  extends StObject
     with typingsJapgolly.baidumapWebSdk.BMap.Polygon {
  def this(points: js.Array[typingsJapgolly.baidumapWebSdk.BMap.Point]) = this()
  def this(points: js.Array[typingsJapgolly.baidumapWebSdk.BMap.Point], opts: PolygonOptions) = this()
