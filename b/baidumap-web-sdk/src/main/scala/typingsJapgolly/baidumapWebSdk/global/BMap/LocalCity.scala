...
import typingsJapgolly.baidumapWebSdk.BMap.LocalCityOptions
import typingsJapgolly.baidumapWebSdk.BMap.LocalCityResult
...
open class LocalCity ()
  extends StObject
     with typingsJapgolly.baidumapWebSdk.BMap.LocalCity {
