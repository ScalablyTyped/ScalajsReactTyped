...
import typingsJapgolly.baidumapWebSdk.BMap.OverviewMapControlOptions
import typingsJapgolly.baidumapWebSdk.anon.IsOpen
...
open class OverviewMapControl protected ()
  extends StObject
     with typingsJapgolly.baidumapWebSdk.BMap.OverviewMapControl {
  ...
  /* CompleteClass */
  override def getSize(): typingsJapgolly.baidumapWebSdk.BMap.Size = js.native
  ...
  /* CompleteClass */
  override def setSize(size: typingsJapgolly.baidumapWebSdk.BMap.Size): Unit = js.native
