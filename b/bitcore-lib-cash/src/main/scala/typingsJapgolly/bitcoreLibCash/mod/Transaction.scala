...
import typingsJapgolly.bitcoreLibCash.bitcoreLibCashStrings.ecdsa
import typingsJapgolly.bitcoreLibCash.bitcoreLibCashStrings.schnorr
import typingsJapgolly.bitcoreLibCash.mod.Transaction.Input
import typingsJapgolly.bitcoreLibCash.mod.Transaction.Output
import typingsJapgolly.bitcoreLibCash.mod.Transaction.UnspentOutput
import typingsJapgolly.bitcoreLibCash.mod.crypto.BN
import typingsJapgolly.bitcoreLibCash.mod.crypto.Signature
import typingsJapgolly.bitcoreLibCash.mod.crypto.TransactionSignature
import typingsJapgolly.bitcoreLibCash.mod.encoding.BufferReader
import typingsJapgolly.bitcoreLibCash.mod.encoding.BufferWriter
...
object Transaction {
  ...
  object Input {
    ...
    open class Multisig protected () extends Input {
      ...
      def this(input: Input, pubkeys: js.Array[typingsJapgolly.bitcoreLibCash.mod.Transaction.Input.PublicKey]) = this()
      def this(
        input: Input,
        pubkeys: js.Array[typingsJapgolly.bitcoreLibCash.mod.Transaction.Input.PublicKey],
        threshold: Double
      ) = this()
      ...
      def normalizeSignatures(
        ...
        publicKeys: js.Array[typingsJapgolly.bitcoreLibCash.mod.Transaction.Input.PublicKey]
      ): js.Array[TransactionSignature] = js.native
      def normalizeSignatures(
        transaction: Transaction,
        input: Input,
