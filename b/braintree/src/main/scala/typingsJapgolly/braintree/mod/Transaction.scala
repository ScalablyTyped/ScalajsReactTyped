...
import typingsJapgolly.braintree.anon.AuthorizationId
import typingsJapgolly.braintree.anon.BillingPeriodEndDate
import typingsJapgolly.braintree.anon.CallId
import typingsJapgolly.braintree.anon.CardType
import typingsJapgolly.braintree.anon.CardholderName
import typingsJapgolly.braintree.anon.CountryCodeAlpha3
import typingsJapgolly.braintree.anon.CustomFields
import typingsJapgolly.braintree.anon.FullInformation
import typingsJapgolly.braintree.anon.Held
import typingsJapgolly.braintree.anon.ImageUrl
...
open class Transaction () extends StObject {
  ...
  var androidPayCard: js.UndefOr[typingsJapgolly.braintree.anon.Debit] = js.native
  ...
  var masterpassCardDetails: js.UndefOr[typingsJapgolly.braintree.anon.CustomerLocation] = js.native
  ...
  var samsungPayCardDetails: js.UndefOr[typingsJapgolly.braintree.anon.DurbinRegulated] = js.native
