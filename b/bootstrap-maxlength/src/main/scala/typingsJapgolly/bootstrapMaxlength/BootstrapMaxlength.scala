  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setPlacementFunction3(
        value: (/* currentInput */ JQuery, /* maxLengthIndicator */ JQuery, /* currentInputPosition */ PositionParam) => Callback
      ): Self = StObject.set(x, "placement", js.Any.fromFunction3((t0: /* currentInput */ JQuery, t1: /* maxLengthIndicator */ JQuery, t2: /* currentInputPosition */ PositionParam) => (value(t0, t1, t2)).runNow()))
