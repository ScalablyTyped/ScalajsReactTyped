...
import typingsJapgolly.bson.anon.TypeofBSONRegExp
import typingsJapgolly.bson.anon.TypeofBinary
import typingsJapgolly.bson.anon.TypeofDecimal128
import typingsJapgolly.bson.anon.TypeofEJSON
import typingsJapgolly.bson.anon.TypeofLong
import typingsJapgolly.bson.anon.TypeofObjectId
import typingsJapgolly.bson.anon.TypeofTimestamp
import typingsJapgolly.bson.anon.TypeofUUID
...
object default {
  ...
  @js.native
  def BSONError: Instantiable1[/* message */ String, typingsJapgolly.bson.mod.BSONError] = js.native
  ...
  @js.native
  def BSONSymbol: Instantiable1[/* value */ String, typingsJapgolly.bson.mod.BSONSymbol] = js.native
  ...
  @js.native
  def BSONTypeError: Instantiable1[/* message */ String, typingsJapgolly.bson.mod.BSONTypeError] = js.native
  ...
  def DBRef: Instantiable4[
    ...
    typingsJapgolly.bson.mod.DBRef
  ] = js.native
  ...
  @js.native
  def Double: Instantiable1[/* value */ scala.Double, typingsJapgolly.bson.mod.Double] = js.native
  ...
  @js.native
  def Int32: Instantiable1[/* value */ scala.Double | String, typingsJapgolly.bson.mod.Int32] = js.native
  ...
  @js.native
  def MaxKey: Instantiable0[typingsJapgolly.bson.mod.MaxKey] = js.native
  ...
  @js.native
  def MinKey: Instantiable0[typingsJapgolly.bson.mod.MinKey] = js.native
  ...
  def ObjectId: TypeofObjectId & (Instantiable1[
    /* inputId */ js.UndefOr[
      String | scala.Double | typingsJapgolly.bson.mod.ObjectId | ObjectIdLike | Buffer | js.typedarray.Uint8Array
    ], 
    typingsJapgolly.bson.mod.ObjectId
  ]) = js.native
