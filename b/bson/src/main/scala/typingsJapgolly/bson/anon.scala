...
import typingsJapgolly.bson.bsonBooleans.`false`
import typingsJapgolly.bson.bsonBooleans.`true`
import typingsJapgolly.bson.bsonInts.`-1`
import typingsJapgolly.bson.bsonInts.`0`
import typingsJapgolly.bson.bsonInts.`1`
import typingsJapgolly.bson.mod.BSONRegExp
import typingsJapgolly.bson.mod.Binary
import typingsJapgolly.bson.mod.BinarySequence
import typingsJapgolly.bson.mod.Decimal128
import typingsJapgolly.bson.mod.Document
import typingsJapgolly.bson.mod.EJSON.SerializableTypes
import typingsJapgolly.bson.mod.EJSONOptions
import typingsJapgolly.bson.mod.Long
import typingsJapgolly.bson.mod.ObjectId
import typingsJapgolly.bson.mod.ObjectIdLike
import typingsJapgolly.bson.mod.UUID
...
object anon {
  ...
  trait PinExcludekeyofLongTimest extends StObject {
    ...
    def add(addend: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("add")
    var add_Original: js.Function1[/* addend */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
    
    def and(other: String): Long
    def and(other: Double): Long
    def and(other: Long): Long
    def and(other: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("and")
    var and_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
    
    def comp(other: String): `0` | `1` | `-1`
    def comp(other: Double): `0` | `1` | `-1`
    def comp(other: Long): `0` | `1` | `-1`
    def comp(other: typingsJapgolly.bson.mod.Timestamp): `0` | `1` | `-1`
    @JSName("comp")
    var comp_Original: js.Function1[
        /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, 
        `0` | `1` | `-1`
      ]
    ...
    def compare(other: typingsJapgolly.bson.mod.Timestamp): `0` | `1` | `-1`
    @JSName("compare")
    ...
    def div(divisor: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("div")
    var div_Original: js.Function1[/* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
    
    def divide(divisor: String): Long
    def divide(divisor: Double): Long
    def divide(divisor: Long): Long
    def divide(divisor: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("divide")
    var divide_Original: js.Function1[/* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
    
    def eq(other: String): Boolean
    def eq(other: Double): Boolean
    def eq(other: Long): Boolean
    def eq(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("eq")
    var eq_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    
    def equals(other: String): Boolean
    def equals(other: Double): Boolean
    def equals(other: Long): Boolean
    def equals(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("equals")
    var equals_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    ...
    def ge(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("ge")
    var ge_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    ...
    def greaterThan(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    ...
    def greaterThanOrEqual(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("greaterThanOrEqual")
    var greaterThanOrEqual_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    
    @JSName("greaterThan")
    var greaterThan_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    
    def gt(other: String): Boolean
    def gt(other: Double): Boolean
    def gt(other: Long): Boolean
    def gt(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("gt")
    var gt_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    
    def gte(other: String): Boolean
    def gte(other: Double): Boolean
    def gte(other: Long): Boolean
    def gte(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("gte")
    var gte_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    ...
    def le(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("le")
    var le_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    
    def lessThan(other: String): Boolean
    def lessThan(other: Double): Boolean
    def lessThan(other: Long): Boolean
    def lessThan(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    
    def lessThanOrEqual(other: String): Boolean
    def lessThanOrEqual(other: Double): Boolean
    def lessThanOrEqual(other: Long): Boolean
    def lessThanOrEqual(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("lessThanOrEqual")
    var lessThanOrEqual_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    
    @JSName("lessThan")
    var lessThan_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    ...
    def lt(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("lt")
    var lt_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    
    def lte(other: String): Boolean
    def lte(other: Double): Boolean
    def lte(other: Long): Boolean
    def lte(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("lte")
    var lte_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    
    def mod(divisor: String): Long
    def mod(divisor: Double): Long
    def mod(divisor: Long): Long
    def mod(divisor: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("mod")
    var mod_Original: js.Function1[/* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
    
    def modulo(divisor: String): Long
    def modulo(divisor: Double): Long
    def modulo(divisor: Long): Long
    def modulo(divisor: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("modulo")
    var modulo_Original: js.Function1[/* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
    
    def mul(multiplier: String): Long
    def mul(multiplier: Double): Long
    def mul(multiplier: Long): Long
    def mul(multiplier: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("mul")
    var mul_Original: js.Function1[/* multiplier */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
    
    def multiply(multiplier: String): Long
    def multiply(multiplier: Double): Long
    def multiply(multiplier: Long): Long
    def multiply(multiplier: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("multiply")
    var multiply_Original: js.Function1[/* multiplier */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
    
    def ne(other: String): Boolean
    def ne(other: Double): Boolean
    def ne(other: Long): Boolean
    def ne(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("ne")
    var ne_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    ...
    def neq(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("neq")
    var neq_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    ...
    def notEquals(other: typingsJapgolly.bson.mod.Timestamp): Boolean
    @JSName("notEquals")
    var notEquals_Original: js.Function1[/* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Boolean]
    ...
    def rem(divisor: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("rem")
    var rem_Original: js.Function1[/* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
    ...
    def sub(subtrahend: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("sub")
    var sub_Original: js.Function1[/* subtrahend */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
    
    def subtract(subtrahend: String): Long
    def subtract(subtrahend: Double): Long
    def subtract(subtrahend: Long): Long
    def subtract(subtrahend: typingsJapgolly.bson.mod.Timestamp): Long
    @JSName("subtract")
    var subtract_Original: js.Function1[/* subtrahend */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp, Long]
  ...
  object PinExcludekeyofLongTimest {
    ...
    inline def apply(
      add: /* addend */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long,
      and: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long,
      comp: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => `0` | `1` | `-1`,
      compare: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => `0` | `1` | `-1`,
      constructor: (/* low */ js.UndefOr[Double | js.BigInt | String], /* high */ js.UndefOr[Double | Boolean], /* unsigned */ js.UndefOr[Boolean]) => Any,
      div: /* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long,
      divide: /* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long,
      eq_ : /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      equals_ : /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      eqz: CallbackTo[Boolean],
      ge: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      getHighBits: CallbackTo[Double],
      getHighBitsUnsigned: CallbackTo[Double],
      getLowBits: CallbackTo[Double],
      getLowBitsUnsigned: CallbackTo[Double],
      getNumBitsAbs: CallbackTo[Double],
      greaterThan: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      greaterThanOrEqual: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      gt: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      gte: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      high: Double,
      isEven: CallbackTo[Boolean],
      isNegative: CallbackTo[Boolean],
      isOdd: CallbackTo[Boolean],
      isPositive: CallbackTo[Boolean],
      isZero: CallbackTo[Boolean],
      le: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      lessThan: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      lessThanOrEqual: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      low: Double,
      lt: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      lte: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      mod: /* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long,
      modulo: /* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long,
      mul: /* multiplier */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long,
      multiply: /* multiplier */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long,
      ne_ : /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      neg: CallbackTo[Long],
      negate: CallbackTo[Long],
      neq: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      not: CallbackTo[Long],
      notEquals: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean,
      or: /* other */ Double | String | Long => Long,
      rem: /* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long,
    ...
    extension [Self <: PinExcludekeyofLongTimest](x: Self) {
      ...
      inline def setAdd(value: /* addend */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "add", js.Any.fromFunction1(value))
      
      inline def setAnd(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "and", js.Any.fromFunction1(value))
      
      inline def setComp(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => `0` | `1` | `-1`): Self = StObject.set(x, "comp", js.Any.fromFunction1(value))
      
      inline def setCompare(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => `0` | `1` | `-1`): Self = StObject.set(x, "compare", js.Any.fromFunction1(value))
      ...
      inline def setDiv(value: /* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "div", js.Any.fromFunction1(value))
      
      inline def setDivide(value: /* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "divide", js.Any.fromFunction1(value))
      
      inline def setEq_(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "eq", js.Any.fromFunction1(value))
      
      inline def setEquals_(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
      
      inline def setEqz(value: CallbackTo[Boolean]): Self = StObject.set(x, "eqz", value.toJsFn)
      ...
      inline def setGe(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "ge", js.Any.fromFunction1(value))
      
      inline def setGetHighBits(value: CallbackTo[Double]): Self = StObject.set(x, "getHighBits", value.toJsFn)
      
      inline def setGetHighBitsUnsigned(value: CallbackTo[Double]): Self = StObject.set(x, "getHighBitsUnsigned", value.toJsFn)
      
      inline def setGetLowBits(value: CallbackTo[Double]): Self = StObject.set(x, "getLowBits", value.toJsFn)
      
      inline def setGetLowBitsUnsigned(value: CallbackTo[Double]): Self = StObject.set(x, "getLowBitsUnsigned", value.toJsFn)
      
      inline def setGetNumBitsAbs(value: CallbackTo[Double]): Self = StObject.set(x, "getNumBitsAbs", value.toJsFn)
      
      inline def setGreaterThan(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "greaterThan", js.Any.fromFunction1(value))
      
      inline def setGreaterThanOrEqual(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "greaterThanOrEqual", js.Any.fromFunction1(value))
      
      inline def setGt(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "gt", js.Any.fromFunction1(value))
      
      inline def setGte(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "gte", js.Any.fromFunction1(value))
      
      inline def setHigh(value: Double): Self = StObject.set(x, "high", value.asInstanceOf[js.Any])
      
      inline def setIsEven(value: CallbackTo[Boolean]): Self = StObject.set(x, "isEven", value.toJsFn)
      ...
      inline def setIsOdd(value: CallbackTo[Boolean]): Self = StObject.set(x, "isOdd", value.toJsFn)
      
      inline def setIsPositive(value: CallbackTo[Boolean]): Self = StObject.set(x, "isPositive", value.toJsFn)
      
      inline def setIsZero(value: CallbackTo[Boolean]): Self = StObject.set(x, "isZero", value.toJsFn)
      
      inline def setLe(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "le", js.Any.fromFunction1(value))
      
      inline def setLessThan(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "lessThan", js.Any.fromFunction1(value))
      
      inline def setLessThanOrEqual(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "lessThanOrEqual", js.Any.fromFunction1(value))
      
      inline def setLow(value: Double): Self = StObject.set(x, "low", value.asInstanceOf[js.Any])
      
      inline def setLt(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "lt", js.Any.fromFunction1(value))
      
      inline def setLte(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "lte", js.Any.fromFunction1(value))
      ...
      inline def setMod(value: /* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "mod", js.Any.fromFunction1(value))
      
      inline def setModulo(value: /* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "modulo", js.Any.fromFunction1(value))
      
      inline def setMul(value: /* multiplier */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "mul", js.Any.fromFunction1(value))
      
      inline def setMultiply(value: /* multiplier */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "multiply", js.Any.fromFunction1(value))
      ...
      inline def setNe_(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "ne", js.Any.fromFunction1(value))
      
      inline def setNeg(value: CallbackTo[Long]): Self = StObject.set(x, "neg", value.toJsFn)
      
      inline def setNegate(value: CallbackTo[Long]): Self = StObject.set(x, "negate", value.toJsFn)
      
      inline def setNeq(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "neq", js.Any.fromFunction1(value))
      
      inline def setNot(value: CallbackTo[Long]): Self = StObject.set(x, "not", value.toJsFn)
      
      inline def setNotEquals(value: /* other */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Boolean): Self = StObject.set(x, "notEquals", js.Any.fromFunction1(value))
      ...
      inline def setRem(value: /* divisor */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "rem", js.Any.fromFunction1(value))
      ...
      inline def setSub(value: /* subtrahend */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "sub", js.Any.fromFunction1(value))
      
      inline def setSubtract(value: /* subtrahend */ String | Double | Long | typingsJapgolly.bson.mod.Timestamp => Long): Self = StObject.set(x, "subtract", js.Any.fromFunction1(value))
      ...
      inline def setToBigInt(value: CallbackTo[js.BigInt]): Self = StObject.set(x, "toBigInt", value.toJsFn)
      
      inline def setToBytes(value: /* le */ js.UndefOr[Boolean] => js.Array[Double]): Self = StObject.set(x, "toBytes", js.Any.fromFunction1(value))
      
      inline def setToBytesBE(value: CallbackTo[js.Array[Double]]): Self = StObject.set(x, "toBytesBE", value.toJsFn)
      
      inline def setToBytesLE(value: CallbackTo[js.Array[Double]]): Self = StObject.set(x, "toBytesLE", value.toJsFn)
      ...
      inline def setToSigned(value: CallbackTo[Long]): Self = StObject.set(x, "toSigned", value.toJsFn)
      
      inline def setToString_(value: /* radix */ js.UndefOr[Double] => String): Self = StObject.set(x, "toString", js.Any.fromFunction1(value))
      
      inline def setToUnsigned(value: CallbackTo[Long]): Self = StObject.set(x, "toUnsigned", value.toJsFn)
  ...
  trait TypeofEJSON extends StObject {
    ...
    def deserialize(ejson: Document, options: typingsJapgolly.bson.mod.EJSON.Options): SerializableTypes = js.native
    
    def parse(text: String): SerializableTypes = js.native
    def parse(text: String, options: typingsJapgolly.bson.mod.EJSON.Options): SerializableTypes = js.native
    
    def serialize(value: SerializableTypes): Document = js.native
    def serialize(value: SerializableTypes, options: typingsJapgolly.bson.mod.EJSON.Options): Document = js.native
    ...
    def stringify(
      ...
      space: String,
      options: typingsJapgolly.bson.mod.EJSON.Options
    ): String = js.native
    ...
    def stringify(value: SerializableTypes, replacer: typingsJapgolly.bson.mod.EJSON.Options): String = js.native
    def stringify(value: SerializableTypes, replacer: typingsJapgolly.bson.mod.EJSON.Options, space: String): String = js.native
    def stringify(
      value: SerializableTypes,
      replacer: typingsJapgolly.bson.mod.EJSON.Options,
      space: String,
      options: typingsJapgolly.bson.mod.EJSON.Options
    ): String = js.native
    def stringify(value: SerializableTypes, replacer: typingsJapgolly.bson.mod.EJSON.Options, space: Double): String = js.native
    def stringify(
      value: SerializableTypes,
      replacer: typingsJapgolly.bson.mod.EJSON.Options,
      space: Double,
  ...
  trait TypeofTimestamp
    extends StObject
       with Instantiable1[/* long */ Long, typingsJapgolly.bson.mod.Timestamp] {
    ...
    /**
      ...
      */
    def fromString(str: String, optRadix: Double): typingsJapgolly.bson.mod.Timestamp = js.native
  }
