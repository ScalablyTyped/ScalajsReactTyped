...
object mod {
  ...
  open class ^ protected ()
    extends StObject
       with typingsJapgolly.bigi.mod.bigi {
  ...
  @JSImport("bigi", "ONE")
  @js.native
  val ONE: typingsJapgolly.bigi.mod.bigi & Constants = js.native
  
  @JSImport("bigi", "ZERO")
  @js.native
  val ZERO: typingsJapgolly.bigi.mod.bigi & Constants = js.native
  
  /* static member */
  inline def fromBuffer(buffer: Any): typingsJapgolly.bigi.mod.bigi = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBuffer")(buffer.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bigi.mod.bigi]
  ...
  /* static member */
  inline def fromHex(hex: String): typingsJapgolly.bigi.mod.bigi = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHex")(hex.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bigi.mod.bigi]
  ...
  /* static member */
  inline def valueOf_(i: Any): typingsJapgolly.bigi.mod.bigi = ^.asInstanceOf[js.Dynamic].applyDynamic("valueOf")(i.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bigi.mod.bigi]
  ...
  trait bigi extends StObject {
    ...
    def add(a: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    
    def addTo(a: typingsJapgolly.bigi.mod.bigi, r: Double): Unit = js.native
    
    def am(i: Any, x: Any, w: Any, j: Any, c: Any, n: Any): Any = js.native
    
    def and(a: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    ...
    def clearBit(n: Double): typingsJapgolly.bigi.mod.bigi = js.native
    
    def compareTo(a: typingsJapgolly.bigi.mod.bigi): Double = js.native
    ...
    def divideAndRemainder(a: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    
    def dlShiftTo(n: typingsJapgolly.bigi.mod.bigi, r: Double): Unit = js.native
    
    def drShiftTo(n: typingsJapgolly.bigi.mod.bigi, r: Double): Unit = js.native
    
    def equals(a: typingsJapgolly.bigi.mod.bigi): Boolean = js.native
    
    def exp(e: Any, z: Any): Any = js.native
    
    def flipBit(n: Double): typingsJapgolly.bigi.mod.bigi = js.native
    ...
    def millerRabin(t: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    
    def min(a: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    
    def mod(a: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    
    def modInt(n: Double): typingsJapgolly.bigi.mod.bigi = js.native
    
    def modInverse(m: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    
    def modPow(e: Any, m: Any): Any = js.native
    
    def modPowInt(e: Any, m: Any): Any = js.native
    
    def multiply(a: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    
    def multiplyLowerTo(a: typingsJapgolly.bigi.mod.bigi, n: Any, r: Any): Unit = js.native
    
    def multiplyTo(a: typingsJapgolly.bigi.mod.bigi, r: Any): Unit = js.native
    
    def multiplyUpperTo(a: typingsJapgolly.bigi.mod.bigi, n: Any, r: Any): Unit = js.native
    
    def negate(): typingsJapgolly.bigi.mod.bigi = js.native
    
    def not(): typingsJapgolly.bigi.mod.bigi = js.native
    
    def or(a: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    
    def pow(e: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    
    def rShiftTo(n: typingsJapgolly.bigi.mod.bigi, r: Any): Unit = js.native
    
    def remainder(a: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
    
    def setBit(n: Double): typingsJapgolly.bigi.mod.bigi = js.native
    
    def shiftLeft(n: Double): typingsJapgolly.bigi.mod.bigi = js.native
    
    def shiftRight(n: Double): typingsJapgolly.bigi.mod.bigi = js.native
    
    def shortValue(): typingsJapgolly.bigi.mod.bigi = js.native
    
    def signum(): typingsJapgolly.bigi.mod.bigi = js.native
    
    def square(): typingsJapgolly.bigi.mod.bigi = js.native
    
    def squareTo(r: Any): Unit = js.native
    
    def subTo(a: Any, r: Any): Unit = js.native
    
    def subtract(a: typingsJapgolly.bigi.mod.bigi): typingsJapgolly.bigi.mod.bigi = js.native
