...
import typingsJapgolly.baiduApp.anon.Connected
import typingsJapgolly.baiduApp.anon.DeviceId
import typingsJapgolly.baiduApp.anon.Devices
import typingsJapgolly.baiduApp.anon.IsConnected
import typingsJapgolly.baiduApp.anon.Level
import typingsJapgolly.baiduApp.anon.PartialCanvasToTempFilePa
import typingsJapgolly.baiduApp.anon.Title
import typingsJapgolly.baiduApp.swan.AccelerometerChangeCallback
import typingsJapgolly.baiduApp.swan.AccelerometerOptions
import typingsJapgolly.baiduApp.swan.AccountInfo
import typingsJapgolly.baiduApp.swan.ActionSheetOptions
import typingsJapgolly.baiduApp.swan.Animation
import typingsJapgolly.baiduApp.swan.App
import typingsJapgolly.baiduApp.swan.AppOptions
import typingsJapgolly.baiduApp.swan.AuthorizeOptions
import typingsJapgolly.baiduApp.swan.BackgroundAudioManager
import typingsJapgolly.baiduApp.swan.BaseOptions
import typingsJapgolly.baiduApp.swan.Beacon
import typingsJapgolly.baiduApp.swan.BluetoothAdapterState
import typingsJapgolly.baiduApp.swan.CameraContext
import typingsJapgolly.baiduApp.swan.CanvasContext
import typingsJapgolly.baiduApp.swan.CanvasImageDataOptions
import typingsJapgolly.baiduApp.swan.CanvasPutImageDataOptions
import typingsJapgolly.baiduApp.swan.CardOptions
import typingsJapgolly.baiduApp.swan.CheckSessionOption
import typingsJapgolly.baiduApp.swan.ChooseAddressOptions
import typingsJapgolly.baiduApp.swan.ChooseImageOptions
import typingsJapgolly.baiduApp.swan.ChooseInvoiceTitleOptions
import typingsJapgolly.baiduApp.swan.ChooseLocationOptions
import typingsJapgolly.baiduApp.swan.ChooseVideoOptions
import typingsJapgolly.baiduApp.swan.CloseBLEConnectionOptions
import typingsJapgolly.baiduApp.swan.CloseBluetoothAdapterOptions
import typingsJapgolly.baiduApp.swan.CloseSocketOptions
import typingsJapgolly.baiduApp.swan.CompassChangeCallback
import typingsJapgolly.baiduApp.swan.CompassOptions
import typingsJapgolly.baiduApp.swan.Component
import typingsJapgolly.baiduApp.swan.ConnectSocketOptions
import typingsJapgolly.baiduApp.swan.ConnectWiFiOptions
import typingsJapgolly.baiduApp.swan.CreateAnimationOptions
import typingsJapgolly.baiduApp.swan.CreateBLEConnectionOptions
import typingsJapgolly.baiduApp.swan.CreateIntersectionObserverOption
import typingsJapgolly.baiduApp.swan.DataResponse
import typingsJapgolly.baiduApp.swan.DownloadFileOptions
import typingsJapgolly.baiduApp.swan.DownloadTask
import typingsJapgolly.baiduApp.swan.DrawCanvasOptions
import typingsJapgolly.baiduApp.swan.EnableDebugOptions
import typingsJapgolly.baiduApp.swan.EnvInfo
import typingsJapgolly.baiduApp.swan.ExtConfig
import typingsJapgolly.baiduApp.swan.ExtendedComponent
import typingsJapgolly.baiduApp.swan.GetBLEDeviceCharacteristicsOptions
import typingsJapgolly.baiduApp.swan.GetBLEDeviceServicesOptions
import typingsJapgolly.baiduApp.swan.GetBackgroundAudioPlayerStateOptions
import typingsJapgolly.baiduApp.swan.GetBeaconsOptions
import typingsJapgolly.baiduApp.swan.GetBluetoothAdapterStateOptions
import typingsJapgolly.baiduApp.swan.GetBluetoothDevicesOptions
import typingsJapgolly.baiduApp.swan.GetConnectedBluetoothDevicesOptions
import typingsJapgolly.baiduApp.swan.GetConnectedWifiOptions
import typingsJapgolly.baiduApp.swan.GetExtConfigOptions
import typingsJapgolly.baiduApp.swan.GetFileInfoOptions
import typingsJapgolly.baiduApp.swan.GetImageInfoOptions
import typingsJapgolly.baiduApp.swan.GetLocationOptions
import typingsJapgolly.baiduApp.swan.GetNetworkTypeOptions
import typingsJapgolly.baiduApp.swan.GetSavedFileInfoOptions
import typingsJapgolly.baiduApp.swan.GetSavedFileListOptions
import typingsJapgolly.baiduApp.swan.GetScreenBrightnessOptions
import typingsJapgolly.baiduApp.swan.GetShareInfoOptions
import typingsJapgolly.baiduApp.swan.GetStorageInfoOptions
import typingsJapgolly.baiduApp.swan.GetStorageOptions
import typingsJapgolly.baiduApp.swan.GetSystemInfoOptions
import typingsJapgolly.baiduApp.swan.GetUserInfoOptions
import typingsJapgolly.baiduApp.swan.GetWifiListOptions
import typingsJapgolly.baiduApp.swan.InnerAudioContext
import typingsJapgolly.baiduApp.swan.IntersectionObserver
import typingsJapgolly.baiduApp.swan.LivePlayerContext
import typingsJapgolly.baiduApp.swan.LoadSubPackageOptions
import typingsJapgolly.baiduApp.swan.LoadingOptions
import typingsJapgolly.baiduApp.swan.Logger
import typingsJapgolly.baiduApp.swan.LoginOptions
import typingsJapgolly.baiduApp.swan.MakePhoneCallOptions
import typingsJapgolly.baiduApp.swan.MapContext
import typingsJapgolly.baiduApp.swan.MetaDescription
import typingsJapgolly.baiduApp.swan.MetaKeywords
import typingsJapgolly.baiduApp.swan.ModalOptions
import typingsJapgolly.baiduApp.swan.NavigateBackMiniProgramOptions
import typingsJapgolly.baiduApp.swan.NavigateBackOptions
import typingsJapgolly.baiduApp.swan.NavigateToMiniProgramOptions
import typingsJapgolly.baiduApp.swan.NavigateToOptions
import typingsJapgolly.baiduApp.swan.NotifyBLECharacteristicValueChanged
import typingsJapgolly.baiduApp.swan.OpenBluetoothAdapterOptions
import typingsJapgolly.baiduApp.swan.OpenCardOptions
import typingsJapgolly.baiduApp.swan.OpenDocumentOptions
import typingsJapgolly.baiduApp.swan.OpenLocationOptions
import typingsJapgolly.baiduApp.swan.OpenSettingOptions
import typingsJapgolly.baiduApp.swan.Page
import typingsJapgolly.baiduApp.swan.PageOptions
import typingsJapgolly.baiduApp.swan.PageScrollToOptions
import typingsJapgolly.baiduApp.swan.PhoneContact
import typingsJapgolly.baiduApp.swan.PlayBackgroundAudioOptions
import typingsJapgolly.baiduApp.swan.PlayVoiceOptions
import typingsJapgolly.baiduApp.swan.PreviewImageOptions
import typingsJapgolly.baiduApp.swan.ReLaunchOptions
import typingsJapgolly.baiduApp.swan.ReadBLECharacteristicValue
import typingsJapgolly.baiduApp.swan.RecorderManager
import typingsJapgolly.baiduApp.swan.RedirectToOptions
import typingsJapgolly.baiduApp.swan.RemoveSavedFileOptions
import typingsJapgolly.baiduApp.swan.RemoveStorageOptions
import typingsJapgolly.baiduApp.swan.RequestOptions
import typingsJapgolly.baiduApp.swan.RequestPaymentOptions
import typingsJapgolly.baiduApp.swan.RequestTask
import typingsJapgolly.baiduApp.swan.SaveFileOptions
import typingsJapgolly.baiduApp.swan.SaveImageToPhotosAlbumOptions
import typingsJapgolly.baiduApp.swan.SaveVideoOptions
import typingsJapgolly.baiduApp.swan.ScanCodeOptions
import typingsJapgolly.baiduApp.swan.SeekBackgroundAudioOptions
import typingsJapgolly.baiduApp.swan.SelectorQuery
import typingsJapgolly.baiduApp.swan.SendSocketMessageOptions
import typingsJapgolly.baiduApp.swan.SetClipboardDataOptions
import typingsJapgolly.baiduApp.swan.SetKeepScreenOnOptions
import typingsJapgolly.baiduApp.swan.SetNavigationBarColorOptions
import typingsJapgolly.baiduApp.swan.SetNavigationBarTitleOptions
import typingsJapgolly.baiduApp.swan.SetScreenBrightnessOptions
import typingsJapgolly.baiduApp.swan.SetStorageOptions
import typingsJapgolly.baiduApp.swan.SetTabBarBadgeOptions
import typingsJapgolly.baiduApp.swan.SetTabBarItemOptions
import typingsJapgolly.baiduApp.swan.SetTabBarStyleOptions
import typingsJapgolly.baiduApp.swan.SetTopBarTextOptions
import typingsJapgolly.baiduApp.swan.SetWifiListOptions
import typingsJapgolly.baiduApp.swan.ShareMenuOptions
import typingsJapgolly.baiduApp.swan.ShowTabBarOptions
import typingsJapgolly.baiduApp.swan.StartBeaconDiscoveryOptions
import typingsJapgolly.baiduApp.swan.StartRecordAudioOptions
import typingsJapgolly.baiduApp.swan.StopBeaconDiscoveryOptions
import typingsJapgolly.baiduApp.swan.StopBluetoothDevicesDiscoveryOptions
import typingsJapgolly.baiduApp.swan.StopRecordAudioOptions
import typingsJapgolly.baiduApp.swan.StorageInfo
import typingsJapgolly.baiduApp.swan.SwanIdOptions
import typingsJapgolly.baiduApp.swan.SwitchTabOptions
import typingsJapgolly.baiduApp.swan.SystemInfo
import typingsJapgolly.baiduApp.swan.TabBarBadgeOptions
import typingsJapgolly.baiduApp.swan.ThisTypedComponentOptionsWithRecordProps
import typingsJapgolly.baiduApp.swan.ToastOptions
import typingsJapgolly.baiduApp.swan.UpdateManager
import typingsJapgolly.baiduApp.swan.UpdateShareMenuOptions
import typingsJapgolly.baiduApp.swan.UploadFileOptions
import typingsJapgolly.baiduApp.swan.UploadTask
import typingsJapgolly.baiduApp.swan.VideoContext
import typingsJapgolly.baiduApp.swan.WiFi
import typingsJapgolly.baiduApp.swan.WriteBLECharacteristicValue
import typingsJapgolly.baiduApp.swan.ai.DetectIdentifyOptions
import typingsJapgolly.baiduApp.swan.ai.GeneralIdentifyOptions
import typingsJapgolly.baiduApp.swan.ai.VoiceRecognizerTask
import typingsJapgolly.baiduApp.swan.ai.animalClassifyOptions
import typingsJapgolly.baiduApp.swan.ai.carClassifyOptions
import typingsJapgolly.baiduApp.swan.ai.dishClassifyOptions
import typingsJapgolly.baiduApp.swan.ai.imageAuditOptions
import typingsJapgolly.baiduApp.swan.ai.logoClassifyOptions
import typingsJapgolly.baiduApp.swan.ai.ocrBankCardOptions
import typingsJapgolly.baiduApp.swan.ai.ocrDrivingLicenseOptions
import typingsJapgolly.baiduApp.swan.ai.ocrIdCardOptions
import typingsJapgolly.baiduApp.swan.ai.ocrVehicleLicenseOptions
import typingsJapgolly.baiduApp.swan.ai.plantClassifyOptions
import typingsJapgolly.baiduApp.swan.ai.textReviewOptions
import typingsJapgolly.baiduApp.swan.ai.textToAudioOptions
import typingsJapgolly.baiduApp.swan.navigateBackSmartProgramOptions
import typingsJapgolly.baiduApp.swan.navigateToSmartProgramOptions
import typingsJapgolly.baiduApp.swan.openShareOptions
import typingsJapgolly.baiduApp.swan.requestPolymerPaymentOptions
import typingsJapgolly.baiduApp.swan.verifyOptions
...
object global {
  ...
  /**
    ...
    */
  inline def App[T /* <: AppOptions */](app: T & (ThisType[T & typingsJapgolly.baiduApp.swan.App])): Unit = js.Dynamic.global.applyDynamic("App")(app.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  // #endregion
  // #region Compontent组件
  inline def Component[D, M, P](): ExtendedComponent[typingsJapgolly.baiduApp.swan.Component[D, P], D, M, P] = js.Dynamic.global.applyDynamic("Component")().asInstanceOf[ExtendedComponent[typingsJapgolly.baiduApp.swan.Component[D, P], D, M, P]]
  inline def Component[D, M, P](
    options: ThisTypedComponentOptionsWithRecordProps[typingsJapgolly.baiduApp.swan.Component[D, P], D, M, P]
  ): ExtendedComponent[typingsJapgolly.baiduApp.swan.Component[D, P], D, M, P] = js.Dynamic.global.applyDynamic("Component")(options.asInstanceOf[js.Any]).asInstanceOf[ExtendedComponent[typingsJapgolly.baiduApp.swan.Component[D, P], D, M, P]]
  ...
  /**
    ...
    */
  inline def Page[T /* <: PageOptions & js.Object */](page: T & (ThisType[T & (typingsJapgolly.baiduApp.swan.Page[js.Object, js.Object])])): Unit = js.Dynamic.global.applyDynamic("Page")(page.asInstanceOf[js.Any]).asInstanceOf[Unit]
