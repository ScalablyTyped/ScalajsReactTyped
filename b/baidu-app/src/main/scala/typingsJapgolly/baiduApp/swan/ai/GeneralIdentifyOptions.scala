...
object GeneralIdentifyOptions {
  ...
  extension [Self <: GeneralIdentifyOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ GeneralIdentifyResponse => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ GeneralIdentifyResponse) => value(t0).runNow()))
