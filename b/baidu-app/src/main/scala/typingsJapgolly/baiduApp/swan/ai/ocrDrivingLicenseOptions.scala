...
object ocrDrivingLicenseOptions {
  ...
  extension [Self <: ocrDrivingLicenseOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ ocrDrivingLicenseResponse => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ ocrDrivingLicenseResponse) => value(t0).runNow()))
