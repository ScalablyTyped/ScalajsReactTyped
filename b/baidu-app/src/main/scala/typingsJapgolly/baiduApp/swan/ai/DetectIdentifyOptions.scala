...
object DetectIdentifyOptions {
  ...
  extension [Self <: DetectIdentifyOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ DetectIdentifyResponse => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ DetectIdentifyResponse) => value(t0).runNow()))
