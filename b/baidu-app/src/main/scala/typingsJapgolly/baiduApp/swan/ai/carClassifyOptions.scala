...
object carClassifyOptions {
  ...
  extension [Self <: carClassifyOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ carClassifyResponse => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ carClassifyResponse) => value(t0).runNow()))
