...
import typingsJapgolly.baiduApp.AnonLatitude
...
object GetCenterLocationOptions {
  ...
  def apply(
    ...
    __obj.updateDynamic("success")(js.Any.fromFunction1((t0: typingsJapgolly.baiduApp.AnonLatitude) => success(t0).runNow()))
