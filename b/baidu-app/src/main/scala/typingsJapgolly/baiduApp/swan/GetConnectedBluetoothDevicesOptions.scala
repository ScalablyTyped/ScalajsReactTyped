...
import typingsJapgolly.baiduApp.devicesArrayBluetoothDevi
...
object GetConnectedBluetoothDevicesOptions {
  ...
  def apply(
    ...
    __obj.updateDynamic("success")(js.Any.fromFunction1((t0: typingsJapgolly.baiduApp.devicesArrayBluetoothDevi) => success(t0).runNow()))
