...
import typingsJapgolly.baiduApp.AnonCityName
...
object ChooseAddressOptions {
  ...
  def apply(
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.baiduApp.AnonCityName) => success(t0).runNow()))
