...
import typingsJapgolly.baiduApp.AnonShareTickets
...
object ShareAppMessage {
  ...
  def apply(
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.baiduApp.AnonShareTickets) => success(t0).runNow()))
