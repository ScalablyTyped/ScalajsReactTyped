...
import typingsJapgolly.baiduApp.anon.ErrCode
...
object RequestOptions {
  ...
  extension [Self <: RequestOptions](x: Self) {
    ...
    inline def setFail(value: /* err */ ErrCode => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* err */ ErrCode) => value(t0).runNow()))
