...
object textReviewOptions {
  ...
  extension [Self <: textReviewOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ textReviewResponse => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ textReviewResponse) => value(t0).runNow()))
