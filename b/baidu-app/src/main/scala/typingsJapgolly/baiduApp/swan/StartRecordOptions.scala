...
object StartRecordOptions {
  ...
  def apply(
    ...
    if (timeoutCallback != null) __obj.updateDynamic("timeoutCallback")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.baiduApp.swan.RecordResponse) => timeoutCallback(t0).runNow()))
