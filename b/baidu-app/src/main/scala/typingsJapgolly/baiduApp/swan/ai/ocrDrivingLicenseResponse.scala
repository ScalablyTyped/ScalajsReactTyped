...
object ocrDrivingLicenseResponse {
  ...
  inline def apply(log_id: String, words_result: StringDictionary[Words], words_result_num: Double): ocrDrivingLicenseResponse = {
  ...
  extension [Self <: ocrDrivingLicenseResponse](x: Self) {
