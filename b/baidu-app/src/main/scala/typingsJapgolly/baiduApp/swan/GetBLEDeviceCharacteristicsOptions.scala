...
import typingsJapgolly.baiduApp.characteristicsArrayuuids
...
object GetBLEDeviceCharacteristicsOptions {
  ...
  def apply(
    ...
    __obj.updateDynamic("success")(js.Any.fromFunction1((t0: typingsJapgolly.baiduApp.characteristicsArrayuuids) => success(t0).runNow()))
