...
import typingsJapgolly.baiduApp.AnonProbability
...
trait logoClassifyResponse extends js.Object {
  var log_id: Double
   // 识别结果数，标识返回结果数目。
  var result: js.Array[AnonProbability]
   // 	唯一的log id，用于问题定位。
...
object logoClassifyResponse {
  @scala.inline
  def apply(log_id: Double, result: js.Array[AnonProbability], result_num: Double): logoClassifyResponse = {
