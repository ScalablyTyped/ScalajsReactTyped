...
import typingsJapgolly.baiduApp.AnonCancel
...
object ModalOptions {
  ...
  def apply(
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.baiduApp.AnonCancel) => success(t0).runNow()))
