...
object ocrVehicleLicenseOptions {
  ...
  def apply(
    ...
    success: /* res */ ocrVehicleLicenseResponse => Callback = null
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.baiduApp.swan.ai.ocrVehicleLicenseResponse) => success(t0).runNow()))
