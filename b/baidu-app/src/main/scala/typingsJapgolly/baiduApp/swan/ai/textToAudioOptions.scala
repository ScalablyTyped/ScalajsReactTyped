...
object textToAudioOptions {
  ...
  def apply(
    ...
    pit: String = null,
    spd: String = null,
    success: /* res */ textToAudioResponse => Callback = null,
    vol: String = null
  ): textToAudioOptions = {
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.baiduApp.swan.ai.textToAudioResponse) => success(t0).runNow()))
