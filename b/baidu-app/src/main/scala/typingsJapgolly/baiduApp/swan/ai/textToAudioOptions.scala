...
object textToAudioOptions {
  ...
  extension [Self <: textToAudioOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ textToAudioResponse => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ textToAudioResponse) => value(t0).runNow()))
