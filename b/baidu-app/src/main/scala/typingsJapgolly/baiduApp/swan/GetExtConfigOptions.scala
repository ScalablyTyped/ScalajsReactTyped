...
import typingsJapgolly.baiduApp.errMsgstringExtConfig
...
object GetExtConfigOptions {
  ...
  def apply(
    ...
    __obj.updateDynamic("success")(js.Any.fromFunction1((t0: typingsJapgolly.baiduApp.errMsgstringExtConfig) => success(t0).runNow()))
