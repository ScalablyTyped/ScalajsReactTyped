...
import typingsJapgolly.baiduApp.anon.FilePath
...
object RemoveSavedFileOptions {
  ...
  extension [Self <: RemoveSavedFileOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ FilePath => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ FilePath) => value(t0).runNow()))
