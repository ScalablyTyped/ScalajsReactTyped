...
import typingsJapgolly.baiduApp.PartialLifetimes
import typingsJapgolly.baiduApp.PartialPageLifetimes
import typingsJapgolly.baiduApp.PartialaddGlobalClassbool
