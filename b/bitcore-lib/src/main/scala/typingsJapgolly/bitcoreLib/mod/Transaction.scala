...
import typingsJapgolly.bitcoreLib.mod.Transaction.Input
import typingsJapgolly.bitcoreLib.mod.Transaction.Output
import typingsJapgolly.bitcoreLib.mod.Transaction.UnspentOutput
import typingsJapgolly.bitcoreLib.mod.crypto.Signature
