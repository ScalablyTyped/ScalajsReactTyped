...
import typingsJapgolly.bitcoreLib.anon.PrevHash
import typingsJapgolly.bitcoreLib.anon.Reverse
import typingsJapgolly.bitcoreLib.bitcoreLibStrings.little
...
object mod {
  ...
  open class Message protected () extends StObject {
    ...
    def toObject(): typingsJapgolly.bitcoreLib.anon.Message = js.native
