...
object listItemsPropsMod extends js.Object {
  ...
  trait IListItemsProps[T] extends IProps {
    ...
    /**
      ...
      */
    var initialContent: js.UndefOr[Node | Null] = js.native
    /**
    ...
    /**
      ...
      * This prop is ignored if a custom `itemListRenderer` is supplied.
      */
    var noResults: js.UndefOr[Node] = js.native
    /**
    ...
    def onItemSelect(item: T, event: ReactEventFrom[HTMLElement]): Unit = js.native
  }
