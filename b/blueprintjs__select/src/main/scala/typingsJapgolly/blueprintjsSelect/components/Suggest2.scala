...
object Suggest2 {
  ...
  inline def apply[T](
    ...
    val __props = js.Dynamic.literal(inputValueRenderer = js.Any.fromFunction1(inputValueRenderer), itemRenderer = js.Any.fromFunction2(itemRenderer), items = items.asInstanceOf[js.Any], onItemSelect = js.Any.fromFunction2((t0: T, t1: js.UndefOr[ReactEventFrom[HTMLElement]]) => (onItemSelect(t0, t1)).runNow()))
    new Builder[T](js.Array(this.component, __props.asInstanceOf[Suggest2Props[T]]))
  }
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsSelect.mod.Suggest2[T]] {
    ...
    inline def defaultSelectedItem(value: T): this.type = set("defaultSelectedItem", value.asInstanceOf[js.Any])
    ...
    inline def selectedItem(value: T): this.type = set("selectedItem", value.asInstanceOf[js.Any])
    
    inline def selectedItemNull: this.type = set("selectedItem", null)
  }
  
  def withProps[T](p: Suggest2Props[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
