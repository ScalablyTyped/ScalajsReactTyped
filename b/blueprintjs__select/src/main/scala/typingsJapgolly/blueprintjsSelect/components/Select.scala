...
object Select {
  def apply[T](
    ...
    ISelectProps[T], 
    typingsJapgolly.blueprintjsSelect.mod.Select[T], 
    Unit, 
    ISelectProps[T]
  ] = {
  ...
  typingsJapgolly.blueprintjsSelect.selectMod.ISelectProps[T], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsSelect.mod.Select[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsSelect.selectMod.ISelectProps[T]])(children: _*)
  }
