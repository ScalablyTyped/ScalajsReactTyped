...
import typingsJapgolly.blueprintjsSelect.libEsmComponentsSuggestSuggestMod.ISuggestProps
...
object Suggest {
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsSelect.mod.Suggest[T]] {
