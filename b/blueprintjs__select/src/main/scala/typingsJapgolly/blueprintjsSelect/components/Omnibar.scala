...
import typingsJapgolly.blueprintjsSelect.anon.PartialOverlayProps
...
import typingsJapgolly.blueprintjsSelect.libEsmComponentsOmnibarOmnibarMod.IOmnibarProps
...
object Omnibar {
  ...
  inline def apply[T](
    ...
    val __props = js.Dynamic.literal(isOpen = isOpen.asInstanceOf[js.Any], itemRenderer = js.Any.fromFunction2(itemRenderer), items = items.asInstanceOf[js.Any], onItemSelect = js.Any.fromFunction2((t0: T, t1: js.UndefOr[ReactEventFrom[HTMLElement]]) => (onItemSelect(t0, t1)).runNow()))
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsSelect.mod.Omnibar[T]] {
    ...
    inline def onClose(value: /* event */ js.UndefOr[ReactEventFrom[HTMLElement]] => Callback): this.type = set("onClose", js.Any.fromFunction1((t0: /* event */ js.UndefOr[ReactEventFrom[HTMLElement]]) => value(t0).runNow()))
    ...
    inline def overlayProps(value: PartialOverlayProps): this.type = set("overlayProps", value.asInstanceOf[js.Any])
