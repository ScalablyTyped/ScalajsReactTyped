...
import typingsJapgolly.blueprintjsSelect.PartialIOverlayProps
...
object Omnibar {
  def apply[T](
    ...
    IOmnibarProps[T], 
    typingsJapgolly.blueprintjsSelect.mod.Omnibar[T], 
    Unit, 
    IOmnibarProps[T]
  ] = {
  ...
  typingsJapgolly.blueprintjsSelect.omnibarMod.IOmnibarProps[T], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsSelect.mod.Omnibar[T]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsSelect.omnibarMod.IOmnibarProps[T]])(children: _*)
  }
