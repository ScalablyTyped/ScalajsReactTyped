...
object MultiSelect2 {
  ...
  inline def apply[T](
    ...
    selectedItems: js.Array[T],
    tagRenderer: T => Node
  ): Builder[T] = {
    val __props = js.Dynamic.literal(itemRenderer = js.Any.fromFunction2(itemRenderer), items = items.asInstanceOf[js.Any], onItemSelect = js.Any.fromFunction2((t0: T, t1: js.UndefOr[ReactEventFrom[HTMLElement]]) => (onItemSelect(t0, t1)).runNow()), selectedItems = selectedItems.asInstanceOf[js.Any], tagRenderer = js.Any.fromFunction1(tagRenderer))
    new Builder[T](js.Array(this.component, __props.asInstanceOf[MultiSelect2Props[T]]))
  }
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsSelect.mod.MultiSelect2[T]] {
    ...
    inline def tagInputProps(value: PartialTagInputProps): this.type = set("tagInputProps", value.asInstanceOf[js.Any])
  }
  
  def withProps[T](p: MultiSelect2Props[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
