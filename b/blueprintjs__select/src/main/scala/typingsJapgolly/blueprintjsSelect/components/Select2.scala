...
object Select2 {
  ...
  inline def apply[T](
    ...
    new Builder[T](js.Array(this.component, __props.asInstanceOf[Select2Props[T]]))
  }
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsSelect.mod.Select2[T]] {
  ...
  def withProps[T](p: Select2Props[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
