...
import typingsJapgolly.blueprintjsSelect.libEsmComponentsQueryListQueryListMod.IQueryListProps
import typingsJapgolly.blueprintjsSelect.libEsmComponentsQueryListQueryListMod.QueryListRendererProps
...
object QueryList {
  ...
  inline def apply[T](
    ...
    renderer: QueryListRendererProps[T] => Element
  ): Builder[T] = {
    val __props = js.Dynamic.literal(itemRenderer = js.Any.fromFunction2(itemRenderer), items = items.asInstanceOf[js.Any], onItemSelect = js.Any.fromFunction2((t0: T, t1: js.UndefOr[ReactEventFrom[HTMLElement]]) => (onItemSelect(t0, t1)).runNow()), renderer = js.Any.fromFunction1(renderer))
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsSelect.mod.QueryList[T]] {
    ...
    inline def initialActiveItem(value: T): this.type = set("initialActiveItem", value.asInstanceOf[js.Any])
