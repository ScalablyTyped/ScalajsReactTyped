...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.bagpipes.bagpipesStrings.hoist
    - typingsJapgolly.bagpipes.bagpipesStrings.sink
  */
  trait Affinity extends StObject
  object Affinity {
    
    inline def hoist: typingsJapgolly.bagpipes.bagpipesStrings.hoist = "hoist".asInstanceOf[typingsJapgolly.bagpipes.bagpipesStrings.hoist]
    
    inline def sink: typingsJapgolly.bagpipes.bagpipesStrings.sink = "sink".asInstanceOf[typingsJapgolly.bagpipes.bagpipesStrings.sink]
  }
