...
import typingsJapgolly.antvG2plot.libTypesTooltipMod.TooltipOptions
...
object libPlotsCoreInterfaceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.bizcharts.bizchartsBooleans.`false`
    - typingsJapgolly.bizcharts.anon.AxisOptionsOmitMetavalues
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.bizcharts.bizchartsBooleans.`false`
    - typingsJapgolly.bizcharts.libPlotsCoreInterfaceMod.LabelOptions
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.bizcharts.bizchartsBooleans.`false`
    - typingsJapgolly.bizcharts.libPlotsCoreInterfaceMod.LengendOptions
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.bizcharts.bizchartsBooleans.`false`
    - typingsJapgolly.bizcharts.libPlotsCoreInterfaceMod.TooltipCfg
  */
