...
object libG2AllMod {
  ...
  @JSImport("bizcharts/lib/g2-all", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /** range-filter 只用于：brush-filter, brush-x-filter, brush-y-filter */
  @JSImport("bizcharts/lib/g2-all", "BRUSH_FILTER_EVENTS")
  @js.native
  ...
  /* note: abstract class */ @JSImport("bizcharts/lib/g2-all", "ComponentController")
  @js.native
  ...
  @JSImport("bizcharts/lib/g2-all", "Coordinate")
  @js.native
  /**
  ...
  @JSImport("bizcharts/lib/g2-all", "DIRECTION")
  @js.native
  ...
  @JSImport("bizcharts/lib/g2-all", "ELEMENT_RANGE_HIGHLIGHT_EVENTS")
  @js.native
  ...
  @JSImport("bizcharts/lib/g2-all", "Element")
  @js.native
  ...
  /* note: abstract class */ @JSImport("bizcharts/lib/g2-all", "Facet")
  @js.native
  ...
  @JSImport("bizcharts/lib/g2-all", "Geometry")
  @js.native
  ...
  @JSImport("bizcharts/lib/g2-all", "GeometryLabel")
  @js.native
  ...
  /**
    * Action 的基类
    */
  /* note: abstract class */ @JSImport("bizcharts/lib/g2-all", "InteractionAction")
  @js.native
  ...
  @JSImport("bizcharts/lib/g2-all", "LAYER")
  @js.native
  ...
  @JSImport("bizcharts/lib/g2-all", "TooltipController")
  @js.native
  ...
  object Util {
    ...
    @JSImport("bizcharts/lib/g2-all", "Util")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("bizcharts/lib/g2-all", "Util.getAngle")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.getDelegationObject")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.getLegendItems")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.getMappingValue")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.getPath")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.getPathPoints")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.getSectorPath")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.getTooltipItems")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.polarToCartesian")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.rotate")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.translate")
    @js.native
    ...
    @JSImport("bizcharts/lib/g2-all", "Util.zoom")
    @js.native
  ...
  @JSImport("bizcharts/lib/g2-all", "VERSION")
  @js.native
  val VERSION: /* "4.2.8" */ String = js.native
  
  @JSImport("bizcharts/lib/g2-all", "VIEW_LIFE_CIRCLE")
  @js.native
