...
object G2 {
  ...
  open class ComponentController[O] protected ()
    extends typingsJapgolly.bizcharts.libG2AllMod.ComponentController[O] {
    def this(view: typingsJapgolly.antvG2.libChartViewMod.View) = this()
  }
  ...
  open class Coordinate ()
    extends typingsJapgolly.bizcharts.libG2AllMod.Coordinate {
  ...
  open class Element protected ()
    extends typingsJapgolly.bizcharts.libG2AllMod.Element {
  ...
  open class Facet[C /* <: FacetCfg[FacetData] */, F /* <: FacetData */] protected ()
    extends typingsJapgolly.bizcharts.libG2AllMod.Facet[C, F] {
  ...
  open class Geometry[S /* <: ShapePoint */] protected ()
    extends typingsJapgolly.bizcharts.libG2AllMod.Geometry[S] {
    /**
      * 创建 Geometry 实例。
      * @param cfg
      */
  ...
  open class GeometryLabel protected ()
    extends typingsJapgolly.bizcharts.libG2AllMod.GeometryLabel {
  ...
  open class InteractionAction[T] protected ()
    extends typingsJapgolly.bizcharts.libG2AllMod.InteractionAction[T] {
  ...
  open class TooltipController ()
    extends typingsJapgolly.bizcharts.libG2AllMod.TooltipController
  ...
  object antvG2LibChartViewAugmentingMod {
    ...
    trait View extends StObject {
      ...
      /**
        ...
        */
      def point(): typingsJapgolly.antvG2.libInterfaceMod.Point = js.native
      def point(cfg: PartialGeometryCfg): typingsJapgolly.antvG2.libInterfaceMod.Point = js.native
