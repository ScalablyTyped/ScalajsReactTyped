...
- typingsJapgolly.react.mod.Props because var conflicts: children. Inlined key, ref */ trait ChartProps
  extends DOMAttributes[js.Object]
     with /* event */ StringDictionary[js.Any] {
  var animate: js.UndefOr[Boolean] = js.undefined
  var background: js.UndefOr[typingsJapgolly.antvG2.mod.Styles.background] = js.undefined
  ...
  // 事件属性
  var onGetG2Instance: js.UndefOr[js.Function1[/* chart */ typingsJapgolly.antvG2.mod.Chart, Unit]] = js.undefined
