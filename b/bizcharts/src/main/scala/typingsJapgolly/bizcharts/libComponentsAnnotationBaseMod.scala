...
object libComponentsAnnotationBaseMod {
  
  /* note: abstract class */ @JSImport("bizcharts/lib/components/Annotation/base", JSImport.Default)
  @js.native
  open class default[PropsI] () extends Annotation[PropsI]
  object default {
