...
object Callback {
  ...
  extension [Self <: Callback](x: Self) {
    ...
    inline def setPauseCallback(value: japgolly.scalajs.react.Callback): Self = StObject.set(x, "pauseCallback", value.toJsFn)
    ...
    inline def setResumeCallback(value: japgolly.scalajs.react.Callback): Self = StObject.set(x, "resumeCallback", value.toJsFn)
