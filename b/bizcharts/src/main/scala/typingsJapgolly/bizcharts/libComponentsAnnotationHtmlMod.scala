...
object libComponentsAnnotationHtmlMod {
  ...
  - typingsJapgolly.bizcharts.libComponentsAnnotationHtmlMod.BaseProps because var conflicts: animate, animateOption, offsetY, top, `type`. Inlined chartIns */ trait HtmlAnnotationProps
    extends StObject
