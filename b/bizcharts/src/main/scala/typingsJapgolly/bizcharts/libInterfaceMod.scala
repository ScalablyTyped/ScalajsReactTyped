...
object libInterfaceMod {
  ...
  open class Chart protected ()
    extends typingsJapgolly.antvG2.libChartMod.Chart {
  ...
  trait IChartProps
    ...
    /**
      ...
      */
    var ErrorBoundaryProps: js.UndefOr[typingsJapgolly.reactErrorBoundary.mod.ErrorBoundaryProps] = js.undefined
    ...
    /**
      ...
      * @example ErrorBoundaryProps={{FallbackComponent: error => <div>{error}</div>}}
      */
    var errorContent: js.UndefOr[japgolly.scalajs.react.facade.React.Element] = js.undefined
  ...
  object IChartProps {
    ...
    extension [Self <: IChartProps](x: Self) {
      ...
      inline def setErrorContent(value: VdomElement): Self = StObject.set(x, "errorContent", value.rawElement.asInstanceOf[js.Any])
  ...
  trait IEvent
    ...
    var view: js.UndefOr[typingsJapgolly.antvG2.libChartViewMod.View] = js.undefined
  ...
  object IEvent {
    ...
    extension [Self <: IEvent](x: Self) {
      ...
      inline def setView(value: typingsJapgolly.antvG2.libChartViewMod.View): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
