...
object DonutChart {
  ...
  inline def apply(angleField: String, colorField: String, data: js.Array[Record[String, Any]]): Builder = {
    val __props = js.Dynamic.literal(angleField = angleField.asInstanceOf[js.Any], colorField = colorField.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[DonutOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "DonutChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def pieStyle(value: StyleAttr): this.type = set("pieStyle", value.asInstanceOf[js.Any])
    
    inline def pieStyleFunction1(value: /* datum */ Datum => ShapeStyle): this.type = set("pieStyle", js.Any.fromFunction1(value))
  ...
  def withProps(p: DonutOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
