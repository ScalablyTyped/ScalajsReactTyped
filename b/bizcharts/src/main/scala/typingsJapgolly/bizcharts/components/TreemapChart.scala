...
object TreemapChart {
  ...
  @JSImport("bizcharts", "TreemapChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def data(value: Record[String, Any]): this.type = set("data", value.asInstanceOf[js.Any])
    ...
    inline def drilldown(value: DrillDownCfg): this.type = set("drilldown", value.asInstanceOf[js.Any])
    ...
    inline def hierarchyConfig(value: OmitHierarchyOptionastype): this.type = set("hierarchyConfig", value.asInstanceOf[js.Any])
    ...
    inline def maxLevel(value: Double): this.type = set("maxLevel", value.asInstanceOf[js.Any])
    ...
    inline def rawFields(value: js.Array[String]): this.type = set("rawFields", value.asInstanceOf[js.Any])
    
    inline def rawFieldsVarargs(value: String*): this.type = set("rawFields", js.Array(value*))
    
    inline def rectStyle(value: StyleAttr): this.type = set("rectStyle", value.asInstanceOf[js.Any])
    
    inline def rectStyleFunction1(value: /* datum */ Datum => ShapeStyle): this.type = set("rectStyle", js.Any.fromFunction1(value))
  ...
  implicit def make(companion: TreemapChart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TreemapOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
