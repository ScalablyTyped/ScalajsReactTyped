...
object RangeBarChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[RangeBarOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "RangeBarChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def barBackground(value: `0`): this.type = set("barBackground", value.asInstanceOf[js.Any])
    
    inline def barSize(value: Double): this.type = set("barSize", value.asInstanceOf[js.Any])
    
    inline def barStyle(value: StyleAttr): this.type = set("barStyle", value.asInstanceOf[js.Any])
    
    inline def barStyleFunction1(value: /* datum */ Datum => ShapeStyle): this.type = set("barStyle", js.Any.fromFunction1(value))
    
    inline def barWidthRatio(value: Double): this.type = set("barWidthRatio", value.asInstanceOf[js.Any])
    ...
    inline def colorField(value: Any): this.type = set("colorField", value.asInstanceOf[js.Any])
    ...
    inline def maxBarWidth(value: Double): this.type = set("maxBarWidth", value.asInstanceOf[js.Any])
    
    inline def meta(value: Record[String, Meta]): this.type = set("meta", value.asInstanceOf[js.Any])
    
    inline def minBarWidth(value: Double): this.type = set("minBarWidth", value.asInstanceOf[js.Any])
  ...
  def withProps(p: RangeBarOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
