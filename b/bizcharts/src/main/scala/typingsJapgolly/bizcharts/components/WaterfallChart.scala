...
import typingsJapgolly.antvG2plot.antvG2plotStrings.absolute
import typingsJapgolly.antvG2plot.antvG2plotStrings.auto
import typingsJapgolly.antvG2plot.antvG2plotStrings.canvas
import typingsJapgolly.antvG2plot.antvG2plotStrings.difference
import typingsJapgolly.antvG2plot.antvG2plotStrings.svg
import typingsJapgolly.antvG2plot.libCorePlotMod.Plot
import typingsJapgolly.antvG2plot.libPlotsWaterfallTypesMod.LeaderLineCfg
import typingsJapgolly.antvG2plot.libPlotsWaterfallTypesMod.TotalCfg
...
object WaterfallChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[WaterfallOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "WaterfallChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def fallingFill(value: String): this.type = set("fallingFill", value.asInstanceOf[js.Any])
    ...
    inline def labelMode(value: absolute | difference): this.type = set("labelMode", value.asInstanceOf[js.Any])
    
    inline def leaderLine(value: `false` | LeaderLineCfg): this.type = set("leaderLine", value.asInstanceOf[js.Any])
    ...
    inline def risingFill(value: String): this.type = set("risingFill", value.asInstanceOf[js.Any])
    ...
    inline def total(value: `false` | TotalCfg): this.type = set("total", value.asInstanceOf[js.Any])
    
    inline def useDeferredLabel(value: Boolean | Double): this.type = set("useDeferredLabel", value.asInstanceOf[js.Any])
    
    inline def waterfallStyle(value: StyleAttr): this.type = set("waterfallStyle", value.asInstanceOf[js.Any])
    
    inline def waterfallStyleFunction1(value: /* datum */ Datum => ShapeStyle): this.type = set("waterfallStyle", js.Any.fromFunction1(value))
  ...
  def withProps(p: WaterfallOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
