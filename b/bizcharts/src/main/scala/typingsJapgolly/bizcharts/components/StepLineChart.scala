...
object StepLineChart {
  
  inline def apply(data: js.Array[Record[String, Any]]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[StepLineOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "StepLineChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def area(value: js.UndefOr[MappingOptions] & PickPointGeometryOptionss): this.type = set("area", value.asInstanceOf[js.Any])
    ...
    inline def customInfo(value: Any): this.type = set("customInfo", value.asInstanceOf[js.Any])
    ...
    inline def lineShape(value: ShapeAttr): this.type = set("lineShape", value.asInstanceOf[js.Any])
    
    inline def lineShapeFunction1(value: /* datum */ Datum => String): this.type = set("lineShape", js.Any.fromFunction1(value))
    
    inline def lineShapeVarargs(value: String*): this.type = set("lineShape", js.Array(value*))
    
    inline def lineStyle(value: StyleAttr): this.type = set("lineStyle", value.asInstanceOf[js.Any])
    
    inline def lineStyleFunction1(value: /* datum */ Datum => ShapeStyle): this.type = set("lineStyle", js.Any.fromFunction1(value))
    ...
    inline def point(value: (js.UndefOr[MappingOptions] & PickPointGeometryOptionss) | Boolean): this.type = set("point", value.asInstanceOf[js.Any])
    
    inline def reflect(value: x | y | (js.Tuple2[x, y])): this.type = set("reflect", value.asInstanceOf[js.Any])
    ...
    inline def step(value: hv | vh | vhv | hvh): this.type = set("step", value.asInstanceOf[js.Any])
    
    inline def stepType(value: String): this.type = set("stepType", value.asInstanceOf[js.Any])
    ...
    inline def yField(value: String): this.type = set("yField", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: StepLineOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
