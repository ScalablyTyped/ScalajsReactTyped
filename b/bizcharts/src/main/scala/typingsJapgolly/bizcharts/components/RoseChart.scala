...
object RoseChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[RoseOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "RoseChart")
  @js.native
  ...
  def withProps(p: RoseOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
