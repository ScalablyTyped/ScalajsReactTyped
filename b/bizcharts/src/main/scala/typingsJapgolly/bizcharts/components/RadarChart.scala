...
import typingsJapgolly.bizcharts.libPlotsRadarChartMod.LineAPIOptions
...
object RadarChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[RadarOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "RadarChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def angleAxis(value: Any): this.type = set("angleAxis", value.asInstanceOf[js.Any])
    
    inline def angleField(value: String): this.type = set("angleField", value.asInstanceOf[js.Any])
    ...
    inline def area(value: MappingOptions): this.type = set("area", value.asInstanceOf[js.Any])
    ...
    inline def line(value: LineAPIOptions): this.type = set("line", value.asInstanceOf[js.Any])
    
    inline def lineStyle(
      value: ShapeStyle | (js.Function3[/* x */ Any, /* y */ Any, /* series */ js.UndefOr[Any], ShapeStyle])
    ): this.type = set("lineStyle", value.asInstanceOf[js.Any])
    
    inline def lineStyleFunction3(value: (/* x */ Any, /* y */ Any, /* series */ js.UndefOr[Any]) => ShapeStyle): this.type = set("lineStyle", js.Any.fromFunction3(value))
    ...
    inline def point(value: js.UndefOr[MappingOptions] & PickPointGeometryOptionss): this.type = set("point", value.asInstanceOf[js.Any])
    
    inline def radius(value: Double): this.type = set("radius", value.asInstanceOf[js.Any])
    
    inline def radiusAxis(value: Any): this.type = set("radiusAxis", value.asInstanceOf[js.Any])
    
    inline def radiusField(value: String): this.type = set("radiusField", value.asInstanceOf[js.Any])
    ...
    inline def xAxis(value: Any): this.type = set("xAxis", value.asInstanceOf[js.Any])
    
    inline def yAxis(value: Any): this.type = set("yAxis", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: RadarOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
