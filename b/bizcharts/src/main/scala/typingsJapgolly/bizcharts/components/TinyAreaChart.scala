...
object TinyAreaChart {
  
  inline def apply(data: js.Array[Double | (Record[String, Any])]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TinyAreaOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "TinyAreaChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def areaStyleFunction1(value: /* datum */ Datum => ShapeStyle): this.type = set("areaStyle", js.Any.fromFunction1(value))
    ...
    inline def line(value: MappingOptions): this.type = set("line", value.asInstanceOf[js.Any])
  ...
  def withProps(p: TinyAreaOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
