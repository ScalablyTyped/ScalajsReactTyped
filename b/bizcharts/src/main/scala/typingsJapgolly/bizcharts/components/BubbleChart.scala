...
object BubbleChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[BubbleOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "BubbleChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def pointSize(value: Any): this.type = set("pointSize", value.asInstanceOf[js.Any])
    ...
    inline def trendLine(value: Any): this.type = set("trendLine", value.asInstanceOf[js.Any])
  ...
  def withProps(p: BubbleOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
