...
object GroupedBarChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[GroupedBarOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "GroupedBarChart")
  @js.native
  ...
  def withProps(p: GroupedBarOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
