...
import typingsJapgolly.antvG2plot.libPlotsLiquidTypesMod.Outline
import typingsJapgolly.antvG2plot.libPlotsLiquidTypesMod.ShapeCallback
import typingsJapgolly.antvG2plot.libPlotsLiquidTypesMod.Wave
...
object LiquidChart {
  ...
  @JSImport("bizcharts", "LiquidChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def liquidStyle(value: StyleAttr): this.type = set("liquidStyle", value.asInstanceOf[js.Any])
    
    inline def liquidStyleFunction1(value: /* datum */ Datum => ShapeStyle): this.type = set("liquidStyle", js.Any.fromFunction1(value))
    ...
    inline def outline(value: Outline): this.type = set("outline", value.asInstanceOf[js.Any])
    ...
    inline def shape(value: String | ShapeCallback): this.type = set("shape", value.asInstanceOf[js.Any])
    
    inline def shapeFunction4(
      value: (/* x */ Double, /* y */ Double, /* width */ Double, /* height */ Double) => js.Array[PathCommand]
    ): this.type = set("shape", js.Any.fromFunction4(value))
    ...
    inline def wave(value: Wave): this.type = set("wave", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: LiquidChart.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: LiquidOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
