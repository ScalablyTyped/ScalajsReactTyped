...
object CalendarChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[CalendarOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "CalendarChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def colors(value: ColorAttr): this.type = set("colors", value.asInstanceOf[js.Any])
    
    inline def colorsFunction2(value: (/* datum */ Datum, /* defaultColor */ js.UndefOr[String]) => String): this.type = set("colors", js.Any.fromFunction2(value))
    ...
    inline def dateField(value: String): this.type = set("dateField", value.asInstanceOf[js.Any])
    
    inline def dateRange(value: js.Array[String]): this.type = set("dateRange", value.asInstanceOf[js.Any])
    
    inline def dateRangeVarargs(value: String*): this.type = set("dateRange", js.Array(value*))
    ...
    inline def valueField(value: String): this.type = set("valueField", value.asInstanceOf[js.Any])
  ...
  def withProps(p: CalendarOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
