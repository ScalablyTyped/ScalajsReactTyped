...
object ScatterChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ScatterOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "ScatterChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def pointSize(value: SizeAttr): this.type = set("pointSize", value.asInstanceOf[js.Any])
    
    inline def pointSizeFunction1(value: /* datum */ Datum => Double): this.type = set("pointSize", js.Any.fromFunction1(value))
    
    inline def pointStyle(value: StyleAttr): this.type = set("pointStyle", value.asInstanceOf[js.Any])
    
    inline def pointStyleFunction1(value: /* datum */ Datum => ShapeStyle): this.type = set("pointStyle", js.Any.fromFunction1(value))
    
    inline def quadrant(value: QuadrantOptions): this.type = set("quadrant", value.asInstanceOf[js.Any])
    
    inline def regressionLine(value: RegressionLineOptions): this.type = set("regressionLine", value.asInstanceOf[js.Any])
    ...
    inline def shape(value: ShapeAttr): this.type = set("shape", value.asInstanceOf[js.Any])
    
    inline def shapeField(value: String): this.type = set("shapeField", value.asInstanceOf[js.Any])
    
    inline def shapeFunction1(value: /* datum */ Datum => String): this.type = set("shape", js.Any.fromFunction1(value))
    
    inline def shapeLegend(value: typingsJapgolly.antvG2plot.libTypesLegendMod.Legend): this.type = set("shapeLegend", value.asInstanceOf[js.Any])
    
    inline def shapeVarargs(value: String*): this.type = set("shape", js.Array(value*))
    
    inline def size(value: SizeAttr): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def sizeField(value: String): this.type = set("sizeField", value.asInstanceOf[js.Any])
    
    inline def sizeFunction1(value: /* datum */ Datum => Double): this.type = set("size", js.Any.fromFunction1(value))
    ...
    inline def trendLine(value: RegressionLineOptions): this.type = set("trendLine", value.asInstanceOf[js.Any])
    
    inline def `type`(value: jitter | stack | symmetric | dodge): this.type = set("type", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ScatterOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
