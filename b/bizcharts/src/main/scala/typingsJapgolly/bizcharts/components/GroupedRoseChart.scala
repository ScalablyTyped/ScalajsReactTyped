...
object GroupedRoseChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[GroupedRoseOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "GroupedRoseChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def categoryField(value: String): this.type = set("categoryField", value.asInstanceOf[js.Any])
    ...
    inline def sectorStyle(value: StyleAttr): this.type = set("sectorStyle", value.asInstanceOf[js.Any])
    
    inline def sectorStyleFunction1(value: /* datum */ Datum => ShapeStyle): this.type = set("sectorStyle", js.Any.fromFunction1(value))
  ...
  def withProps(p: GroupedRoseOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
