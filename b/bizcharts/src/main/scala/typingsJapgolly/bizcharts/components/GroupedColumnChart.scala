...
object GroupedColumnChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[GroupedColumnOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "GroupedColumnChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def columnSize(value: Double): this.type = set("columnSize", value.asInstanceOf[js.Any])
  ...
  def withProps(p: GroupedColumnOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
