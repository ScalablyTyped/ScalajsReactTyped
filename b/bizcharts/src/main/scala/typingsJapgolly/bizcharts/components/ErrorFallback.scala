...
object ErrorFallback {
  
  def apply(p: Any): Default[js.Object] = new Default[js.Object](js.Array(this.component, p.asInstanceOf[js.Any]))
  
  @JSImport("bizcharts/lib/boundary/ErrorBoundary", "ErrorFallback")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ErrorFallback.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
