...
object ProgressChart {
  
  inline def apply(percent: Double): Builder = {
    val __props = js.Dynamic.literal(percent = percent.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ProgressOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "ProgressChart")
  @js.native
  ...
  def withProps(p: ProgressOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
