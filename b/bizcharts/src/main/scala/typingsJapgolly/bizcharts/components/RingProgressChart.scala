...
object RingProgressChart {
  
  inline def apply(percent: Double): Builder = {
    val __props = js.Dynamic.literal(percent = percent.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[RingProgressOptions & RefAttributes[Any]]))
  }
  
  @JSImport("bizcharts", "RingProgressChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def progressStyle(value: StyleAttr): this.type = set("progressStyle", value.asInstanceOf[js.Any])
    
    inline def progressStyleFunction1(value: /* datum */ Datum => ShapeStyle): this.type = set("progressStyle", js.Any.fromFunction1(value))
  ...
  def withProps(p: RingProgressOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
