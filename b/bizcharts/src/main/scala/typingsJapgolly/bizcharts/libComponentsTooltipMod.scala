...
object libComponentsTooltipMod {
  ...
  object ITooltip {
    ...
    extension [Self <: ITooltip](x: Self) {
      ...
      inline def setOnChange(value: (/* e */ js.UndefOr[ITooltipEvent], /* chart */ js.UndefOr[Chart]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* e */ js.UndefOr[ITooltipEvent], t1: /* chart */ js.UndefOr[Chart]) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnHide(value: (/* e */ js.UndefOr[ITooltipEvent], /* chart */ js.UndefOr[Chart]) => Callback): Self = StObject.set(x, "onHide", js.Any.fromFunction2((t0: /* e */ js.UndefOr[ITooltipEvent], t1: /* chart */ js.UndefOr[Chart]) => (value(t0, t1)).runNow()))
      
      inline def setOnHideUndefined: Self = StObject.set(x, "onHide", js.undefined)
      
      inline def setOnShow(value: (/* e */ js.UndefOr[ITooltipEvent], /* chart */ js.UndefOr[Chart]) => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction2((t0: /* e */ js.UndefOr[ITooltipEvent], t1: /* chart */ js.UndefOr[Chart]) => (value(t0, t1)).runNow()))
