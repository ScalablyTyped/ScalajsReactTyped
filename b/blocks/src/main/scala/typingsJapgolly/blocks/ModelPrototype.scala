...
import typingsJapgolly.blocks.anon.BaseUrl
...
object ModelPrototype {
  ...
  extension [Self <: ModelPrototype](x: Self) {
    ...
    inline def setDataItem(value: CallbackTo[js.Object]): Self = StObject.set(x, "dataItem", value.toJsFn)
    ...
    inline def setIsNew(value: CallbackTo[Boolean]): Self = StObject.set(x, "isNew", value.toJsFn)
