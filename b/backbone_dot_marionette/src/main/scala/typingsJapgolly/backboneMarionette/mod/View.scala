...
import typingsJapgolly.backboneMarionette.AnonDictindex
import typingsJapgolly.backboneMarionette.backboneMarionetteBooleans.`false`
...
class View[TModel /* <: Model */] ()
  extends typingsJapgolly.backbone.mod.View[TModel]
     with RegionsMixin
     with DomMixin
     with CommonMixin {
