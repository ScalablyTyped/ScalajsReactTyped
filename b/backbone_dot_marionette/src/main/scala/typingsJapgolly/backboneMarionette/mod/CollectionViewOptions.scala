...
import typingsJapgolly.backboneMarionette.TypeofView
...
trait CollectionViewOptions[TModel /* <: Model */, TCollection /* <: Collection[TModel] */]
  extends typingsJapgolly.backbone.mod.ViewOptions[TModel]
...
object CollectionViewOptions {
  ...
  def apply[TModel /* <: Model */, TCollection /* <: Collection[TModel] */](
    ...
    filter: (/* child */ js.UndefOr[TModel], /* index */ js.UndefOr[Double], /* collection */ js.UndefOr[TCollection]) => CallbackTo[Boolean] = null,
    id: String = null,
    model: TModel = null,
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction3((t0: /* child */ js.UndefOr[TModel], t1: /* index */ js.UndefOr[scala.Double], t2: /* collection */ js.UndefOr[TCollection]) => filter(t0, t1, t2).runNow()))
