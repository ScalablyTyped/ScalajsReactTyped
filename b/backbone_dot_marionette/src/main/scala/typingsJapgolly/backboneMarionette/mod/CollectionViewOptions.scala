...
import typingsJapgolly.backboneMarionette.anon.TypeofView
...
trait CollectionViewOptions[TModel /* <: Model[Any, ModelSetOptions, Any] */, TCollection /* <: Collection[TModel] */]
  extends StObject
     with typingsJapgolly.backbone.mod.ViewOptions[TModel, HTMLElement]
  ...
  var viewFilter: js.UndefOr[
    (js.Function3[
      ...
      /* index */ js.UndefOr[Double], 
      /* children */ js.UndefOr[
        js.Array[typingsJapgolly.backbone.mod.View[Model[Any, ModelSetOptions, Any], HTMLElement]]
      ], 
      Boolean
    ]) | ObjectHash | String
  ] = js.undefined
...
object CollectionViewOptions {
  ...
  extension [Self <: CollectionViewOptions[?, ?], TModel /* <: Model[Any, ModelSetOptions, Any] */, TCollection /* <: Collection[TModel] */](x: Self & (CollectionViewOptions[TModel, TCollection])) {
    ...
    inline def setChildViewFunction1(
      value: /* model */ TModel => TypeofView & (Instantiable0[
          typingsJapgolly.backbone.mod.View[js.UndefOr[Model[Any, ModelSetOptions, Any]], Element]
        ])
    ...
    inline def setChildViewOptionsCallbackTo(value: CallbackTo[ViewOptions[TModel]]): Self = StObject.set(x, "childViewOptions", value.toJsFn)
    ...
    inline def setEmptyViewCallbackTo(
      value: CallbackTo[
          TypeofView & (Instantiable0[
            typingsJapgolly.backbone.mod.View[js.UndefOr[Model[Any, ModelSetOptions, Any]], Element]
          ])
        ]
    ): Self = StObject.set(x, "emptyView", value.toJsFn)
    ...
    inline def setEmptyViewOptionsCallbackTo(value: CallbackTo[ViewOptions[TModel]]): Self = StObject.set(x, "emptyViewOptions", value.toJsFn)
