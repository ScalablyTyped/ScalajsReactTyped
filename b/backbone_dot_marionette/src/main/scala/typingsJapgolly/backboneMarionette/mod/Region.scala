...
class Region ()
  ...
  /**
    ...
    */
  var currentView: typingsJapgolly.backbone.mod.View[Model] = js.native
  /* CompleteClass */
  ...
  /**
    ...
    */
  def attachHtml(view: typingsJapgolly.backbone.mod.View[Model]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def destroyView[TModel /* <: Model */](view: typingsJapgolly.backbone.mod.View[TModel]): typingsJapgolly.backbone.mod.View[TModel] = js.native
  /**
  ...
  /**
    ...
    * view.
    */
  def detachView(): typingsJapgolly.backbone.mod.View[Model] = js.native
  /**
  ...
  /**
    ...
    */
  def removeView(view: typingsJapgolly.backbone.mod.View[Model]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def show(view: typingsJapgolly.backbone.mod.View[Model]): Unit = js.native
  def show(view: typingsJapgolly.backbone.mod.View[Model], options: RegionViewOptions): Unit = js.native
}
