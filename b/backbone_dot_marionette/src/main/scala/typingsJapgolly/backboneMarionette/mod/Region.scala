...
open class Region ()
  ...
  /**
    ...
    */
  def attachHtml(view: typingsJapgolly.backbone.mod.View[Model[Any, ModelSetOptions, Any], HTMLElement]): Unit = js.native
  ...
  /**
    ...
    */
  var currentView: typingsJapgolly.backbone.mod.View[Model[Any, ModelSetOptions, Any], HTMLElement] = js.native
  
  /**
    * Destroys the view taking into consideration if is a View descendant
    * or vanilla Backbone view.
    */
  def destroyView[TModel /* <: Model[Any, ModelSetOptions, Any] */](view: typingsJapgolly.backbone.mod.View[TModel, HTMLElement]): typingsJapgolly.backbone.mod.View[TModel, HTMLElement] = js.native
  ...
  /**
    ...
    * view.
    */
  def detachView(): typingsJapgolly.backbone.mod.View[Model[Any, ModelSetOptions, Any], HTMLElement] = js.native
  ...
  /**
    ...
    */
  def removeView(view: typingsJapgolly.backbone.mod.View[Model[Any, ModelSetOptions, Any], HTMLElement]): Unit = js.native
  ...
  /**
    ...
    */
  def show(view: typingsJapgolly.backbone.mod.View[Model[Any, ModelSetOptions, Any], HTMLElement]): Unit = js.native
  def show(
    view: typingsJapgolly.backbone.mod.View[Model[Any, ModelSetOptions, Any], HTMLElement],
