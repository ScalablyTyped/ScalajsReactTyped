...
object ObjectOptions {
  ...
  def apply(
    ...
    initialize: /* options */ js.UndefOr[ObjectOptions] => Callback = null,
    ...
    if (initialize != null) __obj.updateDynamic("initialize")(js.Any.fromFunction1((t0: /* options */ js.UndefOr[typingsJapgolly.backboneMarionette.mod.ObjectOptions]) => initialize(t0).runNow()))
