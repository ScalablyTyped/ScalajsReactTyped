...
object buildTypesBitStreamMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamViewParameters
    - typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamStreamParameters
    - typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamBufferParameters
    - typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamUint32Parameters
    - typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamStringParameters
  */
  trait BitStreamParameters extends StObject
  object BitStreamParameters {
    
    inline def BitStreamBufferParameters(buffer: js.typedarray.ArrayBuffer): typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamBufferParameters = {
      val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamBufferParameters]
    }
    
    inline def BitStreamStreamParameters(byteStream: ByteStream): typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamStreamParameters = {
      val __obj = js.Dynamic.literal(byteStream = byteStream.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamStreamParameters]
    }
    
    inline def BitStreamStringParameters(string: String): typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamStringParameters = {
      val __obj = js.Dynamic.literal(string = string.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamStringParameters]
    }
    
    inline def BitStreamUint32Parameters(uint32: Double): typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamUint32Parameters = {
      val __obj = js.Dynamic.literal(uint32 = uint32.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamUint32Parameters]
    }
    
    inline def BitStreamViewParameters(view: js.typedarray.Uint8Array): typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamViewParameters = {
      val __obj = js.Dynamic.literal(view = view.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesBitStreamMod.BitStreamViewParameters]
    }
  }
