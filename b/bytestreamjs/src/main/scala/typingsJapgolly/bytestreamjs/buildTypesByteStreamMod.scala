...
import typingsJapgolly.bytestreamjs.anon.Backward
import typingsJapgolly.bytestreamjs.bytestreamjsInts.`-1`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object buildTypesByteStreamMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamEmptyParameters
    - typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamLengthParameters
    - typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamViewParameters
    - typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamBufferParameters
    - typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamStringParameters
    - typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamHexParameters
  */
  trait ByteStreamParameters extends StObject
  object ByteStreamParameters {
    
    inline def ByteStreamBufferParameters(buffer: js.typedarray.ArrayBuffer): typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamBufferParameters = {
      val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamBufferParameters]
    }
    
    inline def ByteStreamHexParameters(hexstring: String): typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamHexParameters = {
      val __obj = js.Dynamic.literal(hexstring = hexstring.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamHexParameters]
    }
    
    inline def ByteStreamLengthParameters(length: Double): typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamLengthParameters = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamLengthParameters]
    }
    
    inline def ByteStreamStringParameters(string: String): typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamStringParameters = {
      val __obj = js.Dynamic.literal(string = string.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamStringParameters]
    }
    
    inline def ByteStreamViewParameters(view: js.typedarray.Uint8Array): typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamViewParameters = {
      val __obj = js.Dynamic.literal(view = view.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStreamViewParameters]
    }
  }
