...
import typingsJapgolly.bytestreamjs.anon.Id
import typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ByteStream
import typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.FindFirstInResult
import typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.FindFirstNotInResult
import typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.FindFirstSequenceResult
import typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.FindPairedArraysResult
import typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.FindPairedPatternsResult
import typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.FindResult
import typingsJapgolly.bytestreamjs.buildTypesByteStreamMod.ReplacePatternResult
...
object buildTypesSeqStreamMod {
  ...
  - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamParameters because Already inherited */ trait SeqStreamBufferParameters
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamParameters because Already inherited */ trait SeqStreamLengthParameters
    extends StObject
       with SeqStreamBaseParameters {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBaseParameters
    - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamLengthParameters
    - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBufferParameters
    - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStreamParameters
    - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamViewParameters
    - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStringParameters
    - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamHexParameters
  */
  trait SeqStreamParameters extends StObject
  object SeqStreamParameters {
    
    inline def SeqStreamBaseParameters(): typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBaseParameters = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBaseParameters]
    }
    
    inline def SeqStreamBufferParameters(buffer: js.typedarray.ArrayBuffer): typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBufferParameters = {
      val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBufferParameters]
    }
    
    inline def SeqStreamHexParameters(hexstring: String): typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamHexParameters = {
      val __obj = js.Dynamic.literal(hexstring = hexstring.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamHexParameters]
    }
    
    inline def SeqStreamLengthParameters(length: Double): typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamLengthParameters = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamLengthParameters]
    }
    
    inline def SeqStreamStreamParameters(stream: ByteStream): typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStreamParameters = {
      val __obj = js.Dynamic.literal(stream = stream.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStreamParameters]
    }
    
    inline def SeqStreamStringParameters(string: String): typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStringParameters = {
      val __obj = js.Dynamic.literal(string = string.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStringParameters]
    }
    
    inline def SeqStreamViewParameters(view: js.typedarray.Uint8Array): typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamViewParameters = {
      val __obj = js.Dynamic.literal(view = view.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamViewParameters]
    }
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamParameters because Already inherited */ trait SeqStreamStreamParameters
    extends StObject
       with SeqStreamBaseParameters {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.bytestreamjs.buildTypesSeqStreamMod.SeqStreamParameters because Already inherited */ trait SeqStreamViewParameters
    extends StObject
       with SeqStreamBaseParameters {
