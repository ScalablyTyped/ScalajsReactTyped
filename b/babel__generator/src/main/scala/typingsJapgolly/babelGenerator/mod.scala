...
import typingsJapgolly.babelGenerator.anon.Compact
import typingsJapgolly.babelGenerator.anon.File
import typingsJapgolly.babelGenerator.babelGeneratorStrings.auto
