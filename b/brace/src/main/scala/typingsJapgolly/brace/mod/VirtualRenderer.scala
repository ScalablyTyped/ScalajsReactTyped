...
object VirtualRenderer
  ...
  **/
Instantiable1[/* container */ typingsJapgolly.std.HTMLElement, VirtualRenderer]
     with Instantiable2[/* container */ typingsJapgolly.std.HTMLElement, /* theme */ String, VirtualRenderer]
