...
import typingsJapgolly.babelCore.mod.InputSourceMap
import typingsJapgolly.babelCore.mod.MatchPattern
import typingsJapgolly.babelCore.mod.MatchPatternContext
...
import typingsJapgolly.babelCore.mod.TransformCaller
...
import typingsJapgolly.babelPluginTester.anon.Filename
import typingsJapgolly.babelPluginTester.anon.TypeofNodePath
import typingsJapgolly.babelPluginTester.anon.Typeoftraverse
import typingsJapgolly.babelPluginTester.anon.Typeoftypes
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.Dotes
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.Dotes6
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.Dotjs
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.Dotjsx
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.Dotmjs
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.`inline`
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.`upward-optional`
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.auto
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.both
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.crlf
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.enter
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.exit
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.lf
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.module
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.preserve
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.root
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.script
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.unambiguous
import typingsJapgolly.babelPluginTester.babelPluginTesterStrings.upward
...
object mod {
  ...
  trait PluginTesterOptions extends StObject {
    ...
    var wrapPluginVisitorMethod: js.UndefOr[
        (js.Function3[
          ...
          /* callback */ js.Function2[/* path */ NodePath[typingsJapgolly.babelTypes.mod.Node], /* state */ Any, Unit], 
          js.Function2[/* path */ NodePath[typingsJapgolly.babelTypes.mod.Node], /* state */ Any, Unit]
        ]) | Null
      ] = js.undefined
  }
  object PluginTesterOptions {
    ...
    extension [Self <: PluginTesterOptions](x: Self) {
      ...
      ): Self = StObject.set(x, "setup", value.toJsFn)
      ...
      inline def setWrapPluginVisitorMethod(
        value: (/* pluginAlias */ String, /* visitorType */ enter | exit, /* callback */ js.Function2[/* path */ NodePath[typingsJapgolly.babelTypes.mod.Node], /* state */ Any, Unit]) => js.Function2[/* path */ NodePath[typingsJapgolly.babelTypes.mod.Node], /* state */ Any, Unit]
