...
object integrationMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.fetch
    - typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.xhr
    - typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.script
    - typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.iframe
  */
  trait ResolveUrlType extends StObject
  object ResolveUrlType {
    
    inline def fetch: typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.fetch = "fetch".asInstanceOf[typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.fetch]
    
    inline def iframe: typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.iframe = "iframe".asInstanceOf[typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.iframe]
    
    inline def script: typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.script = "script".asInstanceOf[typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.script]
    
    inline def xhr: typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.xhr = "xhr".asInstanceOf[typingsJapgolly.builderIoPartytown.builderIoPartytownStrings.xhr]
  }
