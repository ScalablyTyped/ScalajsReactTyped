...
object PaginatorOptions {
  ...
  extension [Self <: PaginatorOptions](x: Self) {
    ...
    inline def setOnPageChanged(
      value: (/* event */ Any, /* originalEvent */ Any, /* type */ String, /* page */ Double) => Callback
    ): Self = StObject.set(x, "onPageChanged", js.Any.fromFunction4((t0: /* event */ Any, t1: /* originalEvent */ Any, t2: /* type */ String, t3: /* page */ Double) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setOnPageChangedUndefined: Self = StObject.set(x, "onPageChanged", js.undefined)
    
    inline def setOnPageClicked(
      value: (/* event */ Any, /* originalEvent */ Any, /* type */ String, /* page */ Double) => Callback
    ): Self = StObject.set(x, "onPageClicked", js.Any.fromFunction4((t0: /* event */ Any, t1: /* originalEvent */ Any, t2: /* type */ String, t3: /* page */ Double) => (value(t0, t1, t2, t3)).runNow()))
