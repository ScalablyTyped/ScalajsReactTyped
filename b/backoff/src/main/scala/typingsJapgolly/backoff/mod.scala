...
import typingsJapgolly.backoff.backoffStrings.abort
import typingsJapgolly.backoff.backoffStrings.call
import typingsJapgolly.backoff.backoffStrings.callback
import typingsJapgolly.backoff.backoffStrings.fail
import typingsJapgolly.backoff.backoffStrings.ready
...
object mod {
  ...
  open class Backoff protected () extends EventEmitter {
    ...
    def addListener_backoff(
      event: typingsJapgolly.backoff.backoffStrings.backoff,
    ...
    @JSName("emit")
    def emit_backoff(event: typingsJapgolly.backoff.backoffStrings.backoff, number: Double, delay: Double): Boolean = js.native
    @JSName("emit")
    def emit_backoff(event: typingsJapgolly.backoff.backoffStrings.backoff, number: Double, delay: Double, error: Any): Boolean = js.native
    @JSName("emit")
    ...
    def listenerCount(`type`: typingsJapgolly.backoff.backoffStrings.backoff | ready | fail): Double = js.native
    
    @JSName("listeners")
    def listeners_backoff(event: typingsJapgolly.backoff.backoffStrings.backoff): js.Array[
    ...
    def removeAllListeners(event: typingsJapgolly.backoff.backoffStrings.backoff | ready | fail): this.type = js.native
  ...
  trait FunctionCall[T] extends EventEmitter {
    ...
    def listenerCount(`type`: call | callback | typingsJapgolly.backoff.backoffStrings.backoff | abort): Double = js.native
    ...
    def removeAllListeners(event: call | callback | typingsJapgolly.backoff.backoffStrings.backoff | abort): this.type = js.native
  ...
  open class FunctionCallCls[T1, T2, T3, R1, R2, R3, E] protected ()
    ...
    override def addListener_callback(
      event: typingsJapgolly.backoff.backoffStrings.callback,
      listener: js.Function1[/* results */ js.Tuple4[E, R1, R2, R3], Unit]
    ): this.type = js.native
    
    /* CompleteClass */
    @JSName("emit")
    override def emit_callback(event: typingsJapgolly.backoff.backoffStrings.callback, results: js.Tuple4[E, R1, R2, R3]): Boolean = js.native
    ...
    /* CompleteClass */
    @JSName("listeners")
    override def listeners_callback(event: typingsJapgolly.backoff.backoffStrings.callback): js.Array[js.Function1[/* results */ js.Tuple4[E, R1, R2, R3], Unit]] = js.native
  ...
  trait FunctionCallAny
    extends typingsJapgolly.backoff.mod.FunctionCall[js.Array[Any]]
  ...
  object FunctionCallArgs {
    ...
    extension [Self <: FunctionCallArgs[?, ?, ?, ?], E, R1, R2, R3](x: Self & (FunctionCallArgs[E, R1, R2, R3])) {
      ...
      inline def setGetLastResult(value: CallbackTo[js.Tuple4[E, R1, R2, R3]]): Self = StObject.set(x, "getLastResult", value.toJsFn)
  ...
  object FunctionCallArgsAny {
    ...
    inline def apply(
      ...
      getLastResult: CallbackTo[js.Array[Any]],
    ...
    extension [Self <: FunctionCallArgsAny](x: Self) {
      ...
      inline def setGetLastResult(value: CallbackTo[js.Array[Any]]): Self = StObject.set(x, "getLastResult", value.toJsFn)
  ...
  trait TypedFunctionCall[T, E, R1, R2, R3]
    extends typingsJapgolly.backoff.mod.FunctionCall[T]
