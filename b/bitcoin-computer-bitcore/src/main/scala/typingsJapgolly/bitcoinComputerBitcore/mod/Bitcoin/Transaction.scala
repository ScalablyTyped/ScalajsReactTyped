...
import typingsJapgolly.bitcoinComputerBitcore.mod.Bitcoin.Transaction.Input
import typingsJapgolly.bitcoinComputerBitcore.mod.Bitcoin.Transaction.Input.MultiSigScriptHash
import typingsJapgolly.bitcoinComputerBitcore.mod.Bitcoin.Transaction.Output
import typingsJapgolly.bitcoinComputerBitcore.mod.Bitcoin.Transaction.UnspentOutput
import typingsJapgolly.bitcoinComputerBitcore.mod.Bitcoin.crypto.Signature
