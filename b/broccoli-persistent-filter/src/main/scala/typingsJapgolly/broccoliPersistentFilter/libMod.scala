...
object libMod {
  ...
  @js.native
  trait Filter
    extends typingsJapgolly.broccoliPlugin.mod.^ {
    ...
    var currentTree: typingsJapgolly.fsTreeDiff.mod.^[DefaultEntry] = js.native
    
    var dependencies: typingsJapgolly.broccoliPersistentFilter.libDependenciesMod.^ | Null = js.native
    ...
    def postProcess(result: typingsJapgolly.broccoliPersistentFilter.anon.ProcessStringResult, _relativePath: String): typingsJapgolly.broccoliPersistentFilter.anon.ProcessStringResult | js.Promise[typingsJapgolly.broccoliPersistentFilter.anon.ProcessStringResult] = js.native
    ...
    def processAndCacheFile(
      ...
      instrumentation: ApplyPatchesSchema
        ...
        js.UndefOr[String | typingsJapgolly.broccoliPersistentFilter.anon.ProcessStringResult]
      ] = js.native
    ...
    /**
      ...
      * @returns {string}
      */
    def processString(_contents: String, _relativePath: String): String | typingsJapgolly.broccoliPersistentFilter.anon.ProcessStringResult | (js.Promise[String | typingsJapgolly.broccoliPersistentFilter.anon.ProcessStringResult]) = js.native
    
    var processor: typingsJapgolly.broccoliPersistentFilter.libProcessorMod.^ = js.native
  ...
  type ProcessStringResult[Data] = typingsJapgolly.broccoliPersistentFilter.libStrategiesStrategyMod.ProcessStringResult[Data]
}
