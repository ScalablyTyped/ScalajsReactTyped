...
object core {
  ...
  open class Enum protected ()
    extends StObject
       with typingsJapgolly.breeze.breeze.core.Enum {
    ...
    /* CompleteClass */
    override def fromName(name: String): typingsJapgolly.breeze.breeze.core.EnumSymbol = js.native
    
    /* CompleteClass */
    override def getNames(): js.Array[String] = js.native
    
    /* CompleteClass */
    override def getSymbols(): js.Array[typingsJapgolly.breeze.breeze.core.EnumSymbol] = js.native
  }
  /* static members */
  object Enum {
  ...
  open class EnumSymbol ()
    extends StObject
       with typingsJapgolly.breeze.breeze.core.EnumSymbol {
  ...
  open class Event protected ()
    extends StObject
       with typingsJapgolly.breeze.breeze.core.Event {
