...
trait DataType extends StObject {
  ...
  var dataType: js.UndefOr[typingsJapgolly.breeze.breeze.DataType] = js.undefined
...
object DataType {
  ...
  extension [Self <: DataType](x: Self) {
    ...
    inline def setDataType(value: typingsJapgolly.breeze.breeze.DataType): Self = StObject.set(x, "dataType", value.asInstanceOf[js.Any])
