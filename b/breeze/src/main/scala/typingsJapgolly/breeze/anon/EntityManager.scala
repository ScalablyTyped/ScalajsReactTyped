...
trait EntityManager extends StObject {
  ...
  var entityManager: typingsJapgolly.breeze.breeze.EntityManager
...
object EntityManager {
  ...
  inline def apply(
    entityManager: typingsJapgolly.breeze.breeze.EntityManager,
  ...
  extension [Self <: EntityManager](x: Self) {
    ...
    inline def setEntityManager(value: typingsJapgolly.breeze.breeze.EntityManager): Self = StObject.set(x, "entityManager", value.asInstanceOf[js.Any])
