...
object OrderByClause {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(getComparer = js.Any.fromFunction1(getComparer), items = items.asInstanceOf[js.Any], toFunction = js.Any.fromFunction1(toFunction), toJSONExt = js.Any.fromFunction1(toJSONExt), validate = js.Any.fromFunction1((t0: EntityType) => validate(t0).runNow()))
