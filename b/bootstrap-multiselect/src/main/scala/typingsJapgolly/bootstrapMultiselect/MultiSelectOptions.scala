...
import typingsJapgolly.bootstrapMultiselect.bootstrapMultiselectStrings.both
import typingsJapgolly.bootstrapMultiselect.bootstrapMultiselectStrings.text
import typingsJapgolly.bootstrapMultiselect.bootstrapMultiselectStrings.value
...
object MultiSelectOptions {
  ...
  extension [Self <: MultiSelectOptions](x: Self) {
    ...
    inline def setOnChange(value: (/* option */ JQuery, /* checked */ Boolean) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* option */ JQuery, t1: /* checked */ Boolean) => (value(t0, t1)).runNow()))
    ...
    inline def setOnDropdownHidden(value: /* event */ Event => Callback): Self = StObject.set(x, "onDropdownHidden", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
    
    inline def setOnDropdownHiddenUndefined: Self = StObject.set(x, "onDropdownHidden", js.undefined)
    
    inline def setOnDropdownHide(value: /* event */ Event => Callback): Self = StObject.set(x, "onDropdownHide", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
    
    inline def setOnDropdownHideUndefined: Self = StObject.set(x, "onDropdownHide", js.undefined)
    
    inline def setOnDropdownShow(value: /* event */ Event => Callback): Self = StObject.set(x, "onDropdownShow", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
    
    inline def setOnDropdownShowUndefined: Self = StObject.set(x, "onDropdownShow", js.undefined)
    
    inline def setOnDropdownShown(value: /* event */ Event => Callback): Self = StObject.set(x, "onDropdownShown", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
    
    inline def setOnDropdownShownUndefined: Self = StObject.set(x, "onDropdownShown", js.undefined)
    
    inline def setOnInitialized(value: (/* select */ HTMLSelectElement, /* container */ HTMLElement) => Callback): Self = StObject.set(x, "onInitialized", js.Any.fromFunction2((t0: /* select */ HTMLSelectElement, t1: /* container */ HTMLElement) => (value(t0, t1)).runNow()))
