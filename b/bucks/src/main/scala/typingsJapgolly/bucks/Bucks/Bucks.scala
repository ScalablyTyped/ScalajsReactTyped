...
trait Bucks extends js.Object {
  ...
  /**
    ...
    */
  def error(onError: js.Function2[/* err */ js.Error, /* next */ js.UndefOr[Task], _]): typingsJapgolly.bucks.Bucks.Bucks = js.native
  /**
  ...
  /**
    ...
    */
  def `then`(onSuccess: js.Function2[/* res */ js.Any, /* next */ js.UndefOr[Task], _]): typingsJapgolly.bucks.Bucks.Bucks = js.native
  /**
    * Add tasks in asynchronous way and join their results.
