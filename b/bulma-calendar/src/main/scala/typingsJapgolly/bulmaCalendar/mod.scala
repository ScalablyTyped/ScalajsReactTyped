...
import typingsJapgolly.bulmaCalendar.anon.Date
import typingsJapgolly.bulmaCalendar.anon.End
import typingsJapgolly.bulmaCalendar.anon.EndDate
...
import typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.default
...
object mod {
  ...
  open class ^ protected ()
    extends StObject
       with typingsJapgolly.bulmaCalendar.mod.bulmaCalendar {
    // Constructors
  ...
  /* static member */
  inline def attach(): js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar] = ^.asInstanceOf[js.Dynamic].applyDynamic("attach")().asInstanceOf[js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar]]
  inline def attach(selector: String): js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar] = ^.asInstanceOf[js.Dynamic].applyDynamic("attach")(selector.asInstanceOf[js.Any]).asInstanceOf[js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar]]
  inline def attach(selector: String, options: Options): js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar] = (^.asInstanceOf[js.Dynamic].applyDynamic("attach")(selector.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar]]
  inline def attach(selector: HTMLElement): js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar] = ^.asInstanceOf[js.Dynamic].applyDynamic("attach")(selector.asInstanceOf[js.Any]).asInstanceOf[js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar]]
  inline def attach(selector: HTMLElement, options: Options): js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar] = (^.asInstanceOf[js.Dynamic].applyDynamic("attach")(selector.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar]]
  inline def attach(selector: Unit, options: Options): js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar] = (^.asInstanceOf[js.Dynamic].applyDynamic("attach")(selector.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.bulmaCalendar.mod.bulmaCalendar]]
  
  trait Event[T /* <: EventType */] extends StObject {
    
    var data: typingsJapgolly.bulmaCalendar.mod.bulmaCalendar
  ...
  object Event {
    ...
    inline def apply[T /* <: EventType */](data: typingsJapgolly.bulmaCalendar.mod.bulmaCalendar, timeStamp: Double, `type`: T): Event[T] = {
    ...
    extension [Self <: Event[?], T /* <: EventType */](x: Self & Event[T]) {
      ...
      inline def setData(value: typingsJapgolly.bulmaCalendar.mod.bulmaCalendar): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.show
    - typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.hide
    - typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.select
    - typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.selectColonstart
  */
  trait EventType extends StObject
  object EventType {
    
    inline def hide: typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.hide = "hide".asInstanceOf[typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.hide]
    
    inline def select: typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.select = "select".asInstanceOf[typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.select]
    
    inline def selectColonstart: typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.selectColonstart = "select:start".asInstanceOf[typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.selectColonstart]
    
    inline def show: typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.show = "show".asInstanceOf[typingsJapgolly.bulmaCalendar.bulmaCalendarStrings.show]
  }
  ...
  trait bulmaCalendar extends StObject {
    ...
    def emit(name: EventType, data: typingsJapgolly.bulmaCalendar.mod.bulmaCalendar): Unit = js.native
    def emit(name: EventType, data: typingsJapgolly.bulmaCalendar.mod.bulmaCalendar, silent: Boolean): Unit = js.native
