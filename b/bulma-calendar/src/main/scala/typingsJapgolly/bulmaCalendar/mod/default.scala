...
object default extends js.Object {
  ...
  def attach(selector: typingsJapgolly.std.HTMLElement): js.Array[bulmaCalendar] = js.native
  def attach(selector: typingsJapgolly.std.HTMLElement, options: BulmaCalendarOptions): js.Array[bulmaCalendar] = js.native
}
