...
import typingsJapgolly.browserify.browserifyStrings._package
import typingsJapgolly.browserify.browserifyStrings.bundle
import typingsJapgolly.browserify.browserifyStrings.file
import typingsJapgolly.browserify.browserifyStrings.reset
import typingsJapgolly.browserify.browserifyStrings.transform
import typingsJapgolly.insertModuleGlobals.mod.VarsOption
