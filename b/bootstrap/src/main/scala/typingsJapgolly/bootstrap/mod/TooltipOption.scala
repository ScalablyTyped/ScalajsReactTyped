...
import typingsJapgolly.popperJs.mod.Behavior
...
object TooltipOption {
  ...
  def apply(
    ...
    sanitizeFn: /* input */ String => CallbackTo[String] = null,
    ...
    if (sanitizeFn != null) __obj.updateDynamic("sanitizeFn")(js.Any.fromFunction1((t0: /* input */ java.lang.String) => sanitizeFn(t0).runNow()))
