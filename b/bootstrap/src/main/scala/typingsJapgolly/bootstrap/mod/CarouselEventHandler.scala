...
import typingsJapgolly.bootstrap.bootstrapStrings.left
import typingsJapgolly.bootstrap.bootstrapStrings.right
import typingsJapgolly.jquery.Event
...
object CarouselEventHandler {
  ...
  def apply[TElement](
    ...
    val __obj = js.Dynamic.literal(currentTarget = currentTarget.asInstanceOf[js.Any], delegateTarget = delegateTarget.asInstanceOf[js.Any], direction = direction.asInstanceOf[js.Any], from = from.asInstanceOf[js.Any], relatedTarget = relatedTarget.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any], timeStamp = timeStamp.asInstanceOf[js.Any], to = to.asInstanceOf[js.Any])
