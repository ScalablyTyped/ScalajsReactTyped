...
import typingsJapgolly.bootstrap.anon.Hide
import typingsJapgolly.bootstrap.anon.PartialOptionsBoundary
import typingsJapgolly.bootstrap.anon.RecordkeyofHTMLElementTag
import typingsJapgolly.bootstrap.bootstrapBooleans.`false`
import typingsJapgolly.bootstrap.bootstrapStrings.`click focus`
import typingsJapgolly.bootstrap.bootstrapStrings.`click hover focus`
import typingsJapgolly.bootstrap.bootstrapStrings.`click hover`
import typingsJapgolly.bootstrap.bootstrapStrings.`hover focus`
import typingsJapgolly.bootstrap.bootstrapStrings.click
import typingsJapgolly.bootstrap.bootstrapStrings.disable
import typingsJapgolly.bootstrap.bootstrapStrings.dispose
import typingsJapgolly.bootstrap.bootstrapStrings.enable
import typingsJapgolly.bootstrap.bootstrapStrings.focus
import typingsJapgolly.bootstrap.bootstrapStrings.hide
import typingsJapgolly.bootstrap.bootstrapStrings.hover
import typingsJapgolly.bootstrap.bootstrapStrings.manual
import typingsJapgolly.bootstrap.bootstrapStrings.setContent
import typingsJapgolly.bootstrap.bootstrapStrings.show
import typingsJapgolly.bootstrap.bootstrapStrings.toggle
import typingsJapgolly.bootstrap.bootstrapStrings.toggleEnabled
...
import typingsJapgolly.bootstrap.jsDistTooltipMod.Tooltip.Options
import typingsJapgolly.bootstrap.jsDistTooltipMod.Tooltip.SetContentFunction
import typingsJapgolly.bootstrap.jsDistTooltipMod.Tooltip.jQueryInterface
  ...
  object Tooltip {
    ...
    trait Options extends StObject {
      ...
      /**
        ...
        */
      var boundary: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Boundary */ Any
    ...
    object Options {
      ...
      inline def apply(
        ...
        animation: Boolean,
        boundary: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Boundary */ Any,
        ...
        sanitize: Boolean,
        sanitizeFn: CallbackTo[Unit | Null],
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setBoundary(
          value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Boundary */ Any
        ...
        inline def setCustomClassCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "customClass", value.toJsFn)
        ...
        inline def setPlacementCallbackTo(value: CallbackTo[PopoverPlacement]): Self = StObject.set(x, "placement", value.toJsFn)
        ...
        inline def setPopperConfigFunction1(
          value: /* defaultBsPopperConfig */ Options => Partial[
                  /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Options */ Any
                ]
        ...
        inline def setSanitizeFn(value: CallbackTo[Unit | Null]): Self = StObject.set(x, "sanitizeFn", value.toJsFn)
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.bootstrap.bootstrapStrings.auto
      - typingsJapgolly.bootstrap.bootstrapStrings.top
      - typingsJapgolly.bootstrap.bootstrapStrings.bottom
    ...
    */
    ...
    object PopoverPlacement {
      ...
      inline def auto: typingsJapgolly.bootstrap.bootstrapStrings.auto = "auto".asInstanceOf[typingsJapgolly.bootstrap.bootstrapStrings.auto]
      
      inline def bottom: typingsJapgolly.bootstrap.bootstrapStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.bootstrap.bootstrapStrings.bottom]
      ...
      inline def top: typingsJapgolly.bootstrap.bootstrapStrings.top = "top".asInstanceOf[typingsJapgolly.bootstrap.bootstrapStrings.top]
    }
    
    type PopperConfigFunction = js.Function1[
        /* defaultBsPopperConfig */ Options, 
        Partial[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Options */ Any
        ]
      ]
