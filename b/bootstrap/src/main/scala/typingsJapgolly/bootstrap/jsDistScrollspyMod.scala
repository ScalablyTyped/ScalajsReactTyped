...
import typingsJapgolly.bootstrap.bootstrapStrings.auto
import typingsJapgolly.bootstrap.bootstrapStrings.dispose
import typingsJapgolly.bootstrap.bootstrapStrings.offset
import typingsJapgolly.bootstrap.bootstrapStrings.position
