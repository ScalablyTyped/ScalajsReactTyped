...
import typingsJapgolly.bootstrap.jsDistPopoverMod.Popover.Options
import typingsJapgolly.bootstrap.jsDistPopoverMod.Popover.PopperConfigFunction
import typingsJapgolly.bootstrap.jsDistTooltipMod.Tooltip.Offset
import typingsJapgolly.bootstrap.jsDistTooltipMod.Tooltip.OffsetFunction
import typingsJapgolly.bootstrap.jsDistTooltipMod.Tooltip.PopoverPlacement
...
object anon {
  ...
  trait PartialOptionsAllowList extends StObject {
    ...
    var boundary: js.UndefOr[
        /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Boundary */ Any
      ] = js.undefined
  ...
  trait PartialOptionsAutoClose extends StObject {
    ...
    var boundary: js.UndefOr[
        (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Boundary */ Any) | Element
      ] = js.undefined
    
    var display: js.UndefOr[dynamic | static] = js.undefined
    
    var offset: js.UndefOr[
        typingsJapgolly.bootstrap.jsDistDropdownMod.Dropdown.Offset | String | typingsJapgolly.bootstrap.jsDistDropdownMod.Dropdown.OffsetFunction
      ] = js.undefined
    ...
    var popperConfig: js.UndefOr[
        ...
        ]) | typingsJapgolly.bootstrap.jsDistDropdownMod.Dropdown.PopperConfigFunction | Null
      ] = js.undefined
    
    var reference: js.UndefOr[
        toggle | parent | Element | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Rect */ Any)
      ] = js.undefined
  }
  object PartialOptionsAutoClose {
    ...
    extension [Self <: PartialOptionsAutoClose](x: Self) {
      ...
      inline def setOffset(
        value: typingsJapgolly.bootstrap.jsDistDropdownMod.Dropdown.Offset | String | typingsJapgolly.bootstrap.jsDistDropdownMod.Dropdown.OffsetFunction
      ): Self = StObject.set(x, "offset", value.asInstanceOf[js.Any])
      
      inline def setOffsetCallbackTo(value: CallbackTo[typingsJapgolly.bootstrap.jsDistDropdownMod.Dropdown.Offset]): Self = StObject.set(x, "offset", value.toJsFn)
      ...
      inline def setPopperConfig(
        value: (Partial[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Options */ Any
            ]) | typingsJapgolly.bootstrap.jsDistDropdownMod.Dropdown.PopperConfigFunction
  ...
  trait PartialOptionsBoundary extends StObject {
    ...
    var popperConfig: js.UndefOr[
        (Partial[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Options */ Any
        ]) | typingsJapgolly.bootstrap.jsDistTooltipMod.Tooltip.PopperConfigFunction | Null
      ] = js.undefined
  ...
  object PartialOptionsBoundary {
    ...
    extension [Self <: PartialOptionsBoundary](x: Self) {
      ...
      inline def setPopperConfig(
        value: (Partial[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Options */ Any
            ]) | typingsJapgolly.bootstrap.jsDistTooltipMod.Tooltip.PopperConfigFunction
      ): Self = StObject.set(x, "popperConfig", value.asInstanceOf[js.Any])
      
      inline def setPopperConfigFunction1(
        value: /* defaultBsPopperConfig */ typingsJapgolly.bootstrap.jsDistTooltipMod.Tooltip.Options => Partial[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Popper.Options */ Any
            ]
