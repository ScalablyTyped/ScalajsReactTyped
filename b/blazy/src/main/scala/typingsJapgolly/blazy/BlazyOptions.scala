...
object BlazyOptions {
  ...
  extension [Self <: BlazyOptions](x: Self) {
    ...
    inline def setError(value: (/* ele */ Element | HTMLElement, /* msg */ String) => Callback): Self = StObject.set(x, "error", js.Any.fromFunction2((t0: /* ele */ Element | HTMLElement, t1: /* msg */ String) => (value(t0, t1)).runNow()))
    ...
    inline def setSuccess(value: /* ele */ Element | HTMLElement => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* ele */ Element | HTMLElement) => value(t0).runNow()))
