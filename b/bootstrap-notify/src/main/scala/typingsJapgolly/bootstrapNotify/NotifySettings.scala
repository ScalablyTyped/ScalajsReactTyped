...
import typingsJapgolly.bootstrapNotify.anon.Align
import typingsJapgolly.bootstrapNotify.anon.Enter
import typingsJapgolly.bootstrapNotify.anon.X
...
object NotifySettings {
  ...
  extension [Self <: NotifySettings](x: Self) {
    ...
    inline def setOnClose(value: /* $ele */ JQuery[HTMLElement] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* $ele */ JQuery[HTMLElement]) => value(t0).runNow()))
    
    inline def setOnCloseUndefined: Self = StObject.set(x, "onClose", js.undefined)
    
    inline def setOnClosed(value: /* $ele */ JQuery[HTMLElement] => Callback): Self = StObject.set(x, "onClosed", js.Any.fromFunction1((t0: /* $ele */ JQuery[HTMLElement]) => value(t0).runNow()))
    
    inline def setOnClosedUndefined: Self = StObject.set(x, "onClosed", js.undefined)
    
    inline def setOnShow(value: /* $ele */ JQuery[HTMLElement] => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* $ele */ JQuery[HTMLElement]) => value(t0).runNow()))
    
    inline def setOnShowUndefined: Self = StObject.set(x, "onShow", js.undefined)
    
    inline def setOnShown(value: /* $ele */ JQuery[HTMLElement] => Callback): Self = StObject.set(x, "onShown", js.Any.fromFunction1((t0: /* $ele */ JQuery[HTMLElement]) => value(t0).runNow()))
