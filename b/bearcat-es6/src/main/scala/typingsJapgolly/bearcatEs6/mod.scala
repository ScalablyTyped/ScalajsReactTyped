package typingsJapgolly.bearcatEs6
...
object mod extends Shortcut {
  ...
  object BeanPostProcessor {
    ...
    inline def apply(postProcessBeanFactory: Callback): BeanPostProcessor = {
      val __obj = js.Dynamic.literal(postProcessBeanFactory = postProcessBeanFactory.toJsFn)
      __obj.asInstanceOf[BeanPostProcessor]
    }
    
    extension [Self <: BeanPostProcessor](x: Self) {
      
      inline def setPostProcessBeanFactory(value: Callback): Self = StObject.set(x, "postProcessBeanFactory", value.toJsFn)
    }
  }
  ...
  object BootStrapLoader {
    ...
    inline def apply(load: js.Array[String] => Callback): BootStrapLoader = {
      val __obj = js.Dynamic.literal(load = js.Any.fromFunction1((t0: js.Array[String]) => load(t0).runNow()))
  ...
  object ConfigLoader {
    ...
    inline def apply(
      getMetaLoader: CallbackTo[MetaLoader],
      getRecursiveScanPath: (String, js.Array[String], js.Object) => Callback,
      getResources: String => js.Object
    ): ConfigLoader = {
      val __obj = js.Dynamic.literal(getMetaLoader = getMetaLoader.toJsFn, getRecursiveScanPath = js.Any.fromFunction3((t0: String, t1: js.Array[String], t2: js.Object) => (getRecursiveScanPath(t0, t1, t2)).runNow()), getResources = js.Any.fromFunction1(getResources))
      __obj.asInstanceOf[ConfigLoader]
    }
    
    extension [Self <: ConfigLoader](x: Self) {
      
      inline def setGetMetaLoader(value: CallbackTo[MetaLoader]): Self = StObject.set(x, "getMetaLoader", value.toJsFn)
      
      inline def setGetRecursiveScanPath(value: (String, js.Array[String], js.Object) => Callback): Self = StObject.set(x, "getRecursiveScanPath", js.Any.fromFunction3((t0: String, t1: js.Array[String], t2: js.Object) => (value(t0, t1, t2)).runNow()))
  ...
  object MetaLoader {
    ...
    inline def apply(
      getMetaObjects: CallbackTo[js.Object],
      load: String => js.Object,
      metaObjects: js.Object,
      setMetaObject: (String, js.Object) => Callback
    ): MetaLoader = {
      val __obj = js.Dynamic.literal(getMetaObjects = getMetaObjects.toJsFn, load = js.Any.fromFunction1(load), metaObjects = metaObjects.asInstanceOf[js.Any], setMetaObject = js.Any.fromFunction2((t0: String, t1: js.Object) => (setMetaObject(t0, t1)).runNow()))
      __obj.asInstanceOf[MetaLoader]
    }
    
    extension [Self <: MetaLoader](x: Self) {
      
      inline def setGetMetaObjects(value: CallbackTo[js.Object]): Self = StObject.set(x, "getMetaObjects", value.toJsFn)
      ...
      inline def setSetMetaObject(value: (String, js.Object) => Callback): Self = StObject.set(x, "setMetaObject", js.Any.fromFunction2((t0: String, t1: js.Object) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object ModuleFactory {
    ...
    inline def apply(
      define: (String, js.Object) => Callback,
      factoryMap: js.Object,
      moduleMap: js.Object,
      require: String => Any
    ): ModuleFactory = {
      val __obj = js.Dynamic.literal(define = js.Any.fromFunction2((t0: String, t1: js.Object) => (define(t0, t1)).runNow()), factoryMap = factoryMap.asInstanceOf[js.Any], moduleMap = moduleMap.asInstanceOf[js.Any], require = js.Any.fromFunction1(require))
      __obj.asInstanceOf[ModuleFactory]
    }
    
    extension [Self <: ModuleFactory](x: Self) {
      
      inline def setDefine(value: (String, js.Object) => Callback): Self = StObject.set(x, "define", js.Any.fromFunction2((t0: String, t1: js.Object) => (value(t0, t1)).runNow()))
  ...
  object ResourceLoader {
    ...
    inline def apply(
      addLoadPath: String => Callback,
      getConfigLoader: CallbackTo[ConfigLoader],
      load: String => js.Object,
      loadPathMap: js.Object,
      loadPaths: String
    ): ResourceLoader = {
      val __obj = js.Dynamic.literal(addLoadPath = js.Any.fromFunction1((t0: String) => addLoadPath(t0).runNow()), getConfigLoader = getConfigLoader.toJsFn, load = js.Any.fromFunction1(load), loadPathMap = loadPathMap.asInstanceOf[js.Any], loadPaths = loadPaths.asInstanceOf[js.Any])
      __obj.asInstanceOf[ResourceLoader]
    }
    
    extension [Self <: ResourceLoader](x: Self) {
      
      inline def setAddLoadPath(value: String => Callback): Self = StObject.set(x, "addLoadPath", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setGetConfigLoader(value: CallbackTo[ConfigLoader]): Self = StObject.set(x, "getConfigLoader", value.toJsFn)
  ...
  object SingletonBeanFactory {
    ...
    inline def apply(
      addSingleton: (String, js.Object) => Callback,
      beanFactory: BeanFactory,
      containsSingleton: String => Boolean,
      getSingleton: String => js.Object,
      getSingletonNames: CallbackTo[js.Array[String]],
      removeSingleton: String => Callback,
      singletonObjects: js.Object
    ): SingletonBeanFactory = {
      val __obj = js.Dynamic.literal(addSingleton = js.Any.fromFunction2((t0: String, t1: js.Object) => (addSingleton(t0, t1)).runNow()), beanFactory = beanFactory.asInstanceOf[js.Any], containsSingleton = js.Any.fromFunction1(containsSingleton), getSingleton = js.Any.fromFunction1(getSingleton), getSingletonNames = getSingletonNames.toJsFn, removeSingleton = js.Any.fromFunction1((t0: String) => removeSingleton(t0).runNow()), singletonObjects = singletonObjects.asInstanceOf[js.Any])
      __obj.asInstanceOf[SingletonBeanFactory]
    }
    
    extension [Self <: SingletonBeanFactory](x: Self) {
      
      inline def setAddSingleton(value: (String, js.Object) => Callback): Self = StObject.set(x, "addSingleton", js.Any.fromFunction2((t0: String, t1: js.Object) => (value(t0, t1)).runNow()))
      ...
      inline def setGetSingletonNames(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "getSingletonNames", value.toJsFn)
      
      inline def setRemoveSingleton(value: String => Callback): Self = StObject.set(x, "removeSingleton", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
