...
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsBooleans.`false`
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsBooleans.`true`
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Ampersand
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.AmpersandAmpersand
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Asterisk
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.AsteriskAsterisk
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.BlockStatement
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ClassBody
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.CommonJS
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ES
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.EqualssignEqualssign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.EqualssignEqualssignEqualssign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Exclamationmark
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ExclamationmarkEqualssign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ExclamationmarkEqualssignEqualssign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Greaterthansign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.GreaterthansignEqualssign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.GreaterthansignGreaterthansign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.GreaterthansignGreaterthansignGreaterthansign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Identifier
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Lessthansign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.LessthansignEqualssign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.LessthansignLessthansign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Percentsign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Plussign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.PlussignPlussign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.QuestionmarkQuestionmark
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Slash
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.StringLiteral
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Tilde
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Verticalline
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.VerticallineGreaterthansign
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.VerticallineVerticalline
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.^
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.`--`
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.`-_`
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.`object`
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.`throw`
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.`var`
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.boolean
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.const
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.constructor
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.delete
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.function
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.get
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.in
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.instanceof
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.let
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.method
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.minus
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.module
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.number
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.plus
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.script
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.set
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.string
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.symbol
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.typeof
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.undefined
import typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.void
...
object anon {
  ...
  trait Typeoftypes extends StObject {
    ...
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ClassAccessorProperty, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.AnyTypeAnnotation, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ArgumentPlaceholder */ Any */](`type`: T): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ClassAccessorProperty, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.AnyTypeAnnotation, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ArgumentPlaceholder */ Any */](`type`: T, n: Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    ...
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ClassAccessorProperty, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.AnyTypeAnnotation, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ClassAccessorProperty, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.AnyTypeAnnotation, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[Node, Type[T]] */](`type`: T, n: Unit, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ClassAccessorProperty, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.AnyTypeAnnotation, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[Node, Type[T]] */](`type`: T, n: Node, required: Partial[P]): /* is P */ Boolean = js.native
    ...
    def isPlaceholderType(
      placeholderType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ClassAccessorProperty, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.AnyTypeAnnotation, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ArgumentPlaceholder */ Any,
      targetType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ClassAccessorProperty, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.AnyTypeAnnotation, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ArgumentPlaceholder */ Any
    ): Boolean = js.native
    ...
    def isType[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ClassAccessorProperty, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.AnyTypeAnnotation, typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.ArgumentPlaceholder */ Any */](nodetype: String, targetType: T): /* is T */ Boolean = js.native
    ...
    def placeholder(
      expectedNode: Identifier | StringLiteral | typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Expression | typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Statement | typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Declaration | BlockStatement | ClassBody | typingsJapgolly.babelHelperPluginUtils.babelHelperPluginUtilsStrings.Pattern,
      name: Identifier_
