...
open class VectorScatter ()
  extends typingsJapgolly.blackEngine.scattersVectorScatterMod.VectorScatter {
...
object VectorScatter {
  ...
  inline def fromObject(values: (Double | typingsJapgolly.blackEngine.scattersVectorScatterBaseMod.VectorScatterBase)*): typingsJapgolly.blackEngine.scattersVectorScatterBaseMod.VectorScatterBase = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(values.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typingsJapgolly.blackEngine.scattersVectorScatterBaseMod.VectorScatterBase]
}
