...
object distLibRegistryMod {
  ...
  open class default protected () extends Registry {
    def this(server: typingsJapgolly.bonjourService.distLibMdnsServerMod.default) = this()
  }
  ...
  open class Registry protected () extends StObject {
    ...
    def publish(config: ServiceConfig): typingsJapgolly.bonjourService.distLibServiceMod.default = js.native
