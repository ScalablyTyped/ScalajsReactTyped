...
object DatetimepickerOptions {
  ...
  def apply(
    ...
    parseInputDate: /* input */ String | js.Date | Moment => CallbackTo[Moment] = null,
    ...
    if (parseInputDate != null) __obj.updateDynamic("parseInputDate")(js.Any.fromFunction1((t0: /* input */ java.lang.String | js.Date | typingsJapgolly.moment.mod.Moment) => parseInputDate(t0).runNow()))
