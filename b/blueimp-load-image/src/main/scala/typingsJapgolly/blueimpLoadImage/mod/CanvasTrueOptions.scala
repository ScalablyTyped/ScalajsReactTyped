...
import typingsJapgolly.blueimpLoadImage.blueimpLoadImageStrings.high
import typingsJapgolly.blueimpLoadImage.blueimpLoadImageStrings.low
import typingsJapgolly.blueimpLoadImage.blueimpLoadImageStrings.medium
