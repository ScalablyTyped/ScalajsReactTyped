...
object anon {
  ...
  object PartialDateInputProps {
    ...
    extension [Self <: PartialDateInputProps](x: Self) {
      ...
      inline def setFooterElement(value: VdomElement): Self = StObject.set(x, "footerElement", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: (/* selectedDate */ js.Date | Null, /* isUserChange */ Boolean) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* selectedDate */ js.Date | Null, t1: /* isUserChange */ Boolean) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnError(value: /* errorDate */ js.Date => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* errorDate */ js.Date) => value(t0).runNow()))
  ...
  object PartialDateRangeInputProp {
    ...
    extension [Self <: PartialDateRangeInputProp](x: Self) {
      ...
      inline def setOnChange(value: /* selectedRange */ DateRange => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* selectedRange */ DateRange) => value(t0).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnError(value: /* errorRange */ DateRange => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* errorRange */ DateRange) => value(t0).runNow()))
  ...
  trait PartialIPopoverProps extends StObject {
    ...
    var targetTagName: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 176, starting with typingsJapgolly.blueprintjsDatetime.blueprintjsDatetimeStrings.a, typingsJapgolly.blueprintjsDatetime.blueprintjsDatetimeStrings.abbr, typingsJapgolly.blueprintjsDatetime.blueprintjsDatetimeStrings.address */ Any
      ] = js.undefined
  ...
  object PartialIPopoverProps {
    ...
    extension [Self <: PartialIPopoverProps](x: Self) {
      ...
      inline def setTargetTagName(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 176, starting with typingsJapgolly.blueprintjsDatetime.blueprintjsDatetimeStrings.a, typingsJapgolly.blueprintjsDatetime.blueprintjsDatetimeStrings.abbr, typingsJapgolly.blueprintjsDatetime.blueprintjsDatetimeStrings.address */ Any
  ...
  object PartialIShortcutsProps {
    ...
    extension [Self <: PartialIShortcutsProps](x: Self) {
      ...
      inline def setOnShortcutClick(value: (/* shortcut */ DateRangeShortcut, /* index */ Double) => Callback): Self = StObject.set(x, "onShortcutClick", js.Any.fromFunction2((t0: /* shortcut */ DateRangeShortcut, t1: /* index */ Double) => (value(t0, t1)).runNow()))
