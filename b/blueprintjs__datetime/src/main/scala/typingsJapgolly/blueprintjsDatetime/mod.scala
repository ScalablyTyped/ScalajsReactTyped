...
import typingsJapgolly.blueprintjsDatetime.anon.PartialDateInputProps
import typingsJapgolly.blueprintjsDatetime.anon.PartialDateRangeInputProp
...
import typingsJapgolly.blueprintjsDatetime.libEsmDateInputMod.DateInputProps
...
import typingsJapgolly.blueprintjsDatetime.libEsmDateRangeInputMod.DateRangeInputProps
import typingsJapgolly.blueprintjsDatetime.libEsmDateRangePickerMod.DateRangePickerProps
...
object mod {
  ...
  open class DateInput protected ()
    extends typingsJapgolly.blueprintjsDatetime.libEsmDateInputMod.DateInput {
  ...
  open class DatePicker protected ()
    extends typingsJapgolly.blueprintjsDatetime.libEsmDatePickerMod.DatePicker {
  ...
  open class DateRangeInput protected ()
    extends typingsJapgolly.blueprintjsDatetime.libEsmDateRangeInputMod.DateRangeInput {
  ...
  open class DateRangePicker protected ()
    extends typingsJapgolly.blueprintjsDatetime.libEsmDateRangePickerMod.DateRangePicker {
  ...
  open class DateTimePicker ()
    extends typingsJapgolly.blueprintjsDatetime.libEsmDateTimePickerMod.DateTimePicker {
  ...
  object Months extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months & Double] = js.native
    
    /* 3 */ val APRIL: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.APRIL & Double = js.native
    
    /* 7 */ val AUGUST: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.AUGUST & Double = js.native
    
    /* 11 */ val DECEMBER: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.DECEMBER & Double = js.native
    
    /* 1 */ val FEBRUARY: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.FEBRUARY & Double = js.native
    
    /* 0 */ val JANUARY: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.JANUARY & Double = js.native
    
    /* 6 */ val JULY: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.JULY & Double = js.native
    
    /* 5 */ val JUNE: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.JUNE & Double = js.native
    
    /* 2 */ val MARCH: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.MARCH & Double = js.native
    
    /* 4 */ val MAY: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.MAY & Double = js.native
    
    /* 10 */ val NOVEMBER: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.NOVEMBER & Double = js.native
    
    /* 9 */ val OCTOBER: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.OCTOBER & Double = js.native
    
    /* 8 */ val SEPTEMBER: typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthsMod.Months.SEPTEMBER & Double = js.native
  }
  
  @JSImport("@blueprintjs/datetime", "TimePicker")
  @js.native
  open class TimePicker ()
    extends typingsJapgolly.blueprintjsDatetime.libEsmTimePickerMod.TimePicker {
  ...
  object TimeUnit extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.blueprintjsDatetime.libEsmCommonTimeUnitMod.TimeUnit & String] = js.native
    
    /* "hour12" */ val HOUR_12: typingsJapgolly.blueprintjsDatetime.libEsmCommonTimeUnitMod.TimeUnit.HOUR_12 & String = js.native
    
    /* "hour24" */ val HOUR_24: typingsJapgolly.blueprintjsDatetime.libEsmCommonTimeUnitMod.TimeUnit.HOUR_24 & String = js.native
    
    /* "minute" */ val MINUTE: typingsJapgolly.blueprintjsDatetime.libEsmCommonTimeUnitMod.TimeUnit.MINUTE & String = js.native
    
    /* "ms" */ val MS: typingsJapgolly.blueprintjsDatetime.libEsmCommonTimeUnitMod.TimeUnit.MS & String = js.native
    
    /* "second" */ val SECOND: typingsJapgolly.blueprintjsDatetime.libEsmCommonTimeUnitMod.TimeUnit.SECOND & String = js.native
  }
