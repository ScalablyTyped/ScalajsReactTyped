...
import typingsJapgolly.blueprintjsDatetime.libEsmCommonMonthAndYearMod.MonthAndYear
...
object libEsmDateRangePickerMod {
  ...
  object IDateRangePickerProps {
    ...
    extension [Self <: IDateRangePickerProps](x: Self) {
      ...
      inline def setOnChange(value: /* selectedDates */ DateRange => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* selectedDates */ DateRange) => value(t0).runNow()))
      ...
      ): Self = StObject.set(x, "onHoverChange", js.Any.fromFunction3((t0: /* hoveredDates */ DateRange, t1: /* hoveredDay */ js.Date, t2: /* hoveredBoundary */ Boundary) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnHoverChangeUndefined: Self = StObject.set(x, "onHoverChange", js.undefined)
      
      inline def setOnShortcutChange(value: (/* shortcut */ DateRangeShortcut, /* index */ Double) => Callback): Self = StObject.set(x, "onShortcutChange", js.Any.fromFunction2((t0: /* shortcut */ DateRangeShortcut, t1: /* index */ Double) => (value(t0, t1)).runNow()))
