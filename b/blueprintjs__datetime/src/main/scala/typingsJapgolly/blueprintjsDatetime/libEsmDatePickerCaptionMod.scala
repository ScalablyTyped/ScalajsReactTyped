...
object libEsmDatePickerCaptionMod {
  ...
  object IDatePickerCaptionProps {
    ...
    extension [Self <: IDatePickerCaptionProps](x: Self) {
      ...
      inline def setOnDateChange(value: /* date */ js.Date => Callback): Self = StObject.set(x, "onDateChange", js.Any.fromFunction1((t0: /* date */ js.Date) => value(t0).runNow()))
      
      inline def setOnDateChangeUndefined: Self = StObject.set(x, "onDateChange", js.undefined)
      
      inline def setOnMonthChange(value: /* month */ Double => Callback): Self = StObject.set(x, "onMonthChange", js.Any.fromFunction1((t0: /* month */ Double) => value(t0).runNow()))
      
      inline def setOnMonthChangeUndefined: Self = StObject.set(x, "onMonthChange", js.undefined)
      
      inline def setOnYearChange(value: /* year */ Double => Callback): Self = StObject.set(x, "onYearChange", js.Any.fromFunction1((t0: /* year */ Double) => value(t0).runNow()))
