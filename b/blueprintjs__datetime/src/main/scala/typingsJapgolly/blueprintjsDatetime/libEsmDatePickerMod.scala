...
import typingsJapgolly.blueprintjsDatetime.libEsmDatePickerCoreMod.DatePickerBaseProps
import typingsJapgolly.blueprintjsDatetime.libEsmShortcutsMod.DatePickerShortcut
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libEsmDatePickerMod {
  ...
  object IDatePickerProps {
    ...
    extension [Self <: IDatePickerProps](x: Self) {
      ...
      inline def setOnChange(value: (/* selectedDate */ js.Date, /* isUserChange */ Boolean) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* selectedDate */ js.Date, t1: /* isUserChange */ Boolean) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnShortcutChange(value: (/* shortcut */ DatePickerShortcut, /* index */ Double) => Callback): Self = StObject.set(x, "onShortcutChange", js.Any.fromFunction2((t0: /* shortcut */ DatePickerShortcut, t1: /* index */ Double) => (value(t0, t1)).runNow()))
