...
import typingsJapgolly.blueprintjsDatetime.anon.PartialIShortcutsProps
...
object libEsmShortcutsMod {
  ...
  object IShortcutsProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(allowSingleDayRange = allowSingleDayRange.asInstanceOf[js.Any], maxDate = maxDate.asInstanceOf[js.Any], minDate = minDate.asInstanceOf[js.Any], onShortcutClick = js.Any.fromFunction2((t0: DateRangeShortcut, t1: Double) => (onShortcutClick(t0, t1)).runNow()), shortcuts = shortcuts.asInstanceOf[js.Any], timePrecision = timePrecision.asInstanceOf[js.Any])
    ...
    extension [Self <: IShortcutsProps](x: Self) {
      ...
      inline def setOnShortcutClick(value: (DateRangeShortcut, Double) => Callback): Self = StObject.set(x, "onShortcutClick", js.Any.fromFunction2((t0: DateRangeShortcut, t1: Double) => (value(t0, t1)).runNow()))
