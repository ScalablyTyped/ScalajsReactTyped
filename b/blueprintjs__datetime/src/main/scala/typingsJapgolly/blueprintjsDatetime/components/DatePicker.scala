...
import typingsJapgolly.blueprintjsDatetime.libEsmDatePickerMod.IDatePickerProps
...
object DatePicker {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsDatetime.mod.DatePicker] {
    ...
    inline def onShortcutChange(value: (/* shortcut */ DatePickerShortcut, /* index */ Double) => Callback): this.type = set("onShortcutChange", js.Any.fromFunction2((t0: /* shortcut */ DatePickerShortcut, t1: /* index */ Double) => (value(t0, t1)).runNow()))
