...
object BetterSqlite3 {
  ...
  object ColumnDefinition {
    ...
    inline def apply(name: String): typingsJapgolly.betterSqlite3.mod.BetterSqlite3.ColumnDefinition = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], column = null, database = null, table = null)
      __obj.updateDynamic("type")(null)
      __obj.asInstanceOf[typingsJapgolly.betterSqlite3.mod.BetterSqlite3.ColumnDefinition]
    }
    
    extension [Self <: typingsJapgolly.betterSqlite3.mod.BetterSqlite3.ColumnDefinition](x: Self) {
  ...
  trait Database extends StObject {
    ...
    def transaction[F /* <: VariableArgFunction */](fn: F): typingsJapgolly.betterSqlite3.mod.BetterSqlite3.Transaction[F] = js.native
  ...
  trait DatabaseConstructor
    extends StObject
       with Instantiable1[
          ...
          typingsJapgolly.betterSqlite3.mod.BetterSqlite3.Database
        ]
       with Instantiable2[
          (/* filename */ Buffer) | (/* filename */ String), 
          /* options */ Options, 
    ...
    def apply(filename: String): typingsJapgolly.betterSqlite3.mod.BetterSqlite3.Database = js.native
    def apply(filename: String, options: Options): typingsJapgolly.betterSqlite3.mod.BetterSqlite3.Database = js.native
  ...
  trait Statement[BindParameters /* <: js.Array[Any] */] extends StObject {
    ...
    def columns(): js.Array[typingsJapgolly.betterSqlite3.mod.BetterSqlite3.ColumnDefinition] = js.native
    
    var database: typingsJapgolly.betterSqlite3.mod.BetterSqlite3.Database = js.native
  ...
  object VirtualTableOptions {
    ...
    inline def apply(columns: js.Array[String], rows: CallbackTo[Generator[Any, Any, Any]]): VirtualTableOptions = {
      val __obj = js.Dynamic.literal(columns = columns.asInstanceOf[js.Any], rows = rows.toJsFn)
    ...
    extension [Self <: VirtualTableOptions](x: Self) {
      ...
      inline def setRows(value: CallbackTo[Generator[Any, Any, Any]]): Self = StObject.set(x, "rows", value.toJsFn)
