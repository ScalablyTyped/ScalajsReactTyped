...
import typingsJapgolly.betterSqlite3.mod.AggregateOptions
import typingsJapgolly.betterSqlite3.mod.BackupMetadata
import typingsJapgolly.betterSqlite3.mod.BackupOptions
import typingsJapgolly.betterSqlite3.mod.PragmaOptions
import typingsJapgolly.betterSqlite3.mod.RegistrationOptions
import typingsJapgolly.betterSqlite3.mod.VariableArgFunction
