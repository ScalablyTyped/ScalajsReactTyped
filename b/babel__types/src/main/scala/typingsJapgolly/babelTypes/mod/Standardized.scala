...
object Standardized {
  ...
  inline def ClassBody_(
    ...
    __obj.asInstanceOf[typingsJapgolly.babelTypes.mod.ClassBody_]
  }
  ...
  inline def DirectiveLiteral_(value: String): typingsJapgolly.babelTypes.mod.DirectiveLiteral_ = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any], end = null, innerComments = null, leadingComments = null, loc = null, start = null, trailingComments = null)
    __obj.updateDynamic("type")("DirectiveLiteral")
    __obj.asInstanceOf[typingsJapgolly.babelTypes.mod.DirectiveLiteral_]
  }
  
  inline def Directive_(value: DirectiveLiteral_): typingsJapgolly.babelTypes.mod.Directive_ = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any], end = null, innerComments = null, leadingComments = null, loc = null, start = null, trailingComments = null)
    __obj.updateDynamic("type")("Directive")
    __obj.asInstanceOf[typingsJapgolly.babelTypes.mod.Directive_]
  }
  ...
  inline def File_(program: Program_): typingsJapgolly.babelTypes.mod.File_ = {
    ...
    __obj.asInstanceOf[typingsJapgolly.babelTypes.mod.File_]
  }
  ...
  inline def InterpreterDirective_(value: String): typingsJapgolly.babelTypes.mod.InterpreterDirective_ = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any], end = null, innerComments = null, leadingComments = null, loc = null, start = null, trailingComments = null)
    __obj.updateDynamic("type")("InterpreterDirective")
    __obj.asInstanceOf[typingsJapgolly.babelTypes.mod.InterpreterDirective_]
  }
  ...
  inline def SwitchCase_(consequent: js.Array[Statement]): typingsJapgolly.babelTypes.mod.SwitchCase_ = {
    ...
    __obj.asInstanceOf[typingsJapgolly.babelTypes.mod.SwitchCase_]
  }
  ...
  inline def TemplateElement_(tail: Boolean, value: Cooked): typingsJapgolly.babelTypes.mod.TemplateElement_ = {
    ...
    __obj.asInstanceOf[typingsJapgolly.babelTypes.mod.TemplateElement_]
  }
  ...
  inline def VariableDeclarator_(id: LVal): typingsJapgolly.babelTypes.mod.VariableDeclarator_ = {
    ...
    __obj.asInstanceOf[typingsJapgolly.babelTypes.mod.VariableDeclarator_]
  }
