...
import typingsJapgolly.babelTypes.babelTypesStrings.TSRestType
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.babelTypes.mod._Node because Already inherited */ trait TSRestType_
  extends StObject
     with BaseNode
     with TSType
     with TypeScript {
...
object TSRestType_ {
  ...
  inline def apply(typeAnnotation: TSType): TSRestType_ = {
  ...
  extension [Self <: TSRestType_](x: Self) {
