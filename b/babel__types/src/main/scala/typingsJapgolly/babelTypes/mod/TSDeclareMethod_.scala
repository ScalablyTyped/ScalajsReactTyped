...
import typingsJapgolly.babelTypes.babelTypesStrings.TSDeclareMethod
...
- typingsJapgolly.babelTypes.mod._Node because Already inherited */ trait TSDeclareMethod_
  extends StObject
     with BaseNode
     with TypeScript {
