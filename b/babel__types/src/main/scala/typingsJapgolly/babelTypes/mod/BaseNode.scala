...
trait BaseNode extends StObject {
  ...
  var `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelTypes.babelTypesStrings.ClassAccessorProperty, typingsJapgolly.babelTypes.babelTypesStrings.AnyTypeAnnotation, typingsJapgolly.babelTypes.babelTypesStrings.ArgumentPlaceholder */ Any
}
object BaseNode {
  
  inline def apply(
    `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelTypes.babelTypesStrings.ClassAccessorProperty, typingsJapgolly.babelTypes.babelTypesStrings.AnyTypeAnnotation, typingsJapgolly.babelTypes.babelTypesStrings.ArgumentPlaceholder */ Any
  ): BaseNode = {
  ...
  extension [Self <: BaseNode](x: Self) {
    ...
    inline def setType(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelTypes.babelTypesStrings.ClassAccessorProperty, typingsJapgolly.babelTypes.babelTypesStrings.AnyTypeAnnotation, typingsJapgolly.babelTypes.babelTypesStrings.ArgumentPlaceholder */ Any
