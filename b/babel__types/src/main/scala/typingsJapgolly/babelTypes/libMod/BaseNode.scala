...
trait BaseNode extends StObject {
  ...
  var `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 252, starting with typingsJapgolly.babelTypes.babelTypesStrings.AnyTypeAnnotation, typingsJapgolly.babelTypes.babelTypesStrings.ArgumentPlaceholder, typingsJapgolly.babelTypes.babelTypesStrings.ArrayExpression */ Any
}
object BaseNode {
  
  inline def apply(
    `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 252, starting with typingsJapgolly.babelTypes.babelTypesStrings.AnyTypeAnnotation, typingsJapgolly.babelTypes.babelTypesStrings.ArgumentPlaceholder, typingsJapgolly.babelTypes.babelTypesStrings.ArrayExpression */ Any
  ): BaseNode = {
  ...
  extension [Self <: BaseNode](x: Self) {
    ...
    inline def setType(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 252, starting with typingsJapgolly.babelTypes.babelTypesStrings.AnyTypeAnnotation, typingsJapgolly.babelTypes.babelTypesStrings.ArgumentPlaceholder, typingsJapgolly.babelTypes.babelTypesStrings.ArrayExpression */ Any
