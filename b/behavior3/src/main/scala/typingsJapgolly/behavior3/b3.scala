...
object b3 {
  ...
  object BaseNode {
    ...
    inline def apply(
      _close: Tick => Callback,
      _enter: Tick => Callback,
      ...
      val __obj = js.Dynamic.literal(_close = js.Any.fromFunction1((t0: Tick) => _close(t0).runNow()), _enter = js.Any.fromFunction1((t0: Tick) => _enter(t0).runNow()), _execute = js.Any.fromFunction1(_execute), _exit = js.Any.fromFunction1((t0: Tick) => _exit(t0).runNow()), _open = js.Any.fromFunction1((t0: Tick) => _open(t0).runNow()), _tick = js.Any.fromFunction1(_tick), close = js.Any.fromFunction1((t0: Tick) => close(t0).runNow()), enter = js.Any.fromFunction1((t0: Tick) => enter(t0).runNow()), exit = js.Any.fromFunction1((t0: Tick) => exit(t0).runNow()), open = js.Any.fromFunction1((t0: Tick) => open(t0).runNow()), tick = js.Any.fromFunction1((t0: Tick) => tick(t0).runNow()))
      __obj.asInstanceOf[BaseNode]
    }
    
    extension [Self <: BaseNode](x: Self) {
      
      inline def setClose(value: Tick => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: Tick) => value(t0).runNow()))
      
      inline def setEnter(value: Tick => Callback): Self = StObject.set(x, "enter", js.Any.fromFunction1((t0: Tick) => value(t0).runNow()))
      
      inline def setExit(value: Tick => Callback): Self = StObject.set(x, "exit", js.Any.fromFunction1((t0: Tick) => value(t0).runNow()))
      
      inline def setOpen(value: Tick => Callback): Self = StObject.set(x, "open", js.Any.fromFunction1((t0: Tick) => value(t0).runNow()))
      
      inline def setTick(value: Tick => Callback): Self = StObject.set(x, "tick", js.Any.fromFunction1((t0: Tick) => value(t0).runNow()))
      
      inline def set_close(value: Tick => Callback): Self = StObject.set(x, "_close", js.Any.fromFunction1((t0: Tick) => value(t0).runNow()))
      
      inline def set_enter(value: Tick => Callback): Self = StObject.set(x, "_enter", js.Any.fromFunction1((t0: Tick) => value(t0).runNow()))
      
      inline def set_execute(value: Tick => Double): Self = StObject.set(x, "_execute", js.Any.fromFunction1(value))
      
      inline def set_exit(value: Tick => Callback): Self = StObject.set(x, "_exit", js.Any.fromFunction1((t0: Tick) => value(t0).runNow()))
      
      inline def set_open(value: Tick => Callback): Self = StObject.set(x, "_open", js.Any.fromFunction1((t0: Tick) => value(t0).runNow()))
  ...
  object Blackboard {
    ...
    inline def apply(
      ...
      set: (String, String, String, String) => Callback
    ): Blackboard = {
      val __obj = js.Dynamic.literal(_getMemory = js.Any.fromFunction2(_getMemory), _getNodeMemory = js.Any.fromFunction2(_getNodeMemory), _getTreeMemory = js.Any.fromFunction1(_getTreeMemory), get = js.Any.fromFunction3(get), set = js.Any.fromFunction4((t0: String, t1: String, t2: String, t3: String) => (set(t0, t1, t2, t3)).runNow()))
    ...
    extension [Self <: Blackboard](x: Self) {
      ...
      inline def setSet(value: (String, String, String, String) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction4((t0: String, t1: String, t2: String, t3: String) => (value(t0, t1, t2, t3)).runNow()))
  ...
  object Tick {
    ...
    inline def apply(
      _closeNode: Any => Callback,
      _enterNode: Any => Callback,
      _exitNode: Any => Callback,
      _openNode: Any => Callback,
      _tickNode: Any => Callback
    ): Tick = {
      val __obj = js.Dynamic.literal(_closeNode = js.Any.fromFunction1((t0: Any) => _closeNode(t0).runNow()), _enterNode = js.Any.fromFunction1((t0: Any) => _enterNode(t0).runNow()), _exitNode = js.Any.fromFunction1((t0: Any) => _exitNode(t0).runNow()), _openNode = js.Any.fromFunction1((t0: Any) => _openNode(t0).runNow()), _tickNode = js.Any.fromFunction1((t0: Any) => _tickNode(t0).runNow()))
      __obj.asInstanceOf[Tick]
    }
    
    extension [Self <: Tick](x: Self) {
      
      inline def set_closeNode(value: Any => Callback): Self = StObject.set(x, "_closeNode", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def set_enterNode(value: Any => Callback): Self = StObject.set(x, "_enterNode", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def set_exitNode(value: Any => Callback): Self = StObject.set(x, "_exitNode", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def set_openNode(value: Any => Callback): Self = StObject.set(x, "_openNode", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def set_tickNode(value: Any => Callback): Self = StObject.set(x, "_tickNode", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    }
  }
