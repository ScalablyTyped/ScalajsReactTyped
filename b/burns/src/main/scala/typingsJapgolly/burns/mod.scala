...
import typingsJapgolly.burns.anon.BroadcastIf
...
object mod extends Shortcut {
  ...
  object Burns {
    ...
    object Config {
      ...
      inline def apply(): typingsJapgolly.burns.mod.Burns.Config = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.burns.mod.Burns.Config]
      }
      
      extension [Self <: typingsJapgolly.burns.mod.Burns.Config](x: Self) {
