...
import typingsJapgolly.burns.burnsBooleans.`false`
import typingsJapgolly.burns.typesRepositoriesConfigMod.Config
...
object anon {
  ...
  object Add {
    ...
    inline def apply(
      ...
      addEventHandlers: (String, /* repeated */ js.Function1[/* payload */ Any, `false` | Unit]) => Callback,
      broadcastConfig: String => BroadcastOn,
      handlers: String => js.Array[js.Function1[/* payload */ Any, `false` | Unit]],
      updateEventConfig: (String, BroadcastIf) => Callback
    ): Add = {
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction1((t0: StringDictionary[
          (js.Function1[/* payload */ Any, `false` | Unit]) | (js.Array[js.Function1[/* payload */ Any, `false` | Unit]]) | BroadcastIf
        ]) => add(t0).runNow()), addEventHandlers = js.Any.fromFunction2((t0: String, t1: /* repeated */ js.Function1[/* payload */ Any, `false` | Unit]) => (addEventHandlers(t0, t1)).runNow()), broadcastConfig = js.Any.fromFunction1(broadcastConfig), handlers = js.Any.fromFunction1(handlers), updateEventConfig = js.Any.fromFunction2((t0: String, t1: BroadcastIf) => (updateEventConfig(t0, t1)).runNow()))
    ...
    extension [Self <: Add](x: Self) {
      ...
      ): Self = StObject.set(x, "add", js.Any.fromFunction1((t0: StringDictionary[
              (js.Function1[/* payload */ Any, `false` | Unit]) | (js.Array[js.Function1[/* payload */ Any, `false` | Unit]]) | BroadcastIf
            ]) => value(t0).runNow()))
      
      inline def setAddEventHandlers(value: (String, /* repeated */ js.Function1[/* payload */ Any, `false` | Unit]) => Callback): Self = StObject.set(x, "addEventHandlers", js.Any.fromFunction2((t0: String, t1: /* repeated */ js.Function1[/* payload */ Any, `false` | Unit]) => (value(t0, t1)).runNow()))
      ...
      inline def setUpdateEventConfig(value: (String, BroadcastIf) => Callback): Self = StObject.set(x, "updateEventConfig", js.Any.fromFunction2((t0: String, t1: BroadcastIf) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object CreateBroadcaster {
    ...
    inline def apply(createBroadcaster: String => Any, options: Config, set: Config => Callback): CreateBroadcaster = {
      val __obj = js.Dynamic.literal(createBroadcaster = js.Any.fromFunction1(createBroadcaster), options = options.asInstanceOf[js.Any], set = js.Any.fromFunction1((t0: Config) => set(t0).runNow()))
    ...
    extension [Self <: CreateBroadcaster](x: Self) {
      ...
      inline def setSet(value: Config => Callback): Self = StObject.set(x, "set", js.Any.fromFunction1((t0: Config) => value(t0).runNow()))
    }
  }
