...
object errorMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    @JSName("name")
    var name_BrowserslistError: typingsJapgolly.browserslist.browserslistStrings.BrowserslistError = js.native
  }
  ...
  trait BrowserslistError
    ...
    @JSName("name")
    var name_BrowserslistError: typingsJapgolly.browserslist.browserslistStrings.BrowserslistError
  }
  object BrowserslistError {
    ...
    extension [Self <: BrowserslistError](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.browserslist.browserslistStrings.BrowserslistError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
}
