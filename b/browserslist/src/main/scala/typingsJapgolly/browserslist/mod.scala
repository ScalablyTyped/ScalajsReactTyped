...
import typingsJapgolly.browserslist.browserslistBooleans.`false`
import typingsJapgolly.browserslist.browserslistBooleans.`true`
import typingsJapgolly.browserslist.browserslistStrings.and
import typingsJapgolly.browserslist.browserslistStrings.or
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.browserslist.browserslistStrings.`my stats`
    - typingsJapgolly.browserslist.mod.Stats
    - typingsJapgolly.browserslist.anon.DataByBrowser
  */
