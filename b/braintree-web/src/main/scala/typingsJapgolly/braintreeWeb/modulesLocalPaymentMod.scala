...
import typingsJapgolly.braintreeWeb.anon.Height
...
object modulesLocalPaymentMod {
  ...
  object LocalPaymentStartPaymentOptions {
    ...
    extension [Self <: LocalPaymentStartPaymentOptions](x: Self) {
      ...
      inline def setOnPaymentStart(value: (/* data */ LocalPaymentStartData, /* callback */ callback[Any]) => Callback): Self = StObject.set(x, "onPaymentStart", js.Any.fromFunction2((t0: /* data */ LocalPaymentStartData, t1: /* callback */ callback[Any]) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.bancontact
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.blik
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.eps
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.giropay
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.ideal
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.sofort
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.mybank
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.p24
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.trustly
  */
  trait LocalPaymentTypes extends StObject
  object LocalPaymentTypes {
    
    inline def bancontact: typingsJapgolly.braintreeWeb.braintreeWebStrings.bancontact = "bancontact".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.bancontact]
    
    inline def blik: typingsJapgolly.braintreeWeb.braintreeWebStrings.blik = "blik".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.blik]
    
    inline def eps: typingsJapgolly.braintreeWeb.braintreeWebStrings.eps = "eps".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.eps]
    
    inline def giropay: typingsJapgolly.braintreeWeb.braintreeWebStrings.giropay = "giropay".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.giropay]
    
    inline def ideal: typingsJapgolly.braintreeWeb.braintreeWebStrings.ideal = "ideal".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.ideal]
    
    inline def mybank: typingsJapgolly.braintreeWeb.braintreeWebStrings.mybank = "mybank".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.mybank]
    
    inline def p24: typingsJapgolly.braintreeWeb.braintreeWebStrings.p24 = "p24".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.p24]
    
    inline def sofort: typingsJapgolly.braintreeWeb.braintreeWebStrings.sofort = "sofort".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.sofort]
    
    inline def trustly: typingsJapgolly.braintreeWeb.braintreeWebStrings.trustly = "trustly".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.trustly]
  }
}
