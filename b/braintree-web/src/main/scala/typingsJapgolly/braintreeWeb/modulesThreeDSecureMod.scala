...
import typingsJapgolly.braintreeWeb.anon.Bin
import typingsJapgolly.braintreeWeb.anon.LiabilityShiftPossible
import typingsJapgolly.braintreeWeb.anon.ThreeDSecureVersion
import typingsJapgolly.braintreeWeb.braintreeWebInts.`1`
import typingsJapgolly.braintreeWeb.braintreeWebInts.`2`
import typingsJapgolly.braintreeWeb.braintreeWebStrings.`2-bootstrap3-modal`
import typingsJapgolly.braintreeWeb.braintreeWebStrings.`2-inline-iframe`
import typingsJapgolly.braintreeWeb.braintreeWebStrings.`lookup-complete`
import typingsJapgolly.braintreeWeb.modulesClientMod.Client
import typingsJapgolly.braintreeWeb.modulesCoreMod.BraintreeError
import typingsJapgolly.braintreeWeb.modulesCoreMod.callback
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object modulesThreeDSecureMod {
  ...
  trait ThreeDSecureCreateOptions extends StObject {
    ...
    var version: js.UndefOr[
        `1` | typingsJapgolly.braintreeWeb.braintreeWebStrings.`1` | `2` | typingsJapgolly.braintreeWeb.braintreeWebStrings.`2` | `2-bootstrap3-modal` | `2-inline-iframe`
      ] = js.undefined
  }
  object ThreeDSecureCreateOptions {
    ...
    extension [Self <: ThreeDSecureCreateOptions](x: Self) {
      ...
      inline def setVersion(
        value: `1` | typingsJapgolly.braintreeWeb.braintreeWebStrings.`1` | `2` | typingsJapgolly.braintreeWeb.braintreeWebStrings.`2` | `2-bootstrap3-modal` | `2-inline-iframe`
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.`lookup-complete`
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.`customer-canceled`
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.`authentication-iframe-available`
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.`authentication-modal-render`
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.`authentication-modal-close`
  */
  trait ThreeDSecureEvent extends StObject
  object ThreeDSecureEvent {
    
    inline def `authentication-iframe-available`: typingsJapgolly.braintreeWeb.braintreeWebStrings.`authentication-iframe-available` = "authentication-iframe-available".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.`authentication-iframe-available`]
    
    inline def `authentication-modal-close`: typingsJapgolly.braintreeWeb.braintreeWebStrings.`authentication-modal-close` = "authentication-modal-close".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.`authentication-modal-close`]
    
    inline def `authentication-modal-render`: typingsJapgolly.braintreeWeb.braintreeWebStrings.`authentication-modal-render` = "authentication-modal-render".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.`authentication-modal-render`]
    
    inline def `customer-canceled`: typingsJapgolly.braintreeWeb.braintreeWebStrings.`customer-canceled` = "customer-canceled".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.`customer-canceled`]
    
    inline def `lookup-complete`: typingsJapgolly.braintreeWeb.braintreeWebStrings.`lookup-complete` = "lookup-complete".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.`lookup-complete`]
  }
  ...
  object ThreeDSecureVerifyOptions {
    ...
    extension [Self <: ThreeDSecureVerifyOptions](x: Self) {
      ...
      inline def setAddFrame(
        value: (/* err */ js.UndefOr[BraintreeError], /* iframe */ js.UndefOr[HTMLIFrameElement]) => Callback
      ): Self = StObject.set(x, "addFrame", js.Any.fromFunction2((t0: /* err */ js.UndefOr[BraintreeError], t1: /* iframe */ js.UndefOr[HTMLIFrameElement]) => (value(t0, t1)).runNow()))
      ...
      inline def setRemoveFrame(value: Callback): Self = StObject.set(x, "removeFrame", value.toJsFn)
