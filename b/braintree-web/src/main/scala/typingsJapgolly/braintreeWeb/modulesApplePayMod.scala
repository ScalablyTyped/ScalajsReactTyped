...
import typingsJapgolly.braintreeWeb.anon.Amount
import typingsJapgolly.braintreeWeb.anon.Client
import typingsJapgolly.braintreeWeb.anon.Commercial
import typingsJapgolly.braintreeWeb.anon.DisplayName
import typingsJapgolly.braintreeWeb.anon.OmitApplePayPaymentReques
import typingsJapgolly.braintreeWeb.anon.Token
import typingsJapgolly.braintreeWeb.braintreeWebStrings.Unknown_
...
object modulesApplePayMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.`final`
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.pending
  */
  trait ApplePayLineItemType extends StObject
  object ApplePayLineItemType {
    
    inline def `final`: typingsJapgolly.braintreeWeb.braintreeWebStrings.`final` = "final".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.`final`]
    
    inline def pending: typingsJapgolly.braintreeWeb.braintreeWebStrings.pending = "pending".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.pending]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.immediate
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.recurring
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.deferred
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.automaticReload
  */
  trait ApplePayPaymentTiming extends StObject
  object ApplePayPaymentTiming {
    
    inline def automaticReload: typingsJapgolly.braintreeWeb.braintreeWebStrings.automaticReload = "automaticReload".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.automaticReload]
    
    inline def deferred: typingsJapgolly.braintreeWeb.braintreeWebStrings.deferred = "deferred".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.deferred]
    
    inline def immediate: typingsJapgolly.braintreeWeb.braintreeWebStrings.immediate = "immediate".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.immediate]
    
    inline def recurring: typingsJapgolly.braintreeWeb.braintreeWebStrings.recurring = "recurring".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.recurring]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.year
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.month
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.day
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.hour
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.minute
  */
  trait ApplePayRecurringPaymentDateUnit extends StObject
  object ApplePayRecurringPaymentDateUnit {
    
    inline def day: typingsJapgolly.braintreeWeb.braintreeWebStrings.day = "day".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.day]
    
    inline def hour: typingsJapgolly.braintreeWeb.braintreeWebStrings.hour = "hour".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.hour]
    
    inline def minute: typingsJapgolly.braintreeWeb.braintreeWebStrings.minute = "minute".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.minute]
    
    inline def month: typingsJapgolly.braintreeWeb.braintreeWebStrings.month = "month".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.month]
    
    inline def year: typingsJapgolly.braintreeWeb.braintreeWebStrings.year = "year".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.year]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.Yes
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.No
    - typingsJapgolly.braintreeWeb.braintreeWebStrings.Unknown_
  */
  trait ApplePayTokenizeValues extends StObject
  object ApplePayTokenizeValues {
    
    inline def No: typingsJapgolly.braintreeWeb.braintreeWebStrings.No = "No".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.No]
    
    inline def Unknown: Unknown_ = "Unknown".asInstanceOf[Unknown_]
    
    inline def Yes: typingsJapgolly.braintreeWeb.braintreeWebStrings.Yes = "Yes".asInstanceOf[typingsJapgolly.braintreeWeb.braintreeWebStrings.Yes]
  }
}
