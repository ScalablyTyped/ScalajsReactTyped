...
import typingsJapgolly.bell.AnonExtendedProfile
import typingsJapgolly.bell.AnonUri
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.bell.mod.CustomProviderOptions
  - typingsJapgolly.bell.mod.KnownProviderOptions
*/
...
object BellOptions {
  ...
  def CustomProviderOptions(
    ...
    runtimeStateCallback: /* req */ Request => CallbackTo[String] = null,
    ...
    if (runtimeStateCallback != null) __obj.updateDynamic("runtimeStateCallback")(js.Any.fromFunction1((t0: /* req */ typingsJapgolly.hapi.mod.Request) => runtimeStateCallback(t0).runNow()))
