...
import typingsJapgolly.bsLogger.distTestingMod.LoggerMock
...
object mod {
  ...
  object LogContexts extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.bsLogger.distLoggerContextMod.LogContexts & String] = js.native
    
    /* "package" */ val _package: typingsJapgolly.bsLogger.distLoggerContextMod.LogContexts._package & String = js.native
    
    /* "application" */ val application: typingsJapgolly.bsLogger.distLoggerContextMod.LogContexts.application & String = js.native
    
    /* "hostname" */ val hostname: typingsJapgolly.bsLogger.distLoggerContextMod.LogContexts.hostname & String = js.native
    
    /* "logLevel" */ val logLevel: typingsJapgolly.bsLogger.distLoggerContextMod.LogContexts.logLevel & String = js.native
    
    /* "namespace" */ val namespace: typingsJapgolly.bsLogger.distLoggerContextMod.LogContexts.namespace & String = js.native
  }
  ...
  object testing {
    ...
    open class LogTargetMock ()
      extends typingsJapgolly.bsLogger.distTestingMod.LogTargetMock {
