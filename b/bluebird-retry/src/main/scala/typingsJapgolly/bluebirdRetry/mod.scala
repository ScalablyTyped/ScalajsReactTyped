package typingsJapgolly.bluebirdRetry
...
object mod {
  ...
  inline def apply[T](func: js.Function1[/* param */ T, Unit]): typingsJapgolly.bluebird.mod.^[T] = ^.asInstanceOf[js.Dynamic].apply(func.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[T]]
  inline def apply[T](func: js.Function1[/* param */ T, Unit], options: Options): typingsJapgolly.bluebird.mod.^[T] = (^.asInstanceOf[js.Dynamic].apply(func.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[T]]
