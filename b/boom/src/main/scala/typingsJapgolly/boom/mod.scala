package typingsJapgolly.boom

import japgolly.scalajs.react.CallbackTo
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.boom.anon.Message
...
object mod {
  ...
  object Boom {
    ...
    inline def apply[Data](
      ...
      typeof: CallbackTo[Any]
    ): Boom[Data] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], isBoom = isBoom.asInstanceOf[js.Any], isServer = isServer.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], output = output.asInstanceOf[js.Any], reformat = reformat.toJsFn, typeof = typeof.toJsFn)
    ...
    extension [Self <: Boom[?], Data](x: Self & Boom[Data]) {
      ...
      inline def setReformat(value: CallbackTo[String]): Self = StObject.set(x, "reformat", value.toJsFn)
      
      inline def setTypeof(value: CallbackTo[Any]): Self = StObject.set(x, "typeof", value.toJsFn)
    }
  }
