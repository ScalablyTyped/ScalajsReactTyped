...
import typingsJapgolly.bbcodeToReact.anon.Linkify
import typingsJapgolly.bbcodeToReact.anon.PartialOmitTagTypechildre
...
object mod extends Shortcut {
  ...
  open class Parser[T] () extends StObject {
    ...
    /**
      ...
      */
    def toReact(input: String): Node = js.native
  }
  ...
  open class Tag[T] protected () extends StObject {
    ...
    /**
      ...
      */
    /* protected */ var children: js.Array[Node] = js.native
    ...
    /**
      ...
      */
    /* protected */ def getComponents(): js.Array[Node] = js.native
    ...
    /**
      ...
      */
    /* protected */ var parent: Node = js.native
    ...
    /**
      ...
      * @returns a react component
      */
    /* protected */ def toReact(): Node = js.native
  }
  ...
  object TagType {
    ...
    inline def apply(children: js.Array[Node], name: String, params: js.Object, text: String): TagType = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], params = params.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any], parent = null)
