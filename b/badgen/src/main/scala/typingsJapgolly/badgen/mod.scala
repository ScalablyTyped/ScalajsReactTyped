package typingsJapgolly.badgen
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.badgen.badgenStrings.flat
    - typingsJapgolly.badgen.badgenStrings.classic
  */
  trait StyleOption extends StObject
  object StyleOption {
    
    inline def classic: typingsJapgolly.badgen.badgenStrings.classic = "classic".asInstanceOf[typingsJapgolly.badgen.badgenStrings.classic]
    
    inline def flat: typingsJapgolly.badgen.badgenStrings.flat = "flat".asInstanceOf[typingsJapgolly.badgen.badgenStrings.flat]
  }
