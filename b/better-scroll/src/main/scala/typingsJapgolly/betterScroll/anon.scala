...
import typingsJapgolly.betterScroll.mod.BounceObjectOption
import typingsJapgolly.betterScroll.mod.DoubleClick
...
object anon {
  ...
  object PartialInfinityOption {
    ...
    extension [Self <: PartialInfinityOption](x: Self) {
      ...
      inline def setFetch(value: /* count */ Double => Callback): Self = StObject.set(x, "fetch", js.Any.fromFunction1((t0: /* count */ Double) => value(t0).runNow()))
