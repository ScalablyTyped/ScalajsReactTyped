package typingsJapgolly.brorand
...
object mod extends Shortcut {
  ...
  open class Rand protected ()
    extends StObject
       with RandInstance {
    def this(rand: typingsJapgolly.brorand.mod.rand) = this()
    
    /* CompleteClass */
    override def generate(len: Double): Buffer | js.typedarray.Uint8Array = js.native
    
    /* CompleteClass */
    var rand: typingsJapgolly.brorand.mod.rand = js.native
  }
  ...
  object rand {
    ...
    inline def apply(getByte: CallbackTo[Double]): rand = {
      val __obj = js.Dynamic.literal(getByte = getByte.toJsFn)
