...
object PartialITimezonePickerPro {
  ...
  def apply(
    ...
    onChange: /* timezone */ String => Callback = null,
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* timezone */ java.lang.String) => onChange(t0).runNow()))
