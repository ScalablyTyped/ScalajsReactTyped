...
object Options {
  ...
  def apply(
    ...
    scriptPath: /* path */ String => CallbackTo[String] = null,
    ...
    if (scriptPath != null) __obj.updateDynamic("scriptPath")(js.Any.fromFunction1((t0: /* path */ java.lang.String) => scriptPath(t0).runNow()))
