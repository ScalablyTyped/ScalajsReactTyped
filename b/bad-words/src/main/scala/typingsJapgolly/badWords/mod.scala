package typingsJapgolly.badWords
...
object mod {
  ...
  object BadWordsFilter {
    ...
    inline def apply(
      addWords: /* repeated */ String => Callback,
      clean: String => String,
      isProfane: String => Boolean,
      removeWords: /* repeated */ String => Callback,
      replaceWord: String => String
    ): BadWordsFilter = {
      val __obj = js.Dynamic.literal(addWords = js.Any.fromFunction1((t0: /* repeated */ String) => addWords(t0).runNow()), clean = js.Any.fromFunction1(clean), isProfane = js.Any.fromFunction1(isProfane), removeWords = js.Any.fromFunction1((t0: /* repeated */ String) => removeWords(t0).runNow()), replaceWord = js.Any.fromFunction1(replaceWord))
      __obj.asInstanceOf[BadWordsFilter]
    }
    
    extension [Self <: BadWordsFilter](x: Self) {
      
      inline def setAddWords(value: /* repeated */ String => Callback): Self = StObject.set(x, "addWords", js.Any.fromFunction1((t0: /* repeated */ String) => value(t0).runNow()))
      ...
      inline def setRemoveWords(value: /* repeated */ String => Callback): Self = StObject.set(x, "removeWords", js.Any.fromFunction1((t0: /* repeated */ String) => value(t0).runNow()))
