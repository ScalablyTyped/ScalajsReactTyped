...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.backboneFetchCache.anon.Url
    - typingsJapgolly.backboneFetchCache.mod.GetCacheKeyObject
  */
  ...
  object _GetCacheKeyOptions {
    ...
    inline def GetCacheKeyObject(): typingsJapgolly.backboneFetchCache.mod.GetCacheKeyObject = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.backboneFetchCache.mod.GetCacheKeyObject]
    }
    
    inline def Url(url: String): typingsJapgolly.backboneFetchCache.anon.Url = {
      val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.backboneFetchCache.anon.Url]
    }
  }
}
