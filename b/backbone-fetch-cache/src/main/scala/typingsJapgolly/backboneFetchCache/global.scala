package typingsJapgolly.backboneFetchCache
...
import typingsJapgolly.backboneFetchCache.mod.Static
  ...
  object BackboneFetchCache {
    ...
    object backboneMod {
      ...
      trait CollectionFetchWithCacheOptions
        extends StObject
           with typingsJapgolly.backboneFetchCache.mod.backboneAugmentingMod.ModelFetchWithCacheOptions {
      ...
      object CollectionFetchWithCacheOptions {
        ...
        extension [Self <: CollectionFetchWithCacheOptions](x: Self) {
          ...
          inline def setPrefillSuccess(value: /* self */ Any => Callback): Self = StObject.set(x, "prefillSuccess", js.Any.fromFunction1((t0: /* self */ Any) => value(t0).runNow()))
      ...
      trait CollectionWithCache extends Collection[Model[Any, ModelSetOptions, Any]] {
        ...
        def fetch(
          options: typingsJapgolly.backboneFetchCache.mod.backboneAugmentingMod.CollectionFetchWithCacheOptions
        ): JQueryXHR = js.native
      }
      ...
      object ModelFetchWithCacheOptions {
        ...
        extension [Self <: ModelFetchWithCacheOptions](x: Self) {
          ...
          inline def setPrefillSuccess(value: (/* self */ Any, /* attributes */ Any, ModelFetchWithCacheOptions) => Callback): Self = StObject.set(x, "prefillSuccess", js.Any.fromFunction3((t0: /* self */ Any, t1: /* attributes */ Any, t2: ModelFetchWithCacheOptions) => (value(t0, t1, t2)).runNow()))
      ...
      trait ModelWithCache extends Model[Any, ModelSetOptions, Any] {
        ...
        def fetch(options: typingsJapgolly.backboneFetchCache.mod.backboneAugmentingMod.ModelFetchWithCacheOptions): JQueryXHR = js.native
      }
    }
  }
}
