...
import typingsJapgolly.bpmnModdle.mod.AdHocOrdering
import typingsJapgolly.bpmnModdle.mod.AssociationDirection
import typingsJapgolly.bpmnModdle.mod.ChoreographyLoopType
import typingsJapgolly.bpmnModdle.mod.ElementType
import typingsJapgolly.bpmnModdle.mod.EventBasedGatewayType
import typingsJapgolly.bpmnModdle.mod.GatewayDirection
import typingsJapgolly.bpmnModdle.mod.ItemKind
import typingsJapgolly.bpmnModdle.mod.MultiInstanceBehaviour
import typingsJapgolly.bpmnModdle.mod.ProcessType
import typingsJapgolly.bpmnModdle.mod.RelationshipDirection
