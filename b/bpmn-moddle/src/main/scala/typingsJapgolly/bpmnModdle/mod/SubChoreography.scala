...
- typingsJapgolly.bpmnModdle.mod.FlowElementsContainer because var conflicts: $attrs, $parent, $type, documentation, extensionDefinitions, extensionElements, id. Inlined laneSets, flowElements */ trait SubChoreography
  extends StObject
...
object SubChoreography {
  ...
  extension [Self <: SubChoreography](x: Self) {
