...
import typingsJapgolly.baseui.anon.ActiveDescendant
import typingsJapgolly.baseui.anon.Clearable
import typingsJapgolly.baseui.anon.ItemOption
import typingsJapgolly.baseui.anon.OptionOption
import typingsJapgolly.baseui.anon.PartialfilterOptionoption
...
import typingsJapgolly.baseui.selectTypesMod.ChangeAction
import typingsJapgolly.baseui.selectTypesMod.Option
import typingsJapgolly.baseui.selectTypesMod.SelectProps
import typingsJapgolly.baseui.selectTypesMod.SelectState
...
object selectSelectComponentMod {
  ...
  trait Select extends Component[SelectProps, SelectState, Any] {
    ...
    var anchor: RefHandle[HTMLElement] = js.native
    ...
    var dropdown: RefHandle[HTMLElement] = js.native
    ...
    def getOptionLabel(locale: Locale, hasOption: typingsJapgolly.baseui.anon.Option): Node = js.native
    ...
    def getValueLabel(hasOption: OptionOption): Node = js.native
    ...
    def handleInputFocus(event: ReactEventFrom[HTMLElement]): Unit = js.native
    ...
    def renderArrow(): typingsJapgolly.react.mod.global.JSX.Element = js.native
    
    def renderClear(): typingsJapgolly.react.mod.global.JSX.Element = js.native
    
    def renderInput(listboxId: String): typingsJapgolly.react.mod.global.JSX.Element = js.native
    
    def renderLoading(): typingsJapgolly.react.mod.global.JSX.Element = js.native
    
    def renderSearch(): typingsJapgolly.react.mod.global.JSX.Element = js.native
    
    def renderValue(valueArray: Value): js.UndefOr[Node | Null | (js.Array[js.UndefOr[Node | Null]])] = js.native
