...
object sideNavigationTypesMod {
  ...
  trait Exclude extends StObject {
    ...
    def children(a: NavigationProps): Node
  }
  object Exclude {
    
    inline def apply(children: NavigationProps => Node): Exclude = {
    ...
    extension [Self <: Exclude](x: Self) {
      ...
      inline def setChildren(value: NavigationProps => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    }
  }
  ...
  object StatefulContainerProps {
    ...
    inline def apply(children: NavigationProps => Node): StatefulContainerProps = {
      val __obj = js.Dynamic.literal(children = js.Any.fromFunction1(children))
