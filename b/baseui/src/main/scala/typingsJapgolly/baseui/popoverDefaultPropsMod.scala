...
object popoverDefaultPropsMod {
  
  /* Inlined std.Partial<baseui.baseui/popover/types.BasePopoverProps> */
  object default {
    
    @JSImport("baseui/popover/default-props", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("baseui/popover/default-props", "default.accessibilityType")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.animateOutTime")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.autoFocus")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.data-baseweb")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.focusLock")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.focusOptions")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.id")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.ignoreBoundary")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.mountNode")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.onBlur")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.onClick")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.onFocus")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.onMouseEnter")
    @js.native
    def onMouseEnter: js.UndefOr[js.Function1[/* e */ ReactMouseEventFrom[Element], Any]] = js.native
    
    @JSImport("baseui/popover/default-props", "default.onMouseEnterDelay")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.onMouseLeave")
    @js.native
    def onMouseLeave: js.UndefOr[js.Function1[/* e */ ReactMouseEventFrom[Element], Any]] = js.native
    
    @JSImport("baseui/popover/default-props", "default.onMouseLeaveDelay")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.overrides")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.placement")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.popoverMargin")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.popperOptions")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.renderAll")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.returnFocus")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.showArrow")
    @js.native
    ...
    @JSImport("baseui/popover/default-props", "default.triggerType")
    @js.native
