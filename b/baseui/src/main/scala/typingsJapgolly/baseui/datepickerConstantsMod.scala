...
object datepickerConstantsMod {
  ...
  object INPUT_ROLE {
    ...
    @js.native
    val endDate: typingsJapgolly.baseui.baseuiStrings.endDate = js.native
    
    @JSImport("baseui/datepicker/constants", "INPUT_ROLE.startDate")
    @js.native
    val startDate: typingsJapgolly.baseui.baseuiStrings.startDate = js.native
  }
  ...
  object RANGED_CALENDAR_BEHAVIOR extends Shortcut {
    ...
    @js.native
    val locked: typingsJapgolly.baseui.baseuiStrings.locked = js.native
