...
object pinCodeDefaultPropsMod {
  
  object default {
    
    @JSImport("baseui/pin-code/default-props", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("baseui/pin-code/default-props", "default.aria-describedby")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.aria-label")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.aria-labelledby")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.autoComplete")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.autoFocus")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.disabled")
    @js.native
    def disabled: Boolean = js.native
    inline def disabled_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("disabled")(x.asInstanceOf[js.Any])
    
    @JSImport("baseui/pin-code/default-props", "default.error")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.mask")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.name")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.placeholder")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.positive")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.required")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.size")
    @js.native
    ...
    @JSImport("baseui/pin-code/default-props", "default.values")
    @js.native
