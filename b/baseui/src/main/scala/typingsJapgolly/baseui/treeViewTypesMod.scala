...
object treeViewTypesMod {
  ...
  object StatefulContainerProps {
    ...
    inline def apply(children: TreeViewProps => Node, data: js.Array[TreeNodeData[Any]]): StatefulContainerProps = {
    ...
    extension [Self <: StatefulContainerProps](x: Self) {
      ...
      inline def setChildren(value: TreeViewProps => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    }
  }
  ...
  trait TreeLabelProps extends StObject {
    ...
    var label: (js.Function1[/* node */ TreeNodeData[Any], Node]) | String
  ...
  object TreeLabelProps {
    ...
    extension [Self <: TreeLabelProps](x: Self) {
      ...
      inline def setLabel(value: (js.Function1[/* node */ TreeNodeData[Any], Node]) | String): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
      
      inline def setLabelFunction1(value: /* node */ TreeNodeData[Any] => Node): Self = StObject.set(x, "label", js.Any.fromFunction1(value))
  ...
  object TreeNodeData {
    ...
    inline def apply[T](label: (js.Function1[/* node */ TreeNodeData[Any], Node]) | String): TreeNodeData[T] = {
  ...
  trait TreeNodeProps extends StObject {
    ...
    var onBlur: js.UndefOr[js.Function1[/* event */ ReactEventFrom[Element], Any]] = js.undefined
    
    var onFocus: js.UndefOr[js.Function1[/* event */ ReactEventFrom[Element], Any]] = js.undefined
  ...
  object TreeNodeProps {
    ...
    extension [Self <: TreeNodeProps](x: Self) {
      ...
      inline def setOnBlur(value: /* event */ ReactEventFrom[Element] => Any): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      
      inline def setOnBlurUndefined: Self = StObject.set(x, "onBlur", js.undefined)
      
      inline def setOnFocus(value: /* event */ ReactEventFrom[Element] => Any): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      ...
      inline def setOnToggle(value: /* node */ TreeNodeData[Any] => Callback): Self = StObject.set(x, "onToggle", js.Any.fromFunction1((t0: /* node */ TreeNodeData[Any]) => value(t0).runNow()))
