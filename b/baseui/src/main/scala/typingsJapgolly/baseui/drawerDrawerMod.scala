...
import typingsJapgolly.baseui.anon.OmitSharedStylePropsArgch
...
import typingsJapgolly.baseui.drawerTypesMod.DrawerState
import typingsJapgolly.baseui.drawerTypesMod.ElementRef
...
object drawerDrawerMod {
  ...
  trait Drawer extends Component[DrawerProps, DrawerState, Any] {
    ...
    def renderDrawer(renderedContent: Node): typingsJapgolly.react.mod.global.JSX.Element = js.native
    ...
    def triggerClose(source: typingsJapgolly.baseui.drawerTypesMod.CloseSource): Unit = js.native
  }
}
