...
trait isFocusVisiblebooleanStyl extends StObject {
  ...
  @JSName("$size")
  var $size: js.UndefOr[typingsJapgolly.baseui.tableSemanticTypesMod.Size] = js.undefined
}
object isFocusVisiblebooleanStyl {
  ...
  extension [Self <: isFocusVisiblebooleanStyl](x: Self) {
    ...
    inline def set$size(value: typingsJapgolly.baseui.tableSemanticTypesMod.Size): Self = StObject.set(x, "$size", value.asInstanceOf[js.Any])
