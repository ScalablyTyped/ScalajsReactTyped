...
import typingsJapgolly.baseui.baseuiStrings.LS
import typingsJapgolly.baseui.baseuiStrings.Lesotho
import typingsJapgolly.baseui.baseuiStrings.Plussign266
