...
trait sizeSizeSharedProps extends StObject {
  ...
  @JSName("$adjoined")
  var $adjoined: typingsJapgolly.baseui.inputTypesMod.Adjoined
...
object sizeSizeSharedProps {
  ...
  inline def apply(
    $adjoined: typingsJapgolly.baseui.inputTypesMod.Adjoined,
  ...
  extension [Self <: sizeSizeSharedProps](x: Self) {
    ...
    inline def set$adjoined(value: typingsJapgolly.baseui.inputTypesMod.Adjoined): Self = StObject.set(x, "$adjoined", value.asInstanceOf[js.Any])
