...
trait CalendarPropsunknownadapt extends StObject {
  ...
  var dateLabel: js.UndefOr[(js.Function1[/* day */ Any, Node]) | Null] = js.undefined
  
  /** Determines the density of the calendar */
  var density: js.UndefOr[typingsJapgolly.baseui.datepickerTypesMod.Density] = js.undefined
  ...
  var locale: js.UndefOr[typingsJapgolly.baseui.datepickerTypesMod.Locale | Null] = js.undefined
...
object CalendarPropsunknownadapt {
  ...
  extension [Self <: CalendarPropsunknownadapt](x: Self) {
    ...
    inline def setDateLabel(value: /* day */ Any => Node): Self = StObject.set(x, "dateLabel", js.Any.fromFunction1(value))
    ...
    inline def setDensity(value: typingsJapgolly.baseui.datepickerTypesMod.Density): Self = StObject.set(x, "density", value.asInstanceOf[js.Any])
    ...
    inline def setLocale(value: typingsJapgolly.baseui.datepickerTypesMod.Locale): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
