...
import typingsJapgolly.baseui.baseuiStrings.Plussign678
import typingsJapgolly.baseui.baseuiStrings.VU
import typingsJapgolly.baseui.baseuiStrings.Vanuatu
