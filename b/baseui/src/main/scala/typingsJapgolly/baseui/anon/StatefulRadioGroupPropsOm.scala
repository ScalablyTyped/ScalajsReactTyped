...
trait StatefulRadioGroupPropsOm extends StObject {
  ...
  var align: js.UndefOr[typingsJapgolly.baseui.radioTypesMod.Align] = js.undefined
...
object StatefulRadioGroupPropsOm {
  ...
  extension [Self <: StatefulRadioGroupPropsOm](x: Self) {
    ...
    inline def setAlign(value: typingsJapgolly.baseui.radioTypesMod.Align): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
