...
trait PartialfilterOptionoptionFilterOption extends StObject {
  
  var filterOption: js.UndefOr[js.Function2[/* option */ Dictx, /* filterValue */ String, Boolean]] = js.undefined
...
object PartialfilterOptionoptionFilterOption {
  
  inline def apply(): PartialfilterOptionoptionFilterOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialfilterOptionoptionFilterOption]
  }
  
  extension [Self <: PartialfilterOptionoptionFilterOption](x: Self) {
    
    inline def setFilterOption(value: (/* option */ Dictx, /* filterValue */ String) => Boolean): Self = StObject.set(x, "filterOption", js.Any.fromFunction2(value))
