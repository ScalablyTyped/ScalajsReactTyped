...
import typingsJapgolly.baseui.baseuiStrings.CO
import typingsJapgolly.baseui.baseuiStrings.Colombia
import typingsJapgolly.baseui.baseuiStrings.Plussign57
