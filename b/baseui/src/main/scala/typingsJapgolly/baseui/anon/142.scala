...
import typingsJapgolly.baseui.baseuiStrings.MT
import typingsJapgolly.baseui.baseuiStrings.Malta
import typingsJapgolly.baseui.baseuiStrings.Plussign356
