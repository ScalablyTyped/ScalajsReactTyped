...
object accordionTypesMod {
  ...
  object AccordionProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(stateReducer = js.Any.fromFunction3(stateReducer), children = null)
  ...
  trait StatefulPanelContainerProps
    ...
    def children(props: OmitPanelPropschildren): Node
  }
  object StatefulPanelContainerProps {
    
    inline def apply(children: OmitPanelPropschildren => Node): StatefulPanelContainerProps = {
    ...
    extension [Self <: StatefulPanelContainerProps](x: Self) {
      ...
      inline def setChildren(value: OmitPanelPropschildren => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    }
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.baseui.accordionTypesMod.SharedPanelProps because var conflicts: onChange. Inlined children, disabled, `aria-controls`, key, onClick, onKeyDown, overrides, title, renderPanelContent, renderAll */ trait StatefulPanelProps
    extends StObject
       with SharedStatefulPanelContainerProps {
  ...
  type StatelessAccordionOnChangeHandler = js.Function1[/* a */ typingsJapgolly.baseui.anon.Key, Any]
  ...
  object StatelessAccordionProps {
    ...
    inline def apply(expanded: js.Array[Key]): StatelessAccordionProps = {
      val __obj = js.Dynamic.literal(expanded = expanded.asInstanceOf[js.Any], children = null)
    ...
    extension [Self <: StatelessAccordionProps](x: Self) {
      ...
      inline def setOnChange(value: /* a */ typingsJapgolly.baseui.anon.Key => Any): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
