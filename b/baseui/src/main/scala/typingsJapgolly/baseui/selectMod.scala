...
import typingsJapgolly.baseui.selectAutosizeInputMod.default
import typingsJapgolly.baseui.selectTypesMod.Optgroups
...
import typingsJapgolly.baseui.selectTypesMod.StatefulSelectProps
...
object selectMod {
  ...
  open class SelectDropdown ()
    extends typingsJapgolly.baseui.selectDropdownMod.default
  ...
  open class StatefulSelectContainer ()
    extends typingsJapgolly.baseui.selectStatefulSelectContainerMod.default
