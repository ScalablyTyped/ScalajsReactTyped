...
- typingsJapgolly.baseui.popoverTypesMod.BodyStylePropsArg because var conflicts: $placement. Inlined $animationDuration, $isAnimating, $isHoverTrigger, $isOpen, $popoverOffset, $showArrow, $popoverMargin */ trait SharedStylePropsArg
  extends StObject
