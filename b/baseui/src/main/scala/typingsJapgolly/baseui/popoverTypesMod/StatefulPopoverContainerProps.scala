...
/* Inlined std.Omit<baseui.baseui/popover/types.StatefulPopoverProps, 'children'> & {children (props : std.Omit<baseui.baseui/popover/types.PopoverProps, 'children'>): react.react.ReactNode} */
...
object StatefulPopoverContainerProps {
  ...
  inline def apply(children: OmitPopoverPropschildren => Node): StatefulPopoverContainerProps = {
