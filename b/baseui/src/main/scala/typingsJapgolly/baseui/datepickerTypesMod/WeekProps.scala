...
trait WeekProps[T] extends StObject {
  ...
  var dateLabel: js.UndefOr[(js.Function1[/* date */ T, Node]) | Null] = js.undefined
...
object WeekProps {
  ...
  extension [Self <: WeekProps[?], T](x: Self & WeekProps[T]) {
    ...
    inline def setDateLabel(value: /* date */ T => Node): Self = StObject.set(x, "dateLabel", js.Any.fromFunction1(value))
