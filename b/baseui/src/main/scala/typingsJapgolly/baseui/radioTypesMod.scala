...
object radioTypesMod {
  ...
  */
  ...
  trait DefaultStatefulProps extends StObject {
    ...
    var children: js.UndefOr[js.Function1[/* props */ RadioGroupProps, Node]] = js.undefined
  ...
  object DefaultStatefulProps {
    ...
    extension [Self <: DefaultStatefulProps](x: Self) {
      ...
      inline def setChildren(value: /* props */ RadioGroupProps => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      inline def setStateReducer(
        value: (/* stateType */ String, /* nextState */ State, /* currentState */ State, /* event */ ReactEventFrom[HTMLInputElement]) => State
