...
object progressBarTypesMod {
  ...
  trait ProgressBarProps extends StObject {
    ...
    def getProgressLabel(value: Double, maxValue: Double, minValue: Double): Node
  ...
  object ProgressBarProps {
    ...
    inline def apply(
      getProgressLabel: (Double, Double, Double) => Node,
      infinite: Boolean,
      maxValue: Double,
      minValue: Double,
      showLabel: Boolean,
    ...
    extension [Self <: ProgressBarProps](x: Self) {
      ...
      inline def setGetProgressLabel(value: (Double, Double, Double) => Node): Self = StObject.set(x, "getProgressLabel", js.Any.fromFunction3(value))
