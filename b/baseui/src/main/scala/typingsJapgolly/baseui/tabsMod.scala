...
import typingsJapgolly.baseui.tabsStatefulTabsMod.default
...
object tabsMod {
  ...
  @js.native
  open class Tab ()
    extends typingsJapgolly.baseui.tabsTabMod.default
  object Tab {
  ...
  @js.native
  open class Tabs ()
    extends typingsJapgolly.baseui.tabsTabsMod.default
  /* static members */
  object Tabs {
