...
object tagTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.baseui.baseuiStrings.orange
    - typingsJapgolly.baseui.baseuiStrings.custom_
    - typingsJapgolly.baseui.baseuiStrings.brown
    - typingsJapgolly.baseui.baseuiStrings.purple
    - typingsJapgolly.baseui.baseuiStrings.yellow
    - typingsJapgolly.baseui.baseuiStrings.red
    - typingsJapgolly.baseui.baseuiStrings.accent
    - typingsJapgolly.baseui.baseuiStrings.primary
    - typingsJapgolly.baseui.baseuiStrings.blue
    - typingsJapgolly.baseui.baseuiStrings.neutral
    - typingsJapgolly.baseui.baseuiStrings.positive
    - typingsJapgolly.baseui.baseuiStrings.black
    - typingsJapgolly.baseui.baseuiStrings.green
  ...
  */
  ...
  object TagKind {
    ...
    @js.native
    val black: typingsJapgolly.baseui.baseuiStrings.black = js.native
    
    @JSImport("baseui/tag/types", "TagKind.blue")
    @js.native
    val blue: typingsJapgolly.baseui.baseuiStrings.blue = js.native
    
    @JSImport("baseui/tag/types", "TagKind.brown")
    @js.native
    val brown: typingsJapgolly.baseui.baseuiStrings.brown = js.native
    ...
    @js.native
    val green: typingsJapgolly.baseui.baseuiStrings.green = js.native
    ...
    @js.native
    val neutral: typingsJapgolly.baseui.baseuiStrings.neutral = js.native
    
    @JSImport("baseui/tag/types", "TagKind.orange")
    @js.native
    val orange: typingsJapgolly.baseui.baseuiStrings.orange = js.native
    ...
    @js.native
    val purple: typingsJapgolly.baseui.baseuiStrings.purple = js.native
    
    @JSImport("baseui/tag/types", "TagKind.red")
    @js.native
    val red: typingsJapgolly.baseui.baseuiStrings.red = js.native
    ...
    @js.native
    val yellow: typingsJapgolly.baseui.baseuiStrings.yellow = js.native
  }
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.baseui.baseuiStrings.solid
    - typingsJapgolly.baseui.baseuiStrings.light
    - typingsJapgolly.baseui.baseuiStrings.outlined
  */
  ...
  object TagVariant {
    ...
    @js.native
    val outlined: typingsJapgolly.baseui.baseuiStrings.outlined = js.native
    
    @JSImport("baseui/tag/types", "TagVariant.solid")
    @js.native
    val solid: typingsJapgolly.baseui.baseuiStrings.solid = js.native
  }
  ...
  trait TagProps extends StObject {
    ...
    var onActionClick: js.UndefOr[js.Function2[/* e */ Event, /* children */ js.UndefOr[Node], Any]] = js.undefined
    
    /** keydown handler for the action button element. */
    var onActionKeyDown: js.UndefOr[js.Function2[/* e */ Event, /* children */ js.UndefOr[Node], Any]] = js.undefined
  ...
  object TagProps {
    ...
    extension [Self <: TagProps](x: Self) {
      ...
      inline def setOnActionClick(value: (/* e */ Event, /* children */ js.UndefOr[Node]) => Any): Self = StObject.set(x, "onActionClick", js.Any.fromFunction2(value))
      
      inline def setOnActionClickUndefined: Self = StObject.set(x, "onActionClick", js.undefined)
      
      inline def setOnActionKeyDown(value: (/* e */ Event, /* children */ js.UndefOr[Node]) => Any): Self = StObject.set(x, "onActionKeyDown", js.Any.fromFunction2(value))
