...
object drawerTypesMod {
  ...
  */
  ...
  /* keyof baseui.anon.Backdrop */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.baseui.baseuiStrings.closeButton
    - typingsJapgolly.baseui.baseuiStrings.backdrop
    - typingsJapgolly.baseui.baseuiStrings.escape_
  */
  ...
  trait DrawerProps extends StObject {
    ...
    var onClose: js.UndefOr[js.Function1[/* a */ typingsJapgolly.baseui.anon.CloseSource, Any]] = js.undefined
  ...
  object DrawerProps {
    ...
    extension [Self <: DrawerProps](x: Self) {
      ...
      inline def setOnClose(value: /* a */ typingsJapgolly.baseui.anon.CloseSource => Any): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
  ...
  /* keyof baseui.anon.Auto */ /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.baseui.baseuiStrings.full
