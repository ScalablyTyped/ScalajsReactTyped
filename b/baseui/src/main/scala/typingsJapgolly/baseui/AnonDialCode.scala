...
import typingsJapgolly.baseui.baseuiStrings.AF
import typingsJapgolly.baseui.baseuiStrings.Plussign93
import typingsJapgolly.baseui.baseuiStrings.`Afghanistan Leftparenthesis‫افغانستان‬‎Rightparenthesis`
