...
object phoneInputDefaultPropsMod {
  
  object default {
    
    @JSImport("baseui/phone-input/default-props", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("baseui/phone-input/default-props", "default.aria-describedby")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.aria-label")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.aria-labelledby")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.clearable")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.country")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.disabled")
    @js.native
    def disabled: Boolean = js.native
    inline def disabled_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("disabled")(x.asInstanceOf[js.Any])
    
    @JSImport("baseui/phone-input/default-props", "default.error")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.focusLock")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.id")
    @js.native
    def id: Any = js.native
    inline def id_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("id")(x.asInstanceOf[js.Any])
    
    @JSImport("baseui/phone-input/default-props", "default.maxDropdownHeight")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.maxDropdownWidth")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.name")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.positive")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.required")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.size")
    @js.native
    ...
    @JSImport("baseui/phone-input/default-props", "default.text")
    @js.native
