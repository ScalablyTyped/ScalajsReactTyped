...
object toastTypesMod {
  ...
  type ComponentRenderProp = js.Function1[/* props */ Dismiss, Node]
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.baseui.baseuiStrings.toast
  */
  ...
  */
  ...
  object ToasterProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(autoFocus = autoFocus.asInstanceOf[js.Any], autoHideDuration = autoHideDuration.asInstanceOf[js.Any], closeable = closeable.asInstanceOf[js.Any], overrides = overrides.asInstanceOf[js.Any], placement = placement.asInstanceOf[js.Any], usePortal = usePortal.asInstanceOf[js.Any], children = null)
