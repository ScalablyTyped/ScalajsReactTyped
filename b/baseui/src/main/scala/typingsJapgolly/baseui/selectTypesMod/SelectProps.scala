...
trait SelectProps extends StObject {
  ...
  var getOptionLabel: js.UndefOr[(js.Function1[/* a */ typingsJapgolly.baseui.anon.Option, Node]) | Null] = js.undefined
...
object SelectProps {
  ...
  extension [Self <: SelectProps](x: Self) {
    ...
    inline def setGetOptionLabel(value: /* a */ typingsJapgolly.baseui.anon.Option => Node): Self = StObject.set(x, "getOptionLabel", js.Any.fromFunction1(value))
