...
object sliderTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.baseui.baseuiStrings.finalChange
  */
  ...
  object ChangeAction {
    ...
    inline def finalChange: typingsJapgolly.baseui.baseuiStrings.finalChange = "finalChange".asInstanceOf[typingsJapgolly.baseui.baseuiStrings.finalChange]
  }
  ...
  trait SliderProps extends StObject {
    ...
    var valueToLabel: js.UndefOr[js.Function1[/* value */ Double, Node]] = js.undefined
  }
  object SliderProps {
    ...
    extension [Self <: SliderProps](x: Self) {
      ...
      inline def setValueToLabel(value: /* value */ Double => Node): Self = StObject.set(x, "valueToLabel", js.Any.fromFunction1(value))
  ...
  trait StatefulContainerProps extends StObject {
    ...
    def children(a: SliderProps): Node
    ...
    /** Handler for events on trigger element, each time thumbs change selection, which is passed in `value`. */
    def onChange(a: typingsJapgolly.baseui.anon.Params): Any
    
    /** Handler for events on trigger element, each time thumbs finish changing selection, which is passed in `value`. */
    def onFinalChange(a: typingsJapgolly.baseui.anon.Params): Any
  ...
  object StatefulContainerProps {
    ...
    inline def apply(
      ...
      max: Double,
      min: Double,
      onChange: typingsJapgolly.baseui.anon.Params => Any,
      onFinalChange: typingsJapgolly.baseui.anon.Params => Any,
    ...
    extension [Self <: StatefulContainerProps](x: Self) {
      ...
      inline def setChildren(value: SliderProps => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      inline def setOnChange(value: typingsJapgolly.baseui.anon.Params => Any): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      
      inline def setOnFinalChange(value: typingsJapgolly.baseui.anon.Params => Any): Self = StObject.set(x, "onFinalChange", js.Any.fromFunction1(value))
