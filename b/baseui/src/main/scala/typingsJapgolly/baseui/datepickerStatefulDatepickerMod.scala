...
import typingsJapgolly.baseui.datepickerTypesMod.Locale
...
object datepickerStatefulDatepickerMod {
  ...
  trait Props[T] extends StObject {
    ...
    var dateLabel: js.UndefOr[(js.Function1[/* day */ T, Node]) | Null] = js.undefined
  ...
  object Props {
    ...
    extension [Self <: Props[?], T](x: Self & Props[T]) {
      ...
      inline def setDateLabel(value: /* day */ T => Node): Self = StObject.set(x, "dateLabel", js.Any.fromFunction1(value))
