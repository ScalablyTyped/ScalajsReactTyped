...
import typingsJapgolly.baseui.radioRadioMod.default
...
object radioMod {
  ...
  open class RadioGroup ()
    extends typingsJapgolly.baseui.radioRadiogroupMod.default
  object RadioGroup {
  ...
  open class StatefulContainer protected ()
    extends typingsJapgolly.baseui.radioStatefulRadiogroupContainerMod.default {
