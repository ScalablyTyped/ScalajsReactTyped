...
object progressStepsTypesMod {
  ...
  object NumberedStepProps {
    ...
    extension [Self <: NumberedStepProps](x: Self) {
      ...
      inline def setStep(value: VdomNode): Self = StObject.set(x, "step", value.rawNode.asInstanceOf[js.Any])
      
      inline def setStepNull: Self = StObject.set(x, "step", null)
      
      inline def setStepUndefined: Self = StObject.set(x, "step", js.undefined)
      
      inline def setStepVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "step", js.Array(value*))
      
      inline def setStepVdomElement(value: VdomElement): Self = StObject.set(x, "step", value.rawElement.asInstanceOf[js.Any])
