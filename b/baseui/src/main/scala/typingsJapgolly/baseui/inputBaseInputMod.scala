...
import typingsJapgolly.baseui.anon.InitialType
...
object inputBaseInputMod {
  ...
  trait BaseInput[T /* <: HTMLInputElement | HTMLTextAreaElement */] extends Component[BaseInputProps[T], InternalState, Any] {
    ...
    def handleBlurForClear(event: ReactEventFrom[Element]): Unit = js.native
    
    def handleBlurForMaskToggle(event: ReactEventFrom[Element]): Unit = js.native
    
    def handleFocusForClear(event: ReactEventFrom[Element]): Unit = js.native
    
    def handleFocusForMaskToggle(event: ReactEventFrom[Element]): Unit = js.native
    
    var inputRef: RefHandle[T] = js.native
    
    def onBlur(e: ReactFocusEventFrom[T & Element]): Unit = js.native
    
    def onClearIconClick(): Unit = js.native
    
    def onFocus(e: ReactFocusEventFrom[T & Element]): Unit = js.native
    
    def onInputKeyDown(e: KeyboardEvent): Unit = js.native
    
    def renderClear(): typingsJapgolly.react.mod.global.JSX.Element = js.native
    
    def renderMaskToggle(): typingsJapgolly.react.mod.global.JSX.Element = js.native
