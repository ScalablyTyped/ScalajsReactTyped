...
object TriangleRight {
  ...
  implicit def make(companion: TriangleRight.type): SharedBuilder_SVGAttributesSVGElementch_8278862[SVGSVGElement] = new SharedBuilder_SVGAttributesSVGElementch_8278862[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
