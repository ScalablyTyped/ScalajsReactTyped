...
object NavigationItem {
  ...
  @JSImport("baseui/header-navigation/styled-components", "NavigationItem")
  @js.native
  val component: js.Object = js.native
  
  implicit def make[C /* <: ElementType */](companion: NavigationItem.type): SharedBuilder_AsOverrideProps1154346082[C] = new SharedBuilder_AsOverrideProps1154346082[C](js.Array(this.component, js.Dictionary.empty))()
