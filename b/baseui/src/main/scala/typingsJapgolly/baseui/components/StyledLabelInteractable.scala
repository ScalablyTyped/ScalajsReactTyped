...
object StyledLabelInteractable {
  ...
  @JSImport("baseui/tree-view/styled-components", "StyledLabelInteractable")
  @js.native
  val component: js.Object = js.native
  
  implicit def make[C /* <: ElementType */](companion: StyledLabelInteractable.type): SharedBuilder_AsOverrideProps1154346082[C] = new SharedBuilder_AsOverrideProps1154346082[C](js.Array(this.component, js.Dictionary.empty))()
