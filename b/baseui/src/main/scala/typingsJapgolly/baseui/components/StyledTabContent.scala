...
object StyledTabContent {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledTabContent.type): SharedBuilder_AsOverrideProps1701960101[C] = new SharedBuilder_AsOverrideProps1701960101[C](js.Array(this.component, js.Dictionary.empty))()
