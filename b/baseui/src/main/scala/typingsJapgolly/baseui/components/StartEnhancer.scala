...
object StartEnhancer {
  ...
  @JSImport("baseui/button/styled-components", "StartEnhancer")
  @js.native
  val component: js.Object = js.native
  
  implicit def make[C /* <: ElementType */](companion: StartEnhancer.type): SharedBuilder_AsOverrideProps_1651054587[C] = new SharedBuilder_AsOverrideProps_1651054587[C](js.Array(this.component, js.Dictionary.empty))()
