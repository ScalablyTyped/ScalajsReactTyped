...
object DisplaySmall {
  ...
  implicit def make[C /* <: ElementType */](companion: DisplaySmall.type): SharedBuilder_OverrideProps438760901[C] = new SharedBuilder_OverrideProps438760901[C](js.Array(this.component, js.Dictionary.empty))()
