...
object StyledTick {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledTick.type): SharedBuilder_AsOverrideProps_1995238606[C] = new SharedBuilder_AsOverrideProps_1995238606[C](js.Array(this.component, js.Dictionary.empty))()
