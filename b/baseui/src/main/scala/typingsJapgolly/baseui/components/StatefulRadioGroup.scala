...
import typingsJapgolly.baseui.anon.StatefulRadioGroupPropsOm
...
object StatefulRadioGroup {
  ...
  def withProps(p: StatefulRadioGroupPropsOm): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
