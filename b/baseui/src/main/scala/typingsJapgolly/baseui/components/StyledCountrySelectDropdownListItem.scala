...
object StyledCountrySelectDropdownListItem {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledCountrySelectDropdownListItem.type): SharedBuilder_AsOverrideProps_465345146[C] = new SharedBuilder_AsOverrideProps_465345146[C](js.Array(this.component, js.Dictionary.empty))()
