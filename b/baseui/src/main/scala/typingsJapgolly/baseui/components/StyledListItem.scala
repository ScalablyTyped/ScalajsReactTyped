...
object StyledListItem {
  ...
  inline def apply[C /* <: ElementType */](): Builder[C] = {
    ...
    new Builder[C](js.Array(this.component, __props.asInstanceOf[As[C] & (OverrideProps[C, StyledPropsitemanyundefin])]))
  }
  ...
  open class Builder[C /* <: ElementType */] (val args: js.Array[Any])
    ...
    inline def $style(value: StyleObject | (js.Function1[StyledPropsitemanyundefin, StyleObject])): this.type = set("$style", value.asInstanceOf[js.Any])
    
    inline def $styleFunction1(value: StyledPropsitemanyundefin => StyleObject): this.type = set("$style", js.Any.fromFunction1(value))
  ...
  implicit def make[C /* <: ElementType */](companion: StyledListItem.type): Builder[C] = new Builder[C](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[C /* <: ElementType */](p: As[C] & (OverrideProps[C, StyledPropsitemanyundefin])): Builder[C] = new Builder[C](js.Array(this.component, p.asInstanceOf[js.Any]))
}
