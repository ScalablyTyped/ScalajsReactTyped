...
import typingsJapgolly.baseui.selectMod.StatefulSelectProps
...
object StatefulSelect {
  def apply(
    ...
    StatefulSelectProps, 
    MountedWithRawType[StatefulSelectProps, js.Object, RawMounted[StatefulSelectProps, js.Object]]
  ] = {
  ...
  typingsJapgolly.baseui.selectMod.StatefulSelectProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.selectMod.StatefulSelectProps])(children: _*)
  }
