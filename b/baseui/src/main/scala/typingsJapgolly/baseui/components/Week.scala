...
import typingsJapgolly.baseui.datepickerWeekMod.default
...
object Week {
  ...
  inline def apply[T](
    ...
    new Builder[T](js.Array(this.component, __props.asInstanceOf[WeekProps[T]]))
  }
  ...
  def withProps[T](p: WeekProps[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
