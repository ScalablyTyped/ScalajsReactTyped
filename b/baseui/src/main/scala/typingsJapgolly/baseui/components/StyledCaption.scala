...
object StyledCaption {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledCaption.type): SharedBuilder_AsOverrideProps1880065505[C] = new SharedBuilder_AsOverrideProps1880065505[C](js.Array(this.component, js.Dictionary.empty))()
