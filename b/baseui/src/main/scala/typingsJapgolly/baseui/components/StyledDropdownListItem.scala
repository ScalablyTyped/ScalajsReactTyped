...
object StyledDropdownListItem {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledDropdownListItem.type): SharedBuilder_AsOverrideProps_465345146[C] = new SharedBuilder_AsOverrideProps_465345146[C](js.Array(this.component, js.Dictionary.empty))()
