...
import typingsJapgolly.baseui.pinCodeMod.PinCodeProps
...
object PinCode {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PinCodeProps, typingsJapgolly.baseui.pinCodeMod.PinCode, Unit, PinCodeProps] = {
  ...
  typingsJapgolly.baseui.pinCodeMod.PinCodeProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.baseui.pinCodeMod.PinCode](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.pinCodeMod.PinCodeProps])(children: _*)
  }
