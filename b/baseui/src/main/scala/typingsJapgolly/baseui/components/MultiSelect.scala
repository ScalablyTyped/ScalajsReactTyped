...
object MultiSelect {
  ...
  @JSImport("baseui/select", "MultiSelect")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: MultiSelect.type): SharedBuilder_PartialSelectProps_575069375 = new SharedBuilder_PartialSelectProps_575069375(js.Array(this.component, js.Dictionary.empty))()
