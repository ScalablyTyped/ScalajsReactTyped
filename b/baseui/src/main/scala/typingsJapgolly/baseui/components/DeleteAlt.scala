...
object DeleteAlt {
  ...
  implicit def make(companion: DeleteAlt.type): SharedBuilder_SVGAttributesSVGElementch_8278862[SVGSVGElement] = new SharedBuilder_SVGAttributesSVGElementch_8278862[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
