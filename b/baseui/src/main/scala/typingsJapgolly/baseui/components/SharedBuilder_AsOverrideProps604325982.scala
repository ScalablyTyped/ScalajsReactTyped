...
@scala.inline
open class SharedBuilder_AsOverrideProps604325982[C /* <: ElementType */] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def $style(value: StyleObject | (js.Function1[SharedStyleProps, StyleObject])): this.type = set("$style", value.asInstanceOf[js.Any])
  
  inline def $styleFunction1(value: SharedStyleProps => StyleObject): this.type = set("$style", js.Any.fromFunction1(value))
