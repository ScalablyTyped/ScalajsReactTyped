...
object DisplayMedium {
  ...
  implicit def make[C /* <: ElementType */](companion: DisplayMedium.type): SharedBuilder_OverrideProps438760901[C] = new SharedBuilder_OverrideProps438760901[C](js.Array(this.component, js.Dictionary.empty))()
