...
import typingsJapgolly.baseui.datepickerCalendarHeaderMod.default
...
object CalendarHeader {
  
  inline def apply[T](date: T, order: Double): Builder[T] = {
    val __props = js.Dynamic.literal(date = date.asInstanceOf[js.Any], order = order.asInstanceOf[js.Any])
    new Builder[T](js.Array(this.component, __props.asInstanceOf[HeaderProps[T]]))
  }
  ...
  open class Builder[T] (val args: js.Array[Any])
    ...
    inline def onDayClick(value: /* a */ DateTEventEvent[T] => Any): this.type = set("onDayClick", js.Any.fromFunction1(value))
    
    inline def onDayFocus(value: /* a */ DateTEventEvent[T] => Any): this.type = set("onDayFocus", js.Any.fromFunction1(value))
    
    inline def onDayMouseLeave(value: /* a */ DateTEventEvent[T] => Any): this.type = set("onDayMouseLeave", js.Any.fromFunction1(value))
    
    inline def onDayMouseOver(value: /* a */ DateTEventEvent[T] => Any): this.type = set("onDayMouseOver", js.Any.fromFunction1(value))
    
    inline def onMonthChange(value: /* a */ DateT[T] => Any): this.type = set("onMonthChange", js.Any.fromFunction1(value))
    ...
    inline def onYearChange(value: /* a */ DateT[T] => Any): this.type = set("onYearChange", js.Any.fromFunction1(value))
  ...
  def withProps[T](p: HeaderProps[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
