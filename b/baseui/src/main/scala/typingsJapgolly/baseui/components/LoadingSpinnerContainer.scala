...
object LoadingSpinnerContainer {
  ...
  implicit def make[C /* <: ElementType */](companion: LoadingSpinnerContainer.type): SharedBuilder_AsOverrideProps_1651054587[C] = new SharedBuilder_AsOverrideProps_1651054587[C](js.Array(this.component, js.Dictionary.empty))()
