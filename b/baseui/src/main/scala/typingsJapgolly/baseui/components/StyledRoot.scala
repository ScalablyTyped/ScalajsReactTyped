...
object StyledRoot {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledRoot.type): SharedBuilder_AsOverrideProps2050516390[C] = new SharedBuilder_AsOverrideProps2050516390[C](js.Array(this.component, js.Dictionary.empty))()
