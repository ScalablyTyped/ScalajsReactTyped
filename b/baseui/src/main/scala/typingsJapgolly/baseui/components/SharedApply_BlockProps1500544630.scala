...
abstract class SharedApply_BlockProps1500544630 () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BlockProps, Ref, Unit, BlockProps] = {
  ...
  typingsJapgolly.baseui.blockMod.BlockProps, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.blockMod.BlockProps])(children: _*)
  }
}
