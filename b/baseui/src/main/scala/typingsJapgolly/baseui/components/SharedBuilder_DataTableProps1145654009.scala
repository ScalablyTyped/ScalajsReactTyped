...
@scala.inline
open class SharedBuilder_DataTableProps1145654009 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def filters(value: Map[String, typingsJapgolly.baseui.anon.Description]): this.type = set("filters", value.asInstanceOf[js.Any])
  ...
  inline def onSelectMany(value: /* rows */ js.Array[Row] => Callback): this.type = set("onSelectMany", js.Any.fromFunction1((t0: /* rows */ js.Array[Row]) => value(t0).runNow()))
  
  inline def onSelectNone(value: Callback): this.type = set("onSelectNone", value.toJsFn)
  
  inline def onSelectOne(value: /* row */ Row => Callback): this.type = set("onSelectOne", js.Any.fromFunction1((t0: /* row */ Row) => value(t0).runNow()))
  
  inline def onSelectionChange(value: /* a */ js.Array[Row] => Any): this.type = set("onSelectionChange", js.Any.fromFunction1(value))
  
  inline def onSort(value: /* columnIndex */ Double => Callback): this.type = set("onSort", js.Any.fromFunction1((t0: /* columnIndex */ Double) => value(t0).runNow()))
  ...
  inline def selectedRowIds(value: Set[String | Double]): this.type = set("selectedRowIds", value.asInstanceOf[js.Any])
  
  inline def sortDirection(value: SortDirections): this.type = set("sortDirection", value.asInstanceOf[js.Any])
  
  inline def sortIndex(value: Double): this.type = set("sortIndex", value.asInstanceOf[js.Any])
  
  inline def textQuery(value: String): this.type = set("textQuery", value.asInstanceOf[js.Any])
}
