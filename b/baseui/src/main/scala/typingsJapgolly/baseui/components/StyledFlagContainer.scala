...
import typingsJapgolly.baseui.phoneInputStyledComponentsMod.SizeStyleProps
...
object StyledFlagContainer {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledFlagContainer.type): Builder[C] = new Builder[C](js.Array(this.component, js.Dictionary.empty))()
