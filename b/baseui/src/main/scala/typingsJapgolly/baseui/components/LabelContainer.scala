...
object LabelContainer {
  ...
  @JSImport("baseui/form-control/styled-components", "LabelContainer")
  @js.native
  val component: js.Object = js.native
  
  implicit def make[C /* <: ElementType */](companion: LabelContainer.type): SharedBuilder_AsOverrideProps1880065505[C] = new SharedBuilder_AsOverrideProps1880065505[C](js.Array(this.component, js.Dictionary.empty))()
