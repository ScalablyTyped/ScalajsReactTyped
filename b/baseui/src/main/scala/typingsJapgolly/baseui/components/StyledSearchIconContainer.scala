...
object StyledSearchIconContainer {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledSearchIconContainer.type): SharedBuilder_AsOverrideProps_1754443696[C] = new SharedBuilder_AsOverrideProps_1754443696[C](js.Array(this.component, js.Dictionary.empty))()
