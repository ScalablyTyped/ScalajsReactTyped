...
object Caption {
  ...
  @JSImport("baseui/form-control/styled-components", "Caption")
  @js.native
  val component: js.Object = js.native
  
  implicit def make[C /* <: ElementType */](companion: Caption.type): SharedBuilder_AsOverrideProps1880065505[C] = new SharedBuilder_AsOverrideProps1880065505[C](js.Array(this.component, js.Dictionary.empty))()
