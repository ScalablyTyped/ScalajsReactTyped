...
object StatefulTooltipContainer {
  
  inline def apply(children: OmitPopoverPropschildren => Node): Builder = {
    val __props = js.Dynamic.literal(children = js.Any.fromFunction1(children))
    new Builder(js.Array(this.component, __props.asInstanceOf[StatefulTooltipContainerProps]))
  }
  ...
  def withProps(p: StatefulTooltipContainerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
