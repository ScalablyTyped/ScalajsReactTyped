...
object NotificationCircle {
  ...
  @JSImport("baseui/badge", "NotificationCircle")
  @js.native
  ...
  implicit def make(companion: NotificationCircle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NotificationCircleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
