...
object StyledBlock {
  ...
  inline def apply[C /* <: ElementType */](): Builder[C] = {
    ...
    new Builder[C](js.Array(this.component, __props.asInstanceOf[As[C] & (OverrideProps[C, StyledBlockProps])]))
  }
  
  @JSImport("baseui/block/styled-components", "StyledBlock")
  @js.native
  ...
  open class Builder[C /* <: ElementType */] (val args: js.Array[Any])
    ...
    inline def $style(value: StyleObject | (js.Function1[StyledBlockProps, StyleObject])): this.type = set("$style", value.asInstanceOf[js.Any])
    
    inline def $styleFunction1(value: StyledBlockProps => StyleObject): this.type = set("$style", js.Any.fromFunction1(value))
  ...
  implicit def make[C /* <: ElementType */](companion: StyledBlock.type): Builder[C] = new Builder[C](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[C /* <: ElementType */](p: As[C] & (OverrideProps[C, StyledBlockProps])): Builder[C] = new Builder[C](js.Array(this.component, p.asInstanceOf[js.Any]))
}
