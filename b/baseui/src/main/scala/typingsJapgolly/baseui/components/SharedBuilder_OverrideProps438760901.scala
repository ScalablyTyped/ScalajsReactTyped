...
@scala.inline
open class SharedBuilder_OverrideProps438760901[C /* <: ElementType */] (val args: js.Array[Any])
  extends AnyVal
     with StBuildingComponent[scala.Nothing] {
  
  inline def $style(value: StyleObject | (js.Function1[BlockProps[C], StyleObject])): this.type = set("$style", value.asInstanceOf[js.Any])
  
  inline def $styleFunction1(value: BlockProps[C] => StyleObject): this.type = set("$style", js.Any.fromFunction1(value))
