...
import typingsJapgolly.baseui.textareaMod.TextareaProps
...
object Textarea {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextareaProps, typingsJapgolly.baseui.textareaMod.Textarea, Unit, TextareaProps] = {
  ...
  typingsJapgolly.baseui.textareaMod.TextareaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.baseui.textareaMod.Textarea](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.textareaMod.TextareaProps])(children: _*)
  }
