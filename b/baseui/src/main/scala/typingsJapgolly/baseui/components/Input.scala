...
import typingsJapgolly.baseui.inputTypesMod.InputOverrides
...
object Input {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.baseui.inputMod.Input] {
    ...
    inline def overrides(value: InputOverrides): this.type = set("overrides", value.asInstanceOf[js.Any])
