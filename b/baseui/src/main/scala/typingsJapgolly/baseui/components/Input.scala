...
import typingsJapgolly.baseui.inputMod.InputProps
...
object Input {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputProps, typingsJapgolly.baseui.inputMod.Input, Unit, InputProps] = {
  ...
  typingsJapgolly.baseui.inputMod.InputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.baseui.inputMod.Input](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.inputMod.InputProps])(children: _*)
  }
