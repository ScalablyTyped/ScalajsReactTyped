...
object StyledSeparator {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledSeparator.type): SharedBuilder_AsOverrideProps1154346082[C] = new SharedBuilder_AsOverrideProps1154346082[C](js.Array(this.component, js.Dictionary.empty))()
