...
object StatefulPinCodeContainer {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.baseui.pinCodeMod.StatefulPinCodeContainer] {
  ...
  def withProps(p: StatefulPinCodeContainerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
