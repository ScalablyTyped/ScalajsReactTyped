...
object StyledStep {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledStep.type): SharedBuilder_AsOverrideProps1443497525[C] = new SharedBuilder_AsOverrideProps1443497525[C](js.Array(this.component, js.Dictionary.empty))()
