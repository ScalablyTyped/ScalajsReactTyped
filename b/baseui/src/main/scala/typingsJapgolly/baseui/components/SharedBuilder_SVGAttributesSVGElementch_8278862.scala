...
@scala.inline
open class SharedBuilder_SVGAttributesSVGElementch_8278862[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def allowReorder(value: no_ | yes): this.type = set("allowReorder", value.asInstanceOf[js.Any])
  ...
  inline def overrides(value: IconOverrides): this.type = set("overrides", value.asInstanceOf[js.Any])
  ...
  inline def strokeLinecap(value: butt | round_ | square | inherit): this.type = set("strokeLinecap", value.asInstanceOf[js.Any])
  
  inline def strokeLinejoin(value: miter | round_ | bevel | inherit): this.type = set("strokeLinejoin", value.asInstanceOf[js.Any])
