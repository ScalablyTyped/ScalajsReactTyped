...
object FlexGrid {
  ...
  inline def apply[C /* <: ElementType */](): Builder[C] = {
    ...
    new Builder[C](js.Array(this.component, __props.asInstanceOf[FlexGridProps[C] & (/* import warning: importer.ImportType#apply Failed type conversion: react.react.ComponentProps<C> extends {  ref :infer R | undefined} ? {  ref :R | undefined} : {} */ js.Any) & (Omit[
  ...
  implicit def make[C /* <: ElementType */](companion: FlexGrid.type): Builder[C] = new Builder[C](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[C /* <: ElementType */](
    p: FlexGridProps[C] & (/* import warning: importer.ImportType#apply Failed type conversion: react.react.ComponentProps<C> extends {  ref :infer R | undefined} ? {  ref :R | undefined} : {} */ js.Any) & (Omit[
      StyledBlockProps & ComponentProps[C], 
      /* keyof baseui.baseui/flex-grid/types.FlexGridProps<react.react.ElementType<any>> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 71, starting with typingsJapgolly.baseui.baseuiStrings.flexGridColumnCount, typingsJapgolly.baseui.baseuiStrings.flexGridColumnGap, typingsJapgolly.baseui.baseuiStrings.flexGridRowGap */ Any
    ])
