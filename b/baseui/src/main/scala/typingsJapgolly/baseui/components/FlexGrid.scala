...
import typingsJapgolly.baseui.flexGridMod.FlexGridProps
...
object FlexGrid {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FlexGridProps, Ref, Unit, FlexGridProps] = {
  ...
  typingsJapgolly.baseui.flexGridMod.FlexGridProps, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.flexGridMod.FlexGridProps])(children: _*)
  }
