...
object BaseInput {
  def apply(
    ...
    typingsJapgolly.baseui.inputMod.BaseInput, 
    Unit, 
    BaseInputProps[HTMLInputElement]
  ] = {
  ...
  typingsJapgolly.baseui.inputMod.BaseInputProps[org.scalajs.dom.raw.HTMLInputElement], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.baseui.inputMod.BaseInput](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.inputMod.BaseInputProps[org.scalajs.dom.raw.HTMLInputElement]])(children: _*)
  }
