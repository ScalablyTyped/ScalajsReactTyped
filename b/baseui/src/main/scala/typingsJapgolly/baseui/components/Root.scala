...
object Root {
  ...
  implicit def make[C /* <: ElementType */](companion: Root.type): SharedBuilder_AsOverrideProps2050516390[C] = new SharedBuilder_AsOverrideProps2050516390[C](js.Array(this.component, js.Dictionary.empty))()
