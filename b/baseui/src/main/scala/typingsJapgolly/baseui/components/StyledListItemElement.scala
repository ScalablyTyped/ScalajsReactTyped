...
object StyledListItemElement {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledListItemElement.type): SharedBuilder_AsOverrideProps_1927812510[C] = new SharedBuilder_AsOverrideProps_1927812510[C](js.Array(this.component, js.Dictionary.empty))()
