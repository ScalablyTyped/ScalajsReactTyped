...
import typingsJapgolly.baseui.paymentCardMod.PaymentCardProps
...
object PaymentCard {
  def apply(
    ...
    PaymentCardProps, 
    typingsJapgolly.baseui.paymentCardMod.PaymentCard, 
    Unit, 
    PaymentCardProps
  ] = {
  ...
  typingsJapgolly.baseui.paymentCardMod.PaymentCardProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.baseui.paymentCardMod.PaymentCard](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.paymentCardMod.PaymentCardProps])(children: _*)
  }
