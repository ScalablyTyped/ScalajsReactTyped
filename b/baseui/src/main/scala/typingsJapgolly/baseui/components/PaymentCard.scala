...
import typingsJapgolly.baseui.paymentCardTypesMod.PaymentCardProps
...
object PaymentCard {
  ...
  inline def apply(overrides: PaymentCardOverrides): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.baseui.paymentCardMod.PaymentCard] {
