...
import typingsJapgolly.baseui.flexGridMod.FlexGridItemProps
...
object FlexGridItem {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FlexGridItemProps, Ref, Unit, FlexGridItemProps] = {
  ...
  typingsJapgolly.baseui.flexGridMod.FlexGridItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.flexGridMod.FlexGridItemProps])(children: _*)
  }
