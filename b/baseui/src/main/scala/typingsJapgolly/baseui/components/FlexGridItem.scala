...
object FlexGridItem {
  ...
  inline def apply[C /* <: ElementType */](): Builder[C] = {
    ...
    new Builder[C](js.Array(this.component, __props.asInstanceOf[FlexGridItemProps[C] & (/* import warning: importer.ImportType#apply Failed type conversion: react.react.ComponentProps<C> extends {  ref :infer R | undefined} ? {  ref :R | undefined} : {} */ js.Any) & (Omit[
  ...
  open class Builder[C /* <: ElementType */] (val args: js.Array[Any])
    ...
    inline def flexGridColumnCount(value: Responsive[Double]): this.type = set("flexGridColumnCount", value.asInstanceOf[js.Any])
    
    inline def flexGridColumnCountVarargs(value: Double*): this.type = set("flexGridColumnCount", js.Array(value*))
    
    inline def flexGridColumnGap(value: Responsive[Scale]): this.type = set("flexGridColumnGap", value.asInstanceOf[js.Any])
    
    inline def flexGridColumnGapVarargs(value: Scale*): this.type = set("flexGridColumnGap", js.Array(value*))
    
    inline def flexGridItemCount(value: Double): this.type = set("flexGridItemCount", value.asInstanceOf[js.Any])
    
    inline def flexGridItemIndex(value: Double): this.type = set("flexGridItemIndex", value.asInstanceOf[js.Any])
    
    inline def flexGridRowGap(value: Responsive[Scale]): this.type = set("flexGridRowGap", value.asInstanceOf[js.Any])
    
    inline def flexGridRowGapVarargs(value: Scale*): this.type = set("flexGridRowGap", js.Array(value*))
  ...
  implicit def make[C /* <: ElementType */](companion: FlexGridItem.type): Builder[C] = new Builder[C](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[C /* <: ElementType */](
    p: FlexGridItemProps[C] & (/* import warning: importer.ImportType#apply Failed type conversion: react.react.ComponentProps<C> extends {  ref :infer R | undefined} ? {  ref :R | undefined} : {} */ js.Any) & (Omit[
      StyledBlockProps & ComponentProps[C], 
      /* keyof baseui.baseui/flex-grid/types.FlexGridItemProps<react.react.ElementType<any>> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 73, starting with typingsJapgolly.baseui.baseuiStrings.flexGridItemIndex, typingsJapgolly.baseui.baseuiStrings.flexGridItemCount, typingsJapgolly.baseui.baseuiStrings.flexGridColumnCount */ Any
    ])
