...
object StyledLoadingSpinnerContainer {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledLoadingSpinnerContainer.type): SharedBuilder_AsOverrideProps_1651054587[C] = new SharedBuilder_AsOverrideProps_1651054587[C](js.Array(this.component, js.Dictionary.empty))()
