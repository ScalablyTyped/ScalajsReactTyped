...
object StartEnhancerContainer {
  ...
  implicit def make[C /* <: ElementType */](companion: StartEnhancerContainer.type): SharedBuilder_AsOverrideProps2050516390[C] = new SharedBuilder_AsOverrideProps2050516390[C](js.Array(this.component, js.Dictionary.empty))()
