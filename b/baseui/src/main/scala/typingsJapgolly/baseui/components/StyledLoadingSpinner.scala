...
object StyledLoadingSpinner {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledLoadingSpinner.type): SharedBuilder_AsOverrideProps_1651054587[C] = new SharedBuilder_AsOverrideProps_1651054587[C](js.Array(this.component, js.Dictionary.empty))()
