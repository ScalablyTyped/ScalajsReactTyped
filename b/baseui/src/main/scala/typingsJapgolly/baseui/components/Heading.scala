...
object Heading {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def as(value: h1): this.type = set("as", value.asInstanceOf[js.Any])
    ...
    inline def styleLevel(value: `1` | `2` | `3` | `4` | `5` | `6`): this.type = set("styleLevel", value.asInstanceOf[js.Any])
  ...
  def withProps(p: HeadingProps & ComponentPropsWithoutRef[BlockComponentType[div]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
