...
import typingsJapgolly.baseui.headingMod.HeadingProps
...
object Heading {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[HeadingProps, Ref, Unit, HeadingProps] = {
  ...
  typingsJapgolly.baseui.headingMod.HeadingProps, 
  japgolly.scalajs.react.Children.Varargs, 
  japgolly.scalajs.react.raw.React.Ref](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.headingMod.HeadingProps])(children: _*)
  }
