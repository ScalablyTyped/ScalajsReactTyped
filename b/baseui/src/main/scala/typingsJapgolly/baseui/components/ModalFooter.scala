...
object ModalFooter {
  ...
  implicit def make[C /* <: ElementType */](companion: ModalFooter.type): SharedBuilder_AsOverrideProps1154346082[C] = new SharedBuilder_AsOverrideProps1154346082[C](js.Array(this.component, js.Dictionary.empty))()
