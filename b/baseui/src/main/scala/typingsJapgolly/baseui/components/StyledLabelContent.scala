...
object StyledLabelContent {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledLabelContent.type): SharedBuilder_AsOverrideProps1154346082[C] = new SharedBuilder_AsOverrideProps1154346082[C](js.Array(this.component, js.Dictionary.empty))()
