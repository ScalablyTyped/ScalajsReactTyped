...
import typingsJapgolly.baseui.datepickerMod.DatePicker_
...
object DatePicker {
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[DatePicker_[T]] {
    ...
    inline def onChange(value: /* a */ `9`[T] => Any): this.type = set("onChange", js.Any.fromFunction1(value))
    ...
    inline def onRangeChange(value: /* a */ `2`[T] => Any): this.type = set("onRangeChange", js.Any.fromFunction1(value))
  ...
  implicit def make[T](companion: DatePicker.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
