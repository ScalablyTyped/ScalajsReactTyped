...
object StyledTab {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledTab.type): SharedBuilder_AsOverrideProps1701960101[C] = new SharedBuilder_AsOverrideProps1701960101[C](js.Array(this.component, js.Dictionary.empty))()
