...
object StatefulDatepicker {
  def apply(
    ...
    MountedWithRawType[
      StatefulDatepickerPropsDa, 
      js.Object, 
      RawMounted[StatefulDatepickerPropsDa, js.Object]
    ]
  ] = {
  ...
  typingsJapgolly.baseui.StatefulDatepickerPropsDa, 
  japgolly.scalajs.react.Children.None, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.StatefulDatepickerPropsDa])
  }
