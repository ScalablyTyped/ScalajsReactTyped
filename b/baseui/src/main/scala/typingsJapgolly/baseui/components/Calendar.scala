...
object Calendar {
  ...
  inline def apply[T](): Builder[T] = {
    ...
    new Builder[T](js.Array(this.component, __props.asInstanceOf[CalendarProps[T]]))
  }
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.baseui.datepickerMod.Calendar[T]] {
  ...
  implicit def make[T](companion: Calendar.type): Builder[T] = new Builder[T](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[T](p: CalendarProps[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
