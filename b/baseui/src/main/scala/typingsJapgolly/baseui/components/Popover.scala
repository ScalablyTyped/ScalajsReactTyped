...
import typingsJapgolly.baseui.popoverMod.PopoverProps
...
object Popover {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PopoverProps, typingsJapgolly.baseui.popoverMod.Popover, Unit, PopoverProps] = {
  ...
  typingsJapgolly.baseui.popoverMod.PopoverProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.baseui.popoverMod.Popover](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.baseui.popoverMod.PopoverProps])(children: _*)
  }
