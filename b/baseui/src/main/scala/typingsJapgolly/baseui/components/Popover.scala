...
object Popover {
  ...
  inline def apply(isOpen: Boolean): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PopoverPropsinnerRefRefHT]))
  }
  ...
  def withProps(p: PopoverPropsinnerRefRefHT): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
