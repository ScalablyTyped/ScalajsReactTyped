...
object StyledNumberContentTail {
  ...
  implicit def make[C /* <: ElementType */](companion: StyledNumberContentTail.type): SharedBuilder_AsOverrideProps1443497525[C] = new SharedBuilder_AsOverrideProps1443497525[C](js.Array(this.component, js.Dictionary.empty))()
