...
object SelectDropdown {
  ...
  inline def apply(
    ...
    value: Value,
    valueKey: String
  ): SharedBuilder_DropdownProps_1703030112[typingsJapgolly.baseui.selectMod.SelectDropdown] = {
    ...
    new SharedBuilder_DropdownProps_1703030112[typingsJapgolly.baseui.selectMod.SelectDropdown](js.Array(this.component, __props.asInstanceOf[DropdownProps]))
  }
  ...
  def withProps(p: DropdownProps): SharedBuilder_DropdownProps_1703030112[typingsJapgolly.baseui.selectMod.SelectDropdown] = new SharedBuilder_DropdownProps_1703030112[typingsJapgolly.baseui.selectMod.SelectDropdown](js.Array(this.component, p.asInstanceOf[js.Any]))
}
