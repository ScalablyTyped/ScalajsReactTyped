...
import typingsJapgolly.baseui.anon.IsOpen
...
import typingsJapgolly.baseui.popoverTypesMod.StatefulPopoverContainerProps
...
object popoverStatefulContainerMod {
  ...
  trait StatefulContainer extends Component[StatefulPopoverContainerProps, State, Any] {
    ...
    def onClick(e: ReactEventFrom[Element]): Unit = js.native
