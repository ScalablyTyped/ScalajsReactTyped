...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.babelPluginTransformRuntime.mod.CorejsVersion
    - typingsJapgolly.babelPluginTransformRuntime.anon.Proposals
    - typingsJapgolly.babelPluginTransformRuntime.babelPluginTransformRuntimeBooleans.`false`
  */
  trait CorejsOption extends StObject
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.babelPluginTransformRuntime.babelPluginTransformRuntimeInts.`2`
    - typingsJapgolly.babelPluginTransformRuntime.babelPluginTransformRuntimeInts.`3`
  */
  trait CorejsVersion
    extends StObject
       with CorejsOption
  object CorejsVersion {
    ...
    inline def `2`: typingsJapgolly.babelPluginTransformRuntime.babelPluginTransformRuntimeInts.`2` = 2.asInstanceOf[typingsJapgolly.babelPluginTransformRuntime.babelPluginTransformRuntimeInts.`2`]
    
    inline def `3`: typingsJapgolly.babelPluginTransformRuntime.babelPluginTransformRuntimeInts.`3` = 3.asInstanceOf[typingsJapgolly.babelPluginTransformRuntime.babelPluginTransformRuntimeInts.`3`]
  }
