...
import typingsJapgolly.babelPluginMacros.babelPluginMacrosBooleans.`false`
import typingsJapgolly.babelPluginMacros.babelPluginMacrosBooleans.`true`
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Ampersand
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.AmpersandAmpersand
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Asterisk
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.AsteriskAsterisk
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.BlockStatement
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ClassBody
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.CommonJS
...
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ES
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.EqualssignEqualssign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.EqualssignEqualssignEqualssign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Exclamationmark
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ExclamationmarkEqualssign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ExclamationmarkEqualssignEqualssign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Greaterthansign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.GreaterthansignEqualssign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.GreaterthansignGreaterthansign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.GreaterthansignGreaterthansignGreaterthansign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Identifier
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Lessthansign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.LessthansignEqualssign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.LessthansignLessthansign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Percentsign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Plussign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.PlussignPlussign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.QuestionmarkQuestionmark
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Slash
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.StringLiteral
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Tilde
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Verticalline
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.VerticallineGreaterthansign
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.VerticallineVerticalline
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.^
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.`--`
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.`-_`
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.`object`
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.`throw`
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.`var`
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.boolean
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.const
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.constructor
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.delete
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.function
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.get
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.in
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.instanceof
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.let
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.method
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.minus
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.module
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.number
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.plus
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.script
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.set
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.string
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.symbol
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.typeof
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.undefined
import typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.void
...
object anon {
  ...
  trait TypeofNodePath
    extends StObject
       with Instantiable2[/* hub */ Hub, /* parent */ typingsJapgolly.babelTypes.mod.Node, NodePath[js.Object]] {
    
    def get[C /* <: typingsJapgolly.babelTypes.mod.Node */, K /* <: /* keyof C */ String */](opts: Container[C, K]): typingsJapgolly.babelTraverse.mod.NodePath[
  ...
  trait Typeoftraverse extends StObject {
    ...
    def apply(
      parent: js.UndefOr[
          typingsJapgolly.babelTypes.mod.Node | js.Array[typingsJapgolly.babelTypes.mod.Node] | Null
        ],
      opts: js.UndefOr[TraverseOptions[typingsJapgolly.babelTypes.mod.Node]],
      scope: js.UndefOr[Scope],
      state: js.UndefOr[Any],
      parentPath: js.UndefOr[typingsJapgolly.babelTraverse.mod.NodePath[typingsJapgolly.babelTypes.mod.Node]]
    ): Unit = js.native
    def apply[S](
      parent: js.Array[typingsJapgolly.babelTypes.mod.Node],
    ...
    def apply[S](
      ...
      scope: Unit,
      state: S,
      parentPath: typingsJapgolly.babelTraverse.mod.NodePath[typingsJapgolly.babelTypes.mod.Node]
    ): Unit = js.native
    def apply[S](
      parent: js.Array[typingsJapgolly.babelTypes.mod.Node],
      opts: TraverseOptions[S],
    ...
    def apply[S](parent: typingsJapgolly.babelTypes.mod.Node, opts: TraverseOptions[S], scope: Unit, state: S): Unit = js.native
    def apply[S](
    ...
    def apply[S](parent: typingsJapgolly.babelTypes.mod.Node, opts: TraverseOptions[S], scope: Scope, state: S): Unit = js.native
    def apply[S](
      parent: typingsJapgolly.babelTypes.mod.Node,
      opts: TraverseOptions[S],
      scope: Scope,
  ...
  trait Typeoftypes extends StObject {
    ...
    def addComment[T /* <: typingsJapgolly.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, content: String): T = js.native
    def addComment[T /* <: typingsJapgolly.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, content: String, line: Boolean): T = js.native
    
    def addComments[T /* <: typingsJapgolly.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, comments: js.Array[Comment]): T = js.native
    ...
    def clone[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = js.native
    
    def cloneDeep[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = js.native
    
    def cloneDeepWithoutLoc[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = js.native
    
    def cloneNode[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = js.native
    def cloneNode[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T, deep: Boolean): T = js.native
    def cloneNode[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T, deep: Boolean, withoutLoc: Boolean): T = js.native
    def cloneNode[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T, deep: Unit, withoutLoc: Boolean): T = js.native
    
    def cloneWithoutLoc[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = js.native
    ...
    def ensureBlock(node: Extract[typingsJapgolly.babelTypes.mod.Node, Body]): BlockStatement_ = js.native
    ...
    def getBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node): Record[String, Identifier_] = js.native
    def getBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node, duplicates: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = js.native
    def getBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node, duplicates: Boolean, outerOnly: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = js.native
    def getBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node, duplicates: Unit, outerOnly: Boolean): Record[String, Identifier_] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_false(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `false`): Record[String, Identifier_] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_false(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `false`, outerOnly: Boolean): Record[String, Identifier_] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_true(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `true`): Record[String, js.Array[Identifier_]] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_true(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `true`, outerOnly: Boolean): Record[String, js.Array[Identifier_]] = js.native
    
    def getOuterBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node): Record[String, Identifier_] = js.native
    def getOuterBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node, duplicates: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = js.native
    @JSName("getOuterBindingIdentifiers")
    def getOuterBindingIdentifiers_false(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `false`): Record[String, Identifier_] = js.native
    @JSName("getOuterBindingIdentifiers")
    def getOuterBindingIdentifiers_true(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `true`): Record[String, js.Array[Identifier_]] = js.native
    ...
    def inheritInnerComments(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): Unit = js.native
    
    def inheritLeadingComments(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): Unit = js.native
    
    def inheritTrailingComments(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): Unit = js.native
    
    def inherits[T /* <: js.UndefOr[typingsJapgolly.babelTypes.mod.Node | Null] */](child: T): T = js.native
    def inherits[T /* <: js.UndefOr[typingsJapgolly.babelTypes.mod.Node | Null] */](child: T, parent: typingsJapgolly.babelTypes.mod.Node): T = js.native
    
    def inheritsComments[T /* <: typingsJapgolly.babelTypes.mod.Node */](node: T, parent: typingsJapgolly.babelTypes.mod.Node): Unit = js.native
    ...
    def is(`type`: String, n: Null, required: Partial[typingsJapgolly.babelTypes.mod.Node]): /* is @babel/types.@babel/types.Node */ Boolean = js.native
    def is(`type`: String, n: Unit, required: Partial[typingsJapgolly.babelTypes.mod.Node]): /* is @babel/types.@babel/types.Node */ Boolean = js.native
    def is(`type`: String, n: typingsJapgolly.babelTypes.mod.Node): /* is @babel/types.@babel/types.Node */ Boolean = js.native
    def is(
      `type`: String,
    ...
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */](`type`: T): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */](`type`: T, n: typingsJapgolly.babelTypes.mod.Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    def is[P /* <: typingsJapgolly.babelTypes.mod.Node */](`type`: String, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
    def is[P /* <: typingsJapgolly.babelTypes.mod.Node */](`type`: String, n: Unit, required: Partial[P]): /* is P */ Boolean = js.native
    def is[P /* <: typingsJapgolly.babelTypes.mod.Node */](`type`: String, n: typingsJapgolly.babelTypes.mod.Node, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Unit, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Type[T]] */](`type`: T, n: typingsJapgolly.babelTypes.mod.Node, required: Partial[P]): /* is P */ Boolean = js.native
    ...
    def isBinding(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): Boolean = js.native
    def isBinding(
    ...
    def isBlockScoped(node: typingsJapgolly.babelTypes.mod.Node): Boolean = js.native
    ...
    def isImmutable(node: typingsJapgolly.babelTypes.mod.Node): /* is @babel/types.@babel/types.Immutable */ Boolean = js.native
    ...
    def isLet(node: typingsJapgolly.babelTypes.mod.Node): /* is @babel/types.@babel/types.VariableDeclaration */ Boolean = js.native
    ...
    def isNodesEquivalent_T[T /* <: Partial[typingsJapgolly.babelTypes.mod.Node] */](a: T, b: Any): /* is T */ Boolean = js.native
    ...
    def isPlaceholderType(
      placeholderType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any,
      targetType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any
    ): Boolean = js.native
    ...
    def isReferenced(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): Boolean = js.native
    def isReferenced(
      node: typingsJapgolly.babelTypes.mod.Node,
      parent: typingsJapgolly.babelTypes.mod.Node,
      grandparent: typingsJapgolly.babelTypes.mod.Node
    ...
    def isScope(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): /* is @babel/types.@babel/types.Scopable */ Boolean = js.native
    ...
    def isType[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */](nodetype: String, targetType: T): /* is T */ Boolean = js.native
    ...
    def isVar(node: typingsJapgolly.babelTypes.mod.Node): /* is @babel/types.@babel/types.VariableDeclaration */ Boolean = js.native
    ...
    def matchesPattern(node: typingsJapgolly.babelTypes.mod.Node, `match`: String): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    def matchesPattern(node: typingsJapgolly.babelTypes.mod.Node, `match`: String, allowPartial: Boolean): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    def matchesPattern(node: typingsJapgolly.babelTypes.mod.Node, `match`: js.Array[String]): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    def matchesPattern(node: typingsJapgolly.babelTypes.mod.Node, `match`: js.Array[String], allowPartial: Boolean): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    ...
    def placeholder(
      expectedNode: Identifier | StringLiteral | typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Expression | typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Statement | typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Declaration | BlockStatement | ClassBody | typingsJapgolly.babelPluginMacros.babelPluginMacrosStrings.Pattern,
      name: Identifier_
    ...
    def removeComments[T /* <: typingsJapgolly.babelTypes.mod.Node */](node: T): T = js.native
    
    def removeProperties(n: typingsJapgolly.babelTypes.mod.Node): Unit = js.native
    def removeProperties(n: typingsJapgolly.babelTypes.mod.Node, opts: PreserveComments): Unit = js.native
    
    def removePropertiesDeep[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = js.native
    def removePropertiesDeep[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T, opts: PreserveComments): T = js.native
    ...
    def toComputedKey[T /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Computed] */](node: T): Expression = js.native
    def toComputedKey[T /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Computed] */](node: T, key: Expression): Expression = js.native
    def toComputedKey[T /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Computed] */](node: T, key: Identifier_): Expression = js.native
    ...
    @JSName("toExpression")
    def toExpression_FunctionExpression_(node: Function): FunctionExpression_ = js.native
    ...
    def toKeyAlias(node: Method, key: typingsJapgolly.babelTypes.mod.Node): String = js.native
    def toKeyAlias(node: Property): String = js.native
    def toKeyAlias(node: Property, key: typingsJapgolly.babelTypes.mod.Node): String = js.native
    
    def toSequenceExpression(nodes: js.Array[typingsJapgolly.babelTypes.mod.Node], scope: BuildUndefinedNode): js.UndefOr[SequenceExpression_] = js.native
    ...
    def traverse[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandler[T]): Unit = js.native
    def traverse[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandlers[T]): Unit = js.native
    def traverse[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandlers[T], state: T): Unit = js.native
    def traverse[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandler[T], state: T): Unit = js.native
    
    def traverseFast[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandler[T]): Unit = js.native
    def traverseFast[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandler[T], state: T): Unit = js.native
    ...
    def validate(n: typingsJapgolly.babelTypes.mod.Node, key: String, value: Any): Unit = js.native
    def validate[T /* <: typingsJapgolly.babelTypes.mod.Node */, K /* <: /* keyof T */ String */](
      n: Null,
      key: K,
  ...
  trait defaultArrayNodePathNodeR
    extends StObject
       with /* key */ StringDictionary[js.Array[NodePath[typingsJapgolly.babelTypes.mod.Node]]] {
    
    var default: js.Array[NodePath[typingsJapgolly.babelTypes.mod.Node]]
  }
  object defaultArrayNodePathNodeR {
    
    inline def apply(default: js.Array[NodePath[typingsJapgolly.babelTypes.mod.Node]]): defaultArrayNodePathNodeR = {
    ...
    extension [Self <: defaultArrayNodePathNodeR](x: Self) {
      ...
      inline def setDefault(value: js.Array[NodePath[typingsJapgolly.babelTypes.mod.Node]]): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
      
      inline def setDefaultVarargs(value: NodePath[typingsJapgolly.babelTypes.mod.Node]*): Self = StObject.set(x, "default", js.Array(value*))
    }
  }
}
