...
import typingsJapgolly.builderUtil.builderUtilStrings._empty
import typingsJapgolly.builderUtil.outArchMod.Arch
import typingsJapgolly.builderUtil.outLogMod.Logger
...
object mod {
  ...
  open class AsyncTaskManager protected ()
    extends typingsJapgolly.builderUtil.outAsyncTaskManagerMod.AsyncTaskManager {
  ...
  open class DebugLogger ()
    extends typingsJapgolly.builderUtil.outDebugLoggerMod.DebugLogger {
  ...
  @js.native
  open class TmpDir ()
    extends typingsJapgolly.tempFile.mod.TmpDir {
