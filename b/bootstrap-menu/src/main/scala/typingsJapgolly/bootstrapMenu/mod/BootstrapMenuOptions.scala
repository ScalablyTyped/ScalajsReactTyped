...
object BootstrapMenuOptions {
  ...
  def apply(
    ...
    fetchElementData: /* jqueryElement */ JQuery_[HTMLElement] => CallbackTo[BootstrapMenuRowElement] = null,
    ...
    if (fetchElementData != null) __obj.updateDynamic("fetchElementData")(js.Any.fromFunction1((t0: /* jqueryElement */ typingsJapgolly.jquery.JQuery_[org.scalajs.dom.raw.HTMLElement]) => fetchElementData(t0).runNow()))
