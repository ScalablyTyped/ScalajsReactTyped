...
import typingsJapgolly.babelTraverse.anon.Confident
import typingsJapgolly.babelTraverse.anon.Existing
...
import typingsJapgolly.babelTypes.mod.Binary
import typingsJapgolly.babelTypes.mod.BinaryExpression_
import typingsJapgolly.babelTypes.mod.BindExpression_
import typingsJapgolly.babelTypes.mod.Block
import typingsJapgolly.babelTypes.mod.BlockParent
...
import typingsJapgolly.babelTypes.mod.Class
...
import typingsJapgolly.babelTypes.mod.CompletionStatement
import typingsJapgolly.babelTypes.mod.Conditional
...
import typingsJapgolly.babelTypes.mod.ExportDeclaration
...
import typingsJapgolly.babelTypes.mod.ExpressionWrapper
import typingsJapgolly.babelTypes.mod.File_
import typingsJapgolly.babelTypes.mod.Flow
import typingsJapgolly.babelTypes.mod.FlowBaseAnnotation
import typingsJapgolly.babelTypes.mod.FlowDeclaration
import typingsJapgolly.babelTypes.mod.FlowTypeAnnotation
import typingsJapgolly.babelTypes.mod.For
...
import typingsJapgolly.babelTypes.mod.ForXStatement
import typingsJapgolly.babelTypes.mod.Function
import typingsJapgolly.babelTypes.mod.FunctionDeclaration_
import typingsJapgolly.babelTypes.mod.FunctionExpression_
import typingsJapgolly.babelTypes.mod.FunctionParent
...
import typingsJapgolly.babelTypes.mod.Immutable
...
import typingsJapgolly.babelTypes.mod.JSX
...
import typingsJapgolly.babelTypes.mod.ObjectMember
...
import typingsJapgolly.babelTypes.mod.Pattern
import typingsJapgolly.babelTypes.mod.Program_
import typingsJapgolly.babelTypes.mod.Property
import typingsJapgolly.babelTypes.mod.Pureish
...
import typingsJapgolly.babelTypes.mod.Scopable
...
import typingsJapgolly.babelTypes.mod.Terminatorless
...
import typingsJapgolly.babelTypes.mod.While
...
object mod {
  ...
  object VisitNodeObject {
    ...
    extension [Self <: VisitNodeObject[?], T](x: Self & VisitNodeObject[T]) {
      ...
      inline def setEnter(value: (/* path */ NodePath[T], /* state */ Any) => Callback): Self = StObject.set(x, "enter", js.Any.fromFunction2((t0: /* path */ NodePath[T], t1: /* state */ Any) => (value(t0, t1)).runNow()))
      
      inline def setEnterUndefined: Self = StObject.set(x, "enter", js.undefined)
      
      inline def setExit(value: (/* path */ NodePath[T], /* state */ Any) => Callback): Self = StObject.set(x, "exit", js.Any.fromFunction2((t0: /* path */ NodePath[T], t1: /* state */ Any) => (value(t0, t1)).runNow()))
  ...
  trait Visitor[S]
    ...
    var Binary: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Binary]] = js.undefined
    ...
    var Block: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Block]] = js.undefined
    
    var BlockParent: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.BlockParent]] = js.undefined
    ...
    var Class: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Class]] = js.undefined
    ...
    var CompletionStatement: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.CompletionStatement]] = js.undefined
    
    var Conditional: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Conditional]] = js.undefined
    ...
    var Declaration: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Declaration]] = js.undefined
    ...
    var ExportDeclaration: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.ExportDeclaration]] = js.undefined
    ...
    var Expression: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Expression]] = js.undefined
    
    var ExpressionStatement: js.UndefOr[VisitNode[S, ExpressionStatement_]] = js.undefined
    
    var ExpressionWrapper: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.ExpressionWrapper]] = js.undefined
    
    var File: js.UndefOr[VisitNode[S, File_]] = js.undefined
    
    var Flow: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Flow]] = js.undefined
    
    var FlowBaseAnnotation: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.FlowBaseAnnotation]] = js.undefined
    
    var FlowDeclaration: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.FlowDeclaration]] = js.undefined
    
    var For: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.For]] = js.undefined
    ...
    var ForXStatement: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.ForXStatement]] = js.undefined
    
    var Function: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Function]] = js.undefined
    ...
    var FunctionParent: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.FunctionParent]] = js.undefined
    ...
    var Immutable: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Immutable]] = js.undefined
    ...
    var JSX: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.JSX]] = js.undefined
    ...
    var LVal: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.LVal]] = js.undefined
    
    var LabeledStatement: js.UndefOr[VisitNode[S, LabeledStatement_]] = js.undefined
    
    var Literal: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Literal]] = js.undefined
    
    var LogicalExpression: js.UndefOr[VisitNode[S, LogicalExpression_]] = js.undefined
    
    var Loop: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Loop]] = js.undefined
    ...
    var Method: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Method]] = js.undefined
    
    var MixedTypeAnnotation: js.UndefOr[VisitNode[S, MixedTypeAnnotation_]] = js.undefined
    
    var ModuleDeclaration: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.ModuleDeclaration]] = js.undefined
    
    var ModuleSpecifier: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.ModuleSpecifier]] = js.undefined
    ...
    var ObjectMember: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.ObjectMember]] = js.undefined
    ...
    var Pattern: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Pattern]] = js.undefined
    
    var Program: js.UndefOr[VisitNode[S, Program_]] = js.undefined
    
    var Property: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Property]] = js.undefined
    
    var Pureish: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Pureish]] = js.undefined
    ...
    var Scopable: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Scopable]] = js.undefined
    ...
    var Statement: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Statement]] = js.undefined
    ...
    var Super: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Super]] = js.undefined
    ...
    var Terminatorless: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.Terminatorless]] = js.undefined
    ...
    var UnaryLike: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.UnaryLike]] = js.undefined
    ...
    var UserWhitespacable: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.UserWhitespacable]] = js.undefined
    ...
    var While: js.UndefOr[VisitNode[S, typingsJapgolly.babelTypes.mod.While]] = js.undefined
