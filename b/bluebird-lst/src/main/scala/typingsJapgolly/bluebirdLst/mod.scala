...
import typingsJapgolly.bluebirdLst.anon.Cancellation
...
object mod {
  ...
  inline def all[R](values: js.Array[PromiseLike[R] | R]): Bluebird[js.Array[R]] = ^.asInstanceOf[js.Dynamic].applyDynamic("all")(values.asInstanceOf[js.Any]).asInstanceOf[Bluebird[js.Array[R]]]
  // array with values
  /* static member */
  ...
  /* static member */
  inline def all_T1[T1](values: js.Array[PromiseLike[T1] | T1]): Bluebird[js.Array[T1]] = ^.asInstanceOf[js.Dynamic].applyDynamic("all")(values.asInstanceOf[js.Any]).asInstanceOf[Bluebird[js.Array[T1]]]
  ...
  object Inspection {
    ...
    inline def apply[R](
      ...
      reason: CallbackTo[Any],
      value: CallbackTo[R]
    ): Inspection[R] = {
      val __obj = js.Dynamic.literal(isCancelled = isCancelled.toJsFn, isFulfilled = isFulfilled.toJsFn, isPending = isPending.toJsFn, isRejected = isRejected.toJsFn, reason = reason.toJsFn, value = value.toJsFn)
    ...
    extension [Self <: Inspection[?], R](x: Self & Inspection[R]) {
      ...
      inline def setIsFulfilled(value: CallbackTo[Boolean]): Self = StObject.set(x, "isFulfilled", value.toJsFn)
      
      inline def setIsPending(value: CallbackTo[Boolean]): Self = StObject.set(x, "isPending", value.toJsFn)
      
      inline def setIsRejected(value: CallbackTo[Boolean]): Self = StObject.set(x, "isRejected", value.toJsFn)
      
      inline def setReason(value: CallbackTo[Any]): Self = StObject.set(x, "reason", value.toJsFn)
      
      inline def setValue(value: CallbackTo[R]): Self = StObject.set(x, "value", value.toJsFn)
    }
  }
