...
object FileInputOptions {
  ...
  def apply(
    ...
    slugCallback: /* filename */ String => CallbackTo[String] = null,
    ...
    if (slugCallback != null) __obj.updateDynamic("slugCallback")(js.Any.fromFunction1((t0: /* filename */ java.lang.String) => slugCallback(t0).runNow()))
