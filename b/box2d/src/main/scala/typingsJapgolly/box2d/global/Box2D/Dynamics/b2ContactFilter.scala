...
open class b2ContactFilter ()
  extends StObject
     with typingsJapgolly.box2d.Box2D.Dynamics.b2ContactFilter {
  ...
  override def ShouldCollide(
    fixtureA: typingsJapgolly.box2d.Box2D.Dynamics.b2Fixture,
    fixtureB: typingsJapgolly.box2d.Box2D.Dynamics.b2Fixture
  ): Boolean = js.native
}
