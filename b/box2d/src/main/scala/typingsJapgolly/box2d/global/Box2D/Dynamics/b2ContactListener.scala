...
open class b2ContactListener ()
  extends StObject
     with typingsJapgolly.box2d.Box2D.Dynamics.b2ContactListener {
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def PostSolve(contact: b2Contact, impulse: typingsJapgolly.box2d.Box2D.Dynamics.b2ContactImpulse): Unit = js.native
