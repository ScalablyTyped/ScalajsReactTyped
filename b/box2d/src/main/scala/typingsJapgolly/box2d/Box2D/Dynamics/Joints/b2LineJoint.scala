...
object b2LineJoint {
  ...
  inline def apply(
    ...
    GetMaxMotorForce: CallbackTo[Double],
  ...
  extension [Self <: b2LineJoint](x: Self) {
    ...
    inline def setGetMaxMotorForce(value: CallbackTo[Double]): Self = StObject.set(x, "GetMaxMotorForce", value.toJsFn)
