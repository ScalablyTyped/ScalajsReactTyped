...
object Controllers {
  ...
  object b2BuoyancyController {
    ...
    inline def apply(
      AddBody: b2Body => Callback,
      Clear: Callback,
      Draw: b2DebugDraw => Callback,
      GetBodyList: CallbackTo[b2ControllerEdge],
      GetNext: CallbackTo[b2Controller],
      GetWorld: CallbackTo[b2World],
      RemoveBody: b2Body => Callback,
      Step: Any => Callback,
      angularDrag: Double,
      density: Double,
      gravity: b2Vec2,
  ...
  object b2ConstantAccelController {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(A = A.asInstanceOf[js.Any], AddBody = js.Any.fromFunction1((t0: b2Body) => AddBody(t0).runNow()), Clear = Clear.toJsFn, Draw = js.Any.fromFunction1((t0: b2DebugDraw) => Draw(t0).runNow()), GetBodyList = GetBodyList.toJsFn, GetNext = GetNext.toJsFn, GetWorld = GetWorld.toJsFn, RemoveBody = js.Any.fromFunction1((t0: b2Body) => RemoveBody(t0).runNow()), Step = js.Any.fromFunction1((t0: Any) => Step(t0).runNow()), m_bodyCount = m_bodyCount.asInstanceOf[js.Any], m_bodyList = m_bodyList.asInstanceOf[js.Any])
  ...
  object b2Controller {
    ...
    extension [Self <: b2Controller](x: Self) {
      ...
      inline def setAddBody(value: b2Body => Callback): Self = StObject.set(x, "AddBody", js.Any.fromFunction1((t0: b2Body) => value(t0).runNow()))
      
      inline def setClear(value: Callback): Self = StObject.set(x, "Clear", value.toJsFn)
      
      inline def setDraw(value: b2DebugDraw => Callback): Self = StObject.set(x, "Draw", js.Any.fromFunction1((t0: b2DebugDraw) => value(t0).runNow()))
      
      inline def setGetBodyList(value: CallbackTo[b2ControllerEdge]): Self = StObject.set(x, "GetBodyList", value.toJsFn)
      
      inline def setGetNext(value: CallbackTo[b2Controller]): Self = StObject.set(x, "GetNext", value.toJsFn)
      
      inline def setGetWorld(value: CallbackTo[b2World]): Self = StObject.set(x, "GetWorld", value.toJsFn)
      ...
      inline def setRemoveBody(value: b2Body => Callback): Self = StObject.set(x, "RemoveBody", js.Any.fromFunction1((t0: b2Body) => value(t0).runNow()))
      
      inline def setStep(value: Any => Callback): Self = StObject.set(x, "Step", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    }
  }
  ...
  object b2GravityController {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(AddBody = js.Any.fromFunction1((t0: b2Body) => AddBody(t0).runNow()), Clear = Clear.toJsFn, Draw = js.Any.fromFunction1((t0: b2DebugDraw) => Draw(t0).runNow()), G = G.asInstanceOf[js.Any], GetBodyList = GetBodyList.toJsFn, GetNext = GetNext.toJsFn, GetWorld = GetWorld.toJsFn, RemoveBody = js.Any.fromFunction1((t0: b2Body) => RemoveBody(t0).runNow()), Step = js.Any.fromFunction1((t0: Any) => Step(t0).runNow()), invSqr = invSqr.asInstanceOf[js.Any], m_bodyCount = m_bodyCount.asInstanceOf[js.Any], m_bodyList = m_bodyList.asInstanceOf[js.Any])
  ...
  object b2TensorDampingController {
    ...
    inline def apply(
      ...
      GetWorld: CallbackTo[b2World],
      RemoveBody: b2Body => Callback,
      SetAxisAligned: (Double, Double) => Callback,
      Step: Any => Callback,
      T: b2Mat22,
      m_bodyCount: Double,
      m_bodyList: b2ControllerEdge,
      ...
      val __obj = js.Dynamic.literal(AddBody = js.Any.fromFunction1((t0: b2Body) => AddBody(t0).runNow()), Clear = Clear.toJsFn, Draw = js.Any.fromFunction1((t0: b2DebugDraw) => Draw(t0).runNow()), GetBodyList = GetBodyList.toJsFn, GetNext = GetNext.toJsFn, GetWorld = GetWorld.toJsFn, RemoveBody = js.Any.fromFunction1((t0: b2Body) => RemoveBody(t0).runNow()), SetAxisAligned = js.Any.fromFunction2((t0: Double, t1: Double) => (SetAxisAligned(t0, t1)).runNow()), Step = js.Any.fromFunction1((t0: Any) => Step(t0).runNow()), T = T.asInstanceOf[js.Any], m_bodyCount = m_bodyCount.asInstanceOf[js.Any], m_bodyList = m_bodyList.asInstanceOf[js.Any], maxTimeStep = maxTimeStep.asInstanceOf[js.Any])
    ...
    extension [Self <: b2TensorDampingController](x: Self) {
      ...
      inline def setSetAxisAligned(value: (Double, Double) => Callback): Self = StObject.set(x, "SetAxisAligned", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
