...
object b2RevoluteJoint {
  ...
  extension [Self <: b2RevoluteJoint](x: Self) {
    ...
    inline def setGetJointAngle(value: CallbackTo[Double]): Self = StObject.set(x, "GetJointAngle", value.toJsFn)
    ...
    inline def setGetMotorTorque(value: CallbackTo[Double]): Self = StObject.set(x, "GetMotorTorque", value.toJsFn)
    ...
    inline def setSetMaxMotorTorque(value: Double => Callback): Self = StObject.set(x, "SetMaxMotorTorque", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
