package typingsJapgolly.bigbluebuttonJs
...
object mod {
  ...
  object MonitoringType {
    ...
    inline def apply(
      getMeetingInfo: String => String,
      getMeetings: CallbackTo[String],
      isMeetingRunning: String => String
    ): MonitoringType = {
      val __obj = js.Dynamic.literal(getMeetingInfo = js.Any.fromFunction1(getMeetingInfo), getMeetings = getMeetings.toJsFn, isMeetingRunning = js.Any.fromFunction1(isMeetingRunning))
    ...
    extension [Self <: MonitoringType](x: Self) {
      ...
      inline def setGetMeetings(value: CallbackTo[String]): Self = StObject.set(x, "getMeetings", value.toJsFn)
