...
object libParseMod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setWarning(value: (/* reason */ String, /* code */ Double, /* offset */ Double) => Callback): Self = StObject.set(x, "warning", js.Any.fromFunction3((t0: /* reason */ String, t1: /* code */ Double, t2: /* offset */ Double) => (value(t0, t1, t2)).runNow()))
