...
object libStringifyMod {
  ...
  trait Schema extends StObject {
    ...
    var extensions: js.UndefOr[js.Array[typingsJapgolly.bcp47.libParseMod.Extension]] = js.undefined
  ...
  object Schema {
    ...
    extension [Self <: Schema](x: Self) {
      ...
      inline def setExtensions(value: js.Array[typingsJapgolly.bcp47.libParseMod.Extension]): Self = StObject.set(x, "extensions", value.asInstanceOf[js.Any])
      
      inline def setExtensionsUndefined: Self = StObject.set(x, "extensions", js.undefined)
      
      inline def setExtensionsVarargs(value: typingsJapgolly.bcp47.libParseMod.Extension*): Self = StObject.set(x, "extensions", js.Array(value*))
