...
import typingsJapgolly.browserBunyan.anon.PartialConsoleFormattedSt
import typingsJapgolly.browserBunyan.anon.PartialConsoleFormattedStDef
import typingsJapgolly.browserBunyan.anon.Typeofbunyan
import typingsJapgolly.browserBunyan.mod.BrowserBunyan.ConsoleFormattedStreamOptions
...
object mod extends Shortcut {
  ...
  type BrowserBunyan = (Instantiable1[/* options */ LoggerOptions, typingsJapgolly.bunyan.mod.^]) & Typeofbunyan & typingsJapgolly.browserBunyan.anon.ConsoleFormattedStream
