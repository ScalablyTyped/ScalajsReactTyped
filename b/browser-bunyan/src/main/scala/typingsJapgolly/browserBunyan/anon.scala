...
object anon {
  ...
  object ConsoleFormattedStream {
    ...
    inline def apply(
      ConsoleFormattedStream: typingsJapgolly.browserBunyan.mod.BrowserBunyan.ConsoleFormattedStream,
    ...
    extension [Self <: ConsoleFormattedStream](x: Self) {
      ...
      inline def setConsoleFormattedStream(value: typingsJapgolly.browserBunyan.mod.BrowserBunyan.ConsoleFormattedStream): Self = StObject.set(x, "ConsoleFormattedStream", value.asInstanceOf[js.Any])
  ...
  object Typeofbunyan {
    ...
    extension [Self <: Typeofbunyan](x: Self) {
      ...
      inline def setSafeCycles(value: CallbackTo[js.Function2[/* key */ String, /* value */ Any, Any]]): Self = StObject.set(x, "safeCycles", value.toJsFn)
