...
trait TSTypeParameter
  ...
  @JSName("type")
  var type_TSTypeParameter: typingsJapgolly.babelTypes.babelTypesStrings.TSTypeParameter
}
object TSTypeParameter {
  ...
  extension [Self <: TSTypeParameter](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSTypeParameter): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
