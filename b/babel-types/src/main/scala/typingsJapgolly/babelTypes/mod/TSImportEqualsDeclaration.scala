...
trait TSImportEqualsDeclaration
  ...
  @JSName("type")
  var type_TSImportEqualsDeclaration: typingsJapgolly.babelTypes.babelTypesStrings.TSImportEqualsDeclaration
}
object TSImportEqualsDeclaration {
  ...
  extension [Self <: TSImportEqualsDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSImportEqualsDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
