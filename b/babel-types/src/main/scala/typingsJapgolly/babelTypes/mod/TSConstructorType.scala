...
trait TSConstructorType
  ...
  @JSName("type")
  var type_TSConstructorType: typingsJapgolly.babelTypes.babelTypesStrings.TSConstructorType
}
object TSConstructorType {
  ...
  extension [Self <: TSConstructorType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSConstructorType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
