...
trait TSFunctionType
  ...
  @JSName("type")
  var type_TSFunctionType: typingsJapgolly.babelTypes.babelTypesStrings.TSFunctionType
}
object TSFunctionType {
  ...
  extension [Self <: TSFunctionType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSFunctionType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
