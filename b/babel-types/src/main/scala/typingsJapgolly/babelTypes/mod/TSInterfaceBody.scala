...
trait TSInterfaceBody
  ...
  @JSName("type")
  var type_TSInterfaceBody: typingsJapgolly.babelTypes.babelTypesStrings.TSInterfaceBody
}
object TSInterfaceBody {
  ...
  extension [Self <: TSInterfaceBody](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSInterfaceBody): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
