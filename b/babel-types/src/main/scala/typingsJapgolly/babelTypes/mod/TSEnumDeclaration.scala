...
trait TSEnumDeclaration
  ...
  @JSName("type")
  var type_TSEnumDeclaration: typingsJapgolly.babelTypes.babelTypesStrings.TSEnumDeclaration
}
object TSEnumDeclaration {
  ...
  extension [Self <: TSEnumDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSEnumDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
