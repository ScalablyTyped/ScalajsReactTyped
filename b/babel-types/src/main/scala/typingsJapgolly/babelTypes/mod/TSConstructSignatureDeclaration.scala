...
trait TSConstructSignatureDeclaration
  ...
  @JSName("type")
  var type_TSConstructSignatureDeclaration: typingsJapgolly.babelTypes.babelTypesStrings.TSConstructSignatureDeclaration
}
object TSConstructSignatureDeclaration {
  ...
  extension [Self <: TSConstructSignatureDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSConstructSignatureDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
