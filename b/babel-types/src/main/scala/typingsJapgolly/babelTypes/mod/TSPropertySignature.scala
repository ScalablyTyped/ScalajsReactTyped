...
trait TSPropertySignature
  ...
  @JSName("type")
  var type_TSPropertySignature: typingsJapgolly.babelTypes.babelTypesStrings.TSPropertySignature
}
object TSPropertySignature {
  ...
  extension [Self <: TSPropertySignature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSPropertySignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
