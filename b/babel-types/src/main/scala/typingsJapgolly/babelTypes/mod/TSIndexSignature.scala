...
trait TSIndexSignature
  ...
  @JSName("type")
  var type_TSIndexSignature: typingsJapgolly.babelTypes.babelTypesStrings.TSIndexSignature
}
object TSIndexSignature {
  ...
  extension [Self <: TSIndexSignature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSIndexSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
