...
trait TSModuleDeclaration
  ...
  @JSName("type")
  var type_TSModuleDeclaration: typingsJapgolly.babelTypes.babelTypesStrings.TSModuleDeclaration
}
object TSModuleDeclaration {
  ...
  extension [Self <: TSModuleDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSModuleDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
