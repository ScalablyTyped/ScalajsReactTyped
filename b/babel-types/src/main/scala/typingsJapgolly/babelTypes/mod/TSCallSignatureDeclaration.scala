...
trait TSCallSignatureDeclaration
  ...
  @JSName("type")
  var type_TSCallSignatureDeclaration: typingsJapgolly.babelTypes.babelTypesStrings.TSCallSignatureDeclaration
}
object TSCallSignatureDeclaration {
  ...
  extension [Self <: TSCallSignatureDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSCallSignatureDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
