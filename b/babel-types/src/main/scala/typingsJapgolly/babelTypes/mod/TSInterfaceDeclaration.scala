...
trait TSInterfaceDeclaration
  ...
  @JSName("type")
  var type_TSInterfaceDeclaration: typingsJapgolly.babelTypes.babelTypesStrings.TSInterfaceDeclaration
}
object TSInterfaceDeclaration {
  ...
  extension [Self <: TSInterfaceDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSInterfaceDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
