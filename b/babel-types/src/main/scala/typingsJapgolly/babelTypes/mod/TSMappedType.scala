...
trait TSMappedType
  ...
  @JSName("type")
  var type_TSMappedType: typingsJapgolly.babelTypes.babelTypesStrings.TSMappedType
}
object TSMappedType {
  ...
  extension [Self <: TSMappedType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSMappedType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
