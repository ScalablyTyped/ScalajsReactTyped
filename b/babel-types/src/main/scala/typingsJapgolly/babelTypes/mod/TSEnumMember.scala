...
trait TSEnumMember
  ...
  @JSName("type")
  var type_TSEnumMember: typingsJapgolly.babelTypes.babelTypesStrings.TSEnumMember
}
object TSEnumMember {
  ...
  extension [Self <: TSEnumMember](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.babelTypes.babelTypesStrings.TSEnumMember): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
