...
import typingsJapgolly.backbone.mod.ObjectHash
import typingsJapgolly.backbone.mod.RouterOptions
...
object anon {
  ...
  trait Typeofbackbone extends StObject {
    ...
    var Collection: (Instantiable2[
        ...
        typingsJapgolly.backbone.mod.Collection[Model[Any, ModelSetOptions, Any]]
    ...
    var Model: (Instantiable2[
        ...
        /* options */ js.UndefOr[
          CombinedModelConstructorOptions[
            ...
            typingsJapgolly.backbone.mod.Model[Any, ModelSetOptions, Any]
          ]
        ], 
        typingsJapgolly.backbone.mod.Model[ObjectHash, js.Object, js.Object]
      ]) & TypeofModel = js.native
    
    var ModelBase: Instantiable0[typingsJapgolly.backbone.mod.ModelBase] = js.native
    
    var Router: (Instantiable1[/* options */ js.UndefOr[RouterOptions], typingsJapgolly.backbone.mod.Router]) & TypeofRouter = js.native
    ...
    var View: (Instantiable1[
        ...
        typingsJapgolly.backbone.mod.View[js.UndefOr[Model[Any, ModelSetOptions, Any]], Element]
