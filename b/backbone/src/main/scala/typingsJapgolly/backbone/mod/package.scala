...
import typingsJapgolly.backbone.anon.Typeofbackbone
import typingsJapgolly.backbone.mod.^
...
inline def Events: typingsJapgolly.backbone.mod.Events = ^.asInstanceOf[js.Dynamic].selectDynamic("Events").asInstanceOf[typingsJapgolly.backbone.mod.Events]
