...
package object mod {
  ...
  type EventMap = org.scalablytyped.runtime.StringDictionary[typingsJapgolly.backbone.mod.EventHandler]
  /**
  ...
  type EventsHash = org.scalablytyped.runtime.StringDictionary[
    java.lang.String | (js.Function1[
      /* eventObject */ typingsJapgolly.jquery.JQuery_.TriggeredEvent[js.Any, js.Any, js.Any, js.Any], 
      scala.Unit
    ])
  ]
  type EventsOff[BaseT] = js.ThisFunction3[
    ...
    /* callback */ js.UndefOr[typingsJapgolly.backbone.mod.EventHandler], 
