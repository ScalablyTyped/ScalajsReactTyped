...
object global {
  ...
  object Backbone {
    ...
    @js.native
    open class Collection[TModel /* <: typingsJapgolly.backbone.mod.Model[Any, ModelSetOptions, Any] */] () extends StObject {
    ...
    open class Model[T /* <: ObjectHash */, S, E] () extends StObject {
      ...
      def this(
        attributes: T,
        options: CombinedModelConstructorOptions[E, typingsJapgolly.backbone.mod.Model[Any, ModelSetOptions, Any]]
      ) = this()
      def this(
        attributes: Unit,
        options: CombinedModelConstructorOptions[E, typingsJapgolly.backbone.mod.Model[Any, ModelSetOptions, Any]]
    ...
    @js.native
    open class View[TModel /* <: js.UndefOr[typingsJapgolly.backbone.mod.Model[Any, ModelSetOptions, Any]] */, TElement /* <: Element */] () extends StObject {
    ...
    @JSGlobal("Backbone.history")
    @js.native
    val history: typingsJapgolly.backbone.mod.History_ = js.native
    ...
    inline def sync(
      method: String,
      model: typingsJapgolly.backbone.mod.Collection[typingsJapgolly.backbone.mod.Model[Any, ModelSetOptions, Any]]
    ...
    // SYNC
    inline def sync(method: String, model: typingsJapgolly.backbone.mod.Model[Any, ModelSetOptions, Any]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("sync")(method.asInstanceOf[js.Any], model.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def sync(
      method: String,
      model: typingsJapgolly.backbone.mod.Model[Any, ModelSetOptions, Any],
      options: JQueryAjaxSettings
    ): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("sync")(method.asInstanceOf[js.Any], model.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  }
}
