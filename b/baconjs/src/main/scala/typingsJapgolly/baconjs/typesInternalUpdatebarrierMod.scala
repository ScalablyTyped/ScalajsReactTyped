...
import typingsJapgolly.baconjs.anon.FnCallObsSubscribeSink
...
object typesInternalUpdatebarrierMod {
  ...
  object Observable {
    ...
    inline def apply(id: Double, internalDeps: CallbackTo[js.Array[Observable]]): Observable = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], internalDeps = internalDeps.toJsFn)
    ...
    extension [Self <: Observable](x: Self) {
      ...
      inline def setInternalDeps(value: CallbackTo[js.Array[Observable]]): Self = StObject.set(x, "internalDeps", value.toJsFn)
    }
  }
