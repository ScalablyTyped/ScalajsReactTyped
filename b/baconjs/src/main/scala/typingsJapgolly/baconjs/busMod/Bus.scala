...
trait Bus[V] extends EventStream[V] {
  ...
  /** @hidden */
  def guardedSink(input: typingsJapgolly.baconjs.observableMod.default[V]): EventSink[V] = js.native
  /**
    ...
    */
  def plug[V2 /* <: V */](input: typingsJapgolly.baconjs.observableMod.default[V2]): js.UndefOr[js.Function0[Unit]] = js.native
  /**
  ...
  /** @hidden */
  def unsubscribeInput(input: typingsJapgolly.baconjs.observableMod.default[_]): Unit = js.native
}
