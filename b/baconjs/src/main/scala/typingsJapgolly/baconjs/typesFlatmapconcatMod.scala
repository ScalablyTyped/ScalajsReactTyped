...
object typesFlatmapconcatMod {
  
  @JSImport("baconjs/types/flatmapconcat", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default[V, V2](src: typingsJapgolly.baconjs.typesObservableMod.default[V], f: SpawnerOrObservable[V, V2]): typingsJapgolly.baconjs.typesObservableMod.default[V2] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(src.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.baconjs.typesObservableMod.default[V2]]
}
