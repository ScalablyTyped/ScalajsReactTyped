...
object typesFlatmapMod_ {
  ...
  inline def default[In, Out](spawner: EventSpawner[In, Out], src: typingsJapgolly.baconjs.typesObservableMod.default[In]): typingsJapgolly.baconjs.typesObservableMod.default[Out] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(spawner.asInstanceOf[js.Any], src.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.baconjs.typesObservableMod.default[Out]]
  ...
  ): typingsJapgolly.baconjs.typesObservableMod.default[Out] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(spawner.asInstanceOf[js.Any], src.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.baconjs.typesObservableMod.default[Out]]
