...
object _empty extends js.Object {
  def asEventStream(eventName: String, selector: js.UndefOr[scala.Nothing], eventTransformer: js.Any): typingsJapgolly.baconjs.observableMod.EventStream[_] = js.native
  /**
    ...
    */
  def asEventStream(eventName: String, selector: String, eventTransformer: js.Any): typingsJapgolly.baconjs.observableMod.EventStream[_] = js.native
  /**
