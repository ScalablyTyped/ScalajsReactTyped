...
import typingsJapgolly.baconjs.typesEventMod.End
...
object typesBufferMod {
  ...
  object Buffer_ {
    ...
    inline def apply[V](
      ...
      val __obj = js.Dynamic.literal(flush = flush.toJsFn, onFlush = js.Any.fromFunction1(onFlush), onInput = js.Any.fromFunction1(onInput), push = js.Any.fromFunction1(push), schedule = js.Any.fromFunction1(schedule), values = values.asInstanceOf[js.Any], scheduled = null)
    ...
    extension [Self <: Buffer_[?], V](x: Self & Buffer_[V]) {
      ...
      inline def setFlush(value: CallbackTo[Any]): Self = StObject.set(x, "flush", value.toJsFn)
