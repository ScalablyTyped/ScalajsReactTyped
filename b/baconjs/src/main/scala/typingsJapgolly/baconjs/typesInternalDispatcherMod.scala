...
object typesInternalDispatcherMod {
  ...
  object Dispatcher {
    ...
    inline def apply[V, O](
      ...
      hasSubscribers: CallbackTo[Boolean],
      inspect: CallbackTo[Any],
      observable: O,
      prevError: Any,
      push: Event[V] => Any,
    ...
    extension [Self <: Dispatcher[?, ?], V, O](x: Self & (Dispatcher[V, O])) {
      ...
      inline def setHasSubscribers(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasSubscribers", value.toJsFn)
      
      inline def setInspect(value: CallbackTo[Any]): Self = StObject.set(x, "inspect", value.toJsFn)
      ...
      inline def setUnsubSrc(value: Callback): Self = StObject.set(x, "unsubSrc", value.toJsFn)
      
      inline def setUnsubSrcUndefined: Self = StObject.set(x, "unsubSrc", js.undefined)
      
      inline def setUnsubscribeFromSource(value: Callback): Self = StObject.set(x, "unsubscribeFromSource", value.toJsFn)
