...
object UploadPartOpts {
  ...
  extension [Self <: UploadPartOpts](x: Self) {
    ...
    inline def setOnUploadProgress(value: /* event */ Any => Callback): Self = StObject.set(x, "onUploadProgress", js.Any.fromFunction1((t0: /* event */ Any) => value(t0).runNow()))
