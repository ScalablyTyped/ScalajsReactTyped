...
object combineMod {
  ...
  inline def default[T /* <: typingsJapgolly.node.streamMod.^ */](streams: js.Array[T | typingsJapgolly.node.streamMod.^]): FirstOrDuplex[
    T, 
  ...
  inline def default[T /* <: typingsJapgolly.node.streamMod.^ */](streams: js.Array[T | typingsJapgolly.node.streamMod.^], options: DuplexOptions): FirstOrDuplex[
    T, 
    /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof streams */ Any
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait FirstOrDuplex[First, T /* <: js.Array[typingsJapgolly.node.streamMod.^] */] extends StObject
}
