package typingsJapgolly.browserfs.dropboxMod
...
import typingsJapgolly.dropboxjs.Dropbox.ApiError
...
trait DropboxFileSystem
  ...
  /**
    ...
    */
  def convert(err: ApiError): typingsJapgolly.browserfs.apiErrorMod.ApiError = js.native
  def convert(err: ApiError, path: String): typingsJapgolly.browserfs.apiErrorMod.ApiError = js.native
  /* InferMemberOverrides */
