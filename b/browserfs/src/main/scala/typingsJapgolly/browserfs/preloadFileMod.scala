...
import typingsJapgolly.browserfs.fileMod.BaseFile
...
import typingsJapgolly.browserfs.fileSystemMod.BFSThreeArgCallback
...
object preloadFileMod extends js.Object {
  ...
  class NoSyncFile[T /* <: FileSystem */] protected ()
    extends PreloadFile[T]
       with File {
    def this(_fs: T, _path: String, _flag: FileFlag, _stat: typingsJapgolly.browserfs.nodeFsStatsMod.default) = this()
    def this(
      _fs: T,
      _path: String,
      _flag: FileFlag,
      _stat: typingsJapgolly.browserfs.nodeFsStatsMod.default,
      contents: Buffer
    ) = this()
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def stat(cb: BFSCallback[typingsJapgolly.browserfs.nodeFsStatsMod.default]): Unit = js.native
    /**
      * Synchronous `stat`.
      */
    /* InferMemberOverrides */
    override def statSync(): typingsJapgolly.browserfs.nodeFsStatsMod.default = js.native
    /* InferMemberOverrides */
  ...
  trait PreloadFile[T /* <: FileSystem */] extends BaseFile {
    ...
    /**
      ...
      */
    def getStats(): typingsJapgolly.browserfs.nodeFsStatsMod.default = js.native
    ...
    /**
      ...
      * @param [Function(BrowserFS.ApiError, BrowserFS.node.fs.Stats)] cb
      */
    def stat(cb: BFSCallback[typingsJapgolly.browserfs.nodeFsStatsMod.default]): Unit = js.native
    /**
      * Synchronous `stat`.
      */
    def statSync(): typingsJapgolly.browserfs.nodeFsStatsMod.default = js.native
    /**
      * Asynchronous truncate.
      * @param [Number] len
      * @param [Function(BrowserFS.ApiError)] cb
