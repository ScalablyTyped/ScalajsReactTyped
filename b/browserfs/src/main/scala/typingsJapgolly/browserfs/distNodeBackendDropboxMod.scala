...
object distNodeBackendDropboxMod {
  ...
  open class DropboxFile protected ()
    extends typingsJapgolly.browserfs.distNodeGenericPreloadFileMod.default[DropboxFileSystem]
       with File {
    def this(
      _fs: DropboxFileSystem,
      _path: String,
      _flag: FileFlag,
      _stat: typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default
    ) = this()
    def this(
      _fs: DropboxFileSystem,
      _path: String,
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def stat(cb: BFSCallback[typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default]): Unit = js.native
    
    /**
      * Synchronous `stat`.
      */
    /* InferMemberOverrides */
    override def statSync(): typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
  ...
  trait DropboxFileSystem
    ...
    /**
      ...
      */
    def convert(err: ApiError): typingsJapgolly.browserfs.distNodeCoreApiErrorMod.ApiError = js.native
    def convert(err: ApiError, path: String): typingsJapgolly.browserfs.distNodeCoreApiErrorMod.ApiError = js.native
