...
import typingsJapgolly.browserfs.anon.Opts
import typingsJapgolly.browserfs.anon.`0`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distNodeGenericEmscriptenFsMod {
  ...
  open class default ()
    ...
    def this(
      ...
      _PATH: Any,
      _ERRNO_CODES: Any,
      nodefs: typingsJapgolly.browserfs.distNodeCoreFSMod.default
    ) = this()
    def this(
      _FS: Any,
      _PATH: Any,
  ...
  trait BFSEmscriptenFS
    ...
    def getNodeFS(): typingsJapgolly.browserfs.distNodeCoreFSMod.default = js.native
  ...
  object EmscriptenNodeOps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getattr = js.Any.fromFunction1(getattr), lookup = js.Any.fromFunction2(lookup), mknod = js.Any.fromFunction4(mknod), readdir = js.Any.fromFunction1(readdir), readlink = js.Any.fromFunction1(readlink), rename = js.Any.fromFunction3((t0: EmscriptenFSNode, t1: EmscriptenFSNode, t2: String) => (rename(t0, t1, t2)).runNow()), rmdir = js.Any.fromFunction2((t0: EmscriptenFSNode, t1: String) => (rmdir(t0, t1)).runNow()), setattr = js.Any.fromFunction2((t0: EmscriptenFSNode, t1: Stats) => (setattr(t0, t1)).runNow()), symlink = js.Any.fromFunction3((t0: EmscriptenFSNode, t1: String, t2: String) => (symlink(t0, t1, t2)).runNow()), unlink = js.Any.fromFunction2((t0: EmscriptenFSNode, t1: String) => (unlink(t0, t1)).runNow()))
    ...
    extension [Self <: EmscriptenNodeOps](x: Self) {
      ...
      inline def setRename(value: (EmscriptenFSNode, EmscriptenFSNode, String) => Callback): Self = StObject.set(x, "rename", js.Any.fromFunction3((t0: EmscriptenFSNode, t1: EmscriptenFSNode, t2: String) => (value(t0, t1, t2)).runNow()))
      
      inline def setRmdir(value: (EmscriptenFSNode, String) => Callback): Self = StObject.set(x, "rmdir", js.Any.fromFunction2((t0: EmscriptenFSNode, t1: String) => (value(t0, t1)).runNow()))
      
      inline def setSetattr(value: (EmscriptenFSNode, Stats) => Callback): Self = StObject.set(x, "setattr", js.Any.fromFunction2((t0: EmscriptenFSNode, t1: Stats) => (value(t0, t1)).runNow()))
      
      inline def setSymlink(value: (EmscriptenFSNode, String, String) => Callback): Self = StObject.set(x, "symlink", js.Any.fromFunction3((t0: EmscriptenFSNode, t1: String, t2: String) => (value(t0, t1, t2)).runNow()))
      
      inline def setUnlink(value: (EmscriptenFSNode, String) => Callback): Self = StObject.set(x, "unlink", js.Any.fromFunction2((t0: EmscriptenFSNode, t1: String) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object EmscriptenStreamOps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(close = js.Any.fromFunction1((t0: EmscriptenStream) => close(t0).runNow()), llseek = js.Any.fromFunction3(llseek), open = js.Any.fromFunction1((t0: EmscriptenStream) => open(t0).runNow()), read = js.Any.fromFunction5(read), write = js.Any.fromFunction5(write))
      __obj.asInstanceOf[EmscriptenStreamOps]
    }
    
    extension [Self <: EmscriptenStreamOps](x: Self) {
      
      inline def setClose(value: EmscriptenStream => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: EmscriptenStream) => value(t0).runNow()))
      
      inline def setLlseek(value: (EmscriptenStream, Double, Double) => Double): Self = StObject.set(x, "llseek", js.Any.fromFunction3(value))
      
      inline def setOpen(value: EmscriptenStream => Callback): Self = StObject.set(x, "open", js.Any.fromFunction1((t0: EmscriptenStream) => value(t0).runNow()))
