...
import typingsJapgolly.browserfs.distNodeBackendXmlHttpRequestMod.XmlHttpRequest
import typingsJapgolly.browserfs.distNodeBackendXmlHttpRequestMod.XmlHttpRequestOptions
import typingsJapgolly.browserfs.distNodeBackendXmlHttpRequestMod.default
