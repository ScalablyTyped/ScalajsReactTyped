...
import typingsJapgolly.browserfs.distNodeBackendZipFSMod.CompressionMethod
import typingsJapgolly.browserfs.distNodeBackendZipFSMod.ZipFS
import typingsJapgolly.browserfs.distNodeBackendZipFSMod.ZipFSOptions
import typingsJapgolly.browserfs.distNodeBackendZipFSMod.ZipTOC
import typingsJapgolly.browserfs.distNodeBackendZipFSMod.default
