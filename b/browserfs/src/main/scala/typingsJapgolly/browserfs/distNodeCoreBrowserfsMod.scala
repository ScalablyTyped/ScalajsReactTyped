...
import typingsJapgolly.browserfs.distNodeGenericEmscriptenFsMod.default
...
object distNodeCoreBrowserfsMod {
  ...
  object Errors {
    ...
    open class ApiError protected ()
      extends typingsJapgolly.browserfs.distNodeCoreApiErrorMod.ApiError {
      /**
