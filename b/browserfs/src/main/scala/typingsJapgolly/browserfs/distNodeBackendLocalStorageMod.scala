...
import typingsJapgolly.browserfs.distNodeGenericKeyValueFilesystemMod.SimpleSyncStore
import typingsJapgolly.browserfs.distNodeGenericKeyValueFilesystemMod.SyncKeyValueFileSystem
import typingsJapgolly.browserfs.distNodeGenericKeyValueFilesystemMod.SyncKeyValueStore
