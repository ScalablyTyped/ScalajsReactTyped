...
object distNodeBackendHtml5fsMod {
  ...
  open class HTML5FSFile protected ()
    extends typingsJapgolly.browserfs.distNodeGenericPreloadFileMod.default[HTML5FS]
       with File {
    def this(
      fs: HTML5FS,
      entry: FileEntry,
      path: String,
      flag: FileFlag,
      stat: typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default
    ) = this()
    def this(
      fs: HTML5FS,
      entry: FileEntry,
  ...
  trait HTML5FS
    ...
    var fs: typingsJapgolly.std.FileSystem = js.native
