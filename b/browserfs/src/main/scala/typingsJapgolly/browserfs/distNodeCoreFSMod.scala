...
import typingsJapgolly.browserfs.anon.AutoClose
import typingsJapgolly.browserfs.anon.Encoding
import typingsJapgolly.browserfs.anon.EncodingFlag
import typingsJapgolly.browserfs.anon.Fd
import typingsJapgolly.browserfs.anon.Flag
import typingsJapgolly.browserfs.anon.Interval
import typingsJapgolly.browserfs.anon.Mode
import typingsJapgolly.browserfs.anon.Persistent
import typingsJapgolly.browserfs.anon.TypeofFS
import typingsJapgolly.browserfs.anon.TypeofStats
...
import typingsJapgolly.browserfs.distNodeCoreFileSystemMod.BFSThreeArgCallback
...
object distNodeCoreFSMod {
  ...
  trait FS extends StObject {
    ...
    def fstat(fd: Double, cb: BFSCallback[typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default]): Unit = js.native
    ...
    /**
      ...
      */
    def fstatSync(fd: Double): typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
    ...
    def lstat(path: String, cb: BFSCallback[typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default]): Unit = js.native
    ...
    /**
      ...
      * @return [BrowserFS.node.fs.Stats]
      */
    def lstatSync(path: String): typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
    ...
    def stat(path: String, cb: BFSCallback[typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default]): Unit = js.native
    ...
    /**
      ...
      * @return [BrowserFS.node.fs.Stats]
      */
    def statSync(path: String): typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
    ...
    def unwatchFile(
      ...
      listener: js.Function2[
          /* curr */ typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default, 
          /* prev */ typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default, 
          Unit
        ]
    ): Unit = js.native
