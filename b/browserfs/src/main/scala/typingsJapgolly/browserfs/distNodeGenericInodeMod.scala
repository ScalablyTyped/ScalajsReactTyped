...
object distNodeGenericInodeMod {
  ...
  trait Inode extends StObject {
    ...
    /**
      ...
      */
    def toStats(): typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
    ...
    /**
      ...
      */
    def update(stats: typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default): Boolean = js.native
  }
}
