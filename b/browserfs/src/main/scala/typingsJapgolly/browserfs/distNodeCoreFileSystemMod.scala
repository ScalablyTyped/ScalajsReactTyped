...
object distNodeCoreFileSystemMod {
  ...
  object FileSystemConstructor {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(Create = js.Any.fromFunction2((t0: js.Object, t1: BFSCallback[FileSystem]) => (Create(t0, t1)).runNow()), Name = Name.asInstanceOf[js.Any], Options = Options.asInstanceOf[js.Any], isAvailable = isAvailable.toJsFn)
      __obj.asInstanceOf[FileSystemConstructor]
    }
    
    extension [Self <: FileSystemConstructor](x: Self) {
      
      inline def setCreate(value: (js.Object, BFSCallback[FileSystem]) => Callback): Self = StObject.set(x, "Create", js.Any.fromFunction2((t0: js.Object, t1: BFSCallback[FileSystem]) => (value(t0, t1)).runNow()))
      
      inline def setIsAvailable(value: CallbackTo[Boolean]): Self = StObject.set(x, "isAvailable", value.toJsFn)
  ...
  object FileSystemOption {
    ...
    extension [Self <: FileSystemOption[?], T](x: Self & FileSystemOption[T]) {
      ...
      inline def setValidator(value: (/* opt */ T, /* cb */ BFSOneArgCallback) => Callback): Self = StObject.set(x, "validator", js.Any.fromFunction2((t0: /* opt */ T, t1: /* cb */ BFSOneArgCallback) => (value(t0, t1)).runNow()))
