...
object inodeMod extends js.Object {
  ...
  trait Inode extends js.Object {
    ...
    /**
      ...
      */
    def toStats(): typingsJapgolly.browserfs.nodeFsStatsMod.default = js.native
    /**
      ...
      */
    def update(stats: typingsJapgolly.browserfs.nodeFsStatsMod.default): Boolean = js.native
  }
