...
import typingsJapgolly.browserfs.distNodeGenericPreloadFileMod.default
...
object distNodeGenericKeyValueFilesystemMod {
  ...
  open class AsyncKeyValueFileSystem () extends BaseFileSystem {
    ...
    def _sync(
      p: String,
      data: Buffer,
      stats: typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default,
  ...
  open class SyncKeyValueFileSystem protected () extends SynchronousFileSystem {
    ...
    def _syncSync(p: String, data: Buffer, stats: typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default): Unit = js.native
  ...
  object AsyncKeyValueROTransaction {
    ...
    inline def apply(get: (String, BFSCallback[Buffer]) => Callback): AsyncKeyValueROTransaction = {
      val __obj = js.Dynamic.literal(get = js.Any.fromFunction2((t0: String, t1: BFSCallback[Buffer]) => (get(t0, t1)).runNow()))
      __obj.asInstanceOf[AsyncKeyValueROTransaction]
    }
    
    extension [Self <: AsyncKeyValueROTransaction](x: Self) {
      
      inline def setGet(value: (String, BFSCallback[Buffer]) => Callback): Self = StObject.set(x, "get", js.Any.fromFunction2((t0: String, t1: BFSCallback[Buffer]) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object AsyncKeyValueRWTransaction {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(abort = js.Any.fromFunction1((t0: BFSOneArgCallback) => abort(t0).runNow()), commit = js.Any.fromFunction1((t0: BFSOneArgCallback) => commit(t0).runNow()), del = js.Any.fromFunction2((t0: String, t1: BFSOneArgCallback) => (del(t0, t1)).runNow()), get = js.Any.fromFunction2((t0: String, t1: BFSCallback[Buffer]) => (get(t0, t1)).runNow()), put = js.Any.fromFunction4((t0: String, t1: Buffer, t2: Boolean, t3: js.Function2[/* e */ ApiError, /* committed */ js.UndefOr[Boolean], Unit]) => (put(t0, t1, t2, t3)).runNow()))
      __obj.asInstanceOf[AsyncKeyValueRWTransaction]
    }
    
    extension [Self <: AsyncKeyValueRWTransaction](x: Self) {
      
      inline def setAbort(value: BFSOneArgCallback => Callback): Self = StObject.set(x, "abort", js.Any.fromFunction1((t0: BFSOneArgCallback) => value(t0).runNow()))
      
      inline def setCommit(value: BFSOneArgCallback => Callback): Self = StObject.set(x, "commit", js.Any.fromFunction1((t0: BFSOneArgCallback) => value(t0).runNow()))
      
      inline def setDel(value: (String, BFSOneArgCallback) => Callback): Self = StObject.set(x, "del", js.Any.fromFunction2((t0: String, t1: BFSOneArgCallback) => (value(t0, t1)).runNow()))
      
      inline def setPut(
        value: (String, Buffer, Boolean, js.Function2[/* e */ ApiError, /* committed */ js.UndefOr[Boolean], Unit]) => Callback
      ): Self = StObject.set(x, "put", js.Any.fromFunction4((t0: String, t1: Buffer, t2: Boolean, t3: js.Function2[/* e */ ApiError, /* committed */ js.UndefOr[Boolean], Unit]) => (value(t0, t1, t2, t3)).runNow()))
    }
  }
  ...
  object SimpleSyncStore {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(del = js.Any.fromFunction1((t0: String) => del(t0).runNow()), get = js.Any.fromFunction1(get), put = js.Any.fromFunction3(put))
  ...
  object SyncKeyValueRWTransaction {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(abort = abort.toJsFn, commit = commit.toJsFn, del = js.Any.fromFunction1((t0: String) => del(t0).runNow()), get = js.Any.fromFunction1(get), put = js.Any.fromFunction3(put))
