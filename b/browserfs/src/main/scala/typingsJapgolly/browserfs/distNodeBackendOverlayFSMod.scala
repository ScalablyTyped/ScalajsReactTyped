...
import typingsJapgolly.browserfs.anon.Readable
...
object distNodeBackendOverlayFSMod {
  ...
  open class UnlockedOverlayFS protected ()
    ...
    def _syncAsync(
      file: typingsJapgolly.browserfs.distNodeGenericPreloadFileMod.default[UnlockedOverlayFS],
      cb: BFSOneArgCallback
    ): Unit = js.native
    
    def _syncSync(file: typingsJapgolly.browserfs.distNodeGenericPreloadFileMod.default[UnlockedOverlayFS]): Unit = js.native
  ...
  @js.native
  trait OverlayFS
    extends typingsJapgolly.browserfs.distNodeGenericLockedFsMod.default[UnlockedOverlayFS] {
