...
import typingsJapgolly.browserfs.distNodeCoreFileMod.BaseFile
...
object distNodeGenericPreloadFileMod {
  ...
  trait PreloadFile[T /* <: FileSystem */] extends BaseFile {
    ...
    /**
      ...
      * @param [Function(BrowserFS.ApiError, BrowserFS.node.fs.Stats)] cb
      */
    def stat(cb: BFSCallback[typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default]): Unit = js.native
    
    /**
      * Synchronous `stat`.
      */
    def statSync(): typingsJapgolly.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
