...
object fSMod extends js.Object {
  ...
  trait FS extends js.Object {
    ...
    def fstat(fd: Double, cb: BFSCallback[typingsJapgolly.browserfs.nodeFsStatsMod.default]): Unit = js.native
    /**
      * Synchronous `fstat`.
      * `fstat()` is identical to `stat()`, except that the file to be stat-ed is
      * specified by the file descriptor `fd`.
      ...
      */
    def fstatSync(fd: Double): typingsJapgolly.browserfs.nodeFsStatsMod.default = js.native
    /**
      * Asynchronous fsync.
      * @param fd
      * @param callback
    ...
    def lstat(path: String, cb: BFSCallback[typingsJapgolly.browserfs.nodeFsStatsMod.default]): Unit = js.native
    /**
      * Synchronous `lstat`.
      * `lstat()` is identical to `stat()`, except that if path is a symbolic link,
      * then the link itself is stat-ed, not the file that it refers to.
      ...
      * @return [BrowserFS.node.fs.Stats]
      */
    def lstatSync(path: String): typingsJapgolly.browserfs.nodeFsStatsMod.default = js.native
    /**
      * Asynchronous `mkdir`.
      * @param path
    ...
    def stat(path: String, cb: BFSCallback[typingsJapgolly.browserfs.nodeFsStatsMod.default]): Unit = js.native
    /**
      * Synchronous `stat`.
      * @param path
      * @return [BrowserFS.node.fs.Stats]
      */
    def statSync(path: String): typingsJapgolly.browserfs.nodeFsStatsMod.default = js.native
    /**
    ...
    def unwatchFile(
      ...
      listener: js.Function2[
          /* curr */ typingsJapgolly.browserfs.nodeFsStatsMod.default, 
          /* prev */ typingsJapgolly.browserfs.nodeFsStatsMod.default, 
          Unit
        ]
    ): Unit = js.native
    /**
