...
import typingsJapgolly.browserfs.fileFlagMod.FileFlag
import typingsJapgolly.browserfs.fileMod.File
...
import typingsJapgolly.browserfs.fileSystemMod.BaseFileSystem
...
class UnlockedOverlayFS protected ()
  ...
  def _syncAsync(file: typingsJapgolly.browserfs.preloadFileMod.default[UnlockedOverlayFS], cb: BFSOneArgCallback): Unit = js.native
  def _syncSync(file: typingsJapgolly.browserfs.preloadFileMod.default[UnlockedOverlayFS]): Unit = js.native
  ...
  def mkdir(p: String, mode: Double, cb: BFSCallback[typingsJapgolly.browserfs.nodeFsStatsMod.default]): Unit = js.native
  /* InferMemberOverrides */
  ...
  /* InferMemberOverrides */
  override def stat(p: String, isLstat: Boolean, cb: BFSCallback[typingsJapgolly.browserfs.nodeFsStatsMod.default]): Unit = js.native
  /* InferMemberOverrides */
  override def stat(p: String, isLstat: Null, cb: BFSCallback[typingsJapgolly.browserfs.nodeFsStatsMod.default]): Unit = js.native
  /* InferMemberOverrides */
  override def statSync(p: String): typingsJapgolly.browserfs.nodeFsStatsMod.default = js.native
  /* InferMemberOverrides */
  override def statSync(p: String, isLstat: Boolean): typingsJapgolly.browserfs.nodeFsStatsMod.default = js.native
  /* InferMemberOverrides */
