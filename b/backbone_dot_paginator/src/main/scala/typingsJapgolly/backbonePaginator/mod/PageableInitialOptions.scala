...
object PageableInitialOptions {
  @scala.inline
  def apply(
    comparator: /* repeated */ js.Any => CallbackTo[Double] = null,
    ...
    if (comparator != null) __obj.updateDynamic("comparator")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => comparator(t0).runNow()))
