...
object libEsmMenuItem2Mod {
  ...
  object MenuItem2Props {
    ...
    extension [Self <: MenuItem2Props](x: Self) {
      ...
      inline def setLabelElement(value: VdomNode): Self = StObject.set(x, "labelElement", value.rawNode.asInstanceOf[js.Any])
      
      inline def setLabelElementNull: Self = StObject.set(x, "labelElement", null)
      
      inline def setLabelElementUndefined: Self = StObject.set(x, "labelElement", js.undefined)
      
      inline def setLabelElementVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "labelElement", js.Array(value*))
      
      inline def setLabelElementVdomElement(value: VdomElement): Self = StObject.set(x, "labelElement", value.rawElement.asInstanceOf[js.Any])
