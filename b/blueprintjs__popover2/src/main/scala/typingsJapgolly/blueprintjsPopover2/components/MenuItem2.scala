...
import typingsJapgolly.blueprintjsPopover2.anon.PartialMenuProps
import typingsJapgolly.blueprintjsPopover2.anon.PartialOmitPopover2PropsHAutoFocus
import typingsJapgolly.blueprintjsPopover2.blueprintjsPopover2Strings.listoption
import typingsJapgolly.blueprintjsPopover2.blueprintjsPopover2Strings.menuitem
...
object MenuItem2 {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsPopover2.mod.MenuItem2] {
    ...
    inline def popoverProps(value: PartialOmitPopover2PropsHAutoFocus): this.type = set("popoverProps", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: MenuItem2.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MenuItem2Props & AnchorHTMLAttributes[HTMLAnchorElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
