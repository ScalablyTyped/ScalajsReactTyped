...
import typingsJapgolly.blueprintjsPopover2.libEsmTooltip2Mod.ITooltip2Props
...
object Tooltip2 {
  ...
  inline def apply[T](content: Element | String): Builder[T] = {
    val __props = js.Dynamic.literal(content = content.asInstanceOf[js.Any])
    new Builder[T](js.Array(this.component, __props.asInstanceOf[ITooltip2Props[T]]))
  }
  ...
  open class Builder[T] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsPopover2.mod.Tooltip2[T]] {
  ...
  def withProps[T](p: ITooltip2Props[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
