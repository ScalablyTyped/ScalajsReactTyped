...
object libEsmResizeSensor2Mod {
  ...
  object ResizeSensor2Props {
    ...
    inline def apply(children: VdomElement, onResize: js.Array[ResizeObserverEntry] => Callback): ResizeSensor2Props = {
      val __obj = js.Dynamic.literal(children = children.rawElement.asInstanceOf[js.Any], onResize = js.Any.fromFunction1((t0: js.Array[ResizeObserverEntry]) => onResize(t0).runNow()))
    ...
    extension [Self <: ResizeSensor2Props](x: Self) {
      ...
      inline def setTargetRefFunction1(value: Any | Null => Callback): Self = StObject.set(x, "targetRef", js.Any.fromFunction1((t0: Any | Null) => value(t0).runNow()))
