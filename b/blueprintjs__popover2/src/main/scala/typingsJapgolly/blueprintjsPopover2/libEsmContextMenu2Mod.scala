...
object libEsmContextMenu2Mod {
  ...
  object ContextMenu2ChildrenProps {
    ...
    inline def apply(
      ...
      onContextMenu: ReactMouseEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback
    ): ContextMenu2ChildrenProps = {
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], contentProps = contentProps.asInstanceOf[js.Any], onContextMenu = js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLElement & org.scalajs.dom.Element]) => onContextMenu(t0).runNow()), ref = null)
    ...
    extension [Self <: ContextMenu2ChildrenProps](x: Self) {
      ...
      inline def setPopover(value: VdomElement): Self = StObject.set(x, "popover", value.rawElement.asInstanceOf[js.Any])
  ...
  trait ContextMenu2ContentProps extends StObject {
    ...
    var mouseEvent: js.UndefOr[ReactMouseEventFrom[HTMLElement]] = js.undefined
  ...
  object ContextMenu2ContentProps {
    ...
    extension [Self <: ContextMenu2ContentProps](x: Self) {
      ...
      inline def setMouseEvent(value: ReactMouseEventFrom[HTMLElement]): Self = StObject.set(x, "mouseEvent", value.asInstanceOf[js.Any])
  ...
  trait ContextMenu2Props extends StObject {
    ...
    /**
      ...
      */
    var children: Node | (js.Function1[/* props */ ContextMenu2ChildrenProps, japgolly.scalajs.react.facade.React.Element])
  ...
  object ContextMenu2Props {
    ...
    extension [Self <: ContextMenu2Props](x: Self) {
      ...
      inline def setChildren(
        value: Node | (js.Function1[/* props */ ContextMenu2ChildrenProps, japgolly.scalajs.react.facade.React.Element])
      ): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenFunction1(value: /* props */ ContextMenu2ChildrenProps => japgolly.scalajs.react.facade.React.Element): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
