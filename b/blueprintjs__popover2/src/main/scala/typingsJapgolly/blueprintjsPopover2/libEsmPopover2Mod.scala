...
import typingsJapgolly.blueprintjsPopover2.anon.Popover2PropsHTMLPropsHTM
...
import typingsJapgolly.blueprintjsPopover2.libEsmPopover2SharedPropsMod.IPopover2SharedProps
...
object libEsmPopover2Mod {
  ...
  open class Popover2[T] protected ()
    ...
    /**
      ...
      * detects a resize).
      */
    def reposition(): js.UndefOr[
        js.Promise[
          (Partial[
            /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify PopperState */ Any
          ]) | Null
        ]
      ] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.blueprintjsPopover2.blueprintjsPopover2Strings.click
    - typingsJapgolly.blueprintjsPopover2.blueprintjsPopover2Strings.`click-target`
    - typingsJapgolly.blueprintjsPopover2.blueprintjsPopover2Strings.hover
    - typingsJapgolly.blueprintjsPopover2.blueprintjsPopover2Strings.`hover-target`
  */
