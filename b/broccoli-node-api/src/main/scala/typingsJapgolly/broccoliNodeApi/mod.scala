...
import typingsJapgolly.broccoliNodeApi.anon.CachePath
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.__broccoliFeatures__
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.__broccoliGetInfo__
  */
  trait Node extends StObject
  object Node {
    
    inline def __broccoliFeatures__ : typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.__broccoliFeatures__ = "__broccoliFeatures__".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.__broccoliFeatures__]
    
    inline def __broccoliGetInfo__ : typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.__broccoliGetInfo__ = "__broccoliGetInfo__".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.__broccoliGetInfo__]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.needsCache
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.setup
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.getCallbackObject
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.volatile
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.trackInputChanges
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.persistentOutput
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.inputNodes
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.watched
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.sourceDirectory
  */
  trait NodeInfo extends StObject
  object NodeInfo {
    
    inline def getCallbackObject: typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.getCallbackObject = "getCallbackObject".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.getCallbackObject]
    
    inline def inputNodes: typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.inputNodes = "inputNodes".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.inputNodes]
    
    inline def needsCache: typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.needsCache = "needsCache".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.needsCache]
    
    inline def persistentOutput: typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.persistentOutput = "persistentOutput".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.persistentOutput]
    
    inline def setup: typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.setup = "setup".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.setup]
    
    inline def sourceDirectory: typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.sourceDirectory = "sourceDirectory".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.sourceDirectory]
    
    inline def trackInputChanges: typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.trackInputChanges = "trackInputChanges".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.trackInputChanges]
    
    inline def volatile: typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.volatile = "volatile".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.volatile]
    
    inline def watched: typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.watched = "watched".asInstanceOf[typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.watched]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.source
    - typingsJapgolly.broccoliNodeApi.broccoliNodeApiStrings.transform
  */
  ...
  object TransformNodeInfo {
    ...
    inline def apply(
      ...
      setup: (FeatureSet, CachePath) => Callback,
      trackInputChanges: Boolean,
      volatile: Boolean
    ): TransformNodeInfo = {
      val __obj = js.Dynamic.literal(getCallbackObject = getCallbackObject.toJsFn, inputNodes = inputNodes.asInstanceOf[js.Any], instantiationStack = instantiationStack.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], needsCache = needsCache.asInstanceOf[js.Any], nodeType = "transform", persistentOutput = persistentOutput.asInstanceOf[js.Any], setup = js.Any.fromFunction2((t0: FeatureSet, t1: CachePath) => (setup(t0, t1)).runNow()), trackInputChanges = trackInputChanges.asInstanceOf[js.Any], volatile = volatile.asInstanceOf[js.Any])
      __obj.asInstanceOf[TransformNodeInfo]
    }
    
    extension [Self <: TransformNodeInfo](x: Self) {
      
      inline def setGetCallbackObject(value: CallbackTo[CallbackObject]): Self = StObject.set(x, "getCallbackObject", value.toJsFn)
      ...
      inline def setSetup(value: (FeatureSet, CachePath) => Callback): Self = StObject.set(x, "setup", js.Any.fromFunction2((t0: FeatureSet, t1: CachePath) => (value(t0, t1)).runNow()))
