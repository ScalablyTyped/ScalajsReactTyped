...
object srcTypesMod {
  ...
  inline def isPoint(p: typingsJapgolly.node.bufferMod.global.Buffer): scala.Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPoint")(p.asInstanceOf[js.Any]).asInstanceOf[scala.Boolean]
