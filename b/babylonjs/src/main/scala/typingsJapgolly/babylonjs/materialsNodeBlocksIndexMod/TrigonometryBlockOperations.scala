...
@JSImport("babylonjs/Materials/Node/Blocks/index", "TrigonometryBlockOperations")
@js.native
object TrigonometryBlockOperations extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[
    typingsJapgolly.babylonjs.materialsNodeBlocksTrigonometryBlockMod.TrigonometryBlockOperations & Double
  ] = js.native
