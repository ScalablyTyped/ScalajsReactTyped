...
object lightsShadowsIndexMod {
  ...
  open class CascadedShadowGenerator protected ()
    extends typingsJapgolly.babylonjs.lightsShadowsCascadedShadowGeneratorMod.CascadedShadowGenerator {
    /**
  ...
  open class ShadowGenerator protected ()
    extends typingsJapgolly.babylonjs.lightsShadowsShadowGeneratorMod.ShadowGenerator {
    /**
  ...
  open class ShadowGeneratorSceneComponent protected ()
    extends typingsJapgolly.babylonjs.lightsShadowsShadowGeneratorSceneComponentMod.ShadowGeneratorSceneComponent {
    /**
