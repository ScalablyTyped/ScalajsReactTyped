...
import typingsJapgolly.babylonjs.materialsTexturesEquiRectangularCubeTextureMod.EquiRectangularCubeTexture
import typingsJapgolly.babylonjs.materialsTexturesHdrCubeTextureMod.HDRCubeTexture
