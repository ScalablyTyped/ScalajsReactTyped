...
import typingsJapgolly.babylonjs.materialsNodeBlocksInputInputBlockMod.InputBlock
...
object materialsNodeNodeMaterialBlockConnectionPointMod {
  ...
  object NodeMaterialConnectionPointCompatibilityStates extends StObject {
    ...
    /* 0 */ val Compatible: typingsJapgolly.babylonjs.materialsNodeNodeMaterialBlockConnectionPointMod.NodeMaterialConnectionPointCompatibilityStates.Compatible & Double = js.native
    ...
    sealed trait HierarchyIssue
      extends StObject
         with NodeMaterialConnectionPointCompatibilityStates
    /* 3 */ val HierarchyIssue: typingsJapgolly.babylonjs.materialsNodeNodeMaterialBlockConnectionPointMod.NodeMaterialConnectionPointCompatibilityStates.HierarchyIssue & Double = js.native
    ...
    sealed trait TargetIncompatible
      extends StObject
         with NodeMaterialConnectionPointCompatibilityStates
    /* 2 */ val TargetIncompatible: typingsJapgolly.babylonjs.materialsNodeNodeMaterialBlockConnectionPointMod.NodeMaterialConnectionPointCompatibilityStates.TargetIncompatible & Double = js.native
    ...
    sealed trait TypeIncompatible
      extends StObject
         with NodeMaterialConnectionPointCompatibilityStates
    /* 1 */ val TypeIncompatible: typingsJapgolly.babylonjs.materialsNodeNodeMaterialBlockConnectionPointMod.NodeMaterialConnectionPointCompatibilityStates.TypeIncompatible & Double = js.native
  }
  ...
  object NodeMaterialConnectionPointDirection extends StObject {
    ...
    /* 0 */ val Input: typingsJapgolly.babylonjs.materialsNodeNodeMaterialBlockConnectionPointMod.NodeMaterialConnectionPointDirection.Input & Double = js.native
    ...
    sealed trait Output
      extends StObject
         with NodeMaterialConnectionPointDirection
    /* 1 */ val Output: typingsJapgolly.babylonjs.materialsNodeNodeMaterialBlockConnectionPointMod.NodeMaterialConnectionPointDirection.Output & Double = js.native
  }
}
