...
object instrumentationIndexMod {
  ...
  open class EngineInstrumentation protected ()
    extends typingsJapgolly.babylonjs.instrumentationEngineInstrumentationMod.EngineInstrumentation {
    /**
  ...
  open class SceneInstrumentation protected ()
    extends typingsJapgolly.babylonjs.instrumentationSceneInstrumentationMod.SceneInstrumentation {
    /**
  ...
  open class TimeToken ()
    extends typingsJapgolly.babylonjs.instrumentationTimeTokenMod.TimeToken
}
