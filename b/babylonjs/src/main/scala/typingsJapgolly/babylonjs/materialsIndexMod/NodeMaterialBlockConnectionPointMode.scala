...
@JSImport("babylonjs/Materials/index", "NodeMaterialBlockConnectionPointMode")
@js.native
object NodeMaterialBlockConnectionPointMode extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[
    typingsJapgolly.babylonjs.materialsNodeEnumsNodeMaterialBlockConnectionPointModeMod.NodeMaterialBlockConnectionPointMode & Double
  ] = js.native
