...
object renderingPrePassRendererSceneComponentMod {
  ...
  object babylonjsAbstractSceneAugmentingMod {
    ...
    object AbstractScene {
      ...
      inline def apply(disablePrePassRenderer: Callback, enablePrePassRenderer: CallbackTo[Nullable[PrePassRenderer]]): AbstractScene = {
        val __obj = js.Dynamic.literal(disablePrePassRenderer = disablePrePassRenderer.toJsFn, enablePrePassRenderer = enablePrePassRenderer.toJsFn, _prePassRenderer = null, prePassRenderer = null)
      ...
      extension [Self <: AbstractScene](x: Self) {
        ...
        inline def setEnablePrePassRenderer(value: CallbackTo[Nullable[PrePassRenderer]]): Self = StObject.set(x, "enablePrePassRenderer", value.toJsFn)
