...
import typingsJapgolly.babylonjs.deviceInputInternalDeviceSourceManagerMod.DeviceSourceType
import typingsJapgolly.babylonjs.deviceInputInternalDeviceSourceManagerMod.IObservableManager
