...
object lensFlaresLensFlareSystemSceneComponentMod {
  ...
  object babylonjsAbstractSceneAugmentingMod {
    ...
    object AbstractScene {
      ...
      inline def apply(
        addLensFlareSystem: LensFlareSystem => Callback,
