...
open class GeometryBufferRenderer protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.GeometryBufferRenderer {
  /**
  ...
  def this(scene: typingsJapgolly.babylonjs.BABYLON.Scene, ratio: Double) = this()
  def this(scene: typingsJapgolly.babylonjs.BABYLON.Scene, ratio: Double, depthFormat: Double) = this()
  def this(scene: typingsJapgolly.babylonjs.BABYLON.Scene, ratio: Unit, depthFormat: Double) = this()
}
/* static members */
