...
open class Trajectory ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.Trajectory {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def add(point: DeepImmutable[typingsJapgolly.babylonjs.BABYLON.Vector3]): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def resampleAtTargetResolution(targetResolution: Double): typingsJapgolly.babylonjs.BABYLON.Trajectory = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def tokenize(tokens: DeepImmutable[js.Array[typingsJapgolly.babylonjs.BABYLON.Vector3]]): js.Array[Double] = js.native
}
/* static members */
object Trajectory {
  ...
  /**
    ...
    */
  inline def Deserialize(json: String): typingsJapgolly.babylonjs.BABYLON.Trajectory = ^.asInstanceOf[js.Dynamic].applyDynamic("Deserialize")(json.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.Trajectory]
