...
import typingsJapgolly.babylonjs.BABYLON.IWebXRFeature
import typingsJapgolly.babylonjs.BABYLON.WebXRFeatureConstructor
...
open class WebXRFeaturesManager protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.WebXRFeaturesManager {
  /**
...
object WebXRFeaturesManager {
  ...
  /**
    ...
    */
  @JSGlobal("BABYLON.WebXRFeaturesManager._ConflictingFeatures")
  @js.native
