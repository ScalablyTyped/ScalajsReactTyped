...
open class CreationDataStorage ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.CreationDataStorage {
  ...
  /* CompleteClass */
  var path3D: typingsJapgolly.babylonjs.BABYLON.Path3D = js.native
  
  /* CompleteClass */
  var pathArray: js.Array[js.Array[typingsJapgolly.babylonjs.BABYLON.Vector3]] = js.native
