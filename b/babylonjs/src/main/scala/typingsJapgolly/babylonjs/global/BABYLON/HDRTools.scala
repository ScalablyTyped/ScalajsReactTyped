...
import typingsJapgolly.babylonjs.BABYLON.HDRInfo
...
open class HDRTools ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.HDRTools
/* static members */
object HDRTools {
  ...
  @JSGlobal("BABYLON.HDRTools._RGBEReadPixelsRLE")
  @js.native
  ...
  @JSGlobal("BABYLON.HDRTools._ReadStringLine")
  @js.native
  ...
  @JSGlobal("BABYLON.HDRTools._Rgbe2float")
  @js.native
