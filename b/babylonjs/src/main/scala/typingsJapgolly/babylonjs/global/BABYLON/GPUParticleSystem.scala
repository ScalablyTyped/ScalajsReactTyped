...
open class GPUParticleSystem protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.GPUParticleSystem {
  /**
...
object GPUParticleSystem {
  ...
  /**
    ...
    */
  inline def Parse(parsedParticleSystem: Any, sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.Scene, rootUrl: String): typingsJapgolly.babylonjs.BABYLON.GPUParticleSystem = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedParticleSystem.asInstanceOf[js.Any], sceneOrEngine.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.GPUParticleSystem]
  inline def Parse(
    parsedParticleSystem: Any,
    sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.Scene,
    rootUrl: String,
    doNotStart: Boolean
  ): typingsJapgolly.babylonjs.BABYLON.GPUParticleSystem = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedParticleSystem.asInstanceOf[js.Any], sceneOrEngine.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any], doNotStart.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.GPUParticleSystem]
  inline def Parse(
    parsedParticleSystem: Any,
    sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.Scene,
    rootUrl: String,
  ...
  inline def Parse(
    ...
    sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.ThinEngine,
    rootUrl: String
  ): typingsJapgolly.babylonjs.BABYLON.GPUParticleSystem = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedParticleSystem.asInstanceOf[js.Any], sceneOrEngine.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.GPUParticleSystem]
  inline def Parse(
    parsedParticleSystem: Any,
    sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.ThinEngine,
    rootUrl: String,
