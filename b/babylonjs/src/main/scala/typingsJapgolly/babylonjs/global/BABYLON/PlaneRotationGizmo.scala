...
open class PlaneRotationGizmo protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.PlaneRotationGizmo {
  /**
    ...
    */
  def this(
    planeNormal: typingsJapgolly.babylonjs.BABYLON.Vector3,
    color: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.Color3],
    gizmoLayer: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.UtilityLayerRenderer],
    tessellation: js.UndefOr[Double],
    parent: js.UndefOr[Nullable[typingsJapgolly.babylonjs.BABYLON.RotationGizmo]],
