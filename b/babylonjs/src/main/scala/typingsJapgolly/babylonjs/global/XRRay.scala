...
open class XRRay ()
  extends StObject
     with typingsJapgolly.babylonjs.XRRay {
  def this(transformOrOrigin: typingsJapgolly.babylonjs.XRRigidTransform) = this()
  def this(transformOrOrigin: DOMPointInit) = this()
  def this(transformOrOrigin: Unit, direction: DOMPointInit) = this()
  def this(transformOrOrigin: typingsJapgolly.babylonjs.XRRigidTransform, direction: DOMPointInit) = this()
