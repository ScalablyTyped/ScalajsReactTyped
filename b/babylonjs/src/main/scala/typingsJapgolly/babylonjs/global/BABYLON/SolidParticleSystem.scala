...
open class SolidParticleSystem protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.SolidParticleSystem {
  /**
  ...
  def this(name: String, scene: typingsJapgolly.babylonjs.BABYLON.Scene, options: AutoFixFaceOrientation) = this()
