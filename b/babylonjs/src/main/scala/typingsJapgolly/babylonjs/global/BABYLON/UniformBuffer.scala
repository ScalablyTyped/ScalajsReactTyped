...
open class UniformBuffer protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.UniformBuffer {
  /**
  ...
  def this(engine: typingsJapgolly.babylonjs.BABYLON.ThinEngine, data: js.Array[Double]) = this()
  def this(engine: typingsJapgolly.babylonjs.BABYLON.ThinEngine, data: js.Array[Double], dynamic: Boolean) = this()
  def this(engine: typingsJapgolly.babylonjs.BABYLON.ThinEngine, data: Unit, dynamic: Boolean) = this()
  def this(
  ...
  def this(engine: typingsJapgolly.babylonjs.BABYLON.ThinEngine, data: Unit, dynamic: Boolean, name: String) = this()
  def this(engine: typingsJapgolly.babylonjs.BABYLON.ThinEngine, data: Unit, dynamic: Unit, name: String) = this()
  def this(
    engine: typingsJapgolly.babylonjs.BABYLON.ThinEngine,
    data: js.Array[Double],
    dynamic: Boolean,
