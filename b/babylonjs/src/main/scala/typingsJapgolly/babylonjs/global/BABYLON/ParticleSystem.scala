...
open class ParticleSystem protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.ParticleSystem {
  /**
    ...
    */
  def this(name: String, capacity: Double, sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.Scene) = this()
  def this(name: String, capacity: Double, sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.ThinEngine) = this()
  def this(
    name: String,
    capacity: Double,
    sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.Scene,
    customEffect: Nullable[typingsJapgolly.babylonjs.BABYLON.Effect]
  ) = this()
  def this(
    name: String,
    capacity: Double,
...
object ParticleSystem {
  ...
  /**
    ...
    */
  inline def Parse(parsedParticleSystem: Any, sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.Scene, rootUrl: String): typingsJapgolly.babylonjs.BABYLON.ParticleSystem = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedParticleSystem.asInstanceOf[js.Any], sceneOrEngine.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.ParticleSystem]
  inline def Parse(
    parsedParticleSystem: Any,
    sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.Scene,
    rootUrl: String,
    doNotStart: Boolean
  ): typingsJapgolly.babylonjs.BABYLON.ParticleSystem = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedParticleSystem.asInstanceOf[js.Any], sceneOrEngine.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any], doNotStart.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.ParticleSystem]
  inline def Parse(
    parsedParticleSystem: Any,
    sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.Scene,
    rootUrl: String,
  ...
  inline def Parse(
    ...
    sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.ThinEngine,
    rootUrl: String
  ): typingsJapgolly.babylonjs.BABYLON.ParticleSystem = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedParticleSystem.asInstanceOf[js.Any], sceneOrEngine.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.ParticleSystem]
  inline def Parse(
    parsedParticleSystem: Any,
    sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.ThinEngine,
    rootUrl: String,
