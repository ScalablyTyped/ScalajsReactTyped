...
open class AnaglyphPostProcess protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.AnaglyphPostProcess {
  /**
    ...
    */
  def this(name: String, options: Double, rigCameras: js.Array[typingsJapgolly.babylonjs.BABYLON.Camera]) = this()
  def this(
    name: String,
