...
open class CustomParticleEmitter ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.CustomParticleEmitter {
  ...
  override def particleDestinationGenerator(
    index: Double,
    particle: Nullable[typingsJapgolly.babylonjs.BABYLON.Particle],
    outDestination: typingsJapgolly.babylonjs.BABYLON.Vector3
  ): Unit = js.native
  ...
  override def particlePositionGenerator(
    index: Double,
    particle: Nullable[typingsJapgolly.babylonjs.BABYLON.Particle],
    outPosition: typingsJapgolly.babylonjs.BABYLON.Vector3
  ): Unit = js.native
