...
import typingsJapgolly.babylonjs.BABYLON.IShadowLight
...
open class ShadowGenerator protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.ShadowGenerator {
  /**
...
object ShadowGenerator {
  ...
  ): typingsJapgolly.babylonjs.BABYLON.ShadowGenerator = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedShadowGenerator.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], constr.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.ShadowGenerator]
