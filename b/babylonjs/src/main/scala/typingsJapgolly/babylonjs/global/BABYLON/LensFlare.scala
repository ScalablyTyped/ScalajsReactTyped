...
open class LensFlare protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.LensFlare {
  /**
  ...
  position: Double,
    ...
    imgUrl: String,
    system: typingsJapgolly.babylonjs.BABYLON.LensFlareSystem
  ) = this()
  
  /** @internal */
  /* CompleteClass */
  var _drawWrapper: typingsJapgolly.babylonjs.BABYLON.DrawWrapper = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var texture: Nullable[typingsJapgolly.babylonjs.BABYLON.Texture] = js.native
}
/* static members */
object LensFlare {
  ...
  inline def AddFlare(
    ...
    imgUrl: String,
    system: typingsJapgolly.babylonjs.BABYLON.LensFlareSystem
  ): typingsJapgolly.babylonjs.BABYLON.LensFlare = (^.asInstanceOf[js.Dynamic].applyDynamic("AddFlare")(size.asInstanceOf[js.Any], position.asInstanceOf[js.Any], color.asInstanceOf[js.Any], imgUrl.asInstanceOf[js.Any], system.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.LensFlare]
}
