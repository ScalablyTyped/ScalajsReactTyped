...
open class ColorGradingTexture protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.ColorGradingTexture {
  /**
    ...
    */
  def this(url: String, sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.Scene) = this()
  def this(url: String, sceneOrEngine: typingsJapgolly.babylonjs.BABYLON.ThinEngine) = this()
  def this(
    url: String,
...
object ColorGradingTexture {
  ...
  /**
    ...
    */
  inline def Parse(parsedTexture: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene): Nullable[typingsJapgolly.babylonjs.BABYLON.ColorGradingTexture] = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedTexture.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[Nullable[typingsJapgolly.babylonjs.BABYLON.ColorGradingTexture]]
