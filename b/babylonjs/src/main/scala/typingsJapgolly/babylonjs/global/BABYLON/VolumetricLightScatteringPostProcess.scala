...
open class VolumetricLightScatteringPostProcess protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.VolumetricLightScatteringPostProcess {
  /**
    * @constructor
  ...
  def this(
    ...
    mesh: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.Mesh],
...
object VolumetricLightScatteringPostProcess {
  ...
  /**
    ...
    */
  inline def CreateDefaultMesh(name: String, scene: typingsJapgolly.babylonjs.BABYLON.Scene): typingsJapgolly.babylonjs.BABYLON.Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateDefaultMesh")(name.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.Mesh]
}
