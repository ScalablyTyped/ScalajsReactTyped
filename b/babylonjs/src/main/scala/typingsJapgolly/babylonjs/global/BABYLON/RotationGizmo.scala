...
import typingsJapgolly.babylonjs.BABYLON.RotationGizmoOptions
...
open class RotationGizmo protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.RotationGizmo {
  /**
  ...
  def this(
    ...
    gizmoManager: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.GizmoManager],
