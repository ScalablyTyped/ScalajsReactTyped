...
import typingsJapgolly.babylonjs.BABYLON.ISpriteJSONAtlas
import typingsJapgolly.babylonjs.BABYLON.ISpriteMapOptions
...
open class SpriteMap protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.SpriteMap {
  /**
  ...
  def this(
    ...
    spriteSheet: typingsJapgolly.babylonjs.BABYLON.Texture,
  ...
  /**
    ...
    */
  /* CompleteClass */
  var spriteSheet: typingsJapgolly.babylonjs.BABYLON.Texture = js.native
}
