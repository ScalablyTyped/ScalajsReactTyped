...
import typingsJapgolly.babylonjs.BABYLON.BabylonFileParser
import typingsJapgolly.babylonjs.BABYLON.IndividualBabylonFileParser
...
open class AbstractScene ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.AbstractScene
/* static members */
object AbstractScene {
  ...
  inline def Parse(
    ...
    container: typingsJapgolly.babylonjs.BABYLON.AssetContainer,
    rootUrl: String
