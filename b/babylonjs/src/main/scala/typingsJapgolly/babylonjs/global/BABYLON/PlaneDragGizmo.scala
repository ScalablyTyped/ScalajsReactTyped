...
open class PlaneDragGizmo protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.PlaneDragGizmo {
  /**
    ...
    * @param parent
    */
  def this(dragPlaneNormal: typingsJapgolly.babylonjs.BABYLON.Vector3) = this()
  def this(
    dragPlaneNormal: typingsJapgolly.babylonjs.BABYLON.Vector3,
...
object PlaneDragGizmo {
  ...
  ): typingsJapgolly.babylonjs.BABYLON.TransformNode = (^.asInstanceOf[js.Dynamic].applyDynamic("_CreatePlane")(scene.asInstanceOf[js.Any], material.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.TransformNode]
}
