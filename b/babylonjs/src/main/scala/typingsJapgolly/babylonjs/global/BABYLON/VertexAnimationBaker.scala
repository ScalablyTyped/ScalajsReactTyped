...
open class VertexAnimationBaker protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.VertexAnimationBaker {
  /**
    ...
    */
  def this(scene: typingsJapgolly.babylonjs.BABYLON.Scene, mesh: typingsJapgolly.babylonjs.BABYLON.Mesh) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def bakeVertexData(ranges: js.Array[typingsJapgolly.babylonjs.BABYLON.AnimationRange]): js.Promise[js.typedarray.Float32Array] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def textureFromBakedVertexData(vertexData: js.typedarray.Float32Array): typingsJapgolly.babylonjs.BABYLON.RawTexture = js.native
}
