...
open class PrimaryIsoTriangle ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.PrimaryIsoTriangle {
  
  /* CompleteClass */
  var IDATA: typingsJapgolly.babylonjs.BABYLON.PolyhedronData = js.native
  
  /* CompleteClass */
  override def MapToFace(faceNb: Double, geodesicData: typingsJapgolly.babylonjs.BABYLON.PolyhedronData): Unit = js.native
  ...
  /* CompleteClass */
  var cartesian: js.Array[typingsJapgolly.babylonjs.BABYLON.Vector3] = js.native
  ...
  /* CompleteClass */
  var isoVecsABOB: js.Array[js.Array[typingsJapgolly.babylonjs.BABYLON.IsoVector]] = js.native
  
  /* CompleteClass */
  var isoVecsBAOA: js.Array[js.Array[typingsJapgolly.babylonjs.BABYLON.IsoVector]] = js.native
  
  /* CompleteClass */
  var isoVecsOBOA: js.Array[js.Array[typingsJapgolly.babylonjs.BABYLON.IsoVector]] = js.native
  ...
  /* CompleteClass */
  var vertices: js.Array[typingsJapgolly.babylonjs.BABYLON.IsoVector] = js.native
}
