...
import typingsJapgolly.babylonjs.BABYLON.ITexturePackerOptions
...
open class TexturePacker protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.TexturePacker {
  /**
  ...
  def this(
    name: String,
    meshes: js.Array[typingsJapgolly.babylonjs.BABYLON.AbstractMesh],
