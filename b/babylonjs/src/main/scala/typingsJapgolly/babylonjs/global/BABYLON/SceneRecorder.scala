...
open class SceneRecorder ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.SceneRecorder {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def track(scene: typingsJapgolly.babylonjs.BABYLON.Scene): Unit = js.native
}
/* static members */
object SceneRecorder {
  ...
  inline def ApplyDelta(deltaJSON: String, scene: typingsJapgolly.babylonjs.BABYLON.Scene): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("ApplyDelta")(deltaJSON.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[Unit]
  /**
    * Apply a given delta to a given scene
    * @param deltaJSON defines the JSON containing the delta
    * @param scene defines the scene to apply the delta to
    */
  inline def ApplyDelta(deltaJSON: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("ApplyDelta")(deltaJSON.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[Unit]
