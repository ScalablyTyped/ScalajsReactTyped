...
open class TrailMesh protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.TrailMesh {
  /**
    * @constructor
    ...
    */
  def this(name: String, generator: typingsJapgolly.babylonjs.BABYLON.TransformNode) = this()
  def this(
    name: String,
    generator: typingsJapgolly.babylonjs.BABYLON.TransformNode,
...
object TrailMesh {
  ...
  /**
    ...
    */
  inline def Parse(parsedMesh: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene): typingsJapgolly.babylonjs.BABYLON.TrailMesh = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedMesh.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.TrailMesh]
}
