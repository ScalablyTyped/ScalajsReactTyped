...
import typingsJapgolly.babylonjs.BABYLON.IColor4Like
...
import typingsJapgolly.babylonjs.anon.HandlerName
...
open class Tools ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.Tools
/* static members */
object Tools {
  ...
  /**
    ...
    */
  inline def DumpFramebuffer(width: Double, height: Double, engine: typingsJapgolly.babylonjs.BABYLON.Engine): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("DumpFramebuffer")(width.asInstanceOf[js.Any], height.asInstanceOf[js.Any], engine.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  ...
  /**
    ...
    */
  inline def GetPointerPrefix(engine: typingsJapgolly.babylonjs.BABYLON.Engine): String = ^.asInstanceOf[js.Dynamic].applyDynamic("GetPointerPrefix")(engine.asInstanceOf[js.Any]).asInstanceOf[String]
