...
import typingsJapgolly.babylonjs.anon.ClickToPlay
...
@js.native
open class TextureDome[T /* <: typingsJapgolly.babylonjs.BABYLON.Texture */] protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.TextureDome[T] {
  /**
