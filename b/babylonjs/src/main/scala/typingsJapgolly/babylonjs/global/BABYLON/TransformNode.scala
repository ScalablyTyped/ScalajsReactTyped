...
open class TransformNode protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.TransformNode {
  ...
  def this(name: String, scene: Nullable[typingsJapgolly.babylonjs.BABYLON.Scene], isPure: Boolean) = this()
...
object TransformNode {
  ...
  /**
    ...
    * @returns a new TransformNode object parsed from the source provided.
    */
  inline def Parse(parsedTransformNode: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene, rootUrl: String): typingsJapgolly.babylonjs.BABYLON.TransformNode = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedTransformNode.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.TransformNode]
