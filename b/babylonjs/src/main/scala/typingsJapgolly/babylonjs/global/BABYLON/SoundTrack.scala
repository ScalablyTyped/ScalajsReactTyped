...
import typingsJapgolly.babylonjs.BABYLON.ISoundTrackOptions
...
open class SoundTrack ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.SoundTrack {
  def this(scene: Nullable[typingsJapgolly.babylonjs.BABYLON.Scene]) = this()
  def this(scene: Unit, options: ISoundTrackOptions) = this()
  def this(scene: Nullable[typingsJapgolly.babylonjs.BABYLON.Scene], options: ISoundTrackOptions) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addSound(sound: typingsJapgolly.babylonjs.BABYLON.Sound): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def removeSound(sound: typingsJapgolly.babylonjs.BABYLON.Sound): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var soundCollection: js.Array[typingsJapgolly.babylonjs.BABYLON.Sound] = js.native
