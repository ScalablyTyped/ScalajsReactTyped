...
import typingsJapgolly.babylonjs.BABYLON.IBakedVertexAnimationManager
...
open class InternalAbstractMeshDataInfo ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.InternalAbstractMeshDataInfo {
  ...
  /* CompleteClass */
  var _currentLOD: Nullable[typingsJapgolly.babylonjs.BABYLON.AbstractMesh] = js.native
  ...
  /* CompleteClass */
  var _facetData: typingsJapgolly.babylonjs.BABYLON.FacetDataStorage = js.native
  ...
  /* CompleteClass */
  var _material: Nullable[typingsJapgolly.babylonjs.BABYLON.Material] = js.native
  
  /* CompleteClass */
  var _materialForRenderPass: js.Array[js.UndefOr[typingsJapgolly.babylonjs.BABYLON.Material]] = js.native
  
  /* CompleteClass */
  var _meshCollisionData: typingsJapgolly.babylonjs.BABYLON.MeshCollisionData = js.native
  
  /* CompleteClass */
  var _morphTargetManager: Nullable[typingsJapgolly.babylonjs.BABYLON.MorphTargetManager] = js.native
  ...
  /* CompleteClass */
  var _positions: Nullable[js.Array[typingsJapgolly.babylonjs.BABYLON.Vector3]] = js.native
  ...
  /* CompleteClass */
  var _skeleton: Nullable[typingsJapgolly.babylonjs.BABYLON.Skeleton] = js.native
