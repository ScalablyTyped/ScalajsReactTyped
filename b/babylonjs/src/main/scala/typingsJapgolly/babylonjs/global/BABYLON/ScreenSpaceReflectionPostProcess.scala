...
open class ScreenSpaceReflectionPostProcess protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.ScreenSpaceReflectionPostProcess {
  /**
...
object ScreenSpaceReflectionPostProcess {
  ...
  inline def _Parse(
    ...
    scene: typingsJapgolly.babylonjs.BABYLON.Scene,
    rootUrl: String
  ): typingsJapgolly.babylonjs.BABYLON.ScreenSpaceReflectionPostProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("_Parse")(parsedPostProcess.asInstanceOf[js.Any], targetCamera.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.ScreenSpaceReflectionPostProcess]
}
