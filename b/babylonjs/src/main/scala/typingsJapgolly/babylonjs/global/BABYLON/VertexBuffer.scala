...
open class VertexBuffer protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.VertexBuffer {
  /**
    * Constructor
  ...
  def this(
    engine: Any,
    data: DataArray | typingsJapgolly.babylonjs.BABYLON.Buffer | typingsJapgolly.babylonjs.BABYLON.DataBuffer,
    kind: String,
    updatable: Boolean,
