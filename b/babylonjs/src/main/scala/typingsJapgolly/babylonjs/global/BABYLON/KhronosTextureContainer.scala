...
open class KhronosTextureContainer protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.KhronosTextureContainer {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def uploadLevels(texture: typingsJapgolly.babylonjs.BABYLON.InternalTexture, loadMipmaps: Boolean): Unit = js.native
}
/* static members */
