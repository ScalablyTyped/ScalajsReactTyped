...
open class LensRenderingPipeline protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.LensRenderingPipeline {
  /**
    * @constructor
    *
    ...
    */
  def this(name: String, parameters: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene) = this()
  def this(name: String, parameters: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene, ratio: Double) = this()
  def this(
    name: String,
    parameters: Any,
