...
import typingsJapgolly.babylonjs.BABYLON.ILoadingScreen
...
open class Engine protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.Engine {
  /**
...
object Engine {
  ...
  inline def MarkAllMaterialsAsDirty(
    flag: Double,
    predicate: js.Function1[/* mat */ typingsJapgolly.babylonjs.BABYLON.Material, Boolean]
  ...
  def _RescalePostProcessFactory: Nullable[
    js.Function1[/* engine */ this.type, typingsJapgolly.babylonjs.BABYLON.PostProcess]
  ] = js.native
