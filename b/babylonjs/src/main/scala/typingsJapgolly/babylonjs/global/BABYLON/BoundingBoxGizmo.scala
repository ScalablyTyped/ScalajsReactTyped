...
open class BoundingBoxGizmo ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.BoundingBoxGizmo {
  def this(color: typingsJapgolly.babylonjs.BABYLON.Color3) = this()
  def this(color: Unit, gizmoLayer: typingsJapgolly.babylonjs.BABYLON.UtilityLayerRenderer) = this()
  def this(
...
object BoundingBoxGizmo {
  ...
  /**
    ...
    */
  inline def MakeNotPickableAndWrapInBoundingBox(mesh: typingsJapgolly.babylonjs.BABYLON.Mesh): typingsJapgolly.babylonjs.BABYLON.Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("MakeNotPickableAndWrapInBoundingBox")(mesh.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.Mesh]
}
