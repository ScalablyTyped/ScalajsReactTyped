...
import typingsJapgolly.babylonjs.BABYLON.IWebXRNearInteractionOptions
...
open class WebXRNearInteraction protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.WebXRNearInteraction {
  /**
...
object WebXRNearInteraction {
  ...
  inline def PickMeshWithSphere(
    ...
    sphere: typingsJapgolly.babylonjs.BABYLON.BoundingSphere
  ): typingsJapgolly.babylonjs.BABYLON.PickingInfo = (^.asInstanceOf[js.Dynamic].applyDynamic("PickMeshWithSphere")(mesh.asInstanceOf[js.Any], sphere.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.PickingInfo]
  inline def PickMeshWithSphere(
    mesh: typingsJapgolly.babylonjs.BABYLON.AbstractMesh,
    sphere: typingsJapgolly.babylonjs.BABYLON.BoundingSphere,
    skipBoundingInfo: Boolean
  ): typingsJapgolly.babylonjs.BABYLON.PickingInfo = (^.asInstanceOf[js.Dynamic].applyDynamic("PickMeshWithSphere")(mesh.asInstanceOf[js.Any], sphere.asInstanceOf[js.Any], skipBoundingInfo.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.PickingInfo]
