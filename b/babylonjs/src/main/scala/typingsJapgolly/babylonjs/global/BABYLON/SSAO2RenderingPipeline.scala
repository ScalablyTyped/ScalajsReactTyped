...
open class SSAO2RenderingPipeline protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.SSAO2RenderingPipeline {
  /**
    * @constructor
...
object SSAO2RenderingPipeline {
  ...
  /**
    ...
    */
  inline def Parse(source: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene, rootUrl: String): typingsJapgolly.babylonjs.BABYLON.SSAO2RenderingPipeline = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(source.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.SSAO2RenderingPipeline]
}
