...
@JSGlobal("BABYLON.NativeXRLayerRenderTargetTextureProvider")
@js.native
open class NativeXRLayerRenderTargetTextureProvider protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.NativeXRLayerRenderTargetTextureProvider {
  def this(
    sessionManager: typingsJapgolly.babylonjs.BABYLON.WebXRSessionManager,
    layerWrapper: typingsJapgolly.babylonjs.BABYLON.NativeXRLayerWrapper
  ) = this()
