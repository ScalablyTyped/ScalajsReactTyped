...
open class EquiRectangularCubeTexture protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.EquiRectangularCubeTexture {
  /**
    ...
    */
  def this(url: String, scene: typingsJapgolly.babylonjs.BABYLON.Scene, size: Double) = this()
  def this(url: String, scene: typingsJapgolly.babylonjs.BABYLON.Scene, size: Double, noMipmap: Boolean) = this()
  def this(
    url: String,
