...
open class VideoTexture protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.VideoTexture {
  /**
...
object VideoTexture {
  ...
  /**
    ...
    */
  inline def CreateFromStreamAsync(scene: typingsJapgolly.babylonjs.BABYLON.Scene, stream: MediaStream, constraints: Any): js.Promise[typingsJapgolly.babylonjs.BABYLON.VideoTexture] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateFromStreamAsync")(scene.asInstanceOf[js.Any], stream.asInstanceOf[js.Any], constraints.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.BABYLON.VideoTexture]]
  inline def CreateFromStreamAsync(
    scene: typingsJapgolly.babylonjs.BABYLON.Scene,
    stream: MediaStream,
    constraints: Any,
    invertY: Boolean
  ): js.Promise[typingsJapgolly.babylonjs.BABYLON.VideoTexture] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateFromStreamAsync")(scene.asInstanceOf[js.Any], stream.asInstanceOf[js.Any], constraints.asInstanceOf[js.Any], invertY.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.BABYLON.VideoTexture]]
  ...
  /**
    ...
    * @returns The created video texture as a promise
    */
  inline def CreateFromWebCamAsync(scene: typingsJapgolly.babylonjs.BABYLON.Scene, constraints: minWidthnumbermaxWidthnum): js.Promise[typingsJapgolly.babylonjs.BABYLON.VideoTexture] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateFromWebCamAsync")(scene.asInstanceOf[js.Any], constraints.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.BABYLON.VideoTexture]]
  inline def CreateFromWebCamAsync(
    scene: typingsJapgolly.babylonjs.BABYLON.Scene,
    constraints: minWidthnumbermaxWidthnum,
    audioConstaints: MediaTrackConstraints
  ): js.Promise[typingsJapgolly.babylonjs.BABYLON.VideoTexture] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateFromWebCamAsync")(scene.asInstanceOf[js.Any], constraints.asInstanceOf[js.Any], audioConstaints.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.BABYLON.VideoTexture]]
  inline def CreateFromWebCamAsync(
    scene: typingsJapgolly.babylonjs.BABYLON.Scene,
    constraints: minWidthnumbermaxWidthnum,
    audioConstaints: MediaTrackConstraints,
    invertY: Boolean
  ): js.Promise[typingsJapgolly.babylonjs.BABYLON.VideoTexture] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateFromWebCamAsync")(scene.asInstanceOf[js.Any], constraints.asInstanceOf[js.Any], audioConstaints.asInstanceOf[js.Any], invertY.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.BABYLON.VideoTexture]]
  inline def CreateFromWebCamAsync(
    scene: typingsJapgolly.babylonjs.BABYLON.Scene,
    constraints: minWidthnumbermaxWidthnum,
    audioConstaints: Boolean
