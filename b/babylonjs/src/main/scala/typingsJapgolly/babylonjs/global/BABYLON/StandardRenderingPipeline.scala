...
open class StandardRenderingPipeline protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.StandardRenderingPipeline {
  /**
    ...
    */
  def this(name: String, scene: typingsJapgolly.babylonjs.BABYLON.Scene, ratio: Double) = this()
  def this(
    name: String,
    scene: typingsJapgolly.babylonjs.BABYLON.Scene,
    ratio: Double,
    originalPostProcess: Nullable[typingsJapgolly.babylonjs.BABYLON.PostProcess]
  ) = this()
  def this(
    name: String,
    scene: typingsJapgolly.babylonjs.BABYLON.Scene,
...
object StandardRenderingPipeline {
  ...
  /**
    ...
    */
  inline def Parse(source: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene, rootUrl: String): typingsJapgolly.babylonjs.BABYLON.StandardRenderingPipeline = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(source.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.StandardRenderingPipeline]
}
