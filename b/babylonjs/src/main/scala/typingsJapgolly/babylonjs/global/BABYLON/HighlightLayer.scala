...
import typingsJapgolly.babylonjs.anon.PartialIHighlightLayerOptAlphaBlendingMode
...
open class HighlightLayer protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.HighlightLayer {
  /**
...
object HighlightLayer {
  ...
  @js.native
  def NeutralColor: typingsJapgolly.babylonjs.BABYLON.Color4 = js.native
  inline def NeutralColor_=(x: typingsJapgolly.babylonjs.BABYLON.Color4): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NeutralColor")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  inline def Parse(parsedHightlightLayer: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene, rootUrl: String): typingsJapgolly.babylonjs.BABYLON.HighlightLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedHightlightLayer.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.HighlightLayer]
}
