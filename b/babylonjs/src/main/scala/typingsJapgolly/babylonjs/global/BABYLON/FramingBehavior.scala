...
open class FramingBehavior ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.FramingBehavior {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def attach(target: typingsJapgolly.babylonjs.BABYLON.ArcRotateCamera): Unit = js.native
...
object FramingBehavior {
  ...
  @js.native
  def EasingFunction: typingsJapgolly.babylonjs.BABYLON.ExponentialEase = js.native
  inline def EasingFunction_=(x: typingsJapgolly.babylonjs.BABYLON.ExponentialEase): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EasingFunction")(x.asInstanceOf[js.Any])
