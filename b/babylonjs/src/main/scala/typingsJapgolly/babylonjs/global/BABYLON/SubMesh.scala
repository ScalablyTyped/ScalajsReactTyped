...
open class SubMesh protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.SubMesh {
  /**
  ...
  indexCount: Double,
    mesh: typingsJapgolly.babylonjs.BABYLON.AbstractMesh,
    renderingMesh: typingsJapgolly.babylonjs.BABYLON.Mesh
  ) = this()
  def this(
    /** the material index to use */
  materialIndex: Double,
...
object SubMesh {
  ...
  inline def AddToMesh(
    ...
    renderingMesh: Unit,
    createBoundingBox: Boolean
  ): typingsJapgolly.babylonjs.BABYLON.SubMesh = (^.asInstanceOf[js.Dynamic].applyDynamic("AddToMesh")(materialIndex.asInstanceOf[js.Any], verticesStart.asInstanceOf[js.Any], verticesCount.asInstanceOf[js.Any], indexStart.asInstanceOf[js.Any], indexCount.asInstanceOf[js.Any], mesh.asInstanceOf[js.Any], renderingMesh.asInstanceOf[js.Any], createBoundingBox.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.SubMesh]
  inline def AddToMesh(
    materialIndex: Double,
    verticesStart: Double,
    verticesCount: Double,
    ...
    mesh: typingsJapgolly.babylonjs.BABYLON.AbstractMesh,
    renderingMesh: typingsJapgolly.babylonjs.BABYLON.Mesh
  ): typingsJapgolly.babylonjs.BABYLON.SubMesh = (^.asInstanceOf[js.Dynamic].applyDynamic("AddToMesh")(materialIndex.asInstanceOf[js.Any], verticesStart.asInstanceOf[js.Any], verticesCount.asInstanceOf[js.Any], indexStart.asInstanceOf[js.Any], indexCount.asInstanceOf[js.Any], mesh.asInstanceOf[js.Any], renderingMesh.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.SubMesh]
  inline def AddToMesh(
    materialIndex: Double,
    verticesStart: Double,
    verticesCount: Double,
  ...
  inline def CreateFromIndices(
    ...
    indexCount: Double,
    mesh: typingsJapgolly.babylonjs.BABYLON.AbstractMesh
  ): typingsJapgolly.babylonjs.BABYLON.SubMesh = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateFromIndices")(materialIndex.asInstanceOf[js.Any], startIndex.asInstanceOf[js.Any], indexCount.asInstanceOf[js.Any], mesh.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.SubMesh]
  inline def CreateFromIndices(
    materialIndex: Double,
    startIndex: Double,
    indexCount: Double,
