...
open class BoundingBoxRenderer protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.BoundingBoxRenderer {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  var backColor: typingsJapgolly.babylonjs.BABYLON.Color3 = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var frontColor: typingsJapgolly.babylonjs.BABYLON.Color3 = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var onAfterBoxRenderingObservable: typingsJapgolly.babylonjs.BABYLON.Observable[typingsJapgolly.babylonjs.BABYLON.BoundingBox] = js.native
  
  /**
    * Observable raised before rendering a bounding box
    */
  /* CompleteClass */
  var onBeforeBoxRenderingObservable: typingsJapgolly.babylonjs.BABYLON.Observable[typingsJapgolly.babylonjs.BABYLON.BoundingBox] = js.native
  
  /**
    * Observable raised after resources are created
    */
  /* CompleteClass */
  var onResourcesReadyObservable: typingsJapgolly.babylonjs.BABYLON.Observable[typingsJapgolly.babylonjs.BABYLON.BoundingBoxRenderer] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var renderList: typingsJapgolly.babylonjs.BABYLON.SmartArray[typingsJapgolly.babylonjs.BABYLON.BoundingBox] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def renderOcclusionBoundingBox(mesh: typingsJapgolly.babylonjs.BABYLON.AbstractMesh): Unit = js.native
