...
import typingsJapgolly.babylonjs.anon.AdjustRoll
...
open class BoneLookController protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.BoneLookController {
  /**
    ...
    **/
  def this(
    mesh: typingsJapgolly.babylonjs.BABYLON.TransformNode,
