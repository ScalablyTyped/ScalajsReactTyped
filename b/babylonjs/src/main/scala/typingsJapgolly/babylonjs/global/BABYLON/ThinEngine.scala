...
import typingsJapgolly.babylonjs.BABYLON.EngineOptions
import typingsJapgolly.babylonjs.BABYLON.IFileRequest
import typingsJapgolly.babylonjs.BABYLON.IInternalTextureLoader
...
open class ThinEngine protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.ThinEngine {
  /**
