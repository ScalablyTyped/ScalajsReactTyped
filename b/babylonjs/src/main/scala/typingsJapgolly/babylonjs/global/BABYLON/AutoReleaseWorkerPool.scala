...
import typingsJapgolly.babylonjs.BABYLON.AutoReleaseWorkerPoolOptions
import typingsJapgolly.babylonjs.BABYLON.WorkerInfo
...
open class AutoReleaseWorkerPool protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.AutoReleaseWorkerPool {
