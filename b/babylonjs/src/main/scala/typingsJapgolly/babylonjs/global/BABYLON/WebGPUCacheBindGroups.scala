...
open class WebGPUCacheBindGroups protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.WebGPUCacheBindGroups {
  def this(
    device: GPUDevice,
    cacheSampler: typingsJapgolly.babylonjs.BABYLON.WebGPUCacheSampler,
  ...
  override def getBindGroups(
    webgpuPipelineContext: typingsJapgolly.babylonjs.BABYLON.WebGPUPipelineContext,
    drawContext: typingsJapgolly.babylonjs.BABYLON.WebGPUDrawContext,
    materialContext: typingsJapgolly.babylonjs.BABYLON.WebGPUMaterialContext
