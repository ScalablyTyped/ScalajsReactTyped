...
open class BoxParticleEmitter ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.BoxParticleEmitter {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var maxEmitBox: typingsJapgolly.babylonjs.BABYLON.Vector3 = js.native
  
  /**
    * Minimum box point around our emitter. Our emitter is the center of particles source, but if you want your particles to emit from more than one point, then you can tell it to do so.
    */
  /* CompleteClass */
  var minEmitBox: typingsJapgolly.babylonjs.BABYLON.Vector3 = js.native
