...
open class AnaglyphUniversalCamera protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.AnaglyphUniversalCamera {
  /**
    ...
    */
  def this(name: String, position: typingsJapgolly.babylonjs.BABYLON.Vector3, interaxialDistance: Double) = this()
  def this(
    name: String,
