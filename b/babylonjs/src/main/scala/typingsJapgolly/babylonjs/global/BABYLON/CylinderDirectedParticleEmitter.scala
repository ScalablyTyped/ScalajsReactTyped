...
open class CylinderDirectedParticleEmitter ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.CylinderDirectedParticleEmitter {
  ...
  def this(
    ...
    */
  direction1: typingsJapgolly.babylonjs.BABYLON.Vector3
  ) = this()
  def this(
    radius: Double,
    height: Double,
  ...
  direction1: Unit,
    ...
    */
  direction2: typingsJapgolly.babylonjs.BABYLON.Vector3
  ) = this()
  def this(
    radius: Double,
    height: Double,
