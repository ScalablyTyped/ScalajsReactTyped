...
open class Material protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.Material {
  /**
  ...
  def this(name: String, scene: Nullable[typingsJapgolly.babylonjs.BABYLON.Scene], doNotAdd: Boolean) = this()
...
object Material {
  ...
  @js.native
  def OnEventObservable: typingsJapgolly.babylonjs.BABYLON.Observable[typingsJapgolly.babylonjs.BABYLON.Material] = js.native
  inline def OnEventObservable_=(x: typingsJapgolly.babylonjs.BABYLON.Observable[typingsJapgolly.babylonjs.BABYLON.Material]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OnEventObservable")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  inline def Parse(parsedMaterial: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene, rootUrl: String): Nullable[typingsJapgolly.babylonjs.BABYLON.Material] = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedMaterial.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[Nullable[typingsJapgolly.babylonjs.BABYLON.Material]]
