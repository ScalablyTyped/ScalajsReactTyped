...
open class PBRMaterial protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.PBRMaterial {
  /**
...
object PBRMaterial {
  ...
  /**
    ...
    * @returns - PBRMaterial
    */
  inline def Parse(source: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene, rootUrl: String): typingsJapgolly.babylonjs.BABYLON.PBRMaterial = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(source.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.PBRMaterial]
}
