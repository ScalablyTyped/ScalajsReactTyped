...
import typingsJapgolly.babylonjs.BABYLON.ITextureCreationOptions
...
open class Texture protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.Texture {
  /**
...
object Texture {
  ...
  @js.native
  def OnTextureLoadErrorObservable: typingsJapgolly.babylonjs.BABYLON.Observable[typingsJapgolly.babylonjs.BABYLON.BaseTexture] = js.native
  inline def OnTextureLoadErrorObservable_=(x: typingsJapgolly.babylonjs.BABYLON.Observable[typingsJapgolly.babylonjs.BABYLON.BaseTexture]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OnTextureLoadErrorObservable")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  inline def Parse(parsedTexture: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene, rootUrl: String): Nullable[typingsJapgolly.babylonjs.BABYLON.BaseTexture] = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedTexture.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[Nullable[typingsJapgolly.babylonjs.BABYLON.BaseTexture]]
  ...
  ): typingsJapgolly.babylonjs.BABYLON.MirrorTexture = (^.asInstanceOf[js.Dynamic].applyDynamic("_CreateMirror")(name.asInstanceOf[js.Any], renderTargetSize.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], generateMipMaps.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.MirrorTexture]
  ...
  inline def _CreateRenderTargetTexture(
    ...
    scene: typingsJapgolly.babylonjs.BABYLON.Scene,
    generateMipMaps: Boolean
  ): typingsJapgolly.babylonjs.BABYLON.RenderTargetTexture = (^.asInstanceOf[js.Dynamic].applyDynamic("_CreateRenderTargetTexture")(name.asInstanceOf[js.Any], renderTargetSize.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], generateMipMaps.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.RenderTargetTexture]
  inline def _CreateRenderTargetTexture(
    name: String,
    renderTargetSize: Double,
    scene: typingsJapgolly.babylonjs.BABYLON.Scene,
  ...
  ): typingsJapgolly.babylonjs.BABYLON.RenderTargetTexture = (^.asInstanceOf[js.Dynamic].applyDynamic("_CreateRenderTargetTexture")(name.asInstanceOf[js.Any], renderTargetSize.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], generateMipMaps.asInstanceOf[js.Any], creationFlags.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.RenderTargetTexture]
  
  /**
    * @internal
    */
  inline def _CubeTextureParser(jsonTexture: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene, rootUrl: String): typingsJapgolly.babylonjs.BABYLON.CubeTexture = (^.asInstanceOf[js.Dynamic].applyDynamic("_CubeTextureParser")(jsonTexture.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.CubeTexture]
}
