...
open class EquiRectangularCubeTextureAssetTask protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.EquiRectangularCubeTextureAssetTask {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  var texture: typingsJapgolly.babylonjs.BABYLON.EquiRectangularCubeTexture = js.native
}
