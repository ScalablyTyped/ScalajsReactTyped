...
open class Camera protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.Camera {
  /**
...
object Camera {
  ...
  /**
    ...
    */
  inline def GetConstructorFromName(`type`: String, name: String, scene: typingsJapgolly.babylonjs.BABYLON.Scene): js.Function0[this.type] = (^.asInstanceOf[js.Dynamic].applyDynamic("GetConstructorFromName")(`type`.asInstanceOf[js.Any], name.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[js.Function0[this.type]]
  ...
  /**
    ...
    */
  inline def Parse(parsedCamera: Any, scene: typingsJapgolly.babylonjs.BABYLON.Scene): typingsJapgolly.babylonjs.BABYLON.Camera = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedCamera.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.BABYLON.Camera]
