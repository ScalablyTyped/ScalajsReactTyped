...
import typingsJapgolly.babylonjs.BABYLON.IEffectRendererOptions
...
open class EffectRenderer protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.EffectRenderer {
  /**
    * Creates an effect renderer
    * @param _engine the engine to use for rendering
    * @param options defines the options of the effect renderer
    */
  def this(_engine: typingsJapgolly.babylonjs.BABYLON.ThinEngine) = this()
  def this(_engine: typingsJapgolly.babylonjs.BABYLON.ThinEngine, options: IEffectRendererOptions) = this()
}
/* static members */
