...
open class ConvolutionPostProcess protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.ConvolutionPostProcess {
  /**
...
object ConvolutionPostProcess {
  ...
  inline def _Parse(
    ...
    rootUrl: String
  ): Nullable[typingsJapgolly.babylonjs.BABYLON.ConvolutionPostProcess] = (^.asInstanceOf[js.Dynamic].applyDynamic("_Parse")(parsedPostProcess.asInstanceOf[js.Any], targetCamera.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[Nullable[typingsJapgolly.babylonjs.BABYLON.ConvolutionPostProcess]]
}
