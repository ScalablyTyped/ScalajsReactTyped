...
import typingsJapgolly.babylonjs.BABYLON.PhysicsImpostorParameters
...
open class PhysicsImpostor protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.PhysicsImpostor {
  /**
...
object PhysicsImpostor {
  ...
  @js.native
  def DEFAULT_OBJECT_SIZE: typingsJapgolly.babylonjs.BABYLON.Vector3 = js.native
  inline def DEFAULT_OBJECT_SIZE_=(x: typingsJapgolly.babylonjs.BABYLON.Vector3): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DEFAULT_OBJECT_SIZE")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def IDENTITY_QUATERNION: typingsJapgolly.babylonjs.BABYLON.Quaternion = js.native
  inline def IDENTITY_QUATERNION_=(x: typingsJapgolly.babylonjs.BABYLON.Quaternion): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IDENTITY_QUATERNION")(x.asInstanceOf[js.Any])
