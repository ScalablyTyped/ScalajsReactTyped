...
@JSGlobal("BABYLON.ShaderStore")
@js.native
open class ShaderStore ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.ShaderStore
/* static members */
object ShaderStore {
  ...
  inline def GetIncludesShadersStore(shaderLanguage: typingsJapgolly.babylonjs.BABYLON.ShaderLanguage): org.scalablytyped.runtime.StringDictionary[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("GetIncludesShadersStore")(shaderLanguage.asInstanceOf[js.Any]).asInstanceOf[org.scalablytyped.runtime.StringDictionary[String]]
  ...
  inline def GetShadersRepository(shaderLanguage: typingsJapgolly.babylonjs.BABYLON.ShaderLanguage): String = ^.asInstanceOf[js.Dynamic].applyDynamic("GetShadersRepository")(shaderLanguage.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def GetShadersStore(shaderLanguage: typingsJapgolly.babylonjs.BABYLON.ShaderLanguage): org.scalablytyped.runtime.StringDictionary[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("GetShadersStore")(shaderLanguage.asInstanceOf[js.Any]).asInstanceOf[org.scalablytyped.runtime.StringDictionary[String]]
  
  /**
    * Store of each included file for a shader (The can be looked up using effect.key)
    */
  @JSGlobal("BABYLON.ShaderStore.IncludesShadersStore")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("BABYLON.ShaderStore.IncludesShadersStoreWGSL")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("BABYLON.ShaderStore.ShadersRepository")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("BABYLON.ShaderStore.ShadersRepositoryWGSL")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("BABYLON.ShaderStore.ShadersStore")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("BABYLON.ShaderStore.ShadersStoreWGSL")
  @js.native
