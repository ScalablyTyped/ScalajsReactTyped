...
open class WebXRManagedOutputCanvas protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.WebXRManagedOutputCanvas {
  /**
  ...
  def this(
    ...
    _options: typingsJapgolly.babylonjs.BABYLON.WebXRManagedOutputCanvasOptions
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var onXRLayerInitObservable: typingsJapgolly.babylonjs.BABYLON.Observable[XRWebGLLayer] = js.native
