...
open class IsoVector ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.IsoVector {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def rotate60About(other: typingsJapgolly.babylonjs.BABYLON.IsoVector): this.type = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def rotateNeg60About(other: typingsJapgolly.babylonjs.BABYLON.IsoVector): this.type = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def toCartesianOrigin(origin: typingsJapgolly.babylonjs.BABYLON.IsoVector, isoGridSize: Double): typingsJapgolly.babylonjs.BABYLON.Vector3 = js.native
...
object IsoVector {
  ...
  /**
    ...
    */
  inline def Zero(): typingsJapgolly.babylonjs.BABYLON.IsoVector = ^.asInstanceOf[js.Dynamic].applyDynamic("Zero")().asInstanceOf[typingsJapgolly.babylonjs.BABYLON.IsoVector]
}
