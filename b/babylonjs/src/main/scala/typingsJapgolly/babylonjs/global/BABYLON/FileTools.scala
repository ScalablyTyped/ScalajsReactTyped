...
object FileTools {
  ...
  inline def RequestFile(
    ...
    offlineProvider: Unit,
    useArrayBuffer: Boolean,
    onError: js.Function1[/* error */ typingsJapgolly.babylonjs.BABYLON.RequestFileError, Unit]
  ...
  inline def RequestFile(
    ...
    useArrayBuffer: Boolean,
    onError: js.Function1[/* error */ typingsJapgolly.babylonjs.BABYLON.RequestFileError, Unit],
    onOpened: js.Function1[/* request */ typingsJapgolly.babylonjs.BABYLON.WebRequest, Unit]
