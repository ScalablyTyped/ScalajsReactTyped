...
import typingsJapgolly.babylonjs.BABYLON.WebGPUBufferDescription
...
open class WebGPUShaderProcessingContext protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.WebGPUShaderProcessingContext {
  def this(shaderLanguage: typingsJapgolly.babylonjs.BABYLON.ShaderLanguage) = this()
}
/* static members */
