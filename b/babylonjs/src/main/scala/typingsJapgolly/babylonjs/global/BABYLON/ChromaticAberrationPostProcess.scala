...
open class ChromaticAberrationPostProcess protected ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.ChromaticAberrationPostProcess {
  /**
...
object ChromaticAberrationPostProcess {
  ...
  inline def _Parse(
    ...
    rootUrl: String
  ): Nullable[typingsJapgolly.babylonjs.BABYLON.ChromaticAberrationPostProcess] = (^.asInstanceOf[js.Dynamic].applyDynamic("_Parse")(parsedPostProcess.asInstanceOf[js.Any], targetCamera.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[Nullable[typingsJapgolly.babylonjs.BABYLON.ChromaticAberrationPostProcess]]
}
