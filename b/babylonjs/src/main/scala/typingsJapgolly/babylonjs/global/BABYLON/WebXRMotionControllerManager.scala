...
import typingsJapgolly.babylonjs.BABYLON.MotionControllerConstructor
...
open class WebXRMotionControllerManager ()
  extends StObject
     with typingsJapgolly.babylonjs.BABYLON.WebXRMotionControllerManager
/* static members */
object WebXRMotionControllerManager {
  ...
  /**
    ...
    * Defaults to true.
    */
  @JSGlobal("BABYLON.WebXRMotionControllerManager.DisableControllerCache")
  @js.native
  ...
  /**
    ...
    */
  inline def GetMotionControllerWithXRInput(xrInput: XRInputSource, scene: typingsJapgolly.babylonjs.BABYLON.Scene): js.Promise[typingsJapgolly.babylonjs.BABYLON.WebXRAbstractMotionController] = (^.asInstanceOf[js.Dynamic].applyDynamic("GetMotionControllerWithXRInput")(xrInput.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.BABYLON.WebXRAbstractMotionController]]
  inline def GetMotionControllerWithXRInput(xrInput: XRInputSource, scene: typingsJapgolly.babylonjs.BABYLON.Scene, forceProfile: String): js.Promise[typingsJapgolly.babylonjs.BABYLON.WebXRAbstractMotionController] = (^.asInstanceOf[js.Dynamic].applyDynamic("GetMotionControllerWithXRInput")(xrInput.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], forceProfile.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.BABYLON.WebXRAbstractMotionController]]
