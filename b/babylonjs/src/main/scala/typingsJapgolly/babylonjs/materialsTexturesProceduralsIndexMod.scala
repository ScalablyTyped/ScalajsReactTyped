...
object materialsTexturesProceduralsIndexMod {
  ...
  open class CustomProceduralTexture protected ()
    extends typingsJapgolly.babylonjs.materialsTexturesProceduralsCustomProceduralTextureMod.CustomProceduralTexture {
    /**
  ...
  open class NoiseProceduralTexture protected ()
    extends typingsJapgolly.babylonjs.materialsTexturesProceduralsNoiseProceduralTextureMod.NoiseProceduralTexture {
    /**
  ...
  open class ProceduralTexture protected ()
    extends typingsJapgolly.babylonjs.materialsTexturesProceduralsProceduralTextureMod.ProceduralTexture {
    /**
  ...
  open class ProceduralTextureSceneComponent protected ()
    extends typingsJapgolly.babylonjs.materialsTexturesProceduralsProceduralTextureSceneComponentMod.ProceduralTextureSceneComponent {
    /**
