...
object babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod {
  ...
  object ArcRotateCameraInputsManager {
    ...
    ): typingsJapgolly.babylonjs.camerasIndexMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager = {
      val __obj = js.Dynamic.literal(addVRDeviceOrientation = addVRDeviceOrientation.toJsFn)
      __obj.asInstanceOf[typingsJapgolly.babylonjs.camerasIndexMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.camerasIndexMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager](x: Self) {
