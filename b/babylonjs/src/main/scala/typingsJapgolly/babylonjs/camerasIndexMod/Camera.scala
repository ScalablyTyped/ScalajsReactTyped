...
open class Camera protected ()
  extends typingsJapgolly.babylonjs.camerasCameraMod.Camera {
  /**
...
object Camera {
  ...
  /**
    ...
    */
  inline def Parse(parsedCamera: Any, scene: Scene): typingsJapgolly.babylonjs.camerasCameraMod.Camera = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedCamera.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.camerasCameraMod.Camera]
  ...
  /**
    * @internal
    */
  inline def _CreateDefaultParsedCamera(name: String, scene: Scene): typingsJapgolly.babylonjs.camerasCameraMod.Camera = (^.asInstanceOf[js.Dynamic].applyDynamic("_CreateDefaultParsedCamera")(name.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.camerasCameraMod.Camera]
}
