...
import typingsJapgolly.babylonjs.lightsLightConstantsMod.ISortableLight
import typingsJapgolly.babylonjs.lightsShadowsShadowGeneratorMod.IShadowGenerator
