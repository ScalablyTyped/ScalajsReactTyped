...
object miscHighDynamicRangeIndexMod {
  ...
  open class CubeMapToSphericalPolynomialTools ()
    extends typingsJapgolly.babylonjs.miscHighDynamicRangeCubemapToSphericalPolynomialMod.CubeMapToSphericalPolynomialTools
  /* static members */
  ...
  @js.native
  open class HDRTools ()
    extends typingsJapgolly.babylonjs.miscHighDynamicRangeHdrMod.HDRTools
  /* static members */
  object HDRTools {
  ...
  open class PanoramaToCubeMapTools ()
    extends typingsJapgolly.babylonjs.miscHighDynamicRangePanoramaToCubemapMod.PanoramaToCubeMapTools
  /* static members */
