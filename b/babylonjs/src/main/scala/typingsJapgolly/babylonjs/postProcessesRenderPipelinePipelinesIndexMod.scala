...
object postProcessesRenderPipelinePipelinesIndexMod {
  ...
  open class DefaultRenderingPipeline ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesDefaultRenderingPipelineMod.DefaultRenderingPipeline {
  ...
  open class LensRenderingPipeline protected ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesLensRenderingPipelineMod.LensRenderingPipeline {
    /**
      * @constructor
      *
  ...
  open class SSAO2RenderingPipeline protected ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesSsao2RenderingPipelineMod.SSAO2RenderingPipeline {
    /**
      * @constructor
      * @param name The rendering pipeline name
      * @param scene The scene linked to this pipeline
  ...
  open class SSAORenderingPipeline protected ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesSsaoRenderingPipelineMod.SSAORenderingPipeline {
    /**
      * @constructor
      * @param name - The rendering pipeline name
      * @param scene - The scene linked to this pipeline
  ...
  open class StandardRenderingPipeline protected ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesStandardRenderingPipelineMod.StandardRenderingPipeline {
    /**
