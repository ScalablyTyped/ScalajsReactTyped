...
import typingsJapgolly.babylonjs.camerasInputsBaseCameraMouseWheelInputMod.BaseCameraMouseWheelInput
import typingsJapgolly.babylonjs.mathsMathDotaxisMod.Coordinate
