...
object miscPerformanceViewerIndexMod {
  ...
  open class DynamicFloat32Array protected ()
    extends typingsJapgolly.babylonjs.miscPerformanceViewerDynamicFloat32ArrayMod.DynamicFloat32Array {
    /**
  ...
  open class PerfCollectionStrategy ()
    extends typingsJapgolly.babylonjs.miscPerformanceViewerPerformanceViewerCollectionStrategiesMod.PerfCollectionStrategy
  /* static members */
  ...
  open class PerformanceViewerCollector protected ()
    extends typingsJapgolly.babylonjs.miscPerformanceViewerPerformanceViewerCollectorMod.PerformanceViewerCollector {
    /**
