...
object enginesProcessorsIndexMod {
  ...
  open class ShaderCodeConditionNode ()
    extends typingsJapgolly.babylonjs.enginesProcessorsShaderCodeConditionNodeMod.ShaderCodeConditionNode
  
  @JSImport("babylonjs/Engines/Processors/index", "ShaderCodeCursor")
  @js.native
  open class ShaderCodeCursor ()
    extends typingsJapgolly.babylonjs.enginesProcessorsShaderCodeCursorMod.ShaderCodeCursor
  
  @JSImport("babylonjs/Engines/Processors/index", "ShaderCodeInliner")
  @js.native
  open class ShaderCodeInliner protected ()
    extends typingsJapgolly.babylonjs.enginesProcessorsShaderCodeInlinerMod.ShaderCodeInliner {
    /**
  ...
  open class ShaderCodeNode ()
    extends typingsJapgolly.babylonjs.enginesProcessorsShaderCodeNodeMod.ShaderCodeNode
  
  @JSImport("babylonjs/Engines/Processors/index", "ShaderCodeTestNode")
  @js.native
  open class ShaderCodeTestNode ()
    extends typingsJapgolly.babylonjs.enginesProcessorsShaderCodeTestNodeMod.ShaderCodeTestNode
  
  @JSImport("babylonjs/Engines/Processors/index", "ShaderDefineAndOperator")
  @js.native
  open class ShaderDefineAndOperator ()
    extends typingsJapgolly.babylonjs.enginesProcessorsExpressionsIndexMod.ShaderDefineAndOperator
  ...
  open class ShaderDefineArithmeticOperator protected ()
    extends typingsJapgolly.babylonjs.enginesProcessorsExpressionsIndexMod.ShaderDefineArithmeticOperator {
  ...
  open class ShaderDefineExpression ()
    extends typingsJapgolly.babylonjs.enginesProcessorsExpressionsIndexMod.ShaderDefineExpression
  /* static members */
  ...
  open class ShaderDefineIsDefinedOperator protected ()
    extends typingsJapgolly.babylonjs.enginesProcessorsExpressionsIndexMod.ShaderDefineIsDefinedOperator {
  ...
  open class ShaderDefineOrOperator ()
    extends typingsJapgolly.babylonjs.enginesProcessorsExpressionsIndexMod.ShaderDefineOrOperator
  
  @JSImport("babylonjs/Engines/Processors/index", "ShaderProcessor")
  @js.native
  open class ShaderProcessor ()
    extends typingsJapgolly.babylonjs.enginesProcessorsShaderProcessorMod.ShaderProcessor
  /* static members */
