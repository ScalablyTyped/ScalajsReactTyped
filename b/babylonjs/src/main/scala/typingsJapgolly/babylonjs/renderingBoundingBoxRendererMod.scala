...
object renderingBoundingBoxRendererMod {
  ...
  object babylonjsMeshesAbstractMeshAugmentingMod {
    ...
    object AbstractMesh {
      ...
      inline def apply(_showBoundingBox: Boolean, showBoundingBox: Boolean): typingsJapgolly.babylonjs.renderingBoundingBoxRendererMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh = {
        ...
        __obj.asInstanceOf[typingsJapgolly.babylonjs.renderingBoundingBoxRendererMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.renderingBoundingBoxRendererMod.babylonjsMeshesAbstractMeshAugmentingMod.AbstractMesh](x: Self) {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      inline def apply(
        ...
        getBoundingBoxRenderer: CallbackTo[BoundingBoxRenderer]
      ): typingsJapgolly.babylonjs.renderingBoundingBoxRendererMod.babylonjsSceneAugmentingMod.Scene = {
        val __obj = js.Dynamic.literal(_boundingBoxRenderer = _boundingBoxRenderer.asInstanceOf[js.Any], _forceShowBoundingBoxes = _forceShowBoundingBoxes.asInstanceOf[js.Any], forceShowBoundingBoxes = forceShowBoundingBoxes.asInstanceOf[js.Any], getBoundingBoxRenderer = getBoundingBoxRenderer.toJsFn)
        __obj.asInstanceOf[typingsJapgolly.babylonjs.renderingBoundingBoxRendererMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.renderingBoundingBoxRendererMod.babylonjsSceneAugmentingMod.Scene](x: Self) {
        
        inline def setForceShowBoundingBoxes(value: Boolean): Self = StObject.set(x, "forceShowBoundingBoxes", value.asInstanceOf[js.Any])
        
        inline def setGetBoundingBoxRenderer(value: CallbackTo[BoundingBoxRenderer]): Self = StObject.set(x, "getBoundingBoxRenderer", value.toJsFn)
