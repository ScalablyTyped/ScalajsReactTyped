...
object materialsNodeBlocksVertexIndexMod {
  
  @JSImport("babylonjs/Materials/Node/Blocks/Vertex/index", "BonesBlock")
  @js.native
  open class BonesBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksVertexBonesBlockMod.BonesBlock {
    /**
  ...
  open class InstancesBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksVertexInstancesBlockMod.InstancesBlock {
    /**
  ...
  open class LightInformationBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksVertexLightInformationBlockMod.LightInformationBlock {
    /**
  ...
  open class MorphTargetsBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksVertexMorphTargetsBlockMod.MorphTargetsBlock {
    /**
  ...
  open class VertexOutputBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksVertexVertexOutputBlockMod.VertexOutputBlock {
    /**
