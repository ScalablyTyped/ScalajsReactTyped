...
@JSImport("babylonjs/PostProcesses/index", "LensRenderingPipeline")
@js.native
open class LensRenderingPipeline protected ()
  extends typingsJapgolly.babylonjs.postProcessesRenderPipelineIndexMod.LensRenderingPipeline {
  /**
    * @constructor
    *
