...
open class GrainPostProcess protected ()
  extends typingsJapgolly.babylonjs.postProcessesGrainPostProcessMod.GrainPostProcess {
  /**
...
object GrainPostProcess {
  ...
  /**
    * @internal
    */
  inline def _Parse(parsedPostProcess: Any, targetCamera: Camera, scene: Scene, rootUrl: String): typingsJapgolly.babylonjs.postProcessesGrainPostProcessMod.GrainPostProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("_Parse")(parsedPostProcess.asInstanceOf[js.Any], targetCamera.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.postProcessesGrainPostProcessMod.GrainPostProcess]
}
