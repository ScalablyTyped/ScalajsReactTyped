...
open class PassCubePostProcess protected ()
  extends typingsJapgolly.babylonjs.postProcessesPassPostProcessMod.PassCubePostProcess {
  /**
...
object PassCubePostProcess {
  ...
  /**
    * @internal
    */
  inline def _Parse(parsedPostProcess: Any, targetCamera: Camera, scene: Scene, rootUrl: String): typingsJapgolly.babylonjs.postProcessesPassPostProcessMod.PassCubePostProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("_Parse")(parsedPostProcess.asInstanceOf[js.Any], targetCamera.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.postProcessesPassPostProcessMod.PassCubePostProcess]
}
