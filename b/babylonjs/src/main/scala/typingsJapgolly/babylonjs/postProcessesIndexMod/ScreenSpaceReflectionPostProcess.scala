...
open class ScreenSpaceReflectionPostProcess protected ()
  extends typingsJapgolly.babylonjs.postProcessesScreenSpaceReflectionPostProcessMod.ScreenSpaceReflectionPostProcess {
  /**
