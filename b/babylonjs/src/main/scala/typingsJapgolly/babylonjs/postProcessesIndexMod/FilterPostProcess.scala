...
open class FilterPostProcess protected ()
  extends typingsJapgolly.babylonjs.postProcessesFilterPostProcessMod.FilterPostProcess {
  /**
    *
...
object FilterPostProcess {
  ...
  /**
    * @internal
    */
  inline def _Parse(parsedPostProcess: Any, targetCamera: Camera, scene: Scene, rootUrl: String): Nullable[typingsJapgolly.babylonjs.postProcessesFilterPostProcessMod.FilterPostProcess] = (^.asInstanceOf[js.Dynamic].applyDynamic("_Parse")(parsedPostProcess.asInstanceOf[js.Any], targetCamera.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[Nullable[typingsJapgolly.babylonjs.postProcessesFilterPostProcessMod.FilterPostProcess]]
}
