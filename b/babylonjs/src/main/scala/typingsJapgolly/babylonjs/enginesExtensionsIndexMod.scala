...
import typingsJapgolly.babylonjs.computeComputeEffectMod.ComputeEffect
...
object enginesExtensionsIndexMod {
  ...
  object ComputeBindingType extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.babylonjs.enginesExtensionsEngineDotcomputeShaderMod.ComputeBindingType & Double
      ] = js.native
    
    /* 5 */ val Sampler: typingsJapgolly.babylonjs.enginesExtensionsEngineDotcomputeShaderMod.ComputeBindingType.Sampler & Double = js.native
    
    /* 3 */ val StorageBuffer: typingsJapgolly.babylonjs.enginesExtensionsEngineDotcomputeShaderMod.ComputeBindingType.StorageBuffer & Double = js.native
    
    /* 1 */ val StorageTexture: typingsJapgolly.babylonjs.enginesExtensionsEngineDotcomputeShaderMod.ComputeBindingType.StorageTexture & Double = js.native
    
    /* 0 */ val Texture: typingsJapgolly.babylonjs.enginesExtensionsEngineDotcomputeShaderMod.ComputeBindingType.Texture & Double = js.native
    
    /* 4 */ val TextureWithoutSampler: typingsJapgolly.babylonjs.enginesExtensionsEngineDotcomputeShaderMod.ComputeBindingType.TextureWithoutSampler & Double = js.native
    
    /* 2 */ val UniformBuffer: typingsJapgolly.babylonjs.enginesExtensionsEngineDotcomputeShaderMod.ComputeBindingType.UniformBuffer & Double = js.native
  }
  
  @JSImport("babylonjs/Engines/Extensions/index", "EngineView")
  @js.native
  open class EngineView ()
    extends typingsJapgolly.babylonjs.enginesExtensionsEngineDotviewsMod.EngineView
  
  @JSImport("babylonjs/Engines/Extensions/index", "_OcclusionDataStorage")
  @js.native
  open class OcclusionDataStorage ()
    extends typingsJapgolly.babylonjs.enginesExtensionsEngineDotqueryMod.OcclusionDataStorage
  ...
  object babylonjsMeshesAbstractMeshAugmentingMod {
    ...
    trait AbstractMesh extends StObject {
      ...
      /**
        ...
        * @internal
        */
      var __occlusionDataStorage: typingsJapgolly.babylonjs.enginesExtensionsEngineDotqueryMod.OcclusionDataStorage
      
      /**
        * Access property
        * @internal
        */
      var _occlusionDataStorage: typingsJapgolly.babylonjs.enginesExtensionsEngineDotqueryMod.OcclusionDataStorage
    ...
    object AbstractMesh {
      ...
      inline def apply(
        __occlusionDataStorage: typingsJapgolly.babylonjs.enginesExtensionsEngineDotqueryMod.OcclusionDataStorage,
        _occlusionDataStorage: typingsJapgolly.babylonjs.enginesExtensionsEngineDotqueryMod.OcclusionDataStorage,
      ...
      extension [Self <: AbstractMesh](x: Self) {
        ...
        inline def set__occlusionDataStorage(value: typingsJapgolly.babylonjs.enginesExtensionsEngineDotqueryMod.OcclusionDataStorage): Self = StObject.set(x, "__occlusionDataStorage", value.asInstanceOf[js.Any])
        
        inline def set_occlusionDataStorage(value: typingsJapgolly.babylonjs.enginesExtensionsEngineDotqueryMod.OcclusionDataStorage): Self = StObject.set(x, "_occlusionDataStorage", value.asInstanceOf[js.Any])
      }
    }
  }
