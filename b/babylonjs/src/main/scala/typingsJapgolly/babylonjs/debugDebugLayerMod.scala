...
object debugDebugLayerMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      inline def apply(_debugLayer: DebugLayer, debugLayer: DebugLayer): typingsJapgolly.babylonjs.debugDebugLayerMod.babylonjsSceneAugmentingMod.Scene = {
        val __obj = js.Dynamic.literal(_debugLayer = _debugLayer.asInstanceOf[js.Any], debugLayer = debugLayer.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.babylonjs.debugDebugLayerMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.debugDebugLayerMod.babylonjsSceneAugmentingMod.Scene](x: Self) {
