...
object meshesMeshSimplificationSceneComponentMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      inline def apply(_simplificationQueue: SimplificationQueue, simplificationQueue: SimplificationQueue): typingsJapgolly.babylonjs.meshesMeshSimplificationSceneComponentMod.babylonjsSceneAugmentingMod.Scene = {
        ...
        __obj.asInstanceOf[typingsJapgolly.babylonjs.meshesMeshSimplificationSceneComponentMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.meshesMeshSimplificationSceneComponentMod.babylonjsSceneAugmentingMod.Scene](x: Self) {
