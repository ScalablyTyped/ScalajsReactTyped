...
@JSImport("babylonjs/index", "EventConstants")
@js.native
open class EventConstants ()
  extends typingsJapgolly.babylonjs.eventsIndexMod.EventConstants
/* static members */
object EventConstants {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "EventConstants.DOM_DELTA_LINE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "EventConstants.DOM_DELTA_PAGE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "EventConstants.DOM_DELTA_PIXEL")
  @js.native
