...
open class VertexBuffer protected ()
  extends typingsJapgolly.babylonjs.buffersIndexMod.VertexBuffer {
  /**
    * Constructor
...
object VertexBuffer {
  ...
  /**
    * Instance Colors
    */
  @JSImport("babylonjs/index", "VertexBuffer.ColorInstanceKind")
  @js.native
  ...
  @JSImport("babylonjs/index", "VertexBuffer._Counter")
  @js.native
