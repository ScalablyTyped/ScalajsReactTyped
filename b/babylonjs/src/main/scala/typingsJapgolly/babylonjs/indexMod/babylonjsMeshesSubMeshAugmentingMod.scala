...
object babylonjsMeshesSubMeshAugmentingMod {
  ...
  object SubMesh {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.babylonjs.indexMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.indexMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.indexMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh](x: Self) {
