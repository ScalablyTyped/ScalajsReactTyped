...
@JSImport("babylonjs/index", "TextureUsage")
@js.native
object TextureUsage extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typingsJapgolly.babylonjs.enginesWebGPUWebgpuConstantsMod.TextureUsage & Double] = js.native
