...
@JSImport("babylonjs/index", "WebXRHand")
@js.native
open class WebXRHand protected ()
  extends typingsJapgolly.babylonjs.xRIndexMod.WebXRHand {
  /**
  ...
  xrController: typingsJapgolly.babylonjs.xRWebXRInputSourceMod.WebXRInputSource,
    _jointMeshes: js.Array[typingsJapgolly.babylonjs.meshesAbstractMeshMod.AbstractMesh],
    _handMesh: Nullable[typingsJapgolly.babylonjs.meshesAbstractMeshMod.AbstractMesh],
