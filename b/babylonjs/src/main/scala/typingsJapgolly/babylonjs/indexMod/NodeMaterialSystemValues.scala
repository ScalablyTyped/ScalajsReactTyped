...
@JSImport("babylonjs/index", "NodeMaterialSystemValues")
@js.native
object NodeMaterialSystemValues extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[
    typingsJapgolly.babylonjs.materialsNodeEnumsNodeMaterialSystemValuesMod.NodeMaterialSystemValues & Double
  ] = js.native
