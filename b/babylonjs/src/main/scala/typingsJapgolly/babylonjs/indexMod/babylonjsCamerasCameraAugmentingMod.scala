...
object babylonjsCamerasCameraAugmentingMod {
  ...
  object Camera {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.babylonjs.indexMod.babylonjsCamerasCameraAugmentingMod.Camera = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.indexMod.babylonjsCamerasCameraAugmentingMod.Camera]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.indexMod.babylonjsCamerasCameraAugmentingMod.Camera](x: Self) {
