...
open class MultiRenderTarget protected ()
  extends typingsJapgolly.babylonjs.materialsIndexMod.MultiRenderTarget {
  /**
  ...
  def this(name: String, size: Any, count: Double, scene: typingsJapgolly.babylonjs.sceneMod.Scene) = this()
