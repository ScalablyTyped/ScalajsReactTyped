...
object babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod {
  ...
  object ArcRotateCameraInputsManager {
    ...
    ): typingsJapgolly.babylonjs.indexMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager = {
      val __obj = js.Dynamic.literal(addGamepad = addGamepad.toJsFn, addVRDeviceOrientation = addVRDeviceOrientation.toJsFn)
      __obj.asInstanceOf[typingsJapgolly.babylonjs.indexMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.indexMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager](x: Self) {
