...
open class BoneIKController protected ()
  extends typingsJapgolly.babylonjs.bonesIndexMod.BoneIKController {
  /**
    ...
    */
  def this(
    mesh: typingsJapgolly.babylonjs.meshesTransformNodeMod.TransformNode,
...
object BoneIKController {
  ...
  @JSImport("babylonjs/index", "BoneIKController._TmpMats")
  @js.native
  ...
  @JSImport("babylonjs/index", "BoneIKController._TmpQuat")
  @js.native
  ...
  @JSImport("babylonjs/index", "BoneIKController._TmpVecs")
  @js.native
