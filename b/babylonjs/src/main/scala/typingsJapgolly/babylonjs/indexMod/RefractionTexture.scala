...
open class RefractionTexture protected ()
  extends typingsJapgolly.babylonjs.materialsIndexMod.RefractionTexture {
  /**
  ...
  def this(name: String, size: Double, scene: typingsJapgolly.babylonjs.sceneMod.Scene) = this()
