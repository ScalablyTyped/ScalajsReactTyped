...
@JSImport("babylonjs/index", "WebGPUCacheBindGroups")
@js.native
open class WebGPUCacheBindGroups protected ()
  extends typingsJapgolly.babylonjs.enginesIndexMod.WebGPUCacheBindGroups {
  def this(
    device: GPUDevice,
    cacheSampler: typingsJapgolly.babylonjs.enginesWebGPUWebgpuCacheSamplerMod.WebGPUCacheSampler,
    engine: typingsJapgolly.babylonjs.enginesWebgpuEngineMod.WebGPUEngine
  ) = this()
}
/* static members */
object WebGPUCacheBindGroups {
  ...
  @JSImport("babylonjs/index", "WebGPUCacheBindGroups.NumBindGroupsCreatedLastFrame")
  @js.native
  ...
  @JSImport("babylonjs/index", "WebGPUCacheBindGroups.NumBindGroupsCreatedTotal")
  @js.native
  ...
  @JSImport("babylonjs/index", "WebGPUCacheBindGroups.NumBindGroupsLookupLastFrame")
  @js.native
  ...
  @JSImport("babylonjs/index", "WebGPUCacheBindGroups.NumBindGroupsNoLookupLastFrame")
  @js.native
  ...
  @JSImport("babylonjs/index", "WebGPUCacheBindGroups._Cache")
  @js.native
  def _Cache: Any = js.native
  inline def _Cache_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("_Cache")(x.asInstanceOf[js.Any])
  
  @JSImport("babylonjs/index", "WebGPUCacheBindGroups._NumBindGroupsCreatedCurrentFrame")
  @js.native
  ...
  @JSImport("babylonjs/index", "WebGPUCacheBindGroups._NumBindGroupsLookupCurrentFrame")
  @js.native
  ...
  @JSImport("babylonjs/index", "WebGPUCacheBindGroups._NumBindGroupsNoLookupCurrentFrame")
  @js.native
