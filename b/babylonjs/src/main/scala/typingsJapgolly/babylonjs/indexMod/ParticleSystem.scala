...
open class ParticleSystem protected ()
  extends typingsJapgolly.babylonjs.particlesIndexMod.ParticleSystem {
  def this(
    name: String,
    capacity: Double,
  ...
  /**
    ...
    */
  def this(name: String, capacity: Double, sceneOrEngine: typingsJapgolly.babylonjs.sceneMod.Scene) = this()
  def this(
    name: String,
    capacity: Double,
    sceneOrEngine: typingsJapgolly.babylonjs.enginesThinEngineMod.ThinEngine,
...
object ParticleSystem {
  ...
  inline def Parse(
    ...
    sceneOrEngine: typingsJapgolly.babylonjs.enginesThinEngineMod.ThinEngine,
    rootUrl: String
  ): typingsJapgolly.babylonjs.particlesParticleSystemMod.ParticleSystem = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedParticleSystem.asInstanceOf[js.Any], sceneOrEngine.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.particlesParticleSystemMod.ParticleSystem]
  inline def Parse(
    parsedParticleSystem: Any,
    sceneOrEngine: typingsJapgolly.babylonjs.enginesThinEngineMod.ThinEngine,
    rootUrl: String,
