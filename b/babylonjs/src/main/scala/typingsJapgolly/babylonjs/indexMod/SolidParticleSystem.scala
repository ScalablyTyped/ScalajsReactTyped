...
import typingsJapgolly.babylonjs.anon.AutoFixFaceOrientation
...
open class SolidParticleSystem protected ()
  extends typingsJapgolly.babylonjs.particlesIndexMod.SolidParticleSystem {
  /**
  ...
  def this(name: String, scene: typingsJapgolly.babylonjs.sceneMod.Scene, options: AutoFixFaceOrientation) = this()
}
