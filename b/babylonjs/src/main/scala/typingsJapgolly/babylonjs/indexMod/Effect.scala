...
open class Effect protected ()
  extends typingsJapgolly.babylonjs.materialsIndexMod.Effect {
  /**
  ...
  def this(
    ...
    uniformsNamesOrEngine: js.Array[String] | typingsJapgolly.babylonjs.enginesThinEngineMod.ThinEngine,
    samplers: js.UndefOr[Nullable[js.Array[String]]],
    engine: js.UndefOr[typingsJapgolly.babylonjs.enginesThinEngineMod.ThinEngine],
