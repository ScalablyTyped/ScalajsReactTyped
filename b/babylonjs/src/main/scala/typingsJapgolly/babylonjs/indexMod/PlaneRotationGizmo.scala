...
open class PlaneRotationGizmo protected ()
  extends typingsJapgolly.babylonjs.gizmosIndexMod.PlaneRotationGizmo {
  /**
    ...
    */
  def this(
    planeNormal: typingsJapgolly.babylonjs.mathsMathDotvectorMod.Vector3,
    color: js.UndefOr[typingsJapgolly.babylonjs.mathsMathDotcolorMod.Color3],
...
object PlaneRotationGizmo {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "PlaneRotationGizmo.MaxDragAngle")
  @js.native
  ...
  @JSImport("babylonjs/index", "PlaneRotationGizmo._RotationGizmoFragmentShader")
  @js.native
  ...
  @JSImport("babylonjs/index", "PlaneRotationGizmo._RotationGizmoVertexShader")
  @js.native
