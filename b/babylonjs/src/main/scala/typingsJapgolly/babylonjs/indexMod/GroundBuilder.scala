...
object GroundBuilder {
  ...
  @JSImport("babylonjs/index", "GroundBuilder.CreateGround")
  @js.native
  ...
  @JSImport("babylonjs/index", "GroundBuilder.CreateGroundFromHeightMap")
  @js.native
  ...
  @JSImport("babylonjs/index", "GroundBuilder.CreateTiledGround")
  @js.native
