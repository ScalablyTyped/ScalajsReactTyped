...
open class RenderTargetTexture protected ()
  extends typingsJapgolly.babylonjs.materialsIndexMod.RenderTargetTexture {
  /**
...
object RenderTargetTexture {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "RenderTargetTexture.REFRESHRATE_RENDER_ONCE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "RenderTargetTexture.REFRESHRATE_RENDER_ONEVERYFRAME")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "RenderTargetTexture.REFRESHRATE_RENDER_ONEVERYTWOFRAMES")
  @js.native
