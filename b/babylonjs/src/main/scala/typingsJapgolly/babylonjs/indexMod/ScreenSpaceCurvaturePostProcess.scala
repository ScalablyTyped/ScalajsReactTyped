...
open class ScreenSpaceCurvaturePostProcess protected ()
  extends typingsJapgolly.babylonjs.postProcessesIndexMod.ScreenSpaceCurvaturePostProcess {
  /**
...
object ScreenSpaceCurvaturePostProcess {
  ...
  inline def _Parse(
    ...
    scene: typingsJapgolly.babylonjs.sceneMod.Scene,
    rootUrl: String
  ): typingsJapgolly.babylonjs.postProcessesScreenSpaceCurvaturePostProcessMod.ScreenSpaceCurvaturePostProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("_Parse")(parsedPostProcess.asInstanceOf[js.Any], targetCamera.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.postProcessesScreenSpaceCurvaturePostProcessMod.ScreenSpaceCurvaturePostProcess]
}
