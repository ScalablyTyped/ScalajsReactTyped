...
@JSImport("babylonjs/index", "PBRClearCoatConfiguration")
@js.native
open class PBRClearCoatConfiguration protected ()
  extends typingsJapgolly.babylonjs.materialsIndexMod.PBRClearCoatConfiguration {
...
object PBRClearCoatConfiguration {
  ...
  /**
    ...
    * @internal
    */
  @JSImport("babylonjs/index", "PBRClearCoatConfiguration._DefaultIndexOfRefraction")
  @js.native
