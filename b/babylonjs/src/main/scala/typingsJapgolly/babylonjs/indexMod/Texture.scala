...
import typingsJapgolly.babylonjs.materialsTexturesTextureMod.ITextureCreationOptions
...
open class Texture protected ()
  extends typingsJapgolly.babylonjs.materialsIndexMod.Texture {
  /**
...
object Texture {
  ...
  @js.native
  def OnTextureLoadErrorObservable: typingsJapgolly.babylonjs.miscObservableMod.Observable[typingsJapgolly.babylonjs.materialsTexturesBaseTextureMod.BaseTexture] = js.native
  inline def OnTextureLoadErrorObservable_=(
    x: typingsJapgolly.babylonjs.miscObservableMod.Observable[typingsJapgolly.babylonjs.materialsTexturesBaseTextureMod.BaseTexture]
  ...
  ): typingsJapgolly.babylonjs.materialsTexturesMirrorTextureMod.MirrorTexture = (^.asInstanceOf[js.Dynamic].applyDynamic("_CreateMirror")(name.asInstanceOf[js.Any], renderTargetSize.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], generateMipMaps.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.materialsTexturesMirrorTextureMod.MirrorTexture]
  ...
  inline def _CreateRenderTargetTexture(
    ...
    scene: typingsJapgolly.babylonjs.sceneMod.Scene,
    generateMipMaps: Boolean
  ): typingsJapgolly.babylonjs.materialsTexturesRenderTargetTextureMod.RenderTargetTexture = (^.asInstanceOf[js.Dynamic].applyDynamic("_CreateRenderTargetTexture")(name.asInstanceOf[js.Any], renderTargetSize.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], generateMipMaps.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.materialsTexturesRenderTargetTextureMod.RenderTargetTexture]
  inline def _CreateRenderTargetTexture(
    name: String,
    renderTargetSize: Double,
    scene: typingsJapgolly.babylonjs.sceneMod.Scene,
  ...
  ): typingsJapgolly.babylonjs.materialsTexturesRenderTargetTextureMod.RenderTargetTexture = (^.asInstanceOf[js.Dynamic].applyDynamic("_CreateRenderTargetTexture")(name.asInstanceOf[js.Any], renderTargetSize.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], generateMipMaps.asInstanceOf[js.Any], creationFlags.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.materialsTexturesRenderTargetTextureMod.RenderTargetTexture]
  
  /**
    * @internal
    */
  inline def _CubeTextureParser(jsonTexture: Any, scene: typingsJapgolly.babylonjs.sceneMod.Scene, rootUrl: String): typingsJapgolly.babylonjs.materialsTexturesCubeTextureMod.CubeTexture = (^.asInstanceOf[js.Dynamic].applyDynamic("_CubeTextureParser")(jsonTexture.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.materialsTexturesCubeTextureMod.CubeTexture]
}
