...
object babylonjsMaterialsTexturesBaseTextureAugmentingMod {
  ...
  object BaseTexture {
    ...
    inline def apply(forceSphericalPolynomialsRecompute: Callback): typingsJapgolly.babylonjs.indexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.indexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.indexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture](x: Self) {
