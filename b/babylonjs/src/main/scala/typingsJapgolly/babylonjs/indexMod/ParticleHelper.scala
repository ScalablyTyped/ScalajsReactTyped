...
open class ParticleHelper ()
  extends typingsJapgolly.babylonjs.particlesIndexMod.ParticleHelper
/* static members */
object ParticleHelper {
  ...
  /**
    ...
    */
  inline def CreateAsync(`type`: String, scene: Nullable[typingsJapgolly.babylonjs.sceneMod.Scene]): js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateAsync")(`type`.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet]]
  inline def CreateAsync(`type`: String, scene: Nullable[typingsJapgolly.babylonjs.sceneMod.Scene], gpu: Boolean): js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateAsync")(`type`.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], gpu.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet]]
  inline def CreateAsync(
    `type`: String,
    scene: Nullable[typingsJapgolly.babylonjs.sceneMod.Scene],
    gpu: Boolean,
    capacity: Double
  ): js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateAsync")(`type`.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], gpu.asInstanceOf[js.Any], capacity.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet]]
  inline def CreateAsync(
    `type`: String,
    scene: Nullable[typingsJapgolly.babylonjs.sceneMod.Scene],
    gpu: Unit,
  ...
  inline def CreateDefault(
    emitter: Nullable[
      typingsJapgolly.babylonjs.meshesAbstractMeshMod.AbstractMesh | typingsJapgolly.babylonjs.mathsMathDotvectorMod.Vector3
    ]
  ...
  /**
    ...
    */
  inline def ExportSet(systems: js.Array[IParticleSystem]): typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet = ^.asInstanceOf[js.Dynamic].applyDynamic("ExportSet")(systems.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet]
  ...
  /**
    ...
    * @returns a promise that will resolve to the new particle system
    */
  inline def ParseFromSnippetAsync(snippetId: String, scene: typingsJapgolly.babylonjs.sceneMod.Scene): js.Promise[IParticleSystem] = (^.asInstanceOf[js.Dynamic].applyDynamic("ParseFromSnippetAsync")(snippetId.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[js.Promise[IParticleSystem]]
