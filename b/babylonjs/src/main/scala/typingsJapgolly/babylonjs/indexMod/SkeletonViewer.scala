...
open class SkeletonViewer protected ()
  extends typingsJapgolly.babylonjs.debugIndexMod.SkeletonViewer {
  /**
...
object SkeletonViewer {
  ...
  @JSImport("babylonjs/index", "SkeletonViewer.DISPLAY_SPHERES")
  @js.native
  val DISPLAY_SPHERES: Double = js.native
  
  /** public Display constants BABYLON.SkeletonViewer.DISPLAY_SPHERE_AND_SPURS */
  @JSImport("babylonjs/index", "SkeletonViewer.DISPLAY_SPHERE_AND_SPURS")
  @js.native
