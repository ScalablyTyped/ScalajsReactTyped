...
open class Light protected ()
  extends typingsJapgolly.babylonjs.lightsIndexMod.Light {
  /**
...
object Light {
  ...
  /**
    ...
    */
  inline def Parse(parsedLight: Any, scene: typingsJapgolly.babylonjs.sceneMod.Scene): Nullable[typingsJapgolly.babylonjs.lightsLightMod.Light] = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedLight.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[Nullable[typingsJapgolly.babylonjs.lightsLightMod.Light]]
}
