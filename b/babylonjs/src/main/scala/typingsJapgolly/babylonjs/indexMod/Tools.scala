...
import typingsJapgolly.babylonjs.Window
import typingsJapgolly.babylonjs.anon.CrossOrigin
import typingsJapgolly.babylonjs.anon.Handler
...
@js.native
open class Tools ()
  extends typingsJapgolly.babylonjs.miscIndexMod.Tools
/* static members */
object Tools {
  ...
  /**
    ...
    */
  inline def DumpFramebuffer(width: Double, height: Double, engine: typingsJapgolly.babylonjs.enginesEngineMod.Engine): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("DumpFramebuffer")(width.asInstanceOf[js.Any], height.asInstanceOf[js.Any], engine.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  ...
  /**
    ...
    */
  inline def GetPointerPrefix(engine: typingsJapgolly.babylonjs.enginesEngineMod.Engine): String = ^.asInstanceOf[js.Dynamic].applyDynamic("GetPointerPrefix")(engine.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  /**
    ...
    */
  inline def SetReferrerPolicyBehavior(referrerPolicy: Nullable[ReferrerPolicy], element: typingsJapgolly.babylonjs.anon.ReferrerPolicy): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("SetReferrerPolicyBehavior")(referrerPolicy.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    * @ignore
    */
  @JSImport("babylonjs/index", "Tools._ScreenshotCanvas")
  @js.native
