...
object babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod {
  ...
  object RenderTargetTexture {
    ...
    inline def apply(): typingsJapgolly.babylonjs.indexMod.babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod.RenderTargetTexture = {
      val __obj = js.Dynamic.literal(_prePassRenderTarget = null)
      __obj.asInstanceOf[typingsJapgolly.babylonjs.indexMod.babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod.RenderTargetTexture]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.indexMod.babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod.RenderTargetTexture](x: Self) {
