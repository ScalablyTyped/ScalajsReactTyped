...
open class SolidParticle protected ()
  extends typingsJapgolly.babylonjs.particlesIndexMod.SolidParticle {
  /**
  ...
  def this(
    ...
    idxInShape: Double,
    sps: typingsJapgolly.babylonjs.particlesSolidParticleSystemMod.SolidParticleSystem,
    modelBoundingInfo: Nullable[typingsJapgolly.babylonjs.cullingBoundingInfoMod.BoundingInfo]
  ) = this()
  def this(
    particleIndex: Double,
    particleId: Double,
