...
open class ViveController protected ()
  extends typingsJapgolly.babylonjs.gamepadsIndexMod.ViveController {
  /**
...
object ViveController {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ViveController.MODEL_BASE_URL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ViveController.MODEL_FILENAME")
  @js.native
