...
@JSImport("babylonjs/index", "WebXRHitTestLegacy")
@js.native
open class WebXRHitTestLegacy protected ()
  extends typingsJapgolly.babylonjs.xRIndexMod.WebXRHitTestLegacy {
  /**
...
object WebXRHitTestLegacy {
  ...
  /**
    * The module's name
    */
  @JSImport("babylonjs/index", "WebXRHitTestLegacy.Name")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRHitTestLegacy.Version")
  @js.native
