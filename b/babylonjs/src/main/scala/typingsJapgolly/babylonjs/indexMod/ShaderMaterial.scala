...
open class ShaderMaterial protected ()
  extends typingsJapgolly.babylonjs.materialsIndexMod.ShaderMaterial {
  /**
    ...
    */
  def this(name: String, scene: typingsJapgolly.babylonjs.sceneMod.Scene, shaderPath: Any) = this()
  def this(
    name: String,
