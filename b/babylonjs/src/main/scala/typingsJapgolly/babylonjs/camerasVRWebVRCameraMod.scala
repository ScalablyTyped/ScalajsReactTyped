...
import typingsJapgolly.babylonjs.gamepadsControllersWebVRControllerMod.WebVRController
...
object camerasVRWebVRCameraMod {
  ...
  - typingsJapgolly.babylonjs.camerasVRWebVRCameraMod.PoseControlled because var conflicts: position, rotationQuaternion. Inlined devicePosition, deviceRotationQuaternion, rawPose, deviceScaleFactor, updateFromDevice */ @JSImport("babylonjs/Cameras/VR/webVRCamera", "WebVRFreeCamera")
  @js.native
  ...
  object PoseControlled {
    ...
    extension [Self <: PoseControlled](x: Self) {
      ...
      inline def setUpdateFromDevice(value: DevicePose => Callback): Self = StObject.set(x, "updateFromDevice", js.Any.fromFunction1((t0: DevicePose) => value(t0).runNow()))
    }
  }
