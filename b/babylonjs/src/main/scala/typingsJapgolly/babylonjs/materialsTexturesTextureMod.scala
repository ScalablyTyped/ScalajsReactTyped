...
import typingsJapgolly.babylonjs.materialsTexturesCubeTextureMod.CubeTexture
import typingsJapgolly.babylonjs.materialsTexturesInternalTextureMod.InternalTexture
import typingsJapgolly.babylonjs.materialsTexturesMirrorTextureMod.MirrorTexture
...
object materialsTexturesTextureMod {
  ...
  object ITextureCreationOptions {
    ...
    extension [Self <: ITextureCreationOptions](x: Self) {
      ...
      inline def setOnError(value: (/* message */ js.UndefOr[String], /* exception */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction2((t0: /* message */ js.UndefOr[String], t1: /* exception */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
