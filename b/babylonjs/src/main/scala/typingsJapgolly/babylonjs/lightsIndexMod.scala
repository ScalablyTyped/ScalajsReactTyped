...
import typingsJapgolly.babylonjs.lightsShadowLightMod.IShadowLight
...
object lightsIndexMod {
  ...
  open class CascadedShadowGenerator protected ()
    extends typingsJapgolly.babylonjs.lightsShadowsIndexMod.CascadedShadowGenerator {
    /**
  ...
  open class DirectionalLight protected ()
    extends typingsJapgolly.babylonjs.lightsDirectionalLightMod.DirectionalLight {
    /**
  ...
  open class HemisphericLight protected ()
    extends typingsJapgolly.babylonjs.lightsHemisphericLightMod.HemisphericLight {
    /**
  ...
  open class Light protected ()
    extends typingsJapgolly.babylonjs.lightsLightMod.Light {
    /**
  ...
  object Light {
    ...
    /**
      ...
      */
    inline def Parse(parsedLight: Any, scene: Scene): Nullable[typingsJapgolly.babylonjs.lightsLightMod.Light] = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedLight.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[Nullable[typingsJapgolly.babylonjs.lightsLightMod.Light]]
  }
  
  @JSImport("babylonjs/Lights/index", "PointLight")
  @js.native
  open class PointLight protected ()
    extends typingsJapgolly.babylonjs.lightsPointLightMod.PointLight {
    /**
  ...
  open class ShadowGenerator protected ()
    extends typingsJapgolly.babylonjs.lightsShadowsIndexMod.ShadowGenerator {
    /**
  ...
  object ShadowGenerator {
    ...
    ): typingsJapgolly.babylonjs.lightsShadowsShadowGeneratorMod.ShadowGenerator = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedShadowGenerator.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], constr.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.lightsShadowsShadowGeneratorMod.ShadowGenerator]
  ...
  open class ShadowGeneratorSceneComponent protected ()
    extends typingsJapgolly.babylonjs.lightsShadowsIndexMod.ShadowGeneratorSceneComponent {
    /**
  ...
  open class ShadowLight protected ()
    extends typingsJapgolly.babylonjs.lightsShadowLightMod.ShadowLight {
    /**
      * Creates a Light object in the scene.
      * Documentation : https://doc.babylonjs.com/babylon101/lights
      * @param name The friendly name of the light
  ...
  open class SpotLight protected ()
    extends typingsJapgolly.babylonjs.lightsSpotLightMod.SpotLight {
    /**
