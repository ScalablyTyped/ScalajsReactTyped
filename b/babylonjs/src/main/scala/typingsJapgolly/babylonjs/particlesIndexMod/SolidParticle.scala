...
open class SolidParticle protected ()
  extends typingsJapgolly.babylonjs.particlesSolidParticleMod.SolidParticle {
  /**
  ...
  def this(
    ...
    indiceIndex: Double,
    model: Nullable[typingsJapgolly.babylonjs.particlesSolidParticleMod.ModelShape],
    shapeId: Double,
    idxInShape: Double,
    sps: typingsJapgolly.babylonjs.particlesSolidParticleSystemMod.SolidParticleSystem
  ) = this()
  def this(
    particleIndex: Double,
    particleId: Double,
