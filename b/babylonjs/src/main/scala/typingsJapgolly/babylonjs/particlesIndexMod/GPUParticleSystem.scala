...
open class GPUParticleSystem protected ()
  extends typingsJapgolly.babylonjs.particlesGpuParticleSystemMod.GPUParticleSystem {
...
object GPUParticleSystem {
  ...
  /**
    ...
    */
  inline def Parse(parsedParticleSystem: Any, sceneOrEngine: Scene, rootUrl: String): typingsJapgolly.babylonjs.particlesGpuParticleSystemMod.GPUParticleSystem = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedParticleSystem.asInstanceOf[js.Any], sceneOrEngine.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.particlesGpuParticleSystemMod.GPUParticleSystem]
  inline def Parse(parsedParticleSystem: Any, sceneOrEngine: Scene, rootUrl: String, doNotStart: Boolean): typingsJapgolly.babylonjs.particlesGpuParticleSystemMod.GPUParticleSystem = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedParticleSystem.asInstanceOf[js.Any], sceneOrEngine.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any], doNotStart.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.particlesGpuParticleSystemMod.GPUParticleSystem]
  inline def Parse(
    parsedParticleSystem: Any,
    sceneOrEngine: Scene,
    rootUrl: String,
