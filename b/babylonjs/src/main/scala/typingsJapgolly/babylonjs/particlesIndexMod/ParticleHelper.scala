...
open class ParticleHelper ()
  extends typingsJapgolly.babylonjs.particlesParticleHelperMod.ParticleHelper
/* static members */
object ParticleHelper {
  ...
  /**
    ...
    */
  inline def CreateAsync(`type`: String, scene: Nullable[Scene]): js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateAsync")(`type`.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet]]
  inline def CreateAsync(`type`: String, scene: Nullable[Scene], gpu: Boolean): js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateAsync")(`type`.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], gpu.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet]]
  inline def CreateAsync(`type`: String, scene: Nullable[Scene], gpu: Boolean, capacity: Double): js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateAsync")(`type`.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], gpu.asInstanceOf[js.Any], capacity.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet]]
  inline def CreateAsync(`type`: String, scene: Nullable[Scene], gpu: Unit, capacity: Double): js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet] = (^.asInstanceOf[js.Dynamic].applyDynamic("CreateAsync")(`type`.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], gpu.asInstanceOf[js.Any], capacity.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.babylonjs.particlesParticleSystemSetMod.ParticleSystemSet]]
