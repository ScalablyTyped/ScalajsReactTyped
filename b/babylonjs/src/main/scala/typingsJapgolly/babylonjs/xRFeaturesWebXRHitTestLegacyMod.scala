...
import typingsJapgolly.babylonjs.xRWebXRFeaturesManagerMod.IWebXRFeature
...
object xRFeaturesWebXRHitTestLegacyMod {
  ...
  - typingsJapgolly.babylonjs.xRFeaturesWebXRHitTestLegacyMod.IWebXRHitTestFeature because var conflicts: attached, dependsOn, disableAutoAttach, getXRSessionInitExtension, isDisposed, xrNativeFeatureName. Inlined onHitTestResultObservable */ @JSImport("babylonjs/XR/features/WebXRHitTestLegacy", "WebXRHitTestLegacy")
  @js.native
