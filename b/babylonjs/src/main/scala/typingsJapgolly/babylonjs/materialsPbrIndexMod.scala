...
object materialsPbrIndexMod {
  ...
  open class MaterialAnisotropicDefines ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrAnisotropicConfigurationMod.MaterialAnisotropicDefines {
  ...
  open class MaterialClearCoatDefines ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrClearCoatConfigurationMod.MaterialClearCoatDefines {
    def this(externalProperties: StringDictionary[Default]) = this()
  }
  ...
  open class MaterialIridescenceDefines ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrIridescenceConfigurationMod.MaterialIridescenceDefines {
    def this(externalProperties: StringDictionary[Default]) = this()
  }
  ...
  open class MaterialSheenDefines ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrSheenConfigurationMod.MaterialSheenDefines {
    def this(externalProperties: StringDictionary[Default]) = this()
  }
  ...
  open class MaterialSubSurfaceDefines ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrSubSurfaceConfigurationMod.MaterialSubSurfaceDefines {
    def this(externalProperties: StringDictionary[Default]) = this()
  }
  ...
  open class PBRAnisotropicConfiguration protected ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrAnisotropicConfigurationMod.PBRAnisotropicConfiguration {
  ...
  open class PBRBaseMaterial protected ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrBaseMaterialMod.PBRBaseMaterial {
    /**
  ...
  open class PBRBaseSimpleMaterial protected ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrBaseSimpleMaterialMod.PBRBaseSimpleMaterial {
    /**
      * Instantiates a new PBRMaterial instance.
      *
      * @param name The material name
  ...
  open class PBRClearCoatConfiguration protected ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrClearCoatConfigurationMod.PBRClearCoatConfiguration {
    def this(material: typingsJapgolly.babylonjs.materialsPbrPbrBaseMaterialMod.PBRBaseMaterial) = this()
    def this(
      material: typingsJapgolly.babylonjs.materialsPbrPbrBaseMaterialMod.PBRBaseMaterial,
      addToPluginList: Boolean
  ...
  open class PBRIridescenceConfiguration protected ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrIridescenceConfigurationMod.PBRIridescenceConfiguration {
    def this(material: typingsJapgolly.babylonjs.materialsPbrPbrBaseMaterialMod.PBRBaseMaterial) = this()
    def this(
      material: typingsJapgolly.babylonjs.materialsPbrPbrBaseMaterialMod.PBRBaseMaterial,
      addToPluginList: Boolean
  ...
  open class PBRMaterial protected ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrMaterialMod.PBRMaterial {
    /**
      * Instantiates a new PBRMaterial instance.
      *
      * @param name The material name
  ...
  open class PBRMaterialDefines ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrBaseMaterialMod.PBRMaterialDefines {
    def this(externalProperties: StringDictionary[Default]) = this()
  }
  ...
  open class PBRMetallicRoughnessMaterial protected ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrMetallicRoughnessMaterialMod.PBRMetallicRoughnessMaterial {
    /**
  ...
  open class PBRSheenConfiguration protected ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrSheenConfigurationMod.PBRSheenConfiguration {
    def this(material: typingsJapgolly.babylonjs.materialsPbrPbrBaseMaterialMod.PBRBaseMaterial) = this()
    def this(
      material: typingsJapgolly.babylonjs.materialsPbrPbrBaseMaterialMod.PBRBaseMaterial,
      addToPluginList: Boolean
  ...
  open class PBRSpecularGlossinessMaterial protected ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrSpecularGlossinessMaterialMod.PBRSpecularGlossinessMaterial {
    /**
  ...
  open class PBRSubSurfaceConfiguration protected ()
    extends typingsJapgolly.babylonjs.materialsPbrPbrSubSurfaceConfigurationMod.PBRSubSurfaceConfiguration {
    def this(material: typingsJapgolly.babylonjs.materialsPbrPbrBaseMaterialMod.PBRBaseMaterial) = this()
    def this(
      material: typingsJapgolly.babylonjs.materialsPbrPbrBaseMaterialMod.PBRBaseMaterial,
      addToPluginList: Boolean
