...
object materialsMaterialPluginBaseMod {
  
  @JSImport("babylonjs/Materials/materialPluginBase", "MaterialPluginBase")
  @js.native
  open class MaterialPluginBase protected () extends StObject {
    /**
      ...
      */
    def this(material: Material, name: String, priority: Double) = this()
    def this(material: Material, name: String, priority: Double, defines: StringDictionary[Any]) = this()
    def this(
      material: Material,
      name: String,
      priority: Double,
    ...
    def this(material: Material, name: String, priority: Double, defines: Unit, addToPluginList: Boolean) = this()
    def this(
      material: Material,
      name: String,
      priority: Double,
    ...
    /* protected */ var _pluginDefineNames: js.UndefOr[StringDictionary[Any]] = js.native
    ...
    /**
      ...
      */
    def collectDefines(defines: StringDictionary[Default]): Unit = js.native
    ...
    /**
      ...
      */
    def getCustomCode(shaderType: String): Nullable[StringDictionary[String]] = js.native
