...
object behaviorsIndexMod {
  ...
  open class AttachToBoxBehavior protected ()
    extends typingsJapgolly.babylonjs.behaviorsMeshesIndexMod.AttachToBoxBehavior {
    /**
  ...
  open class AutoRotationBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsCamerasIndexMod.AutoRotationBehavior
  
  @JSImport("babylonjs/Behaviors/index", "BaseSixDofDragBehavior")
  @js.native
  open class BaseSixDofDragBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsMeshesIndexMod.BaseSixDofDragBehavior
  /* static members */
  ...
  open class BouncingBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsCamerasIndexMod.BouncingBehavior
  /* static members */
  ...
  open class FadeInOutBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsMeshesIndexMod.FadeInOutBehavior
  
  @JSImport("babylonjs/Behaviors/index", "FollowBehavior")
  @js.native
  open class FollowBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsMeshesIndexMod.FollowBehavior
  
  @JSImport("babylonjs/Behaviors/index", "FramingBehavior")
  @js.native
  open class FramingBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsCamerasIndexMod.FramingBehavior
  /* static members */
  ...
  open class HandConstraintBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsMeshesIndexMod.HandConstraintBehavior
  ...
  open class MultiPointerScaleBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsMeshesIndexMod.MultiPointerScaleBehavior
  ...
  open class PointerDragBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsMeshesIndexMod.PointerDragBehavior {
  ...
  open class SixDofDragBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsMeshesIndexMod.SixDofDragBehavior
  
  @JSImport("babylonjs/Behaviors/index", "SurfaceMagnetismBehavior")
  @js.native
  open class SurfaceMagnetismBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsMeshesIndexMod.SurfaceMagnetismBehavior
}
