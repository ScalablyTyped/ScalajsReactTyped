...
object babylonjsMeshesAbstractMeshAugmentingMod {
  ...
  trait AbstractMesh extends StObject {
    ...
    /**
      ...
      */
    var edgesRenderer: Nullable[typingsJapgolly.babylonjs.renderingEdgesRendererMod.EdgesRenderer]
  ...
  object AbstractMesh {
    ...
    extension [Self <: AbstractMesh](x: Self) {
      ...
      inline def setEdgesRenderer(value: Nullable[typingsJapgolly.babylonjs.renderingEdgesRendererMod.EdgesRenderer]): Self = StObject.set(x, "edgesRenderer", value.asInstanceOf[js.Any])
