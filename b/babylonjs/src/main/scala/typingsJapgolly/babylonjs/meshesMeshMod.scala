...
import typingsJapgolly.babylonjs.mathsMathDotpathMod.Path3D
...
import typingsJapgolly.babylonjs.meshesInstancedMeshMod.InstancedMesh
import typingsJapgolly.babylonjs.meshesMeshSimplificationMod.ISimplificationSettings
import typingsJapgolly.babylonjs.meshesMeshSimplificationMod.SimplificationType
  ...
  object babylonjsMeshesMeshAugmentingMod {
    ...
    trait Mesh extends StObject {
      ...
      /**
        ...
        * @deprecated Please use MeshBuilder instead Please use setMaterialById instead
        */
      def setMaterialByID(id: String): typingsJapgolly.babylonjs.meshesMeshMod.babylonjsMeshesMeshAugmentingMod.Mesh
    }
    object Mesh {
      
      inline def apply(
        setMaterialByID: String => typingsJapgolly.babylonjs.meshesMeshMod.babylonjsMeshesMeshAugmentingMod.Mesh
      ): typingsJapgolly.babylonjs.meshesMeshMod.babylonjsMeshesMeshAugmentingMod.Mesh = {
        val __obj = js.Dynamic.literal(setMaterialByID = js.Any.fromFunction1(setMaterialByID))
        __obj.asInstanceOf[typingsJapgolly.babylonjs.meshesMeshMod.babylonjsMeshesMeshAugmentingMod.Mesh]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.meshesMeshMod.babylonjsMeshesMeshAugmentingMod.Mesh](x: Self) {
        
        inline def setSetMaterialByID(value: String => typingsJapgolly.babylonjs.meshesMeshMod.babylonjsMeshesMeshAugmentingMod.Mesh): Self = StObject.set(x, "setMaterialByID", js.Any.fromFunction1(value))
      }
    }
  }
}
