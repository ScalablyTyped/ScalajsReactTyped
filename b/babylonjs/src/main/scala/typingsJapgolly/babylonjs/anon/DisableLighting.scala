...
trait DisableLighting extends StObject {
  ...
  /**
    ...
    */
  var teleportationCircleMaterial: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.Material] = js.undefined
  ...
  /**
    ...
    */
  var torusArrowMaterial: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.Material] = js.undefined
}
object DisableLighting {
  ...
  extension [Self <: DisableLighting](x: Self) {
    ...
    inline def setTeleportationCircleMaterial(value: typingsJapgolly.babylonjs.BABYLON.Material): Self = StObject.set(x, "teleportationCircleMaterial", value.asInstanceOf[js.Any])
    ...
    inline def setTorusArrowMaterial(value: typingsJapgolly.babylonjs.BABYLON.Material): Self = StObject.set(x, "torusArrowMaterial", value.asInstanceOf[js.Any])
