...
import typingsJapgolly.babylonjs.BABYLON.WebXRControllerPointerSelection
import typingsJapgolly.babylonjs.BABYLON.WebXRInput
import typingsJapgolly.babylonjs.BABYLON.WebXRNearControllerMode
...
trait PartialIWebXRNearInteractCustomUtilityLayerScene extends StObject {
  ...
  var motionControllerOrbMaterial: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.Material] = js.undefined
...
object PartialIWebXRNearInteractCustomUtilityLayerScene {
  ...
  extension [Self <: PartialIWebXRNearInteractCustomUtilityLayerScene](x: Self) {
    ...
    inline def setMotionControllerOrbMaterial(value: typingsJapgolly.babylonjs.BABYLON.Material): Self = StObject.set(x, "motionControllerOrbMaterial", value.asInstanceOf[js.Any])
