...
trait PartialIWebXRControllerPo extends StObject {
  ...
  var customSelectionMeshGenerator: js.UndefOr[js.Function0[typingsJapgolly.babylonjs.meshesMeshMod.Mesh]] = js.undefined
...
object PartialIWebXRControllerPo {
  ...
  extension [Self <: PartialIWebXRControllerPo](x: Self) {
    ...
    inline def setCustomSelectionMeshGenerator(value: CallbackTo[typingsJapgolly.babylonjs.meshesMeshMod.Mesh]): Self = StObject.set(x, "customSelectionMeshGenerator", value.toJsFn)
