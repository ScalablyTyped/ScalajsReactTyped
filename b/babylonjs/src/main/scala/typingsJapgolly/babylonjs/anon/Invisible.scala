...
import typingsJapgolly.babylonjs.BABYLON.InstancedMesh
...
trait Invisible extends StObject {
  ...
  /**
    ...
    */
  var sourceMesh: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.Mesh] = js.undefined
}
object Invisible {
  ...
  extension [Self <: Invisible](x: Self) {
    ...
    inline def setSourceMesh(value: typingsJapgolly.babylonjs.BABYLON.Mesh): Self = StObject.set(x, "sourceMesh", value.asInstanceOf[js.Any])
