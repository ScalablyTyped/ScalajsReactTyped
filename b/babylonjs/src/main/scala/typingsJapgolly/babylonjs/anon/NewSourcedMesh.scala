...
trait NewSourcedMesh extends StObject {
  ...
  var newSourcedMesh: js.UndefOr[typingsJapgolly.babylonjs.meshesMeshMod.Mesh] = js.undefined
}
object NewSourcedMesh {
  ...
  extension [Self <: NewSourcedMesh](x: Self) {
    ...
    inline def setNewSourcedMesh(value: typingsJapgolly.babylonjs.meshesMeshMod.Mesh): Self = StObject.set(x, "newSourcedMesh", value.asInstanceOf[js.Any])
