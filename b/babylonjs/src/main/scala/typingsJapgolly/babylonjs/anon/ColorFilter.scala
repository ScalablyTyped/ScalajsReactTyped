...
import typingsJapgolly.babylonjs.BABYLON.GroundMesh
...
object ColorFilter {
  ...
  extension [Self <: ColorFilter](x: Self) {
    ...
    inline def setOnReady(value: /* mesh */ GroundMesh => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onReady", js.Any.fromFunction1((t0: /* mesh */ GroundMesh) => value(t0).runNow()))
