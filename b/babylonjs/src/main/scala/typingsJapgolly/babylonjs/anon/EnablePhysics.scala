...
trait EnablePhysics extends StObject {
  ...
  /**
    ...
    */
  var sourceMesh: js.UndefOr[typingsJapgolly.babylonjs.meshesMeshMod.Mesh] = js.undefined
}
object EnablePhysics {
  ...
  extension [Self <: EnablePhysics](x: Self) {
    ...
    inline def setSourceMesh(value: typingsJapgolly.babylonjs.meshesMeshMod.Mesh): Self = StObject.set(x, "sourceMesh", value.asInstanceOf[js.Any])
