...
import typingsJapgolly.babylonjs.BABYLON.AbstractMesh
import typingsJapgolly.babylonjs.BABYLON.Scene
import typingsJapgolly.babylonjs.BABYLON.WebXRCamera
...
trait PartialIWebXRControllerPoCustomLasterPointerMeshGenerator extends StObject {
  ...
  var customSelectionMeshGenerator: js.UndefOr[js.Function0[typingsJapgolly.babylonjs.BABYLON.Mesh]] = js.undefined
...
object PartialIWebXRControllerPoCustomLasterPointerMeshGenerator {
  ...
  extension [Self <: PartialIWebXRControllerPoCustomLasterPointerMeshGenerator](x: Self) {
    ...
    inline def setCustomSelectionMeshGenerator(value: CallbackTo[typingsJapgolly.babylonjs.BABYLON.Mesh]): Self = StObject.set(x, "customSelectionMeshGenerator", value.toJsFn)
