...
trait DoNotInstantiateNewSourcedMesh extends StObject {
  ...
  var newSourcedMesh: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.Mesh] = js.undefined
}
object DoNotInstantiateNewSourcedMesh {
  ...
  extension [Self <: DoNotInstantiateNewSourcedMesh](x: Self) {
    ...
    inline def setNewSourcedMesh(value: typingsJapgolly.babylonjs.BABYLON.Mesh): Self = StObject.set(x, "newSourcedMesh", value.asInstanceOf[js.Any])
