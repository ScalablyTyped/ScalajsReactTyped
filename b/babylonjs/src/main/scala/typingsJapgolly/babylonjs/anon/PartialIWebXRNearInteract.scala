...
import typingsJapgolly.babylonjs.xRFeaturesWebXRNearInteractionMod.WebXRNearControllerMode
...
trait PartialIWebXRNearInteract extends StObject {
  ...
  var motionControllerOrbMaterial: js.UndefOr[typingsJapgolly.babylonjs.materialsMaterialMod.Material] = js.undefined
...
object PartialIWebXRNearInteract {
  ...
  extension [Self <: PartialIWebXRNearInteract](x: Self) {
    ...
    inline def setMotionControllerOrbMaterial(value: typingsJapgolly.babylonjs.materialsMaterialMod.Material): Self = StObject.set(x, "motionControllerOrbMaterial", value.asInstanceOf[js.Any])
