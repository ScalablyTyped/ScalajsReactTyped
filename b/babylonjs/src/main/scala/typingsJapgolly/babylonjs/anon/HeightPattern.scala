...
trait HeightPattern extends StObject {
...
object HeightPattern {
  
  inline def apply(): HeightPattern = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HeightPattern]
  }
  
  extension [Self <: HeightPattern](x: Self) {
