...
import typingsJapgolly.babylonjs.BABYLON.WebXREnterExitUIButton
...
object PartialWebXREnterExitUIOpCustomButtons {
  ...
  extension [Self <: PartialWebXREnterExitUIOpCustomButtons](x: Self) {
    ...
    inline def setOnError(value: /* error */ Any => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* error */ Any) => value(t0).runNow()))
