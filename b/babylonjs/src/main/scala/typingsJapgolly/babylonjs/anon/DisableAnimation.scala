...
trait DisableAnimation extends StObject {
  ...
  /**
    ...
    */
  var teleportationCircleMaterial: js.UndefOr[typingsJapgolly.babylonjs.materialsMaterialMod.Material] = js.undefined
  ...
  /**
    ...
    */
  var torusArrowMaterial: js.UndefOr[typingsJapgolly.babylonjs.materialsMaterialMod.Material] = js.undefined
}
object DisableAnimation {
  ...
  extension [Self <: DisableAnimation](x: Self) {
    ...
    inline def setTeleportationCircleMaterial(value: typingsJapgolly.babylonjs.materialsMaterialMod.Material): Self = StObject.set(x, "teleportationCircleMaterial", value.asInstanceOf[js.Any])
    ...
    inline def setTorusArrowMaterial(value: typingsJapgolly.babylonjs.materialsMaterialMod.Material): Self = StObject.set(x, "torusArrowMaterial", value.asInstanceOf[js.Any])
