...
trait ClickToPlay extends StObject {
  ...
  var mesh: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.Mesh] = js.undefined
...
object ClickToPlay {
  ...
  inline def apply(): ClickToPlay = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClickToPlay]
  }
  
  extension [Self <: ClickToPlay](x: Self) {
    ...
    inline def setMesh(value: typingsJapgolly.babylonjs.BABYLON.Mesh): Self = StObject.set(x, "mesh", value.asInstanceOf[js.Any])
