...
trait FirstNormal extends StObject {
  ...
  var instance: js.UndefOr[typingsJapgolly.babylonjs.BABYLON.Mesh] = js.undefined
...
object FirstNormal {
  ...
  inline def apply(path: js.Array[Vector3], shape: js.Array[Vector3]): FirstNormal = {
  ...
  extension [Self <: FirstNormal](x: Self) {
    ...
    inline def setInstance(value: typingsJapgolly.babylonjs.BABYLON.Mesh): Self = StObject.set(x, "instance", value.asInstanceOf[js.Any])
