...
/* Inlined std.Partial<babylonjs.BABYLON.IEnvironmentHelperOptions> */
trait PartialIEnvironmentHelperBackgroundYRotation extends StObject {
...
object PartialIEnvironmentHelperBackgroundYRotation {
  
  inline def apply(): PartialIEnvironmentHelperBackgroundYRotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIEnvironmentHelperBackgroundYRotation]
  }
  
  extension [Self <: PartialIEnvironmentHelperBackgroundYRotation](x: Self) {
