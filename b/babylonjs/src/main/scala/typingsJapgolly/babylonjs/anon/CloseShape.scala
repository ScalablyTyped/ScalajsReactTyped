...
trait CloseShape extends StObject {
  ...
  var instance: js.UndefOr[typingsJapgolly.babylonjs.meshesMeshMod.Mesh] = js.undefined
...
object CloseShape {
  ...
  inline def apply(path: js.Array[Vector3], shape: js.Array[Vector3]): CloseShape = {
  ...
  extension [Self <: CloseShape](x: Self) {
    ...
    inline def setInstance(value: typingsJapgolly.babylonjs.meshesMeshMod.Mesh): Self = StObject.set(x, "instance", value.asInstanceOf[js.Any])
