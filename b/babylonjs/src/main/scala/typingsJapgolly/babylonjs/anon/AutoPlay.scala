...
trait AutoPlay extends StObject {
  ...
  var mesh: js.UndefOr[typingsJapgolly.babylonjs.meshesMeshMod.Mesh] = js.undefined
...
object AutoPlay {
  ...
  extension [Self <: AutoPlay](x: Self) {
    ...
    inline def setMesh(value: typingsJapgolly.babylonjs.meshesMeshMod.Mesh): Self = StObject.set(x, "mesh", value.asInstanceOf[js.Any])
