...
object materialsNodeBlocksModBlockMod {
  
  @JSImport("babylonjs/Materials/Node/Blocks/modBlock", "ModBlock")
  @js.native
  open class ModBlock protected () extends NodeMaterialBlock {
    /**
