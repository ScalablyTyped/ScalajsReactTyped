...
object navigationPluginsIndexMod {
  ...
  open class RecastJSCrowd protected ()
    extends typingsJapgolly.babylonjs.navigationPluginsRecastJSPluginMod.RecastJSCrowd {
    /**
      * Constructor
  ...
  open class RecastJSPlugin ()
    extends typingsJapgolly.babylonjs.navigationPluginsRecastJSPluginMod.RecastJSPlugin {
