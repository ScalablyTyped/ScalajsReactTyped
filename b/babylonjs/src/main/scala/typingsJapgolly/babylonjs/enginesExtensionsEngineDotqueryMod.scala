  ...
  object babylonjsEnginesEngineAugmentingMod {
    ...
    object Engine {
      ...
      inline def apply(
        ...
        _createTimeQuery: CallbackTo[WebGLQuery],
        _deleteTimeQuery: WebGLQuery => Callback,
        ...
        captureGPUFrameTime: Boolean => Callback,
        createQuery: CallbackTo[OcclusionQuery],
        deleteQuery: OcclusionQuery => Engine,
        endOcclusionQuery: Double => Engine,
        endTimeQuery: TimeToken => int,
        getGPUFrameTimeCounter: CallbackTo[PerfCounter],
        getQueryResult: OcclusionQuery => Double,
        isQueryResultAvailable: OcclusionQuery => Boolean,
        startTimeQuery: CallbackTo[Nullable[TimeToken]]
      ): Engine = {
        val __obj = js.Dynamic.literal(_captureGPUFrameTime = _captureGPUFrameTime.asInstanceOf[js.Any], _createTimeQuery = _createTimeQuery.toJsFn, _deleteTimeQuery = js.Any.fromFunction1((t0: WebGLQuery) => _deleteTimeQuery(t0).runNow()), _getGlAlgorithmType = js.Any.fromFunction1(_getGlAlgorithmType), _getTimeQueryAvailability = js.Any.fromFunction1(_getTimeQueryAvailability), _getTimeQueryResult = js.Any.fromFunction1(_getTimeQueryResult), _gpuFrameTime = _gpuFrameTime.asInstanceOf[js.Any], beginOcclusionQuery = js.Any.fromFunction2(beginOcclusionQuery), captureGPUFrameTime = js.Any.fromFunction1((t0: Boolean) => captureGPUFrameTime(t0).runNow()), createQuery = createQuery.toJsFn, deleteQuery = js.Any.fromFunction1(deleteQuery), endOcclusionQuery = js.Any.fromFunction1(endOcclusionQuery), endTimeQuery = js.Any.fromFunction1(endTimeQuery), getGPUFrameTimeCounter = getGPUFrameTimeCounter.toJsFn, getQueryResult = js.Any.fromFunction1(getQueryResult), isQueryResultAvailable = js.Any.fromFunction1(isQueryResultAvailable), startTimeQuery = startTimeQuery.toJsFn, _currentNonTimestampToken = null, _gpuFrameTimeToken = null, _onBeginFrameObserver = null, _onEndFrameObserver = null)
      ...
      extension [Self <: Engine](x: Self) {
        ...
        inline def setCaptureGPUFrameTime(value: Boolean => Callback): Self = StObject.set(x, "captureGPUFrameTime", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
        
        inline def setCreateQuery(value: CallbackTo[OcclusionQuery]): Self = StObject.set(x, "createQuery", value.toJsFn)
        ...
        inline def setGetGPUFrameTimeCounter(value: CallbackTo[PerfCounter]): Self = StObject.set(x, "getGPUFrameTimeCounter", value.toJsFn)
        ...
        inline def setStartTimeQuery(value: CallbackTo[Nullable[TimeToken]]): Self = StObject.set(x, "startTimeQuery", value.toJsFn)
        
        inline def set_captureGPUFrameTime(value: Boolean): Self = StObject.set(x, "_captureGPUFrameTime", value.asInstanceOf[js.Any])
        
        inline def set_createTimeQuery(value: CallbackTo[WebGLQuery]): Self = StObject.set(x, "_createTimeQuery", value.toJsFn)
        ...
        inline def set_deleteTimeQuery(value: WebGLQuery => Callback): Self = StObject.set(x, "_deleteTimeQuery", js.Any.fromFunction1((t0: WebGLQuery) => value(t0).runNow()))
