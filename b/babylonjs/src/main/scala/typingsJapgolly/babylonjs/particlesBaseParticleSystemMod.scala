...
import typingsJapgolly.babylonjs.materialsImageProcessingConfigurationMod.ImageProcessingConfigurationDefines
...
import typingsJapgolly.babylonjs.particlesEmitterTypesIndexMod.CylinderDirectedParticleEmitter
