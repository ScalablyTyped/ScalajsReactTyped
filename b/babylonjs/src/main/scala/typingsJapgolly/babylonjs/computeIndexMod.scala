...
object computeIndexMod {
  ...
  open class ComputeEffect protected ()
    extends typingsJapgolly.babylonjs.computeComputeEffectMod.ComputeEffect {
    /**
  ...
  open class ComputeShader protected ()
    extends typingsJapgolly.babylonjs.computeComputeShaderMod.ComputeShader {
    /**
