...
object probesReflectionProbeMod {
  ...
  object babylonjsAbstractSceneAugmentingMod {
    ...
    object AbstractScene {
      ...
      inline def apply(
        addReflectionProbe: ReflectionProbe => Callback,
        reflectionProbes: js.Array[ReflectionProbe],
        removeReflectionProbe: ReflectionProbe => Double
      ): typingsJapgolly.babylonjs.probesReflectionProbeMod.babylonjsAbstractSceneAugmentingMod.AbstractScene = {
        val __obj = js.Dynamic.literal(addReflectionProbe = js.Any.fromFunction1((t0: ReflectionProbe) => addReflectionProbe(t0).runNow()), reflectionProbes = reflectionProbes.asInstanceOf[js.Any], removeReflectionProbe = js.Any.fromFunction1(removeReflectionProbe))
        __obj.asInstanceOf[typingsJapgolly.babylonjs.probesReflectionProbeMod.babylonjsAbstractSceneAugmentingMod.AbstractScene]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.probesReflectionProbeMod.babylonjsAbstractSceneAugmentingMod.AbstractScene](x: Self) {
        
        inline def setAddReflectionProbe(value: ReflectionProbe => Callback): Self = StObject.set(x, "addReflectionProbe", js.Any.fromFunction1((t0: ReflectionProbe) => value(t0).runNow()))
