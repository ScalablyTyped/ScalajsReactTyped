...
object babylonjsMaterialsTexturesBaseTextureAugmentingMod {
  ...
  object BaseTexture {
    ...
    inline def apply(forceSphericalPolynomialsRecompute: Callback): typingsJapgolly.babylonjs.materialsTexturesIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.materialsTexturesIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.materialsTexturesIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture](x: Self) {
