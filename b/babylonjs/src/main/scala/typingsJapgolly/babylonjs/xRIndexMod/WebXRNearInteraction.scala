...
open class WebXRNearInteraction protected ()
  extends typingsJapgolly.babylonjs.xRFeaturesIndexMod.WebXRNearInteraction {
  /**
...
object WebXRNearInteraction {
  ...
  /**
    * The module's name
    */
  @JSImport("babylonjs/XR/index", "WebXRNearInteraction.Name")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/XR/index", "WebXRNearInteraction.Version")
  @js.native
  val Version: Double = js.native
  
  @JSImport("babylonjs/XR/index", "WebXRNearInteraction._IdCounter")
  @js.native
