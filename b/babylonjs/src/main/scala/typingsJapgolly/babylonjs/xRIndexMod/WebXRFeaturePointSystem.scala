...
open class WebXRFeaturePointSystem protected ()
  extends typingsJapgolly.babylonjs.xRFeaturesIndexMod.WebXRFeaturePointSystem {
  /**
...
object WebXRFeaturePointSystem {
  ...
  /**
    * The module's name
    */
  @JSImport("babylonjs/XR/index", "WebXRFeaturePointSystem.Name")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/XR/index", "WebXRFeaturePointSystem.Version")
  @js.native
