...
import typingsJapgolly.babylonjs.xRFeaturesWebXRHandTrackingMod.IWebXRHandTrackingOptions
...
open class WebXRHandTracking protected ()
  extends typingsJapgolly.babylonjs.xRFeaturesIndexMod.WebXRHandTracking {
  /**
