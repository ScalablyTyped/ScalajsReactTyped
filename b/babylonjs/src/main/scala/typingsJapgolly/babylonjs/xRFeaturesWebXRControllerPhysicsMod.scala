...
import typingsJapgolly.babylonjs.anon.Friction
import typingsJapgolly.babylonjs.anon.ImpostorSize
import typingsJapgolly.babylonjs.anon.ImpostorType
...
object xRFeaturesWebXRControllerPhysicsMod {
