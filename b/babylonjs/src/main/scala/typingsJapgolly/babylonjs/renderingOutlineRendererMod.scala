...
import typingsJapgolly.babylonjs.meshesMeshMod.InstancesBatch
...
object renderingOutlineRendererMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      inline def apply(_outlineRenderer: OutlineRenderer, getOutlineRenderer: CallbackTo[OutlineRenderer]): typingsJapgolly.babylonjs.renderingOutlineRendererMod.babylonjsSceneAugmentingMod.Scene = {
        val __obj = js.Dynamic.literal(_outlineRenderer = _outlineRenderer.asInstanceOf[js.Any], getOutlineRenderer = getOutlineRenderer.toJsFn)
        __obj.asInstanceOf[typingsJapgolly.babylonjs.renderingOutlineRendererMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.renderingOutlineRendererMod.babylonjsSceneAugmentingMod.Scene](x: Self) {
        
        inline def setGetOutlineRenderer(value: CallbackTo[OutlineRenderer]): Self = StObject.set(x, "getOutlineRenderer", value.toJsFn)
