...
import typingsJapgolly.babylonjs.xRFeaturesWebXRHitTestLegacyMod.IWebXRLegacyHitResult
...
object xRFeaturesWebXRHitTestMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.babylonjs.sceneMod.IDisposable because Already inherited
  - typingsJapgolly.babylonjs.xRWebXRFeaturesManagerMod.IWebXRFeature because Already inherited
  - typingsJapgolly.babylonjs.xRFeaturesWebXRHitTestLegacyMod.IWebXRHitTestFeature because var conflicts: attached, dependsOn, disableAutoAttach, getXRSessionInitExtension, isDisposed, xrNativeFeatureName. Inlined onHitTestResultObservable */ @JSImport("babylonjs/XR/features/WebXRHitTest", "WebXRHitTest")
  @js.native
