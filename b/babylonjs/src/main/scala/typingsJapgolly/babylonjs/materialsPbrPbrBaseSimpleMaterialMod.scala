...
object materialsPbrPbrBaseSimpleMaterialMod {
  
  /* note: abstract class */ @JSImport("babylonjs/Materials/PBR/pbrBaseSimpleMaterial", "PBRBaseSimpleMaterial")
  @js.native
  open class PBRBaseSimpleMaterial protected () extends PBRBaseMaterial {
    /**
