...
import typingsJapgolly.babylonjs.anon.RemoveAttributes
import typingsJapgolly.babylonjs.anon.RepeatKey
...
import typingsJapgolly.babylonjs.materialsNodeNodeMaterialBuildStateSharedDataMod.NodeMaterialBuildStateSharedData
