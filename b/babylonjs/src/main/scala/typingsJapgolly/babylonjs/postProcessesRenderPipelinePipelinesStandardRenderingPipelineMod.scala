...
import typingsJapgolly.babylonjs.lightsSpotLightMod.SpotLight
import typingsJapgolly.babylonjs.materialsTexturesTextureMod.Texture
import typingsJapgolly.babylonjs.postProcessesBlurPostProcessMod.BlurPostProcess
import typingsJapgolly.babylonjs.postProcessesFxaaPostProcessMod.FxaaPostProcess
...
import typingsJapgolly.babylonjs.postProcessesScreenSpaceReflectionPostProcessMod.ScreenSpaceReflectionPostProcess
...
object postProcessesRenderPipelinePipelinesStandardRenderingPipelineMod {
  ...
  object StandardRenderingPipeline {
    ...
    /**
      ...
      */
    inline def Parse(source: Any, scene: Scene, rootUrl: String): StandardRenderingPipeline = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(source.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[StandardRenderingPipeline]
  }
}
