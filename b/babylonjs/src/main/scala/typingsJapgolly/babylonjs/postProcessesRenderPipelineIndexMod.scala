...
object postProcessesRenderPipelineIndexMod {
  ...
  open class DefaultRenderingPipeline ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesIndexMod.DefaultRenderingPipeline {
  ...
  open class PostProcessRenderEffect protected ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePostProcessRenderEffectMod.PostProcessRenderEffect {
    /**
  ...
  open class PostProcessRenderPipeline protected ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePostProcessRenderPipelineMod.PostProcessRenderPipeline {
    /**
  ...
  open class PostProcessRenderPipelineManager ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePostProcessRenderPipelineManagerMod.PostProcessRenderPipelineManager
  ...
  open class PostProcessRenderPipelineManagerSceneComponent protected ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePostProcessRenderPipelineManagerSceneComponentMod.PostProcessRenderPipelineManagerSceneComponent {
    /**
  ...
  open class SSAO2RenderingPipeline protected ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesIndexMod.SSAO2RenderingPipeline {
    /**
      * @constructor
      * @param name The rendering pipeline name
      * @param scene The scene linked to this pipeline
  ...
  object SSAO2RenderingPipeline {
    ...
    /**
      ...
      * @returns An instantiated pipeline from the serialized object.
      */
    inline def Parse(source: Any, scene: Scene, rootUrl: String): typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesSsao2RenderingPipelineMod.SSAO2RenderingPipeline = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(source.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesSsao2RenderingPipelineMod.SSAO2RenderingPipeline]
  }
  
  @JSImport("babylonjs/PostProcesses/RenderPipeline/index", "SSAORenderingPipeline")
  @js.native
  open class SSAORenderingPipeline protected ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesIndexMod.SSAORenderingPipeline {
    /**
      * @constructor
      * @param name - The rendering pipeline name
      * @param scene - The scene linked to this pipeline
  ...
  open class StandardRenderingPipeline protected ()
    extends typingsJapgolly.babylonjs.postProcessesRenderPipelinePipelinesIndexMod.StandardRenderingPipeline {
    /**
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      inline def apply(
      ...
      ): typingsJapgolly.babylonjs.postProcessesRenderPipelineIndexMod.babylonjsSceneAugmentingMod.Scene = {
        ...
        __obj.asInstanceOf[typingsJapgolly.babylonjs.postProcessesRenderPipelineIndexMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.postProcessesRenderPipelineIndexMod.babylonjsSceneAugmentingMod.Scene](x: Self) {
