...
@JSImport("babylonjs/Engines/index", "BlendFactor")
@js.native
object BlendFactor extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typingsJapgolly.babylonjs.enginesWebGPUWebgpuConstantsMod.BlendFactor & String] = js.native
