...
object gamepadsControllersIndexMod {
  ...
  open class DaydreamController protected ()
    extends typingsJapgolly.babylonjs.gamepadsControllersDaydreamControllerMod.DaydreamController {
    /**
  ...
  open class GearVRController protected ()
    extends typingsJapgolly.babylonjs.gamepadsControllersGearVRControllerMod.GearVRController {
    /**
  ...
  open class GenericController protected ()
    extends typingsJapgolly.babylonjs.gamepadsControllersGenericControllerMod.GenericController {
    /**
  ...
  open class OculusTouchController protected ()
    extends typingsJapgolly.babylonjs.gamepadsControllersOculusTouchControllerMod.OculusTouchController {
    /**
  ...
  open class PoseEnabledController protected ()
    extends typingsJapgolly.babylonjs.gamepadsControllersPoseEnabledControllerMod.PoseEnabledController {
    /**
  ...
  open class PoseEnabledControllerHelper ()
    extends typingsJapgolly.babylonjs.gamepadsControllersPoseEnabledControllerMod.PoseEnabledControllerHelper
  /* static members */
  ...
  object PoseEnabledControllerType extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.babylonjs.gamepadsControllersPoseEnabledControllerMod.PoseEnabledControllerType & Double
      ] = js.native
    
    /* 4 */ val DAYDREAM: typingsJapgolly.babylonjs.gamepadsControllersPoseEnabledControllerMod.PoseEnabledControllerType.DAYDREAM & Double = js.native
    
    /* 3 */ val GEAR_VR: typingsJapgolly.babylonjs.gamepadsControllersPoseEnabledControllerMod.PoseEnabledControllerType.GEAR_VR & Double = js.native
    
    /* 5 */ val GENERIC: typingsJapgolly.babylonjs.gamepadsControllersPoseEnabledControllerMod.PoseEnabledControllerType.GENERIC & Double = js.native
    
    /* 1 */ val OCULUS: typingsJapgolly.babylonjs.gamepadsControllersPoseEnabledControllerMod.PoseEnabledControllerType.OCULUS & Double = js.native
    
    /* 0 */ val VIVE: typingsJapgolly.babylonjs.gamepadsControllersPoseEnabledControllerMod.PoseEnabledControllerType.VIVE & Double = js.native
    
    /* 2 */ val WINDOWS: typingsJapgolly.babylonjs.gamepadsControllersPoseEnabledControllerMod.PoseEnabledControllerType.WINDOWS & Double = js.native
  }
  
  @JSImport("babylonjs/Gamepads/Controllers/index", "ViveController")
  @js.native
  open class ViveController protected ()
    extends typingsJapgolly.babylonjs.gamepadsControllersViveControllerMod.ViveController {
    /**
  ...
  open class WebVRController protected ()
    extends typingsJapgolly.babylonjs.gamepadsControllersWebVRControllerMod.WebVRController {
    /**
  ...
  open class WindowsMotionController protected ()
    extends typingsJapgolly.babylonjs.gamepadsControllersWindowsMotionControllerMod.WindowsMotionController {
    /**
  ...
  open class XRWindowsMotionController protected ()
    extends typingsJapgolly.babylonjs.gamepadsControllersWindowsMotionControllerMod.XRWindowsMotionController {
    /**
