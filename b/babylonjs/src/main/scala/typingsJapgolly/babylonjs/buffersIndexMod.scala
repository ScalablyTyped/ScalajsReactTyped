...
object buffersIndexMod {
  ...
  open class Buffer protected ()
    extends typingsJapgolly.babylonjs.buffersBufferMod.Buffer {
    /**
      * Constructor
  ...
  open class DataBuffer ()
    extends typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer
  /* static members */
  object DataBuffer {
  ...
  open class StorageBuffer protected ()
    extends typingsJapgolly.babylonjs.buffersStorageBufferMod.StorageBuffer {
    /**
  ...
  open class VertexBuffer protected ()
    extends typingsJapgolly.babylonjs.buffersBufferMod.VertexBuffer {
    /**
      * Constructor
      * @param engine the engine
    ...
    def this(
      engine: Any,
      data: DataArray | typingsJapgolly.babylonjs.buffersBufferMod.Buffer | typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer,
      kind: String,
      updatable: Boolean,
      postponeInternalCreation: js.UndefOr[Boolean],
      stride: js.UndefOr[Double],
