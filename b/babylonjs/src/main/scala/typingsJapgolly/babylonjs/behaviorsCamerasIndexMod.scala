...
object behaviorsCamerasIndexMod {
  ...
  open class AutoRotationBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsCamerasAutoRotationBehaviorMod.AutoRotationBehavior
  
  @JSImport("babylonjs/Behaviors/Cameras/index", "BouncingBehavior")
  @js.native
  open class BouncingBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsCamerasBouncingBehaviorMod.BouncingBehavior
  /* static members */
  ...
  open class FramingBehavior ()
    extends typingsJapgolly.babylonjs.behaviorsCamerasFramingBehaviorMod.FramingBehavior
  /* static members */
