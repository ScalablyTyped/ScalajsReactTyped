...
import typingsJapgolly.babylonjs.physicsPhysicsJointMod.DistanceJointData
...
object physicsIndexMod {
  ...
  open class AmmoJSPlugin ()
    extends typingsJapgolly.babylonjs.physicsPluginsIndexMod.AmmoJSPlugin {
  ...
  open class CannonJSPlugin ()
    extends typingsJapgolly.babylonjs.physicsPluginsIndexMod.CannonJSPlugin {
    def this(_useDeltaForWorldStep: Boolean) = this()
  ...
  open class DistanceJoint protected ()
    extends typingsJapgolly.babylonjs.physicsPhysicsJointMod.DistanceJoint {
    /**
      *
  ...
  open class Hinge2Joint protected ()
    extends typingsJapgolly.babylonjs.physicsPhysicsJointMod.Hinge2Joint {
    /**
  ...
  open class HingeJoint protected ()
    extends typingsJapgolly.babylonjs.physicsPhysicsJointMod.HingeJoint {
    /**
  ...
  open class MotorEnabledJoint protected ()
    extends typingsJapgolly.babylonjs.physicsPhysicsJointMod.MotorEnabledJoint {
    /**
  ...
  open class OimoJSPlugin ()
    extends typingsJapgolly.babylonjs.physicsPluginsIndexMod.OimoJSPlugin {
    def this(_useDeltaForWorldStep: Boolean) = this()
    def this(_useDeltaForWorldStep: Boolean, iterations: Double) = this()
    def this(_useDeltaForWorldStep: Unit, iterations: Double) = this()
  ...
  open class PhysicsEngine protected ()
    extends typingsJapgolly.babylonjs.physicsPhysicsEngineMod.PhysicsEngine {
    /**
  ...
  open class PhysicsEngineSceneComponent protected ()
    extends typingsJapgolly.babylonjs.physicsPhysicsEngineComponentMod.PhysicsEngineSceneComponent {
    /**
  ...
  open class PhysicsHelper protected ()
    extends typingsJapgolly.babylonjs.physicsPhysicsHelperMod.PhysicsHelper {
    /**
  ...
  open class PhysicsImpostor protected ()
    extends typingsJapgolly.babylonjs.physicsPhysicsImpostorMod.PhysicsImpostor {
    /**
  ...
  open class PhysicsJoint protected ()
    extends typingsJapgolly.babylonjs.physicsPhysicsJointMod.PhysicsJoint {
    /**
  ...
  open class PhysicsRadialExplosionEventOptions ()
    extends typingsJapgolly.babylonjs.physicsPhysicsHelperMod.PhysicsRadialExplosionEventOptions
  ...
  open class PhysicsUpdraftEventOptions ()
    extends typingsJapgolly.babylonjs.physicsPhysicsHelperMod.PhysicsUpdraftEventOptions
  ...
  open class PhysicsVortexEventOptions ()
    extends typingsJapgolly.babylonjs.physicsPhysicsHelperMod.PhysicsVortexEventOptions
