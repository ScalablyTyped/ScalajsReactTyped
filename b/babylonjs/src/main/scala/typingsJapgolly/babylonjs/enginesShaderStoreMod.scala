...
object enginesShaderStoreMod {
  
  @JSImport("babylonjs/Engines/shaderStore", "ShaderStore")
  @js.native
  open class ShaderStore () extends StObject
  /* static members */
  object ShaderStore {
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Engines/shaderStore", "ShaderStore.IncludesShadersStore")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Engines/shaderStore", "ShaderStore.IncludesShadersStoreWGSL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Engines/shaderStore", "ShaderStore.ShadersRepository")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Engines/shaderStore", "ShaderStore.ShadersRepositoryWGSL")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Engines/shaderStore", "ShaderStore.ShadersStore")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Engines/shaderStore", "ShaderStore.ShadersStoreWGSL")
    @js.native
