...
object xRFeaturesWebXRControllerMovementMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.babylonjs.anon.axisChangedHandleraxesIWe
    - typingsJapgolly.babylonjs.anon.buttonChangedhandlerpress
  */
  ...
  object WebXRControllerMovementRegistrationConfiguration {
    ...
    inline def axisChangedHandleraxesIWe(
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.anon.axisChangedHandleraxesIWe]
    }
    ...
    inline def buttonChangedhandlerpress(
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.anon.buttonChangedhandlerpress]
    }
  }
