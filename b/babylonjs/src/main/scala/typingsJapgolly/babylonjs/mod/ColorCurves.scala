...
open class ColorCurves ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.ColorCurves
/* static members */
object ColorCurves {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ColorCurves._ApplyColorGradingSliderNonlinear")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ColorCurves._Clamp")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ColorCurves._FromHSBToRef")
  @js.native
