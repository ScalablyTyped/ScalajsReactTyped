...
object babylonjsMaterialsMaterialAugmentingMod {
  ...
  object Material {
    ...
    inline def apply(): typingsJapgolly.babylonjs.mod.babylonjsMaterialsMaterialAugmentingMod.Material = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.babylonjs.mod.babylonjsMaterialsMaterialAugmentingMod.Material]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.mod.babylonjsMaterialsMaterialAugmentingMod.Material](x: Self) {
