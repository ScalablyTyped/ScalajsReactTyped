...
@JSImport("babylonjs", "WebXRImageTracking")
@js.native
open class WebXRImageTracking protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.WebXRImageTracking {
  /**
...
object WebXRImageTracking {
  ...
  /**
    * The module's name
    */
  @JSImport("babylonjs", "WebXRImageTracking.Name")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "WebXRImageTracking.Version")
  @js.native
