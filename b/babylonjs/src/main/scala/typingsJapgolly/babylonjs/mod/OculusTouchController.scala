...
open class OculusTouchController protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.OculusTouchController {
  /**
...
object OculusTouchController {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "OculusTouchController.MODEL_BASE_URL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "OculusTouchController.MODEL_LEFT_FILENAME")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "OculusTouchController.MODEL_RIGHT_FILENAME")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "OculusTouchController.QUEST_MODEL_BASE_URL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "OculusTouchController._IsQuest")
  @js.native
