...
open class RenderTargetTexture protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.RenderTargetTexture {
  /**
...
object RenderTargetTexture {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "RenderTargetTexture.REFRESHRATE_RENDER_ONCE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "RenderTargetTexture.REFRESHRATE_RENDER_ONEVERYFRAME")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "RenderTargetTexture.REFRESHRATE_RENDER_ONEVERYTWOFRAMES")
  @js.native
