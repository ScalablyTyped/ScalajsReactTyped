...
open class CascadedShadowGenerator protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.CascadedShadowGenerator {
  /**
    ...
    */
  def this(mapSize: Double, light: typingsJapgolly.babylonjs.lightsDirectionalLightMod.DirectionalLight) = this()
  def this(
    mapSize: Double,
...
object CascadedShadowGenerator {
  ...
  /**
    ...
    */
  inline def Parse(parsedShadowGenerator: Any, scene: typingsJapgolly.babylonjs.sceneMod.Scene): typingsJapgolly.babylonjs.lightsShadowsShadowGeneratorMod.ShadowGenerator = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedShadowGenerator.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.lightsShadowsShadowGeneratorMod.ShadowGenerator]
