...
open class Engine protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.Engine {
  /**
...
object Engine {
  ...
  inline def MarkAllMaterialsAsDirty(
    flag: Double,
    predicate: js.Function1[/* mat */ typingsJapgolly.babylonjs.materialsMaterialMod.Material, Boolean]
  ...
  def _RescalePostProcessFactory: Nullable[
    js.Function1[
      /* engine */ this.type, 
      typingsJapgolly.babylonjs.postProcessesPostProcessMod.PostProcess
    ]
  ] = js.native
