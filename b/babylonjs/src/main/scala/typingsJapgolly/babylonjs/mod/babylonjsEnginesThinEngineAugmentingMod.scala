...
import typingsJapgolly.babylonjs.computeComputeEffectMod.IComputeEffectCreationOptions
...
import typingsJapgolly.babylonjs.enginesIpipelinecontextMod.IPipelineContext
...
object babylonjsEnginesThinEngineAugmentingMod {
  ...
  trait ThinEngine extends StObject {
    ...
    def _createDepthStencilCubeTexture(
      ...
      rtWrapper: typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.RenderTargetWrapper
    ): typingsJapgolly.babylonjs.materialsTexturesInternalTextureMod.InternalTexture = js.native
    ...
    /** @internal */
    def _createHardwareRenderTargetWrapper(isMulti: Boolean, isCube: Boolean, size: TextureSize): typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.RenderTargetWrapper = js.native
    ...
    /** @internal */
    def _releaseComputeEffect(effect: typingsJapgolly.babylonjs.computeComputeEffectMod.ComputeEffect): Unit = js.native
    ...
    /**
      ...
      */
    def bindUniformBuffer(buffer: Nullable[typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer]): Unit = js.native
    ...
    /**
      ...
      */
    def bindUniformBufferBase(buffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer, location: Double, name: String): Unit = js.native
    ...
    /**
      ...
      */
    def computeDispatch(
      effect: typingsJapgolly.babylonjs.computeComputeEffectMod.ComputeEffect,
    ...
    /**
      ...
      */
    def createComputeEffect(baseName: Any, options: IComputeEffectCreationOptions): typingsJapgolly.babylonjs.computeComputeEffectMod.ComputeEffect = js.native
    ...
    def createCubeTexture(
      ...
      lodScale: Double,
      lodOffset: Double,
      fallback: Nullable[typingsJapgolly.babylonjs.materialsTexturesInternalTextureMod.InternalTexture],
      loaderOptions: Any,
    ...
    /**
      ...
      */
    def createDynamicTexture(width: Double, height: Double, generateMipMaps: Boolean, samplingMode: Double): typingsJapgolly.babylonjs.materialsTexturesInternalTextureMod.InternalTexture = js.native
    ...
    /**
      ...
      */
    def createDynamicUniformBuffer(elements: FloatArray): typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer = js.native
    ...
    /**
      ...
      */
    def createExternalTexture(video: HTMLVideoElement): Nullable[typingsJapgolly.babylonjs.materialsTexturesExternalTextureMod.ExternalTexture] = js.native
    ...
    /**
      ...
      */
    def createMultipleRenderTarget(size: TextureSize, options: IMultiRenderTargetOptions): typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.RenderTargetWrapper = js.native
    def createMultipleRenderTarget(size: TextureSize, options: IMultiRenderTargetOptions, initializeBuffers: Boolean): typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.RenderTargetWrapper = js.native
    ...
    /**
      ...
      */
    def createRenderTargetCubeTexture(size: Double): typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.RenderTargetWrapper = js.native
    def createRenderTargetCubeTexture(size: Double, options: PartialRenderTargetCreati): typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.RenderTargetWrapper = js.native
    ...
    /**
      ...
      */
    def createRenderTargetTexture(size: TextureSize, options: Boolean): typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.RenderTargetWrapper = js.native
    def createRenderTargetTexture(size: TextureSize, options: RenderTargetCreationOptions): typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.RenderTargetWrapper = js.native
    
    def createStorageBuffer(data: Double, creationFlags: Double): typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer = js.native
    /**
      ...
      */
    def createStorageBuffer(data: DataArray, creationFlags: Double): typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer = js.native
    ...
    /**
      ...
      * @returns the webGL uniform buffer
      */
    def createUniformBuffer(elements: FloatArray): typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer = js.native
    ...
    /**
      ...
      */
    def readFromStorageBuffer(storageBuffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer): js.Promise[js.typedarray.ArrayBufferView] = js.native
    def readFromStorageBuffer(storageBuffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer, offset: Double): js.Promise[js.typedarray.ArrayBufferView] = js.native
    def readFromStorageBuffer(
      storageBuffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer,
      offset: Double,
      size: Double
    ): js.Promise[js.typedarray.ArrayBufferView] = js.native
    def readFromStorageBuffer(
    ...
    def setExternalTexture(
      name: String,
      texture: Nullable[typingsJapgolly.babylonjs.materialsTexturesExternalTextureMod.ExternalTexture]
    ): Unit = js.native
    ...
    /**
      ...
      */
    def setStorageBuffer(name: String, buffer: Nullable[typingsJapgolly.babylonjs.buffersStorageBufferMod.StorageBuffer]): Unit = js.native
    ...
    def setTextureSampler(
      name: String,
      sampler: Nullable[typingsJapgolly.babylonjs.materialsTexturesTextureSamplerMod.TextureSampler]
    ): Unit = js.native
    ...
    /**
      ...
      */
    def updateDynamicIndexBuffer(indexBuffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer, indices: IndicesArray): Unit = js.native
    def updateDynamicIndexBuffer(
      indexBuffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer,
    ...
    def updateDynamicTexture(
      texture: Nullable[typingsJapgolly.babylonjs.materialsTexturesInternalTextureMod.InternalTexture],
    ...
    /**
      ...
      */
    def updateDynamicVertexBuffer(vertexBuffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer, data: DataArray): Unit = js.native
    def updateDynamicVertexBuffer(
      vertexBuffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer,
      data: DataArray,
      byteOffset: Double
    ): Unit = js.native
    def updateDynamicVertexBuffer(
    ...
    def updateMultipleRenderTargetTextureSampleCount(
      rtWrapper: Nullable[typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.RenderTargetWrapper],
      samples: Double
    ): Double = js.native
    def updateMultipleRenderTargetTextureSampleCount(
      rtWrapper: Nullable[typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.RenderTargetWrapper],
    ...
    /**
      ...
      * @param byteLength the byte length of the data
      */
    def updateStorageBuffer(buffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer, data: DataArray): Unit = js.native
    def updateStorageBuffer(
      buffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer,
      data: DataArray,
      byteOffset: Double
    ): Unit = js.native
    def updateStorageBuffer(
    ...
    /**
      ...
      */
    def updateUniformBuffer(uniformBuffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer, elements: FloatArray): Unit = js.native
    def updateUniformBuffer(
      uniformBuffer: typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer,
      elements: FloatArray,
      offset: Double
    ): Unit = js.native
    def updateUniformBuffer(
