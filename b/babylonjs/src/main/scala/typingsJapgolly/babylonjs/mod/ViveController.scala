...
open class ViveController protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.ViveController {
  /**
...
object ViveController {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ViveController.MODEL_BASE_URL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ViveController.MODEL_FILENAME")
  @js.native
