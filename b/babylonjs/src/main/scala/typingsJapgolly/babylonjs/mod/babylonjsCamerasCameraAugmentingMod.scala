...
object babylonjsCamerasCameraAugmentingMod {
  ...
  object Camera {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.babylonjs.mod.babylonjsCamerasCameraAugmentingMod.Camera = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.mod.babylonjsCamerasCameraAugmentingMod.Camera]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.mod.babylonjsCamerasCameraAugmentingMod.Camera](x: Self) {
