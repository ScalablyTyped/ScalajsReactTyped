...
@JSImport("babylonjs", "ShaderStore")
@js.native
open class ShaderStore ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.ShaderStore
/* static members */
object ShaderStore {
  ...
  inline def GetIncludesShadersStore(shaderLanguage: typingsJapgolly.babylonjs.materialsShaderLanguageMod.ShaderLanguage): org.scalablytyped.runtime.StringDictionary[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("GetIncludesShadersStore")(shaderLanguage.asInstanceOf[js.Any]).asInstanceOf[org.scalablytyped.runtime.StringDictionary[String]]
  ...
  inline def GetShadersRepository(shaderLanguage: typingsJapgolly.babylonjs.materialsShaderLanguageMod.ShaderLanguage): String = ^.asInstanceOf[js.Dynamic].applyDynamic("GetShadersRepository")(shaderLanguage.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def GetShadersStore(shaderLanguage: typingsJapgolly.babylonjs.materialsShaderLanguageMod.ShaderLanguage): org.scalablytyped.runtime.StringDictionary[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("GetShadersStore")(shaderLanguage.asInstanceOf[js.Any]).asInstanceOf[org.scalablytyped.runtime.StringDictionary[String]]
  
  /**
    * Store of each included file for a shader (The can be looked up using effect.key)
    */
  @JSImport("babylonjs", "ShaderStore.IncludesShadersStore")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShaderStore.IncludesShadersStoreWGSL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShaderStore.ShadersRepository")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShaderStore.ShadersRepositoryWGSL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShaderStore.ShadersStore")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ShaderStore.ShadersStoreWGSL")
  @js.native
