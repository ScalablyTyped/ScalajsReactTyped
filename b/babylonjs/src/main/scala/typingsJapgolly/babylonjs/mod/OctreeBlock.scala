...
open class OctreeBlock[T] protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.OctreeBlock[T] {
  /**
    * Creates a new block
    ...
    */
  def this(
    minPoint: typingsJapgolly.babylonjs.mathsMathDotvectorMod.Vector3,
    maxPoint: typingsJapgolly.babylonjs.mathsMathDotvectorMod.Vector3,
    capacity: Double,
    depth: Double,
    maxDepth: Double,
...
object OctreeBlock {
  ...
  inline def _CreateBlocks[T](
    worldMin: typingsJapgolly.babylonjs.mathsMathDotvectorMod.Vector3,
    worldMax: typingsJapgolly.babylonjs.mathsMathDotvectorMod.Vector3,
    entries: js.Array[T],
