...
object babylonjsAbstractSceneAugmentingMod {
  ...
  object AbstractScene {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.babylonjs.mod.babylonjsAbstractSceneAugmentingMod.AbstractScene = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.mod.babylonjsAbstractSceneAugmentingMod.AbstractScene]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.mod.babylonjsAbstractSceneAugmentingMod.AbstractScene](x: Self) {
