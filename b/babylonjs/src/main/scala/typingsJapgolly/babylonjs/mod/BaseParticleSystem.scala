...
open class BaseParticleSystem protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.BaseParticleSystem {
  /**
...
object BaseParticleSystem {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "BaseParticleSystem.BLENDMODE_ADD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "BaseParticleSystem.BLENDMODE_MULTIPLY")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "BaseParticleSystem.BLENDMODE_MULTIPLYADD")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "BaseParticleSystem.BLENDMODE_ONEONE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "BaseParticleSystem.BLENDMODE_STANDARD")
  @js.native
