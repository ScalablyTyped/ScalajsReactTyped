...
import typingsJapgolly.babylonjs.nodeMod.NodeConstructor
...
open class Node protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.Node {
  /**
    * Creates a new Node
  ...
  def this(name: String, scene: Nullable[typingsJapgolly.babylonjs.sceneMod.Scene]) = this()
}
/* static members */
object Node {
  ...
  /**
    ...
    */
  inline def Construct(`type`: String, name: String, scene: typingsJapgolly.babylonjs.sceneMod.Scene): Nullable[js.Function0[this.type]] = (^.asInstanceOf[js.Dynamic].applyDynamic("Construct")(`type`.asInstanceOf[js.Any], name.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[Nullable[js.Function0[this.type]]]
  ...
  /**
    * @internal
    */
  inline def _AnimationRangeFactory(_name: String, _from: Double, _to: Double): typingsJapgolly.babylonjs.animationsAnimationRangeMod.AnimationRange = (^.asInstanceOf[js.Dynamic].applyDynamic("_AnimationRangeFactory")(_name.asInstanceOf[js.Any], _from.asInstanceOf[js.Any], _to.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.animationsAnimationRangeMod.AnimationRange]
