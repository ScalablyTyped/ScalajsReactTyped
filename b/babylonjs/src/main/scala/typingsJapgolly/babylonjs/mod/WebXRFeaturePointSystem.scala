...
open class WebXRFeaturePointSystem protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.WebXRFeaturePointSystem {
  /**
...
object WebXRFeaturePointSystem {
  ...
  /**
    * The module's name
    */
  @JSImport("babylonjs", "WebXRFeaturePointSystem.Name")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "WebXRFeaturePointSystem.Version")
  @js.native
