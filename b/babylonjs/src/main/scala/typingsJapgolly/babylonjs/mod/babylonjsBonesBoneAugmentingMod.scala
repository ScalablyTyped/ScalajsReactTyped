...
object babylonjsBonesBoneAugmentingMod {
  ...
  object Bone {
    ...
    ): typingsJapgolly.babylonjs.mod.babylonjsBonesBoneAugmentingMod.Bone = {
      val __obj = js.Dynamic.literal(copyAnimationRange = js.Any.fromFunction5(copyAnimationRange))
      __obj.asInstanceOf[typingsJapgolly.babylonjs.mod.babylonjsBonesBoneAugmentingMod.Bone]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.mod.babylonjsBonesBoneAugmentingMod.Bone](x: Self) {
