...
@JSImport("babylonjs", "WebXREyeTracking")
@js.native
open class WebXREyeTracking protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.WebXREyeTracking {
  /**
...
object WebXREyeTracking {
  ...
  /**
    * The module's name
    */
  @JSImport("babylonjs", "WebXREyeTracking.Name")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "WebXREyeTracking.Version")
  @js.native
