...
object babylonjsMaterialsTexturesBaseTextureAugmentingMod {
  ...
  object BaseTexture {
    ...
    inline def apply(forceSphericalPolynomialsRecompute: Callback): typingsJapgolly.babylonjs.mod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.mod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.mod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture](x: Self) {
