...
open class Geometry protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.Geometry {
  /**
  ...
  def this(id: String, scene: typingsJapgolly.babylonjs.sceneMod.Scene) = this()
  def this(
    id: String,
    scene: Unit,
  ...
  def this(id: String, scene: typingsJapgolly.babylonjs.sceneMod.Scene, vertexData: Unit, updatable: Boolean) = this()
  def this(
    id: String,
    scene: typingsJapgolly.babylonjs.sceneMod.Scene,
    vertexData: typingsJapgolly.babylonjs.meshesMeshDotvertexDataMod.VertexData,
...
object Geometry {
  ...
  @JSImport("babylonjs", "Geometry._GetGeometryByLoadedUniqueId")
  @js.native
