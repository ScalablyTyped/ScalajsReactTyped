...
open class PivotTools ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.PivotTools
/* static members */
object PivotTools {
  ...
  /**
    * @internal
    */
  inline def _RemoveAndStorePivotPoint(mesh: typingsJapgolly.babylonjs.meshesTransformNodeMod.TransformNode): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("_RemoveAndStorePivotPoint")(mesh.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  /**
    * @internal
    */
  inline def _RestorePivotPoint(mesh: typingsJapgolly.babylonjs.meshesTransformNodeMod.TransformNode): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("_RestorePivotPoint")(mesh.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
