...
open class EdgesRenderer protected ()
  extends typingsJapgolly.babylonjs.legacyLegacyMod.EdgesRenderer {
  /**
    ...
    */
  def this(source: typingsJapgolly.babylonjs.meshesAbstractMeshMod.AbstractMesh) = this()
  def this(source: typingsJapgolly.babylonjs.meshesAbstractMeshMod.AbstractMesh, epsilon: Double) = this()
  def this(
