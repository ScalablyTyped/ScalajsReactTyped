...
import typingsJapgolly.babylonjs.deviceInputInputDevicesDeviceEnumsMod.PointerInput
import typingsJapgolly.babylonjs.deviceInputInputDevicesDeviceEnumsMod.PointerInput.Horizontal
import typingsJapgolly.babylonjs.deviceInputInputDevicesDeviceEnumsMod.PointerInput.MouseWheelX
import typingsJapgolly.babylonjs.deviceInputInputDevicesDeviceEnumsMod.PointerInput.MouseWheelY
import typingsJapgolly.babylonjs.deviceInputInputDevicesDeviceEnumsMod.PointerInput.MouseWheelZ
import typingsJapgolly.babylonjs.deviceInputInputDevicesDeviceEnumsMod.PointerInput.Vertical
import typingsJapgolly.std.Exclude
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object eventsDeviceInputEventsMod {
  ...
  object DeviceInputEventType extends StObject {
    ...
    /* 1 */ val PointerDown: typingsJapgolly.babylonjs.eventsDeviceInputEventsMod.DeviceInputEventType.PointerDown & Double = js.native
    ...
    sealed trait PointerMove
      extends StObject
         with DeviceInputEventType
    /* 0 */ val PointerMove: typingsJapgolly.babylonjs.eventsDeviceInputEventsMod.DeviceInputEventType.PointerMove & Double = js.native
    ...
    sealed trait PointerUp
      extends StObject
         with DeviceInputEventType
    /* 2 */ val PointerUp: typingsJapgolly.babylonjs.eventsDeviceInputEventsMod.DeviceInputEventType.PointerUp & Double = js.native
  }
  ...
  object IKeyboardEvent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(altKey = altKey.asInstanceOf[js.Any], code = code.asInstanceOf[js.Any], ctrlKey = ctrlKey.asInstanceOf[js.Any], inputIndex = inputIndex.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any], keyCode = keyCode.asInstanceOf[js.Any], metaKey = metaKey.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, shiftKey = shiftKey.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any])
  ...
  object IPointerEvent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(altKey = altKey.asInstanceOf[js.Any], button = button.asInstanceOf[js.Any], buttons = buttons.asInstanceOf[js.Any], clientX = clientX.asInstanceOf[js.Any], clientY = clientY.asInstanceOf[js.Any], ctrlKey = ctrlKey.asInstanceOf[js.Any], inputIndex = inputIndex.asInstanceOf[js.Any], metaKey = metaKey.asInstanceOf[js.Any], movementX = movementX.asInstanceOf[js.Any], movementY = movementY.asInstanceOf[js.Any], offsetX = offsetX.asInstanceOf[js.Any], offsetY = offsetY.asInstanceOf[js.Any], pageX = pageX.asInstanceOf[js.Any], pageY = pageY.asInstanceOf[js.Any], pointerId = pointerId.asInstanceOf[js.Any], pointerType = pointerType.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, shiftKey = shiftKey.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
