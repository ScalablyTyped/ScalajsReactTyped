...
import typingsJapgolly.babylonjs.enginesRenderTargetWrapperMod.IRenderTargetTexture
...
object materialsEffectRendererMod {
  ...
  object EffectWrapperCreationOptions {
    ...
    extension [Self <: EffectWrapperCreationOptions](x: Self) {
      ...
      inline def setOnCompiled(value: /* effect */ Effect => Callback): Self = StObject.set(x, "onCompiled", js.Any.fromFunction1((t0: /* effect */ Effect) => value(t0).runNow()))
