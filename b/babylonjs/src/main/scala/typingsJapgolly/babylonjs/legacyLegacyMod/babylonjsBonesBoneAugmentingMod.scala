...
object babylonjsBonesBoneAugmentingMod {
  ...
  object Bone {
    ...
    ): typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsBonesBoneAugmentingMod.Bone = {
      val __obj = js.Dynamic.literal(copyAnimationRange = js.Any.fromFunction5(copyAnimationRange))
      __obj.asInstanceOf[typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsBonesBoneAugmentingMod.Bone]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsBonesBoneAugmentingMod.Bone](x: Self) {
