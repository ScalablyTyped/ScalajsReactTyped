...
object babylonjsMaterialsMaterialAugmentingMod {
  ...
  object Material {
    ...
    inline def apply(): typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsMaterialsMaterialAugmentingMod.Material = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsMaterialsMaterialAugmentingMod.Material]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsMaterialsMaterialAugmentingMod.Material](x: Self) {
