...
@js.native
open class Logger ()
  extends typingsJapgolly.babylonjs.indexMod.Logger
/* static members */
object Logger {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "Logger.MessageLimitReached")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "Logger._CheckLimit")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "Logger._GenerateLimitMessage")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "Logger._Levels")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "Logger._LogLimitOutputs")
  @js.native
