...
object babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod {
  ...
  object RenderTargetTexture {
    ...
    inline def apply(): typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod.RenderTargetTexture = {
      val __obj = js.Dynamic.literal(_prePassRenderTarget = null)
      __obj.asInstanceOf[typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod.RenderTargetTexture]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod.RenderTargetTexture](x: Self) {
