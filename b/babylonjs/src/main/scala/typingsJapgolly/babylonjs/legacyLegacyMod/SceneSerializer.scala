...
open class SceneSerializer ()
  extends typingsJapgolly.babylonjs.indexMod.SceneSerializer
/* static members */
object SceneSerializer {
  ...
  /**
    ...
    */
  inline def Serialize(scene: typingsJapgolly.babylonjs.sceneMod.Scene): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Serialize")(scene.asInstanceOf[js.Any]).asInstanceOf[Any]
  ...
  /**
    ...
    */
  inline def SerializeAsync(scene: typingsJapgolly.babylonjs.sceneMod.Scene): js.Promise[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("SerializeAsync")(scene.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Any]]
