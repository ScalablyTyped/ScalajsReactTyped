...
@JSImport("babylonjs/Legacy/legacy", "ArcRotateCameraPointersInput")
@js.native
open class ArcRotateCameraPointersInput ()
  extends typingsJapgolly.babylonjs.indexMod.ArcRotateCameraPointersInput
/* static members */
object ArcRotateCameraPointersInput {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "ArcRotateCameraPointersInput.MinimumRadiusForPinch")
  @js.native
