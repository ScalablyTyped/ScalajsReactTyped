...
import typingsJapgolly.babylonjs.anon.JsDecoderModule
...
open class KhronosTextureContainer2 protected ()
  extends typingsJapgolly.babylonjs.indexMod.KhronosTextureContainer2 {
  /**
    * Constructor
  ...
  def this(engine: typingsJapgolly.babylonjs.enginesThinEngineMod.ThinEngine, numWorkers: Double) = this()
}
/* static members */
object KhronosTextureContainer2 {
  ...
  @JSImport("babylonjs/Legacy/legacy", "KhronosTextureContainer2._DecoderModulePromise")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "KhronosTextureContainer2._Initialize")
  @js.native
