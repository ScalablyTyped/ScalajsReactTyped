...
object babylonjsAbstractSceneAugmentingMod {
  ...
  object AbstractScene {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsAbstractSceneAugmentingMod.AbstractScene = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsAbstractSceneAugmentingMod.AbstractScene]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsAbstractSceneAugmentingMod.AbstractScene](x: Self) {
