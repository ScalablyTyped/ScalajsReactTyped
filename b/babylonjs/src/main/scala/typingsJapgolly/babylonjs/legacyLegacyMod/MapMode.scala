...
@JSImport("babylonjs/Legacy/legacy", "MapMode")
@js.native
object MapMode extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typingsJapgolly.babylonjs.enginesWebGPUWebgpuConstantsMod.MapMode & Double] = js.native
