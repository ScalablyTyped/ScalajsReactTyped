...
/* note: abstract class */ @JSImport("babylonjs/Legacy/legacy", "WebXRAbstractMotionController")
@js.native
open class WebXRAbstractMotionController protected ()
  extends typingsJapgolly.babylonjs.indexMod.WebXRAbstractMotionController {
  /**
