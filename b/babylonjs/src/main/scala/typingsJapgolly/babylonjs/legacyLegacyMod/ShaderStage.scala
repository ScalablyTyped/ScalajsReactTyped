...
@JSImport("babylonjs/Legacy/legacy", "ShaderStage")
@js.native
object ShaderStage extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typingsJapgolly.babylonjs.enginesWebGPUWebgpuConstantsMod.ShaderStage & Double] = js.native
