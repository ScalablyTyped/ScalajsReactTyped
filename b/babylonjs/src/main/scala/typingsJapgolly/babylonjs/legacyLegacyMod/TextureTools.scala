...
object TextureTools {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "TextureTools.ApplyPostProcess")
  @js.native
  ...
  def CreateResizedCopy: js.Function4[
    ...
    typingsJapgolly.babylonjs.materialsTexturesTextureMod.Texture
  ] = js.native
  /**
    * Uses the GPU to create a copy texture rescaled at a given size
    * @param texture Texture to copy from
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "TextureTools.FromHalfFloat")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "TextureTools.ToHalfFloat")
  @js.native
