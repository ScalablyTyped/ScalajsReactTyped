...
@JSImport("babylonjs/Legacy/legacy", "VertexAnimationBaker")
@js.native
open class VertexAnimationBaker protected ()
  extends typingsJapgolly.babylonjs.indexMod.VertexAnimationBaker {
  /**
    ...
    */
  def this(scene: typingsJapgolly.babylonjs.sceneMod.Scene, mesh: Mesh) = this()
}
