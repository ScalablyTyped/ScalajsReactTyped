...
open class TransformNode protected ()
  extends typingsJapgolly.babylonjs.indexMod.TransformNode {
  ...
  def this(name: String, scene: Nullable[typingsJapgolly.babylonjs.sceneMod.Scene], isPure: Boolean) = this()
}
/* static members */
object TransformNode {
  ...
  /**
    ...
    * @returns a new TransformNode object parsed from the source provided.
    */
  inline def Parse(parsedTransformNode: Any, scene: typingsJapgolly.babylonjs.sceneMod.Scene, rootUrl: String): typingsJapgolly.babylonjs.meshesTransformNodeMod.TransformNode = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedTransformNode.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.meshesTransformNodeMod.TransformNode]
