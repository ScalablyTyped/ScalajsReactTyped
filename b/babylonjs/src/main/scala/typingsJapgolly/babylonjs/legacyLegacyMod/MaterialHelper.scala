...
open class MaterialHelper ()
  extends typingsJapgolly.babylonjs.indexMod.MaterialHelper
/* static members */
object MaterialHelper {
  ...
  inline def BindBonesParameters(mesh: Unit, effect: typingsJapgolly.babylonjs.materialsEffectMod.Effect): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("BindBonesParameters")(mesh.asInstanceOf[js.Any], effect.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def BindBonesParameters(mesh: typingsJapgolly.babylonjs.meshesAbstractMeshMod.AbstractMesh): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("BindBonesParameters")(mesh.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def BindBonesParameters(
  ...
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("BindClipPlane")(effect.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def BindLight(
    light: typingsJapgolly.babylonjs.lightsLightMod.Light,
    lightIndex: Double,
    scene: typingsJapgolly.babylonjs.sceneMod.Scene,
    effect: typingsJapgolly.babylonjs.materialsEffectMod.Effect,
    useSpecular: Boolean
  ...
  inline def BindMorphTargetParameters(
    abstractMesh: typingsJapgolly.babylonjs.meshesAbstractMeshMod.AbstractMesh,
    effect: typingsJapgolly.babylonjs.materialsEffectMod.Effect
  ...
  inline def BindSceneUniformBuffer(
    effect: typingsJapgolly.babylonjs.materialsEffectMod.Effect,
    sceneUbo: typingsJapgolly.babylonjs.materialsUniformBufferMod.UniformBuffer
  ...
  inline def BindTextureMatrix(
    ...
    uniformBuffer: typingsJapgolly.babylonjs.materialsUniformBufferMod.UniformBuffer,
    key: String
  ...
  /**
    ...
    */
  inline def HandleFallbacksForShadows(defines: Any, fallbacks: typingsJapgolly.babylonjs.materialsEffectFallbacksMod.EffectFallbacks): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("HandleFallbacksForShadows")(defines.asInstanceOf[js.Any], fallbacks.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def HandleFallbacksForShadows(
    defines: Any,
    fallbacks: typingsJapgolly.babylonjs.materialsEffectFallbacksMod.EffectFallbacks,
    maxSimultaneousLights: Double
  ...
  /**
    ...
    */
  inline def PrepareAttributesForInstances(
    attribs: js.Array[String],
    defines: typingsJapgolly.babylonjs.materialsMaterialDefinesMod.MaterialDefines
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareAttributesForInstances")(attribs.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param defines The defines to update
    */
  inline def PrepareDefinesForBakedVertexAnimation(mesh: typingsJapgolly.babylonjs.meshesAbstractMeshMod.AbstractMesh, defines: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForBakedVertexAnimation")(mesh.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param defines The defines to update
    */
  inline def PrepareDefinesForBones(mesh: typingsJapgolly.babylonjs.meshesAbstractMeshMod.AbstractMesh, defines: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForBones")(mesh.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param key The channel key "diffuse", "specular"... used in the shader
    */
  inline def PrepareDefinesForMergedUV(
    texture: typingsJapgolly.babylonjs.materialsTexturesBaseTextureMod.BaseTexture,
    defines: Any,
    key: String
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForMergedUV")(texture.asInstanceOf[js.Any], defines.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param defines The defines to update
    */
  inline def PrepareDefinesForMorphTargets(mesh: typingsJapgolly.babylonjs.meshesAbstractMeshMod.AbstractMesh, defines: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForMorphTargets")(mesh.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param defines The defines to update
    */
  inline def PrepareDefinesForMultiview(scene: typingsJapgolly.babylonjs.sceneMod.Scene, defines: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForMultiview")(scene.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def PrepareDefinesForOIT(scene: typingsJapgolly.babylonjs.sceneMod.Scene, defines: Any, needAlphaBlending: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForOIT")(scene.asInstanceOf[js.Any], defines.asInstanceOf[js.Any], needAlphaBlending.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def PrepareDefinesForPrePass(scene: typingsJapgolly.babylonjs.sceneMod.Scene, defines: Any, canRenderToMRT: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForPrePass")(scene.asInstanceOf[js.Any], defines.asInstanceOf[js.Any], canRenderToMRT.asInstanceOf[js.Any])).asInstanceOf[Unit]
