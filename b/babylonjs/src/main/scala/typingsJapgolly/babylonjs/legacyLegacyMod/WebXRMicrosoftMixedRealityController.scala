...
open class WebXRMicrosoftMixedRealityController protected ()
  extends typingsJapgolly.babylonjs.indexMod.WebXRMicrosoftMixedRealityController {
  def this(
...
object WebXRMicrosoftMixedRealityController {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRMicrosoftMixedRealityController.MODEL_BASE_URL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRMicrosoftMixedRealityController.MODEL_LEFT_FILENAME")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRMicrosoftMixedRealityController.MODEL_RIGHT_FILENAME")
  @js.native
