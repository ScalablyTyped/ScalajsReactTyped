...
open class Trajectory ()
  extends typingsJapgolly.babylonjs.indexMod.Trajectory {
...
object Trajectory {
  ...
  /**
    ...
    */
  inline def Deserialize(json: String): typingsJapgolly.babylonjs.miscTrajectoryClassifierMod.Trajectory = ^.asInstanceOf[js.Dynamic].applyDynamic("Deserialize")(json.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.babylonjs.miscTrajectoryClassifierMod.Trajectory]
