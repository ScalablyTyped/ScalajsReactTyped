...
object babylonjsMeshesSubMeshAugmentingMod {
  ...
  object SubMesh {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh](x: Self) {
