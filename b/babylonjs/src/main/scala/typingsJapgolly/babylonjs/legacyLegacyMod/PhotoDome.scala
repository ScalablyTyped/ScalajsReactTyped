...
open class PhotoDome protected ()
  extends typingsJapgolly.babylonjs.indexMod.PhotoDome {
  /**
...
object PhotoDome {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "PhotoDome.MODE_MONOSCOPIC")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "PhotoDome.MODE_SIDEBYSIDE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "PhotoDome.MODE_TOPBOTTOM")
  @js.native
