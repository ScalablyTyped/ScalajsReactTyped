...
object babylonjsEnginesEngineAugmentingMod {
  ...
  trait Engine extends StObject {
    ...
    /** @internal */
    var _currentNonTimestampToken: Nullable[typingsJapgolly.babylonjs.instrumentationTimeTokenMod.TimeToken] = js.native
    ...
    /** @internal */
    var _gpuFrameTime: typingsJapgolly.babylonjs.miscPerfCounterMod.PerfCounter = js.native
    
    /** @internal */
    var _gpuFrameTimeToken: Nullable[typingsJapgolly.babylonjs.instrumentationTimeTokenMod.TimeToken] = js.native
    ...
    /** @internal */
    var _oldSize: typingsJapgolly.babylonjs.mathsMathDotsizeMod.Size = js.native
    
    /** @internal */
    var _onBeginFrameObserver: Nullable[
        typingsJapgolly.babylonjs.miscObservableMod.Observer[
    ...
    /**
      ...
      */
    def bindTransformFeedbackBuffer(value: Nullable[typingsJapgolly.babylonjs.buffersDataBufferMod.DataBuffer]): Unit = js.native
    ...
    /**
      ...
      */
    def createEffectForParticles(fragmentName: String, uniformsNames: js.Array[String], samplers: js.Array[String], defines: String): typingsJapgolly.babylonjs.materialsEffectMod.Effect = js.native
    def createEffectForParticles(
      ...
      defines: String,
      fallbacks: Unit,
      onCompiled: js.Function1[/* effect */ typingsJapgolly.babylonjs.materialsEffectMod.Effect, Unit]
    ): typingsJapgolly.babylonjs.materialsEffectMod.Effect = js.native
    def createEffectForParticles(
      fragmentName: String,
      uniformsNames: js.Array[String],
      samplers: js.Array[String],
    ...
    /**
      ...
      */
    def endTimeQuery(token: typingsJapgolly.babylonjs.instrumentationTimeTokenMod.TimeToken): int = js.native
    ...
    /**
      ...
      */
    def getGPUFrameTimeCounter(): typingsJapgolly.babylonjs.miscPerfCounterMod.PerfCounter = js.native
    ...
    /**
      ...
      */
    val onAfterViewRenderObservable: typingsJapgolly.babylonjs.miscObservableMod.Observable[typingsJapgolly.babylonjs.enginesExtensionsEngineDotviewsMod.EngineView] = js.native
    
    /**
      * Will be triggered before the view renders
      */
    val onBeforeViewRenderObservable: typingsJapgolly.babylonjs.miscObservableMod.Observable[typingsJapgolly.babylonjs.enginesExtensionsEngineDotviewsMod.EngineView] = js.native
    
    /**
      * Observable signaled when VR display mode changes
      */
    var onVRDisplayChangedObservable: typingsJapgolly.babylonjs.miscObservableMod.Observable[IDisplayChangedEventArgs] = js.native
    
    /**
      * Observable signaled when VR request present is complete
      */
    var onVRRequestPresentComplete: typingsJapgolly.babylonjs.miscObservableMod.Observable[Boolean] = js.native
    
    /**
      * Observable signaled when VR request present starts
      */
    var onVRRequestPresentStart: typingsJapgolly.babylonjs.miscObservableMod.Observable[
    ...
    def registerView(canvas: HTMLCanvasElement, camera: typingsJapgolly.babylonjs.camerasCameraMod.Camera): typingsJapgolly.babylonjs.enginesExtensionsEngineDotviewsMod.EngineView = js.native
    def registerView(
      canvas: HTMLCanvasElement,
      camera: typingsJapgolly.babylonjs.camerasCameraMod.Camera,
      clearBeforeCopy: Boolean
    ): typingsJapgolly.babylonjs.enginesExtensionsEngineDotviewsMod.EngineView = js.native
    ...
    /**
      ...
      */
    def startTimeQuery(): Nullable[typingsJapgolly.babylonjs.instrumentationTimeTokenMod.TimeToken] = js.native
