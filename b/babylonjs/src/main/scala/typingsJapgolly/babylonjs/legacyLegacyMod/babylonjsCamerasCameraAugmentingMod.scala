...
object babylonjsCamerasCameraAugmentingMod {
  ...
  trait Camera extends StObject {
    ...
    /**
      ...
      */
    var _multiviewTexture: Nullable[
  ...
  object Camera {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsCamerasCameraAugmentingMod.Camera = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsCamerasCameraAugmentingMod.Camera]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.legacyLegacyMod.babylonjsCamerasCameraAugmentingMod.Camera](x: Self) {
      
      inline def set_multiviewTexture(
        value: Nullable[
              typingsJapgolly.babylonjs.materialsTexturesRenderTargetTextureMod.RenderTargetTexture
            ]
      ): Self = StObject.set(x, "_multiviewTexture", value.asInstanceOf[js.Any])
