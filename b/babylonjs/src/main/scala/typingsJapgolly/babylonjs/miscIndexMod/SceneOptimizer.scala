...
open class SceneOptimizer protected ()
  extends typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizer {
  /**
  ...
  def this(scene: Scene, options: typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizerOptions) = this()
...
object SceneOptimizer {
  ...
  /**
    ...
    */
  inline def OptimizeAsync(scene: Scene): typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizer = ^.asInstanceOf[js.Dynamic].applyDynamic("OptimizeAsync")(scene.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizer]
  ...
  inline def OptimizeAsync(scene: Scene, options: Unit, onSuccess: js.Function0[Unit], onFailure: js.Function0[Unit]): typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizer = (^.asInstanceOf[js.Dynamic].applyDynamic("OptimizeAsync")(scene.asInstanceOf[js.Any], options.asInstanceOf[js.Any], onSuccess.asInstanceOf[js.Any], onFailure.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizer]
  inline def OptimizeAsync(scene: Scene, options: Unit, onSuccess: Unit, onFailure: js.Function0[Unit]): typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizer = (^.asInstanceOf[js.Dynamic].applyDynamic("OptimizeAsync")(scene.asInstanceOf[js.Any], options.asInstanceOf[js.Any], onSuccess.asInstanceOf[js.Any], onFailure.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizer]
  inline def OptimizeAsync(scene: Scene, options: typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizerOptions): typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizer = (^.asInstanceOf[js.Dynamic].applyDynamic("OptimizeAsync")(scene.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.miscSceneOptimizerMod.SceneOptimizer]
