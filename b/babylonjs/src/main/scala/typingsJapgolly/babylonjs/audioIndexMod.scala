...
object audioIndexMod {
  ...
  /**
    ...
    */
  open class Analyser ()
    extends typingsJapgolly.babylonjs.audioAnalyserMod.Analyser {
  ...
  open class AudioEngine ()
    extends typingsJapgolly.babylonjs.audioAudioEngineMod.AudioEngine {
  ...
  open class AudioSceneComponent ()
    extends typingsJapgolly.babylonjs.audioAudioSceneComponentMod.AudioSceneComponent {
    def this(scene: Nullable[Scene]) = this()
  }
  /* static members */
  ...
  open class Sound protected ()
    extends typingsJapgolly.babylonjs.audioSoundMod.Sound {
    /**
  ...
  object Sound {
    ...
    /**
      ...
      */
    inline def Parse(parsedSound: Any, scene: Scene, rootUrl: String): typingsJapgolly.babylonjs.audioSoundMod.Sound = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedSound.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.audioSoundMod.Sound]
    inline def Parse(
      parsedSound: Any,
      scene: Scene,
      rootUrl: String,
  ...
  open class SoundTrack ()
    extends typingsJapgolly.babylonjs.audioSoundTrackMod.SoundTrack {
    def this(scene: Nullable[Scene]) = this()
  ...
  open class WeightedSound protected ()
    extends typingsJapgolly.babylonjs.audioWeightedsoundMod.WeightedSound {
    /**
  ...
  object babylonjsSceneAugmentingMod {
    ...
    trait Scene extends StObject {
      ...
      /**
        ...
        * Backing field
        */
      var _mainSoundTrack: typingsJapgolly.babylonjs.audioSoundTrackMod.SoundTrack
      ...
      /**
        ...
        */
      def getSoundByName(name: String): Nullable[typingsJapgolly.babylonjs.audioSoundMod.Sound]
      ...
      /**
        ...
        */
      var mainSoundTrack: typingsJapgolly.babylonjs.audioSoundTrackMod.SoundTrack
      
      /**
        * The list of sound tracks added to the scene
        * @see https://doc.babylonjs.com/how_to/playing_sounds_and_music
        */
      var soundTracks: Nullable[js.Array[typingsJapgolly.babylonjs.audioSoundTrackMod.SoundTrack]]
    }
    object Scene {
      
      inline def apply(
        _mainSoundTrack: typingsJapgolly.babylonjs.audioSoundTrackMod.SoundTrack,
        audioEnabled: Boolean,
        audioPositioningRefreshRate: Double,
        getSoundByName: String => Nullable[typingsJapgolly.babylonjs.audioSoundMod.Sound],
        headphone: Boolean,
        mainSoundTrack: typingsJapgolly.babylonjs.audioSoundTrackMod.SoundTrack
      ): typingsJapgolly.babylonjs.audioIndexMod.babylonjsSceneAugmentingMod.Scene = {
        ...
        __obj.asInstanceOf[typingsJapgolly.babylonjs.audioIndexMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.audioIndexMod.babylonjsSceneAugmentingMod.Scene](x: Self) {
        
        inline def setAudioEnabled(value: Boolean): Self = StObject.set(x, "audioEnabled", value.asInstanceOf[js.Any])
        
        inline def setAudioListenerPositionProvider(value: CallbackTo[Vector3]): Self = StObject.set(x, "audioListenerPositionProvider", value.toJsFn)
        ...
        inline def setGetSoundByName(value: String => Nullable[typingsJapgolly.babylonjs.audioSoundMod.Sound]): Self = StObject.set(x, "getSoundByName", js.Any.fromFunction1(value))
        
        inline def setHeadphone(value: Boolean): Self = StObject.set(x, "headphone", value.asInstanceOf[js.Any])
        
        inline def setMainSoundTrack(value: typingsJapgolly.babylonjs.audioSoundTrackMod.SoundTrack): Self = StObject.set(x, "mainSoundTrack", value.asInstanceOf[js.Any])
        
        inline def setSoundTracks(value: Nullable[js.Array[typingsJapgolly.babylonjs.audioSoundTrackMod.SoundTrack]]): Self = StObject.set(x, "soundTracks", value.asInstanceOf[js.Any])
        
        inline def setSoundTracksNull: Self = StObject.set(x, "soundTracks", null)
        
        inline def setSoundTracksVarargs(value: typingsJapgolly.babylonjs.audioSoundTrackMod.SoundTrack*): Self = StObject.set(x, "soundTracks", js.Array(value*))
        
        inline def set_mainSoundTrack(value: typingsJapgolly.babylonjs.audioSoundTrackMod.SoundTrack): Self = StObject.set(x, "_mainSoundTrack", value.asInstanceOf[js.Any])
      }
    }
  }
}
