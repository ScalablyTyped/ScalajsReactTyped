...
@JSImport("babylonjs/Gamepads/index", "WindowsMotionController")
@js.native
open class WindowsMotionController protected ()
  extends typingsJapgolly.babylonjs.gamepadsControllersIndexMod.WindowsMotionController {
  /**
...
object WindowsMotionController {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "WindowsMotionController.GAMEPAD_ID_PATTERN")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "WindowsMotionController.GAMEPAD_ID_PREFIX")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "WindowsMotionController.MODEL_BASE_URL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "WindowsMotionController.MODEL_LEFT_FILENAME")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "WindowsMotionController.MODEL_RIGHT_FILENAME")
  @js.native
