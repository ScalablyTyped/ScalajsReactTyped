...
open class PoseEnabledController protected ()
  extends typingsJapgolly.babylonjs.gamepadsControllersIndexMod.PoseEnabledController {
  /**
...
object PoseEnabledController {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Gamepads/index", "PoseEnabledController.POINTING_POSE")
  @js.native
