...
object xRMotionControllerIndexMod {
  
  /* note: abstract class */ @JSImport("babylonjs/XR/motionController/index", "WebXRAbstractMotionController")
  @js.native
  open class WebXRAbstractMotionController protected ()
    extends typingsJapgolly.babylonjs.xRMotionControllerWebXRAbstractMotionControllerMod.WebXRAbstractMotionController {
    /**
  ...
  open class WebXRControllerComponent protected ()
    extends typingsJapgolly.babylonjs.xRMotionControllerWebXRControllerComponentMod.WebXRControllerComponent {
    /**
  ...
  open class WebXRGenericHandController protected ()
    extends typingsJapgolly.babylonjs.xRMotionControllerWebXRGenericHandControllerMod.WebXRGenericHandController {
    /**
  ...
  open class WebXRGenericTriggerMotionController protected ()
    extends typingsJapgolly.babylonjs.xRMotionControllerWebXRGenericMotionControllerMod.WebXRGenericTriggerMotionController {
    def this(
      scene: Scene,
      gamepadObject: IMinimalMotionControllerObject,
      handedness: MotionControllerHandedness
  ...
  open class WebXRHTCViveMotionController protected ()
    extends typingsJapgolly.babylonjs.xRMotionControllerWebXRHTCViveMotionControllerMod.WebXRHTCViveMotionController {
    /**
  ...
  open class WebXRMicrosoftMixedRealityController protected ()
    extends typingsJapgolly.babylonjs.xRMotionControllerWebXRMicrosoftMixedRealityControllerMod.WebXRMicrosoftMixedRealityController {
    def this(
      scene: Scene,
      gamepadObject: IMinimalMotionControllerObject,
      handedness: MotionControllerHandedness
  ...
  open class WebXRMotionControllerManager ()
    extends typingsJapgolly.babylonjs.xRMotionControllerWebXRMotionControllerManagerMod.WebXRMotionControllerManager
  /* static members */
  ...
  open class WebXROculusTouchMotionController protected ()
    extends typingsJapgolly.babylonjs.xRMotionControllerWebXROculusTouchMotionControllerMod.WebXROculusTouchMotionController {
    def this(
      scene: Scene,
      gamepadObject: IMinimalMotionControllerObject,
      handedness: MotionControllerHandedness
  ...
  open class WebXRProfiledMotionController protected ()
    extends typingsJapgolly.babylonjs.xRMotionControllerWebXRProfiledMotionControllerMod.WebXRProfiledMotionController {
