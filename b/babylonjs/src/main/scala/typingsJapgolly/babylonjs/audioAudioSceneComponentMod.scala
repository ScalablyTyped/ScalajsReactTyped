...
object audioAudioSceneComponentMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      inline def apply(
      ...
      ): typingsJapgolly.babylonjs.audioAudioSceneComponentMod.babylonjsSceneAugmentingMod.Scene = {
        ...
        __obj.asInstanceOf[typingsJapgolly.babylonjs.audioAudioSceneComponentMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.audioAudioSceneComponentMod.babylonjsSceneAugmentingMod.Scene](x: Self) {
