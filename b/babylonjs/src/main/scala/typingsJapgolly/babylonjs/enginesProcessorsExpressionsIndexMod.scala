...
object enginesProcessorsExpressionsIndexMod {
  ...
  open class ShaderDefineAndOperator ()
    extends typingsJapgolly.babylonjs.enginesProcessorsExpressionsOperatorsIndexMod.ShaderDefineAndOperator
  ...
  open class ShaderDefineArithmeticOperator protected ()
    extends typingsJapgolly.babylonjs.enginesProcessorsExpressionsOperatorsIndexMod.ShaderDefineArithmeticOperator {
  ...
  open class ShaderDefineExpression ()
    extends typingsJapgolly.babylonjs.enginesProcessorsExpressionsShaderDefineExpressionMod.ShaderDefineExpression
  /* static members */
  ...
  open class ShaderDefineIsDefinedOperator protected ()
    extends typingsJapgolly.babylonjs.enginesProcessorsExpressionsOperatorsIndexMod.ShaderDefineIsDefinedOperator {
  ...
  open class ShaderDefineOrOperator ()
    extends typingsJapgolly.babylonjs.enginesProcessorsExpressionsOperatorsIndexMod.ShaderDefineOrOperator
}
