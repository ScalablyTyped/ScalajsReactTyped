...
import typingsJapgolly.babylonjs.camerasVRWebVRCameraMod.DevicePose
import typingsJapgolly.babylonjs.camerasVRWebVRCameraMod.PoseControlled
...
object gamepadsControllersPoseEnabledControllerMod {
  ...
  trait GamePadFactory extends StObject {
    ...
    /**
      ...
      */
    def create(gamepadInfo: Any): typingsJapgolly.babylonjs.gamepadsGamepadMod.Gamepad
  }
  object GamePadFactory {
    
    inline def apply(canCreate: Any => Boolean, create: Any => typingsJapgolly.babylonjs.gamepadsGamepadMod.Gamepad): GamePadFactory = {
    ...
    extension [Self <: GamePadFactory](x: Self) {
      ...
      inline def setCreate(value: Any => typingsJapgolly.babylonjs.gamepadsGamepadMod.Gamepad): Self = StObject.set(x, "create", js.Any.fromFunction1(value))
    }
  }
