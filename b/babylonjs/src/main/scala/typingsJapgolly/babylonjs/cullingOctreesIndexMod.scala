...
object cullingOctreesIndexMod {
  ...
  open class Octree[T] protected ()
    extends typingsJapgolly.babylonjs.cullingOctreesOctreeMod.Octree[T] {
    /**
      * Creates a octree
  ...
  open class OctreeBlock[T] protected ()
    extends typingsJapgolly.babylonjs.cullingOctreesOctreeBlockMod.OctreeBlock[T] {
    /**
      * Creates a new block
  ...
  open class OctreeSceneComponent ()
    extends typingsJapgolly.babylonjs.cullingOctreesOctreeSceneComponentMod.OctreeSceneComponent {
