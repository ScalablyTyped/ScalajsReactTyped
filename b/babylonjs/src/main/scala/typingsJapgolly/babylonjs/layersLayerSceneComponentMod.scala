...
import typingsJapgolly.babylonjs.layersLayerMod.Layer
...
object layersLayerSceneComponentMod {
  ...
  object babylonjsAbstractSceneAugmentingMod {
    ...
    object AbstractScene {
      ...
      inline def apply(layers: js.Array[Layer]): typingsJapgolly.babylonjs.layersLayerSceneComponentMod.babylonjsAbstractSceneAugmentingMod.AbstractScene = {
        val __obj = js.Dynamic.literal(layers = layers.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.babylonjs.layersLayerSceneComponentMod.babylonjsAbstractSceneAugmentingMod.AbstractScene]
      }
      
      extension [Self <: typingsJapgolly.babylonjs.layersLayerSceneComponentMod.babylonjsAbstractSceneAugmentingMod.AbstractScene](x: Self) {
