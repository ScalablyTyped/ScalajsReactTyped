...
import typingsJapgolly.babylonjs.anon.WheelDeltaX
...
object camerasInputsBaseCameraMouseWheelInputMod {
  
  /* note: abstract class */ @JSImport("babylonjs/Cameras/Inputs/BaseCameraMouseWheelInput", "BaseCameraMouseWheelInput")
  @js.native
