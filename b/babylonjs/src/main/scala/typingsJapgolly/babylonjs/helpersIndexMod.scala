...
object helpersIndexMod {
  ...
  open class EnvironmentHelper protected ()
    extends typingsJapgolly.babylonjs.helpersEnvironmentHelperMod.EnvironmentHelper {
    /**
      * constructor
  ...
  open class PhotoDome protected ()
    extends typingsJapgolly.babylonjs.helpersPhotoDomeMod.PhotoDome {
    /**
  ...
  open class VideoDome protected ()
    extends typingsJapgolly.babylonjs.helpersVideoDomeMod.VideoDome {
    /**
      * Create an instance of this class and pass through the parameters to the relevant classes- Texture, StandardMaterial, and Mesh.
      * @param name Element's name, child elements will append suffixes for their own names.
      * @param textureUrlOrElement defines the url(s) or the (video) HTML element to use
