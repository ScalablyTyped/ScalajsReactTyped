...
import typingsJapgolly.babylonjs.xRFeaturesWebXRPlaneDetectorMod.IWebXRPlaneDetectorOptions
...
open class WebXRPlaneDetector protected ()
  extends typingsJapgolly.babylonjs.xRFeaturesWebXRPlaneDetectorMod.WebXRPlaneDetector {
  /**
