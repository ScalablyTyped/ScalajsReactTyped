...
@JSImport("babylonjs/XR/features/index", "WebXRProjectionLayerWrapper")
@js.native
open class WebXRProjectionLayerWrapper protected ()
  extends typingsJapgolly.babylonjs.xRFeaturesWebXRLayersMod.WebXRProjectionLayerWrapper {
