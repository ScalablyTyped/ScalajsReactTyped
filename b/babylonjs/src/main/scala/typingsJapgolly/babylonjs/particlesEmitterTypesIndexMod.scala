...
object particlesEmitterTypesIndexMod {
  ...
  open class BoxParticleEmitter ()
    extends typingsJapgolly.babylonjs.particlesEmitterTypesBoxParticleEmitterMod.BoxParticleEmitter
  ...
  open class ConeParticleEmitter ()
    extends typingsJapgolly.babylonjs.particlesEmitterTypesConeParticleEmitterMod.ConeParticleEmitter {
  ...
  open class CustomParticleEmitter ()
    extends typingsJapgolly.babylonjs.particlesEmitterTypesCustomParticleEmitterMod.CustomParticleEmitter
  ...
  open class CylinderDirectedParticleEmitter ()
    extends typingsJapgolly.babylonjs.particlesEmitterTypesCylinderParticleEmitterMod.CylinderDirectedParticleEmitter {
    def this(radius: Double) = this()
  ...
  open class CylinderParticleEmitter ()
    extends typingsJapgolly.babylonjs.particlesEmitterTypesCylinderParticleEmitterMod.CylinderParticleEmitter {
    def this(/**
  ...
  open class HemisphericParticleEmitter ()
    extends typingsJapgolly.babylonjs.particlesEmitterTypesHemisphericParticleEmitterMod.HemisphericParticleEmitter {
    def this(/**
  ...
  open class MeshParticleEmitter ()
    extends typingsJapgolly.babylonjs.particlesEmitterTypesMeshParticleEmitterMod.MeshParticleEmitter {
  ...
  open class PointParticleEmitter ()
    extends typingsJapgolly.babylonjs.particlesEmitterTypesPointParticleEmitterMod.PointParticleEmitter
  ...
  open class SphereDirectedParticleEmitter ()
    extends typingsJapgolly.babylonjs.particlesEmitterTypesSphereParticleEmitterMod.SphereDirectedParticleEmitter {
    def this(radius: Double) = this()
  ...
  open class SphereParticleEmitter ()
    extends typingsJapgolly.babylonjs.particlesEmitterTypesSphereParticleEmitterMod.SphereParticleEmitter {
    def this(/**
