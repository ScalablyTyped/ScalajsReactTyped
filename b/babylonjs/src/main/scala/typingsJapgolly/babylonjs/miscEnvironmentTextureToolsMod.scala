...
import typingsJapgolly.babylonjs.babylonjsInts.`2`
...
object miscEnvironmentTextureToolsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV1
    - typingsJapgolly.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV2
  */
  trait EnvironmentTextureInfo extends StObject
  object EnvironmentTextureInfo {
    
    inline def EnvironmentTextureInfoV1(irradiance: Any, specular: Any, width: Double): typingsJapgolly.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV1 = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV1]
    }
    
    inline def EnvironmentTextureInfoV2(imageType: String, irradiance: Any, specular: Any, width: Double): typingsJapgolly.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV2 = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV2]
    }
  }
