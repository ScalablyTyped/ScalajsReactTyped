...
object statesIndexMod {
  ...
  open class AlphaState ()
    extends typingsJapgolly.babylonjs.statesAlphaCullingStateMod.AlphaState
  ...
  open class DepthCullingState ()
    extends typingsJapgolly.babylonjs.statesDepthCullingStateMod.DepthCullingState {
  ...
  open class StencilState ()
    extends typingsJapgolly.babylonjs.statesStencilStateMod.StencilState
  /* static members */
  object StencilState {
  ...
  open class StencilStateComposer ()
    extends typingsJapgolly.babylonjs.statesStencilStateComposerMod.StencilStateComposer {
    def this(reset: Boolean) = this()
  }
}
