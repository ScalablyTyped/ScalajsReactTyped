...
object materialsNodeBlocksDualIndexMod {
  
  @JSImport("babylonjs/Materials/Node/Blocks/Dual/index", "ClipPlanesBlock")
  @js.native
  open class ClipPlanesBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksDualClipPlanesBlockMod.ClipPlanesBlock {
    /**
  ...
  open class CurrentScreenBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksDualCurrentScreenBlockMod.CurrentScreenBlock {
    /**
  ...
  open class FogBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksDualFogBlockMod.FogBlock {
    /**
  ...
  open class ImageSourceBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksDualImageSourceBlockMod.ImageSourceBlock {
    /**
  ...
  open class LightBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksDualLightBlockMod.LightBlock {
    /**
  ...
  open class ReflectionTextureBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksDualReflectionTextureBlockMod.ReflectionTextureBlock {
    /**
  ...
  open class SceneDepthBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksDualSceneDepthBlockMod.SceneDepthBlock {
    /**
  ...
  open class TextureBlock protected ()
    extends typingsJapgolly.babylonjs.materialsNodeBlocksDualTextureBlockMod.TextureBlock {
    /**
