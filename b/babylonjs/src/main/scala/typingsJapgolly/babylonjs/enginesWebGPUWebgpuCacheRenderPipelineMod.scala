...
import typingsJapgolly.babylonjs.anon.Pipeline
...
object enginesWebGPUWebgpuCacheRenderPipelineMod {
  
  /* note: abstract class */ @JSImport("babylonjs/Engines/WebGPU/webgpuCacheRenderPipeline", "WebGPUCacheRenderPipeline")
  @js.native
  open class WebGPUCacheRenderPipeline protected () extends StObject {
