...
object meshesCompressionIndexMod {
  ...
  open class DracoCompression ()
    extends typingsJapgolly.babylonjs.meshesCompressionDracoCompressionMod.DracoCompression {
  ...
  open class MeshoptCompression ()
    extends typingsJapgolly.babylonjs.meshesCompressionMeshoptCompressionMod.MeshoptCompression
  /* static members */
