...
object babylonjsMeshesSubMeshAugmentingMod {
  ...
  object SubMesh {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.babylonjs.meshesIndexMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh = {
      ...
      __obj.asInstanceOf[typingsJapgolly.babylonjs.meshesIndexMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh]
    }
    
    extension [Self <: typingsJapgolly.babylonjs.meshesIndexMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh](x: Self) {
