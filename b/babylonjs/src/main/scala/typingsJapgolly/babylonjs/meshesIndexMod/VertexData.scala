...
open class VertexData ()
  extends typingsJapgolly.babylonjs.meshesMeshDotvertexDataMod.VertexData
/* static members */
object VertexData {
  ...
  /**
    ...
    */
  inline def CreateGroundFromHeightMap(options: Buffer): typingsJapgolly.babylonjs.meshesMeshDotvertexDataMod.VertexData = ^.asInstanceOf[js.Dynamic].applyDynamic("CreateGroundFromHeightMap")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.babylonjs.meshesMeshDotvertexDataMod.VertexData]
  ...
  /**
    ...
    */
  inline def CreatePlane(options: Size): typingsJapgolly.babylonjs.meshesMeshDotvertexDataMod.VertexData = ^.asInstanceOf[js.Dynamic].applyDynamic("CreatePlane")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.babylonjs.meshesMeshDotvertexDataMod.VertexData]
  ...
  inline def CreatePolygon(polygon: Mesh, sideOrientation: Double, fUV: js.Array[Vector4]): typingsJapgolly.babylonjs.meshesMeshDotvertexDataMod.VertexData = (^.asInstanceOf[js.Dynamic].applyDynamic("CreatePolygon")(polygon.asInstanceOf[js.Any], sideOrientation.asInstanceOf[js.Any], fUV.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.meshesMeshDotvertexDataMod.VertexData]
