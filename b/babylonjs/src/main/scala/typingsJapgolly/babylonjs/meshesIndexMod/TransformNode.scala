...
open class TransformNode protected ()
  extends typingsJapgolly.babylonjs.meshesTransformNodeMod.TransformNode {
...
object TransformNode {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Meshes/index", "TransformNode.BILLBOARDMODE_ALL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Meshes/index", "TransformNode.BILLBOARDMODE_NONE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Meshes/index", "TransformNode.BILLBOARDMODE_USE_POSITION")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Meshes/index", "TransformNode.BILLBOARDMODE_X")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Meshes/index", "TransformNode.BILLBOARDMODE_Y")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Meshes/index", "TransformNode.BILLBOARDMODE_Z")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Meshes/index", "TransformNode.BillboardUseParentOrientation")
  @js.native
  ...
  /**
    ...
    * @returns a new TransformNode object parsed from the source provided.
    */
  inline def Parse(parsedTransformNode: Any, scene: Scene, rootUrl: String): typingsJapgolly.babylonjs.meshesTransformNodeMod.TransformNode = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedTransformNode.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.babylonjs.meshesTransformNodeMod.TransformNode]
