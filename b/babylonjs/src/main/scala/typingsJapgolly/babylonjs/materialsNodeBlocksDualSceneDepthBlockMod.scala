...
object materialsNodeBlocksDualSceneDepthBlockMod {
  
  @JSImport("babylonjs/Materials/Node/Blocks/Dual/sceneDepthBlock", "SceneDepthBlock")
  @js.native
  open class SceneDepthBlock protected () extends NodeMaterialBlock {
    /**
