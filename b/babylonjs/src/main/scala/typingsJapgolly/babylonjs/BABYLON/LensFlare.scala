...
object LensFlare {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(_drawWrapper = _drawWrapper.asInstanceOf[js.Any], _system = _system.asInstanceOf[js.Any], alphaMode = alphaMode.asInstanceOf[js.Any], color = color.asInstanceOf[js.Any], dispose = dispose.toJsFn, position = position.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any], texture = null)
