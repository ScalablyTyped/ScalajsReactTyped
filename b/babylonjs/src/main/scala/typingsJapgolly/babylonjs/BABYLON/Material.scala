...
trait Material
  ...
  /* protected */ var _onEffectCreatedObservable: Nullable[Observable[typingsJapgolly.babylonjs.anon.SubMesh]] = js.native
  ...
  /**
    ...
    */
  def onEffectCreatedObservable: Observable[typingsJapgolly.babylonjs.anon.SubMesh] = js.native
