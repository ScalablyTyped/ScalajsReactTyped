...
object Spherical {
  ...
  extension [Self <: Spherical](x: Self) {
    ...
    inline def setToVector3(value: CallbackTo[Vector3]): Self = StObject.set(x, "toVector3", value.toJsFn)
