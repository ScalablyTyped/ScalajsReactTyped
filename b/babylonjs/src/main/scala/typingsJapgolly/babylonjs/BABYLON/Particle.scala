...
object Particle {
  ...
  inline def apply(
    ...
    _inheritParticleInfoToSubEmitter: SubEmitter => Callback,
    _inheritParticleInfoToSubEmitters: Callback,
  ...
  extension [Self <: Particle](x: Self) {
    ...
    inline def setCopyTo(value: Particle => Callback): Self = StObject.set(x, "copyTo", js.Any.fromFunction1((t0: Particle) => value(t0).runNow()))
    ...
    inline def setUpdateCellIndex(value: Callback): Self = StObject.set(x, "updateCellIndex", value.toJsFn)
    ...
    inline def set_inheritParticleInfoToSubEmitter(value: SubEmitter => Callback): Self = StObject.set(x, "_inheritParticleInfoToSubEmitter", js.Any.fromFunction1((t0: SubEmitter) => value(t0).runNow()))
    
    inline def set_inheritParticleInfoToSubEmitters(value: Callback): Self = StObject.set(x, "_inheritParticleInfoToSubEmitters", value.toJsFn)
