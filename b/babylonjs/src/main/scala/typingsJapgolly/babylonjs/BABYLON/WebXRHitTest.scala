...
- typingsJapgolly.babylonjs.BABYLON.IWebXRFeature because Already inherited
- typingsJapgolly.babylonjs.BABYLON.IWebXRHitTestFeature because var conflicts: attached, dependsOn, disableAutoAttach, getXRSessionInitExtension, isDisposed, xrNativeFeatureName. Inlined onHitTestResultObservable */ @js.native
trait WebXRHitTest
  extends StObject
