...
object Polar {
  ...
  extension [Self <: Polar](x: Self) {
    ...
    inline def setToVector2(value: CallbackTo[Vector2]): Self = StObject.set(x, "toVector2", value.toJsFn)
