...
object KhronosTextureContainer {
  ...
  extension [Self <: KhronosTextureContainer](x: Self) {
    ...
    inline def setUploadLevels(value: (InternalTexture, Boolean) => Callback): Self = StObject.set(x, "uploadLevels", js.Any.fromFunction2((t0: InternalTexture, t1: Boolean) => (value(t0, t1)).runNow()))
