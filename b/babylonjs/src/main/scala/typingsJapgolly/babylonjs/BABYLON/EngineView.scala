...
object EngineView {
  ...
  extension [Self <: EngineView](x: Self) {
    ...
    inline def setCustomResize(value: /* canvas */ HTMLCanvasElement => Callback): Self = StObject.set(x, "customResize", js.Any.fromFunction1((t0: /* canvas */ HTMLCanvasElement) => value(t0).runNow()))
