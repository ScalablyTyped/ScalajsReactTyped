...
object NodeMaterialBuildStateSharedData {
  ...
  extension [Self <: NodeMaterialBuildStateSharedData](x: Self) {
    ...
    inline def setEmitErrors(value: Callback): Self = StObject.set(x, "emitErrors", value.toJsFn)
