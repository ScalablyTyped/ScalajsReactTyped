...
object BoundingBoxRenderer {
  ...
  extension [Self <: BoundingBoxRenderer](x: Self) {
    ...
    inline def setRender(value: Double => Callback): Self = StObject.set(x, "render", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    
    inline def setRenderList(value: SmartArray[BoundingBox]): Self = StObject.set(x, "renderList", value.asInstanceOf[js.Any])
    
    inline def setRenderOcclusionBoundingBox(value: AbstractMesh => Callback): Self = StObject.set(x, "renderOcclusionBoundingBox", js.Any.fromFunction1((t0: AbstractMesh) => value(t0).runNow()))
