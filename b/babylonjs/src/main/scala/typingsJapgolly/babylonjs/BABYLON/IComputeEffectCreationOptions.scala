...
object IComputeEffectCreationOptions {
  ...
  extension [Self <: IComputeEffectCreationOptions](x: Self) {
    ...
    inline def setOnCompiled(value: /* effect */ ComputeEffect => Callback): Self = StObject.set(x, "onCompiled", js.Any.fromFunction1((t0: /* effect */ ComputeEffect) => value(t0).runNow()))
    
    inline def setOnCompiledNull: Self = StObject.set(x, "onCompiled", null)
    
    inline def setOnError(value: (/* effect */ ComputeEffect, /* errors */ String) => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction2((t0: /* effect */ ComputeEffect, t1: /* errors */ String) => (value(t0, t1)).runNow()))
