...
import typingsJapgolly.babylonjs.anon.InsertFirst
...
object ITimerOptions {
  ...
  extension [Self <: ITimerOptions[?], T](x: Self & ITimerOptions[T]) {
    ...
    inline def setOnAborted(value: /* data */ ITimerData[Any] => Callback): Self = StObject.set(x, "onAborted", js.Any.fromFunction1((t0: /* data */ ITimerData[Any]) => value(t0).runNow()))
    
    inline def setOnAbortedUndefined: Self = StObject.set(x, "onAborted", js.undefined)
    
    inline def setOnEnded(value: /* data */ ITimerData[Any] => Callback): Self = StObject.set(x, "onEnded", js.Any.fromFunction1((t0: /* data */ ITimerData[Any]) => value(t0).runNow()))
    
    inline def setOnEndedUndefined: Self = StObject.set(x, "onEnded", js.undefined)
    
    inline def setOnTick(value: /* data */ ITimerData[Any] => Callback): Self = StObject.set(x, "onTick", js.Any.fromFunction1((t0: /* data */ ITimerData[Any]) => value(t0).runNow()))
