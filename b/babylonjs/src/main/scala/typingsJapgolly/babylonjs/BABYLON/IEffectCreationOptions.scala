...
object IEffectCreationOptions {
  ...
  extension [Self <: IEffectCreationOptions](x: Self) {
    ...
    inline def setOnError(value: (/* effect */ Effect, /* errors */ String) => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction2((t0: /* effect */ Effect, t1: /* errors */ String) => (value(t0, t1)).runNow()))
