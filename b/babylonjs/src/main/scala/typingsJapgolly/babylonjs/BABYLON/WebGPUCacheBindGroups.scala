...
object WebGPUCacheBindGroups {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(_cacheSampler = _cacheSampler.asInstanceOf[js.Any], _device = _device.asInstanceOf[js.Any], _engine = _engine.asInstanceOf[js.Any], disabled = disabled.asInstanceOf[js.Any], endFrame = endFrame.toJsFn, getBindGroups = js.Any.fromFunction3(getBindGroups))
  ...
  extension [Self <: WebGPUCacheBindGroups](x: Self) {
    ...
    inline def setEndFrame(value: Callback): Self = StObject.set(x, "endFrame", value.toJsFn)
