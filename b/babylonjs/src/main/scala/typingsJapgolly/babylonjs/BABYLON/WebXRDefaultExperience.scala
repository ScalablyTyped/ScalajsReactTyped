...
object WebXRDefaultExperience {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(baseExperience = baseExperience.asInstanceOf[js.Any], dispose = dispose.toJsFn, enterExitUI = enterExitUI.asInstanceOf[js.Any], input = input.asInstanceOf[js.Any], nearInteraction = nearInteraction.asInstanceOf[js.Any], pointerSelection = pointerSelection.asInstanceOf[js.Any], renderTarget = renderTarget.asInstanceOf[js.Any], teleportation = teleportation.asInstanceOf[js.Any])
