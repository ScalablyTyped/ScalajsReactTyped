...
- typingsJapgolly.babylonjs.BABYLON.IAnimatable because var conflicts: animations. Inlined 
...
trait GPUParticleSystem
  ...
  /**
    ...
    */
  def clone(name: String, newEmitter: Any): GPUParticleSystem = js.native
  /**
    * Clones the particle system.
    * @param name The name of the cloned object
    * @param newEmitter The new emitter to use
