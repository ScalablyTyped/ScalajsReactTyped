...
object IShaderProcessor {
  ...
  extension [Self <: IShaderProcessor](x: Self) {
    ...
    inline def setInitializeShaders(value: /* processingContext */ Nullable[ShaderProcessingContext] => Callback): Self = StObject.set(x, "initializeShaders", js.Any.fromFunction1((t0: /* processingContext */ Nullable[ShaderProcessingContext]) => value(t0).runNow()))
