...
object IGPUParticleSystemPlatform {
  ...
  extension [Self <: IGPUParticleSystemPlatform](x: Self) {
    ...
    inline def setCreateVertexBuffers(value: (Buffer, org.scalablytyped.runtime.StringDictionary[VertexBuffer]) => Callback): Self = StObject.set(x, "createVertexBuffers", js.Any.fromFunction2((t0: Buffer, t1: org.scalablytyped.runtime.StringDictionary[VertexBuffer]) => (value(t0, t1)).runNow()))
