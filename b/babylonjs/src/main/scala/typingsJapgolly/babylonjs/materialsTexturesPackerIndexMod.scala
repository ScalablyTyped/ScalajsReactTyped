...
object materialsTexturesPackerIndexMod {
  ...
  open class TexturePacker protected ()
    extends typingsJapgolly.babylonjs.materialsTexturesPackerPackerMod.TexturePacker {
    /**
  ...
  open class TexturePackerFrame protected ()
    extends typingsJapgolly.babylonjs.materialsTexturesPackerFrameMod.TexturePackerFrame {
    /**
