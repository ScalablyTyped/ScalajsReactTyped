...
import typingsJapgolly.blueprintjsCore.libEsmComponentsOverlayOverlayMod.IOverlayLifecycleProps
...
object libEsmComponentsAlertAlertMod {
  ...
  object IAlertProps {
    ...
    extension [Self <: IAlertProps](x: Self) {
      ...
      inline def setOnCancel(value: /* evt */ js.UndefOr[ReactEventFrom[HTMLElement]] => Callback): Self = StObject.set(x, "onCancel", js.Any.fromFunction1((t0: /* evt */ js.UndefOr[ReactEventFrom[HTMLElement]]) => value(t0).runNow()))
      
      inline def setOnCancelUndefined: Self = StObject.set(x, "onCancel", js.undefined)
      
      inline def setOnClose(value: (/* confirmed */ Boolean, /* evt */ js.UndefOr[ReactEventFrom[HTMLElement]]) => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* confirmed */ Boolean, t1: /* evt */ js.UndefOr[ReactEventFrom[HTMLElement]]) => (value(t0, t1)).runNow()))
      
      inline def setOnCloseUndefined: Self = StObject.set(x, "onClose", js.undefined)
      
      inline def setOnConfirm(value: /* evt */ js.UndefOr[ReactEventFrom[HTMLElement]] => Callback): Self = StObject.set(x, "onConfirm", js.Any.fromFunction1((t0: /* evt */ js.UndefOr[ReactEventFrom[HTMLElement]]) => value(t0).runNow()))
