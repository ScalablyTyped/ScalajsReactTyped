...
object Label {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def elementRef(value: Ref[HTMLLabelElement]): this.type = set("elementRef", value.asInstanceOf[js.Any])
    
    inline def elementRefFunction1(value: HTMLLabelElement | Null => Callback): this.type = set("elementRef", js.Any.fromFunction1((t0: HTMLLabelElement | Null) => value(t0).runNow()))
  ...
  def withProps(p: HTMLPropsHTMLLabelElement): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
