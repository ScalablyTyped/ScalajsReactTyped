...
object Overlay {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IOverlayProps, typingsJapgolly.blueprintjsCore.mod.Overlay, Unit, IOverlayProps] = {
  ...
  typingsJapgolly.blueprintjsCore.overlayMod.IOverlayProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Overlay](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.overlayMod.IOverlayProps])(children: _*)
  }
