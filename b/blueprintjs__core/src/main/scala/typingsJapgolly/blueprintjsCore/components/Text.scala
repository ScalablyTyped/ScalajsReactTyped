...
object Text {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.Text] {
    ...
    inline def ellipsize(value: Boolean): this.type = set("ellipsize", value.asInstanceOf[js.Any])
  ...
  def withProps(p: TextPropsOmitHTMLAttribut): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
