...
import typingsJapgolly.blueprintjsCore.libEsmComponentsSpinnerSpinnerMod.ISpinnerProps
...
object Spinner {
  ...
  object ISpinnerPropsHTMLAttributes {
    ...
    open class Builder (val args: js.Array[Any])
      extends AnyVal
         with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.Spinner] {
    ...
    implicit def make(companion: ISpinnerPropsHTMLAttributes.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ISpinnerProps & HTMLAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object ISpinnerPropsSVGAttributes {
    ...
    implicit def make(companion: ISpinnerPropsSVGAttributes.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ISpinnerProps & SVGAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
