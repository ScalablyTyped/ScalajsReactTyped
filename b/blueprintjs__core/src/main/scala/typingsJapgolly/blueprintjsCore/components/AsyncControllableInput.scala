...
import typingsJapgolly.blueprintjsCore.libEsmComponentsFormsAsyncControllableInputMod.IAsyncControllableInputProps
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[
          typingsJapgolly.blueprintjsCore.libEsmComponentsFormsAsyncControllableInputMod.AsyncControllableInput
        ] {
