...
import typingsJapgolly.blueprintjsCore.navbarGroupMod.INavbarGroupProps
...
object NavbarGroup {
  def apply(
    ...
    INavbarGroupProps, 
    typingsJapgolly.blueprintjsCore.mod.NavbarGroup, 
    Unit, 
    INavbarGroupProps
  ] = {
  ...
  typingsJapgolly.blueprintjsCore.navbarGroupMod.INavbarGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.NavbarGroup](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.navbarGroupMod.INavbarGroupProps])(children: _*)
  }
