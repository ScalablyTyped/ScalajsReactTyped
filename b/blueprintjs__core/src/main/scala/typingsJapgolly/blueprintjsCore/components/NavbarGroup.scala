...
import typingsJapgolly.blueprintjsCore.libEsmComponentsNavbarNavbarGroupMod.INavbarGroupProps
...
object NavbarGroup {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.NavbarGroup] {
  ...
  implicit def make(companion: NavbarGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: INavbarGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
