...
import typingsJapgolly.blueprintjsCore.libEsmComponentsFormsControlGroupMod.IControlGroupProps
...
object ControlGroup {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.ControlGroup] {
  ...
  implicit def make(companion: ControlGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IControlGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
