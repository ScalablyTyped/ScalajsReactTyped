...
import typingsJapgolly.blueprintjsCore.controlGroupMod.IControlGroupProps
...
object ControlGroup {
  def apply(
    ...
    IControlGroupProps, 
    typingsJapgolly.blueprintjsCore.mod.ControlGroup, 
    Unit, 
    IControlGroupProps
  ] = {
  ...
  typingsJapgolly.blueprintjsCore.controlGroupMod.IControlGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.ControlGroup](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.controlGroupMod.IControlGroupProps])(children: _*)
  }
