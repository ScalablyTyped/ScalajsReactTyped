...
object FileInput {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IFileInputProps, typingsJapgolly.blueprintjsCore.mod.FileInput, Unit, IFileInputProps] = {
  ...
  typingsJapgolly.blueprintjsCore.fileInputMod.IFileInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.FileInput](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.fileInputMod.IFileInputProps])(children: _*)
  }
