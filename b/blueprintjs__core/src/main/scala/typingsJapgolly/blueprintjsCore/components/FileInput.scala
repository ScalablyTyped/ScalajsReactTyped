...
import typingsJapgolly.blueprintjsCore.libEsmComponentsFormsFileInputMod.IFileInputProps
...
object FileInput {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.FileInput] {
    ...
    inline def hasSelection(value: Boolean): this.type = set("hasSelection", value.asInstanceOf[js.Any])
  ...
  def withProps(p: IFileInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
