...
object NumericInput {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.NumericInput] {
    ...
    inline def allowNumericCharactersOnly(value: Boolean): this.type = set("allowNumericCharactersOnly", value.asInstanceOf[js.Any])
    ...
    inline def asyncControl(value: Boolean): this.type = set("asyncControl", value.asInstanceOf[js.Any])
    ...
    inline def buttonPosition(value: left | right | typingsJapgolly.blueprintjsCore.blueprintjsCoreStrings.none): this.type = set("buttonPosition", value.asInstanceOf[js.Any])
    
    inline def capture(value: Boolean | user | environment): this.type = set("capture", value.asInstanceOf[js.Any])
    
    inline def checked(value: Boolean): this.type = set("checked", value.asInstanceOf[js.Any])
    
    inline def clampValueOnBlur(value: Boolean): this.type = set("clampValueOnBlur", value.asInstanceOf[js.Any])
    ...
    inline def leftElement(value: VdomElement): this.type = set("leftElement", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def majorStepSize(value: Double): this.type = set("majorStepSize", value.asInstanceOf[js.Any])
    
    inline def majorStepSizeNull: this.type = set("majorStepSize", null)
    ...
    inline def minorStepSize(value: Double): this.type = set("minorStepSize", value.asInstanceOf[js.Any])
    
    inline def minorStepSizeNull: this.type = set("minorStepSize", null)
    ...
    inline def onButtonClick(value: (/* valueAsNumber */ Double, /* valueAsString */ String) => Callback): this.type = set("onButtonClick", js.Any.fromFunction2((t0: /* valueAsNumber */ Double, t1: /* valueAsString */ String) => (value(t0, t1)).runNow()))
    ...
    inline def onValueChange(
      value: (/* valueAsNumber */ Double, /* valueAsString */ String, /* inputElement */ HTMLInputElement | Null) => Callback
    ): this.type = set("onValueChange", js.Any.fromFunction3((t0: /* valueAsNumber */ Double, t1: /* valueAsString */ String, t2: /* inputElement */ HTMLInputElement | Null) => (value(t0, t1, t2)).runNow()))
    ...
    inline def selectAllOnIncrement(value: Boolean): this.type = set("selectAllOnIncrement", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: NumericInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: HTMLInputProps & NumericInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
