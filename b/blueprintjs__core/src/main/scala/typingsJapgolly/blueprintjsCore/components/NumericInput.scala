...
object NumericInput {
  def apply(
    ...
    buttonPosition: left | right | typingsJapgolly.blueprintjsCore.blueprintjsCoreStrings.none = null,
    ...
    HTMLInputProps with INumericInputProps, 
    typingsJapgolly.blueprintjsCore.mod.NumericInput, 
    Unit, 
    HTMLInputProps with INumericInputProps
  ] = {
  ...
  typingsJapgolly.blueprintjsCore.propsMod.HTMLInputProps with typingsJapgolly.blueprintjsCore.numericInputMod.INumericInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.NumericInput](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.propsMod.HTMLInputProps with typingsJapgolly.blueprintjsCore.numericInputMod.INumericInputProps])(children: _*)
  }
