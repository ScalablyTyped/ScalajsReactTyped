...
import typingsJapgolly.blueprintjsCore.libEsmComponentsNavbarNavbarMod.INavbarProps
...
object Navbar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.Navbar] {
    ...
    inline def fixedToTop(value: Boolean): this.type = set("fixedToTop", value.asInstanceOf[js.Any])
