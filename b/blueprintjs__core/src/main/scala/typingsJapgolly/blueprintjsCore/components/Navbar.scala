...
import typingsJapgolly.blueprintjsCore.navbarMod.INavbarProps
...
object Navbar {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[INavbarProps, typingsJapgolly.blueprintjsCore.mod.Navbar, Unit, INavbarProps] = {
  ...
  typingsJapgolly.blueprintjsCore.navbarMod.INavbarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Navbar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.navbarMod.INavbarProps])(children: _*)
  }
