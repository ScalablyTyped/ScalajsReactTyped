...
@scala.inline
open class SharedBuilder_HTMLPropsHTMLHeadingEleme569594477[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def elementRef(value: Ref[HTMLHeadingElement]): this.type = set("elementRef", value.asInstanceOf[js.Any])
  
  inline def elementRefFunction1(value: HTMLHeadingElement | Null => Callback): this.type = set("elementRef", js.Any.fromFunction1((t0: HTMLHeadingElement | Null) => value(t0).runNow()))
