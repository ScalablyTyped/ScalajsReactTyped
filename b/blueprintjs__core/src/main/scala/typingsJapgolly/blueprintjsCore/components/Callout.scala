...
import typingsJapgolly.blueprintjsCore.calloutMod.ICalloutProps
...
object Callout {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ICalloutProps, typingsJapgolly.blueprintjsCore.mod.Callout, Unit, ICalloutProps] = {
  ...
  typingsJapgolly.blueprintjsCore.calloutMod.ICalloutProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Callout](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.calloutMod.ICalloutProps])(children: _*)
  }
