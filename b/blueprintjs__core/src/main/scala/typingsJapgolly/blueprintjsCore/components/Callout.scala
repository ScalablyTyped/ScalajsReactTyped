...
import typingsJapgolly.blueprintjsCore.libEsmComponentsCalloutCalloutMod.ICalloutProps
...
object Callout {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.Callout] {
