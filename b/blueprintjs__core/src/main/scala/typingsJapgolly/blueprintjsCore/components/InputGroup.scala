...
object InputGroup {
  def apply(
    ...
    IInputGroupProps with HTMLInputProps, 
    typingsJapgolly.blueprintjsCore.mod.InputGroup, 
    Unit, 
    IInputGroupProps with HTMLInputProps
  ] = {
  ...
  typingsJapgolly.blueprintjsCore.inputGroupMod.IInputGroupProps with typingsJapgolly.blueprintjsCore.propsMod.HTMLInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.InputGroup](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.inputGroupMod.IInputGroupProps with typingsJapgolly.blueprintjsCore.propsMod.HTMLInputProps])(children: _*)
  }
