...
import typingsJapgolly.blueprintjsCore.libEsmComponentsFormsInputGroupMod.IInputGroupProps2
...
object InputGroup {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.InputGroup] {
  ...
  def withProps(p: IInputGroupProps2): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
