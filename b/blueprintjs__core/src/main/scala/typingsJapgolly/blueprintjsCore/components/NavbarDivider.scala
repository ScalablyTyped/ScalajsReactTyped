...
import typingsJapgolly.blueprintjsCore.libEsmComponentsNavbarNavbarDividerMod.INavbarDividerProps
...
object NavbarDivider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.NavbarDivider] {
