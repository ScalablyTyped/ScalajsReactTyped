...
import typingsJapgolly.blueprintjsCore.navbarDividerMod.INavbarDividerProps
...
object NavbarDivider {
  def apply(
    ...
    INavbarDividerProps, 
    typingsJapgolly.blueprintjsCore.mod.NavbarDivider, 
    Unit, 
    INavbarDividerProps
  ] = {
  ...
  typingsJapgolly.blueprintjsCore.navbarDividerMod.INavbarDividerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.NavbarDivider](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.navbarDividerMod.INavbarDividerProps])(children: _*)
  }
