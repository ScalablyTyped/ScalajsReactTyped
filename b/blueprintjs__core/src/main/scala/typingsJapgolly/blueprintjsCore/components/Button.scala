...
object Button {
  def apply(
    ...
    IButtonProps with ButtonHTMLAttributes[HTMLButtonElement], 
    typingsJapgolly.blueprintjsCore.mod.Button, 
    Unit, 
    IButtonProps with ButtonHTMLAttributes[HTMLButtonElement]
  ] = {
  ...
  typingsJapgolly.blueprintjsCore.abstractButtonMod.IButtonProps with typingsJapgolly.react.mod.ButtonHTMLAttributes[org.scalajs.dom.raw.HTMLButtonElement], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Button](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.abstractButtonMod.IButtonProps with typingsJapgolly.react.mod.ButtonHTMLAttributes[org.scalajs.dom.raw.HTMLButtonElement]])(children: _*)
  }
