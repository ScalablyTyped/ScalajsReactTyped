...
object Tab {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ITabProps, typingsJapgolly.blueprintjsCore.mod.Tab, Unit, ITabProps] = {
  ...
  typingsJapgolly.blueprintjsCore.tabMod.ITabProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Tab](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.tabMod.ITabProps])(children: _*)
  }
