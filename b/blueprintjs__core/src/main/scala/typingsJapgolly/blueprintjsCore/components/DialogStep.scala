...
import typingsJapgolly.blueprintjsCore.libEsmComponentsDialogDialogStepMod.IDialogStepProps
...
object DialogStep {
  ...
  inline def apply(id: DialogStepId, panel: VdomElement): Builder = {
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any], panel = panel.rawElement.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[IDialogStepProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.DialogStep] {
  ...
  def withProps(p: IDialogStepProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
