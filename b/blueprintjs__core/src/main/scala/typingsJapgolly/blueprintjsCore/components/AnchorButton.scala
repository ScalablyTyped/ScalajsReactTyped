...
object AnchorButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.AnchorButton] {
    ...
    inline def elementRef(value: Ref[HTMLAnchorElement]): this.type = set("elementRef", value.asInstanceOf[js.Any])
    
    inline def elementRefFunction1(value: HTMLAnchorElement | Null => Callback): this.type = set("elementRef", js.Any.fromFunction1((t0: HTMLAnchorElement | Null) => value(t0).runNow()))
  ...
  def withProps(
    p: ButtonProps[HTMLAnchorElement] & (/* import warning: importer.ImportType#apply Failed type conversion: E extends std.HTMLButtonElement ? react.react.ButtonHTMLAttributes<std.HTMLButtonElement> : react.react.AnchorHTMLAttributes<std.HTMLAnchorElement> */ js.Any)
