...
import typingsJapgolly.blueprintjsCore.abstractButtonMod.IButtonProps
...
object AnchorButton {
  def apply(
    ...
    IButtonProps with AnchorHTMLAttributes[HTMLAnchorElement], 
    typingsJapgolly.blueprintjsCore.mod.AnchorButton, 
    Unit, 
    IButtonProps with AnchorHTMLAttributes[HTMLAnchorElement]
  ] = {
  ...
  typingsJapgolly.blueprintjsCore.abstractButtonMod.IButtonProps with typingsJapgolly.react.mod.AnchorHTMLAttributes[org.scalajs.dom.raw.HTMLAnchorElement], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.AnchorButton](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.abstractButtonMod.IButtonProps with typingsJapgolly.react.mod.AnchorHTMLAttributes[org.scalajs.dom.raw.HTMLAnchorElement]])(children: _*)
  }
