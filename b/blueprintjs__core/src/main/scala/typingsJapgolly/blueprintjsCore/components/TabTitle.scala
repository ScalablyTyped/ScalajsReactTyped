...
import typingsJapgolly.blueprintjsCore.tabTitleMod.ITabTitleProps
...
object TabTitle {
  def apply(
    ...
    ITabTitleProps, 
    typingsJapgolly.blueprintjsCore.tabTitleMod.TabTitle, 
    Unit, 
    ITabTitleProps
  ] = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], parentId = parentId.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
  
      __obj.updateDynamic("onClick")(js.Any.fromFunction2((t0: typingsJapgolly.blueprintjsCore.tabMod.TabId, t1: japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement]) => onClick(t0, t1).runNow()))
  ...
  typingsJapgolly.blueprintjsCore.tabTitleMod.ITabTitleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.tabTitleMod.TabTitle](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.tabTitleMod.ITabTitleProps])(children: _*)
  }
