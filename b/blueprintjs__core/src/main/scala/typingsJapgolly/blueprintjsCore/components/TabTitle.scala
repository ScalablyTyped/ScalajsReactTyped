...
import typingsJapgolly.blueprintjsCore.libEsmComponentsTabsTabTitleMod.ITabTitleProps
...
object TabTitle {
  ...
  inline def apply(
    ...
    val __props = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onClick = js.Any.fromFunction2((t0: TabId, t1: ReactMouseEventFrom[HTMLElement]) => (onClick(t0, t1)).runNow()), parentId = parentId.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.libEsmComponentsTabsTabTitleMod.TabTitle] {
    ...
    inline def panel(value: VdomElement): this.type = set("panel", value.rawElement.asInstanceOf[js.Any])
