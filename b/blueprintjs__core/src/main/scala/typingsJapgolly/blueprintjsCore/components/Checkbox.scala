...
import typingsJapgolly.blueprintjsCore.libEsmComponentsFormsControlsMod.ICheckboxProps
...
object Checkbox {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.Checkbox] {
