...
object Checkbox {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ICheckboxProps, typingsJapgolly.blueprintjsCore.mod.Checkbox, Unit, ICheckboxProps] = {
  ...
  typingsJapgolly.blueprintjsCore.controlsMod.ICheckboxProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Checkbox](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.controlsMod.ICheckboxProps])(children: _*)
  }
