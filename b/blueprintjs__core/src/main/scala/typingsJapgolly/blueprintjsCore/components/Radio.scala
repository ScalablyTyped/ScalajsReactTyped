...
import typingsJapgolly.blueprintjsCore.controlsMod.IControlProps
...
object Radio {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IControlProps, typingsJapgolly.blueprintjsCore.mod.Radio, Unit, IControlProps] = {
  ...
  typingsJapgolly.blueprintjsCore.controlsMod.IControlProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Radio](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.controlsMod.IControlProps])(children: _*)
  }
