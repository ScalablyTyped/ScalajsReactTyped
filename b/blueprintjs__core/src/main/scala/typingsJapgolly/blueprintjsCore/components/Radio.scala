...
import typingsJapgolly.blueprintjsCore.libEsmComponentsFormsControlsMod.IControlProps
...
object Radio {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.Radio] {
