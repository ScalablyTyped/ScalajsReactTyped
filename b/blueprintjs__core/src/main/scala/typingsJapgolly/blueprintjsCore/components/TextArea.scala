...
import typingsJapgolly.blueprintjsCore.textAreaMod.ITextAreaProps
...
object TextArea {
  def apply(
    ...
    inputRef: /* ref */ HTMLTextAreaElement | Null => CallbackTo[js.Any] = null,
    intent: Intent = null,
    is: String = null,
    itemID: String = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ITextAreaProps, typingsJapgolly.blueprintjsCore.mod.TextArea, Unit, ITextAreaProps] = {
  ...
  typingsJapgolly.blueprintjsCore.textAreaMod.ITextAreaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.TextArea](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.textAreaMod.ITextAreaProps])(children: _*)
  }
