...
import typingsJapgolly.blueprintjsCore.libEsmComponentsFormsTextAreaMod.ITextAreaProps
...
object TextArea {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.TextArea] {
    ...
    inline def growVertically(value: Boolean): this.type = set("growVertically", value.asInstanceOf[js.Any])
