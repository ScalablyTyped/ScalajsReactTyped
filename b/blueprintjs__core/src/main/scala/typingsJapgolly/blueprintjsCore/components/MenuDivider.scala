...
import typingsJapgolly.blueprintjsCore.libEsmComponentsMenuMenuDividerMod.IMenuDividerProps
...
object MenuDivider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.MenuDivider] {
