...
import typingsJapgolly.blueprintjsCore.libEsmComponentsFormsControlsMod.ISwitchProps
...
object Switch {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.Switch] {
    ...
    inline def alignIndicator(value: Alignment): this.type = set("alignIndicator", value.asInstanceOf[js.Any])
    ...
    inline def innerLabel(value: String): this.type = set("innerLabel", value.asInstanceOf[js.Any])
    
    inline def innerLabelChecked(value: String): this.type = set("innerLabelChecked", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ISwitchProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
