...
import typingsJapgolly.blueprintjsCore.controlsMod.ISwitchProps
...
object Switch {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ISwitchProps, typingsJapgolly.blueprintjsCore.mod.Switch, Unit, ISwitchProps] = {
  ...
  typingsJapgolly.blueprintjsCore.controlsMod.ISwitchProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Switch](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.controlsMod.ISwitchProps])(children: _*)
  }
