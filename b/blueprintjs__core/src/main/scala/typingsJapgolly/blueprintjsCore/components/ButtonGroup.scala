...
import typingsJapgolly.blueprintjsCore.libEsmComponentsButtonButtonGroupMod.IButtonGroupProps
...
object ButtonGroup {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.ButtonGroup] {
