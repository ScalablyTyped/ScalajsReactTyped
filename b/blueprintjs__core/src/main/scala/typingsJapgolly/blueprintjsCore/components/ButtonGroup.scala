...
import typingsJapgolly.blueprintjsCore.buttonGroupMod.IButtonGroupProps
...
object ButtonGroup {
  def apply(
    ...
    IButtonGroupProps, 
    typingsJapgolly.blueprintjsCore.mod.ButtonGroup, 
    Unit, 
    IButtonGroupProps
  ] = {
  ...
  typingsJapgolly.blueprintjsCore.buttonGroupMod.IButtonGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.ButtonGroup](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.buttonGroupMod.IButtonGroupProps])(children: _*)
  }
