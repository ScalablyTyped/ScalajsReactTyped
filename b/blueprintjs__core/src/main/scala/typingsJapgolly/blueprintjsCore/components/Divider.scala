...
object Divider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.Divider] {
  ...
  def withProps(p: IDividerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
