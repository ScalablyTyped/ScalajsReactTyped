...
import typingsJapgolly.blueprintjsCore.dividerMod.IDividerProps
...
object Divider {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IDividerProps, typingsJapgolly.blueprintjsCore.mod.Divider, Unit, IDividerProps] = {
  ...
  typingsJapgolly.blueprintjsCore.dividerMod.IDividerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Divider](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.dividerMod.IDividerProps])(children: _*)
  }
