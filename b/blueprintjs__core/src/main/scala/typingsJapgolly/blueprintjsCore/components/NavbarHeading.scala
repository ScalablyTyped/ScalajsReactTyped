...
import typingsJapgolly.blueprintjsCore.libEsmComponentsNavbarNavbarHeadingMod.INavbarHeadingProps
...
object NavbarHeading {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.NavbarHeading] {
