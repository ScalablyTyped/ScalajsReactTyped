...
object MenuItem {
  def apply(
    ...
    IMenuItemProps with AnchorHTMLAttributes[HTMLAnchorElement], 
    typingsJapgolly.blueprintjsCore.mod.MenuItem, 
    Unit, 
    IMenuItemProps with AnchorHTMLAttributes[HTMLAnchorElement]
  ] = {
  ...
  typingsJapgolly.blueprintjsCore.menuItemMod.IMenuItemProps with typingsJapgolly.react.mod.AnchorHTMLAttributes[org.scalajs.dom.raw.HTMLAnchorElement], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.MenuItem](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.menuItemMod.IMenuItemProps with typingsJapgolly.react.mod.AnchorHTMLAttributes[org.scalajs.dom.raw.HTMLAnchorElement]])(children: _*)
  }
