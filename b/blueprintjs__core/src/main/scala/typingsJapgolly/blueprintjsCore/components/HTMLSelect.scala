...
import typingsJapgolly.blueprintjsCore.htmlSelectMod.IHTMLSelectProps
...
object HTMLSelect {
  def apply(
    ...
    elementRef: /* ref */ HTMLSelectElement | Null => Callback = null,
    ...
    IHTMLSelectProps, 
    typingsJapgolly.blueprintjsCore.mod.HTMLSelect, 
    Unit, 
    IHTMLSelectProps
  ] = {
  ...
  typingsJapgolly.blueprintjsCore.htmlSelectMod.IHTMLSelectProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.HTMLSelect](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.htmlSelectMod.IHTMLSelectProps])(children: _*)
  }
