...
object AbstractButton {
  ...
  inline def apply[E /* <: HTMLButtonElement | HTMLAnchorElement */](): Builder[E] = {
    val __props = js.Dynamic.literal()
    new Builder[E](js.Array(this.component, __props.asInstanceOf[ButtonProps[E] & (/* import warning: importer.ImportType#apply Failed type conversion: E extends std.HTMLButtonElement ? react.react.ButtonHTMLAttributes<std.HTMLButtonElement> : react.react.AnchorHTMLAttributes<std.HTMLAnchorElement> */ js.Any)]))
  }
  ...
  @scala.inline
  open class Builder[E /* <: HTMLButtonElement | HTMLAnchorElement */] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[
          typingsJapgolly.blueprintjsCore.libEsmComponentsButtonAbstractButtonMod.AbstractButton[E]
        ] {
    ...
    inline def elementRef(value: Ref[E]): this.type = set("elementRef", value.asInstanceOf[js.Any])
    
    inline def elementRefFunction1(value: E | Null => Callback): this.type = set("elementRef", js.Any.fromFunction1((t0: E | Null) => value(t0).runNow()))
  ...
  implicit def make[E /* <: HTMLButtonElement | HTMLAnchorElement */](companion: AbstractButton.type): Builder[E] = new Builder[E](js.Array(this.component, js.Dictionary.empty))()
  
  def withProps[E /* <: HTMLButtonElement | HTMLAnchorElement */](
    p: ButtonProps[E] & (/* import warning: importer.ImportType#apply Failed type conversion: E extends std.HTMLButtonElement ? react.react.ButtonHTMLAttributes<std.HTMLButtonElement> : react.react.AnchorHTMLAttributes<std.HTMLAnchorElement> */ js.Any)
  ): Builder[E] = new Builder[E](js.Array(this.component, p.asInstanceOf[js.Any]))
}
