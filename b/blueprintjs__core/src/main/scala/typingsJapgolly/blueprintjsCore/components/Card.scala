...
import typingsJapgolly.blueprintjsCore.libEsmComponentsCardCardMod.ICardProps
...
object Card {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsCore.mod.Card] {
    ...
    inline def elevation(value: Elevation): this.type = set("elevation", value.asInstanceOf[js.Any])
