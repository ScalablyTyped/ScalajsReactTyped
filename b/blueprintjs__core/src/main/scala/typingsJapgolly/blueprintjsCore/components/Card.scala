...
object Card {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ICardProps, typingsJapgolly.blueprintjsCore.mod.Card, Unit, ICardProps] = {
  ...
  typingsJapgolly.blueprintjsCore.cardMod.ICardProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Card](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.cardMod.ICardProps])(children: _*)
  }
