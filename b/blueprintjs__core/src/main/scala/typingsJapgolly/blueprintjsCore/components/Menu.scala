...
import typingsJapgolly.blueprintjsCore.menuMod.IMenuProps
...
object Menu {
  def apply(
    ...
    typeof: String = null,
    ulRef: /* ref */ HTMLUListElement | Null => CallbackTo[js.Any] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IMenuProps, typingsJapgolly.blueprintjsCore.mod.Menu, Unit, IMenuProps] = {
  ...
  typingsJapgolly.blueprintjsCore.menuMod.IMenuProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.blueprintjsCore.mod.Menu](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.blueprintjsCore.menuMod.IMenuProps])(children: _*)
  }
