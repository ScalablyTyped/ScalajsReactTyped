...
object libEsmCommonAbstractComponent2Mod {
  
  /* note: abstract class */ @JSImport("@blueprintjs/core/lib/esm/common/abstractComponent2", "AbstractComponent2")
  @js.native
  open class AbstractComponent2[P, S, SS] protected () extends Component[P, S, SS] {
