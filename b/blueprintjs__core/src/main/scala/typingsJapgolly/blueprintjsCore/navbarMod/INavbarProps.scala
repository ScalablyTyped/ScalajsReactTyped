package typingsJapgolly.blueprintjsCore.navbarMod
...
- typingsJapgolly.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait INavbarProps extends HTMLAttributes[HTMLDivElement] {
  /**
