package typingsJapgolly.blueprintjsCore.navbarGroupMod
...
- typingsJapgolly.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait INavbarGroupProps extends HTMLAttributes[HTMLDivElement] {
  /**
