...
object libEsmComponentsNavbarNavbarMod {
  
  @JSImport("@blueprintjs/core/lib/esm/components/navbar/navbar", "Navbar")
  @js.native
  open class Navbar protected ()
    extends AbstractPureComponent2[NavbarProps, js.Object, js.Object] {
  ...
  object INavbarProps {
    ...
    inline def apply(): INavbarProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[INavbarProps]
    }
    
    extension [Self <: INavbarProps](x: Self) {
      ...
      inline def setFixedToTop(value: Boolean): Self = StObject.set(x, "fixedToTop", value.asInstanceOf[js.Any])
      
      inline def setFixedToTopUndefined: Self = StObject.set(x, "fixedToTop", js.undefined)
