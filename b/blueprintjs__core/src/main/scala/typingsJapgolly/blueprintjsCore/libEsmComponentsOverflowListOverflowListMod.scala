...
object libEsmComponentsOverflowListOverflowListMod {
  ...
  object IOverflowListProps {
    ...
    extension [Self <: IOverflowListProps[?], T](x: Self & IOverflowListProps[T]) {
      ...
      inline def setOnOverflow(value: /* overflowItems */ js.Array[T] => Callback): Self = StObject.set(x, "onOverflow", js.Any.fromFunction1((t0: /* overflowItems */ js.Array[T]) => value(t0).runNow()))
      
      inline def setOnOverflowUndefined: Self = StObject.set(x, "onOverflow", js.undefined)
      
      inline def setOverflowRenderer(value: js.Array[T] => Node): Self = StObject.set(x, "overflowRenderer", js.Any.fromFunction1(value))
