package typingsJapgolly.blueprintjsCore.navbarHeadingMod
...
- typingsJapgolly.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait INavbarHeadingProps extends HTMLAttributes[HTMLDivElement]
