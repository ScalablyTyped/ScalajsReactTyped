...
object libEsmComponentsTagTagMod {
  ...
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait ITagProps
    ...
    var onRemove: js.UndefOr[
        js.Function2[/* e */ ReactMouseEventFrom[HTMLButtonElement], /* tagProps */ TagProps, Unit]
      ] = js.undefined
  ...
  object ITagProps {
    ...
    extension [Self <: ITagProps](x: Self) {
      ...
      inline def setOnRemove(value: (/* e */ ReactMouseEventFrom[HTMLButtonElement], /* tagProps */ TagProps) => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction2((t0: /* e */ ReactMouseEventFrom[HTMLButtonElement], t1: /* tagProps */ TagProps) => (value(t0, t1)).runNow()))
