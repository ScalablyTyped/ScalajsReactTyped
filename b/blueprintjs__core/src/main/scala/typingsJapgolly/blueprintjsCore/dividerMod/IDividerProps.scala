package typingsJapgolly.blueprintjsCore.dividerMod
...
- typingsJapgolly.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait IDividerProps extends HTMLAttributes[HTMLElement] {
  /**
