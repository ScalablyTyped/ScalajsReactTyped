...
object libEsmComponentsPanelStackPanelViewMod {
  ...
  object IPanelViewProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(onClose = js.Any.fromFunction1((t0: IPanel[Any]) => onClose(t0).runNow()), onOpen = js.Any.fromFunction1((t0: IPanel[Any]) => onOpen(t0).runNow()), panel = panel.asInstanceOf[js.Any], showHeader = showHeader.asInstanceOf[js.Any])
      __obj.asInstanceOf[IPanelViewProps]
    }
    
    extension [Self <: IPanelViewProps](x: Self) {
      
      inline def setOnClose(value: IPanel[Any] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: IPanel[Any]) => value(t0).runNow()))
      
      inline def setOnOpen(value: IPanel[Any] => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction1((t0: IPanel[Any]) => value(t0).runNow()))
