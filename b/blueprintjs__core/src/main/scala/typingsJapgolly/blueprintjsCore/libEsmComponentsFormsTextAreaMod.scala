...
object libEsmComponentsFormsTextAreaMod {
  ...
  - typingsJapgolly.react.mod.TextareaHTMLAttributes because var conflicts: className. Inlined required, cols, wrap, maxLength, form, value, minLength, readOnly, name, disabled, dirName, rows, autoFocus, onChange_TextareaHTMLAttributes, autoComplete */ trait ITextAreaProps
    extends StObject
       with IIntentProps
       with IProps
       with AriaAttributes
