...
object libEsmComponentsPanelStack2PanelStack2Mod {
  ...
  object PanelStack2Props {
    ...
    extension [Self <: PanelStack2Props[?], T /* <: Panel[js.Object] */](x: Self & PanelStack2Props[T]) {
      ...
      inline def setOnClose(value: /* removedPanel */ T => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* removedPanel */ T) => value(t0).runNow()))
      
      inline def setOnCloseUndefined: Self = StObject.set(x, "onClose", js.undefined)
      
      inline def setOnOpen(value: /* addedPanel */ T => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction1((t0: /* addedPanel */ T) => value(t0).runNow()))
