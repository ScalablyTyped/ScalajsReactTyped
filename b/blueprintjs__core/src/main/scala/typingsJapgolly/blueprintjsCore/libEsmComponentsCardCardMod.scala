...
object libEsmComponentsCardCardMod {
  
  @JSImport("@blueprintjs/core/lib/esm/components/card/card", "Card")
  @js.native
  open class Card protected ()
    extends AbstractPureComponent2[CardProps, js.Object, js.Object] {
  ...
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait ICardProps
    ...
    /**
      ...
      */
    @JSName("onClick")
    var onClick_ICardProps: js.UndefOr[js.Function1[/* e */ ReactMouseEventFrom[HTMLDivElement], Unit]] = js.undefined
  ...
  object ICardProps {
    ...
    extension [Self <: ICardProps](x: Self) {
      ...
      inline def setElevation(value: Elevation): Self = StObject.set(x, "elevation", value.asInstanceOf[js.Any])
