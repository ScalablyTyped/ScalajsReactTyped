...
import typingsJapgolly.blueprintjsCore.blueprintjsCoreInts.`0`
import typingsJapgolly.blueprintjsCore.blueprintjsCoreInts.`1`
import typingsJapgolly.blueprintjsCore.blueprintjsCoreInts.`2`
import typingsJapgolly.blueprintjsCore.blueprintjsCoreInts.`3`
import typingsJapgolly.blueprintjsCore.blueprintjsCoreInts.`4`
...
import typingsJapgolly.blueprintjsCore.libEsmCommonElevationMod.Elevation
...
object libEsmCommonMod {
  ...
  /* note: abstract class */ @JSImport("@blueprintjs/core/lib/esm/common", "AbstractComponent")
  @js.native
  open class AbstractComponent[P, S] protected ()
    extends typingsJapgolly.blueprintjsCore.libEsmCommonAbstractComponentMod.AbstractComponent[P, S] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
  }
  
  /* note: abstract class */ @JSImport("@blueprintjs/core/lib/esm/common", "AbstractComponent2")
  @js.native
  open class AbstractComponent2[P, S, SS] protected ()
    extends typingsJapgolly.blueprintjsCore.libEsmCommonAbstractComponent2Mod.AbstractComponent2[P, S, SS] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
  }
  
  /* note: abstract class */ @JSImport("@blueprintjs/core/lib/esm/common", "AbstractPureComponent")
  @js.native
  open class AbstractPureComponent[P, S] protected ()
    extends typingsJapgolly.blueprintjsCore.libEsmCommonAbstractPureComponentMod.AbstractPureComponent[P, S] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
  }
  
  /* note: abstract class */ @JSImport("@blueprintjs/core/lib/esm/common", "AbstractPureComponent2")
  @js.native
  open class AbstractPureComponent2[P, S, SS] protected ()
    extends typingsJapgolly.blueprintjsCore.libEsmCommonAbstractPureComponent2Mod.AbstractPureComponent2[P, S, SS] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
  }
