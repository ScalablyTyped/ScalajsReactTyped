...
object libEsmComponentsTreeTreeMod {
  ...
  object ITreeProps {
    ...
    extension [Self <: ITreeProps[?], T](x: Self & ITreeProps[T]) {
      ...
      ): Self = StObject.set(x, "onNodeClick", js.Any.fromFunction3((t0: /* node */ TreeNodeInfo[T], t1: /* nodePath */ js.Array[Double], t2: /* e */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnNodeClickUndefined: Self = StObject.set(x, "onNodeClick", js.undefined)
      
      inline def setOnNodeCollapse(
        value: (/* node */ TreeNodeInfo[T], /* nodePath */ js.Array[Double], /* e */ ReactMouseEventFrom[HTMLElement]) => Callback
      ): Self = StObject.set(x, "onNodeCollapse", js.Any.fromFunction3((t0: /* node */ TreeNodeInfo[T], t1: /* nodePath */ js.Array[Double], t2: /* e */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnNodeCollapseUndefined: Self = StObject.set(x, "onNodeCollapse", js.undefined)
      
      inline def setOnNodeContextMenu(
        value: (/* node */ TreeNodeInfo[T], /* nodePath */ js.Array[Double], /* e */ ReactMouseEventFrom[HTMLElement]) => Callback
      ): Self = StObject.set(x, "onNodeContextMenu", js.Any.fromFunction3((t0: /* node */ TreeNodeInfo[T], t1: /* nodePath */ js.Array[Double], t2: /* e */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnNodeDoubleClick(
        value: (/* node */ TreeNodeInfo[T], /* nodePath */ js.Array[Double], /* e */ ReactMouseEventFrom[HTMLElement]) => Callback
      ): Self = StObject.set(x, "onNodeDoubleClick", js.Any.fromFunction3((t0: /* node */ TreeNodeInfo[T], t1: /* nodePath */ js.Array[Double], t2: /* e */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnNodeDoubleClickUndefined: Self = StObject.set(x, "onNodeDoubleClick", js.undefined)
      
      inline def setOnNodeExpand(
        value: (/* node */ TreeNodeInfo[T], /* nodePath */ js.Array[Double], /* e */ ReactMouseEventFrom[HTMLElement]) => Callback
      ): Self = StObject.set(x, "onNodeExpand", js.Any.fromFunction3((t0: /* node */ TreeNodeInfo[T], t1: /* nodePath */ js.Array[Double], t2: /* e */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnNodeExpandUndefined: Self = StObject.set(x, "onNodeExpand", js.undefined)
      
      inline def setOnNodeMouseEnter(
        value: (/* node */ TreeNodeInfo[T], /* nodePath */ js.Array[Double], /* e */ ReactMouseEventFrom[HTMLElement]) => Callback
      ): Self = StObject.set(x, "onNodeMouseEnter", js.Any.fromFunction3((t0: /* node */ TreeNodeInfo[T], t1: /* nodePath */ js.Array[Double], t2: /* e */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnNodeMouseEnterUndefined: Self = StObject.set(x, "onNodeMouseEnter", js.undefined)
      
      inline def setOnNodeMouseLeave(
        value: (/* node */ TreeNodeInfo[T], /* nodePath */ js.Array[Double], /* e */ ReactMouseEventFrom[HTMLElement]) => Callback
      ): Self = StObject.set(x, "onNodeMouseLeave", js.Any.fromFunction3((t0: /* node */ TreeNodeInfo[T], t1: /* nodePath */ js.Array[Double], t2: /* e */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1, t2)).runNow()))
