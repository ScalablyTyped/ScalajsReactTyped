...
import typingsJapgolly.blueprintjsCore.libEsmComponentsFormsInputSharedPropsMod.InputSharedProps
...
object libEsmComponentsFormsNumericInputMod {
  ...
  object INumericInputProps {
    ...
    extension [Self <: INumericInputProps](x: Self) {
      ...
      inline def setOnButtonClick(value: (/* valueAsNumber */ Double, /* valueAsString */ String) => Callback): Self = StObject.set(x, "onButtonClick", js.Any.fromFunction2((t0: /* valueAsNumber */ Double, t1: /* valueAsString */ String) => (value(t0, t1)).runNow()))
      ...
      ): Self = StObject.set(x, "onValueChange", js.Any.fromFunction3((t0: /* valueAsNumber */ Double, t1: /* valueAsString */ String, t2: /* inputElement */ HTMLInputElement | Null) => (value(t0, t1, t2)).runNow()))
