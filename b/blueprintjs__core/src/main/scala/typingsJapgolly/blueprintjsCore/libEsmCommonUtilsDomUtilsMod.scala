...
object libEsmCommonUtilsDomUtilsMod {
  ...
  inline def throttleReactEventCallback[E /* <: ReactEventFrom[Element] */](callback: js.Function2[/* event */ E, /* repeated */ Any, Any]): js.Function1[/* event2 */ E, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("throttleReactEventCallback")(callback.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* event2 */ E, Unit]]
  inline def throttleReactEventCallback[E /* <: ReactEventFrom[Element] */](
