...
import typingsJapgolly.blueprintjsCore.blueprintjsCoreStrings.pop
...
object libEsmComponentsPanelStackPanelStackMod {
  ...
  object IPanelStackProps {
    ...
    extension [Self <: IPanelStackProps](x: Self) {
      ...
      inline def setOnClose(value: /* removedPanel */ IPanel[js.Object] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* removedPanel */ IPanel[js.Object]) => value(t0).runNow()))
      
      inline def setOnCloseUndefined: Self = StObject.set(x, "onClose", js.undefined)
      
      inline def setOnOpen(value: /* addedPanel */ IPanel[js.Object] => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction1((t0: /* addedPanel */ IPanel[js.Object]) => value(t0).runNow()))
