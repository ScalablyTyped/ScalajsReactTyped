package typingsJapgolly.blueprintjsCore.controlsMod
...
- typingsJapgolly.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait IControlProps extends InputHTMLAttributes[HTMLInputElement] {
  /**
...
object IControlProps {
  ...
  def apply(
    ...
    inputRef: /* ref */ org.scalajs.dom.raw.HTMLInputElement | Null => CallbackTo[js.Any] = null,
    is: String = null,
    itemID: String = null,
