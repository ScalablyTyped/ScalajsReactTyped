...
/* Inlined react.react.HTMLProps<std.HTMLElement> & @blueprintjs/core.@blueprintjs/core/lib/esm/common.IElementRefProps<std.HTMLElement> & {  children :react.react.ReactNode | undefined} */
trait HTMLPropsHTMLElementIElem extends StObject {
...
object HTMLPropsHTMLElementIElem {
  
  inline def apply(): HTMLPropsHTMLElementIElem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLPropsHTMLElementIElem]
  }
  
  extension [Self <: HTMLPropsHTMLElementIElem](x: Self) {
