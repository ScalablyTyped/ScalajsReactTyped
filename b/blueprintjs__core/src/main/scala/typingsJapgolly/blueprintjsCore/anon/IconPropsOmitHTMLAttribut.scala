...
trait IconPropsOmitHTMLAttribut extends StObject {
  ...
  var children: js.UndefOr[scala.Nothing] & js.UndefOr[Node]
...
object IconPropsOmitHTMLAttribut {
  ...
  inline def apply(children: js.UndefOr[scala.Nothing] & js.UndefOr[Node]): IconPropsOmitHTMLAttribut = {
  ...
  extension [Self <: IconPropsOmitHTMLAttribut](x: Self) {
    ...
    inline def setChildren(value: js.UndefOr[scala.Nothing] & js.UndefOr[Node]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
