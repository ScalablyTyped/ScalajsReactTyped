...
import typingsJapgolly.blueprintjsCore.anon.IHotkeysPropschildrenReacChildren
...
object libEsmComponentsHotkeysHotkeysEventsMod {
  ...
  object HotkeyScope extends StObject {
    ...
    sealed trait GLOBAL
      extends StObject
         with HotkeyScope
    /* "global" */ val GLOBAL: typingsJapgolly.blueprintjsCore.libEsmComponentsHotkeysHotkeysEventsMod.HotkeyScope.GLOBAL & String = js.native
    
    @js.native
    sealed trait LOCAL
      extends StObject
         with HotkeyScope
    /* "local" */ val LOCAL: typingsJapgolly.blueprintjsCore.libEsmComponentsHotkeysHotkeysEventsMod.HotkeyScope.LOCAL & String = js.native
  }
