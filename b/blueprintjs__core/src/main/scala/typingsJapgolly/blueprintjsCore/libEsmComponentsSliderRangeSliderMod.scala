...
object libEsmComponentsSliderRangeSliderMod {
  ...
  object IRangeSliderProps {
    ...
    extension [Self <: IRangeSliderProps](x: Self) {
      ...
      inline def setOnChange(value: /* value */ NumberRange => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* value */ NumberRange) => value(t0).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnRelease(value: /* value */ NumberRange => Callback): Self = StObject.set(x, "onRelease", js.Any.fromFunction1((t0: /* value */ NumberRange) => value(t0).runNow()))
