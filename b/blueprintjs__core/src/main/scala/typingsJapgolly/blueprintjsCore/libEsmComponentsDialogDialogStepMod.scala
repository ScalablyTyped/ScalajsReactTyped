...
object libEsmComponentsDialogDialogStepMod {
  
  @JSImport("@blueprintjs/core/lib/esm/components/dialog/dialogStep", "DialogStep")
  @js.native
  open class DialogStep protected ()
    extends AbstractPureComponent2[DialogStepProps, js.Object, js.Object] {
  ...
  object DialogStep {
    ...
    @JSImport("@blueprintjs/core/lib/esm/components/dialog/dialogStep", "DialogStep.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  }
  
  type DialogStepId = String | Double
  
  type DialogStepProps = IDialogStepProps
  
  /* Inlined parent @blueprintjs/core.@blueprintjs/core/lib/esm/common/props.Props */
  /* Inlined parent std.Omit<@blueprintjs/core.@blueprintjs/core/lib/esm/common/props.HTMLDivProps, 'id' | 'title' | 'onClick'> */
  trait IDialogStepProps extends StObject {
  ...
  object IDialogStepProps {
    
    inline def apply(id: DialogStepId, panel: VdomElement): IDialogStepProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], panel = panel.rawElement.asInstanceOf[js.Any])
      __obj.asInstanceOf[IDialogStepProps]
    }
    
    extension [Self <: IDialogStepProps](x: Self) {
      ...
      inline def setId(value: DialogStepId): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
