...
object libEsmComponentsSliderMultiSliderMod {
  ...
  object IMultiSliderProps {
    ...
    extension [Self <: IMultiSliderProps](x: Self) {
      ...
      inline def setOnRelease(value: /* values */ js.Array[Double] => Callback): Self = StObject.set(x, "onRelease", js.Any.fromFunction1((t0: /* values */ js.Array[Double]) => value(t0).runNow()))
