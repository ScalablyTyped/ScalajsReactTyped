...
import typingsJapgolly.blueprintjsCore.libEsmComponentsNavbarNavbarGroupMod.NavbarGroupProps
...
open class NavbarGroup protected ()
  extends typingsJapgolly.blueprintjsCore.libEsmComponentsMod.NavbarGroup {
