...
import typingsJapgolly.blueprintjsCore.libEsmComponentsNonIdealStateNonIdealStateMod.NonIdealStateProps
...
open class NonIdealState protected ()
  extends typingsJapgolly.blueprintjsCore.libEsmComponentsMod.NonIdealState {
