...
object Classes extends js.Object {
  ...
  def alignmentClass(alignment: typingsJapgolly.blueprintjsCore.alignmentMod.Alignment): String = js.native
  def elevationClass(elevation: typingsJapgolly.blueprintjsCore.elevationMod.Elevation): String = js.native
  ...
  def intentClass(intent: typingsJapgolly.blueprintjsCore.intentMod.Intent): String = js.native
  def positionClass(position: typingsJapgolly.blueprintjsCore.positionMod.Position): String = js.native
}
