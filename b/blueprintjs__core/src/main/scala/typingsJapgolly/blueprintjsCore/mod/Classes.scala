...
object Classes {
  ...
  inline def alignmentClass(alignment: typingsJapgolly.blueprintjsCore.libEsmCommonAlignmentMod.Alignment): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("alignmentClass")(alignment.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
  ...
  inline def elevationClass(elevation: typingsJapgolly.blueprintjsCore.libEsmCommonElevationMod.Elevation): String = ^.asInstanceOf[js.Dynamic].applyDynamic("elevationClass")(elevation.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def elevationClass_Union(elevation: typingsJapgolly.blueprintjsCore.libEsmCommonElevationMod.Elevation): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("elevationClass")(elevation.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
  ...
  inline def intentClass(): js.UndefOr[typingsJapgolly.blueprintjsCore.libEsmCommonIntentMod.Intent] = ^.asInstanceOf[js.Dynamic].applyDynamic("intentClass")().asInstanceOf[js.UndefOr[typingsJapgolly.blueprintjsCore.libEsmCommonIntentMod.Intent]]
  inline def intentClass(intent: typingsJapgolly.blueprintjsCore.libEsmCommonIntentMod.Intent): String = ^.asInstanceOf[js.Dynamic].applyDynamic("intentClass")(intent.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def intentClass_Union(intent: typingsJapgolly.blueprintjsCore.libEsmCommonIntentMod.Intent): js.UndefOr[typingsJapgolly.blueprintjsCore.libEsmCommonIntentMod.Intent] = ^.asInstanceOf[js.Dynamic].applyDynamic("intentClass")(intent.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.blueprintjsCore.libEsmCommonIntentMod.Intent]]
  ...
  inline def positionClass(position: typingsJapgolly.blueprintjsCore.libEsmCommonPositionMod.Position): String = ^.asInstanceOf[js.Dynamic].applyDynamic("positionClass")(position.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def positionClass_Union(position: typingsJapgolly.blueprintjsCore.libEsmCommonPositionMod.Position): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("positionClass")(position.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
}
