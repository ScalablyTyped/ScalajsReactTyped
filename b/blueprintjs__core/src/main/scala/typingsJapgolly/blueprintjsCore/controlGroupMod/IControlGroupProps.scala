...
- typingsJapgolly.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait IControlGroupProps extends HTMLAttributes[HTMLDivElement] {
  /**
