package typingsJapgolly.blueprintjsCore.cardMod
...
- typingsJapgolly.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait ICardProps extends HTMLAttributes[HTMLDivElement] {
  /**
  ...
  var onClick_ICardProps: js.UndefOr[
    js.Function1[/* e */ ReactMouseEventFrom[org.scalajs.dom.raw.HTMLDivElement], Unit]
  ] = js.undefined
}
...
object ICardProps {
  ...
  def apply(
    ...
    onClick: /* e */ ReactMouseEventFrom[org.scalajs.dom.raw.HTMLDivElement] => Callback = null,
