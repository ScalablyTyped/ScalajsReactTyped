...
object libEsmComponentsHotkeysHotkeysTarget2Mod {
  ...
  object HotkeysTarget2RenderProps {
    ...
    inline def apply(
      handleKeyDown: ReactKeyboardEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback,
      handleKeyUp: ReactKeyboardEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback
    ): HotkeysTarget2RenderProps = {
      val __obj = js.Dynamic.literal(handleKeyDown = js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLElement & org.scalajs.dom.Element]) => handleKeyDown(t0).runNow()), handleKeyUp = js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLElement & org.scalajs.dom.Element]) => handleKeyUp(t0).runNow()))
      __obj.asInstanceOf[HotkeysTarget2RenderProps]
    }
    
    extension [Self <: HotkeysTarget2RenderProps](x: Self) {
      
      inline def setHandleKeyDown(value: ReactKeyboardEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "handleKeyDown", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLElement & org.scalajs.dom.Element]) => value(t0).runNow()))
      
      inline def setHandleKeyUp(value: ReactKeyboardEventFrom[HTMLElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "handleKeyUp", js.Any.fromFunction1((t0: ReactKeyboardEventFrom[HTMLElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    }
  }
}
