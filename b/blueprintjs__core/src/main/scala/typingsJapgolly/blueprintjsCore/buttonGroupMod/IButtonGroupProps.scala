package typingsJapgolly.blueprintjsCore.buttonGroupMod
...
- typingsJapgolly.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait IButtonGroupProps extends HTMLAttributes[HTMLDivElement] {
  /**
