...
object libEsmComponentsEditableTextEditableTextMod {
  ...
  object IEditableTextProps {
    ...
    extension [Self <: IEditableTextProps](x: Self) {
      ...
      inline def setOnConfirm(value: /* value */ String => Callback): Self = StObject.set(x, "onConfirm", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
      
      inline def setOnConfirmUndefined: Self = StObject.set(x, "onConfirm", js.undefined)
      
      inline def setOnEdit(value: /* value */ js.UndefOr[String] => Callback): Self = StObject.set(x, "onEdit", js.Any.fromFunction1((t0: /* value */ js.UndefOr[String]) => value(t0).runNow()))
