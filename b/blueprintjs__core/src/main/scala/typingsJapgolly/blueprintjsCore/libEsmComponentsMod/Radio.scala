...
import typingsJapgolly.blueprintjsCore.libEsmComponentsFormsControlsMod.RadioProps
...
open class Radio protected ()
  extends typingsJapgolly.blueprintjsCore.libEsmComponentsFormsControlsMod.Radio {
