...
object libEsmComponentsFormsNumericInputUtilsMod {
  ...
  inline def isValidNumericKeyboardEvent(e: ReactKeyboardEventFrom[Element]): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isValidNumericKeyboardEvent")(e.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def isValidNumericKeyboardEvent(e: ReactKeyboardEventFrom[Element], locale: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isValidNumericKeyboardEvent")(e.asInstanceOf[js.Any], locale.asInstanceOf[js.Any])).asInstanceOf[Boolean]
