...
object libEsmComponentsSliderHandlePropsMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.blueprintjsCore.blueprintjsCoreStrings.full
  ...
  */
  ...
  object IHandleProps {
    ...
    extension [Self <: IHandleProps](x: Self) {
      ...
      inline def setOnChange(value: /* newValue */ Double => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* newValue */ Double) => value(t0).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnRelease(value: /* newValue */ Double => Callback): Self = StObject.set(x, "onRelease", js.Any.fromFunction1((t0: /* newValue */ Double) => value(t0).runNow()))
