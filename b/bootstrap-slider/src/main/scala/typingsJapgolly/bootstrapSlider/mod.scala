...
object mod {
  ...
  object SliderEvent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(isDefaultPrevented = isDefaultPrevented.toJsFn, isImmediatePropagationStopped = isImmediatePropagationStopped.toJsFn, isPropagationStopped = isPropagationStopped.toJsFn, preventDefault = preventDefault.toJsFn, stopImmediatePropagation = stopImmediatePropagation.toJsFn, stopPropagation = stopPropagation.toJsFn, timeStamp = timeStamp.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slide
    - typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideStart
    - typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideStop
    - typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.change
    - typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideEnabled
    - typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideDisabled
  */
  trait SliderEventType extends StObject
  object SliderEventType {
    
    inline def change: typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.change = "change".asInstanceOf[typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.change]
    
    inline def slide: typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slide = "slide".asInstanceOf[typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slide]
    
    inline def slideDisabled: typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideDisabled = "slideDisabled".asInstanceOf[typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideDisabled]
    
    inline def slideEnabled: typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideEnabled = "slideEnabled".asInstanceOf[typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideEnabled]
    
    inline def slideStart: typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideStart = "slideStart".asInstanceOf[typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideStart]
    
    inline def slideStop: typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideStop = "slideStop".asInstanceOf[typingsJapgolly.bootstrapSlider.bootstrapSliderStrings.slideStop]
  }
