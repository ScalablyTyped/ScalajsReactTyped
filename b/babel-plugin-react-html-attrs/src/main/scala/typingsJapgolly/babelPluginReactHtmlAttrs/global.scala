package typingsJapgolly.babelPluginReactHtmlAttrs

import org.scalajs.dom.Element
import org.scalajs.dom.HTMLElement
import org.scalajs.dom.HTMLInputElement
import org.scalajs.dom.SVGElement
import typingsJapgolly.babelPluginReactHtmlAttrs.anon.Default
import typingsJapgolly.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.input
import typingsJapgolly.babelPluginReactHtmlAttrs.experimentalMod.babelPluginReactHtmlAttrsAugmentingMod.SuspenseConfig
import typingsJapgolly.babelPluginReactHtmlAttrs.experimentalMod.babelPluginReactHtmlAttrsAugmentingMod.SuspenseListProps
import typingsJapgolly.babelPluginReactHtmlAttrs.experimentalMod.babelPluginReactHtmlAttrsAugmentingMod.TimeoutConfig
import typingsJapgolly.babelPluginReactHtmlAttrs.experimentalMod.babelPluginReactHtmlAttrsAugmentingMod.TransitionStartFunction
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.Attributes
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.CElement
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.CFactory
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ClassAttributes
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ClassType
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ClassicComponent
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ClassicComponentClass
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ComponentClass
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ComponentProps
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ComponentState
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ComponentType
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.Context
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.DOMAttributes
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.DOMElement
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.DOMFactory
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.DependencyList
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.DetailedReactHTMLElement
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.Dispatch
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.DispatchWithoutAction
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.EffectCallback
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ExoticComponent
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.Factory
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ForwardRefExoticComponent
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ForwardRefRenderFunction
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.FunctionComponent
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.FunctionComponentElement
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.FunctionComponentFactory
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.HTMLAttributes
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.HTMLFactory
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.InputHTMLAttributes
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.JSXElementConstructor
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.LazyExoticComponent
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.MemoExoticComponent
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.MutableRefObject
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.NamedExoticComponent
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ProfilerProps
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.PropsWithChildren
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.PropsWithoutRef
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ReactChildren
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ReactElement
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ReactHTMLElement
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ReactNode
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ReactSVGElement
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.Reducer
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ReducerAction
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ReducerState
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ReducerStateWithoutAction
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.ReducerWithoutAction
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.Ref
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.RefAttributes
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.RefObject
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.SFC
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.SVGAttributes
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.SVGFactory
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.SetStateAction
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.SuspenseProps
...
object global {
  ...
  object React {
    ...
    open class Component[P, S, SS] protected ()
      extends typingsJapgolly.babelPluginReactHtmlAttrs.mod.Component[P, S, SS] {
    ...
    @js.native
    val Fragment: ExoticComponent[typingsJapgolly.babelPluginReactHtmlAttrs.anon.Children] = js.native
    ...
    open class PureComponent[P, S, SS] protected ()
      extends typingsJapgolly.babelPluginReactHtmlAttrs.mod.PureComponent[P, S, SS] {
      def this(props: P) = this()
      def this(props: P, context: Any) = this()
    }
    ...
    @js.native
    val StrictMode: ExoticComponent[typingsJapgolly.babelPluginReactHtmlAttrs.anon.Children] = js.native
    ...
    inline def cloneElement[P, T /* <: typingsJapgolly.babelPluginReactHtmlAttrs.mod.Component[P, ComponentState, Any] */](element: CElement[P, T], props: Partial[P] & ClassAttributes[T], children: ReactNode*): CElement[P, T] = (^.asInstanceOf[js.Dynamic].applyDynamic("cloneElement")((scala.List(element.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[CElement[P, T]]
    inline def cloneElement[P, T /* <: typingsJapgolly.babelPluginReactHtmlAttrs.mod.Component[P, ComponentState, Any] */](element: CElement[P, T], props: Unit, children: ReactNode*): CElement[P, T] = (^.asInstanceOf[js.Dynamic].applyDynamic("cloneElement")((scala.List(element.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[CElement[P, T]]
    ...
    inline def createElement[P /* <: SVGAttributes[T] */, T /* <: SVGElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55, starting with typingsJapgolly.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.animate, typingsJapgolly.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.circle, typingsJapgolly.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.clipPath */ Any,
    ...
    inline def createElement_PTC_CElement[P /* <: js.Object */, T /* <: typingsJapgolly.babelPluginReactHtmlAttrs.mod.Component[P, ComponentState, Any] */, C /* <: ComponentClass[P, ComponentState] */](`type`: ClassType[P, T, C], props: ClassAttributes[T] & P, children: ReactNode*): CElement[P, T] = (^.asInstanceOf[js.Dynamic].applyDynamic("createElement")((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[CElement[P, T]]
    inline def createElement_PTC_CElement[P /* <: js.Object */, T /* <: typingsJapgolly.babelPluginReactHtmlAttrs.mod.Component[P, ComponentState, Any] */, C /* <: ComponentClass[P, ComponentState] */](`type`: ClassType[P, T, C], props: Null, children: ReactNode*): CElement[P, T] = (^.asInstanceOf[js.Dynamic].applyDynamic("createElement")((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[CElement[P, T]]
    inline def createElement_PTC_CElement[P /* <: js.Object */, T /* <: typingsJapgolly.babelPluginReactHtmlAttrs.mod.Component[P, ComponentState, Any] */, C /* <: ComponentClass[P, ComponentState] */](`type`: ClassType[P, T, C], props: Unit, children: ReactNode*): CElement[P, T] = (^.asInstanceOf[js.Dynamic].applyDynamic("createElement")((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[CElement[P, T]]
    ...
    inline def createElement_PT_DetailedReactHTMLElement[P /* <: HTMLAttributes[T] */, T /* <: HTMLElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 116, starting with typingsJapgolly.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.a_, typingsJapgolly.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.abbr, typingsJapgolly.babelPluginReactHtmlAttrs.babelPluginReactHtmlAttrsStrings.address */ Any,
      props: ClassAttributes[T] & P,
      children: ReactNode*
    ...
    inline def createFactory_PTC_CFactory[P, T /* <: typingsJapgolly.babelPluginReactHtmlAttrs.mod.Component[P, ComponentState, Any] */, C /* <: ComponentClass[P, ComponentState] */](`type`: ClassType[P, T, C]): CFactory[P, T] = ^.asInstanceOf[js.Dynamic].applyDynamic("createFactory")(`type`.asInstanceOf[js.Any]).asInstanceOf[CFactory[P, T]]
