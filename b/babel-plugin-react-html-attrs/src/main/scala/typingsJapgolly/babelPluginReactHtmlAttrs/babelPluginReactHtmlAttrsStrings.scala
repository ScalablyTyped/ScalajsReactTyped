...
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.SuspenseListRevealOrder
import typingsJapgolly.babelPluginReactHtmlAttrs.mod.SuspenseListTailMode
...
object babelPluginReactHtmlAttrsStrings {
  ...
  sealed trait backwards
    extends StObject
       ...
       with typingsJapgolly.babelPluginReactHtmlAttrs.experimentalMod.babelPluginReactHtmlAttrsAugmentingMod.SuspenseListRevealOrder
  ...
  sealed trait collapsed
    extends StObject
       ...
       with typingsJapgolly.babelPluginReactHtmlAttrs.experimentalMod.babelPluginReactHtmlAttrsAugmentingMod.SuspenseListTailMode
