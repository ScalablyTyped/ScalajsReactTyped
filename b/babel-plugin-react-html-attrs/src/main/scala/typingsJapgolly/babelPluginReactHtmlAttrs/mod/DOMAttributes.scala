...
import typingsJapgolly.babelPluginReactHtmlAttrs.anon.Html
...
object DOMAttributes {
  ...
  extension [Self <: DOMAttributes[?], T](x: Self & DOMAttributes[T]) {
    ...
    inline def setOnScroll(value: UIEvent[T, org.scalajs.dom.UIEvent] => Callback): Self = StObject.set(x, "onScroll", js.Any.fromFunction1((t0: UIEvent[T, org.scalajs.dom.UIEvent]) => value(t0).runNow()))
    
    inline def setOnScrollCapture(value: UIEvent[T, org.scalajs.dom.UIEvent] => Callback): Self = StObject.set(x, "onScrollCapture", js.Any.fromFunction1((t0: UIEvent[T, org.scalajs.dom.UIEvent]) => value(t0).runNow()))
