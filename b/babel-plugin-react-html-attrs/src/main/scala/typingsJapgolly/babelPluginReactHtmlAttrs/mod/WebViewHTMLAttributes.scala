...
object WebViewHTMLAttributes {
  ...
  extension [Self <: WebViewHTMLAttributes[?], T](x: Self & WebViewHTMLAttributes[T]) {
    ...
    inline def setAllowpopups(value: Boolean | String): Self = StObject.set(x, "allowpopups", value.asInstanceOf[js.Any])
    ...
    inline def setDisableguestresize(value: Boolean | String): Self = StObject.set(x, "disableguestresize", value.asInstanceOf[js.Any])
    
    inline def setDisableguestresizeUndefined: Self = StObject.set(x, "disableguestresize", js.undefined)
    
    inline def setDisablewebsecurity(value: Boolean | String): Self = StObject.set(x, "disablewebsecurity", value.asInstanceOf[js.Any])
    ...
    inline def setNodeintegration(value: Boolean | String): Self = StObject.set(x, "nodeintegration", value.asInstanceOf[js.Any])
    ...
    inline def setPlugins(value: Boolean | String): Self = StObject.set(x, "plugins", value.asInstanceOf[js.Any])
