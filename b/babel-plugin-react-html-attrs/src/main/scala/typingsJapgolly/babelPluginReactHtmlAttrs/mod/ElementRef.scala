...
/** NOTE: Conditional type definitions are impossible to translate to Scala.
  ...
  */
@js.native
trait ElementRef[C /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typingsJapgolly.babelPluginReactHtmlAttrs.mod.ForwardRefExoticComponent[scala.Any], typingsJapgolly.babelPluginReactHtmlAttrs.anon.Instantiable, js.Function2[
/ * props * / scala.Any, 
/ * context * / js.UndefOr[scala.Any], 
(typingsJapgolly.babelPluginReactHtmlAttrs.mod.ReactElement[
  scala.Any, 
  java.lang.String | typingsJapgolly.babelPluginReactHtmlAttrs.mod.JSXElementConstructor[scala.Any]
