...
trait ReactHTML extends StObject {
  ...
  var bdo: DetailedHTMLFactory[BdoHTMLAttributes[HTMLElement], HTMLElement]
...
object ReactHTML {
  ...
  inline def apply(
    ...
    bdo: DetailedHTMLFactory[BdoHTMLAttributes[HTMLElement], HTMLElement],
  ...
  extension [Self <: ReactHTML](x: Self) {
    ...
    inline def setBdo(value: DetailedHTMLFactory[BdoHTMLAttributes[HTMLElement], HTMLElement]): Self = StObject.set(x, "bdo", value.asInstanceOf[js.Any])
    ...
    inline def setWebview(value: DetailedHTMLFactory[WebViewHTMLAttributes[HTMLElement], HTMLElement]): Self = StObject.set(x, "webview", value.asInstanceOf[js.Any])
  }
}
