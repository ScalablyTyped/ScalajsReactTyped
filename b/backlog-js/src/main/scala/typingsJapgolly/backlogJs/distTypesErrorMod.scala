...
object distTypesErrorMod {
  ...
  */
  ...
  object BacklogErrorNameType {
    ...
    inline def BacklogApiError: typingsJapgolly.backlogJs.backlogJsStrings.BacklogApiError = "BacklogApiError".asInstanceOf[typingsJapgolly.backlogJs.backlogJsStrings.BacklogApiError]
    
    inline def BacklogAuthError: typingsJapgolly.backlogJs.backlogJsStrings.BacklogAuthError = "BacklogAuthError".asInstanceOf[typingsJapgolly.backlogJs.backlogJsStrings.BacklogAuthError]
    
    inline def UnexpectedError: typingsJapgolly.backlogJs.backlogJsStrings.UnexpectedError = "UnexpectedError".asInstanceOf[typingsJapgolly.backlogJs.backlogJsStrings.UnexpectedError]
  }
}
