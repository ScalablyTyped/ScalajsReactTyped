...
object distTypesEntityMod {
  ...
  object File {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.backlogJs.distTypesEntityMod.File.NodeFileData
      - typingsJapgolly.backlogJs.distTypesEntityMod.File.BrowserFileData
    */
    trait FileData extends StObject
    object FileData {
      
      inline def BrowserFileData(body: Any, url: String): typingsJapgolly.backlogJs.distTypesEntityMod.File.BrowserFileData = {
        val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.backlogJs.distTypesEntityMod.File.BrowserFileData]
      }
      
      inline def NodeFileData(body: PassThrough, filename: String, url: String): typingsJapgolly.backlogJs.distTypesEntityMod.File.NodeFileData = {
        ...
        __obj.asInstanceOf[typingsJapgolly.backlogJs.distTypesEntityMod.File.NodeFileData]
      }
    }
