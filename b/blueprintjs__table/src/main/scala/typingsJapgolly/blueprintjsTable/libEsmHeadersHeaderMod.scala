...
import typingsJapgolly.blueprintjsTable.libEsmInteractionsReorderableMod.IReorderableProps
...
object libEsmHeadersHeaderMod {
  ...
  type IHeaderCellRenderer = js.Function1[/* index */ Double, Element]
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.blueprintjsTable.libEsmInteractionsSelectableMod.ISelectableProps because var conflicts: selectedRegions. Inlined enableMultipleSelection, focusedCell, onSelectionEnd, selectedRegionTransform */ @js.native
  trait IHeaderProps
    extends StObject
  ...
  trait IInternalHeaderProps
    ...
    /**
      ...
      */
    def ghostCellRenderer(index: Double, extremaClasses: js.Array[String]): typingsJapgolly.react.mod.global.JSX.Element = js.native
    ...
    /**
      ...
      */
    def headerCellRenderer(index: Double): typingsJapgolly.react.mod.global.JSX.Element | Null = js.native
    ...
    /**
      ...
      */
    def wrapCells(cells: js.Array[Element]): typingsJapgolly.react.mod.global.JSX.Element = js.native
  }
}
