...
import typingsJapgolly.blueprintjsTable.libEsmHeadersRowHeaderMod.RowHeaderRenderer
...
import typingsJapgolly.blueprintjsTable.libEsmInteractionsResizableMod.IIndexedResizeCallback
...
object libEsmTablePropsMod {
  ...
  object ITableProps {
    ...
    extension [Self <: ITableProps](x: Self) {
      ...
      inline def setBodyContextMenuRenderer(value: /* context */ IMenuContext => typingsJapgolly.react.mod.global.JSX.Element): Self = StObject.set(x, "bodyContextMenuRenderer", js.Any.fromFunction1(value))
      ...
      inline def setOnColumnWidthChanged(value: (/* index */ Double, /* size */ Double) => Callback): Self = StObject.set(x, "onColumnWidthChanged", js.Any.fromFunction2((t0: /* index */ Double, t1: /* size */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnColumnWidthChangedUndefined: Self = StObject.set(x, "onColumnWidthChanged", js.undefined)
      
      inline def setOnColumnsReordered(value: (/* oldIndex */ Double, /* newIndex */ Double, /* length */ Double) => Callback): Self = StObject.set(x, "onColumnsReordered", js.Any.fromFunction3((t0: /* oldIndex */ Double, t1: /* newIndex */ Double, t2: /* length */ Double) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnRowHeightChanged(value: (/* index */ Double, /* size */ Double) => Callback): Self = StObject.set(x, "onRowHeightChanged", js.Any.fromFunction2((t0: /* index */ Double, t1: /* size */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnRowHeightChangedUndefined: Self = StObject.set(x, "onRowHeightChanged", js.undefined)
      
      inline def setOnRowsReordered(value: (/* oldIndex */ Double, /* newIndex */ Double, /* length */ Double) => Callback): Self = StObject.set(x, "onRowsReordered", js.Any.fromFunction3((t0: /* oldIndex */ Double, t1: /* newIndex */ Double, t2: /* length */ Double) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnRowsReorderedUndefined: Self = StObject.set(x, "onRowsReordered", js.undefined)
      
      inline def setOnSelection(value: /* selectedRegions */ js.Array[Region] => Callback): Self = StObject.set(x, "onSelection", js.Any.fromFunction1((t0: /* selectedRegions */ js.Array[Region]) => value(t0).runNow()))
      
      inline def setOnSelectionUndefined: Self = StObject.set(x, "onSelection", js.undefined)
      
      inline def setOnVisibleCellsChange(value: (/* rowIndices */ RowIndices, /* columnIndices */ ColumnIndices) => Callback): Self = StObject.set(x, "onVisibleCellsChange", js.Any.fromFunction2((t0: /* rowIndices */ RowIndices, t1: /* columnIndices */ ColumnIndices) => (value(t0, t1)).runNow()))
  ...
  object TablePropsDefaults {
    ...
    inline def apply(
      ...
      rowHeaderCellRenderer: /* rowIndex */ Double => Element,
