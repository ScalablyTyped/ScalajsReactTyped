...
import typingsJapgolly.blueprintjsTable.libEsmHeadersHeaderCellMod.IHeaderCellProps
...
object libEsmHeadersRowHeaderCellMod {
  ...
  object IRowHeaderCellProps {
    ...
    extension [Self <: IRowHeaderCellProps](x: Self) {
      ...
      inline def setNameRenderer(value: (/* name */ String, /* index */ js.UndefOr[Double]) => Element): Self = StObject.set(x, "nameRenderer", js.Any.fromFunction2(value))
