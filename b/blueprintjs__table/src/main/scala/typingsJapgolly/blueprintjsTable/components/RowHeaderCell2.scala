...
object RowHeaderCell2 {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsTable.mod.RowHeaderCell2] {
  ...
  implicit def make(companion: RowHeaderCell2.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
