...
import typingsJapgolly.blueprintjsTable.libEsmTable2Mod.Table2Props
...
object Table2 {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsTable.mod.Table2] {
    ...
    inline def cellRendererDependencies(value: DependencyList): this.type = set("cellRendererDependencies", value.asInstanceOf[js.Any])
    
    inline def cellRendererDependenciesVarargs(value: Any*): this.type = set("cellRendererDependencies", js.Array(value*))
  ...
  implicit def make(companion: Table2.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: Table2Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
