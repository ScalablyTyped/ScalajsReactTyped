...
import typingsJapgolly.blueprintjsTable.libEsmHeadersColumnHeaderCell2Mod.ColumnHeaderCell2Props
...
object ColumnHeaderCell2 {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.blueprintjsTable.mod.ColumnHeaderCell2] {
  ...
  implicit def make(companion: ColumnHeaderCell2.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ColumnHeaderCell2Props): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
