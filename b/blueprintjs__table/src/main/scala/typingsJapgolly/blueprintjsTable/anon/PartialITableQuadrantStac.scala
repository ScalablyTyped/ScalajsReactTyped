...
object PartialITableQuadrantStac {
  ...
  extension [Self <: PartialITableQuadrantStac](x: Self) {
    ...
    inline def setColumnHeaderRefFunction1(value: HTMLDivElement | Null => Callback): Self = StObject.set(x, "columnHeaderRef", js.Any.fromFunction1((t0: HTMLDivElement | Null) => value(t0).runNow()))
    ...
    inline def setHandleColumnResizeGuide(value: /* verticalGuides */ js.Array[Double] => Callback): Self = StObject.set(x, "handleColumnResizeGuide", js.Any.fromFunction1((t0: /* verticalGuides */ js.Array[Double]) => value(t0).runNow()))
    
    inline def setHandleColumnResizeGuideUndefined: Self = StObject.set(x, "handleColumnResizeGuide", js.undefined)
    
    inline def setHandleColumnsReordering(value: /* verticalGuides */ js.Array[Double] => Callback): Self = StObject.set(x, "handleColumnsReordering", js.Any.fromFunction1((t0: /* verticalGuides */ js.Array[Double]) => value(t0).runNow()))
    
    inline def setHandleColumnsReorderingUndefined: Self = StObject.set(x, "handleColumnsReordering", js.undefined)
    
    inline def setHandleRowResizeGuide(value: /* horizontalGuides */ js.Array[Double] => Callback): Self = StObject.set(x, "handleRowResizeGuide", js.Any.fromFunction1((t0: /* horizontalGuides */ js.Array[Double]) => value(t0).runNow()))
    
    inline def setHandleRowResizeGuideUndefined: Self = StObject.set(x, "handleRowResizeGuide", js.undefined)
    
    inline def setHandleRowsReordering(value: /* horizontalGuides */ js.Array[Double] => Callback): Self = StObject.set(x, "handleRowsReordering", js.Any.fromFunction1((t0: /* horizontalGuides */ js.Array[Double]) => value(t0).runNow()))
    ...
    inline def setOnScroll(value: ReactEventFrom[HTMLElement] => Callback): Self = StObject.set(x, "onScroll", js.Any.fromFunction1((t0: ReactEventFrom[HTMLElement]) => value(t0).runNow()))
    ...
    inline def setRowHeaderRefFunction1(value: HTMLDivElement | Null => Callback): Self = StObject.set(x, "rowHeaderRef", js.Any.fromFunction1((t0: HTMLDivElement | Null) => value(t0).runNow()))
