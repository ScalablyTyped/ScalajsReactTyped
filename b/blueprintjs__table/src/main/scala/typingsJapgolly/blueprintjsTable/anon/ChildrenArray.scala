...
import typingsJapgolly.blueprintjsTable.libEsmCommonCellTypesMod.IFocusedCellCoordinates
...
object ChildrenArray {
  ...
  extension [Self <: ChildrenArray](x: Self) {
    ...
    inline def setChildrenArray(value: js.Array[Element]): Self = StObject.set(x, "childrenArray", value.asInstanceOf[js.Any])
    
    inline def setChildrenArrayVarargs(value: Element*): Self = StObject.set(x, "childrenArray", js.Array(value*))
