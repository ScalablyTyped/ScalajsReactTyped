...
object libEsmInteractionsDragTypesMod {
  ...
  object IDragHandler {
    ...
    extension [Self <: IDragHandler](x: Self) {
      ...
      inline def setOnDoubleClick(value: /* event */ MouseEvent => Callback): Self = StObject.set(x, "onDoubleClick", js.Any.fromFunction1((t0: /* event */ MouseEvent) => value(t0).runNow()))
      
      inline def setOnDoubleClickUndefined: Self = StObject.set(x, "onDoubleClick", js.undefined)
      
      inline def setOnDragEnd(value: (/* event */ MouseEvent, /* coords */ ICoordinateData) => Callback): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction2((t0: /* event */ MouseEvent, t1: /* coords */ ICoordinateData) => (value(t0, t1)).runNow()))
      
      inline def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
      
      inline def setOnDragMove(value: (/* event */ MouseEvent, /* coords */ ICoordinateData) => Callback): Self = StObject.set(x, "onDragMove", js.Any.fromFunction2((t0: /* event */ MouseEvent, t1: /* coords */ ICoordinateData) => (value(t0, t1)).runNow()))
