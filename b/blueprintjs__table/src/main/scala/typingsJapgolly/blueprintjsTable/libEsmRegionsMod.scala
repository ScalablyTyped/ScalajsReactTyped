...
object libEsmRegionsMod {
  ...
  object ColumnLoadingOption extends StObject {
    ...
    /* "cells" */ val CELLS: typingsJapgolly.blueprintjsTable.libEsmRegionsMod.ColumnLoadingOption.CELLS & String = js.native
    
    @js.native
    sealed trait HEADER
      extends StObject
         with ColumnLoadingOption
    /* "column-header" */ val HEADER: typingsJapgolly.blueprintjsTable.libEsmRegionsMod.ColumnLoadingOption.HEADER & String = js.native
  }
  ...
  object RegionCardinality extends StObject {
    ...
    /* "cells" */ val CELLS: typingsJapgolly.blueprintjsTable.libEsmRegionsMod.RegionCardinality.CELLS & String = js.native
    ...
    sealed trait FULL_COLUMNS
      extends StObject
         with RegionCardinality
    /* "full-columns" */ val FULL_COLUMNS: typingsJapgolly.blueprintjsTable.libEsmRegionsMod.RegionCardinality.FULL_COLUMNS & String = js.native
    ...
    sealed trait FULL_ROWS
      extends StObject
         with RegionCardinality
    /* "full-rows" */ val FULL_ROWS: typingsJapgolly.blueprintjsTable.libEsmRegionsMod.RegionCardinality.FULL_ROWS & String = js.native
    ...
    sealed trait FULL_TABLE
      extends StObject
         with RegionCardinality
    /* "full-table" */ val FULL_TABLE: typingsJapgolly.blueprintjsTable.libEsmRegionsMod.RegionCardinality.FULL_TABLE & String = js.native
  }
  ...
  object TableLoadingOption extends StObject {
    ...
    /* "cells" */ val CELLS: typingsJapgolly.blueprintjsTable.libEsmRegionsMod.TableLoadingOption.CELLS & String = js.native
    
    @js.native
    sealed trait COLUMN_HEADERS
      extends StObject
         with TableLoadingOption
    /* "column-header" */ val COLUMN_HEADERS: typingsJapgolly.blueprintjsTable.libEsmRegionsMod.TableLoadingOption.COLUMN_HEADERS & String = js.native
    
    @js.native
    sealed trait ROW_HEADERS
      extends StObject
         with TableLoadingOption
    /* "row-header" */ val ROW_HEADERS: typingsJapgolly.blueprintjsTable.libEsmRegionsMod.TableLoadingOption.ROW_HEADERS & String = js.native
  }
