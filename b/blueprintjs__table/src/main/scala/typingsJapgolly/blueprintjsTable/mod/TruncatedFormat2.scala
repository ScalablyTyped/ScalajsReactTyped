...
@js.native
open class TruncatedFormat2 protected ()
  extends typingsJapgolly.blueprintjsTable.libEsmCellFormatsTruncatedFormat2Mod.TruncatedFormat2 {
...
object TruncatedFormat2 {
  ...
  @JSImport("@blueprintjs/table", "TruncatedFormat2.defaultProps")
  @js.native
  ...
  @JSImport("@blueprintjs/table", "TruncatedFormat2.displayName")
  @js.native
