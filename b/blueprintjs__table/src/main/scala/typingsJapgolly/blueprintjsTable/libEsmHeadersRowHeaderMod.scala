...
import typingsJapgolly.blueprintjsTable.anon.RowHeaderCellRenderer
...
import typingsJapgolly.blueprintjsTable.libEsmHeadersHeaderMod.IHeaderProps
...
object libEsmHeadersRowHeaderMod {
  ...
  type IRowHeaderRenderer = js.Function1[/* rowIndex */ Double, japgolly.scalajs.react.facade.React.Element]
