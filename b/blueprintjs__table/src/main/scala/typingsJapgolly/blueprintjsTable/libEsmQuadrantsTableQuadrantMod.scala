...
import typingsJapgolly.blueprintjsTable.anon.PartialITableQuadrantProp
...
object libEsmQuadrantsTableQuadrantMod {
  ...
  object QuadrantType extends StObject {
    ...
    sealed trait LEFT
      extends StObject
         with QuadrantType
    /* "left" */ val LEFT: typingsJapgolly.blueprintjsTable.libEsmQuadrantsTableQuadrantMod.QuadrantType.LEFT & String = js.native
    ...
    sealed trait MAIN
      extends StObject
         with QuadrantType
    /* "main" */ val MAIN: typingsJapgolly.blueprintjsTable.libEsmQuadrantsTableQuadrantMod.QuadrantType.MAIN & String = js.native
    ...
    sealed trait TOP
      extends StObject
         with QuadrantType
    /* "top" */ val TOP: typingsJapgolly.blueprintjsTable.libEsmQuadrantsTableQuadrantMod.QuadrantType.TOP & String = js.native
    ...
    sealed trait TOP_LEFT
      extends StObject
         with QuadrantType
    /* "top-left" */ val TOP_LEFT: typingsJapgolly.blueprintjsTable.libEsmQuadrantsTableQuadrantMod.QuadrantType.TOP_LEFT & String = js.native
  }
