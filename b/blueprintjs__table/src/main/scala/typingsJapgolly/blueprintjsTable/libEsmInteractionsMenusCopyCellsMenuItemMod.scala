...
import typingsJapgolly.blueprintjsCore.libEsmComponentsMenuMenuItemMod.IMenuItemProps
...
object libEsmInteractionsMenusCopyCellsMenuItemMod {
  ...
  object ICopyCellsMenuItemProps {
    ...
    inline def apply(context: IMenuContext, getCellData: (Double, Double) => Any): ICopyCellsMenuItemProps = {
      val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any], getCellData = js.Any.fromFunction2(getCellData), text = null)
    ...
    extension [Self <: ICopyCellsMenuItemProps](x: Self) {
      ...
      inline def setOnCopy(value: /* success */ Boolean => Callback): Self = StObject.set(x, "onCopy", js.Any.fromFunction1((t0: /* success */ Boolean) => value(t0).runNow()))
