...
object libEsmHeadersEditableNameMod {
  ...
  object IEditableNameProps {
    ...
    extension [Self <: IEditableNameProps](x: Self) {
      ...
      inline def setOnCancel(value: (/* value */ String, /* columnIndex */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "onCancel", js.Any.fromFunction2((t0: /* value */ String, t1: /* columnIndex */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
      
      inline def setOnCancelUndefined: Self = StObject.set(x, "onCancel", js.undefined)
      
      inline def setOnChange(value: (/* value */ String, /* columnIndex */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* value */ String, t1: /* columnIndex */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnConfirm(value: (/* value */ String, /* columnIndex */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "onConfirm", js.Any.fromFunction2((t0: /* value */ String, t1: /* columnIndex */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
