...
import typingsJapgolly.blueprintjsTable.libEsmHeadersColumnHeaderCellMod.IColumnNameProps
import typingsJapgolly.blueprintjsTable.libEsmHeadersColumnHeaderMod.ColumnHeaderRenderer
...
object libEsmColumnMod {
  ...
  object IColumnProps {
    ...
    extension [Self <: IColumnProps](x: Self) {
      ...
      inline def setCellRenderer(value: (/* rowIndex */ Double, /* columnIndex */ Double) => js.UndefOr[Element]): Self = StObject.set(x, "cellRenderer", js.Any.fromFunction2(value))
      
      inline def setCellRendererUndefined: Self = StObject.set(x, "cellRenderer", js.undefined)
      
      inline def setColumnHeaderCellRenderer(value: /* columnIndex */ Double => Element | Null): Self = StObject.set(x, "columnHeaderCellRenderer", js.Any.fromFunction1(value))
