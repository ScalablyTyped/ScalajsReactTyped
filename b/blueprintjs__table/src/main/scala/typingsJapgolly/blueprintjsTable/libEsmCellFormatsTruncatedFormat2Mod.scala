...
import typingsJapgolly.blueprintjsTable.libEsmCellFormatsTruncatedFormatMod.ITruncatedFormatState
import typingsJapgolly.blueprintjsTable.libEsmCellFormatsTruncatedFormatMod.TruncatedFormatProps
