...
import typingsJapgolly.blueprintjsTable.anon.IsActive
import typingsJapgolly.blueprintjsTable.anon.ValidationMapColumnIntera
import typingsJapgolly.blueprintjsTable.libEsmCommonContextMod.ColumnInteractionBarContextTypes_
...
object libEsmHeadersColumnHeaderCellMod {
  ...
  - typingsJapgolly.blueprintjsTable.libEsmHeadersColumnHeaderCellMod.IColumnNameProps because var conflicts: name. Inlined nameRenderer */ trait IColumnHeaderCellProps
    extends StObject
  ...
  object IColumnHeaderCellProps {
    ...
    extension [Self <: IColumnHeaderCellProps](x: Self) {
      ...
      inline def setMenuIconVdomElement(value: VdomElement): Self = StObject.set(x, "menuIcon", value.rawElement.asInstanceOf[js.Any])
      
      inline def setNameRenderer(
        value: (/* name */ String, /* index */ js.UndefOr[Double]) => japgolly.scalajs.react.facade.React.Element
      ): Self = StObject.set(x, "nameRenderer", js.Any.fromFunction2(value))
