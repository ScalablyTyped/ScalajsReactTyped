...
import typingsJapgolly.bootstrap3Typeahead.anon.Name
...
object Bootstrap3Typeahead {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setScrollHeightCallbackTo(value: CallbackTo[Double]): Self = StObject.set(x, "scrollHeight", value.toJsFn)
      ...
      inline def setSourceFunction2(
        value: (/* query */ js.UndefOr[String], /* process */ js.UndefOr[js.Function1[/* callback */ Any, String | (js.Array[js.Object | String])]]) => Callback
      ): Self = StObject.set(x, "source", js.Any.fromFunction2((t0: /* query */ js.UndefOr[String], t1: /* process */ js.UndefOr[js.Function1[/* callback */ Any, String | (js.Array[js.Object | String])]]) => (value(t0, t1)).runNow()))
