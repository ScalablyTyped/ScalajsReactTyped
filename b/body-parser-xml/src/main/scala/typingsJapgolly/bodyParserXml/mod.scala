...
import typingsJapgolly.bodyParser.mod.BodyParser
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setVerify(
        value: (/* req */ Request, /* res */ Response, /* buf */ Buffer, /* encoding */ BufferEncoding) => Callback
      ): Self = StObject.set(x, "verify", js.Any.fromFunction4((t0: /* req */ Request, t1: /* res */ Response, t2: /* buf */ Buffer, t3: /* encoding */ BufferEncoding) => (value(t0, t1, t2, t3)).runNow()))
  ...
  object bodyParserAugmentingMod {
    ...
    trait BodyParser extends StObject {
      ...
      def xml(options: typingsJapgolly.bodyParser.mod.Options): NextHandleFunction = js.native
    }
  }
}
