...
trait Marker
  ...
  def onmousedown(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
  
  def onmouseout(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
  
  def onmouseover(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
  
  def onmouseup(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
