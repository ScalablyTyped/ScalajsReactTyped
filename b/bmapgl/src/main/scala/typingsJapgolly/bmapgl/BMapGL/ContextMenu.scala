...
trait ContextMenu extends StObject {
  ...
  def onclose(event: typingsJapgolly.bmapgl.anon.Pixel): Unit
  
  def onopen(event: typingsJapgolly.bmapgl.anon.Pixel): Unit
...
object ContextMenu {
  ...
  extension [Self <: ContextMenu](x: Self) {
    ...
    inline def setOnclose(value: typingsJapgolly.bmapgl.anon.Pixel => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onclose", js.Any.fromFunction1((t0: typingsJapgolly.bmapgl.anon.Pixel) => value(t0).runNow()))
    
    inline def setOnopen(value: typingsJapgolly.bmapgl.anon.Pixel => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onopen", js.Any.fromFunction1((t0: typingsJapgolly.bmapgl.anon.Pixel) => value(t0).runNow()))
