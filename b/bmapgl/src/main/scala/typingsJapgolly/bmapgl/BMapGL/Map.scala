...
import typingsJapgolly.bmapgl.anon.Spots
import typingsJapgolly.bmapgl.anon.Target
import typingsJapgolly.bmapgl.anon.Type
...
trait Map extends StObject {
  ...
  def onclick(event: typingsJapgolly.bmapgl.anon.Overlay): Unit = js.native
  
  def ondblclick(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
  
  def ondragend(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
  
  def ondragging(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
  
  def ondragstart(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
  ...
  def onlongpress(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
  
  def onmaptypechange(event: Target): Unit = js.native
  
  def onmousemove(event: typingsJapgolly.bmapgl.anon.Overlay): Unit = js.native
  ...
  def onresize(event: typingsJapgolly.bmapgl.anon.Size): Unit = js.native
  
  def onrightclick(event: typingsJapgolly.bmapgl.anon.Overlay): Unit = js.native
  
  def onrightdblclick(event: typingsJapgolly.bmapgl.anon.Overlay): Unit = js.native
  
  def ontilesloaded(event: Target): Unit = js.native
  
  def ontouchend(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
  
  def ontouchmove(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
  
  def ontouchstart(event: typingsJapgolly.bmapgl.anon.Pixel): Unit = js.native
