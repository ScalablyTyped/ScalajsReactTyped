...
import typingsJapgolly.blessed.blessedStrings.cancel
import typingsJapgolly.blessed.blessedStrings.reset
import typingsJapgolly.blessed.blessedStrings.submit
