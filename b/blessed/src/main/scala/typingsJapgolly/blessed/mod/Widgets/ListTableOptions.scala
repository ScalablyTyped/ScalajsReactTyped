...
object ListTableOptions {
  ...
  def apply(
    ...
    search: (/* err */ js.Any, /* value */ js.UndefOr[String]) => Callback = null,
    ...
    if (search != null) __obj.updateDynamic("search")(js.Any.fromFunction2((t0: /* err */ js.Any, t1: /* value */ js.UndefOr[java.lang.String]) => search(t0, t1).runNow()))
