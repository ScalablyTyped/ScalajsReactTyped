package typingsJapgolly.bang88ReactNativeDrawerLayout.components
...
import typingsJapgolly.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.`locked-closed`
import typingsJapgolly.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.`locked-open`
import typingsJapgolly.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.`on-drag`
import typingsJapgolly.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.left
import typingsJapgolly.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.right
import typingsJapgolly.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.unlocked
import typingsJapgolly.bang88ReactNativeDrawerLayout.mod.DrawerLayoutProperties
import typingsJapgolly.bang88ReactNativeDrawerLayout.mod.DrawerLayoutSlideEvent
...
object ReactNativeDrawerLayout {
  def apply(
    ...
    keyboardDismissMode: typingsJapgolly.bang88ReactNativeDrawerLayout.bang88ReactNativeDrawerLayoutStrings.none | `on-drag` = null,
    ...
    if (onDrawerSlide != null) __obj.updateDynamic("onDrawerSlide")(js.Any.fromFunction1((t0: /* event */ typingsJapgolly.bang88ReactNativeDrawerLayout.mod.DrawerLayoutSlideEvent) => onDrawerSlide(t0).runNow()))
  ...
  typingsJapgolly.bang88ReactNativeDrawerLayout.mod.DrawerLayoutProperties, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.bang88ReactNativeDrawerLayout.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.bang88ReactNativeDrawerLayout.mod.DrawerLayoutProperties])(children: _*)
  }
