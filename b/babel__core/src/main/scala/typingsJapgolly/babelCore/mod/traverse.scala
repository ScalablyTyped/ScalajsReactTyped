...
object traverse {
  ...
  inline def apply[S](parent: typingsJapgolly.babelTypes.mod.Node, opts: TraverseOptions[S], scope: Unit, state: S): Unit = (^.asInstanceOf[js.Dynamic].apply(parent.asInstanceOf[js.Any], opts.asInstanceOf[js.Any], scope.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def apply[S](
  ...
  inline def apply[S](parent: typingsJapgolly.babelTypes.mod.Node, opts: TraverseOptions[S], scope: Scope, state: S): Unit = (^.asInstanceOf[js.Dynamic].apply(parent.asInstanceOf[js.Any], opts.asInstanceOf[js.Any], scope.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def apply[S](
    parent: typingsJapgolly.babelTypes.mod.Node,
    opts: TraverseOptions[S],
    scope: Scope,
