...
import typingsJapgolly.babelCore.babelCoreStrings.Declaration
...
import typingsJapgolly.babelTypes.AnonComputed
import typingsJapgolly.babelTypes.AnonCooked
import typingsJapgolly.babelTypes.AnonPreserveComments
import typingsJapgolly.babelTypes.AnonToString
import typingsJapgolly.babelTypes.AnonType
import typingsJapgolly.babelTypes.PickMemberExpressionobjec
...
object types extends js.Object {
  ...
  def ensureBlock(node: Extract[typingsJapgolly.babelTypes.mod.Node, AnonBody]): BlockStatement_ = js.native
  ...
  def is(
    `type`: String,
    n: js.UndefOr[typingsJapgolly.babelTypes.mod.Node],
  ...
  def is[T /* <: /* import warning: importer.ImportType#apply Failed type conversion: @babel/types.@babel/types.Node['type'] */ js.Any */](`type`: T, n: typingsJapgolly.babelTypes.mod.Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.AnonType<T>> */ Boolean = js.native
  def is[T /* <: /* import warning: importer.ImportType#apply Failed type conversion: @babel/types.@babel/types.Node['type'] */ js.Any */, P /* <: Extract[typingsJapgolly.babelTypes.mod.Node, AnonType[T]] */](`type`: T, n: js.UndefOr[typingsJapgolly.babelTypes.mod.Node], required: Partial[P]): /* is P */ Boolean = js.native
  def is[T /* <: /* import warning: importer.ImportType#apply Failed type conversion: @babel/types.@babel/types.Node['type'] */ js.Any */, P /* <: Extract[typingsJapgolly.babelTypes.mod.Node, AnonType[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
  ...
  def isNodesEquivalent[T /* <: Partial[typingsJapgolly.babelTypes.mod.Node] */](a: T, b: js.Any): /* is T */ Boolean = js.native
  ...
  @JSName("is")
  def is_P_Node[P /* <: typingsJapgolly.babelTypes.mod.Node */](`type`: String, n: js.UndefOr[typingsJapgolly.babelTypes.mod.Node], required: Partial[P]): /* is P */ Boolean = js.native
  @JSName("is")
  def is_P_Node[P /* <: typingsJapgolly.babelTypes.mod.Node */](`type`: String, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
  ...
  def matchesPattern(node: js.UndefOr[typingsJapgolly.babelTypes.mod.Node], `match`: String): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
  def matchesPattern(node: js.UndefOr[typingsJapgolly.babelTypes.mod.Node], `match`: String, allowPartial: Boolean): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
  def matchesPattern(node: js.UndefOr[typingsJapgolly.babelTypes.mod.Node], `match`: js.Array[String]): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
  def matchesPattern(
    node: js.UndefOr[typingsJapgolly.babelTypes.mod.Node],
  ...
  @JSName("placeholder")
  def placeholder_Expression(expectedNode: typingsJapgolly.babelCore.babelCoreStrings.Expression, name: Identifier_): Placeholder_ = js.native
  @JSName("placeholder")
  def placeholder_Identifier(expectedNode: Identifier, name: Identifier_): Placeholder_ = js.native
  @JSName("placeholder")
  def placeholder_Pattern(expectedNode: typingsJapgolly.babelCore.babelCoreStrings.Pattern, name: Identifier_): Placeholder_ = js.native
  @JSName("placeholder")
  def placeholder_Statement(expectedNode: typingsJapgolly.babelCore.babelCoreStrings.Statement, name: Identifier_): Placeholder_ = js.native
  @JSName("placeholder")
  ...
  def removeProperties(n: typingsJapgolly.babelTypes.mod.Node, opts: AnonPreserveComments): Unit = js.native
  def removePropertiesDeep[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = js.native
  def removePropertiesDeep[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T, opts: AnonPreserveComments): T = js.native
  ...
  def toComputedKey[T /* <: Extract[typingsJapgolly.babelTypes.mod.Node, AnonComputed] */](node: T): Expression = js.native
  def toComputedKey[T /* <: Extract[typingsJapgolly.babelTypes.mod.Node, AnonComputed] */](node: T, key: Expression): Expression = js.native
  def toComputedKey[T /* <: Extract[typingsJapgolly.babelTypes.mod.Node, AnonComputed] */](node: T, key: Identifier_): Expression = js.native
  ...
  def toSequenceExpression(nodes: js.Array[typingsJapgolly.babelTypes.mod.Node], scope: AnonBuildUndefinedNode): js.UndefOr[SequenceExpression_] = js.native
  ...
  def validate(n: typingsJapgolly.babelTypes.mod.Node, key: String, value: js.Any): Unit = js.native
  def validate[T /* <: typingsJapgolly.babelTypes.mod.Node */, K /* <: String */](
    n: js.UndefOr[typingsJapgolly.babelTypes.mod.Node],
    key: K,
