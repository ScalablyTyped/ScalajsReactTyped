...
import typingsJapgolly.babelCore.babelCoreStrings.BlockStatement
import typingsJapgolly.babelCore.babelCoreStrings.ClassBody
import typingsJapgolly.babelCore.babelCoreStrings.CommonJS
import typingsJapgolly.babelCore.babelCoreStrings.ES
...
import typingsJapgolly.babelCore.babelCoreStrings.Identifier
...
import typingsJapgolly.babelCore.babelCoreStrings.QuestionmarkQuestionmark
import typingsJapgolly.babelCore.babelCoreStrings.Slash
import typingsJapgolly.babelCore.babelCoreStrings.StringLiteral
import typingsJapgolly.babelCore.babelCoreStrings.Tilde
import typingsJapgolly.babelCore.babelCoreStrings.Verticalline
import typingsJapgolly.babelCore.babelCoreStrings.VerticallineGreaterthansign
...
import typingsJapgolly.babelCore.babelCoreStrings.`object`
import typingsJapgolly.babelCore.babelCoreStrings.`throw`
import typingsJapgolly.babelCore.babelCoreStrings.`var`
import typingsJapgolly.babelCore.babelCoreStrings.boolean
...
import typingsJapgolly.babelCore.babelCoreStrings.function
...
import typingsJapgolly.babelCore.babelCoreStrings.minus
import typingsJapgolly.babelCore.babelCoreStrings.module
import typingsJapgolly.babelCore.babelCoreStrings.number
import typingsJapgolly.babelCore.babelCoreStrings.plus
import typingsJapgolly.babelCore.babelCoreStrings.script
import typingsJapgolly.babelCore.babelCoreStrings.set
import typingsJapgolly.babelCore.babelCoreStrings.string
import typingsJapgolly.babelCore.babelCoreStrings.symbol
import typingsJapgolly.babelCore.babelCoreStrings.typeof
import typingsJapgolly.babelCore.babelCoreStrings.undefined
...
import typingsJapgolly.babelTypes.mod.ClassAccessorProperty_
...
import typingsJapgolly.babelTypes.mod.ClassPrivateMethod_
import typingsJapgolly.babelTypes.mod.ClassPrivateProperty_
...
import typingsJapgolly.babelTypes.mod.CommentTypeShorthand
...
import typingsJapgolly.babelTypes.mod.DeclaredPredicate_
...
import typingsJapgolly.babelTypes.mod.EmptyTypeAnnotation_
import typingsJapgolly.babelTypes.mod.EnumBooleanBody_
import typingsJapgolly.babelTypes.mod.EnumBooleanMember_
import typingsJapgolly.babelTypes.mod.EnumDeclaration_
import typingsJapgolly.babelTypes.mod.EnumDefaultedMember_
import typingsJapgolly.babelTypes.mod.EnumNumberBody_
import typingsJapgolly.babelTypes.mod.EnumNumberMember_
import typingsJapgolly.babelTypes.mod.EnumStringBody_
import typingsJapgolly.babelTypes.mod.EnumStringMember_
import typingsJapgolly.babelTypes.mod.EnumSymbolBody_
import typingsJapgolly.babelTypes.mod.ExistsTypeAnnotation_
...
import typingsJapgolly.babelTypes.mod.ImportAttribute_
...
import typingsJapgolly.babelTypes.mod.IndexedAccessType_
import typingsJapgolly.babelTypes.mod.InferredPredicate_
import typingsJapgolly.babelTypes.mod.InterfaceDeclaration_
import typingsJapgolly.babelTypes.mod.InterfaceExtends_
import typingsJapgolly.babelTypes.mod.InterfaceTypeAnnotation_
import typingsJapgolly.babelTypes.mod.InterpreterDirective_
...
import typingsJapgolly.babelTypes.mod.JSXClosingFragment_
...
import typingsJapgolly.babelTypes.mod.JSXOpeningFragment_
...
import typingsJapgolly.babelTypes.mod.NumberLiteralTypeAnnotation_
...
import typingsJapgolly.babelTypes.mod.ObjectTypeInternalSlot_
import typingsJapgolly.babelTypes.mod.ObjectTypeProperty_
import typingsJapgolly.babelTypes.mod.ObjectTypeSpreadProperty_
import typingsJapgolly.babelTypes.mod.OpaqueType_
import typingsJapgolly.babelTypes.mod.OptionalCallExpression_
import typingsJapgolly.babelTypes.mod.OptionalIndexedAccessType_
...
import typingsJapgolly.babelTypes.mod.Placeholder_
...
import typingsJapgolly.babelTypes.mod.StaticBlock_
...
import typingsJapgolly.babelTypes.mod.SymbolTypeAnnotation_
import typingsJapgolly.babelTypes.mod.TSAnyKeyword_
import typingsJapgolly.babelTypes.mod.TSArrayType_
import typingsJapgolly.babelTypes.mod.TSAsExpression_
import typingsJapgolly.babelTypes.mod.TSBigIntKeyword_
import typingsJapgolly.babelTypes.mod.TSBooleanKeyword_
import typingsJapgolly.babelTypes.mod.TSCallSignatureDeclaration_
import typingsJapgolly.babelTypes.mod.TSConditionalType_
import typingsJapgolly.babelTypes.mod.TSConstructSignatureDeclaration_
import typingsJapgolly.babelTypes.mod.TSConstructorType_
import typingsJapgolly.babelTypes.mod.TSDeclareFunction_
import typingsJapgolly.babelTypes.mod.TSDeclareMethod_
import typingsJapgolly.babelTypes.mod.TSEntityName
import typingsJapgolly.babelTypes.mod.TSEnumDeclaration_
import typingsJapgolly.babelTypes.mod.TSEnumMember_
import typingsJapgolly.babelTypes.mod.TSExportAssignment_
import typingsJapgolly.babelTypes.mod.TSExpressionWithTypeArguments_
import typingsJapgolly.babelTypes.mod.TSExternalModuleReference_
import typingsJapgolly.babelTypes.mod.TSFunctionType_
import typingsJapgolly.babelTypes.mod.TSImportEqualsDeclaration_
import typingsJapgolly.babelTypes.mod.TSImportType_
import typingsJapgolly.babelTypes.mod.TSIndexSignature_
import typingsJapgolly.babelTypes.mod.TSIndexedAccessType_
import typingsJapgolly.babelTypes.mod.TSInferType_
import typingsJapgolly.babelTypes.mod.TSInstantiationExpression_
import typingsJapgolly.babelTypes.mod.TSInterfaceBody_
import typingsJapgolly.babelTypes.mod.TSInterfaceDeclaration_
import typingsJapgolly.babelTypes.mod.TSIntersectionType_
import typingsJapgolly.babelTypes.mod.TSIntrinsicKeyword_
import typingsJapgolly.babelTypes.mod.TSLiteralType_
import typingsJapgolly.babelTypes.mod.TSMappedType_
import typingsJapgolly.babelTypes.mod.TSMethodSignature_
import typingsJapgolly.babelTypes.mod.TSModuleBlock_
import typingsJapgolly.babelTypes.mod.TSModuleDeclaration_
import typingsJapgolly.babelTypes.mod.TSNamedTupleMember_
import typingsJapgolly.babelTypes.mod.TSNamespaceExportDeclaration_
import typingsJapgolly.babelTypes.mod.TSNeverKeyword_
import typingsJapgolly.babelTypes.mod.TSNonNullExpression_
import typingsJapgolly.babelTypes.mod.TSNullKeyword_
import typingsJapgolly.babelTypes.mod.TSNumberKeyword_
import typingsJapgolly.babelTypes.mod.TSObjectKeyword_
import typingsJapgolly.babelTypes.mod.TSOptionalType_
import typingsJapgolly.babelTypes.mod.TSParameterProperty_
import typingsJapgolly.babelTypes.mod.TSParenthesizedType_
import typingsJapgolly.babelTypes.mod.TSPropertySignature_
import typingsJapgolly.babelTypes.mod.TSQualifiedName_
import typingsJapgolly.babelTypes.mod.TSRestType_
import typingsJapgolly.babelTypes.mod.TSStringKeyword_
import typingsJapgolly.babelTypes.mod.TSSymbolKeyword_
import typingsJapgolly.babelTypes.mod.TSThisType_
import typingsJapgolly.babelTypes.mod.TSTupleType_
import typingsJapgolly.babelTypes.mod.TSType
import typingsJapgolly.babelTypes.mod.TSTypeAliasDeclaration_
import typingsJapgolly.babelTypes.mod.TSTypeAnnotation_
import typingsJapgolly.babelTypes.mod.TSTypeAssertion_
import typingsJapgolly.babelTypes.mod.TSTypeElement
import typingsJapgolly.babelTypes.mod.TSTypeLiteral_
import typingsJapgolly.babelTypes.mod.TSTypeOperator_
import typingsJapgolly.babelTypes.mod.TSTypeParameterDeclaration_
import typingsJapgolly.babelTypes.mod.TSTypeParameterInstantiation_
import typingsJapgolly.babelTypes.mod.TSTypeParameter_
import typingsJapgolly.babelTypes.mod.TSTypePredicate_
import typingsJapgolly.babelTypes.mod.TSTypeQuery_
import typingsJapgolly.babelTypes.mod.TSTypeReference_
import typingsJapgolly.babelTypes.mod.TSUndefinedKeyword_
import typingsJapgolly.babelTypes.mod.TSUnionType_
import typingsJapgolly.babelTypes.mod.TSUnknownKeyword_
import typingsJapgolly.babelTypes.mod.TSVoidKeyword_
...
import typingsJapgolly.babelTypes.mod.TraversalHandler
import typingsJapgolly.babelTypes.mod.TraversalHandlers
...
import typingsJapgolly.babelTypes.mod.Variance_
...
object types {
  ...
  inline def addComment[T /* <: typingsJapgolly.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, content: String): T = (^.asInstanceOf[js.Dynamic].applyDynamic("addComment")(node.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], content.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def addComment[T /* <: typingsJapgolly.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, content: String, line: Boolean): T = (^.asInstanceOf[js.Dynamic].applyDynamic("addComment")(node.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], content.asInstanceOf[js.Any], line.asInstanceOf[js.Any])).asInstanceOf[T]
  
  inline def addComments[T /* <: typingsJapgolly.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, comments: js.Array[Comment]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("addComments")(node.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], comments.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  inline def buildMatchMemberExpression(`match`: String): js.Function1[
    /* node */ js.UndefOr[typingsJapgolly.babelTypes.mod.Node | Null], 
  ...
  inline def cloneDeep[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("cloneDeep")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  
  inline def cloneDeepWithoutLoc[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("cloneDeepWithoutLoc")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  
  inline def cloneNode[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  inline def cloneNode[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T, deep: Boolean): T = (^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(n.asInstanceOf[js.Any], deep.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def cloneNode[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T, deep: Boolean, withoutLoc: Boolean): T = (^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(n.asInstanceOf[js.Any], deep.asInstanceOf[js.Any], withoutLoc.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def cloneNode[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T, deep: Unit, withoutLoc: Boolean): T = (^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(n.asInstanceOf[js.Any], deep.asInstanceOf[js.Any], withoutLoc.asInstanceOf[js.Any])).asInstanceOf[T]
  
  inline def cloneWithoutLoc[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("cloneWithoutLoc")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  
  inline def clone_[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  ...
  inline def declareExportDeclaration(declaration: Unit, specifiers: js.Array[ExportSpecifier_ | ExportNamespaceSpecifier_]): DeclareExportDeclaration_ = (^.asInstanceOf[js.Dynamic].applyDynamic("declareExportDeclaration")(declaration.asInstanceOf[js.Any], specifiers.asInstanceOf[js.Any])).asInstanceOf[DeclareExportDeclaration_]
  inline def declareExportDeclaration(
    declaration: Unit,
    specifiers: js.Array[ExportSpecifier_ | ExportNamespaceSpecifier_],
    source: StringLiteral_
  ...
  inline def ensureBlock(node: Extract[typingsJapgolly.babelTypes.mod.Node, Body]): BlockStatement_ = ^.asInstanceOf[js.Dynamic].applyDynamic("ensureBlock")(node.asInstanceOf[js.Any]).asInstanceOf[BlockStatement_]
  inline def ensureBlock[K /* <: /* keyof std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Body> */ String */](
    node: Extract[
      typingsJapgolly.babelTypes.mod.Node, 
  ...
  inline def getBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node): Record[String, Identifier_] = ^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any]).asInstanceOf[Record[String, Identifier_]]
  inline def getBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node, duplicates: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_ | js.Array[Identifier_]]]
  inline def getBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node, duplicates: Boolean, outerOnly: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any], outerOnly.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_ | js.Array[Identifier_]]]
  inline def getBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node, duplicates: Unit, outerOnly: Boolean): Record[String, Identifier_] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any], outerOnly.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_]]
  
  inline def getBindingIdentifiers_false(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `false`): Record[String, Identifier_] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_]]
  inline def getBindingIdentifiers_false(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `false`, outerOnly: Boolean): Record[String, Identifier_] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any], outerOnly.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_]]
  
  inline def getBindingIdentifiers_true(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `true`): Record[String, js.Array[Identifier_]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, js.Array[Identifier_]]]
  inline def getBindingIdentifiers_true(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `true`, outerOnly: Boolean): Record[String, js.Array[Identifier_]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any], outerOnly.asInstanceOf[js.Any])).asInstanceOf[Record[String, js.Array[Identifier_]]]
  
  inline def getOuterBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node): Record[String, Identifier_] = ^.asInstanceOf[js.Dynamic].applyDynamic("getOuterBindingIdentifiers")(node.asInstanceOf[js.Any]).asInstanceOf[Record[String, Identifier_]]
  inline def getOuterBindingIdentifiers(node: typingsJapgolly.babelTypes.mod.Node, duplicates: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOuterBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_ | js.Array[Identifier_]]]
  
  inline def getOuterBindingIdentifiers_false(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `false`): Record[String, Identifier_] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOuterBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_]]
  
  inline def getOuterBindingIdentifiers_true(node: typingsJapgolly.babelTypes.mod.Node, duplicates: `true`): Record[String, js.Array[Identifier_]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOuterBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, js.Array[Identifier_]]]
  ...
  inline def inheritInnerComments(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("inheritInnerComments")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def inheritLeadingComments(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("inheritLeadingComments")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def inheritTrailingComments(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("inheritTrailingComments")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def inherits[T /* <: js.UndefOr[typingsJapgolly.babelTypes.mod.Node | Null] */](child: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("inherits")(child.asInstanceOf[js.Any]).asInstanceOf[T]
  inline def inherits[T /* <: js.UndefOr[typingsJapgolly.babelTypes.mod.Node | Null] */](child: T, parent: typingsJapgolly.babelTypes.mod.Node): T = (^.asInstanceOf[js.Dynamic].applyDynamic("inherits")(child.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[T]
  
  inline def inheritsComments[T /* <: typingsJapgolly.babelTypes.mod.Node */](node: T, parent: typingsJapgolly.babelTypes.mod.Node): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("inheritsComments")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def is(`type`: String, n: Null, required: Partial[typingsJapgolly.babelTypes.mod.Node]): /* is @babel/types.@babel/types.Node */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.Node */ Boolean]
  inline def is(`type`: String, n: Unit, required: Partial[typingsJapgolly.babelTypes.mod.Node]): /* is @babel/types.@babel/types.Node */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.Node */ Boolean]
  inline def is(`type`: String, n: typingsJapgolly.babelTypes.mod.Node): /* is @babel/types.@babel/types.Node */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.Node */ Boolean]
  inline def is(
    `type`: String,
    n: typingsJapgolly.babelTypes.mod.Node,
    required: Partial[typingsJapgolly.babelTypes.mod.Node]
  ): /* is @babel/types.@babel/types.Node */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.Node */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelCore.babelCoreStrings.ClassAccessorProperty, typingsJapgolly.babelCore.babelCoreStrings.AnyTypeAnnotation, typingsJapgolly.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */](`type`: T): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any]).asInstanceOf[/* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelCore.babelCoreStrings.ClassAccessorProperty, typingsJapgolly.babelCore.babelCoreStrings.AnyTypeAnnotation, typingsJapgolly.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */](`type`: T, n: typingsJapgolly.babelTypes.mod.Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[/* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean]
  inline def is[P /* <: typingsJapgolly.babelTypes.mod.Node */](`type`: String, n: Null, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[P /* <: typingsJapgolly.babelTypes.mod.Node */](`type`: String, n: Unit, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[P /* <: typingsJapgolly.babelTypes.mod.Node */](`type`: String, n: typingsJapgolly.babelTypes.mod.Node, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelCore.babelCoreStrings.ClassAccessorProperty, typingsJapgolly.babelCore.babelCoreStrings.AnyTypeAnnotation, typingsJapgolly.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelCore.babelCoreStrings.ClassAccessorProperty, typingsJapgolly.babelCore.babelCoreStrings.AnyTypeAnnotation, typingsJapgolly.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Unit, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelCore.babelCoreStrings.ClassAccessorProperty, typingsJapgolly.babelCore.babelCoreStrings.AnyTypeAnnotation, typingsJapgolly.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Type[T]] */](`type`: T, n: typingsJapgolly.babelTypes.mod.Node, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  ...
  inline def isBinding(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isBinding")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def isBinding(
    node: typingsJapgolly.babelTypes.mod.Node,
    parent: typingsJapgolly.babelTypes.mod.Node,
    grandparent: typingsJapgolly.babelTypes.mod.Node
  ...
  inline def isBlockScoped(node: typingsJapgolly.babelTypes.mod.Node): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBlockScoped")(node.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  inline def isImmutable(node: typingsJapgolly.babelTypes.mod.Node): /* is @babel/types.@babel/types.Immutable */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isImmutable")(node.asInstanceOf[js.Any]).asInstanceOf[/* is @babel/types.@babel/types.Immutable */ Boolean]
  ...
  inline def isLet(node: typingsJapgolly.babelTypes.mod.Node): /* is @babel/types.@babel/types.VariableDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isLet")(node.asInstanceOf[js.Any]).asInstanceOf[/* is @babel/types.@babel/types.VariableDeclaration */ Boolean]
  ...
  inline def isNodesEquivalent_T[T /* <: Partial[typingsJapgolly.babelTypes.mod.Node] */](a: T, b: Any): /* is T */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isNodesEquivalent")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[/* is T */ Boolean]
  ...
  inline def isPlaceholderType(
    placeholderType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelCore.babelCoreStrings.ClassAccessorProperty, typingsJapgolly.babelCore.babelCoreStrings.AnyTypeAnnotation, typingsJapgolly.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any,
    targetType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelCore.babelCoreStrings.ClassAccessorProperty, typingsJapgolly.babelCore.babelCoreStrings.AnyTypeAnnotation, typingsJapgolly.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any
  ...
  inline def isReferenced(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isReferenced")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isScope(node: typingsJapgolly.babelTypes.mod.Node, parent: typingsJapgolly.babelTypes.mod.Node): /* is @babel/types.@babel/types.Scopable */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isScope")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.Scopable */ Boolean]
  ...
  inline def isType[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typingsJapgolly.babelCore.babelCoreStrings.ClassAccessorProperty, typingsJapgolly.babelCore.babelCoreStrings.AnyTypeAnnotation, typingsJapgolly.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */](nodetype: String, targetType: T): /* is T */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isType")(nodetype.asInstanceOf[js.Any], targetType.asInstanceOf[js.Any])).asInstanceOf[/* is T */ Boolean]
  ...
  inline def isVar(node: typingsJapgolly.babelTypes.mod.Node): /* is @babel/types.@babel/types.VariableDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isVar")(node.asInstanceOf[js.Any]).asInstanceOf[/* is @babel/types.@babel/types.VariableDeclaration */ Boolean]
  ...
  inline def matchesPattern(node: typingsJapgolly.babelTypes.mod.Node, `match`: String): /* is @babel/types.@babel/types.MemberExpression */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("matchesPattern")(node.asInstanceOf[js.Any], `match`.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.MemberExpression */ Boolean]
  inline def matchesPattern(node: typingsJapgolly.babelTypes.mod.Node, `match`: String, allowPartial: Boolean): /* is @babel/types.@babel/types.MemberExpression */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("matchesPattern")(node.asInstanceOf[js.Any], `match`.asInstanceOf[js.Any], allowPartial.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.MemberExpression */ Boolean]
  inline def matchesPattern(node: typingsJapgolly.babelTypes.mod.Node, `match`: js.Array[String]): /* is @babel/types.@babel/types.MemberExpression */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("matchesPattern")(node.asInstanceOf[js.Any], `match`.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.MemberExpression */ Boolean]
  inline def matchesPattern(node: typingsJapgolly.babelTypes.mod.Node, `match`: js.Array[String], allowPartial: Boolean): /* is @babel/types.@babel/types.MemberExpression */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("matchesPattern")(node.asInstanceOf[js.Any], `match`.asInstanceOf[js.Any], allowPartial.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.MemberExpression */ Boolean]
  ...
  inline def placeholder(
    expectedNode: Identifier | StringLiteral | typingsJapgolly.babelCore.babelCoreStrings.Expression | typingsJapgolly.babelCore.babelCoreStrings.Statement | typingsJapgolly.babelCore.babelCoreStrings.Declaration | BlockStatement | ClassBody | typingsJapgolly.babelCore.babelCoreStrings.Pattern,
    name: Identifier_
  ...
  inline def removeComments[T /* <: typingsJapgolly.babelTypes.mod.Node */](node: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("removeComments")(node.asInstanceOf[js.Any]).asInstanceOf[T]
  
  inline def removeProperties(n: typingsJapgolly.babelTypes.mod.Node): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("removeProperties")(n.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def removeProperties(n: typingsJapgolly.babelTypes.mod.Node, opts: PreserveComments): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("removeProperties")(n.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def removePropertiesDeep[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("removePropertiesDeep")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  inline def removePropertiesDeep[T /* <: typingsJapgolly.babelTypes.mod.Node */](n: T, opts: PreserveComments): T = (^.asInstanceOf[js.Dynamic].applyDynamic("removePropertiesDeep")(n.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  inline def toComputedKey[T /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Computed] */](node: T): Expression = ^.asInstanceOf[js.Dynamic].applyDynamic("toComputedKey")(node.asInstanceOf[js.Any]).asInstanceOf[Expression]
  inline def toComputedKey[T /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Computed] */](node: T, key: Expression): Expression = (^.asInstanceOf[js.Dynamic].applyDynamic("toComputedKey")(node.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[Expression]
  inline def toComputedKey[T /* <: Extract[typingsJapgolly.babelTypes.mod.Node, Computed] */](node: T, key: Identifier_): Expression = (^.asInstanceOf[js.Dynamic].applyDynamic("toComputedKey")(node.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[Expression]
  ...
  inline def toKeyAlias(node: Method, key: typingsJapgolly.babelTypes.mod.Node): String = (^.asInstanceOf[js.Dynamic].applyDynamic("toKeyAlias")(node.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def toKeyAlias(node: Property, key: typingsJapgolly.babelTypes.mod.Node): String = (^.asInstanceOf[js.Dynamic].applyDynamic("toKeyAlias")(node.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[String]
  
  inline def toSequenceExpression(nodes: js.Array[typingsJapgolly.babelTypes.mod.Node], scope: BuildUndefinedNode): js.UndefOr[SequenceExpression_] = (^.asInstanceOf[js.Dynamic].applyDynamic("toSequenceExpression")(nodes.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[SequenceExpression_]]
  ...
  inline def traverse[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandler[T]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverse")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def traverse[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandlers[T]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverse")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def traverse[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandlers[T], state: T): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverse")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def traverse[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandler[T], state: T): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverse")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def traverseFast[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandler[T]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverseFast")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def traverseFast[T](n: typingsJapgolly.babelTypes.mod.Node, h: TraversalHandler[T], state: T): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverseFast")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def validate(n: typingsJapgolly.babelTypes.mod.Node, key: String, value: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("validate")(n.asInstanceOf[js.Any], key.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def validate[T /* <: typingsJapgolly.babelTypes.mod.Node */, K /* <: /* keyof T */ String */](
    n: Null,
    key: K,
