...
object PluginObj {
  ...
  extension [Self <: PluginObj[?], S](x: Self & PluginObj[S]) {
    ...
    inline def setManipulateOptions(value: (/* opts */ Any, /* parserOpts */ Any) => Callback): Self = StObject.set(x, "manipulateOptions", js.Any.fromFunction2((t0: /* opts */ Any, t1: /* parserOpts */ Any) => (value(t0, t1)).runNow()))
