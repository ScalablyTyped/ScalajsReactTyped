...
trait BabelFile extends StObject {
  ...
  var path: typingsJapgolly.babelTraverse.mod.NodePath[Program_]
...
object BabelFile {
  ...
  inline def apply(
    ...
    path: typingsJapgolly.babelTraverse.mod.NodePath[Program_],
    scope: Scope
  ): BabelFile = {
  ...
  extension [Self <: BabelFile](x: Self) {
    ...
    inline def setPath(value: typingsJapgolly.babelTraverse.mod.NodePath[Program_]): Self = StObject.set(x, "path", value.asInstanceOf[js.Any])
