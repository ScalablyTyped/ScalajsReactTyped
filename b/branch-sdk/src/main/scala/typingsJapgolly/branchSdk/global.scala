package typingsJapgolly.branchSdk

import typingsJapgolly.branchSdk.anon.Makenewlink
import typingsJapgolly.branchSdk.branchSdkStrings.purchase
import typingsJapgolly.branchSdk.mod.AutoAppIndexData
import typingsJapgolly.branchSdk.mod.BranchError
import typingsJapgolly.branchSdk.mod.CreditHistoryCallbackResponse
import typingsJapgolly.branchSdk.mod.CreditHistoryOptions
import typingsJapgolly.branchSdk.mod.DeepLinkData
import typingsJapgolly.branchSdk.mod.DeepViewOptions
import typingsJapgolly.branchSdk.mod.FingerprintResponse
import typingsJapgolly.branchSdk.mod.IdentityCallbackData
import typingsJapgolly.branchSdk.mod.InitOptions
import typingsJapgolly.branchSdk.mod.JourneyEvent
import typingsJapgolly.branchSdk.mod.SessionData
...
object global {
  ...
  object branch {
    ...
    object JourneyEvent extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typingsJapgolly.branchSdk.mod.JourneyEvent & String] = js.native
      
      /* "didCallJourneyClose" */ val didCallJourneyClose: typingsJapgolly.branchSdk.mod.JourneyEvent.didCallJourneyClose & String = js.native
      
      /* "didClickJourneyCTA" */ val didClickJourneyCTA: typingsJapgolly.branchSdk.mod.JourneyEvent.didClickJourneyCTA & String = js.native
      
      /* "didClickJourneyClose" */ val didClickJourneyClose: typingsJapgolly.branchSdk.mod.JourneyEvent.didClickJourneyClose & String = js.native
      
      /* "didCloseJourney" */ val didCloseJourney: typingsJapgolly.branchSdk.mod.JourneyEvent.didCloseJourney & String = js.native
      
      /* "didShowJourney" */ val didShowJourney: typingsJapgolly.branchSdk.mod.JourneyEvent.didShowJourney & String = js.native
      
      /* "willCloseJourney" */ val willCloseJourney: typingsJapgolly.branchSdk.mod.JourneyEvent.willCloseJourney & String = js.native
      
      /* "willNotShowJourney" */ val willNotShowJourney: typingsJapgolly.branchSdk.mod.JourneyEvent.willNotShowJourney & String = js.native
      
      /* "willShowJourney" */ val willShowJourney: typingsJapgolly.branchSdk.mod.JourneyEvent.willShowJourney & String = js.native
    }
    ...
    object UriRedirectMode extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.branchSdk.mod.UriRedirectMode & Double] = js.native
      
      /* 0 */ val Default: typingsJapgolly.branchSdk.mod.UriRedirectMode.Default & Double = js.native
      
      /* 2 */ val Forceful: typingsJapgolly.branchSdk.mod.UriRedirectMode.Forceful & Double = js.native
      
      /* 1 */ val Smart: typingsJapgolly.branchSdk.mod.UriRedirectMode.Smart & Double = js.native
    }
