...
import typingsJapgolly.bookshelf.anon.Instantiable
...
open class Model[T /* <: Model[Any] */] () extends ModelBase[T] {
  ...
  def fetchPage(): typingsJapgolly.bluebird.mod.^[Collection[T] & Pagination] = js.native
  def fetchPage(options: FetchPageOptions): typingsJapgolly.bluebird.mod.^[Collection[T] & Pagination] = js.native
  ...
  def load(relations: Relations): typingsJapgolly.bluebird.mod.^[T] = js.native
  def load(relations: Relations, options: SyncOptions): typingsJapgolly.bluebird.mod.^[T] = js.native
  ...
  def save(attrs: StringDictionary[Any]): typingsJapgolly.bluebird.mod.^[T] = js.native
  def save(attrs: StringDictionary[Any], options: SaveOptions): typingsJapgolly.bluebird.mod.^[T] = js.native
  def save(attrs: Unit, options: SaveOptions): typingsJapgolly.bluebird.mod.^[T] = js.native
  def save(key: String): typingsJapgolly.bluebird.mod.^[T] = js.native
  def save(key: String, `val`: Any): typingsJapgolly.bluebird.mod.^[T] = js.native
  def save(key: String, `val`: Any, options: SaveOptions): typingsJapgolly.bluebird.mod.^[T] = js.native
  def save(key: String, `val`: Unit, options: SaveOptions): typingsJapgolly.bluebird.mod.^[T] = js.native
  def save(key: Unit, `val`: Any): typingsJapgolly.bluebird.mod.^[T] = js.native
  def save(key: Unit, `val`: Any, options: SaveOptions): typingsJapgolly.bluebird.mod.^[T] = js.native
  def save(key: Unit, `val`: Unit, options: SaveOptions): typingsJapgolly.bluebird.mod.^[T] = js.native
...
object Model {
  ...
  @JSImport("bookshelf", "Model.NoRowsDeletedError")
  @js.native
  def NoRowsDeletedError: typingsJapgolly.createError.mod.Error[js.Error] = js.native
  inline def NoRowsDeletedError_=(x: typingsJapgolly.createError.mod.Error[js.Error]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NoRowsDeletedError")(x.asInstanceOf[js.Any])
  ...
  @JSImport("bookshelf", "Model.NoRowsUpdatedError")
  @js.native
  def NoRowsUpdatedError: typingsJapgolly.createError.mod.Error[js.Error] = js.native
  inline def NoRowsUpdatedError_=(x: typingsJapgolly.createError.mod.Error[js.Error]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NoRowsUpdatedError")(x.asInstanceOf[js.Any])
  ...
  @JSImport("bookshelf", "Model.NotFoundError")
  @js.native
  def NotFoundError: typingsJapgolly.createError.mod.Error[js.Error] = js.native
  inline def NotFoundError_=(x: typingsJapgolly.createError.mod.Error[js.Error]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NotFoundError")(x.asInstanceOf[js.Any])
  ...
  /* static member */
  inline def count(): typingsJapgolly.bluebird.mod.^[Double | String] = ^.asInstanceOf[js.Dynamic].applyDynamic("count")().asInstanceOf[typingsJapgolly.bluebird.mod.^[Double | String]]
  inline def count(column: String): typingsJapgolly.bluebird.mod.^[Double | String] = ^.asInstanceOf[js.Dynamic].applyDynamic("count")(column.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Double | String]]
  inline def count(column: String, options: SyncOptions): typingsJapgolly.bluebird.mod.^[Double | String] = (^.asInstanceOf[js.Dynamic].applyDynamic("count")(column.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Double | String]]
  inline def count(column: Unit, options: SyncOptions): typingsJapgolly.bluebird.mod.^[Double | String] = (^.asInstanceOf[js.Dynamic].applyDynamic("count")(column.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Double | String]]
  ...
  /* static member */
  inline def fetchAll[T /* <: Model[Any] */](): typingsJapgolly.bluebird.mod.^[Collection[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("fetchAll")().asInstanceOf[typingsJapgolly.bluebird.mod.^[Collection[T]]]
