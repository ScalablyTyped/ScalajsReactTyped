...
import typingsJapgolly.lodash.mod.DictionaryIterator
import typingsJapgolly.lodash.mod.ListIterator
import typingsJapgolly.lodash.mod.MemoIterator
...
open class CollectionBase[T /* <: Model[Any] */] () extends Events[T] {
  ...
  def fetch(): typingsJapgolly.bluebird.mod.^[Collection[T]] = js.native
  def fetch(options: CollectionFetchOptions): typingsJapgolly.bluebird.mod.^[Collection[T]] = js.native
  ...
  def forEach(callback: Unit, thisArg: Any): Dictionary[T] = js.native
  def forEach(callback: DictionaryIterator[T, Unit]): Dictionary[T] = js.native
  def forEach(callback: DictionaryIterator[T, Unit], thisArg: Any): Dictionary[T] = js.native
  @JSName("forEach")
  def forEach_List(): typingsJapgolly.lodash.mod.List[T] = js.native
  @JSName("forEach")
  def forEach_List(callback: Unit, thisArg: Any): typingsJapgolly.lodash.mod.List[T] = js.native
  @JSName("forEach")
  def forEach_List(callback: ListIterator[T, Unit]): typingsJapgolly.lodash.mod.List[T] = js.native
  @JSName("forEach")
  def forEach_List(callback: ListIterator[T, Unit], thisArg: Any): typingsJapgolly.lodash.mod.List[T] = js.native
  @JSName("forEach")
  def forEach_T(): T = js.native
  @JSName("forEach")
  def forEach_T(callback: Unit, thisArg: Any): T = js.native
  @JSName("forEach")
  def forEach_T(callback: ObjectIterator[T, Unit]): T = js.native
  @JSName("forEach")
  def forEach_T(callback: ObjectIterator[T, Unit], thisArg: Any): T = js.native
  ...
  def invokeThen(name: String, args: Any*): typingsJapgolly.bluebird.mod.^[Any] = js.native
  ...
  def reduceThen[R](
    ...
    initialValue: R,
    context: Any
  ): typingsJapgolly.bluebird.mod.^[R] = js.native
