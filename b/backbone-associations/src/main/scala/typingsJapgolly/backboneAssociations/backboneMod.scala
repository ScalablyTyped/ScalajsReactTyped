package typingsJapgolly.backboneAssociations

import org.scalablytyped.runtime.Instantiable0
import typingsJapgolly.backbone.mod.Collection
import typingsJapgolly.backbone.mod.CombinedModelConstructorOptions
import typingsJapgolly.backbone.mod.Model
import typingsJapgolly.backbone.mod.ModelSetOptions
import typingsJapgolly.backboneAssociations.backboneMod.Associations.IRelation
...
object backboneMod {
  ...
  object Associations {
    ...
    trait IRelation extends StObject {
      ...
      var relatedModel: String | Instantiable0[typingsJapgolly.backboneAssociations.backboneMod.Associations.AssociatedModel]
    ...
    object IRelation {
      ...
      inline def apply(
        key: String,
        relatedModel: String | Instantiable0[typingsJapgolly.backboneAssociations.backboneMod.Associations.AssociatedModel],
        `type`: String
      ): IRelation = {
      ...
      extension [Self <: IRelation](x: Self) {
        ...
        inline def setRelatedModel(
          value: String | Instantiable0[typingsJapgolly.backboneAssociations.backboneMod.Associations.AssociatedModel]
        ): Self = StObject.set(x, "relatedModel", value.asInstanceOf[js.Any])
