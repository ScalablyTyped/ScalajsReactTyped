...
import typingsJapgolly.backstopjs.AnonArgs
import typingsJapgolly.backstopjs.AnonBitmapsreference
import typingsJapgolly.backstopjs.AnonErrorColor
import typingsJapgolly.backstopjs.AnonFormat
