...
object anon {
  ...
  trait Config extends StObject {
    ...
    var config: js.UndefOr[typingsJapgolly.backstopjs.mod.Config | String] = js.undefined
  ...
  object Config {
    ...
    extension [Self <: Config](x: Self) {
      ...
      inline def setConfig(value: typingsJapgolly.backstopjs.mod.Config | String): Self = StObject.set(x, "config", value.asInstanceOf[js.Any])
