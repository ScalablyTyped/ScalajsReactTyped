...
object IStreetsideOptions {
  ...
  extension [Self <: IStreetsideOptions](x: Self) {
    ...
    inline def setOnErrorLoading(value: Callback): Self = StObject.set(x, "onErrorLoading", value.toJsFn)
    
    inline def setOnErrorLoadingUndefined: Self = StObject.set(x, "onErrorLoading", js.undefined)
    
    inline def setOnSuccessLoading(value: Callback): Self = StObject.set(x, "onSuccessLoading", value.toJsFn)
