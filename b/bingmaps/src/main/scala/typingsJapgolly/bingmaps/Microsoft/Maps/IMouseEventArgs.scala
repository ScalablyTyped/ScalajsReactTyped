...
object IMouseEventArgs {
  ...
  extension [Self <: IMouseEventArgs](x: Self) {
    ...
    inline def setTarget(value: Map | IPrimitive): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
