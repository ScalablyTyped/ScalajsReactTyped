...
object IGeocodeRequestOptions {
  @scala.inline
  def apply(
    callback: (IGeocodeResult, js.Any) => Callback,
    where: String,
    bounds: LocationRect = null,
    count: Int | Double = null,
    errorCallback: /* geocodeRequestOptions */ IGeocodeRequestOptions => Callback = null,
    ...
    __obj.updateDynamic("callback")(js.Any.fromFunction2((t0: typingsJapgolly.bingmaps.Microsoft.Maps.Search.IGeocodeResult, t1: js.Any) => callback(t0, t1).runNow()))
    if (bounds != null) __obj.updateDynamic("bounds")(bounds.asInstanceOf[js.Any])
    if (count != null) __obj.updateDynamic("count")(count.asInstanceOf[js.Any])
    if (errorCallback != null) __obj.updateDynamic("errorCallback")(js.Any.fromFunction1((t0: /* geocodeRequestOptions */ typingsJapgolly.bingmaps.Microsoft.Maps.Search.IGeocodeRequestOptions) => errorCallback(t0).runNow()))
