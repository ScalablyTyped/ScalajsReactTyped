...
object IDirectionsRenderOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(displayDisclaimer)) __obj.updateDynamic("displayDisclaimer")(displayDisclaimer.asInstanceOf[js.Any])
    if (!js.isUndefined(displayManeuverIcons)) __obj.updateDynamic("displayManeuverIcons")(displayManeuverIcons.asInstanceOf[js.Any])
    if (!js.isUndefined(displayPostItineraryItemHints)) __obj.updateDynamic("displayPostItineraryItemHints")(displayPostItineraryItemHints.asInstanceOf[js.Any])
    if (!js.isUndefined(displayPreItineraryItemHints)) __obj.updateDynamic("displayPreItineraryItemHints")(displayPreItineraryItemHints.asInstanceOf[js.Any])
    if (!js.isUndefined(displayRouteSelector)) __obj.updateDynamic("displayRouteSelector")(displayRouteSelector.asInstanceOf[js.Any])
    if (!js.isUndefined(displayStepWarnings)) __obj.updateDynamic("displayStepWarnings")(displayStepWarnings.asInstanceOf[js.Any])
    if (!js.isUndefined(displayWalkingWarning)) __obj.updateDynamic("displayWalkingWarning")(displayWalkingWarning.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showInputPanel)) __obj.updateDynamic("showInputPanel")(showInputPanel.asInstanceOf[js.Any])
