...
object IClusterLayerOptions {
  ...
  def apply(
    ...
    clusteredPinCallback: /* pin */ ClusterPushpin => Callback = null,
    ...
    if (clusteredPinCallback != null) __obj.updateDynamic("clusteredPinCallback")(js.Any.fromFunction1((t0: /* pin */ typingsJapgolly.bingmaps.Microsoft.Maps.ClusterPushpin) => clusteredPinCallback(t0).runNow()))
