...
object ReverseGeocodeRequestOptions {
  @scala.inline
  def apply(
    callback: (IPlaceResult, js.Any) => Callback,
    location: Location,
    errorCallback: /* reverseGeocodeRequestOptions */ ReverseGeocodeRequestOptions => Callback = null,
    ...
    __obj.updateDynamic("callback")(js.Any.fromFunction2((t0: typingsJapgolly.bingmaps.Microsoft.Maps.Search.IPlaceResult, t1: js.Any) => callback(t0, t1).runNow()))
    if (errorCallback != null) __obj.updateDynamic("errorCallback")(js.Any.fromFunction1((t0: /* reverseGeocodeRequestOptions */ typingsJapgolly.bingmaps.Microsoft.Maps.Search.ReverseGeocodeRequestOptions) => errorCallback(t0).runNow()))
