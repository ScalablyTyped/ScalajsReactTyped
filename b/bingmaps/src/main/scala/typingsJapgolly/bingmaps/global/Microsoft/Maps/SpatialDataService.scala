...
import typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator
import typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.equals
import typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterLogicalOperator
import typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.IFilter
import typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.IGeoDataResultSet
import typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.IGetBoundaryRequestOptions
import typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.IQueryAPIOptions
...
object SpatialDataService {
  ...
  open class Filter protected ()
    extends StObject
       with typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.Filter {
    /**
      * @constructor
      * @requires The Microsoft.Maps.SpatialDataService module.
  ...
  object FilterCompareOperator extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator & Double
      ] = js.native
    
    /* 0 */ val endsWith: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.endsWith & Double = js.native
    
    /* 1 */ @JSName("equals")
    val equals_ : equals & Double = js.native
    
    /* 2 */ val greaterThan: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.greaterThan & Double = js.native
    
    /* 3 */ val greaterThanOrEqual: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.greaterThanOrEqual & Double = js.native
    
    /* 4 */ val isIn: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.isIn & Double = js.native
    
    /* 5 */ val lessThan: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.lessThan & Double = js.native
    
    /* 6 */ val lessThanOrEqual: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.lessThanOrEqual & Double = js.native
    
    /* 7 */ val notEndsWith: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.notEndsWith & Double = js.native
    
    /* 8 */ val notEquals: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.notEquals & Double = js.native
    
    /* 9 */ val notStartsWith: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.notStartsWith & Double = js.native
    
    /* 10 */ val startsWith: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterCompareOperator.startsWith & Double = js.native
  }
  ...
  open class FilterGroup protected ()
    extends StObject
       with typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterGroup {
    /**
      * @constructor
      * @requires The Microsoft.Maps.SpatialDataService module.
  ...
  object FilterLogicalOperator extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterLogicalOperator & Double
      ] = js.native
    
    /* 0 */ val and: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterLogicalOperator.and & Double = js.native
    
    /* 1 */ val or: typingsJapgolly.bingmaps.Microsoft.Maps.SpatialDataService.FilterLogicalOperator.or & Double = js.native
  }
  ...
  object GeoDataAPIManager {
    ...
    inline def getBoundary(
      ...
      errorCallback: js.Function2[
          /* callbackState */ js.UndefOr[String | typingsJapgolly.bingmaps.Microsoft.Maps.Location], 
    ...
    inline def getBoundary(
      locations: String,
      request: IGetBoundaryRequestOptions,
      credentials: typingsJapgolly.bingmaps.Microsoft.Maps.Map,
      callback: js.Function1[/* results */ IGeoDataResultSet, Unit]
    ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("getBoundary")(locations.asInstanceOf[js.Any], request.asInstanceOf[js.Any], credentials.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def getBoundary(
      locations: String,
    ...
    inline def getBoundary(
      locations: js.Array[String | typingsJapgolly.bingmaps.Microsoft.Maps.Location],
      request: IGetBoundaryRequestOptions,
      credentials: String,
      callback: js.Function1[/* results */ IGeoDataResultSet, Unit]
    ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("getBoundary")(locations.asInstanceOf[js.Any], request.asInstanceOf[js.Any], credentials.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    inline def getBoundary(
      locations: typingsJapgolly.bingmaps.Microsoft.Maps.Location,
      request: IGetBoundaryRequestOptions,
      credentials: String,
      callback: js.Function1[/* results */ IGeoDataResultSet, Unit]
    ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("getBoundary")(locations.asInstanceOf[js.Any], request.asInstanceOf[js.Any], credentials.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
