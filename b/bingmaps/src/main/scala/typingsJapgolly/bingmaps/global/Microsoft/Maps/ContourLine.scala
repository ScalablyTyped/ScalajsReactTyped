...
@js.native
open class ContourLine protected ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.ContourLine {
  /**
    * @constructor
    * @param boundary The boundary of this contour line
    * @param contourValue The value associated with this contour line
    */
  def this(boundary: js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location]) = this()
  def this(boundary: js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location], contourValue: String) = this()
  def this(boundary: js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location], contourValue: Double) = this()
