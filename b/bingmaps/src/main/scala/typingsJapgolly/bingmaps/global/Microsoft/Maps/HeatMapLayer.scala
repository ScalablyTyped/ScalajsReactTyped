...
import typingsJapgolly.bingmaps.Microsoft.Maps.IHeatMapLayerOptions
...
open class HeatMapLayer protected ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.HeatMapLayer {
  /**
    * @constructor
  ...
  def this(locations: js.Array[
        typingsJapgolly.bingmaps.Microsoft.Maps.Location | typingsJapgolly.bingmaps.Microsoft.Maps.Pushpin
      ]) = this()
  def this(
    locations: js.Array[
        typingsJapgolly.bingmaps.Microsoft.Maps.Location | typingsJapgolly.bingmaps.Microsoft.Maps.Pushpin
