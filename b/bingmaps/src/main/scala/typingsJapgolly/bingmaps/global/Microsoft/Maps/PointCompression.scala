...
open class PointCompression ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.PointCompression
/* static members */
object PointCompression {
  ...
  /**
    ...
    */
  inline def decode(value: String): js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location] = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(value.asInstanceOf[js.Any]).asInstanceOf[js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location]]
  ...
  /**
    ...
    */
  inline def encode(locations: js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location]): String = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(locations.asInstanceOf[js.Any]).asInstanceOf[String]
}
