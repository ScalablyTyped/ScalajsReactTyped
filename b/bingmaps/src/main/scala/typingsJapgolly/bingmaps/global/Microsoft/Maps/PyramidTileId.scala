...
open class PyramidTileId protected ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId {
  /**
    * @constructor
...
object PyramidTileId {
  ...
  /**
    ...
    */
  inline def areEqual(
    tileId1: typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId,
    tileId2: typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId
  ...
  /**
    ...
    * @param height The tile's height in pixels. Default value: 256
    */
  inline def fromQuadKey(quadkey: String): typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId = ^.asInstanceOf[js.Dynamic].applyDynamic("fromQuadKey")(quadkey.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId]
  inline def fromQuadKey(quadkey: String, width: Double): typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId = (^.asInstanceOf[js.Dynamic].applyDynamic("fromQuadKey")(quadkey.asInstanceOf[js.Any], width.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId]
  inline def fromQuadKey(quadkey: String, width: Double, height: Double): typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId = (^.asInstanceOf[js.Dynamic].applyDynamic("fromQuadKey")(quadkey.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId]
  inline def fromQuadKey(quadkey: String, width: Unit, height: Double): typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId = (^.asInstanceOf[js.Dynamic].applyDynamic("fromQuadKey")(quadkey.asInstanceOf[js.Any], width.asInstanceOf[js.Any], height.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.PyramidTileId]
}
