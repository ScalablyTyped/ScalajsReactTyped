...
import typingsJapgolly.bingmaps.Microsoft.Maps.IDictionary
...
open class ConfigurableMap ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.ConfigurableMap
/* static members */
object ConfigurableMap {
  ...
  inline def createFromConfig(
    ...
    requestHeaders: Unit,
    callback: js.Function1[/* map */ typingsJapgolly.bingmaps.Microsoft.Maps.Map, Unit]
