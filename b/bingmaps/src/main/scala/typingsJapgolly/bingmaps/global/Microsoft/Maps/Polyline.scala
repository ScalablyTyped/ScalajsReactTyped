...
open class Polyline protected ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.Polyline {
  /**
    * @constructor
    ...
    */
  def this(locations: js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location]) = this()
  def this(locations: js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location], options: IPolylineOptions) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getLocations(): js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getStrokeColor(): String | typingsJapgolly.bingmaps.Microsoft.Maps.Color = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setLocations(locations: js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location]): Unit = js.native
