...
import typingsJapgolly.bingmaps.Microsoft.Maps.IMapLoadOptions
import typingsJapgolly.bingmaps.Microsoft.Maps.IPanoramaInfo
...
open class Map protected ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.Map {
  /**
    * @constructor
