...
import typingsJapgolly.bingmaps.Microsoft.Maps.IClusterLayerOptions
...
open class ClusterLayer protected ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.ClusterLayer {
  /**
    * @constructor
  ...
  def this(pushpins: js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Pushpin], options: IClusterLayerOptions) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getClusterPushpinByGridKey(gridKey: Double): typingsJapgolly.bingmaps.Microsoft.Maps.ClusterPushpin | typingsJapgolly.bingmaps.Microsoft.Maps.Pushpin = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getDisplayedPushpins(): js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Pushpin] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getPushpins(): js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Pushpin] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getPushpinsByGridKey(gridKey: Double): js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Pushpin] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setPushpins(pushpins: js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Pushpin]): Unit = js.native
}
