...
open class Color protected ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.Color {
  /**
    * @constructor
...
object Color {
  ...
  /**
    ...
    */
  inline def clone(color: typingsJapgolly.bingmaps.Microsoft.Maps.Color): typingsJapgolly.bingmaps.Microsoft.Maps.Color = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(color.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.Color]
  ...
  /**
    ...
    */
  inline def fromHex(hex: String): typingsJapgolly.bingmaps.Microsoft.Maps.Color = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHex")(hex.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.Color]
}
