...
import typingsJapgolly.bingmaps.Microsoft.Maps.IAnimatedTileLayerOptions
...
open class AnimatedTileLayer ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.AnimatedTileLayer {
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def getLoadingScreen(): typingsJapgolly.bingmaps.Microsoft.Maps.CustomOverlay = js.native
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def getTileSources(): js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.TileSource] = js.native
