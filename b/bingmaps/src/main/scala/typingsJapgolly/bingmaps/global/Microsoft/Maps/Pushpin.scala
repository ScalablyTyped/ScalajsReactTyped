...
@js.native
open class Pushpin protected ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.Pushpin {
  /**
    * @constructor
    ...
    */
  def this(location: typingsJapgolly.bingmaps.Microsoft.Maps.Location) = this()
  def this(location: typingsJapgolly.bingmaps.Microsoft.Maps.Location, options: IPushpinOptions) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getAnchor(): typingsJapgolly.bingmaps.Microsoft.Maps.Point = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getColor(): String | typingsJapgolly.bingmaps.Microsoft.Maps.Color = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getTextOffset(): typingsJapgolly.bingmaps.Microsoft.Maps.Point = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setLocation(location: typingsJapgolly.bingmaps.Microsoft.Maps.Location): Unit = js.native
