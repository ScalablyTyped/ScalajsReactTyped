...
open class LocationRect protected ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect {
  /**
    * @constructor
    ...
    */
  def this(center: typingsJapgolly.bingmaps.Microsoft.Maps.Location, width: Double, height: Double) = this()
  ...
  /* CompleteClass */
  var center: typingsJapgolly.bingmaps.Microsoft.Maps.Location = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def contains(location: typingsJapgolly.bingmaps.Microsoft.Maps.Location): Boolean = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getNorthwest(): typingsJapgolly.bingmaps.Microsoft.Maps.Location = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getSoutheast(): typingsJapgolly.bingmaps.Microsoft.Maps.Location = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def intersects(rect: typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect): Boolean = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def splitByInternationalDateLine(): js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect] = js.native
...
object LocationRect {
  ...
  inline def fromCorners(
    northwest: typingsJapgolly.bingmaps.Microsoft.Maps.Location,
    southeast: typingsJapgolly.bingmaps.Microsoft.Maps.Location
  ): typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCorners")(northwest.asInstanceOf[js.Any], southeast.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect]
  ...
  /**
    ...
    */
  inline def fromEdges(north: Double, west: Double, south: Double, east: Double): typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEdges")(north.asInstanceOf[js.Any], west.asInstanceOf[js.Any], south.asInstanceOf[js.Any], east.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect]
  ...
  /**
    ...
    */
  inline def fromLocations(locations: typingsJapgolly.bingmaps.Microsoft.Maps.Location*): typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect = ^.asInstanceOf[js.Dynamic].applyDynamic("fromLocations")(locations.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect]
  /**
    * Gets a LocationRect using an array of locations.
    * @param locations An array of locations.
    * @returns A LocationRect that encloses all the specified locations.
    */
  inline def fromLocations(locations: js.Array[typingsJapgolly.bingmaps.Microsoft.Maps.Location]): typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect = ^.asInstanceOf[js.Dynamic].applyDynamic("fromLocations")(locations.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect]
  
  inline def fromShapes(shapes: js.Array[IPrimitive | js.Array[IPrimitive]]): typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect = ^.asInstanceOf[js.Dynamic].applyDynamic("fromShapes")(shapes.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect]
  /**
    ...
    */
  inline def fromShapes(shapes: IPrimitive): typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect = ^.asInstanceOf[js.Dynamic].applyDynamic("fromShapes")(shapes.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect]
  ...
  /**
    ...
    */
  inline def fromString(str: String): typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect = ^.asInstanceOf[js.Dynamic].applyDynamic("fromString")(str.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect]
  ...
  /**
    ...
    */
  inline def merge(
    rect1: typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect,
    rect2: typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect
  ): typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect = (^.asInstanceOf[js.Dynamic].applyDynamic("merge")(rect1.asInstanceOf[js.Any], rect2.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bingmaps.Microsoft.Maps.LocationRect]
}
