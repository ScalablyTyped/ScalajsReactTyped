...
import typingsJapgolly.bingmaps.Microsoft.Maps.IGroundOverlayOptions
...
open class GroundOverlay protected ()
  extends StObject
     with typingsJapgolly.bingmaps.Microsoft.Maps.GroundOverlay {
  /**
    * @constructor
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getBackgroundColor(): String | typingsJapgolly.bingmaps.Microsoft.Maps.Color = js.native
