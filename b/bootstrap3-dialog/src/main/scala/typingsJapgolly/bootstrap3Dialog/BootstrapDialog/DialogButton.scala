...
object DialogButton {
  @scala.inline
  def apply(
    action: /* dialog */ DialogContext => Callback = null,
    ...
    if (action != null) __obj.updateDynamic("action")(js.Any.fromFunction1((t0: /* dialog */ typingsJapgolly.bootstrap3Dialog.BootstrapDialog.DialogContext) => action(t0).runNow()))
