...
object DialogOptions {
  ...
  def apply(
    ...
    callback: /* result */ Boolean => Callback = null,
    ...
    onhidden: /* dialog */ js.UndefOr[DialogContext] => Callback = null,
    onhide: /* dialog */ js.UndefOr[DialogContext] => CallbackTo[js.Any] = null,
    onshow: /* dialog */ js.UndefOr[DialogContext] => Callback = null,
    onshown: /* dialog */ js.UndefOr[DialogContext] => Callback = null,
    size: String = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction1((t0: /* result */ scala.Boolean) => callback(t0).runNow()))
    ...
    if (onhidden != null) __obj.updateDynamic("onhidden")(js.Any.fromFunction1((t0: /* dialog */ js.UndefOr[typingsJapgolly.bootstrap3Dialog.BootstrapDialog.DialogContext]) => onhidden(t0).runNow()))
    if (onhide != null) __obj.updateDynamic("onhide")(js.Any.fromFunction1((t0: /* dialog */ js.UndefOr[typingsJapgolly.bootstrap3Dialog.BootstrapDialog.DialogContext]) => onhide(t0).runNow()))
    if (onshow != null) __obj.updateDynamic("onshow")(js.Any.fromFunction1((t0: /* dialog */ js.UndefOr[typingsJapgolly.bootstrap3Dialog.BootstrapDialog.DialogContext]) => onshow(t0).runNow()))
    if (onshown != null) __obj.updateDynamic("onshown")(js.Any.fromFunction1((t0: /* dialog */ js.UndefOr[typingsJapgolly.bootstrap3Dialog.BootstrapDialog.DialogContext]) => onshown(t0).runNow()))
