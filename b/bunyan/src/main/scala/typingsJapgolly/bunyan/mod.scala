...
object mod {
  ...
  */
  ...
  object LogLevelString {
    ...
    inline def debug: typingsJapgolly.bunyan.bunyanStrings.debug = "debug".asInstanceOf[typingsJapgolly.bunyan.bunyanStrings.debug]
    
    inline def error: typingsJapgolly.bunyan.bunyanStrings.error = "error".asInstanceOf[typingsJapgolly.bunyan.bunyanStrings.error]
    
    inline def fatal: typingsJapgolly.bunyan.bunyanStrings.fatal = "fatal".asInstanceOf[typingsJapgolly.bunyan.bunyanStrings.fatal]
    
    inline def info: typingsJapgolly.bunyan.bunyanStrings.info = "info".asInstanceOf[typingsJapgolly.bunyan.bunyanStrings.info]
    
    inline def trace: typingsJapgolly.bunyan.bunyanStrings.trace = "trace".asInstanceOf[typingsJapgolly.bunyan.bunyanStrings.trace]
    
    inline def warn: typingsJapgolly.bunyan.bunyanStrings.warn = "warn".asInstanceOf[typingsJapgolly.bunyan.bunyanStrings.warn]
  }
  ...
  object WriteFn {
    ...
    inline def apply(write: js.Object => Callback): WriteFn = {
      val __obj = js.Dynamic.literal(write = js.Any.fromFunction1((t0: js.Object) => write(t0).runNow()))
      __obj.asInstanceOf[WriteFn]
    }
    
    extension [Self <: WriteFn](x: Self) {
      
      inline def setWrite(value: js.Object => Callback): Self = StObject.set(x, "write", js.Any.fromFunction1((t0: js.Object) => value(t0).runNow()))
    }
  }
}
