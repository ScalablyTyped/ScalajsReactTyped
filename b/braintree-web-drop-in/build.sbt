...
version := "1.33-dt-20220926Z-9ef969"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.github.japgolly.scalajs-react" %%% "core" % "2.1.1",
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped.japgolly" %%% "applepayjs" % "3.0-dt-20220301Z-8bc8da",
  "org.scalablytyped.japgolly" %%% "braintree-web" % "3.75-dt-20220916Z-52a069",
