...
import typingsJapgolly.braintreeWebDropIn.braintreeWebDropInStrings.`white-outline`
import typingsJapgolly.braintreeWebDropIn.braintreeWebDropInStrings.black
import typingsJapgolly.braintreeWebDropIn.braintreeWebDropInStrings.white
